...
contract Metaloot is ERC721 {
    ...
    uint256 private maxMetalootPerWallet = 10;
    uint256 private maxMetalootPerTransaction = 10;
    ...
    constructor() ERC721("Metaloot", "MTL") {}
    ...
    /**
     * @dev Allow devs to hand pick some metaloots before the available metaloots list is created
     */
    function allocateTokens(uint256[] memory tokenIds)
        external
        onlyCollaborator
    {
        require(availableMetaloots.length == 0, "Available metaloots are already set");
    ...
    * @dev Reserve particular customized tokens for giveways
    ...
    function claimMetaloot() external payable callerIsUser claimStarted {
        ...
        require(
            claimedMetalootPerWallet[msg.sender] < maxMetalootPerWallet,
            "You cannot claim more metaloots"
        );
        ...
        claimStarted
    {
        ...
        require(
            claimedMetalootPerWallet[msg.sender] + quantity <= maxMetalootPerWallet,
            "You cannot claim more Metaloots"
        );
