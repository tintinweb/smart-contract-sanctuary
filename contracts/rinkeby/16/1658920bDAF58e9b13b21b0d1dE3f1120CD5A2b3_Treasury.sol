...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x1f3dc74655fB9Ffee5Dbd7d9cbb891BE01cE50AD), // GalaxyGenesisPool
        address(0x89C0bf8Bb4daB0788C16b78ab8Ad63BE9DD60c09) // new GalaxyRewardPool
    ...
    // 28 first epochs (1 week) with 4.5% expansion regardless of GLX price
    ...
    uint256 public mintingFactorForPayingDebt; // print extra GLX during debt phase
    ...
    function getGalaxyPrice() public view returns (uint256 galaxyPrice) {
        try IOracle(galaxyOracle).consult(galaxy, 1e18) returns (uint144 price) {
            ...
            revert("Treasury: failed to consult GLX price from the oracle");
        }
    }
    ...
    function getBondDiscountRate() public view returns (uint256 _rate) {
        ...
        if (_galaxyPrice <= galaxyPriceOne) {
            if (discountPercent == 0) {
                ...
                uint256 _bondAmount = galaxyPriceOne.mul(1e18).div(_galaxyPrice); // to burn 1 GLX
    ...
    function initialize(
        ...
        maxSupplyContractionPercent = 300; // Upto 3.0% supply for contraction (to burn GLX and mint gBOND)
    ...
    function buyBonds(uint256 _galaxyAmount, uint256 targetPrice) external onlyOneBlock checkCondition checkOperator {
        ...
        require(galaxyPrice == targetPrice, "Treasury: GLX price moved");
        require(
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            if (previousEpochGalaxyPrice > galaxyPriceCeiling) {
                // Expansion ($GLX Price > 1 $FTM): there is some seigniorage to be allocated
