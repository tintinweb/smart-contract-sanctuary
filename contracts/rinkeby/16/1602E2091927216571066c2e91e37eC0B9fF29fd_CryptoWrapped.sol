...
contract CryptoWrapped is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PREMIUM_PRICE = 0.002 ether;
    uint256 public constant ULTRA_PREMIUM_PRICE = 0.005 ether;
    ...
    modifier canMintTier(bytes32 _tierHash) {
        if (_tierHash == keccak256(abi.encode("wrapped-", "classic"))) {
            _;
