...
contract BigBang is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function init(string[] memory _planets, string[] memory _terrains, string[] memory _stages, string[] memory _roles, string[] memory _elements, string[] memory _animals, string[] memory _plants, string[] memory _times) public onlyOwner{
        planets = _planets;
        terrains = _terrains;
        stages = _stages;
        roles = _roles;
