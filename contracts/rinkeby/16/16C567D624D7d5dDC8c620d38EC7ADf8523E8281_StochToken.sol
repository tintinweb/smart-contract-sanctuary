 ...
 *
 * @dev Standard ERC20 token without burning and mintable optional functions implemented.
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract StochToken is ERC20, Ownable {

    string private _name                        = "STOCH";
    string private _symbol                      = "STOCH";
    uint8 private _decimals                     = 18;    
    uint256 private _totalSupply                = 6200000 * 10e18;    // 6.2 million fixed supply 
    address public tokenOwnerAddress;
    uint public contractDeploymentTime;
    uint private percent = 15;
    uint private _initialSupply;
    uint private _initialValue = 100000 * 10e18;
    uint private amount = 1000 * 10e18;
    ...
    function transfer(address recipient, uint256 _amount) public override returns (bool) {
        if (now-contractDeploymentTime > 72 hours) {
            uint fee;
            fee = _amount.mul(percent.div(10**3));
    ...
    function _emitFirst(address account) internal {
      ...
      function emitEveryWeekTokens() public onlyOwner {
        ...
        require(tokenOwnerAddress != address(0), "ERC20: mint to the zero address");
        require(now >= mintExpPeriod + 2 minutes);
        
        _initialSupply = _initialSupply.add(amount);
        _emitInitial(tokenOwnerAddress,amount);      
        mintExpPeriod = now;
    }
