...
contract PublicSale is IPublicSale, Ownable {
    ...
    uint256 public constant PUBLIC_SALE_DELAY = 60 minutes;
    ...
    uint256 public constant HARD_CAP_ETH_AMOUNT = 2.6 ether;
...
contract LiquidityProvider is ILiquidityProvider, Ownable {
    ...
    uint256 public constant LP_TOKENS_LOCK_DELAY = 60 minutes;
