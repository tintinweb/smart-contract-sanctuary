...
contract LarvaLadsTest is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[8] private baseColors = ['#AE8B61','#DBB181','#EFB19D','#F9CDCD','#EED6B2','#C3C6B0','#D5CDDC','#EAD9D9'];
    ...
    function mint(address destination, uint256 amountOfTokens) public payable virtual {
