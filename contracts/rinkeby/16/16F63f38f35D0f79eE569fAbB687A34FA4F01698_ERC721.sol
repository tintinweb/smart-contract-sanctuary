...
contract BollyERC721 is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable{
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    uint256 public constant MAX_ELEMENTS = 10000; // Maximum number of NFTs
    uint256 public constant MAX_BY_MINT = 10;  //Maximum minting amount per user
    uint256 public constant PRICE = 1*10**17; // Price of the NFT
    ...
    event Claimed(address indexed _to, uint256 _tokenId, uint256 _amount);
    constructor(
        string memory _name,
    ...
    function safeMint(uint256 _count) public payable saleIsOpen {
    ...
    function viewPrice(uint256 _count) public pure returns (uint256) {
    ...
    function maximumElement() public pure returns(uint256){
        return MAX_ELEMENTS;
    }
