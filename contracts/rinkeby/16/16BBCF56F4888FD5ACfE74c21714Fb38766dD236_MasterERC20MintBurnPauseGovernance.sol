...
import "../../token/ERC20/ERC20MintBurnPauseGovernance.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20MintBurnPauseGovernance is ContractOwnable, IMasterERC20 {
  ERC20MintBurnPauseGovernance[] private childERC20MintBurnPauseGovernance;
  ...
  function createERC20(
    ...
    ERC20MintBurnPauseGovernance child = new ERC20MintBurnPauseGovernance(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20MintBurnPauseGovernance.push(child);
...
contract ERC20MintBurnPauseGovernance is ERC20 {
