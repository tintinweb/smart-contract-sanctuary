...
contract randomSVG is ERC721URIStorage, VRFConsumerBase {
        ...
        override
    {
        ...
        emit CreateUnfinishedRandomSVG(tokenId, _randomNumber);
    }
    ...
    function finishMint(uint256 _tokenId) public {
        ...
        emit CreateRandomSVG(_tokenId, tokenURI);
    }
    ...
    {
        uint256 numberOfCommands = (_randomNumber % maxNumberOfCommands) + 1;
        pathSvg = "<path d='";
