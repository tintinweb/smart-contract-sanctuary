...
contract Para is Context, IERC20, Ownable {
    ...
    Taxes public sellTaxes = Taxes(3, 9, 25, 25, 25, 12);
    Taxes public buyTaxes = Taxes(1, 7, 25, 25, 25, 12);
    Taxes public sendTaxes = Taxes(2, 8, 25, 25, 25, 12);
    ...
    function _transfer(
        ...
        _liquidityFee = sendTaxes.liquidity;
        ...
        if (to == uniswapV2Pair) {
            ...
            _liquidityFee = sellTaxes.liquidity;
            ...
            _liquidityFee = buyTaxes.liquidity;
