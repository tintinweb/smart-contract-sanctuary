...
contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
    	_prevOwner = _owner;
    	timetoPass = block.timestamp + 30 days;
...
contract DogeCare is Context, IERC20, Ownable {
    ...
    uint256 private  _totalSupply = 4200000000000 * 10**uint256(_decimals);
    ...
    uint256 private BuyLimit = 189000000000 * 10**uint256(_decimals);
