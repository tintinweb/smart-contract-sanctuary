...
contract R012876Inu is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        uint256 totalTokensToSwap = _liquidityTokensToSwap.add(_marketingTokensToSwap).sub(_tokensToBurn);
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 totalTokensToSwap = _liquidityTokensToSwap + _marketingTokensToSwap - _tokensToBurn;
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        if(buyOrSellSwitch == BUY){
            ...
            _tokensToBurn += _buyMarketingFee * 125 / 1000;
            ...
            _tokensToBurn += _sellMarketingFee * 125 / 1000;
        }
        uint256 currentRate = _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
