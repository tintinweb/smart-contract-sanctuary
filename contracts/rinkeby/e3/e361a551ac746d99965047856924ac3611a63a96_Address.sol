 ...
 */
contract UALtd is ERC1155Tradable {
	constructor(address _proxyRegistryAddress) public ERC1155Tradable("Uniart Ltd.", "UART", _proxyRegistryAddress) {
		_setBaseMetadataURI("https://uniart.io/ua/memes/");
	}

	function contractURI() public view returns (string memory) {
		return "https://uniart.io/contract/memes-erc1155";
	}
}