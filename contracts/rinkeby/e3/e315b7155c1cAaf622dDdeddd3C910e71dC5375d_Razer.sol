...
contract Razer is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "RAZER TOKEN";
    string private _symbol = "RAZT";
    ...
    uint256 public _taxFee = 500; // means 0% which distribute to all holders reflection fee
    uint256 public _marketingFee = 1000; // meanse 8% bnb to marketing Wallet
    uint256 public _burnFee = 0; // means 0.3% it menas burn 3%
    
    
    address marketingAddress=0x77d597bC42D6a4EcB41eFEf4c337CF10D6c5636b;//dummy addresss Bnb 
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    
    uint256 public _taxFeeTotal = 500; 
    uint256 public _burnFeeTotal = 0;
    uint256 public _liquidityFeeTotal = 200;
