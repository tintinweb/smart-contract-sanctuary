...
abstract contract BH {
    function mintButt(uint256 _numberOfButts) external virtual payable;
...
contract BHFreeMint is ERC721Holder, Ownable {
    ...
    function _mint(address _to, uint256 _butts) internal {
        ...
        require(booties.length >= _butts, "Not enough butts minted");
    ...
    function freeMint(uint256 _numberOfButts) external onlyFreeMinters {
        ...
        require(
            butts.totalSupply() + _numberOfButts <= 8888,
            "Purchase exceeds max supply of Butts"
        );
        require(
