...
contract InventoryControl is IInventoryControl {
    ...
    // Added seller
    event SellerAdded(address indexed _sender, address indexed _seller);
    // Deleted seller
    event SellerDeleted(address indexed _sender, address indexed _seller);
    ...
    function isAdmin__(address _sender) override external view returns (bool) {
