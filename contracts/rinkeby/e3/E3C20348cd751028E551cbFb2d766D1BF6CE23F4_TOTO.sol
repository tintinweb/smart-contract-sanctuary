...
contract TOTO is ERC721, Ownable {
    ...
    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        GHOST_PROVENANCE = _provenanceHash;
    }
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmNpuMwEWoa65ZxANxGmNo7LDrEFpJDXSXYdb9jR95dAHw/";
    }

    function safeMint(address to) public onlyOwner {
        uint256 tokenId = _tokenIdCounter.current();
        require(tokenId > 0 && tokenId < MAX_TOKENS_PER_PURCHASE + 1, "Exceeds maximum tokens you can purchase in a single transaction");
        ...
        require(tokenId + _count < MAX_TOKENS + 1, "Exceeds maximum tokens available for purchase");
