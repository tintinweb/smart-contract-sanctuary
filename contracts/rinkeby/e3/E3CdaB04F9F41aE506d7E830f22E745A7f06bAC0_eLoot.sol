...
contract eLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    using Strings for uint256;
    ...
    function claim(uint256 tokenId) public nonReentrant {
         require(tokenId > 0 && tokenId < 6667, "Token ID invalid");
        _safeMint(_msgSender(), tokenId);
    }

    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner{
         require(tokenId > 6666 && tokenId < 6732, "Token ID invalid");
    ...
    constructor() ERC721("eloot", "ELOOT") Ownable() {}
}
