...
contract EventLifeCycle {
    ...
    constructor(
        ...
        address secondarypoolAddress
            ...
            _secondaryPool = SecondaryPool(_secondaryPoolAddress);
        }
    ...
    public 
    onlyGovernance {
        require (oracleAddress != address(0), "NEW GOVERNANCE ADDRESS SHOULD BE NOT NULL");
        _governanceAddress = _governanceAddress;
    ...
    public 
    onlyGovernance {
        require (poolAddress != address(0), "NEW GOVERNANCE ADDRESS SHOULD BE NOT NULL");
