...
contract SaberMountain is ERC721Enumerable, Ownable {
  /* Define */
    ...
    function _mintTeam(address to, uint amount) internal {
    ...
    function teamMint200() external onlyOwner {
      require(teamMintComplete == false, "This function can only be run once, and it has already been run");
