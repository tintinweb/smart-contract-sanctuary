...
//    __unstable__TokenVault private _vault;
    ...
    constructor (uint256 initialRate, uint256 factor, uint256 threshold,
        uint256 openingTime, uint256 closingTime, IERC20 token)

        Crowdsale(initialRate, 0xc4E3057A4410e118c3B357D049838407Ad95943d, token)
        AllowanceCrowdsale(0xc4E3057A4410e118c3B357D049838407Ad95943d)
 ...
 * @return amount of tokens to be purchased before multiplication factor is applied.
 */
    function stage5m() public view returns (uint256) {
        return _stage5m;
    }
    /**
     * @return amount of tokens to be purchased before multiplication factor is applied.
     */
    function stage10m() public view returns (uint256) {
        return _stage10m;
    }
 ...
 * @return amount of tokens to be purchased before multiplication factor is applied.
 */
    function stage15m() public view returns (uint256) {
        return _stage15m;
    }
...
* @return amount of tokens to be purchased before multiplication factor is applied.
*/
    function stage20m() public view returns (uint256) {
        return _stage20m;
    }
...
* @return amount of tokens to be purchased before multiplication factor is applied.
*/
    function rate5m() public view returns (uint256) {
        return _rate5m;
    }
...
* @return amount of tokens to be purchased before multiplication factor is applied.
*/
    function rate10m() public view returns (uint256) {
        return _rate10m;
    }
...
* @return amount of tokens to be purchased before multiplication factor is applied.
*/
    function rate15m() public view returns (uint256) {
        return _rate15m;
    }
...
* @return amount of tokens to be purchased before multiplication factor is applied.
*/
    function rate20m() public view returns (uint256) {
        return _rate20m;
    }
...
* @return amount of tokens to be purchased before multiplication factor is applied.
*/
    function purchasedTokenAmount() public view returns (uint256) {
