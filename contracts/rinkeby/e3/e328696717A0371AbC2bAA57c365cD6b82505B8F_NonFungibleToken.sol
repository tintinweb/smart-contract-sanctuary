...
contract NonFungibleToken is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, AccessControl {
    ...
    function setValue(uint256 _value) public onlyRole(MANAGER_KEY) {
        value = _value;
    }
...
abstract contract AccessControl is IAccessControl, ERC165 {
    ...
    bytes32 public constant MANAGER_KEY = keccak256("MANAGER");
    bytes32 public constant SYSTEM_KEY = keccak256("SYSTEM");
