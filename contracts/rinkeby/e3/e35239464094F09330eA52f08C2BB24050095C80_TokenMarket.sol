...
contract TokenMarket is TokenMarketBase {
    ...
    */
    ...
    function loanPaybackBeforeTermEnd(uint256 _loanId) public {
        ...
        uint256 paybackAmounttoLoanMarket =  loanDetails.loanAmountInBorrowed - apyFeeOriginal;
        uint256 finalPaybackAmounttoLender = paybackAmounttoLoanMarket + apyFeeBeforeLoanTermLengthEnd;
        ...
        stableCoinAPYFeeFromToken[address(this)] -= paybackAmounttoLoanMarket;

        IERC20(loanDetails.borrowStableCoin).transferFrom(loanDetails.borrower, address(this), paybackAmounttoLoanMarket);
        ...
        emit TokensLoanPaybacked(_loanId, borrower, TokenLoanData.LoanStatus.CLOSED);
  ...
  /**
    ...
    // @param _percentage percentage which goes to loan market
    //  */
    // function setLoanMarketPercentage(uint _percentage) public only {
    //     require(_percentage <= 50, "GPL: Gov Percentage should lower than 50%");
    //     govPercentage = _percentage;
    // }
