...
contract Moglets is ERC721, Ownable, IMintedBeforeReveal {
    using SafeMath for uint256;
    // This is the original provenance record of all Moglets in existence at the time.
    string public constant ORIGINAL_PROVENANCE = "6e7526a91362be1c27ba24c82007e91e1a42d6efe78fddfe2addc1fd885bf423";

    // Time of when the sale starts. Use https://www.unixtimestamp.com/
    uint256 public constant SALE_START_TIMESTAMP = 1619664900;

    // Time after which the Moglets are randomized and revealed (X days from initial launch = 86400 * X).
    ...
    // Mapping from token ID to whether the Moglets were minted before reveal.
    ...
    /**
    * @dev Returns if the Moglets were minted before reveal phase. This could come in handy later.
    */
    ...
    */
    function mintAMoglet(uint256 numberOfMoglets) public payable {
        ...
        if (startingIndexBlock == 0 && (totalSupply() == MAX_MOGLET_SUPPLY || block.timestamp >= REVEAL_TIMESTAMP)) {
    ...
    */
    ...
    function contractURI() public view returns (string memory) {
        return "https://ipfs.io/ipfs/QmTy73JKAN9Wnp6K6ajCwEBSXw4qvcVt34JaBrNeKpXU9S";
    }
