...
interface IERC1155 is IERC165 {
     ...
     * transfers.
     */
    event TransferBatchAcc(address indexed operator, address indexed from, address indexed to, uint256[] ids, uint256[] values);
...
/**
     ...
     */
    function safeBatchAccTransferFrom(
        address from,
        address to,
        uint256[] memory ids,
        ...
        
    {
        ...
        emit TransferBatchAcc(operator, from, to, ids, amounts);
