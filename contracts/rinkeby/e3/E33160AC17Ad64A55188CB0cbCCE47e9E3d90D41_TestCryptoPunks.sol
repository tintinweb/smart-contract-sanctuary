...
// File contracts/TestCryptoPunks.sol

pragma solidity ^0.8.0;


// NOTE: https://xtremetom.medium.com/cool-cats-contract-improvements-8643fcbc7fb9
contract TestCryptoPunks is ERC721Enumerable, Ownable {
    // TODO: Set PROVENANCE by hashing the hash of all images
    ...
    // withdraw addresses
    address t1 = 0xD8B3AffA8747b9aea0f60FF97D7797942276Fcda;
    address t2 = 0x4Ee34BA6c5707f37C8367fd8AEF43F754435F588;
    address t3 = 0x1b33EBa79c4DD7243E5a3456fc497b930Db054b2;

    constructor(string memory baseURI) ERC721("TestCryptoPunks", "PUNK")  {
        setBaseURI(baseURI);
    }
    ...
    function adopt(uint256 num) public payable {
        ...
        require(num < 21, "You can adopt a maximum of 20 anons");
        require(supply + num <= 100 - _reserved, "Exceeds maximum supply");
