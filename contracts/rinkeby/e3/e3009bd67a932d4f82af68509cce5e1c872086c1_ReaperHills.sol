    ...
    ReentrancyGuard
{
    ...
    // flag to signal if the minting is started
    ...
    function startMinting() external onlyOwner {
        require(!mintingStarted, "Minting is already started");
        mintingStarted = true;
    ...
    modifier checkStartMinting() {
        require(mintingStarted, "Minting hasn't started");
        _;
    }
