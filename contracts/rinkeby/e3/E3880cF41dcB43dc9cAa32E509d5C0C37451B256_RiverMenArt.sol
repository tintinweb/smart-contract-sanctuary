...
contract RiverMenArt is IRiverMenArt, ERC721, ERC721Enumerable, AccessControl, Pausable, ReentrancyGuard {
    ...
    function batchMint(address[] memory receivers, uint16[] memory resourceIds) public override {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "require admin permission");
