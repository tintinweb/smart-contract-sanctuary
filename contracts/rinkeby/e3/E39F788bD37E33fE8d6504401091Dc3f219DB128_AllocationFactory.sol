...
contract AllocationFactory is IAllocationFactory, AccessControl {
    ...
    mapping(address => address) public getAllocation;
    ...
    function createAllocation(
        ...
        if (getAllocation[_saleToken] != address(0)) {
            return getAllocation[_saleToken];
        }
        ...
        getAllocation[_saleToken] = address(allocationAddress);

        emit AllocationCreated(allocationAddress, _saleToken);
    }
    ...
    function _deploy(
        ...
        parameters = Parameters({
            ...
            amountDistribute: _amountDistribute,
        ...
        allocationAddress = address(
            new Allocation{ salt: keccak256(abi.encode(_stakeToken)) }()
        );
