    ...
    Ownable
{
    ...
    */
    ...
    function usdtBuyTokensTest(address beneficiary) public nonReentrant payable {
        uint256 weiAmount = msg.value;
        _preValidatePurchase(beneficiary, weiAmount);
    ...
    function _forwardFundsUSDT() internal {
        // Transfer amount USDT tokens from msg.sender to contract
        usdt.transferFrom(_msgSender(), _wallet, msg.value);
    }
}