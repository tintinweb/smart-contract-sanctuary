...
using SafeMath for uint256;
  ...
  constructor() public{
    Random = IERC20(0xCdB079dba0EF13463555487308E870B1933c276f);
  }

  function randomGenerator(uint256 count) public {
    for(uint256 i =0; i<3; i++)
    {
    Random.getRandomNumber();
    randomValue = Random.getRandomVal();
    test[i] = uint256(keccak256(abi.encode(randomValue, i)));
    }
  }

  function getDetail() public view returns(uint256, uint256, uint256){
