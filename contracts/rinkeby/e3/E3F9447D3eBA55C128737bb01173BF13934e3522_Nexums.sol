 ...
 * Treasury role is specific to this contract. Only account with such role could be minted.
 */
contract Nexums is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
    ...
    /**
     * @dev Mint `to` account to reach cap.
     *
     * Requirements:
     *
     * - the `to` account must have the `TREASURY` role.
     */
