...
contract CowToken is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Blue Cow", "BC") {}
    ...
    function mintCows(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of cows");
