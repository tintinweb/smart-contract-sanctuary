...
// 15%~ Slippage required: 8% ADA Auto-reflect /5% Dev & Marketing Wallet/2% Auto-LP
    ...
    contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
          ...
          address public immutable BUSD = address(0xD92E713d051C37EbB2561803a3b5FBAbc4962431); //TUSDT TESTNET
    ...
    contract Tokenflect is IBEP20, Ownable {
        ...
        address public constant TUSDT                   = address(0xD92E713d051C37EbB2561803a3b5FBAbc4962431); // TUSDT TESTNET
        ...
        address payable public _supplyWalletAddress    = payable(0x1b3d603467A3B35FDb35F02621FaFA049245CD83); // Wallet Supply-team (là où nous enverrons les tokens à la création du smartcontract avant d'airdrop la v2)
