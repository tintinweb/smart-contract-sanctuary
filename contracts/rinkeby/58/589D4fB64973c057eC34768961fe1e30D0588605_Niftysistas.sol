...
contract Niftysistas is ERC721, Ownable, Pausable {
    ...
    uint[] private lowerBounds = [861, 842, 811, 639, 302, 184, 141, 100, 772, 669, 491, 440, 249];
    uint[] private upperBounds = [879, 860, 841, 668, 439, 248, 183, 140, 810, 771, 638, 490, 301];
