...
contract DIPS is AccessControl, ERC20 {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    

    //for total supply we do 1b
    constructor() ERC20("dips", "DIPS") {
    ...
    function retrieveLost(IERC20 token) public onlyRole(DEFAULT_ADMIN_ROLE) {
