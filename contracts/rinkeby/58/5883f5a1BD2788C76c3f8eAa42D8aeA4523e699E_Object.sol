...
contract Object is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[16] = '</text><text x="125" y="275" class="base" style="font-size: 10px; letter-spacing: 1.5; fill: purple">The Alchemist\'s</text><text x="110" y="300" class="base" style="font-size: 20px; letter-spacing: 5;">GLIMMER</text></svg>';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Object #', toString(tokenId), '", "description": "Why hello there, Moon Boy. It seems that you have found my Glimmer.", "external_url": "https://www.houseofmagnus.com/", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
