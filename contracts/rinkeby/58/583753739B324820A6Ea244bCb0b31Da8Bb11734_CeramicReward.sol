...
contract CeramicReward is Ownable, ReentrancyGuard, Initializable {
    ...
    function setCeramicAddress(address _ceramicAddress) public onlyOwner {
        require(_ceramicAddress != address(0), "Zero address.");
        require(ceramicAddress != _ceramicAddress, "Already set.");
        ceramicAddress = _ceramicAddress;
    }
