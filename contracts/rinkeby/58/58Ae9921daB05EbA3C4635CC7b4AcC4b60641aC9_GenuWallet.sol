...
abstract contract ForwarderInterface {
    ...
    */
    function flushTokensERC721(address tokenContractAddress, uint256 quantity) public virtual;
...
contract GenuWallet is Ownable, Pausable, IERC721Receiver {
    ...
    */
    ...
    event TransactedERC20(address indexed msgSender, address indexed toAddress, uint256 indexed value, address tokenContractAddress);
    event TransactedERC721(address indexed msgSender, address indexed toAddress, uint256[] indexed tokenIds, address tokenContractAddress);
    ...
    */
    function sendTokensERC20(address toAddress, uint256 value, address tokenContractAddress) external onlyOwner whenNotPaused {
        ...
        emit TransactedERC20(msg.sender, toAddress, value, tokenContractAddress);
    }
    ...
    */
    function sendTokensERC721(address toAddress, uint256[] calldata tokenIds, address tokenContractAddress) external onlyOwner whenNotPaused {
        ...
        emit TransactedERC721(msg.sender, toAddress, tokenIds, tokenContractAddress);
    }
   ...
   */
    function flushForwarderTokens(
        ...
        ForwarderInterface forwarder = ForwarderInterface(forwarderAddress);
     ...
     * @param tokenContractAddress the address of the erc20 token contract
    */
    function flushForwarderTokensERC721(address payable forwarderAddress, address tokenContractAddress) external onlyOwner whenNotPaused {
        ForwarderInterface _forwarder = ForwarderInterface(forwarderAddress);
     ...
     * @param quantity the quantity to move
    */
    function flushForwarderTokensERC721(address payable forwarderAddress, address tokenContractAddress, uint256 quantity) external onlyOwner whenNotPaused {
