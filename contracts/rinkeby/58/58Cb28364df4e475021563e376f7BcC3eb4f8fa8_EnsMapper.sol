...
/* This code will work for any ERC-721 contract. Please feel free to reuse :-)
...
contract EnsMapper is Ownable {
    ...
    string public domainLabel = "monkee";
    ...
    function setDomain(string calldata label, uint256 token_id) public {
        ...
        nextRegisterTimestamp[msg.sender] = block.timestamp + 7257600;
