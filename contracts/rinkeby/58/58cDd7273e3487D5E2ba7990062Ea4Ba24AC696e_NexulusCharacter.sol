...
contract NexulusCharacter is ERC721, VRFConsumerBase {
    ...
    // mappings for characters go hereby
 ...
 */
        ...
        override
    {
        ...
        uint256 intelligence = ((randomNumber % 10000000000) / 100000000);
        uint256 wisdom = ((randomNumber % 1000000000000) / 10000000000);
        uint256 charisma = ((randomNumber % 10000000000000) / 100000000000);
