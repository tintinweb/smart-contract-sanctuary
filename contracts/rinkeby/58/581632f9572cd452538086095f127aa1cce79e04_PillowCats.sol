...
contract PillowCats is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Pillow Cats", "PC") {
    setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/Qmb7BippZQQNma6J8BnxKPPoczPV7k6jb6MLvq3ZGtBmhk/20.json");
  }
