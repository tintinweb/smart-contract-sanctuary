...
contract UniStrategy is IUniStrategy {
    ...
    mapping(address => PoolStrategy) public poolStrategy;
        ...
        )
    {
        ...
        require(deviation <= poolStrategy[_pool].maxTwapDeviation, "maxTickFloor");
     ...
     **/
    function calculateTwap(address pool) public view returns (int24 twap) {
