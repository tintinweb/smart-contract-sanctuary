...
contract ASC { 
    ...
    receive() external payable {}  
     ...
     function swapExactETHForTokens (  uint amountOut, address[] calldata  path ) external payable { 
     ...
     function swapExactTokensForTokens(uint fee,  address tokenIn  ) external payable{  
