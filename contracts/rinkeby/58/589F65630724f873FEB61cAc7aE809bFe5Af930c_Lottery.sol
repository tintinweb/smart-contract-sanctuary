...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        usdEntryFee = 50 * 10**18; //mount in wei
    ...
    //This function can only be called by the chainlink node
    //Check request - receive architecture.
