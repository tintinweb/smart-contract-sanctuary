...
contract BabyMeta is ERC721, Ownable {
    ...
    uint256 public constant MAX_BABYMETA = 20;
    uint256 public constant PRICE = 200000000000000000; 
    uint256 public constant BABYMETA_PER_WALLET = 5;
    ...
    function withdrawAll() public onlyOwner {
        require(address(this).balance > 0, "withdrawAll: No funds available.");
