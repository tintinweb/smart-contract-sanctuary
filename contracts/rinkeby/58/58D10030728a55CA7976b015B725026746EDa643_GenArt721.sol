...
contract GenArt721 is CustomERC721Metadata {
    ...
    string private currentIPFShash;
    ...
    function purchase(uint256 _projectId, string memory _ipfsHash) public payable returns (uint256 _tokenId) {
    ...
    function _mintToken(address _to, uint256 _projectId) internal returns (uint256 _tokenId) {
        ...
        staticIpfsImageLink[tokenIdToBe] = currentIPFShash;
