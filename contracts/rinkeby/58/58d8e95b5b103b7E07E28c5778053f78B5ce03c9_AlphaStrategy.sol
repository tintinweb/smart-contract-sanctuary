...
contract AdminInterface is Pausable {
    ...
    function updateAlphaPrice(uint256 _price) external  onlyAlphaStrategy {
        ALPHA_PRICE = _price;
    }
  ...
  // fees
    ...
    uint256 _MAX_AMOUNT_DEPOSIT, uint256 _MAX_AMOUNT_WITHDRAW) public onlyAlphaStrategy {
        uint256 _netDeposit;
        if (netDepositInd == 1) {
