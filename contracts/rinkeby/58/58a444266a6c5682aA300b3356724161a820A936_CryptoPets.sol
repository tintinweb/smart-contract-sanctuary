...
contract CryptoPets is ERC721, Ownable, ERC721Enumerable {
    ...
    mapping(uint => bool) public usedBotsIds;
    ...
    function mintNft(uint8 numberOfTokens) public {
        ...
        uint approvedTokens = approvedAddresses[msg.sender];
        uint addressBalance = balanceOf(msg.sender);
        require(
            approvedTokens >= numberOfTokens && addressBalance < approvedTokens,
