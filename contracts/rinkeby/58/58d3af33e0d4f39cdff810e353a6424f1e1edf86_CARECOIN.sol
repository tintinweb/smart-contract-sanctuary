...
contract Pausable is Ownable {
 ...
 contract ERC20 is Pausable {
    ...
    event birthOfCPN(address indexed from, address indexed to, uint256 value);
...
//ICO Sale will end on (Unix Time Stamp)
       ...
       //exclude Liquidity Router and Factory from fee
        ...
        emit birthOfCPN(address(0), tokenOwner,  communityAmount);
        //emit Transfer(address(0), devFund, devAmount);
    }
