...
contract NtentArt is CustomERC721Metadata {
    ...
    constructor() CustomERC721Metadata("ntent art collective", "NTNT") public {
        admin = msg.sender;
    ...
    function mint(address _to, uint256 _projectId, address _by) external returns (uint256 _tokenId) {
        ...
        require(projects[_projectId].invocations.add(1) <= projects[_projectId].maxInvocations, "Exceeds max invocations");
    ...
    function projectTokenInfo(uint256 _projectId) view public returns (address artistAddress, uint256 pricePerTokenInWei, uint256 invocations, uint256 maxInvocations, bool active, address purchaseContract) {
