...
contract Cats is ERC721PresetMinterPauserAutoId, Garage {
    ...
    function purchase() public payable override {
        ...
        require(count < 5, "All 5 cats have already been minted!");
        ...
        // Keep count of how many robots have been minted so far
        count += 1;
    }
}