...
library ViralswapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'828310d554f4e4b9399677338d98c7462ac0ed6f188942c39d309055de498057' // init code hash
            ))));
    }
    ...
    function vaultFor(address factory, address tokenA, address tokenB) internal pure returns (address vault) {
        ...
        vault = address(uint(keccak256(abi.encodePacked(
                ...
                factory,
                keccak256(abi.encodePacked(token0, token1)),
                hex'5d17fc123137aff23eefd93a71c22404da6202f065d58b8f88302b5e6b84073d' // init code hash
            ))));
    }
