...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(uint256 => uint32) private _ownerCount;
    ...
    PaymentSplitter
{
    ...
    uint256 TOKEN_COUNT = 8888;
    address VERIFY_ADDRESS = 0x70B3f80B88EDc8893d3364038CEdD6A0244B4a80;
    address DEV_ADDRESS = 0x73124518c6a1e9f63D5867a0C06161963501D2Bf;
    address PRIMARY_ADDRESS = 0xF62FDf9De5D8E0AF9d994874F48129f5BA365574;
    address SECONDARY_ADDRESS = 0x84973268c54a37D40AA4d46F9cE9A279C0d298B0;
    ...
    function safeMint(string[] memory phashes, uint256 amount)
        public
        payable
        costs(TOKEN_PRICE * amount)
    {
        for (uint256 i = 0; i < amount; i++) {
            ...
            _setTokenURI(_tokenIdCounter.current(), phashes[i]);
            _tokenIdCounter.increment();
        }
    }

    function safeMint(string memory phash) public payable costs(TOKEN_PRICE) {
        require(_tokenIdCounter.current() < TOKEN_COUNT);
        _safeMint(msg.sender, _tokenIdCounter.current());
        _setTokenURI(_tokenIdCounter.current(), phash);
        _tokenIdCounter.increment();
    }
