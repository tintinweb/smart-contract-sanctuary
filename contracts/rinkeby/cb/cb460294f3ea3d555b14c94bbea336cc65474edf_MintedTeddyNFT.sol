...
// File contracts/MintedTeddyNFT.sol
...
contract MintedTeddyNFT is ERC721URIStorage, EIP712, Ownable {
    using Counters for Counters.Counter;
    string private constant SIGNING_DOMAIN = "MintedTeddy-Voucher";
    string private constant SIGNATURE_VERSION = "1";
    Counters.Counter private _tokenIds;
    mapping(uint => bool) private _locks;
    mapping(uint256 => uint) private _editions;
    mapping(uint256 => uint) private _maxSupply;
    ...
    function mintNFT(address recipient, NFTVoucher calldata voucher) external payable returns (uint256) {
        ...
        _tokenIds.increment();
        _locks[voucher.tokenId] = voucher.locked;
        _editions[voucher.edition] = _editions[voucher.edition] + 1;
    ...
    /// @notice This returns how many teddies have been minted in total.
    ...
    function _safeParseInt(string memory _a) internal pure returns (uint _parsedInt) {
