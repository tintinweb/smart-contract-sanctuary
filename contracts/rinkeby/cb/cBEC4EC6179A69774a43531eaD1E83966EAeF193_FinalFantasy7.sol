...
contract FinalFantasy7 {
	...
	function setTokenURI(uint256 tokenId, string memory _tokenURI) internal virtual {
        require(exists(tokenId), "Problem is URI");
	...
	function buildPlayer(string memory named) public {
		...
		Player memory addPlayer = Player(named,rLevel, rStrength, rMagic, rVitality, rSpirit, rLuck, rSpeed);
	...
	function cost(string memory named) public payable {
