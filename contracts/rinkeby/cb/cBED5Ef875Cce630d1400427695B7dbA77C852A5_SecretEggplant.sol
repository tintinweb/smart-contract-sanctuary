...
contract SecretEggplant is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Secret Eggplant", "Secret Eggplant") {
        ownerContract = payable(address(0x9b822baa7A008c686DDf01eb892b029BBe68606E));
    }

    uint256 public constant MAX_SUPPLY = 1000;
    uint256 public constant MAX_MINTABLE_IN_TXN = 5;
    uint256 private _reserved = 10;
    string public _baseTokenURI = "ipfs://QmQus27Z1U1gvQqBB21BN6dzAYYjAgX6AnPtYCKjKktx4Y/";
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmWouCLxgrtGWv84Nb7qjaLSEKz4Aogxdj1SzGzfxxCWfy";
    }
