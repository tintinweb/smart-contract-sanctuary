...
contract Squish is ERC721, VRFConsumerBase {
    ...
    function requestnewRandomCharacter (uint256 userProvidedSeed, string memory name) public returns (bytes32) {
        ...
        //using mapping from above the random number 'request' will be associated with 'name' (given)
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        uint256 newId = squishes.length; 
        uint256 faded = (randomNumber % 10000);
        squishes.push(
            Squishes(
                faded,
