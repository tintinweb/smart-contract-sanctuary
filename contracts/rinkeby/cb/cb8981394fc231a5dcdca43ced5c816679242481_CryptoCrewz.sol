...
contract CryptoCrewz is ERC721Enumerable, Ownable {
  ...
  address private Address1 = 0x678c4405ABdfbfaB26dbC55F615e2B924D6E7491;
  ...
  constructor(string memory baseURI) ERC721("Crypto Crewz", "CC") {
    setBaseURI(baseURI);
  }
  ...
  function withdraw() external onlyAuthorized {
    ...
    payable(Address1).transfer(balance * 1000 / 10000);
