...
contract SecretSocietyNFT is ERC721, Ownable {
	...
	uint public constant MAX_TOKENS = 10008;
	...
	uint public CURR_SUPPLY_CAP = 2009;
	...
	constructor() ERC721("SecretSocietyNFT", "SecretSocietyNFT") {
		setBaseURI("http://api.secretsocietynft.com/collection/");
	}
	...
	function setCurrentSupply(uint numSupply) public onlyOwner{
		require(numSupply<=MAX_TOKENS, "Can't add new character NFTs. Would exceed MAX_TOKENS");
		CURR_SUPPLY_CAP = numSupply;
	}
