  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x69f9A8dcf24a3812C984d7F1bafaE97B18347006);
    ...
    // File: contracts/dinoDoodsLastContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract DinoDoodsLastContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Dino Doods Last", "RAMPP", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/swz08SNyyfpLXOaiPD80/contract-metadata";
        }
    }