...
contract slots is VRFConsumerBase {
    ...
    function playSlot(uint256 bet) public payable{
    ...
    function verdict(uint256 finalResult) internal{
        ...
        if(finalResult == 1){
            userAddress.transfer(2 * userBet);
            result = "Winner!";
        }
        else{
            result = "Loser!";
    ...
    function displayEtherInContract() public view returns(uint256) {
