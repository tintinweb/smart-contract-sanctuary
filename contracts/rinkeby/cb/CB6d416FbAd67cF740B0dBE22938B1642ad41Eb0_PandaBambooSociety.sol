...
contract PandaBambooSociety is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI = 'http://146.59.189.98:5000';
    uint256 private _maxMint = 20;
    uint256 private _price = 35 * 10**16; //0.03 ETH;
    bool public _paused = true;
    uint public constant MAX_ENTRIES = 10101;

    constructor() ERC721("Panda Bamboo Society", "PBS")  {
        //mint(msg.sender, 50);
    }
