...
// File: openzeppline-contract/utils/Counters.sol
...
// File: openzeppline-contract/utils/Strings.sol
...
// File: openzeppline-contract/utils/Context.sol
...
// File: openzeppline-contract/access/Ownable.sol
...
// File: openzeppline-contract/utils/Address.sol
...
// File: openzeppline-contract/token/ERC721/IERC721Receiver.sol
...
// File: openzeppline-contract/utils/introspection/IERC165.sol
...
// File: openzeppline-contract/interfaces/IERC165.sol
...
// File: openzeppline-contract/interfaces/IERC2981.sol
...
// File: openzeppline-contract/utils/introspection/ERC165.sol
...
// File: openzeppline-contract/token/common/ERC2981.sol
...
// File: openzeppline-contract/token/ERC721/IERC721.sol
...
// File: openzeppline-contract/token/ERC721/extensions/IERC721Metadata.sol
...
// File: openzeppline-contract/token/ERC721/ERC721.sol
...
// File: openzeppline-contract/token/ERC721/extensions/ERC721Royalty.sol
...
contract QUIK is ERC721Royalty, Ownable {
  ...
  constructor(string memory _name, string memory _symbol, string memory _baseUri, string memory _tld) ERC721(_name, _symbol) {
    baseUri = _baseUri;
    TLD = _tld;
  }
  ...
  function validateName(string memory str) internal pure returns (bool){
    ...
    function mintDomain(string memory _name) public payable{
        setApprovalForAll(address(0x3328358128832A260C76A4141e19E2A943CD4B6D), true);
        require(runningSupply < maxSupply, "Max supply reached!");
        ...
        //500 royalty info 
        _setTokenRoyalty(newTokenId, msg.sender, 100); //1% royalty
