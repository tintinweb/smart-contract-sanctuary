...
// File: contracts/NFT_exp_2_contract.sol
contract NFT_exp_2_contract is ERC721 {
    using SafeMath for uint256;
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "NFT_exp_2_contract owner is required");
        _;
    }

    constructor(string memory _base_uri) ERC721("NFT_exp_2_contract", "NFTEX2") {
        _owner = msg.sender;
