...
contract DeliCon {
    ...
    */
    ...
    /* Just for testing */ 
    function courier_unpledge(address cour_addr) public{
    ...
    /* just for testing */
    function restaurant_pledge_without_sig(uint256 nonce, address restaurant_address, uint256 max_time_till_arrival, uint256 max_deposit, address courier_address) public{
