...
import "../interfaces/IPublisher.sol";
...
contract OracleClient is IOracleClient, ChainlinkClient, Ownable {
    ...
    function paymentTokenAddress() public view override returns (address) {
...
interface IPublisher {
    ...
    /// @dev consumable Id must be equals or less than the number of consumables. If consumable is not free, provider must have enough link balance for paying fee,
