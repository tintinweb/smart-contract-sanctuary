...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b);
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x1B9c6f59ca5dE5793931736FedCada507BE10588);
        _token = msg.sender;
    }
...
contract LILKISHUX is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x1B9c6f59ca5dE5793931736FedCada507BE10588);
