...
contract faAddons is Ownable, ERC721, ERC721Enumerable {
    ...
    function assignAddon(uint16 _addonId, uint16 _nftId) public  {
        ...
        {
            nftToAddonPremium[addonToNFTPremium[_addonId]] = 15000;
            nftToAddonPremium[_nftId] = _addonId;
            addonToNFTPremium[_addonId] = _nftId;
        }
        else 
        {    
            nftToAddonStandard[addonToNFTStandard[_addonId]] = 15000;
    ...
    function newBattlePoints(uint16 _fromId, uint16 _toId) external view returns (uint16,uint16,uint16,uint16,uint32,uint32) {
       ...
       // Stats memory toStats; 
        ...
        return (fromStandardAddonId, fromPremiumAddonId, toStandardAddonId, toPremiumAddonId, _fromClass, _toClass); 
       /* 
