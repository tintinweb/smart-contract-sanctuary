...
contract EvolutionMinter is ERC721Enumerable, Ownable {
  ...
  function evolve(uint256[3] memory _tokensToBurn, string memory data) public {
    ...
    mintingContract.safeTransferFrom(msg.sender, address(0), _tokensToBurn[0]);
    mintingContract.safeTransferFrom(msg.sender, address(0), _tokensToBurn[1]);
    mintingContract.safeTransferFrom(msg.sender, address(0), _tokensToBurn[2]);
