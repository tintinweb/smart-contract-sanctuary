...
contract PrayingHands is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    // CURRENT EPOCH TIMES FOR TESTING ON RINKEBY
    uint public presaleStart = 1637107200; // November 22nd NEEDS TO BE 111 minutes BEFORE public sale + extra hour for us to mint first one for client
    uint public presaleEnd = 1637109900;   // November 22nd   
    uint public publicSale = 1637109901;   // November 22nd 11:11pm UTC 
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[admins[5]] = Account( 0, 0, 0, true); //6
        accounts[admins[6]] = Account( 0, 0, 0, true); //7
        accounts[admins[7]] = Account( 0, 0, 0, true); //8
        accounts[admins[8]] = Account( 0, 0, 0, true); //9
        accounts[admins[9]] = Account( 0, 0, 0, true); //10
        accounts[admins[10]] = Account( 0, 0, 0, true); //11
