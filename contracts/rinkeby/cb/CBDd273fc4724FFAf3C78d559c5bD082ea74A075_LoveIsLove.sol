...
contract LoveIsLove is ERC721, ERC721Enumerable, Ownable {
    ...
    uint MAX_SUPPLY = 500;
    uint MAX_PURCHASE_PER_TX = 2;
    uint MINT_PRICE = 0.05683 ether;
    uint NUM_TIERS;
    ...
    // this is sort of a hack and should probably be replaced with just a 0<tierId<n check
    ...
    function mint(uint numberOfTokens, uint tierId) public payable {
