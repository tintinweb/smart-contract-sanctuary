        ...
        bytes(
          string(
            abi.encodePacked(
              ...
              toString(tokenId),
              '", "description": "Traveling Musician: The Songs of the Metaverse. First collection of 5 unique/original songs to be played by your traveling musician on the journey ahead. Compatible with Loot (for Adventurers)", "song": "',
              song,
