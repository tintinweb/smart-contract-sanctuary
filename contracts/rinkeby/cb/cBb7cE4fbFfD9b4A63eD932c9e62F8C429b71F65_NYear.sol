...
contract NYear is ERC20("New Year", "NYEAR"), Ownable{
    using SafeMath for uint256;
    using Address for address;

    bytes32 public merkleRoot = 0x8843b768f12583228eb29145928982d433e4e3faf5d7a40dca30fbefccc83641;
    mapping (address=>bool) public savedFromRug;
    uint256 public constant MAX_SUPPLY = uint248(1e14 ether);
    uint256 public constant AMOUNT_CREATOR = (MAX_SUPPLY / 100) * 1;
    address public constant ADDR_CREATOR =
        0x505ab506411a095D381f21F99177B0933D405062;

    // for liquidity providers
    uint256 public constant AMOUNT_LP = (MAX_SUPPLY / 100) * 49;
