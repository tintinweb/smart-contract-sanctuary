...
contract PixelERC20 is ERC20, Ownable {
    ...
    uint256 public amountReservedForWinners = 10000 ether;
    ...
    function airdropWinners(address to, uint256 amount) external onlyOwner {
        require(amount * 1000000000000000000 <= amountReservedForWinners, "No more reserved");
        _mint(to, amount * 1000000000000000000);
        amountReservedForWinners = amountReservedForWinners - amount * 1000000000000000000;
    }
