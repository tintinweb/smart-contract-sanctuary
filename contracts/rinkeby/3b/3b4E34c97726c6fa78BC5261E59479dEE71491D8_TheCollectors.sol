...
contract TheCollectors is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MINT_FEE = 0.000008 ether;
    IPunk public constant PUNK = IPunk(0x7E3382095DD19F4e4B46494B12E8A5926DA3d809);
    ...
    constructor(
        ...
        maxMintsPerWhitelistedAddress = 4;
    ...
    includesMintFee(amountToMint)
    {
        ...
        require(maxMintsPerWhitelistedAddress > balanceOf(msg.sender), ">max");
        uint256 i;
        ...
        ;
            ...
            maxMintsPerWhitelistedAddress > balanceOf(msg.sender);
            i++
        ) {
    ...
    includesMintFee(amountToMint)
    {
        ...
        require(maxMintsPerAddress > balanceOf(msg.sender), ">max");
        uint256 i;
        // Since i can be lower than amountToMint after loop ends
        for (
        ;
            i < amountToMint &&
            MAX_SUPPLY > totalSupply &&
            maxMintsPerAddress > balanceOf(msg.sender);
            i++
        ) {
            _mintNextToken(msg.sender);
        }
