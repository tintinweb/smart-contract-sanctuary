...
contract Niftysistas is ERC721, Ownable, Pausable {
    ...
    uint[] private lowerBounds = [794, 775, 770, 599, 296, 182, 141, 100, 731, 629, 472, 420, 238];
    uint[] private upperBounds = [812, 793, 774, 628, 419, 237, 181, 140, 769, 730, 598, 471, 295];
