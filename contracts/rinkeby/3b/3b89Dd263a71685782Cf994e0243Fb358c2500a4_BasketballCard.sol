...
contract BasketballCard is ERC1155Tradable {
	constructor() public ERC1155Tradable("BasketballCard", "BC") {
		_setBaseMetadataURI("https://raw.githubusercontent.com/eurohsu2/bc_metadata/master/");
	}
  ...
  function setMaxSupply(uint256 _id, uint256 _newMaxSupply) public onlyWhitelistAdmin {
    require(_exists(_id), "BasketballCard#setMaxSupply: NONEXISTENT_TOKEN");
    require(_newMaxSupply >= tokenSupply[_id], "BasketballCard#setMaxSupply: Max supply cannot be less than token supply");
