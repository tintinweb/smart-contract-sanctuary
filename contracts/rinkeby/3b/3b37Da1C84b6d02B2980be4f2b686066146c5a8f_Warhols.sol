...
contract Warhols is ERC721, Ownable, ERC165Storage {
    ...
    function bardot() internal view returns (bytes memory) {
        return abi.encodePacked(
            '<filter id="filter"><feColorMatrix type="matrix" values="',
            '-0.537  0.835  0.702  0.000  0.000',
            '0.469  0.578 -0.046  0.000  0.000',
            '-0.106  1.720 -0.613  0.000  0.000',
