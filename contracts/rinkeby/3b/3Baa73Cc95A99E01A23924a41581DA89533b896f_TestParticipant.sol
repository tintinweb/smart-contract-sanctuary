...
contract TestParticipant is ERC1155, Ownable {
    using Strings for uint256;

    string public name;
    string public symbol;
    uint constant PARTICIPANT = 0;
    ...
    function mint(address account) public onlyOwner {
        _mint(account, PARTICIPANT, 1, "");
    }

    function mintEach(address[] memory accounts) public onlyOwner {
