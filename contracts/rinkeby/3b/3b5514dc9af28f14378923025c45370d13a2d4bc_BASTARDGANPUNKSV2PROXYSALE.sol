...
// THIS IS THE BASTARD GAN PUNKS V2 PROXY SALE CONTRACT: THE CONTRACT IS WRITTEN TO CATAPULT A NEW PRICING MODEL TO KILL THE BONDING CURVE ON ORIGINAL CONTRACT, TO GIVE NEW MINTS TO USERS VIA DISCOUNTED PRICE. AND ALL INCOME FROM MINTS DIRECTLY GO TO CHARITIES OF MINTER'S CHOICE. LONG LIVE BASTARDS! 
...
contract BASTARDGANPUNKSV2PROXYSALE is Ownable, IERC721Receiver {
    ...
    address public BGANPUNKSV2ADDRESS =
        0xf48ce8E434667b02cA98966cc78794151A653419;
    ...
    event donationSent(string charityName, uint amount);
