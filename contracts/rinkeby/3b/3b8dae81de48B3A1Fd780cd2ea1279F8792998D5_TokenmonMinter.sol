...
contract TokenmonMinter is ERC721Enumerable, PaymentSplitter, Ownable {
  ...
  uint256 public constant MAX_FIRST_EVO_SUPPLY = 1000; // This supply is for the first evolutions only, evolved tokens can exceed this

  uint256 public constant FIRST_EVO_PRICE = 0.001 ether;
  ...
  function mint(uint256 amount) public payable {
    ...
    require(amount <= 100, "TokenmonMinter: must mint fewer than 20");
