...
contract NFT is ERC721, Ownable {
    ...
    uint256 public constant NFTPrice = 0.01e18; //0.1 ETH
    ...
    bytes32 public root = 0xdc714cb08d4c83536e4a7adaf85adbb83fe3858468234f6b3b89dc983910d838; // todo
    bytes32 public presaleRoot = 0xdc714cb08d4c83536e4a7adaf85adbb83fe3858468234f6b3b89dc983910d838; // todo
    ...
    */
    function mint(address to, uint numberOfTokens, bytes32[] memory proof) public payable {
        ...
        require(listPurchases[operator] + numberOfTokens <= maxNFTPurchase, 'Error: Error: Each person can mint only 2');
    ...
    function presaleMint(address to, uint numberOfTokens, bytes32[] memory proof) public payable {
        ...
        require(NFTPrice.mul(numberOfTokens) <= msg.value, "Ether value sent is not correct");
        require(listPurchases[operator] + numberOfTokens <= maxNFTPurchase, 'Error: Each person can mint only 2');
