...
contract Profanity is NPass {
    ...
    function getOverlays(uint[8] memory nNumbers, uint tokenId) public view returns (string[2] memory, string memory) {
...
library ProfanityLib {
    ...
    uint private constant two_count = 49;
    ...
    function getWords(uint seedOne, uint seedTwo, uint seedThree, uint seedFour, uint tokenId) public view returns (string memory, string memory, string memory, string memory) {
        return (
    ...
    function getColorScheme(uint seed, uint tokenId) public view returns (string memory) {
