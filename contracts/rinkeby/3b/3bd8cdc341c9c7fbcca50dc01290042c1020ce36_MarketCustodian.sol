...
// File: https://raw.githubusercontent.com/OpenZeppelin/openzeppelin-contracts/master/contracts/token/ERC721/extensions/ERC721URIStorage.sol
...
contract MarketCustodian {
    ...
    event CheckDebug(uint tokenId, uint amount);

    function buyNft(uint tokenId) public payable{
        uint tokenPrice = nftMarket.getTokenPrice(tokenId);
        price = tokenPrice;
        emit CheckDebug(tokenPrice, tokenPrice);
        uint creditAmount = msg.value;
        emit CheckDebug(tokenPrice, creditAmount);
