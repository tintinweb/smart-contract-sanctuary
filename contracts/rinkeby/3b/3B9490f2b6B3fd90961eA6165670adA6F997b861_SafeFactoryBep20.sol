...
contract TokenFactory is Ownable, CloneFactory {
  ...
  address payable public masterContract = 0x6AFc6695555B3B2FBad6C93a8B1d9A4dae9b455e;
  ...
  function createToken(string memory _name, string memory _symbol,uint256 _totalsupply, uint8 _decimals, uint256 _maxtxamount, uint256 _taxfee, uint256 _liquidityfee, uint256 _numtokenstoselltoaddtoliquidity) public payable {
    require(msg.value == fee, "you must pay the fee");
    address payable clone = createClone(masterContract);
    newCloneOwner = msg.sender;
    SafeFactoryBep20(clone).init(_name, _symbol, _totalsupply, _decimals, _maxtxamount, _taxfee, _liquidityfee, _numtokenstoselltoaddtoliquidity, newCloneOwner);
  ...
  function _forwardFunds() internal {
        moonfactoryboss.transfer(msg.value);
    }
}