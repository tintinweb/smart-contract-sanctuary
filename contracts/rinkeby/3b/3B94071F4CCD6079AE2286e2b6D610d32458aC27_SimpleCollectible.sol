...
contract SimpleCollectible is ERC721 {
    ...
    function createCollectible(string memory tokenURI) public returns (uint256) {
      if(tokenCounter < 100){
        uint256 newItemId1 = tokenCounter;
        uint256 newItemId2 = tokenCounter + 1;
        uint256 newItemId3 = tokenCounter + 2;
        uint256 newItemId4 = tokenCounter + 3;
        _safeMint(msg.sender, newItemId1);
        _safeMint(msg.sender, newItemId2);
        _safeMint(msg.sender, newItemId3);
        _safeMint(msg.sender, newItemId4);
        
        _setTokenURI(newItemId1, tokenURI);
        _setTokenURI(newItemId2, tokenURI);
        _setTokenURI(newItemId3, tokenURI);
        _setTokenURI(newItemId4, tokenURI);
