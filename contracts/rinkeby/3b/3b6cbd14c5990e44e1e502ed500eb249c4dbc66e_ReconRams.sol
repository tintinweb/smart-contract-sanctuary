...
contract ReconRams is ERC721Enum, Ownable, PaymentSplitter {
    ...
    // 2  Took an ERC721 derivative implementation called "ERC721P" from another contract. Seems to be a trimmed version of ERC721, saves 0.1 ETH in deployment cost. Valid?
    // 3. Reentrancy guard needed or no given attempted checks-effects-interaction pattern? I observed contracts using it regardless of checks-effects-interaction, don't understand why.
