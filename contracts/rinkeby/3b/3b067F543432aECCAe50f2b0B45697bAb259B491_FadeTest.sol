...
contract FadeTest is ERC721, Ownable {
    ...
    function setCurrentTimetamp(uint256 currentTimestamp) public {
        require(currentTimestamp>_creationTimestamp, "Timestamp must be in the future");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (_completionTimestamp > block.timestamp) {
            completion = ABDKMath64x64.divu(_completionTimestamp-_currentTimestamp, 31536000);
        }
