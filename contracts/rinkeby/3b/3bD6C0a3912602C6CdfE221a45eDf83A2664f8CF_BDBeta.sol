...
contract BDBeta is ERC721Enumerable, EIP712, AccessControl {
    ...
    constructor(address owner) ERC721("BD", "BD") EIP712("BD", "0.5") {
        _setupRole(
            OWNER_ROLE,
            address(owner)
        );
    ...
    function check(Voucher memory voucher, bytes calldata signature) private {
        require(
            ...
            "Product signature is not valid."
        );
        ...
        require(
            ...
            "All the items of this product are sold"
        );
        require(msg.value >= voucher.price, "The amount of ether is not correct");
        if (voucher.auction) {
            require(
