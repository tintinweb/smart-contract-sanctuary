...
contract RebelMaxNFT is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
  ...
  uint256 private _maxTokensAtOnce = 200;
  ...
  address payable private fee2Address = payable(0x3077F6f9Dd328F0b72ce54B36Ae46aa26F2E95cC); // 90%
    ...
    ERC721("Rebel Max NFT", "MAX")
  {
    ...
    _mintMultipleTokensForPrivateSale();
  ...
  */
  ...
  function _mintMultipleTokensForPrivateSale() private {
