    ...
    Ownable
{
    ...
    function updateBaseURI(string calldata newBaseURI) external onlyOwner {
        require(!isBaseURIChanged, "Base URI already changed");

        baseURI = newBaseURI;

        isBaseURIChanged = true;
    }
