...
// File: contracts/ERC2309_test.sol
...
contract ERC2309 is Context, ERC165, IERC721, IERC721Metadata, IERC2309, Ownable {
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "ipfs://QmdiJGrB6VrxGwKDHAAXrpL1RG5xfnR8gzjk7ToKPaQd3A/";
    }
    ...
    function _transfer(
        ...
        require(ERC2309.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
...
// File: contracts/Correct_2309.sol
...
contract CryptoCanvas is ERC2309 {
    ...
    constructor(uint _tokenCount, string memory _uri) ERC2309("TEST", "REST") {
        admin = msg.sender;
