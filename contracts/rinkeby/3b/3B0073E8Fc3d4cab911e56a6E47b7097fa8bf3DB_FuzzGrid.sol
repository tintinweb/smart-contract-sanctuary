    ...
    function generateSVGofTokenById() internal pure returns (string memory) {
        string memory svg = string(
            abi.encodePacked(
                ...
                '<g id="svg_in"><use xlink:href="#up" x="450" y="450"></use><use xlink:href="#sq" x="450" y="200"></use><use xlink:href="#circ" x="450" y="150"></use><use xlink:href="#circ" x="450" y="0"></use><use xlink:href="#sq" x="400" y="400"></use><use xlink:href="#sq" x="350" y="350"></use><use xlink:href="#circ" x="350" y="150"></use><use xlink:href="#circ" x="300" y="200"></use><use xlink:href="#sq" x="300" y="0"></use><use xlink:href="#up" x="250" y="350"></use><use xlink:href="#sq" x="200" y="450"></use><use xlink:href="#circ" x="200" y="400"></use><use xlink:href="#up" x="200" y="150"></use><use xlink:href="#sq" x="200" y="100"></use><use xlink:href="#sq" x="150" y="450"></use><use xlink:href="#up" x="150" y="350"></use><use xlink:href="#up" x="100" y="150"></use><use xlink:href="#circ" x="100" y="50"></use><use xlink:href="#tris" x="100" y="0"></use><use xlink:href="#circ" x="50" y="100"></use><use xlink:href="#up" x="0" y="450"></use><use xlink:href="#up" x="0" y="300"></use></g>',
                '<symbol id="circ">',
                '<path d="M26,0V52A30.87,30.87,0,0,1,14.7,49.54a25.17,25.17,0,0,1-8.48-6.61A25.33,25.33,0,0,1,0,26,25.29,25.29,0,0,1,6.22,9.11a25.05,25.05,0,0,1,8.44-6.6A31.62,31.62,0,0,1,26,0Z" style="" class="shape"></path>',
                "</symbol>",
                '<symbol id="tris">',
                '<path d="M22.5,45,0,22.5,22.5,0Zm24.26,0L24.26,22.5,46.76,0Z" style="" class="shape"></path>',
                "</symbol>",
                '<symbol id="up">',
                '<path d="M52,26H0A30.66,30.66,0,0,1,2.5,14.7,25,25,0,0,1,9.11,6.22,25.29,25.29,0,0,1,26,0,25.33,25.33,0,0,1,42.93,6.22a25.14,25.14,0,0,1,6.59,8.44A31.41,31.41,0,0,1,52,26Z" style="" class="shape"></path>',
                "</symbol>",
                '<symbol id="sq">',
                '<path d="M0,36.77V0h36.81v36.77H0z" style="" class="shape"></path>',
                "</symbol>",
                "</svg>"
            )
        );
