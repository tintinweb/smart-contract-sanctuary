...
contract RandomGenerator is IRandomizer, VRFConsumerBase, Ownable {
    ...
    uint16 public override commitId = 1;
     ...
     * @param fee: fee of requesting Random
     */
    // constructor
...
//         return randomResult;
     ...
     function sRandom(uint256 tokenId) external override returns (uint256) {
        return uint256(keccak256(
    ...
    function increaseCommitId() external {
        ...
        require(commitRandoms[commitId] > 0, "Random seed not set");
        commitId += 1;
    }
    ...
    function getCommitRandom(uint16 id) external view override returns (uint256) {
        return commitRandoms[id];
    } 
}
