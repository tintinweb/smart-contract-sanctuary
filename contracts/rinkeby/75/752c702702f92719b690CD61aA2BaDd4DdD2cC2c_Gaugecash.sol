...
contract Gaugecash is Whitelist, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PermitUpgradeable {
   
    function __GAU_init(string memory name, string memory symbol) public initializer {
