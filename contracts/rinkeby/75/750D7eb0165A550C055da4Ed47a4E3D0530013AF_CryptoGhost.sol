...
contract CryptoGhost is ERC721Tradable {
    ...
    function claimGhost(string memory ghostKey, string memory ghostName)
        ...
        payable
    {
        // require(block.timestamp < 1616247607, "Minting is over");
    ...
    function baseTokenURI() public pure returns (string memory) {
        return "https://cryptospirit.modez.pro/ghost2/items/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://cryptospirit.modez.pro/ghost2/ghost.json";
    }
