...
interface IPubgNFT {
    ...
    function adminSetApprovalForAll(address _from, address _operator, bool _approved) external;
}
...
interface IKAP_721 {
    ...
    function setApprovalForAll(address _from, address _operator, bool _approved) external;
...
contract PubgNFT is IPubgNFT, IKAP_721 {
    ...
    function getTokenURI(uint256 _typeId)
        external
        view
        override
    ...
    function setApprovalForAll(
        ...
        operatorApprovals[_from][_operator] = _approved;
