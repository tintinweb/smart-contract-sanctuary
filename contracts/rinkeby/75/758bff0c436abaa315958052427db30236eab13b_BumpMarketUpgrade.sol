...
contract BumpMarketUpgrade is BumpMarket {
    ...
    function getWhiteListAddresses(address whitelistAddr)
        ...
        returns (bool)
    {
        return whiteListAddresses[whitelistAddr];
    }
    ...
    GovernanceAndOwner
{
    ...
    function pause() public whenNotPaused onlyGovernanceOrOwner {
        _pause();
    }

    function unpause() public whenPaused onlyGovernanceOrOwner {
        _unpause();
    }
