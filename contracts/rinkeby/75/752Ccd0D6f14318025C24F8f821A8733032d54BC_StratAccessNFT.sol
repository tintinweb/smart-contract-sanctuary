 ...
 */
contract StratAccessNFT is ERC1155Tradable, StrategyRole {
    ...
    function contractURI() public view returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmPEY2LoEyqP8uQAUkqk1ppdg7nXuVrr25aWodNZUuvy38";
    }
    ...
    function startUsingNFT(address _account, uint256 _id) public onlyStrategy {
        require(
            ...
            "StratAccessNFT: user account doesnt have NFT"
        );
    ...
    function safeTransferFrom(
        ...
        require(
            ...
            "StratAccessNFT: NFT being used in strategy"
        );
