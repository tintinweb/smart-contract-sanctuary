...
contract HarvestArt is ReentrancyGuard, Ownable, IERC721Receiver, IERC1155Receiver {
    ...
    function onERC721Received(
        ...
        (bool sent, bytes memory data) = payable(from).call{ value: amountPerTx }("");
    ...
    function onERC1155Received(
        ...
        (bool sent, bytes memory data) = payable(from).call{ value: amountPerTx * value }("");
        require(sent, "Failed to send ether.");
    ...
    function onERC1155BatchReceived(
        ...
        (bool sent, bytes memory data) = payable(from).call{ value: amountPerTx * totalNFTs }("");
        require(sent, "Failed to send ether.");
