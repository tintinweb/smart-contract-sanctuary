...
contract MedievalNFT is Initializable, ERC721Upgradeable, MedievalAccessControlled, VRFConsumerBaseUpgradable{
    ...
    uint256 constant FARMER_OCCUPATION = 1 << 0;
    uint256 constant THIEF_OCCUPATION = 1 << 1;
    uint256 constant GUARD_OCCUPATION = 1 << 2;
    ...
    function occupation(uint256 tokenId) public view returns(uint256) {
        uint256 _seed = tokenSeed[tokenId];
        return FARMER_OCCUPATION;
    }
...
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
import "./MedievalAccessControlCenter.sol";
...
contract MedievalAccessControlled {   
    ...
    MedievalAccessControlCenter public controlCenter;
    
    // tempAdmin has all the privile, and it is only used when controlCenter is not set.
    address public tempAdmin; 

    function _setControlCenter(address _controlCenter, address _tempAdmin) internal {
        controlCenter = MedievalAccessControlCenter(_controlCenter);
