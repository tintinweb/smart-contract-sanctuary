...
contract FS is ERC1155, Ownable {
    uint public MAX_SUPPLY = 50; 
    uint public MAX_CLAIM_PER_TX = 5;
    uint private counter;

    address public constant creatorAddress = 0xdD870fA1b7C4700F2BD7f44238821C26f7392148;   // !!!
    address public constant charityAddress = 0x583031D1113aD414F02576BD6afaBfb302140225;   // !!!
    ...
    function claim(uint amount) external payable {
        ...
        require(counter + amount <= MAX_SUPPLY, "Exceed max public supply.");
    ...
    function give(address[] calldata recipient, uint[] calldata amount) external payable {
        ...
        require(counter + totalAmount <= MAX_SUPPLY, "Exceed max public supply.");
    ...
    function withdrawAll() external onlyOwner {
        require(payable(creatorAddress).send(address(this).balance * 1/2));     // 50%
        require(payable(charityAddress).send(address(this).balance));
    }
