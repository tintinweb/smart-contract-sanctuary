...
contract ENSMigrationSubdomainRegistrar is EthRegistrarSubdomainRegistrar {
    constructor(ENS ens) public EthRegistrarSubdomainRegistrar(ens) {}
...
contract EthRegistrarSubdomainRegistrar is AbstractSubdomainRegistrar {
    ...
    constructor(ENS ens) public AbstractSubdomainRegistrar(ens) {}
     ...
     */
    function migrate(string memory name)
        public
        owner_only(keccak256(bytes(name)))
    {
        require(stopped);
    ...
    function payRent(bytes32 label, string calldata subdomain)
        external
        payable
    {
        revert();
...
contract AbstractSubdomainRegistrar is RegistrarInterface {
     ...
     */
    function setMigrationAddress(address _migration)
        public
