...
contract Punks is ERC721, ERC721Enumerable, PunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("Punks", "PKS") {
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "Punks #',
                tokenId.toString(),
                '", "description": "Punks are randomized Avataaars stored on chain", "image": "',
                image,
                '"}'
            )
        );
