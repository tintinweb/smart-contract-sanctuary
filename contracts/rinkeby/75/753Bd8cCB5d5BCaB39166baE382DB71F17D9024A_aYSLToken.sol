...
/// @notice YSL token - YSL.IO utility token
contract aYSLToken is ERC20, Ownable, AccessControl {
    ///@notice Hash of minter role for access control
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    ///@notice Perform contaract initial setup
    constructor() ERC20("YSL token", "YSL") {}
    ...
    function mintFor(address account, uint256 amount) external _isMinter {
    ...
    ///@dev Available only for minter contract
    ///@param amount Amount of tokens to mint
    function mint(uint256 amount) external _isMinter {
    ...
    function burnFrom(address account, uint256 amount) external _isMinter {
        transferFrom(account, _msgSender(), amount);
    ...
    ///@dev Available only for minter contract
    ///@param amount Amount of tokens to burn
    function burn(uint256 amount) external _isMinter {
        _burn(_msgSender(), amount);
    }
