...
contract FlowersTypes is Ownable, ERC721Enumerable  {
    using SafeMath for uint256;

    bool public saleIsActive = false;
    string private baseURI = "https://kspdvsd.elb.cisinlive.com/flower?tokenId=";
    ...
    constructor(address _bonesAddress) ERC721("Flowers", "FLW") {
    ...
    function contractURI() public pure returns (string memory) {
        return "https://kspdvsd.elb.cisinlive.com/contract/";
    }
}