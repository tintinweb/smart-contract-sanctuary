...
contract Rinkeby is ERC721, Ownable {

    //Rinkeby address Flemi
    IERC721 public FlemiCollection = IERC721(0x77E0D5009d9C3B3f01Ca68372a21744bbAAf9c5d);    
    ...
    constructor() ERC721("RinkebyNFT", "RNFT") { }
    ...
    /** 
     * @dev to make the price variable
     */
    ...
    function reserve(uint256 amount) external onlyOwner {
        require((totalSupply() + amount) <= maxSupply, "Purchase exceeds max supply");
    ...
    /**
     * Claim function for Flemi holders
     */
    function claim(uint256 amount) external {
        require(saleIsActive, "Sale must be active to claim");
        require((totalSupply() + 1) <= maxSupply, "Claim exceeds max supply");
        require(addressClaimed[msg.sender] + amount <= FlemiCollection.balanceOf(msg.sender), "Over max limit to claim");
    ...
    */
    ...
    /**
    * @dev Returns base URI, is used in ERC721.sol
    */
