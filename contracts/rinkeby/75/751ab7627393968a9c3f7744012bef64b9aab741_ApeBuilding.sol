    ...
    UUPSUpgradeable
{
    ...
    function startDefault() public onlyOwner {
                collaterals["wAoE"] = address(
            0xf1108700Bb74bFFC7c2acA9664959BdC31316Be2
        );
        collaterals["aWood"] = address(
            0xd8E0Fec01Fb430621F5960aD99D271621115a581
        );
        collaterals["aStone"] = address(
            0x498B03b5f633ABFE403259Afea18535C6f0cCBC3
        );
        collaterals["aStraw"] = address(
            0x96e3D41bd1CA70b0471B2a7E4632D7620A3274Bd
        );
        ...
        apeBarracks.buildingName = "ApeFarm";
        ...
        feeMap[1].fee = 50;
        //2-Liquidity
        feeMap[2].receiver = 0x96e57f7eF2F298FeaEFD80Fc70b1d10B825F6D32;
        feeMap[2].fee = 40;
        //3-Developers
        ...
        feeMap[4].fee = 4;
        //5-GameEcosys
        feeMap[5].receiver = 0x3dc43fE3eb169d23756e0eCB3b9Eb1EC21082007;
        feeMap[5].fee = 1;
        //6-Burn
    ...
    //     return bProps[typeOfBuildingByNFTId[tokenId]].fullURI;
    // }
    ...
    function safeMint(address to, string memory buildingName) public onlyOwner {
        uint256 currentNFTId = _tokenIdCounter.current();
        _safeMint(to, currentNFTId);
    ...
    function Buy(string memory buildingName, address buyer) public {
