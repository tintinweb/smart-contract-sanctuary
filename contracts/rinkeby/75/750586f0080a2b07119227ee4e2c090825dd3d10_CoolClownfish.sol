...
contract CoolClownfish is ERC721, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQLUr9gkUWuzS98C8hweL6swFUZbbRZRWuGXGQgumpBKQ";
    ...
    constructor(
    ) ERC721("Cool Clownfish", "CLOWNFISH") {
    }
