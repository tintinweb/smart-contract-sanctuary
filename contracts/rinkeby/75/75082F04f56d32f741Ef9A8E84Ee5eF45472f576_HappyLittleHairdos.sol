...
contract HappyLittleHairdos is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
  ...
  function withdraw() external onlyOwner {
    ...
    function purchase(uint numberOfTokens) external  payable {
...
function reservedHLHD(address _to, uint256 _count) external  onlyOwner {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmacdDpkmMmeCCNQ1a8sMDG4cSLL4rPqSViUUe54vZQxEB/";
    }
