...
contract EpicEagles is ERC721, Ownable {
    ...
    uint256 private startSales = 1631131200; // 2021-09-08 à 22:00:00

    address public constant creatorAddress = address(0x00); // 55%
    address public constant devAddress = 0xcBCc84766F2950CF867f42D766c43fB2D2Ba3256;  // 45%
    ...
    function withdrawContract() public payable onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(devAddress, balance.mul(45).div(100));
