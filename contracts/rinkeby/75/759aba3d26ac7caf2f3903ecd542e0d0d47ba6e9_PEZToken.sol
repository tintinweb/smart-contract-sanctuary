...
contract Stakable   is Ownable
{
    ...
    mapping(address => bool)                        public allowedNftContractAddresses;         // Pour la fonction nftBonus qui doit etre appeller par un contrat NFT autorisé uniquement
    ...
    //----------------------------------------------------------------------
    function    checkIfTokensHaveNftBonuses(string memory collectionName, uint256[] memory tokenIds) view external returns(uint256[] memory)
    {
    ...
    //----------------------------------------------------------------------
    function    getNftBonusAddressesFromTokenIds(string memory collectionName, uint256[] memory tokenIds) view external returns(address[] memory)
    {
        uint256          nToken    = tokenIds.length;
