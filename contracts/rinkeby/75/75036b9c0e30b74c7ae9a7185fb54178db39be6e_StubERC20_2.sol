...
contract SwapperStub_0 {
    function swapExactTokensForTokens(
        ...
        require(count >= 2, "Path too short");
        ...
        IERC20(path[0]).transferFrom(msg.sender, destination, amount);
        IERC20(path[count - 1]).transfer(destination, amount);
