...
contract Junedog is Context, IERC20, Ownable {
    ...
    string private _name = "Junedog Labs";
    string private _symbol = "JUNEDOG";
    ...
    uint16 private _burnDenominator = 50; // 2.0%
    uint16 private _luckyDenominator = 200; // 0.5%
    uint256 private _luckyMinimum = _maxTransfer.div(100000);
    uint256 private _luckyMaximum = _maxTransfer.div(100);
    uint8 private _luckyEntriesMinimum = 15;
     ...
     */
    function luckyEntriesMinimum() public view returns (uint8) {
