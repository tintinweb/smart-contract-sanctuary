...
contract NFTProject is ERC721, Ownable, Pausable {
    ...
    function makeOfferOnItem (uint256 itemID, uint256 expiryTimestamp) public payable returns (bool) {
        ...
        require(msg.value > itemsOnProject[itemID].offersOnItem[itemsOnProject[itemID].openOffers.current() + 1].offer, "Your bid is less than other available bid");
        ...
        itemsOnProject[itemID].offersOnItem[itemsOnProject[itemID].openOffers.current() + 1].beneficiaryAddress = msg.sender;
        itemsOnProject[itemID].offersOnItem[itemsOnProject[itemID].openOffers.current() + 1].offer = msg.value;
        itemsOnProject[itemID].offersOnItem[itemsOnProject[itemID].openOffers.current() + 1].expiryTimestamp = expiryTimestamp;
