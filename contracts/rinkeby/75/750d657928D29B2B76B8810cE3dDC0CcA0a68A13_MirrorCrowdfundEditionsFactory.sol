...
import {IMirrorCrowdfundEditionsLogic} from "./interface/IMirrorCrowdfundEditionsLogic.sol";
    ...
    IMirrorCrowdfundEditionsFactory
{
    ...
    function deployAndCreateEditions(
        ...
        IMirrorCrowdfundEditionsLogic(proxy).initialize(
            owner,
        ...
        emit EditionsProxyDeployed(proxy, owner, logic);
    }
