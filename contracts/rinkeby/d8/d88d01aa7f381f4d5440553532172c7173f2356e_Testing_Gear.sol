...
contract Testing_Gear is ERC721Enumerable, Ownable {
  using Strings for uint256;
 ...
 //Whitelist
  ...
  function MasterActive(bool _isMasterActive) external  onlyOwner {
    isMasterActive = _isMasterActive;
  }
  
  function PublicActive(bool _isPublicActive) external  onlyOwner {
    isPublicActive = _isPublicActive;
  }

  function WhitelistActive(bool _isWhitelistActive) external  onlyOwner {
    isWhitelistActive = _isWhitelistActive;
  }
  
  
  
  function setMessage(string calldata messageString) external  onlyOwner {
