...
import "./library/MaterialFunctionality.sol";
...
contract MaterialBag is ERC721, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        return MaterialFunctionality._tokenURI(tokenId);
    }
    ...
    function materialIds(uint256 tokenId) public view returns (MaterialItemIds memory) {
        ...
        return
            MaterialItemIds({
                gem: MaterialFunctionality.gemId(tokenId),
                rune: MaterialFunctionality.runeId(tokenId),
                material: MaterialFunctionality.materialId(tokenId),
                charm: MaterialFunctionality.charmId(tokenId),
                tool: MaterialFunctionality.toolId(tokenId),
                element: MaterialFunctionality.elementId(tokenId),
                requirement: MaterialFunctionality.requirementId(tokenId)
            });
    }
    ...
    function seeMaterials(uint256 tokenId) public view returns (MaterialItemNames memory) {
        ...
        return
            MaterialItemNames({
                gem: MaterialFunctionality.materialTokenName(items.gem),
                rune: MaterialFunctionality.materialTokenName(items.rune),
                material: MaterialFunctionality.materialTokenName(items.material),
                charm: MaterialFunctionality.materialTokenName(items.charm),
                tool: MaterialFunctionality.materialTokenName(items.tool),
                element: MaterialFunctionality.materialTokenName(items.element),
                requirement: MaterialFunctionality.materialTokenName(items.requirement)
            });
    }
