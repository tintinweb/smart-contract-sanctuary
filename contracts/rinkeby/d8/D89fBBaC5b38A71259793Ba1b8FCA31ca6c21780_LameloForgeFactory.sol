...
contract LameloForgeFactory is IFactoryERC721, AdminControl {
    ...
    function name() external pure override returns (string memory) {
        return "Lamelo Ball Forge Factory";
    }
    ...
    function canMint(uint256 _optionId) public pure override returns (bool) {
        return true;
    }
    ...
    function mint(uint256 _optionId, address _toAddress) public override {
        ...
        LameloForgeToken token = LameloForgeToken(nftAddress);
