...
contract ERC721FloorBidMatcher is ReentrancyGuardUpgradeable {
    ...
    function createBuyOrder(
        ...
        require(numberOfTokens > 0 && numberOfTokens <= 20, "Wrong number of tokens");
        ...
        nonReentrant
    {
        ...
        (order.numberOfTokens == 0) ? order.orderStatus = OrderStatus.EXECUTED: order.orderStatus = OrderStatus.PARTIALLY_EXECUTED; 
    }
