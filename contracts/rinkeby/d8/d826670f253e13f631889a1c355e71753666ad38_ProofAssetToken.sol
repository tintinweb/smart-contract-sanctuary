...
contract ProofAssetToken is ERC20 {
    ...
    IERC20 public prf = IERC20(0x453313FD0741c099b0b99A2Cdacf4Ad89A46B6A6);    
    prfInterface public prfInterfaceCall = prfInterface(0x453313FD0741c099b0b99A2Cdacf4Ad89A46B6A6);
    ...
    function prsRate() external view returns(uint256) { return smart.balance / totalSupply(); }
}