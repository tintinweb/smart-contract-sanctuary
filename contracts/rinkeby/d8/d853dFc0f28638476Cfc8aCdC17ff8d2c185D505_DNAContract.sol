        ...
        if (supply < 0) {
            ...
            output = string(abi.encodePacked(
                ...
                '<svg preserveAspectRatio="xMinYMin meet" viewBox="0 0 800 800" ',  
                    ...
                    '<style> .color_1{stop-color:rgb(255,0,255);stop-opacity:1} .color_2{stop-color:rgb(0,0,255);stop-opacity:1} .color_3{fill:none;stroke-width:25;stroke:rgb(0,0,255)} .color_4{fill:none;stroke-width:18;stroke:rgb(222, 124, 231)} </style>',
                    '<g id="ladder_1"> <path d="M400,100 l-125,0" class="color_3"/> <path d="M400,100 l125,0" class="color_3" /> <path d="M400,180 l-100,0" class="color_3" /> <path d="M400,180 l100,0" class="color_3" /> </g>', 
                    '<g id="ladder_2"> <path d="M400,360 l-100,0" class="color_3"/> <path d="M400,360 l100,0" class="color_3" /> <path d="M400,440 l-100,0" class="color_3" /> <path d="M400,440 l100,0" class="color_3" /> </g>',
                    '<g id="ladder_3"> <path d="M400,620 l-100,0" class="color_3" /> <path d="M400,620 l100,0" class="color_3" /> <path d="M400,700 l125,0" class="color_3" /> <path d="M400,700 l-125,0" class="color_3" /> </g>',
                    '<g id="Right_strand"> <path d="M525,50 q0,200 -125,210" class="style_strand_1" /> <path d="M400,260 q-125,10 -125,140" class="style_strand_2" /> <path d="M275,400 q0,130 125,140" class="style_strand_1" /> <path d="M400,540 q125,10 125,210" class="style_strand_2" /> </g>',
                    '<g id="Left_strand"> <path d="M275,50 q0,200 125,210" class="style_strand_1" /> <path d="M400,260 q125,10 125,140" class="style_strand_2" /> <path d="M525,400 q0,130 -125,140" class="style_strand_1" /> <path d="M400,540 q-125,10 -125,210" class="style_strand_2" /> </g>',
                    '<g id="Right_strand_overlap"> <path d="M550,50 q0,200 -125,210" class="style_strand_1" /> <path d="M425,260 q-125,10 -125,140" class="style_strand_2" /> <path d="M300,400 q0,130 125,140" class="style_strand_1" /> <path d="M425,540 q125,10 125,210" class="style_strand_2" /> </g>',                    
                    '<g id="Right_strand_overlap"> <path d="M250,50 q0,200 125,210" class="style_strand_1" /> <path d="M375,260 q125,10 125,140" class="style_strand_2" /> <path d="M500,400 q0,130 -125,140" class="style_strand_1" /> <path d="M375,540 q-125,10 -125,210" class="style_strand_2" /> </g>',
                    '<g id="Left_eye"> <ellipse cx="325" cy="400" rx="35" ry="50" style="fill:white;stroke:black;stroke-width:2" /> <circle cx="325" cy="425" r="25" style="fill:black;stroke:black;stroke-width:1" /> <circle cx="320" cy="430" r="8" style="fill:white;stroke:black;stroke-width:1" /> <circle cx="328" cy="438" r="4" style="fill:white;stroke:black;stroke-width:1" /> </g>',
                    '<g id="Right_eye"> <ellipse cx="475" cy="400" rx="35" ry="50" style="fill:white;stroke:black;stroke-width:2" /> <circle cx="475" cy="425" r="25" style="fill:black;stroke:black;stroke-width:1" /> <circle cx="470" cy="430" r="8" style="fill:white;stroke:black;stroke-width:1" /> <circle cx="478" cy="438" r="4" style="fill:white;stroke:black;stroke-width:1" /> </g>',
                    '<g id="Mouth"> <ellipse cx="400" cy="505" rx="35" ry="40" style="fill:black;stroke:black;stroke-width:2" /> </g>',
                    '<g id="Left_eyebrow"> <path stroke-linecap="round" d="M300,330 q30,-30 50,-20" style="fill:none;stroke-width:15;stroke:black" /> </g>',                 
                    '<g id="Right_eyebrow"> <path stroke-linecap="round" d="M500,330 q-30,-30 -50,-20" style="fill:none;stroke-width:15;stroke:black" /> </g>',
                    //'<g id="Left_strand_shadow"> <path stroke-linecap="round" d="M262.5,80 q0,25 7.5,50" class="color_4" /> <path stroke-linecap="round" d="M278,160 q0,0 4,10" class="color_4" /> <path stroke-linecap="round"  d="M262.5,720 q0,-25 7.5,-50" class="color_4" /> <path stroke-linecap="round" d="M278,640 q0,0 4,-10" class="color_4" /> </g>',
                    //'<g id="Right_strand_shadow"> <path stroke-linecap="round"  d="M537.5,80 q0,25 -7.5,50" class="color_4" /> <path stroke-linecap="round" d="M522,160 q0,0 -4,10" class="color_4" /> <path stroke-linecap="round" d="M537.5,720 q0,-25 -7.5,-50" class="color_4" /> <path stroke-linecap="round" d="M522,640 q0,0 -4,-10" class="color_4" /> </g>',
                '</svg>' 
            ));
