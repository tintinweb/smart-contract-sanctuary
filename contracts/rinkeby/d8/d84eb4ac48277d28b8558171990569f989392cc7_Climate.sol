...
contract Climate is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3 * 10**9 * 10**9;
    ...
    string private _name = "Climate Token";
    ...
    address payable public charityAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Charity Address
    ...
    constructor () public {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);  // V2 pancake
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 unitAlloc = contractTokenBalance.div(8);
        uint256 charityAlloc = unitAlloc.mul(3);
        uint256 liquidityAlloc = unitAlloc.mul(5);
        sendToCharity(charityAlloc);
        handleLiquidity(liquidityAlloc);
       
    }
    
    function sendToCharity(uint256 amountToken) private {
    ...
    function handleLiquidity(uint256 amountToken) private {
        uint256 amountToSwap = amountToken.div(2);
        uint256 initialBalance = address(this).balance;
        swapTokensForEth(amountToSwap);
        uint256 newBalance = address(this).balance.sub(initialBalance);
        addLiquidity(amountToSwap, newBalance);
