...
contract PaperPeople is ERC721Enumerable, Ownable, Pausable {
    ...
    uint256 public constant PP_PREMINT = 2;
    uint256 public constant PP_SUPPLY = 10;
    uint256 public constant PP_SUPPLY_PRE = 3;
    uint256 public constant PP_PRICE = 0.04 ether;
    uint256 public constant PP_PRICE_PRE = 0.03 ether;
    uint256 public constant PP_PER_TRANS = 2;
    ...
    constructor(string memory baseTokenURI) ERC721("Paper Men", "PP") {
