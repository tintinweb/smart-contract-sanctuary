...
contract LikoNFT is AvatarNFT {

    constructor() AvatarNFT(0.03 ether, 50, 0, 5, "ipfs://Qmd9gJFaxAZh5SRsxzdErEmwQS2X7kfzpW84zoLL5fJp9S/", "TESTLIK", "LIK") {}
}
...
contract AvatarNFT is ERC721, ERC721Enumerable, Ownable {
        ...
        returns (bool)
    {
        ...
        if (_onlyWhitelisted) // Added by Adiel
        {
            require(addressIsWhitelisted(_address) == true, "User isn't whitelisted"); // Added by Adiel
        }
    ...
    function mint(uint256 _nbTokens) external payable whenSaleStarted whenSaleAllowed(msg.sender) {
        ...
        removeAddressesFromWhitelist(addressToRemove);
    }
    ...
    // From now until the end added by Adiel
    ...
    function addressIsWhitelisted(address _whitelistedAddress) public view returns(bool) {
