...
contract PiggyIDO is ERC20 {
    ...
    uint256 public totalPreSale = 1000*10**9;
    uint256 public totalPreSaleLeft = 1000*10**9;
    
    DAIERC20 public daiERC20;
    uint256 public daiPrice = 50*10**18;
    
    uint256 public maxPurchase = 20*10**9;
    ...
    function buyPiggyIDO(uint256 _amount) public whenNotPaused returns(uint256) {
        ...
        require(daiERC20.allowance(msg.sender, address(this)) >= daiPrice.mul(_amount).div(10**9), "Insuffcient approved USDT");
