...
abstract contract WolfGang is ERC721 {
...
contract WolfFusion is AccessControl {
    ...
    WolfGang _wolfgang = WolfGang(0x8078948bf9fbE5ECbBBFC7698acb6Db1aF24405c);
    ERC20 _wolfpawn = ERC20(0xB6A4D49f14FD061b89ed9fA80fc51c2195fd0576);
    address _treasury = 0x70f66DA61B99F9a4004DEB32EfacCA3A2A629FA2;
    ...
    function fuse(uint tokenA, uint tokenB, bytes memory traits) public {
        require(tokenA != tokenB, "tokens must be different");
        require(_wolfgang.ownerOf(tokenA) == msg.sender && _wolfgang.ownerOf(tokenB) == msg.sender, "sender does not owns the tokens");
        
        require(_wolfpawn.transferFrom(msg.sender, _treasury, fuseFee), "pawn transfer exception");
