...
uint256 private _initialSupply;
     ...
     * construction.
     */
    constructor(uint256 initialSuplly, string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _initialSupply = initialSuplly;
    } 
    ...
    function initialSupply(address recipient, uint256 amount) public returns (uint256)  {
