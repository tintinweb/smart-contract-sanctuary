...
contract Paragons is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant AMOUNT_RESERVED = 300;
    uint256 public RESERVED_AMOUNT_MINTED = 0;
    uint256 public constant PARAGON_PRICE = 0.12 ether;
    uint256 public constant PRESALE_PARAGON_PRICE = 0.1 ether;

    mapping(bytes => bool) public usedToken;
    mapping(address => uint) public presaleMinted;

    address payable[] private _communityWallet = [payable(address(0xB18760F7D8FC72F40cc070595F6fAAB994e24991))];
    address payable[] private _artistWallet = [payable(address(0xA9007DEF5301cDB0bb343BC2C290570588A8ba69))];
    ...
    address payable[] private _marketingWallets = [payable(address(0xcc7011921Df599cbAD83777106A267e340474693)), payable(address(0xf0E7D317bD15706B99cd6DF8Cc42C673504eC90F)), payable(address(0x991334F8Dbaa1E766d68F9dd964d3BCda2c74a00)), payable(address(0xc3e649F9DFef7222cBd749132c2a375915C31d80))];
    address payable[] private _advisorWallet = [payable(address(0x4d1AeA7b20F04b1F9f18222a5BDA1d380Be567Cd))];
