...
contract Unnamed is ERC721, Ownable {
    ...
    constructor() ERC721("Unnamed", "NONE") {
        _tokenIds.increment();
    }

    modifier isMintable() {
        require(mintable, "Unnamed: NFT cannot be minted yet.");
        _;
    }

    modifier isPreSaleMintable() {
        require(preSaleMintable, "Unnamed: NFT cannot be minted yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "Unnamed: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedAvailableSupply(uint256 amount) {
        require(
            ...
            "Unnamed: There are no more remaining NFT's to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficient(uint256 amount) {
        require(
            ...
            "Unnamed: There was not enough/extra ETH transferred to mint an NFT."
        );
        _;
    }
    ...
    modifier isAllowList() {
        require(
            ...
            "Unnamed: You're not on the list for the presale."
        );
        _;
    }
