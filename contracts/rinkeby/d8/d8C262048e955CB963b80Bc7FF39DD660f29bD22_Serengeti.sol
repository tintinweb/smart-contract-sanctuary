...
// Stake Simba Coin to control the LionDAO test
...
contract Serengeti is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 lastTimeStamp;    // Last timestamp that Simba distribution occurred.
    ...
    function updateRewardPerSecond(uint256 _simbaPerSecond) external onlyOwner {
        massUpdatePools();
        simbaPerSecond = _simbaPerSecond;
    }
