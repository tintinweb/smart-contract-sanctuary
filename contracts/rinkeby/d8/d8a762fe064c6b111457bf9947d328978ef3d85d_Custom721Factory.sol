...
contract Custom721Factory {
    Custom721[] public custom721s;
    
    event ContractCreated(address indexed contractAddress, string indexed name);
    ...
    function create(
        ...
        Custom721 custom721 = new Custom721(_maxUsage, _maxNFT,_nftName,_nftSymbol,_url);
        custom721s.push(custom721);
        emit ContractCreated(address(custom721),_nftName);
