...
contract WordClock is ERC721Enumerable, Ownable, ERC165Storage {
    ...
    constructor() payable ERC721("EverybodysIcon", "EBICON") {
    ...
    function svgRaw(uint256 tokenId, uint256 timestamp) public view returns (bytes memory) {
        ...
        // how do we find the right element index?
        ...
        svg.appendSafe(
            abi.encodePacked(
                ...
                "<style>",
                ".base{fill:#504f54;font-family:Monospace;font-size: 36px;}",
                elementClasses,
                "{fill: red}",
                "</style>",
    ...
    function renderRow(uint256 rowNum) internal view returns (bytes memory) {
        ...
        row.appendSafe(
            abi.encodePacked(
                '<text x="18" y="',
                ((rowNum + 1) * 36).toString(),
                '" class="base" method="stretch" lengthAdjust="spacing" textLength="100%">'
            )
        );
        ...
        for (uint256 i = 0; i < 7; i++) {
            row.appendSafe(
                abi.encodePacked(
                    '<tspan class="',
                    abi.encodePacked("el", rowNum.toString(), i.toString()),
                    '" lengthAdjust="spacing" textLength="28em">',
                    rowLabels[i],
                    "</tspan>"
                )
            );
    ...
    function animationUrl(uint256 tokenId) internal view returns (string memory) {
        return "ipfs://";
    }
