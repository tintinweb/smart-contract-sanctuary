...
import "./interfaces/IHornToken.sol";
    ...
    Ownable
{
    ...
    uint256 public constant PRIVATE_SALE = 800;
    uint256 public constant BLESSED_SALE = 800;
    ...
    // uint256 public constant PRIVATE_SALE_OPEN = 1631404800; // Sunday, 12 September 2021 00:00:00
    // uint256 public constant BLESSED_SALE_OPEN = 1631491200; // Monday, 13 September 2021 00:00:00
    // uint256 public constant PUBLIC_SALE_OPEN = 1631577600; // Tuesday, 14 September 2021 00:00:00
    uint256 public constant PRIVATE_SALE_OPEN = 0; // For testing only
    uint256 public constant BLESSED_SALE_OPEN = 0; // For testing only
    uint256 public constant PUBLIC_SALE_OPEN = 0; // For testing only
    bytes32 public constant TREASURY_ROLE = keccak256("TREASURY_ROLE");
    string public PROVENANCE_HASH = "";

    IBreedManager public BREED_MANAGER;
    ICandyToken public CANDY_TOKEN;
    IHornToken public HORN_TOKEN;
    ...
    function mint(uint256 _quantity) public payable whenNotPaused {
        require(
            ...
            "UninterestedUnicorns: Quantity must be lesser than MAX_SUPPLY = 6900"
        );
        require(
            _quantity > 0,
        ...
        require(
            ...
            "UninterestedUnicorns: Public Sale opens on 14th Sept 2021 00:00 UTC"
        );
    ...
    function privateMint() public payable whenNotPaused {
        ...
        require(
            ...
            "UninterestedUnicorns: Private Sale opens on 12th Sept 2021 00:00 UTC"
        );
        require(
            block.timestamp <= PRIVATE_SALE_OPEN.add(1 days),
            "UninterestedUnicorns: Private Sale is Closed!"
        );
        require(
    ...
    /// @dev Private Sale mint
    function blessedMint() public payable whenNotPaused {
        require(
            totalSupply().add(1) <= MAX_SUPPLY - RESERVED,
            "UninterestedUnicorns: Quantity must be lesser than MAX_SUPPLY = 6900"
        );
        ...
        require(
            block.timestamp >= BLESSED_SALE_OPEN,
            "UninterestedUnicorns: Blessed Sale opens on 13th Sept 2021 00:00 UTC"
        );
        require(
            block.timestamp <= BLESSED_SALE_OPEN.add(1 days),
    ...
    /// @dev Reserve mint
    function reserveMint(uint256 _quantity)
        public
        payable
        whenNotPaused
        onlyTreasury
...
interface IHornToken is IERC20 {
    function sacrifice(address _to) external;
}
