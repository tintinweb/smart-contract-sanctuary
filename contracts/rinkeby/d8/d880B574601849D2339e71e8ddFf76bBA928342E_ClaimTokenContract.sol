...
contract ClaimTokenContract is controllerPanel {
    ...
    constructor(
        IERC721Enumerable _giveAwayToken, // 0x01ba93514e5eb642ec63e95ef7787b0edd403add
        IERC721Enumerable _checkToken, // 0xdda2ea1cef44c206818161e7876f7277bd39a99c
        address _vault
    ) {
    ...
    function getTokenID(uint256 _tokenID) public view returns (uint256) {
        return giveAwayToken.tokenOfOwnerByIndex(vault, _tokenID);
    }
    ...
    function claim(uint256 _tokenID) external {
        ...
        uint256 _tokenId = giveAwayToken.tokenOfOwnerByIndex(vault, 0);
