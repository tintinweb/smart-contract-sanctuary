...
contract AztecArmy is ERC721, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _tokenPrice, uint256 _maxTokens, uint _presaleTimestamp, uint _saleTimestamp, string memory _baseUri) ERC721(_name, _symbol) {
    ...
    function tokenURI(uint256 _tokenID) override public view returns (string memory) {
        require(_tokenID > 0 && _tokenID <= maxTokens, "query for nonexistent token");
