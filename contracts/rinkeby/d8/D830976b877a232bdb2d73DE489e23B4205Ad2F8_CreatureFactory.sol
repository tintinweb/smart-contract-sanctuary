...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    uint256 public pricePerLootBox = 80000000000000000;
    ...
    function name() override external pure returns (string memory) {
        return "Banana Creature Item Sale";
    }
    ...
    // buy and mint lootbox in one atomit transation
    function buyAndMintLootBox() public payable {
        require(msg.value == pricePerLootBox, 'Min price not met');
        _mint(LOOTBOX_OPTION, msg.sender);
    }
    ...
    function _mint(uint256 _optionId, address _toAddress) internal {
