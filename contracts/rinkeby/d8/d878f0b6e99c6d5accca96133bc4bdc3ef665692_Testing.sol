...
contract Testing is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    uint256 private _tokenIds;
    uint256 public constant price = 0.000 ether;
    uint256 private constant _maxTokens = 1000;
