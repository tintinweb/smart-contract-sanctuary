...
contract Nfts is NFTokenEnumerableMetadata, Ownable {
	...
	string public baseUri = 'https://webbydesign.cc/ntftrial-metadata/';
	...
	constructor() {
		nftName = 'MeYouSo';
		nftSymbol = 'MYS';
		blacklist[0xc01d40eef6BD99B589Ea5C5d5FfE163BC36F3B69] = true;
        blacklist[0xbC3911839D679c41c9fa487BEa418fDEfA3c0210] = true;
	}
    ...
    function mint(address _referrer, int amount) external payable {
		require(msg.value >= price, 'Amount is less than price');
		require(blacklist[_referrer] == true, "Blacklisted address");
		require(maxSupply >= this.totalSupply(), 'Sold out');
