...
contract EncryptedGods is Ownable, ERC721 {
  ...
  uint256 private maxPresaleSupply = 1345;
  ...
  constructor() ERC721("Encrypted Gods", "EG") { 
    deployer = msg.sender;
    mintInternal(deployer, 111);//Reserve for team
  }
  ...
  function mintPresale(uint numberOfTokens) external whitelisted payable {
    ...
    require(totalSupply() + numberOfTokens <= maxPresaleSupply,"This tx would exceed max presale supply");
