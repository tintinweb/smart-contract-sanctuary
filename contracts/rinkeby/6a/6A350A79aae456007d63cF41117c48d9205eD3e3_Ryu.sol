...
contract Ryu is ERC721, Ownable {
    ...
    uint256 public constant RYU_GIFT = 100;
    uint256 public constant RYU_PRIVATE = 1000;
    uint256 public constant RYU_PUBLIC = 8900;
    uint256 public constant RYU_MAX = RYU_GIFT + RYU_PRIVATE + RYU_PUBLIC;

    uint256 public constant RYU_PRICE = 0.1 ether;
    ...
    address private member1 = 0xF41D419b73AC92f0f2C2135e798879CE9AB24B63; // TEST WALLET
    ...
    constructor() ERC721("Ryu", "RYU") {
        for (uint256 i = 0; i < 2; i++) {
            _safeMint(member1, totalSupply + i);
        }
    }
    ...
    function mint(uint256 tokenQuantity) external payable {
        require(tokenQuantity > 0, "0_TOKEN_QUANTITY");
    ...
    function withdraw() external {
        ...
        // payable(member5).transfer(address(this).currentBalance / 2);
    }
