...
contract BlockStars is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    constructor (string memory name, string memory symbol) ERC721(name, symbol){
        ...
        require( tempName.length != 0 && tempSymbol.length != 0,
            "ERC721: Choose a name and symbol");
    ...
    function safeMint(address _to, string memory _uri) public onlyRole(MINTER_ROLE)  whenNotPaused returns(uint256) {
