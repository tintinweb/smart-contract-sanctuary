...
// TODO replace our custom contracts with interface to reduce overall contract size;
...
contract ClaimSyndicateLeader is Pausable, Ownable {
    TheLostGlitches public tlg;
    DeepSkyNetwork public dsn;
    Syndicates public syndicates;
    mapping(uint256 => bool) public hasClaimed;

    constructor(address _tlg, address _dsn, address _syn) {
    ...
    function claim(
        ...
        require(hasClaimed[glitch] == false, "AlreadyClaimed");

        uint256 syndicate = syndicates.syndicate(glitch);
        require(syndicate != 0, "NotInSyndicate");
        require(1 <= syndicate && syndicate <= 5, "InvalidSyndicate");
...
contract Syndicates {
    ...
    // function joinFifthSyndicate(uint256 _glitch){}
