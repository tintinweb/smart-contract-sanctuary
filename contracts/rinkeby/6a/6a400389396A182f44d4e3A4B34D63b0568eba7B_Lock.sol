...
contract Lock is BaseGovernanceWithUserUpgradable, ERC721Upgradeable {
        ...
        initializer 
    {
        ...
        __Lock_init(
            _schedule, _depositManager, _splitManager, _tokenERC20,
            _canAddBeneficiaries, _canRemoveBeneficiaries,
            _data, _lockedAmount
        );
    }
        ...
        initializer 
    {
        ...
        _initializeBeneficiaries(_data, _lockedAmount);
    }

    function _initializeBeneficiaries(bytes calldata _data,  uint _lockedAmount) internal initializer {
    ...
    function split(uint originId, uint[] memory splitParts, address[] memory addresses, bytes calldata ownershipProof) external {
        ...
        require(_success, "ERROR: You are not the owner or are approved for this NFT");
        uint[] memory newIDs = depositManager.split(_ID, splitParts, addresses);
