        ...
        if (supply < 0) {
            ...
            output = string(abi.encodePacked(
                ...
                '<svg preserveAspectRatio="xMinYMin meet" viewBox="0 0 800 800" ',  
                    ...
                    '<style>                   .color_1{stop-color:rgb(255,0,255);stop-opacity:1}',
                        '.color_2{stop-color:rgb(0,0,255);stop-opacity:1}',
                        '.color_3{fill:none;stroke-width:25;stroke:rgb(0,0,255)}',
                        '.color_4{fill:none;stroke-width:18;stroke:rgb(222, 124, 231)}',
                    '</style>',
            ...
            output = string(abi.encodePacked(
                output,
                    '<g id="Left_strand_shadow">',
                        ...
                        'd="M262.5,80 q0,25 7.5,50" class="color_4" />',
                        
                        '<path stroke-linecap="round" ',
                        'd="M278,160 q0,0 4,10" class="color_4" />',

                        '<path stroke-linecap="round" ',
                        'd="M262.5,720 q0,-25 7.5,-50" class="color_4" />',
                                
                        '<path stroke-linecap="round" ',
                        'd="M278,640 q0,0 4,-10" class="color_4" />',
                    '</g>'
            ));
            ...
            output = string(abi.encodePacked(
                output, 
                    '<g id="Right_strand_shadow">',
                        '<path stroke-linecap="round" ',
                        'd="M537.5,80 q0,25 -7.5,50" class="color_4" />',
                        
                        '<path stroke-linecap="round" ',
                        'd="M522,160 q0,0 -4,10" class="color_4" />',

                        '<path stroke-linecap="round" ',
                        'd="M537.5,720 q0,-25 -7.5,-50" class="color_4" />',
                                
                        '<path stroke-linecap="round" ',
                        'd="M522,640 q0,0 -4,-10" class="color_4" />',
                    '</g>'
            ));
