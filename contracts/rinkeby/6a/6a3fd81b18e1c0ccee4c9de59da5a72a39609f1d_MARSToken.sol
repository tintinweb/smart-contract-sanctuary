...
contract MARSToken is owned, Minter {
    ...
    string constant private _name = "MARS Token";
    string constant private _symbol = "MARS";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply = 8000000 * (10**_decimals);         //8M
    uint256 immutable public maxSupply = 50000000 * (10**_decimals);    //50M
