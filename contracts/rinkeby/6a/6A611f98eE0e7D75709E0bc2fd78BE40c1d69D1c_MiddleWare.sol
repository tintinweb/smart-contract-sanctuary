...
contract MiddleWare{
    ...
    function getGtokenInfoList(address comptrollerAddress, address userAddress) public{
        ...
        for(uint i=0; i<getAllMarkets.length; i++){
            ...
            if(userAddress != address(0)){
                userInfo = getUserInfo(gToken, userAddress);
            }
    ...
    function getUserInfo(GToken gToken, address userAddress) public returns(UserInfo memory){
        ...
        userInfo.underlyingBalance = underlyingBalance;
        userInfo.accountBalance = accountBalance;
