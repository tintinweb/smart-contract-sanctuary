...
/**
    !Disclaimer!
    Predep will not be liable in any way for the use 
    of the code. That being said, the code has been tested 
    to the best of the developers' knowledge to work as intended.
    This code has been thoroughly tested on both testnet AND mainnet
    to ensure maximum safety, efficiency and functionality.
*/
...
contract SMSFINALT2 is ERC721Enumerable, Ownable, nonReentrant {
  using Strings for uint256;
