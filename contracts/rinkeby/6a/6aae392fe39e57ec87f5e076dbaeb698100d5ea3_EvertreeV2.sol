    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        lockFundsInternal(0x77DaD28f302EBD245f15480Be38037197cC4135d, toLock);
        lockFundsInternal(0x479D80a319df59814Fa45e08817798ff96273607, toLock);
       lockFundsInternal(0x2264D2D5E550A5521681fB093aaCE0Ff73C22C41, toLock);
    ...
    function lockFundsInternal(address _addr, uint256 amount) private onlyOwnerOrCTO
    {
        lockFunds(_addr, amount);
    }
...
function lockFunds(address _addr, uint256 toLock) private returns (bool) {
