    ...
    PausableUpgradeable
{
    ...
    function stake(
        ...
        emit Staked(_msgSender(), _nftAdr, _nftId, _duration);
    }
    ...
    function withdraw(uint256 _stakeId) external whenNotPaused {
        ...
        Stake memory userStake = stakeOf[_msgSender()][_stakeId];
        require(block.timestamp >= userStake.end, "Withdraw: too soon");
