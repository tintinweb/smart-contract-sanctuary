...
contract PeacefulToadz is ERC721, Ownable {
  ...
  //Actions
    ...
    constructor(string memory _name, string memory _symbol,string memory _initBaseURI,string memory _initcontractURI,address _initProxyAddress,bytes32 _merkleRoot,address _token1address, address _token2address) ERC721(_name, _symbol) {   
  ...
  // public
    ...
    function holderSaleMint(uint _mintAmount) external payable{
        ...
        require(holderMaxMintAmount >= holderSaleRemaining[msg.sender]+_mintAmount,"You are exceed maximum mint amount");
        ...
        require(holderSaleRemaining[msg.sender]-_mintAmount>=0,"You're exceeding registered amount");
    ...
    function publicSaleMint(uint _mintAmount) external payable {
        ...
        require(publicMaxMintAmount >= _mintAmount,"You are exceed maximum mint amount");
        require(publicMaxMintAmount >= publicSaleRemaining[msg.sender]+_mintAmount,"You are exceed maximum mint amount");
