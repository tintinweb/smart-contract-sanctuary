...
contract testg {
    ...
    string internal nftName = "testgg";
    string internal nftSymbol = "8888";
    ...
    function draw(uint id) public view returns (string memory) {
        ...
        if (idToSymbolScheme[id] == 0) {
            ...
            symbols = 0x313831342E2E2E2E2E2E; // ░┼≡
        } else {
    ...
    function feelingLuckyColor(uint id) public {
        ...
        if (idToSymbolScheme[id] == 1) {
            symbolToUpdate = (seed % 2) + 1;
        }
        else if (idToSymbolScheme[id] == 2) {
            symbolToUpdate = (seed % 2) + 3;
        }
        else if (idToSymbolScheme[id] == 3) {
            symbolToUpdate = (seed % 3) + 1;
            if (symbolToUpdate == 3) {
                symbolToUpdate = 5;
            }
        }
    ...
    function checkValidSymbol(uint id, uint symbolToCheck) public view returns (bool isValid){
        ...
        if (idToSymbolScheme[id] == 1) {
            if (symbolToCheck == 1 || symbolToCheck == 2) {
                isValid = true;
            }
        }
        else if (idToSymbolScheme[id] == 2) {
            if (symbolToCheck == 3 || symbolToCheck == 4) {
                isValid = true;
            }
        }
        else if (idToSymbolScheme[id] == 3) {
            if (symbolToCheck == 1 || symbolToCheck == 2 || symbolToCheck == 5) {
                isValid = true;
            }
        }
        else if (idToSymbolScheme[id] == 4) {
            if (symbolToCheck == 1 || symbolToCheck == 6 || symbolToCheck == 7) {
                isValid = true;
            }
        }
        else if (idToSymbolScheme[id] == 5) {
            if (symbolToCheck == 1 || symbolToCheck == 4 || symbolToCheck == 8) {
                isValid = true;
            }
        } 
        else {
            if (symbolToCheck == 1 || symbolToCheck == 2 || symbolToCheck == 3 || symbolToCheck == 4 || symbolToCheck == 5) {
                isValid = true;
            }
        } 
    }
