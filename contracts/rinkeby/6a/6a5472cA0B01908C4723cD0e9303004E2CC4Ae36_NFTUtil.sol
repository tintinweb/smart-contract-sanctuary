...
contract DIADataNFT is Ownable, ERC1155 {
	...
	constructor(address _paymentToken, uint256 _burnAmount, uint256 _mintingPoolAmount, address _mintingPool, address _DIAGenesisMinterAddr, bytes memory metadataURI) ERC1155(string(abi.encodePacked(metadataURI, "{id}.json"))) {
