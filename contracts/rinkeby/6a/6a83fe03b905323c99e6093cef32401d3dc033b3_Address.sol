...
// File @openzeppelin/contracts/token/ERC721/[email protected]v4.2.0
...
contract CampfireBearClub is ERC721Enumerable, Ownable {
  ...
  // There will only be 8500 bears available.
  uint256 public constant maxBears = 8500;

  // There will only be 500 bears available in presale.
  uint256 public constant bearPresale = 500;

  // Presale price is 0.05 ETH to mint.
