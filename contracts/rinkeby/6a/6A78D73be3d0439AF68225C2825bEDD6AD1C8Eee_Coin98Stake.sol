...
contract Coin98Stake is ERC721Enumerable, Ownable {
    ...
    */
     ...
     */
    function getStakedByTokenId(uint256 _tokenId) public view returns (uint256) {
        ...
        if(!stakeInfo.flag || (timeStaked < locked_time)){
            ...
            uint256 amountProfitBySeconds = stakeInfo.amount.mul(calRate).div(Percent).div(yearTimestamp);
