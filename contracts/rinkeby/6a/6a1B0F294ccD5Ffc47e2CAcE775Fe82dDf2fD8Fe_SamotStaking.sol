...
contract SamotStaking is Ownable, IERC721Receiver, ReentrancyGuard, Pausable {
    ...
    function numberStaked(address _address)
        public
        view
    ...
    function claimedDrop(address _address)
        public
        view
        returns (bool _claimedDrop)
    {
        return hasClaimedDrop[_address];
    }

    function restaBlocks() public view returns (uint256 blocks) {
