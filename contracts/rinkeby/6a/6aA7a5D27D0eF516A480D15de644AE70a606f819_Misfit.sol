...
// import "hardhat/console.sol"; //take out in prod?
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol";

contract Misfit is Initializable, ERC721EnumerableUpgradeable, OwnableUpgradeable,EIP712Upgradeable,UUPSUpgradeable {
    ...
    function initialize(uint256 maxSupply_,address payable wallet_) public initializer {
        maxSupply = maxSupply_;
        wallet = wallet_;
        __ERC721_init("Misfit","MFT");
        __EIP712_init("Misfit-Voucher", "1");
        __Ownable_init();
    ...
    function withdraw(uint256 amount) external onlyOwner {
        AddressUpgradeable.sendValue(wallet, amount);
    }
