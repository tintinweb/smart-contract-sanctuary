...
contract Octoplush is ERC721, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;
    using SafeMath for uint256;

    string private _baseURIPrefix;

    uint256 private constant maxTokensPerTransaction = 8;
    uint256 private tokenPrice = 60000000000000000; //0.06 ETH
    uint256 public constant nftsNumber = 8888;
    uint256 private constant nftsPublicNumber = 8838; // 50 for giveaways and promotions

    Counters.Counter private _tokenIdCounter;

    event Giveaway(address to, uint256 tokensNumber);

    constructor() ERC721("Octoplushv1", "OCTO") {
