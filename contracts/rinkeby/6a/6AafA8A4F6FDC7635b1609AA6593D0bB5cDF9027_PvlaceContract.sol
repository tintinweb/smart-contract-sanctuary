...
//when publishing set:
// provenance, owner payment contract, sale start timestamp, time LENGTH (seconds in day * 10) metadata link, correct name & symbol
// make sure tokens burn after 10 days!!!!!!
...
contract PvlaceContract is ERC721, Ownable {
    ...
    constructor() public ERC721("PVLACE NFTtest", "PT") {
        _setBaseURI(
