...
contract MetaWolves is ERC721Enumerable {
    ...
    constructor () ERC721("MetaWolves", "MWL") {
        ...
        mintLimits.push(MintLimit(0, uint32(maxSupply), 215));
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, tokenId.toString())) : "ipfs://bafkreig7vzyp6q4gqxcfdq26s3qb3lufk7c4rktvjgfu4t7jsi2hmxmkoq";
    }
