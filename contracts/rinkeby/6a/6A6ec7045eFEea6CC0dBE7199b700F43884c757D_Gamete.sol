...
contract Gamete is ERC721, Ownable {
    ...
    constructor(string memory baseURI, uint[] memory itemIds, uint[] memory numRemaining, address payable addr) ERC721("Gamete","GAMETE")  {
        ...
        //     itemCounts[10]++;
        //     nthOfItem[tokenId] = itemCounts[10];
        //     tokenIdToItemId[tokenId] = 10;
        //     numOfItemsRemaining[10]--;   
        //     _safeMint(msg.sender, tokenId);
        // }
    }

    function mint(uint itemId) external payable {
        require(msg.value >= calculatePrice(itemId), "Insufficient ether sent");
