...
contract StablePriceOracle is Ownable, PriceOracle {
    ...
    function price(string calldata name, uint duration) external view override returns(uint) {
     ...
     *                    in base price units, equal to one attoeth (1e-18
     *                    dollar) each.
     *                    In simple terms, this is per second price is ETH (wei). 
     */
