...
contract Factory is AccessControl {
    ...
    function createCollection(
        ...
        Collection collection =
            new Collection(uri, _total, _startTime, _endTime, _amount, _percent, _admin, _facAddress);
    ...
    function giveRole(address _farmAddress, address _collec) public{
        Ifarm = FarmV2(_farmAddress);
        Ifarm.grantRole(COLLECTION_ROLE, _collec);
    
    }

    function transferFarmAdmin(address _farmAddress) external onlyRole(DEFAULT_ADMIN_ROLE){
        Ifarm = FarmV2(_farmAddress);
        Ifarm.grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
    }
...
contract FarmV2 is AccessControl{
    ...
    function sell(uint256 stones, address from, address to) public {
        ...
        require(hasRole(COLLECTION_ROLE, msg.sender) || (from == msg.sender), "you are not authorized on this account!");
...
contract MoneyHandler is Context,Ownable {
   ...
   // uint256 public amu = 1;
     ...
     */
    function release(address account) private  {
