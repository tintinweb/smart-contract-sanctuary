...
contract DNAContract is ERC721Enumerable, Ownable {
    ...
    uint256 constant private DNA_LENGTH = 4;
    ...
    function EyeType(uint256 Idx) public view returns (string memory) {
        ...
        if (Idx == 0) {
            ...
            eyeString = string(abi.encodePacked(        
                eyeString, 
                '<g id="Left_eye">',
                    '<path d="M278,420 l0,-20 a1,1 0 0,1 94,0 l0,20 a10,1 0 0,1 -94,0"', 
                    'style="fill:rgb(40,40,40);stroke:rgb(40,40,40);stroke-width:1" />',
                    '<ellipse cx="335" cy="400" rx="40" ry="25"  style="fill:rgb(120,120,120);stroke:rgb(120,120,120);stroke-width:1" />',
                    '<path d="M275,420 l0,-20 a1,1 0 0,1 100,0 l0,20 a10,1 0 0,1 -100,0"',
                    'style="fill:none;stroke:rgb(230,230,255);stroke-width:6" />',      
            ...
            eyeString = string(abi.encodePacked(
                eyeString,
                '<g id="Right_eye">',
                    '<path d="M428,420 l0,-20 a1,1 0 0,1 94,0 l0,20 a10,1 0 0,1 -94,0"', 
                    'style="fill:rgb(40,40,40);stroke:rgb(40,40,40);stroke-width:1" />',
                    '<ellipse cx="485" cy="400" rx="40" ry="25"  style="fill:rgb(120,120,120);stroke:rgb(120,120,120);stroke-width:1" />',
                    '<path d="M425,420 l0,-20 a1,1 0 0,1 100,0 l0,20 a10,1 0 0,1 -100,0"',
                    'style="fill:none;stroke:rgb(230,230,255);stroke-width:6" />',
    ...
    function generateDNAarray(uint256 tokenId) public view returns (uint256[] memory) {
        string memory tokenIdStr = tokenId.toString();
        uint256[] memory neucleotideIdxArray = new uint[](4);
        uint256 startNeucleotideIdx = seededRandom(tokenIdStr, "0") % neucleotideComb.length;
        ...
        if (supply < 0) {
            ...
            output = string(abi.encodePacked(
                output, 
                    '<style>',
                        '.corneaColor{fill:#', 
                        CorneaColor[1],              // taking first element of dna for first color
                        ';stroke:#',
                        CorneaColor[0],              // taking first element of dna for first color
                        '; stroke-width:2}'
                        '.pupilColor{fill:#', 
                        PupilColor[2],              // taking first element of dna for first color
                        ';stroke:#',
                        PupilColor[0],              // taking first element of dna for first color
                        '; stroke-width:1}',                       
                    '</style>'
            ));
            ...
            string memory eyeTypeString = EyeType(0);
            output = string(abi.encodePacked(
                output, 
                eyeTypeString
            ));
