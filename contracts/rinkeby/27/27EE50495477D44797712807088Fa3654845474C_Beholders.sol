...
contract Beholders is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function ownerMint(uint256 _count) external payable nonReentrant onlyOwner returns (uint256, uint256) {
    ...
    function mintPublicSale() external payable nonReentrant returns (uint256, uint256) {
    ...
    constructor() ERC721("Beholds", "BEHOLDERS") Ownable() {}
}
