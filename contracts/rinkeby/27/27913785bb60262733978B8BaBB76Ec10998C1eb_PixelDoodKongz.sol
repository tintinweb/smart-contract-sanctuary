...
contract PixelDoodKongz is ERC721, Ownable {
    ...
    uint256 public maxFreeSupply = 10;
    uint256 public mintPrice = 30000000000000000; // 0.03 ETH
    uint256 public maxMintPerTransaction = 8;

    string public _baseTokenURI;
    address public secondWallet = 0xae2e23D8d2a817464e4c89F89ccE616dE4518b8F;

    // constructor
    constructor(string memory _initialBaseUri) ERC721("Pixel Dood Kong", "PDK") {
    ...
    function freeMint(uint256 numberOfTokens) external {
        ...
        require(supply + numberOfTokens <= maxFreeSupply, "Not enough free mints remaining");
