...
contract OwnerfyContract3 is Context, AccessControlEnumerable, ERC1155Burnable {
  ...
  // CIDs
     ...
     */
    function mint(address to, uint256 id, uint256 amount, bytes memory data, bytes32 cid, string calldata _update) public virtual {
     ...
     */
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data, bytes32[] memory _cids, string[] calldata updates) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "Ownerfy: must have minter role to mint");
    ...
    function uri(uint256 _id) public view virtual override returns (string memory) {
      ...
      return string(abi.encodePacked('https://gateway.pinata.cloud/ipfs/', bytes32ToString(cids[_id])));
    }
