...
contract Election {
    ...
    event Voted(uint indexed issueId, address voter, uint indexed option);
    ...
    function close() public onlyAmin {
    ...
    function vote(uint option) public  {
        ...
        emit Voted(_issueId, msg.sender, option);
    }
