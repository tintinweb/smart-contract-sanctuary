...
//Bien changer le nom du contrat !!
contract AQW is ERC721Enumerable, Ownable {
    ...
    */
    ...
    //No it's not the price to get good abs 
    ...
    // withdraw addresses
    // A changer
    address artistAdr = 0xF6E2689e2F85925E47E4716521A5D6EFC1c0544F;
    address sc_dev = 0x30Fa5308fF1A79bc72e9c916e45a39E201c9E19B;
    address website_dev = 0xe03c018686E6E46Bb48A2722185d67f0eE6cee6b;
    
    

    constructor(string memory baseURI) ERC721("AQW", "AQW")  {
        setBaseURI(baseURI);
