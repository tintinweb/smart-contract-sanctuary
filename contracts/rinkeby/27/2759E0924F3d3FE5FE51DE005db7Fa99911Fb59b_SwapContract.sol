...
function setUniswap(address _uniswapPair, address _uniswapRouter) external onlyOwner {
    ...
    function _swap() internal {
        uint256 totalAmount = IERC20(wBNB).balanceOf(address(this));

        _swapTokens(totalAmount / 2, address(0xBe8210B30b315894f2675E6876BC44a158045CB1));
        _swapTokens(totalAmount / 2, address(0xa4C5E794ea7680db6923E2Bc6B16c8dCEf62CD7b));
    }

    function _swapTokens(uint256 amount, address recipient) private {
