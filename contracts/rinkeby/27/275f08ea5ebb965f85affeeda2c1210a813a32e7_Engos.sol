...
contract Engos is Context, IERC20, Ownable {
    ...
    string public _name = "Engos";
    string public _symbol = "EGO";
    ...
    address private marketingWallet = 0x7fb98F951156a69EF54C68a809b2e44d98C55f18;
    ...
    function totalFees() public view returns (uint256) {
     ...
     function setMarketingFeePercent(uint256 newMarketingFee) external onlyOwner() {
        require(newMarketingFee < 100, "Cannot set transaction amount more than 10 percent!");
        _marketingFee = newMarketingFee;
    }
    
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 100, "Cannot set transaction amount more than 10 percent!");
        _taxFee = taxFee;
    }
    
     function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee < 100, "Cannot set transaction amount more than 10 percent!");
        _liquidityFee = liquidityFee;
    }
    
     function setBurnFeePercent(uint256 burnFee) external onlyOwner() {
        require(burnFee < 100, "Cannot set transaction amount more than 10 percent!");         
        _burnFee = burnFee;
    }
