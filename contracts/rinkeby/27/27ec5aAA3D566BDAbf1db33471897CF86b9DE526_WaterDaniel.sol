...
contract WaterDaniel is ERC20, ERC20Burnable, AccessControl {
    ...
    constructor(
        ...
        address _team,
        uint256 _teamTax
    ) ERC20("WaterDaniel", "WATER DANIEL IS A TOKEN MADE BY MY AUTISTIC 7 YEAR OLD BROTHER") {
        treasury = _treasury;
        ...
        _mint(
            0x20460b42776dbE80315a31aAA7F0459c915440b5, //set to deployment wallet
            100000 * (10**uint256(18))
        );
