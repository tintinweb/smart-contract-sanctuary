...
contract WeirdDonuts is ERC721Enumerable, Ownable {
    ...
    constructor(string memory theBaseURI, address theOwner1, uint numToken, bool debug) ERC721("WeirdDonuts", "WEIRDDONUT")  {
    ...
    function mintHeads(uint _count) public payable saleIsOpen notPaused notRevealed {
        require(_count > 0, "You can't mint 0 WeirdDonuts");
    ...
    function contractURI() public pure returns (string memory) {
        return "www.weirddonuts.vercel.app/contract-info.json";
    }
