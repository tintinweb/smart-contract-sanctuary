...
contract ParrotsNFT is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    string private baseURI = "ipfs://QmSR1fPBGvJDAcuH74NdDMatrWMYnFk3A3r6MZznVCbLQ7/";
    string public baseExtension = ".json";
    string public notRevealedUri;
    uint256 public preSaleCost = 0.08 ether;
    uint256 public cost = 0.1 ether;
    uint256 public maxSupply = 5555;
    uint256 public maxMintAmountPresale = 500;
    uint256 public maxMintAmount = 5555;
    uint256 public nftPerAddressLimitPresale = 1;
    uint256 public nftPerAddressLimit = 3;
    uint256 public preSaleDate = 1640188200;
    uint256 public preSaleEndDate = 1640189400;
    uint256 public publicSaleDate = 1640189400;
    ...
    constructor(string memory _name, string memory _symbol, string memory _initNotRevealedUri, address[] memory payees, uint256[] memory shares_) ERC721(_name, _symbol) PaymentSplitter(payees, shares_) payable {
    ...
    function mint(uint256 _mintAmount) public payable notPaused saleStarted minimumMintAmount(_mintAmount) {
        ...
        block.timestamp < publicSaleDate ? presaleValidations(ownerMintedCount, _mintAmount) : publicsaleValidations(ownerMintedCount, _mintAmount);
