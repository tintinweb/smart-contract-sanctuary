...
contract SmokyHeads is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    event TokenMinttedSusseccfully(string _value, uint256 indexed _id);
...
//    }
    ...
    function setPermanentURI(string memory tokenUri, uint256 tokenId) public onlyOwner {
