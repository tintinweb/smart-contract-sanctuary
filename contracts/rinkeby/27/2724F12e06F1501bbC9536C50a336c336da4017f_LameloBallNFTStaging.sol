...
contract LameloBallNFTStaging is ECNFT {
    ...
    constructor() ECNFT(
        ...
        setDataFolder("https://lameloball.io/staging/");
    ...
    function mintExactTokenId(uint256 _newItemId) public onlyOwner returns (uint256) {
