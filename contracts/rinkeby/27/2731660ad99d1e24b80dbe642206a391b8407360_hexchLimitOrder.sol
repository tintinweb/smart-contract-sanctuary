...
contract hexchLimitOrder {
    ...
    constructor() public {
        ...
        //test
        factoryMap[0x184ecf6e573d15F6461BfCe98C9B14F9Ed8542be] = hex'7225d8c5df340bf38a5ae645e17c28f5044e46a8e8186f399800f5582eb585be';

        factoryFeeMap[0x184ecf6e573d15F6461BfCe98C9B14F9Ed8542be] = 9970;
        defaultFactory = 0x184ecf6e573d15F6461BfCe98C9B14F9Ed8542be;
    ...
    function addOrderWithFactory(address factory, address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOut) public {

    }

    function addOrder(address tokenIn, address tokenOut, uint256 amountIn, uint256 amountOut) public {
    }
    ...
    function execOrder(bytes32 hash) public {
    }
    function execOrderWithFactory(bytes32 hash, address factory) public {
    }


    function execOrderWithProxy(bytes32 hash, address router, bytes memory data) public {
    }
