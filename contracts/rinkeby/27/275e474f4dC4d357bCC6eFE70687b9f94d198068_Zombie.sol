...
contract Zombie is ERC721Enumerable, IERC721Receiver, Ownable {
    using EnumerableSet for EnumerableSet.UintSet;

    IERC721 CONTROL = IERC721(address(this));
    IERC20 TOKEN = IERC20(0x49CAaEdf8651d9C2da40401C1652b5FaD1EaaD35);
    ...
    constructor() ERC721("Zombie", "ZBS") {
        baseTokenURI = "https://ipfs/";
    ...
    function mint(uint256 _mintAmount) external payable {
        ...
        require(_mintAmount <= maxTokensPurchase, "Mint limit exceeded.");
        require(msg.value >= price * _mintAmount);
        require(
            total + _mintAmount <= MAX_TOKEN_SUPPLY,
    ...
    function claimRewards() public {
        ...
        if (rewards > 0) {
            try TOKEN.transfer(msg.sender, rewards) returns (
                bool v
