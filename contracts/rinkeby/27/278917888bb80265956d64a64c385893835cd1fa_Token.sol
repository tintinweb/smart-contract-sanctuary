...
// @title Token contract - Implements Standard ERC20 Token for TJX project.
/// @author Zerion - <[email protected]>
contract TestTJXToken is Token {

	/// TOKEN META DATA
	string constant public name = 'TestTJX';
	string constant public symbol = 'TjX';
	...
	address public investorsAllocation = address(0x27b392248Db0E21dBa18eFA3f081FCd64095A075);
	...
	address public overdraftAllocation = address(0x74bd0fda9cD18E01A03d7250D8fab53D034E1783);
	...
	uint256 public overdraftCliff = 5 * 30 minutes;
	uint256 public overdraftPeriodLength = 30 minutes;
	...
	address public teamAllocation  = address(0x92C39fA4FA5a0B81a3B8aFa30ff8a4951e1256E1);
	...
	uint256 public teamPeriodLength = 3 * 30 minutes;
	...
	address public communityAllocation  = address(0xB2C3c9de0E81C3FB83883A4C599Bcdf3609130Ee);
	...
	uint256 public communityPeriodLength = 3 * 30 minutes;
	...
	address public advisersAllocation  = address(0x4dC5Ff3dF5041A348D8FBF9fF554267BC0d7d40a);
	...
	uint256 public advisersPeriodLength = 30 minutes;
