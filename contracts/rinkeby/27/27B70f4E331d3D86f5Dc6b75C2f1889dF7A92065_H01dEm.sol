...
contract H01dEm is ERC721Enumerable, Ownable {
    ...
    function devClaim() external onlyOwner returns (uint) {
        require(handList.length < 82, "Can only claim first 100");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked("data:application/json;base64,",
            Base64.encode(bytes(abi.encodePacked(
                ...
                '","description":"H01d\'Em Genesis Series. The first ever H01d\'Em tournament, shuffled and dealt on-chain. 52 card deck. 0ne mint = 0ne shuffle. Five card draw dealt on contract. 10,000 hands. 311,875,200 possibilities. 0ne Champion. May the best hand win.","attributes":[{"trait_type":"Hand","value":"',trait,'"}]}'
            )))));
    }
...
library Render {
  ...
  function getBrandImage(uint256 tokenId) internal pure returns (bytes memory) {
    return abi.encodePacked(
      '</text></g><text x="250" y="83" style="fill: #C2BD88;font-size:0.85em" text-anchor="middle">H01d\'Em</text><text x="250" y="100" style="fill: #C2BD88;font-size:0.5em;font-style:italic" text-anchor="middle">Genesis Series</text><text x="250" y="387" style="fill: #C2BD88;font-size:0.65em;font-style:italic" text-anchor="middle">#',
      toString(tokenId),
