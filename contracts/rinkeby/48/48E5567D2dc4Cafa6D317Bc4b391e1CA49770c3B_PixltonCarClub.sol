...
contract PixltonCarClub is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // Parent NFT Contract rinkeby address
    address public nftAddress = 0x70a5f49eFB1Bae2C2Db9808c746576CcF321bD16;
    IPixls nftContract = IPixls(nftAddress);

    constructor(string memory _baseURI) ERC721("Pixlton Car Club", "PXCC") {
        baseURI = _baseURI;
        devMint(0x0f00Daec0d940C4f46F4869372d05FE4004027Cd, 40);
    }
    ...
    function mintPublic(uint256 quantity) payable public nonReentrant {
