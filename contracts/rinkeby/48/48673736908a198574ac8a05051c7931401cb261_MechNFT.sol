...
contract MechNFT is ERC721URIStorage, VRFConsumerBase, Ownable {
    ...
    // price probably shouldn't be a public variable - hardcode in the mint function to reduce gas
        ...
        ERC721("MechNFT", "MECH")
    {
        ...
        tokenCounter = 0;
        revealedMechs = 0;
        ownerReserve = 10000; // maxxed out for testing - but change to 100 before deploying
        //Rinkeby Value
    ...
    function ownerMint(uint256 tokenQuant) public payable virtual onlyOwner {
        ...
        require(
            tokenQuant <= ownerReserve,
            "The team is only reserving 100 mechs - nice try, buddy!"
        );
        for (uint256 i; i < tokenQuant; i++) {
            _mint(msg.sender, tokenCounter);
            tokenCounter = tokenCounter + 1;
        }
        ownerReserve = ownerReserve - tokenQuant;
    }
    ...
    //Signer address is hardcoded to reduce gas in other functions
    ...
    // Dividing mint functions to reduce operations
