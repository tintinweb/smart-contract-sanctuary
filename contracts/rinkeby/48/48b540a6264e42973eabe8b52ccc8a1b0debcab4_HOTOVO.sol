...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xD135C4fCb02937b446e61a4b2Ee854B230E60985;
...
contract HOTOVO is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x3D68ED00fa4b350B62D6D25019FC5D3d28EB826A;
    ...
    uint256 private numTokensSellToAddToLiquidity = 10000000000 * 10**6 * 10**9;
    ...
    function totalSupply() public view override returns (uint256) {
        uint256 totalSupplyAmount = _tTotal + mintedToken;
    ...
    function reflectionFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
        require(tAmount <= (_tTotal + mintedToken), "Amount must be less than supply");
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        _reflectFee(rFee, rCharity, tFee, tCharity);
    ...
    function _reflectFee(uint256 rFee, uint256 rCharity, uint256 tFee, uint256 tCharity) private {
        _rTotal = _rTotal.sub(rFee).sub(rCharity);
        _tFeeTotal = _tFeeTotal.add(tFee).add(tCharity);
    }
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            require(amount <= (_maxTxAmount + mintedToken), "Transfer amount exceeds the maxTxAmount.");
    ...
    */
    function _mint(address recipient, uint256 amount) internal {
        ...
        uint256 mintAmount = amount.mul(_getRate());
        
        _rOwned[recipient] = _rOwned[recipient].add(mintAmount);
