...
contract newHarry is ERC721, Ownable 
{
    using SafeMath for uint256;
    uint256 public immutable pricePerKILLA;
    uint256 public immutable maxPerTx;
    uint256 public immutable maxnewHarry;
    ...
    function reservenewHarry() public onlyOwner {   
     ...
     function mintnewHarry(uint256 numberOfTokens) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 20 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxnewHarry, "Purchase would exceed max supply of newHarry");
