...
contract PTokenOption is IPTokenOption, ERC721 {
    ...
    function getActiveSymbolIds() public view override returns (uint256[] memory) {
        return _activeSymbolIds;
    }

    function isActiveSymbolId(uint256 symbolId) public view override returns (bool) {
        return _isActiveSymbolId[symbolId];
    }

    function getNumPositionHolders(uint256 symbolId) public view override returns (uint256) {
    ...
    function getPosition(address owner, uint256 symbolId) public view override returns (Position memory) {
    ...
    function updatePosition(
        ...
        emit UpdatePosition(
            ...
            position.volume,
            position.cost,
            position.lastCumulativeDeltaFundingRate,
            position.lastCumulativePremiumFundingRate
        );
    }
