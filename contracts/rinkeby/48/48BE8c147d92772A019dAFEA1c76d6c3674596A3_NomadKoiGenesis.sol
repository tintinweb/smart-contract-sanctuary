...
// File: NomadKoiGenesis.sol

//import "./clubs.sol";

contract NomadKoiGenesis is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private _price = 0.073 ether;
    uint256 private _reserved = 10; 

    string public NKG_PROVENANCE = "";
    uint256 public startingIndex;

    bool private _saleStarted;
    string public baseURI;

    uint256 public squaredNumber;
    string public ostring;
    string public testOstr1 = "O";
    string public testOstr2 = "o";
    string public OUTSTR;

    address t1 = 0x8eaFB616e4519578195b32C2d5e07578F2E1cB87;
    address t2 = 0x8eaFB616e4519578195b32C2d5e07578F2E1cB87;


    //=====================================================================================================================
    // CONSTRUCTOR, MODIFIERS, ESSENTIAL FUNCTIONS
    //=====================================================================================================================

    constructor() ERC721("Nomad Koi Genesis", "NKG") {
        _saleStarted = false;
    }
    ...
    function isIsContract(address account) private view returns(bool) {
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        NKG_PROVENANCE = provenanceHash;
    }

    // List all the NKG of a wallet
    ...
    function claimReserved(uint256 _number, address _receiver) external onlyOwner {
        require(_number <= _reserved, "Input amount exceeds the max reserved.");
    ...
    //specify the percentage of withdrawals sent to each address. I.e. owner, treasury/fund address, any 
    ...
    function setSquareYourFavoriteNumber(uint256 numberToSquare) public returns(uint256) {
        squaredNumber = numberToSquare**2;
        return squaredNumber;
    }

    function getSquaredNumber() public view returns(uint256) {
        return squaredNumber;
    }

    function setOstring(string memory _oh) public returns(string memory OUTSTR) {
        if (keccak256(abi.encodePacked(_oh)) == keccak256(abi.encodePacked(testOstr1))) {
            OUTSTR = "NOM";
            return OUTSTR;
        } else if (keccak256(abi.encodePacked(_oh)) == keccak256(abi.encodePacked(testOstr2))) {
            OUTSTR = "NOM!";
            return OUTSTR;
        }
    }

    function getOstring() public view returns(string memory) {
        return OUTSTR;
    }
