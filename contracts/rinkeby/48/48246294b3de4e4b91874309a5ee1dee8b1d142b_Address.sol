...
contract MatrixLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function claim(uint256 tokenId) public payable nonReentrant {
        ...
        require(msg.value == mintPrice, "Ether value sent is not correct.");
    ...
    constructor() ERC721("Matrix Loot", "mLOOT") Ownable() {}
}
