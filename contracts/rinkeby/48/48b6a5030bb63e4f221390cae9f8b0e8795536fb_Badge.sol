...
contract Badge is ERC1155, BaseContract {
    ...
    mapping(uint256 => uint8) public isBadgeClaimed;
    mapping(address => bool) public isStudentClaim;
    ...
    function createBadge(
        ...
        isBadgeClaimed[numberOfCopies] = 0;
    ...
    function claimBadgePrize(uint256 badgeId) external onlyStudent {
        ...
        address getsAddress = manager.getAddress("gets");
        GETSInterface gets = GETSInterface(getsAddress);
        require(isBadgeClaimed[badgeId] == 0, "Badge already claimed");
        isBadgeClaimed[badgeId] = 1;
        isStudentClaim[msg.sender] = true;
