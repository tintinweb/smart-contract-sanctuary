...
contract Aidicraft1155 is Ownable{
...
contract AidicraftMultiMint is Aidicraft1155{
    string public name;
    string public symbol;

    mapping (uint256 => string) private _tokenURIs;

    constructor(string memory _name, string memory _symbol) Aidicraft1155(name, symbol) public{
        name = _name;
        symbol = _symbol;
    }
}