...
/*
 * @notice This Contract allows smaller depositors to mint and redeem HYSI without needing to through all the steps necessary on their own,
 ...
 * We Batch this process and allow users to pool their funds. Then we pay keeper to Mint or Redeem HYSI regularly.
 */
