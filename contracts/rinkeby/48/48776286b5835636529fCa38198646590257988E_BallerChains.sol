...
contract BallerChains is ERC721, Ownable {
    ...
    **/
    ...
    // Addresses
    address public _gemsAddress;
    IGems _gemsContract;

    bool public _paused = true;

    string private _baseTokenURI = "https://oksnhdoq1m.execute-api.us-east-1.amazonaws.com/";
    ...
    /**
     * @dev Sets Gems contract address
     * @param gemsAddress The Gems contract address
     */

    function setGemsAddress(address gemsAddress) onlyOwner public {
        _gemsAddress = gemsAddress;
        _gemsContract = IGems(_gemsAddress);
    }
