...
contract InsuracePositionController is AbstractController {
    ...
    */
     ...
     */
    function _caclulateRewardsPerBlock(address _tokenAddress) internal returns (uint256) {
     ...
     */
    function _caclulatePoolAPY(address stakingtokenAddress) internal returns (uint256) {
