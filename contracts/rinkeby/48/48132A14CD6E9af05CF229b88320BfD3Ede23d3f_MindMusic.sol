...
contract MindMusic is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        //uniswap router address for ropsten network
        ...
        _isExcludeFromExternalTokenMinAmount[uniswapPair]             = true;
        _isExcludeFromExternalTokenMinAmount[address(_uniswapRouter)] = true;
    ...
    function setExternalToken(address externaltoken) external onlyOwner(){
        _externalToken = IERC20(externaltoken);
    }
