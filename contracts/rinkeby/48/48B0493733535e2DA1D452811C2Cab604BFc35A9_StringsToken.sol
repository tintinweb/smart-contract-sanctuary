...
contract StringsToken is Context, Ownable, ERC165Storage, IERC721Enumerable, IERC721Metadata {
    ...
    // Events
    event MintedStrings(address minter, uint256 stringId, uint256 count);
    ...
    */
    function mintOneString(uint256 count, uint256 dustAmount) public {
        ...
        IDUST(_dustAddress).burn(dustAmount.div(5).mul(4)); 	// burn 80% of the dust, keep 20% as treasury for incentives, puzzles etc.
	...
	uint mintStart = mintedSupply();
        ...
        emit MintedStrings(msg.sender, mintStart, count);
    }
