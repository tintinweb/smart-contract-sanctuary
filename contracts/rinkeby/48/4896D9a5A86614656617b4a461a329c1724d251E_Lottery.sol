...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    // OPEN=0, CLOSED=1, CALCULATING_WINNER=3
    ...
    // owerrides definiton in VRFConsumerBase.sol
    function fulfillRandomness(bytes32 _requiestId, uint256 _randomness)
        internal
        override
    {
        require(
        ...
        // Pay all money to winner
        recentWinner.transfer(address(this).balance);
        // Reset the lottery
        players = new address payable[](0);
        lottery_state = LOTTERY_STATE.CLOSED;
        // keep track on most recent random number
