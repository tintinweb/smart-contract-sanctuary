...
contract sdvsdvs is ERC721Enumerable, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/195/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/195/contract-uri";
	...
	uint256 public pricePerToken = 1200000000000000;

    // presale settings
    address private signerAddress;
	uint256 public presaleMaxSupply = 5;
	uint256 public presaleMaxPerMint = 2;
	uint256 public presalePricePerToken = 9100000000000000;
  uint256 public presaleEndDate = 1639648830;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("asvsdv", "sdvd") {
