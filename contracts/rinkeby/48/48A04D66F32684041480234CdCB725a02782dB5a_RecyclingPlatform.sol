...
contract RecyclingPlatform is Context, AccessControlEnumerable {
    ...
    */
    ...
    function exchangeRCL(address client, uint256 amountRCL) public payable {
        exchangeRCLgeneral(client, amountRCL, payable(msg.sender), msg.value);
    }

    function exchangeRCLplatform(address client, uint256 amountRCL, uint256 ethValue) public payable {
        exchangeRCLgeneral(client, amountRCL, payable(address(this)), ethValue);
    }

    function exchangeRCLgeneral(address client, uint256 amountRCL, address payable ethSender, uint256 ethValue ) internal {
