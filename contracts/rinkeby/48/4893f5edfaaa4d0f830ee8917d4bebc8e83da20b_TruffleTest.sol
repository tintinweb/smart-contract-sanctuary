...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 internal _minimumSupply = 69420000 * (10 ** 18);
...
contract TruffleTest is ERC20 {

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 internal _totalSupply = 1000000000000 * (10 ** 18);
    string internal _symbol = "TRUF3";
    string internal _name = "TruffleTest3";

    constructor() ERC20("TruffleTest", "TRUF") {
