...
contract TOKENBridge is ReentrancyGuard, Context, Ownable {
  ...
  function getMaxTransactionWSG() external view returns (uint256) {
    return maxTransactionWSG;
  }
  ...
  function getMaxTransactionGASPAY() external view returns (uint256) {
    return maxTransactionGASPAY;
  }
  ...
  function getMaxTransactionGASG() external view returns (uint256) {
    return maxTransactionGASG;
  }
  ...
  function getWSGTokenBalance() external view returns (uint256) {
    return WSG_TOKEN.balanceOf(address(this));
  }

  function getGASPAYTokenBalance() external view returns (uint256) {
    return GASPAY_TOKEN.balanceOf(address(this));
  }

  function getGASGTokenBalance() external view returns (uint256) {
    return GASG_TOKEN.balanceOf(address(this));
  }
