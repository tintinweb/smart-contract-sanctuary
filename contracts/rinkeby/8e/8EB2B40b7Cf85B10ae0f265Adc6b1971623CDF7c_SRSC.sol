...
contract SRSC is ERC721Enumerable, Ownable {
    uint public constant MAX_EAGLES = 3600;
    ...
    */
    ...
    function mintEagles(address _to, uint _count) public payable saleIsOpen {
        ...
        require(totalSupply() < MAX_EAGLES, "Sale end");
        require(_count <= 1500, "Exceeds 15");
    ...
    function price(uint _count) public view returns (uint256) {
        ...
        return 72000000000000 * _count; // 0.0720 ETH
    }

    function contractURI() public view returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmRycvAznusQkZHG5JgWsGydfMArZWwCpRhbVFps8ErmVN";
    }
