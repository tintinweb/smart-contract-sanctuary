...
contract NFT is ERC721, Ownable, PaymentSplitter { // TODO change to final contract name
  ...
  uint public constant maxPresaleSupply = 2000;
  ...
  string public hiddenTokenURI = "https://onchain.mypinata.cloud/ipfs/QmRXi8J1djy4iNc98N83rqooLfRp3xRXF9hr1KKJ6XZGMX";
  ...
  function addToWhitelist(address[] memory addresses) external onlyOwner {
    for(uint256 i = 0; i < addresses.length; i++) {
      whitelist[addresses[i]] = maxMintsPerWhitelistedAddress;
    }
  }
  ...
  function _mintDO(address to, uint amount) private {
    uint id;
