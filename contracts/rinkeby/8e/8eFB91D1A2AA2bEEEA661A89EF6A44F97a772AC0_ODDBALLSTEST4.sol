...
contract ODDBALLSTEST4 is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    constructor() ERC721("ODDBALLSTEST4", "ODD3") {}
    ...
    function setAllowListMaxMint(uint256 reserveLimit) public onlyOwner {
