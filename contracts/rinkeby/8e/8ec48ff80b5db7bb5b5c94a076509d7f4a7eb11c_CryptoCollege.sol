...
contract CryptoCollege is ERC721, ERC721Enumerable, Ownable, Pausable, ERC721URIStorage {
    using Strings for uint256;
    string private _baseTokenURI;
    address public vault;
    uint256 public constant MAX_SUPPLY = 300;

    constructor() ERC721("Crypto College", "CC") {}
    ...
    function calculatePrice() public view returns (uint256) {
        ...
        if (currentSupply >= 200) {
            return 1400000000000000000; // 1,601 - 3,200 : 1.4 ETH
        } else if (currentSupply >= 100) {
            return 1200000000000000000; // 801 - 1600 : 1.2 ETH
        } else if (currentSupply >= 50) {
            return 600000000000000000; // 401 - 800 : 0.6 ETH
        } else if (currentSupply >= 20) {
            return 300000000000000000; // 201 - 400 : 0.3 ETH
        } else {
            return 150000000000000000; // 1 - 200 : 0.15 ETH
        }
    }
