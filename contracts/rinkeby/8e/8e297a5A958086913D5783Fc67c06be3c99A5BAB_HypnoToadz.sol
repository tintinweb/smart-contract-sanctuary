...
contract HypnoToadz is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("HypnoToadz", "HTC") {
    setHiddenMetadataUri("ipfs://QmckJfYn3WfhEnDtfYWDfnZLU89TaGFTThowGG6pmRYPqz/hidden.json");
  }
