...
╚═╝     ╚═╝ ╚═════╝  ╚═════╝╚═╝  ╚═╝    ╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝     
*/                                                                                      
contract MockAirdrop is GremlinsERC721Proxy {
    ...
    struct AppStorage {
        uint16 totalSupply;
        mapping(address => bool) claimedWallets;
    }
    ...
    // Constructor
    constructor(address logic) GremlinsERC721Proxy(logic, "Mock Airdrop", "Mock") {}
    ...
    function claim() public {
        ...
        require(app.claimedWallets[msg.sender] == false, "2X");

        uint256 tokenId = app.totalSupply + 1;
        app.totalSupply += 1;
        app.claimedWallets[msg.sender] = true;

        bytes memory data = abi.encodeWithSignature("mint(address,uint256,string)", msg.sender, tokenId, "");
