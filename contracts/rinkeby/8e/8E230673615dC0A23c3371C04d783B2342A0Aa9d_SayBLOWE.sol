...
contract SayBLOWE is ERC721, ChainlinkYoutube, Ownable {
    ...
    function updateCollectiables(
        uint256 _tokenID,
        string memory _tokenUri,
        uint256 _dynamicRating,
...
contract ChainlinkYoutube is ChainlinkClient {
    ...
    constructor() public {
    	...
    	oracle = 0x1D6Ce376d4C32e27243266583300c3E65399E1Ca; // Rinkeby oracle address
    	jobId1 = "88a91a76ab8942119ac81e8d68b20e07"; //job id Rinkeby twitter adapter
    	jobId2 = "a18c31bb988842d293befa1dffe91aaa"; //job id Rinkeby youtube adapter
    	fee = 1; 
    }
