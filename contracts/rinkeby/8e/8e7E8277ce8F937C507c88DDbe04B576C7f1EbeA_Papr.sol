...
contract Papr is ERC20Burnable, DoubleOperator {
    ...
    constructor() public ERC20('PAPR', 'PAPR') {
        ...
        feesTaxRate[0] = 0; feesTaxRate[1] = 40; feesTaxRate[2] = 35; feesTaxRate[3] = 30; feesTaxRate[4] = 25; feesTaxRate[5] = 10; feesTaxRate[6] = 5; feesTaxRate[7] = 4; feesTaxRate[8] = 3; feesTaxRate[9] = 2; feesTaxRate[10] = 1;
    }
