...
contract RainiCards is ERC1155, AccessControl {
  ...
  function uri(uint256 id) public view virtual override returns (string memory) {
    ...
    if (cards[_tokenVars.cardId].subContract == address(0)) {
      return string(abi.encodePacked(baseUri, cardPathUri[_tokenVars.cardId], "/", _tokenVars.mintedContractChar, "l", Strings.toString(_tokenVars.level), "n", Strings.toString(_tokenVars.number), ".json"));
    } else {
