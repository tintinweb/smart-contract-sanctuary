...
contract qMarketV3 is PausableUpgradeable, OwnableUpgradeable {
  ...
  event ItemAdded(bytes32 item_id, uint256 token_id, address token_address, address owner_of, uint256 askingPrice, uint256 createdAt);
