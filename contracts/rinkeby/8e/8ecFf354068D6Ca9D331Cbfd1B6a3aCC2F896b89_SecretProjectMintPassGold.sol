...
contract SecretProjectMintPassGold is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("SecretProjectMintPass", "SPMP") {
        setBaseURI(baseURI);
        whitelisted[0xbEbB18f66fB06A2bf541CBF0c7047D14F6f411C9] = true;
    }
