...
contract DeepWatersLending is ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        if (isStableRateBorrow) {
            data.newAverageStableInterestRate = 
                ...
                add(data.currentBorrowBalance.mul(vault.getUserBorrowAverageStableInterestRate(_asset, msg.sender))).
    ...
    **/
        ...
        internal
    {
        ...
        uint256 newBorrowBalance = currentBorrowBalance.add(linearInterest).sub(_amount);
