...
contract NOFIToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, ERC20FlashMintUpgradeable {
    ...
    uint private FOUNDERS_SUPPLY;

    uint[2][] private FOUNDERS_RELEASE;
    ...
    function initialize() initializer public {
        ...
        _supplyCap = 600000000 * 10 ** 18;
        START_BLOCK = block.number;
        START_TIME = block.timestamp;
        FOUNDERS_SUPPLY = 0;
        FOUNDERS_RELEASE = [
            [START_BLOCK + (60 * 60 * 24 * 90 * 1), 1500000 * 8],
            [START_BLOCK + (60 * 60 * 24 * 90 * 2), 1500000 * 8],
            [START_BLOCK + (60 * 60 * 24 * 90 * 3), 1500000 * 8],
            [START_BLOCK + (60 * 60 * 24 * 90 * 4), 1500000 * 8]
        ];
    }
    ...
    function mint(address to, uint256 amount) public onlyRole(MINTER_ROLE) {
        require(amount + totalSupply() <= _maxSupply(), "MINT OVERFLOW");
        _mint(to, amount);
    }
