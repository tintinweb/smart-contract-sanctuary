...
contract SecurityToken is ERC1404, Ownable {
    ...
    uint8 public constant ERR_RECIPIENT_CODE = 1;
    uint8 public constant ERR_BONDING_CURVE_CODE = 2;
    uint8 public constant ERR_NOT_WHITELISTED_CODE = 3;
    string public constant SUCCESS_MESSAGE = "SecurityToken: SUCCESS";
    string public constant ERR_RECIPIENT_MESSAGE = "SecurityToken: RECIPIENT SHOULD BE IN THE WHITELIST";
    string public constant ERR_BONDING_CURVE_MESSAGE = "SecurityToken: CAN TRANSFER ONLY TO BONDING CURVE";
    string public constant ERR_NOT_WHITELISTED_MESSAGE = "SecurityToken: ONLY WHITELISTED USERS CAN TRANSFER TOKEN";
