...
contract CrazySkullzHalloweenCards is ERC721Enumerable, Ownable {
    ...
    address public crazySkullzContractAddress = 0x7f82DE7f622d7E4f3b1Bd9A386DDaD24724F1034;


    uint256 public MAX_SUPPLY = 10000;

    mapping(uint256 => bool) _claimingSkullz;
    ...
    constructor() ERC721("CrazySkullzHalloweenCards","SKLZHALO"){}
    ...
    function claim(uint256 crazySkullzTokensNumber) public {
        ...
        uint256 walletBalance = crazySkullzContractCaller.balanceOf(msg.sender);
        ...
        for (uint256 i = 0; i < walletBalance; i++) {
            uint256 userTokenId = crazySkullzContractCaller.tokenOfOwnerByIndex(msg.sender, i);
        ...
        for (uint i = 0; i < walletBalance; i++) {
            if (!isClaimed(userTokens[i]) && crazySkullzTokensNumber > 0) {
                ...
                _claimingSkullz[userTokens[i]] = true;
