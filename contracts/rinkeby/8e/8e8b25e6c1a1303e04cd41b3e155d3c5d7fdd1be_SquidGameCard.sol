...
contract SquidGameCard is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint8 private constant _PICKSIZE = 3;
    uint16 private constant _MAX_CLAIMS = 3*4;
    uint16 private constant _MAX_OWNER_CLAIMS = 3;
    uint16 private constant _TIMELOCK_COUNT = 3;
    uint private constant _TIMELOCK_DURATION = 3 seconds;
