...
contract DiagnostList is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
  ...
  constructor() ERC721("Diagnose List", "DIAGNOSE") Ownable() {}
  ...
  function reserveTokens(address _to, uint256 _reserveAmount) public onlyOwner {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Lootbox #', toString(tokenId), '", "description": "Altered Acoustics description.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '", "attributes": [{"trait_type": "Base", "value": "Star"}],}'))));
