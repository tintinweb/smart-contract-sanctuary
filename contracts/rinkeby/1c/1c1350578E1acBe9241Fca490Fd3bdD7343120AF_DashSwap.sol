...
contract DashSwap is Ownable {
  ...
  uint public constant totalSupply = 10000000e18; // 10 million DashSwap
  ...
  function transfer(address dst, uint rawAmount) external returns (bool) {
    require(whitelisted[dst] || whitelisted[msg.sender], "DashSwap::only allowed to be used in ecosystem");
