...
contract FactoryClone is Ownable, Pausable, IFactoryClone {
    ...
    constructor() {
        ...
        // _fees = 10 // uncommment this line when `production`
    ...
    ReentrancyGuardUpgradeable
{
    ...
    struct tokenInfo {
        ...
        // to reduce gas fees you can put mapping in struct
        // so this solution with create nested struct
    }
    ...
    function addWhitelist(address to) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "a4fb704b");
        whitelist[to] = true;
    }

    function removeWhitelist(address to) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "a4fb704b");
        whitelist[to] = false;   
    }

    /// TODO adding pre-sale feature below here.
    /// @dev adding or refactor fix amount buying for pre-sale
    // function buyPresale() public payable virtual {
    //     require(whitelist[_msgSender()] = true, "error message you are not in whitelist");
    //     buy(1);
    // }
