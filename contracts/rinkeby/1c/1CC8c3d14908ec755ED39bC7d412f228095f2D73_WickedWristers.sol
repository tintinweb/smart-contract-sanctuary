...
contract WickedWristers is ERC721Enumerable, Ownable {
    ...
    event PresaleMint(address minter, uint256 numberOfTokens);
    event PublicSaleMint(address minter, uint256 numberOfTokens);
    ...
    function mintWrister(uint numberOfTokens) public payable {
        ...
        emit PublicSaleMint(msg.sender, numberOfTokens);
    }
}