...
contract MiddlePunks is Initializable, OwnableUpgradeable, ERC721EnumerableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  // You can use this hash to verify the image file containing all the MidPunks
  ...
  uint256 public constant MAX_MINTABLE_AT_ONCE = 100;

  uint256[104] private _availableTokens;
  uint256 private _numAvailableTokens = 104;
