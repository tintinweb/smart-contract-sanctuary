...
contract Potenza is NPassCore {
    ...
    function getSVGStart() private view returns (string memory) {
        ...
        SVGStart memory svgStart = SVGStart('<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="','" height="','" viewBox="0 0 ',' ','"><defs></defs><g><rect fill="rgb(255,255,255)" stroke="none" x="0" y="0" width="','" height="','" transform="matrix(1 0 0 1 0 0)" fill-opacity="1"></rect>');
        ...
        string memory output2 = string(abi.encodePacked(svgStart.SVG_FRAGMENT_3, parts[1], svgStart.SVG_FRAGMENT_5, parts[0], svgStart.SVG_FRAGMENT_6, parts[1], svgStart.SVG_FRAGMENT_7));
