 ...
 */
contract VestingSEVS is Context {
    ...
    constructor(
        ...
        require(durationSeconds > 0, "durationSeconds Should be greater than 0");
        _token = tokenAddress;
     ...
     */
    function newLock(address account,uint256 amount) public virtual{
    ...
    /**
     * @dev Batch release the tokens that have already vested.
     */
    ...
    function vestedAmount(address account, uint64 timestamp) public view virtual returns (uint256) {
        return _vestingSchedule(_locked[account], timestamp);
    }
