...
contract EthChars is ERC721Enumerable, ReentrancyGuard, Ownable {

        string[] private heritages = [
        "Human",
        "Elf",
        "Half-Elf",
        "Dwarf",
    ...
    function getHeritage(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "HERITAGE", heritages);
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[11] = getConstitution(tokenId);

        parts[12] = '</text><text x="10" y="140" class="base">';

        parts[13] = getIntelligence(tokenId);

        parts[14] = '</text><text x="10" y="160" class="base">';

        parts[15] = getWisdom(tokenId);
        
        parts[16] = '</text><text x="10" y="180" class="base">';

        parts[17] = getCharisma(tokenId);
