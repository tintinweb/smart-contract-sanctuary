...
contract DLZToken     is  ERC721Enumerable
{
    ...
    {
        uint256 orderPrice = calculateMintingOrderPrice(quantity, 1, msg.value);       // mode: 1=Simple_MINT  2=MINT+STAKING
    ...
    {
        uint256 orderPrice = calculateMintingOrderPrice(quantity, 2, msg.value);       // mode: 1=Simple_MINT  2=MINT+STAKING
        
        mintEx(quantity, orderPrice, true);
    }
    //=============================================================================
    function    calculateMintingOrderPrice(uint256 quantity, uint256 stakingMode, uint256 amount) internal returns(uint256)
    {
        uint256     orderPrice;
        ...
        if (mintingMode==2)             // on est dans la phase de WHITELIST 
        {
            ...
            else
            {
                ...
                if (stakingMode==1)     orderPrice = presalesPrice      * quantity;
        ...
        if (mintingMode>2)
        {
            ...
            if (stakingMode==1)     orderPrice = salesPrice      * quantity;
            else                    orderPrice = stakeSalesPrice * quantity;
        }

        require(amount==orderPrice,  "Send exact Amount to claim NFT(s)!");

        return orderPrice;
    }
    //=============================================================================
    function    getMintingPrice(uint256 quantity, uint256 stakingMode) external returns(uint256)
    {
        uint256     orderPrice;
    ...
    //=============================================================================
    function    generateDoolnyProfile() external  returns (P2EDoolny memory)
    {
        P2EDoolny memory  profile;
    ...
    //=============================================================================
    function    rand(uint32 from, uint32 to) internal  returns(uint32)
    {
        ...
        return minVal + (uint32(rnd)%modulo);
    }
    //=============================================================================
    //=============================================================================
    //=============================================================================
