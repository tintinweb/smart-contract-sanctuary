...
contract AlphaMock {
    ...
    string public constant name = "Alpha Mock";

    /// @notice The number of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    function quorumVotes() public pure returns (uint) { return 1; }

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 0; }
    ...
    function votingPeriod() public pure returns (uint) { return 20; }
    ...
    function queue(uint proposalId) public {
        ...
        uint eta = add256(block.timestamp, 10);
        proposal.eta = eta;
