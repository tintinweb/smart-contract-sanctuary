...
contract LoveToken is Context, ERC20 {
    ...
    function accumulated(address _address, uint256 tokenIndex) public view returns (uint256) {
        ...
        uint256 totalAccumulated = accumulationPeriod.sub(lastClaimed).mul(dailyEmissionWithBoost).div(SECONDS_IN_A_DAY);
    ...
    function claim(address _address, uint256[] memory tokenIndices) internal returns (uint256) {
        ...
        require(totalClaimQty != 0, "No accumulated SEMEN");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if (msg.sender != _dudesAddress && msg.sender != _sistasAddress) {
