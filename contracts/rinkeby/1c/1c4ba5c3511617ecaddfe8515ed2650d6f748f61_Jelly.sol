...
contract Jelly is JellyTokenAccess, ERC20, Pausable, ERC20Permit {
    ...
    */
    ...
    constructor(string memory name, string memory symbol, uint256 hardcap, address owner, uint256 initialSupply) ERC20(name,symbol) ERC20Permit(name) {
    ...
    /**
     * @dev Sets $JELLY ready for serving when the time is just right.
     */
    ...
    function canTransfer(
        ...
        return (!paused() || hasOperatorRole(_from));
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused() || hasOperatorRole(_msgSender()), "JELLY: tokens cannot be transferred until setJelly has been executed");
    }
