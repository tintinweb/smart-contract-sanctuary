...
contract FoMo3Dlong is modularLong {
	...
	PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0x239fA697F4226A79c372c046a5c5177C06fbE706);
...
// ROUND DATA 
//****************
	uint256 private rndExtra_ = getLongExtra();     // length of the very first ICO 
    uint256 private rndGap_ = getLongGap();         // length of ICO phase, set to 1 year for EOS.
...
//==============================================================================
        ...
        returns (F3Ddatasets.EventReturns)
    {
        ...
        // CHANGE THIS TO A SMART CONTRACT THAT HOLDS DIVIES 
