...
contract TanerDeneme is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x675666e7d3FE5F1eB3E93B233693a39b1a76FDf1); // Marketing Address
    ...
    string private _name = "Taner Deneme";
    string private _symbol = "TDNM";
