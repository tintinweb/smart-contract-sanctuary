...
contract MintPassFactory is AbstractMintPassFactory, PaymentSplitter  {
    ...
    constructor(
        ...
        //mint all to contract (to, ids, amounts, data)
        ...
        ids[5] = 6;
        ids[6] = 7;
        uint256[] memory quantities = new uint256[](7);
        quantities[0] = 10560;
        quantities[1] = 7060;
        quantities[2] = 3000;
        quantities[3] = 500;
        ...
        _mintBatch(address(this), ids, quantities, "");
    ...
    function claim(
        ...
        _safeBatchTransferFrom(address(this), msg.sender, ids, qtys, "");
