...
contract MAMB is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;
	
	uint256 public MAX_NFT = 10000;
	uint256 public MAX_MINT_PRESALE = 24;
	uint256 public MAX_MINT_SALE = 24;
    ...
    constructor(string memory baseURI) ERC721("Mamba's", "MAMB") {
		setBaseURI(baseURI);
        pause(true);
    }
