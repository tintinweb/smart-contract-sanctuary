...
contract Test is ERC1155Supply, Ownable  {
    ...
    uint constant TOKEN_ID = 11;
    uint constant NUM_RESERVED_TOKENS = 111;
    uint constant MAX_TOKENS_PER_PURCHASE = 11;
    uint constant MAX_TOKENS = 1111;
    uint constant TOKEN_PRICE = 0.5 ether;
