...
contract Staking {
    ...
    // FXF Contract Address
    address public constant FXFTOKENADDRESS = 0x31DC5c2fE0d4081885C13377cbe76E979247088a;
    // Uncomment below and comment above like for production
    // address public constant FXFTOKENADDRESS = 0x8a40c222996f9f3431f63bf80244c36822060f12;
    ...
    function _calculateRewards(uint256 _noOfTokens) internal view returns (uint256) {
        uint256 userShareInPool = (_noOfTokens.mul(10000)).div(stakingPool);
        return StakeHolders[msg.sender].rewards.add((userShareInPool.mul(stakingPoolRewards)).div(10000));
    }
    ...
    function calculateRewardsView(address _wallet, uint256 _noOfTokens) external view returns (uint256) {
        uint256 userShareInPool = (_noOfTokens.mul(10000)).div(stakingPool);
        return StakeHolders[_wallet].rewards.add((userShareInPool.mul(stakingPoolRewards)).div(10000));
    }
