...
contract GenF is ERC721, Ownable {
    ...
    uint public presaleMintPrice = 0.025 ether;
    uint public dutchAuctionStart = 0.500 ether;
    uint public dutchAuctionEnd = 0.025 ether;
    uint public dutchAuctionIncrement = 0.025 ether;
    uint public dutchAuctionStepTime = 1800; // 30 minutes
    ...
    constructor(address _owner) ERC721("Gen-F", "GENF") {
