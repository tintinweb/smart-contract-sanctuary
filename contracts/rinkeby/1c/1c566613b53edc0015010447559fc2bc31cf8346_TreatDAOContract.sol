...
// import '/Users/train/Documents/Work/Gall/TreatDao-v2/node_modules/@uniswap/v2-periphery/contracts/interfaces/IUniswapV2Router01.sol';
...
contract TreatDAOContract is ERC20, Ownable {
    ...
    */
    function _transfer(
        ...
        //(bool success, ) = address(treatTreasuryAddress).call{value:tokensToLock.div(2)}("");
    ...
    */
    function calculateTokenFee(
        ...
        address _from,
        address _to
    ) public returns (uint256 locked) {
        bool isTaxed = taxedContracts[_from] || taxedContracts[_to];
        if(isTaxed) {
          emit Taxing(_from,_to,_amount);
    ...
    mapping (address => bool) public taxedContracts;
    function addTaxedContract(address taxed) public {
        require(!taxedContracts[taxed], "Address is already taxed");
        taxedContracts[taxed] = true;
        emit RouterChanged(taxed);
    }

    function removeTaxedContract(address notaxed) public {
        taxedContracts[notaxed] = false;
        emit RouterChanged(notaxed);
    }
    ...
    function withdrawAll(address _tokenAddress, address payable _to) onlyOwner public {
