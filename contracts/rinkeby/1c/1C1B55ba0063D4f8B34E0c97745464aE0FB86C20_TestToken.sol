...
contract TestToken is ERC721 {
    ...
    event MintedToken(uint256 indexed tokenId, address owner);
    ...
    function mint(address _to) public returns (uint256) {
        ...
        names[newTokenId] = "Token";

        emit MintedToken(newTokenId, _to);

        return newTokenId;
    }

    function changeName(uint256 _tokenId, string memory _name) public {
        require(_tokenId <= _tokenIds.current(), "Non existant token");
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        string memory content = string(abi.encodePacked(
                ...
                tokenName,
                '",',
                '"attributes": [ { "trait_type": "type", "value": "human" }, { "trait_type": "size", "value": "medium" } ], ',
                '"image": "ipfs://QmRukKYGBVE4P1cCqvp7K85AhRidB8kE1bcD6dKp8V6Y6C/yacht1.png"}'
            ));
