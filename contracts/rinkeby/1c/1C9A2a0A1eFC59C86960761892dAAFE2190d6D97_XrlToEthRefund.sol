...
interface IERC20 {
    ...
    function getRefunds(address account, uint index) external view returns (uint256);
...
contract ERC20Basic is IERC20 {
    ...
    function getRefunds(address account, uint index) public override view returns (uint256){
...
contract XrlToEthRefund {
    ...
    function getRefunds(address _address, uint _index) public view returns (uint){
        return xrlToken.getRefunds(_address, _index);
    }
