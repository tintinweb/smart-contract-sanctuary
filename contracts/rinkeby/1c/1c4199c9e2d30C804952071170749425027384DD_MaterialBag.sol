...
contract MaterialBag is ERC721, ReentrancyGuard, Ownable {
    using SafeMath for uint256;

    string public PROVENANCE = "";
    uint256 public ownersPrice = 0; //0 ETH
    uint256 public membersPrice = 0; //0 ETH
    uint256 public publicPrice = 100000000000000000; //0.01 ETH
    bool public saleIsActive = true;
    bool public privateSale = true;

    //Loot Bag Contract
    address public lootBagAddress = 0xF77Aa03Ac2ae97322323fd225f3D5196a779Df35;
    LootBagInterface lootBagContract = LootBagInterface(lootBagAddress);
