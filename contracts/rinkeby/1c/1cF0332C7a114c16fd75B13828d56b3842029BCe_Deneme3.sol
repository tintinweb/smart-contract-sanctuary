...
contract Deneme3 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("deneme3", "dnm") {
    setHiddenMetadataUri("ipfs://QmapEfoSihNphThCRVF5qwEhyERWP8QC2woqZUad5xTyDw/.json");
  }
