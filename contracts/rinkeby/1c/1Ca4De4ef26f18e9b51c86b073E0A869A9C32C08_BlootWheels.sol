...
contract BlootWheels is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getWave(uint256 tokenId) public view returns (string memory) {
        ...
        string memory h1 = getHeight(tokenId * 10);
        string memory h2 = getHeight(tokenId);

        wave = string(abi.encodePacked( '<defs> <path id="gentle-wave" d="M-310 250c30 0 58-', h1, ' 88-', h1, 's 58 ', h1, ' 88 ', h1 ));
        ...
        wave = string(abi.encodePacked(
            wave, ' v100h-1000z"/></defs><g class="parallax"><use xlink:href="#gentle-wave" x="48" y="0" fill="rgba(', color, ' ,0.7)" /><use xlink:href="#gentle-wave" x="48" y="3" fill="rgba(', color, ', 0.5)" /><use xlink:href="#gentle-wave" x="48" y="5" fill="rgba(', color, ',0.3)" /><use xlink:href="#gentle-wave" x="48" y="7" fill="rgba(', color, ', 0.4)" /></g></svg>'
        ));
