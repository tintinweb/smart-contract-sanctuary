...
contract HousePal is ERC721URIStorage, Ownable{
    ...
    event PaidUp (address indexed summoner, uint256 startWith, uint256 times);
    ...
    function paidUp(uint256 _times) payable public {
        require(started, "not started");        
        require(totalHouses + _times <= totalCount, "paid up too much");
        require(msg.value == _times * price, "value error");
        payable(owner()).transfer(msg.value);
        emit PaidUp(_msgSender(), totalHouses+1, _times);
