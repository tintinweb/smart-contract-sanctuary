...
contract Pizza is ERC721Enumerable {

    uint256 public constant PUBLIC_MINT_PRICE = 30000000000000000;
    ...
    constructor() ERC721("PizzaOnChain", "PZS") {
        _owner = msg.sender;


        //bg colors
        traitTypes[0].push(Trait("BG","Color","c2dab8",6));
        traitTypes[0].push(Trait("BG","Color","e7f0b3",6));
        traitTypes[0].push(Trait("BG","Color","b3cef0",6));
        traitTypes[0].push(Trait("BG","Color","d7b3f0",6));
        traitTypes[0].push(Trait("BG","Color","f0b3b3",6));
        
        //basis colors
        traitTypes[1].push(Trait("BASIS","Color","9d7c32",6));
        traitTypes[1].push(Trait("BASIS","Color","9f8973",6));
        traitTypes[1].push(Trait("BASIS","Color","7c590c",6));
        traitTypes[1].push(Trait("BASIS","Color","ab3d17",6));
        traitTypes[1].push(Trait("BASIS","Color","bbb897",6));
        
        //bg colors
        TIERS[0] = [50, 800, 1205, 1500, 2000];
        //basis colors
        TIERS[1] = [50, 800, 1205, 1500, 2000];
        //crust
        TIERS[2] = [5555];
        //Topping 1
        TIERS[3] = [1355, 1400, 1400, 1400];
        //Topping 2
        TIERS[4] = [1355, 1400, 1400, 1400];
        //Topping 3
        TIERS[5] = [1355, 1400, 1400, 1400];
        //
    ...
    function mintInternal() internal {
        ...
        require(!Oven.isContract(msg.sender));
   ...
   /**
        ...
        returns (uint8)
    {
        for (uint8 i = 0; i < LETTERS.length; i++) {
            if (Oven.compareStrings((LETTERS[i]),_inputLetter))
               return (i);
        }
        revert();
    }
    ...
    // function hashToSVG(string memory pixels,uint256 startIndex,
    //     uint256 endIndex)
    //     public
    //     view
    //     returns (string memory)
    ...
    //     string memory thisPixel = Oven.substring(
    //                 pixels,
    //                 startIndex,
    //                 endIndex
    //             );
        ...
        returns (string memory)
    {
        ...
        bool[25][25] memory placedPixels;
        ...
        svgString = string(
            abi.encodePacked(
                '<svg id="mouse-svg" fill="#6b2e09" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 48 48">',
                bgRect,
                ...
                basisRect,
                svgString,
                '</g><style>rect {width: 1px;height: 1px;}#mouse-svg {shape-rendering: crispedges;}.bg {width: 100%;height: 100%}.z{fill:#590a01}.c00{fill:#311500}.c01{fill:#f6e3bb}.c02{fill:#131913}.c03{fill:#821003}.c04{fill:#590a01}.c05{fill:#466930}.c06{fill:#779a61}.c07{fill:#366028}.c08{fill:#2d7717}.c09{fill:#e9b857}.c10{fill:#7e1d13}.c11{fill:#620f06}.c12{fill:#e9c59f}.c13{fill:#2d2a26}.c14{fill:#c74833}.c15{fill:#e99a8c}.c16{fill:#b6742f}.c17{fill:#d59049}.c18{fill:#590a01}.c19{fill:#915a1f}',
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    ...
                                    '", "description": "Some pizza description. All the metadata and images are generated and stored 100% on-chain. No IPFS, no API. Just the Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
                                    Oven.encode(
