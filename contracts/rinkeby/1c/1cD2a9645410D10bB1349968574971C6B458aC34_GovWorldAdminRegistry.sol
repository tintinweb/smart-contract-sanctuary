...
contract GovWorldAdminRegistry is GovWorldAdminBase {
        ...
        onlyAddGovAdminRole(msg.sender)
    {
        ...
        AddAdminRejected(_admin, msg.sender);
    }
        ...
        onlyEditGovAdminRole(msg.sender)
    {
        ...
        EditAdminRejected(_admin, msg.sender);
    }
    /**
        ...
        onlyEditGovAdminRole(msg.sender)
    {
        ...
        //this will remove admin roles from approved admins roles mapping
        delete approvedAdminRoles[_admin];

        RemoveAdminRejected(_admin, msg.sender);
    }
