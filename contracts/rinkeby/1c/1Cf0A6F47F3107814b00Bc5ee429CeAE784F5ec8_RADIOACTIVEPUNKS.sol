 ...
 *      fees declared via the Rarible V1 Protocol and ERC2981 standard.
 */
contract RADIOACTIVEPUNKS is ERC721Burnable, ERC721Pausable, ERC721Enumerable, HasSecondarySaleFees, ERC2981, Ownable {

  uint256 public activationTime = 32525026388; // YEAR 3000
  ...
  uint private constant maxPunksAtOnce = 10;
  ...
  /*
   * @dev Sends all funds in contract to the PaymentSplitter instance
   */
  ...
  /*
   * @dev Used in pseudorandom generator
   */
  ...
  function setAPIBaseURL(string memory URI) external onlyOwner {
    require(frozen == false, "Metadata permanently frozen");
    API_BASE_URL = URI;
  }
  ...
  function reservePunks(uint256 numberOfTokens) public onlyOwner {
    require(numberOfTokens <= PUNKS_LEFT, "Reservation exceeds max supply of Radioactive Punks");
  ...
  /*
   * For minting up to ten punks at once, tokenIds pseudorandomly generated.
   */
  function mintPunks(uint256 numberOfTokens) public payable whenNotPaused {
    ...
    require(numberOfTokens <= PUNKS_LEFT, "Purchase exceeds max supply of Radioactive Punks");
