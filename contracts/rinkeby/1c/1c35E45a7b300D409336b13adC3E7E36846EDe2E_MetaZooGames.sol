...
contract MetaZooGames is ERC721Enumerable, Ownable {
    ...
    constructor(uint256 _sales_start) ERC721("MetaZoo Games Token", "MZGT") {
        sales_end = _sales_start + 2 days;
    }
    ...
    string public localBaseURL =
        "https://metazoo-metadata-server.ether.cards/metadata/";
    ...
    function lockStatus() public view returns (bool) {
        return (sales_end >= block.timestamp);
    }
        ...
        returns (string memory)
    {
        ...
        return string(abi.encodePacked(_baseURI(), file, ".json"));
    }

    // https://metazoo-metadata-server.ether.cards/metadata/<id>.json
