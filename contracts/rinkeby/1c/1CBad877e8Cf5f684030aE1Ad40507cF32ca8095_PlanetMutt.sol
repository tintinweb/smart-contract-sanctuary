...
contract PlanetMutt is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    uint private constant maxPremintTokensPerTransaction = 5;
    ...
    string public _baseTokenURI = "https://planetmutt.s3.amazonaws.com/mint/";
    ...
    constructor() ERC721("PlanetMutt", "PLMUTT") {
    ...
    {
        //if (isLocked || !startingTimestampPassed() || endingTimestampPassed() || paused()) {
