...
contract IshidaMitsunariNFT is BaseERC721 {
    enum ProjectState {
        Prepare, //0
    ...
    constructor(string memory _tokenURI)
        ERC721("Revenge of the Ishida Mitsunari", "RIM")
    {
        _baseInit();
    ...
    function mint(
        ...
        require(
            ...
            "RIM: Sale is not started"
        );

        // each ticket can only be used once
        require(!_ticketUsed[_ticket], "RIM: ticket has already been used");
    ...
    function _mint(uint256 num) private {
        require(
            ...
            "RIM: Exceeds maximum supply"
        );
        require(msg.value >= (PRICE * num), "RIM: Not enough ETH was sent");
