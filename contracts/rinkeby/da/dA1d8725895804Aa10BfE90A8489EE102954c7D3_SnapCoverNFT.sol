...
contract SnapCoverNFT is ERC721URIStorage, ERC721Pausable, Ownable {
    ...
    constructor() ERC721("SNAP! Cover NFT", "SNAPCOVER1") {
        fee = 20000000000000000000; //20,000,000,000 SNAP!
    ...
    function mint(address wallet, uint numberOfMints) whenNotPaused public returns (uint256) {
        ...
        require(mintedTokens[wallet] <= 3, "You cant mint more than 3 for one wallet.");
