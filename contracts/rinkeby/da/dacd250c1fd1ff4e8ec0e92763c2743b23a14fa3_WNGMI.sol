...
contract WNGMI is Context, IERC20 {
    ...
    string private _name = "we're not going to make it";
    string private _symbol = "WNGMI";
    ...
    address payable private _marketingWallet = payable(0x8fBd19f9C029f06566c81b0D446A9508d9E8ab5A);
