    ...
    ERC721Enumerable
{
    ...
    //     // require( mint_balance[_msgSender()] < 10,        "Max mint per wallet is 10");
    ...
    //     _internal_mint(_msgSender(), num, supply);

    //     // mint_balance[_msgSender()] = num;
    // }
    ...
    //     require(tx.gasprice < _max_gas,                 "Please set lower gas price and retry"); // Set a cap on gas
    //     require( !_paused,                              "Mint is paused" );
    //     require( balanceOf(_msgSender()) < 10,        "Max mint per wallet is 10");
    ...
    // function _internal_mint(address to, uint256 num) internal virtual {
    //     uint256 supply = totalSupply();
    //     for(uint256 i; i < num; i++){
    //         _safeMint(to, supply + i );
    //     }
