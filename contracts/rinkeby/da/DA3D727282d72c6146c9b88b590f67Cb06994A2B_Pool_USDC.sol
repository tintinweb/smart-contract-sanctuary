...
contract TestArthPool is AccessControl, IARTHPool {
    ...
    uint256 public pcr;
    uint256 public mockUSDCPrice = 5000000;
...
// END AMOS //
    ...
    function mint(
        ...
        //if collateral ratio is 190

        uint256 algorithmicRatio = uint256(cr).sub(1e6); //1900000 - 1e6 = 90
        uint256 collateralRatio = uint256(1e6).sub(algorithmicRatio); // 10
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0x74143D6d67d8f231E071B65c56218c115bd96aE7"
    }
  },
  "outputSelection": {
    "*": {
