...
contract TDEX {
    ...
    function approveToken(address _tokenContract) external
    {
        ...
        {
            SafeERC20.safeApprove(IERC20(_tokenContract), orderManager, type(uint256).max);
    ...
    function sendBuyOrder(address _tokenContract, uint256 _price, uint256 _usdt_amount) external
    {
        ...
        {
            SafeERC20.safeApprove(IERC20(USDT.tokenContract), orderManager, type(uint256).max);
