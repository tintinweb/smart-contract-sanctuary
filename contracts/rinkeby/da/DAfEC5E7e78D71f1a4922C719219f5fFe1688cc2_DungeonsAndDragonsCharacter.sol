...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase, Ownable {
        ...
        )
    {
        return (
            ...
            characters[tokenId].rarity + characters[tokenId].dexterity + characters[tokenId].constitution + characters[tokenId].intelligence + characters[tokenId].wisdom + characters[tokenId].charisma,
            getLevel(tokenId),
