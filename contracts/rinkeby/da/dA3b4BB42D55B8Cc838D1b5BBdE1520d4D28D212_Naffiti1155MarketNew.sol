...
contract Naffiti1155MarketNew is ERC1155Holder {
    ...
    modifier isAuctionNotStartedByOwner(
        ...
        require(
            nftContractAuctions[_nftContractAddress][_tokenId][_listId]
                .nftSeller !=
                //            nftContractAuctions[_nftContractAddress][_tokenId][_listId].nftSeller !=
                msg.sender,
    ...
    {
        if (_lastListId >= _totalListId) {
            _totalListId = _lastListId;
        }
    ...
    //        increasePercentageAboveMinimum(_bidIncreasePercentage)
    {
        //        nftContractAuctions[_nftContractAddress][_tokenId][_listId].auctionBidPeriod = _auctionBidPeriod;
        //        nftContractAuctions[_nftContractAddress][_tokenId][_listId].bidIncreasePercentage = _bidIncreasePercentage;
        //        nftContractAuctions[_nftContractAddress][_tokenId][_listId].nftQuantity = _quantity;
        _createNewNftAuction(
            _nftContractAddress,
            _tokenId,
            _erc20Token,
    ...
    function setCurrentListId(uint256 _CurrentListId) external {
        _listId = _CurrentListId;
    }
