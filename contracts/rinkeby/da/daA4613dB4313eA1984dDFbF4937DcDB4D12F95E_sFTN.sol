...
contract sFTN is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Fortune", "sFTN", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFTN supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFTN
