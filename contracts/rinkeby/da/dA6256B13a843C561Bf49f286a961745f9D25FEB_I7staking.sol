...
contract I7staking is Ownable {
    ...
    address public constant tokenAddress = 0x40b785F06946D6A847A6b0e74513D8f01Df758fF;
    
    // reward rate 72.00% per year
    uint public constant rewardRate = 6000;
    uint public constant rewardInterval = 86400 seconds;
    ...
    uint public constant cliffTime = 120 seconds;
