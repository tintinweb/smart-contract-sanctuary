...
contract ERC1155Tradable is ERC1155MintBurn, Ownable {
    ...
    address constant public proxyRegistryAddress = 0xF57B2c51dED3A29e6891aba85459d600256Cf317;
    // Contract name
    string constant public name = "SLESS";
    // Contract symbol
    string constant public symbol = "SLESS";
...
contract ERC1155Metadata {
  ...
  string constant baseMetadataURI = "https://esqaqwr7po2punovuguae6nwzdfyewe3fk5ln4glbdfqekry47yq.arweave.net/JKAIWj97tPo11aGoAnm2yMuCWJsqurbwywjLAio45_E/";
...
contract AssetContract is ERC1155Tradable, ERC1155Metadata {
    ...
    uint256 constant MAX_TOKEN_ID = 1010;
        ...
        returns (string memory _uintAsString)
    {
        ...
        bytes memory bstr = "0000";
        uint256 k = bstr.length - 1;
