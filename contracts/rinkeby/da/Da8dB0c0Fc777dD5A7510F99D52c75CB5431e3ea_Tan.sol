...
contract Tan is
    ...
    bytes32 constant private merkleRootOG = 0xc7397944a552e73f86437f7a913d9cf5c8bd85056db2715a30936953c6902b53;
    bytes32 constant private merkleRootWL = 0xf6c54efaf65ac33f79611e973313be91913aaf019de02d6d3ae1e6566f75929a;
        ...
        returns (uint)
    {
        ...
        for (uint gen = 1; gen <= 7; gen++) {
            ...
            tmp += maxMintForGeneration(generation);
        }
        ...
        whenNotPaused()
    {
        ...
        if ((mintCounter[nextGeneration] >= maxMintForGenerationBeforeClosing(nextGeneration)) && (state == StateType.GENERATIONSTARTED)) {
            changeState(StateType.GENERATIONSTARTED, StateType.GENERATIONCLOSING);
        }
    ...
    function changeStateGenerationClosed() internal virtual override
        generationBetween(currentGeneration, 2, 7)
