...
contract SAMOY is ERC20, ERC20Burnable, ERC20Capped, Ownable {
    ...
    bool public _disableSell = false;
    ...
    function disableSell (bool status) public virtual onlyOwner {
        require(_disableSell != status, "already set to this status");
        _disableSell = status;
    }

    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        if(_disableSell) {
            require(to != _uniswap, "sell is not allowed yet");
        }
     }
}
