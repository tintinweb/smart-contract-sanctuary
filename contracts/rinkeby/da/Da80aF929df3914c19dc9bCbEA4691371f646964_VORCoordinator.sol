...
contract VORCoordinator is Ownable, ReentrancyGuard, VOR, VORRequestIDBase {
    ...
    event SetBaseGasRate(address indexed sender, uint256 oldBaseRate, uint256 newBaseRate);

    event GasRefundedToProvider(bytes32 indexed requestId, address indexed consumer, address indexed provider, uint256 amount);
