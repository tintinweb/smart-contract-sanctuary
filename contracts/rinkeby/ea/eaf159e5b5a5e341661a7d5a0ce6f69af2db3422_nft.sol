...
contract nft is ERC721, Ownable {
	...
	uint public constant mintCost = 0.06 ether;
	...
	address payable public constant shareholder1 = payable(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2);
	address payable public constant shareholder2 = payable(0x5c6B0f7Bf3E7ce046039Bd8FABdfD3f9F5021678);
	address payable public constant shareholder3 = payable(0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db);
	address payable public constant shareholder4 = payable(0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db);
	address payable public constant projectWallet = payable(0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db);
	address public constant marketingAccount = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    ...
    */
    ...
    function mint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v, _r, _s) public payable {
        require(msg.value == mintCost * number, "Not sufficient ether to mint this amount of NFTs (Cost = 0.06 ether for each NFT)");
    ...
    function initalMint() internal {
        for (uint256 i = 0; i < 66; i++) {
            uint256 tid = tokenId();
            _safeMint(marketingAccount, tid);
            mintsPerAddress[marketingAccount] += 1;
        }    
    }
    ...
    function withdrawAll() public {
        ...
        withdraw(shareholder1, ((balance * 20) / 100));
        withdraw(shareholder2, ((balance * 20) / 100));
        withdraw(shareholder3, ((balance * 20) / 100));
        withdraw(shareholder4, ((balance * 20) / 100));
        withdraw(projectWallet, ((balance * 20) / 100));
    }
