...
// End Set functions //
    ...
    function redeem(
        ...
        uint256 fullAmount = calcCr(arthAmount, _arthController.getGlobalCollateralRatio());
       ...
       lastRedeemed[msg.sender] = block.number;
        ...
        mintersDetails[msg.sender].amount = mintersDetails[msg.sender].amount.sub(fullAmount.mul(1e12));
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0xef83dAE9562199493D63bd962f9D5D103528C98D"
    }
  },
  "outputSelection": {
    "*": {
