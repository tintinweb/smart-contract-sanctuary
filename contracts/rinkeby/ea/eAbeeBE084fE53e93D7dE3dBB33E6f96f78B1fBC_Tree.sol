...
contract Tree is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    returns (string memory)
  {
    ...
    output = string(
      abi.encodePacked(
        '<svg height=1000 width=1000 xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink><rect height=1000 style=fill:#000 width=1000></rect><defs><g id=stem><line stroke-width=0.1 x1=0 x2=0 y1=0 y2=-0.7></line></g><g id=bubbles><circle cx=0 cy=-0.7 r=0.05></circle><circle cx=0 cy=0 r=0.05></circle></g>',
        output,
