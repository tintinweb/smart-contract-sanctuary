...
contract BinaryOptions is Ownable, Pausable, Oracle {
    ...
    function bidLong(uint256 bids) public payable whenNotPaused {
        ...
        longBid++;
        eventReceiveFunds("bid long called", msg.sender, msg.value);
        eventLongBid("Long Bid Invoked");
    }
    ...
    function bidShort(uint256 bids) public payable whenNotPaused {
        ...
        shortBid++;
        eventReceiveFunds("bid short called", msg.sender, msg.value);
        eventShortBid("Short Bid Invoked");
    }
    ...
    receive() external payable {
        ...
        eventReceiveFunds("receive fnction called", msg.sender, msg.value);
    }
}
