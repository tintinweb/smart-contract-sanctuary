...
contract Enzyme is ERC721Enumerable, Ownable {
    ...
    //address
    address _owner;
    address _enzyme = 0x8A5577Eb9A3Aa8a9800B7f1019afB33aa438AB99;

    constructor() ERC721(nftName, code) {
        _owner = msg.sender;
    }
 ...
 \___/   \_/\_/  |__|__||_____||__|\_|    |__|    \__,_||__|__|\____| |__|  |____|\___/ |__|__| \___|
    ...
    */
    ...
    function withdrawFunds() public onlyOwner {
        ...
        payable(_enzyme).transfer(balance/2);
    ...
    function giveAwayReserved(address _to, uint256 _amount) public onlyOwner {
        require( _amount <= RESERVED, "Exceeds reserved supply" );
        RESERVED -= _amount;
