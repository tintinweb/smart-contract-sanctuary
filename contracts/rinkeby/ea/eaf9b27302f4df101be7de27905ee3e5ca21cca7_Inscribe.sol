...
interface InscribeMetaDataInterface {
    ...
    /**
     * @dev Emitted when a URI has been deleted.
     */
    event InscriptionURIDeleted(uint256 indexed URIId, string indexed baseURI);
     ...
     * 
     * The URIId of the empty URI ("") is 0
     * 
    ...
    /**
     * @dev Removes a URI from the contract state
     *
     * Requirements:
     *
     * - `URIId` must exist.
     ...
     * 
     * Emits a {InscriptionURIDeleted} event.
     */
    function removeInscriptionURI(uint256 URIId) external;
...
contract InscribeMetadata is InscribeMetaDataInterface {
     ...
     */
    function addInscriptionURI(string memory baseURI) external override {
    ...
    /**
     * @dev See {InscribeMetaDataInterface-removeInscriptionURI}.
     */
    function removeInscriptionURI(uint256 uriId) external override {
        ...
        emit InscriptionURIDeleted(uriId, _baseURIMapping[uriId].baseURI);
        delete _baseURIMapping[uriId];
    }
