...
contract BineERC20 is Ownable, ERC20 {
    using SafeMath for uint256;

    uint256 internal amountFarm = 0;
    uint256 private farmReward;

    uint256 public tokenForMarketing = 2 * 10**6 * 10**18;
    ...
    function setMinTokensBeforeSwap(uint256 _tokenForMarketing)
        ...
        onlyOwner
    {
        require(_tokenForMarketing < 20 * 10**6 * 10**18);
...
contract Binemon is BineERC20, ReentrancyGuard {
    using SafeMath for uint256;
