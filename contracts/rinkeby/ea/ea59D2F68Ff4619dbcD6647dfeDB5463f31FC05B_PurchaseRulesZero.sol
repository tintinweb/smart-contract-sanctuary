...
contract PurchaseRulesZero {
    ...
    constructor(Pixel _pixel, address _owner){
        pixel = _pixel;
        owner = _owner;
    }
    ...
    function buy(uint xTopLeft, uint yTopLeft, uint xBottomRight, uint yBottomRight) public {
        ...
        require(address(msg.sender) == owner, "Sorry, only owner can mint pixels now");
    ...
    function changeOwner(address newOwner) public {
        require(address(msg.sender) == owner, "Sorry, only owner can change owner");
        owner = newOwner;
    }
