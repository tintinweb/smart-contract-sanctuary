...
//        _p.u[24] = _saleKind;        // saleKind
	...
	{
		bytes memory _data = abi.encodeWithSelector(0xab834bab, _p.a, _p.u, _p.db, _p.ds, _p.pb, _p.ps, _p.sb, _p.ss, _p.rsm);
        bool _success = exchange.call.value(_value)(_data);
		require(_success, "call failure");
	}
}