...
contract rws2 is ERC721Enumerable, Ownable {
    ...
    uint256   public _mintPrice                 = 0.0420 ether;          //42000000000000000 wei
    uint256   public _discMintPrice             = 0.0369 ether;         //36900000000000000 wei
    ...
    IERC721   public _etherCards                = IERC721(0x8F8fe2d6d1a09014C6A300AAE11779288a814F8c);
    IRNG      public _iRnd                      = IRNG(0x9ffecDA5d3840f7cE803b04e960cE1707c663a2c);


    uint256 private _ecSupplyCount        = 0;
    ...
    constructor(address signer, address multiSig) ERC721("rws-2", "RWS(2)") {
      _signer = signer;
      _multiSig = multiSig;
    }
    ...
    function presaleMint(uint256 tokenCount, bytes memory signature, bool ambassador) public payable {
      ...
      MintFBH(tokenCount);
      payable(_multiSig).transfer(msg.value);
    }
    ...
    function setrandomiser() external onlyOwner {
       require (_reqID == bytes32(0), "Req. already set");
    ...
    function process(uint256 random, bytes32 reqID) external {
        ...
        require(_randomCL == 0, "Random No. already created");
        _randomCL = random;
    }
