...
// import "./ReflectionsMetadata.sol";

/*
- Claimable by deviated corruptions only
- One mint per deviated corruption
- Mint fee of 0.064 ETH
- Proxy insight scores from original contract
...
contract Reflections is ERC721Enumerable, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        return
            ICorruptionsMetadata(metadataAddress).tokenURI(
                tokenID,
                insight(tokenID)
            );
    }
