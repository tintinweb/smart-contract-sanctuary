...
contract GameERC20Treasure is Ownable, Pausable {
    ...
    function upChain(
        ...
        require(verify(msg.sender, address(this), token, _amount, _nonce,  _signature), "sign is not correct");
    ...
    function verify(
        ...
        return isSigner(signatureWallet(_wallet, _this, _token, _amount, _nonce, _signature));
    }
    ...
    function signatureWallet(
        ...
        bytes32 hash = keccak256(abi.encode(_wallet, _this, _token, _amount, _nonce));
