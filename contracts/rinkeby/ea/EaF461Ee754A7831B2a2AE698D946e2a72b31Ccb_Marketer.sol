    ...
    PaymentRecipient
{
    ...
    function initialize(address nftAddress_, address wyvernExchange_, address openSeaWallet_, address proxyRegistryAddress) public initializer {
        ...
        //address proxy = WyvernProxyRegistryInterface(proxyRegistryAddress).registerProxy();
    ...
    ) public virtual isDirectory()
    {
        ...
        //address proxyAdd = WyvernProxyRegistryInterface(proxy).registerProxy();
        SampleNFTContract(nftAddress).approve(approveTo, tokenId);
        //SampleNFTContract(nftAddress).setApprovalForAll(address(this), true);
        ...
        }
        {
            uints = [
                // Maker Relayer Fee
                250, // TODO get relayer fee from param (could be unique's 5% fee)
                // Taker Relayer Fee
                zero,
                // Maker Protocol Fee
