...
contract AmuletPriceProviderBase is Ownable {
    ...
    function setPriceFeedProvider(address _token, address _provider, OracleType _providerType)
        ...
        onlyOwner 
    {
        _setPriceFeedProvider(_token, _provider, _providerType, WETH);
    }
        ...
        onlyOwner 
    {
        ...
        for (uint8 i = 0; i < _token.length; i++) {
            _setPriceFeedProvider(_token[i], _provider[i], _providerType[i], WETH);
        } 
     
    }

    function _setPriceFeedProvider(address _token, address _provider, OracleType _providerType, address WETH)
        internal
    {
...
// File: AmuletPriceProviderRinkeby.sol

contract AmuletPriceProviderRinkeby is AmuletPriceProviderBase {

    constructor(address _weth) AmuletPriceProviderBase(_weth) {
        _setPriceFeedProvider(0x5Adab1014646a2F9b3C61A15724EA97972b8f456, 0x67455d2f55D735dc9ab9a0628833834eB22d5C7f, OracleType.Uniswap,   _weth); // DUNG v19
        _setPriceFeedProvider(0x8B781cD4DA77E706fFDf86f7DB978645dDA83901, 0x24BA6AC002f3d43b07066EFfb4155d5FA5C59608, OracleType.SushiSwap, _weth); // DUNG v18 SushiSwap
        _setPriceFeedProvider(0xECe365B379E1dD183B20fc5f022230C044d51404, 0xECe365B379E1dD183B20fc5f022230C044d51404, OracleType.ChainLink, _weth); // BTC-USD
    }
}