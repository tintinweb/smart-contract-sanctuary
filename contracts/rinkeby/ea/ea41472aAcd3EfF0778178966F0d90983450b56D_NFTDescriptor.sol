...
library MultiPartRLEToSVG {
        ...
        returns (string memory svg)
    {
        ...
        return string(
            abi.encodePacked(
                '<svg width="100%" height="100%" viewBox="0 0 2400 2400" style="stroke-width:0;margin:auto;height:-webkit-fill-available" xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges">',
                '<rect width="100%" height="100%" fill="#', params.background, '" />',
                '<rect width="50%" height="50%" x="50%" y="50%" style="transform:translate(-25%, -25%)"><animate attributeName="fill" values="red;blue;red" dur="10s" repeatCount="indefinite" /></rect>',
