...
contract VestingFactory is Ownable {
    ...
    mapping(address=>address) public beneficiaryVsVesting;
        ...
        external
    {
        for (uint256 i = 0; i < beneficiaries.length; i++) {
            require(beneficiaryVsVesting[beneficiaries[i]] == address(0), "Beneficiary already vesting already added!!");
            ...
            beneficiaryVsVesting[beneficiaries[i]] = address(vesting);
            IERC20(token).transfer(address(vesting), amounts[i]);
        }
