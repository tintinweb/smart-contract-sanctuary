...
contract CloneTest2 {
    ...
    event GasNumber(string name,uint256 gasPrice);
    event GasPrice(string name,uint256 gasPrice);
    ...
    function cloneContract(address _v) public {
        ...
        emit GasNumber("cloneContract", gasNumber);
    }
    ...
    function newContract() public {
        ...
        emit GasNumber("newContract", gasNumber);
    }
    ...
    function setNewCloneNull() public {
        ...
        emit GasNumber("setNewCloneNull", gasNumber);
    }
}