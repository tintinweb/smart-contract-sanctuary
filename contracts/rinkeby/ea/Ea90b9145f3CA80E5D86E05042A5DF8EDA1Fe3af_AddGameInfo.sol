...
// Key: gameListId
    ...
    GetAnswerInterface getAnswerContract = GetAnswerInterface(GetAnswerInterfaceAddress);
    ...
    address GenerateBadgeInterfaceAddress = 0xD9985145179e6E1dCeFf7e6d52E2e3E87CD2d091;
...
// 3.5
    function makeOptions(int256 _questionId, int256 _gameId) public{
        if(_questionId == 1){
            ...
            gameList[_gameId].options = [0,1,2];
