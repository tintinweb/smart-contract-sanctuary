...
contract WnD is IWnD, ERC721Enumerable, Ownable, Pausable {
    ...
    // number of tokens that can be claimed for a fee: 25% of MAX_TOKENS
    uint256 public PAID_TOKENS;
    // number of tokens have been minted so far
    uint16 public minted;
    uint16 public numWizards;
    uint16 public numDragons;
    uint16 public numWizardsStolen;
    uint16 public numDragonsStolen;
    ...
    constructor(uint256 _maxTokens) ERC721("Contract2", "Contract2") {
        ...
        aliases[6] = [0];
        // wand
        rarities[7] = [243, 189, 50, 30, 225, 180, 80, 90, 155, 210, 222, 255];
        aliases[7] = [1, 7, 4, 2, 11, 11, 0, 10, 0, 0, 11, 4];
        // rankIndex
        rarities[8] = [255];
        aliases[8] = [0];
        ...
        aliases[11] = [0];
        // eyes
        rarities[12] = [90, 40, 219, 80, 183, 225, 40];
        aliases[12] = [1, 2, 3, 4, 5, 6, 5];
        // nose
        rarities[13] = [255];
        aliases[13] = [0];
        // mouth
        rarities[14] = [239, 244, 255, 234, 234, 234, 234, 234, 234, 234];
        aliases[14] = [1, 2, 2, 0, 2, 2, 9, 0, 5, 2];
        // wings
        rarities[15] = [80, 200, 144, 145, 80, 140, 120, 170, 50];
        aliases[15] = [1, 9, 0, 0, 3, 0, 3, 3, 5];
        // wand 
        rarities[16] = [255];
        aliases[16] = [0];
        // rankIndex
    ...
    */
    function mint(address recipient, uint256 seed) external override whenNotPaused disallowIfStateIsChanging {
    ...
    function transferFrom(
        ...
        // Hardcode the Tower's approval so that users don't have to waste gas approving
        if (_msgSender() != address(tower)) {
    ...
    */
    function selectTraits(uint256 seed) internal view returns (WizardDragon memory t) {    
        ...
        seed >>= 16;
        t.wings = selectTrait(uint16(seed & 0xFFFF), 6 + shift);
        seed >>= 16;
