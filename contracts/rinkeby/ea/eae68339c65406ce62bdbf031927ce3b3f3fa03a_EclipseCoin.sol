...
https://purgatorywear.com/pages/eclipsecoin
*/ 
...
Symbol: ECC
Decimals: 9 (I think)
Total supply: 161,803,398.87
 */ 


contract EclipseCoin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor () {
        ...
        _symbol = "ECC";
        _decimals = 18;
        _totalSupply = 161803398 * 10 **(_decimals);
