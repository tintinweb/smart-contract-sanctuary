...
contract ERC223Mintable is ERC223Token {
  ...
  function _mint(address _owner, uint256 amount) internal virtual override  {
    require(
      ERC223Token.totalSupply() + amount <= cap(),
      "ERC20Capped: cap exceeded"
    );
    super._mint(_owner, amount);
  }

  function mint(address _owner, uint256 amount) external {
    _mint(_owner, amount);
  }
