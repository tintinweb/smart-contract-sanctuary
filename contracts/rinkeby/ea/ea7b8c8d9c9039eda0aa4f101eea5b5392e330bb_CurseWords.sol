...
contract CurseWords is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        uint256 randomX = seed % 69;
        uint256 randomY = seed % 300 + 20;
        // uint256 randomAuxX = seed % 42 + 30;
        // uint256 randomAuxY = seed % 150 + 69;
        ...
        parts[3] = string(abi.encodePacked('</text><text x="10" y="', uint2str(randomY), '" class="aux">'));
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked(
            ...
            toString(tokenId), 
            '", "description": "Empty Curses (for Assholes) are randomly generated, minimally artistic curse words generated on-chain. They do nothing...?\nBTW did I mention this is all generated on-chain? Look at the contract. I know you nerds love that shit.", ', 
            metadata, 
    ...
    function claimFreeEmptyCurse(uint256 tokenId) public nonReentrant {
        require(tokenId > 0 && tokenId < 2610, "Token ID invalid");
    ...
    constructor() ERC721("Empty Curse", "MTCRS") Ownable() {}
}
