...
contract YungApes is Ownable, ERC721 {
  ...
  function mint(uint numberOfTokens) external payable {
    ...
    require(mintedByAddress[msg.sender] + numberOfTokens <= mintLimitPerAddress, "You don't have enough mints left for this many tokens for this address");
  ...
  function mintInternalPresale(address wallet, uint tokenId) internal {
    ...
    for(uint256 _index; _index < tokenIdsOfAddresses[wallet].length; _index++){
      if(tokenId == tokenIdsOfAddresses[wallet][_index]){
