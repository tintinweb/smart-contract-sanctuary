...
contract LazyBonk is ERC721Enumerable, Ownable, AccessControl {
    ...
    string private _currentBaseUrl = "";
  ...
  function setPreMintRoleBatch(address[] calldata _addresses) external onlyRole(WHITE_LIST_ROLE) {
    ...
    function mintByNumber(uint256 index) public onlyOwner {
    ...
    function addToPreMint(address addr) public onlyOwner {
        _pre_sale_minters[addr] = true;
    }
