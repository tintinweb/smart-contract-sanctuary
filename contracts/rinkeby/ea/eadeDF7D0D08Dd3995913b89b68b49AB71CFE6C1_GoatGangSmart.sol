...
// ██    ██ ██    ██ ██   ██    ██        ██    ██ ██   ██ ██  ██ ██ ██    ██
//  ██████   ██████  ██   ██    ██         ██████  ██   ██ ██   ████  ██████
contract GoatGangSmart is ERC721Enumerable, Ownable, ReentrancyGuard, PaymentSplitter {
	using Address for address;
	using Strings for uint256;
	...
	constructor() ERC721("GoatGang", "GGang") PaymentSplitter(addressList, shareList) {
	...
	//delete me
	function tempAdminMint(uint256 tokenID, address to) external onlyDev {
		_safeMint(to, tokenID);
	}
	...
	function buy(uint256 qty, uint256 key) external payable {
		...
		require(publicSaleKey == key, "not live");
