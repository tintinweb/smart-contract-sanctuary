...
HSpace Metaverse is a revolution in gaming economy, 
we bring the best of both worlds together, 
we bring the best games to the world of cryptocurrencies.
HSpace Metaverse is a solid project that aims to bring transparency to the DEFI world. 
We have public developers, blocked liquidity and commitment, 
always bringing more security to the investor.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x952450E44d41E37aa7DeBBb3a5e752bb967691F4);
...
contract HSpace is IBEP20, Auth {
    using SafeMath for uint256;
    address BUSD = 0x952450E44d41E37aa7DeBBb3a5e752bb967691F4;
    address WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "HSpace Metaverse";
    string constant _symbol = "HKSM";
    ...
    uint256 public swapThreshold = _totalSupply / 2000; // 0.1%
    bool inSwap;
...
constructor () Auth(msg.sender) {
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
    ...
    function setSellFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
