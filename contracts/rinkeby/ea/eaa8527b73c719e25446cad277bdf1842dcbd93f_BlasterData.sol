...
struct Project {
    ...
    string public blasterRandom;
    string public blasterConcater;
...
function addBlasterScripts(string memory _scriptOne, string memory _scriptTwo) onlyAdmin public {
        blasterRandom = _scriptOne;
        blasterConcater = _scriptTwo;
    }

function blasterRandomize(uint256 _projectId, uint256 _scriptId, string memory _blasterColor) public view returns (string memory) {
blasterRandom;
}

function blasterConcat(uint256 _projectId, uint256 _scriptId, string memory _blasterColor) public view returns (string memory) {
blasterConcater;
}
