...
contract DSNFT is ERC721URIStorage {
    ...
    event TokenCreated(uint256 indexed newItemId, address tokenCreater);
    ...
    ) ERC721("Dimond Swap Non-Fungible Token", "DSNFT") {
    ...
    function createToken(
        ...
        // Save ticket show
        TicketItem memory ticket = TicketItem(
            newItemId,
            mintingDate,
            showName,
            artistName,
        ...
        // Create event
        emit TokenCreated(newItemId, msg.sender);
        
        return newItemId;
    }
    
     // Burn tokenId by Owner
