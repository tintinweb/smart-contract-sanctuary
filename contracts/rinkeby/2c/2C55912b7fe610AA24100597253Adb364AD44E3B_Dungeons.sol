...
/// @title COSMO MAPS ERC-721 token

/*****************************************************
0000000                                        0000000
0001100     COSMO MAPS                         0001100
0001100     9000 generative on-chain dungeons  0001100
0003300                                        0003300
*****************************************************/

/* COSMO MAPS is an onchain map generator that produces an infinite set of dungeons.
...
Cosmo Maps are free to use however you want.
...
contract Dungeons is IDungeons, ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    CharacterCard internal lootContract;
    ...
    /* Write Functions */
    /**
    * @dev Allow a user to claim/mint this token if they hold the CharacterCard. Accepts a single tokenId uint256.
    *       e.g. claim(43)
    */
    function claim(uint256 tokenId) override public payable nonReentrant {
        require(tokenId > 0 && tokenId < 7778, "Token ID invalid");
        require(!restricted || lootContract.ownerOf(tokenId) == msg.sender, "Not your CharacterCard");
    ...
    /**
    * @dev Allow a user to claim many tokens as they hold Character Card. Accepts an array of uint256 token Id's.
    ...
    */
    function claimMany(uint256[] memory tokenArray) override public payable nonReentrant {
        for(uint256 i=0; i < tokenArray.length; i++) {
            ...
            require(!restricted || lootContract.ownerOf(tokenArray[i]) == msg.sender, "Not your Character Card");
    ...
    */
    ...
    /**
    * @dev Allows anyone to claim #1-7777 (e.g. after initial Character Card owner claim period)
    */
    ...
    */
    ...
    constructor(CharacterCard _lootContract, IDungeonsRender _render, IDungeonsGenerator _generator, IDungeonsSeeder _seeder) ERC721("COSMO MAPS", "COSP") Ownable() {
...
/// @title Interface for COSMO MAPS
