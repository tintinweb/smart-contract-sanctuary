...
contract dogeIncubator is Ownable, IERC1155Receiver, VRFConsumerBase {
    ...
    // encodedDoge => tokenId
    mapping(bytes2 => uint256) public dogeIdByTraits;
    uint256 public dogeIdByTraitsLength = 0;
    ...
    */
    ...
    function hatchEgg() public {
        ...
        require(dogeIdByTraitsLength > 0, "The incubator is not ready yet");
    ...
    function finishHatchingEgg(bytes32 requestId, uint256 randomNumber) private {
        ...
        uint256 randomDoge = randomNumber % (availableDoges.length-1);
        ...
        IERC1155(dogeAddress).mint(hatcher, dogeIdByTraits[pickedDoge], 1, "");
    ...
    function setDogeIdByTraits(bytes2[] memory _traits, uint256[] memory _tokenIds) public onlyOwner {
        for (uint256 i = 0; i < _traits.length; i++) {
            dogeIdByTraits[_traits[i]] = _tokenIds[i];
            dogeIdByTraitsLength++;
        }
    }
