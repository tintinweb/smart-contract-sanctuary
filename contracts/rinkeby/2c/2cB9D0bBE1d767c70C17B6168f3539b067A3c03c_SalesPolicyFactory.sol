...
contract SalesPolicy is EIP712MetaTransaction("BuyPolicyMetaTransaction", "1"), ERC1155Supply, ISalesPolicy, ReentrancyGuard {
    ...
    function buyPolicy(
        ...
        address _signer = getSender(_policyPriceInUSDT, _coverageDuration, _coverageAmount, _signedTime, _premiumCurrency, r, s, v);
    ...
    function getSender(
        ...
        bytes32 msgHash = keccak256(abi.encodePacked(_policyPrice, _coverageDuration, _coverageAmount, _signedTime, _premiumCurrency));
