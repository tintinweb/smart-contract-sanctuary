...
contract Saja is Context, IERC20, Ownable {
    ...
    address public _marketingWallet = 0x9934AA2AF6604aD463afD2a9F5e0C24b84481268;
    address public _donationWallet = 0x6780313D958B535BB103386919a02c835207f2a0;
    ...
    function setFees (uint256 taxFee, uint256 marketingFee, uint256 donationFee, uint256 burnFee) external onlyOwner {
        _taxFee = taxFee;
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        uint donationFee = amount * _donationFee /100;
        ...
        if(donationFee > 0) {
            _tokenTransfer(from, _donationWallet, donationFee, takeFee);
        }
