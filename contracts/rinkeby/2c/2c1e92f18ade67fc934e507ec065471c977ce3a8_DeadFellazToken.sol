...
// File contracts/DeadFellazToken.sol
...
contract DeadFellazToken is Ownable, ERC721Enumerable {
  ...
  uint public remainingPrizeMints = 100;
  uint public remainingPublicMints = 10_000 - remainingPrizeMints;
  string public constant contractURI = "https://ipfs.io/ipfs/QmdUf9eYuXxmKuE34ZLNzzghD9gyUE8HEknrbgPLMbfBQU";
  ...
  function mint(uint amount) public payable {
    ...
    if (isOwner) {
      require(remainingPrizeMints - amount >= 0, "DeadFellazToken: Not enough prize mints remaining");
      remainingPrizeMints = remainingPrizeMints - amount;
    } else {
      require(remainingPublicMints - amount >= 0, "DeadFellazToken: Not enough mints remaining");
      remainingPublicMints = remainingPublicMints - amount;
    }

    uint currentTotalSupply = totalSupply();
    require(currentTotalSupply + amount <= MAX_SUPPLY, "DeadFellazToken: Mint amount exceeds total supply");
  ...
  function _baseURI() internal override view returns (string memory){
    return "https://ipfs.io/ipfs/QmZqi1cq2cCnZrzZFKZJwiaJkj98XerMRowoP1PfLtJB3q/";
  }
