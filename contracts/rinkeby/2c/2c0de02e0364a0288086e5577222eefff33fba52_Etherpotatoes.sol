...
contract Etherpotatoes is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateEtherpotatoes(uint256 indexed id);
	
    constructor(string memory baseURI, address payable creator) ERC721("Etherpotatoes", "Etherpotatoes") {
        setBaseURI(baseURI);
