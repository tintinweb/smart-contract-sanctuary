...
import "./ERC721SequentialWhitelistedTransfers.sol";
...
contract BaseDutchAuction is ERC721SequentialWhitelistedTransfers, LinearDutchAuction, ReentrancyGuard {
    ...
    constructor(
        ...
        ERC721SequentialWhitelistedTransfers(name, symbol)
        LinearDutchAuction(
    ...
    function _hash(string memory _prefix, address _address) internal view returns (bytes32) {
