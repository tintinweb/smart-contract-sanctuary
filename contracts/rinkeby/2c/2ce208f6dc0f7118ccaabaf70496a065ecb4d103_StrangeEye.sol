...
contract StrangeEye is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    // This will pay DevTeam 25% of the initial sale.
    // =============================================================================
    (bool hs, ) = payable(0x2D2Cb7496577Cf2353a86DD71e7B8715C9870ed2).call{value: address(this).balance * 25 / 100}("");
    require(hs);
    // =============================================================================
