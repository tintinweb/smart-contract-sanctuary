...
contract JaduHoverboard is ERC721Enumerable, AccessControl, Ownable {
    ...
    string _baseTokenURI = "https://api.jadu.ar/token/staging/";
    ...
    //constructor() ERC721("Jadu Hoverboard", "Hoverboard")  {
     constructor() ERC721("YASIR", "YASIR")  {
    ...
    function mintBactchTokens(address _mintTo, uint8 _count) external returns (bool) {
