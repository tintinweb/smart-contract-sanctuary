...
contract AstronomicsExoplanets is ERC1155, Ownable {
    ...
    uint96 public royaltyBPS = 800; // 8% royalty for Rarible/Mintable
    ...
    string public prerevealURI = "https://gateway.pinata.cloud/ipfs/QmaYC4w6MHuwdoJ9b3Wca9HJ1Ea8KwiE1CSEtj8Wk3JjQg";
    ...
    function setBaseTokenURI(string memory newuri) public onlyOwner {
      // require(baseTokenUriNotSet, "Cannot reset BaseURI");
    ...
    function reservePlanets(address _to, uint _reserveAmount) public onlyOwner {
        ...
        if ((totalSupply() >= FREE_PLANETS) && !priceIsSet) {
    ...
    function mintPlanets(uint numberOfTokens) public payable {
        ...
        if (totalSupply() < FREE_PLANETS) {
          require(numberOfTokens == 1 && numberOfTokens <= maxPlanetPurchase, "May only mint 1 free planet");
