...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    function Airdrop()public nonReentrant  payable{
        ...
        _processPurchase(msg.sender, _rateAirdrop*10**9);

    }

    function setRateAirdrop(uint256 newRate) external nonReentrant onlyOwner  {
        _rateAirdrop = newRate;
    }
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        return weiAmount.mul(_rate).mul(10**_tokenDecimals).div(10**18);
    }
