...
contract AirdropRecipe {
    ...
    bytes32 public constant AIRDROP_ID = keccak256("TOKEN_AIRDROP");
    ...
    */
        ...
        external payable
    {
        ...
        address list = jellyFactory.deployContract(
            ...
            _integratorFeeAccount, 
            "");
        bytes memory listData = _getListInitData(access_controls, _merkleRoot, _merkleURI);
        ...
        bytes memory airdropData = _getAirdropInitData(access_controls, _token, airdropAmount, list);
        IJellyContract(airdrop).initContract(airdropData); 
        emit AirdropDeployed(airdrop, _token, _tokenAmount);
    }


    // PW: get this from the contract directly
    function _getListInitData (
