...
// Bond Constant Value -> Bond Control Variable
  ...
  function calculateBondInterest( address treasury_, address principleTokenAddress_, uint amountDeposited_, uint bondConstantValue_ ) external override returns ( uint interestDue_ ) {
