...
contract RedeemNFT is ERC1155, AccessControl, Ownable, IRedeemNFT {
    ...
    bool private redeemActive = true;

    constructor(address initialSignerAddress)
