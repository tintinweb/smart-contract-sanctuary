...
contract TCA is ERC721, Ownable, ERCWithdrawable {
    // Constructor
    ...
    function publicMint(uint16 amount) external payable onlySender publicSale {
        require(amount <= 5, "Max 5 mints per transaction");
        require(addressToPublicMinted[msg.sender] < 30, "Max 30 mints per account!");
