...
contract SmartContract {
     ...
     string public encryptionPrivateKey;
   ...
   function setEncryptionPrivateKey(string _myEncryptionPrivateKey) onlyBy(owner) checkBlockLock() returns(bool) {
        encryptionPrivateKey = _myEncryptionPrivateKey;
