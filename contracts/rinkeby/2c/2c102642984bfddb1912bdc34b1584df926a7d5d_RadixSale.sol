...
contract RadixSale is Ownable, Pausable {
    RadixNft public nftAddress;
    ...
    constructor(address _nftAddress, uint256 _currentPrice) public {
        ...
        nftAddress = RadixNft(_nftAddress);
    ...
    function purchaseToken(uint256 _tokenId) public payable whenNotPaused {
        require(msg.sender != address(0) && msg.sender != address(this), "msg.sender != address(0) && msg.sender != address(this)");
        require(msg.value >= currentPrice, "currentPrice");
        require(nftAddress.exists(_tokenId), "exists");
