...
abstract contract ArcadeBaseCollection is Ownable, ERC721Enumerable {
     ...
     */
    function getGameKey(string memory _gameId) public view onlyAllowed returns (bytes32) {
    ...
    */
    function getIssued(string memory _gameId) external view onlyAllowed returns (uint256) {
