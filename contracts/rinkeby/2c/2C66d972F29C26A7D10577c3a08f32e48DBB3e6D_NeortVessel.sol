...
contract NeortVessel is iNeortVessel, ERC721, ReentrancyGuard, Ownable {
    ...
    function generateMetadataJson(uint256 tokenId) public view returns (string memory) {
        ...
        parts[21] = '"attributes":[ { "trait_type":"Artist", "value":"NIINOMI" }, { "trait_type":"License", "value":"Attribution-NonCommercial-ShareAlike 3.0 Unported (CC BY-NC-SA 3.0)" } ],';
