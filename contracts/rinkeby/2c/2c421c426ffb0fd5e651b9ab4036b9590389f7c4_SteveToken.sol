...
contract SteveToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "Steve";
    string  public constant symbol = "STFC";
    ...
    uint256 public tokenExchangeRate = 625;             // 625 Steve 兑换 1 ETH
