...
contract Escrow is Migratable {
    ...
    returns (uint256) {
        ...
        uint256 daiValueInEscrow1 = getPaprPrice().div(1e18).mul(_amount.div(1e18));
        uint256 daiValueInEscrow = daiValueInEscrow1.mul(1e18);
    ...
    returns (uint256) {
        ...
        uint256 totalPayoutCAN = escrows[_escrowId].totalValueDai.div(getPaprPrice());
