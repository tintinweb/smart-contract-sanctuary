	...
	function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
		...
		vikings.push(
			Viking(
				...
				// Sheild & Defence
				Stats((randomNumber % 10^6) / 10^4, (randomNumber % 10^8) / 10^6),
				// Boots & Speed
				Stats((randomNumber % 10^10) / 10^8, (randomNumber % 10^12) / 10^10),
				// Helmet and Intelligence
				Stats((randomNumber % 10^14) / 10^12, (randomNumber % 10^16) / 10^14)
				// Bottoms & Stamina
				// Stats((randomNumber % 10^18) / 10^16, (randomNumber % 10^20) / 10^18),
				// Body
				// (randomNumber % 10^22) / 10^20,
				// Face
				// (randomNumber % 10^24) / 10^22,
				// Beard
				// (randomNumber % 10^26) / 10^24
			)
		);
