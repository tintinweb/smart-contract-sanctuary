...
contract LonelyAlienNFT is ERC721, PaymentSplitter, Ownable, Pausable {
    ...
    uint256 public constant MAXNFT = 10000 + 40 + 20;
    ...
    {
        api_entry = "https://raw.githubusercontent.com/darkacorn/test/master/";
    ...
    function getMultipleNFT(uint256 _howMany) public payable {
		require(_howMany <= _maxNftAtOnce, "max 10 cats at once");
    ...
    function mint(address to, uint256 id) private onlyOwner {
