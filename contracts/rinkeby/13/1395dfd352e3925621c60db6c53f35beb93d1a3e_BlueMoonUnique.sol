 ...
 */
contract BlueMoonUnique is ERC721, Ownable {
    using SafeMath for uint256;

    address public ownerWalletAddress;

    constructor() ERC721("BlueMoonUnique", "BMUNIQUE") public {
    ...
    * Mints BlueMoon
    */
    function mintUnique(address payable recipient, string memory uri) public payable returns (uint256) {
