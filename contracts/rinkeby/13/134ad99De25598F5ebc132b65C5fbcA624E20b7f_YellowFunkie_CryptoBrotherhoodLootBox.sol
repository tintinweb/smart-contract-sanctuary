...
contract YellowFunkie_CryptoBrotherhoodFactory is FactoryERC721, Ownable {
	...
	uint256 private itemsPerLootbox;
    ...
    constructor(address _proxyRegistryAddress, address _nftAddress, address _lootBoxNftAddress) {
   ...
   */
    ...
    function canMint(uint256 _optionId) override public view returns (bool) {
		...
		require ((_optionId < NUM_OPTIONS) && (factoryProduced < FACTORY_MAX_SUPPLY),  "Can't mint anymore through the factory");
		
				
		//reserve space also for the lootboxes that were not open
        uint256 creatureSupply = YellowFunkie.totalSupply() + itemsPerLootbox * YellowFunkieLootBox.totalSupply();
...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
   ...
   */
	...
	function setSpecialMintAddress(address _nftSpecialMintAddress) public onlyOwner{
		require(nftSpecialMintAddress == address(0));
