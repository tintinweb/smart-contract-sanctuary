...
contract PropositionToken is ERC721Enumerable, Ownable {
    ...
    uint public constant MAX_PROPOSITIONS = 5;
    ...
    function mint(string memory _proposition) public payable {
        ...
        // add protection against max length?
        ...
        // Proposition memory _prop = Proposition({
        //   proposition: propToLowercase
        // });
    
        // uint _propositionId = propositions.push(_prop) - 1;
    ...
    */
    ...
    // /* Returns string to bytes */
    // function generate(string memory prop) public view returns (bytes memory) {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        output = string(abi.encodePacked(output,'<text class="base" x="15" y ="15">',_proposition,'</text>'));
