...
contract Beta9 is Context, IERC20, Ownable {
    ...
    function setDev1(address payable Sales1) external onlyOwner() {
            _devWalletAddress1 = Sales1;
    }
    
    function setDev2(address payable Sales2) external onlyOwner() {
            _devWalletAddress2 = Sales2;
    }
