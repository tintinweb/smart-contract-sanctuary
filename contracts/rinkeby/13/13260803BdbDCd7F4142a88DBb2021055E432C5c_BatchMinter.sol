...
contract BatchMinter is ERC721Enumerable {
    ...
    function mint(uint256 amount) public payable {
        require(amount >= 1, "must mint more than 0");
        require(amount <= 30, "must mint fewer than 30");
        require(amount * price == msg.value, "must send correct ETH amount");
        
        uint256 firstMinted = _tokenIdTracker.current();
