...
contract DegenerativeArtV2 is AccessControlUpgradeable, ERC721BurnableUpgradeable, ERC721EnumerableUpgradeable, UUPSUpgradeable {
    ...
    // Missing ownable part:

    
    /**
     * @dev Initializes the contract setting the deployer as the initial owner.
     */
    function __Ownable_init() public onlyRole(DEFAULT_ADMIN_ROLE) {
