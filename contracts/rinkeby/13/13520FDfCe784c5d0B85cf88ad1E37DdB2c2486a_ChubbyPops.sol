...
contract ChubbyPops is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public _saleStartDate = 1639651200; // 24 Dec 2021 00:00 MSK or 23 Dec 2021 21:00 UTC

    address payable treasurer; // withdraw to
    uint256 public tokenPrice = 0.02 ether; // 40 matic
