...
* @author Niftydude
*/
contract AD is AbstractERC1155Factory, PaymentSplitter  {
    ...
    address[]  payees = [0xef968FeE8cA91fb9c3E8435Bd05A8EFEea155432];
    uint256[]  shares_ = [100];


    constructor() ERC1155("ADURI") PaymentSplitter(payees, shares_) {
        name_ = "AD";
        symbol_ = "AD";
