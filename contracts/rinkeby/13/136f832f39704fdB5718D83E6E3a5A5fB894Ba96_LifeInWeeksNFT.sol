      ...
      string memory json = Base64.encode(
          bytes(string(
              abi.encodePacked(
                  ...
                  '"description": "A display of your entire life, the rows designate the years, the columns are the weeks (52 weeks per year).",',
                  '"attributes":[{"trait_type":"Birth Year", "value":"',uintToString(birthyear),'"}],',
                  '"image_data": "', svg, '"}' 
              )
          ))
      );
