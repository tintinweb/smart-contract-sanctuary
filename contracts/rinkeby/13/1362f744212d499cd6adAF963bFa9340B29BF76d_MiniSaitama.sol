...
contract MiniSaitama is Context, IERC20, Ownable {
  ...
  string private _name = 'mini SAITAMA';
  string private _symbol = 'miniSAITAMA';
  uint8 private _decimals = 9;

  address public devAddress =
    address(0xEBdC249284a90B5A30e7b1c5DE2466aa79408F18);
  address public teamAddress =
    address(0x959a080EC80feC53E90cec092CebB031C4a7533e);
  address public marketAddress =
    address(0xF09655c88ED089f00b5883f7Ee905b2cbFfCA6E9);
  address public recoveryAddress =
    address(0x5C055672C7d26db291f2B3518db96124b5C470cd);

  uint256 public devFee = 15;
  uint256 public teamFee = 30;
  uint256 public marketFee = 20;
  uint256 public recoveryFee = 20;
  ...
  function setTeamFeePercent(uint256 fee) external onlyOwner {
    teamFee = fee;
  }
  ...
  function _transfer(
    ...
    if (
      ...
      uint256 totalFee = devFee.add(teamFee).add(marketFee).add(recoveryFee);
