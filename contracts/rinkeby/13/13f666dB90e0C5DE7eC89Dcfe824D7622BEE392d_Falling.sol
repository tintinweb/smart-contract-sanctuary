...
contract Falling is ERC721, ERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) external view override returns (string memory) {
        return "https://gist.githubusercontent.com/smatthewenglish/878ec2825e0e42fb2cd73a5e0b1a513f/raw/4bb1f9ac600efe69d6ff6a274456df84c38c82b3/falling.json";
    }
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        require(from == _owner, "ERC721: not yours to give away!");
