...
contract StakingErc721 is ReentrancyGuard, Pausable, Ownable {
  ...
  function initNftToken(uint256 _maxAmount) public onlyOwner {
  ...
  function stakeInternal(uint256 tokenId) internal {
    require(nftAccountBalances[msg.sender].add(1) <= maxAmount, "NFT max amount exceeded");
    ...
    nftAccountBalances[msg.sender] = nftAccountBalances[msg.sender].add(1);
    nftTokenBalances[tokenId][msg.sender] = 1;
