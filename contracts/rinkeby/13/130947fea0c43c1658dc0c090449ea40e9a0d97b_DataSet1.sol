...
// File: contracts\DataSet1.sol

contract DataSet1 is ERC721Mintable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("DataSet1", "DataSet1", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset1/metadata/token/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset1/metadata/contract/metadata.json";
    }
}