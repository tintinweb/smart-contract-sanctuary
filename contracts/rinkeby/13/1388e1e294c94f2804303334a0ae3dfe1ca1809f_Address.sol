...
contract CryptoPunksPortraits is ERC721Enumerable, Ownable {
    ...
    uint256 public constant CryptoPunksPortraitsPrice = 20000000000000000;
    uint public constant maxCryptoPunksPortraitsPurchase = 10;
    uint256 public constant MAX_CryptoPunksPortraits = 10000;
    uint public CryptoPunksPortraitsReserve = 100;
    ...
    constructor() ERC721("CryptoPunksPortraits", "MTL") { }
    ...
    function flipSaleState() public onlyOwner {
     ...
     function mintCryptoPunksPortraits(uint numberOfTokens) public payable {
        ...
        require(msg.value == CryptoPunksPortraitsPrice.mul(numberOfTokens), "Ether value sent is not correct");
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            if (totalSupply() < MAX_CryptoPunksPortraits) {
               ...
               saleIsActive = !saleIsActive;
                payable(msg.sender).transfer(numberOfTokens.sub(i).mul(CryptoPunksPortraitsPrice));
                break;
            }
        }
    }
