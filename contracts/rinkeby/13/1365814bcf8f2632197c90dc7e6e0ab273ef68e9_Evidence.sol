...
//Read Service ServiceHistory Start
  ...
  //function readServiceHistory(uint _vid) public view returns (ServiceHistoryVehicle[] memory){
    //ACCESS CONTROL owner OR law 
     ...
     //require((keccak256(abi.encodePacked((r.getRoles(msg.sender)))) == keccak256(abi.encodePacked(("6"))))||(keccak256(abi.encodePacked((r.getRoles(msg.sender)))) == keccak256(abi.encodePacked(("8"))))||(keccak256(abi.encodePacked((r.getRoles(msg.sender)))) == keccak256(abi.encodePacked(("2"))))) ;
