...
contract RidiculousRhinos is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    event rhinoBred(uint256 firstTokenId, uint256 secondTokenId, uint256 cookedDevilTokenId);
    ...
    */
    ...
    function BreedRhino(uint256 firstTokenId, uint256 secondTokenId) public {
        require(breedingIsActive && !saleIsActive, "Either sale is currently active or cooking is inactive");
