...
library StringHell {
    ...
    bytes32 internal constant json = 'data:application/json;base64,';
    ...
    function Json() external pure returns (bytes32){
        return json;
    }
}
/// ~~~~~~~~~~~~~      
...
contract UsrMessage is ERC721Tradable {
    ...
    // v1 connection code
    Message v1Contract;
    address thevoid = 0x0000000000000000000000000000000000000000;
    ...
    function populateV1Upgrades() public onlyOwner {
    ...
    bytes32 internal constant spanA = '<tspan x="40" dy="25">';
    bytes32 internal constant spanZ = '</tspan>';
    ...
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Usr Message", "MESSAGE", _proxyRegistryAddress)
    {}
...

{
  ...
  "libraries": {
    "/Users/sterlingcrispin/code/ConceptualLandscapesCONCEPT/Messages/contracts/DrawSvgOps.sol": {
      "DrawSvgOps": "0x2D9bf72651EA8aBaB385A48cB41f95b5f83C78CA"
    },
    "/Users/sterlingcrispin/code/ConceptualLandscapesCONCEPT/Messages/contracts/UsrMessage.sol": {
      "StringHell": "0xe1fdBd9Cbe0891aB85239BeeD50e1eC13C8bCB96",
      "v1ContractData": "0xBBe56a7a7286F6c9498e912c8DcD2d962d306A32"
    }
  },
  "outputSelection": {
    "*": {
