...
contract ClaimingRegistry is IClaimingRegistry, Initializable, AbstractDependant {
    ...
    uint256 internal constant ANONYMOUS_VOTING_DURATION_CONTRACT = 1200;
    uint256 internal constant ANONYMOUS_VOTING_DURATION_EXCHANGE = 1200;

    uint256 internal constant EXPOSE_VOTE_DURATION = 900;
    uint256 internal constant PRIVATE_CLAIM_DURATION = 1200;
