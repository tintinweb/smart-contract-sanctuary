...
contract TokenMarket is TokenMarketBase {
    ...
    */
     function createLoanOfferToken(TokenLoanData.LoanDetails memory loanDetails)
        ...
        require(ltv.div(1e18) > 125, "GLM: Can not create loan at liquidation level.");
        ...
        ) external view override returns(uint256) 
    {
        ...
        if(govPriceConsumerV3.isChainlinFeedEnabled(_altCoin) && govPriceConsumerV3.isChainlinFeedEnabled(_stableCoin)) {
                ...
                collateralAmountinStable = collateralAmountinStable.add(govPriceConsumerV3.getDexTokenPrice(uniswapDexFactory, _stableCoin, _altCoin, _collateralAmount));
                return collateralAmountinStable;
        } 
