...
// File: AdvnacedCollectible.sol

contract AdvnacedCollectible is ERC721Burnable, VRFConsumerBase {
    enum BREED {
        PUG,
        SHIBA_INU,
        ST_BERNARD
    ...
    constructor(
        ...
        bytes32 _keyHash,
        uint256 _fee
    ) public ERC721("Dogie", "DOG") VRFConsumerBase(VRFCoordinator, LINKToken) {
        keyHash = _keyHash;
        fee = _fee;
        owner = msg.sender;
        tokenIdCounter = 0;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness)
        ...
        override
    {
        address tokenOwner = requestIdToOwner[requestId];
