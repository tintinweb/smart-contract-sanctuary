...
contract SafuInvestmentsFactory {
    ...
    bytes32 public immutable uniswapRouterPairForCodeHash;

    constructor(
        address _safuInfoAddress,
    ...
    function createPresale(
        ...
        require(existingPairAddress == address(0) || token.balanceOf(existingPairAddress) == 0);
...
contract SafuInvestmentsLiquidityLock is TokenTimelock {
    ...
    ) public TokenTimelock(_token, _presaleCreator, _releaseTime) {}
}
