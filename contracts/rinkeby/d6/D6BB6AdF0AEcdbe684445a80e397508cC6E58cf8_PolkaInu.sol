...
// PolkaInu - Stealth launch - No TG, No Website, No Marketing
...
contract PolkaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "PolkaInu";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x340F4EEc1e16faFaF4d96a871c0697ccFb311295);
        _feeAddrWallet2 = payable(0x340F4EEc1e16faFaF4d96a871c0697ccFb311295);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(tradingOpen || from == uniswapV2Pair || from == owner() || to == owner(), "not able to trade");
