...
contract SVGNFT is ERC721URIStorage {
    ...
    constructor() ERC721("Shroom Chan NFT", "ShroomChan") {
        tokenCounter = 0;
    }
    ...
    // Not a view function because it is NOT reading anything from ETH chain
    ...
    function formatTokenURI(string memory _imageURI) public pure returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked('{"name": "Shroom Chan NFT", "description": "An NFT based on SVG", "attributes": "", "image": "', _imageURI, '"}')
                    )
                )
            )
        );
