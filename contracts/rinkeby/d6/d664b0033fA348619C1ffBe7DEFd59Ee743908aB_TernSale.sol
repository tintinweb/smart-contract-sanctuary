...
contract TernSale is ERC721Enumerable, Ownable {
    ...
    modifier onlySigned(bytes memory signature) {
        ...
        require(hash.recover(signature) == _signAddress, "418");
        _;
    }
    ...
    function mint(bytes memory signature) public payable onlySigned(signature) {
        ...
        require(tx.origin == msg.sender,        "400");
        require(saleState == true,              "412");
        require(supply + count <= MAX_ELEMENTS, "451");
        require(tokensMinted < MAX_MINT_COUNT,  "429");
        require(tx.gasprice <= gasPriceLimit,   "406");

        require(paymentToken.allowance(msg.sender, address(this)) >= amountToPay, "423");
        require(paymentToken.transferFrom(msg.sender, address(this), amountToPay), "402");
    ...
    function withdrawBalance() public payable onlyOwner {
        ...
        require(paymentToken.transferFrom(address(this), _withdrawAddress, _balance), "Oops");
    }
