// SPDX-License-Identifier: MIT
    ...
    contract AytacNFT is ERC721, Ownable, ERC721Enumerable {
      ...
      bool public saleIsActive = false; //Satis
      bool public presaleIsActive = false; //OnSatis
      bool public isRevealed = false; //Gizli
      ...
      constructor() ERC721("AytacNFT", "AYT") {}
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmPxsiX6pHKDKHzyDbAECM6YFCeFHFinwmE3B8PCsDfadG/hidden.json";
        }
