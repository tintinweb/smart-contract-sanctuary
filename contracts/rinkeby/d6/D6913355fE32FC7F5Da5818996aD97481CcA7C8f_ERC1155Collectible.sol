...
contract ERC1155Collectible is ERC1155, AccessControl, ERC1155Burnable {
    ...
    mapping (uint => bool) publicMintingAllowed;

    /**
     * @dev Require msg.sender to be the creator of the token id
     */
    modifier creatorOrApprovedOnly(uint256 _id) {
        require(creators[_id] == msg.sender || hasRole(MINTER_ROLE, msg.sender), "ONLY_CREATOR_OR_APPROVED");
        _;
    }
     ...
     */
    function publicMint(address account, uint256 id, uint256 amount, bytes memory data)
    public
    {
