...
contract BAYCBills is ERC721URIStorage {
  ...
  // mapping(uint256 => uint256) tokenIdToBoredApeId;
  // mapping(uint256 => uint256) tokenIdToBackground;
  ...
  function mintNFT(
    ...
    string memory generatedSvg = genSVG(tokenId, _svg0, _svg1, _svg2, _svg3, _bgColor);
