...
contract MechanizedPreSale is Ownable {
    ...
    uint256 public PRE_SALE_MINT_PRICE = 0.00000008 ether; //persale mint price: 0.01 ETH
    uint256 public MAX_PRE_MINT_PER_USER = 515; // maximum amount of tokens one address can mint  
    ...
    mapping(address => bool) public giveAwayClaimed;
     ...
     /** MERKLE */
    bytes32 public preSaleMerkleRoot = 0x59e76973acb75fc86b73dc016b45251c2dcf414e0327507b34529c36d064dbff;
    bytes32 public giveawayMerkleRoot = 0x4d00258fdc10d6530fc8c810957f76dbf0a69dab8b0247287fe3de0e3986063f;
