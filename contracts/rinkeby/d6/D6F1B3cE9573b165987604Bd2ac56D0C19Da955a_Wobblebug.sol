...
contract Wobblebug is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x435Cd3902d1b4f4E842F2C0fd5028EEE71dd099C).transfer(balance * 5 / 100);
        payable(0x0cB121E3e18c364F318A1FB97bd304e5855c8250).transfer(balance * 5 / 100);
        payable(0x927e093B623F90a0311C03009aA1D1DF4cf08634).transfer(balance * 20 / 100);
        payable(0x0048D02963b97445a012Ad6D44Bd38A0239C5B88).transfer(balance * 20 / 100);
        payable(0x491dc513212E0b896690B6Fb4483929f0Abde975).transfer(balance * 20 / 100);
        payable(0x0f075aC7186A8D43c1b6A819B5BCEff7c936d7Cf).transfer(balance * 12 / 100); // owed .5
        payable(0xe1Db3822239a27451b68a0cfFC19a9160EE36f75).transfer(balance * 17 / 100); // owed .5

        // the contract will have 1% balance remaining, so split it to get .5% each
        payable(0x0f075aC7186A8D43c1b6A819B5BCEff7c936d7Cf).transfer(balance / 2);
        payable(0xe1Db3822239a27451b68a0cfFC19a9160EE36f75).transfer(balance / 2);
    }
