...
contract RabbidRabbits is ERC721, Ownable {
    using SafeMath for uint256;
    string public rabbidRabbitsProvenance = ""; //after sold out
    ...
    uint256 public constant MaxRabbidRabbits = 999;
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        rabbidRabbitsProvenance = provenanceHash;
    }
    ...
    function tokenLicense(uint _id) public view returns(string memory) {
        require(_id < totalSupply(), "Choose a Rabbit Rabbit Within Range");
        return LICENSE_TEXT;
    }
