...
contract AdventureGold is Context, Ownable, ERC20 {
    ...
    address public lootContractAddress =
        0x2a051115383f95e26DaaECA239909364c066cE55;
    ...
    */
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        uint256 multiplier = 
            lootContract.getFirst(tokenId)*
            lootContract.getSecond(tokenId)*
            lootContract.getThird(tokenId)*
            lootContract.getFourth(tokenId)*
            lootContract.getFifth(tokenId)*
            lootContract.getSixth(tokenId)*
            lootContract.getSeventh(tokenId)*
            lootContract.getEight(tokenId);

        _mint(tokenOwner, multiplier*(10**decimals()));
    }
}