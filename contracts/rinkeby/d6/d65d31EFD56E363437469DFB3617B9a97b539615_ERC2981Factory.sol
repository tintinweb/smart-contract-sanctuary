...
contract ERC2981 is ERC165, IERC2981, Initializable, NiftyEntity {
     ...
     * @param amount uint16 value for percentage (using 2 decimals - 10000 = 100, 0 = 0)
     */
    function updateTokenRoyaltyRange(
        ...
        if (royaltyRanges.length > 0 && rangeIdx > 0) {
    ...
    function _setTokenRoyaltyRange(
        ...
        royaltyRanges.push(RoyaltyRange(startTokenId, endTokenId, recipient, amount));
    }
