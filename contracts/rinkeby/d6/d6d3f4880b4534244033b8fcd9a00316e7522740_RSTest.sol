...
contract RSTest is ERC721Enumerable, Ownable, AccessControl {
    ...
    function mint(uint256 num) public payable whenMintNotStopped(){
        ...
        require( supply + num <= MAX_SUPPLY - RESERVED_SUPPLY + RESERVED_PREMINT_SUPPLY,    "Maximum Token supply" );
    ...
    function preMint(uint256 num) public payable whenPreMintNotStopped() {
        uint256 supply = totalSupply();
        ...
        require( num <= PREMINT_AMOUNT,                                                     "Maximum of PREMINT_AMOUNT Tokens" );
        require( msg.value >= CURRENT_PRICE * num,                                          "Ether sent is less than PRICE" );
    ...
    function getAllowedPreMint(address account) public view  returns (bool) {
