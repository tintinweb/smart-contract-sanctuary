...
contract GenesisVault is TokenVault, ContractGuard {
    ...
    function beginGenesis() onlyOperator public {
        ...
        for (uint256 i = 0; i < stakersList.length; i++) {
            ...
            // // console.log(totalMultipliedWBTCTokens.mul(1e10).div(2));
            // // console.log(totalMultipliedWBTCTokens.mul(1e10).div(2).mul(getStakingTokenPrice()).div(getShareTokenPrice()));
            
            // // console.log(IERC20(pairTo).balanceOf(address(this)));
            // // console.log(seat.multipliedNumWBTCTokens);
            // // console.log(totalMultipliedWBTCTokens);
