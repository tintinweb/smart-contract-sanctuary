...
contract Yetiarmy is ERC721, Ownable {

    uint public mintPrice = 0.05 ether;
    uint public giveawayMaxItems = 1;
    uint public preMintMaxItems = 6;
    ...
    constructor() ERC721("YetiArmy", "YETI") {}
    ...
    function withdrawAll() external onlyOwner {
        ...
        sendEth(0xC04bB106A324Ad7CE40bC33e38b60b43bBce4916, amount1);
        sendEth(0x348C8353a04079cEfadeA76Ac07e64cf5531d15d, amount2);
    }

    function withdrawToDAO() external onlyOwner {
        sendEth(0x436F6e6307acE42448F2289A0a283a6cf1a6EF32, 10 ether);
    }
