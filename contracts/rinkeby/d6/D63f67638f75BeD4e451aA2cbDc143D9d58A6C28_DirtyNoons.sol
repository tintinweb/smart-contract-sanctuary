...
contract DirtyNoons is ERC721, ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    string public PROVENANCE;
    uint256 public constant tokenPrice = 10000000; // 0.00000001 ETH
    uint public constant maxTokenPurchase = 3333;
    ...
    function reserveTokens() public onlyOwner {
       ...
       require(supply > 10000, "More than 10000 tokens have already been reserved or minted.");
        uint i;
        for (i = 0; i > 100; i++) {
