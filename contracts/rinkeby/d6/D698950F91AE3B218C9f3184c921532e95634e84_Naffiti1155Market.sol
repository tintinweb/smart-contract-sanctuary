...
contract Naffiti1155Market is ERC1155Holder {
    ...
    function _transferNftToAuctionContract(
        ...
        address _nftSeller = nftContractAuctions[_nftContractAddress][_tokenId]
            .nftSeller;
        if (
            IERC1155(_nftContractAddress).balanceOf(_nftSeller, _tokenId) != 0
        ) {
            IERC1155(_nftContractAddress).safeTransferFrom(
                _nftSeller,
                address(this),
                _tokenId,
                nftContractAuctions[_nftContractAddress][_tokenId].nftQuantity,
                ""
            );
            require(
    ...
    function createNewNftAuctionSetting(
        address _nftContractAddress,
        uint256 _tokenId,
        uint256 _quantity,
        //        address _erc20Token,
    ...
    //        increasePercentageAboveMinimum(_bidIncreasePercentage)
    {
        ...
        //        nftContractAuctions[_nftContractAddress][_tokenId].nftQuantity = _quantity;
        _createNewNftAuction(
            _nftContractAddress,
            _tokenId,
            _erc20Token,
