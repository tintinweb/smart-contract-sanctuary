...
// @title: OnChainMonkey Babies
// @author: Based on the work by huuep, modified by Unstuck NFTs
//
...
//   - all 5000 OnChain Monkey Babies should be unique
...
// Bring on the OnChain Monkey Babies!
contract OnChainMonkeyBabies721A is ERC721A, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 500 500"><rect x="0" y="0" width="500" height="500" style="fill:#',
    '"/><rect width="216" height="90" x="142" y="424" style="fill:#', '"/><circle cx="205" cy="470" r="5" style="fill:#', '"/><circle cx="295" cy="470" r="5" style="fill:#',
    '"/><circle cx="135" cy="318" r="37" style="fill:#', '"/><circle cx="135" cy="318" r="15" style="fill:#', '"/><circle cx="365" cy="318" r="37" style="fill:#',
    '"/><circle cx="365" cy="318" r="15" style="fill:#', '"/><circle cx="250" cy="312" r="112" style="fill:#', '"/><circle cx="250" cy="312" r="90" style="fill:#',
    '"/><circle cx="210" cy="295" r="35" style="fill:#fff"/><circle cx="295" cy="302" r="31" style="fill:#fff"/><circle cx="210" cy="300" r="20" style="fill:#',
    '"/><circle cx="290" cy="300" r="20" style="fill:#', '"/><circle cx="210" cy="300" r="7" style="fill:#000"/><circle cx="290" cy="300" r="7" style="fill:#000"/>',
    '<ellipse cx="250" cy="360" rx="63" ry="25" style="fill:#',
     '"/><rect x="210" y="370" width="82" height="3" style="fill:#000"/><circle cx="261" cy="345" r="4" style="fill:#000"/><circle cx="237" cy="345" r="4" style="fill:#000"/>',
    '</svg>'];
  string private cross='<rect x="135" y="331" width="10" height="40" style="fill:#872"/><rect x="125" y="341" width="30" height="10" style="fill:#872"/>';
  string private clo1='<rect width="216" height="90" x="142" y="424" style="fill:#';
  string private clo2='"/><rect width="37" height="35" x="280" y="450" style="fill:#';
  string private hh1='<rect width="216" height="110" x="142" y="171" style="fill:#';
  string private hh2='"/><rect width="216" height="33" x="142" y="248" style="fill:#';
  string private sl1='<rect x="174" y="275" width="152" height="25" style="fill:#';
  string private sl2='"/><rect x="180" y="260" width="140" height="40" style="fill:#';
  string private mou='<line x1="267" y1="371" x2="300" y2="406" style="stroke:#000;stroke-width:4"/>';
  string private ey1='<rect x="178" y="278" width="65" height="12" style="fill:#';
  string private ey2='"/><rect x="265" y="278" width="60" height="12" style="fill:#';
  string private ey3='<rect x="170" y="312" width="160" height="25" style="fill:#';
  string private zz='"/>';
  string private ea1='<circle cx="140" cy="350" r="12" style="fill:#';
  string private ea2='fe7';
  string private ea3='999';
  string private ea4='"/><circle cx="140" cy="350" r="4" style="fill:#000"/>';
  string private ea5='<circle cx="140" cy="350" r="12" style="fill:#';
  string private ea6='bdd';
  string private mo1='<line x1="';
  string private mo2='" y1="351" x2="';
  string private mo3='" y2="356" style="stroke:#000;stroke-width:2"/>';
  string private mo4='" y1="361" x2="';
  string private mo5='" y2="366" style="stroke:#000;stroke-width:2"/>';
  ...
  string private co1=', ';
  string private rl1='{"name": "OnChain Monkey Baby #';
  string private rl3='"}';
  ...
  // this was modified for randomness
  ...
  function randomOne(uint256 tokenId) internal view returns (Ape memory) {
    tokenId=uint(keccak256(abi.encodePacked(block.difficulty, block.timestamp,tokenId))); // new randomness
  ...
  function genMouth(uint8 h) internal view returns (string memory) {
    ...
    if ((h>24) || ((h>8) && (h<16))) {
      for (i=0;i<5;i++) {
        out = string(abi.encodePacked(out,mo1,(200+i*25).toString(),mo2,(200+i*25).toString(),mo3));
      }
      for (i=0;i<4;i++) {
        out = string(abi.encodePacked(out,mo1,(212+i*25).toString(),mo4,(212+i*25).toString(),mo5));
      }
    }
    if (h>15) {
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
   ...
   function withdraw(address payable _to) external onlyOwner 
    ...
    function mint(uint8 quantity) external payable nonReentrant {
        ...
        require(msg.value == MINT_PRICE * quantity, "incorrect price");
        require(quantity > 0);
        require(minted + quantity <= MAX_SUPPLY, "We're out of babies!");
        require(quantity + saleMintCount[msg.sender] <= MAX_MINT_PER_WALLET, "Maximum 5 per wallet");
        saleMintCount[msg.sender] += quantity;
        _safeMint(_msgSender(), quantity);
  }

  constructor() ERC721A("OnChainMonkey Babies", "BABYMANK", 100) Ownable() {}
