...
abstract contract IERC1363 is IERC20, ERC165 {
   ...
   * @return true unless throwing
   */
  function transferAndCall(address to, uint256 value, bytes memory data) public virtual returns (bool); // solium-disable-line max-len
   ...
   * @return true unless throwing
   */
  function transferFromAndCall(address from, address to, uint256 value) public virtual returns (bool); // solium-disable-line max-len
   ...
   * @return true unless throwing
   */
  function transferFromAndCall(address from, address to, uint256 value, bytes memory data) public virtual returns (bool); // solium-disable-line max-len, arg-overflow
   ...
   */
  function approveAndCall(address spender, uint256 value) public virtual returns (bool); // solium-disable-line max-len
   ...
   */
  function approveAndCall(address spender, uint256 value, bytes memory data) public virtual returns (bool); // solium-disable-line max-len
}
...
abstract contract IERC1363Receiver {
   ...
   *  unless throwing
   */
  function onTransferReceived(address operator, address from, uint256 value, bytes memory data) external virtual returns (bytes4); // solium-disable-line max-len, arg-overflow
}
...
abstract contract IERC1363Spender {
   ...
   *  unless throwing
   */
  function onApprovalReceived(address owner, uint256 value, bytes memory data) external virtual returns (bytes4); // solium-disable-line max-len
}
 ...
 */
abstract contract ERC1363 is ERC20, IERC1363 { // solium-disable-line max-len
