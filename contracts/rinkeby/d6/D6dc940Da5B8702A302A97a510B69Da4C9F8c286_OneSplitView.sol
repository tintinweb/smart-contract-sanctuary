...
contract OneSplitRoot is IOneSplitView {
    ...
    IUniswapV2Factory constant internal sushiswapV2 = IUniswapV2Factory(0xc35DADB65012eC5796536bD9864eD8773aBc74C4);
...
contract OneSplitView is IOneSplitView, OneSplitRoot {
    ...
    function getExpectedReturnWithGasTest(
        IERC20 fromToken,
        IERC20 destToken,
        uint256 amount,
        uint256 parts,
    ...
    {
        uint256[] memory distribution = new uint256[](DEXES_COUNT);
...
contract IOneSplitConsts {
    ...
    uint256 internal constant FLAG_DISABLE_SUSHISWAP = 0x66668888;
}
