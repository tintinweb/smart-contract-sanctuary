...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/tesTskiContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract TesTskiContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("TESTski", "TSKI", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://Qmd1mTW9DD1Qc5sW7B3h4hYDZPCfPbUvcMT2nh9EB8uWEi/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/3bAldb7kpvamZamXFBnt/contract-metadata";
        }
    }