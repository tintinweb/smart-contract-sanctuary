...
contract PlatziPunksDNA {
  ...
  {
    return
      // We do the casting (uint8) so we return uint8
      // This function received uint256 and uint8, this is why we cast
      uint8(
        // This is the insane formula that returns the two numbers of the section desired
