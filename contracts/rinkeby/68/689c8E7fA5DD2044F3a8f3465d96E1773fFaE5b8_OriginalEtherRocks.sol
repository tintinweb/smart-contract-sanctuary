...
/******************************************/
/*      Original EtherRocks Wrapper       */
/*               Rocks 0-99               */
/******************************************/

contract OriginalEtherRocks is ERC721, Ownable {
...
// "
  ...
  constructor() ERC721("Original EtherRocks", "WLTR") {}
  ...
  function wrap(uint256 id) public {
    ...
    require(id <= 99, "Only Original EtherRocks allowed!");
