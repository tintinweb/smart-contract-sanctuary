...
contract Traits is Ownable, ITraits {
  ...
  function drawSVG(uint256 tokenId) public view returns (string memory) {
    ...
    string memory svgString = string(abi.encodePacked(
      s.isTortoise ? drawTrait(traitData[9][s.skin]) : drawTrait(traitData[9][s.fur]),
      s.isTortoise ? drawTrait(traitData[10][s.feet]) : drawTrait(traitData[2][s.ears]),
      s.isTortoise ? drawTrait(traitData[11][s.shell]) : drawTrait(traitData[3][s.eyes]),
      s.isTortoise ? drawTrait(traitData[12][s.face]) : drawTrait(traitData[6][s.neck]),
      s.isTortoise ? drawTrait(traitData[13][s.accessory]) : drawTrait(traitData[7][s.feet])
    ));
  ...
  function compileAttributes(uint256 tokenId) public view returns (string memory) {
    ...
    if (s.isTortoise) {
      traits = string(abi.encodePacked(
        attributeForTypeAndValue(_traitTypes[1], traitData[9][s.skin].name),',',
        attributeForTypeAndValue(_traitTypes[7], traitData[10][s.feet].name),',',
        attributeForTypeAndValue(_traitTypes[4], traitData[11][s.shell].name),',',
        attributeForTypeAndValue(_traitTypes[5], traitData[12][s.face].name),',',
        attributeForTypeAndValue(_traitTypes[9], traitData[13][s.accessory].name),','
      ));
    } else {
      traits = string(abi.encodePacked(
