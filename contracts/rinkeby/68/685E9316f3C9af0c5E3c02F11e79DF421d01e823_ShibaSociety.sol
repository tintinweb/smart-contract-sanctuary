...
contract ShibaSociety is ERC721("Shiba Society", "SHIBS"), Ownable {
    ...
    uint256 private _maxNFTLimit = 10;
    // uint256 public MAX_NFT = 10000;
    uint256 public MAX_NFT = 5;
    ...
    */
    function mintNFT(uint256 _numOfTokens) public payable {
        require(_numOfTokens <= _maxNFTLimit, "Can't mint above limit");
        ...
        for(uint i=0; i < _numOfTokens; i++) {
            ...
            emit PermanentURI(tokenURI(totalSupply), totalSupply);
    ...
    */
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 && totalSupply >= MAX_NFT ? string(abi.encodePacked(baseURI, 
            tokenId.toString())) : "";
    }
