...
contract WrappedElves is ERC721, Ownable {
    ...
    function mint() public payable {
        ...
        nextTokenID += 1;
        _tokensOwned[msg.sender].push(tokenID);
    }
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '", "description":"There was an accident at Santas Workshop and 500 elves got trapped in presents! Help save them before they suffocate!", "external_url":"https://welf.xyz/?tokenId=',
                                id.toString(),
                                '", "attributes": [], "owner":"',
    ...
    function transferFrom(
        ...
        uint256[] memory ownedTokens = _tokensOwned[from];
        uint256 tokenIdx;
        ...
        delete _tokensOwned[from][tokenIdx];
