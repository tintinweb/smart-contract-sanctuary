...
contract TokenWorks is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/71/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/71/contract-uri";
	...
	uint256 public pricePerToken = 30000000000000000;
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("TokenWorks", "WRS") {
