...
// File contracts/VirusCreamNFT.sol
    ...
    ERC721Pausable
{
    ...
    function mint(address to, string memory uri) external virtual payable {
        // Verify value equal mintFee
        require(msg.value == mintFee, "Mint Fail");
    ...
    function _pay() internal {
        (bool sent, bytes memory data) = developer.call{value: address(this).balance}("");
