...
contract ClaimNAFF {
    ...
    function claim(
        ...
        require(amount > IERC20(tokenAddress).balanceOf(address(this)), "ERROR: Not Enough Token");

        // Mark this record and transfer tokens
        isClaimedList[msg.sender] = true;
        require(IERC20(tokenAddress).transfer(account, amount), "ERROR: Transfer Failed.");
