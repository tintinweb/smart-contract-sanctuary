...
contract LaunchpadFactoryIdo is Ownable {
  ...
  function launchCrowdsale(
    ...
    uint256 _maxUserUsdLimit, // 18 decimal
    address _owner,
    uint256 _rate,
    ...
    require(
      _leashLockPeriod > 1 days,
      "the lock period must be greater than 1 day"
    );
    require(_maxUserUsdLimit > 500e18);
    require(
    ...
    if (_crowdsaleEndTime == 0) {
      ...
      require(
        _vestingTimeTillEnd > _vestingStartTime,
  ...
  function breakFunc(
    address _tokenAddress,
    uint256 _amountAllocation,
    uint256 _maxUserUsdLimit, // div by 100
    address _owner,
    uint256 _rate,
    uint256 _crowdsaleStartTime,
    uint256 _crowdsaleEndTime,
    ...
    CrowdsaleIdo newCrowdsale = new CrowdsaleIdo(_owner, address(this));
...
contract CrowdsaleIdo is ReentrancyGuard {
    ...
    IERC20 private usdt = IERC20(0x37906Bb496df5b3b7c741688b4EA6013870700B1); //0xE185701D5690864f48cD401eeEFC60802B7449A3
