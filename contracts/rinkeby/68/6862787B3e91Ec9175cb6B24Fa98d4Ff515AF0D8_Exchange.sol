...
contract Exchange is ExchangeCore {
    ...
    function setSeller_(address _seller)public onlyOwner{
        setSeller(_seller);
    }
...
contract ExchangeCore is ReentrancyGuarded, EIP712, Ownable{
    ...
    function setSeller(address _seller) internal onlyOwner{
        sellOnly = _seller;
    }
    ...
    {   
        ...
        require(seller.maker == sellOnly, "You are not authorized to perform this action");
