...
interface IFarm {
    ...
    function consolidateExternal(address staker) external;

    function userExist(address staker) external view returns (bool);

    function registerLp(address staker) external;

    function unRegisterLp(address staker) external;
}
