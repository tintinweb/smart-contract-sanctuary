...
contract NFTMarket is ReentrancyGuardUpgradeable {
    ...
    function createMarketItem(
        ...
        marketToken.approve(address(this), listingPrice);
    ...
    function createMarketSale(
        ...
        IERC20(address(0xf740E266a17918c20cE2dd40eEfad2B2f8Dacb45)).approve(
            address(this),
            0.001 * 10**18
        );
        // idToMarketItem[itemId].seller.transfer(msg.value);
        IERC20(address(0xf740E266a17918c20cE2dd40eEfad2B2f8Dacb45))
