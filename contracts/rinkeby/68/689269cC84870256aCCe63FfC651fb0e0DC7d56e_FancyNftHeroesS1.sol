...
abstract contract FancyNftHeroesS1Sale is FancyNftBase, Ownable {
    ...
    uint256 public airdropMintsTotalLimit = 100; // TODO
    ...
    uint256 public presaleMintsTotalLimit = 1000; // TODO
    uint256 public presaleMintsTotal;
    mapping(address => bool) public presaleWhitelist;
    mapping(address => uint256) public presaleMints;

    // Privsale
    uint256 public privsalePrice = 0.3 ether; // TODO
    ...
    // Sale
    uint256 public salePrice = 0.3 ether; // TODO
    ...
    function isSaleActive() public view returns (bool) {
        return _isActive(totalSupply(), _maxSupply, saleStartTime, ~uint256(0));
    }
