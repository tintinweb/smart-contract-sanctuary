...
contract LostWalletNFT is ERC721URIStorage , Pausable {
    ...
    string public Wallet_Owner_Information_Name;
        address public Wallet_Owner_Information_Address;
        address public Wallet_Owner_Information_Wallet_address;
      ...
      //  string public  Due_Diligence_Date_of_completing_the_due_diligence;
       // bool public  Due_Diligence__success;
        //string public Chrysalis_token_Owner_Information_name;
       // address public  Chrysalis_token_Owner_Information_Address;

       // bool public Chrysalis_token_Tradeable;
       // string public Chrysalis_token_Type;
       // string public Chrysalis_token_Rating;
   ...
   bytes32 public constant SUB_ADMIN_ROLE = keccak256("SUB_ADMIN_ROLE"); 
    ...
    constructor(
        ...
        address _Wallet_Owner_Information_Address,
        address _Wallet_Owner_Information_Wallet_address,
      ...
      //  string memory __Due_Diligence_Date_of_completing_the_due_diligence,
      //  bool _Due_Diligence__success,
       // string memory _Chrysalis_token_Owner_Information_name,
     //   address _Chrysalis_token_Owner_Information_Address,

     //   bool  _Chrysalis_token_Tradeable,
      //  string memory _Chrysalis_token_Type,
     //   string memory _Chrysalis_token_Rating,
   ...
   /*   function _beforeTokenTransfer(
    ...
    function owner_info(
        ...
        )  public whenNotPaused
        {
            ...
            require(IAdminContract(Admincontract).hasRole(SUB_ADMIN_ROLE,msg.sender) || owner==msg.sender,"onlyAdmin can call");
  ...
  struct Lost_wallet_info
      ...
      function wallet_info(
       ...
       {
           require( owner==msg.sender || (IAdminContract(Admincontract).hasRole(SUB_ADMIN_ROLE,msg.sender)),"onlyAdmin can call");
...
contract lost_wallet_Admin is OwnableUpgradeable , AccessControlUpgradeable {
    ...
    function Lost_Wallet_NFT (
        ...
        address  Wallet_Owner_Information_Address,
        address  Wallet_Owner_Information_Wallet_address,
      ...
      //  string memory  Due_Diligence_Date_of_completing_the_due_diligence
       // bool  Due_Diligence__success
        //string memory Chrysalis_token_Owner_Information_name,
       // address  Chrysalis_token_Owner_Information_Address

       // bool Chrysalis_token_Tradeable
       // string memory Chrysalis_token_Type,
       // string memory Chrysalis_token_Rating
        ...
        LostWalletNFT A = new LostWalletNFT (
          ...
          //  Due_Diligence_Date_of_completing_the_due_diligence,
          //  Due_Diligence__success,

           // Chrysalis_token_Owner_Information_name,
          //  Chrysalis_token_Owner_Information_Address,

           // Chrysalis_token_Tradeable,
         //   Chrysalis_token_Type,
          //  Chrysalis_token_Rating,
