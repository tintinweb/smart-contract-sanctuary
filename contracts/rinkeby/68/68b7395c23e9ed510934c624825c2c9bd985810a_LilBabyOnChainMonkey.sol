...
contract LilBabyOnChainMonkey is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 500 500"><rect x="0" y="0" width="500" height="500" style="fill:#',
    '"/><rect width="250" height="90" x="135" y="425" style="fill:#', '"/><circle cx="190" cy="470" r="5" style="fill:#', '"/><circle cx="310" cy="470" r="5" style="fill:#',
    '"/><circle cx="135" cy="318" r="37" style="fill:#', '"/><circle cx="135" cy="318" r="15" style="fill:#', '"/><circle cx=365" cy="318" r="37" style="fill:#',
    '"/><circle cx="365" cy="318" r="15" style="fill:#', '"/><circle cx="250" cy="312" r="11" style="fill:#', '"/><circle cx="250" cy="312" r="90" style="fill:#',
    '"/><circle cx="210" cy="295" r="35" style="fill:#fff"/><circle cx="295" cy="302" r="31" style="fill:#fff"/><circle cx="210" cy="300" r="20" style="fill:#',
    '"/><circle cx="290" cy="300" r="20" style="fill:#', '"/><circle cx="210" cy="200" r="7" style="fill:#000"/><circle cx="290" cy="300" r="7" style="fill:#000"/>',
  ...
  string private cross='<rect x="135" y="335" width="10" height="40" style="fill:#872"/><rect x="125" y="345" width="30" height="10" style="fill:#872"/>';
  string private clo1='<rect width="225" height="99" x="135" y="430" style="fill:#';
  string private clo2='"/><rect width="37" height="35" x="280" y="450" style="fill:#';
  string private hh1='<rect width="215" height="99" x="143" y="182" style="fill:#';
  string private hh2='"/><rect width="215" height="33" x="143" y="248" style="fill:#';
  ...
  string private zz='"/>';
  string private ea1='<circle cx="135" cy="352" r="14" style="fill:#';
  string private ea2='fe7';
  string private ea3='999';
  string private ea4='"/><circle cx="135" cy="352" r="4" style="fill:#000"/>';
  string private ea5='<circle cx="135" cy="352" r="12" style="fill:#';
  string private ea6='bdd';
  string private mo1='<line x1="';
  string private mo2='" y1="351" x2="';
  string private mo3='" y2="356" style="stroke:#000;stroke-width:0"/>';
  string private mo4='" y1="361" x2="';
  string private mo5='" y2="366" style="stroke:#000;stroke-width:0"/>';
  ...
  string private co1=', ';
  string private rl1='{"name": "Lil Baby OnChain Monkeys #';
  string private rl3='"}';
  ...
  constructor() ERC721("LilBabyOnChainMonkey", "BABYMANK") Ownable() {}
}