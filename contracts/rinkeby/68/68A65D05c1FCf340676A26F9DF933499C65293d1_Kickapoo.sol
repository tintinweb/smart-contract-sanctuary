    ...
    ReentrancyGuard
{
    ...
    function isWhitelisted(bytes32[] memory proof) public view returns (bool) {
        ...
        return MerkleProof.verify(proof, presaleRoot, _leaf);
    }

    function mintPresale(uint256 amount, bytes32[] calldata proof) public payable {
        require(isWhitelisted(proof), "Not whitelisted.");
        require(
