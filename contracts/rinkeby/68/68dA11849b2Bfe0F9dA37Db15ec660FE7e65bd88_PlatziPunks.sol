...
contract PlatziPunksDNA {
  ...
  function deterministicPseudoRandomDNA(uint256 _tokenId, address _minter)
    ...
    returns(uint256)
  {
    uint256 combinedParams = _tokenId + uint160(_minter); // el address tiene una longitud de 160, lo que hace que se pueda sumar al token
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
  ...
  /** Lugar o domino en la que estará alojado el NFT */
