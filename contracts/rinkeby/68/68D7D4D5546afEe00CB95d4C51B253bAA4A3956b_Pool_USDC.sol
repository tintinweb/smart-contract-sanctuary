...
// END AMOS //
    ...
    function redeem(
       ...
       lastRedeemed[msg.sender] = block.number;
        ...
        mintersDetails[msg.sender].amount = mintersDetails[msg.sender].amount.sub(collateralNeededBeforeFee.sub(collateralNeededAfterFee).mul(10**_missingDeciamls));
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0x62Af943fd9988a662515558652Dc23D370eAA68B"
    }
  },
  "outputSelection": {
    "*": {
