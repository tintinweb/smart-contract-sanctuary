...
contract XCubes is ERC721Enumerable, Ownable {
    ...
    bool private revealed = false; // watchdog
    ...
    constructor(string memory initialBaseURI) ERC721("XCubes", "XCubes") {
        // setBaseURI(baseURI);
        baseURI = initialBaseURI;

        // First 2 for the team, 2 for people who helped and 10 to hold.
    ...
    //     uint256 metadataId = tokenId % _maxSupply;

    //     return
    //         string(
    //             abi.encodePacked(_baseURI(), metadataId.toString(), ".json")
    //         );
    // }
