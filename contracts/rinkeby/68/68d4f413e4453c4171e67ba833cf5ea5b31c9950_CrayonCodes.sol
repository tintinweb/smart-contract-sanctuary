...
contract CrayonCodes is ERC721Enumerable, Authorizable, IERC2981 {
    ...
    uint256 public constant MAX_ROYALTY_AGG_BPS = 100_00;
    ...
    mapping(uint256 => uint256[]) public tokensByUserID; // userID => tokenID
    ...
    function authorizedMint(
        ...
        tokensByUserID[userID_].push(tokenID);
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        royaltyAmount =
            (salePrice_ * uint256(token.royaltyAggBPS)) /
            MAX_ROYALTY_AGG_BPS;
    }
        ...
        returns (string memory)
    {
        ...
        return string(abi.encodePacked(baseURI, ipfsID));
    }
