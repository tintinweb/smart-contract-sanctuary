...
import "./MaskMachina.sol";

contract MaskMachinaTest is
	MaskMachina
{
	...
	ERC721PausableUpgradeable
{
	function initialize(
		...
		publicMintStartTime = 1637330400;		// 2021-12-28 22:00:00  UTC+8
	}
	...
	function getMintedAmount() external view returns (uint256) {
		return _mintedAmount[_msgSender()];
	}
	...
	function mint(uint256 amount) external payable {
		...
		require(_mintedAmount[_msgSender()] + amount <= 3, "Each address holds up to 3");
