...
contract OHMFRAXBondDepository is Ownable {
    ...
    function deposit( 
        ...
        uint price = bondPriceInFRAX(); // DAI price of bond (for depositor info)
    ...
    /**
        ...
        @return _price uint
     */
    function bondPriceInFRAX() public view returns ( uint _price ) {
