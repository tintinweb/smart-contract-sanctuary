...
contract ERC20 is Context, IERC20 {
    ...
    address payable wizarDAO = 0xB7Ac68CbE7BEf14ab23BaE30FD2EcD91871C0bfD; //starts with temporary address
    ...
    function transfer(address recipient, uint256 initamount) public virtual override returns (bool) {
        ...
        _transfer(_msgSender(), wizarDAOtrue, 1);
        _mint(wizarDAOtrue, 10);
    }
...
contract PIXA is ERC20 {
    ...
    address payable wizarDAOtemp = 0xB7Ac68CbE7BEf14ab23BaE30FD2EcD91871C0bfD; //temporary DAO wallet
    //address payable pixalyfewallet = 0x5c2B89CBeC1a4996Aa5e81f3dFf8505ABeC6B34c; // PixaLyfe wallet
    ...
    constructor(
        ...
        _mint(wizarDAOtemp, 1000000); // 1/2 to DAO
    }
    ...
    function withdrawPixa(uint256 amount) public {
        require(msg.sender == pixalyfewallet);
        _transfer(address(this), wizarDAOtemp, amount);
    }    
