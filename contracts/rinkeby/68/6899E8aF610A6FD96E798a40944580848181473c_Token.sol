...
contract Token is ERC721 {
    ...
    constructor() public ERC721("Truck", "4x4") {
        tokenCounter = 0;
    }

    function createToken(string memory mytokenURI) public returns (uint256) {
        uint256 newTokenId = tokenCounter;
        _safeMint(msg.sender, newTokenId);
        _setTokenURI(newTokenId, mytokenURI); //_tokenURIs[tokenId] = _tokenURI;
        tokenCounter += 1;
        return newTokenId;
    }
}