...
contract Newnft is ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_MINTABLE_PER_TX = 10;
    uint256 public PRICE_PER_TOKEN = 0.01 ether;

    string public beginning_uri = "ipfs://QmbHx45p5H39TyeB97zBZhfrFL9YrtF8W49EmGmuQw7emh/";
    string public ending_uri = ".json";

    bool public minting_allowed = false;

    address payable public main_owner = payable(0xAEfE71147614AFa159df8B2D5094909aDBe06b8b);
    address payable public second_owner = payable(0xAEfE71147614AFa159df8B2D5094909aDBe06b8b);
    address payable public third_owner = payable(0xAEfE71147614AFa159df8B2D5094909aDBe06b8b);
