...
contract BullishBanners is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Bullish Banners", "BB") {
    }

    modifier mintCompliance(uint256 _mintAmount) {
        require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, "Invalid mint amount!");
        require(supply.current() + _mintAmount <= maxSupply, "Soldout");
        _;
    }
    ...
    function mintSale(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
