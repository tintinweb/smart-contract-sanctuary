...
contract NFT is ERC721Enumerable, Ownable {
  ...
  address contractOwner = 0xe4944B0d43A170a0770c4bBa5696198efF601Be3;
  ...
  {
    uint256 ownerTokenCount = balanceOf(contractOwner);
    uint256[] memory tokenIds = new uint256[](ownerTokenCount);
    for (uint256 i; i < ownerTokenCount; i++) {
      tokenIds[i] = tokenOfOwnerByIndex(contractOwner, i);
    }
    return tokenIds;
  }
