    ...
    UUPSUpgradeable
{
    ...
    mapping(address => mapping(uint256 => EditionInfo)) projectTokenIdToEditionInfo;
    ...
    function buyNow(
        ...
        //        );
        // mint token to the buyer, uri is empty because it's controlled by #this.tokenURI function
