...
contract CrownyVesting is Ownable {
    ...
    function setVesting(address _beneficiary, uint32[] memory _junctures, uint256 _vestingAmount, uint256 _vestingIncrement, uint256 _initialClaim) external onlyOwner {
