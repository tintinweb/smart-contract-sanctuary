...
contract VectorscapeFactory is ERC721, Ownable {
    ...
    string _baseURL;
    string _contractURL = "ipfs://QmbC7VDa6zv44V2XsUgAaJhW8ZH61CjGQy7S6pXHD2Y1vK";
    bool paused;
        ...
        returns (uint256)
    {
        ...
        require(vectorscapes.length < maxSupply, "max supply has been minted");
