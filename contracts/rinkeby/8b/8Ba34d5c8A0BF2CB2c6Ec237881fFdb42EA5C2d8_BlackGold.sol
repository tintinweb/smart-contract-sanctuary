...
contract BlackGold is ERC20Detailed, Ownable, ReentrancyGuard {
    ...
    function withdraw(uint256 ethAmount) external nonReentrant {
        ...
        require(_ethBalances[msg.sender] >= ethAmount, "Withdraw amount exceeds balance");

        _totalEthStaked = _totalEthStaked.sub(ethAmount);
        _ethBalances[msg.sender] = _ethBalances[msg.sender].sub(ethAmount);
