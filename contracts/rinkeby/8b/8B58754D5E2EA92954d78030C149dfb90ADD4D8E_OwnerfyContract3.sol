// contracts/Ownerfy-Contract-2-urls.sol
...
contract OwnerfyContract3 is Context, AccessControlEnumerable, ERC1155Burnable {
  ...
  // CIDs
    ...
    function uri(uint256 _id) public view virtual override returns (string memory) {
      // or use ipfs://QmTy8w65yBXgyfG2ZBg5TrfB2hPjrDQH3RCQFJGkARStJb.
      // DELETE This
      // https://ipfsgateway.makersplace.com/ipfs/QmXkxpwAHCtDXbbZHUwqtFucG1RMS6T87vi1CdvadfL7qA
      // https://gateway.pinata.cloud/ipfs/QmNdNTQVE4BUpERFwVTxX2RwZNbTCSwQr5pZ83EJJsBfWW/8046.gif
