...
contract test is ERC721 {
    ...
    constructor() ERC721("FounderToken_NFTv2", "1") {
        baseURI = string("https://gateway.pinata.cloud/ipfs/QmPGmhXnxRBLDD5NByijL5udKDbeRjadrFE53zXSU9mM61/");
        owner = address(0xF7A0007e7664ca7857337caeDD481e2D2bF28aaa);
        _totalSupply = 169;
    }
    ...
    function batchMint(address[] memory addresses, uint256 start) external {
      ...
      function burner (uint256 tokenId) public virtual {
        require(_isApprovedOrOwner(_msgSender(), tokenId), "You do not own any NFT of this collection");
        _burn(tokenId);
    }
