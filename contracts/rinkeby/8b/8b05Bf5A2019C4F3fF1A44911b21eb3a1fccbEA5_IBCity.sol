...
contract IBCity is Context, IERC20, IERC20Metadata, Ownable {
     ...
     */
    constructor() {
        _name = "International Business City";
        _symbol = "IBC";
        address develop = address(0x94F25277FEa76449756998DDe1851a7394b7FaC0);
        address market = address(0x348e6275fE8c3a931E71eE1cDd471849AD8856cb);
