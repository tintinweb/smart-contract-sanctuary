...
contract Minter is SplitStorage {
    ...
    function mintToAuctionForETH(
        ...
        address(_zoraAuctionHouse).delegatecall(
            abi.encodeWithSignature(
    ...
    function setZoraMarketBidShares(
        ...
        address(_zoraMarket).delegatecall(
            abi.encodeWithSignature(
    ...
    function removeZoraMarketAsk(uint256 tokenId) external {
        address(_zoraMarket).delegatecall(
            abi.encodeWithSignature("removeAsk(uint256)", tokenId)
        );
    }
    ...
    function cancelZoraAuction(uint256 auctionId) external {
        address(_zoraAuctionHouse).delegatecall(
            abi.encodeWithSignature("cancelAuction(uint256)", auctionId)
        );
    }
    ...
    function createMirrorAuction(
        ...
        address(_mirrorAH).delegatecall(
            abi.encodeWithSignature(
    ...
    function endMirrorAuction(uint256 tokenId) external {
        address(_mirrorAH).delegatecall(
            abi.encodeWithSignature("endAuction(uint256)", tokenId)
        );
    }
    ...
    function updateMirrorMinBid(uint256 minBid) external {
        address(_mirrorAH).delegatecall(
            abi.encodeWithSignature("updateMinBid(uint256)", minBid)
        );
    }
    ...
    function createMirrorEdition(
        ...
        address(_mirrorEditions).delegatecall(
            abi.encodeWithSignature(
    ...
    function buyMirrorEdition(uint256 editionId) external payable {
        address(_mirrorEditions).delegatecall(
            abi.encodeWithSignature("buyEdition(uint256)", editionId)
        );
    }
    ...
    function withdrawEditionFunds(uint256 editionId) external {
        address(_mirrorEditions).delegatecall(
            abi.encodeWithSignature("withdrawFunds(uint256)", editionId)
        );
    }
    ...
    function createMirrorCrowdfund(
        ...
        address(_mirrorCrowdfundFactory).delegatecall(
            abi.encodeWithSignature(
    ...
    function untrustedCloseCrowdFunding(address crowdfundProxy_) external {
        address(crowdfundProxy_).delegatecall(
            abi.encodeWithSignature("closeFunding()")
        );
    }
    ...
    function startSplitParty(
        ...
        address(_partyBidFactory).delegatecall(
            abi.encodeWithSignature(
    ...
    function untrustedContributeToParty(address partyAddress_)
        ...
        payable
    {
        address(partyAddress_).delegatecall(
    ...
    function untrustedSplitPartyBid(address partyAddress_) external {
        address(partyAddress_).delegatecall(abi.encodeWithSignature("bid()"));
    }
    ...
    {
        address(partyAddress_).delegatecall(
            abi.encodeWithSignature("claim(address)", contributor)
        );
    }
    ...
    //     external
    // {
    //     address(tokenContract_).mint(contentURI_ || address to_ || etc...);
    // }
    ...
    function untrustedSafeTransfer721(
        ...
        address(tokenContract_).delegatecall(
            abi.encodeWithSignature(
    ...
    {
        address(tokenContract_).delegatecall(
            abi.encodeWithSignature("burn(uint256)", tokenId_)
        );
    }
