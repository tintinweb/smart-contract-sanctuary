...
contract PlanetMetadata is IDynamicMetadata {
    ...
    uint8[] public patternThresholds;
...
*/
    ...
    function _initPathPatterns() private {
        /** DEFAULT CIRCLE */
        pathPatterns.push("M 0 0a 400 400 0 1,0 1,0 z"); //just for sample
        patternThresholds.push(50);
        /** HEART PATTERN */
        pathPatterns.push(
