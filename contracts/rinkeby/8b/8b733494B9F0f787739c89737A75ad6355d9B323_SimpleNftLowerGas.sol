...
// File: contracts/EntryNftTest1.sol
// Amended by HashLips
/**
    !Disclaimer!
...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("EntryNftTest1", "SYMBOL") {
    setHiddenMetadataUri("ipfs://QmeDsmNji9uF3M3BHnrWhQ578DeypGsA3Q7trGoFYLqHsW/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x16D270AC5D3d95919d6EA01a83A274631D4a67AD).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
