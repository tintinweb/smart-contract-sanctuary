            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Hexagon #',
                        toString(tokenId),
                        '", "description": "This hexagon is randomly generated and stored on chain. Each piece shows stats (20 ~ 95) of the Loot with the same tokenId. Anyone can define attributes, images, rarities, levels and other functionalities by utilizing this collection. Feel free to use in any way you want", "image": "data:image/svg+xml;base64,',
