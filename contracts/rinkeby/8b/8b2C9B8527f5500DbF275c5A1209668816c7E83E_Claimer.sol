...
contract Claimer is Context, Ownable, ERC1155Receiver {
    ...
    function createMessage(
        ...
        return keccak256(abi.encode(account, tokenId, nonce, address(this)));
    }
    ...
    function claim(
        ...
        _useAllowance(_msgSender(), tokenId, nonce, signature);
    ...
    function _useAllowance(
        ...
        bytes32 message = validateSignature(account, tokenId, nonce, signature);
    ...
    function validateSignature(
        ...
        bytes32 message = createMessage(account, tokenId, nonce).toEthSignedMessageHash();
