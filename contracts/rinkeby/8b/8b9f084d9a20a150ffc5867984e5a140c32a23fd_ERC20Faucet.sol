...
// File contracts/ERC20Faucet.sol
...
contract ERC20Faucet is Ownable {
    ...
    event TokenQuotaSet(IERC20 indexed token, uint256 period, uint256 amount);
    event TokensDonated(IERC20 indexed token, address indexed donor, uint256 amount, uint256 totalSupply);
    event TokensWithdrawn(IERC20 indexed token, address indexed account, uint256 amount, uint256 totalSupply);
    ...
    */
    constructor (IERC20[] memory _tokens, uint256[] memory _periods, uint256[] memory _amounts) Ownable() public {
    ...
    * @param _amounts List of quota amounts for each ERC20 token
    */
    function setQuotas(IERC20[] calldata _tokens, uint256[] calldata _periods, uint256[] calldata _amounts) external onlyOwner {
        _setQuotas(_tokens, _periods, _amounts);
    }
    ...
    */
    function getQuota(IERC20 _token) external view returns (uint256 period, uint256 amount) {
    ...
    */
    function getTotalSupply(IERC20 _token) external view returns (uint256) {
    ...
    */
    function getWithdrawal(address _account, IERC20 _token) external view returns (uint256 id, uint256 amount) {
    ...
    * @param _amounts List of quota amounts for each ERC20 token
    */
    function _setQuotas(IERC20[] memory _tokens, uint256[] memory _periods, uint256[] memory _amounts) internal {
    ...
    */
    function _setQuota(IERC20 _token, uint256 _period, uint256 _amount) internal {
