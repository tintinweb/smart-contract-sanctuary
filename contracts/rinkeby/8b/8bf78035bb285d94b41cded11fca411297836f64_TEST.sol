...
contract TEST is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xDeee154099f92936979d325A999a36DC83A1A117); // Marketing Address
    ...
    uint256 private buyBackPercentage = 10;
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > uint256(1 * 10**18)) {
                ...
                buyBackTokens(balance.div(buyBackPercentage));
            }
        }
    ...
    function setMarketingDivisor(uint256 divisor) external onlyOwner() {
        require(divisor >= 1 && divisor <= 5, "Invalid divisor value");
