...
contract BabetteFlat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Babette", "BABE") {
    setHiddenMetadataUri("ipfs://QmWucGyYBsiG4eRPwfpcpTaxZFmM9mMxsZf4uK9tHGNecL/hidden.json");
  }
