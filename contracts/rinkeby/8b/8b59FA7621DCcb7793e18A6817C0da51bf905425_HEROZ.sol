...
contract HEROZ is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	function presaleBuy(
		...
		require(matchAddresSigner(hashTransactionEIP191(msg.sender), sig), "no direct minting");
		require(qty <= 10, "no more than 10");
	...
	function hashTransactionEIP191(
		address sender
