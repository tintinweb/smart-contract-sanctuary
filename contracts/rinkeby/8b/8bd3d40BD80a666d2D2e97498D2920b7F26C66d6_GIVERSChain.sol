...
contract GIVERSChain is Context, IERC20, Ownable {
    ...
    uint256 public charityFee   = 3; //changed
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000;//1000
    ...
    constructor (address payable charityWallet) {
        ...
        //0xA61a3cB59a01f13E3C2373932d093870671e8964  - rinkeby
        //0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D  - UniswapV2Router02  rinkeby
    ...
    function deliver(uint256 tAmount) public {                                                  //goes to totalFees
