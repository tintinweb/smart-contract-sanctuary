...
interface IFrameRegistry {
    ...
    function getFrameId(uint16 x1, uint16 y1, uint16 x2, uint y2) external returns(uint16);
...
contract FrameRegistry is Algos, Encoding, FrameStorage, IFrameRegistry {
    ...
    function getFrameId(uint16 x1, uint16 y1, uint16 x2, uint y2) external override returns(uint16) {
    ...
    function getFrameId(uint16 x1, uint16 y1, uint16 x2, uint16 y2) public returns(uint16) {
        return _getFrameId(x1, y1);
    }
