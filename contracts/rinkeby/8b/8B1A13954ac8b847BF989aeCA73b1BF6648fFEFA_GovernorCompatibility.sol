...
import "@openzeppelin/contracts/contracts/governance/compatibility/GovernorCompound.sol";
import "@openzeppelin/contracts/contracts/governance/extensions/GovernorTimelockExternal.sol";
import "@openzeppelin/contracts/contracts/governance/extensions/GovernorWithERC20Votes.sol";

contract GovernorCompatibility is GovernorCompound, GovernorTimelockExternal, GovernorWithERC20Votes {
    constructor(
        string memory name_,
        address token_,
        address timelock_
    ...
    function votingPeriod() public pure override returns (uint64) {
        return 17280; // blocks, value from governor alpha
    }
    ...
    function _cancel(
        ...
        return GovernorTimelockExternal._cancel(targets, values, calldatas, salt);
    }
}
