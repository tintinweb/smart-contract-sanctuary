...
contract MultiGame is Ownable, ReentrancyGuard {
    ...
    function cancelGame(uint256 _gameId) public nonReentrant onlyOrgAddress returns (bool) {
        GameInfo storage currentGame = gameList[_gameId];
        require(currentGame.gameStatus == Status.Activated, "The game is in the progress");
