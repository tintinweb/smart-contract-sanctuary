...
/// @title GenuineHuman Art contract
/// @author Simon Fremaux (@dievardump)
/// @notice This contract is for GenuineHuman to be able to release some of his Art on his own contract collection
/// @notice It expects each tokens to have its own URI
contract GenuineHumanArt is ArtistCollection721 {
    ...
    function initialize(
        ...
        _initialize(name_, symbol_, contractURI_, openseaProxyRegistry_);
    }
}
