...
contract MetaverseInvadersContract is ERC721EnumMTIV, Ownable, ReentrancyGuard {
        ...
        payable 
    {
        ...
        uint256 availableMints = MAX_SALE_MINT - ERC721EnumMTIV.tokensOfOwner(msg.sender).length;
        ...
        payable 
    {
        ...
        uint256 totalSupply = ERC721EnumMTIV.totalSupply();
        uint256 availableMints = MAX_PRESALE_MINT - ERC721EnumMTIV.tokensOfOwner(msg.sender).length;
