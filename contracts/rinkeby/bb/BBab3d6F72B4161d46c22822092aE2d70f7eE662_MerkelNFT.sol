...
contract MerkelNFT is ERC721Enumerable, Ownable {
    ...
    address payable LOTTERY_ADDRESS=  payable(address(0x8C66917d26E3180D1831C23Fb9E9060d71A6d618));
    ...
    uint256 public MAX_TOKENS = 4;

    // Current price.
    uint256 public CURRENT_PRICE = 1000000000000000000;
  ...
  modifier onlyWhitelisted() {
     ...
     */
     ...
     function mintFromWhiteList(uint256 numberOfTokens) public payable onlyWhitelisted {
        ...
        LOTTERY_ADDRESS.transfer(100000);
