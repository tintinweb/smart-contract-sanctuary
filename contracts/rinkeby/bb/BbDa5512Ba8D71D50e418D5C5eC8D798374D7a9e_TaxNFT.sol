...
import "hardhat/console.sol"; // is this auto-removed on deploy?
...
contract TaxNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_MINT = 21;
    ...
    // TODO: update these values (see: https://docs.opensea.io/docs/contract-level-metadata)
    string public _contractURI = "https://dummyurl.com/contract_metadata/";
    string public _tokenURI = "https://dummyurl.com/metadata/";
    ...
    constructor() ERC721("NFT Tax Guide", "NFTAX") { }
    ...
    function devMint(uint256 _tokenQuantity) external {
    ...
    // TODO: update this with the correct address(s) we're withdrawing too, be wary of testnet
