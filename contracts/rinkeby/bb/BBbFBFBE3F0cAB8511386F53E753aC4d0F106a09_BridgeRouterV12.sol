...
contract BridgeRouterV12 is Ownable {
    ...
    function swap(
		...
		IBridgePool(pool).swap(to, token, targetNetwork, targetToken, swapTargetTokenTo, targetAddress);
	}
    ...
    function swapAndCross(
		...
		_swapAndCross(to, swapRouter, amountIn, amountCrossMin, path, deadline, crossTargetNetwork, crossTargetToken,
