...
contract CryptoHackers is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("CryptoHackers NFT Testnet", "HACKERZ_T") {
        _tokenIds.increment();
    }
    ...
    uint256 private maxCap = 50; // (7132 + 2)
    string public baseUri = "https://ipfs.io/ipfs/QmQsEzEHNfnmZ27j2SpjtqXYgdda4uYB3MNw2ECozeSjQz/";
    ...
    function OwnerMint(address to, uint256 amountToMint) public onlyOwner {
        for(uint256 i = 0; i < amountToMint; i++){
    ...
    function UnlockMetadata() public onlyOwner {
        require(metadataLocked == true, "Metadata are unlocked");
