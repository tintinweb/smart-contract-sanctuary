...
// File: contracts/rinkebytest.sol
...
contract CDRRinkebytest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CDRRinkebytest", "CDRRT") {
    setHiddenMetadataUri("ipfs://QmY4ApHgGG9xKTDbYqSXvuRWjgXZbJFi6uXJTFg4zgTrXv/hidden.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if (presale) { //dont allow minting if presale is set and buyer is not in whitelisted map
