...
contract BabyElon is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "SpaceCookie";                                                // name
    string private _symbol = "SPACECOOKIE";                                             // symbol
    ...
    address payable public marketingWallet = payable(0x063107f8fD74220A9D35b1a6d0cE62065E2a1ea4); // marketing wallet
