...
contract TokenVesting is Context, Ownable {
        ...
        returns (uint256 _amountVested)
    {
        ...
        uint256 _end = withdrawInterval.mul(releasePeriods);
        ...
        uint256 vestedAmount =
            period.sub(1).mul(lockAmount).add(initialUnlockAmount);
        return vestedAmount;
    }
...
contract PresaleVesting is TokenVesting {
    ...
    uint256 public constant RELEASE_PERIODS = 6;
