...
contract KeysWithPlonkVerifier is VerifierWithDeserialize {
    ...
    uint256 constant VK_TREE_ROOT = 0x299ee8c8641ae3157d939c2951afef4319c5d04cda1b322403cc71c032bc9216;
...
contract KeysWithPlonkVerifierOld is VerifierWithDeserializeOld {
    ...
    function getVkExit() internal pure returns(VerificationKeyOld memory vk) {
        ...
        vk.selector_commitments[0] = PairingsBn254.new_g1(
            0x24119c0f60ba71edf549f12ef34b3d284cd266eeb71cce0a7a0830b294f64edb,
            0x1094673a68350181b5fb8ee6a120104d61f558f746866fd077f33e5f53f9e14e
        );
        vk.selector_commitments[1] = PairingsBn254.new_g1(
            0x0860a8116edaea5e4420ff43d2fbb98ca46a5d3a4e95d25d8cbca10d0e0c06d7,
            0x06356ba071e43e36553a2a64f0301ed7af89d02c36ae481138d09603f18e9bbc
        );
        vk.selector_commitments[2] = PairingsBn254.new_g1(
            0x087a4373ad0f9533830f8ae12a94f9b477696e5eda5efdbbb0293987d9276756,
            0x12c69813ac729a259fa534ebc041e1461bd45b082a37f31f38dca8504dd9cf8f
        );
        vk.selector_commitments[3] = PairingsBn254.new_g1(
            0x2cddf0acb36ea85f68e5fb56c9e74743f73ab4f2acae450e8f4e5af434d41578,
            0x1999955f1416bcc73b1a457a634d531a4dc3a8b1662b6df9b1a5b2722f56cd2e
        );
        vk.selector_commitments[4] = PairingsBn254.new_g1(
            0x22c76a9de513d5c498cbb0b65b79d10521296777744683ee95bdb2b38b87d247,
            0x28f720c0fb77943ad1a630f61abc56841bc650ff87c0b791b72693e69ffb5782
        );
        vk.selector_commitments[5] = PairingsBn254.new_g1(
            0x2b5559b492769630b38df8cfafc832528304c6c9764f0f982f904f33d8a64d70,
            0x0e4c62a50079889c03c0e5141a64d0a3112bfc67b00332ead50432ed3600cc60
        );
        ...
        vk.next_step_selector_commitments[0] = PairingsBn254.new_g1(
            0x103f6e7a0b5cd22147aa6ef2cf516fef073365479c7b35cc822198bf80d0b072,
            0x04045bd253487f0e00a0af472da8cb27cc7494a770014b05b8c3aeca03b42657
        );

        vk.permutation_commitments[0] = PairingsBn254.new_g1(
            0x1d54b5c06597206f636dc31cc612c1ba74e09a3dce410f2501bf9c02b7dedd4e,
            0x0f900aa118749923aaf755bd66614b8888848e40aded90bd88935fdf5893c1cb
        );
        vk.permutation_commitments[1] = PairingsBn254.new_g1(
            0x0bb36ab2e243b7001b9dc5c74a33308160e77ce2f1241f0402a6289a30ec7a33,
            0x0eedcdbc9cf244706864b44a061cc5fac1799b86a0734ac481d23613aad88548
        );
        vk.permutation_commitments[2] = PairingsBn254.new_g1(
            0x146f99251634c5e0a7a06ba75b0ca94b0d2ae33e13ed8dfa05d2bc6bfccd2d0c,
            0x078a1be5350c5c95dc2339e357842b14fc61387a51b8fae1d668d1568d32ca1c
        );
        vk.permutation_commitments[3] = PairingsBn254.new_g1(
            0x2d72a5beb0ca04f429c4425d013c8144767fbbdf3359532148eef459477f2f6c,
            0x1bc5adf2ca84d02d9fee3a17edce44c4b04e956b80edb35b3cbcdf010f73cd9a
        );
...
library Operations {
    ...
    enum OpType {
        ...
        ChangePubKey,
        CreatePair,
        AddLiquidity,//should not used  yet.
        RemoveLiquidity,// should not used yet.
        Swap//should not used.
    }
...
contract ZkSync is PairTokenManager, UpgradeableMaster, Storage, Config, Events, ReentrancyGuard {
    ...
    event  NewPoolActivity(
        uint16 indexed tokenAId,
        uint16 indexed tokenBId,
      	uint16 indexed tokenRewardId,
        uint Layer2startBlock,
        uint layer2Endblock,
      	uint totalReward
    );

    ///@notice only event emit only. 
    function initPoolActivity (address _tokenA,
                               address _tokenB,
                               address rewardToken,
                               uint Layer2startBlock,
                               uint layer2Endblock,
        ...
        governance.requireGovernor(msg.sender);
        requireActive();
        uint16 tokenAId      = tokenIds[_tokenA];
        uint16 tokenBId      = tokenIds[_tokenB];
        uint16 tokenRewardId = tokenIds[rewardToken];

        emit NewPoolActivity(tokenAId,
                            tokenBId,
                            tokenRewardId,
                            Layer2startBlock,
                            layer2Endblock,
    ...
    /// @param _accountId Numerical id of the account
    /// @param _token Token address, 0 address for ether
    function fullExit(uint32 _accountId, address _token, uint32 _pairAccountId) external {
        requestFullExit(_accountId, _token, _pairAccountId);
    }
