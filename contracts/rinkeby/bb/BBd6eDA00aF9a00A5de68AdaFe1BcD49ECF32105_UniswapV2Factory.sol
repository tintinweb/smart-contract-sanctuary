...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    returns (address pair)
  {
    ...
    IUniswapV2Pair(pair).initialize(token0, token1, router);
...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
  ...
  function swap(
    ...
    address to,
    bytes calldata data
  ) external lock onlyBabyDogeRouter {
    ...
    uint256 balance1;
    {
      ...
      console.log("Transfering out optimisticly", amount0Out);
      console.log("Transfering out optimisticly", amount1Out);
      if (data.length > 0)
...
contract UniswapV2ERC20 is IUniswapV2ERC20 {
  ...
  string public constant name = "TreatSwap V2";
  string public constant symbol = "Treat-V2";
