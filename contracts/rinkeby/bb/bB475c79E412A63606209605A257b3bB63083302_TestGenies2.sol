 ...
 */
contract TestGenies2 is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Test Genies 2", "TGEN2") {
        presaleStartBlock = 9257545;
        saleStartBlock = 9257565;
    ...
    function presaleMint(uint256 amount) external payable whenPresaleActive {
        ...
        require(publicMinted + amount <= MAX_PRESALE_ITEMS, "TheSampleNft: Purchase would exceed presale supply cap");
