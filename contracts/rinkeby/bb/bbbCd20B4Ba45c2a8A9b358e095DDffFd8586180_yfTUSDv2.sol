...
contract yfTUSDv2 is ERC20, Ownable {
  /**
  ...
  // IYearn public earn = IYearn(0x73a052500105205d34Daf004eAb301916DA8190f);
  // IYvault public vault = IYvault(0x37d19d1c4E1fa9DC47bD1eA12f742a0887eDa74a);
  IERC20 public token = IERC20(0xe1964BDd447ee6f0Ee2bC734f1043ebA35444CFC);
  IYearn public earn = IYearn(0x63659FCb4a1f62e0c80690Ddc67084e8e1560C61);
  IYvault public vault = IYvault(0x0c9Ddf949e32221612145807e34483Ccf946B2b9);
  ...
  constructor() ERC20("Yearn Farmer v2 TUSD", "yfTUSDv2") {
      _setupDecimals(6);
      _approvePooling();
  }
