 ...
 * {ERC721Enumerable}.
 */
abstract contract ERC721 is ERC165, IERC721, IERC721Metadata, IERC721Extend {
...
contract ERC721Mintable is ERC721 ,Ownable{
    ...
    mapping(uint256 => uint256) private weights;
    ...
    function weight(uint256 _id) public view returns (uint256) {
        return weights[_id];
    }
...
contract TLNft is ERC721Mintable {

    constructor() ERC721Mintable("TLT NFT", "TLT") {
