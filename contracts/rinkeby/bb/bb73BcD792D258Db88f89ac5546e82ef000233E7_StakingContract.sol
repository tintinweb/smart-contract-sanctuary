...
contract StakingContract is Ownable, ReentrancyGuard {
  ...
  uint256 public processingFeeForStakedToken;
  ...
  /**
   * @notice Withdraws all tokens of an account and rewards.
   */
  ...
  /**
   * @notice Withdraws all tokens of an account immediately without a reward.
   */
  ...
  /**
   * @notice Return total pending rewards.
   */
  ...
  /**
   * Set APRM (in basis points).
   */
  function setAPRM(uint256 _APRM) public onlyOwner {
    APRM = _APRM;
  }
  ...
  /**
   * Set Processing Fee Percentage (in basis points) for Staking Token.
   */
  function setProcessingFeeForStakedToken(uint256 _processingFee) public onlyOwner {
    processingFeeForStakedToken = _processingFee;
  }
