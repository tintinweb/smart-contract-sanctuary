...
contract Treasury is AccessControl, PaymentRecipient {
    string public constant name = "Flair Treasury";
    ...
    constructor(address payable uniswapRouter) public {
    ...
    //
    modifier isGovernor() {
        require(hasRole(GOVERNOR_ROLE, msg.sender), "TOKEN/NOT_GOVERNOR");
        _;
    }
    ...
    function withdraw(uint256 amount) external isGovernor() {
    ...
    function buybackAndBurn(uint256 ethAmount, uint256 amountOutMin) public isGovernor() {
        ...
        emit BoughtBack(msg.sender, ethAmount, amountBought);

        _tokenAddress.burn(amountBought);
        emit Burnt(msg.sender, amountBought);
    }
}
