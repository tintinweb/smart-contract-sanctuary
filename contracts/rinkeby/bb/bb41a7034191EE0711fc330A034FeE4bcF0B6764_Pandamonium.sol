...
contract Pandamonium is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    // Presale
    mapping (address => bool) private presaleAddresses; // holds addresses
...
0x8E0cB536DaA6527Ff5cc830f393A71C05651923f
            ];
    ...
    function setDeveloperAddress4(address addr) external onlyOwner {
        developer = addr;
    }

    function setGenDeveloperAddress4(address addr) external onlyOwner {
        genDeveloper = addr;
    }
