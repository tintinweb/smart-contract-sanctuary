...
This contract is ngl your second best chance after GM/GN.
Ngl Tokens will be locked.
This contract is by a safu and based dev - ngl.
Community owned and driven. 100% tokens in LP.
...
contract ngl is Context, IERC20, Ownable {
    ...
    string private _name = "NotGonnaLie";
    string private _symbol = "ngl";
