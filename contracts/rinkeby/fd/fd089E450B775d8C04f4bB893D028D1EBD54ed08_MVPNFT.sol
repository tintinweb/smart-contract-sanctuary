...
contract MVPNFT {
    ...
    string public constant arbitraryString = "Scaffold-eth RULES!";
    ...
    */
    ...
    string public constant name = "One-Of-One MVP";
    string public constant symbol = "OOMVP";
    string public constant uri = "QmfVMAmNM1kDEBYrC2TPzQDoCRFH6F5tE1e9Mr4FkkR5Xr";
