...
// File: contracts\DataSet2.sol

contract DataSet2 is ERC721Mintable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("DataSet2", "DataSet2", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset2/metadata/token/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://nft-demonstration-data.s3.amazonaws.com/dataset2/metadata/contract/metadata.json";
    }
}