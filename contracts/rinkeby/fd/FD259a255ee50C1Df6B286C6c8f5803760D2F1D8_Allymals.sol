...
contract Allymals is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    uint256 public _presaleStartTime = 1634713199; //Next Tuesday at Noon PCT- not sure when launch is actually
    ...
    address t3 = 0xda73C4DFa2F04B189A7f8EafB586501b4D0B73dC;

    address[] addressList = [t1, t2, t3];
    uint256[] shareList = [15,70,15];

    constructor()
    ERC721("Allymals Squiffy Collection", "ALML")
