...
contract TestERC20Token {
    ...
    function setMinter(address minter_) external {
        require(msg.sender == minter, "setMinter: only the minter can change the minter address");
    ...
    function unlock() external {
        require(msg.sender == minter, "unlock: only the minter can unlock");
    ...
    function _transferTokens(address src, address dst, uint96 amount) internal {
        ...
        require(!lock, "_transferTokens: transfer is not allowed");
