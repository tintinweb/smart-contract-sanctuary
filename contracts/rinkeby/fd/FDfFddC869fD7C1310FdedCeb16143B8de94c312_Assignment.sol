...
contract Assignment {
    ...
    constructor(address _stableCoinAddress, address _WETHAddress, address _swapRouterAddress) {
    ...
    function placeOrder(
        ...
        if (vendorMapping[orderId].isPresent) {
            ...
            uint256 stableCoinToSend = balance/vendorMapping[orderId].rate;
            stableCoin.transfer(vendorMapping[orderId].vendorAddress, stableCoinToSend);
    ...
    function addVendor(
        ...
        Vendor memory vendor = Vendor(_vendorAddress, _tokenAddress, _fees, _rate, true);
    ...
    function modifyrate(
        ...
        vendorMapping[_orderId].rate = _rate;
    }
