...
contract FLOKI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x23C6599aAdF44Be7cbaD6D9051bb4C2255b2f713); // Marketing Address
    ...
    uint256 private _rTotal = (MAX - (MAX % _tTotal)); //((2**256-1) - (2**256-1 % 10000000000000**9))
    ...
    constructor () {
        //gives total of the supply to owner
    ...
    function initContract() external onlyOwner() {
        ...
        //@dev creates pair between weth and this token
        ...
        //@dev excludes the owner and this token from fees
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        
        
        marketingAddress = payable(0x23C6599aAdF44Be7cbaD6D9051bb4C2255b2f713);
    }
    ...
    function _transfer(
        ...
        //sell
         ...
         //checks if swap is not locked, trading is open and receiver is uniswapPair(weth, address(this))
