...
contract TomiStaking is Ownable, ReentrancyGuard, Pausable {
    ...
    function transferTomiPlatform(address newTomiPlatform) external onlyOwner {
        require(newTomiPlatform != address(0), "New TomiPlatform is the zero address");
        tomiPlatform = newTomiPlatform;
    }
    ...
    modifier PlatformAndGovernance() {
        require((msg.sender == tomiPlatform) || (msg.sender == tomiGovernance), "TomiStaking: caller is not TomiPlatform or TomiGovernance");
        _;
    }
