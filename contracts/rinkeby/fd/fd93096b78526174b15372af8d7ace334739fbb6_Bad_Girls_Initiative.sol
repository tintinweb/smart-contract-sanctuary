...
contract Bad_Girls_Initiative is ERC721, ERC721Enumerable, Ownable {
    ...
    address t1 = 0xD9a8d6026e301671B39694c26D3512953C13150d;
    address t2 = 0x3230cAEb7BEe1D1E633CaC78d25739862ce49567;
    ...
    function withdraw_2(uint256 share) public onlyOwner {
        share2 = share;
        uint256 balance = address(this).balance;
        uint256 profit1 = balance.mul(share2).div(100);
        require(payable(t2).send(profit1));
    }
