...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */    
    ...
    function _setRoyaltyReceiver(address _receiver) internal {
        require(_receiver != address(0),"ERC1155: receiver address should not be Zero");
...
interface IBAFNFT1155 {

    function mint(address from, uint256 tokenId, string memory uri, uint256 supply, uint256 fee) external;
}
...
contract BAFNFT1155 is ERC1155 {
    ...
    function mint(address from, uint256 tokenId, string memory uri, uint256 supply, uint256 fee)  public {
        require(msg.sender == operator,"ERC1155: caller doesn't have operator Role");
        _mint(from, tokenId, supply, uri, fee);
    }
