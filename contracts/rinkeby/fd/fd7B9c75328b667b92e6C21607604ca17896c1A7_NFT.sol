...
contract NFT is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    mapping(uint256 => State) public tokenDetail;
    event UpgrapdeLevel(
        address owner,
        uint256 Id,
        uint8 class,
    ...
    function upgradeLevel(uint256 _NFTId) public payable {
        ...
        tokenDetail[_NFTId].level++;
        tokenDetail[_NFTId].heath++;
        tokenDetail[_NFTId].speed++;
        tokenDetail[_NFTId].skill++;
        tokenDetail[_NFTId].morale++;
        emit UpgrapdeLevel(
            ownerOf(_NFTId),
            _NFTId,
            tokenDetail[_NFTId].class,
            tokenDetail[_NFTId].level,
            tokenDetail[_NFTId].heath,
            tokenDetail[_NFTId].speed,
            tokenDetail[_NFTId].skill,
