...
contract CoinPlants is ERC721Enumerable, Ownable {
    using Strings for uint256;
	...
	address private mavrek_wallet = 0x1F0b53dB1fA67F5b2891400D4108Bc01dEfBdAC6;
    address private cas_wallet = 0xC5aDdeF7CcF69Ef65e65870CF00eC47B25374694;
 ...
 function setPresaleMaxMintAmount(uint256 _newPresaleMaxMintAmount) public onlyOwner {
    ...
    uint256 _mv= _team.mul(50).div(100);
    uint256 _cs= _team.mul(50).div(100);
 



		
        payable(mavrek_wallet).transfer(_mv);
        payable(cas_wallet).transfer(_cs);
