...
contract PXMetadata is IPXMetadata {
    ...
    constructor() {
        ...
        _imageParts.push("<svg xmlns='http://www.w3.org/2000/svg' version='1.1' width='500' height='500'>");
            ...
            _imageParts.push("<g class='");
                ...
                _imageParts.push("'>");
                    _imageParts.push("<rect id='r' width='500' height='500'/>");
                    _imageParts.push("<circle id='c' cx='250' cy='250' r='");
    ...
    function _getJsonAttributes(uint256 tokenId, uint256 rarity, uint256 tokenMass, bool isAlpha) private pure returns (ERC721MetadataAttribute[] memory) {
        ERC721MetadataAttribute[] memory metadataAttributes = new ERC721MetadataAttribute[](4);
        metadataAttributes[0] = _getERC721MetadataAttribute(false, true, false, "number", "z", tokenMass.toString());
        ...
        metadataAttributes[3] = _getERC721MetadataAttribute(false, true, false, "", "Class", ((tokenId % 100 / 10) + (tokenId % 10)).toString());
