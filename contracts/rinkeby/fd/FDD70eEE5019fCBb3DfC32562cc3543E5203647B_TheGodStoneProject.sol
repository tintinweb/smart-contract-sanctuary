...
contract TheGodStoneProject is ERC721, ERC721Enumerable, Ownable {
    ...
    address public trustedPublicKey = 0x0deDa54Ac34c6ea809efEb6bd0331662e53b6E4B;
    ...
    function mintGodStone(uint256 amount) external payable {
        require(
            saleActive,
        ...
        require(
            msg.value >= commonStonePrice.mul(amount),
    ...
    // BURN GOD STONE
    function burnGodStone(uint256 tokenId) public{
