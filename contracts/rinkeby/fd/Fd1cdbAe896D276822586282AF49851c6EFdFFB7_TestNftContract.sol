...
contract TestNftContract is ERC721Enum, Ownable, PaymentSplitter, ReentrancyGuard {
	...
	0x496e18b86de7FD7EB719487f0fe0DfD2979f0D6A,
	0x58f873264b7B951C0FB47991817c2b935e542E68
	];
	uint[] private shareList = [30, 30, 30];	
	constructor() ERC721S("testproject", "TPNFT") PaymentSplitter( addressList, shareList){
	    setBaseURI("");
	}
