 ...
 */
contract VindergoodMarketplaceERC1155 is
    RoyaltiesV2Impl,
    ERC1155Upgradeable,
    OwnableUpgradeable
{
 ...
 */
contract VindergoodMarketplaceERC721 is
    RoyaltiesV2Impl,
    ERC721Upgradeable,
    OwnableUpgradeable
{
...
import "./VindergoodMarketplaceERC1155.sol";
import "./VindergoodMarketplaceERC721.sol";

contract VindergoodNFTs is Ownable {
    using SafeMath for uint256;

    uint256 public totalCollections;
    VindergoodMarketplaceERC721 private impl;
    VindergoodMarketplaceERC1155 private implMultiple;
    ...
    constructor(
        VindergoodMarketplaceERC1155 _implMultiple,
        VindergoodMarketplaceERC721 _impl,
        address _registry,
        address _exchange
    ) {
        impl = _impl;
    ...
    function setProxyRegistry(address _registry) external onlyOwner {
        require(
            ...
            "VindergoodNFTs::SAME REGISTRY ADDRESS"
        );
    ...
    function setNewExchange(address _exchange) external onlyOwner {
        require(
            ...
            "VindergoodNFTs::SAME EXCHANGE ADDRESS"
        );
    ...
    function newCollection(
        ...
        VindergoodMarketplaceERC721(newCollection).initialize(
            _name,
            _symbol,
            _tokenURI,
        ...
        returns (address)
    {
        ...
        VindergoodMarketplaceERC1155(newCollection).initialize(
            _tokenURI,
            _proxyRegistryAddress,
            _exchangeAddress
        );
