...
contract BlootWheelsUp is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private patterns = ['<polygon points="0,0 2,5 0,10 5,8 10,10 8,5 10,0 5,2" fill="#FFA500" opacity="0.5" />', '<polygon points="0,5 5,0 10,5 10,10 5,5 0,10" fill="#FFA500" opacity="0.5"/>'];
