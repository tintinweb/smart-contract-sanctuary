...
// TODO - test the factory enabled/disabled function
...
contract NIPnftFactory is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    event NFTcreated(address indexed creatorAddress, uint256 indexed newItemID, string indexed inputTokenURI);
    ...
    function createNFT(address creatorAddress, string memory inputTokenURI) public returns (uint256) {
        ...
        safeMintNoData(creatorAddress, newItemID);
        setTokenURI(newItemID, inputTokenURI);

        numberOfNFTsCreated[creatorAddress]++;
        
        emit NFTcreated(creatorAddress, newItemID, inputTokenURI);
