...
// File contracts/TheLostBadgers.sol
...
contract TheLostBadgers is ERC721, Ownable, ReentrancyGuard {
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenSupply;

    //sale settings
    uint256 constant private MAX_SUPPLY = 8000;
    uint256 private TEAM_RESERVE_AVAILABLE_MINTS = 50;
    uint256 private COST = 0.055 ether;
    ...
    function mint(uint256 _mintAmount) external payable {
        ...
        uint256 totalSupply = _tokenSupply.current();
        ...
        for (uint256 i = 0; i < _mintAmount; i++) {
            ...
            _safeMint(msg.sender, _tokenSupply.current() + i);
        }
    }
