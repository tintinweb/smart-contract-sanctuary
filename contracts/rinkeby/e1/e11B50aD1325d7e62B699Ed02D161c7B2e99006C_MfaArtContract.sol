  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x27EC4696076b8b52D21bF18851Fe80ef6e7BdCAd);
    ...
    // File: contracts/mfaArtContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MfaArtContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("mfa_art", "MFT", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://www.meebitsvoxel.com/";
        }
