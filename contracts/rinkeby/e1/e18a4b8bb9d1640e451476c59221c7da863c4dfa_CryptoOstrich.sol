...
// File: contract-01c194a24a_flat.sol


// File: contract-01c194a24a.sol
...
contract  CryptoOstrich  is ERC721Enumerable, Ownable
{
    ...
    constructor(string memory baseURI) ERC721("Crypto Ostrich", "OSTRICH")  {
        setBaseURI(baseURI);
    }
