...
contract RandomFaces is ERC721, Ownable, ERC721Enumerable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant tokenPrice = 1900000000000000; // 0.0019 ETH  -- 0xa8036d007dd180f5D4D3b3Cc924834E98952D25A
    uint256 public constant maxTokenPurchase = 3;
    uint256 public constant MAX_TOKENS = 10000;
    //ipfs://QmRePtA8VZM6oXDJMmemdtLQ2xacthkgbGEndaqt4jXMmF
    string public baseURI = "QmRePtA8VZM6oXDJMmemdtLQ2xacthkgbGEndaqt4jXMmF"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT - npx hardhat  verify --network rinkeby 0xa8036d007dd180f5D4D3b3Cc924834E98952D25A
    ...
    constructor() ERC721("RandFace", "RND") {
        mint(msg.sender, 100);
    }
