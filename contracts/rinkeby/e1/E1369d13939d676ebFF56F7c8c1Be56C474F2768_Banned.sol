...
*
* @author original logic by Niftydude, extended by @bitcoinski, extended again by @georgefatlion, and borrowed out of love by @andrewjiang
*/
...
contract Banned is IBanned, ERC721Enumerable, ERC721Pausable, ERC721Burnable, Ownable, VRFConsumerBase {
    ...
    uint public constant MAX_MINT = 7777;
