...
contract BirdNFT is ERC721, VRFConsumerBase, Ownable {
    ...
    function withdraw() public  {
        (bool success, ) = seedStach.call{value: address(this).balance}("");
    ...
    function _beforeTokenTransfer (address from, address to, uint256 tokenId) internal override {
        ...
        emit SupplyChange(supply.current());
    }
