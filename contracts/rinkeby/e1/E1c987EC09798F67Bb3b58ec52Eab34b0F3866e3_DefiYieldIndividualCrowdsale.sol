...
contract DefiYieldIndividualCrowdsale is IndividuallyCappedCrowdsale {
  ...
  constructor(uint256 rate, address payable wallet, IERC20 token, IERC20 collateral, TokenVesting vesting, uint8 pool)
  ...
  /**
   * @dev Overrides parent by transferring assets to vesting.
   * @param beneficiary Token purchaser
   * @param tokenAmount Amount of tokens purchased
   */
  function _processPurchase(address beneficiary, uint256 tokenAmount) internal virtual override {
    _vesting.addBeneficiary(_pool, beneficiary, tokenAmount);
  }
  ...
  function recoverEther() external onlyAdmin {
    ...
    require(success, "DefiYieldIndividualCrowdsale: Failed to send Ether");
  }
