...
contract Token is ERC20, Ownable {
    string constant SYMBOL = "PSQ";
    string constant NAME = "Parking Squatter Coin";
    uint256 constant MINT_AMOUNT = 1500000000e18;

    address constant ICO_ADDRESS = 0xaFAd1CAaeD345B223ED7AAb57AA11c937aDdD517;
    uint256 constant ICO_AMOUNT = 250000000e18;
    address constant BOUNTY_ADDRESS = 0x9fDe232Cb4c0F3fe0844c9013F9631f1e1516e22;
    uint256 constant BOUNTY_AMOUNT = 50000000e18;
    uint256 constant MINING_AMOUNT = 400000000e18;
    uint256 constant SHOP_AMOUNT = 800000000e18;

    constructor() ERC20(NAME, SYMBOL) public {
        _mint(address(this), MINT_AMOUNT);
        _transfer(address(this), ICO_ADDRESS, ICO_AMOUNT);
        _transfer(address(this), BOUNTY_ADDRESS, BOUNTY_AMOUNT);
    }
...
contract ICO is Ownable {
    ...
    function _buy(address sender, uint256 value) internal returns (uint256) {
        finish = true;
//        _sender = sender;
//        _value = value;
