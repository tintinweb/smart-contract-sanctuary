...
contract Game is Ownable {
     ...
     */
    function getRandomChoice() internal view returns (uint8) {
        //a simple but not secure way to implement, use chainlink VRF for more security
    ...
    function playerWin(uint256 bet) internal {
        ...
        if(prizePoolActivated == false || bet > prizePool * extendPoolPer / 100) {
            ...
            prizePoolEndTime = block.timestamp + prizePoolTimeLength;
            changeWinner = true;
        }
