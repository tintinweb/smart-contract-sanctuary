...
contract CnM is ICnM, ERC721Enumerable, Ownable, Pausable {
    ...
    event CatMinted(address indexed owner, uint256 indexed tokenId);
    event CrazyCatLadyMinted(address indexed owner, uint256 indexed tokenId);
    event MouseMinted(address indexed owner, uint256 indexed tokenId);
    ...
    event CatStaked(address indexed owner, uint256 indexed tokenId);
    event CrazyCatLadyStaked(address indexed owner, uint256 indexed tokenId);
    event MouseStaked(address indexed owner, uint256 indexed tokenId);

    event CatUnStaked(address indexed owner, uint256 indexed tokenId);
    event CrazyCatLadyUnStaked(address indexed owner, uint256 indexed tokenId);
    event MouseUnStaked(address indexed owner, uint256 indexed tokenId);
   ...
   * @param tokenId the id of the token to generate traits for
    ...
    */
    function generate(address recipient, uint256 tokenId, uint256 seed, LastWrite memory lw) internal returns (CatMouse memory t){
        ...
        if (existingCombinations[structToHash(t)] == 0) {
            ...
            if (t.isCat) {
                if (t.isCrazy) {
                    emit CrazyCatLadyMinted(recipient, tokenId);
                } else {
                    emit CatMinted(recipient, tokenId);
                }
            } else {
                emit MouseMinted(recipient, tokenId);
            }
            return t;
        }
    ...
    */
    function emitCrazyCatStakedEvent(address owner, uint256 tokenId) external override whenNotPaused {
        emit CrazyCatLadyStaked(owner, tokenId);
    }
    ...
    */
    function emitMouseStakedEvent(address owner, uint256 tokenId) external override whenNotPaused {
        emit MouseStaked(owner, tokenId);
    }
    ...
    */
    function emitCatUnStakedEvent(address owner, uint256 tokenId) external override whenNotPaused {
        emit CatUnStaked(owner, tokenId);
    }
    ...
    */
    function emitCrazyCatUnStakedEvent(address owner, uint256 tokenId) external override whenNotPaused {
        emit CrazyCatLadyUnStaked(owner, tokenId);
    }
    ...
    */
    function emitMouseUnStakedEvent(address owner, uint256 tokenId) external override whenNotPaused {
        emit MouseUnStaked(owner, tokenId);
    }
    //---------------------------------------------
