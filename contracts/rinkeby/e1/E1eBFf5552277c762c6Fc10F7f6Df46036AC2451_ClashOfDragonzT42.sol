...
contract ClashOfDragonzT42 is ERC721Enumerable, ERC721Burnable, ERC721Pausable, Ownable {
     ...
     */
    function togglePublicSaleActive() public unfrozen ownerOrDevAccessOnly {
     ...
     */
    function togglePrivateSaleActive() public unfrozen ownerOrDevAccessOnly {
     ...
     */
    function freezeAll() public ownerOrDevAccessOnly unfrozen {
        _frozen = true;
    }
     ...
     */
    function theBurn(uint[] memory tokenIds) public ownerOrDevAccessOnly unfrozen {
