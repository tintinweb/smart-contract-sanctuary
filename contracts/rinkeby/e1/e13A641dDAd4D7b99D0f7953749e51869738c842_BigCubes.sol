...
contract BigCubes is ERC721Tradable {

    string private _contractURI;

    constructor(address _proxyRegistryAddress, string memory _cURI) ERC721Tradable("Big Cubes", "CUBES", _proxyRegistryAddress) {  _contractURI = _cURI; }
