...
contract AuctionNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    *******************************/
    ...
    uint256 _publicStartedAt; // time
    uint256 _normalStartedAt; // time
    ...
    function requestNormalToken() external payable nonReentrant{
        uint256 secondsPassed = 0;
    ...
    function getPublicMintingAvailableTime() public view returns(uint256) {
        return PUBLIC_MINT_AVAILABLE_TIME - (now - _publicStartedAt);
    }
    ...
    function getNormalMintingAvailableTime() public view returns(uint256) {
        return NORMAL_MINT_AVAILABLE_TIME - (now - _normalStartedAt);
    }
