...
contract Sockz is ERC721, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
		...
		//socks are fungible so they can all use the same metadata here.
		//implemented as an erc721 to integrate with services and to better represent a digital object
		string memory tokenHash = "QmV5TD6bj2STBpBtV6LpKzqKVjo6v31vjRaJgSB8RcHsyH";
    ...
    function mintWithtoad(uint toadId) public payable nonReentrant {
    ...
    function multiMintWithtoad(uint[] memory toadIds) public payable nonReentrant {
        require(saleIsActive, "Sale must be active to mint");
