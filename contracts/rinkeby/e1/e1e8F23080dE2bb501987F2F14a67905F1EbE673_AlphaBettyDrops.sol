...
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "./AlphaBettyDoodles.sol";


pragma solidity ^0.8.0;

contract AlphaBettyDrops is ERC721Enumerable, Ownable {
    AlphaBettyDoodles doodles;

    uint256 private _launchTimeEpochSeconds = 1628283600;

    string private _baseTokenURI = "https://d7wwabszc3xro.cloudfront.net/";

    constructor() ERC721("AlphaBetty Drops", "ALPHABETTYDROPS") {

        doodles = AlphaBettyDoodles(0xCcA53Fb336E0153006892CeeDD84b637BdA9978B);
    }
    ...
    function isLaunched() public view returns (bool) {
        return block.timestamp >= _launchTimeEpochSeconds;
    }
    ...
    function mint(uint256 tokenId) public {  
        ...
        require(block.timestamp >= _launchTimeEpochSeconds, "Not live yet.");
        require(doodles.ownerOf(tokenId) == msg.sender, "Sender doesn't own that Betty");
