...
contract HedgeFund is Operator, ContractGuard {
    ...
    function setLPPoolValues(address _stakepegPool, address _pegsharePool) external {
...
//console.log("hedgefund:" ,mintedHedge);
    ...
    function withdrawFromHedgeFund(uint256 amount) external hasOracle hasLPPoolValues returns (uint256 removedHaifAmount) {
            ...
            uint256 stakerBalance = _haifBalances[msg.sender];

            require(stakerBalance >= amount, 'HedgeFund: You dont have this amount invested');
            ...
            _haifBalances[msg.sender] = stakerBalance.sub(amount);
