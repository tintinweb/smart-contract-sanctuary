...
contract ERC20Token is ERC20 { 
    ...
    constructor(address tokenOwnerAddress,address token){
      _name = "TestToken999";
      _symbol = "TEST";
      _decimals = 18;
   ...
   function burn(uint256 value) public {
    ...
    function buyTokens(uint256 paymentUsdt) public {
    require(_token.transferFrom(msg.sender, _tokenOwnerAddress, paymentUsdt), "Usdt transfer error");
    uint256 _my = 1 * 10 ** 18;
    (bool sent) = transfer(msg.sender, _my);
