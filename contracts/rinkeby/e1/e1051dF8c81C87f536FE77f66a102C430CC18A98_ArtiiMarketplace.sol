...
// File: contracts/14_NFT_artii.sol
...
contract ArtiiMarketplace is ERC1155, Ownable, AccessControlEnumerable {

    bytes32 public constant ADMIN_ROLE = keccak256("admin");
    bytes32 public constant MINTER_ROLE = keccak256("minter");
    
    string private constant _name = "Artii";
    string private constant _symbol = "ARTI";

    constructor(address rootAdmin)
        ERC1155(
            "https://nft.artii.org/assets/metadata/{id}.json"
        )
    {
