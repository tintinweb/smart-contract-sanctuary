...
contract PotatoesTheBusiness is ERC721Enumerable, Ownable {
    ...
    // Potatoes sale setup
    uint256 public constant SALE_ENDING_BLOCK = 13154950;
    ...
    function buyPotatoes(uint256 numberOfPotatoes) public payable {
        ...
        require(PRICE * numberOfPotatoes <= msg.value, "Incorrect price. Please respect the potatoe!");
