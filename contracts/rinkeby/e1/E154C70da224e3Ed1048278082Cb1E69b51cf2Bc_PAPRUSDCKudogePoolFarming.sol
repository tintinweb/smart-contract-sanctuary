...
contract PAPRUSDCKudogePoolFarming is Ownable, ReentrancyGuard {
    ...
    address public trustedDepositTokenAddress = 0x3fD5D987eee6b6d5E590835DA55a12cf5658307d;
    // Earned Tokens address : PRNTR
    address public trustedRewardTokenAddress = 0x7a0D9f3D669De0d8Dfe8Dc4e7dfe76Ea935d53AC; 

    // Amount of tokens
    uint public disburseAmount = 25e30;
    // To be disbursed continuously over this duration
    uint public disburseDuration = 10 days;
