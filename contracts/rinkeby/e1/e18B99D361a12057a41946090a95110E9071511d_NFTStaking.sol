...
// File contracts/BondlyAccessControl.sol
...
contract RewardDistributor is Context {
    ...
    function withdrawReward(uint256 _amount) external onlyManager {
        require(
            bondlyToken.transferFrom(_msgSender(), address(this), _amount),
            "Withdraw: BondlyToken.TransferFrom: Failed to Deposite!"
        );
        totalRewards = totalRewards.sub(_amount);
    }
}
...
contract NFTStaking is Context, ERC1155Holder {
     ...
     */
    function updateAccessControl(BondlyAccessControl _accessControl) public {
        require(
