...
contract Controller is IController, Context {
    ...
    event SetVault (address indexed _token,address indexed _vault);
    event ApprovedStrategy (address indexed _strategy,address indexed _vault);
    event RevokedStrategy (address indexed _strategy,address indexed _vault);
    event SetStrategy (address indexed _strategy,address indexed _vault);
    ...
    function approveStrategy(address _vault, address _strategy) external governanceOnly {
        ...
        emit ApprovedStrategy(_strategy, _vault);
    }
    ...
    function revokeStrategy(address _vault, address _strategy) external governanceOnly {
        ...
        emit RevokedStrategy(_strategy, _vault);
    }
    ...
    /// @param _vault Address of the vault.
    /// @param _strategy Address of the strategy.
    function setStrategy(address _vault, address _strategy) external governanceOrStrategy {
        ...
        emit SetStrategy(_strategy, _vault);
    }
