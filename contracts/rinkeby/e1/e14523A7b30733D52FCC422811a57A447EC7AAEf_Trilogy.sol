...
contract Trilogy is ERC721TradableTrilogy {
    ...
    // TEST-ONLY
    address private FINDER_1_ADDRESS   = 0xc3334d69b39972DdF4A5Cd268e0d5a02e92c3d5f;
    
    function test_finder(uint256 owned) external view returns(uint256 _trilogy_id) {
