...
// ownable operator role  TODO : ownable运营商角色
...
// erc721 base contract   TODO : ERC721基础合约
abstract contract ERC721Base is ERC721Burnable {
...
// lion metawords ERC721 contract TODO : 狮子的ERC721合约
contract LionMetawords is Ownable, ERC721Base, OwnableOperatorRole {
    // 字符串工具
    ...
    // 设置最大尺寸
    function setRelSize(uint256 _size) external onlyOwner returns (bool) {
        relMaxSize = _size;
        return true;
    }
    ...
    modifier onlyWhitelist() {
        require(whitelist[msg.sender], "account is not in whitelist");
        _;
    }

    // mint author， TODO ： 作者铸造
    function mint(
        uint256 tokenId  // NFT 的tokenID
    ) public onlyWhitelist {  // 必须是白名单账户和作者账户才能进行铸造NFT
        // 作者铸造NFT
