...
contract UniSwapV3Contract is IUniSwapV3Contract {
    address internal constant UNISWAP_V3_FACTORY =
        0x815BCC87613315327E04e4A3b7c96a79Ae80760c; // rinkeby
    address internal constant UNISWAP_V3_SWAP_ROUTER =
        0x483B27F0cF5AF935371d52A7F810799cD141E3dc;
    address internal constant POSITION_MANAGER =
        0x3255160392215494bee8B5aBf8C4C40965d0986C;
    address internal constant TEST_TOKEN_1 =
        0x106923449322ad6FC2Fe4D047f9B6deFBf2947e8; // TOKEN1
    address internal constant TEST_TOKEN_2 =
        0x086Ae3E80914ebA0Be82A4898F058380ac45E430; //TOKEN2
    ...
    constructor() {
        ...
        token0 = IERC20(TEST_TOKEN_1);
        token1 = IERC20(TEST_TOKEN_2);
    }
    ...
    function initializePool(address _pool, uint160 sqrtPriceX96)
        public
        override
    ...
    function initialLiquidityV3(addLiquidityV3Params calldata params)
        public
        override
        returns (
            uint256 tokenId,
    ...
    function approval(
        ...
        token0.approve(getPair(_token0, _token1, _fee), uint256(-1));
        token1.approve(getPair(_token0, _token1, _fee), uint256(-1));
    }

    function approvalForNFTManager() public override {
        token0.approve(POSITION_MANAGER, uint256(-1));
        token1.approve(POSITION_MANAGER, uint256(-1));
    }
