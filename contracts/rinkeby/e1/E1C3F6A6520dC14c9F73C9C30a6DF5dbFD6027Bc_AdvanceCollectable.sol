...
contract AdvanceCollectable is ERC721, VRFConsumerBase {
    ...
    mapping(uint256 => IMAGE) public tokenIdImage;
    ...
    constructor(
        ...
        bytes32 _keyhash,
        uint256 _fee
    ) public VRFConsumerBase(_vrfConsumerBase, _link) ERC721("IMAGE", "count") {
        tokenCounter = 0;
        fee = _fee;
        keyhash = _keyhash;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber)
        ...
        override
    {
        IMAGE image = IMAGE(randomNumber % 3);
        uint256 newTokenId = tokenCounter;
        tokenIdImage[newTokenId] = image;
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(
            ...
            "ERC:721, Caller is not owner o approval"
        );
