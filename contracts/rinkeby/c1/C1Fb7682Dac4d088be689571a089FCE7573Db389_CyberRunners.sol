...
contract CyberRunners is ERC721, ERC721Enumerable, Ownable {
    ...
    uint private constant maxTokenPurchase = 4;
    ...
    address  art1 = 0xEE2D12d7318c0496a0C08227886F2C804B69d92e;
    address  art2 = 0xF26ABB6E367C5CE81c8E3fAa1a2CC750f3EA5615;
    ...
    event createCyberRunner(address indexed, uint256 tokenId);
    
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("CyberRunners", "CRunners") { 
    ...
    function internalMint(address to) internal {
        ...
        emit createCyberRunner(to, _tokenIdCounter.current());
    }

    function withdraw() external onlyOwner {
        uint256 balance = address(this).balance;
        require(balance > 0);
        payable(art1).transfer((balance * 15) / 100);
        payable(art2).transfer((balance * 85) / 100);
    }
