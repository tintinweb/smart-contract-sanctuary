 ...
 //add original metadata in native initial contract   
    ...
    function initiateMetadata2() public onlyOwner {
     ...
     function initiateMetadata3() public onlyOwner {
        for (uint256 i = 1001; i<= 1500; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata4() public onlyOwner {
        for (uint256 i = 1501; i<= 2000; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata5() public onlyOwner {
        for (uint256 i = 2001; i<= 2500; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata6() public onlyOwner {
        for (uint256 i = 2501; i<= 3000; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata7() public onlyOwner {
        for (uint256 i = 3001; i<= 3500; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata8() public onlyOwner {
        for (uint256 i = 3501; i<= 4000; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata9() public onlyOwner {
        for (uint256 i = 4001; i<= 4500; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
    function initiateMetadata10() public onlyOwner {
        for (uint256 i = 4501; i<= 5000; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata11() public onlyOwner {
        for (uint256 i = 5001; i<= 5500; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata12() public onlyOwner {
        for (uint256 i = 5501; i<= 6000; i++){
            string memory temp = string(abi.encodePacked("chicken",i));
            _commonMetadata.push(temp);
        }
    }
     function initiateMetadata13() public onlyOwner {
        for (uint256 i = 6001; i<= 6500; i++){
            string memory temp = string(abi.encodePacked("dragpn",i));
            _rareMetadata.push(temp);
        }
    }
     function initiateMetadata14() public onlyOwner {
        for (uint256 i = 6501; i<= 7000; i++){
            string memory temp = string(abi.encodePacked("dragpn",i));
            _rareMetadata.push(temp);
        }
    }
    function initiateMetadata15() public onlyOwner {
        for (uint256 i = 7001; i<= 7500; i++){
            string memory temp = string(abi.encodePacked("dragpn",i));
            _rareMetadata.push(temp);
        }
    }
     function initiateMetadata16() public onlyOwner {
        for (uint256 i = 7501; i<= 8000; i++){
            string memory temp = string(abi.encodePacked("dragpn",i));
            _rareMetadata.push(temp);
        }
    }
    function initiateMetadata17() public onlyOwner {
        for (uint256 i = 8001; i<= 8500; i++){
            string memory temp = string(abi.encodePacked("dragpn",i));
            _rareMetadata.push(temp);
        }
    }
      function initiateMetadata18() public onlyOwner {
        for (uint256 i = 8501; i<= 9000; i++){
            string memory temp = string(abi.encodePacked("dragpn",i));
            _rareMetadata.push(temp);
        }
    }
    function initiateMetadata19() public onlyOwner {
        for (uint256 i = 9001; i<= 9500; i++){
            string memory temp = string(abi.encodePacked("phoenix",i));
            _legendaryMetadata.push(temp);
        }
    }
     function initiateMetadata20() public onlyOwner {
        for (uint256 i = 9501; i<= 10000; i++){
            string memory temp = string(abi.encodePacked("phoenix",i));
            _legendaryMetadata.push(temp);
        }
    }
