...
contract Catnip is Context, IBEP20, Initializable {
    ...
    function initialize() public initializer {
        ...
        tokenSymbol = "NIP2";        //CHANGEIT - Change the NAme to the PRoduction one NIP
        tokenName = "Catnip2";       //CHANGEIT - Change the NAme to the PRoduction one Catnip
        MAXintNum = ~uint256(0);
    ...
    function initializeTeamMemberWalletAddresses() internal {
        ...
        teamMemberWalletAddresses.push(teamWalletAddr);     // The Gnosis Multisg Wallet to build up community funds too    // TODO - might need to change
