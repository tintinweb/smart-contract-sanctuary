...
contract Orders is UniswapHandler {
    ...
    enum Status {None, Open, Closed, Canceled}
    ...
    function placeOrder(
        ...
        bytes32 id =
            keccak256(abi.encodePacked(msg.sender, _nonces[msg.sender]++));
        ...
        returns (bool)
    {
        ...
        uint256 allowance =
            IERC20(order.tokenIn).allowance(order.creator, address(this));
