...
contract Token is ERC721, Ownable {
	...
	uint256 public TOKEN_RESERVE = 100;
	...
	function reserveTokens(uint256 numberOfTokens) public onlyOwner {
		require(numberOfTokens > 0 && numberOfTokens <= TOKEN_RESERVE, "Not enough reserve left for team");
		...
		TOKEN_RESERVE = TOKEN_RESERVE.sub(numberOfTokens);
	}
