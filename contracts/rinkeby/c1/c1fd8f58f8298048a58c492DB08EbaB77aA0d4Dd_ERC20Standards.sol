...
contract ERC20Standards is ERC20 {
  ...
  function burn(uint256 amount) public virtual checkBurnable {
    // require(
    //   keccak256(abi.encodePacked(types)) ==
    //     keccak256(abi.encodePacked("Burnable"))
    // );
   ...
   */
  function delegate(address delegatee) external checkGovernanace {
