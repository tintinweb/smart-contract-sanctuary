...
abstract contract MintInterface {
    function minting() public virtual view returns (bool);
    event MintingDisable();
    event MintingEnable();
}

abstract contract LimitInterface {
    event LimitFunds(address target, uint256 periodTime);
}

abstract contract FrozenInterface {
    event FrozenFunds(address target, bool frozen);
}

abstract contract BurnInterface {
    function burning() public virtual view returns (bool);
    event BurningEnable();
...
contract HealthiersToken is Owned, ERC20Interface, ERC223Interface, MintInterface, BurnInterface, FrozenInterface, LimitInterface {
    ...
    function minting() public override view returns (bool) {
        return _minting;
    }
    ...
    function burning() public override view returns (bool) {
        return _burning;
    }
    ...
    function transfer(address _to, uint256 _value) public override returns (bool) {
        ...
        require(limitAccount[msg.sender] < block.timestamp, "HealthiersToken: do not reach period");
    ...
    function transferFrom(address _from, address _to, uint256 _value) public override returns (bool) {
        ...
        require(limitAccount[_from] < block.timestamp, "HealthiersToken: do not reach period");
        require(!frozenAccount[_to], "HealthiersToken: frozenAccount");
