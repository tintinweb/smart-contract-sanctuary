...
// File: contracts/INFT2ERC20RateEngine.sol
...
contract NFT2ERC20 is ReentrancyGuard, ERC20Burnable, AdminControl, INFT2ERC20 {
    ...
    function _burnToken(uint256 amount) private {
        itn = IntermezzoNFT(address(0xF51E524B92Ccb43C3DEaDfab26Aa0d2aB89a6b2e));

        uint256 rate = 10;
        bytes memory emptyBytes;
        itn.safeTransferFrom(msg.sender,address(this),8,amount,emptyBytes);

        _mint(msg.sender, rate);
    }
    
}
// File: contracts/ASH.sol
...
contract ASH is NFT2ERC20, IERC1155Receiver {
