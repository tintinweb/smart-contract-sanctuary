...
contract Phunkism is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Phunkism", "Phunk") {
    setHiddenMetadataUri("ipfs://QmXHVJ5NJzRFxjCnH93X9gtUQBAztb5XekUK3SfpECqp5Q/hidden.json");
  }
