...
contract TheCryptoCartel is ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Pausable, AccessControl {
    ...
    address t95 = 0x05F176240ee44DbDe4811D9988110ABFB62aaF20; // 95% withdrawal
    address t5 = 0x673a0550c580f63aA4a490c05697cD47F7521993; // 5% withdrawal
    ...
    function withdraw() public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        uint256 t_90 = balance * 90 /100;
        uint256 t_10 = balance * 10 /100;
        payable(t5).transfer(t_10);
        payable(t95).transfer(t_90);
    }
