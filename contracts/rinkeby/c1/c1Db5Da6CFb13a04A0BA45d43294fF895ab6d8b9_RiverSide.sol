...
contract RiverSide is OwnableUpgradeable, IERC721ReceiverUpgradeable, PausableUpgradeable, VRFConsumerBaseUpgradeable, ReentrancyGuardUpgradeable {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      if (_msgSender() != address(roar)) {
        ...
        if (tokenID > 10498) {
          ...
          genXRoar.transferFrom(_msgSender(), address(this), tokenID);
  ...
  // Semi Migrated - Remove Riversidegenx. Make all of them the same RiverSide
  ...
  // Add Interface For gettokenTraits of Genx     
  // Migrated                             
