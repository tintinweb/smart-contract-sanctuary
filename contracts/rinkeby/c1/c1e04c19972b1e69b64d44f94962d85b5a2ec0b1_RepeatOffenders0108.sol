...
// File: contracts/TestingforGas25Nov.sol


pragma solidity 0.8.9;
pragma abicoder v2;

contract RepeatOffenders0108 is ERC721, Ownable {
    ...
    uint public constant hostBodyMaxPurchase = 20;
    ...
    // Reserve up to 100 Repeat Offenders 
    uint public foundersReserve = 100;

    string private _baseTokenURI;

    constructor() ERC721("Repeat Offenders 0108", "Repeaters0108") { }
    ...
    function buyYourFreedom(uint numberOfTokens) public payable {
        ...
        require(block.number < 10082936); // edited for rinkeby blocks
    ...
    function burnYourToken(uint256 unmarkedToken) public {
        ...
        uint256 newTokenGranted = unmarkedToken + 5000;
