...
contract RaccoonSecretProject is ERC721, ERC721Enumerable, Ownable, IERC721Receiver {
    ...
    function onERC721Received(address, address _from, uint256, bytes calldata) external override returns(bytes4) {
    ...
    function angelUpgrade(uint256 tokenId) public {
        ...
        require(sacrificedRaccoons[msg.sender] >= 5, "You need to sacrifice more");
