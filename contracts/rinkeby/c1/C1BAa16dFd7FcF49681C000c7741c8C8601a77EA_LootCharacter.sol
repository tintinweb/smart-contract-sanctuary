...
contract LootCharacter is NonTransferablebERC721URIStorage, Ownable, Pausable {
    ...
    constructor(address _lootAddress, address _mLootAddress, string memory __baseURI) ERC721("Loot Character", "LCHAR") {
        lootAddress = _lootAddress;
        mLootAddress = _mLootAddress;
        baseURI = __baseURI;  // NOTE - double underscore to not shadow _baseURI method
    }
