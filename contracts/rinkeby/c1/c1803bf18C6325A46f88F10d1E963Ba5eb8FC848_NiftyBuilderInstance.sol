...
contract NiftyBuilderInstance is ERC721, ERC721Burnable {
    ...
    ) ERC721(defaultOwner, niftyRegistryContract) {
        _creator = "Goldweard";
        _setNiftyTypeName(1, "Crystal Pop");
    }
    ...
    function mintNifty(uint256 niftyType, uint256 count) public onlyValidSender {
        ...
        uint256 tokenNumber = _mintCount[niftyType];
...
contract ERC721 is NiftyEntity, Context, ERC165, IERC721, IERC721Metadata {
    ...
    constructor(
        ...
        _id = 1;
        _typeCount = 1;
        _baseURI = "https://api.niftygateway.com/crystal-pop-10k/";
        _symbol = "CrystalPops10K";
        _name = "Crystal Pops 10K";
