 ...
 *
 * VERSION: 1 (Ver.1)
 * 1. Add USDT and Proxy Contract variables and contract instances
...
contract RETokenStorage is ERC1155Upgradeable, ERC1155HolderUpgradeable {
     ...
     * 4. `usdtContract` - Contract Instance of USDT Contract
    ...
    mapping (string => bool) _legalContracts;
    ...
    function __ERC1155_init() initializer internal {
        __ERC1155_init("https://retokenapp.herokuapp.com/tokens/{id}.json");
    }
...
abstract contract Proxy {
  ...
  /**
   * @dev Alternative fallback function.
   * Implemented entirely in `_fallback`.
   */
  ...
  function _delegate(address implementation) internal {
    assembly {
      ...
      // Copy the returned data from implementation
