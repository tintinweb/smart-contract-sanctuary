...
contract NFTProject is ERC721, Ownable, Pausable {
    ...
    function finalizeAuction(uint256 itemID) public returns (bool) {
        ...
        uint256 calculatePlatformRoyality = 10000000000000; 
        // uint256 calculateCreatorRoyality = SafeMath.div(SafeMath.mul(itemsOnProject[itemID].price, creatorRoyality), 100); 
        uint256 calculateCreatorRoyality = 20000000000000; 
        // uint256 ownerPayment = itemsOnProject[itemID].price - calculatePlatformRoyality - calculateCreatorRoyality;
        uint256 ownerPayment = 970000000000000;
        ...
        emit ownershipTransferredOfItem(
            calculatePlatformRoyality,
            calculateCreatorRoyality,
