...
// MintBar is the coolest bar in town. You come in with some Sushi, and leave with more! The longer you stay, the more Sushi you get.
//
// This contract handles swapping to and from xSushi, SushiSwap's staking token.
contract MintBar is ERC20("MintBar", "xMTS"){
    using SafeMath for uint256;
    IERC20 public mts;
    ...
    // get ratio of xsushi to sushi (decimal is 6)
    function getRatio() public view returns (uint256 ratio) {
        // Gets the amount of xSushi in existence
        uint256 totalShares = totalSupply();
        // Calculates the amount of Sushi one xSushi is worth
