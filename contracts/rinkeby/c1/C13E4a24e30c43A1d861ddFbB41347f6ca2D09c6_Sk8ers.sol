...
contract Sk8ers is ERC721Enumerable, Ownable {
    ...
    uint256 public constant RESERVES = 300;
    uint256 public constant MINT_LIMIT = 20;
    uint256 private _saleTime = 1638468000; // Thursday 2 December 2021 18:00:00
    ...
    constructor(string memory baseURI, string memory theContractURI) ERC721("Sk8ers", "SK8") {
        setBaseURI(baseURI);
        setContractURI(theContractURI);
    }
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        require(totalSupply() + _count <= MAX_SK8ERS, "Max limit");
    ...
    function reserveSk8ers(uint256 _count) public onlyOwner {
