...
contract COVIDPUNKSv04 is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  constructor() ERC721("COVIDPUNKSv04", "COV-4PUNKS") {}
...
//   uint256 public _price = 30000000000000000; // 0.03 ETH
    ...
    // withdraw addresses
    address t1 = 0xe0DF6a29eFB0C5EbdCb69f88f858c95d6BD27094;
    address t2 = 0xA8c45A88D8E403C60B9E505a864EE4D11248f84d;
...
// have replaced 10000 with 100 for testing. Change back later.
  uint256[50] private _availableTokens;
  uint256 private _numAvailableTokens = 50;
  ...
  function mint(uint256 _numToMint) public payable nonReentrant() {
    ...
    uint256 costForMintingPhunks = _price * _numToMint;
    require(
...
function setPrice(uint256 _newPrice) public onlyOwner() {
  ...
  function giveFreeRoll(address receiver, uint256 numRolls) public onlyOwner {
    ...
    freeRollPhunks[receiver] = freeRolls + numRolls;
...
// EDITwhy is withdrawal function payable?
  function withdrawOwner() public onlyOwner {
    (bool success, ) = msg.sender.call{value: address(this).balance}("");
    require(success, "Transfer failed.");
  }

// EDIT why is withdrawal function payable?
    function withdrawTeam() public onlyOwner {
    //uint256 _each = address(this).balance / 4;
    // uint256 _sixp = .06;
    uint256 _balance = address(this).balance;
    uint256 _t1 = _balance / 100 * 6;
    uint256 _t2 = _balance - _t1;
