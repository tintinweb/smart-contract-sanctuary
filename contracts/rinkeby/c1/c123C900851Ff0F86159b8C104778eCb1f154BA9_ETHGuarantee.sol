...
abstract contract Guarantee is Pausable {
    ...
    function register(uint256 _guarantorIndex, address _demandA, address _demandB, uint256 _fund, uint32 _feePercentLimit, string calldata _content) external whenNotPaused {
    ...
    function deposit(uint256 _guaranteeIndex, uint256 _amount) external whenNotPaused {
