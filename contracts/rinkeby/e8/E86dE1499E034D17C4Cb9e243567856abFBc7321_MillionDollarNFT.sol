...
contract MillionDollarNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    modifier ifWithdrawalsEnabled () {
        require(withdrawalsEnabled, "Withdrawals are disabled");
        _;
    }

    constructor() ERC721("MillionDollarNFT", "MDNFT") Ownable() {
        minDeposit = 100000;
    ...
    public
    onlyOwner {
        require(!withdrawalsEnabled, "Withdrawals already disabled!");
        withdrawalsEnabled = true;
    }
}
