...
contract TestProject is ERC721Enumerable, Ownable {
    using Address for address;

    // Withdraw Address
    address A1 = 0x3c564044123B2Ca6AB4dE20Af9Fa0E159783a2D5;
    address A2 = 0x98067D7ABf4b4E3379AD9b784a46F1d74008BdAd;
    ...
    uint256 constant GIFT_SUPPLY = 100;
    uint256 constant PRESALE_SUPPLY = 1200;
    uint256 constant PUBLIC_SUPPLY = MAX_SUPPLY - GIFT_SUPPLY - PRESALE_SUPPLY;

    // The base link that leads to the image / video of the token
    string public baseTokenURI;

    constructor(string memory newBaseURI) ERC721("Test H Token", "THT") {
    ...
    function checkTokenOwner(address addr)
        public
        view
