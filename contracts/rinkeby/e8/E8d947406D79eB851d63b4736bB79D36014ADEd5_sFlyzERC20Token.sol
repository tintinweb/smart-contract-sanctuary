...
contract sFlyzERC20Token is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Flyz", "sFLZ", 9) ERC20Permit("sFLZ") {
    ...
    /**
        @notice increases sFLZ supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFLZ
