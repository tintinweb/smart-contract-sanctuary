...
//owen.eth
contract deSocialBetaBuddy is ERC721("Beta Buddies by de.Social", "BETA BUDDIES"), HasSecondarySaleFees{
	...
	constructor() public {
		owner = msg.sender;
		_setBaseURI("https://api.de.social/api/metadata/");
	...
	function mint(uint256 _amount) public payable {
		require(available == true, "Too early!");
