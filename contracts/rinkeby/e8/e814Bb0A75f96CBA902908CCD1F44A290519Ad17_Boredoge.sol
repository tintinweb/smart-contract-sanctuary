...
contract Boredoge is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;

  uint256 public currentSupply = 0;
  //string public baseURI;
  uint256 public cost = 50000000;
  ...
  constructor(
    ...
    RandomlyAssigned(maxSupply,1) {
          _setBaseURI("https://gateway.pinata.cloud/ipfs/QmcNfSaajFrgZFE5jKoTDWeRQ6rej61NzubUjf11MEUu8M/");
...
*/
  function pause(bool _state) internal onlyOwner {
    paused = _state;
  }
