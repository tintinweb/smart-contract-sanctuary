...
contract AlphaStrategy is Pausable, AlphaToken {
    ...
    function calculateProfitFees() external onlyManager {
        PROFIT_FEES = (TOTAL_ALPHA_SUPPLY * (ALPHA_PRICE - ALPHA_PRICE_WAVG) * PROFIT_FEE_RATE) / (COEFF_SCALE_DECIMALS * COEFF_SCALE_DECIMALS_F);
    ...
    function calculateManagementFees() external onlyManager {
        MANAGEMENT_FEES = (TOTAL_ALPHA_SUPPLY * MANAGEMENT_FEE_RATE) / (COEFF_SCALE_DECIMALS * COEFF_SCALE_DECIMALS_M);
    }
