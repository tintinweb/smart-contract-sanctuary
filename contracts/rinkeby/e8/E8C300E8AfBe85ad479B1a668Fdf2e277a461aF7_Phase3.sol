/*
        ...
        \ \  \|\  \ \  \\\  \ \  \|\  \ \  \___|\ \   __/|        \|____|\ /_          \ \  \|\ /_   \ \  \/  / /                          
         \ \   ____\ \   __  \ \   __  \ \_____  \ \  \_|/__            \|\  \          \ \   __  \   \ \    / /                           
          \ \  \___|\ \  \ \  \ \  \ \  \|____|\  \ \  \_|\ \          __\_\  \          \ \  \|\  \   \/  /  /                            
           \ \__\    \ \__\ \__\ \__\ \__\____\_\  \ \_______\        |\_______\          \ \_______\__/  / /                              
            \|__|     \|__|\|__|\|__|\|__|\_________\|_______|        \|_______|           \|_______|\___/ /                               
                                         \|_________|                                               \|___|/                                
                                                                                                                                   
                                                                                                                                   
 ________  ________  ________      ___    ___      ___      ___ ________  ________           ___       _______   ___       __      
|\   ____\|\   __  \|\   __  \    |\  \  /  /|    |\  \    /  /|\   __  \|\   ___  \        |\  \     |\  ___ \ |\  \     |\  \    
\ \  \___|\ \  \|\  \ \  \|\  \   \ \  \/  / /    \ \  \  /  / | \  \|\  \ \  \\ \  \       \ \  \    \ \   __/|\ \  \    \ \  \   
 \ \  \    \ \  \\\  \ \   _  _\   \ \    / /      \ \  \/  / / \ \   __  \ \  \\ \  \       \ \  \    \ \  \_|/_\ \  \  __\ \  \  
  \ \  \____\ \  \\\  \ \  \\  \|   \/  /  /        \ \    / /   \ \  \ \  \ \  \\ \  \       \ \  \____\ \  \_|\ \ \  \|\__\_\  \ 
   \ \_______\ \_______\ \__\\ _\ __/  / /           \ \__/ /     \ \__\ \__\ \__\\ \__\       \ \_______\ \_______\ \____________\
    \|_______|\|_______|\|__|\|__|\___/ /             \|__|/       \|__|\|__|\|__| \|__|        \|_______|\|_______|\|____________|
                                 \|___|/                                                                                                                                                                                                                            
    ...
    Ownable
{
    ...
    /**
     * @dev Grants `adminRole`, `minterRole` and `pauserRole` to the
    ...
    constructor(
        ...
        _setupRole(pauserRole, _msgSender());
    }
    ...
    function mint(address to) public virtual {
        require(
            hasRole(minterRole, _msgSender()),
            "Phase 3: must have minter role to mint"
        );
    ...
    function mintMultiple(address to, uint256 amount) public virtual {
        require(
            hasRole(minterRole, _msgSender()),
            "Phase 3: must have minter role to mint"
        );
    ...
    function pause() public virtual {
        require(
            hasRole(pauserRole, _msgSender()),
            "Phase 3: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(pauserRole, _msgSender()),
            "Phase 3: must have pauser role to unpause"
        );
        _unpause();
    }
