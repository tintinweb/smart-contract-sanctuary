...
contract Staking is Ownable {
	...
	uint256 public minimumAmount = 10000000000000000; //1 SPI
	uint256 public maxAmount = 10000000000000000000; //1000 SPI
	uint256 lockTime = 10 minutes; //1 hours
	...
	function stake(uint256 _amount) external {
		require(_amount >= minimumAmount, "amount >= minimumAmount");
	...
	function unstake() external {
		...
		require(user.lastUpdateAt + lockTime <= block.timestamp, "lock time 3 days");
