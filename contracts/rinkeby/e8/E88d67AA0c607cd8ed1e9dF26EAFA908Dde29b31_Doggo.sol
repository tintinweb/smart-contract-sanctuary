...
// File: contracts/doggoEye.sol                                                                                             \|_________|
/*
                                                    `..:`.
                                                ``.-/.::/..```.-----:-`
                                    ```....````.-.`    `...-:+------..:.
...
contract Doggo is ERC721A, Ownable, Pausable, PreSaleAware, ReentrancyGuard {
	...
	bytes32 public constant PRE_SALE_MERKLE_ROOT = 0xd406e4ab758566f64b379c1948f8350a9ad4ac0deabc375ddbff6e8b46c0f9db;
	...
	constructor() ERC721A("DoggoEye9", "DE9", 200) {
		setHiddenMetadataUri("ipfs://QmWsSvghTJdjJcQjsRNSK6QZ6Bmj3ufnDrjmowS44xbPBb/unreaveled");
	}
	...
	function withdraw() public onlyOwner {
     // DAO reserve 30% for the DAO
     (bool hs, ) = payable(0xfE379610071D92Effd15CDF689dfccf7318E6602).call{value: address(this).balance * 30 / 100}("");
     require(hs);
