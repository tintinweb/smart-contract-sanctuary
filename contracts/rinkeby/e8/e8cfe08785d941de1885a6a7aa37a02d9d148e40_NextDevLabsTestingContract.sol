  ...
  function _beforeTokenTransfer(
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xD3524526DDF70D0E2Ce1D3ec3620C54C7C4dEC5d);
    ...
    // File: contracts/nextDevLabsTestingContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract NextDevLabsTestingContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("NextDev Labs Testing", "NDLT", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/lq3Su5wL9GXKGKTh05L1/contract-metadata";
        }
    }