...
contract MaterialBag is ERC721, ReentrancyGuard, Ownable, MaterialMetadata {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        (uint256[1] memory components, uint256 itemType) = MaterialTokenId.fromId(gemId(tokenId));
        ...
        (components, itemType) = MaterialTokenId.fromId(runeId(tokenId));
        slot = materialItemTypes[itemType];
        res = string(abi.encodePacked(res, ", ", materialTrait("Slot", slot)));
        item = materialItemName(itemType, components[0]);
        res = string(abi.encodePacked(res, ", ", materialTrait("Item", item)));

        parts[4] = '</text><text x="10" y="60" class="base">';

        parts[5] = materialTokenName(materialId(tokenId));
        (components, itemType) = MaterialTokenId.fromId(materialId(tokenId));
        slot = materialItemTypes[itemType];
        res = string(abi.encodePacked(res, ", ", materialTrait("Slot", slot)));
        item = materialItemName(itemType, components[0]);
        res = string(abi.encodePacked(res, ", ", materialTrait("Item", item)));
        ...
        (components, itemType) = MaterialTokenId.fromId(charmId(tokenId));
        slot = materialItemTypes[itemType];
        res = string(abi.encodePacked(res, ", ", materialTrait("Slot", slot)));
        item = materialItemName(itemType, components[0]);
        res = string(abi.encodePacked(res, ", ", materialTrait("Item", item)));
        ...
        (components, itemType) = MaterialTokenId.fromId(toolId(tokenId));
        slot = materialItemTypes[itemType];
        res = string(abi.encodePacked(res, ", ", materialTrait("Slot", slot)));
        item = materialItemName(itemType, components[0]);
        res = string(abi.encodePacked(res, ", ", materialTrait("Item", item)));
        ...
        (components, itemType) = MaterialTokenId.fromId(elementId(tokenId));
        slot = materialItemTypes[itemType];
        res = string(abi.encodePacked(res, ", ", materialTrait("Slot", slot)));
        item = materialItemName(itemType, components[0]);
        res = string(abi.encodePacked(res, ", ", materialTrait("Item", item)));
        ...
        (components, itemType) = MaterialTokenId.fromId(requirementId(tokenId));
        slot = materialItemTypes[itemType];
        res = string(abi.encodePacked(res, ", ", materialTrait("Slot", slot)));
        item = materialItemName(itemType, components[0]);
        res = string(abi.encodePacked(res, ", ", materialTrait("Item", item)));
