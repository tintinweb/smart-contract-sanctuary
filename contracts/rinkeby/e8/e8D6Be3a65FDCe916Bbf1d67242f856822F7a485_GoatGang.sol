    ...
    PaymentSplitter
{
    ...
    //the merkle root
    bytes32 public root =
        0x53f1995dc0ddf5a8ff7b345d7a2e822cad528e6d5a7afcae13e6cf7a050e03b4;

    string public _contractBaseURI = "https://exo-api.to.wtf/metadata/";
    string public _contractURI =
        "https://to.wtf/contract_uri/exoverse/contract_uri.json";
    ...
    uint256 public publicSaleStartTime = block.timestamp; //1641870000; Tue Jan 11 2022 03:00:00 GMT+0000
    ...
    function whitelistBuy(
        ...
        require(
            _tokenIds.current() + qty < maxSupplyPresale + 1,
            "out of stock"
        );
    ...
    function decreaseMaxPresaleSupply(uint256 newMaxPresaleSupply)
        external
        onlyOwner
    {
