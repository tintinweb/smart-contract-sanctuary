...
contract SmartContract is ERC721Enumerable, Ownable {
    ...
    address public artistAddress = 0x848b6B2e7c8Bf9D4172305fd12B51446417e6f9a;
    address public txFeeToken = 0x848b6B2e7c8Bf9D4172305fd12B51446417e6f9a;
    uint public txFeeAmount = 10000000000000000;
  ...
  function _payTxFee(address from) internal {
    ...
    token.transferFrom(from, artistAddress, txFeeAmount);
  }
}