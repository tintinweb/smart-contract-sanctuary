...
contract TestPunksMarket is ERC721 {
    ...
    string public standard = 'TestPunks';
    // string public name;
    ...
    constructor() ERC721("TestPunks", "\xcf\xbe") {
        //        balanceOf[msg.sender] = initialSupply;              // Give the creator all initial tokens
        owner = msg.sender;
        totalSupply = 10000;                        // Update total supply
        punksRemainingToAssign = totalSupply;
        // name = "TESTPUNKS";                                   // Set the name for display purposes
    ...
    function setInitialOwner(address to, uint punkIndex) public {
        ...
        if (punkIndexToAddress[punkIndex] != to) {
            if (punkIndexToAddress[punkIndex] != address(0)) {
                _balanceOf[punkIndexToAddress[punkIndex]]--;
            } else {
    ...
    function transferPunk(address to, uint punkIndex) public {
        ...
        _balanceOf[msg.sender]--;
        _balanceOf[to]++;
        emit Transfer_(msg.sender, to, 1);
    ...
    function buyPunk(uint punkIndex) payable public {
        ...
        _balanceOf[seller]--;
        _balanceOf[msg.sender]++;
        emit Transfer_(seller, msg.sender, 1);
    ...
    function acceptBidForPunk(uint punkIndex, uint minPrice) public {
        ...
        _balanceOf[seller]--;
        _balanceOf[bid.bidder]++;
        emit Transfer_(seller, bid.bidder, 1);
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory baseURI = "ipfs://QmSKr9gButtzbLeSgzLpqAMBZJ9BCek8iJ2erhjdH4QATT/";
