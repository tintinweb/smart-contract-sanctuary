...
contract BattleDoge is ERC721, VRFConsumerBase, Ownable {
   ...
   function Attack (uint256 tokenId, uint256 _tokenId , uint256 _number)  public  returns (uint256 _winner)   {
     ...
     Game memory newGame = Game(index, ownerOf(tokenId), ownerOf(_tokenId), _number, ownerOf(_winner));
    ...
    function get_game_info(uint256 _index) external view returns(uint256 _i, address _player1, address _player2, uint256 _number, address _winner) {
