...
contract GeneRoom is ERC721Enumerable, Ownable {
    ...
    function mint(uint64 quantity) external payable {
        ...
        require(!msg.sender.isContract() || msg.sender == owner(), 'only EOA or owner');
    ...
    // for testing purpose only should remove.
    function setNextTokenId(uint64 _nextToken) external  {
        nextTokenId = _nextToken;
    }
}
