...
contract FloydiesGenerative is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    function mint(uint256 num ) public payable {
        ...
        require((supply + num) < 5000, "Your order exceeds the maximum supply of 5,000 Floydies!");
        require( msg.value >= 0.006 ether * num, "Not enough ETH paid, make sure to pay 0.006" );
