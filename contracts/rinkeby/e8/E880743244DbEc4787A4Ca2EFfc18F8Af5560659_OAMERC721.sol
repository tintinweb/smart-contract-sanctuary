...
contract OAMERC721 is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIds;

    event OAMERC721TokenMinted(
        uint256 tokenId,
        string tokenURI,
        address receiver,
        uint256 time
    ...
    function mint(
    ...
    ) public virtual onlyOwner returns (uint256 tokenId) {
        _tokenIds.increment();
        ...
        emit OAMERC721TokenMinted(newItemId, tokenURI, receiver, block.timestamp);
