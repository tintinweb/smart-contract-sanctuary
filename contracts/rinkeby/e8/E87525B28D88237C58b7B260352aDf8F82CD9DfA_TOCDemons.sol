...
// File: contracts/LowerGasTOC.sol
...
contract TOCDemons is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TOC Demons", "TOCD") {
    setHiddenMetadataUri("ipfs://QmUN1otD1KhHmKpf3bp4wg1d7aDCD3gCW83d4EmUgSPY8y/hidden.json");
  }
