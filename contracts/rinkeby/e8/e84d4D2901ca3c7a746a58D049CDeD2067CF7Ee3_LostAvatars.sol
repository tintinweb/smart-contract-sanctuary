...
*/
    ...
    function mint(uint256 numberOfTokens) external payable nonReentrant {
        ...
        require(
            ...
            "Sorry you cannot mint more at once!"
        );
        require(totalSupply() <= MAX_SUPPLY - reserved, "All tokens minted");
        require(
            totalSupply() + numberOfTokens <= maxMints,
            "Not enough Tokens avaiable"
        );

        require(
            msg.value >= mintingCost * numberOfTokens,
