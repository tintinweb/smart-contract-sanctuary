...
contract CressayZoo4 is Ownable, ReentrancyGuard, ERC721Enumerable {
    ...
    uint256 public constant withdrawpercent = 30;
    uint256 public constant daopercent = 5;
    uint256 public constant donationpercent = 5;
    ...
    */
     ...
     constructor(
        ...
        address dao,
        address dona
    ) ERC721("CressayZoo2", "CRZ") {
        address1 = addr1;
        address2 = addr2;
        daoaddress = dao;
        donationaddress = dona;
    }
   ...
   function reserve() public onlyOwner {
    ...
    function withdraw() public onlyOwner {
        ...
        sendValueTo(daoaddress, (value * daopercent) / 100);
        sendValueTo(donationaddress, (value * donationpercent) / 100);
    }
