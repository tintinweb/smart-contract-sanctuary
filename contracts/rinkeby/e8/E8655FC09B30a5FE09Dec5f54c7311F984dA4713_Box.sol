...
contract Box is ERC721, Ownable, IMintedBeforeReveal {

    // This is the provenance record of all Boxes  in existence. The provenance will be updated once metadata is live at launch.
    ...
    // Maximum amount of Boxes  in existance.
    ...
    uint256 BASE_LILBANANA_COST = 3000000000000000;  //   0.03 LILBANANA
    ...
    function FreeMint(uint256 numberOfTokens) public {
        ...
        //Burn LilBanana
        ILilBanana(LILBANANA_ADDRESS).burnFrom(msg.sender, BASE_LILBANANA_COST);
