            ...
            output = string(abi.encodePacked(
                output, 
                    '<style>',
                        ...
                        ';stroke:#',
                        CorneaColor[neucleotideIdxArray[1]],              // taking first element of dna for first color
                        '; stroke-width:2}'
                        '.pupilColor{fill:#', 
                        PupilColor[0],              // taking first element of dna for first color
                        ';stroke:#',
                        PupilColor[neucleotideIdxArray[2]],              // taking first element of dna for first color
                        '; stroke-width:1}'
