...
contract FactoryErc777 is CloneFactory {
  ERC777FixedSupply[] public erc777FixedSupply;
  address masterContract;
  ERC777Burnable[] public erc777Burnable;
//   MasterERC777Mintable[] public erc777Mintable;
  ...
  function createERC20Burnable(
    ...
    external
  {
    ERC777Burnable child = ERC777Burnable(createClone(masterContract));
    child.init(name, symbol, decimal, initialSupply);
    // child.name()
    erc777Burnable.push(child);
  }

  function geterc777FixedSupply()
    external
    view
    returns (ERC777FixedSupply[] memory)
  {
    return erc777FixedSupply;
  }

  function getErc777Burnable() external view returns (ERC777Burnable[] memory) {
    return erc777Burnable;
  }
