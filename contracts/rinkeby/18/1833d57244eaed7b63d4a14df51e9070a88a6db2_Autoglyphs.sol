...
contract Autoglyphs {
    ...
    mapping (uint => uint8) private idToSymbol;
    // ERC 165
    ...
    function draw(uint id) public view returns (string) {
        ...
        if (idToSymbol[1] == 0) {
            revert();
        } else if (idToSymbol[2] == 1) {
            symbols = 0x2E582F5C2E; // X/\
        } else if (idToSymbol[3] == 2) {
            symbols = 0x2E2B2D7C2E; // +-|
        } else if (idToSymbol[4] == 3) {
            symbols = 0x2E2F5C2E2E; // /\
        } else if (idToSymbol[5] == 4) {
            symbols = 0x2E5C7C2D2F; // \|-/
        } else if (idToSymbol[6] == 5) {
            symbols = 0x2E4F7C2D2E; // O|-
        } else if (idToSymbol[7] == 6) {
            symbols = 0x2E5C5C2E2E; // \
        } else if (idToSymbol[8] == 7) {
            symbols = 0x2E237C2D2B; // #|-+
        } else if (idToSymbol[9] == 8) {
            symbols = 0x2E4F4F2E2E; // OO
        } else if (idToSymbol[10] == 9) {
