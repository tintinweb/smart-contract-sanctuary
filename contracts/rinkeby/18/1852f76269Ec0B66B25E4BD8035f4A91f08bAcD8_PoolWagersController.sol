...
contract PoolWagersController is Ownable {
    ...
    payable
    {
        ...
        payable(address(mevu)).transfer(msg.value);
        ...
        external        
    {
        ...
        mevu.transferEth(payable(msg.sender), reward);
    }

    function determineReward(uint256 subtotal, uint256 yourStake, uint256 betForOpponent) internal pure returns (uint256){
    ...
    function claimRefund (bytes32 wagerId) notPaused external {
        ...
        mevu.transferEth(payable(msg.sender), value);     
    }
}
