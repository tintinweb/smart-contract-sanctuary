...
contract BatchAuction is IFlybyMarket, FLYBYAccessControls, BoringBatchable, SafeTransfer, Ownable, ReentrancyGuard  {
    ...
    uint256 public nextTimeRedeem = 30;
    ...
    function setNextTimeRedeem(uint256 _nextTimeRedeem) public onlyOwner {
        nextTimeRedeem = _nextTimeRedeem;
    }
    ...
    function withdrawTokens(address payable beneficiary) public nonReentrant {
        if (auctionSuccessful()) {
            ...
            approve(0x3aB3E303D37AB51C260d809cB873e68a3A03134B, auctionToken, secondRedeemToken);
            
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), secondRedeemToken, marketInfo.endTime + nextTimeRedeem, beneficiary);
        } else {
            require(block.timestamp > marketInfo.endTime, "BatchAuction: Auction has not finished yet");
