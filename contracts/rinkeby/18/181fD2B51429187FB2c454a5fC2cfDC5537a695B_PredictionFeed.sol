...
contract PredictionFeed is Ownable, ChainlinkClient {
    ...
    mapping(address => AggregatorV2V3Interface) private priceFeeds;
    ...
    constructor(address _gfxAddress, address _oracleAddress) {
        ...
        ] = AggregatorV2V3Interface(0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE);
        priceFeeds[
            0x264990fbd0A4796A3E3d8E37C4d5F87a3aCa5Ebf
        ] = AggregatorV2V3Interface(0x264990fbd0A4796A3E3d8E37C4d5F87a3aCa5Ebf);
        priceFeeds[
            0x63D407F32Aa72E63C7209ce1c2F5dA40b3AaE726
        ] = AggregatorV2V3Interface(0x63D407F32Aa72E63C7209ce1c2F5dA40b3AaE726);

        // BSC TEST NET
        priceFeeds[
            0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526
        ] = AggregatorV2V3Interface(0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526);
        priceFeeds[
            0x5741306c21795FdCBb9b265Ea0255F499DFe515C
        ] = AggregatorV2V3Interface(0x5741306c21795FdCBb9b265Ea0255F499DFe515C);
        priceFeeds[
            0x143db3CEEfbdfe5631aDD3E50f7614B6ba708BA7
        ] = AggregatorV2V3Interface(0x143db3CEEfbdfe5631aDD3E50f7614B6ba708BA7);

        gfx_ = IERC20(_gfxAddress);

        oracleAddress_ = _oracleAddress;
        jobId_ = "6d1bfe27e7034b1d87b5270556b17277";
        fee_ = 0.1 * (10**18);
    ...
    function startPool(uint256 _poolId) public onlyOwner {
    ...
    function lockPool(uint256 _poolId) public onlyOwner {
        ...
        canParticipatePool(_poolId)
    {
        ...
        emit NewParticipantJoined(_poolId, msg.sender, msg.value, _vote);
