...
contract pizzaNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    {
        return super.tokenURI(tokenId);
    }function createPizzaIngretients(address wallet_address, string[] memory tokenURI) public  onlyOwner returns (bool success){
        _itemIds.increment();
    ...
    //combina IngredientURI
    // function buyingPizza() public returns (uint256){
    // }
      enum Letter {A, B, C}
   function say(uint index) public returns (Letter) {
