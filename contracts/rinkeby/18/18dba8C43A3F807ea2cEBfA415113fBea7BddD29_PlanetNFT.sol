...
contract PlanetNFT is ERC721Tradable {
    ...
    function create_random(uint256 tokenId,
        ...
        if(_angletype==0){
            ...
            newPlanet.positionX=int16(700-newPlanet.radius-uint16(2*uint256(longRadius)*707/1000))-int16(uint16(randomNum(uint256(700-newPlanet.radius-uint256(longRadius)*707/1000)*2, newPlanet.randomness, block.timestamp)));
            newPlanet.positionY=int16(700-newPlanet.radius-uint16(2*uint256(longRadius)*707/1000))-int16(uint16(randomNum(uint256(700-newPlanet.radius-uint256(longRadius)*707/1000)*2, newPlanet.randomness, block.timestamp)));
        }
