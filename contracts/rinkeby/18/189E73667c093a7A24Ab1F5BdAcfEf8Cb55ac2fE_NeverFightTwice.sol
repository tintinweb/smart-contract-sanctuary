...
contract NeverFightTwice is VRFConsumerBase, IERC721Receiver {
    ...
    mapping (bytes32 => bool) public requestIdToWinOrLose; // true is win
    mapping (bytes32 => uint256) public requestIdToWinTokenId; // true is win
    mapping (bytes32 => address) public requestIdToWinNFTcontract; // true is win
    ...
    internal override {
        ...
        if(randomNumber.mod(2) == 0 || NFTsLen == 0) {
            ...
            NFTsLen++;
            requestIdToWinOrLose[requestId] = false;
        }
        else {
            ...
            requestIdToWinOrLose[requestId] = true;
            requestIdToWinTokenId[requestId] = winningNFT.tokenId;
            requestIdToWinNFTcontract[requestId] = winningNFT.NFTcontract;
