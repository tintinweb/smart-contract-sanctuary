...
contract DEX {
    ...
    event TestApproval(address owner, address spender, uint allowance);
    ...
    function buy(uint numTokens) public payable {
        ...
        require(numTokens <= token.balanceOf(address(this)), "Not enough tokens in the reserve");
    ...
    function withdraw() public {
        ...
        require(sale.withdrawn == false, 'You have already redeemed your tokens');
        require(block.timestamp >= sale.soldAt + duration, 'You cannot redeem your tokens yet');
...
contract Token is ERC20 {
    ...
    constructor (uint _totalSupply) ERC20 ('InterestToken', 'ITK') {
        owner = msg.sender;
