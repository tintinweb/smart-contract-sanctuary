...
contract GetSchwiftyNFT is ERC721Enumerable, PaymentSplitter, Ownable {
    ...
    bool private _breedActive;
    bool private _mutateActive;
    bool private _presaleActive;
    mapping(uint256 => bool) private _canBreed;
    ...
    function mintMultiple(uint256 amount) public payable {
        require(_mintActive, "Sale is not acitve!");
        require(getItemPrice().mul(amount) == msg.value, "Insufficient ETH");
    ...
    function breed(uint256 id1, uint256 id2) public payable {
        require(_breedActive, "Breed is not acitve!");
        require((ownerOf(id1) == ownerOf(id2)) && ownerOf(id1) == msg.sender, "You dont own these IDs!");
        ...
        require(_canBreed[id1] && _canBreed[id2], "IDs cannot breed anymore!");
    ...
    function getMintActive() view public returns (bool) {
        return _mintActive;
    }

    function getBreedActive() view public returns (bool) {
        return _breedActive;
    }

    function getMutateActive() view public returns (bool) {
        return _mutateActive;
    }

    function getPresaleActive() view public returns (bool) {
    ...
    function canBreed(uint256 id) view public returns (bool) {
        return _canBreed[id];
    }
}
