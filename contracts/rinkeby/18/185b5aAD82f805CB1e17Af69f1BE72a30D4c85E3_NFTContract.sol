...
contract NFTContract is ERC721, ERC721Enumerable, Ownable {
    ...
    address public constant USER_1_ADDRESS = 0xB8dee77177A8b9CC8bD9583Afb1F8F0Fca8E4f33; // todo: add right address
    address public constant USER_2_ADDRESS = 0x15C69Bd0fc7D792454975CE8D0E3fD74C5fe9567; // todo: add right address
    address public constant USER_3_ADDRESS = 0x787946Ab56bc1DDfE602B8643f3f3F9AEd6D361B; // todo: add right address
    address public constant USER_4_ADDRESS = 0xcF9cf2944F5c59644edCdd975bA83d1778548230; // todo: add right address

    constructor() ERC721('PismenaACisla2', 'PAC') {}
    ...
    function _withdrawSplitter() private {
        ...
        _widthdraw(USER_1_ADDRESS, cut);
        _widthdraw(USER_2_ADDRESS, cut);
        _widthdraw(USER_3_ADDRESS, cut);
        _widthdraw(USER_4_ADDRESS, cut);
