...
contract Chains is ERC721Enumerable, Ownable {
    ...
    **/
    ...
    /**
     * @dev EXPERIMENTAL mint with unclaimed bars by offsetting claims
     * @param _tokenIds The tokens to offset claims for
     */
    function mintWithBallerBarsUnclaimed(uint256[] memory _tokenIds) public {
        require(_paused==false,"PAUSED");
        IBallerBars(_genTwoBallerBarsAddress).burnUnclaimed(_tokenIds, currentBallerBarsCost());
        mintInternal();
    }
