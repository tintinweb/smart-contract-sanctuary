...
contract CrocZoo is ERC721, Ownable, PaymentSplitter, Pausable {
    ...
    uint256 private constant _tokenPrice = 20000000000000000; // 0.02 ETH
    ...
    uint public tokenReserve = 100;

    address[] private _team = [
	0x05f849d2e6aF313945F4D52590Cb6FaA56346810,
	0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266,
	0xbAa59FaaE3231eEc5D7A6450BBb62cDFAEb444ea, 
	0x2381f2499b003b306364775F71c135fEFDfe032A
    ];
  ...
  //  event tokenNameChange(address _by, uint _tokenId, string _name);
    ...
    constructor() 
       ERC721("Crocodoodle Zoo", "CDZ") 
       PaymentSplitter(_team, _team_shares)
    { 
        _baseApi="localhost:3000/api/";
    }
    ...
    function mintReserves(address _to) public onlyOwner {
        _safeMint(_to, _IdCounter.current());
        _IdCounter.increment();
    }
