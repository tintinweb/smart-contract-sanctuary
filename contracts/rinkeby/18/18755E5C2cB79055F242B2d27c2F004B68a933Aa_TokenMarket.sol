...
contract TokenMarket is TokenMarketBase {
    ...
    */
    ...
    function activateLoan(uint256[] memory loanIds, uint256[] memory stableCoinAmounts, bool[] memory _autoSell) public {
        ...
        IERC20(loanOffersToken[loanIds[i]].borrowStableCoin).transferFrom(msg.sender, address(this), loanAmountAfterAPYFee);
        ...
        activatedLoanOffersFull[loanIds[i]] =  TokenLoanData.LenderDetails({
		    lender: msg.sender,
            activationLoanTimeStamp: 1627894578,       //block.timestamp, //TODO change time to block.timestamp
