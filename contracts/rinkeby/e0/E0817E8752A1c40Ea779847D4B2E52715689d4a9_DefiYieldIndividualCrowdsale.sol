...
contract DefiYieldIndividualCrowdsale is IndividuallyCappedCrowdsale {
   ...
   */
  function getVestingAddress() view external returns (TokenVesting) {
    return _vesting;
  }
   ...
   */
  function getVestingPool() view external returns (uint8) {
    return _pool;
  }
  ...
  /**
 * @dev Withdraw ether put into contract by mistake
 */
