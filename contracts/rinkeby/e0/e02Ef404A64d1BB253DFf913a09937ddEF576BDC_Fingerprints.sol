...
contract Fingerprints is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, ERC721Burnable {
    ...
    constructor() ERC721("Fingerprints", "FNGRPRNT") {
        _maxSupply = 1024;
    ...
    returns (string memory)
    {
        ...
        return string(abi.encodePacked("data:application/json;utf8,{\"id\": \"", token, "\", \"name\": \"Fingerprint #", token, "\", \"description\": \"Abstract interpretation of the minting address as a fingerprint\", \"attributes\": [", traits, "], \"image_data\": \"", imageObj.image, "\", \"external_url\": \"https://obsolete.design/art/collection/fingerprints/gallery/", token, "\"}"));
    }
    ...
    function _calcRowValues(uint256 chunk, uint8 i, PrecalculatedValues memory precalc) internal pure returns(RowValues memory) {
        ...
        uint256 l1x2 = width - precalc.strokeWidth;
        uint256 l2x1 = width + precalc.strokeWidth;
        ...
        if (precalc.isRekt) {
            ...
            y1 = rektPositive ? offset + precalc.r : offset - precalc.r;
            y2 = rektPositive ? offset - precalc.r : offset + precalc.r;
        }
