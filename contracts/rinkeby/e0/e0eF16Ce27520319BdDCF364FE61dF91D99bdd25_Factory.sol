...
contract Factory is ReentrancyGuard{
    ...
    returns (address) 
    {
        NewToken token = new NewToken(name, symbol, decimals, totalSupply, issuer, operator);
    ...
    function returnTokens(address tokenAddress, uint256 amount) external nonReentrant {
        ...
        if(returned[tokenAddress] == IERC20(tokenAddress).totalSupply()){
...
contract NewToken is ERC20 {
    ...
    constructor(string memory name, string memory symbol, uint8 _decimals, uint256 _initialSupply, address _mintAddress, address _operator) public ERC20(name, symbol) {
