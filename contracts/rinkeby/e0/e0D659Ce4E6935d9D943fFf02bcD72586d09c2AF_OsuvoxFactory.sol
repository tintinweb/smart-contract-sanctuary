...
contract Osuvox is ERC721Tradable {
    ...
    function baseTokenURI() public pure override returns (string memory) {
        return "https://api.osuvox.io/avatars/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://api.osuvox.io/contract";
    }
}
...
contract OsuvoxFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://api.osuvox.io/factory/";

    /*
     * Enforce the existence of only 100 OpenSea Osuvoxs.
     */
    uint256 OSUVOX_SUPPLY = 10000;

    /*
     * Three different options for minting Osuvoxs (basic, premium, and gold).
     */
