...
contract GasMovr is Ownable {
    ...
    */
    ...
    function depositNativeToken(uint256 destinationChainId, address _to)
        ...
        payable
    {
        require(msg.value >= minAmount, "Please send more tokens");
        require(msg.value <= maxAmount, "Surpasses max transfer amount");
    ...
    function getMinAndMaxAmount() public view returns (uint256, uint256) {
