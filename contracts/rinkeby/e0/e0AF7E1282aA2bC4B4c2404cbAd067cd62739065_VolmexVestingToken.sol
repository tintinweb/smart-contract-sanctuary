...
contract VolmexVestingToken is BaseToken, OwnableUpgradeable {
    ...
    function updateRecipient(
        ...
        ITreasuryVester treasureVester
    ) external onlyOwner {
        require(
     ...
     */
    function endVesting(ITreasuryVester treasureVester, address refundAddress)
        external
        onlyOwner
    {
        require(
            address(treasureVester) != address(0),
            "VolmexVestingToken: Zero address"
        );
