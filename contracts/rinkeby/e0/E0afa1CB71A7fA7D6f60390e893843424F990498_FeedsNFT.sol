...
contract FeedsNFT is ERC721 {
    ...
    function addLowURI(string memory _svgLowURI) public {
        lowImageURI = _svgLowURI;
    }   

    function addHighURI(string memory _svgHighURI) public {
        highImageURI = _svgHighURI;
    }

    function addLowSVG(string memory _svgLowRaw) public {
        string memory svgURI = svgToImageURI(_svgLowRaw);
        addLowURI(svgURI);
    }

    function addHighSVG(string memory _svgHighRaw) public {
