...
/*
    function isPresaleAddress( address wallet ) public view onlyOwner returns( bool ){
        return _presale[ wallet ] == 1;
    }

    function removePresaleAddresses( address[] memory wallets ) public onlyOwner{
        for( uint i; i < wallets.length; ++i ){
            _presale[ wallets[i] ] = 0;
        }
    }
