...
contract SynapseNetwork is IERC20, Ownable, EIP712 {
    ...
    constructor() EIP712(Constants.getName(), "1") {
        ...
        _balances[msg.sender] = Constants.getTotalSupply();
        emit Transfer(address(0), msg.sender, Constants.getTotalSupply());

        setExcludedFromFees(msg.sender, true);
    }
...
library Constants {
    string private constant _name = "Test Synapse Network";
    string private constant _symbol = "tSNP";
