...
contract TestLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    uint256 public price = 15000000000000000; //0.015 ETH

    //Loot Contract
    address public lootAddress = 0x98d994C4C3310222743F53B8b2B5A55094c3144E;
    ...
    function mint(uint256 tokenId) public payable nonReentrant {
        require(tokenId > 1 && tokenId <= 12000, "Token ID invalid");
    ...
    constructor() ERC721("TestLoot", "TestLoot") Ownable() {}
}
