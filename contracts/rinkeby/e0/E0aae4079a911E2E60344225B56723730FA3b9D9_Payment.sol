...
contract Payment is Initializable, EIP712Upgradeable, AccessControlUpgradeable {
    ...
    event PaymentEvent(OrderData order);

    function initialize() public initializer {
        __EIP712_init(SIGNING_DOMAIN, SIGNATURE_VERSION);
        _setupRole(SIGNER_ROLE, 0x68CdE1E165A68f232d41Fa36F9019C8101881975);
    ...
    function pay(OrderData calldata data) public payable virtual {
        ...
        require(
            msg.value >= _totalFunds(data.fees),
