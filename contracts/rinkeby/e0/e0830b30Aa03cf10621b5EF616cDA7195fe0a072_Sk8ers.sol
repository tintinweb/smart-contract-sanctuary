...
contract Sk8ers is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRICE = 80e15;
    uint256 public constant MINT_LIMIT = 20;
    string private baseTokenURI;
    string private theContractURI;

    event CreateSk8er(uint256 indexed id);

    constructor(string memory baseURI, string memory newContractURI) ERC721("Sk8ers", "SK8") {
        setBaseURI(baseURI);
