...
contract WickedWristers is ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_WRISTERS_PRESALE = 200;
    ...
    address t2 = 0x978549262a2E86a7Dc7e7bad660f521162f06d09; //acc2
    address t3 = 0x71bcB4b7A26586D9e255773211FeeE132a1c38c8; //acc3
    address t4 = 0x60Eb7cE49281ca285bb580f746265B033250bCbF; //acc4
    ...
    function mintPresale(uint256 numberOfTokens) public payable {
        ...
        require(_totalClaimed[msg.sender].add(numberOfTokens) <= maxWristerMintable, "Purchase exceeds max allowed");
