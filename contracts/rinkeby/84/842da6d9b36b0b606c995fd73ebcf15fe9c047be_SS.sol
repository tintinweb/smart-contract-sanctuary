...
contract SS is ERC721("SNEAKYSOCIETY", "SSOCIETY"), ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    string private baseURI;
    string private blindURI;
    uint256 public constant maxTokensPerTransaction = 6;
    uint256 private constant nftsNumber = 6666;
