...
contract EGG is IEGG, ERC20, Ownable {
  ...
  function transferFrom(
      ...
      address recipient,
      uint256 amount
  ) public virtual override(ERC20, IEGG) disallowIfStateIsChanging returns (bool) {
    ...
    // If it's not an admin entity (game contract, Protected Island, etc)
    // The entity will need to be given permission to transfer these funds
    // For instance, someone can't just make a contract and siphon $EGG from every account
