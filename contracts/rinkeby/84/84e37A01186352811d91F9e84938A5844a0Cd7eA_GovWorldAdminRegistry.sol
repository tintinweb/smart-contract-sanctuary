...
contract GovWorldAdminRegistry is GovWorldAdminBase {
 ...
 address govSuperAdmin = 0x87A46c33356a5610026293B01f421e15ac7d33b9;
        ...
        onlyAddGovAdminRole(msg.sender)
    {
        ...
        require(allApprovedAdmins.length == 1, "GAR: addDefaultAdmin as onwer first. ");
    ...
    function removeAdmin(address _admin)
        ...
        onlyEditGovAdminRole(msg.sender)
    {
        require(_admin != govSuperAdmin, "GAR: Cannot Remove Super Admin");
        ...
        onlyEditGovAdminRole(msg.sender)
    {
        ...
        require(_admin != govSuperAdmin, "GAR: Cannot Edit Super Admin");
