...
contract Attention2476 is AdminControl, ERC1155Receiver{
    ...
    /**    
    * Set 2476 Attetion contract on/off
    */
    ...
    */
    ...
    function withDrawTokens(string memory project) external {
        ...
        IERC1155(contractAddress2476).safeTransferFrom(address(this),msg.sender, 2476, stakesByProject[project].amount[msg.sender],"" );
        emit WithDrawDeposit(msg.sender, stakesByProject[project].amount[msg.sender], project);
    ...
    function burnDeposit(string memory project) external adminRequired{
        ...
        for (uint i = 0; i < stakesByProject[project].wallet.length; i++) {
            ...
            if (stakesByProject[project].wallet[i]!=address(0)){
                ERC1155Burnable(contractAddress2476).burn(address(this),2476, stakesByProject[project].amount[stakesByProject[project].wallet[i]]); 
