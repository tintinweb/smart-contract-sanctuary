    ...
    Ownable
{
    ...
    function withdraw(uint256 value) public onlyOwner {
        ...
        // any ETH that cannot be claimed by either an artist or collaborator will be lost
    ...
    function getArtistRewards(uint256 _collectionId) public view onlyArtist(_collectionId) returns(uint256) {
    ...
    function getCollaboratorShares(uint256 _collectionId) public view onlyCollaborator(_collectionId) returns(uint256) {
        return _collectionsMap[_collectionId].collaboratorShares[_msgSender()];
    }

    function getCollaboratorPercentage(uint256 _collectionId) public view onlyCollaborator(_collectionId) returns(uint256) {
        return _collectionsMap[_collectionId].collaboratorPercentages[_msgSender()];
    }
