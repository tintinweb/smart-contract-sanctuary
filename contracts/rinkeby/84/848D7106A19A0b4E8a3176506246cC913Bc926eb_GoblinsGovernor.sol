    ...
    GovernorProposalThreshold
{
        ...
        )
    {
        ...
        neznamVotes = details.neznamVotes;
        valjdaVotes = details.valjdaVotes;
    ...
    function _countVote(
        ...
        }else if (support == uint8(VoteType.Neznam)) {
            details.neznamVotes += weight;
        }else if (support == uint8(VoteType.Valjda)) {
            details.valjdaVotes += weight;
        } else {
