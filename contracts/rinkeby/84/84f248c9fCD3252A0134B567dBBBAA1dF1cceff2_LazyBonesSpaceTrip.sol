...
contract LazyBonesSpaceTrip is ERC721Enumerable, Ownable, AccessControl {
    ...
    constructor() ERC721("LazyBonesSpaceTrip", "LBST") {
        setBaseURI("https://lazybonesspacetrip.s3.eu-north-1.amazonaws.com/");
        _setupRole(DEFAULT_ADMIN_ROLE, LazyGeek);
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
            ...
            return bytes(baseURI).length > 0
                ...
                : "https://lazybonesnft.io/api/lazybones.json"
                : '';
    }
    ...
    function withdrawSplitter() public onlyOwner {
        uint balance = address(this).balance;
        payable(LazyGeek).transfer(balance % 50);
        payable(LazyDescartes).transfer(balance % 50);
    }
    function mintToAddress(address[] calldata accounts) public onlyOwner {
