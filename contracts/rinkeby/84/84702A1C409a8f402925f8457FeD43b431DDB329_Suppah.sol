...
contract Suppah is ERC721, VRFConsumerBase {
    ...
    // FUNCTION 1: requesting a random number
    ...
    // FUNCTION 2: fulfilling randomness, assigning an reservation
    function fulfillRandomness(bytes32 requestID, uint256 randomNumber)
        internal
        override
    {
        Reservation reservation = Reservation(randomNumber % 2);
    ...
    function setTokenURI(uint256 tokenID, string memory _tokenURI) public {
        require(
            ...
            "The caller is not the owner and/or is not approved"
        );
