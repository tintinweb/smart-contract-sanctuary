...
contract SongsOfTheMetaverseV1 is ERC721Enumerable, ReentrancyGuard, Ownable {
  uint256 public lootPrice = 50000000000000000; //0.05 ETH
  ...
  function getDanceStyle(uint256 tokenId) public view returns (string memory) {
    return pluck(tokenId, "DANCE STYLE", danceStyles);
  }
