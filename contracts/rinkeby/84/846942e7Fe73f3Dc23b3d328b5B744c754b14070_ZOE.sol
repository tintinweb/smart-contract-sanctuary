...
contract ZOE is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable {
    function initialize(uint256 _supplyLibre,address _FoundersAddress,address _AirdropsAddress,address MainnetLoans,address Devteam,address listingfee) public virtual initializer {
        __ERC20PresetMinterPauser_init("MDT20","MDT");
         __Ownable_init();
        _mint(_msgSender(), _supplyLibre);
        _supplyLibre  = 67000000 ether; // 67millones seran minteados a una Wallet gnosis Safe por motivos de seguridad
        _FoundersAddress = _FoundersAddress;
        _mint(_FoundersAddress,8000000 ether);//8Millones seran minteados a una Wallet gnosis Safe por motivos de seguridad
        _AirdropsAddress = _AirdropsAddress;
        _mint(_AirdropsAddress,2000000 ether); //2Millones serán minteados a una wallet Genosis
        MainnetLoans = MainnetLoans;
        _mint(MainnetLoans,10000000 ether); // MainnetLaons serán minteados  a una wallet Gnosis 
        Devteam = Devteam;
        _mint(Devteam,8000000 ether); // Devteam serán minteados a una wallet Genosis safe
        listingfee = listingfee;
        _mint(listingfee,5000000 ether);   //5Millones seran minteados a una wallet gnosis 
    }
