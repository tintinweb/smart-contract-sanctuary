...
abstract contract BuilderMaster {
   ...
   function strConcat(string memory _a, string memory _b, string memory _c, string memory _d, string memory _e) public view virtual returns (string memory);
   function strConcat(string memory _a, string memory _b, string memory _c, string memory _d) public view virtual returns (string memory);
   function strConcat(string memory _a, string memory _b, string memory _c) public view virtual returns (string memory);
...
//   string public creatorName;
   ...
   constructor(
       ...
       string memory name_of_creator) ERC721(_name, _symbol) public {
