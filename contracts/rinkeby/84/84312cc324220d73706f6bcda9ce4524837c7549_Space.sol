...
contract Space is ERC721Enumerable, Ownable {
    ...
    mapping(uint256 => uint256) public attributeIndex;
    ...
    function setAttributeIndex(uint256 tokenId) private {
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        if (keccak256(abi.encodePacked(revealedCollectionBaseURL)) == keccak256(abi.encodePacked(''))) {
            ...
            content = abi.encodePacked(content,
                ...
                ', ',
                '"attributes": [{"trait_type": "Board Factor", "value": "',getCombatEffectiveness(_tokenId),'"},{"trait_type": "Board Factor", "value": "',getCombatEffectiveness(_tokenId),'"}]',
                ', ',
    ...
    function getCombatEffectiveness(uint256 tokenId) private view returns (string memory){
        return combatEffectiveness[attributeIndex[tokenId]];
    }
    function getRarity(uint256 tokenId) private view returns (string memory){
