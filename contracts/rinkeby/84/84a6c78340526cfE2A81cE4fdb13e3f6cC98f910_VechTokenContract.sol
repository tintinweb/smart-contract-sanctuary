...
contract VechTokenContract is ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    uint256 public collabReservedTokens = 113; 
    /// amount of reserved tokens minted
    ...
    /// max amount of tokens in the collection
    uint256 public maxPublicMintableTokens = maxTokens - collabReservedTokens; // 8888 - 113 = 8775
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 amountToFounders = address(this).balance; // The rest (51%)
        sendEth(fudzeroAddress, amountToFounders / 2);
        amountToFounders = address(this).balance; // send the rest like this to include rest-value from /2 above
        sendEth(haydenAddress, amountToFounders);
    }
