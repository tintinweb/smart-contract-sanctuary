...
contract MightyBabyDragons is ERC721Enumerable, Ownable {
    ...
    mapping(address => uint) public addressCanMint;
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            if (whitelisted[msg.sender] != true) {
                ...
                require(_mintAmount <= addressCanMint[msg.sender], "You cant mint more items with this whitelisted run");
    ...
    function whitelistUser(address _user, uint _canMint) public onlyOwner {
