...
contract CommunityArtMint is Ownable {
    ...
    function mintMajor(uint256 edition) external onlyOwner() {
        ...
        require(nextMinorId[edition] >= maxMinorId[edition]
            , "Number of minors is to low, need 99");
    ...
    function getNextMintNumber(uint256 edition) public onlyOwner() returns (uint256) {
