...
// File: contracts\LoserChickNFTTest.sol
...
contract LoserChickNFTTest is OwnableContract, ERC721("LuckyChick", "LuckyChick"){
    ...
    constructor(address _randomAddr, uint256 _maxSupply) public{
     ...
     */
    function createNFT(address owner) public returns(uint256){
