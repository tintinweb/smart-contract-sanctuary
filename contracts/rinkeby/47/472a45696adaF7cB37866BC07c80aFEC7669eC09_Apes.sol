...
contract Apes is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
  /// @custom:oz-upgrades-unsafe-allow constructor
  constructor() initializer {}

  function initialize() initializer public {
    __ERC721_init("Apes", "APES");
  ...
  function grow(uint256 _tokenIdx) public {
    ...
    typeOfApeById[tokenId] = uint(current.level);
  }
  ...
  function migrate(uint256 _tokenId) public {
    ...
    address actualOwner = oldApeInstance.ownerOf(_tokenId);
    require(msg.sender == actualOwner, "not owner");
    oldApeInstance.transferFrom(actualOwner, devWallet, _tokenId);
