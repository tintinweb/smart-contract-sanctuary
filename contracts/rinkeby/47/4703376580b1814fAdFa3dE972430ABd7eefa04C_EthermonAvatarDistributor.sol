...
contract EthermonAvatarDistributor is AccessControl {
    ...
    uint256 public tokenPrice = uint256(5* 10**16); // = 0.05 ETH
    ...
    uint256 minTokenBalanceRequired = 4000000000000000000000; //4000 EMON to mint 

    function mintUsingEth(uint256 _num) public payable returns (bool) {
        ...
        // Check user need to hold: 4000 EMON to mint
