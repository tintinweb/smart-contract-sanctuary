...
contract MillionFarm is Ownable {
    ...
    constructor(
        ...
        emissionCheckpoint=_startTime.add(100); //15768000
    }
    ...
    function updateRewardPerSecond() external onlyOwner {
        require(block.timestamp > emissionCheckpoint);
        massUpdatePools();
        simbaPerSecond =  simbaPerSecond.div(2);
        emissionCheckpoint=emissionCheckpoint.add(100);
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        simba.transfer(dev, simbaReward.div(33));           //3% to the Core Team
        simba.transfer(lionBank,simbaReward.div(20));       //5% to the Lion Bank
        simba.transfer(simbaTreasury,simbaReward.div(50));  //2% to the Treasury for Liquidity purposes
