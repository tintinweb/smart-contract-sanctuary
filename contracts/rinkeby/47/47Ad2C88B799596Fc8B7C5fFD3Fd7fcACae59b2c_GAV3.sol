...
contract GAV3 is ERC20, Ownable, Editor {
    using SafeMath for uint256;
    ...
    constructor(address payable _vaultAddress) ERC20("GAV3", "GAv3") {
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "GAv3: Automated market maker pair is already set to that value");
        automatedMarketMakerPairs[pair] = value;
        emit SetAutomatedMarketMakerPair(pair, value);
    }
		
    function excludeFromFees(address account, bool excluded) public OwnerOrEditor{
        require(_isExcludedFromFees[account] != excluded, "GAv3: Account is already the value of 'excluded'");
