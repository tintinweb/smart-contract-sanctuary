...
contract TigerTes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Tiger Tes tett", "TGTT") {
    setHiddenMetadataUri("ipfs://QmSRgJ8aq6s3ddFyucCHnWEBA1qtSHpFRHJpgKrfpVD1Bk/Hidden.json");
  }
