...
contract GMENFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("GME Certificates", "GMENFT") {}

    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override {
        require(msg.sender == contractOwner, "Vertificate: Only the contract owner can transfer the token");
        super._beforeTokenTransfer(from, to, tokenId);
    }

    function unlockToken(bytes32 unlockHash, uint256 tokenId) public {
        require(msg.sender == owner(), "AishtisiToken: Only the Owner can unlock the Token");
