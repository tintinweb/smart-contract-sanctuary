...
// File: Assara_contract/IERC20.sol
...
// File: Assara_contract/Context.sol
...
// File: Assara_contract/SafeMath.sol
...
// File: Assara_contract/Assa_Contract.sol
...
contract Award is Context, Ownable{
    ...
    function TransferToken(uint256 amount) public returns(uint64) {
        ...
        require(allowance >= (HowMuchTokenMustPay() * 10**18), "Check the token allowance tokenmustpay");
    ...
    function _TransferToken(address _adrt, uint256 _amount) private returns (uint64) {
        ...
        _lockedToken = _amount.mul(909).div(1000);
    ...
    function _PayForLockedTokens(uint256 _TotalVal) private {
        ...
        for(uint64 i = 0; i < ticketCode; i++){
            ...
            PrizeStakePerson = tokenPersonLocked.mul(10**42).div(_TotalLockedToken).mul(_TotalVal).div(10**42);
