...
contract Elementa is ERC721Enumerable, Ownable {
    ...
    event Reroll(address indexed roller, uint256 indexed oldTokenId, uint256 indexed tokenId);                  

    constructor(address _proxyRegistryAddress) ERC721("Elements2", "ELEM") {
    ...
    function rerollToken(uint256 tokenId) external payable  {
        ...
        uint mintIndex = totalSupply();
        _safeMint(msg.sender, mintIndex);
        emit Reroll(msg.sender, tokenId, mintIndex);
    }
