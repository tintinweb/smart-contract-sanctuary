...
contract GullToken is ERC20,Ownable,AccessControl {
    ...
    function acceptWithdraw(address from,uint256 amount) public returns (bool) {
        bool result = true;
    ...
    function userWithdrawAmount() public view returns (uint256) {
        return _cappedWithdrawalArray[msg.sender].amount;
    }

    function userWithdrawTime() public view returns (uint256) {
        return _cappedWithdrawalArray[msg.sender].time;
    }
