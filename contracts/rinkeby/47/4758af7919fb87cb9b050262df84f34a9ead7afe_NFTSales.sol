...
// File: lab/kira_nft_sale_whitelist.sol

// contracts/GameItem.sol

pragma solidity ^0.8.7;

contract NFTSales is Pausable, AccessControl {
    ...
    IERC721 public immutable paymentToken;
    ...
    function purchaseTokenWithErc20(uint256 _tokenId)
        public
        payable
        whenNotPaused
        afterStartSales
        beforeEndSales
    {
        ...
        address tokenSeller = nftAddress.ownerOf(_tokenId);
        paymentToken.transferFrom(msg.sender, tokenSeller, currentPrice);
        nftAddress.safeTransferFrom(tokenSeller, msg.sender, _tokenId);
        emit ReceivedErc20(
            msg.sender,
            _tokenId,
    ...
    function sendTo(address _payee, uint256 _amount)
        public
