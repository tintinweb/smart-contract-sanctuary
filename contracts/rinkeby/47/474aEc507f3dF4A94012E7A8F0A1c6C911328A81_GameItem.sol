...
function append(string memory a, uint256 b, string memory c) internal pure returns (string memory) {
    ...
    function mintAll(string memory tokenURI1, string memory tokenURI2, uint256 nb) public{
        ...
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        string memory tokenuri = append(tokenURI1, newItemId, tokenURI2);
