...
contract Jeet is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (!inSwap && swapEnabled && overMinTokenBalance && /* swap on buy side */ sender == uniswapV2Pair) {
    ...
    function _seNumOfTokensToExchangeForCharity(uint256 numOfTokensToExchangeForCharity) external onlyOwner() {
