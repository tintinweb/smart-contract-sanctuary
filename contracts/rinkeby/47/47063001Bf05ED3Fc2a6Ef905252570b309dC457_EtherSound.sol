...
Set of 8 random C major notes ranging from C2 to B4.
First 888 EtherSounds can be claimed if your Eth balance < 1 Eth.

mint price : 0.05 Eth                                                                                                  
max mint : 10 EtherSounds
supply : 8888 EtherSounds
...
contract EtherSound is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public maxSupplyClaim = 10;
