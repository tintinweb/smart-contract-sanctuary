...
contract FontStaking is AccessControl {
    ...
    address font_token_address = 0x025A6A3D5cef1A0d08E44e42B1b3DDD9Aa717584; //token address of the font
    uint256 public maxSnapshotLifetime = 60; // 3 days Max freshness of snapshot before reward distribution
    uint256 public minSnapshotInterval = 1000; //3 months this is used for both snapshot and reward distribution
    uint256 public minStakeTime = 1000; //90 days in second
