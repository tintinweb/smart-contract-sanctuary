...
contract YesQueenClub is ERC721Enumerable, Ownable {
    ...
    uint256 public presaleStartDate = 1635126000;       // 11 Nov 2021
    uint256 public publicStartDate = 1635127200;        // 14 Nov 2021
    uint256 public discountingNum = 13;
    uint256 public discountingInterval = 300;           // second

    uint256 public minPrice = 0.07 ether;
    uint256 public maxPrice = 0.2 ether;
    ...
    */
    ...
    constructor() ERC721("Yes Queen Club", "YQC") {
        //setBaseURI(baseURI);
    }
    ...
    function price() public view returns (uint256) {
        ...
        if (d_now < presaleStartDate) {
            ...
            return minPrice;
        } else if (publicStartDate <= d_now && d_now < publicStartDate + discountingNum * discountingInterval) {
            uint cnt = (d_now - publicStartDate) / discountingInterval;
            return maxPrice - cnt * 0.01 ether;
        } else {
            return minPrice;
        }
    }
    ...
    function preSaleMint() public payable onlyWhitelisted {
        ...
        require(supply < presaleSupply,                 'This transaction would exceed max presale supply of queen');
        require(msg.value >= minPrice,                  'Ether value is too low');
    ...
    function setPrice(uint256 _max_price, uint256 _min_price) public onlyOwner {
        maxPrice = _max_price;
        minPrice = _min_price;
        discountingNum = (maxPrice - minPrice) / (0.01 ether);
    }
