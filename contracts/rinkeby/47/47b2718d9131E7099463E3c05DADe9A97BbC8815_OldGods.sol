...
contract OldGods is ERC721, Ownable,Pausable {
    ...
    uint256 private maxPrice = 0.05 ether;
    uint256 private maxQuantity=11;
    ...
    constructor(string memory _baseURII) ERC721("The Old Gods", "GODS"){tokenBaseURI=_baseURII;}
    ...
    require(_quantity <= maxQuantity, "Your are not allowed to mint more than 10 tokens");
