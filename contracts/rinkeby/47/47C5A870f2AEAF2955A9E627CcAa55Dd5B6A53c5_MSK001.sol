...
contract MSK001 is ERC721Enumerable, Ownable {
     ...
     * @dev Constructor
     */
    constructor(address hmAddress, address nctAddress, address daoTreasury) ERC721("NFT test gtk v02", "GTK") {
    ...
    */
    ...
    function canMintTicket()  public view returns (bool){
        return (totalSupply() < MAX_SUPPLY)
                && (balanceOf(_msgSender()) == 0)
                && (_hm.balanceOf(_msgSender()) > 0);
    }
