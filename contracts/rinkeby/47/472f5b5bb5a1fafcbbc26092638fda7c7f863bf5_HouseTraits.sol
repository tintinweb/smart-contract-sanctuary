...
contract HouseTraits is Ownable, IHouseTraits {
  ...
  function drawSVG(uint256 tokenId) internal view returns (string memory) {
    ...
    // Trait data indexes 0 - 7 are reserved for Shake
    // Trait data indexew 8 - 15 are reserved for Ranch.
    // Trait data indexew 16 - 23 are reserved for Mansion.
  ...
  function compileAttributes(uint256 tokenId) internal view returns (string memory) {
    ...
    if (s.roll == 0) {
      ...
      traits = string(abi.encodePacked(
        attributeForTypeAndValue(_traitTypes[0], traitData[16][s.body].name),',',
        attributeForTypeAndValue(_traitTypes[1], traitData[17][s.head].name),',',
        attributeForTypeAndValue(_traitTypes[2], traitData[18][s.spell].name),',',
        attributeForTypeAndValue(_traitTypes[3], traitData[19][s.eyes].name),',',
        attributeForTypeAndValue(_traitTypes[4], traitData[20][s.neck].name),',',
        attributeForTypeAndValue(_traitTypes[5], traitData[21][s.mouth].name),',',
        attributeForTypeAndValue(_traitTypes[6], traitData[22][s.tail].name),',',
        attributeForTypeAndValue(_traitTypes[7], traitData[23][s.wand].name),','
      ));
      return string(abi.encodePacked(
      '[',
        traits,
