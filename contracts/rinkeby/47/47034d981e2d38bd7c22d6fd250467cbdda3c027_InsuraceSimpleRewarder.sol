...
// File: contracts/InsuraceSimpleRewarder.sol
...
contract InsuraceSimpleRewarder is IRewarder, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMathUpgradeable for uint256;
    ...
    function initializeInsuraceSimpleRewarder() public initializer {
        __Ownable_init();
    ...
    //Sushi is with 18 decimal precison, using same precision
