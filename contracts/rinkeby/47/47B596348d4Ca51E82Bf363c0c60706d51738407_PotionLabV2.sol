...
contract PotionLabV2 is ERC721, Ownable {
    ...
    uint8 public maxMintPreSale = 4;
    uint8 public maxMintPublicSale = 5;
    ...
    function mint(uint256 amount) external payable {
        ...
        require(!preSale || amount <= maxMintPreSale, "WRONG_AMOUNT");
        require(!publicSale || amount <= maxMintPublicSale, "WRONG_AMOUNT");
