...
contract faAddons is Ownable, ERC721, ERC721Enumerable {
    ...
    function newBattlePoints(uint16 _fromId, uint16 _toId) external returns (uint32, uint32,uint32, uint32,uint32, uint32) {
