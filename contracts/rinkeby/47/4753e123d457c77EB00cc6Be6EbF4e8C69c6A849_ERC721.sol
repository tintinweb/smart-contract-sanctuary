...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function mint(address[] memory apes, uint256 typeCount) public {
        require(!_finalized, "ERC721: minting concluded");
        
        for(uint256 index = 0; index <= apes.length; index++){
            
            address owner = apes[index];
            uint256 tokenId = typeCount + index; 
