	...
	function tokenURI(uint256 _token_id) public view override returns(string memory)
	{
		...
		string memory json = string(
			abi.encodePacked(
				...
				'"attributes": [{"trait_type": "background color", "value": "', username.bg_color, '"},{"trait_type": "text color", "value": "', username.text_color, '"},{"trait_type": "noteworthy", "value": "', username.comment, '"}],',
