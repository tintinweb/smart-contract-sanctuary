    ...
    Ownable
{
    ...
    constructor(address payable givenWithdrawalAddress) ERC721 ("Grinders by Andrew Benson", "GRINDER") {
        ...
        console.log("Set address to",withdrawalAddress);
    }

    bool public mintActive = false;
    uint256 public lastMintedId;
    uint256 public constant mintPrice = 0.5 ether;
    uint256 public constant maxSupply = 100;
    uint256 public currentAvailableSet = 0; 
    ...
    function buy() public payable nonReentrant {
        ...
        require(
            lastMintedId < currentAvailableSet,
            "The current set is all gone, stay tuned for the next release."
        );
        require(mintPrice == msg.value, "Must use correct amount.");
        _mintNFT();
    }
    ...
    //release the next N tokens for minting
    //Allows for a staggered release of the 100 tokens at arbitrary times
    function releaseSet(uint256 mintCount) public onlyOwner {
        uint256 _currentSet = currentAvailableSet+mintCount;
        currentAvailableSet = _currentSet <= maxSupply ? _currentSet : maxSupply ; 
    }
