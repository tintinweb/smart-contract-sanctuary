...
contract ERC1155WrapperFactory is UpgradeableBeacon {
    ...
    function createWrapper(
        ...
        require(
            ...
            "ERC1155WrapperFactory: 0-address proxy"
        );
        ERC1155Wrapper(_wrapperProxyAddress).initialize(
            _name,
            _symbol,
            conditionalTokensAddress,
            _positionId
        );
        wrappers.push(address(_wrapperProxyAddress));
        wrapperForPosition[_positionId] = address(_wrapperProxyAddress);
        emit WrapperCreated(address(_wrapperProxyAddress));
    }
...
contract ERC1155Wrapper is ERC20Upgradeable, IERC1155ReceiverUpgradeable {
    bytes4 public immutable SINGLE_RECEIVER_FUNCTION_SELECTOR = 0xf23a6e61;
    bytes4 public immutable BATCH_RECEIVER_FUNCTION_SELECTOR = 0xbc197c81;
    ...
    function onERC1155Received(
        ...
        return SINGLE_RECEIVER_FUNCTION_SELECTOR;
    }
