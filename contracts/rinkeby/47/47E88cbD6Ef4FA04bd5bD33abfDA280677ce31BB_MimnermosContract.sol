...
// File: contracts/MimnermosContract.sol
...
contract MimnermosContract is ERC721PresetMinterPauserAutoId {
    constructor() ERC721PresetMinterPauserAutoId("Mimnermos Contract", "MNM", '') {
    }
}