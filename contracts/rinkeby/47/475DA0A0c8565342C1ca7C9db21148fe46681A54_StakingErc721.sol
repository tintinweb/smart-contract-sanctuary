...
contract StakingErc721 is IERC721Receiver, ReentrancyGuard, Pausable, Ownable {
  ...
  function stakeInternal(address sender, uint256 tokenId) internal {
    require(nftAccountBalances[sender].add(1) <= maxAmount, "NFT max amount exceeded");
    ...
    nftAccountBalances[sender] = nftAccountBalances[sender].add(1);
    nftTokenBalances[tokenId][sender] = 1;
