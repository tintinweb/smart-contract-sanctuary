  ...
  Ownable
{
  ...
  event CreateMulligan(uint256 indexed id);

  constructor(string memory baseURI) ERC721("Mulligans", "MLLGS") {
    setBaseURI(baseURI);
  }
  ...
  function royaltyInfo(uint, uint _salePrice) external pure returns (address, uint) {
    uint royalty = 500;
    address receiver = parseAddr("0x70997970c51812dc3a010c7d01b50e0d17dc79c8");
