...
contract Factory is IFactory, Ownable, ReentrancyGuard {
  ...
  function _mint(
    ...
    MyCollection nftContract = MyCollection(nftAddress);
    uint256 id = optionToTokenID[optionId];
    if (id == 0) {
      id = nftContract.create(_toAddress,optionId, _amount, "", _data);
...
/**
 * @title MyCollection
 * @dev a contract for fungible and non-fungible token.
 */


contract MyCollection is ERC1155Tradable {
    constructor(string memory _collectionName, string memory _collectionSymbol, string memory _uri, address _proxyRegistryAddress)
        ERC1155Tradable(
            _collectionName,
            _collectionSymbol,
            _uri,
    ...
    function contractURI(string memory _uriMarket) public pure returns (string memory) {
        return _uriMarket;
    }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
        ...
        override
    {
        ...
        emit ApprovalForAll1155(_msgSender(), operator, approved);
    }
