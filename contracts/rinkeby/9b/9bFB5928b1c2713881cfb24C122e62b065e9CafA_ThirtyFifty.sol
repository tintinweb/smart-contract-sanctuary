...
contract ThirtyFifty is ERC721, Ownable, AccessControl, ReentrancyGuard {
  ...
  /*
   * TODO: update with our final interface
   ...
   */
  constructor(string memory baseURI) ERC721("ThirtyFifty","3050") {
    setBaseURI(baseURI);
