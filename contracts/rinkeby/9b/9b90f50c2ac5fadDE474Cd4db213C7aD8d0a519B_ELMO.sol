...
contract ELMO is ERC20, Ownable {
    ...
    uint256 public swapAtAmount = _tTotal.mul(10).div(1000);       // 0.10% of total supply
    uint256 public maxTxLimit = _tTotal.mul(75).div(100);         // 0.75% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(150).div(100);    // 1.50% of total supply
    ...
    address _dev = 0x6d050A42084257c4E59009A8877B0Ac2f6e9927e;
