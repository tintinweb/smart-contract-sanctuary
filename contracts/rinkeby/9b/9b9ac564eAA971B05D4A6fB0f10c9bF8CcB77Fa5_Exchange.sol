...
contract Exchange is ExchangeCore {
    ...
    function addTreasuryAdd_(address _treasury)public onlyOwner{
        addTreasuryAdd(_treasury);
    }
...
contract ExchangeCore is ReentrancyGuarded, EIP712, Ownable{
    ...
    function addTreasuryAdd(address  _treasury) internal onlyOwner{
        TreasuryAdd = _treasury;
    }
      ...
      
    {
        ...
        require(collection.balanceOf(seller.maker, seller.tokenId) > 0, "Seller must be have enough funds");
            ...
            token_.transfer(TreasuryAdd, shareAmount);
       ...
       // TreasuryAdd.updateRecieved(seller.target, shareAmount);
