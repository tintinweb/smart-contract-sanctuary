...
contract BlootMF is ERC721Enumerable, Ownable {
    ...
    uint256 private constant MAX_FOUNDER = 1000;
    ...
    // withdraw addresses
    address withdrawalAddress = 0x4CDa9c34Ff9600589082ACF6159B047413472122;//for rinkeby
    ERC721 bloot = ERC721(0x4F8730E0b32B04beaa5757e5aea3aeF970E5B613);//for mainnet

    constructor(string memory baseURI) ERC721("BlxxtMFv2", "BLXXTMFv2")  {
        setBaseURI(baseURI);
    }
    ...
    function mint() public payable {
        ...
        if (msg.value >= FOUNDER_DONATION) {
            ...
            require(freeMintCounter <= MAX_FREE, "All free mints are done");
            freeMintCounter++;
        }
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(withdrawalAddress).send(bal));
    }
}