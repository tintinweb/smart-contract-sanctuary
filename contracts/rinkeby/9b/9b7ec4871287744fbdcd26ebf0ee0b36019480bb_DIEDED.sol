  ...
  Ownable
{
  ...
  uint256 constant MAX_MINT_NR = 55;
  ...
  ERC721Enumerable
{
  ...
  mapping(uint256 => uint256) internal idToOwnerIndex;
    ...
    /**
   * @dev Mapping from whitelisted owner if already claimed
    10: not claimed
    20: claimed
   */
  ...
  function claim(uint8 mint_num) external payable{
    ...
    require(_getOwnerNFTCount(msg.sender) + mint_num <= 4, "Claiming too many assets per address");
  ...
  {
    whitelisted_res = isWhitelisted(msg.sender);
