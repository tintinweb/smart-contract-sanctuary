...
contract Alphabets is ERC721, ReentrancyGuard, Ownable {
    ...
    //Nproject Contract
    address public NprojectAddress = 0x4E05D8ef5d55cbA5AF05B22244d0458dEA99B8DC;
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="#f4ca16" /><text x="10" y="20" class="base">';

        parts[1] = getLetter1(tokenId);

        parts[2] = '</text><text x="10" y="40" class="base" font-weight="bold">';
        ...
        parts[4] = '</text><text x="10" y="100" class="base" font-weight="bold">';
        ...
        parts[8] = '</text><text x="10" y="140" class="base" font-weight="bold">';

        parts[9] = getLetter5(tokenId);
        
        parts[10] = '</text><text x="10" y="160" class="base" font-weight="bold">';
