...
// File contracts/LeanPunkDNA.sol



pragma solidity ^0.8.0;

contract LeanPunkDNA {
...
contract LeanPunks is ERC721, ERC721Enumerable, LeanPunkDNA {
    ...
    constructor(uint256 _maxSupply) ERC721 ("LeanPunks", "LEANP") {
    ...
    function mint() public {
        for (uint i = 0; i < 90; i++) {
            ...
            require(current < maxSupply, "Not LeanPunk left :(");
    ...
    function _bsaeURI() internal pure returns (string memory) {
        ...
        returns(string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "LeanPunk #',
                tokenId.toString(),
                '", "description": "NFT DApp Test", "image": "',
                image,
                '"}'
            )
        );
