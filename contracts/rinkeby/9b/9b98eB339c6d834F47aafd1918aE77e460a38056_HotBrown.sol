...
contract HotBrown is ERC721Enum, Ownable, PaymentSplitter, Pausable,  ReentrancyGuard {
    ...
    constructor() ERC721P("HotBrown", "BROWN") PaymentSplitter(addressList, shareList){
        setBaseURI("");
    }
