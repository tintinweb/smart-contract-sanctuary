...
contract NFTCollection is ERC721Enumerable, Ownable{
    ...
    */    
    constructor (string memory uri_) ERC721("NAME", "SYMBOL")  {
        _uri = uri_;
        _whitelistDate = block.timestamp + 2 minutes;
    ...
    */    
    ...
    function mint() external payable {
        require(_whitelistDate >= block.timestamp, "Bad Babies: Only whitelist");
    ...
    */      
    ...
    /**
        ...
        @return Token ID
    */     
    function getTokenByOwnerIndex(uint256 index) public view returns(uint256) {
        return _ownerBabies[msg.sender].at(index);
    }
