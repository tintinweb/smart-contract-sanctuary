...
contract MiddlePunks is OwnableUpgradeable, ERC721EnumerableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function mint(uint256 _numToMint) public payable nonReentrant() {
    ...
    if (isFreeSaleOn) {
      ...
      require(_numToMint == 1, "Can only mint one free MidPunk.");
      require(
        balanceOf(msg.sender) == 0,
        "Can only receive a free MidPunk if you don't already have a MidPunk."
      );
    } else {
      require(
