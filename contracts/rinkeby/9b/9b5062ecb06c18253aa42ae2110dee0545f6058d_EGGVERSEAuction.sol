...
contract EGGVERSEAuction is Initializable, ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    enum Status{ OPEN, PENDING, SUCCESS } // burn은 상태 없음 상태 맵에서도 삭제됨
    ...
    event AuctionCreated(uint256 _tokenId, uint8 _auctionId, string _tokenURI, address _proposer);
    ...
    function mint(
        ...
        emit AuctionCreated(newId, _auctionId, _tokenURI, msg.sender);
        return newId;
    }
