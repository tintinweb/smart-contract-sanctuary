...
contract Bear is IBear, ERC721Enumerable, Ownable, Pausable, VRFConsumerBase {
  ...
  { 
    ...
    aliases[5] = [0];
    // eyes 3
    rarities[6] = [245, 255, 249, 251, 252, 255, 78, 83, 255];
    aliases[6] = [1, 2, 5, 8, 1, 8, 1, 4, 5];
    // face 4
    rarities[7] = [253, 255, 79, 250, 246, 247, 244, 253, 250, 255, 239, 254, 21, 255, 255, 24];
    aliases[7] = [0, 1, 3, 4, 5, 6, 7, 8, 9, 10, 11, 13, 1, 1, 13, 14];
    // head 5
    ...
    aliases[15] = [3, 3, 3, 3];
    // eyes 13
	rarities[16] = [235, 247, 239, 241, 76, 225, 235, 255, 234, 239, 29];
    aliases[16] = [1, 2, 3, 0, 5, 6, 7, 7, 7, 8, 9];
    // face 14
    rarities[17] = [243, 64, 251, 73, 236, 26, 233, 99];
    aliases[17] = [0, 0, 0, 2, 2, 2, 4, 6];
    // mouth 16
