...
contract RocketGame is ERC721Enumerable, Ownable {
    ...
    uint256 public constant endGameTimerPeriod = 900; //72 hours 60*60*72
    ...
    function claimAllColorsOfEngineWin(uint8 partType, uint256 characterId, uint256 grayEngineId, uint256 blackEngineId, uint256 goldEngineId, uint256 trippyEngineId) public gameNotEnded {
        ...
        validateColorsAndBurn(characterId, partType, grayEngineId, blackEngineId, goldEngineId, trippyEngineId, winPercentage);
        if(partType == Fuel) {
            hasGameEnded = true;
        }
    }
