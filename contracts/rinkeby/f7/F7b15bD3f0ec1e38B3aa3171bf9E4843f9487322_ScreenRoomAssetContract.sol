...
/**
 * @title AssetContract
 * AssetContract - A contract for easily creating non-fungible assets on ScreenRoomAssetContract.
 */
contract AssetContract is ERC1155Tradable {
    ...
    function ScreenRoomVersion() public pure returns (string memory) {
        return "2.0.2";
    }
    ...
    function safeBatchTransferFrom(
        ...
        require(
            _ids.length == _amounts.length,
            "ScreenRoomAssetContract#safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"
        );
...
contract ScreenRoomAssetContract is AssetContract, ReentrancyGuard {
    ...
    modifier creatorOnly(uint256 _id) {
        require(
            ...
            "ScreenRoomAssetContract#creatorOnly: ONLY_CREATOR_ALLOWED"
        );
        _;
    }
    ...
    function setCreator(uint256 _id, address _to) public creatorOnly(_id) {
        require(
            _to != address(0),
            "ScreenRoomAssetContract#setCreator: INVALID_ADDRESS."
        );
    ...
    function _requireMintable(
        ...
        require(
            ...
            "ScreenRoomAssetContract#_requireMintable: ONLY_CREATOR_ALLOWED"
        );
        require(
            _remainingSupply(_id) >= _amount,
            "ScreenRoomAssetContract#_requireMintable: SUPPLY_EXCEEDED"
        );
    }
