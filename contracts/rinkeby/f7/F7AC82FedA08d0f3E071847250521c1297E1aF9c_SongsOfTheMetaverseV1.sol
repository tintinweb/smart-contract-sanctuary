...
contract SongsOfTheMetaverseV1 is ERC721Enumerable, ReentrancyGuard, Ownable {
  uint256 public lootPrice = 100000000000000000; //0.1 ETH
        ...
        bytes(
          string(
            abi.encodePacked(
              ...
              toString(tokenId),
              '", "description": "The Songs of the Metaverse. First collection of 5 unique and original songs to accompany you on the journey ahead. Compatible with Loot (for Adventurers)", "file":',
              song,
