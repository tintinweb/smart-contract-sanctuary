...
contract ERC20 is Context, IERC20, Ownable {
  ...
  function disableTrading() external onlyOwner {
    ...
    function turnBotKillerOff() external onlyOwner {
        botKiller = false;
    
    }
  function turnBotKillerOn() external onlyOwner {
        botKiller = true;
...
contract GIRL is ERC20 {
    ...
    constructor() {
        createSupply(_msgSender(), _totalSupply);
