...
contract AxonToken is IAxonsToken, ERC20, Ownable {
    // AH contract
     ...
     */
    function generateReward(address recipient) public override {
        require(msg.sender == auctionHouse);
        _mint(payable(recipient), 1 * 10**uint(decimals()));
    }
    ...
    function transfer(address recipient, uint256 amount) public override(IERC20,ERC20) returns (bool) {
        require(recipient == auctionHouse || _msgSender() == auctionHouse, 'This token cannot be traded');
