...
contract decoffer_V2{
    ...
    Credit_token CT = Credit_token(0x1fe769E62092A21FD428f1b32F0a38402Af8e090);
    ...
    function claim_profit()public {
        ...
        msg.sender.transfer(take_profit);
        
        now_balance = now_balance.sub(profit);
    }
    ...
    function withdraw()public {
        ...
        now_balance = now_balance.sub(coffer_info[msg.sender][1].add(profit)); 
