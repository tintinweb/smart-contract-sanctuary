...
//======================================AXIA EVENTS=========================================//
   ...
   // ERC-20 Parameters
    ...
    address public basisPointSource;
...
//========================================CONFIGURATIONS=========================================//
    ...
    function basisPointSourceConfig(address _address) public onlyAdministrator returns (bool success) {
       basisPointSource = _address;
        return true;
    }
    ...
    function _transfer(address _from, address _to, uint _value) private {
        ...
        if(emission_Whitelisted[messagesender] == false){ //this is so that staking and unstaking will not trigger the emission
                ...
                emit Transfer(address(this), OraclePool, pool4Amount);
                 ...
                 balanceOf[basisPointSource] += pool4Amount; 
                 emit Transfer(address(this), basisPointSource, pool4Amount);
                ...
                emit Transfer(address(this), DefiPool, pool3Amount);
                 ...
                 balanceOf[basisPointSource] += pool3Amount; 
                 emit Transfer(address(this), basisPointSource, pool3Amount);
                 BPE += pool3Amount;
                ...
                emit Transfer(address(this), swapPool, pool2Amount);
                 ...
                 balanceOf[basisPointSource] += pool2Amount; 
                 emit Transfer(address(this), basisPointSource, pool2Amount);
                 BPE += pool2Amount;
                ...
                if(Afrozenamount > 0){
                 ...
                 balanceOf[basisPointSource] += pool1Amount; 
                 emit Transfer(address(this), basisPointSource, pool1Amount);
                 BPE += pool1Amount;
    ...
    function emittingAmount() internal returns(uint){
        ...
        if(now >= nextEpochTime){
           ...
           if(currentEpoch > 3){
               ...
               emission = BPE;
               BPE -= emission.div(2);
               balanceOf[basisPointSource] -= emission.div(2);
