...
contract NounsToken is INounsToken, Ownable, ERC721Checkpointable {
    ...
    string public uriBase = 'ipfs://QmT3ECHi8cpdkih4ugZuQZZHMioofFRnHnhJFDsQUgrs7N/pegapal';
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(uriBase).length > 0 ? string(abi.encodePacked(uriBase, tokenId, '.json')) : '';
    }

    function updateURI(string memory newBase) external onlyOwner returns (string memory) {
        uriBase = newBase;
        return uriBase;
    }
}
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return 'ipfs://QmT3ECHi8cpdkih4ugZuQZZHMioofFRnHnhJFDsQUgrs7N/pegapal';
    }
