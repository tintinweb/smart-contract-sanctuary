...
contract LostPunkSociety is ERC721Enumerable, Ownable {
    ...
    address private giveDirectlyDonationAddress = 0xc7464dbcA260A8faF033460622B23467Df5AEA42;
    ...
    function mintLostPunk(uint16 fatherIndex, uint16 motherIndex) external payable {
        ...
        require((childGen - 1) * TIER_PRICE_IN_WEI  <= msg.value, "Insufficient Ether sent");
    ...
    function tokenURI(uint256 index) public view override returns (string memory)
    {
        ...
        string memory json = base64Encode(bytes(string(abi.encodePacked(
            '{"name": "Lost Punk #',
            toString(index), 
            '", "description": "Lost Punks are descendants of the original CryptoPunks. Minting new children requires owning both a mother and a father. All metadata and images are fully generated and stored on-chain. Inspired by LarvaLabs (not affiliated).", "image": "data:image/svg+xml;base64,', 
