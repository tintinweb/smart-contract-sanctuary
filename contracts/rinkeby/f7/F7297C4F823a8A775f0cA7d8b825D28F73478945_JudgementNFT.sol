...
contract JudgementNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, Whitelist {
    ...
    function buy(uint256 _tokenId) external {
        ...
        require(redeemCurrency.transferFrom(_newOwner, address(this), price[_tokenId]), "deposit redeem failed");
        
        require(redeemCurrency.transfer(_previousOwner, sellerValue), "transfer to seller failed");
        if(feeAddress != address(0x0) && feeValue != 0x0) {
            require(redeemCurrency.transfer(feeAddress, feeValue), "transfer to fee address failed");
        }
