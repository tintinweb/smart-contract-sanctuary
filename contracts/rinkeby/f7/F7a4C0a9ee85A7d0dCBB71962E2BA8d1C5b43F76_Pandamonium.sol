...
contract Pandamonium is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    address public pandaOwner = 0x8A34D35Eab3ab1b8c5c68F9cb072273B180eea23;
    address public developer = 0x6D049ed4d3d93beB75E435F594e448E8cF5EA597;
    address public developer2 = 0x6D049ed4d3d93beB75E435F594e448E8cF5EA597;
    address public address1 = 0x6D049ed4d3d93beB75E435F594e448E8cF5EA597;
    address public address2 = 0x6D049ed4d3d93beB75E435F594e448E8cF5EA597;
    address public address3 = 0x6D049ed4d3d93beB75E435F594e448E8cF5EA597;
    address public address4 = 0x6D049ed4d3d93beB75E435F594e448E8cF5EA597;
    ...
    function mintPresale(
        ...
        // require(presaleClaimed[_msgSender()].exists, "Address not whitelisted");
    ...
    function withdraw() public onlyOwner {
        ...
        payable(developer).transfer(balance * 10 / 100);
        payable(developer2).transfer(balance * 3 / 100);
        payable(address1).transfer(balance * 75 / 1000);
        payable(address2).transfer(balance * 75 / 1000);
        payable(address3).transfer(balance * 75 / 1000);
        payable(address4).transfer(balance * 75 / 1000);
