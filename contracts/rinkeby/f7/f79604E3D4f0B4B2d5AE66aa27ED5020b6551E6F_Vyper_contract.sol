...
def _burn(_to: address, _value: uint256):
    ...
    # NOTE: vyper does not allow underflows, so the following subtraction(s) would revert on insufficient balance
...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    """
    # NOTE: vyper does not allow underflows, so the following subtraction would revert on insufficient balance
...
#################################
# No minting allowed after init # TODO: really? (https://www.notion.so/Finality-of-ERC-20-supply-a166ec56355e46ec96144dac8274213f)
#################################
