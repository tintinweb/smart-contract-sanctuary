...
contract CyberApes is ERC721, Ownable {
    ...
    string public APES_PROVENANCE = "";

    uint256 public startingIndexBlock;

    uint256 public startingIndex;

    uint256 public constant apePrice = 88000000000000000; //0.088 ETH
    ...
    function whitelistAddress(address account) public onlyOwner() {
        require(!_isWhitelisted[account], "Account is already White Listed");
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        APES_PROVENANCE = provenanceHash;
    }
