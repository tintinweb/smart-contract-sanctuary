// SPDX-License-Identifier: GPL-3.0.json
...
contract VoxelCityPlots is ERC721Enumerable, Ownable {
    ...
    string public collectionURI_;


    uint256 public constant standardPrice = 50000000000000000;
    uint256 public constant whitelistPrice = 40000000000000000;
    ...
    struct Sale {
      ...
      // mapping(address => uint256) mintPerWhitelist;
    ...
    //                         MUTATIVE Functions                         //
    ////////////////////////////////////////////////////////////////////////
    constructor(address _cityBank, string memory _collectionURI) ERC721("Voxel City Plots", "VCP") {
        cityBank_ = _cityBank;
        collectionURI_ = _collectionURI;
        numberOfSales = 0;
        // setBaseURI(setupUri);
    }

    // create new sale 
    function CreateSale(string memory _baseURI, uint256 _tokenSupply, uint256 _startState) public onlyOwner{
    ...
    function MintPlot(uint256 _saleId, uint256 _numberOfTokens) public payable {
        ...
        require(msg.value == (standardPrice * (_numberOfTokens)), "Ether value sent is not correct");
        ...
        for(uint256 i = 0; i < _numberOfTokens; i++) {
            if (saleIdToSale[_saleId].numTokens < saleIdToSale[_saleId].tokenSupply) {
                ...
                saleIdToSale[_saleId].state = 3;
                payable(cityBank_).transfer((_numberOfTokens - i) * standardPrice);
                return;
            }
        }
