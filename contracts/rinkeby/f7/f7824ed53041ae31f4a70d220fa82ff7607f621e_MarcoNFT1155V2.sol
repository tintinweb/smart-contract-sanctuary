...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    mapping(address => mapping(uint256 => bool)) public isOnSale;
    ...
    */
        ...
        override
    {
        ...
        for (uint256 i = 0; i < tokenIds.length; ++i) {
            ...
            _balances[tokenId][to] = _balances[tokenId][to].add(amount);
            isOnSale[from][tokenIds[i]] = false;
        }
...
contract MarcoNFT1155V2 is ERC1155 {
    ...
    */
    ...
    function putOnSale(uint256 _tokenId) public payable {
        require(!isOnSale[msg.sender][_tokenId], "already putOnSale is enabled");
        ...
        isOnSale[msg.sender][_tokenId] = true;
