...
import "@openzeppelin/contracts/security/ReentrancyGuard.sol"; //needed?
...
contract AuctionHouse is Ownable, Pausable {
    ...
    function removeFromSale(uint256 saleID) public {
        ...
        emit RemoveSale(sl.nftContract, saleID, sl.nftID, sl.price, msg.sender);
    }
