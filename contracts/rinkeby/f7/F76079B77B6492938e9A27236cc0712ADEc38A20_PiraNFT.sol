...
contract PiraNFT is IPiraNFT, IPiraUtil, ERC721URIStorage {
    ...
    constructor(string memory piraHash) ERC721("Pira Digitals Tokens", "PIRA") {
        _piraHash = piraHash;
    }

    function enablePiraHash(string memory piraHash) public override {
        _piraHash = piraHash;
    }

    function disablePiraHash() public override{
        _piraHash = '';
    }
    ...
    function mint(string memory tokenURI, string memory nftId) public override returns (uint256) {
        _tokenIds.increment();
    ...
    function tokenURI(uint256 tokenId, string memory piraHash) public view override returns (string memory) {
...
interface IPiraNFT {
    function mint(string memory tokenURI, string memory nftId) external returns (uint256);
    ...
    // function getItemRoyaltyRule(uint256 tokenId) external view returns (string memory);
}
