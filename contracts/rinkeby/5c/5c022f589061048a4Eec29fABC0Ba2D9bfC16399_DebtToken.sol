...
contract DebtToken is IDebtToken {
     ...
     * @notice couldn't override in interface
     * @dev modifier onlyCommunityContract
     *
     * @param _sender address - the address to debit tokens from
     * @param _recipient address - the address to credit tokens to
     * @param _amount uint256 - the amount of tokens to be transferred
     * @return bool - true if transfer was successful, and false otherwise
     */
    function transferFrom(
        address _sender,
        address _recipient,
        uint256 _amount
    ) public override onlyCommunityContract returns (bool) {
 ...
 */
abstract contract IDebtToken is ERC20Upgradeable, BasicMetaTransaction {
