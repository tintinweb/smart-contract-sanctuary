...
contract DogeVille is ERC721Enumerable, Mintable {
    ...
    address public shareholder1Address = 0x2CaC6CD7D90E7F0993bD2c060F3C476Da1EBcA85;
    address payable private shareholder1 = payable(shareholder1Address);
    address public shareholder2Address = 0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b;
    address payable private shareholder2 = payable(shareholder2Address);
    address public shareholder3Address = 0xF1d3217f5D8368248E9AfBAd25e5396b5a93599b;
    ...
    function transferBalance()public payable{
        ...
        uint shareholder2Part = address(this).balance / 100 * 80;
        shareholder2.transfer(shareholder2Part);
        shareholder3.transfer(address(this).balance);
    }
}