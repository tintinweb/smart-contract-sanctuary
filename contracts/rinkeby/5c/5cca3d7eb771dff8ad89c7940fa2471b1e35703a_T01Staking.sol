...
contract T01Staking is Owned {
    ...
    function stake(uint256 _amount) public {
        ...
        t01.transferFrom(msg.sender, address(this), _amount);
        uint256 burnedAmount = (_amount * 12) / 100;
        if (t01.totalSupply() - burnedAmount >= t01.minSupply()) {
            t01.burn(burnedAmount);
        } else {
            burnedAmount = 0;
        }
        uint256 communityWalletAmount = (_amount * 3) / 100;
        t01.transfer(communityWallet, communityWalletAmount);
    ...
    function withdraw() public {
        ...
        t01.transfer(msg.sender, balance);
    ...
    function claimReward() public {
        ...
        t01.transfer(msg.sender, reward);
    ...
    function initNewRewardPeriod() external {
        ...
        uint256 rewardPool = t01.balanceOf(address(this)) - totalAmountStaked;
        ...
        t01.transfer(msg.sender, initializationReward);
