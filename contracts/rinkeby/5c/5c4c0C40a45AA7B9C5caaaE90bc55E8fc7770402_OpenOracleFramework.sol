...
contract OpenOracleFramework {
    ...
    // an optional fee for oracle data access
    ...
    event contractSetup(address[] signers, uint256 signerThreshold, uint256 fee, address payout);
    ...
    constructor(address[] memory signers_, uint256 signerThreshold_, uint256 oracleFee_, address payable payoutAddress_, uint256 subscriptionPassPrice_) {
        ...
        emit contractSetup(signers_, signerThreshold, oracleFee, payoutAddress);
    }
