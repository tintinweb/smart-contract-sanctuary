...
// File: RandomHumans.sol

contract RandomHumans is Context, ERC721, Ownable {
        uint256 public tokenCounter;
        uint private constant mintPrice = 50000000000000000;

    constructor () public ERC721("RandomHumans", "RHU"){
        tokenCounter = 0;
    }
    ...
    function mintme(string memory tokenURI) public onlyOwner returns (uint256) {
        uint256 newItemId = tokenCounter;
        _safeMint(msg.sender, newItemId);
        _setTokenURI(newItemId, tokenURI);
        tokenCounter = tokenCounter + 1;
