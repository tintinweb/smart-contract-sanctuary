...
contract Spells is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function spellTokenUri(uint256 tokenId) internal view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Spell Tomb: ', parts[1], '", "description": "Spells for Adventurers is extension for Loot for Adventurers.", "attributes": [ { "trait_type": "Spell 1", "value": "', spellActions[0], '" }, { "trait_type": "Spell 2", "value": "', spellActions[1], '" }, { "trait_type": "Spell 3", "value": "', spellActions[2], '" }, { "trait_type": "Spell 4", "value": "', spellActions[3], '" } ], "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
