...
contract GTW is ERC20, Ownable {
    ...
    constructor() ERC20("Gang of Thieves World", "GTW") {
    	...
    	marketingWallet = address(0xeB37Ad189b3672896d805FAa6e2E27F89D7AD3aA); // set as marketing wallet
    	devWallet = address(0x1Bb4C586ae31d910287A19344BeA2Be7e5b9E4b0); // set as buyback wallet
