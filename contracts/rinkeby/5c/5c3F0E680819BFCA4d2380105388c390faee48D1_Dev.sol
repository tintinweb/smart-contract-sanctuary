 ...
 */
contract Dev is ERC721Tradable {

    function contractURI() public pure returns (string memory) {
        return "https://ipfs.io/ipfs/QmUkBmsMNvz6Mi514cSrt4qGYTrMgPrvQVeQnHcaz3RUPj";
    }

    function baseTokenURI() public override pure returns (string memory) {
        return "https://ipfs.io/ipfs/QmXDkpycE4g4g55veHgRrSYXaWPSHA7R6WBNuzN5fZpHyk/";
    }

    constructor(address _proxyRegistryAddress)
        ERC721Tradable("DEVOTION Cryptobaebes Experience", "DEVOTION", _proxyRegistryAddress)
    {}
 ...
 */
contract ERC721Tradable is Context, ERC721Burnable, Ownable {
