...
contract SipherIBCO is Ownable {
    ...
    uint256 public constant START = 1638623937; // Monday, December 6, 2021 1:00 AM UTC
    uint256 public constant END = START + 1 days; // Thursday, December 9, 2021 1:00 AM UTC
