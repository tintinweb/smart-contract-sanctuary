    ...
    Proxiable
{
    ...
    event AMMInitialized(ISimpleToken lpToken, address sirenPriceOracle);
    ...
    function initialize(
        ...
        emit AMMInitialized(lpToken, address(sirenPriceOracle));
    }
            ...
            if (
                ...
                if (wTokenBalance > 0) {
                    (uint256 unclaimedCollateral, ) =
                        marketController.getClaimAmount(
                            marketId,
                            wTokenBalance
                        );
                    expiredTokensValue += unclaimedCollateral;
                }
                if (bTokenBalance > 0) {
                    (uint256 unexercisedCollateral, ) =
                        marketController.getExerciseAmount(
                            marketId,
                            bTokenBalance
                        );
                    expiredTokensValue += unexercisedCollateral;
                }
            }
        }
