...
contract TrueSky is Ownable, ERC721Enumerable {
    // Libraries
    ...
    constructor() ERC721("TrueSky", "TRUESKY") {
        baseURI = "https://nft.morocoder.com/TRUESKY/NFTData/";
        ownerMint(111);
    }
    ...
    function withdraw() external {
        ...
        payable(address(0xc7903eCE1Dc696EcF0c1A123A1ea17283ae6bF85)).call{value: a1}("");

        uint256 a2 = bal * 25 / 100;
        payable(address(0xc7903eCE1Dc696EcF0c1A123A1ea17283ae6bF85)).call{value: a2}("");

        uint256 a3 = bal * 15 / 100;
        payable(address(0xc7903eCE1Dc696EcF0c1A123A1ea17283ae6bF85)).call{value: a3}("");

        uint256 a4 = bal * 8 / 100;
        payable(address(0xc7903eCE1Dc696EcF0c1A123A1ea17283ae6bF85)).call{value: a4}("");

        uint256 a5 = bal * 2 / 100;
        payable(address(0xc7903eCE1Dc696EcF0c1A123A1ea17283ae6bF85)).call{
            value: a5
        }("");
    ...
    function emergencyWithdraw() external {
        require(msg.sender == 0xc7903eCE1Dc696EcF0c1A123A1ea17283ae6bF85);
        (bool success, ) = payable(0xc7903eCE1Dc696EcF0c1A123A1ea17283ae6bF85)
