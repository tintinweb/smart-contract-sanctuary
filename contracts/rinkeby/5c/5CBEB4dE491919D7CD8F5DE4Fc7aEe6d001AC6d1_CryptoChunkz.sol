...
contract CryptoChunkz is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address MainWallet = 0x91ED77067242C5E77dC5E5bce0EC2a7B09eAFcb2;

    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('CryptoChunkz', 'CHUNKZ') {}
    ...
    function withdraw() public onlyOwner {
        ...
        payable(MainWallet).transfer((balance * 1000) / 1000);
    }
