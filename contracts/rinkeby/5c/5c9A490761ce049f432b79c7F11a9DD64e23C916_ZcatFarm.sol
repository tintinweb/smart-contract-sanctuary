...
contract ZcatFarm is IERC721Receiver, Ownable {
    using EnumerableSet for EnumerableSet.UintSet;

    

    address public ZCAT;
    address public immutable ERC721_CONTRACT;
    uint256 public EXPIRATION;
    uint256 public RATE = 115740700000000;

    mapping(address => EnumerableSet.UintSet) private _deposits;
    mapping(address => mapping(uint256 => uint256)) public depositBlocks;

    constructor(
        address zcat_erc20_token_address,
        address zombiecats_erc721_address,
        uint256 expiration
    ) {
        ZCAT = zcat_erc20_token_address; 
        ERC721_CONTRACT = zombiecats_erc721_address;
    ...
    function claimRewards(uint256[] calldata tokenIds) public {
        ...
        if (reward > 0) {
            try IERC20(ZCAT).transfer(msg.sender, reward) returns (bool v) {
