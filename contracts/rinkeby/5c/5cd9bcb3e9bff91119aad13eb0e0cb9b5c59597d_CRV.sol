...
/**
Crystal Vision is a platform and ecosystem based on our token $CRV, that will focus on bringing it's holders the BEST defi projects to invest in, and reward you for holding our token, as well as the tokens under our ecosystem. Crystal Visions IDO Launchpad is a deFi platform where pre-sales of the coins sold through the project determined by our Crypto Project Developers are made. We will carefully analyze and bring you TOP new projects to invest in and reward you for participating in those projects pre-sales. The Crystal Vision team will provide our investors with high quality blockchain projects that have been carefully vetted, analyzed and targeted through our experienced checklist, to bring you MASSIVE profits and rewards by participating in these project pre-sales. 
*/
