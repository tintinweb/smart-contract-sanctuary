...
contract UGO7 is ERC721Enumerable, Ownable {
    using Strings for uint256;

    //sale settings
    uint256 public MAX_SUPPLY = 100;
    uint256 public MAX_PRESALE_MINT = 3;
    uint256 public TEAM_RESERVE_AVAILABLE_MINTS = 50;
    uint256 public COST = 0.02 ether;
    uint256 public MAX_SALE_MINT = 7;
    ...
    function CambiaPresaleState() external onlyOwner {
    ...
    function CambiaSaleState() external onlyOwner {
    ...
    returns (string memory)
  {
    ...
    function setMAX_SUPPLY(uint256 _newMAX_SUPPLY) external onlyOwner {
        MAX_SUPPLY = _newMAX_SUPPLY;
    }

    function setTEAM_RESERVE_AVAILABLE_MINTS(uint256 _newTEAM_RESERVE_AVAILABLE_MINTS) external onlyOwner {
        TEAM_RESERVE_AVAILABLE_MINTS = _newTEAM_RESERVE_AVAILABLE_MINTS;
    }    
