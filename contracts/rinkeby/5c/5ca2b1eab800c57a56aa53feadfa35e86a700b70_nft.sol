 ...
 * account.
 */
abstract contract ERC721Enumerable is nft, IERC721Enumerable {
...
contract Whales is nft, ERC721Enumerable, Ownable {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override(nft, ERC721Enumerable) {
        super._beforeTokenTransfer(from, to, tokenId);
    }

    function supportsInterface(bytes4 interfaceId) public view virtual override(nft, ERC721Enumerable) returns (bool) {
