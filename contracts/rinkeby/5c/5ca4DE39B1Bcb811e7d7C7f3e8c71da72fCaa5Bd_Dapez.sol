...
contract Dapez is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public constant dapezMax = 5;
    uint256 public constant purchaseLimit = 20;

    uint256 private dapezPrice = 0.00000003 ether;
 ...
 function mint(uint256 numberOfTokens) external payable {
  ...
  function contractURI() public view returns (string memory) {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x8394F023cA9FD93a42D1C5F156e428D88f25b299).transfer(share1);
        payable(0x5528c3f30665C615021FF7f77b7eaA9605507A15).transfer(balance - share1);
    }
}
