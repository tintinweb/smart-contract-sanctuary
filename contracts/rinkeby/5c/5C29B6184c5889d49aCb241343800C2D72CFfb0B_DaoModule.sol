...
abstract contract AlbumBuyoutManager {
    ...
    {
        return (buyer, buyoutCost, buyoutEnd, bought, timeout);
    }
...
contract AlbumFactory {
    ...
    // Total num tokens is 100k tokens, with 18 decimals.
    uint256 public constant TOTAL_TOKENS = 1e5 * 1e18;
    ...
    function createAlbum(
        ...
        console.log("Creating an Album with name: ", name);
        require(
        ...
        address daoModule;
        {
            ...
            (safe, daoModule) = FACTORY_SAFE_HELPER.createAndSetupSafe(
                ensSubNode
            );
        ...
        distributeAlbumTokens(token, tokenSaleParams.numTokens, album);
    ...
    function createAndSetupToken(
        ...
        ERC20PresetMinterPauser token =
            new ERC20PresetMinterPauser{salt: ""}(
    ...
    function distributeAlbumTokens(
        ...
        token.mint(msg.sender, TOTAL_TOKENS - amountSold);
...
import {
    ...
    Executor,
    Realitio
} from "@gnosis/dao-module/contracts/DaoModule.sol";
import "hardhat/console.sol";
...
contract FactorySafeHelper is IFactorySafeHelper {
    ...
    constructor(
        ...
        ORACLE = Realitio(realitioAddress);
        ...
        returns (address safeAddress, address)
    {
        ...
        safe.setup(
            ...
            1, // threshold
            address(this), // to
            abi.encodeWithSignature("initSafe(address)", daoModule), // data
        ...
        return (safeAddress, address(daoModule));
    }

    function initSafe(address daoModuleAddress) external {
        IGnosisSafe safe = IGnosisSafe(address(this));
        safe.enableModule(daoModuleAddress);
        console.log(
            "Enabled dao module",
            safe.isModuleEnabled(daoModuleAddress)
        );
        // TODO set szns dao as arbitrator on module?
    }
}
...
// SPDX-License-Identifier: MIT
// From: https://github.com/sushiswap/sushiswap/blob/master/contracts/MasterChef.sol
pragma solidity ^0.8.0;
...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        token.mint(devaddr, sushiReward.div(10));
