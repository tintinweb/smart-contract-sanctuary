...
contract Loops is Context, Ownable, ERC165Storage, IERC721Enumerable, IERC721Metadata {
    ...
    // Public variables
    uint256 public constant TO_WEI                  = 10**18;
    //TODO uint256 public constant LOOPS_PROOF      = "df760c771ad006eace0d705383b74158967e78c6e980b35f670249b5822c42e1";
    ...
    function getCurrentPrice(uint256 count) public view returns (uint256) {
        ...
        if (currentNumOfLoops < 512) {          price = 80000000000000000;     // 0-511      ... 0.08E
        } else if (currentNumOfLoops < 1024) {  price = 160000000000000000;    // 512-1023   ... 0.16E
        } else if (currentNumOfLoops < 2048) {  price = 320000000000000000;    // 1024-2047  ... 0.32E
        } else if (currentNumOfLoops < 4096) {  price = 640000000000000000;    // 2048-4095  ... 0.64E
        } else if (currentNumOfLoops < 8192) {  price = 1280000000000000000;   // 4096-8191  ... 1.28E
        } else {                                price = 2560000000000000000;   // 8192-10100
        }
    ...
    */
	...
	uint mintStart = mintedSupply();
        ...
        for (uint i = 0; i < count; i++) {
            ...
            _safeMint(msg.sender, mintIndex);   // TODO: EXPLOIT 
            IDUST(_dustAddress).mint(msg.sender, LOOP_MINT_REWARD);
        }
