    ...
    Configurable
{
    ...
    function initialize(
        ...
        __ERC20_init("SIP.SPACE - Space SIP Token", "SIP");
        __Ownable_init();
    ...
    /**
     * @dev function to purchase new SIP
     * @param issuer the address that will receive the newly minted SIP
     * @param value the amount of SIP to mint
     */
    function issue(
        address issuer,
        uint256 value,
        ...
        require(totalSupply() + value <= cap, "minted value + total supply must be smaller or equal token cap");
        _mint(issuer, value);
