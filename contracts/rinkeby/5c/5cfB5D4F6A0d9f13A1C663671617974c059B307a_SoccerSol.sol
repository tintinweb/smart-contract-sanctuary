...
contract SoccerSol is ERC721, Ownable, ReentrancyGuard {
    ...
    // Mint Price
    uint public preSalePrice = 0.05 ether; // presale price
    uint public publicSalePrice = 0.08 ether; // publicsale price
    ...
    function setMintStep(uint8 _mintStep) external onlyOwner returns (uint8) {
        ...
        mintStep = _mintStep;
        emit Setting(mintStep, publicSalePrice, preSalePrice, totalLimit, mintLimit, _tokenId, totalSupply);
        return mintStep;
    }
