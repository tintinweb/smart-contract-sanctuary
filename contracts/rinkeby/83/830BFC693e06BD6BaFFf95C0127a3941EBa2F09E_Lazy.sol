...
contract Lazy is  ERC721URIStorage, EIP712 ,AccessControl, Ownable, ERC721Enumerable {
    ...
    function mint(uint256 tokenId, uint index) public onlyOwner{
        ...
        see[0] = 'https://exposedwalls.mypinata.cloud/ipfs/QmdSV4AbPjSAyDWRdDLDgqWrkvekVH7fFCJu1VtRoi5uFS/1.json';
        see[1] = 'https://exposedwalls.mypinata.cloud/ipfs/QmdSV4AbPjSAyDWRdDLDgqWrkvekVH7fFCJu1VtRoi5uFS/2.json';
        see[2] = 'https://exposedwalls.mypinata.cloud/ipfs/QmdSV4AbPjSAyDWRdDLDgqWrkvekVH7fFCJu1VtRoi5uFS/3.json';
        see[3] = 'https://exposedwalls.mypinata.cloud/ipfs/QmdSV4AbPjSAyDWRdDLDgqWrkvekVH7fFCJu1VtRoi5uFS/4.json';
        see[4] = 'https://exposedwalls.mypinata.cloud/ipfs/QmdSV4AbPjSAyDWRdDLDgqWrkvekVH7fFCJu1VtRoi5uFS/5.json';
