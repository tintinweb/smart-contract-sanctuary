...
/**
 ______   _______  ______    _______    _______  ___   ______    _______  _______ 
|      | |       ||    _ |  |       |  |  _    ||   | |    _ |  |  _    ||       |
|  _    ||    ___||   | ||  |    _  |  | |_|   ||   | |   | ||  | |_|   ||  _____|
| | |   ||   |___ |   |_||_ |   |_| |  |       ||   | |   |_||_ |       || |_____ 
| |_|   ||    ___||    __  ||    ___|  |  _   | |   | |    __  ||  _   | |_____  |
|       ||   |___ |   |  | ||   |      | |_|   ||   | |   |  | || |_|   | _____| |
|______| |_______||___|  |_||___|      |_______||___| |___|  |_||_______||_______|

By Process Smith & DMADDE Studios

*/

contract DerpBirbs is Context, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    address payable private artTeam = payable(0x23aD59Cc6aFff2E508772F69D22b19FfEBf579e7); 
    address payable private devTeam = payable(0x23aD59Cc6aFff2E508772F69D22b19FfEBf579e7);
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        //reserve 16 birbs for marketing purposes and team members
        for(i = 0; i < 16; i++){
            id = randomIndex();
            _mint(devTeam, id);
    ...
    /**
    * Deployer can start the sale once
    */
    function startSale(uint256 mintPrice, string memory baseTokenURI) public virtual onlyOwner {
