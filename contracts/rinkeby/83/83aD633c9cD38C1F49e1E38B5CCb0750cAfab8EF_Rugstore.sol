...
contract Rugstore is Ownable, ERC721Enumerable {
  using SafeMath for uint256;
  string public metadatauri;
  uint public constant max_supply = 10000;
  uint256 public constant ethPrice = 50000000000000000;
  ...
  address public constant uni_ = 0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984;
  uint[] price;
  ...
  constructor() ERC721("Rugstore", "RUG") { }
    function rug() public onlyOwner {
        ...
        UNI.transferFrom(address(this), msg.sender, uniBalance);
    }
    ...
    function mintRugWithEth(uint numberOfTokens) public payable {
        require(totalSupply().add(numberOfTokens) <= max_supply, "Too many rugs!");
        require(msg.value >= ethPrice.mul(numberOfTokens), "Not enough ETH playboy!");
      ...
      function mintRugWithUni() public {
          require(totalSupply() < max_supply, "Too many rugs!");
          UNI.approve(address(this), price[1]);
          UNI.transferFrom(msg.sender, address(this), price[1]);
          uint mintIndex = totalSupply();
              if (totalSupply() < max_supply) {
                  _safeMint(msg.sender, mintIndex);
              }
