 ...
 */
contract LootRealmsTest is ERC721, ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    //Loot Contract
    address public lootAddress = 0x4228F689Df43FD12bfFA59F49e145BFf20E72CEb;
    LootInterface lootContract = LootInterface(lootAddress);

    constructor() ERC721("Realms (for Adventurers)", "Realms") {
    }
