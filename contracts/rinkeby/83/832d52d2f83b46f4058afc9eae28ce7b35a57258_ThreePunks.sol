...
contract ThreePunks is ERC721Enumerable, Ownable {
    ...
    // withdraw address
    address team = 0xD71cc55eEe810489fA5e8e53225FeE434B924dE8;
    ...
    function mint3x3(uint256 num) public payable {
        ...
        if(_onlyWhitelist==true){
            ...
            require(ownerTokenCount + num < nftPerAddress,  "Maximum of 9 3x3Punks per address");
        }
