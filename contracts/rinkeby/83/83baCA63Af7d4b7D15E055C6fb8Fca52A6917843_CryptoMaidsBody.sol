...
import "./erc/ERC721MintableNotEnum.sol";
...
contract CryptoMaidsBody is ERC721MintableNotEnum, ERC721Permit("CryptoMaids:Body") ,Ownable, ERC721URIStorage{
    ...
    address public constant devAddress = 0xF2B097235feB9D5F4B897dA0c654c026524F2A81;

    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("CryptoMaids:Body", "CMTB") {
        setDefaultURI("https://api.cryptomaids.tokyo/metadata/body/");
        pause();
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721, ERC721MintableNotEnum) returns (bool) {
        return super.supportsInterface(interfaceId);
    }

    function widthdraw(address _address, uint256 _amount) private {
        (bool success, ) = _address.call{value: _amount}("");
        require(success, "Transfer failed.");
    }

    function recruitMaid(address _to, uint256 _count) public payable {
...
abstract contract ERC721MintableNotEnum is IERC721Mintable, ERC721, AccessOperatable {
