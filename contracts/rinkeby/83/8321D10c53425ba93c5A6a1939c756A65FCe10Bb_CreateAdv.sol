...
contract CreateAdv is ERC721 {
    ...
    function setMaxTokenCount(uint256 _maxTokenCount) public {
        require(msg.sender == owner, "Only Owner can set maximum token count");
    ...
    function createAdvertisement(string memory tokenURI) public {
    ...
    function setTokenURI(uint256 tokenId, string memory tokenURI) public {
        require(
            ...
            "ERC721: trander caller is not owner nor approved"
        );
