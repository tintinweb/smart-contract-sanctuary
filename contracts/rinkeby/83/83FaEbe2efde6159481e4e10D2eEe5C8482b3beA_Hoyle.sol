...
contract Hoyle is ERC721URIStorage, Ownable {
    uint256 public tokenCounter;
    event CreatedHoyle(uint256 indexed tokenId, string tokenURI);

    constructor() ERC721("Hoyle NFT", "hoyle")
    {
        tokenCounter = 0;
    }
    ...
    function create(string memory svg) public {
        ...
        emit CreatedHoyle(tokenCounter, svg);
    }
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                "Hoyle NFT", // You can add whatever name here
                                '", "description":"A hoyle NFT based on SVG!", "attributes":"", "image":"',imageURI,'"}'
                            )
                        )
                    )
                )
