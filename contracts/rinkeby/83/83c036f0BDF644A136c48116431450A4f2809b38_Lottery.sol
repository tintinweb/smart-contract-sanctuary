...
contract Lottery is VRFConsumerBase , Ownable{
    ...
    function getEntranceFee() public view returns (uint256){
        ...
        uint256 adjustedPrice = uint256(price) * 10 ** 10;//= true price in usd * 10e18
        return (usdEntryFee * 10 ** 18 + adjustedPrice - 1) / adjustedPrice;
    }
    function startLottery() public onlyOwner {
        require(lottery_state == LOTTERY_STATE.CLOSED, "Can't start a new lottery because there is a running one");
