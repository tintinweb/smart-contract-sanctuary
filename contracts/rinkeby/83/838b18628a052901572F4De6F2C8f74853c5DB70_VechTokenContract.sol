...
contract VechTokenContract is ERC721AModified, Ownable, Pausable {
    ...
    constructor() ERC721AModified("VECH", "VECH", 100) {}
  ...
  IERC721Enumerable
{
  ...
  function approve(address to, uint256 tokenId) public override {
    address owner = ERC721AModified.ownerOf(tokenId);
