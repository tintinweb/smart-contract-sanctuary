...
contract GeckTest is ERC721Enumerable { 
    ...
    constructor(
        ...
        LEGENDARY_TIERS[0] = [1000, 1000, 1000, 4000, 4000, 4000, 8000, 8000, 8000];
    ...
    function mintInternal() internal {
        ...
        if (legendariesMinted < 9) {
            ...
            if (legendaryDecider == 0) {
                ...
                _tokenIdToLegendaryName[thisTokenId] = legNames[legendariesMinted];
    ...
    function legToMetadata(string memory legName) public view returns (string memory){
                            ...
                            string(
                                abi.encodePacked(
                                    ...
                                    '", "description": "This is just a test. Hopefully it works well.", "image": "',
                                     "I am an image",
                                    '","attributes":',
                                    legToMetadata(_tokenIdToLegendaryName[_tokenId]),
                                    "}"
                                )
                            )
                        )
    ...
    function addLegNames(string[] memory names)
        public
        onlyOwner
    {
