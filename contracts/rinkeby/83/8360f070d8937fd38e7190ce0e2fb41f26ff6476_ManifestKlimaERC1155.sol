...
contract ManifestKlimaERC1155 is ERC1155, Ownable {
    ...
    function mintWithMNFST(uint256 hoodieId) external {
        mint(hoodieId, MNFST);
    }

    function mintWithSMNFST(uint256 hoodieId) external {
        mint(hoodieId, sMNFST);
    }

    function mint(uint256 hoodieId, address token) internal {
