...
import "./AccessControl/MustCAccessControl.sol";
import "./interfaces/IMustC.sol";

contract MustC is Initializable, ERC1155MintBurn, ERC1155Metadata, Ownable {
    ...
    MustCAccessControl public accessControls;
    ...
    function initialize(
        ...
        MustCAccessControl _accessControls
    ) public initializer {
        name = _name;
        symbol = _symbol;
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        return
            Strings.strConcat(baseMetadataURI, Strings.uint2str(_id), ".json");
    }
    ...
    */
    function updateAccessControls(MustCAccessControl _accessControls)
        public
        onlyOwner
    {
        accessControls = _accessControls;
    ...
    function create(address _bankAddress, bytes memory _data)
        external
        returns (uint256)
    {
        require(
            ...
            "MustC.mint: Sender must have minter or smart contract role"
        );
 ...
 */
contract MustCAccessControl is AccessControl {
