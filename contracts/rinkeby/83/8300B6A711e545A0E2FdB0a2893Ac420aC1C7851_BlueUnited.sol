...
contract BlueUnited is ERC1155Tradable {
    ...
    constructor(address _proxyRegistryAddress)
        ERC1155Tradable(
            ...
            "STREDIUM",
            "https://storageapi.fleek.co/stredium-team-bucket/test/{id}.json",
            _proxyRegistryAddress
        ) {
        create(msg.sender, NFT1, 50, '', '0x0');
        create(msg.sender, NFT2, 50, '', '0x0');
        create(msg.sender, NFT3, 50, '', '0x0');
        create(msg.sender, NFT4, 50, '', '0x0');
        create(msg.sender, NFT5, 20, '', '0x0');
        create(msg.sender, NFT6, 20, '', '0x0');
    }

    function contractURI() public pure returns (string memory) {
        return "https://storageapi.fleek.co/stredium-team-bucket/test/metadata.json"; 
    }
}
