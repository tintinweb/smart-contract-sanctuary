...
contract ERC20 is IERC20 {
     ...
     * applications that interact with token matic will not expect
     ...
     *
     * To learn more about hooks, head to xref:ROOT:extending-matic.adoc#using-hooks[Using Hooks].
     */
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual { }
}

//import "./WlucaInterface.sol";
interface Iwluca {
