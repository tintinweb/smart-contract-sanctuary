...
contract DivineAssembly is ERC721Enumerable, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    address[] private _team = [
        0xDe1B51a2d486B00858F7458863d225A6dE84C252,
    ...
    uint256[] private _teamShares = [10, 25, 25, 40];
    ...
    uint256 public firstWithdrawRemaining;
    address private firstWithdrawWallet = 0xebe3BfBEC8332B0835bf0f466ba34c64655BA94d;

    constructor(
        string memory _name,
        string memory _symbol,
        uint256 _firstWithdrawAmount
    ) ERC721(_name, _symbol) PaymentSplitter(_team, _teamShares) {
        firstWithdrawRemaining = _firstWithdrawAmount;
    }
    ...
    function setWhitelistMintPrice(uint256 _nb) external onlyOwner {
    ...
    function whitelistMint(
        ...
        require(msg.value >= whitelistSalePrice * _nb, "DA: Insufficient amount.");
    ...
    function publicMint(uint256 _nb) external payable {
        ...
        require(msg.value >= publicSalePrice * _nb, "DA: Insufficient amount.");
