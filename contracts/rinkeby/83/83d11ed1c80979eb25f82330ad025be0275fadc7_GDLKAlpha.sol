...
contract GDLKAlpha is ERC721Enumerable, Ownable {
    ...
    constructor(string memory name, string memory symbol, uint256 genCount, string memory uri) ERC721(name, symbol) {
    ...
    function mintPresale(uint256 numberOfMints) public payable {
        ...
        require(numberOfMints > 0 && numberOfMints < reserved,  "Can't mint more than reserved");
