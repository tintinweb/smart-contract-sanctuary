...
contract AlphaWolves is ERC721Enumerable, Ownable {
    ...
    //TODO: Revert this
    uint256 public maxWolfSupply = 20; // 10000
    uint256 public maxAlphaWolfSupply = 10; // Max Alpha Wolf Count aka 5000
    ...
    function clone() public { 
        ...
        uint256 meatTokensInWallet = MeatToken.balanceOf(msg.sender);
        ...
        MeatToken.burn(msg.sender, clonePrice);
   ...
   function mint(uint256 numberOfMints) public payable {
    ...
    /* 
        ...
        if (betaWolfCount > 4000) {
            clonePrice = 75000000000000000000;
        } else if (betaWolfCount > 3000) {
            clonePrice = 60000000000000000000;
        } else if (betaWolfCount > 2000) {
            clonePrice = 45300000000000000000;
        } else if (betaWolfCount > 1000) {
            clonePrice = 30000000000000000000;
        } else if (betaWolfCount >= 0) {
            clonePrice = 15000000000000000000;
        }
    ...
    function getClonePrice() public view returns(uint256){
        ...
        if (betaWolfCount > 4) {
            clonePrice = 75000000000000000000;
        } else if (betaWolfCount > 3) {
            clonePrice = 60000000000000000000;
        } else if (betaWolfCount > 2) {
            clonePrice = 45300000000000000000;
        } else if (betaWolfCount > 1) {
            clonePrice = 30000000000000000000;
        } else if (betaWolfCount >= 0) {
            clonePrice = 15000000000000000000;
        }
    ...
    function _baseURI() internal view override returns (string memory) {
        ...
        MeatToken = IMeatToken(_stakeAddress);
    }
}
