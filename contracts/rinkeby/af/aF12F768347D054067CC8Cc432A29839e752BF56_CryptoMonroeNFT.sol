...
contract CryptoMonroeNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Crypto Monroe NFT", "CMN") {
    setHiddenMetadataUri("ipfs://QmeLhJPUdSDdu9xC9iUCHBD85hLbWrxQaiupPKnLtCxBM9/_metadata.json");
  }
