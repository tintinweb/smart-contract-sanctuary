 ...
 */
contract RFOXNFT is ERC721Tradable {
  string private _baseTokenURI;

  event PermanentURI(string _value, uint256 indexed _id);

  constructor(address _proxyRegistryAddress)
    ERC721Tradable("RFOX_VALT", "VALTNFT", _proxyRegistryAddress)
  {}
  ...
  */
  function freeze(string memory _value, uint256 _id) external {
    require(ownerOf(_id) == msg.sender, 'RFOXNFT: INSUFFICIENT PERMISSION');
