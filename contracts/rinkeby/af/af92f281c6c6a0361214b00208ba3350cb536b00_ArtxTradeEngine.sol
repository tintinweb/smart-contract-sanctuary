...
contract ArtxTradeEngine is ReentrancyGuarded, Ownable
{
   ...
   constructor()
   {
       ARTXToken = ERC1155(0xd7b4F1B9399bAB765cc2003f12BB13c2bc90f559);
   ...
   function enlistForSale(uint256 _id) public{
       ...
       if(!ARTXToken.isApprovedForAll(msg.sender, address(this)))
         ARTXToken.setApprovalForAll(address(this), true);
