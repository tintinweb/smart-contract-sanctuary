...
contract BullishBanners is ERC721, Ownable {
    ...
    uint256 public maxPreMintAmountPerTx = 2;
    ...
    modifier preMintCompliance(uint256 _mintAmount) {
        ...
        require(addressToPreSaleTokensMinted[msg.sender] + _mintAmount <= maxPreMintAmountPerTx, "Exceeds the amount of presale Tokens you can mint.");
        require(supply.current() + _mintAmount <= maxSupply, "Presale Closed");
        _;
    }
    ...
    function mintPreSale(uint256 _mintAmount) public payable preMintCompliance(_mintAmount) {
        ...
        addressToPreSaleTokensMinted[msg.sender] += _mintAmount;
    }
