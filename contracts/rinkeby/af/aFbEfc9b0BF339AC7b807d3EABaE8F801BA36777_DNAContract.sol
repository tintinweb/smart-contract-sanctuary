...
contract DNAContract is ERC721Enumerable, Ownable {
    ...
    uint256 constant private ladderNum = 9;
    ...
    */
    ...
    function GenerateLadder(uint256 tokenId) public view returns (string memory) {
        ...
        uint256 ladderNumTemp = neucleotideIdxArray[7]%ladderNum;
        string[ladderNum] memory ladder_pos_y = ["150", "400", "650", "90", "710", "330", "210", "590", "470"];
