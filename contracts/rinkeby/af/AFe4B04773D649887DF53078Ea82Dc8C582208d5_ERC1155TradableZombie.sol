...
/**
 * @title ERC1155TradableZombie
 * ERC1155TradableZombie - ERC1155 contract that whitelists an operator address, has create and mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract ERC1155TradableZombie is  
    ContextMixin,
    ERC1155,
