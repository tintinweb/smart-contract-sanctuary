...
contract JesusCrypt is ERC721Tradeable {
    ...
    bytes32 private root = 0xb26327104f4b5fb7490b034cd3273a93f3af7cd824fe37c98e89ef6bb28740d7;
    ...
    function mintWhitelist(
        ...
        // Comprobar si tiene más de 5 NFT con la suma y con los que quiere mintear
    ...
    function mintNormal(uint256 count) external payable {
    ...
    function mint(uint256 count) internal {
        ...
        require(count > 0, "JesusCrypt: Must mint at least 1 JesusCrypt!");
        require(
            count <= 20,
