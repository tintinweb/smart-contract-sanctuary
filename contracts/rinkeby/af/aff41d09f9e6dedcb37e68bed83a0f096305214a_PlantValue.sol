...
contract PlantValue is ERC721Pausable, AccessControl, Ownable, IPlantValue {
    ...
    function mint(uint256 num, address _from, address _to, uint256 _value) external onlyOwner {
        uint256 supply = totalSupply();
        require(_to != address(0));
        require(rangeOfId.length > 0, "INSUFFFICIENT PLANT ID");
        require( num > 0, "you can mint 0 plants");
        require( num <= 150, "You can mint maximum of 100 plants");
        require( supply + num < 150 - _reserved, "Exceeds maximum Plants spply");
