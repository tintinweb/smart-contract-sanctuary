...
contract Fortune is Divine {
  ...
  using SafeERC20 for IERC20;
    ...
    uint public price_Q = 400; // 1 BNB = price_Quilified for qualified accounts;
    uint public price_unQ = 300; // 1 BNB = price_unQuilified for unqualified accounts;
    uint public buyAmountLimit = 1; //upper limit of buyAmountLimit BNB
    uint public _floorbuyAmount = 1*1e17; // 0.1 BNB
