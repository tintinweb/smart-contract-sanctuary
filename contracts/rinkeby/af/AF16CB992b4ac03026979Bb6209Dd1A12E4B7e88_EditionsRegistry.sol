...
abstract contract OwnableOperatorControl is OwnableUpgradeable {
    ...
    function __OwnableOperatorControl_init() internal {
        __Ownable_init();
    ...
    EditionsStorage
{
    ...
    /**
     * @dev Mint with Signature - Allows Wallkanda to authorize minting of tokens by signing the content
     * of the tx
     */
    function mint(
        uint256 id,
    ...
    function safeMintBatchForArtistsAndTransfer(
        ...
        // set flag to 2 so isApprovedForall is overrided
        ...
        for (uint256 i; i < artists.length; i++) {
            ...
            safeTransferFrom(artists[i], recipient, ids[i], 1, data);
        }
    ...
    function _mint(
        ...
        ERC1155Upgradeable._mint(creator, id, supply, data);

        // if specific uri
        _setMetadata(id, uri, creator);
...
abstract contract ERC1155WithMetadata is ERC1155Upgradeable {
        ...
        returns (string memory)
    {
        ...
        return ERC1155Upgradeable(address(this)).uri(id);
    }
...
abstract contract ERC2981Royalties is ERC165Upgradeable, IERC2981Royalties {
    ...
    function __ERC2981Royalties_init() internal initializer {
