...
contract Hand is ERC721Tradable {
    uint256 public MAX_HANDS = 235000;
    uint256 public GIVEAWAY_AMOUNT = 25;
    uint256 public MAX_MINTABLE_PER_TXN = 10;
    uint256 public PRICE_PER_HAND = 0.025 ether;

    bool public minting_enabled = false;

    string public baseTokenURI = "https://hoc-metadata-api.herokuapp.com/data/";
    string public baseTokenURI_ext = ".json";
    ...
    function setBaseTokenURI_ext(string memory _new_ext) public onlyOwner {
        baseTokenURI_ext = _new_ext;
    }
}
