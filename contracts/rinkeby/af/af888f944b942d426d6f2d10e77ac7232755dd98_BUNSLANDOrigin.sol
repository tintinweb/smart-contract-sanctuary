...
contract BUNSLANDOrigin is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public constant bunsPrice = 69000000000000000;
    ...
    function safeMint(address to, uint256 numBuns) public payable {
        ...
        require(numBuns > 0 && numBuns <= 6, "You can mint from 1 to 6 Buns");
        require(msg.value >= bunsPrice, "Not enough ETH sent; check price!"); 
