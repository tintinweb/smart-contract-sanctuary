...
contract FETest is Context, IERC20, Ownable {
    ...
    string private _name = "FETest";
    string private _symbol = "FEtst";
    ...
    uint256 public _marketingFee = 2; // All taxes are divided by 100 for more accuracy.
