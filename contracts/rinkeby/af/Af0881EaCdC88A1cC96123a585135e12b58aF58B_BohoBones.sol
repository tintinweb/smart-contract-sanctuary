...
contract BohoBones is ERC721, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    uint256 public maxBohoBonePurchase = 2; // Default state to 2, as that is max presale amount
    uint256 public MAX_BOHOBONES = 18; // **~~** //
    uint256 public numReservationsLeft = 12345; // **~~** //
