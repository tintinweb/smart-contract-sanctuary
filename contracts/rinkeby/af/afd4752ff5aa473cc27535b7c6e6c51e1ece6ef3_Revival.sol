...
contract Revival is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private outerChestWear = [
        unicode"ぉe l e c t r o n i c",
        unicode"おa e s t h e t i c",
        unicode"かw a v e",
        unicode"がw a t e r",
        unicode"きf i r e"
    ];
    ...
    string[] private footWear = [
        unicode"Astra Model 900",
        unicode"Bayard 1908",
        unicode"Beretta 93R",
        unicode"ČZ vz. 45",
        unicode"Mannlicher 99"
    ];
    ...
    string[] private prefixes = [
        ...
        unicode"る",
        unicode"れ",
        unicode"a r t i f i c i a l  i n t e l l i g e n c e"
    ];
    
    string[] private namePrefixes = [
        "Neuromancer", "Cyborg", "Console", "Cowboy"  
    ];
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: monospace; font-size: 14px; }</style><rect width="100%" height="100%" fill="#0A2C61" /><text x="10" y="20" class="base">';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Revival #', toString(tokenId), '", "description": "Revival is randomized cyberpunk aesthetics generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Revival in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function mint(uint256 tokenQuantity) external payable {
        require(totalSupply() + tokenQuantity <= 4444, "EXCEED MAX");
        require(tokenQuantity <= 20, "EXCEED MAX PER MINT");
        require(0.02 ether * tokenQuantity <= msg.value, "INSUFFICIENT_ETH");
    ...
    constructor() ERC721("Revival", "Revival") Ownable() {}
}
