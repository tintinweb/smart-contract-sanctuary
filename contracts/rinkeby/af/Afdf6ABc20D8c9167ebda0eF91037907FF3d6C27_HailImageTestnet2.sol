...
contract HailstoneTestnet2 is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function getJsonImage(uint _tokenId) internal pure returns (string memory) {
        return string(abi.encodePacked(',"image": "data:image/svg+xml;base64,', Base64.encode(bytes(HailImageTestnet2.createSvgImage(_tokenId))), '"'));
    }
