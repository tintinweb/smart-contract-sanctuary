...
contract StakedLandContract is ERC721Tradable {
  constructor(address _proxyRegistryAddress) ERC721Tradable("Staked Land", "STKL", _proxyRegistryAddress) public {  }

  function baseTokenURI() public view returns (string memory) {
    return "https://continentslootboxes.herokuapp.com/api/place/";
  }
