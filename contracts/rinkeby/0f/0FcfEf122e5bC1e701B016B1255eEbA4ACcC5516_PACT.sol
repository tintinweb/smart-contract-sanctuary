...
//    uint256 AmountLockedForBridge   = 25000000e18;
...
//
//    modifier onlyBridge() {
//        require(bridge() == _msgSender(), "PACT: caller is not the bridge");
//        _;
//    }
//
//    function transferBridge(address newBridge) public virtual onlyOwner {
...
//        require(AmountLockedForBridge > 0, "LockedForBridge account already setup");
//        AmountLockedForBridge = AmountLockedForBridge.sub(amount, "LockedForBridge not enough balance");
//
