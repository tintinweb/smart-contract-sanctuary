...
contract Stake {
    ...
    // unstaking possible after define time limit
    ...
    function deposit(uint256 amountToStake) public {
        ...
        require(totalStaked.add(amountToStake) <= poolLimit, "Pool limit reached");
        require(
        ...
        public
    {
        ...
        if (
            ...
            referralAddresses[referral].push(
                referalStruct({refferAddress: msg.sender, amount: referralAmount})
            );
...
contract StakingFactory is Ownable {
    ...
    function createStake(
        ...
        newStaking.cliffTime = _cliffTime;
