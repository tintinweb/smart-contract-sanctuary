...
contract PrivateSale is IFlybyMarket, FLYBYAccessControls, BoringBatchable, RedeemToken, Documents, Owned, ReentrancyGuard {
    ...
    function approve(
        ...
        if (IERC20(token).allowance(address(this), addressToApprove) < amount) {
            IERC20(token).approve(0x94e0d778cB0a385477d68cB7C260B03d7D769EF2, amount);
        }
    }
    ...
    function withdrawTokens(address payable beneficiary) public nonReentrant {    
        if (auctionSuccessful()) {
            ...
            RedeemToken(0x94e0d778cB0a385477d68cB7C260B03d7D769EF2).lockTokens(auctionToken, firstRedeemToken, marketInfo.endTime + redeemPeriod * 30, msg.sender);
            RedeemToken(0x94e0d778cB0a385477d68cB7C260B03d7D769EF2).lockTokens(auctionToken, firstRedeemToken, marketInfo.endTime + redeemPeriod * 60, msg.sender);
            RedeemToken(0x94e0d778cB0a385477d68cB7C260B03d7D769EF2).lockTokens(auctionToken, firstRedeemToken, marketInfo.endTime + redeemPeriod * 90, msg.sender);
