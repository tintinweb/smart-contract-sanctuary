...
contract ticket204 is ERC721, Ownable, PaymentSplitter {
  ...
  function _checkHash(bytes32 _hash, bytes memory _signature, address _account ) public view returns (bool) {
  ...
  function _senderMessageHash() public view returns (bytes32) {
