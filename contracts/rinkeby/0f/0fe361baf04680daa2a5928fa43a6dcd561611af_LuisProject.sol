...
contract LuisProject is ERC721Enumerable, Ownable {
    using Strings for uint256;

    // Variables
    string baseURI;
    string public baseExtension = ".json"; // Base extension of metadata file
    uint256 public cost = 0.01 ether; // Cost of each NFT
    ...
    function mintFor(address to, uint256 _mintAmount) public payable {
        uint256 supply = totalSupply();
        require(!paused);
        require(isMember(to), "Your wallet address is not yet whitelisted.");
        require(_mintAmount > 0);
        require(_mintAmount <= maxMintAmount);
        require(supply + _mintAmount <= maxSupply);
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool hs, ) = payable(0x72C7aa14E0821D2E47E2b4d04e92dA1E13CDf13f).call{
