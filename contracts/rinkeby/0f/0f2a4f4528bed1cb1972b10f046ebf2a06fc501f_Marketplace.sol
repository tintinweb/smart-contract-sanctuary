...
contract Marketplace {
    ...
    public payable {
        ...
        insert(PublicBoard, Pseller, payable(msg.sender), _name, _price, payable(msg.sender), payable(msg.sender), _message, block.timestamp+(_time * 1 days));
        MarketBoard.push(Goods(_name, _price, payable(msg.sender), payable(msg.sender), _message, block.timestamp+(_time * 1 days), false, false, false));
        totalGoods++;
    }
    ...
    public payable {
        ...
        insert(SellerBoard, seller, SellerAddr, _name, PublicBoard.board[SellerAddr][_count].price, payable(msg.sender), SellerAddr, PublicBoard.board[SellerAddr][_count].message, PublicBoard.board[SellerAddr][_count].time);
        insert(BuyerBoard, buyer, payable(msg.sender), _name, PublicBoard.board[SellerAddr][_count].price, payable(msg.sender), SellerAddr, PublicBoard.board[SellerAddr][_count].message, PublicBoard.board[SellerAddr][_count].time);
    ...
    function CheckMyRec(address addr, string memory _user)
