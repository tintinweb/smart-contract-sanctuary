...
contract YoutubeNFT is ERC1155PresetMinterPauser {
    ...
    function addGameID( string memory gameID, uint256 initialSupply ) external {
        require(hasRole(MINTER_ROLE, _msgSender()), "YoutubeNFT: must have minter role to mint");
        
        require(idmap[gameID] == 0, "YoutubeNFT: This gameID already exists");
