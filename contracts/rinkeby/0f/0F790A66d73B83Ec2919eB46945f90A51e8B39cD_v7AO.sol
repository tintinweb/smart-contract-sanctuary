...
contract v7AO is ERC721Enumerable, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/205/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/205/contract-uri";
	...
	uint256 public presaleMaxSupply = 1;
	uint256 public presaleMaxPerMint = 1;
	uint256 public presalePricePerToken = 1000000000000000000;
  uint256 public presaleEndDate = 1639757176;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("v7AO", "v7AO") {
