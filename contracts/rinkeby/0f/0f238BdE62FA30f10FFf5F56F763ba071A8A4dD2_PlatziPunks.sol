...
contract PlatziPunksDNA {
    ...
    function getClotheType(uint256 _dna)
        ...
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 4);
    ...
    function getEyeType(uint256 _dna)
        ...
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 6);
    ...
    function getEyebrowType(uint256 _dna)
        ...
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 8);
    ...
    function getFacialHairColor(uint256 _dna)
        ...
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 10);
    ...
    function getFacialHairType(uint256 _dna)
        ...
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 12);
    ...
    function getHairColor(uint256 _dna)
        ...
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 14);
        return _hairColor[dnaSection % _hairColor.length];
    }

    function getHatColor(uint256 _dna)
        public
        view
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 16);
    ...
    function getGraphicType(uint256 _dna)
        ...
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 18);
        return _graphicType[dnaSection % _graphicType.length];
    }

    function getMouthType(uint256 _dna)
        public
        view
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 20);
        return _mouthType[dnaSection % _mouthType.length];
    }

    function getSkinColor(uint256 _dna)
        public
        view
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 22);
        return _skinColor[dnaSection % _skinColor.length];
    }

    function getTopType(uint256 _dna)
        public
        view
        returns (string memory)
    {
        uint8 dnaSection = getDNASection(_dna, 24);
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
    ...
    // First parameter is: token name
    // Second parameter: symbol to be used when listed
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory){
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "PlatziPunks #',
                tokenId.toString(),
                '", "description": "PlatziPunks are randomized Avatars stored on chain to teach DApp development on Platzi", "image": "',
                image,
                '"}'
            )
        );
