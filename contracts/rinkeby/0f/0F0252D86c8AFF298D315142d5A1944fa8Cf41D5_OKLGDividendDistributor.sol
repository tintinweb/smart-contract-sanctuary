...
contract OKLGDividendDistributor is OKLGWithdrawable {
  ...
  constructor(
    ...
    totalShares = IERC20(shareToken).totalSupply();
  ...
  function distributeDividend(
    ...
    uint256 shareholderAmount = IERC20(shareToken).balanceOf(shareholder);
...
*/
  ...
  function setShareToken(address _token) external onlyOwner {
    shareToken = _token;
    totalShares = IERC20(shareToken).totalSupply();
  }
