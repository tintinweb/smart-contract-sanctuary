...
contract MyCollectible is ERC721Enumerable, Ownable, PaymentSplitter, ReentrancyGuard {
  ...
  constructor() ERC721("Bored Bunny", "BUNNY") PaymentSplitter(_team, _teamShares) ReentrancyGuard() {}
}
