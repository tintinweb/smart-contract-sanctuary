...
contract RoyalSocietyChips is ERC721Enumerable, Ownable {
    ...
    uint256 private _dropTime = 1630702800; // Date and time (GMT): Sunday, September 3, 2021 5:00:00 PM EST (https://www.epochconverter.com/)
    uint256 private _dropDuration = 604800; // 604800 is one week.
    uint256 private _maxSupply = 10000; // Used for a few checks
    uint256 private _maxPerTx = 41; // Prevents gas limit errors. One higher than necessary for gt/lt checks.
