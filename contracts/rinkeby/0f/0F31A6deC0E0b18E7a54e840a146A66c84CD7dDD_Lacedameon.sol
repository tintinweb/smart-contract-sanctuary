    ...
    */
    function mint(uint256 _count) public payable {
        ...
        if (privateSaleIsActive) {
            ...
            require(_count <= maxToMint, "Exceeds maximum number of mintable tokens at a time");
        }
    ...
    function freeMint(uint _count) public {
        ...
        winnerlist[msg.sender].claimAmount = winnerlist[msg.sender].claimAmount - _count;
