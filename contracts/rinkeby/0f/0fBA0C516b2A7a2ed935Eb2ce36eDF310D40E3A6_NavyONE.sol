...
contract fundTokenized  {
    ...
    string public symbol = 'N1Ta1';
    string public  name = 'Navy1Tokena1';
...
contract NavyONE is Ownable, fundTokenized{
    ...
    function getTotalValue () public view returns(uint256)  {
        ...
        for (uint256 i = 0; i < valuedTokens.length; i ++){
            ...
            if (valuedTokens[i].decimals < 100){
              totalValue = totalValue.add(tokenValue.div(10**uint256(valuedTokens[i].decimals)));
            }else{
              totalValue = totalValue.add(tokenValue.mul(10**(uint256(valuedTokens[i].decimals)-100)));
            }
    ...
    function calInvestValue (uint256 tokenIndex, uint256 amount) public view returns(uint256)  { //todo: to internal in mainnet
        ...
        if (valuedTokens[tokenIndex].decimals < 100){
          tokenValue = tokenValue.div(10**uint256(valuedTokens[tokenIndex].decimals));
        }else{
          tokenValue = tokenValue.mul(10**(uint256(valuedTokens[tokenIndex].decimals)-100));
        }
        return tokenValue;
    }
