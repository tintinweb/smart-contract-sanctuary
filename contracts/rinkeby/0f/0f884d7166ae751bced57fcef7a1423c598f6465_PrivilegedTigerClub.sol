...
contract PrivilegedTigerClub is ERC721Enumerable, Ownable {
    ...
    function setWhiteList(address[] calldata whiteListAddress, bool bEnable) external onlyOwner {
    ...
    function airdrop(address[] calldata airdropAddress, uint256 numberOfTokens) external onlyOwner {
