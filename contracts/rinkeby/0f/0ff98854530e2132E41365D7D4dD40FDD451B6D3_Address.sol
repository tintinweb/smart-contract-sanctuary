...
// File: contracts/lower gas test.sol
...
contract lower_gas_test is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("lower gas test", "lgt") {
    setHiddenMetadataUri("ipfs://QmX8uTeuWtGH3d9jv54DPDj8kkZUUQmMQVKesK8vG3ZKc9/1.json");
  }
