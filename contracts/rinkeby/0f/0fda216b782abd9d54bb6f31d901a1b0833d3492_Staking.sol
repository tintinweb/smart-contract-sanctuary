...
contract Staking {
  ...
  uint256 constant public REWARD_PERCENT_SILVER    = 10;            // variable constant to managr reward percentage for silver
  uint256 constant public REWARD_PERCENT_GOLD      = 20;            // variable constant to managr reward percentage for gold
  uint256 constant public REWARD_PERCENT_PLATINUM  = 30;            // variable constant to managr reward percentage for platinum
  uint256 constant public PENALTY_PERCENT_SILVER   = 3;             // variable constant to managr penalty percentage for silver
  uint256 constant public PENALTY_PERCENT_GOLD     = 6;             // variable constant to managr penalty percentage for silver
  uint256 constant public PENALTY_PERCENT_PLATINUM = 9;             // variable constant to managr penalty percentage for silver
