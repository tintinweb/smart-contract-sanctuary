...
contract PuzzledNew is ERC721Tradable {
    ...
    function mintWhitelist(uint256 _count, uint256 _tokenId, uint256 _timestamp, bytes memory _signature) public payable {

        uint256 total = totalSupply(); //CHANGE TO TOTAL WHITELIST
        ...
        address signerOwner = signatureWallet(wallet,_tokenId,_signature);
