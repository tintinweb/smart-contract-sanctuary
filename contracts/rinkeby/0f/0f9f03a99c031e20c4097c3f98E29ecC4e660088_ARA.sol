...
contract ARA is ERC721Tradable {
    ...
    constructor(
        ...
        emit Transfer(address(0), 0x7401dEf278c1E40C2220f302d2E260da30Be4180, 1);
        emit Transfer(address(0), 0x7401dEf278c1E40C2220f302d2E260da30Be4180, 2);
        emit Transfer(address(0), 0x7401dEf278c1E40C2220f302d2E260da30Be4180, 42);
    }
    ...
    /// @notice Change paradigm
    function paradigm_setter(uint256 _price) external onlyOwner {
        price = _price;
    }
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // TODO Modify
    uint256 private originalSupply = 100;
    ...
    function balanceOf(address owner) public view virtual override returns (uint256) {
        ...
        return _balances[owner] + 2 * original.balanceOf(owner) - _transferredBalances[owner];
    }
    ...
    function _transfer(
        ...
        if (_owners[tokenId] == address(0) && tokenId < 2 * originalSupply) {
