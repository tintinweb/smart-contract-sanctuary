...
contract ElvesNorth is ERC721, Ownable {
    uint256 public constant MAX_ELVES = 10_000;
    ...
    function setElvesURI(string memory _uri) external onlyOwner {
        require(!lock, "already locked");
        elvesURI = _uri;
    }
