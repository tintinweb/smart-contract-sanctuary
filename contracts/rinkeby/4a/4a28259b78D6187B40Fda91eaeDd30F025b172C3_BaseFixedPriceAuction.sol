...
contract BaseFixedPriceAuction is ERC721Sequential, ReentrancyGuard, Ownable {
    ...
    mapping(address => uint8) private _publicListClaimed;
    ...
    uint8 public whitelistMaxMint;
    uint8 public publicListMaxMint;
    ...
    constructor(
        ...
        uint8 _whitelistMaxMint, 
        uint8 _publicListMaxMint,
    ...
    function setWhitelistMaxMint(uint8 _whitelistMaxMint) external onlyOwner {
        whitelistMaxMint = _whitelistMaxMint;
    }

    function setPublicListMaxMint(uint8 _publicListMaxMint) external onlyOwner {
        publicListMaxMint = _publicListMaxMint;
    }

    function mintPublic(uint8 numberOfTokens) external payable nonReentrant {
    ...
    function mintWhitelist(bytes32 hash, bytes memory signature, uint8 numberOfTokens) external payable {
    ...
    function _nonReservedMintHelper(uint8 numberOfTokens) internal {
