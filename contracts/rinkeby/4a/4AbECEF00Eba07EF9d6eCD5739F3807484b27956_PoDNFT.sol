...
contract PoDNFT is ERC721, ERC721Enumerable, Ownable {
     ...
     * @dev Mints a new PoD
     */
    function mint(DonationInfo calldata params) external onlyOwner returns (uint256) {
    ...
    /**
     * @dev Get donation info by tokenId
     */
    function getDonationInfo(uint256 _tokenId) external view returns (DonationInfo memory) {
        return _donationInfo[_tokenId];
    }

    /**
     * @dev Burn a tokenId and delete the donation info
     */
