...
contract TestLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TestLowGas", "TLG") {
    setHiddenMetadataUri("ipfs://QmWa29eg4oxiHBAJGpiMUsaHas6KitgZT8FpvYUtMDHHmF/hidden.json");
  }
