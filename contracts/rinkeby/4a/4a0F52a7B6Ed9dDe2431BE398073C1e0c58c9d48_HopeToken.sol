...
contract HopeToken is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/73/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/73/contract-uri";
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("HopeToken", "HOPE") {
