 ...
 */
abstract contract ERC721Tradable is ERC721, DNA, ContextMixin, NativeMetaTransaction, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    ...
    function mintTo(address _to) public onlyOwner {
        ...
        _nextTokenId.increment();
        tokenDNA[currentTokenId] = deterministicPseudoRandomDNA(currentTokenId, _to);
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        ...
        string memory jsonURI1 = string(
            abi.encodePacked(
                '{"name" : "Princess # ',tokenId.toString(),'", "description" : "el mejor NFT que puedes tener es MyNFT" , "image" : "',image,'", "attributes" : [{"trait_type": "Accessorie Type", "value": "',getAccessoriesType(dna),'"}, {"trait_type": "Clothe Color", "value": "',getClotheColor(dna),'"}, {"trait_type": "Clothe Type", "value": "',getClotheType(dna),'"}, {"trait_type": "Eye Type", "value": "',getEyeType(dna),'"}, {"trait_type": "Eyebrow Type", "value": "',getEyeBrowType(dna),'"}, {"trait_type": "Facial Hair Color", "value": "',getFacialHairColor(dna),'"}, {"trait_type": "Facial Hair Type", "value": "',getFacialHairType(dna),'"}, {"trait_type": "Hair Color", "value": "',getHairColor(dna),'"}, {"trait_type": "Hat Color", "value": "',getHatColor(dna)
            )
        );
        string memory jsonURI2= string(
            abi.encodePacked(  
            '"}, {"trait_type": "Graphic Type", "value": "',getGraphicType(dna),'"}, {"trait_type": "Mouth Type", "value": "',getMouthType(dna),'"}, {"trait_type": "Skin Color", "value": "','1','"}, {"trait_type": "Top Type", "value": "','1',' "}]}'
        ));
...
// File contracts/UndercoverMonarchy.sol
 ...
 */
contract UndercoverMonarchy is ERC721Tradable {

    constructor()
        ERC721Tradable("Undercover Moranchy", "UCM")
    {}
...
contract PrincessFactory is FactoryERC721, Ownable {
    ...
    constructor() {
        proxyRegistryAddress = 0xF57B2c51dED3A29e6891aba85459d600256Cf317;
        nftAddress = 0x6A6b62146Dbd345061425098Ba412ec267751Bc4;
        fireTransferEvents(address(0), owner());
    }

    function name() override external pure returns (string memory) {
        return "Princess Factory!";
    }
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        UndercoverMonarchy princess = UndercoverMonarchy(nftAddress);
        if (_optionId == 0) {
            princess.mintTo(_toAddress);
        }
    }
    ...
    function canMint(uint256 _optionId) override public view returns (bool) {
        ...
        UndercoverMonarchy princess = UndercoverMonarchy(nftAddress);
        uint256 creatureSupply = princess.totalSupply();
