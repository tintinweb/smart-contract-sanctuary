...
contract MindBlown is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant maxPublicQty = 5;
    uint256 public constant pricePerToken = 0.075 ether;    
    ...
    function flipSaleState(uint8[] calldata listIds) external onlyOwner {
    ...
    function mintAllowList(uint8 numberOfTokens) external payable {
        ...
        require(_allowListPrice * numberOfTokens <= msg.value, "Ether value sent is not correct");
    ...
    function reserve(uint256 nftCount) public onlyOwner {
