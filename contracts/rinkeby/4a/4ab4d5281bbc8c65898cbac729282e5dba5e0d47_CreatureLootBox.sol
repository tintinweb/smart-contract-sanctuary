...
contract Creature is TradeableERC721Token {
  constructor() TradeableERC721Token("Creature", "OSC") public {  }
...
// File: contracts/CreatureLootBox.sol
...
contract CreatureLootBox is TradeableERC721Token {
    ...
    constructor(address _factoryAddress) TradeableERC721Token("CreatureLootBox", "PUFFBOX") public {
