...
contract ThisIsATest is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    
    uint256 private _maxSupply = 404;
    uint256 internal _commission = 404; // parts per 10,000

    constructor() ERC721("ThisIsATest", "TIAT") {}
