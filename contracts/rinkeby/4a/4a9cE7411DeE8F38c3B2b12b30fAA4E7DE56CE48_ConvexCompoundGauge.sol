...
interface ICompoundBooster {
    function liquidate(bytes16 _lendingId) external payable returns (address);
...
contract ConvexCompoundGauge {
    ...
    mapping(bytes16 => BorrowInfo) public borrowInfos;
    mapping(bytes16 => Statistic) public myStatistics;
