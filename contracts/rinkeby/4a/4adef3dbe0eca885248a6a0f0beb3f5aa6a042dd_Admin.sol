...
contract NFT is ERC721URIStorage {
    ...
    function Add_1(
        string memory _name,
        address _Address,
        uint _National_id_Number,
        string memory  _DOB,
        address _Address_history,
        uint _phone_number,
        ...
        {
           lost_wallet_owner_info.push(Lost_wallet_owner_info({
               name:_name,
               Address:_Address,
  ...
  struct Lost_wallet_info
      ...
      function Add_2(
       ...
       {
           lost_wallet_info.push(Lost_wallet_info({
  ...
  struct Lost_wallet_Due_Diligence
   ...
   function Add_3(
       ...
       {
           lost_wallet_Due_Diligence.push(Lost_wallet_Due_Diligence({
   ...
   struct Lost_Wallet_Intermediary
    ...
    function Add_4(
        ...
        {
            lost_Wallet_Intermediary.push(Lost_Wallet_Intermediary({
                name:_name,
                Industry:_Industry,
 ...
 struct Lost_Wallet_Chrysalis_token_Owner_Information
     ...
     Lost_Wallet_Chrysalis_token_Owner_Information[] public lost_Wallet_Chrysalis_token_Owner_Information;
     ...
     function Add_5(
         ...
         lost_Wallet_Chrysalis_token_Owner_Information.push(Lost_Wallet_Chrysalis_token_Owner_Information({
             Name:_Name,
             Address:_Address,
             National_ID_number:_National_ID_number,
  ...
  struct Lost_Wallet_Chrysalis_Token
    ...
    function  Add_6(
     ...
     {
         lost_Wallet_Chrysalis_Token.push(Lost_Wallet_Chrysalis_Token({
     ...
     struct Insured_Wallet_Wallet_Owner_Information
     {
        ...
        uint IP_address;
         ...
         Insured_Wallet_Wallet_Owner_Information[] public insured_Wallet_Wallet_Owner_Information;
    ...
    function Add_7(
        ...
        {
            insured_Wallet_Wallet_Owner_Information.push(Insured_Wallet_Wallet_Owner_Information({
                name:_name,
               Address:_Address,
               National_id_Number:_National_id_Number,
                DOB:_DOB,
    ...
    Insured_Wallet_Wallet_Information[] public insured_Wallet_Wallet_Information;
    ...
    function Add_8(
     ...
     {
         insured_Wallet_Wallet_Information.push(Insured_Wallet_Wallet_Information({
           Wallet_source:_Wallet_source,
           Public_key:_Public_key
  ...
  struct Insured_Wallet_Due_Diligence
    ...
    {
         insured_Wallet_Due_Diligence.push(Insured_Wallet_Due_Diligence({
    ...
    function Add_10(
         ...
         {
             insured_Wallet_Intermediary.push(Insured_Wallet_Intermediary({
                name:_name,
                Industry:_Industry,
                Geolocation:_Geolocation
...
struct Insured_Wallet_Chrysalis_token_Owner_Information
    ...
    Insured_Wallet_Chrysalis_token_Owner_Information[] public insured_Wallet_Chrysalis_token_Owner_Information;
    ...
    ) public 
    {
        ...
        insured_Wallet_Chrysalis_token_Owner_Information.push(Insured_Wallet_Chrysalis_token_Owner_Information({
            name:_name,
            Address:_Address,
            National_id_Number:_National_id_Number,
            DOB:_DOB,
 ...
 function  Add_12(
     ...
     {
         insured_Wallet_Chrysalis_token.push(Insured_Wallet_Chrysalis_token({
             Tradeable:_Tradeable,
             Type:_Type,
             Rating:_Rating
...
contract Admin is OwnableUpgradeable , AccessControlUpgradeable {
    ...
    function CreatNewNft (
        address user,
        string memory URI
       
    ) external {
        require(hasRole(SUB_ADMIN_ROLE, msg.sender) || hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "!! Caller does not have right roles !!");
        NFT A = new NFT (
            owner(),
            user,
            URI
    ...
    function setNewAdminRole(address subAdmin) external onlyRole(DEFAULT_ADMIN_ROLE) {
