    ...
    IERC2309
{
    ...
    */
    ...
    function mint(address to, uint256 tokenId) public onlyOwner {
     //   require(ownerOf(tokenId) != BURN_ADDRESS, "The token is already Burnt");
        require(
            to != address(0),
    ...
    function mintBulk(uint256 quantity) public onlyOwner {
        ...
        */
        _ownedTokensCount[owner()] = _ownedTokensCount[owner()].add(quantity);
    ...
    function _addTokenTo(address to, uint256 tokenId) internal {
        ...
        require(
            ownerOf(tokenId) == BURN_ADDRESS || ownerOf(tokenId) == owner(),
