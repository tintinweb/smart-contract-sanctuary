...
contract BchainTest is ERC721, Pausable, Ownable {
    ...
    constructor() ERC721("Bchain Test", "BCT") {
    }
    ...
    function mint(
        ...
        // Check this blockedId hasn't already registered this blockerId
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked(
            '{"name": "Blockedchain - @', blocker.handle , ' (#', uint2str(blocker.numBlocks) ,')", "description": "The minter of this token was confirmed to be blocked by ', blocker.name , ' (@', blocker.handle ,') on Twitter. \\n \\n[Block provenance]  \\nTime: ', timeString ,'  \\nBlocked Twitter ID: ', uint2str(t.blockeeId) ,'", "image": "', blocker.image ,'", "animation_url": "', blocker.asset ,'", "attributes": [{"trait_type": "Blocker","value": "@', blocker.handle , '"}]}'))));
