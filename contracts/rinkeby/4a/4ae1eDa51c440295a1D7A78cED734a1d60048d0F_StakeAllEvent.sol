...
contract StakeAllEvent {

    address public immutable stakeAllList;

    constructor (address _stakeAllList) public {
        stakeAllList = _stakeAllList;
    }
    ...
    function emitEvent(uint _connectorType, uint _connectorID, bytes32 _eventCode, bytes calldata _eventData) external {
        uint64 _ID = ListInterface(stakeAllList).accountID(msg.sender);
