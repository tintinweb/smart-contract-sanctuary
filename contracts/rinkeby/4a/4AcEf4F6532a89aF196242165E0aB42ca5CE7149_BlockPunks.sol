...
contract BlockPunks is ERC1155, AccessControl {
    ...
    uint public constant RESERVED_TOTAL_SUPPLY = 1032;
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");

    address constant _devAddress = 0x38c918Db9dfb6Cfc27F462ce1CD5C56072D0A4f1;
    address constant _ownerAddress = 0x70f66DA61B99F9a4004DEB32EfacCA3A2A629FA2;
    ...
    function mintReservedBatch(address[] memory receivers, uint[] memory tokenIds) public onlyAdmin {
    ...
    function toggleStartSale() public onlyAdmin {
