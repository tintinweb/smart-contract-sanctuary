...
contract TestNFT is ERC721Burnable, Ownable {
    ...
    IChangeName public changeName;

    // Public variables
    uint256 public reserved = 16;
    uint256 public woollyStartBlock;
    bool public preventGasWar;
    bool public paused = true;
    uint256 public constant MAX_WOOLLY_SUPPLY = 30;
    uint256 public price = 0.01 ether;
    uint256 public REVEAL_TIMESTAMP = block.timestamp + 5 minutes;
    // This is the provenance record of all Happy Woolly artwork in existence
    string public constant HAPPY_WOOLLY_PROVENANCE = "507cc002a86b412b31be5c3e1a5b9af8ee48dcf76eb59f9abcc42c10c932b0bf";
     ...
     */
    constructor (uint256 _block, string memory baseURI) ERC721("TestNFT", "TestNFT") {
    ...
    modifier isPreventGasWar(uint256 num) {
        require((preventGasWar && (block.timestamp.sub(coolDown[msg.sender]) >= 7 minutes)) || preventGasWar == false, "cooldown");
        require((preventGasWar && balanceOf(msg.sender).add(num) <= 7) || preventGasWar == false, "max 7");
        _;
    }
    ...
    */
    ...
    function communityReserve(address _whitelist) public {
        ...
        require(IERC721(_whitelist).balanceOf(msg.sender) > 0, "not qualified");
        require(!mintabled[msg.sender], "already minted");
    ...
    function tokenNameByIndex(uint256 index) public view returns (string memory) {
        return changeName.tokenNameByIndex(index);
    }
    ...
    function setChangeName(IChangeName _changeName) public onlyOwner {
