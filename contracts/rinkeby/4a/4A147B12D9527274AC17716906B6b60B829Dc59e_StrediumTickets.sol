...
/**
 * @title StrediumTickets
 * StrediumTickets - a contract for Stredium Accessory semi-fungible tokens. https://api.stredium.com/v1/accessory/{id}
 * bafybeib2lul4uxohlt4mm23npxgfqxiz5jdxb2steebqe3tqfswpuhb56q
 */
contract StrediumTickets is ERC1155Tradable {
    constructor(address _proxyRegistryAddress)
        ERC1155Tradable(
            "Stredium Tickets",
            "TICKETS",
            "https://ipfs.io/ipfs/QmWQjVfq8LVx6DdVvsxMnAtA7N9iG7HJYhKyKAtTDWRu2B/{id}.json",
            _proxyRegistryAddress
        ) {}

    function contractURI() public pure returns (string memory) {
        return "https://ipfs.io/ipfs/bafybeiftaanoukrp6aismxanbbiz2emaraozudmpdkhzttuseeh42w3pum?filename=metadata.json";
    }
}
