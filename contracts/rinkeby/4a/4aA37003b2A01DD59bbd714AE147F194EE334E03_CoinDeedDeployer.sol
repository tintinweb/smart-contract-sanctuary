...
contract CoinDeed is ICoinDeed, AccessControl, ReentrancyGuard {
    ...
    function buy() onlyInState(DeedState.READY) external override {
        ...
        if (pair.tokenB == address(0x00)) {
            uint256 totalTokenB = address(this).balance;
            ...
            uint256 totalTokenB = tokenB.balanceOf(address(this));
            // deposit the funds in lending pool
    ...
    function executeRiskMitigation() external override onlyInState(DeedState.OPEN) {
        ...
        uint256 sellAmount = CoinDeedUtils.checkRiskMitigationAndGetSellAmount(
