...
contract HoleyPeople is ERC721Enumerable, ReentrancyGuard, AccessControl, ERC2981ContractWideRoyalties {
    ...
    uint256 public tempSaleLimit = 500;

    uint256 public nHolderMintLimit = 3;
    uint256 public presaleListMintLimit = 3;
    ...
    constructor(
        ...
        _owner = msg.sender;
        _tokenIds.increment();
        metadataExtension = "arweave"; // TODO
    ...
    function devMint(address addr, uint256 amount) public onlyAdmin {
        require(_tokenIds.current() + amount <= MAX_SUPPLY, "HoleyPeople:MAX_SUPPLY_REACHED");
    ...
    function totalMintsAvailable() public view returns (uint256) {
        return tempSaleLimit - _tokenIds.current();
    }
    ...
    address private constant devAddress = 0xC7515bab24Ad88C27CB8eBFaf29d08a09194fb6a; // TODO: dev address
    address private constant artistAddress1 = 0xFe5F90756BF715B55774E18EC4EE26424e56c3B9; // TODO: 87.5%
    address private constant artistAddress2 = 0xB7D2EFED6D2B0F080e3B96D10f6259B8A958E88e; // TODO: 12.5%
    ...
    function unlock(bool _lockState) public {
        require(msg.sender == 0xC7515bab24Ad88C27CB8eBFaf29d08a09194fb6a, "HoleyPeople:NOT_DEV");
        devLock = _lockState;
    }
