...
contract CubePool is ReentrancyGuard {
     ...
     * @param spotSymbol Symbol of underlying token. Used to fetch price from
     * the oracle
     * @param inverse True means 3x short token. False means 3x long token.
     * @param depositWithdrawFee Fee charged on each deposit and withdrawal in
     * basis points
     * @param maxPoolShare Limit on the cube token's share of the pool in basis
     * points
