...
contract Creature is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress)
        ...
        contractUri = "https://creatures-api.opensea.io/contract/opensea-creatures";
        baseTokenUri = "https://creatures-api.opensea.io/api/creature/";
    }
...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    // miner->tokenid
    mapping(address => uint256) public minerAddr;
    ...
    function setMaxTokenId(uint256 _maxTokenId) external onlyOwner {
        require(_maxTokenId > super.totalSupply(), "maxTokenId can't be reduce");
    ...
    function mintTo(address _to) public {
        require(minerAddr[_to] == 0, "The user has already minted");
        uint256 newTokenId = _getNextTokenId();
        require(newTokenId <= maxTokenId, "nft number has reached up limit");
        _mint(_to, newTokenId);
        minerAddr[_to] = newTokenId;
        _incrementTokenId();
    }
