...
// File: contracts/utils/HasContractURI.sol
...
// File: contracts/utils/UintLibrary.sol
...
// File: contracts/utils/StringLibrary.sol
...
// File: contracts/utils/HasTokenURI.sol
...
// File: contracts/tokens/ERC721/ERC721Base.sol
...
contract MintableToken is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
    ...
    function mint(string memory tokenURI, uint _royality) public {
        ...
        _mint(msg.sender, this.totalSupply(), _royality);
        _setTokenURI(this.totalSupply()-1, tokenURI);
    }
...
contract CollectionFactory is Ownable{
    ...
    function createCollection(
        ...
        _userCollections[msg.sender].push(address(collection));
