...
contract DaddyLetter is ERC721Enumerable, Ownable {
  ...
  uint256 public maxClaimTx = 2;
  uint256 public maxCharLimit = 200;
  uint256 public maxSupply = 3000;
  uint256 public claimSupply = 2400;
  ...
  function claim(uint8 mintTotal) public {
        uint256 totalMinted = mintTotal + claimWalletLimits[msg.sender];

        require(claimWallets[msg.sender] == true, "You aren't whitelisted!");
        require(mintTotal >= 1 && mintTotal <= maxTx, "Mint Amount Incorrect");
        require(totalSupply() <= claimSupply, "Out of Stock!");
