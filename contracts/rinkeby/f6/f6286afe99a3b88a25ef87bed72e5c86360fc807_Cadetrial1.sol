...
contract Cadetrial1 is ERC1155 , Ownable {
    ...
    function mintUser () public payable {
           require (saleActivity == true , "There isn't a sale of trainer Nfts right now");
        if(requireWhitelist) {
    ...
    function setRequireWhitelist (bool whitelist) public onlyOwner {
        requireWhitelist = whitelist;
    }
