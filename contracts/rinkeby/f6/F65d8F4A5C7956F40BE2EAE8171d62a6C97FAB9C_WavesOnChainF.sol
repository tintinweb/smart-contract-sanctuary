...
contract WavesOnChainF is ERC721, Ownable {
    ...
    address public artistAddress = 0xA551B27aEB7E6cB6A8ee60A0774eEc8bA14a47d8;
    address public constant ADVISOR_ADDRESS = 0x1F792C9FCC5C97476357aeefe421005e5D7Db4f1;
    string public script;
    string public scriptType = "p5js";
    bool public saleStarted = false;
    mapping (uint256 => uint256) public creationDates;

    constructor() ERC721("WavesOnChainF","WOCF")  {
        setBaseURI("https://api.chromorphs.xyz/woc/json/");
        _safeMint(artistAddress, 0);
        creationDates[0] = block.number;
        _safeMint(developerAddress, 1);
        creationDates[1] = block.number;
        _safeMint(ADVISOR_ADDRESS, 2);
