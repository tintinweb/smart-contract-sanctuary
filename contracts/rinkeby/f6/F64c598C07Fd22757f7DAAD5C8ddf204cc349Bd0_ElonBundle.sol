...
contract ElonBundle {
  ...
  constructor(address _tokenAddr1,address _tokenAddr2,address _nftAddr1,uint256 _ethPrice) public {
   ...
   function buyBundle() public  payable{
      ...
      token1.contractMint(msg.sender,1); //Coin1
      token2.contractMint(msg.sender,1000000); // Coin2
