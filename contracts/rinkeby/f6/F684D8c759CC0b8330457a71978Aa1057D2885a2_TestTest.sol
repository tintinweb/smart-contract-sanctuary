...
contract TestTest is ERC1155, Ownable {
    string public constant name = "TestTest";
    string public constant symbol = "TestTest";
    ...
    uint256 public NFTPrice = 8000000000000000;  // 0.008 ETH
    uint256 public giveawayCount;
    uint256 public constant WHITELIST_MAX_MINT = 15;
    uint private devSup = 0.1 ether;
    address private devAddress = 0x82048089C65773c99f54972DEb945ead545d1C6b;
    ...
    */
    ...
    {
        if(_isActive==true){
            NFTPrice=8000000000000000;  // 0.008 ETH
        }else{
            NFTPrice=10000000000000000;  // 0.01 ETH
        }
