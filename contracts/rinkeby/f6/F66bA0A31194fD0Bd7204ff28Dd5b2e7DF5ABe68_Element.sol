...
contract Element is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory output) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Element Bag #', tokenId.toString(), '", "description": "The elements of the metaverse are element gears randomly generated and stored on the chain. Combine elements according to common sense or ignore common sense to form the props or even magic or skills you want.. Feel free to use any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
