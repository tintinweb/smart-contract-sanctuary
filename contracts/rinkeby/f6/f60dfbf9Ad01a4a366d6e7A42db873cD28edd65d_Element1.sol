...
contract Element1 is ERC721Enumerable, Ownable {
    ...
    uint256 public TOKEN_PRICE = 60000000000000000;
    uint public MAX_TOKENS_PER_ORDER = 20;
    uint256 public MAX_GAS_PRICE = 100000000000;
    bool public ON_SALE = false;                        

    constructor(address _proxyRegistryAddress) ERC721("Element1", "Element1") {
    ...
    function mintToken(uint numberOfTokens) external payable  {
        ...
        require(TOKEN_PRICE.mul(numberOfTokens) <= msg.value, 'Not enough Ethereum to buy that many');
