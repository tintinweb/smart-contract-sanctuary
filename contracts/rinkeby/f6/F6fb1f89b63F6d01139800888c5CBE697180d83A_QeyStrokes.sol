...
contract QeyStrokes is ERC1155Burnable, Ownable, ReentrancyGuard, Pausable, PaymentSplitter {
    ...
    string public tokenURI = "https://ipfs.io/ipfs/QmS7nC8KkLjotmfSk6naSDSxRhqbsbPQNJfa31zToxdrgz/";
    bytes32 public root;
    ...
    uint256[] _shares = [1750 ,4125, 4215];
    ...
    function contractURI() public view returns (string memory) {
        return "https://ipfs.io/ipfs/QmY2GVe5jjmVYSiRFU2REku5RzK4y1Y4239jEizEmwwTuT";
    }
