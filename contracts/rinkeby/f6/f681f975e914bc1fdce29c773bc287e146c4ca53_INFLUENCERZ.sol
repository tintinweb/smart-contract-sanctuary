...
contract INFLUENCERZ  is ERC721Enumerable, Ownable
{
    ...
    function mint(string memory _type) public payable   isSaleOpen  {
    ...
    function mintByAdmin()  public onlyOwner isSaleOpen  {
    ...
    function updateTotalSupply(uint256 totalsupply) public onlyOwner {
        _TOTALSUPPLY =  totalsupply;
        emit MAX_SUPPLY_UPDATED(_TOTALSUPPLY);
    }
    ...
    function auction() public onlyOwner returns(uint) {
        ...
        auctionId=auctionId++;
        require(auctionId <= _TOTALSUPPLY);
    ...
    function placeBid() public payable onlyNotOwner {
    ...
    function cancelAuction() public onlyOwner returns(bool success) {
