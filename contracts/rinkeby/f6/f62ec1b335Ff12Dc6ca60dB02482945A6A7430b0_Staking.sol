...
contract Staking is IERC721Receiver, Ownable, ReentrancyGuard  {
    ...
    event NftsRewarded(address receiver, uint256 amount);
    event NftLost(uint256 tokenId);
...
//                if (nftReceiverAddress != _msgSender()) {
//                    emit NftLost(tokenId);
//                }
...
//            emit NftsRewarded(_msgSender(), totalReservations);
    ...
    function setNftMintPrice(uint256 _nftMintPrice) external onlyOwner {
        nftMintPrice = _nftMintPrice;
    }
