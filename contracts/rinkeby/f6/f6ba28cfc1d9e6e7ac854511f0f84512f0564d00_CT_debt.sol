...
contract decoffer_V2{
    ...
    Credit_token CT = Credit_token(0xE1Aa89C39bC8fB30613D5ae30cD977b8eB88BE53);
    recommender RT = recommender(0xE124660c73b4e2A9585266CA12618a6700931F1E);
    ...
    function manage(address _user)public payable{
        ...
        if(RT.get_recommender(_user)== address(0x0)){
            RT.set_recommender(msg.sender,_user);
        }
        
        if(RT.get_recommender(_user) == msg.sender){
...
contract CT_debt{
    ...
    decoffer_V2 DT = decoffer_V2(0x1Bcd4DbBd484BA062f28791073138775C0a050Bc);
    Credit_token CT = Credit_token(0xE1Aa89C39bC8fB30613D5ae30cD977b8eB88BE53);
    recommender RT = recommender(0xE124660c73b4e2A9585266CA12618a6700931F1E);
    ...
    constructor()public {
        ...
        fee_info[1][2] = 150;        //1-2匯兌比 
        fee_info[1][4] = 500;       //1-4 Actual profit
        fee_info[1][5] = 300;       //1-5收益抽成
        fee_info[1][6] = 80;        //1-6推薦抽成  
        
        fee_info[3][1] = 240;        //credit
    ...
    function withdraw()public {
        ...
        DT.CT_swap_ETH(msg.sender, debt_info[msg.sender][4],principal,principal,0);
        reset(); 
    }
