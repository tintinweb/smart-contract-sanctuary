...
contract ERC20NFTToken is ERC20, Managed {
    ...
    constructor(
        ...
        bool infinity,
        uint256 supply
    ) ERC20(name, symbol) Managed(management) {
    ...
    function setOpenTransfer(bool isOpen) external requirePermission(ROLE_ADMIN) {
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "ERC20: you don't have permission to transfer"
        );
    }
}
