...
contract Song is ERC721, ERC721URIStorage, ReentrancyGuard {
  struct Track {
    string name;
    address minter;
    string audio_uri;
  ...
  modifier onlyTrackOwner(uint256 token_id) {
    require(ownerOf(token_id) == msg.sender);
    _;
  }
    ...
    returns (bool)
  {
    ...
    require(track.freeze_audio_uri == false, "Frozen");
