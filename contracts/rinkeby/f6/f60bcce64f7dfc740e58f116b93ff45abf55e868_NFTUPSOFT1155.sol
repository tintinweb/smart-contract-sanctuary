...
contract NFTUPSOFT1155 is Initializable,ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable {
   event Approve(
    ...
    function initialize() public initializer {
        ERC1155Upgradeable.__ERC1155_init("", "NFTUPSOFT", "NFTUPSOFT");
        __Ownable_init();
        _tid = 1;
