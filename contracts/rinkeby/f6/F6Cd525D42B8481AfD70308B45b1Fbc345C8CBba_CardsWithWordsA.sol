...
contract CardsWithWordsA is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    Card memory newCard = Card("I wish you a merry Christmas and a happy, healthy & a peaceful year, Thanks for being a friend, AFAC");
