...
import "./ERC2981.sol";
import "./QuantumArtSeeder.sol";
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/utils/structs/BitMaps.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract QuantumArt is ERC2981, IQuantumArt, OSContractURI, Ownable, Manageable, ERC721Enumerable, QuantumArtSeeder {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        //shuffle metadata
        uint256 shuffledVTI = (virtualTokenId + dropIdToSeed[dropId]) % _drops[dropId].max;
...
contract QuantumArtSeeder is Manageable, VRFConsumerBase {
    
    mapping (uint256 => uint256) public dropIdToSeed;
    ...
    function setSeed(uint256 dropId, uint256 seed) onlyRole(MANAGER_ROLE) public {
        dropIdToSeed[dropId] = seed;
    }

    //use if we want to skip some drops for example
    function setCounter(uint256 counter) onlyRole(MANAGER_ROLE) public {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        dropIdToSeed[_seederDropIdCounter++] = randomness;
    }
