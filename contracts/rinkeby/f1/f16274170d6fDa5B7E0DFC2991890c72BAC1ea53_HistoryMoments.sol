...
contract HistoryMoments is ERC721, Ownable {
    ...
    uint public maxFreeMint = 4;
    bool public isSalesActive = false;
    
    mapping(address => uint) public addressToFreeMinted;

    constructor() ERC721("HistoryMoments", "HM") {
        _contractUri = "ipfs://QJhJhJhJhJhhHhh";
    }
    ...
    function mint(uint quantity) external payable {
        require(isSalesActive, "sale is not active");
        require(quantity <= 40, "max mints per transaction exceeded");
