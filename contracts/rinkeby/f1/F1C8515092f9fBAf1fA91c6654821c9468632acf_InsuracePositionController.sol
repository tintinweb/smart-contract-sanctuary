...
contract InsuracePositionController is AbstractController {
    ...
    */
    ...
    function netWorth() external view override returns (uint256) {
        ...
        _rewards = _rewards * 1000000000000000000;
        
        // returns currently staked amopunt in base asset 
        uint256 totalStakedinBaseToken = _priceFeed.howManyTokensAinB(_stakingAsset, address(base), _currentlyAtStake(_stakingAsset));

        // returns INSUR rewards in base asset
        uint256 rewardsinBaseToken = _priceFeed.howManyTokensAinB(_insurToken, address(base), _rewards);
