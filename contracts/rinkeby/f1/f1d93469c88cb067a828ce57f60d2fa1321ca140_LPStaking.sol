...
contract LPStaking is Ownable {
    ...
    // Constructor will set the address of BNFY/BNB LP token and address of BNFY/BNB LP token staking NFT
    ...
    // Get total rewards for all of user's BNFY/BNB LP nfts
    ...
    // Function that updates BNFY/BNB LP pool
    ...
    // Function that lets user stake BNFY/BNB LP
    ...
    // Function that will unstake every user's BNFY/BNB LP stake NFT for user
