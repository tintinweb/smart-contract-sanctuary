...
contract Serengeti is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accSimbaPerShare;   // Accumulated Simba per share.
    ...
    // Update the given pool's Simba allocation point and deposit fee. Subject to Lion DAO approval.
    ...
    function updateDev(address _dev) external {
        require(msg.sender == dev, "no permission");
        dev = _dev;
    }

    //Update Simba Reward Emissions. Emission schedule outlined in docs and subject to Lion DAO approval.  
    ...
    function updatePool(uint256 _pid) public {
        ...
        simba.transfer(dev, simbaReward.div(50));   // 2% to the dev team
        simba.transfer(lionBank,simbaReward.div(20)); //5% to the Lion Bank
