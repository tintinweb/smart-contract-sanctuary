...
contract Bornless is ERC721Enumerable, Ownable {
    ...
    function mint(uint _mintAmount) public payable {
        ...
        require(!privateSale, "Minting is in pre-sale mode");
        mintX(_mintAmount);
    }
    ...
    function privateSaleMint(uint _mintAmount, bytes memory signature) public payable {
        ...
        //uint8 group = recoverGroup(signature);
        uint8 group = 0;
...
//            }
    ...
    function configure(bool _paused, bool _privateSale, uint256 _maxMintAmount,
