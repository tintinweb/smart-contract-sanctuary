...
contract UnifarmV9 is Admin {
  ...
  constructor(address trustForwarder_) Admin(_msgSender()) {
    poolStartTime = block.timestamp;
    trustedForwarder = trustForwarder_;
  }
  ...
  /**
   * @notice setter of trustForwarder which can be called by owner.
   */
  function setTrustForwarder(address newTrustedForwarder_) external onlyOwner {
    trustedForwarder = newTrustedForwarder_;
  }
