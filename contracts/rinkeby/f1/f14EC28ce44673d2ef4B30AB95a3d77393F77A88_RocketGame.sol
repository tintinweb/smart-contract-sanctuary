...
contract RocketGame is ERC721Enumerable, Ownable {
    ...
    uint256 public constant endGameTimerPeriod = 300; //72 hours 60*60*72
    uint256 public triggerEndGameTimestamp;
    

    uint256 constant characters = 2000;
    uint256 constant preSaleCharacters = 1000;
    uint256 constant rocketParts = 6000;
    uint256 constant characterPrice = 0.0001 ether;
    uint256 constant rocketPartPrice = 0.0001 ether;
    ...
    constructor() ERC721("RocketGame", "RKG") {
    ...
    function endGame(bool startTimer) public onlyOwner {
        if(startTimer) {
            triggerEndGameTimestamp = block.timestamp;
        } else {
            require(block.timestamp >= triggerEndGameTimestamp + endGameTimerPeriod , "It is not ready yet");
            hasGameEnded = true;
