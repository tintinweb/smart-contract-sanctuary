...
contract BridgeDev is AccessControl, Pausable, ReentrancyGuard {
  ...
  event TokenDeposited(address indexed ethToken, address indexed ektaToken, uint256 amount, address user);
  ...
  function deposit(address _ethToken, uint256 _amount) external nonReentrant whenNotPaused returns(bool) {
    ...
    emit TokenDeposited(_ethToken, ektaToken, _amount, msg.sender);
    return true;
  }
