...
contract MyContract is ERC20Pausable {
    ...
    modifier onlyFactory(){
        require(msg.sender==factory,"not allowed, only Factory, msg no.100");
        _;
    }
    modifier onlyOperator(){
        require(msg.sender == _operator,"not allowed, only operator, msg no.101");
        _;
    }
    modifier onlyPauser(){
        require(msg.sender == _pauser,"not allowed, only pauser, msg no. 102");
        _;
    }
