...
contract CHECK2 is IERC20, Ownable
{
    ...
    mapping (address => bool) private _NoMBall;
    ...
    //Token Info
    string private constant _name = 'funz';
    ...
    //Divider for the Minimal MaxBalance based on circulating Supply (1.0% during start, will be switched to 2.5% once normal tax level is reached)
    ...
    address public constant TeamWallet=0xEc64874749e45d03C7Cfbd6D3971efBE549FdA98;
    ...
    //address private constant UniswapRouter=0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    //TODO: Change to Mainnet
    //address tokenToClaim=0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;// WETH
    //Testnet WETH
    address tokenToClaim=0xc778417E063141139Fce010982780140Aa0cD5Ab;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            //As soon a holder sells, MBall function is gone and can never be reached again
            _NoMBall[sender]=true;
            tax=_sellTax;
    ...
    function TeamSetMBall(uint8 fee, bool feeOn) public onlyTeam{
        require(fee<=50,"Mball function Fee is capped to 50%");
        noMBallFeeOn=feeOn;
        noMBallFeePercent=fee;
    }
    uint8 public noMBallFeePercent=50;
    bool public noMBallFeeOn=true;
    ...
    function claimToken(address addr, address token, uint256 payableAmount) private{
        ...
        //If you don't have Mball function you are redistributing a part of your reward
        //Does not affect Compound
        if(noMBallFeeOn&&_NoMBall[addr]&&token!=address(this)){
            uint256 noMBallFee=amount*noMBallFeePercent/100;
            amount=amount-noMBallFee;
            _distributeStake(noMBallFee,false);
        }
        ...
        path[1] = address(0xD92E713d051C37EbB2561803a3b5FBAbc4962431);
        path[2] = token;
    ...
    function _swapContractToken(uint16 permilleOfuniswap,bool ignoreLimits) private lockTheSwap{
        ...
        //swaps marketingToken and the liquidity token half for ETH
    ...
    function hasMBall(address AddressToCheck) public view returns(bool){
        return !_NoMBall[AddressToCheck];
    }
    ...
    function TeamSetMBallTaxFree(bool taxFree) public onlyTeam{
    ...
    function getDividentsOf(address addr) public view returns (uint256){
        ...
        if(noMBallFeeOn&&_NoMBall[addr])
            amount-=amount*noMBallFeePercent/100;
        return amount;
    }
