...
contract Highflyers is ERC721 {
    ...
    constructor() ERC721("Highflyers", "DHF420") {
        ...
        _safeMintWithChecks(_ownerAddress, 3);
    ...
    function _safeMintWithChecks(address mintAddress, uint256 numberOfTokensToMint) internal {
        ...
        require(currentNumberOfTokens + numberOfTokensToMint <= MAX_TOKENS, "Yo, can't mint more than is available");
        require(numberOfTokensToMint <= MAX_MINTABLE_AT_ONCE, "Yo, can't mint that many at once");

        // we want to index tokens from 1:n instead of 0:(n-1)
        uint256 nextTokenID = currentNumberOfTokens + 1;
