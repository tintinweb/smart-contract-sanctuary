...
contract PolygonNFTv1 is NFTv1, ContextMixin, NativeMetaTransaction {
  constructor(string memory name_, string memory symbol_) NFTv1(name_, symbol_) {
  }

  function setDomainSeperator(string memory name) external onlyOwner {
...
contract FactoryV1 {
  ...
  constructor() {
    owner = msg.sender;
    proxyRegistry = ProxyRegistry(0xF57B2c51dED3A29e6891aba85459d600256Cf317);
    nft = NFTv1(address(new ProxyV1("Rainy Dolls", "DOLL", 0x6EEe7CA9D7C541081AC35F8D995698F9a51Ec89E)));
    address[] memory b = new address[](1);
    uint[] memory r = new uint[](1);
    b[0] = 0x46f1A2e739e374cF98bFbbBdA3e3d23A58933501;
    r[0] = 1000;
    nft.init(10, 10, 1 ether, b, r);
  }
  ...
  function canMint(uint256 _optionId) external view returns (bool) {
    _optionId;
    return nft.maxSupply() > nft.tokenIds();
  }

  function tokenURI(uint256 _optionId) external pure returns (string memory) {
    _optionId;
    return "https://sunnydolls.dbzapi.com/polygon/metadata/1";
  }
