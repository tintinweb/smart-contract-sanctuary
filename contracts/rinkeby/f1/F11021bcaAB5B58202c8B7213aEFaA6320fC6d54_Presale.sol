...
contract Presale is ERC721Enumerable, Ownable {
  constructor() ERC721("WSB Presale", "WSBP") {}
  ...
  address payable private ownerA = payable(0x820fA3e8EF65C679dCa0713A2938a309F3C01298);//0xB240D3aAD9093a08B62ce96343d8A47e22266AdD);
  address payable private ownerB = payable(0x0506638518678Cba66221650253712A233Ab1a31);//0x75dF311CE8E000CaDD8E4382B42483530bCC6355);
  ...
  function withdraw() public onlyOwner {
    uint balanceA = address(this).balance.mul(55).div(10000);
    uint balanceB = address(this).balance.sub(balanceA);
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    return "ipfs://QmZNJSk9WFVk7BLUX6pqkVbmZuqYegCXY4QYgZADQF22pM";
  }
}
