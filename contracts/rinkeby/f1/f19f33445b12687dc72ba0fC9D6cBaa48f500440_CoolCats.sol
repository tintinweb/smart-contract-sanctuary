...
contract CoolCats is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x09D6A2224C62EC977Bc29E438C3CF0DF16d4775a;
    address t2 = 0x09D6A2224C62EC977Bc29E438C3CF0DF16d4775a;

    // Cool Cats are so cool they dont need a lots of complicated code :)
    // 9999 cats in total, cos cats have 9 lives
    constructor(string memory baseURI) ERC721("Cool Walpers", "COOL")  {
        setBaseURI(baseURI);

        // team gets the first 2 walper
        _safeMint( t1, 0);
        _safeMint( t2, 1);
    }
    ...
    function adopt(uint256 num) public payable {
        ...
        require( supply + num < _maxsupply - _reserved, "Exceeds maximum Cats supply" );
