...
/**
 * @dev Provides information about the current execution ContextNoUpgrade, including the
 ...
 */
abstract contract ContextNoUpgrade {
 ...
 */
abstract contract PausableNoUpgrade is ContextNoUpgrade {
    /**
 ...
 * the owner.
 */
abstract contract OwnableNoUpgrade is PausableNoUpgrade {
...
/**
    ALL DEPENDENCY MODULES AND SUBMODULES RALATED TO THIS CONTRACT ARE IMPORTED AND INSPIRED BY THE 
            OPENZEPPELIN CONTRACTS. WE SENT OUR REGARDS AD KUDOS TO THESE GREAT GUYS.
                THIS CONTRACT IS UPGRADEABLE AND WE HAVE STRICTLY FOLLOW OZ's 
 ...
 */
abstract contract ERC20NoUpg is IERC20Metadata, ContextNoUpgrade {
    ...
    */
    ...
    function _toogleFanTip(uint8 cmd) internal virtual {
...
contract QfourNoUpg is Once, OwnableNoUpgrade, ERC20Votes {
    ...
    */
     ...
     */
    function toogleFanTip(uint8 cmd) public onlyOwner returns(bool) {
        _toogleFanTip(cmd);
        return true;
    }
