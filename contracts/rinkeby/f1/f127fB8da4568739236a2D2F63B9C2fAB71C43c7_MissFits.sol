...
contract MissFits is ERC721Enumerable, Ownable {
    ...
    require(supply + _Amount <= MaxCollection, "Sold Out");
      if (msg.sender != owner()) {
        if (isPresalesMode == true) {
            ...
            require(msg.value >= Price * _Amount, "PS: Balance Insufficient");
        }
          else {
  ...
  function withdraw() public payable onlyOwner {
    (bool mf, ) = payable(owner()).call{value: address(this).balance}("");
    require(mf);
  }
}