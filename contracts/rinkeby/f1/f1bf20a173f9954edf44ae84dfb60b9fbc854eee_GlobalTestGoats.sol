...
contract GlobalTestGoats is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_MintedForPromotion = 2;
    ...
    uint256 public constant MAX_PreSaleMintedGoats = 5;
...
//Index of Golden Goats
    ...
    uint[] GoldenGoats = [ 4,5,8,10,16,20,23,11,15,19];
    ...
    constructor() ERC721("GlobalTestGoats", "GOAT") {
    ...
    function mint(uint16 numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) > MAX_PreSaleMintedGoats, "Try pre-sale mint");
        require(numberOfTokens <= MAX_PURCHASE, "Can only mint max 20 tokens per transaction");
