...
contract Donkeyz is ERC721, VRFConsumerBase, Ownable{
    ...
    mapping(bytes32 => string) requestToDonkeyName;
    mapping(bytes32 => address) requestToSender;
    mapping(bytes32 => uint256) requestToTokenId;
    event battleDonkey(bytes32 indexed requestId);
    ...
    function createDonkey(string memory name) 
        public returns (bytes32){
            ...
            requestToDonkeyName[requestId] = name;
            requestToSender[requestId] = msg.sender;
            emit battleDonkey(requestId);
            return requestId;
    }
