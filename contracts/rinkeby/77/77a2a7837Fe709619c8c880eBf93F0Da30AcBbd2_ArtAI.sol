    ...
    Whitelist
{
    ...
    uint256 private _maxPaintingNameLength = 100;
    // purchase price
        ...
        onlyAllowWhitelistWhenPaused
    {
        ...
        require(
            bytes(_imageName).length <= _maxPaintingNameLength,
    ...
    function tokenInfo(uint256 _tokenId)
        external
        view
        returns (string memory _imageHash, string memory _imageName)
    {
        return (_tokenImageHashes[_tokenId], _tokenIdToName[_tokenId]);
    }
