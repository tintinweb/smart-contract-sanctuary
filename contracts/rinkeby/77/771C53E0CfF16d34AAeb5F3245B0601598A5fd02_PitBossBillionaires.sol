...
contract PitBossBillionaires is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant PRE_PRICE = 8 * 10**16; // (WEI) 0.08 Ether
    uint256 public constant PRICE = 1 * 10**17; // (WEI) 0.1 Ether
    ...
    function presaleMint(uint256 _count, bytes32[] calldata proof) public payable saleIsOpen  {
        uint256 total = _totalSupply();
