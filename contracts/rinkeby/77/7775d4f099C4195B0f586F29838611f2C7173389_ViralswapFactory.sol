...
library ViralswapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'94bc08418fa6414810c0f1c9078edbf2fb66b0b71d8e75a34c59679223308991' // init code hash
            ))));
    }
    ...
    function vaultFor(address factory, address tokenA, address tokenB) internal pure returns (address vault) {
        ...
        vault = address(uint(keccak256(abi.encodePacked(
                ...
                factory,
                keccak256(abi.encodePacked(token0, token1)),
                hex'a0e81a28b5bf24b15c060f3e16e080ae6ae092dc948f6eefaf25ced93e158546' // init code hash
            ))));
    }
