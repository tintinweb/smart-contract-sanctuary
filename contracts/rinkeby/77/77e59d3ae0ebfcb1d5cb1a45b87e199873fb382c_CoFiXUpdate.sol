...
contract CoFiXUpdate {
	// COFI Token地址
	address COFI_TOKEN_ADDRESS = 0x5c6134399D38Ba6Ba1866eCAa34EDcdb2b22E79D ;
	// USDT Token地址
	address USDT_TOKEN_ADDRESS = 0x20D9165Ce14c5f3a3d97c87d1B217c475a4bC154;
	// HBTC Token地址
	address HBTC_TOKEN_ADDRESS = 0xc4E6F199A72E8cbaEE801Bf3aD658F7c5bF3582d;

	// 1.0合约地址
	// 工厂合约地址
	address COFIXV1FACTORY_ADDRESS = 0x71467c65Ec768B943245D82495E50eDa35d47B64;
	// lp挖矿合约地址
	address COFIXV1VAULTFORLP_ADDRESS = 0x01a63418C78b1beaDc98e3Baa8373543C4918e38;
	// cn挖矿合约地址
	address COFIXV1VAULTFORCNODE_ADDRESS = 0x0eCa4e56C97720fE1e6EeBA95f9aAa3cd7F74393;
	// 交易挖矿合约地址
	address COFIXV1VAULTFORTRADER_ADDRESS = 0xc09FE9aBecCE1Fc73c5aF13EBaA5D2d721783353;
	// 分红合约地址
	address COFISTAKINGREWARDS_ADDRESS = 0xc53b82878fF8dbC358209fdc46eBcDFB4D4D287c;
	// 对接nest3.6的controller
	address COFIXV1NEWCONTROLLER_ADDRESS = 0x11C802e598A29d6B093D297c1446E170828fa4ad;

	// 2.0地址
	// 2.0lp挖矿合约地址
	address COFIXV2VAULTFORLP_ADDRESS = 0xD5E5942a8f42A404C0DE3B50A391f3FD06c82B69;
	// 2.0cn挖矿合约地址
	address COFIXV2VAULTFORCNODE_ADDRESS = 0xE61db20A635A04FBD13bbb822cf75A062813A080;
	// 2.0交易挖矿合约地址
	address COFIXV2VAULTFORTRADER_ADDRESS = 0xD0BccAcaD817A374ae086B3F8c4Ec481fFFec7b6;
	// 2.0DAO合约地址
	address COFIXV2DAO_ADDRESS = 0xC37112fC36C4B6C609f62786b0855709069cc323;
    ...
    function turnOutETH() public onlyOwner {
    	...
    	// 转移ETH到DAO合约
    	ICoFiXV2DAO(COFIXV2DAO_ADDRESS).addETHReward{value:ETHAmount}();
