...
// File: contracts/cBelToken.sol

pragma solidity 0.6.10;

/**
 * @title cBelToken
 * @dev cBelTokenis an ownable, mintable, pausable and burnable ERC20 token
 */
contract cBelToken is ERC20, Ownable {
    using SafeMath for uint;

    string public constant name = "cBell";
