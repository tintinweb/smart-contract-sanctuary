...
/* ========  Internal Function References  ======== */
  function(address) view returns (uint256) private immutable getSharesOf; // balanceOf
  function() view returns (uint256) private immutable getTotalShares; // totalSupply
