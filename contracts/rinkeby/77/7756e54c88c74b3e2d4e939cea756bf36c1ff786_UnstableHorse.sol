...
// contract ytyu12 is ERC721URIStorage {
    ...
    uint public total_No_Horses = 900;
    uint public total_No_HorsesRemaining = total_No_Horses;
    uint public owner_Horses = 100;
    ...
    function updateTokenQuantity() private { 
      require(total_No_HorsesRemaining == 0, "mint token limit exceeds, check how many remaining to mint.");
      require(total_No_Tokens != 10000, "mint token limit exceeds, check how many remaining to mint.");

      start = total_No_Horses + 1;
      _lastIpfsId = total_No_Horses;

      total_No_Tokens += 9000;
      total_No_Horses += 8900;
      total_No_TokensRemaining += 9000;
      total_No_HorsesRemaining += 8900;
