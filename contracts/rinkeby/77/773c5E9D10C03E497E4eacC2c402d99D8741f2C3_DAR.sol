...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable, Pausable {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_,uint totalsupply_, uint decimals_,uint decimalsMultiplier_) {
        _name = name_;
        _symbol = symbol_;
...
constructor () ERC20('DAR Token', 'DAR', 8, 500000000, 0  ) public {
