...
contract MyNftToken is Ownable, ERC721 {
    ...
    string[] internal textColors = ["#32a852", "#7132a8"];
    string[] internal backgroundColors = ["#000000", "#FFFFFF"];
    ...
    function buildStyles(string memory textColor) internal pure returns (string memory) {
        return
            string(
                abi.encodePacked(
                    "<style>",
                    ".small { font: italic 13px sans-serif; fill: ",
                    textColor,
                    "; }",
                    ".heavy { font: bold 30px sans-serif; fill: ",
                    textColor,
                    "; }",
