...
contract MyNftToken is Ownable, ERC721Checkpointable {
    ...
    string[] internal textColors = ["red", "blue", "pink", "tomato" "white","black"];
    string[] internal backgroundColors = ["orange", "#565656", "purple", "brown", "green"];
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory textColor = textColors[tokenId % textColors.length];
        string memory backgroundColor = backgroundColors[tokenId % backgroundColors.length];
        return MetadataBuilder.tokenURI(noun, adjective, textColor, backgroundColor);
    }
}
