...
contract IshiharaPlates is ERC721, Ownable {
    ...
    uint256 public constant ishiharaPrice = 80000000000000000; // 0.05 ETH

    uint public constant maxIshiharaPurchase = 15;
    ...
    function mintIshihara(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxIshiharaPurchase, "Can only mint 15 tokens at a time");
