...
contract SimpleCollectible is ERC721, RoyaltiesV2Impl {
    ...
    constructor(address _artist) public ERC721("ValtSpaceClub", "2222") {
    ...
    // Add back the missing _setTokenURI() from ^0.8.0
