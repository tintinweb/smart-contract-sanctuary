...
contract YKXRJETEST is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("YKXRJETEST","YKXRJETEST") {}
    ...
    function getPresalePrice() public view returns (uint256) {
        ...
        if (totalSupply() >= capThreshold)
            ...
            return (1 + (totalSupply() / 1000)) * (10 ** 16);
        else
   ...
   function mintToken(uint256 qty) public payable {
    ...
    function mintPromoToken(uint256 qty) public payable onlyOwner {
        ...
        require(totalSupply() < maxTokenSupply, "All promo tokens have been minted.");
        require(totalSupply().add(qty) < maxTokenSupply, "Quantity exceeds max promo supply.");
