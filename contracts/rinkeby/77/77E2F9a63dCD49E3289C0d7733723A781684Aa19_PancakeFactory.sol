...
contract PancakeFactory is IPancakeFactory {
    ...
    constructor(address _feeTo, address owner, uint _feePercent) public {
        feeToSetter = owner;
        feeTo = _feeTo;
        _owner = owner;
    ...
    function setFeeAmount(uint _newFeeAmount) external{
        ...
        require (_newFeeAmount <= 160000, "amount too big");
