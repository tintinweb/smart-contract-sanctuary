    ...
    Ownable
{
    ...
    uint256 public constant PUBLIC_SALE_OPEN = 1630425600;
    ...
    function mint(uint256 _quantity) public payable whenNotPaused {
        ...
        require(
            ...
            "UninterestedUnicorns: Quantity must be less than MAX_QUANTITY = 10"
        );
        require(
        ...
        require(
            ...
            "UninterestedUnicorns: Public Sale opens on 1st Sept 2021 00:00 UTC"
        );
    ...
    function privateMint() public payable whenNotPaused {
        ...
        CANDY_TOKEN.updateRewardOnMint(_msgSender(), 1);
    }
    ...
    function getReward() external {
        CANDY_TOKEN.updateReward(msg.sender, address(0));
        CANDY_TOKEN.getReward(msg.sender);
    }
    ...
    function changeBio(uint256 _tokenId, string memory _bio) public virtual {
        ...
        CANDY_TOKEN.burn(msg.sender, BIO_CHANGE_PRICE);
    ...
    function changeName(uint256 tokenId, string memory newName) public virtual {
        ...
        CANDY_TOKEN.burn(msg.sender, NAME_CHANGE_PRICE);
    ...
    function sacrifice(uint256 _tokenId) external {
        HORN_TOKEN.sacrifice(_msgSender());
        _burn(_tokenId);
    }
    ...
    function transferFrom(
        ...
        CANDY_TOKEN.updateReward(from, to);
    ...
    // ---------------------- ADMIN FUNCTIONS -----------------------
    function setBreedingManager(address _manager) external onlyAdmin {
        BREED_MANAGER = IBreedManager(_manager);
    }
