...
contract GOMR is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public qtyFree = 0;
    uint256 public saleStatus = 0; // 0 - presale, 1 - whitelist, 2 - public
    
    mapping(uint => uint) public roomUpdates;
    ...
    constructor() ERC721("Get Outta My Room!", "ROOM") {
    ...
    // updates a room URI
    function updateRoomURI(uint256 tokenId, string memory _uri) public onlyOwner{
        require(roomUpdates[tokenId] < 3, 'No frames left');
    ...
    // owner can mint qty amount of tokens to an address
    ...
    // presale mint, allows wallets on the whitelist to mint
    ...
    // public mint, mints qty amount of tokens to the caller
