...
contract ApeSoldiers is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Date of release;
    uint public releaseTimestamp = 1644598800; 

    // Date of screensaver Delete

    uint public afterScreenSaverTimestamp = 1644858000;
    ...
    */
    ...
    function releaseDate() public view returns (uint) {
     ...
     function setScreenSaverDate(uint _screenSaverTimestamp) public onlyOwner {
      require(_screenSaverTimestamp > block.timestamp, 'timestamp should be greater than block timestamp');
       afterScreenSaverTimestamp = _screenSaverTimestamp;
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory uriEnding = block.timestamp > afterScreenSaverTimestamp ? tokenId.toString() : '0';
