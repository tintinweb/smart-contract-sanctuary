...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    string private _name = "TESTI";
    string private _symbol = "TESTI";
    ...
    uint private constant _max_days = 20 minutes;
    ...
    constructor () {
        ...
        // include in fee
        includeInFee(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    ...
    function _transfer(
        ...
        if(_enableFee && (_isIncludedInFee[from] || _isIncludedInFee[to])){
            if (block.timestamp <= (_deploy_timstamp + _max_days)) {
                ...
                require(!isExcludedFromMaxTx(to) && recipientBalance + amount <= _maxTxAmount, "ERC20: Recipient amount exceeds maxTxAmount");
            }
            takeFee = true;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(tBurn > 0) emit Transfer(sender, burn_address, tBurn);
