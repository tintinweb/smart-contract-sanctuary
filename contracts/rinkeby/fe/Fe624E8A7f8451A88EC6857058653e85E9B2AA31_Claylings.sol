...
contract Claylings is ERC721Enumerable, Ownable {
    ...
    uint256 public constant CLAYS_PUBLIC = 3540;
    uint256 public constant CLAYS_MAX =  CLAYS_PRIVATE + CLAYS_PUBLIC;
    ...
    address private member5 = 0x0000003f9A1FBB7348f3a4BF96BbBE68b6dEafcD;
    string public proof;
    ...
    constructor() ERC721("Claylings", "CLAY") { }
    ...
    function gift(address[] calldata receivers) external onlyOwner {
        require(totalSupply() + receivers.length <= CLAYS_MAX, "MAX_MINT");
