...
contract PixlBrosFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://pixlbros.com/api/factory/";
    ...
    /*
     * 10 different options for minting (basic, premium, and gold).
     */
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        PixlBros nft = PixlBros(nftAddress);
        if (_optionId < 5) {
    ...
    function canMint(uint256 _optionId) override public view returns (bool) {
        ...
        return totalSupply < (MAX_TOKENS - 1);
    }
    ...
    function tokenURI(uint256 _optionId) override external view returns (string memory) {
        ...
        return string(abi.encodePacked(
                baseURI,
                Strings.toString(_optionId < 5 ? 0 : 1)));
    }
    ...
    function transferFrom(
        ...
        require(_from != _to, "From & To are the same");
        mint(_tokenId, _to);
    }
    ...
    function ownerOf(uint256 _tokenId) public view returns (address _owner) {
        if (_tokenId >= 0 && _tokenId < MAX_TOKENS)
            return owner();
        else
            return nftAddress;
    }
