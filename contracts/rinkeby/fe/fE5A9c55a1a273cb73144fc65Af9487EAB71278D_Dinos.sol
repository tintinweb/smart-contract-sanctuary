...
contract Dinos is ERC721Enumerable, Ownable {
    ...
    uint256 public MAXDINOS = 30;
    uint256 public MAXDINOS_PRESALE = 15;
    uint256 public maxDinosPurchase = 10;
    uint256 public reservedDinosCustom = 5;
    ...
    constructor(string memory baseURI) ERC721("DinoSquad Unleashed", "Dinos") {
        setBaseURI(baseURI);
        isSaleActive = false;
    ...
    function preSaleMintDino(uint256 numberOfDinos) public payable {
        ...
        require(numberOfDinos >= 0 && balanceOf(msg.sender) + numberOfDinos <= maxDinosPurchase,
    ...
    function setMaxDinos(uint256 max_dinos) public onlyOwner {
        MAXDINOS = max_dinos;
    }

    function setMaxDinosPresale(uint256 max_dinos_presale) public onlyOwner {
        MAXDINOS_PRESALE = max_dinos_presale;
    }
