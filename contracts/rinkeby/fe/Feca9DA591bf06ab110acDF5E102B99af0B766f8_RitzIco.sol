...
contract RitzIco is CappedCrowdsale , RefundableCrowdsale{
    ...
    // Caps
    // =============================
    uint256 public MaximumGoal = 0.5 ether;
    uint256 public MinimumGoal = 0.4 ether;
    // ==============================

    // Token Distribution
    // =============================
    uint256 public maxTokens = 1 ether * 10 ** 12; // There will be total 400 000 000 Custom Deal Tokens
    uint256 public tokensForEcosystem = 400000000000 ether; // 400000000000 RITZ will be reserved for ecosystem
    uint256 public totalTokensForSale = 400000000000 ether; // 400000000000 RITZ will be sold in Crowdsale
    uint256 public totalTokensForSaleDuringPreICO = 400000000000 ether; // 400000000000 RITZ will be reserved for PreICO Crowdsale
    // ==============================
    ...
    //     super.createTokenContract();
    //     // return new Ritz("RITZ coin","RITZ"); // Deploys the ERC20 token. Automatically called when crowdsale contract is deployed
    // }
    // ==================
    ...
    function setCrowdsaleStage(uint value) public onlyOwner {
        ...
        // based on the price of 1 ETH = 2000 RITZ
        if (stage == CrowdsaleStage.PreICO) {
            setCurrentRate(2000 ether);
...
contract Ritz is ERC20Capped,Pausable,AccessControl,ERC20Permit {

    uint256 private constant CAPPED_SUPPLY = 1 ether * 10 ** 12;
    ...
    function finishMinting() onlyRole(DEFAULT_ADMIN_ROLE) canMint public returns (bool) {
...
contract Crowdsale {
  ...
  function buyTokens(address beneficiary) public checkDeposit(msg.value) payable {
