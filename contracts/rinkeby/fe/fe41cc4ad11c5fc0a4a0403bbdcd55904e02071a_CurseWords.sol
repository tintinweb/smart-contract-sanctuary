...
contract CurseWords is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getSizeA(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "SIZE", sizes);
    }
    
    function getSizeB(uint256 tokenId) public view returns (string memory) {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        uint256 randomX = 69 + seed % 69;
        uint256 randomY = 42 + 18 + seed % 204;
        ...
        parts[0] = string(abi.encodePacked(
            ...
            "; font-family: serif; font-size: 48px; } .aux{fill: #",
            getSecondaryColor(tokenId),
            '; font-family: arial; font-size: 14px}</style><rect width="100%" height="100%" fill="black" />'
        ));
