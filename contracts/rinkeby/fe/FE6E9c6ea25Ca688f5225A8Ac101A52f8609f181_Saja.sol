...
contract Saja is Context, IERC20, Ownable {
    ...
    address public _donationWallet;
    ...
    constructor () public {
        ...
        _donationWallet = 0x6780313D958B535BB103386919a02c835207f2a0;
    ...
    function setFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 donationFee, uint256 burnFee) external onlyOwner {
        _taxFee = taxFee;
    ...
    function removeAllFee() private {
        if (_taxFee == 0 && _liquidityFee == 0 && _marketingFee == 0 && _burnFee == 0 && _donationFee == 0) return;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        _tokenTransfer(from, to, amount .sub(marketingFee) .sub(burnFee).sub(donationFee), takeFee);
