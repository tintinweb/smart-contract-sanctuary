...
contract Discount is ERC721Enumerable, Ownable {
  using Strings for uint256;
 
  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public baseCost = .025 ether;
  ...
  IERC721 internal _token1 = IERC721(0xAF8aF6971bFf649264be4C6101AC80EAE32A92F1); // doodles
  IERC721 internal _token2 = IERC721(0xc92cedDfb8dd984A89fb494c376f9A48b999aAFc); // creature world
