...
contract CryptoCities is ERC721Batchable 
{
    ...
    // once this limit is reached the owner of the contract can only mint a new token by burning an old token they own 
    ...
    //   maker tokens  >                                 (maker gives their tokens away)
    ...
    function cancelOffer(Offer memory offer) external {
        ...
        // set the offer has as cancelled
