...
contract Immortals is ERC721, Ownable {
  ...
  mapping (address => bool) private gauntletsClaimed;

  mapping (address => bool) private wilderAllowList;
  mapping (address => bool) private wilderClaimed;

  mapping (address => bool) private metaverseAllowList;
  mapping (address => bool) private metaverseClaimed;

  mapping (address => bool) private immortalsAllowList;
  mapping (address => bool) private immortalsClaimed;
