...
contract Trade {
    ...
    function tradeAsset(address paymentAssetAddress, address assetOwner, address buyer, BuyingAssetType buyingAssetType, address buyingAssetAddress, uint tokenId, uint8 buyingAssetQty, Fee memory fee, bytes memory data) internal virtual {
        if(buyingAssetType == BuyingAssetType.ERC721) {
    ...
    function buyAsset(address paymentAssetAddress, address assetOwner, uint paymentAmt, uint unitPrice, BuyingAssetType buyingAssetType, address buyingAssetAddress, uint tokenId, uint8 buyingAssetQty, Sign memory sign, bytes memory data) public returns(bool) {
    ...
    function executeBid(address paymentAssetAddress, address buyer, uint paymentAmt, BuyingAssetType buyingAssetType, address buyingAssetAddress, uint tokenId, uint8 buyingAssetQty, Sign memory sign, bytes memory data) public returns(bool) {
        Fee memory fee = getFees(paymentAmt, buyingAssetType, buyingAssetAddress, tokenId);
