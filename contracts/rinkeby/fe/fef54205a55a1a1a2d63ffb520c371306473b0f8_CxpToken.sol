...
contract CxpToken is ERC20, ERC20Snapshot, AccessControl, Pausable {
        ...
        returns (bool)
    {
        ...
        _mint(account, amount.add((amount.mul(15).div(100))));
        return true;
    }
        ...
        returns (bool)
    {
        ...
        SafeERC20.safeTransfer(collateral, account, amount.mul(15).div(100));
        return true;
    }
}