...
contract Lottery is Ownable, VRFConsumerBase{
    ...
    constructor(address _feedAddress, address _vfrCoordinator,
     address _linkToken, uint256 _fee, bytes32 _keyhash) public
     VRFConsumerBase(_vfrCoordinator, _linkToken){
        usdEntryFee = 50 * (10 ** 18);
        ethUsdPriceFeed = AggregatorV3Interface(_feedAddress);
    ...
    {
        require(lottery_state == LOTTERY_STATE.CALCULATING_WINNER, "you ain't their yet");
