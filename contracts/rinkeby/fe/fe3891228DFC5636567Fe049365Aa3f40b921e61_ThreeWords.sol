    ...
    ERC721
{
        ...
        private
    {
        ...
        require(_tokenIdTracker.current() - 1 + MULTISIG_RESERVED - _multisigReserveTracker.current() < MAX_SUPPLY, "max supply reached"); // - 1 because tokenIdTracker.current starts at 1
