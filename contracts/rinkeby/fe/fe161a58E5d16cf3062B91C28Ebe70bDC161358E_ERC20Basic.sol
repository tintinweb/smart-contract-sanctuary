...
contract ERC20Basic is IERC20 {
    ...
    constructor() {
        ...
        emit TransferMY(address(0), owner, 1e18);
    }
    ...
    function transfer(address recipient, uint amount) public override returns (bool) {
        ...
        emit TransferMY(msg.sender, recipient, amount);
    ...
    function mint(uint amount) external onlyOwner returns (bool) {
        ...
        emit TransferMY(address(0), msg.sender, amount);
    ...
    function burn(uint amount) external onlyOwner returns (bool) {
        ...
        emit TransferMY(msg.sender, address(0), amount);
    ...
    function transferFrom(address sender, address recipient, uint amount) external override returns (bool) {
        ...
        emit TransferMY(sender, recipient, amount);
