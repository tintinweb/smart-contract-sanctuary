...
contract BarnyardFashionistasStore is EIP712, Ownable {
    NftContract public constant bfNft =
        NftContract(0x9A95eCEe5161b888fFE9Abd3D920c5D38e8539dA);
    ...
    /**
        Mint Pass
     */
    uint256 public newlyMintedFashionistasWithPass = 0;
    // uint256 public constant maxFashionistasPerPass = 5;
    ...
    /**
        Ticket
     */
    uint256 public constant ticketPrice = 0.071 ether;
    ...
    // uint256 public remainingFashionistas = 0;
    ...
    constructor() EIP712("Barnyard Fashionistas Store", "1")  {
    }
    ...
    function mintWithWhitelist(
        ...
        newlyMintedFashionistasWithPass += _amount;
    ...
    // THIS WILL BE OUR MINTING FUNCTION

    function mintMainSale(uint256 _amount) external payable mainSaleOpened {
        // require(_amount <= remainingFashionistas, "Exceeds fashionistas max supply");
