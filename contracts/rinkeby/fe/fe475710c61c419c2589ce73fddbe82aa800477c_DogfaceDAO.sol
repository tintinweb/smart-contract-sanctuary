...
contract DogfaceDAO is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721("DogfaceDAO", "DFD") {
    setBaseURI(baseURI);
  }
...
//   }
  ...
  function withdrawAll() public onlyOwner {
        ...
        _widthdraw(w1, ((balance * 20) / 100));
        _widthdraw(w2, ((balance * 20) / 100));
        _widthdraw(w3, ((balance * 20) / 100));
