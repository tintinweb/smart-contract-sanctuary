...
contract LazerSoda is ERC721Enumerable, Ownable {
    ...
    address private constant WITHDRAWAL_ADDRESS = 0x4CDa9c34Ff9600589082ACF6159B047413472122; // testnet
    address private constant BLOOTMF_ADDRESS = 0x0EF32052eB9349C360503894729c13715745FBD8; // testnet
    address private constant BLOOT_ADDRESS = 0x89aAdd47F66f09775ED0e1B2f0685Ee0F51abA35; // testnet
    
    //address private constant WITHDRAWAL_ADDRESS = 0x0A0Da512157d16f456C837a93a91c12f4B703672; // mainnet
    //address private constant BLOOTMF_ADDRESS = 0x4F8730E0b32B04beaa5757e5aea3aeF970E5B613; // mainnet
    //address private constant BLOOT_ADDRESS = 0x4F8730E0b32B04beaa5757e5aea3aeF970E5B613; // mainnet
    ...
    */
    ...
    function mint(uint256 num) public payable {
        ...
        require(supply + 1 <= MAX_TOTAL_PUBLIC, "Exceeds maximum supply");
    ...
    // Mint as Donor (can mint one)
    //
    function mintAsDonor() public payable {
            require( blootMF.isDiamond(msg.sender) || blootMF.isFounder(msg.sender), "Sender is not a Donor");
           
            uint256 supply = totalSupply();
            require( !_paused, "Minting is paused" );
            require(supply + 1 <= MAX_TOTAL_DONORS, "Exceeds maximum supply for donors");
