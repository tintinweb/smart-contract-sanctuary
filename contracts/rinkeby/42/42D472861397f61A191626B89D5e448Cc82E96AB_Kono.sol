...
contract Kono is ERC721Enumerable, Ownable, ContextMixin, NativeMetaTransaction {
  ...
  constructor(
    ...
    tiers.push(Tier("OG", 0.70 ether, 99));
    tiers.push(Tier("Early Bird", 0.80 ether, 900));
    tiers.push(Tier("First Adopter", 0.90 ether, 1000));
    tiers.push(Tier("Bloomer", 1.00 ether, 701));
  }
