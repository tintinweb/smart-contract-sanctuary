...
contract BeatportSynth is ERC721, ERC721Enumerable, Ownable {
    string public PROVENANCE;
    bool public saleIsActive = false;
    string private _baseURIextended;
    address payable public immutable shareholderAddress;

    constructor(address payable shareholderAddress_) ERC721("Beatport", "BEAT") {
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(totalSupply() + numberOfTokens <= 3300, "Purchase would exceed max supply of tokens");
