...
contract Squuid is ISquuid, ERC721Enumerable, Ownable, Pausable {
   ...
   */
  constructor(address _squid, address _traits, uint256 _maxTokens) ERC721("Guard Game", 'WGAME') { 
    squid = SQUID(_squid);
...
contract Arena is Ownable, IERC721Receiver, Pausable {
  ...
  uint256 public constant DAILY_SQUID_RATE = 10000 ether;
  ...
  uint256 public constant MAXIMUM_GLOBAL_SQUID = 2400000000 ether;
