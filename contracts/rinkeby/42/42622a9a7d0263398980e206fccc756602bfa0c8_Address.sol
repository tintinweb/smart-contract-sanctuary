...
contract PlantCore is ERC721Pausable, AccessControl, Ownable, IPlantCore {
    ...
    address public DVOToken = 0xbC981a7eee3E2B6A494fE4De020996b3bBD39C1e;
    bool public isBurn;
    uint256 public rate;
    ...
    function createPlant(address _owner, uint256 _amount) external {
        ...
        require(IERC20(DVOToken).transferFrom(msg.sender, address(this), _amount));
    ...
    function burnPlant(uint256 _tokenId) external {
        ...
        IERC20(DVOToken).transfer(msg.sender, amount);
    }
    ...
    function getBalance() public view returns(uint256) {
        return IERC20(DVOToken).balanceOf(address(this));
    }
    
    function withdrawBalance() external onlyOwner {
        IERC20(DVOToken).transfer(owner(), getBalance());
    }
