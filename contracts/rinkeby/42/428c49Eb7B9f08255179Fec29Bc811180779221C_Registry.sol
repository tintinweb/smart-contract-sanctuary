...
contract Registry is IRegistry, AccessControl {
    ...
    function purchases(address eventAddress) external view returns (uint256) {
        return _purchases[msg.sender][eventAddress];
    }
    ...
    function setLimitPerWallet(uint256 limit) external {
    ...
    function buyBatchTickets(
        ...
        require(_purchases[msg.sender][eventAddress] < _limitPerWallet, 'Amount exceeded.');
        ...
        for (uint256 i = 0; i < ticketTypes.length; i++) {
            ...
            require(amount <= _limitPerWallet, 'Amount exceeded.');
        ...
        require(_purchases[msg.sender][eventAddress].add(amount) <= _limitPerWallet, 'Amount exceeded.');
        ...
        _purchases[msg.sender][eventAddress] = _purchases[msg.sender][eventAddress].add(amount);
