...
contract TheORB is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        oneDayTimer = 10 minutes;       
        threeDaysTimer = 20 minutes;
        fiveDaysTimer = 30 minutes;
    ...
    function isStakingReadyAfterSales() public view returns (bool){
        ...
        if(block.timestamp > timeStakingIsEnabled){
            return false;   
        }
    ...
    function presaleBuy(uint256 keyCode) external payable {
        ...
        require(keyCode == 1337, "Don't use this contract presale function except through our website at "); // TODO - get the Orb website
