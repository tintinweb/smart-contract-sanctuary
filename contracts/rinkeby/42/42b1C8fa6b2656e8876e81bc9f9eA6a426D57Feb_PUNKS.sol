...
contract PUNKS is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0x6d050A42084257c4E59009A8877B0Ac2f6e9927e);
    ...
    string private _name = "ShibaPunks";
    string private _symbol = "$SHIBAPNKS";
