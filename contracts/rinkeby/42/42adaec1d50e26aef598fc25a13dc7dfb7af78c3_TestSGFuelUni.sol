...
/**
    ...
    TEST SGFUEL ON UNISWAP (ALLOW TO CREATE LIQUIDITY POOL ON TESTNET)
...
contract TestSGFuelUni is Context, IERC20, Ownable {
    ...
    string private _name = "TestSGFuelUni Token";
    string private _symbol = "TSGFUELUT";
