...
*/
    ...
    string imageUrl = 'https://whispering-mesa-45416.herokuapp.com/api/axons/image/';
    string animationUrl = 'https://ab7777.mypinata.cloud/ipfs/QmQynAAwybeWSA7qd9sPjNWNmjrvvGJCCb2yTof7pfup3g?x=';
...
*/
    ...
    */
     ...
     */
    function dataURI(uint256 _axonNumber)
        public override
        view
        returns (string memory)
    {
        string memory htmlString = string(
            abi.encodePacked(
                ...
                AnonymiceLibrary.toString(_axonNumber),
                '%3Bvar%20hash%3D%22',
                _axonNumber
            )
        );
        ...
        returns (string memory)
    {
        ...
        string memory description = '", "description": "Axons is an infinite collection of generative pixel art, built by a neural network. Metadata and art is mirrored permanently on-chain.';
