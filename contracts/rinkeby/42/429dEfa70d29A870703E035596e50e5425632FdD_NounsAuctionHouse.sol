...
/// @title The Pegapals DAO auction house
...
// LICENSE
// PegapalsAuctionHouse.sol is a modified version of Zora's AuctionHouse.sol:
...
contract NounsAuctionHouse is INounsAuctionHouse, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function _createAuction() internal {
        try INounsToken(Pegapals).safeMint() returns (uint256 nounId) {
    ...
    function _settleAuction() internal {
        ...
        if (_auction.bidder == address(0)) {
            INounsToken(Pegapals).burn(_auction.nounId);
        } else {
            INounsToken(Pegapals).transferFrom(address(this), _auction.bidder, _auction.nounId);
        }
