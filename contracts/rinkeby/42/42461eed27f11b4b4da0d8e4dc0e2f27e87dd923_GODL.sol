...
contract GODL is ERC20, Ownable {
    ...
    uint256 public constant TRADING_ENABLED_TIMESTAMP = 1626223500; // July 14, 2021 (00:45 UTC)
    ...
    event IncludedForFees(address indexed account);
    ...
    event AllowedTransferBeforeTradingEnabled(address indexed account);
    ...
    function includeForFees(address account) public onlyOwner {
        require(_isExcludedFromFees[account], "GODL: Account is already included for fees");
        _isExcludedFromFees[account] = false;

        emit IncludedForFees(account);
    }
    ...
    function allowTransferBeforeTradingIsEnabled(address account) public onlyOwner {
        ...
        emit AllowedTransferBeforeTradingEnabled(account);
    }
    ...
    function getTradingIsEnabled() public view returns (bool) {
        return block.timestamp >= TRADING_ENABLED_TIMESTAMP;
    }
