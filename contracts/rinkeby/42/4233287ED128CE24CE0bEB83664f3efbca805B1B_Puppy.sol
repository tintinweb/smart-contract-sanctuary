...
contract Puppy is ERC721Burnable {
    ...
    IDogePound public dogePound = IDogePound(0x8B7283cA394b7C306BE44295A6b55c4a80dfcDf5);
    ...
    constructor() ERC721("PUPPY", "PUPPY") {
        ...
        maxToMint = 30;
        mintIsActive = false;
        breedByDoggoIsActive = true;
        breedFeeWallet = 0xe2f071Fa6a421c6Bd7DF3635cC001c569182B950;
        breedFeePct = 20;
    }
    ...
    function breedPuppyByDoggo (address doggoOwner,
        ...
        if(breedFee > 0)
            payable(msg.sender).transfer(breedValueForDoge);
    }
