...
//    constructor(string memory _ipfsHash,bytes32 merkleRoot_ ,address pool_lock_address_, address gof_vault_address_) ERC721('GOGOGO', "GOGOGO") {
...
//    }
    ...
    constructor(string memory _ipfsHash) ERC721('GOGOGO', "GOGOGO") {
        setRevealedCollectionBaseURL(_ipfsHash);
    }
    ...
    function claim(uint256 size) public{
        require(totalSupply() + size <= MAX_SPACE_SUPPLY, "GolffPet:claim would exceed max supply");
    ...
    function setRevealedCollectionBaseURL(string memory _ipfsHash) onlyOwner public {
        revealedCollectionBaseURL = string(abi.encodePacked('https://gateway.pinata.cloud/ipfs/', _ipfsHash, '/'));
    }
