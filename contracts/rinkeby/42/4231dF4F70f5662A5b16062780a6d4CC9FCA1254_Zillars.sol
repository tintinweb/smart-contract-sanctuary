...
contract Zillars is ERC721Enumerable, Ownable {
    ...
    address admin = 0x3D27f909606c97b13973c52b0752c06C5cAd9240;
    ...
    function mint(uint256 amount) public payable {
        ...
        if ((block.timestamp - startTime) <= 10800) {
            ...
            require(
                ...
                "In PRESALE Stage, you can buy ONLY 2 Zillars!"
            );
        } else {
            require(
                balanceOf(msg.sender) + amount <= MAX_BUYABLE[1],
                "In PUBLIC Stage, you can buy ONLY 4 Zillars!"
            );
        }
        ...
        require(msg.value >= price, "Zillar : INCORRECT PRICE!");
        ...
        onlyOwner
    {
        for (uint16 i = 0; i < addresses.length; i++) {
            require(whitelistAccessCount + i < LIMIT_WL);
