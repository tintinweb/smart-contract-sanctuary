...
contract PawnMortgage is Pawn {
    ...
    function lend(
        ...
        address _lender,
        Sig memory _borrowerSig,
        Sig memory _lenderSig
    ...
    function isBorrowerSignValid(
        ...
        bytes memory _borrowerMsg = prepareBorrowerMessage(
            _nftTokenId,
            _borrowerNonce,
            _erc721Contract,
            msg.sender
    ...
    // data[0] - loanPrincipalAmount
    // data[1] - repaymentAmount
    // data[2] - nftTokenId
    // data[3] - loanDuration
    // data[4] - platformFee
    // data[5] - lenderNonce
    function isLenderSignValid(
        ...
        bytes memory _lenderMsg = prepareLenderMessage(
            _data[0],
            _data[1],
            _data[2],
            _data[3],
    ...
    function prepareBorrowerMessage(
        uint256 _nftTokenId,
        uint256 _borrowerNonce,
        address _nftContract,
        address _borrower
