...
// File contracts/Edegen.sol


contract Edegen is VRFConsumerBase, ERC721, Ownable {  
  ...
  struct Token {
    ...
    function setBaseURI(bytes memory baseURI) public requireAdmin {
      _my_baseURI = string(baseURI);
    }
