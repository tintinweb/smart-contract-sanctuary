...
\__\/  /~~/:/\  \:\ \:\_\/\  \:\ /  /:/\  \:\/:/ /:/\  \:\ \:\_\/\  \:\ /  /:/\__\/  \:\/:/\  \:\ /  /:/
    ...
    Meows(DAO) Genesis Collection (c) 2021 @meowsdao 
    Author: @atsignhandle                 
    Usage: Call adoptKittyCats(numberOfCats) to adopt a numberOfCats.
        * MAX_KITTENS is 25 per account
        * kittensPrice is 0.05 ETH
        * must have (numberOfCats < MAX_KITTENS) * (kittensPrice)         
    ...
    Visit @meowsdao on Twitter for more https://bit.ly/3vELWRa
    While each kitten is unique, there exists a singletons of the following
    WallStreetBets Diamondhand Whiskers https://bit.ly/3b5myu6
    Example Alps Set https://bit.ly/3b31mVH
    Example Space Set https://bit.ly/3Bj4RCh
    Example Underwater Set https://bit.ly/3CaWfyB
    CSV of all the kittens 
...
contract MeowsDAO is ERC721, Ownable {
    ...
    /*
     * @dev kittensPrice == $200 == 0.05 ETH
     */
    uint256 public constant kittensPrice = 50000000000000000;
    uint256 public constant maxKittenPurchase = 25;
