...
contract ERC721Rarible is ERC721Base {
    ...
    function __ERC721Rarible_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        _setBaseURI(baseURI);
        __ERC721Lazy_init_unchained();//register Interface
        __RoyaltiesV2Upgradeable_init_unchained();// register interface
        __Context_init_unchained();//empty Function
        __ERC165_init_unchained();//register interface
        __Ownable_init_unchained();//for setting owner
        __ERC721Burnable_init_unchained();//empty function
