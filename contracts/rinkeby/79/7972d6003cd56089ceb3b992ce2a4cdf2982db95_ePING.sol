...
contract LockerContract is Ownable{
...
contract ePING is Context, IERC20, Ownable {
    ...
    LockerContract lockerContract = new LockerContract(address(this));
    ...
    constructor () {
        _rOwned[address(lockerContract)] = _rTotal;
        ...
        setPresaleWallet(address(lockerContract));
        excludeFromFeeAndRfi(address(lockerContract));

        //emit Transfer(address(0), address(lockerContract), _tTotal);
    }
    ...
    function totalSupply() public view override returns (uint256) {
        return _tTotal - balanceOf(address(lockerContract));
    }
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
    ...
    function _mint(address recipient, uint256 amount) public { //TEMP public
        ...
        lockerContract.withdraw(amount, recipient);
    }
    ...
    function _burn(address senderAddress, uint256 amount) public { //TEMP public
        ...
        increaseAllowance(address(lockerContract), amount);
        lockerContract.deposit(amount, senderAddress);
    }
