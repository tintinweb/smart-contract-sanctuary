...
contract CressayZooClub is Ownable, ERC721Enumerable {
    using SafeMath for uint256;

    uint256 public constant MAX_SUPPLY = 5555;
    uint256 public constant MAX_SUPPLY_WL = 2222;
    uint256 public constant MAX_MINT_PER_TRANSACTION_WL = 2;
    uint256 public constant MAX_MINT_PER_TRANSACTION = 5;
    uint256 public constant PRICE = 0.2 ether;
    uint256 public Max_Supply_T;
    string public BASE_URI = "";

    uint256 public constant withdrawpercent = 22;
    uint256 public constant daopercent = 22;
    ...
    */
    ...
    /**
    * @dev  flip the whitelist state 
    */

    function launchWl() public onlyOwner {
        wlOpen = !wlOpen;
    }
    ...
    */   
    ...
    function whitelist_purchase(uint256 numberOfTokens, bytes memory sig) public payable  {
    require(wlOpen, "Whitelist not active yet !");
    require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY_WL, "no more WL available");
    require(numberOfTokens > 0 && numberOfTokens <= MAX_MINT_PER_TRANSACTION_WL, "2 mint max per transaction");
    require(msg.value >= PRICE.mul(numberOfTokens),"Ether value sent is not correct !");
    require(msg.value / numberOfTokens == PRICE, "Mint value is not good !");
    require(checkSignature(sig, msg.sender) == true, "Signature is not valid ");
    require(blacklist[msg.sender] == false, "This whitelisted address was already used");
