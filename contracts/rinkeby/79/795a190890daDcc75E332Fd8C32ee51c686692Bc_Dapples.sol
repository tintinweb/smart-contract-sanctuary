...
contract Dapples is ERC721, Ownable {
    
    using SafeMath for uint256;

    string public DAPPLE_PROVENANCE = "";

    uint256 public constant MAX_TOKENS = 6464;
    ...
    constructor() ERC721("Dapples", "DAPPL") {}

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        DAPPLE_PROVENANCE = _provenanceHash;
    }
