...
contract FishbowlHeads is ERC721Enumerable, Ownable, ReentrancyGuard, IERC777Recipient {
    ...
    uint256   public _dustPrice                 = 420;
    uint256   public _ecMaxSupply               = 1000;
    uint256   public _dustMaxSupply             = 1000;
    uint256   public _ecSupplyCount             = 0;
    uint256   public _dustSupplyCount           = 0;
    ...
    function tokensReceived(
        ...
        require(_presaleIsActive || _publicSaleIsActive, "Minting not active yet");
        require(msg.sender == _dustToken, "Unauthorised");

        uint256 tokenCount = amount/_dustPrice;
        _presaleMintCount[from] += tokenCount;
        _dustSupplyCount += tokenCount;
        require(_presaleMintCount[from] <= _ecMaxSupply, "Exceeds max allowed limit");
        require(_dustSupplyCount < _dustMaxSupply, "EC max supply reached");
