...
contract PuzzledNew is ERC721Tradable {
    ...
    function signatureWallet(address wallet, uint256  _tokenId, bytes memory _signature) public view returns (address){
        ...
        bytes32 hash = keccak256(abi.encode(wallet, _tokenId));
    ...
    function getencode(address wallet, uint256  _tokenId) public view returns (bytes memory){


        return abi.encode(wallet, _tokenId);
    }

    function getencode2(address wallet, uint256  _tokenId) public view returns (bytes32){
