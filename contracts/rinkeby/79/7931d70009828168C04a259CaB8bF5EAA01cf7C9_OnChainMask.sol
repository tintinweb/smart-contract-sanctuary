    ...
    Ownable
{
    ...
    string constant NAME = "OnChainMask";
    string constant SYMBOL = "OnChainMask";
    string constant _CONTRACT = "ERC1155";
    uint256 constant MAX_TOTAL_SUPPLY = 10000;
    uint256 constant MAX_NUM_PER_TOKEN = 1;
    uint256 constant batchCount = 100;
    uint256 private price = 0.02 ether;//80000000000000000; // 0.008 ETH;
    bool private isOpenOtherMint = false;
    uint256 public currentID = 1;
    string constant URI_BASE = "https://onchainmask.s3.us-west-1.amazonaws.com/metadata/chainmask-metadata-";//"https://soccerdogeclubnft.s3.us-west-1.amazonaws.com/metadatas/sdc-metadata-";
    ...
    function isOpenSwitch() public view returns(bool) {
        return isOpenOtherMint;
    }
    
    function setIsOpenSwitch(bool _isOpen) external onlyOwner {
        isOpenOtherMint = _isOpen;
    }
   ...
   // Make it possible to change the price: just in case
    ...
    modifier whenOpenSwitch() {
        require(isOpenOtherMint);
        _;
    }
        ...
        whenOpenSwitch
    {
        ...
        require(price.mul(_customBatchCount) <= msg.value,"Sorry, sending incorrect eth value");
