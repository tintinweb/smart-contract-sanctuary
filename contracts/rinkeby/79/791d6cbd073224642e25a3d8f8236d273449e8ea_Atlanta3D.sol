...
contract Atlanta3D is ERC721Enumerable, Ownable {
    ...
    address public kinesisContractAddress = 0x0bB99a45e74B5d016500Ec538d2BD107205c45Fb;
    ...
    function claimAllForOwner() external {
        ...
        for (uint256 i = 0; i < tokenBalanceOwner; i++) {
            ...
            if (tokenId < ONE_MILLION) {
                _claim(
                    kinesisContract.tokenOfOwnerByIndex(_msgSender(), i),
                    _msgSender()
                );
            }
        }
    ...
    function getProjectScript() view public returns (string memory){
        return script;
    }
