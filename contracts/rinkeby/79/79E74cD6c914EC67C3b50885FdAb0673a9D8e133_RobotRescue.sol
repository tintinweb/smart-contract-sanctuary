...
contract RobotRescue is ERC721Enumerable, Ownable {
 ...
 function whitelistBuy(uint256 _amount) external payable {
        require(whitelistSaleActive, "Droprocket|whitelistBuy| Whitelist buying is not active.");
        require(_amount <= maxPurchaseSize, "Droprocket|whitelistBuy| Too many tokens for one transaction.");
        require(msg.value >= price.mul(_amount), "Droprocket|whitelistBuy| Insufficient payment.");
        require(whitelist[msg.sender], "Droprocket|whitelistBuy| You are not whitelisted.");
        ...
        uint256 orderPrice = price.mul(_amount);
        payable(owner1).transfer(orderPrice);
    ...
    function setPrice(uint256 _price) public onlyOwner {
        require(_price >= 0.032 ether, "Minimum price is 0.032 ether");
