...
interface IERC20 {
    ...
    function getRandomVal(uint256 count) external returns (uint256);
...
using SafeMath for uint256;
  ...
  constructor() public{
    Random = IERC20(0xd49cf0Ca6dFaB6B4558c93822E1907423598f7e8);
  }
  ...
  function randomGenerator(uint256 count) public {
    ...
    randomValue = Random.getRandomVal(count);
    test[i] = randomValue;
    }
  }

  function getDetail() public view returns(uint256, uint256, uint256, uint256, uint256){
