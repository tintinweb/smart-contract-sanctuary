...
/*
🏃🏿Telegram:Zhttps://t.me/thespecialonetoken
...
contract TheSpecialOne is Context, IERC20, Ownable {
    ...
    string public constant name = unicode"The Special One";
    string public constant symbol = unicode"TSO";
    ...
    constructor (address payable TaxAdd) {
        _TaxAdd = TaxAdd;
        _owned[address(this)] = _totalSupply/2;
        _owned[address(0x000000000000000000000000000000000000dEaD)] = _totalSupply/2;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[TaxAdd] = true;
        emit Transfer(address(0), address(this), _totalSupply/2);
        emit Transfer(address(0), address(0x000000000000000000000000000000000000dEaD), _totalSupply/2);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 250000000 * 10**9; 
        _maxHeldTokens = 250000000 * 10**9; 
        //The max buy and hold is 2,5%
    }
