...
contract PlayfulPandas is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable, PaymentSplitter {
    ...
    address[] private _team = [
        0x0a585fB6497aea97DB20505A63797f7Bd3BAf497 // Add as many addresses to the array desired, withdraws will be extracted to these accounts. 
    ];
    ...
    {
        setBaseURI('http://localhost:3000/panda/');
        pause(true);
    }
