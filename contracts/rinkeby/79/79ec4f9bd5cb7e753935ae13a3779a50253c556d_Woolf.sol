...
contract Woolf is IWoolf, ERC721Enumerable, Ownable, Pausable {
	...
	constructor(
		...
		address _traits,
		uint256 _maxTokens
	) ERC721("Mutant Forest", "Mutant Forest") {
		// 桃子币合约
		...
		// ape
		// skin
		rarities[0] = [128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[0] = [21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21];
		// eyes;
		rarities[1] = [128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[1] = [18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18];
		// mouth;
		rarities[2] = [128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		...
		// wolf
		// skin
		rarities[6] = [128, 128, 128, 128, 128];
		aliases[6] = [4, 4, 4, 4, 4];
		// eyes;
		rarities[7] = [128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[7] = [11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11];
		// mouth;
		rarities[8] = [128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
	 ...
	 */
	function generate(uint256 tokenId, uint256 seed) internal returns (ApeWolf memory t) {
		t = selectTraits(seed);
	...
	function selectRecipient(uint256 seed) internal view returns (address) {
		...
		if (minted <= PAID_TOKENS || ((seed >> 245) % 10) <= num) return _msgSender(); // top 10 bits haven't been used
	 ...
	 */
	function selectTraits(uint256 seed) internal view returns (ApeWolf memory t) {
	...
	function getLP() external {
		StakeLP memory stake = LPMap[_msgSender()];
		require(uint256(block.timestamp) - stake.time > uint256(30 days), "stop");
	...
	function getTokenTraits(uint256 tokenId) external view override returns (ApeWolf memory) {
