...
contract BondTreasury is IBondTreasury, Policy {
    ...
    constructor(address _payoutToken) public {
     ...
     */
    function deposit(address _principleTokenAddress, uint _amountPrincipleToken, uint _amountPayoutToken) external override  {
