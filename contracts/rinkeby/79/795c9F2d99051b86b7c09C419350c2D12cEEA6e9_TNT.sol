...
contract TNT is ERC721, Ownable {
    ...
    function mint() public payable {
        require(totalSupply + 1 < MAX_TNT, "No TimeNFT left");
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory jsonString = string(abi.encodePacked(
            ...
            '", "description": "',
            Strings.toString(tokenId), 
            '", "image": "https://arweave.net/9rO-wLmxPuf-9aptGfPxJO8ieKBFZUQzHamckRpqUs4/', 
            Strings.toString(timeIndex()), 
            '.png"}'
        ));
