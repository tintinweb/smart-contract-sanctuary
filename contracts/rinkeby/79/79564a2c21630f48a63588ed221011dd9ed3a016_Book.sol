            ...
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            '{"name":"The Emperor\'s Password",'
                            '"description":"This book holds the Emperor\'s secret password. It\'s written in the same ink used to dye his clothes. You\'ll need good timing, and watch out for caching! (You might want to use Etherscan.)",'
                            '"image":"data:image/svg+xml;base64,',
                            Base64.encode(
                                password.length > 0
                                    ? getOpenSVG()
