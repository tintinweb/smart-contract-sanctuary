...
contract Wcraft is ERC721, Ownable {
    ...
    mapping(string => bool) private itemIds;
    ...
    function existsItemId(string memory itemId) public view returns (bool){
    ...
    function mint(address _to, string memory itemId) external payable onlyOwner {
        if (msg.sender != owner()) {
