...
contract Chubbies is ERC721, Ownable {
    ...
    constructor() ERC721("Chubbies", "CHUBBIES") {
    ...
    function adoptChubby(uint256 numChubbies) public payable {
        ...
        require(totalSupply().add(numChubbies) <= MAX_CHUBBIES, "Exceedss MAX_CHUBBIES");
        require(msg.value >= calculatePrice().mul(numChubbies), "Enter value sent is below the price");
