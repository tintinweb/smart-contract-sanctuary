...
contract CreateArt is ERC721 {
    ...
    function createArt(string memory tokenURI) public {
    ...
    function changeMarketplaceAddress(address _marketplaceAddress) public {
        require(msg.sender == owner, "Only owner can change marketplace address");
        marketplaceAddress = _marketplaceAddress;
    }
