...
contract PUNK_EMOJIS is ERC721, Ownable { 
    string internal baseTokenURI = 'https://punk-emojis.b-cdn.net/';
    uint public price = 0.02 ether;
    uint public totalSupply = 10000;
    uint public nonce = 0;
    uint public maxTx = 20;
    address public constant developer = 0xC006562812F7Adf75FA0aDCE5f02C33E070e0ada;
    address public constant charity = 0xC006562812F7Adf75FA0aDCE5f02C33E070e0ada;
    uint public developerFee = 15;
    uint public charityFee = 10;
    uint constant shareSum = 100;
    
    constructor() ERC721("Punk Emojis", "PUNK_EMOJIS") {}
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        uint toDeveloper = (balance * developerFee) / shareSum;
        uint toCharity = (balance * charityFee) / shareSum;
        uint toOwner = balance - (toDeveloper + toCharity);

        payable(developer).transfer(toDeveloper);
        payable(charity).transfer(toCharity);
