...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function enter() public payable {
        ...
        require(msg.value >= getEntranceFee(), "Not enough ETH, mate!");
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        // $50, $3230 / ETH
        // 50 / 3230 -> solidity doesn't work with decimals
        // 50 * (10**x) / 3230
    ...
    function endLottery() public onlyOwner {
        ...
        // Good way: We need to look for a number outside of the blockchain. And it is verifiably random. Chainlink VRF (verifiable randomness function)
        ...
        override
    {
        ...
        // override - override the original declaration of the fulfillRandomness function!
        require(
            lottery_state == LOTTERY_STATE.CALCULATING_WINNER,
