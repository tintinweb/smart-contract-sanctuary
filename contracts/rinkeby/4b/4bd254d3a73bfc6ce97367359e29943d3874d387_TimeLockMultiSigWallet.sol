...
contract TimeLockMultiSigWallet {
    ...
    {
        require(_delay >= MINIMUM_DELAY, "TimeLockMultiSigWallet::setDelay: Delay must exceed minimum delay.");
        require(_delay <= MAXIMUM_DELAY, "TimeLockMultiSigWallet::setDelay: Delay must not exceed maximum delay.");
    ...
    function setDelay(uint _delay) public {
        require(msg.sender == address(this), "Timelock::setDelay: Call must come from Timelock::setDelay: Call must come from Timelock::setDelay: Call must come from Timelock.");
        require(_delay >= MINIMUM_DELAY, "TimeLockMultiSigWallet::setDelay: Delay must exceed minimum delay.");
        require(_delay <= MAXIMUM_DELAY, "TimeLockMultiSigWallet::setDelay: Delay must not exceed maximum delay.");
