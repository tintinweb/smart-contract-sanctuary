...
contract NFTGurus is ERC721Enumerable, Ownable {
    ...
    uint256 public _maxperTX = 7;
    uint256 public _limit = 1000;  // presale 777+_reserved=1000  =>  postsale will 7777
    uint256 public _reserved = 223; // fixed
    ...
    function MINT(uint256 num) public payable {
        ...
        require( num <= _maxperTX,                               "Max mint per TX exceeds");
        require( supply + num <= _limit - _reserved,             "Exceeds maximum guru supply");
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Exceeds reserved guru supply");
