...
contract ReflectionsMetadata is Ownable, ICorruptionsMetadata {
    ...
    address public constant corruptionsAddress =
        0x5BDf397bB2912859Dbd8011F320a222f79A28d2E;
    address public constant corruptionsDeviationRegistryAddress =
        0x40f7ad19c7F37AcD76958d61Cbc783c77411cd9b;
    address public constant corruptionsDataMapperAddress =
    ...
    constructor() Ownable() {
        description = "Unknown";
        dataMapper = ICorruptionsDataMapper(corruptionsDataMapperAddress);
    }
    ...
    function tokenURI(uint256 tokenId, uint256 amount)
        ...
        returns (string memory)
    {
        // ICorruptions corruptions = ICorruptions(corruptionsAddress);
        ...
        //     DeviationInfo memory info = ICorruptionsDeviationRegistry(corruptionsDeviationRegistryAddress).valueFor(dataMapper.valueFor(0, tokenId));
