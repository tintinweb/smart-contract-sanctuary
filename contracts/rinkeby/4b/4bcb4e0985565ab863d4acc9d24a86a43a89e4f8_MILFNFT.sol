...
//delete    uint256 internal tokenIdCounter_;
...
//delete        tokenIdCounter_ = tokenIdcounter_.;

        _safeMint(_to, tokenIdCounter_.current());
        _setTokenURI(tokenIdCounter_.current(), _tokenURI);
    ...
    for(uint256 i; i < _to.length; i++){
     _safeMint(_to[i], tokenIdCounter_.current());
     _setTokenURI(tokenIdCounter_.current(), _tokenURI);
      tokenIdCounter_.increment();
