...
contract LonelyAlienNFT is ERC721, PaymentSplitter, Ownable, Pausable {
    ...
    bool public _didWeGetTheReserves = false;

    // 60 reserve and giveaways / promo
    uint256 public constant MAXNFT = 50 + 60;
    ...
    address[] private _team = [
        ...
        0x496e18b86de7FD7EB719487f0fe0DfD2979f0D6A, // PI -20%
        0x58f873264b7B951C0FB47991817c2b935e542E68, // PI -20%
        0x7f6731a245Cda74172D65f19A27C721580cB765B, // PI -15%
        0x41090B9697c640d91853D7Ba8535b3E555def741  // PI -15%
    ];

    uint256[] private _team_shares = [30, 20 ,20 ,15,15];
        ...
        ERC721("Loneley Aliens Space Club MASTER TEST", "LASCMT")
    {
        ...
        setItemPrice(89000000000000000);
    }

    function getReserves() public onlyOwner {
        require(_didWeGetTheReserves == false, "Reserves taken already!");
        for(uint x = 0; x < 59; x++){
	    _premine(msg.sender);
        }
