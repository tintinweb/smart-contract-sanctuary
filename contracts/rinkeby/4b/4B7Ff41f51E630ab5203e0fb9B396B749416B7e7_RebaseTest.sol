...
contract RebaseTest is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Rebasing", "REBA", 9) {
    ...
    function rebase(uint256 _rebaseAmount) public onlyOwner() returns (uint256) {

        _totalSupply = _totalSupply.add(_rebaseAmount);
