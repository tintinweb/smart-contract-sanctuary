        ...
        bytes(
          string(
            abi.encodePacked(
              ...
              toString(tokenId),
              '", "description": "The Songs of the Metaverse. First collection of 5 unique/original songs to accompany you on the journey ahead. Compatible with Loot (for Adventurers)", "image": "data:image/svg+xml;base64,',
