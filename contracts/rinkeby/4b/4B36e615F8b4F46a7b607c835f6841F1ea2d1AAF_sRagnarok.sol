...
contract sRagnarok is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Ragnarok", "sRGK", 9) ERC20Permit() {
    ...
    /**
        @notice increases sRGK supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sRGK
