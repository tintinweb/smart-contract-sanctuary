...
// File: contracts/crowdsale/interfaces.sol
...
contract Crowdsale is Context, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for CycleToken;

    // The token being sold
    CycleToken private _token;
     ...
     */
    function token() public view returns (CycleToken) {
        return _token;
    }
...
contract CappedCrowdsale is Crowdsale {
    ...
    function capReached() public view returns (bool) {
        return weiRaised() >= _cap - 10_000_000_000_000_000;
    }
    ...
    PostDeliveryCrowdsale
{
    constructor(
        ...
        Crowdsale(rate, wallet, CycleToken(cycleToken))
    {}
}