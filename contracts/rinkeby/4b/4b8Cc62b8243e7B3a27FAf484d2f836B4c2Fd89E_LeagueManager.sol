...
contract LeagueManager {
    ...
    function setBaseURI(string memory _newBaseURI) public {
        leagueBadge.setBaseURI(_newBaseURI);
    }
...
contract LeagueBadge is ERC721Pausable, Ownable {
    ...
    function tokenURI(uint256 _tokenId)
        ...
        returns (string memory)
    {
        require(_exists(_tokenId), "tokenURI: tokenId does not exist");
    ...
    function setBaseURI(string memory _newBaseURI) external virtual {
        baseURI = _newBaseURI;
