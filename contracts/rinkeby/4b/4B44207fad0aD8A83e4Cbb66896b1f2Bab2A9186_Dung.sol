...
// Part: OpenZeppelin/[email protected].0/ERC20
...
contract Dung is ERC20, MinterRole {
    ...
    uint256 public constant INITIAL_MINT = 130e18;

    constructor()
    ERC20("Degens Farm Dung", "DUNG")
    MinterRole(msg.sender)
    {
        _mint(msg.sender, INITIAL_MINT);//130 $DUNG for lock in Uniswap liquidity pool.
