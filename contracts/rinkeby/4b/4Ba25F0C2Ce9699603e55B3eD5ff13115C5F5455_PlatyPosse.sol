...
contract PlatyPosse is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    address proxyRegistryAddress;
    address platyPosseWallet;
    mapping (uint256 => string) private _tokenURIs;
    string private BASE_URI = "https://api.platypossenft.com/";
    uint256 public MAX_TOKENS = 10000;
    uint256 public TOKEN_PRICE = 50000000000000000;
    uint256 public MAX_GAS_PRICE = 1000000000000;
    uint public MAX_TOKENS_PER_ORDER = 20;
    bool public ON_SALE = false;                 

    constructor(address _proxyRegistryAddress) ERC721("Platyposse", "POSSE") {
    ...
    function mintToken(uint numberOfTokens) external payable  {
        ...
        require(tx.gasprice <= MAX_GAS_PRICE, "Do not start gas wars please.");
    ...
    function withdrawBalance() external onlyOwner {
        ...
        payable(platyPosseWallet).transfer(balance);
    }
    ...
    function setPlatyPosseWallet(address _wallet) external onlyOwner {
        platyPosseWallet = _wallet;
    }
