    ...
    Proxiable
{
    ...
    // TODO rename this and all instances from seriesId to seriesId
    ...
    function calculateFee(uint256 amount, uint16 basisPoints)
        ...
        returns (uint256)
    {
        // TODO maybe change this to a value updateable by an admin
        return (amount * basisPoints) / (10000);
    }

    /**
    @dev Calculate settlemnet payoffs for the option buyers and writers
     */
    ...
    /**
    @notice Calculate exercise payouts
     */
        ...
        whenNotPaused
    {
        ...
        emit OptionMinted(
            ...
            IERC1155Controller(erc1155Controller).optionTokenTotalSupply(bIndex)
        );
    }
    ...
    function exerciseOption(
        ...
        // Only ITM exercise results in payout
        require(
    ...
    function setPriceOracle(address _priceOracle) external onlyOwner {
        ...
        // TODO fire PriceOracleSet event
    }
...
interface IERC1155Controller {
    function optionTokenTotalSupply(uint256 id) external returns (uint256);
