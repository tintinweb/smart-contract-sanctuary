...
contract Fiddles3D is ERC721Enumerable, Ownable {
    uint256 public constant MINT_PRICE = 0.03 ether;
    uint256 public constant TOTAL_SUPPLY = 3333;
    uint256 public constant TOTAL_FREE = 250;
    uint256 public constant PUBLIC_MINT_LIMIT = 15;

    string private baseURI;

    /// @dev Inactive = 0; Public = 1;
    ...
    function freeMint(uint256 _amount) public {
        ...
        require(supply + _amount <= TOTAL_FREE, "EXCEEDS_TOTAL_FREE_SUPPLY");
        require(saleFlag == 1, "MINTING_PAUSED");
        require(_amount <= 1, "AMOUNT_TOO_HIGH");
