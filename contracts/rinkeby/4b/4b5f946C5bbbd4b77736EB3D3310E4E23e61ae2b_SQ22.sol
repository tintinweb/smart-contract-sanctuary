...
contract SQ22 is Ownable, ERC721A, ReentrancyGuard {
    ...
    function mintW (uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable callerIsUser  {
        ...
        if (msg.sender != owner()) {
            ...
            if (sale == Sale.WHITELIST) {
                ...
                require( _mintAmount <= maxMintWhitelist,"you've max minted for whitelist");
            } 
else {
