...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase {
    ...
    mapping(bytes32 => string) requestToChracterName;
    ...
    function requestNewRandomCharacter (string memory name) public returns (bytes32){
        ...
        requestToChracterName[requestId] = name;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        characters.push(Character(
            ...
            speed,
            stamina,
            requestToChracterName[requestId]
        ));
    ...
    function setTokenUri(uint256 tokenId, string memory _tokenUri) public {
        require(
            ...
            "ERC721: transfer caller is now owner nor approved"
        );
