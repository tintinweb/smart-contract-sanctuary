...
contract CraneSpecials2021 is ERC1155, Ownable {
  ...
  function mintWithCrane(uint256 id, uint256 craneId) public virtual {
  ...
  function uri(uint256 id) public view virtual override returns (string memory) {
    ...
    string memory base64 = Base64.encode(bytes(string(abi.encodePacked('{"name":"Cranes #2021/s1","description":"', DESCRIPTION, '","image":"data:image/svg+xml;base64,', image64, '"}'))));
