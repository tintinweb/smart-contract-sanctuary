...
/*
    ...
    uint256 private     stakingOnlyPrice   = 0.0005 ether;
...
*/  
    ...
    //=============================================================================
    //=============================================================================
    function    addWhitelistUser(address userWallet)    external 
    {
    ...
    //=============================================================================
    function    stakeMyNft(uint256 tokenId, uint256 affHash)                 external payable callerIsUser
    {
    ...
    //=============================================================================
    function    mint(uint256 quantity, uint256 affHash)                      external payable callerIsUser
    {
    ...
    //=============================================================================
    function    mintWithStaking(uint256 quantity, uint256 affHash)           external payable callerIsUser
    {
...
emit A8();
    ...
    //=============================================================================
    function    __mintEx(uint256 quantity, uint256 unitPrice, bool isWithStaking, uint256 affHash) internal callerIsUser
    {
emit A3();
...
emit A9();
    ...
    function    setAffiliate(address walletAddress, string memory username, uint256 share, bool enabled) public onlyOwner
    {
        ...
        affiliates[affHash] = TAffiliate( walletAddress, share, username, enabled);
    }
    //----------------------------------------------------------------------
