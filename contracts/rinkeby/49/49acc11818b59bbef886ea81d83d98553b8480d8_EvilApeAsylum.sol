...
// Contract: EvilApeAsylum
// ---- CONTRACT BEGINS HERE ----

pragma solidity ^0.8.0;

contract EvilApeAsylum is ERC721A, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.1 ether; // Variable Cost
    uint256 public whitelistCost = 0.08 ether; // Whitelist Cost
    uint256 public maxSupply = 5000;
    uint256 public maxGiftSupply = 500;
    uint256 public maxMintAmount = 10;
    uint256 public walletWhitelistLimit = 3;
    ...
    constructor(string memory _initBaseURI)
        ERC721A("Evil Apes Asylum", "EAA", maxMintAmount)
    {
            ...
            if (msg.sender != owner()) {
                ...
                require(
                    (balanceOf(msg.sender) + _mintAmount) <=
                        walletWhitelistLimit,
                    "Max Mint of wallet is reached"
                );
                require(
    ...
    function giftMint(address[] calldata _addresses) public onlyOwner {
        require(
    ...
    function setMaxMintAmountAndWalletLimit(uint256 _newmaxMintAmount)
        public
        onlyOwner
    {
        maxMintAmount = _newmaxMintAmount;
