...
contract Vendor is Ownable {
  ...
  constructor(address tokenAddress) public {
    ...
    yourToken.approve(address(this),1000*(10**18));
  }
  ...
  function buyTokens() public payable {
    ...
    yourToken.transferFrom(address(this), msg.sender, amountOfTokens);
  ...
  function sellTokens(uint256 theAmount) public payable {
    ...
    emit BuyTokens(address(this), amountOfETH, theAmount);
  }
  //ToDo: create a withdraw() function that lets the owner, you can
  //use the Ownable.sol import above:
  function withdraw(uint256 amountInWei) public onlyOwner payable {
    yourToken.transferFrom(address(this), msg.sender, amountInWei);
  }
}
