...
function getRecords(address userAddress) public view returns(string[] memory){
    return records[msg.sender];
}

function getLookup(address userAddress) public view returns(string[] memory){
    return kLookup[msg.sender];
}
