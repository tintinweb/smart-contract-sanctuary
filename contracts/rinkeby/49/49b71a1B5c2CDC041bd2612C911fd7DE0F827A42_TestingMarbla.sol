...
contract TestingMarbla is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Testing Marbla", "LOTA") {
  ...
  {
    return (address(this), (salePrice * 3300) / 10000);
  }
