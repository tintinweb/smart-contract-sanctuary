...
contract BitmindCrowdsale {
  ...
  /**
    ...
    function Purchase(uint256 _amount) external onlyWhileOpen returns(bool){
        ...
        uint256 rates = getPrice();
        
        uint256 amount = _amount.mul(10e12).div(price).mul(10e18).mul(rates);
