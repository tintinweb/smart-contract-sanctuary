...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    function _acceptTimelockAdmin() public {
        require(msg.sender == admin, "GovernorBravo::_acceptTimelockAdmin: admin only");
...
contract GovernorBravoEvents {
    ...
    /// @param reason The reason given for the vote by the voter
    event VoteCast(address indexed voter, uint indexed proposalId, uint8 support, uint votes, string reason);
