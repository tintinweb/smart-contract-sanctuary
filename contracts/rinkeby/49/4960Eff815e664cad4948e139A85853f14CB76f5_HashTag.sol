    ...
    ERC721PausableUpgradeable
{
    function initialize(
        ...
        __HashTag_init(name, symbol, baseTokenURI);
    }
    ...
    function __HashTag_init(
        ...
        __HashTag_init_unchained(name, symbol, baseTokenURI);
    }

    function __HashTag_init_unchained(
        string memory name,
        string memory symbol,
        string memory baseTokenURI
    ) internal initializer {
    ...
    function mint(address to) public virtual {
        require(
            ...
            "HashTag: must have minter role to mint"
        );
    ...
    function pause() public virtual {
        require(
            ...
            "HashTag: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "HashTag: must have pauser role to unpause"
        );
        _unpause();
    }
