...
contract Vendor is Ownable {
    ...
    function sellToken(uint256 theAmount) public {
        require(theAmount > 0, "Specify a > 0 amount to sell.");
        yourToken.transferFrom(msg.sender, address(this), theAmount);
        uint256 ethVal = theAmount / tokensPerEth;
        emit SellTokens(msg.sender, ethVal, theAmount);
