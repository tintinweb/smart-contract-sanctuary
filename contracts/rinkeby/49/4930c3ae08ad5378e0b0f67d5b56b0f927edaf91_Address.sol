...
contract LarvaChads is Ownable, PaymentSplitter, ERC721Enumerable {
    ...
    constructor()
        ...
        ERC721("Larva Chads Random", "LChadsR")
    {}

    function _getID() internal view returns (uint256 array) {
        return _ids[_tokenIds.current()];
    }
    ...
    function setids(uint256[] memory _newids) public onlyOwner {
        _ids = _newids;
    }
