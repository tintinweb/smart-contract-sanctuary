...
contract EtalonTokenOwner is EtalonToken, Owned {
    ...
    function OwnerAddLiquidityToPair() public payable onlyOwner {
        ...
        (uint256 RouterEth, uint256 RouterToken, ) = _UniswapV2Pair
            .getReserves();
...

{
  ...
  "libraries": {
    "contracts/GlobalLimits.sol": {
      "GlobalLimits": "0xe33540de92bd9d9cbf3d3b0070c67766b51987a7"
    },
    "contracts/SellLimit.sol": {
      "SellLimit": "0xed768228af85141d4dd61395f06206bffe2b8db6"
    }
  }
}