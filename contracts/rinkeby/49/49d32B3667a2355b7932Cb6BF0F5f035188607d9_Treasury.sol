...
contract Treasury is Ownable{
    ...
    function liquidate(address account, address _token, address _asset, uint slippage) public {
        ...
        // require price >= uniswap pair price * (1.003)
        ...
        router.swapTokensForExactTokens(tokenToLiquidate, amountToLiquidate.mulTruncate(slippage),
                             path, address(this), 100*10**18);
        // extract exact amountToLiquidate from router transaction
        token.burnLiquidate(account, tokenToLiquidate,  amountToLiquidate);
    }
