...
contract Mythicwolfpack is ERC721Enumerable, Ownable {
    ...
    uint256 public prePrice     = 0.015 ether;
    uint256 public price        = 0.01 ether;
    uint256 public maxSupply    = 9000;
    uint256 public maxMintCount = 9;
    ...
    event FlinchMinted(uint256 indexed id, address from);
    ...
    function preSaleMint(uint256 _mintCount) public payable onlyWhitelisted {
        ...
        for (uint256 i = 0; i < _mintCount; i++) {
            if (totalSupply() < maxSupply) {
                ...
                emit FlinchMinted(supply + i, msg.sender);
            }
        }
    ...
    function info() public view returns (uint256, uint256, uint256, uint256, bool, bool) {
        return (prePrice, price, totalSupply(), maxSupply, isPreSaleActive, isPublicSaleActive);
    }
}