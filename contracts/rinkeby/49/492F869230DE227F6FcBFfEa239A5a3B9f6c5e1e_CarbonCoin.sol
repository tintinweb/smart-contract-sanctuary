    ...
    ERC20Pausable
{
     ...
     */
    constructor() ERC20("CarbonCoin Token", "CARBON") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(
            ...
            "CarbonCoin: must have minter role to mint"
        );
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(
            ...
            "CarbonCoin: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "CarbonCoin: must have pauser role to unpause"
        );
        _unpause();
    }
