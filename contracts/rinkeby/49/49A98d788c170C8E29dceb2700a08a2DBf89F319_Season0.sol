...
contract Season0 is ERC721Delegated {
  using CountersUpgradeable for CountersUpgradeable.Counter;
  CountersUpgradeable.Counter public atId;
  address payable public multisig;
  uint256 PRICE = 33 * 10**17; //fix -  MAKE PRICE CORRECT
  uint256 TOTAL_SUPPLY = 667;
  ...
  ) ERC721Delegated(baseFactory, name, symbol,
  ConfigSettings({
                royaltyBps: royaltyBps,
                uriBase: 'https://raw.githubusercontent.com/channeleng/channel-front/main/metadata/',
                uriExtension: '.json',
  ...
  function mint(uint256 numToMint) public payable {
    ...
    require((atId.current() - 1) + numToMint < TOTAL_SUPPLY);
