...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable DividendsToken = address(0xdB150654af3C44cb2396d39868A087750b6da4C4);  // USDC
  ...
  function distributeUSDCDividends(uint256 amount) public {
    require(totalSupply() > 0);
...
contract SmartGeneration is ERC20, Ownable {
   ...
   USDCeDividendTracker public dividendTracker;
    ...
    uint256 private _previousUSDCRewardsFee;
    uint256 private _previousMarketingFee;
    uint256 private _liquidityFee;
    uint256 private _USDCRewardsFee;
    uint256 private _marketingFee;

    uint256 public USDCRewardsFee;
    ...
    constructor() ERC20 ("SmartGeneration", "SGEN") {
        _USDCRewardsFee = 4;
        _liquidityFee = 5;
		_marketingFee = 2;
        ...
        totalFees = _USDCRewardsFee.add(_liquidityFee).add(_marketingFee);
    	...
    	dividendTracker = new USDCeDividendTracker();
    	antiBotEnabled = true;

    	liquidityWallet = owner();
		
		marketingWallet = payable(0xd76e33E96f8901bc2aD8F417FCF1eDF30E546939);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        USDCeDividendTracker newDividendTracker = USDCeDividendTracker(payable(newAddress));
    ...
    function excludeFromMaxSell(address account, bool excluded) public onlyOwner {
        require(_isExcludedMaxSellTransactionAmount[account] != excluded, "SmartGeneration: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SmartGeneration: The PCS pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SmartGeneration: The liquidity wallet is already this address");
    ...
    function swapTokensForUSDC(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of SmartGeneration
            path,
            recipient,
            block.timestamp
        );
    ...
    function removeAllFee() external onlyOwner() {
        ...
        _previousUSDCRewardsFee  = _USDCRewardsFee;
    ...
    function restoreAllFee() external onlyOwner() {
        ...
        _USDCRewardsFee = _previousUSDCRewardsFee;
    ...
    function updateUSDCRewardsFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 15, "SuprLotto: USDC Rewards tax must be between 0 and 15");
        liquidityFee = newFee;
    }
...
contract USDCeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("USDCe_Dividend_Tracker", "USDCe_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "USDCe_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "USDCe_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main USDCe contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "USDCe_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "USDCe_Dividend_Tracker: Cannot update claimWait to same value");
