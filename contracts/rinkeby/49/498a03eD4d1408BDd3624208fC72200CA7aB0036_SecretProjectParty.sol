...
contract MintPass {
    function hasMintPass() public view returns (bool) {}
}

contract SecretProjectParty is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("SecretProject", "SP") {
        setBaseURI(baseURI);
    }
