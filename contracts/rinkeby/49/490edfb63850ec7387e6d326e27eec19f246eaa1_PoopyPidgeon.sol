...
contract PoopyPidgeon is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Poopy Pidgeon", "Poopy")  {
        setBaseURI(baseURI);
    ...
    function mint(address _to, uint256 num) public payable {
        ...
        if(msg.sender != owner()) {
          ...
          require( num < (_maxMint+1),"You can adopt a maximum of _maxMint Pidgeons" );
