...
contract KittyToken is Context, IERC20, Ownable {
    ...
    string private _name = "Kitty Token";
    ...
    mapping(address => bool) internal claimTokens;
    
    
    uint256 public _feeDecimal = 100; // do not change this value...
    uint256 public _taxFee = 500; // means 5% which distribute to all holders
    uint256 public _liquidityFee = 0; // means 0% add liquidity
    uint256 public _burnFee = 1; // means 0.01 it menas burn 0.01%
    uint256 public _ownerFee=200; //2% goes to owner wallet
    
    address public airDropAddress=0x78F8b26750763a6D79Bf514dEd10556DAF35E5b7;
    uint256 public airDropAmount=20000000e18;
    ...
    constructor() public {
     ...
     IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // for Ethereum uniswap
        ...
        _reflectionBalance[owner()] =reflectionFromToken(800_000_000_000e18,false);
        
        
        _reflectionBalance[airDropAddress] = reflectionFromToken(200_000_000_000e18,false);
        
        emit Transfer(address(0),owner(), 800_000_000_000e18);
        
        emit Transfer(address(0),airDropAddress, 200_000_000_000e18);
    }
    ...
    function claimAirDropTokens() external {
        require(claimTokens[msg.sender] == true,"already claim the tokens");
