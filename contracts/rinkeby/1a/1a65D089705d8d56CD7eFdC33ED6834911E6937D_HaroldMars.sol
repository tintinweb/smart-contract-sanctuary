...
contract HaroldMars is ERC20Burnable, DoubleOperator {
    ...
    constructor() public ERC20('HAROLDMARS', 'HMARS') {
    ...
    function burnFrom(address account, uint256 amount) public override (ERC20Burnable) {
     ...
     function setFees(uint256 newFees) external onlyDoubleOperator {
        fees = newFees;
    }
