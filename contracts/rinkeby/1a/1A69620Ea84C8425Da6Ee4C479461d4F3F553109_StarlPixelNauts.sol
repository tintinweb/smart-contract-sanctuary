...
contract StarlPixelNauts is Ownable, ERC721Enumerable {
    ...
    constructor (string memory _pendingURI, uint256 _mintStartTime) ERC721("Starlink PixelNauts", "STPN") {
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(
                !addressHasTokens[msg.sender] || _mintAmount <= addressCanMint[msg.sender],
