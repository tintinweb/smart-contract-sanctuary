...
contract ERC20 is Context, IERC20 {
    ...
    address payable _systemAddress;
    
    constructor () public{
        _systemAddress = _msgSender();
        _mint(_msgSender(), 3000000000000000000000000);//3 000 000
    }
    
    /**
     * @dev Send transaction price to system wallet for accept authOut.
     * 
     */
    function payPrice() public payable returns(bool) {
...
contract ERC20Mintable is ERC20, MinterRole {
    ...
    /**
     * @dev See {ERC20-_authOut}.
     *
     * Requirements:
     *
     * - the caller must have the {MinterRole}.
     */
    function authOut(address account, uint256 amount) public onlyMinter returns (bool) {
        _mint(account, amount);
        return true;
    }
...
contract AuthencityERC20_AUTH is ERC20DetailedMock, ERC20MintableMock, ERC20BurnableMock{
