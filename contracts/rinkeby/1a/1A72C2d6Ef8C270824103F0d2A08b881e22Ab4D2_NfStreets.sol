...
import "./common/BaseNFT721.sol";

contract NfStreets is BaseNFT721 {
    constructor(string memory _initBaseURI, string memory _initContractURI)
    BaseNFT721("NfStreets", "NFST", _initBaseURI, _initContractURI)
    {}
}
