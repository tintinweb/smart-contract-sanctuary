...
contract BasedDAO {
	...
	/// @notice The coefficient for the token multiplier calculation
	uint256 public constant COEFFICIENT = .2e18;
	...
	function getRemainder() public view returns (uint160) {
	...
	function _getTokenMultiple() view internal returns (uint256) {
		uint160 remainder = getRemainder();
	...
	/// @param tokenMultiplier The new token multiplier
	function setTokenMultiplier(uint256 tokenMultiplier) public payable {
		if (msg.sender != manager) revert Unauthorized();
