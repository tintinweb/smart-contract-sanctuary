...
contract RogueOutcasts is ERC721Enumerable, ERC2981Royalties, Ownable {
    ...
    // Token detail
    struct RogueOutcastsSocietyDetail {
    ...
    // Token Detail
    mapping(uint256 => RogueOutcastsSocietyDetail) private _rogueOutcasts;
    ...
    /**
     * Mint RogueOutcastsSociety
     */
    function mintRogueOutcastsSociety(uint256 numberOfTokens) public payable {
        ...
        require(
            ...
            "Purchase would exceed max supply of RogueOutcastsSociety"
        );
        require(
        ...
        for (uint256 i = 1; i <= numberOfTokens; i++) {
            ...
            if (tokenId <= MAX_TOKENS) {
                _safeMint(msg.sender, tokenId);
                _rogueOutcasts[tokenId] = RogueOutcastsSocietyDetail(
                    first_encounter
                );
                emit TokenMinted(tokenId, msg.sender, first_encounter);
            }
     ...
     */
    function getRogueOutcastsSocietyDetail(uint256 tokenId)
        public
        view
        returns (RogueOutcastsSocietyDetail memory detail)
    {
