...
contract TestKids is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("TestKids", "Tkids") {
    }
    ...
    function presaleMint(uint256 amountToMint) public payable {
        ...
        require(amountToMint > 0, "Minimum mint is 1 test.");
        require(amountToMint <= 3, "You can only mint up to 3 test during the presale.");
   ...
   function mint(uint256 amountToMint) public payable {
        ...
        require(totalSupply() < NFT_SUPPLY, "All Hops have been minted.");
        require(amountToMint > 0, "Minimum mint is 1 Hops.");
        require(amountToMint <= MAX_PURCHASABLE, "Maximum mint is 20 Hops.");
        require(totalSupply() + amountToMint <= NFT_SUPPLY, "The amount of Hops you are trying to mint exceeds the max supply.");
