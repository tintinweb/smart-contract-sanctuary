...
contract EthanolX is Ownable, IERC20Metadata {
    ...
    function _distributeTax(uint256 _amount) internal returns(uint8) {
        ...
        /* 
            Add twice of the _splitedAmount to distributionRewardsPool, 
    ...
    function registerReferrer(address _referrer) external {
        ...
        require(balanceOf(_msgSender()) >= 500 ether, "EthanolX: Balance must be greater than zero to register a referrer");
