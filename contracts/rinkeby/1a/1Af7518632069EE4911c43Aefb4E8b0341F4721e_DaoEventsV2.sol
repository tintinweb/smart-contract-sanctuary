        ...
        goodTime(events[_buyTicket.eventId].time)
    {
        ...
        if (!_event.token) {
            ...
            if(_event.isPHNX) {
                ...
                console.log("_buyTicket.categoryIndex");
                console.log(_buyTicket.categoryIndex);
                console.log("usdt IN");
                console.log(_usdtPrice);
                console.log(oracle.fetch(USDT));
                console.log(_usdtPrice * oracle.fetch(USDT));
                _phnxPrice = (_usdtPrice * oracle.fetch(USDT)) / 1e18;
                console.log("PHNX to deduct");
                console.log(_phnxPrice);
            }
        }
