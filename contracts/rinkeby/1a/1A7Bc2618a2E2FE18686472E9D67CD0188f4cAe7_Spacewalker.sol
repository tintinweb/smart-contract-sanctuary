...
contract Spacewalker is ERC721Enumerable, Ownable {
    ...
    uint256 private _saleTime = 1630951200; // Date and time (GMT): Monday 6 September 2021 18:00:00 (https://www.epochconverter.com/)
    ...
    constructor() ERC721("Space Walker", "SW") {}
    ...
    function reserveNFT(uint256 count) public onlyOwner {
        ...
        for (uint256 index; index < count; index++) {
            ...
            tokenToTrialLockPeriod[totalSupply + index] = 5 weeks;
            tokenToUnlockedTrial[totalSupply + index] = block.timestamp + 5 weeks;
        }
    }
    ...
    function mint(uint256 _count) public payable {
        ...
        for (uint256 i; i < _count; i++) {
            ...
            if (newId < 251) {
                tokenToTrialLockPeriod[newId] = 5 weeks;
            }
            else if (newId < 500) {
                tokenToTrialLockPeriod[newId] = 15 weeks;
            }
            else if (newId < 2000) {
                tokenToTrialLockPeriod[newId] = 26 weeks;
            }
            else if (newId < 4000) {
                tokenToTrialLockPeriod[newId] = 52 weeks;
            }
            else if (newId < 7000) {
                tokenToTrialLockPeriod[newId] = 78 weeks;
            }
            else if (newId < 10000) {
                tokenToTrialLockPeriod[newId] = 104 weeks;
            }
    ...
    */
    ...
    function withdrawTo() public onlyOwner {
        require(withdrawalWallet != address(0), "withdrawal wallet should be set before");
