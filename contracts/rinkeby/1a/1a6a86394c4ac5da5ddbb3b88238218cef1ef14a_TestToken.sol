...
contract TestToken is Initializable, ContextUpgradeable, IERC777Upgradeable, IERC20Upgradeable {
    ...
    function initialize(string memory name_, string memory symbol_, address[] memory defaultOperators_) public virtual initializer {
    ...
    */
    ...
    function mint(address account, uint256 amount, bytes memory userData, bytes memory operatorData) public virtual  {
        return
        _mint(account, amount*10**uint256(18), userData, operatorData, true);
    }
