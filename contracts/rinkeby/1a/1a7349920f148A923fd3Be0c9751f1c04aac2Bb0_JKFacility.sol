...
_________ _        _______  _______  _______ _________ _       __________________
\__    _/| \    /\(  ____ \(  ___  )(  ____ \\__   __/( \      \__   __/\__   __/|\     /|
   )  (  |  \  / /| (    \/| (   ) || (    \/   ) (   | (         ) (      ) (   ( \   / )
   |  |  |  (_/ / | (__    | (___) || |         | |   | |         | |      | |    \ (_) /
   |  |  |   _ (  |  __)   |  ___  || |         | |   | |         | |      | |     \   /
   |  |  |  ( \ \ | (      | (   ) || |         | |   | |         | |      | |      ) (
|\_)  )  |  /  \ \| )      | )   ( || (____/\___) (___| (____/\___) (___   | |      | |
(____/   |_/    \/|/       |/     \|(_______/\_______/(_______/\_______/   )_(      \_/
...
contract JKFacility is ReentrancyGuard, ERC1155, Ownable {
        ...
        external payable nonReentrant
    {
        ...
        require(matchHash(msg.sender, _count, _hash), "invalid hash - verify _count");
        require(matchSigner(_hash, _sig), "invalid signer");
        require(!_usedHashes[_hash], "_hash already used");
        require(mintedCounter + _count <= MAX_KEY_CARDS, "max key cards");

        _usedHashes[_hash] = true;
        mintedCounter += _count;
    ...
    function isWhitelist(
        ...
        return matchHash(msg.sender, _count, _hash) && matchSigner(_hash, _sig);
    }

    function adminCheckWhitelist(
        address _sender,
        uint256 _count,
        bytes32 _hash,
        bytes memory _sig
