...
contract DogeDrinks is Context, IERC20Upgradeable {
    ...
    //address payable private _marketingWallet = payable(0xDF864485dBC986F01A9c88A95F1aE2A4bF5702cd);//ETH Mainnet
    address payable private _marketingWallet = payable(0xF056A3EC225380dDb5cE96457323f2f8A9274b2b);//Rinkeby Testnet
...
//===============================================================================================================
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            if (sameBlockActive) {
                if (lpPairs[from]){
                    require(lastTrade[to]+30 <= block.timestamp);
                    lastTrade[to] = block.timestamp;
                } else {
                    require(lastTrade[from]+30 <= block.timestamp);
