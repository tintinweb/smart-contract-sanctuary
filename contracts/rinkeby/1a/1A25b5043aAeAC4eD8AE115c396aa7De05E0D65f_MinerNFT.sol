...
//        _setTokenURI(_currTokenId, tokenURI);
    ...
    function sendTokens(address owner, address receiver, uint256 minerId) public  {
        require(!_miners.isMinerMining(minerId), "Remove miner from mine first!");
        _transfer(owner, receiver, minerId);
    }
}
