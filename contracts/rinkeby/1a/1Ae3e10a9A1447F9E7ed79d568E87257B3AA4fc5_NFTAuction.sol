...
contract NFTAuction is Ownable{
    ...
    constructor(address _nftAddress,address _biddingContract) {
        ...
        isNftOwner(_tokenId,NFT_Owner)
    {
        ...
        IERC1155(_nftContractAddress).safeTransfersFrom(
                NFT_Owner,
                BiddingContract,
                _tokenId,
                1,
    ...
    function _resetAuction( string memory _tokenId)external {
        nftContractAuctions[_nftContractAddress][_tokenId] = address(0);
    }
