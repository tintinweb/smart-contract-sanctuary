...
contract Torum is ERC20Interface, SafeMath, Ownable {
    ...
    function createMetaData(address _offChainToAddress, uint256 _tokenAmount, uint256 _transactionFee) internal returns(bool) {
    ...
    function transferToBridge(address _offChainToAddress, uint256 _tokenAmount) public returns (bool success) {
        ...
        createMetaData(_offChainToAddress, actualTokenAmount, actualTransactionFee);
