...
contract Vendor is Ownable {
    ...
    bool public withdrawalEnabled = true;
    ...
    function buyTokens() public payable {
        ...
        require(success, "There was an error transfering the tokens");
    ...
    function withdraw() public onlyOwner {
        require(
            withdrawalEnabled,
            "Withdrawals currently disabled to mantain vendor liquidity"
        );
        (bool succ, ) = owner().call{value: address(this).balance}("");
        require(succ, "Error transfering ETH");
    }
    ...
    function sellTokens(uint256 amount) public {
        ...
        (bool succ, ) = (msg.sender).call{value: amount / tokensPerEth}("");
        require(succ, "Error transfering ETH");
