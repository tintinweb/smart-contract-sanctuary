...
contract FI25 is Pausable, IERC20 {
    ...
    function _transfer(
        ...
        require(
            ...
            "Transfer amount must be greater than 200 or excluded from fees"
        );
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(!_owners[newOwner], "Owned: New owner is already owner");
        require(newOwner != address(0), "Owned: Address cannot be zero");
        require(
