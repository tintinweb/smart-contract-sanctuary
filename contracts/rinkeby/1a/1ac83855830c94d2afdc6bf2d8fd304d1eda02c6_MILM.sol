...
/*
   ...
   => Hyper-deflationary & automated buyback with competent reflection.
   
   - One of the first automated dynamic buyback tokens (Inspired by and forked from the Inari project smart contract)
   - Token holders are rewarded through a redistribution fee on every transaction.
   - The MILM smart contract comes with static buy fees and dynamic sell fees designed to help the price remain stable and grow.
   - The initial burn and the buyback burn fuel the black hole address. This wallet, like every other holder, gets rewards from transaction, reducing the supply and making MILM hyper-deflationary.
...
contract MILM is Context, IERC20, Ownable {
    ...
    function initContract() external onlyOwner() {
        ...
        teamDevAddress = payable(0xCabeEe95b404435613C7d53BFBb3cD9a0dB87B53);
    }
