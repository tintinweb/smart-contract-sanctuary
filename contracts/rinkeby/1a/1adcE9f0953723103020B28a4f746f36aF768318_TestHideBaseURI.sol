...
contract TestHideBaseURI is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address payable commissions = payable(0x22F1cc87bd9bC24cD56B3beC5dc46211ab98690B); //We will set aside 10% for charity (Look at Line 1290)
  address[] public whitelistedAddresses;
  mapping(address => uint256) public addressPresaleMinted;


  constructor() ERC721("Test Hide BaseURI", "THBU") {
    setNotRevealedURI("ipfs://QmP9pMTXmGuLMVJmiG6dwQbATaxSp5oJp5XXKYwMwVrPWp/hidden.json");
  }
