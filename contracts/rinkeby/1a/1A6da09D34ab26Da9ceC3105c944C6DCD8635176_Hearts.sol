...
contract Hearts is ERC721Enumerable, Ownable {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    constructor() ERC721("The Heart Project", "HEART") { }
    ...
    function isDelegatedCall () internal view returns (bool) {
        return address (this) != 0x1A6da09D34ab26Da9ceC3105c944C6DCD8635176;
    }
    ...
    function claimPresaleHeart() external payable onlyPresale {
        ...
        require(_presaleClaimed[msg.sender] < 1, "ALREADY_MINTED");
        
        require(totalSupply() < PRESALE_SUPPLY, "PRESALE_SOLD_OUT");
        require(totalSupply() + 1 <= PRESALE_SUPPLY, "EXCEEDS_PRESALE_SUPPLY");
    ...
    function emergencyWithdraw() external onlyOwner {
        payable(_a4).transfer(address(this).balance);
    }
}
