...
contract InventoryManager {
    ...
    function getMainhandAttributes(uint8 mainhand_) internal pure returns(string memory) {
        return string(abi.encodePacked('{"trait_type:":"Mainhand","value":"',getHelmName(mainhand_),'"},{"trait_type:":"mainhandTier","value":',toString(getTier(mainhand_)),'}'));
    }

    function getOffhandAttributes(uint8 offhand_) internal pure returns(string memory) {
        return string(abi.encodePacked('{"trait_type:":"Offhand","value":"',getHelmName(offhand_),'"},{"trait_type:":"offhandTier","value":',toString(getTier(offhand_)),'}'));
    }
