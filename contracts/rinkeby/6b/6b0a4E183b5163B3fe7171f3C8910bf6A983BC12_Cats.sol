...
// contracts/Cats.sol
// 
// https://etherscan.io/tx/0xad680b05e13ef313c5aca9e92ed35c568a267c2df943f8c343e1c2849dc10723
// let m = await Cats.deployed();
// let trait = {traitName:'foo',traitType:'bar',pixels:'',pixelCount:164};
// let traits = [trait,trait,trait,trait,trait,trait,trait,trait,trait,trait];
// m.addTraitType(0,traits);
// m.addTraitType(1,traits);
// m.addTraitType(2,traits);
// m.addTraitType(3,traits);
// m.addTraitType(4,traits);
// m.addTraitType(5,traits);
// m.addTraitType(6,traits);
// m.addTraitType(7,traits);
// m.addTraitType(8,traits);
...
*/
 ...
 |_|  |_|_|_||_\__|_|_||_\__, | |_| \_,_|_||_\__|\__|_\___/_||_/__/
   ...
   */
    ...
    /**
     * @dev Returns the current cheeth cost of fing.
     */
    function currentMieceCost() public view returns (uint256) {
        uint256 _totalSupply = totalSupply();

        if (_totalSupply <= 2000) return 500000000000000000;
...
|     | \      / |  |  ||     ||  .  \    |  |   |     ||  |  \     | |  |   |  ||     ||  |  |\    |
 \___/   \_/\_/  |__|__||_____||__|\_|    |__|    \__,_||__|__|\____| |__|  |____|\___/ |__|__| \___|
    ...
    */
     ...
     * @param _mieceAddress The cheeth address
     */
