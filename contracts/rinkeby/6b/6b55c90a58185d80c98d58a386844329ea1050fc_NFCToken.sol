...
contract NFCToken is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("NFC Token", "NFCT") {
        setBaseURI(baseURI);
    }
    ...
    //mint NFT
    function mintNFT(address _to) external onlyOwner returns(bool) {
         _mint(_to);
         return true;
    }
