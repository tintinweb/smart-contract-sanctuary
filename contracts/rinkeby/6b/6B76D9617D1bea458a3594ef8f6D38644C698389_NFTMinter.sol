...
contract NFTMinter is ERC721, Ownable, ERC721Enumerable, Iminter {
    ...
    function mint(address _to, uint256 _quantity) override public {
        require(msg.sender == AllowedAddress, "Not allowed minting address");
        require(_quantity <= MaxMintCount, "Max mint count exceeded");
