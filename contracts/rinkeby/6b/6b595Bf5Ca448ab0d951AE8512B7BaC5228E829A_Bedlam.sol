...
contract Bedlam is Ownable, ReentrancyGuard, BaseERC721, Merkle {          
    ...
    mapping(uint => bool) submitted;

    event Submission(uint[]ids, uint16[] values, address sender);
     ...
     */
    function claim(string[] calldata ids, uint totalAllocated, bytes32[] calldata proof) external nonReentrant {
