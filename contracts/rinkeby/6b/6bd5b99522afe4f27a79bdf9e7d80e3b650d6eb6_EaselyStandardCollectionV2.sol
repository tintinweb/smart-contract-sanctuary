...
contract EaselyStandardCollectionV2 is EaselyMarketplaceCollection, IEaselyContractInitializer {   
    ...
    // Events related to Claiming that generate a new tokenId
    event ClaimableClaimed(address indexed claimer, uint256 indexed originalTokenId, uint256 newTokenId, string originalIpfs);
    ...
    function buyNewToken(
        ...
        _markHashMinted(claimable, version, nonce, currentPrice, pricesAndTimestamps, ipfsHash, claimedIpfsHash, signature);
    ...
    function _markHashMinted(
        ...
        emit SaleCompleted(nextTokenId, salePrice, owner(), _msgSender(), hash);
    }
