...
contract TestTokenz is Context, IBEP20, Ownable {
    ...
    string private _name = "TestTokenz";
    string private _symbol = "TTTZ";
    ...
    address payable public buybackAddress = payable(0x9aD4591e9B1D0F3ABB91e536A4eD2b2Af596b98f);
    address payable public lpAddress = payable(0x9aD4591e9B1D0F3ABB91e536A4eD2b2Af596b98f);
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 95, "tax too high");
        _taxFee = taxFee;
    }
        
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        require(liquidityFee < 95, "tax too high");
