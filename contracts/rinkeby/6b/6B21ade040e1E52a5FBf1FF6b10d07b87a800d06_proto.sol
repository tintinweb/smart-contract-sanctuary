...
*/
    ...
    function advanceLoan(uint16 tokenId) OnlyItemOwner(ELIGIBLE_NFT_ADDRESS,tokenId) HasTransferApproval(ELIGIBLE_NFT_ADDRESS,tokenId) external returns (uint256){
    ...
    // borrower:
    function receivePayment(uint256 _loanId) payable public ItemExists(_loanId) IsUnderLoan(_loanId) OnlyItemBorrower(_loanId) IsCurrentlyCustodied(_loanId){
