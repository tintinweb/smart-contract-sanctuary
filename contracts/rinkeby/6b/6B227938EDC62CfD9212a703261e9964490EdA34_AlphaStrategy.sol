...
contract AlphaStrategy is Pausable, AlphaToken {
    ...
    uint256 public NAV = 1 * COEFF_SCALE_WEI;
    uint256 public ALPHA_PRICE = 1 * COEFF_SCALE_WEI;
    uint256 public ALPHA_PRICE_WAVG = 1 * COEFF_SCALE_WEI;
    ...
    constructor(address _stableTokenAddress) {
        ...
        _mint(address(this), 1 * COEFF_SCALE_WEI);
    }
    ...
    function deposit(uint256 _amount) external whenNotPaused {
        ...
        ALPHA_PRICE_WAVG =
            ...
            (totalSupply() + _alphaAmount) * COEFF_SCALE_WEI;
