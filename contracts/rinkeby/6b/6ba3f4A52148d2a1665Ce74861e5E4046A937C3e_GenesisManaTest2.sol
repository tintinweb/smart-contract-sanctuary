...
contract GenesisManaTest2 is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  using strings for strings.slice;
    ...
    mapping(uint256 => BagRef) public _bagRefs;
   ...
   mapping(uint8 => mapping(uint8 => uint8)) private _currentLostGenesisMana;
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
      require(
        _bagRefs[tokenId].lootTokenId != 0 || (_bagRefs[tokenId].suffixId != 0 && _bagRefs[tokenId].inventoryId != 0),
        "TOKEN_ID_NOT_MINTED"
      );
    ...
    function _claim(uint256 lootTokenId, uint8 inventoryId,  uint8 suffixId, address tokenOwner) internal {
        ...
        if (lootTokenId > 0) {
          ...
          string memory separatorStr = "of ";
          //Needs to split twice to get the 2nd item in string.
