...
contract ConstantReturnStaking_BuyBack is Ownable {
    ...
    address public constant TRUSTED_TOKEN_ADDRESS = 0xFA7a078C689129f1459A2b7c5e8F10dAF9098a9A;
    
    // earnings reward rate
    uint public constant REWARD_RATE_X_100 = 34e2;
    uint public constant REWARD_INTERVAL = 120 minutes;
    
    // unstaking possible after lockup time
    uint public LOCKUP_TIME = 5 minutes;
    
    uint public constant ADMIN_CAN_CLAIM_AFTER = 120 minutes;
