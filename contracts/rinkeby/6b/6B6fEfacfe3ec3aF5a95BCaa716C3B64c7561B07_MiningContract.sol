...
contract MiningContract is Ownable, ReentrancyGuard {
    ...
    constructor(address _mining_token, uint256 _mining_start_block, address _devAddr) public {
        ...
        phase2EndBlockNumber = phase1EndBlockNumber.add(blockCountPerDay.mul(25));
        ...
        phase6EndBlockNumber = phase5EndBlockNumber.add(blockCountPerDay.mul(248));

        uint256 phase1TokenMountPerDay = 2480000 * 1e18; // phase1: 2480000 KIKA per day
