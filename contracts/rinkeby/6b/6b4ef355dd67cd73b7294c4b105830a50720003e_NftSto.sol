...
//    }
    ...
    function tokenByTokenId(uint _tokenId) public view returns (string memory, string memory, string memory) {
        return (nftList[_tokenId].symbol,nftList[_tokenId].name,nftList[_tokenId].icon);
    }
}