...
*/
	...
	function _bigbang() internal virtual {
		for(uint256 i = 0; i < 365; i++) {
			...
			_beforeBigBang(i); //_allTokens.push(tokenId);
		}
	...
	function _beforeBigBang(uint256 tokenId) internal virtual {}
}
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
	...
	function _beforeBigBang(uint256 tokenId) internal virtual override {
		_addTokenToAllTokensEnumeration(tokenId);
	}
...
contract Clockchains is Context, ERC721Enumerable, ERC721Burnable, IERC2309 {
	...
	function _beforeBigBang(uint256 tokenId) internal virtual override(ERC721, ERC721Enumerable) {
		super._beforeBigBang(tokenId);
	}
