...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(
            path[0], UniswapV2Library.pairFor(factory, path[0], path[1]), polkaTreasury, amounts[0].mul(4).div(10000)
        );
    }
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex'b51a8c428fd65c53fa0fbf2124cd456daf106004517ea2e9560ded43bc066659' // init code hash of factory
                    )
                )
            )
        );
