...
contract UNDERSCORELABS is ERC721Enumerable, Ownable {
    using Strings for uint256;
    using SafeMath for uint256;
    using ECDSA for bytes32;

    uint public constant publicSupply = 9700;
    uint public constant presaleSupply = 300;
    ...
    constructor(string memory unrevealedBaseURI) ERC721("UNDERSCORELABS", "UDSLBS") {
