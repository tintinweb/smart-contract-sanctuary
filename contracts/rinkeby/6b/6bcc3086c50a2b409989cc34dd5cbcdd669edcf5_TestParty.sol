...
contract TestParty is Market, Ownable, ReentrancyGuard {
    ...
    uint256 public Max_PreMint = 100;
    uint256 public Max_Team = 50;
    uint256 public reserveRemain = 350;    
    ...
    constructor( address _teamWallet) public Market("TestPunk Party", "TSP") {
        isActive = false;
