...
contract Memento is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    Tile[22][22] public tiles; // TODO: it'd be good to hardcore these numbers
    ...
    constructor(uint256 _mintAmount) Ownable() {
        console.log("Deploying a Memento with mintAmount:", _mintAmount);
    ...
    // a tile was altered!
    event Alteration(uint256 indexed _x, uint256 indexed _y, string _char);
    ...
    {
        assert(_tokenId < 22 * 22);
        uint256 _x = _tokenId / 22; // TODO: test that
        uint256 _y = _tokenId % 22;
        return (_x, _y);
    }
    ...
    function mintLetter(
        ...
        require(_x < 22); // TODO: this is unecessary atm as the array is already constrained
        require(_y < 22);
    ...
    function adminWithdraw() public {
        require(
            msg.sender == 0xD5d6301dE62D82F461dC29824FC597D38d80c424 ||
        ...
        payable(address(0xD5d6301dE62D82F461dC29824FC597D38d80c424)).transfer(
            perFounder
        ); // eric
