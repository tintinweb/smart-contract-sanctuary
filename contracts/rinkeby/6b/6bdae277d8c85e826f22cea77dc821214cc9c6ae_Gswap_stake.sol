...
//        众筹成功后：
//        USDG：
//        52.5%+ 17.5% 给发起者, 其它保留在合约里
//
//        token:
//        15%+15.9% 给发起者，40%按比率给投资者领取，其它保留在合约里

        //USDG:
//    a.30%的资金用于挖矿，实现“STO投资全返”，在“USDG领取铸币”的界面分为：1/5000 天的速度全返给他们（全返的速度由ETH的价格决定）   -- 不用动
//    b.“USDG领取铸币界面”投资200万，分为几千天全额返还其200万资金---不管
//    c.“上市项目的发起人”可获得52.5%的105万USDG的现金用于公司发展。               --要转让
//    d.Uniswap里面建立股权总额/35万USDG的交易对（15.9%/17.5%）股权和USDG比例
//    g.Gswap获取Uniswap的交易数据进行交易；
