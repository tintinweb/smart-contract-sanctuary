...
contract BondlyStaking is IBondlyStaking, OwnableUpgradeable {
	...
	function _convertToxBONDLY(uint256 _amount) public view returns (uint256) {
	...
	function _convertToBONDLY(uint256 _amount) public view returns (uint256) {
		uint256 TSxBondlyToken = xBondlyToken.totalSupply();
		uint256 stakingPool = totalPool.add(_calculateReward());
	...
	function _calculateReward() public view returns (uint256) {
