...
// interface ERC721{
//     function supportsInterface(bytes interfaceId) external;
// }
contract ERCHolders is ERC1155Holder, ERC721Holder, ERC721, AccessControl {
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes4 public constant IID_IERC1155 = type(IERC1155).interfaceId;
    bytes4 public constant IID_IERC721 = type(IERC721).interfaceId;
    ERC721 erc721 = new ERC721("GameItem", "ITM");
    ...
    function tranferNftToContract(string memory name, uint itemId, uint256 price, address item, uint256 amount, PRICE_MODE mode) public{
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC1155Receiver, AccessControl, ERC721)
        returns (bool)
    {
