...
import "../../token/ERC20/ERC20MintGovernance.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20MintGovernance is ContractOwnable, IMasterERC20 {
  ERC20MintGovernance[] private childERC20MintGovernance;
  ...
  function createERC20(
    ...
    ERC20MintGovernance child = new ERC20MintGovernance(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20MintGovernance.push(child);
