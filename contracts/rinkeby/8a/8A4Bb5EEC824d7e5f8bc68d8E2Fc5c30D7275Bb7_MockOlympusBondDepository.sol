...
contract MockOlympusBondDepository is Ownable {
  ...
  /**
   *  @notice Set the liquidity bond, in case user made a mistake on deployment [emergency]
   *  @param _isLiquidityBond bool
   */
  function setIsLiquidityBond(bool _isLiquidityBond) onlyPolicy external {
