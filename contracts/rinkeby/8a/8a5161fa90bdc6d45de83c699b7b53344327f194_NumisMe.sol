...
contract NumisMe is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        marketingAddress = payable(newOwner); // Marketing Address
        devAddress = payable(newOwner); // Dev Address
    ...
    function swapBack() private lockTheSwap {
        ...
        // yes, the totalTokensToSwap should be reduced by the liquidity tokens, however this could cause 
        // potential math underflow bugs if people send tokens directly to the contract.  
        // It is cheaper to get the addLiquidity feature to refund.
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyDevFee <= 2000, "Must keep buy taxes below 20%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellDevFee <= 3200, "Must keep sell taxes below 32%");
