...
interface AdventurersWizard {
    function composePFP(address owner, uint256 PFPtokenId) external returns (bool);
} 
...
contract theAdventurerscontract is ERC721, Ownable {
    ...
    uint256 public  heroPrice = 30000000000000000; // 0.03 ETH

    uint public constant maxheroPurchase = 20;
    uint public maxReroll = 3;
    uint256 public  MAX_heroS = 8888;
   ...
   address burnaddress = 0x000000000000000000000000000000000000dEaD;
     advText.approve(burnaddress, tokenId );
    advText.safeTransferFrom( advText.ownerOf(tokenId),burnaddress, tokenId );
   ...
   function composeWizard(uint256 PFPtokenId) public  {
        ...
        bool result = wizard.composePFP(msg.sender, PFPtokenId);
