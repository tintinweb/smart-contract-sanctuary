...
contract QlbcNft is ERC721Enumerable, Ownable {
  ...
  uint256 public costPublic = 0.24 ether;
  uint256 public costVIP = 0.08 ether;
  uint256 public costPremium = 0.16 ether;
