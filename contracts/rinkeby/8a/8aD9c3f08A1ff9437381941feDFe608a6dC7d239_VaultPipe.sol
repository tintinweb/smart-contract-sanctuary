...
contract Pipe is Vault {
    ...
    function inflowPipeFlowRate() external view returns (int96) {
        return inflowToPipeData.inflowToPipeFlowRate;
    }

    function realtimeTokenBalance() public view returns (int256) {
        (int256 pipeAvailableBalance, , , ) = ISuperToken(acceptedToken).realtimeBalanceOfNow(address(this));
        return pipeAvailableBalance;
    }
