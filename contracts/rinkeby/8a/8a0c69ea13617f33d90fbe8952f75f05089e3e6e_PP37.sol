...
contract PP37 is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public PirateReserve = 130; // Reserve 130 Pirates for team & community (Used in giveaways, events etc...) plus the 20 below a total of 150 are held back 
    event licenseisLocked(string _licenseText);


    constructor() ERC721("PP37", "PP37s") {//Team Mints the first 20
