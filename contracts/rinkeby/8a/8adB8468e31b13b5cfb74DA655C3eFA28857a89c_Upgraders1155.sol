...
contract Upgraders1155 is ERC1155Supply, Ownable {
    ...
    constructor()
       ERC1155("https://dev.nftstars.app/backend/api/v1/nfts/metadata/{address}/{id}")  {
    }
...
//    }
    ...
    function _setPartner(uint256 _tokenID, address _partner, uint256 _limit) internal {
        ...
        uint256 av = _availableFreeMint(_partner, _tokenID);
