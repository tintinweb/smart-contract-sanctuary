  ...
  VRFConsumerBase
{
  ...
  uint16 public constant NUM_RESERVED_TOKENS = 150;
    ...
    whenSaleIsActive
  {
    // require(
    //   !isPresale(),
    //   "The cryptids refuse to answer your call. For now..."
    // );
    _minternal(_numToMint);
  }

  // internal mint function to avoid code replication
  function _minternal(uint256 _numToMint) internal {
  ...
  // // check that merkelProof is valid for this user, then mint
  // function mintPresale(
  //   uint256 _numToMint,
  //   bytes32[] calldata merkelProof,
  //   uint256 proofLocation
  // ) public payable whenNotPaused whenSaleIsActive {
  //   require(
  //     merkelProof[proofLocation] ==
  //       keccak256(abi.encode(msg.sender, _numToMint)),
  //     "The cryptids have not yet deemed you worthy"
  //   );
  //   require(
  //     keccak256(encodeAddressArray(merkelProof)) == merkelRoot,
  //     "Your insolence will not be tolerated"
  //   );
  //   uint256 currCount = balanceOf(msg.sender);
  //   require(currCount < _numToMint, "The cryptids tire. For now...");
  //   return _minternal(_numToMint - currCount);
  // }
    ...
    beforeStarted
  {
    ...
    // require(merkelRoot != 0, "Didn't set merkel root");
    ...
    whenSaleIsActive
  {
    ...
    // require(_nextPhaseSupply < MAX_TOKENS, "Supply exceeds maximum");
