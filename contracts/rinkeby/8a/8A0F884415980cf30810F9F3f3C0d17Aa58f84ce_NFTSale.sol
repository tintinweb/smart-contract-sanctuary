...
contract NFTSale is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    uint256 public salePrice = 10000000000000; // 0,00001 Ether

    constructor() ERC721("Dao Genomic NFT", "xGen")  {
    }

    function mintNFT(string memory tokenURI) public payable returns (bool) {
        
        require(msg.value >= salePrice, 'Value sent needs to be at least sale price.');
