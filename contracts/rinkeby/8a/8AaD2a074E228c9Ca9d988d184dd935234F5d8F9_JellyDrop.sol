...
contract JellyDrop is IJellyContract, Documents {
    ...
    function addRewards(uint256 _rewardAmount) public {
        ...
        uint256 jellyFee = _rewardAmount * uint256(feePercentage) / 10000;
        totalTokens += _rewardAmount - jellyFee;
     ...
     *  _multiplier Number to multiply list values, in wei. (18 decimal place format)
     */
     ...
     * Reverts if the given user has not been verified.
    ...
    function _earnedAmount(
        ...
        if (block.timestamp > expiry && expiry > 0 ) {
            return 0;
        }
    ...
    ) public 
    {
        ...
        require(_jellyFee < 10000 , "feePercentage greater than 10000 (100.00%)");
