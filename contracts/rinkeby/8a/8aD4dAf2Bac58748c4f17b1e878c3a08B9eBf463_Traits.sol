        ...
        returns (string memory)
    {
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                s.isSheep ? "Sheep #" : "Wolf #",
                tokenId.toString(),
                '", "description": "Thousands of Sheep and Wolves compete on a farm in the metaverse. A tempting prize of $WOOL awaits, with deadly high stakes. All the metadata and images are generated and stored 100% on-chain. No IPFS. NO API. Just the Ethereum Mainnet.", "image": "data:image/svg+xml;base64,',
