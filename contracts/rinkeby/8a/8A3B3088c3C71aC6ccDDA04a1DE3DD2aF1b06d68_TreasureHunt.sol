...
contract TreasureHunt is BaseContract {
    ...
    using EnumerableSet for EnumerableSet.AddressSet;
    uint256 private constant ONE_HOUR = 300;
    ...
    function claimReward(bytes memory signature) external whenNotPaused returns (bool) {
        ...
        require(
            ...
            block.timestamp - _timeOfLastSubmissionByAddress[msg.sender] >= ONE_HOUR,
            "Must wait an hour to resubmit a puzzle answer"
        );
