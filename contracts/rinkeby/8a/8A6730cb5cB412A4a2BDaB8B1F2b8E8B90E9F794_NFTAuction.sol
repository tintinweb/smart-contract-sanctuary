...
contract NFTAuction is Context, ReentrancyGuard {
    ...
    uint256 public bidLockTime = 1 minutes;
    ...
    function resultAuction(string memory _igUrl, address _seller) external nonReentrant {
        ...
        // require(!auctionsFinished[_igUrl], "NFTAuction.resultAuction: auction already resulted");
        ...
        emit AuctionResulted(auctionDetail.tokenId, _seller, _igUrl, "1 of 1", winner, winningBid);
    }
    ...
    */
    ...
    // /**
    //  @notice Update the Auction of instagram url for resell feature.
    //  @dev Only owner of Instagram post owner
    //  @param _igUrl instagram post url
    //  @param _status if auction finished true otherwise false.
    //  */
    // function updateAuctionStatus(string memory _igUrl, bool _status) external {
    //     require(instagrmOwners[_igUrl] == _msgSender(), "NFTAuction.updateAuctionStatus: Sender must be owner of Instagram post");
    //     auctionsFinished[_igUrl] = _status;
    //     emit UpdateAuctionStatus(_igUrl, _status);
    // }
