  ...
  ChainlinkClient
{
  ...
  function upgradeState(bytes32 _jobId, uint256 _oracleFee) public initializer {
    jobId = _jobId;
    oracleFee = _oracleFee;
  }

  function validateName(string calldata _name) external {
  ...
  function fulfill(bytes32 requestId, bool value) external {
