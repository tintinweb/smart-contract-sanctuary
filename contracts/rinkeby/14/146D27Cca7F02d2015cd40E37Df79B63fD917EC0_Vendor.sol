...
contract Vendor is Ownable {
  ...
  function buyTokens() payable public {
    require(msg.value > 0, "Buy a positive amount of tokens");
    require(yourToken.balanceOf(address(this)) > msg.value * tokensPerEth, "Insufficient funds");
  ...
  function sellTokens(uint256 amount) public {
    require(yourToken.transferFrom(msg.sender, address(this), amount));
