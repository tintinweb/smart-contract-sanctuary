...
contract ArenaNFT is ERC721URIStorage, VRFConsumerBase, Ownable {
    ...
    function svgToImageURI(string memory svg) public pure returns (string memory) {
      ...
      string memory chessURL = "QmbfMBrSLSskTyocctNrh9PXA6ZGmU2MQYpmvdekUyft4i/Queens-Gambit.gif";
      return string(abi.encodePacked(baseURL,chessURL));
    }
