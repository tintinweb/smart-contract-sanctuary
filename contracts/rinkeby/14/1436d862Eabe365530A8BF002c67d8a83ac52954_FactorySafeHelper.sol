...
contract FactorySafeHelper is IFactorySafeHelper {
        ...
        returns (address safeAddress, address realityModule)
    {
        ...
        safe.setup(
            ...
            1, // threshold
            address(this), // to
            abi.encodeWithSignature("initSafe(address, address)", realityModule, WYVERN_PROXY_REGISTRY), // data
    ...
    function initSafe(address realityModuleAddress, address wyvernProxyRegistryAddress) external {
