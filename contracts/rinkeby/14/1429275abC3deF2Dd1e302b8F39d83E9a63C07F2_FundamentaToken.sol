...
contract FundamentaToken is SecureContract, ERC20
{
    ...
    constructor(string memory name, string memory ticker, uint8 tokenDecimals) ERC20(name, ticker)
    {
        SecureContract.init();
    ...
    {
        require(hasRole(_MINTTO, msg.sender), "FundamentaToken: mintTo - Permission denied");
        _mint(user, amount);
    ...
    {
        require(hasRole(_BURNFROM, msg.sender), "FundamentaToken: burnFrom - Permission denied");
        _burn(user, amount);
