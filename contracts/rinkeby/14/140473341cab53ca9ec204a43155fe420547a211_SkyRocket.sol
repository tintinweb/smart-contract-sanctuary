...
contract SkyRocket is Context, IBEP20, Ownable {
    ...
    address public BUSD     = address(0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735); // BUSD address for Swapping   
    ...
    uint256 public _marketingFee = 400; // 1% of every transaction is sent to marketing wallet
    ...
    uint256 public _maxTxAmount                   = 5000000000 * 10**9; //  5,000,000,000 (5 billions - 0,5% of total supply)
    uint256 public _numTokensSellToAddToLiquidity = 15000 * 10**9; 
    ...
    function _transfer(
        ...
        //if (!isExcludedFromFee[to] && !automa)
