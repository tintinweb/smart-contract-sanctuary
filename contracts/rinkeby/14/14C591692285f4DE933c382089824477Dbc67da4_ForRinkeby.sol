...
contract ForRinkeby is ERC721Enumerable, Ownable {
    ...
    function savexxxxxxxx(uint256 num) public payable {
        uint256 supply = totalSupply();
        require( !xxxxPaused,                              "Sale paused" );
    ...
    function reserveXXXX(address _to, uint256 _amount) external onlyOwner {
