...
/**
 * @title BlazinTest
 * BlazinTest - a contract for my non-fungible creatures.
 */
contract BlazinTest is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("BlazinTest", "OSC", _proxyRegistryAddress)
    {}
...
import "./BlazinTest.sol";
import "./BlazinTestLootBox.sol";

contract BlazinTestFactory is FactoryERC721, Ownable {
    ...
    /*
     * Three different options for minting BlazinTests (basic, premium, and gold).
     */
    ...
    constructor(address _proxyRegistryAddress, address _nftAddress) {
        ...
        lootBoxNftAddress = address(
            new BlazinTestLootBox(_proxyRegistryAddress, address(this))
        );
    ...
    function name() override external pure returns (string memory) {
        return "OpenSeaBlazinTest Item Sale";
    }
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        BlazinTest openSeaBlazinTest = BlazinTest(nftAddress);
        if (_optionId == SINGLE_CREATURE_OPTION) {
            openSeaBlazinTest.mintTo(_toAddress);
            ...
            BlazinTestLootBox openSeaBlazinTestLootBox = BlazinTestLootBox(
                lootBoxNftAddress
            );
            openSeaBlazinTestLootBox.mintTo(_toAddress);
        }
    }
    ...
    function canMint(uint256 _optionId) override public view returns (bool) {
        ...
        BlazinTest openSeaBlazinTest = BlazinTest(nftAddress);
        uint256 creatureSupply = openSeaBlazinTest.totalSupply();
        ...
        if (_optionId == SINGLE_CREATURE_OPTION) {
            ...
            numItemsAllocated = openSeaBlazinTestLootBox.itemsPerLootbox();
        }
...
/**
 * @title BlazinTestLootBox
 *
 * BlazinTestLootBox - a tradeable loot box of BlazinTests.
 */
contract BlazinTestLootBox is ERC721Tradable {
    uint256 NUM_CREATURES_PER_BOX = 3;
    uint256 OPTION_ID = 0;
    address factoryAddress;

    constructor(address _proxyRegistryAddress, address _factoryAddress)
        ERC721Tradable("BlazinTestLootBox", "LOOTBOX", _proxyRegistryAddress)
    {
