...
contract CDPManager is ReentrancyGuard{
    ...
    */
    ...
    constructor(address _cdpManagerParameters, address _oracleRegistry, address _cdpRegistry){
        ...
        WETH  = payable(IVaultParameters(ICdpManagerParameters(_cdpManagerParameters).vaultParameters()).vault());
        // WETH =  payable(address(0xc778417E063141139Fce010982780140Aa0cD5Ab));
    }
