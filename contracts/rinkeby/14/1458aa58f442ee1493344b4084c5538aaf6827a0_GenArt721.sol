...
contract GenArt721 is CustomERC721Metadata {
    ...
    function purchase(uint256 _projectId, string memory _ipfsHash) public payable returns (uint256 _tokenId) {
        return purchaseTo(msg.sender, _projectId, _ipfsHash);
    }

    function purchaseTo(address _to, uint256 _projectId, string memory _ipfsHash) public payable returns (uint256 _tokenId) {
