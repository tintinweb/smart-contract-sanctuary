...
/*
 ...
 ____  __    _  _    ____   __   __ _  ____  _  _  ____  ____     ___  __    _  _  ____ 
/ ___)(  )  ( \/ )  (  _ \ / _\ (  ( \(_  _)/ )( \(  __)(  _ \   / __)(  )  / )( \(  _ \
\___ \/ (_/\ )  /    ) __//    \/    /  )(  ) __ ( ) _)  )   /  ( (__ / (_/\) \/ ( ) _ (
(____/\____/(__/    (__)  \_/\_/\_)__) (__) \_)(_/(____)(__\_)   \___)\____/\____/(____/
...
contract SlyPantherClub is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRIVATE_SUPPLY = 1000;
    uint256 public constant PUBLIC_SUPPLY = 9000;
    ...
    function reservePanthers(uint num) public onlyOwner {
        uint256 i;
        for (i=0; i<num; i++)
    ...
    function preSaleMint(uint256 numOfTokens) public payable {
        ...
        require(currentSupply < MAX_SUPPLY, "Out Of Stock.");
        require(currentSupply + numOfTokens <= PRIVATE_SUPPLY, "Exceeded private amount.");
    ...
    function mintPanthers(uint256 numOfTokens) public payable {
        uint256 currentSupply = totalSupply();
        require(saleEnabled, "Sale must be active.");
        require(currentSupply + numOfTokens < MAX_SUPPLY, "Exceed max supply"); 
        require(numOfTokens > 0, "You must claim at least one.");
        require(numOfTokens <= maxInTx, "Can't claim more than 5 in 1 tx.");
        require((price * numOfTokens) <= msg.value, "Insufficient funds to claim.");
