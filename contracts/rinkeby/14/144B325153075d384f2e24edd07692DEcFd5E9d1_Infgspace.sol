...
contract Infgspace is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
    ...
    function regMinter() public payable {
        ...
        allocatedWorks = allocatedWorks.sub(1);
    ...
    function payMintTimes() public payable {
        ...
        minters[msg.sender].remaiMintTimes = minters[msg.sender].remaiMintTimes.sub(times);
        allocatedWorks = allocatedWorks.sub(times);
