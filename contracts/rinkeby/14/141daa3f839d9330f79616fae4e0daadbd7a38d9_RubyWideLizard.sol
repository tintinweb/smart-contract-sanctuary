...
contract RubyWideLizard is MintableToken {

  string public constant name = "Ruby Wide Lizard"; // solium-disable-line uppercase
  string public constant symbol = "RWL"; // solium-disable-line uppercase
