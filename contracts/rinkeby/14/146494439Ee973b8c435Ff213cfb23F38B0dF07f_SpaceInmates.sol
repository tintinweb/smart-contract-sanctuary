...
contract SpaceInmates is ERC721Enumerable, Ownable {
    ...
    // Allows for the early reservation of 300 tokens from the creators for promotional usage
    function reserveByOwner(uint256 _count) public onlyOwner {
        uint256 totalSupply = totalSupply();
        require(
            totalSupply + _count < 301,
            "Owner can only reserve max 300 tokens"
        );
