 ...
 * from operating the forge all these years? Gone. Thomazi’s skin thing? Yeah.
 *
 * Look, I don't know what this stuff is. But it's damn magic as far as
 * I'm concerned. Every Renegade ought to be walking around with one of
 * these on em. We won't ever lose a damn war again.
 *
 * So that's what me and Thomazi did. We call them Medallions and we made
 * one for all of you.
 *
 * Break the chain!
 * 
