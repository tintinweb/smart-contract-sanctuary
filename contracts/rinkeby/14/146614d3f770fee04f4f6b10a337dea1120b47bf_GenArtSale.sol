    ...
    IERC721Enumerable
{
    ...
    constructor(
        ...
        string memory uri_premium_,
        string memory uri_gold_,
        uint256 max_members_
    ) public {
        _name = name_;
        _symbol = symbol_;
        _uri_premium = uri_premium_;
        _uri_gold = uri_gold_;
    ...
    function setUriPremium(string memory _uri) public onlyOwner {
        _uri_premium = _uri;
    }
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = GenArtSale.ownerOf(tokenId);
        require(to != owner, "approval to current owner");
        address sender = _msgSender();
        require(
            sender == owner || GenArtSale.isApprovedForAll(owner, sender),
        ...
        returns (bool)
    {
        ...
        return (spender == owner ||
            ...
            GenArtSale.isApprovedForAll(owner, spender));
    }
    ...
    function _transfer(
        ...
        require(
            GenArtSale.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(GenArtSale.ownerOf(tokenId), to, tokenId); // internal owner
    }
}