...
// File: contracts/OhmOwlsGenesis.sol
...
contract FrenDAOGriffinGenesis is ERC721, Ownable {    
    ...
    string public constant PRESALE_OHMOWL_URI = "https://gateway.pinata.cloud/ipfs/QmYeGGSBciV3FS3tmL6jLLBTgepr67gBTxiUc2sHKUVmyf";

    uint256 public owlPrice = 0.003 ether;// 0.03 ether;
    ...
    function presaleMintNFT(uint256 index, uint256 amount, bytes32[] calldata merkleProof) external payable {        
        ...
        require(msg.value == owlPrice, "Ether value sent is not correct");
