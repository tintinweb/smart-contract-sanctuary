...
//contract for character with true randomized data values
...
//mappings will go here!!
    ...
    function requestNewRandomCharacter (uint256 seed, string memory name) public returns (bytes32) {
