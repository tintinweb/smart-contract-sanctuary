...
contract Component2 is ERC721, Ownable, nonReentrant {
    using Address for address payable;

    string public baseTokenURI = "ipfs://<insertipfshash/";
    uint16 public tokenCount = 0;

    address private openSeaProxyRegistryAddress;
    bool private isOpenSeaProxyActive = true;

    uint16 public immutable supply = 6616;
    
    bytes32 public immutable MerkleRoot = 
        // REAL = 0x317d0e913d541be9fa22038ab90007224468b5db1e0bb0cda0efc3ad3810dca8;

        // RINKEBY TESTING = 
        0x0f30c586062ec23b3fae4dec68bfbd8a88bcd4fe51c80f820fd3d2a36386f27a;
