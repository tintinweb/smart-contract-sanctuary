...
contract BitmindCrowdsale {
  ...
  /**
    ...
    function Purchase(uint256 amount) external onlyWhileOpen returns(bool){
        ...
        crowdsaleInfo[crowdsaleid.length].total_received = crowdsaleInfo[crowdsaleid.length].total_received.add(amount.div(1e18));
    ...
    function withdrawToken() public onlyOwner returns(bool){
         ...
         emit WithdrawBMD(msg.sender, remainingToken());
         return true;
    }
