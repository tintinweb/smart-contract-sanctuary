...
/*
  ...
  "I'm a Kitty Cat NFT" --> Mint @ https://imakittycat.com/ <--
   9,840 generative 3D-rendered Kitty Cats running around crazy 
   on the ETH blockchain and coming to life in their own AR app. 
   Adopt up to 10 cats and level them up on the coming app! 
   Enjoy freely: NFT copyright transfers to the NFT holder. (^_^)
...
contract NFTcontract is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    uint public publicSale = 1641784500; // Testing: set to 1-9-22 @ 9:15pm CST
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[4]] = Account( 50, 0, true); // KCat_ownr
        accounts[teamclaim[5]] = Account( 20, 0, true); // KCat_mktg
