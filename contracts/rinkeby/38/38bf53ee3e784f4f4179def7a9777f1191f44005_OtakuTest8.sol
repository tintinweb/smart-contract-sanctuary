...
contract OtakuTest8 is ERC721Enumerable, ReentrancyGuard, Ownable {

    string[] private colorA = [
    ...
    function getColorA(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "COLORA", colorA);
    }
    function getColorB(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "COLORB", colorB);
    }
    function getColorC(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "COLORC", colorC);
    }
    function getColorD(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "COLORD", colorD);
    }
    function getColorE(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "COLORE", colorE);
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg id="layer_1" data-name="layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 566.93 510.24"><defs><style>.cls-6{fill:';
        parts[1] = getColorA(tokenId);
        parts[2] = ';}.cls-4{fill:#';
        parts[3] = getColorB(tokenId);
        parts[4] = ';}.cls-1{fill:#';
        parts[5] = getColorC(tokenId);
        parts[6] = ';}.cls-5{fill:#';
        parts[7] = getColorD(tokenId);
        parts[8] = ';}.cls-3{fill:#';
        parts[9] = getColorE(tokenId);
    ...
    constructor() ERC721("OtakuTest8", "OtakuTest8") Ownable() {}
}
