...
contract GPUNKSNFT is ERC721, PaymentSplitter, Ownable, Pausable {
    ...
    uint256 public gpunksNeeded = 500000 * 10**18;
    address public gpunksAddress = 0x3676A46e3859918e983001807ad674F8Aa7f17a6;

    uint256[] private _team_shares = [50,50];

    constructor()
        PaymentSplitter(_team, _team_shares)
        ERC721("GrumpyDogePunks", "GPUNKS")
    {
