...
contract Market is Ownable{
    ...
    function getAmountsOutEth(uint _value) public view returns (uint balance) {
        ...
        if (upgraded) {
            ...
            amount = _getAmountsOutToken(_value,saleTokenRate);
        }
        return amount;
    }

    function buyToken(uint amountOutMin,  uint deadline)payable ensure(deadline) public {
    ...
    function saleToken(uint256 _value,uint amountOutMin,  uint deadline) ensure(deadline) public {
