...
contract ARA is ERC721Tradable {
    ...
    uint256 public constant mintStartDate = 1642629933;
    ...
    function withdraw(address payable to) external onlyOwner {
        ...
        uint256 shareInvestor = (5 * (address(this).balance - 30 ether)) / 100;
