...
contract SupermanDns is Ownable, ERC721Enumerable {
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    for (uint256 i = 1; i <= _mintAmount; i++) {
      ...
      _tokenURIs[tokenId] = string(abi.encodePacked( _baseURI(), tokenId.toString(), baseExtension));
    }
  }
 ...
 function transferToken(address _to, uint256 tokenId) public onlyOwner {
    require(_exists(tokenId), "ERC721URIStorage: URI set of nonexistent token");
