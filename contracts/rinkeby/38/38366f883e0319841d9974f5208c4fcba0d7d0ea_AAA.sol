    ...
    PaymentSplitter
{
        ...
        validatePurchasePrice(numberOfTokens)
    {
        ...
        require((balanceOf(msg.sender) + numberOfTokens) <= 2, "This mint would put you above the presale limit of 2 per account");
        ...
        validatePurchasePrice(numberOfTokens)
    {
        ...
        require((balanceOf(msg.sender) + numberOfTokens) <= 1, "This mint would put you above the sale limit of 1 per account");
