...
contract K9 is ERC721Enumerable, Ownable {
    ...
    function mintNFT(uint256 numberOfNfts) public payable {
        ...
        require(
            numberOfNfts <= MAX_NFT_MINT,
            "You may not buy more than MAX_NFT_MINT NFTs at once"
        );
        require(
        ...
        require(
            NFT_MINT_PRICE.mul(numberOfNfts) == msg.value,
     ...
     */
    function assignNFT(address[] calldata destinations, uint256 numberOfNfts)
        public
        onlyOwner
    {
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
