...
contract BubbleTea is ERC721, Ownable, Withdrawable {
    ...
    uint256[MAX_SUPPLY] public indices;

    bool public mintable = false;

    event Mintable(bool mintable);

    constructor() ERC721("BubbleTea", "BubbleTea") {}
    ...
    function getAvailableRandomTokenId() public returns (uint256) {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return
            "ipfs://bafybeidnrkgpzdyetubagst46vggehqtpwiqerwcq2ritoi6rtffllgmle/";
    }
    ...
    modifier isMintable() {
        require(mintable, "BubbleTea: NFT is not mintable yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "BubbleTea: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedMaxSupply(uint256 amount) {
        require(
            ...
            "BubbleTea: There is not enough NFTs to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficient(uint256 amount) {
        require(
            ...
            "BubbleTea: There is not enough ETH transferred to mint NFTs."
        );
        _;
    }
}
