...
contract NFTfiAdmin is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() internal {
        ...
        erc20CurrencyIsWhitelisted[address(0xc778417E063141139Fce010982780140Aa0cD5Ab)] = true;

        // Whitelist mainnet CryptoKitties
        nftContractIsWhitelisted[address(0xcC14dd8E6673fEE203366115D3f9240b079a4930)] = true;
    }
