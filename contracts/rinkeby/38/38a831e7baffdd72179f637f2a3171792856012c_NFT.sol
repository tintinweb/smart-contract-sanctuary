...
contract NFT is ERC721, Ownable, ReentrancyGuard {
  ...
  */
  ...
  function _baseURI() override internal pure returns (string memory) {
    return "https://gateway.pinata.cloud/ipfs/QmTJuWQ3chQKXvUSaLaBW6Fc6CRzWwaREHSgcFRK5ZsTxz";
  }
  function contractURI() public pure returns (string memory) {
    return "https://gateway.pinata.cloud/ipfs/QmUdpoZFNaJJj1e4hVEnhnAxcCWBX9rT1R3YZbfbqo585Q";
  }
}