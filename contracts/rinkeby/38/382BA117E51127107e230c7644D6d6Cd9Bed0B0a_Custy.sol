...
contract Custy is ERC721URIStorage, Ownable, RoyaltiesV2Impl {
    ...
    mapping(address => uint256[]) public custyHashesByOwner;
    mapping(uint256 => string) private _tokenURIsById;

    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721("CustyNFT", "CST") {}
    ...
    function mintCusty(
        ...
        custyHashesByOwner[_recipient].push(_custyHashValue);
        ...
        // Setting 2.5% royalty
        _setRoyalties(_tokenIds.current(), payable(address(this)), 25);
    }
    ...
    function withdrawToCommunityBank() public {
        require(
            ...
            "Community bank is not existed yet"
        );
        require(
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        if (_royalties.length > 0) {
            return (
                ...
                ((_salePrice * _royalties[0].value) / 1000)
            );
        }
        return (address(0), 0);
    }
