...
contract LifeInWeeksNFT is ERC721Tradable {
  ...
  TokenData[MAX_SUPPLY] public tokenData;
  ...
  function tokenURI(uint256 tokenId) override(ERC721) public view returns (string memory) {
      ...
      uint birthyear = tokenData[tokenId].birthyear;
      ...
      string memory json = Base64.encode(
          bytes(string(
              abi.encodePacked(
                  ...
                  '"attributes":[{"trait_type":"Year", "value":"',birthyear,'"}],'
                  '"image_data": "', svg, '"}' 
              )
          ))
      );
  ...
  function mint(uint birthyear) public payable {
    ...
    uint256 tokenId = ts;
    tokenData[tokenId] = TokenData(birthyear);
    mintTo(msg.sender);
  }
