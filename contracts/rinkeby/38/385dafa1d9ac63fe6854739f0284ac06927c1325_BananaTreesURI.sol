...
interface IEcoz {/*ECOZ BANANA TREE*/}
...
contract BananaTreesURI is Ownable {
    ...
    function bananaTreeTokenURI(uint256 treeID, uint256 treeWeight) external view virtual returns(string memory) {
        ...
        if (treeID <= 5850) {
            ...
            if (treeID == 4051) {
                thisTrait = Leg[0];
                metadataString = string(abi.encodePacked(metadataString,'{"trait_type":"','1/1','","value":"','Treedenza''"},','{"trait_type":"','Generation','","value":"','Genesis''"},','{"trait_type":"','Thrive Production','","value":"','7''"}'));
                BGcolor = 'e0d195';
            }

            else if (treeID == 4052) {
                thisTrait = Leg[1];
                metadataString = string(abi.encodePacked(metadataString,'{"trait_type":"','1/1','","value":"','Alien''"},','{"trait_type":"','Generation','","value":"','Genesis''"},','{"trait_type":"','Thrive Production','","value":"','7''"}'));
                BGcolor = '98e2bb';
            }

            else if (treeID == 4053) {
                thisTrait = Leg[2];
                metadataString = string(abi.encodePacked(metadataString,'{"trait_type":"','1/1','","value":"','Bubble Gum Blossom''"},','{"trait_type":"','Generation','","value":"','Genesis''"},','{"trait_type":"','Thrive Production','","value":"','7''"}'));
                BGcolor = '4e3e6f';
            }
            else {
