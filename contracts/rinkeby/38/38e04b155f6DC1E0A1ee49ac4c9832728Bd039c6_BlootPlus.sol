...
contract BlootPlus is ERC721Enumerable, ReentrancyGuard {
        ...
        returns (string memory)
    {
        ...
        // We cannot encode more than a few sections of the string at once, so we need to break it
        // up into a few successive calls
        string memory json = string(
            abi.encodePacked(
                '{"name": "Accessories (for the end of the world) #',
                toString(tokenId),
                '", "description": "Bloot is basically worthless.", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("Bloot", "BLOOT") {}
}
