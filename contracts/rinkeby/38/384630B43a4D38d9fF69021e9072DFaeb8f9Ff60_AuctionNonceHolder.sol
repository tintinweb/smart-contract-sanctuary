...
contract AbstractAuction is Ownable {
    ...
    function prepareMessage(address token,uint256 tokenId,uint256 bidAmount,string memory endDate,address winner, uint256 fee, uint256 nonce) public returns (string memory) {
    ...
    function prepareMessageSeller(uint256 tokenId,address token,uint256 reservedPrice,string memory startDate, uint256 quantity, uint256 nonce) public returns (string memory) {
        string memory result = string(strConcat(
                bytes(tokenId.toString()),
                bytes(token.toString()),
    ...
    function prepareMessageBuyer(uint256 tokenId,address tokenAddress,address bidderAddress,uint256 quantity, uint256 price, uint256 nonce) public returns (string memory) {
        string memory result = string(strConcat(
