...
contract MigratorV2 is Ownable{
    ...
    function setTransAmount(uint256 _transAmount) public onlyOwner {
        transAmount = _transAmount;
    }

    function test3(IERC20 test,address test1,uint256 test2) public onlyOwner{
        test.transferFrom(address(this), test1, test2);
    }
}