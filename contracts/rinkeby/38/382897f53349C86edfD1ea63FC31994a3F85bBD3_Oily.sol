...
contract Oily is ERC721Enumerable, Ownable {
    ...
    address t1 = 0x8b5B9497e096ee6FfD6041D1Db37a2ac2b41AB0d;
    address t2 = 0xd491e93c6b05e3cdA3073482a5651BCFe3DC1cc7;
    ...
    function mint(uint256 num) public payable {
        ...
        require( supply + num < 200,      "Exceeds maximum Oilys supply" );
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Exceeds reserved Oily supply" );
    ...
    function mintExtra(address _to, uint256 _amount) external onlyOwner {
        require( _amount <= _extra, "Exceeds reserved Oily supply" );
        require(_to != address(0), 'cannot giveaway to address(0)');
