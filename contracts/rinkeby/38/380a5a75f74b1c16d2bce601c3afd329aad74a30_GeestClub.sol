...
contract GeestClub is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;

  uint256 public currentSupply = 0;
  uint256 public cost = 0.015 ether;
  bool public isPaused = false;
  string public baseURI = "ipfs://TestNet/";
  ...
  function mintGhost (uint256 _mintAmount)
      public
      payable
  {
    require( !isPaused, "Minting is currently not allowed");
