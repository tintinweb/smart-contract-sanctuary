...
contract Token is Context, IERC20, Ownable {
    ...
    address public devWallet = 0x94AC1a3a50e6bff8682c7Dea5B416E958e2aA09b ;
    address public marketingWallet = 0xCe93dBF858C0588BBBC4a9E49Cb9e1faA539a187 ;
    address public partnershipsWallet = 0x769594Ad1758bd2E7ba67B83Ac04852E1Ba3bAE5 ;
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if (_msgSender() == initialOwner || ongoingSale == false) {
    ...
    function tokenFromReflection(uint256 rAmount) public view returns(uint256) {
        ...
        function setOngoingSale(bool saleFlag) public onlyOwner {
...
/////////////////////////////////////////////////////
    ...
    function burn(uint256 amount) public {
        ...
        require(sender != address(dead), "BaseRfiToken: burn from the burn address");
