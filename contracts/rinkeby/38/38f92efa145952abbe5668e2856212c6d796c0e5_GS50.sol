    ...
    */
        ...
        public
    {
       ...
       //updates dividends tracker
        ...
        // fire event
        emit onTokenSell(msg.sender, _tokens, _taxedEthereum,block.timestamp,tokenBalanceLedger_[msg.sender],buyPrice());
        ...
        returns(uint256)
    {
        ...
        // fire event
        emit onTokenPurchase(msg.sender, _incomingEthereum, _amountOfTokens, _referredBy,block.timestamp,tokenBalanceLedger_[msg.sender],buyPrice());
    ...
    function distributingEthers(uint256 _eth) internal{
        ...
        nftStaking.receiveEth{value: (_eth.mul(3)).div(100)}();
