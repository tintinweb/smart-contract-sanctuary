...
contract LostPunkSociety is ERC721Enumerable, Ownable {
    ...
    function resetEnvironment(address cryptoPunksAssetsAddress, uint8 generationLimit, uint16 totalLimit, bool shouldVerifyCryptoPunk, bool shouldVerifyLostPunk) external onlyOwner unsealed {
    ...
    constructor() ERC721("LostPunkSociety", "LPS") {
        // Rinkeby
        cryptoPunksAssets = CryptoPunksAssets(0x13E9B487ca0f550afFf20A454fdbb984bbc6aAa1);
