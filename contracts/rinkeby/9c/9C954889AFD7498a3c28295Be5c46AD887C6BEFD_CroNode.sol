...
// Part: OpenZeppelin/[email protected]/PaymentSplitter
...
contract CroNode is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("CroNode", "CROD") PaymentSplitter(payees, shares) {
