...
contract Whitelisted is Ownable {
    ...
    function validateTokens(address tokenIn, address tokenOut) internal view {
        require(whitelisted[tokenIn], "token in has not been whitelisted");
        require(whitelisted[tokenOut], "token out has not been whitelisted");
    }
}
...

{
  ...
  "libraries": {
    "contracts/libraries/BytesLib.sol": {
      "BytesLib": "0xd939823ad9ae7d93039fc8b13c490e9f663eee91"
    },
    "contracts/libraries/Path.sol": {
      "Path": "0x866a5af171b161c183ee15edf059fcb8522676ad"
    }
  }
}