...
contract EtherFolds is ERC721Tradable {
    ...
    uint128 public MAX_SUPPLY = 10000;
    uint128 public WHITELIST_SLOTS = 2000;
    ...
    ERC721Tradable("YourCollectible", "XCT", _proxyRegistryAddress)
    {}


    event userAddedToWhitelist(address account);
    event newMint(address account);
    event newWhitelistMint(address account);
    ...
    function mint() public payable {
        ...
        require(msg.value >= TOKEN_PRICE, "Ether sent is less than price");
        _mintTo(msg.sender);
    ...
    function mintWhitelisted() public payable {
        ...
        WHITELIST_SLOTS -= 1;
        _mintTo(msg.sender);
        emit newWhitelistMint(msg.sender);
    }
