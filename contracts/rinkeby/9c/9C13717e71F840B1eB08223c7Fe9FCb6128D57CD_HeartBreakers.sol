...
contract HeartBreakers is ERC721Enumerable, Ownable {
    ...
    address public constant t1 = 0xe248cF590D6aCda514Eaab47EB147FC0ec678714;
    address public constant t2 = 0xEbE38B545198578975571096717fB3377647dEaE;
    address public constant t3 = 0x356C931438955EC7D4b11e4FCa358B2Da6E6C5c3;
    address public constant t4 = 0xAB92D152D7eCB40eCCF8a78BF5e8F14eeD5C80B3;
    address public constant t5 = 0xe248cF590D6aCda514Eaab47EB147FC0ec678714;

    string public baseTokenURI;

    event CreateHeartbreaker(uint256 indexed id);

    constructor(string memory baseURI) ERC721("The Heartbreakers", "HBS") {
        setBaseURI(baseURI);
    }
    ...
    function setMaxElements(uint _count) public onlyOwner {
        uint256 total = _totalSupply();
        require(_count < total, "Incorrect new supply");
        MAX_ELEMENTS = _count;
    }
