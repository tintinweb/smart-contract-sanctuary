...
contract YELCrowdsale is TimedCrowdsale, AllowanceCrowdsale {
    ...
    */
    ...
    function withdrawTokens(address beneficiary) public {
        ...
        amount = _recalculateAmount(amount);
    ...
    /**
     * @dev when amount of total purchased tokens becomes bigger than
     * a predefined threshold the price for token becomes higher.
     * @param amount amount of tokens to be recalculated.
     */
    function _recalculateAmount(uint256 amount) internal returns (uint256){
        // solhint-disable-next-line not-rely-on-time
    ...
    function balanceOf(address account) public returns (uint256) {
        ...
        return _recalculateAmount(amount);
    }
}
