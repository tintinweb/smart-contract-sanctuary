...
contract TomDoppleToken is ERC20("TomDopperToken", "TDOP"), Ownable {
  uint256 private _cap = 1000000000e18; //1000M
  ...
  constructor(uint256 _startReleaseBlock, uint256 _endReleaseBlock) public {
    ...
    manualMint(msg.sender, 100000000e18); // 1st manual mint 100M
  }
