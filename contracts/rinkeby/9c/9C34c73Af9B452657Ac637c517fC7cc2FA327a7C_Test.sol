...
contract Burn721 is OwnableContract, ERC721 {
...
contract Test{
    event NewBurn721(string name_);

    function newC(string memory name_, string memory symbol_) public{
         Burn721 t = new Burn721(name_,symbol_);
         emit NewBurn721(t.name());
    } 
}