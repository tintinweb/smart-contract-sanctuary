...
contract FinalNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    //gets set in the constructor and can never be changed
    ...
    */
    ...
    /**
    * Reserve tokens for community, partners etc.
    */
    function reserve(uint256 numberOfTokens) public onlyOwner {
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended!");
        require(totalSupply().add(numberOfTokens) <= MAX_NFT_SUPPLY, "Purchase would exceed the maximum supply!");
        require(numberOfTokens > 0, "You cannot mint 0 NFTs!");
    ...
    */
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if (startingIndex != 0) {
            // + 1 because the first token starts at 1
            uint256 initialSequenceId = ((tokenId + startingIndex) % MAX_NFT_SUPPLY) + 1;
            return string(abi.encodePacked(baseURI, initialSequenceId.toString()));
        }
    ...
    */
     ...
     */
    function createStartingIndex() public {
