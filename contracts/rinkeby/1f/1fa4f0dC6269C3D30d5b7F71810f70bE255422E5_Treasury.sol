...
import "./example/ExampleToken.sol";

contract Treasury {
    ExampleToken exToken;
    ...
    function setTokenAddress(address _token) external onlyTreasuryOwner {
        exToken = ExampleToken(_token);
    }

    function withdrawFunds() public onlyTreasuryOwner {
        exToken.transfer(treasuryOwner, exToken.balanceOf(address(this)));
    }
}
