...
/*                                                                                                                                                 
                                     ...
                                     -/+ydhy+/:::::::::::::::::/+shdho:                             
                                   `:/:::/oyddyo+/+////////+oyhddyo+::/                             
                                 .:/::/oyhdddddddmmmdhhhhdmmhso+/:::::/`                            
                              .-:/::::ymmmmmmdmmmhyhmmddhhdmhs/::::::::/.                           
                           `-:/::/:::::/+////ommy::omd+shmmmmmy:::::::::/:`                         
                        .-:/::///:::::::::::smms:::smm/::/oyys/:::::::::::/:`                       
                     .-/::::///:::::::::://smms::::hmd::::::::::::::::::::::/:`                     
                  `-::::::///:::::::::::::+mmo::::/mmo:::::::::::::::::::::://:-`                   
          ...
          .+::::::::-:hsoo+///::::::::::::::::::::::::::::::::::::::::::/+/:::::::::::::+`          
           :/::::-` `ssysssooooo+////:::::/::::::::::::::::::::::::::::://o/::::/:::::::/.          
             ``     :+yoooossssossooosoo++///:/:::::::::::::::::///+ooooosyyo/::/:::::::+`          
                 `  :+yoooossoooossssssssyyyyyyssoooooooooooooossyssoooo++//+y+/::::::::/           
                    `+/oo++/sooooooooooooooooy++++ooo+++++ooo+++////////////o/ .:/::::/:`           
                     :::::::+++++++++++++++++o//////////////////////////////+     `...`             
...
contract WaterDaniel is ERC20, ERC20Burnable, AccessControl {
    bytes32 public constant OWNER_ROLE = keccak256("OWNER_ROLE");
    uint256 public constant DENOMINATOR = 100;
    uint256 public tokenThreshold = 100 * 10 ** decimals();
    uint256 public fundingFee = 100;
    ...
    constructor() ERC20("WaterDaniel", "WATER DANIEL IS A TOKEN MADE BY MY AUTISTIC 7 YEAR OLD BROTHER"){

        _mint(msg.sender, 108679 * 10 ** decimals());
    ...
    function _addPair(address pair, address router, address base) public onlyRole(OWNER_ROLE){
    ...
    function setFundingWallet(address payable _address) public virtual onlyRole(OWNER_ROLE){
    ...
    function _taxTransfer(
        ...
        if (isTaxed(sender) == false || isTaxed(recipient) == false) {
