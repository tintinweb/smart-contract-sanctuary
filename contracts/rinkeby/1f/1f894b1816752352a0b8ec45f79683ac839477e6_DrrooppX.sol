...
// File: contracts/VRF/SafeMathChainlink.sol
...
// File: contracts/Drroopp.sol


pragma solidity 0.8.3;


contract DrrooppX is ERC721Enumerable, IERC2981, Ownable, VRFConsumerBase {
    uint256 internal constant _maxUniqly = 110; //TODO
    ...
    */
        ...
        returns (bytes32)
    {
        ...
        require(address(this).balance >= 0.1 ether, "0.1 ETH balance required"); //TODO
        require(
    ...
    function _isWinner(uint256 id) internal view returns (bool) {
        ...
        uint256 result =
            (uint256(keccak256(abi.encodePacked(id, randomResult)))) % 110; //TODO
        if (result <= 20) return true; //TODO
        return false;
    }
    ...
    function collectPrize(uint256 _tokenId) external {
        ...
        payable(msg.sender).transfer(0.1 ether); //1 ETH //TODO
    }

    //TODO getAllWiners array
    ...
    // restrict burning with save data for owner
    //TODO // Add additional event Claim (indexed id, string Name);
    function burn( uint256 _tokenId, string memory _claimersName, bytes memory _signature )
        external
    {
        //TODO require konkurs 
    ...
    */
    ...
    // up to 10% as per
    //TODO
    function setRoyaltyFee(uint256 _rate) external onlyOwner {
        require(_rate < 10000000, "Invalid rate");
        ROYALTY_FEE = _rate;
    }
