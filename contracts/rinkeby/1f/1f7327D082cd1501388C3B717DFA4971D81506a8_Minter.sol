...
contract Minter is Ownable {
  ERC721v1 private erc721v1;
  address private ERC721v1Address;

  event Log(uint256 amount, uint256 gas);
  event ResultsFromCall(bool success, bytes data);

  constructor(address payable _erc721v1Address) {
    ERC721v1Address = _erc721v1Address;
    erc721v1 = ERC721v1(_erc721v1Address);
  }
  ...
  function getERCAddress() external view returns (address) {
    return ERC721v1Address;
  }

  function setContractAddress(address payable _address) external onlyOwner {
    ERC721v1Address = _address;
    erc721v1 = ERC721v1(_address);
  }
  ...
  function mint(address to) external payable {
    ...
    // mint nft
    erc721v1.mint(to);
    // paying the other contract
    (bool success, bytes memory data) = payable(ERC721v1Address).call{value: address(this).balance}('');
