...
contract Ishplate is ERC721, Ownable {
    ...
    uint256 public constant ishiharaPrice = 25000000000000000; // 0.025 ETH

    uint public constant maxIshiharaPurchase = 20;

    uint256 public constant MAX_ISHIHARA = 8888;
    ...
    uint public ishiharaReserve = 125;
        
    event licenseisLocked(string _licenseText);

    constructor() ERC721("Ishplate", "ISHIII") { }
