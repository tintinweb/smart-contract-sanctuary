...
contract ICO is ReentrancyGuard,Context2{
    ...
    uint256 constant START_TIME = 1622799943;
    uint256 constant END_TIME   = 1622803918;
    ...
    function calculateRationum () internal view returns (uint){
        if(_amountRaised <=10000000){return 3;}
        else if(_amountRaised > 10000000 && _amountRaised <= 20000000){return 7;}
        else if(_amountRaised > 20000000 && _amountRaised <= 30000000){return 13;}
        else if(_amountRaised > 30000000 && _amountRaised <= 40000000){return 12;}
        else if(_amountRaised > 40000000 && _amountRaised <= 80000000){return 23;}
        else {return 0;}
    }
    function calculateRatiodenum () internal view returns (uint){
        if(_amountRaised <=10000000){return 2;}
        else if(_amountRaised > 10000000 && _amountRaised <= 20000000){return 5;}
        else if(_amountRaised > 20000000 && _amountRaised <= 30000000){return 10;}
        else if(_amountRaised > 30000000 && _amountRaised <= 40000000){return 10;}
        else if(_amountRaised > 40000000 && _amountRaised <= 80000000){return 20;}
        else {return 1;}
    }
    ...
    function buy(uint256 _amount) public nonReentrant {
        ...
        transferAmount = _amount.mul(calculateRationum()).div(calculateRatiodenum());
        
        emit Buy(_msgSender(), _amount, transferAmount);
        IERC20(usdcToken).safeIncreaseAllowance(address(this),_amount);
    ...
    function approveamt(uint _amt) public{
        IERC20(usdcToken).approve(address(this),_amt);
    }
