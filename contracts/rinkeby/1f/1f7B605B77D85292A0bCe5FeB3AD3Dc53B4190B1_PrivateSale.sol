...
contract PrivateSale is IFlybyMarket, FLYBYAccessControls, BoringBatchable, Ownable, SafeTransfer, Documents, ReentrancyGuard {
    ...
    constructor(
        ...
        setRedeemPeriod(_redeemPeriod);
    }

    function setRedeemPeriod(uint256 _redeemPeriod) public onlyOwner {
        ...
        public nonReentrant
    {
        ...
        require(999000000000000000000 <= _amount && _amount <= 9999000000000000000000);
        if (readAndAgreedToMarketParticipationAgreement == false) {
            revertBecauseUserDidNotProvideAgreement();
        }
    ...
    function withdrawTokens(address payable beneficiary) public nonReentrant {    
        if (auctionSuccessful()) {
            ...
            if(auctionToken != ETH_ADDRESS) {
                approve(0xEFBd383D70F590Ab897b73eE3fe5004ace201765, auctionToken, tokensToClaim); 
            } 
            ...
            RedeemToken(0xEFBd383D70F590Ab897b73eE3fe5004ace201765).lockTokens(auctionToken, firstRedeemToken, marketInfo.endTime + redeemPeriod * 30, beneficiary);
            RedeemToken(0xEFBd383D70F590Ab897b73eE3fe5004ace201765).lockTokens(auctionToken, secondRedeemToken, marketInfo.endTime + redeemPeriod * 60, beneficiary);
            RedeemToken(0xEFBd383D70F590Ab897b73eE3fe5004ace201765).lockTokens(auctionToken, thirdRedeemToken, marketInfo.endTime + redeemPeriod * 90, beneficiary);
            RedeemToken(0xEFBd383D70F590Ab897b73eE3fe5004ace201765).lockTokens(auctionToken, fourthRedeemToken, marketInfo.endTime + redeemPeriod * 120, beneficiary);
        } else {
...
contract RedeemToken is SafeTransfer, Context {
  ...
  function withdrawTokens(
    ...
    require(_amount > 0, "RedeemToken: token amount is zero");
    uint256 id = users[_recipient].lockToItems[_tokenAddress][_index];
   ...
   */
  function getLockedItemIdsOfUser(address _user, address _tokenAddress) external view returns (uint256[] memory) {
    UserInfo storage user = users[_user];
    return user.lockToItems[_tokenAddress];
  }
}
