...
contract Waffles is ERC721Enumerable, Ownable {
    ...
    modifier onlyWhitelisted() {
        require(
            ...
            "Sorry, but this address is not on the whitelist. Please message us on Discord."
        );
        _;
    }
    ...
    /**
       WhiteList Addresses
      */
    function addAddressesToWhiteList(address[] memory addresses)
        public
        onlyOwner
    {
    ...
    function withdraw() public onlyOwner {
        ...
        payable(msg.sender).transfer((balance*33)/100);
        payable(msg.sender).transfer((balance*33)/100);
        payable(msg.sender).transfer((balance*34)/100);  
    }
     ...
     * Mint Waffles
     */
    function mintFromWhiteList(uint256 numberOfTokens)
        public
        payable
        onlyWhitelisted
    {
