  ...
  AddressBook
{
   ...
   */
  constructor(address deployer, IAddressRegistry _addressRegistry)
    ...
    ERC20(TOKEN_NAME, TOKEN_SYMBOL)
  {
    ...
    _mint(deployer, 3600 * 1e18);
    _marketingWallet = deployer;
     ...
     */
    // reverts if address is invalid
    _mint(deployer, 7500 * 1e18);
    _teamWallet = deployer;
