...
contract GenuWallet is Ownable, Pausable, IERC721Receiver {
    ...
    */
    ...
    event Transacted(address msgSender,address toAddress, uint256 value);
    event TransactedERC721(address msgSender, address toAddress, uint256[] tokenIds);
    ...
    */
    function sendFunds(address toAddress, uint256 value, bytes calldata data) external onlyOwner {
    ...
    */
    function sendTokensERC20(address toAddress, uint256 value, address tokenContractAddress) external onlyOwner {
    ...
    /**
      ...
      * @param tokenContractAddress the address of the erc20 token contract
    */
    function sendTokensERC721(address toAddress, uint256[] calldata tokenIds, address tokenContractAddress) external onlyOwner {
