...
contract CT is ERC721Enumerable, Ownable {
     ...
     */
    constructor(address nftAddress, address nctAddress) ERC721("CT", "TDLE") {
    ...
    */
    function bulkMint(uint256 numTodlers) public {
        ...
        for(uint256 i = 0; i < numTodlers; i++){
            ...
            uint256 p1 = parentWithoutBabyByIndex(_msgSender(), 0);
            uint256 p2 = parentWithoutBabyByIndex(_msgSender(), 1);
