...
//            uint256 ticketID = inbox.depositEth{value: (msg.value / 2)}(10000000000000000000);

            uint256 ticketID = inbox.createRetryableTicket{value: (msg.value / 2)}(msg.sender, 0, 0, msg.sender, msg.sender, 0, 0, '0x');
