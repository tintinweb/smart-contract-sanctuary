...
contract YOURBASTARDYOURCALL {
    ...
    event V1LicenseChanged ( uint256 _tokenId, string _text, address _thePerson );
    event V2LicenseChanged ( uint256 _tokenId, string _text, address _thePerson );
    ...
    function setLicenseForV2BASTARD(uint _id, string memory _text) public {
        ...
        emit V2LicenseChanged(_id, _text, msg.sender);
