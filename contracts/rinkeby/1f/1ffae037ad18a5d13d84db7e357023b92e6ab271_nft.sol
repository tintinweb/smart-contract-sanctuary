...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        unrevelead = true;
        unreveleadURI = "ipfs://QmXjmH4mmHEXk9e6744Zuvq5JLSFPGvc3NkLfa4ddycpkU/hidden.json";
    }
...
contract nft is ERC721, Ownable {
    ...
    address payable public projectAddress = payable(0xC84305CE347FD912B3ddeFBaA7FD731A329A81A6);
    ...
    constructor(string memory nombre, string memory simbolo) ERC721(nombre, simbolo) {
        numberOfTokens = 0;
        baseURI = 'ipfs://QmQCwoHJaUR28Qins4Wi88ioT37DYXNmkMJZvHxkx1Ts9j/';
        maxTokens = 6666;
