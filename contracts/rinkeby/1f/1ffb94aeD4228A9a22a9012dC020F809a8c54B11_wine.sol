...
contract wine is Context, IERC20, Ownable {
    ...
    uint256 private _taxFee = 1; // 7% reflection fee for every holder
    uint256 private _charityFee = 17; // 13% charity
    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousCharityFee = _charityFee;

    address payable public _charityWalletAddress = payable(0x8B9B8cF6BB2E85f4C5f6843F858F7d6f7EE67378);
