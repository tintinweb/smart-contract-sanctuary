...
contract Catnip is Context, IBEP20, Initializable {
    ...
    function initialize() public initializer {
        ...
        tokenSymbol = "NIP4";        //CHANGEIT - Change the NAme to the PRoduction one NIP
        tokenName = "Catnip4";       //CHANGEIT - Change the NAme to the PRoduction one Catnip
        MAXintNum = ~uint256(0);
    ...
    function presaleBuy(uint256 amountOfBNBToInput, uint256 keyCode) external {
        ...
        uint256 truePreSaleRate = preSaleRate.div(1000);
        uint256 amountOfNIPtoGive = howMuchMoneyInput.div(truePreSaleRate);
