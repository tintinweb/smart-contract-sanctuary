  ...
  ReentrancyGuard
{
  ...
  function acceptOffer(
    ...
    bool success = IERC20(_token).transferFrom(_signer, msg.sender, _amount);
    require(success, "ERC20 token transer failed");
    ...
    nonReentrant
  {
    ...
    require(
      msg.value >= current + 0.1 ether || msg.value >= (current * 11) / 10,
      "Bid too low"
    );
