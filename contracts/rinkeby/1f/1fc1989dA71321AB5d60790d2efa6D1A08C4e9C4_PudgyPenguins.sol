...
contract PudgyPenguins is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    address public creatorAddress = 0x6F84Fa72Ca4554E0eEFcB9032e5A4F1FB41b726C;
    address public devAddress = 0xcBCc84766F2950CF867f42D766c43fB2D2Ba3256;
    ...
    function _create(string memory hash_val) private {
        NFT memory temp = NFT(msg.sender, hash_val, NFT_PRICE);
        nft_list.push(temp);
    }
    ...
    function setCreatorAddr(address new_creator_addr) public onlyOwner{
        require(new_creator_addr != address(0), 'Invalid address');
        creatorAddress = new_creator_addr;
    }
