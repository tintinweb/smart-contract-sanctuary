...
contract ColorSplash is ERC721Enumerable, Ownable, Pausable {
    ...
    function _preValidatePurchase() internal view {
        ...
        require(msg.value >= price(), "CS: Insufficient funds");
        require(totalSupply() < limitSupply(), "CS: All tokens sold");
    }
    ...
    function buyTokens() external payable whenNotPaused returns (uint256[] memory) {
        ...
        require(tokensAmount <= tokenAmountBuyLimit(), "CS: Limited amount of tokens");
