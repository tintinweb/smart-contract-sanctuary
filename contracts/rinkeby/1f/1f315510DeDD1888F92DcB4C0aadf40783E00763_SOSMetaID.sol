...
contract SOSMetaID is Ownable, EIP712, ERC721Enumerable {
    ...
    // Record for tokenId
    mapping(uint256 => uint256) public sosToMetaId;
    mapping(uint256 => uint256) public metaIdToSos;
    ...
    function mint(
        ...
        sosToMetaId[_tokenId] = newTokenId;
        metaIdToSos[newTokenId] = _tokenId;
