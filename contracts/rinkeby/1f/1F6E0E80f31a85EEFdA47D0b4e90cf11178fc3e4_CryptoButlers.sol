...
contract CryptoButlers is ERC721, AccessControl, Pausable, Ownable {
    ...
    uint256 private _saleStart = 20000000;
    uint256 private _whitelistSaleStart = 20000000;
    ...
    function validateMint(uint256 _value, uint256 _count) public view{
        require(!paused(), "Sale paused");
        require(_count <= _maxMint, "Exceeds number");
        require(_value <= totalPrice(_count), "Value below price");
    }

    function recruitButler(uint256 _count) public payable {
        validateMint(msg.value, _count);
