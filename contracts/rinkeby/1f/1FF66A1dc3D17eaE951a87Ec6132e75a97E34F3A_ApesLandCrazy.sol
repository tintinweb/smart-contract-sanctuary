  ...
  UUPSUpgradeable
{
  ...
  */
  ...
  function initialize() public initializer {
    ...
    aGoldAddress = address(0xB3B1c5ff9016Ba6eb375E7D0e2E98bc95d1075df);
  ...
  */
  function claimRewards(uint256 genericType) public {
    ...
    for (uint256 index = 0; index < totalApesByType; index++) {
      uint256 apeId = addressToApesType[sender][genericType][index];
    ...
    // for (uint256 index = 0; index < totalApesByType; index++) {
      apesInstance.transferFrom(
        address(this),
        sender,
        addressToApesType[sender][genericType][0]
      );
      apesAtAddress[addressToApesType[sender][genericType][0]] = address(0x000);
      addressToApesType[sender][genericType].pop();
    // }
  }
