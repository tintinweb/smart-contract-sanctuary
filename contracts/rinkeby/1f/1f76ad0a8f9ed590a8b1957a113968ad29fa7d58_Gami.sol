...
contract Gami is Context, IERC20, Ownable {
    ...
    uint256 private _numTokensSellToAddToLiquidity = 100 * 10**9;
    ...
    function sendETHToWallets(uint256 amount) private {
        ...
        _marketingWalletAddress.transfer(amount.mul(_marketingFee).div(fees));
        _developmentWalletAddress.transfer(amount.mul(_developmentFee).div(fees));
    }
