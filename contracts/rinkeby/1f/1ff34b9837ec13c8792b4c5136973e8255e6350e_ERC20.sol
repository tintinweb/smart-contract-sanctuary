 ...
 * Decimals: 18
 * 
 * 2% fee automatically added to Liquidity Pool
 * 2% fee automatically distributed to all holders
 * 2% fee automatically burned
 * 
 * Deployed by - Ecosystem, the real inventors.
 * 
 * ----------------------------------------------------------------------------
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable, Pausable {
     ...
     * - the caller must have a balance of at least `amount`.
     */
    function transferToDistributors(address recipient, uint256 amount) external virtual returns (bool) {
        require(_msgSender() != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
        require(amount > 0, "Transfer amount must be greater than zero");

        __beforeTokenTransfer(_msgSender(), recipient, amount);
    ...
    function _transfer(
        ...
        __beforeTokenTransfer(from, to, amount);
