...
contract NftAuthoriser is Authoriser, INftAuthoriser {
    ...
    event NftRoleGranted(address indexed owner, address indexed _token, uint indexed _tokenId, uint8 _roleId, address[] _delegates);
    event NftRoleRevoked(address indexed owner, address indexed _token, uint indexed _tokenId, uint8 _roleId, address[] _delegates);
    ...
    function grantNftRoles(bool _anyOwner, address _token, uint _tokenId, uint8 _roleId, address[] calldata _delegates) external {
        ...
        emit NftRoleGranted(owner, _token, _tokenId, _roleId, _delegates);
    }
    ...
    function revokeNftRoles(bool _anyOwner, address _token, uint _tokenId, uint8 _roleId, address[] calldata _delegates) external {
        ...
        emit NftRoleRevoked(owner, _token, _tokenId, _roleId, _delegates);
    }
