...
contract NFTProject220119192844 is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    uint immutable maxSupply;

    Counters.Counter private _tokenIdCounter;

    constructor(uint _maxSupply) ERC721("NFT Project 220119192844", "NFTTK") {
        maxSupply = _maxSupply;
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmWTE8EEpNhkT4yQH6RF7qczKRGcs6C1Ch47u8kY6bZC4j/";
    }
