...
contract MekiCats is ERC721URIStorage, Ownable, ERC721Enumerable {
   ...
   //ipfs://QmYzB2Ei7uXLrE5NPv2dUfbsK6jBWVsiarSetAWoKhr2N1/
   function mintURI(uint256 _mintAmount) public onlyOwner {
       ...
       // Minting used for Trippy Hippies (it works fine)
       for (uint256 i = 1; i <= _mintAmount; i++) {
           _safeMint(owner(), (supply + i));
           _setTokenURI((supply + i), "1");
       }
   }
 
   function setReadyNFTs(uint256 _newReadyNFTs) public onlyOwner {
       // supply = 0
       // _newReadyNFTs = 100
       require(
