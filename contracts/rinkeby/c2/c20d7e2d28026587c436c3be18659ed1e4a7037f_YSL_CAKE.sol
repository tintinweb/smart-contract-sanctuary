...
contract YSL_CAKE is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x30A57b3aa80A0668A59f9548E7Ee7f00D99081F4); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "YSL CAKE"; // token name
    string private _symbol = "YSL CAKE"; // token symbol
    uint8 private _decimals = 18; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 9000000000 * 10**1 * 10**_decimals;
    ...
    uint256 public _marketingBNBFee = 160; // marketing BNB fee
    ...
    uint256 public _minTokensSwapToAndTransferTo = 90000000 * 10**1 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
