...
/** 
 *  SourceUnit: d:\GitWork\RoyalFruitNFT\contracts\contracts\KrownCanvasMarket.sol
*/
...
contract KrownCanvasNFT is ERC721 {
...
////import "./KrownCanvasNFT.sol";
////import "./IBEP20.sol";

interface IKrownCanvasNFT {
...
contract KrownCanvasMarket is Ownable, ERC721Holder {
    using SafeMath for uint256;
	using EnumerableSet for EnumerableSet.AddressSet;
	...
	IKrownCanvasNFT public nftCollection;
	...
	uint256 public totalEarning; /* Total KrownCanvas Token */
	uint256 public totalSwapped; /* Total swap count */

	/** Events */
    event ItemListed(uint256 id, uint256 token_id, uint256 price, address creator, address owner, uint256 creatorFee);
	...
	constructor (address _governanceToken, 
		...
		nftCollection = IKrownCanvasNFT(_nftCollection);	
	}
    ...
    function list(uint256 _token_id, uint256 _price) OnlyItemOwner(_token_id) public {
    ...
    function delist(uint256 _id) external {        
        ...
        nftCollection.safeTransferFrom(address(this), msg.sender, pairs[_id].token_id);        
    ...
    function buy(uint256 _id) external ItemExists(_id) {
		...
		// transfer KrownCanvas token to adminAddress
		...
		// transfer KrownCanvas token to owner
		...
		nftCollection.safeTransferFrom(address(this), msg.sender, pair.token_id);
