...
contract ArcadeLife is ERC721, ERC721Enumerable, Pausable, Ownable {
    using SafeMath for uint;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    string private _contractBaseURI;
    address private _withdrawalAddress = 0x8D89C34710950649601AE8E24068AF0D5F3053B5;
    ...
    uint256 public txGiveAwayLimit = 20;

    constructor() ERC721("Arcade Life V3", "ARLF") {}
    ...
    function readMintPrice() public view returns (uint256) {
        return _mintPrice;
    }
    ...
    function withdraw() public onlyOwner payable {
        require(payable(_withdrawalAddress).send(address(this).balance));
    }
