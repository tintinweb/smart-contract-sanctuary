...
contract TheColors is ERC721, Ownable {
    string public TheColors_PROVENANCE = "";
    ...
    function tokenURI(uint256 tokenId) public view virtual override(ERC721) returns (string memory) {
        ...
        if (startingIndex > 0) {
            sequenceId = int((tokenId + startingIndex) % MAX_COLORS);
        } else {
            sequenceId = -1;
        }

        return string(abi.encodePacked(base, sequenceId));
    }
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        TheColors_PROVENANCE = provenanceHash;
    }
