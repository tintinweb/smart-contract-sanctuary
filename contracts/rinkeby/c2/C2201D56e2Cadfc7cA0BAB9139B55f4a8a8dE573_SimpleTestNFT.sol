...
contract SimpleTestNFT is ERC721URIStorage, AccessControl {
    ...
    //For Dynamic NFTs external APIs will be used, update tokenURI is required in case API dies, we can update data source.
