...
contract Goald721 {
     ...
     * @dev See {IERC721-safeTransferFrom}.
     */
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) external virtual {
        _transfer(from, to, tokenId);
...
contract GoaldFlexibleDeployer {
    address constant DAO_ADDRESS = 0xe66872CF641a1fa145b2C62d2f3734E600916e5b;
...
contract GoaldFlexible is Goald721 {
    ...
    ) Goald721("Goald BTC", "GOALD", goaldId) public {
