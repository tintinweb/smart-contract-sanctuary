...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    string internal deployNetwork = "KOVAN"; //"KOVAN", "RINKEBY", "POLYGONTEST", "POLYGON"
    ...
    function getPrice() public view returns (uint256) {
        (, int256 price, , , ) = ethUsdPriceFeed.latestRoundData(); //you can eliminate return values that you don't need, just use blanks as spaceholders
        return uint256(price * 10000000000); //type cast int256 to uint256
    }
