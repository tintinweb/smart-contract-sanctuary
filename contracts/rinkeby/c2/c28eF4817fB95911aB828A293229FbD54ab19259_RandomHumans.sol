...
contract RandomHumans is ERC721, Ownable {
    using Strings for uint256;
    ...
    // withdraw address
    address t1 = 0x39C6F6312a2759084429dCf598f48D9971fC3F26;
    ...
    function mintHuman() public payable {
    ...
    function mintID(string memory tokenURI) public returns (uint256) {
        uint256 newItemId = tokenCounter;
