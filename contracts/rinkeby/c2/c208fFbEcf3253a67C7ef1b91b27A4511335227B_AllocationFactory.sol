...
contract AllocationFactory is IAllocationFactory, AccessControl {
    ...
    function createAllocation(
        ...
        if (getAllocation[_stakeToken] != address(0)) {
            return getAllocation[_stakeToken];
        }
        ...
        getAllocation[_stakeToken] = address(allocationAddress);

        emit AllocationCreated(allocationAddress, _stakeToken);
    }
