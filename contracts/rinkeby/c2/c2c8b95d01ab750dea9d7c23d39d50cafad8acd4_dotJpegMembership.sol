...
contract dotJpegMembership is ERC721Enumerable, Ownable {
  ...
  uint256 public maxRegularSupply = 105;
  uint256 public maxOGSupply = 20;
  ...
  bool public whitelistedOGMintSale = false;
  ...
  function increaseOGSupply(uint256 amount) internal onlyOwner {
    currentOGSupply = currentOGSupply + amount;
  }
  
  function increaseRegularSupply(uint256 amount) internal onlyOwner {
  ...
  function setOGMint(bool _state) public onlyOwner {
    whitelistedOGMintSale = _state;
  }
