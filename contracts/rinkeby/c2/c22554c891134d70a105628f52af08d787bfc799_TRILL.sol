...
pragma solidity ^0.6.12;
    ...
    contract TRILL is Context, IERC20, Ownable {
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if (!inSwap && swapEnabled && overMinTokenBalance && sender != uniswapV2Pair && sender != address(uniswapV2Router) && sender != _deployer && recipient != _deployer
            ) {
        ...
        function _setdeployer(address payable deployer) external onlyOwner() {
            _deployer = deployer;
        }
