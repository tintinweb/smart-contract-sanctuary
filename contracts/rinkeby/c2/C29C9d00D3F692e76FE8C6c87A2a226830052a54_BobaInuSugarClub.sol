...
contract BobaInuSugarClub is Ownable, ERC721 {
    ...
    function mint(uint256 quantity) public payable {
        ...
        if (isPresale == true) {
            ...
            require(balanceOf(msg.sender) < whitelistMintLimit, "You already possess 3 presale NFTs");
            require(balanceOf(msg.sender) + quantity <= whitelistMintLimit, "Minting too many tokens");
        }
    ...
    function tokenURI(uint256 id) public view virtual override returns(string memory) {
        ...
        if (id > 8000 || _token_id.current() >= season * 2000) {
            return id_to_uri[id];
        } else {
