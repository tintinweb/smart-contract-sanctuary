...
contract ControlledToken is ERC20, ControlledTokenInterface {
    ...
    constructor(string memory _name,string memory _symbol,TokenControllerInterface _controller)public ERC20(_name,_symbol){
...
contract Ticket is ControlledToken {
  ...
  constructor (TokenControllerInterface _controller)public ControlledToken("4PlayTicket","4PT",_controller){
