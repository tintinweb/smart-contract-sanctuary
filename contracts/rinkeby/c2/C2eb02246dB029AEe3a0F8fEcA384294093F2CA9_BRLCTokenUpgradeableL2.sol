...
/**
 * @title BRLCTokenUpgradeableL2
 * @dev An BRLCTokenUpgradeableL2 is an ERC20 implementation which represents L1 asset deposited into L2,
 * minting and burning on deposits and withdrawals.
 *
 * `BRLCTokenUpgradeableL2` implements the IL2StandardERC20 interface provided by optimism to link into
 * a standard L1 deposit contract while using the `ERC20`implementation I as a developer want to use.
 *
 * Compiler used: optimistic-solc
 * Runtime target: OVM
 */
contract BRLCTokenUpgradeableL2 is BRLCTokenUpgradeable, IL2StandardERC20 {
    ...
    function initialize(
        ...
        __BRLCTokenL2_init(l2Bridge_, l1Token_, name_, symbol_, decimals_);
    }

    function __BRLCTokenL2_init(
        address l2Bridge_,
        address l1Token_,
        string memory name_,
        string memory symbol_,
        ...
        __BRLCTokenL2_init_unchained(l2Bridge_, l1Token_);
    }

    function __BRLCTokenL2_init_unchained(address l2Bridge_, address l1Token_) internal initializer {
        l2Bridge = l2Bridge_;
        l1Token = l1Token_;
    }
