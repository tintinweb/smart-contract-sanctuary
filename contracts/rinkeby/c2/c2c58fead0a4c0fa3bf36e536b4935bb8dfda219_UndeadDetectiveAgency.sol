...
contract UndeadDetectiveAgency is ERC721, Ownable {
    ...
    function mintWhitelistNFT(uint numberOfTokens, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v, _r, _s) public payable {
    ...
    modifier onlyValidAccess(uint8 _v, bytes32 _r, bytes32 _s){
        require(isValidAccessMessage(msg.sender, _v, _r, _s), "NO VALID ACCESS");
        _;
    }
