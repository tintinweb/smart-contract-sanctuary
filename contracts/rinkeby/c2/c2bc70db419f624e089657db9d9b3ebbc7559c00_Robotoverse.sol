...
// File: contracts/Robotoverse.sol
...
contract Robotoverse is ERC721Enumerable, Ownable{
    ...
    /* states */
    bool public batchOneActive = false;
    ...
    /* whitelist params */
    uint256 public maxWhitelistAmount = 10;
    ...
    function mintNFT(address _to, uint256 _mintAmount) public payable {
        ...
        if(tokenCounter >= 0 && tokenCounter  + _mintAmount <= batchOneMembers) {
            ...
            if(tokenCounter + _mintAmount <= batchOneMembers + batchTwoMembers) {
                ...
                require(msg.value >= batchTwoPrice * _mintAmount, "Amount of ETH is to less");
                toPay = batchOnePrice * _mintAmount;
            } else {
                ...
                require(msg.value >= batchThreePrice * _mintAmount, "Amount of ETH is to less");
                toPay = batchOnePrice * _mintAmount;
                } else {
