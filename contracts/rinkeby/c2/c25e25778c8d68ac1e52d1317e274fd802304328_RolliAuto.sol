...
contract RolliAuto is Context, IERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x000000000000000000000000000000000000dEaD; // initially set as dead address
    ...
    string private _name = "RolliAuto Inc.";
