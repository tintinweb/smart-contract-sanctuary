...
contract ERC20 is Context, IERC20, Ownable {
  ...
  address public marketingAddress = 0x2d1B8ba4a49C0338A301BD16ff43E4A6d2604dc3;
  ...
  function _transfer(
    ...
    if (
      ...
      _amountToRecipient = _takeFeeOnSwap(recipient, amount);
    }
  ...
  function _takeFeeOnSwap(address _to, uint256 _amount)
    private
    returns (uint256)
  {
    ...
    uint256 _contractTokenBalance = _balances[address(this)];

    // sell
    if (!inSwapAndLiquify && _to == uniswapV2Pair) {
      if (
