...
contract BULL is ERC721Enumerable, Ownable  {
    ...
    IERC20 public rewardToken = IERC20(0xB5726025C331b29018eB68B10D95C48C6581e893);
    ...
    // Token Detail
    mapping( uint256 => BULLDetail) private _bullDetails;
    ...
    function reserveTokens() public onlyOwner {
        ...
        for (i = 1; i <= 20; i++) {
            ...
            if (tokenId <= MAX_TOKENS) {
                ...
                _bullDetails[tokenId] = BULLDetail(first_encounter);
    ...
    * Mint BULL
    */
    function mintBULL(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_TOKENS, "Purchase would exceed max supply of BULL");
   ...
   /**
     ...
     */
    function getBullDetail(uint256 tokenId) public view returns(BULLDetail memory detail) {
        require(_exists(tokenId), "Token was not minted");

        return _bullDetails[tokenId];
    }
