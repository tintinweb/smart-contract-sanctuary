    ...
    ERC721CustomEnumerable
{
    ...
    uint256 public constant GIVEAWAY_TOKENS = 500;
    Counters.Counter private _giveawayCounter;
    uint256 public constant TEAM_RESERVE_TOKENS = 50;
    ...
    {
        require(
            _purchaseCounter.current() + numberOfTokens <= MAX_TOKENS - GIVEAWAY_TOKENS - TEAM_RESERVE_TOKENS, 
    ...
    function giveaway(address receiver)
        external
        onlyOwner
        whenNotPaused
        ensureAvailability
    ...
    function teamMint(address receiver)
        external
        onlyOwner
        whenNotPaused
        ensureAvailability
    ...
    function purchasedCount() external view returns (uint256) {
...
abstract contract ERC721CustomEnumerable is ERC721 {
    ...
    /**
     * @dev {IERC721Enumerable-totalSupply} is replaced with currentSupply because method clashes with 
     * totalSupply in {WithLimitedSupply-totalSupply}
     */
