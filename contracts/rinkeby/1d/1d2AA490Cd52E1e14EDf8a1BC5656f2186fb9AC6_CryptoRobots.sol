...
// input  /mnt/e/Projects/RobotNFT/SolidityProject/contracts/CryptoRobots.sol
// flattened :  Tuesday, 07-Sep-21 04:24:19 UTC
library Strings {
...
contract CryptoRobots is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    address public constant creatorAddress = 0x4db825224DfAd84E8B68c3d196eDE93EB4ebb872;
    //address public constant devAddress = 0x6f095133E814200fcf06bC185569544249Bd1713;
    string public baseTokenURI;

    event CreateCryptoRobot(uint256 indexed id);
    event AttributeChanged(uint256 indexed _tokenId, string _key, string _value);

    constructor(string memory baseURI) ERC721("CRYPTO ROBOTS", "CRYPTOROBOTS") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
    ...
    function changeAttribute(uint256 tokenId, string memory key, string memory value) public payable {
        address owner = ERC721.ownerOf(tokenId);
        require(_msgSender() == owner, "This is not your CryptoRobot.");
