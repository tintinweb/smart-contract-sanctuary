...
// File: contracts/IclearlyNotNFT.sol
...
abstract contract IclearlyNotNFT is ERC721Enumerable {
...
// File: contracts/clearlyNotNFT.sol
...
contract clearlyNotNFT is IclearlyNotNFT, Ownable, ReentrancyGuard {
    ...
    constructor(string memory baseURI) ERC721("Clearly Not NFT", "CNFT") {
        setBaseURI(baseURI);
    }
