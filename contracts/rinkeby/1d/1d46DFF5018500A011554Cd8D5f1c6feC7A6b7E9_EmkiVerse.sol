...
contract EmkiVerse is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRICE = 0.08 ether; //0.08 ETH
    address withdrawalAddress;

    event PauseEvent(bool pause);
    event welcomeToEmkiVerse(uint256 indexed id);
    ...
    constructor(
        ...
        MAX_ELEMENTS = maxNftSupply;
        setBaseURI(baseURI);
        withdrawalAddress = 0x7579232017e86915Ff546D4B77a298b57B80Ac2f;
    }
    ...
    function _mintAnElement(address _to, uint256 _tokenId) private {
        ...
        emit welcomeToEmkiVerse(_tokenId);
    }
    ...
    function reserveEmki() public onlyOwner {
