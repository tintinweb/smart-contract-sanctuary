...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function endLottery() public onlyOwner {
        ...
        bytes32 requestId = getRandomNumber(); // The random number will be sent via the callback fulfillRandomness
        emit RequestedRandomness(requestId);
    }

    function selectWinner(uint256 _idx) internal {
        recentWinner = players[_idx];
        ...
        override
    {
        ...
        selectWinner(_randomness % players.length);
    }
}