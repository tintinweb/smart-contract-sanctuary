...
contract SmolPunksTestFull is Ownable, ERC721 {
  ...
  uint32 public freeMintAmount = 666;
  uint8 public mintLimit = 3;
  bool public publicSaleState = false;

  constructor() ERC721("SmolPunksTestFull", "SMOLTEST") { 
  }
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    return string(abi.encodePacked(baseURI, Strings.toString(_tokenId), base_URI_tail));
  }
