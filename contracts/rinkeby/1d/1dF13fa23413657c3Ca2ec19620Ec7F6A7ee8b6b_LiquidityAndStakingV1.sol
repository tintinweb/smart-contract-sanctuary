...
contract LiquidityAndStakingV1 is OwnableUpgradeable {
    ...
    //     // DAIAddress = 0xa1633D089d0c613D9992C445832819e0b35c51a3;
    //     // PAXG_GAIN = [GainTokenAddress, PAXGAddress];
    //     // DAI_GAIN = [GainTokenAddress, DAIAddress];
    //    // pairCount = 1;
    //     GainAmount = 10000 * (10 ** 18);
    //     //OhmAddress = __OHM_Address;
    // }
    ...
    function initialize() public initializer {
        ...
        liquidityAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
        factory = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f;
        GainTokenAddress = 0x650ac42FD0A68e0e021e551E8df3A0d71248Dac3;
        GLWallet = 0x819704F4dd43c1c2D8890be1a44dEdb2caBE8647;
        // PAXGAddress = 0x6dE86BC1DE4BeC6213C127540B46E264B310C8CC;
        // DAIAddress = 0xa1633D089d0c613D9992C445832819e0b35c51a3;
        // PAXG_GAIN = [GainTokenAddress, PAXGAddress];
    ...
    function addLiquidityFromContract(
        ...
        // if(pairExists[GainTokenAddress][tokenAddress] == false){
        //     pairs storage data = pairAddresses[pairCount];
        //     data.id = pairCount;
        //     data.pairedAddress = tokenAddress;
        //     pairExists[GainTokenAddress][tokenAddress] == true;
    ...
    //     returns (bool)
    // {
    //     IStaking tokenAddress = IStaking(OhmAddress);
    //     tokenAddress.stakeOLY(amount);
    //     return true;
    // }

    // function unStaking(uint256 amount)
    //     external onlyOwner
    //     returns (bool)
    // {
    //     IStaking tokenAddress = IStaking(OhmAddress);
    //     tokenAddress.unstakeOLY(amount);
    //     return true;
    // }
}
