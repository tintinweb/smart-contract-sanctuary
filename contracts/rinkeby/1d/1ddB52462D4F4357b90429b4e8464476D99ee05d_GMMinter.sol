...
contract GMMinter is ERC721Enumerable {
    using Counters for Counters.Counter;
    
    Counters.Counter private _tokenIdCounter;
    uint256 public constant NFT_PRICE = 0.033 ether;
    uint256 public constant MAX_SUPPLY = 10000;
    uint256 public constant SALE_START = 1628126100;
    ...
    function mint(uint256 amount) public payable {
        ...
        require(_tokenIdCounter.current() < MAX_SUPPLY, "Sale has ended");
        ...
        uint256 firstMinted = _tokenIdCounter.current();
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmPv6bMCF3Jfsza4i7YjyAGX4adzqPzQ4eJp6Dwq1ghXCD/";
    }
}
