...
contract NFTAGOR is Ownable, ERC721 {
    using Strings for string;
    using SafeMath for uint256;

    constructor () ERC721("NFTAGOR" ,"NFTAGOR"){
    ...
    uint256 public priceMint5 = 5000000000000000000;
    uint256 public priceMint6 = 6000000000000000000;
    ...
    function setTaxes(uint _BMATax, uint _taxTax, uint _treasuryTax, uint _teamTax, uint _artistTax) public onlyOwner {
        BMATax = _BMATax;
        taxTax = _taxTax;
    ...
    function calculateDutchAuction() public view returns (uint256)  {
        uint256 price = mintCount <= 120 ? priceMint7 : 
        mintCount > 120 && mintCount <= 234 ? priceMint6 : 
        mintCount > 234 && mintCount <= 342 ? priceMint5 : 
        mintCount > 342 && mintCount <= 444 ? priceMint4 : 
        mintCount > 444 && mintCount <= 540 ? priceMint3 : 
        mintCount > 540 && mintCount <= 630 ? priceMint2 : priceMint1;
