 ...
 */
contract HaktAuctionHouse is IAuctionHouse, ReentrancyGuard {
    ...
    function getCurrentAuctionId() public view returns(Counters.Counter memory) {
        return _auctionIdTracker;
    }
