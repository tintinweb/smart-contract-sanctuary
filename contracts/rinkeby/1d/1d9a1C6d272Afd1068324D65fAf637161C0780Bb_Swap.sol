...
function exchange(
    ...
    uint256 valueOfQuoteAsset = (amountOfBaseAsset * decimalsOfQuoteAsset) / exchange_rate;

    // 1. Amount must be greater than 0
    require(valueOfBaseAsset > 0, "You need to send some asset to buy");
  ...
  function setExchangeRae(uint256 rate) public {
      exchange_rate = rate; 
  }
}