...
contract HashedHedge is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = .001 ether; // change price per unit
  ...
  uint256 public nftPerAddressLimit = 26;
