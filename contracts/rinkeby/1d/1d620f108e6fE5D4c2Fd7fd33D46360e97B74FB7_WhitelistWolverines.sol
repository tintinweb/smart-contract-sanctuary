...
contract WhitelistWolverines is ERC721, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public constant tokenPrice = 200000000000000000;
    uint public constant maxTokenPurchase = 1;
    uint256 public constant MAX_TOKENS = 4;
    mapping(address => uint256) private minted;
    
    
    constructor() ERC721("Whitelist Wolverines", "WW") { }
    ...
    function whitelistMint(uint256 numberOfTokens, bytes32[] memory proof) public payable nonReentrant {
