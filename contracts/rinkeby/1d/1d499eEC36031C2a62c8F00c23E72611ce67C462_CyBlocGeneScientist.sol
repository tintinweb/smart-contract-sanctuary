...
contract CyBlocGeneScientist {
    ...
    function generateGene(uint256 class, uint256[3] memory traits) public view returns (uint256) {
        ...
        uint256 newGenes = parseInt(newGenesString);
        return parseInt(newGenesString);
    ...
    function parseInt(string memory _string) public pure returns (uint256) {
