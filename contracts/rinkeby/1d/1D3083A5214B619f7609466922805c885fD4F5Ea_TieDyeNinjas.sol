...
contract TieDyeNinjas is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://tie-dye-ninjas.s3.eu-central-1.amazonaws.com/unrevealed/";
	string private _contractURI = "ipfs://QmQRm4cDvXJPtHYQgLQTQgK7p5UMetS72h2cihCPsYaS94";
	...
	function buy(uint256 amount) public payable nonReentrant {
		require(amount <= 15, "max 15 tokens");
