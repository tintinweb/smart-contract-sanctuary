...
contract OnChainXmasTree is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string[7] memory treeColAttr = ['Gorgeous Green','Snow White','Golden Sizzle','Alien Blue','Merry Red','Pink Berry','Icy Blue'];
        ...
        string[5] memory colsAttr = ['Red','Yellow','Green','Blue','No'];
        string[9] memory bgAttr = ['Sliver Clouds','Peachy Noon','Pink Dawn','Northern Lights','Morning Green','Lavender Dusk','Misty Blue','Stormy Grey','Night Sky'];  
