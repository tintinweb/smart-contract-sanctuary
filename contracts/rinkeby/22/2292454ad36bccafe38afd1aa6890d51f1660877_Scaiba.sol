...
/**
 * ScarShiba Official Contract
  Features:
   4% fee auto added to the liquidity pool
   4% fee auto distributed to all hodlers
   2% fee added to charity/marketing wallet for charitable giving/marketing 
   1% burnt
*/
...
contract Scaiba is Context, IERC20, Ownable {
    ...
    address payable charityWallet = 0xAaD5c453E5f3ad2af18a33D9508AaEA2238Bb3A1;
    address payable marketingWallet =
        0xcE144d1dA55B4F87439C06B1f1907502A7FA185C;

    uint8 private constant _DECIMALS = 4;
    uint256 private constant _DECIMALFACTOR = 10**uint256(_DECIMALS);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 9_999_999 * _DECIMALFACTOR;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    // 2% of the supply
    uint256 public _maxTxAmount = 1_000_000 * _DECIMALFACTOR;
    ...
    string private constant _name = "Scaiba";
    string private constant _symbol = "Scaiba";
    ...
    constructor() public {
        ...
        IUniswapV2Router02 _uniswapV2Router =
            IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // v2 testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 main 0x10ED43C718714eb63d5aA57B78B54704E256024E
