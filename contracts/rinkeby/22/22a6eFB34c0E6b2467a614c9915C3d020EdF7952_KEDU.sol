...
contract KEDU is ERC721Enumerable, Ownable {
    ...
    constructor (address _multivisa) ERC721("Keplers Civil Society", "KEDU"){
        baseURI = "https://gateway.pinata.cloud/ipfs/QmQXKtdMcLaiz3AFGCMTMiCVk2cxZjFJ46hwmKNEGwQJZS/";   // Placeholder
    ...
    function mint(uint numberOfMints) public payable {
        ...
        require(numberOfMints <= MINT_LIMIT,  "Specified Amount Over Max Mints Per Transaction Limit");
