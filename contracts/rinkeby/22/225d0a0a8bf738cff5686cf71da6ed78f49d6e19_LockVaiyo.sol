...
contract LockVaiyo is Ownable {
    ...
    uint256 public softCapEthAmount = 250 ether;
    uint256 public hardCapEthAmount = 350 ether;
    ...
    uint256 public totallockTime = 180 minutes;
    uint256 public minDepositAmount = 25 * (10 ** 9);
    ...
    function read() public view returns(uint256, uint256) {
        uint256 tokenamount = deposits[msg.sender];
        uint256 deposittime = totallockTime - deposittimes[msg.sender];
        return (tokenamount, deposittime);
    }

    function claimTokens() public view {
        require(deposits[msg.sender] > 0, "There are no deposited tokens for you.");
        require(now - deposittimes[msg.sender] > totallockTime, "Your tokens are locked now.");
        
    }

    function getBUSDAmount() public {
    }
    ...
    //     rewardTokenCount = 0.05 ether; // 20 tokens per BNB
