...
contract DHStaking is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Staked DeadHeads", "sDEAD") {
        addContract(0xC3F78f50222b3CAB2eD2F73D07Ed28131d1EBAA3, "", 1 ether);
    }
    ...
    function addContract(address contractAddress, string memory baseURI, uint stakeReward) public onlyOwner {
