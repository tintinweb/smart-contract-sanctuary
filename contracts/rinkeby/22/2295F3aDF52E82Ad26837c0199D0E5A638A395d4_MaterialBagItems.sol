...
contract MaterialBagItems is ERC1155 {
    ...
    //loot bag contract (RINKEBY TEST NET)
    IERC721 lootBag  = IERC721(0xF77Aa03Ac2ae97322323fd225f3D5196a779Df35);

    //material bag contract (RINKEBY TEST NET)
    IERC721 materialBag  = IERC721(0x1c4199c9e2d30C804952071170749425027384DD);
    ...
    /// @notice Claims an airdrop for a token owned by Loot Bag. The airdrop is then
    /// claimable by the owner of the reassembled pieces.
    function claimAirdropForLoot(ILootAirdrop airdrop, uint256 tokenId) external payable {
        airdrop.claimForLootBag{value: msg.value}(tokenId);
    }

    /// @notice Allows you to claim an airdrop that has already been claimed by Loot Bag
    ...
    function claimAirdrop(ILootAirdrop airdrop, uint256 tokenId) external {
        require(lootBag.ownerOf(tokenId) == msg.sender, "you do not own the loot for this airdrop");
    ...
    */
    ...
    function contractURI() external pure returns (string memory) {
      string memory json = '{"name": "MaterialBagItems", "description": "MaterialBagItems lets you unbundle your Material Bags into individual ERC1155 NFTs or rebundle items into their original Material Bags."}';
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '"description" : ', '"MaterialBagItems lets you unbundle your Material Bags into individual ERC1155 NFTs or rebundle items into their original Material Bags.", ',
