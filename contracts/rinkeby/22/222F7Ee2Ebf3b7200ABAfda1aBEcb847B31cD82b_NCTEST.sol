...
contract NCTEST is ERC721PresetMinterPauserAutoId, Ownable {
    ...
    uint256 public constant totalTokenToMint = 4221;
    ...
    modifier adminOnly() {
        require(
            ...
            "NovaCreed: caller is not an admin!"
        );
        _;
    }
    ...
    function createTokens(uint256 _howMany) external payable {
        ...
        require(_howMany <= howManyToMint,"NCToken: max tokens you can mint at once exceeded!, reduce your amount of tokens you want to mint");
        ...
        require(msg.value >= price.mul(_howMany),"NCToken: insufficient ETH to mint! Try minting less NFTs");
        ...
        adminOnly
    {
        ...
        require(
            ...
            "NCToken: purchase amount is greater than the token available!"
        );
