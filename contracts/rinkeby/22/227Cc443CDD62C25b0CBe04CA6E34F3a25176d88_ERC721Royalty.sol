...
import "./interfaces/LibRoyaltiesV1.sol";
import "./interfaces/AbstractRoyalties.sol";
    ...
    AbstractRoyalties
{
    ...
    string private _ipfsBaseURI = "http://staging.api.nifty.ideofuzion.com/nft/meta/";
    ...
    constructor() ERC721("ArtToken", "ART") {
        ...
        assetUri = "http://staging.api.nifty.ideofuzion.com/nft/meta/";
        ...
        returns (bool)
    {
        return
            ...
            interfaceId == type(RoyaltiesV1).interfaceId ||
   ...
   function royaltyInfo(uint256 _tokenId,uint256 _salePrice) external view override returns (address receiver,uint256 royaltyAmount)
    {
        ...
        return (receiver, (_salePrice * 100) / royaltyAmount);
    }

    

    //abstract royalties function override
    ...
    /**
    @dev function to get reyalties receipient and royalty value
    @param tokenId , id of the token to check royalites
     */
        ...
        returns (LibPart.Part[] memory)
    {
        ...
        return AbstractRoyalties.royalties[tokenId];
    }
...
interface RoyaltiesV1 {
    ...
    //fee basis points for ERC721 Token
