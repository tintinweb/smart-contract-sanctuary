...
contract HackerDaoNFT is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;

    constructor(string memory baseURI) ERC721("HackerDAO NFT", "HACKNFT") {
        setBaseURI(baseURI);
    }

    /// @dev allows owner to airdrop nfts to specified addresses
    ...
    function transferFrom(
        ...
        require(msg.sender == address(this), "ERC721: transfer caller is not this contract");
    ...
    ///@dev new token uri function TODO:
