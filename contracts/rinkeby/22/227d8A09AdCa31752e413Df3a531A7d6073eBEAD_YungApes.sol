...
contract YungApes is Ownable, ERC721Enumerable {
  ...
  function mintInternalPresale(address wallet, uint tokenId) internal {
    ...
    require(wallet == squidApeContract.ownerOf(tokenId), "You don't own the Squid Ape corresponding to that tokenID?!");
  ...
  function setSquidApeContract(address _contract) external onlyOwner{
    require (_contract != address(0), "Can't set Address 0 as contract address!");
    squidApeContract = IYungApe(_contract);
