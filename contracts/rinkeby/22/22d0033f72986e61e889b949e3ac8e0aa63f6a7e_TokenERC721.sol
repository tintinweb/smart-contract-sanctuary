...
contract TokenERC721 is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function safeMint(
        ...
        SpecialErc20Tokens[tokenId] = spErc20Addr;
        SpErc20MinBalances[tokenId] = spErc20MinBalance;
        NftExpirations[tokenId] = nftExpiration;
    }
    ...
    function burnExpiredToken(uint tokenId) public {
        if(isTokenExpired(tokenId)) _burn(tokenId);
    }
