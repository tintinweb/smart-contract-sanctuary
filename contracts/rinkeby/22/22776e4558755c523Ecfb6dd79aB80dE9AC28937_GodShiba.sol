...
contract GodShiba is ERC20, Ownable {
    ...
    uint16 public totalFees = liquidityFee + marketingFee + lotteryFee;
    ...
    function setLiquidityFee(uint8 value) external onlyOwner{
        liquidityFee = value;
        totalFees = liquidityFee + marketingFee + lotteryFee;
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            uint256 lotteryTokens = amount.mul(lotteryFee).div(totalFees);
