...
/**
 * @dev SVGNFT contract with on chain storage.
 */
contract SVGNFT is ERC721URIStorage {
    ...
    function formatTokenURI(string memory _imageURI) public pure returns (string memory) {
        ...
        string memory encodedURI = Base64.encode(bytes(abi.encodePacked('{"name": "SVG NFT", "description": "An NFT based on SVG!", "attributes": "", "image": "', _imageURI,'"}')));
        return string(abi.encodePacked(baseURI, encodedURI));
    }
}
