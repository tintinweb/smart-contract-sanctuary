...
contract LootZh is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private namePrefixes = [
        "\u75db\u82e6", "\u555f\u793a", "\u5927\u6c7a\u6230", "\u91ce\u7378", "\u5de8\u7378", "\u67af\u840e", "\u8840", "\u523a\u85e4", 
        "\u786b\u78fa", "\u6c88\u601d", "\u8150\u8089", "\u5927\u707d\u96e3", "\u5d4c\u5408\u9ad4", "\u6b7b\u5c4d", "\u58ae\u843d", "\u8a5b\u5492", 
        "\u6b7b\u4ea1", "\u60e1\u9b54", "\u60b2\u6158", "\u9f8d", "\u6050\u61fc", "\u5384\u904b", "\u5e7d\u6697", "\u8001\u9df9", "\u84bc\u5929", "\u547d\u904b", "\u4ec7\u6575", 
        "\u72c2\u98a8", "\u98df\u5c4d\u9b3c", "\u9ed1\u6697", "\u8c61\u5f62\u6587\u5b57", "\u9b54\u50cf", "\u51b7\u9177", "\u6068", "\u6d69\u52ab", "\u69ae\u8b7d", "\u6050\u6016", "\u50ac\u7720", 
        "\u6d77\u5996", "\u52c9\u5f37", "\u5927\u6f29\u6e26", "\u7cbe\u529b", "\u5947\u8e5f", "\u75c5\u614b", "\u907a\u5fd8", "\u731b\u653b", "\u75db\u82e6", 
        "\u6df7\u4e82", "\u9cf3\u51f0", "\u761f\u75ab", "\u61a4\u6012", "\u72c2\u559c", "\u5bc6\u8a9e", "\u9ab7\u9871", "\u592a\u967d\u795e", "\u5fc3\u9748", "\u60b2\u54c0", 
        "\u9748\u9b42", "\u98a8\u66b4", "\u66b4\u98a8\u96e8", "\u6298\u78e8", "\u5fa9\u4ec7", "\u52dd\u5229", "\u5f97\u86c7", "\u6e26\u6d41", "\u4e0d\u5e78", "\u72c2\u6012",
        "\u5149\u8292\u7684", "\u9583\u8000\u7684"  
    ];
    ...
    function pluck(uint256 tokenId, string memory keyPrefix, string[] memory sourceArray) internal view returns (string memory) {
        ...
        if (greatness > 14) {
            output = string(abi.encodePacked(suffixes[rand % suffixes.length], output));
        }
        if (greatness >= 19) {
            ...
            if (greatness == 19) {
                output = string(abi.encodePacked(suffixes[rand % suffixes.length], '\u300c', name[0], '', name[1], '\u300d', sourceArray[rand % sourceArray.length]));
            } else {
                output = string(abi.encodePacked(suffixes[rand % suffixes.length], '\u300c', name[0], '', name[1], '\u300d', sourceArray[rand % sourceArray.length], " +1"));
            }
        }
        return output;
    }
    ...
    constructor() ERC721("LootZh", "LOOTZH") Ownable() {}
}
