...
contract WonderWalls is ERC721Enumerable, Ownable {
	...
	constructor(string memory baseURI, string memory pass) ERC721("WonderWalls", "WWS")  {
		setBaseURI(baseURI);
		t1 = msg.sender;
		_pass = pass;
	...
	function mintWhaleWL(uint256 num, string memory pass) public payable {
		uint256 supply = totalSupply();
		require( _paused, "Whitelist sold out" );
		require( supply + num < 801 - _reserved, "Exceeds maximum supply" );
		require( msg.value >= _price * num, "Incorrect ether amount" );
