...
abstract contract MillionDollarsUtils is Aggregator, Ownable, RandomNumber {}
contract MillionDollarsMint is ERC721Enumerable, MillionDollarsUtils {
    ...
    function previewEthValue(int256 _ethprice) public view onlyOwner returns(int256){
      int256 latestPrice = _ethprice;

      int ethValue = ((1_000_000 * 10 ** 10) / latestPrice) * 10 ** 16; 
    ...
    // NOTE: Cannot withdraw until collection is sold out
    function withdrawAll() public onlyOwner soldOut {
      require(drawed, "Collection not drawed yet");
