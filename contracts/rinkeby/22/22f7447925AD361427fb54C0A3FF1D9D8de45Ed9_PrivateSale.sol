...
contract PrivateSale is IFlybyMarket, FLYBYAccessControls, BoringBatchable, SafeTransfer, Ownable, ReentrancyGuard {
    ...
    function _getFirstTimeRedeem() private view returns (uint256) {
        return firstTimeRedeem;
    }

    function _getNextTimeRedeem() private view returns (uint256) {
        return nextTimeRedeem;
    }
    ...
    function withdrawTokens(address payable beneficiary) public nonReentrant {    
        if (auctionSuccessful()) {
            ...
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), firstRedeemToken, marketInfo.endTime + _getFirstTimeRedeem(), beneficiary);
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), secondRedeemToken, marketInfo.endTime + _getFirstTimeRedeem() + _getNextTimeRedeem(), beneficiary);
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), thirdRedeemToken, marketInfo.endTime + _getFirstTimeRedeem() + 2 * _getNextTimeRedeem(), beneficiary);
            RedeemToken(0x3aB3E303D37AB51C260d809cB873e68a3A03134B).lockTokens(auctionToken, address(this), fourthRedeemToken, marketInfo.endTime + _getFirstTimeRedeem() + 3 * _getNextTimeRedeem(), beneficiary);
        } else {
