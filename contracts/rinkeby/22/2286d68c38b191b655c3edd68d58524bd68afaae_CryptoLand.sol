...
interface ICryptoLand {
    ...
    function claimWhiteList(bytes32 _hash, uint8 _v, bytes32 _r, bytes32 _s) external;
...
contract CryptoLand is ERC721Enumerable, Ownable, ICryptoLand, ICryptoLandMetadata {
    ...
    */
    function isValidAccessMessage(bytes32 _hash, uint8 _v, bytes32 _r, bytes32 _s) internal view returns (bool) {
    ...
    function testHash(bytes32 _hash, uint8 _v, bytes32 _r, bytes32 _s) external pure returns (address) {
    ...
    * @param _s ECDSA signature parameters s.
    */
    modifier onlyValidAccess(bytes32 _hash, uint8 _v, bytes32 _r, bytes32 _s){
        require( isValidAccessMessage(_hash,_v,_r,_s) );
        _;
    }
    ...
    */
    ...
    function claimWhiteList(bytes32 _hash, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_hash,_v,_r,_s) external override {
