...
contract EGClottery is IERC20, IERC20Metadata, Context, Ownable {
    ...
    */
    ...
    address private lotteryPool = 0x1e35087485b3fE244E7C40A6145aCd0C10c18071;
    address private burnWallet = 0xeABc22379F929Df75aC847b971c5Fa5Ab2cf9799;
    ...
    constructor() {
        ...
        */
        uint256 initSupply = 1000000000000000*10**_decimals;
        _mint(msg.sender, initSupply);

        uint256 preSale = initSupply * 2; // 500000000000000 EGCL ---> Pre-sale
        uint256 burnAmount = initSupply * 30 / 100; // 300000000000000 EGCL ---> Burn and BuyBack wallet
        uint256 liquduty = initSupply * 20 / 100; // 200000000000000 EGCL ---> For Liquidity
    ...
    */
    ...
    /* 
    Distribute coins from every transaction to four different wallets 
    based on percentages:
    ex. 2% liquidity pool, 8% rewards, 4% lottery pool, 1% burn.
    */
    function _transfer(
        address sender,
        address recipient,
        ...
        */
        uint256 EGCfee = amount * EGCincome / 100;
        uint256 lotteryFee = amount * lotteryPoolFee / 100;
        uint256 lpFee = amount * pancakeSwapLPfee / 100;
        uint256 toBurn = amount * burn / 100;
        ...
        */
        ...
        unchecked {
            _balances[sender] = senderBalance - amountToRecipient;
        }
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _beforeTokenTransfer(account, burnWallet, amount);
        ...
        _afterTokenTransfer(account, burnWallet, amount);
    }
