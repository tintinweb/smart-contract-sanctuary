// // SVG PICTURE MINTING COMMENTED OUT
...
//     console.log('Logging the first J_Em NFT');
//   }
...
//     // Set the NFTs data. using https://jsonkeeper.com with a name, description and image. make sure the image ends in .png or something like that. right click on an image and copy image address will do it.
...
//     // Increment the counter for when the next NFT is minted. COMMENT THIS OUT IF YOURE ONLY MINTING ONE
//     _tokenIds.increment();
//   }
// }


//RANDOMLY GENERATE WORDS ON AN IMAGE START HERE
...
string[] firstWords = ["Burger", "Fries", "Burrito", "Pizza", "Marshmellow", "Chocolate", "Cheese", "Crackers", "Nuts", "Sausage", "Cereal", "Yogurt", "Fruit", "Salmon", "Potato"];
string[] secondWords = ["Abra", "Blastoise", "Butterfree", "Dragonite", "Gastly", "Geodude", "Hitmonchan", "Hitmonlee", "Lugia", "Mewtwo", "Onix", "Persian", "Raichu", "Slowpoke", "Venusaur"];
string[] thirdWords = ["Bills", "Chargers", "Raiders", "Giants", "Eagles", "Packers", "Ravens", "Browns", "Bengals", "Dolphins", "Patriots", "Vikings", "Titans", "Chiefs", "Seahawks"];
