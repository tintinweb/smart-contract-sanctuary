...
contract chaingang {
    ...
    function colorScheme(uint _id) external view returns (uint256 color1, uint color2, uint color3, uint color4, uint color5, uint color6, uint color7, uint color8) {
        color1 = idToColorScheme[_id][0];
        color2 = idToColorScheme[_id][1];
        color3 = idToColorScheme[_id][2];
        color4 = idToColorScheme[_id][3];
        color5 = idToColorScheme[_id][4];
        color6 = idToColorScheme[_id][5];
        color7 = idToColorScheme[_id][6];
        color8 = idToColorScheme[_id][7];
    }
