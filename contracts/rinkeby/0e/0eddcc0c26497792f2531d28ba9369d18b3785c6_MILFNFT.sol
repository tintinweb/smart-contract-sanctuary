...
// NFT Contract for Milf.finance 
// t.me/milffinance_official
...
contract MILFNFT is Ownable, ERC721URIStorage {
    ...
    /**
     Same as above but now with some bitch ass batching
     */
    function batchMint(
        string memory _tokenURI,
        address[] memory _to
    ...
    for(uint256 i; i < _to.length; i++){
      _safeMint(_to[i], tokenIdCounter_);
      _setTokenURI(tokenIdCounter_, _tokenURI);
}
