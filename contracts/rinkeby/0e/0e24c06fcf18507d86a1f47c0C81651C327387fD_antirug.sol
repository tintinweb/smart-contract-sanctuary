...
contract antirug is ERC721  {
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        if (bytes(_baseuri).length > 0) {
            return string(abi.encodePacked("https://ipfs.io/ipfs/",_baseuri,"/",uint2str(_tokenId),".json"));
        } else {
            return "https://ipfs.io/ipfs/QmT89nJ824tixsqP335T8eR6kkMP9TSATomymqHzFp4YyM";
        }
