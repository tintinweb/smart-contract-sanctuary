...
contract TheHolyHippoClub is ERC721Enumerable, Ownable { // contract name to yours
  ...
  uint256 public cost = .033 ether; // change price per unit
  uint256 public maxSupply = 3303; // max supply, contract will stop minting after this amount is reach in your open sea colection
