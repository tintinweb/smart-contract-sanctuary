...
contract OrderManagerReal is OrderManager {
    ...
    function getOrder(address _tokenContract, uint256 _orderId) public view returns (
        uint256 orderId,
        uint256 price,
        uint256 tokenTotal,
    ...
    function getOrderPriceList(address _tokenContract) public view returns (
    ...
    function getOrderPriceOrderId(address _tokenContract, uint256 _price) public view returns (
    ...
    function getMatch(address _tokenContract, uint256 _matchId) public view returns (
        uint256 matchId,
        uint256 buyOrderId,
        uint256 sellOrderId,
        uint256 price,
