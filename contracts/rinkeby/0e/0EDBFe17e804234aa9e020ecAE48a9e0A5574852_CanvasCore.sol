...
contract CanvasBase is CanvasAdministration {
    ...
    function _testCreations(uint amount) external {
      require(msg.sender == ceoAddress);
...
contract SquareShopBase is CanvasBase {
...
contract SquareShop is SquareShopBase, Ownable {
  bytes4 constant InterfaceSignature_ERC721 = bytes4(0x9a20483d);

  function SquareSale(address _nftAddress) public {
...
/** Main Contract **/
contract CanvasCore is Pausible, Picasso, SquareShop {
