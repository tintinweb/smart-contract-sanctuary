...
import "./helper/ERC721Tradable.sol";
 ...
 * MapGame NFT ERC721
 */
contract MapGameNFT is ERC721Tradable {
    ...
    constructor(string memory _baseUri,
                string memory _name,
                string memory _symbol)ERC721Tradable(_name, _symbol){
        setBaseURI(_baseUri);
    }
    ...
    function tokenURI(uint256 _tokenId) public override virtual view returns (string memory) {
        ...
        return string(abi.encodePacked(_baseURI(), _tokenId.toString(), "/", _catId.toString(), ".json"));
    }
