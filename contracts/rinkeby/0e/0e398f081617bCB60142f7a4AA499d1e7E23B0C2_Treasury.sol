...
contract Treasury is ITreasury, Ownable, Constants, Initializable, ReentrancyGuard {
    ...
    function sharePrice() public view returns (uint256) {
        return IPairOracle(oracleShare).consult(share, 1 ether);
    }

    /**
     * @dev Returns the price of the collateral token.
     */
    ...
    function globalShareValue() public view override returns (uint256) {
        return IPairOracle(oracleShare).consult(share, globalShareBalance());
    }
    ...
    /**
     * @dev Sets DollarOracle smart contract address. Can be called only by the owner.
     * @param _oracleDollar Address of DollarOracle smart contract.
     *
    ...
    /**
     * @dev Sets ShareOracle smart contract address. Can be called only by the owner.
     * @param _oracleShare Address of ShareOracle smart contract.
     *
     * Reverts if `_oracleShare` is zero address.
     */
    ...
    /**
     * @dev Sets CollateralOracle smart contract address. Can be called only by the owner.
     * @param _oracleCollateral Address of CollateralOracle smart contract.
     *
     * Reverts if `_oracleCollateral` is zero address.
     */
