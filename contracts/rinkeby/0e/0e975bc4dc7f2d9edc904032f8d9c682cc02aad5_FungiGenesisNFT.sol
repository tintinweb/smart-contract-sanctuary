...
contract FungiGenesisNFT is ERC721, ERC721Enumerable,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    uint16 public constant maxSupply = 100;
    string private _baseTokenURI;
    //https://gateway.pinata.cloud/ipfs/QmfEkrVis3sJxQ9CQ6g4yqj4h8g9wE1ZAsjJsZi88LTmJ9/
    
    uint256 public _mintForAllStartDate = 1633118400;

    constructor() ERC721("Fungible Fungi Genesis", "FUN") {
    }
    ...
    function mint(uint8 _quantityToMint) public payable {
        ...
        require((_quantityToMint + balanceOf(msg.sender)) <= 2, "Max mint per account is 2");
        require(
    ...
    function withdraw() public onlyOwner {
        ...
        address _coldWallet = 0xB4C84F2848ba2FF988f4Ca33A5b37f0FCC4a60c2;
        payable(_coldWallet).transfer((_balance * 975)/1000);
        
        address _devWallet = 0x34D9E79fA07f3adBbd8445b8A3A5969E04d8bA10;
        payable(_devWallet).transfer((_balance * 25)/1000);
    }
}