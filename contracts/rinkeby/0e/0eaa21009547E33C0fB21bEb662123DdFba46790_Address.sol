...
// contracts/bestiesContractWhite.sol
...
contract Besties is ERC721Enumerable, Ownable {
    ...
    uint256 public bestiesPrice = 400000000000000; //0.0004 ETH
    uint256 constant public MAX_MINT_WHITELIST = 4;
    ...
    constructor(string memory baseURI, address[] memory addrs, uint[] memory claimAmounts) ERC721("Besties", "BEST")  {
        setBaseURI(baseURI);
        whitelistAddr = addrs;
    ...
    function claimBesties(uint numberOfTokens) public {
        uint256 supply = totalSupply();
        require(numberOfTokens <= 4, "You can mint 4 tokens at a time." );
