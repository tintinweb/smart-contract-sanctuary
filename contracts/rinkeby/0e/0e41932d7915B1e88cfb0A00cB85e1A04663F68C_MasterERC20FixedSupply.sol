...
contract MasterERC20FixedSupply {
  ERC20FixedSupply[] private childrenErc20FixedSupply;

  function createMasterERC20FixedSupply(
    string memory name,
    ...
    childrenErc20FixedSupply.push(child);
  }
}
