...
contract CryptoSis is ERC721, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    address public constant communityAddress = 0x2E342B44F8E8A7e096C996Bb3dA34832Ae1BBf16;
    ...
    function withdrawAll() public onlyOwner {
        ...
        uint256 communityShare = balance.mul(10).div(100);
        uint256 marketingShare = balance.mul(24).div(100);
        uint256 devShare = balance.mul(14).div(100);
        require(balance > 0);
        _withdraw(creatorAddress, creatorShare);
        _withdraw(communityAddress, communityShare);
