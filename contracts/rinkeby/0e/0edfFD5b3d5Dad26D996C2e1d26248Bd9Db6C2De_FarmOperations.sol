...
contract FarmOperations is VRFConsumerBase, Ownable {
    ...
    mapping(address => uint256[]) public farmer_to_orders; //TODO: remove public
    ...
    function placeOrder(
        ...
        address[] memory _seller_addresses
    ) public {
        ...
        require(_total_amount > 0, "Order is invalid");
        ...
        for (uint256 index = 0; index < _seller_addresses.length; index++) {
            farmer_to_orders[_seller_addresses[index]].push(order_counter);
        }
