...
contract CryptoCharts is ERC721URIStorage, Ownable {
    ...
    // Used to track the order of minting for OpenSea (unrelated to the tokenId)
    Counters.Counter private mintCounter;

    string[] public ipfsLinks;

    event ChartMinted(address sender, uint256 arrayIndex, uint256 mintPosition);
    ...
    function mintChart(uint256 tokenId) public {
        ...
        emit ChartMinted(msg.sender, tokenId, mintCounter.current());
