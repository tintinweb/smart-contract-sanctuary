...
abstract contract AbstractLocker is AccessControl, Initializable {
    ...
    modifier onlyManager {
        require(hasRole(MANAGER_ROLE, msg.sender), "locker: not manager role");
        _;
    }
    ...
    // Update fee bps
    function setFeeBP(uint16 _feeBP) public onlyManager {
        require(_feeBP <= 10000, "setFeeBP: invalid fee");
        feeBP = _feeBP;
    }

    // Update oracle address
    function addOracleAddress(address _oracleAddress) public onlyManager {
        oracles[_oracleAddress] = true;
    }

    function removeOracleAddress(address _oracleAddress) public onlyManager {
        oracles[_oracleAddress] = false;
    }

    // Update maintenance mode
    function setMaintenanceMode(bool _maintenanceMode) public onlyManager {
    ...
    function _verify(
        ...
        address recoveredAddress = ECDSA.recover(_digest, _v, _r, _s);
