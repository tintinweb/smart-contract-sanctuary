...
contract RarityBattleScar is AccessControl, Ownable, ERC721Enumerable {
    ...
    constructor() ERC721(0xEFEaB9F659F7320681f1f723Ec2900C3f94D609e) {
...
contract ERC721 is IERC721 {
     ...
     * This Rarity version does an extra check that the recipient is a real summoner
     */
    function safeTransferFrom(
        uint256 from,
        uint256 to,
        ...
        require(_isApprovedOrOwnerOfSummoner(from), "not owner of summoner");
        (, , , uint256 summonerLevel) = rm.summoner(to);
        require(summonerLevel != 0, "Cannot send to a non-summoner recipient");
