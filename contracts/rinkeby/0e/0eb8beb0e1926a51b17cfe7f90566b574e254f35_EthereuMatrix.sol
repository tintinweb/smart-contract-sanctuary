...
contract EthereuMatrix is Context, IERC20, Ownable {
    ...
    string private constant _name = "eMTX_V3";
    string private constant _symbol = "eMTX_V3";
    ...
    uint256 private _buybackFee = 70;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (block.number <= launchBlock + 3 && !_isExcludedFromFee[to]) {
