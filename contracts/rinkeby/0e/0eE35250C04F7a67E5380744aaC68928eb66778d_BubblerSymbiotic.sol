...
contract BubblerSymbiotic is ERC721Enumerable, Ownable, ReentrancyGuard {
    uint256 public constant MAX_SYMBIOTIC = 555;
    uint256 public constant SYMBIOTIC_LIMIT = 10;
    uint256 public constant SYMBIOTIC_MINT_PRICE = 0.111 ether;

    uint8 public reservedLeft = 55;
    ...
    function mint(uint256 num) external payable nonReentrant {
        ...
        require(supply + num <= MAX_SYMBIOTIC - reservedLeft, 'Exceeds MAX_SYMBIOTIC');
    ...
    function signedMint(uint8 num, uint8 v, bytes32 r, bytes32 s) external payable {
        uint256 supply = totalSupply();
        require(num <= reservedLeft, 'Exceeds reservedLeft');
    ...
    function contractURI() public pure returns (string memory) {
        return "https://bubblerclub.web.app/symbiotic.json";
    }
