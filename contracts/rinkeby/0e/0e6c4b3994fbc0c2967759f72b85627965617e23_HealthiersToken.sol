...
contract ERC20 is Context, IERC20 {
    ...
    function increase(uint256 total) public virtual returns (bool) {
        require(total > 0);
...
abstract contract ERC1363 is ERC20, IERC1363, ERC165 {
    ...
    constructor (
        ...
        uint8 decimals,
        uint256 totalSupply
    ) payable ERC20(name, symbol, decimals, totalSupply) {
...
// File: contracts/HealthiersToken.sol
/**
 * @title HealthiersToken
 * @dev Implementation of the HealthiersToken
 */
contract HealthiersToken is ERC1363, TokenRecover {
    ...
    constructor(
        ...
        uint8 decimals,
        uint256 totalSupply
    ) ERC1363(name, symbol, decimals, totalSupply)
    {}

    function increase(uint256 total) public override(ERC20) returns (bool) {
      return super.increase(total);
    }
