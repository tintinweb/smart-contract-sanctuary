...
contract ChainlinkSolutionsProject is ChainlinkClient, Ownable {
    ...
    bytes32 public highestBalanceAddressResult;

    constructor() {
        setPublicChainlinkToken();
        oracle = 0x6b3a83765eAccf91785C0cb76BfFbe32D15725ec;
        sumJobId = "0ff1eccbba5d4767809b7527f3516df1";
        minmaxJobId = "9ddbc92549664da6897ce0d568af1b5d";
        fee = 0.1 ether;
    }
    ...
    function fulfillHighestBalanceAddress(bytes32 requestId, bytes32 result)
        public
        recordChainlinkFulfillment(requestId)
    {
