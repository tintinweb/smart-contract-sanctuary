...
//https://rinkeby.etherscan.io/address/0x61742527a93D44C99f07D18248bF91497485bFe0#contracts
...
contract GuessContract is VRFConsumerBase {
    ...
    ERC20Interface public stochContractAddress = ERC20Interface(0xaac5C82822DabD683ECf8bF1EC7bB049F3C47F2B);
...
//////////////////////////////////////////////////////////////////////////////////////Modifier Definitations////////////////////////////////////////////////////////////////////////////////////////////
    ...
    modifier onlyAdmin {
        require (msg.sender == 0x819de8bA8b172a6063923EB1b003fA9487773465 , 'Only Admin has right to execute this function');
        _;
...
//////////////////////////////////////////////////////////////////////////////////////Staking Function//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
     ...
     function stakeTokens(uint _amount) public  {
       ...
       require (ERC20Interface(stochContractAddress).transferFrom(msg.sender, address(this), _amount.mul(10**18)));
    ...
    */
    ...
    function unstakeTokens() public onlyStaked() {
        ...
        require(ERC20Interface(stochContractAddress).transferGuessUnstake(msg.sender, balance.mul(10**18)));
