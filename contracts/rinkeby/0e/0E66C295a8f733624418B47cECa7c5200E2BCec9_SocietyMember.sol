...
contract SocietyMember is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAXIMUM_MEMBER_COUNT = 5000;

    // There need to be 2,000 members to proceed.
    uint256 public constant ENOUGH_MEMBERS_TO_PROCEED = 2000;

    // During contract construction, we mint 7 tokens,
    // one for each member of the founding team and the first artist.
    uint256 constant FOUNDING_TEAM_COUNT = 7;
    ...
    // See how many memberships have been minted.
    ...
    // This announces that we support the IERC2981 (royalty info) interface.
