...
contract GeneralPermissionManager is GeneralPermissionManagerStorage, IPermissionManager, Module {
     ...
     * return bool
     */
    function checkDelegate(address _potentialDelegate) external override view returns(bool) {
    ...
    * return Array of permission flags
    */
    function getPermissions() public pure override (IPermissionManager, Module) returns(bytes32[] memory) {
