...
contract Nornir is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBase {
	...
	function setStats(uint256 randomNumber1, uint256 randomNumber2) internal pure returns (Stats memory) {
		return Stats(randomNumber1, statNumberToName(randomNumber2), randomNumber2);
	}

	function setVikingStats(uint256 randomNumber) public {
		// Add the new viking to the vikings collction
		vikings.push(
			Viking(
				// Weapon & Attack
				setStats((randomNumber % 100), (randomNumber % 10000) / 100),
				// Sheild & Defence
				setStats((randomNumber % 1000000) / 10000, (randomNumber % 100000000) / 1000000),
				// Boots & Speed
				setStats((randomNumber % 10000000000) / 100000000, (randomNumber % 1000000000000) / 10000000000),
				// Helmet and Intelligence
				setStats((randomNumber % 100000000000000) / 1000000000000, (randomNumber % 10000000000000000) / 100000000000000),
				// Bottoms & Stamina
				setStats((randomNumber % 1000000000000000000) / 10000000000000000, (randomNumber % 100000000000000000000) / 1000000000000000000)
			)
		);
	}
