...
contract LootItems is ERC1155 {
    ...
    function getAttributes(string memory base, string memory suffix, LootType lootType, string[2] memory name, string memory augmentation) internal view returns (string memory) {
