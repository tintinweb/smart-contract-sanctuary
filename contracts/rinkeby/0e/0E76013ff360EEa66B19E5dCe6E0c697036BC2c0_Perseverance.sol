 ...
 */
contract Perseverance is NPassCore {
    using Strings for uint256;
    ...
    uint16 public constant M_PERCENT_CUT = 40;
    uint16 public constant G_PERCENT_CUT = 60;
    uint16 public constant MAX_NUMBER_OF_MINTS = 5;

    address public constant mAddress = 0x459176f62188A95FF99A12DB9ED1D635472e0216;
    address public constant gAddress = 0x7C45Fc2C517BB6dDea0eaeA9302e5f62C9B645Cf;
    ...
    function _sendEthOut() internal {
        ...
        _sendTo(gAddress, (value * G_PERCENT_CUT) / 100);
...
abstract contract NPassCore is ERC721Enumerable, ReentrancyGuard, Ownable {
    uint256 public constant MAX_MULTI_MINT_AMOUNT = 5;
