...
contract ULMState is IULMState, BlockTimestamp {
        ...
        )
    {
        ...
        (fee0, fee1, amount0, amount1, totalLiquidity) = liquidityManager
        ...
        returns (bool readjust)
    {
        ...
        int24 thershold = tickSpacing; // will increase thershold for mainnet to 1200
    ...
    function getTotalAmounts(address pool, address liquidityManager)
        external
        view
        override
        returns (
        ...
        )
    {
        ...
        (
            ...
            ,
            ,
            localVars.totalLiquidity
        ) = IUniswapLiquidityManager(liquidityManager).liquidityPositions(pool);
        IUniswapV3Pool uniswapPool = IUniswapV3Pool(pool);

        (
            localVars.baseAmount0,
            localVars.baseAmount1,
            localVars.baseFees0,
            localVars.baseFees1
        ...
        (
            localVars.rangeAmount0,
            localVars.rangeAmount1,
            localVars.rangeFees0,
            localVars.rangeFees1
        ) = LiquidityReserves.getPositionTokenAmounts(
            liquidityManager,
            localVars.rangeTickLower,
            localVars.rangeTickUpper,
        ...
        totalLiquidity = localVars.totalLiquidity;
        fee0 = localVars.fees0.add(localVars.baseFees0.add(localVars.rangeFees0));
        fee1 = localVars.fees1.add(localVars.baseFees1.add(localVars.rangeFees1));
    }
}
...
interface IUniStrategy {
    ...
    function swapPercentage() external view returns (uint8);
}
...
interface IUniswapLiquidityManager is IULMEvents {
    ...
    struct ReadjustPremium {
        // Status to enable/disable swapping in readjust method.
        bool readjustSwapStatus;
        // additional premium of a user as an incentive for optimization of vaults.
        bool premiumStatus;
        uint256 premium;
    }
    ...
    /// @return amount0Added Amount of token0 added to the Unipilot
    /// @return amount1Added Amount of token1 added to the Unipilot
