 ...
 */
contract Aura is ERC721, Ownable {
    using SafeMath for uint256;

    string public METADATA_PROVENANCE_HASH = '';
    uint256 public constant craniumPrice = 30000000000000000; // 0.03 ETH
    ...
    // cross-checked 
    function reserveAuras() public onlyOwner {        
    ...
    // unsure wheather we need, not sure what provenance hash does 
    function setProvenanceHash(string memory _hash) public onlyOwner {
        METADATA_PROVENANCE_HASH = _hash;
    }

    // cross-checked 
    function mintAuras(uint numberOfTokens) public payable {
