...
contract ECNFT is ERC721, Ownable, Pausable {
    ...
    function retrieveSpecialCards() public onlyAllowed initialised {
        ...
        _mint(msg.sender, CardType[0].end);
        _mint(msg.sender, CardType[0].end.sub(1));
        _mint(msg.sender, CardType[0].end.sub(2));
    }
