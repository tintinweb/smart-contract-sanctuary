...
contract wFOOD is ERC20 {
    ...
    constructor( address _sOHM ) ERC20( 'Wrapped sFOOD', 'wsFOOD' ) {
    ...
    function wrap( uint _amount ) external returns ( uint ) {
        ...
        uint value = sFOODTowFOOD( _amount );
    ...
    function unwrap( uint _amount ) external returns ( uint ) {
        ...
        uint value = wFOODTosFOOD( _amount );
    ...
    /**
        ...
        @return uint
     */
    function wFOODTosFOOD( uint _amount ) public view returns ( uint ) {
    ...
    /**
        ...
        @return uint
     */
    function sFOODTowFOOD( uint _amount ) public view returns ( uint ) {
