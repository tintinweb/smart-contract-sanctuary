...
contract OpinionDemo is Context, ERC165, IERC721, IERC721Metadata, Ownable, Pausable {
    ...
    // purchase price
    uint256 public _purchasePrice = 1000000000000000 wei;
    // baseURI for Metadata
    string private _metadataURI = "https://ipfs.infura.io/ipfs/";
    // SC beneficiary
    address private beneficiary = 0x62B4fc68C635203FCF81Fa5E02843fbE96735309;
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = OpinionDemo.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(OpinionDemo.ownerOf(tokenId) == from, "ERC721: not own");
        require(to != address(0), "ERC721: zero address");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(OpinionDemo.ownerOf(tokenId), to, tokenId);
    }
