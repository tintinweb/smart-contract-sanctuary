...
contract Conjure is IERC20, ReentrancyGuard {
    ...
    event FeesCollected(address account, uint256 amount);
    event PriceUpdated(address account, uint256 time, uint256 price);
    event AssetClosed();
    ...
    */
    function collectFees() external onlyOwner {
        emit FeesCollected(msg.sender, address(this).balance);
    ...
    */
    function updatePrice() public {
        ...
        emit PriceUpdated(msg.sender, _latestobservedtime, _latestobservedprice);
