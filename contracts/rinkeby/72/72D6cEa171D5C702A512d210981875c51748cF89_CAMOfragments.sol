...
// File @openzeppelin/contracts/utils/introspection/ERC[email protected]
...
contract CAMOfragments is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    address public team1Address = 0x8633C9ccBBD3c0B8a8912bDf9db78b9dCcB28d1a;
    address public team2Address = 0x065b7911afBd60B9b6f26F9ab5990Ffc2b1e81F6;
    uint256 public constant TEAM_1_SELL_PERCENT = 20;
    uint256 public constant TEAM_2_SELL_PERCENT = 5;

    event licenseisLocked(string _licenseText);

    constructor() ERC721('CAMOfragments', 'CAMO') {
    }
    ...
    function sendTeamValue() internal {
