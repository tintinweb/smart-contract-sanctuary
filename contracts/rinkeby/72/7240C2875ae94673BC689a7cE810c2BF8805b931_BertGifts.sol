...
import "./interfaces/IBertGifts.sol";

/**
 * @title BertGifts NFTs
 * @dev Implementation of the {IBertGifts} interface.
 * @author Ahmed Ali Bhatti <github.com/ahmedali8>
 */
contract BertGifts is IBertGifts, Ownable, ERC721Enumerable {
    ...
    /**
     * @dev See {IBertoneXmasGifts-MAX_SUPPLY}.
     */
    uint256 public constant override MAX_SUPPLY = 400;

    /**
     * @dev See {IBertoneXmasGifts-giftClaims}.
     ...
     */
    constructor(string memory _initialBaseURI) ERC721("BertGifts", "BRTG") {
        _baseTokenURI = _initialBaseURI;
    }

    /**
     * @dev See {IBertoneXmasGifts-baseURI}.
     */
    ...
    /**
     * @dev See {IBertoneXmasGifts-tokenExists}.
     */
    ...
    /**
     * @dev See {IBertoneXmasGifts-giftsOfOwner}.
     */
    ...
    /**
     * @dev See {IBertoneXmasGiftss-claimGift}.
     *
     * Requirements:
     *
     * - caller must not have already claimed BertoneXmasGift.
     */
    function claimGift() external override {
        require(
            !giftClaims[_msgSender()],
            "ClaimGift: BertoneXmasGift already claimed"
        );

        // mint BertoneXmasGift
        _mint(1);
    ...
    /**
     * @dev See {IBertoneXmasGifts-setBaseURI}.
     *
    ...
    /**
     * @dev Internal function called in {claimFreeBertoneXmasGift}.
...
/**
 * @dev Interface of the BertoneXmasGifts.
 * @author Ahmed Ali Bhatti <github.com/ahmedali8>
 */
interface IBertGifts {
    /**
