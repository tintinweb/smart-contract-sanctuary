...
contract ElevenEleven is Context, Ownable, ERC165, IElevenEleven, IERC721Metadata {
    ...
    uint256 public startingIndexBlock; // 8286932
    ...
    function getNFTPrice() public view returns (uint256[2] memory) {
        ...
        if (currentSupply == MAX_NFT_SUPPLY.sub(1)) {
        // if (currentSupply == 1110) {        // comment for test, undo before deploy
...
*/
    ...
    */
    function mintNFT(uint256 numberOfNfts) public payable {
	    ...
	    require(msg.value == 0, "Ether sent instead of smol");
