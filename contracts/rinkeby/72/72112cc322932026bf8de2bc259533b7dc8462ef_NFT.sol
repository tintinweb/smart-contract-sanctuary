...
contract NFT is ERC721URIStorage {
    ...
    constructor(address _frogToken, string memory _metadata, string memory _firstEditionMetadata, uint256 _cost, uint256 _maxMintable) ERC721('TEST Generation 1 NFTs','CDE') {
