...
contract CoinFlipper is Owner {
    ...
    using SafeMath for uint256;
        ...
        /** @author Peter Allemann
          ...
          * @param _pkX is the x-coordinate of the public key (Secp256k1 curve, SHA256 hash)
          * @param _pkY is the y-coordinate of the public key (Secp256k1 curve, SHA256 hash)
          */
        ...
        /** @author Peter Allemann
          ...
          * @dev The seed provided by the better is extended with counting integer in order to prevent the replay of the same seed.
          * @param _alphaStringBetter is the betters part of the seed used to generate pseudorandomness.
          */
        ...
        /** @author Peter Allemann
          ...
          * @param _alphaStringBetter is the alpha-string provided by the better.
          */
        ...
        function resolveBet(bytes calldata _proof) external isOwner {
            ...
            if(0 == uint256(VRF.gammaToHash(proof[0], proof[1])) % 2) {
                betterAddress.transfer(betRewardFactorInPercent*betAmount/100);
            }
        ...
        /** @author Peter Allemann
          ...
          * @return alphaByteString is the alpha-string for the currently ongoing bet or the last played bet.
          */
