...
contract Jungle is Ownable, IERC721Receiver {
    ...
    */
    ...
    //Used to map address to claimable Apes from original Galaxy Contract
    mapping (address => uint256) public claimableApes;
   ...
   if (supply < 12000)
            ...
            return 1000;
         else if (supply < 22000)
            return 1200;
        else if (supply < 24000)
            return 1400;
        else if (supply < 26000)
            return 1600;
         else if (supply < 28000)
            return 1800;
        else if (supply < 30000)
            return 2000;
    }
    ...
    */
    ...
    function getNewOwnerForGreedyApe(uint256 seed, uint256 tokenId) internal{
        tokenInfo memory greedyApe = galaxy[tokenId];
        uint256 roll = randomIntInRange(seed, mutantApesStaked.length);
        tokenInfo memory mutantApe = galaxy[mutantApesStaked[roll]];
