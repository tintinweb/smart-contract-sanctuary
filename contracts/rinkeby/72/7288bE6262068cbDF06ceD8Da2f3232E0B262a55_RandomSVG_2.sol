...
contract RandomSVG_2 is ERC721URIStorage, VRFConsumerBase {
    ...
    function finishMint (uint256 _tokenId) public{
        ...
        //generate dsome random SVG code
    ...
    function generatePath(uint256 _randomNumber) public view returns(string memory pathSVG){
        uint256 numberOfPathCommands = (_randomNumber % maxNumberofPathCommands) + 2;
        pathSVG = "<path d='";
        ...
        pathSVG = string(abi.encodePacked(pathSVG, "' fill='", color, "' stroke='", color, "'/>"));
    }
