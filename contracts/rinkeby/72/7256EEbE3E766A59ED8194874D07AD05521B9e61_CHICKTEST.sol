...
contract CHICKTEST is ERC721, ERC721Enumerable, Ownable {
  ...
  // Provenance
  string public CHICKTEST_HASH = "";

  // Price & Supply
  uint256 public constant NFT_PRICE = 88000000000000000; //0.088 ETH
  ...
  constructor(string memory baseURI) ERC721("CHICKTEST", "CTEST") {
    setBaseURI(baseURI);
  }
