...
contract WrappedPunk is Ownable, ERC721, Pausable {
   ...
   */
    ...
    whenNotPaused
    {
        ...
        punksArray[punkIndex] = address(0x0);
    ...
    function punkNoLongerForSale(uint punkIndex) public whenNotPaused {
    ...
    function offerPunkForSale(uint punkIndex, uint minSalePriceInWei) public whenNotPaused {
        require(punkIndexToAddress[punkIndex] == msg.sender);
        require(punkIndex <= totalPunkSupply);
    ...
    function offerPunkForSaleToAddress(uint punkIndex, uint minSalePriceInWei, address toAddress) public whenNotPaused {
        require(punkIndexToAddress[punkIndex] == msg.sender);
        require(punkIndex <= totalPunkSupply);
    ...
    function enterBidForPunk(uint punkIndex) public payable whenNotPaused {
        require(punkIndex <= totalPunkSupply);
    ...
    function acceptBidForPunk(uint punkIndex, uint minPrice) public whenNotPaused {
        require(punkIndex <= totalPunkSupply);
        require(punkIndexToAddress[punkIndex] == msg.sender);
    ...
    function buyPunk(uint punkIndex) external payable {
        ...
        punksArray[punkIndex] = msg.sender;
