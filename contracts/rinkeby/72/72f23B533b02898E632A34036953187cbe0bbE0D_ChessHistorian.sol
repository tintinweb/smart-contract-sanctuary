...
import "./ChessHistorianMetaDataGenerator.sol";

contract ChessHistorian is ERC721Enumerable, ReentrancyGuard, Ownable {
    // immutable configuration
    uint256 private constant TOKEN_PRICE = 0.00 ether;
    ...
    constructor() ERC721("CH1", "CH1") {
        mintStartsAtTimestamp = 0;
        maxTokensPerAddress = 20;
        maxTokensPerTransaction = 20;
    }

    function setTmpStr(string memory _tmpStr) external onlyOwner {
        tmpStr = _tmpStr;
    }
    ...
    function tokenURI(uint256 _tokenId) override public view returns (string memory) {
        ...
        return ChessHistorianMetaDataGenerator.genJsonTokenURI(tmpStr);
    }
...
library ChessHistorianMetaDataGenerator {
    ...
    function genAttributes() internal pure returns (string memory) {
