...
contract ERC1155Curio is ERC1155Base {
    event CreateERC1155Curio(address owner, string name, string symbol);

    function __ERC1155Curio_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        ...
        _setBaseURI(baseURI);
        emit CreateERC1155Curio(_msgSender(), _name, _symbol);
    }
    uint256[50] private __gap;
}
