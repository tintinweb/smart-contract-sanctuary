...
contract A {
    ...
    function getIdx(bytes memory s, uint x) public pure returns(uint8 y) {
        y = uint8(s[x]);
    }
    ...
    function getSVG() public returns(string memory) {
        bytes memory s = bytes("0x000a1711071000030006000100060003000100020102000101010001000201020101000400020102000300020102000100010102000100020102000101010001000201020001010101020001000201020001010100010102010200010103000600010006001000");
