...
contract WincityLilleAsset1 is ERC1155, ERC1155Pausable, Ownable {
    ...
    */
    ...
    uint16 public constant RARITY_RANGE2_PUBLIC_SUPPLY = 3;
    uint16 public constant RARITY_RANGE3_PUBLIC_SUPPLY = 10;
    uint16 public constant RARITY_RANGE4_PUBLIC_SUPPLY = 100;

    uint16 private _maxTokenPerTx = 4;
    ...
    // RarityRanges by id
    mapping(uint8 => RarityRange) public rarityRangeById;
    ...
    mapping(uint16 => bool) private privateTokensWithdrawl;
    ...
    constructor(
        ...
        uint16 rarityRange2FirstId = rarityRange1FirstId +
            RARITY_RANGE1_SUPPLY;
        uint16 rarityRange3FirstId = rarityRange2FirstId +
            RARITY_RANGE2_SUPPLY;
        uint16 rarityRange4FirstId = rarityRange3FirstId +
    ...
    function setPublicMintPrice(uint8 rarityRangeId, uint256 mintPrice)
        public
        onlyOwner
    {
