...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 adjusted_price = uint256(price) * 10**10; // 18decimals
        // $50, $2000 /eth
        // 50/2000
        // 50 * 100000 / 2000
        uint256 costToEnter = (usdEntryFee * 10**18) / adjusted_price;
        return costToEnter;
        // REMEMBER TO USE SAFE MATH
    }

    function startLottery() public onlyOwner {
        require(
            lottery_state == LotteryState.CLOSED,
            "Can' start a new lotter yet"
        );
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        require(lottery_state == LotteryState.CALCULATING_WINNER);
