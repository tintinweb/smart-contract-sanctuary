...
// File: contracts/RADIOACTIVEPUNKS.sol
...
@art pixantle :: @pixantle
@tech white lights :: @iamwhitelights

@title RADIOACTIVEPUNKS contract
@dev Extends ERC721 Non-Fungible Token Standard to alllow
     for pausing, burning, enumerability, and secondary sales
     fees declared via Rarible V1 Protocol and ERC2981 NFT Royalty Standard.
     The metadata and images are stored on Arweave, creating an on-chain
     generative collectible series that takes serious care of it's permanence
     and its provenance. It might not survive nuclear war, but its dang close.
...
contract RADIOACTIVEPUNKS is ERC721Burnable, ERC721Pausable, ERC721Enumerable, HasSecondarySaleFees, ERC2981, Ownable {
  ...
  address payable public PAYMENT_SPLITTER = payable(0x5510561E8bb773c0B4e93672fF2c348f14c5459d);
  ...
  string private constant IDENTITY_TYPE = "Identity(address wallet)";
  address constant verifyingContract = 0x5510561E8bb773c0B4e93672fF2c348f14c5459d; // TOOD UPDATE
  bytes32 constant salt = 0xf2d857f4a3edcb9b78b4d503bfe733db1e3f6cdc2b7971ee739626c97e86a558; // TODO UPDATE
  string private constant EIP712_DOMAIN = "EIP712Domain(string name,string version,uint256 chainId,address verifyingContract,bytes32 salt)";
  bytes32 private constant DOMAIN_SEPARATOR = keccak256(abi.encode(
      EIP712_DOMAIN,
      keccak256("RADIOACTIVEPUNKS"),
      keccak256("4"), // WARNING WARNING MUST UPDATE
      chainId,
      verifyingContract,
      salt
  ));
   ...
   */
  function mintPunks(uint256 numberOfTokens, uint8 v, bytes32 r, bytes32 s) public payable {
    ...
    require(verify(msg.sender, v, r , s) == true, "You cheated");
   ...
   * EIP718 Verification
   */
  function verify(address sender, uint8 v, bytes32 r, bytes32 s) public pure returns (bool) {
    Identity memory iden = Identity({
      wallet: sender
    });
    return sender == ecrecover(hashIdentity(iden), v, r, s);
  }
}