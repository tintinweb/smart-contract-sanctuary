...
contract Huddlious is Context, IERC20, Ownable {
    ...
    string private _name = "Huddlious";
    string private _symbol = "HDLS";
    ...
    /// @notice This function set taxFee to the proper value.
    /// @param taxFee input variable to set the fee.
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        _taxFee = taxFee;
    }
    
    /// @notice This function set liquidityFee
    /// @param liquidityFee liquid fee
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        _liquidityFee = liquidityFee;
    }
   
    /// @notice This function set maxTxAmount
    ...
    /// @param _enabled boolean value enabled
    ...
    /// @param from the address from where the transfer is from 
    /// @param to the address to where the amount is to
    /// @param amount the amount of that will be transfered
    function _transfer(
        address from,
        address to,
    ...
    /// @param contractTokenBalance to swap with ethereum
    ...
    /// @param ethAmount the amount of Ethereum
