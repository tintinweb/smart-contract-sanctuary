...
contract Paintblocks is ERC721, Ownable {
  using Counters for Counters.Counter;

  Counters.Counter private _tokenIdCounter;

  uint256 currentPrice = 0.03 ether;
  uint256 totalSupply = 100000;

  constructor() ERC721("Paintblocks", "PB") {}

  function mintPaintblock(uint256 id) public payable {
    // require(msg.value >= currentPrice, "Amount of Ether sent too small");

    require(
      (_tokenIdCounter.current()) <= totalSupply,
      "No Paintblocks available"
    );
