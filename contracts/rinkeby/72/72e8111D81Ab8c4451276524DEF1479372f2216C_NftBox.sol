...
contract NftBox is INftBox, IERC721Metadata, ERC721Enumerable, ERC721Burnable, ERC721Pausable, Ownable, Security {
    ...
    string internal baseURIString = "https://www.sccnft.com/api/box/metadata/";
    string internal contractURIString = "https://www.sccnft.com/api/contract/boxes";
    ...
    constructor(address adminAddress, address payable payeeAddress, address payable treasuryAddress, string memory baseURI, string memory contractURI) ERC721("SCC Box", "SCCB") {
