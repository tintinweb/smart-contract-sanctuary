...
contract XMas is ERC721, Ownable, Pausable {
    ...
    // TODO set OpenSea Proxy Registry Address
    ...
    function setIsBurnable(bool status) public onlyOwner {
        isBurnable = status;
    }
    ...
    function mintTo(address beneficiary) public payable whenNotPaused {
        ...
        require(_nextTokenId.current() < MAX_SUPPLY, "Exceeds max supply");
        _nextTokenId.increment();
        _safeMint(beneficiary, _nextTokenId.current());
    }
