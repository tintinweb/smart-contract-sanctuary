 ...
 * 1.5%  : sent to marketing wallet
 * 1.5% : sent to dev wallet
 * 
 * 
 */
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Dino";
    string internal constant SYMBOL = "DNO";
    ...
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY ; 

    // --------------------- Fees Settings ------------------- //

    /**
     * @dev sets charity and dev wallets
     */
    ...
    function _addFees() private {
        ...
        /**
         * dev sets fee percentages per transaction. total percentage is 11%
         */ 
        _addFee(FeeType.Rfi, 30, address(this) ); 
        _addFee(FeeType.Burn, 20, burnAddress );
        _addFee(FeeType.Liquidity, 30, address(this) );
        _addFee(FeeType.External, 15, charityAddress );
        _addFee(FeeType.External, 15, marketingAddress );
