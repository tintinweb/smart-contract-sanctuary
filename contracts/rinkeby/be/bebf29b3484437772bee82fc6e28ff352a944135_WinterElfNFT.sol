...
// File contracts/WinterElfNFT.sol



pragma solidity ^0.8.0;
contract WinterElfNFT is ERC721URIStorageUpgradeable, AccessControlUpgradeable {
    using StringsUpgradeable for uint256;
    ...
    returns (string memory)
  {
    ...
    function mint(
        ...
        // bytes32 h = keccak256(abi.encodePacked(msg.sender, _tokenId, expires));
