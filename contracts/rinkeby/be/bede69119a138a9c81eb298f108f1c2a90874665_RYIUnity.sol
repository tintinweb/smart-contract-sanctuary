...
Tokenomics:
Total: 20,000,000
Black Hole Wallet: 5,000,000 (burned)

0.25% Burn/Lock (expands over time as BHW increases)
1.75% Frictionless Yield (i.e. no staking)
Anti-Dump Protection: 200,000 max tokens per tx

tg: @RYIUNITY

contract for BSC by @sycore0
...
contract RYIUnity is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 20 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'RYI Unity';
    string private _symbol = 'RYIU';
    uint8 private _decimals = 9;

    bool public LimitMode = false;
    bool public DevMode = true;
    uint256 _maxTransactionTokens = 200000 * 10**9;
