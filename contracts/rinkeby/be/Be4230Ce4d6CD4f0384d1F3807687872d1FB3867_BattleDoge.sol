...
contract BattleDoge is ERC721, VRFConsumerBase, Ownable {
   ...
   function Attack (uint256 tokenId, uint256 _tokenId) public returns (uint256 winner){
       ...
       if ((characters[tokenId].strength ** 10/3) + (characters[tokenId].intelligence ** 10/3) > (characters[_tokenId].strength ** 10/3) + (characters[_tokenId].intelligence ** 10/3) ** i){
