...
contract Song is ISong, ERC721, Ownable {
    ...
    */
    ...
    function burn(uint256[] calldata tokenIds) external override onlyOwner {
     ...
     * Can only be called by the current owner.
     */
    function transferOwnership(address newOwner) public override(ISong, Ownable) onlyOwner {
