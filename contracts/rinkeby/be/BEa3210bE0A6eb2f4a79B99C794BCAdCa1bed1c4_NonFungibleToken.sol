...
contract NonFungibleToken is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, AccessControl {
    ...
    constructor() ERC721("Non-Fungible Token", "NFT") {
        _setupRole(ADMIN_HASH, msg.sender);
    }

    function setValue(uint256 _value) public onlyRole(MANAGER_HASH) {
        value = _value;
    }
    ...
    function withdraw() public onlyRole(SYSTEM_HASH) {
...
abstract contract AccessControl is IAccessControl, ERC165 {
    ...
    bytes32 public constant ADMIN_HASH = 0x00;
    bytes32 public constant MANAGER_HASH = keccak256("MANAGER");
    bytes32 public constant SYSTEM_HASH = keccak256("SYSTEM");
