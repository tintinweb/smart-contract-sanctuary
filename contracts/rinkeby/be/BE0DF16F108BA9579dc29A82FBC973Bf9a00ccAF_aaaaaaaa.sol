...
contract gfykhjfyjty {
    ...
    struct Problem_Details {
        ...
        uint    Problem_ID;
        address Thinker;
        uint[]  ALL_Problems_byID_for_Problem_byName_ARRAY;
        
        uint    Total_Filled;
        uint    Solution_Total_Filled;
        
        string[]    ALL_Solutions_byName_for_Problem_ARRAY;
        uint[]      ALL_Solutions_byID_for_Problem_ARRAY;
        
        uint[]  ALL_Solutions_byID_LinkedTo_Problem_ARRAY;
        uint[]  ALL_Linkages_byID_for_FromProblem_ARRAY;
        uint[]  ALL_Linkages_byID_for_ToProblem_ARRAY;
        uint[]  ALL_Fillings_byID_for_Problem_ARRAY;
...
contract fgsthgfhdsthf {
    ...
    struct Solution_Details {
        ...
        uint    Solution_ID;
        address Master;
        uint[]  ALL_Solutions_byID_for_Solution_byName_ARRAY;
        
        uint    Total_Filled;
        
        uint[]  ALL_Problems_byID_LinkedTo_Solution_ARRAY;
        uint[]  ALL_Linkages_byID_for_Solution_ARRAY;
        uint[]  ALL_Fillings_byID_for_Solution_ARRAY;
...
contract ppppugfgrdgfhd is dthtdrhr, gfykhjfyjty, fgsthgfhdsthf, oiuijkyjtdg, iiiiifgdfgsefs {
    ...
    function aa_NEW_Problem(string memory Name, string memory Description) public {
        ...
        problemDetails.ALL_Solutions_byName_for_Problem_ARRAY   .push(Name);
        problemDetails.ALL_Solutions_byID_for_Problem_ARRAY     .push(ja_TOTAL_Problems);
        ...
        _problemDetails.ALL_Problems_byID_for_Problem_byName_ARRAY.push(ja_TOTAL_Problems);
    ...
    function ba_FILL_Problem(uint Problem_ID) public payable {
        ...
        problemDetails.ALL_Fillings_byID_for_Problem_ARRAY  .push(jd_TOTAL_Fillings);
        ...
        //     Linkage storage linkage = ha_LINKAGE_byID[problem.Linkage_ID];
        ...
        //     Linkage storage _linkage = ha_LINKAGE_byID[problem.Linkage_ID];
...
contract sfdsfsdgdfgdr is dthtdrhr, gfykhjfyjty, fgsthgfhdsthf, oiuijkyjtdg, iiiiifgdfgsefs {
    ...
    function ab_NEW_Solution(uint Problem_ID, string memory Name, string memory Explanation) public {
        ...
        Solution_Details storage    _solutionDetails    = gb_SOLUTION_Details   [_solution.Solution_ID];
        _solutionDetails.ALL_Solutions_byID_for_Solution_byName_ARRAY.push(jb_TOTAL_Solutions);
    ...
    function bb_FILL_Solution(uint Solution_ID) public payable {
        ...
        solutionDetails.ALL_Fillings_byID_for_Solution_ARRAY    .push(jd_TOTAL_Fillings);
        ...
        //     Linkage storage linkage = ha_LINKAGE_byID[solution.Linkage_ID];
        ...
        //     Linkage storage _linkage = ha_LINKAGE_byID[solution.Linkage_ID];
...
contract ghjghghjjjjjjjj is dthtdrhr, gfykhjfyjty, fgsthgfhdsthf, oiuijkyjtdg, iiiiifgdfgsefs {
    ...
    function ac_LINK_Solution(uint Solution_ID, uint to_Problem_ID, string memory Linkage_Reason) public {
        ...
        solutionDetails     .ALL_Linkages_byID_for_Solution_ARRAY      .push(jc_TOTAL_Linkages);
        fromProblemDetails  .ALL_Linkages_byID_for_FromProblem_ARRAY   .push(jc_TOTAL_Linkages);
        toProblemDetails    .ALL_Linkages_byID_for_ToProblem_ARRAY     .push(jc_TOTAL_Linkages);
        
        bool P_alreadyLinked;
        bool S_alreadyLinked;
        
        for (uint i=1; i<=solutionDetails.ALL_Problems_byID_LinkedTo_Solution_ARRAY.length; i++) {
        
            if (solutionDetails.ALL_Problems_byID_LinkedTo_Solution_ARRAY[i-1]==to_Problem_ID) {
        ...
        for (uint i=1; i<=toProblemDetails.ALL_Solutions_byID_LinkedTo_Problem_ARRAY.length; i++) {
        
            if (toProblemDetails.ALL_Solutions_byID_LinkedTo_Problem_ARRAY[i-1]==Solution_ID) {
        ...
        if (P_alreadyLinked==false) {
            ...
            solutionDetails.ALL_Problems_byID_LinkedTo_Solution_ARRAY.push(to_Problem_ID);
            
        }
        
        if (S_alreadyLinked==false) {
        
            toProblemDetails.ALL_Solutions_byID_LinkedTo_Problem_ARRAY.push(Solution_ID);
...
contract aaaaaaaa is xfhdtfhdth, ppppugfgrdgfhd, sfdsfsdgdfgdr, ghjghghjjjjjjjj {
    ...
    constructor() {
        ...
        problemDetails      .ALL_Solutions_byID_LinkedTo_Problem_ARRAY  .push(0);
        problemDetails      .ALL_Linkages_byID_for_FromProblem_ARRAY    .push(0);
        problemDetails      .ALL_Linkages_byID_for_ToProblem_ARRAY      .push(0);
        problemDetails      .ALL_Fillings_byID_for_Problem_ARRAY        .push(0);
        solutionDetails     .ALL_Problems_byID_LinkedTo_Solution_ARRAY  .push(0);
        solutionDetails     .ALL_Linkages_byID_for_Solution_ARRAY       .push(0);
        solutionDetails     .ALL_Fillings_byID_for_Solution_ARRAY       .push(0);
    ...
    function fc_ALL_SOLUTIONS_byName_for_PROBLEM_byName     (string memory Name)    public view returns (string[] memory) {
        ...
        return problemDetails.ALL_Solutions_byName_for_Problem_ARRAY;
        
    }
    
    function fd_ALL_SOLUTIONS_byID_for_PROBLEM_byName       (string memory Name)    public view returns (uint[] memory) {
    
        Problem storage         problem         = ea_PROBLEM_byName  [Name];
        Problem_Details storage problemDetails  = fb_PROBLEM_Details [problem.Problem_ID];
        return problemDetails.ALL_Solutions_byID_for_Problem_ARRAY;
        
    }
    
    function fe_ALL_SOLUTIONS_byID_for_PROBLEM_byID         (uint Problem_ID)       public view returns (uint[] memory) {
    ...
    function ff_ALL_PROBLEMS_byID_for_PROBLEM_byName        (string memory Name)    public view returns (uint[] memory) {
    
        Problem storage         problem         = ea_PROBLEM_byName  [Name];
        Problem_Details storage problemDetails  = fb_PROBLEM_Details [problem.Problem_ID];
        return problemDetails.ALL_Problems_byID_for_Problem_byName_ARRAY;
        
    }
    
    function fg_ALL_SOLUTIONS_byID_LinkedTo_PROBLEM_byName  (string memory Name)    public view returns (uint[] memory) {
    
        Problem storage         problem         = ea_PROBLEM_byName  [Name];
        Problem_Details storage problemDetails  = fb_PROBLEM_Details [problem.Problem_ID];
        return problemDetails.ALL_Solutions_byID_LinkedTo_Problem_ARRAY;
        
    }
    
    function fh_ALL_SOLUTIONS_byID_LinkedTo_PROBLEM_byID    (uint Problem_ID)       public view returns (uint[] memory) {
    ...
    function fi_ALL_LINKAGES_byID_for_FromPROBLEM_byID      (uint FromProblem_ID)   public view returns (uint[] memory) {
    
        Problem_Details storage problem_Details = fb_PROBLEM_Details[FromProblem_ID];
        return problem_Details.ALL_Linkages_byID_for_FromProblem_ARRAY;
        
    }
    
    function fj_ALL_LINKAGES_byID_for_ToPROBLEM_byID        (uint ToProblem_ID)     public view returns (uint[] memory) {
    
        Problem_Details storage problem_Details = fb_PROBLEM_Details[ToProblem_ID];
        return problem_Details.ALL_Linkages_byID_for_ToProblem_ARRAY;
        
    }
    
    function fk_ALL_FILLINGS_byID_for_PROBLEM_byID          (uint Problem_ID)       public view returns (uint[] memory) {
    
        Problem_Details storage problem_Details = fb_PROBLEM_Details[Problem_ID];
        return problem_Details.ALL_Fillings_byID_for_Problem_ARRAY;
        
    }
    
    
    
    function gc_ALL_SOLUTIONS_byID_for_SOLUTION_byName      (string memory Name)    public view returns (uint[] memory) {
        ...
        return solutionDetails.ALL_Solutions_byID_for_Solution_byName_ARRAY;
        
    }
    
    function gd_ALL_PROBLEMS_byID_LinkedTo_SOLUTION_byName  (string memory Name)    public view returns (uint[] memory) {
    
        Solution storage            solution        = eb_SOLUTION_byName     [Name];
        Solution_Details storage    solutionDetails = gb_SOLUTION_Details    [solution.Solution_ID];
        return solutionDetails.ALL_Problems_byID_LinkedTo_Solution_ARRAY;
        
    }
    
    function ge_ALL_PROBLEMS_byID_LinkedTo_SOLUTION_byID    (uint Solution_ID)      public view returns (uint[] memory) {
    ...
    function gf_ALL_LINKAGES_byID_for_SOLUTION_byID         (uint Solution_ID)      public view returns (uint[] memory) {
    
        Solution_Details storage solutionDetails = gb_SOLUTION_Details[Solution_ID];
        return solutionDetails.ALL_Linkages_byID_for_Solution_ARRAY;
        
    }
    
    function gg_ALL_FILLINGS_byID_for_SOLUTION_byID         (uint Solution_ID)      public view returns (uint[] memory) {
    
        Solution_Details storage solutionDetails = gb_SOLUTION_Details[Solution_ID];
        return solutionDetails.ALL_Fillings_byID_for_Solution_ARRAY;
