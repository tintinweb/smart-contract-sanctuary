...
contract Tester is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant AVAILABLE_FOR_PUBLIC = 55;
    ...
    string private URI = "https://gateway.pinata.cloud/ipfs/";

    constructor() ERC721("Test150", "TSO") {}
        ...
        returns (string memory)
    {
            ...
            return
                bytes(URI).length > 0
                    ? string(
                        abi.encodePacked(URI, tokenId.toString(), ".json")
                    )
                    : "";
                    }
    ...
    function flipSale() external onlyOwner {
        ...
        require(msg.value >= PRICE * amount, "Please add the correct price");
