...
contract Test0101 is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  ERC721 Smilesssvrs = ERC721(0x14B35fFCEFe3D73F19816b4fd6EbCF659B6f64A3); //ERC721(0x177EF8787CEb5D4596b6f011df08C86eb84380dC);

  // ERC721 params
  string private tokenName = 'Gif';
  string private tokenId = 'GIF';
