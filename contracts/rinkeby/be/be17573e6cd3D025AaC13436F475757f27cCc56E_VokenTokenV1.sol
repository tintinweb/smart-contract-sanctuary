...
abstract contract Tokenomics {
    ...
    uint8 internal constant DECIMALS = 1; //FIXME: change back to 18
    uint256 internal constant ZEROES = 10**DECIMALS;

    uint256 private constant MAX = ~uint256(0); // OK; max value of an uint256
    uint256 internal constant TOTAL_SUPPLY = 10_000_00 * ZEROES; // total supply FIXME: change back to 10_000_000
    ...
    Tokenomics
{
    ...
    /**
    FIXME: need to change this to be able to add and remove unlimitedsender
     */
    ...
    /**
        FIXME: need to change this to be able to add and remove unlimitedrec
     */
    ...
    function setFundAddress(address _account)
        external
        onlyOwner
    {
        fundAddress = _account;
    }
    function setRnDAddress(address _account)
        external
        onlyOwner
    {
        rndAddress = _account;
