...
contract MojNFTProduction is ERC721Enumerable, Ownable, ReentrancyGuard {
    
    using Strings for uint256;

    uint256 public constant NMS_GIFT = 2;
    uint256 public constant NMS_PRESALE = 3;
    uint256 public constant NMS_SALE = 5;
    uint256 public constant NMS_MAX = NMS_GIFT + NMS_PRESALE + NMS_SALE;
    uint256 public constant NMS_MAX_PREMINT = 2;
    uint256 public constant NMS_MAX_MINT = 3;
    uint256 public NMS_PRICE = 0.01 ether;
    
    string private _contractURI;
    string private _baseTokenURI;
    address private _devAddress = 0xE9C11FdD25dfd4987Cb0d8eb136898Cd3d938A4a;
    ...
    constructor(string memory baseURI, string memory contURI) ERC721("MojNFTProduction", "MNP") {
