...
contract LDFWTest is ERC721, Ownable, ReentrancyGuard {
    ...
    //TODO: Change before mainnet deployment
    // Payout addresses
    address private constant _founder = 0x4DFA7FF4a33F2625495867a373caa4d165d37F37; // Founder
    address private constant _believer = 0xc36596E05312410fC41337eC6c2914A4FCA8d6C1; // The Believer
    address private constant _dev1 = 0x7560749351EA673a7054b746Ff49c794597258f6; // Solidity dev    
    address private constant _dev2 = 0xF6c1eC971255dE031A1642345F36c13f0e2B829D; // Web dev
    address private constant _dev3 = 0xD8CC6fb6fda6d052045c4066f7320584Bb1eA082; // Web dev
    address private constant _reasearchAndDevelopment = 0x0E2890095d63b769Ac6C0811c522be6A286a2814; // R&D
    address private constant _marketing = 0xd821bd8F420F842b0EfCc7488573A5C0Ffd5842A; // Marketing
    address private constant _comm = 0xCE3aBE17cd10a26Fd9CAA98809875Cf91Fa7F1d3; // Comm
    ...
    address[8] private _shareholders = [_founder,_believer,_dev1,_dev2,_dev3,_reasearchAndDevelopment,_marketing,_comm];
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        //TODO: Change before mainnet deployment
        _shares[_founder] = 47685;
        _shares[_believer] = 26315;
        _shares[_dev1] = 1000;
        _shares[_dev2] = 1000;
        _shares[_dev3] = 1000;
    ...
    function mintFromPresale(uint256 qty) external payable presaleActive onlyWhitelisted {
        ...
        require(msg.value == (PRESALE_PRICE * qty), "Incorrect payment amount");
