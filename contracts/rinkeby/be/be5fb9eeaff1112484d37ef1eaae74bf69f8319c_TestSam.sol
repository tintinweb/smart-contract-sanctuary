...
// File: contracts/TestSam.sol


pragma solidity 0.6.12;


// TestSam with Governance.
contract TestSam is BEP20('TestSam', 'TSAM') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TestSam::transfer: Burn value invalid");
