...
contract NFT is ERC721Enumerable, Ownable {
  ...
  address add1 = 0x59972aFD2f10AFe81c6faa79403A59d3f7692707;
  address add2 = 0xBc7EaECaB03fBb234157e3D51699B70a6f842d7e;
  address add3 = 0x59972aFD2f10AFe81c6faa79403A59d3f7692707;
  address add4 = 0x59972aFD2f10AFe81c6faa79403A59d3f7692707;
  address add5 = 0x59972aFD2f10AFe81c6faa79403A59d3f7692707;
  ...
  function withdraw() public payable onlyOwner {
    require(payable(add1).send(address(this).balance / 100 * 23));
    require(payable(add2).send(address(this).balance / 100 * 23));
    require(payable(add3).send(address(this).balance / 100 * 23));
    require(payable(add4).send(address(this).balance / 100 * 23));
    require(payable(add5).send(address(this).balance / 100 * 8));
  }
}