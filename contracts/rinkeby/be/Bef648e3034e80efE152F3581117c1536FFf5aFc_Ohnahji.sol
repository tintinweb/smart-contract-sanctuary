...
/**
  ...
  ╚██████╔╝██║  ██║██║ ╚████║██║  ██║██║  ██║╚█████╔╝██║    
   ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚════╝ ╚═╝    
                                 ...
                                 _                ()     _                \ /            
  |_  \/   |V| _  __ |     _    |_) __ o __  _    /\/   |_) __ o  _ __     V  _  _| _ __ 
  |_) /    | |(_| |  |<|_|_>    |   |  | |||(/_   \/\   |_) |  | (_|| |      (_|(_|(/_| |
...
// @dev make sure to read to the bottom if planning on using 
...
contract Ohnahji is ERC721, Ownable {
  ...
  constructor() ERC721("Ohnahji", "OHNAH") {
    setHiddenMetadataUri("ipfs://QmTZTPR43NmW7YneT6TPuQmtvGt3m5VctQgJZNGaWhoAnU/hidden.json");
  }
...
/** Feel free to contact us for questions, help, comments: [email protected]

    TipJar: 
   ----------
    OhnahjiB: 0xF4DF7A060388b155D58de25bc24ABa4130B5d8A2

    Markus Prime!: 0x7AB90FA825aB9cf7bE231AbFB8184B212dbA25b7
...
P.S. This is what happens when two black artists loving life
         decide to figure out coding a little bit.
*/