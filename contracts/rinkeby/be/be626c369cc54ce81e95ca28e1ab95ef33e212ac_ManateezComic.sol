...
contract ManateezComic is ERC721, Ownable {
    ...
    uint256 public ComicPrice = 10000000000000000; // 0.01 ETH
    ...
    //string public baseURI = "https://api.mightymanateez.io/comics/";

    mapping(address => uint256[]) public userOwnedTokens;
    mapping(uint256 => uint256) public tokenIsAtIndex;

    constructor() ERC721("Manateez Comic", "MMCOMIC") {
    ...
    function mintComics(uint numberOfTokens) public payable {
        require(isLive, "Can not mint Comic before the sale has started");
