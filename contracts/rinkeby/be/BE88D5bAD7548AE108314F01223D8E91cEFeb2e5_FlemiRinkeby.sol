...
contract FlemiRinkeby is ERC721Enumerable, Ownable {

    //Rinkeby test contract
    IERC721 public token = IERC721(0x6be759Bd2808b869b821AE5d8184e2eFfe5eF396);
    IERC721 public link = IERC721(0x01BE23585060835E02B77ef475b0Cc51aA1e0709);

    //REDUCED TO 0.005ETH for rinkeby
    ...
    */
    function mintFlemi(uint numberOfTokens) public payable {
        ...
        if(numberOfTokens >= 2 && totalSupply() < 500 && (token.balanceOf(msg.sender) > 0 || link.balanceOf(msg.sender) > 0)) {
