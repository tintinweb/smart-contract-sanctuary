...
contract TheWorldsHardestGameToken is ERC721Enumerable, Ownable {
    ...
    function setStartTime(uint256 startTime_) public virtual onlyOwner {
    ...
    function _preValidatePurchase() internal view {
        require(startTime != 0 && block.timestamp >= startTime, "TWHGT: Sale has not started yet");
