...
contract VenosaurInu is Context, IERC20, Ownable {
    ...
    string private _name = "VenosaurInu";
    string private _symbol = "VENO";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 8; //(2% liquidityAddition + 3% rewardsDistribution + 5% devExpenses)
    ...
    // limit
    uint256 public _maxTxAmount = 5000000000000 * 10**2 * 10**9; //1.5% after 60% burn
