...
contract doggos is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("dsfsdsfsd", "ttttsssstttt321") {
                ...
                abi.encodePacked(
                    ...
                    doggosLibrary.encode(
                        bytes(
                            string(
                                abi.encodePacked(
                                    '{"name": "On-Chain Doggos #',
                                    doggosLibrary.toString(_tokenId),
                                    '", "description": "On-Chain Doggos is a collection of 4,000 unique doggos. All the metadata and images are stored 100% on the Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
                                    doggosLibrary.encode(
