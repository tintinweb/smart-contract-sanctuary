...
contract NFTShamim is ERC721, VRFConsumerBase {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal
        override {
            ...
            uint256 decieveLevel = (randomNumber % 100);
            uint256 yearsofexp = ((randomNumber % 10000) / 100 );
            uint256 am_sm_am = ((randomNumber % 1000000) / 10000 );
            // uint256 wisdom = 0;
