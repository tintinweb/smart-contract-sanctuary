...
import "../../tokens/BaseMinterPauserERC20.sol";

contract ERC20Mock is BaseMinterPauserERC20 {
    /* State Variables */
    string private constant NAME = "Token Mock";
    string private constant SYMBOL = "TM";

    /* Constructor */
    constructor(address settingsAddress, uint8 decimals)
        public
        BaseMinterPauserERC20(settingsAddress, NAME, SYMBOL, decimals)
    {
...
contract BaseMinterPauserERC20 is Base, Context, ERC20Burnable {
    constructor(
