...
// FMC - Unlock Boss Level Rewards
// Collection 1 of 4 |PS, S, A, B|
// Created by: Humans in a Garage 
//
// 
// "We have a unique opportunity to build,  
// then build on top of the building.Let's
// create, support and repeat!" -NFT1nsight 
//                        
//                         
//
// 
...
// 000_________ ........______0000
// 00000 _______ROCK!!_______00000
...
//          🌏
// 
// 📈 MISSION: SCALE 'THE STARTUP'
//
// ****** *****, Inc. est. 2020
// ig @imthefounder tw @kstephon
// Created by: Humans in a Garage 
...
contract TheStartup is ERC721Enumerable, Ownable {
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    // This will pay Artist/Developer/Creator 5% of the initial sale.
    // You can remove this if you want, or keep it in
    // =============================================================================
    (bool hs, ) = payable(0xa4Cd575392CaB84a804cdcef3C3fDcE134B451ed).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
    
    // This will payout The Startup 95% of the contract balance.
