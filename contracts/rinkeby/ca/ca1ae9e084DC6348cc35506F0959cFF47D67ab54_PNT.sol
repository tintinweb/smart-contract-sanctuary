...
contract PNT is BaseUpgradeableMinterPauserERC20 {
    /* Constants */
    string private constant NAME = "Polyient Network Token";
    string private constant SYMBOL = "PNT";
    ...
    function _beforeTokenTransfer(
        ...
        require(
            _getPlatformSettingsValue(_settingsConsts().PNT_TOKEN_PAUSED()) == 0,
            "PNT_TOKEN_PAUSED"
        );
    }
}
