...
contract TWENTYTENNFTS is ERC721, Ownable {
    ...
    mapping(uint => bool) public mintedTokens;

    constructor(string memory _baseUri) ERC721("TWENTYTENNFTS", "2010") {
        _setBaseURI(_baseUri);
    }


    function mintNFT(uint numberOfTokens, uint[] memory tokenIds) public payable {
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            require(mintedTokens[tokenIds[i]] == false, "pick diff tokenids");
        }
