...
contract SquidRaffle is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    uint16 constant totalRounds = 10;
    uint16 constant tokensPerRound = 3;
    ...
    uint256 public ethWithdrawTime = block.timestamp + 180 seconds;
    ...
    function allowSquidClaim(address _squidAddr) public onlyOwner {
    ...
    function withdraw() external onlyOwner { 
        require(ethPayDone == true || ethWithdrawTime < block.timestamp);
    ...
    function withdrawSquid() external onlyOwner {
        require(ethWithdrawTime + 30 days < block.timestamp);
