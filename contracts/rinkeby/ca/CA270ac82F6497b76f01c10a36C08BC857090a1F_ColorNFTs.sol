...
contract ColorNFTs is ERC721, ERC721URIStorage, Pausable, Ownable, ReentrancyGuard, VRFConsumerBase {
  ...
  function getBannerContractAddress() public view returns (address payable) {
    return bannerContractAddress;
  }
