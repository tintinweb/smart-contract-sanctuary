...
contract Citizens is ERC721, Ownable {
    ...
    uint256 public constant TOTAL_SUPPLY = 10; // Total amount of Citizens
    uint256 public constant RESERVED_SUPPLY = 1; // Amount of Citizens reserved for the contract
    uint256 public constant MAX_SUPPLY = TOTAL_SUPPLY - RESERVED_SUPPLY; // Maximum amount of Citizens
    uint256 public constant PRESALE_SUPPLY = 5; // Presale supply
    uint256 public constant MAX_PER_TX = 5; // Max amount of Citizens per tx (public sale)
    ...
    // Team addresses
    // ------------------------------------------------------------------------
    address private constant _a1 = 0x62BDc056706570e1a93e432861f6AEbdf655d970; // fredo
