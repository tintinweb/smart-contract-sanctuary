...
contract NFTmint is ERC721URIStorage {
    ...
    mapping(address => uint256) rewardTokens; // USER => Amount.
    ...
    address[] whitelist;
    string HAIR_URL =
        "https://gateway.pinata.cloud/ipfs/QmeoCmChHVfyDUayu3yddApt978DuApZ2YCpViawj7GYWU/";
    string HATS_URL =
        "https://gateway.pinata.cloud/ipfs/QmUDQGSbbYfQZX3YMqtQmKxTzHWSJNsTf7maADzswEEw5u/";

    constructor() ERC721("LYA Penguin token", "LYA") {
        owner = payable(msg.sender);
        salePoint = START_TIME + 86400 * presale_period;
    }
    ...
    function mintToken(uint256 _amount) public payable {
        require(pauseState == false, "Now Minting is paused!");
        require(
