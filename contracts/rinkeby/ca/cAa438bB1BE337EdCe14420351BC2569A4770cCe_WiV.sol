...
contract WiV is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl, ReentrancyGuard, WiVWineNFT {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://wivtechtest.blob.core.windows.net/metadata/";
    }
...
abstract contract WiVWineNFT is ERC721 {
    ...
    event LotMinted(    uint256    _lot_id, uint256 _process_id );
    event LotDestroyed(    uint256 _lot_id    );
    event LotRedeemed(    uint256 _lot_id    );
