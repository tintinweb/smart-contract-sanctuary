...
contract Bridge is Ownable, ReentrancyGuard {
	...
	function checkDepositInHomeChain(address _address) public view returns (uint256, uint256, uint256, address, uint256, uint256) {
	...
	function checkWithdrawalInForeignChain(address _address) public view returns (uint256, uint256, uint256, address, bytes32, bool) {
