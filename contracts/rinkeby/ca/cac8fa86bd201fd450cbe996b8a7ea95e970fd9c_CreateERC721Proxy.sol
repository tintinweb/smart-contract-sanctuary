...
contract CreateERC721Proxy {
        function create(string calldata name,string calldata symbol,string calldata tokenURI) external returns (address addr){
            ...
            newcontract.init(msg.sender,name,symbol,tokenURI);    
