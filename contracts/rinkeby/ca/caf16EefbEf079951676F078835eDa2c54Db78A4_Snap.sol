...
contract Snap is Context, IERC20, Ownable {
    ...
    // FIXME uint256 private _swapEth = 1 * 10**18;
    ...
    // FIXME  uint256 private _maxTxAmount = INITIAL_FRAGMENTS_SUPPLY;
    ...
    // FIXME await projectX._setMaxTxAmount("10000000000000000000000");
