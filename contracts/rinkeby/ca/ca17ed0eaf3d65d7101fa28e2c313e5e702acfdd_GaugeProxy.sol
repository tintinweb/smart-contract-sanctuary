...
contract Gauge is ReentrancyGuard {
    ...
    IERC20 public constant PICKLE = IERC20(0x53BecbFf070c7d273C9147FaA4bcC545A4e90FF2);
    IERC20 public constant DILL = IERC20(0x6a488fDe9D9aB47F457b4977eb84C3dA3D1797cd);
...
contract GaugeProxy is ProtocolGovernance {
    ...
    MasterChef public constant MASTER = MasterChef(0x2FE125762552aaB71b587A2fEDF292AB95ed2b65);
    IERC20 public constant DILL = IERC20(0x6a488fDe9D9aB47F457b4977eb84C3dA3D1797cd);
    IERC20 public constant PICKLE = IERC20(0x53BecbFf070c7d273C9147FaA4bcC545A4e90FF2);
