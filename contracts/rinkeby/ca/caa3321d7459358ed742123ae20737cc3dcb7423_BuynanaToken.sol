...
contract BuynanaToken is Context, Ownable, IERC20 {

	using SafeMath for uint256;
    using Address for address;
    string private _name = "Buynana";
    string private _symbol = "BUYNANA";
    ...
    function _getValues(uint256 amount) private returns (uint256) {
    	...
    	uint256 businessTax = operationalTax.add(burnableFundTax).add(ripeBananasTaxFee);
