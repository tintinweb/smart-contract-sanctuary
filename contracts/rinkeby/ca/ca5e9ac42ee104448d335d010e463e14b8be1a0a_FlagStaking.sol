 ...
 * Thank's for your job (drikkx.eth)
 */

contract FlagStaking is Ownable, ReentrancyGuard, Pausable { 
  ...
  constructor(address _stakingToken, address _rewardToken) {
    ...
    dailyEmissionsRate = 548000000000000000000; // daily emissions for a 800k supply over 4 years
