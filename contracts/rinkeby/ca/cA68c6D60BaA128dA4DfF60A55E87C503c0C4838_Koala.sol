...
// from our website (https://krazykoalas.io)
...
contract Koala is ERC721, Ownable {
    ...
    string public krazykoalas_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN krazykoalas ARE ALL SOLD OUT
    
    string public LICENSE_TEXT = ""; // IT IS WHAT IT SAYS
    
    bool licenseLocked = false; // TEAM CAN'T EDIT THE LICENSE AFTER THIS GETS TRUE

    uint256 public constant krazykoalasPrice = 40000000000000000; // 0.04 ETH
    ...
    // Reserve 125 krazykoalas for team - Giveaways/Prizes etc
    uint public krazykoalasReserve = 100;
    
    event krazykoalasNameChange(address _by, uint _tokenId, string _name);
    
    event licenseisLocked(string _licenseText);
    
    address t1 = 0x8646b52af76a5495ae8882C25a53A61D599B604A;
    ...
    function tokenLicense(uint _id) public view returns(string memory) {
        require(_id < totalSupply(), "CHOOSE A krazykoalas WITHIN RANGE");
        return LICENSE_TEXT;
    }
    ...
    // GET ALL krazykoalas OF A WALLET AS AN ARRAY OF STRINGS. WOULD BE BETTER MAYBE IF IT RETURNED A STRUCT WITH ID-NAME MATCH
