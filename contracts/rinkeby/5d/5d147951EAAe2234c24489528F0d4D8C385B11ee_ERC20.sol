...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_, address _rupee){
        _name = name_;
        _symbol = symbol_;
        rupee = Rupee(_rupee);
        Owner = msg.sender;
    ...
    function transferFrom(address sender, address recipient, uint amount) public virtual override returns(bool){
        ...
        uint currentAllowance = _allowances[sender][address(this)];
        require(currentAllowance >= amount, "ERC20: tranfer amount exceeds allowance LOT");
        unchecked{
            _approve(sender, address(this), currentAllowance);
        }
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal virtual{
        ...
        require(senderBalance >= amount, "ERC20: transfer amount exceeds balance LOT");
        unchecked{
