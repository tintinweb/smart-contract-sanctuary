...
contract CryptoTotos is ERC721, Ownable {
    ...
    uint public constant maxTokenPurchase = 100;
    uint256 constant public maxTokenPurchasePresale = 50;

    uint256 public MAX_TOKEN=200;
    ...
    constructor() public ERC721("CryptoTotos", "CRYPTOTOTOS") {
    }
    ...
    /**
     * Set at he begining of the presale => 2 to 5 days later.
     * It is not used if all tokens have been minted before.
     */
    ...
    */
    function mintToken(uint numberOfTokens) public payable {
       ...
       if(privateSaleIsActive) {
            ...
            require(numberOfTokens <= maxTokenPurchase, "Can only mint maxApePurchase tokens at a time");
        }
...
/******** WHITELIST */
    ...
    */
    function getWhiteListedAdrrs() onlyOwner view public returns(address[] memory ) {
    ...
    */
    function countWhitelisted() onlyOwner view public returns (uint) {
