...
contract TestFactory is EIP712, Ownable{
    ...
    function _encode(
        ...
        return abi.encodeWithSignature("initialize(address,address,string,string)", owner, operator, name, symbol);
    }
    ...
    function _deploy(
        ...
        bytes memory data = _encode(owner, operator, name, symbol);
        ...
        emit Deployed(owner, operator, implementation, deployedContract, name, symbol);
    }
    ...
    function deploy(
        ...
        _deploy(implementation, msg.sender, msg.sender, name, symbol);
    }

    function deployByFactoryOwner(
        address implementation,
        address owner,
        address operator,
        string memory name,
        ...
        _deploy(implementation, owner, operator, name, symbol);
    }
    ...
    function deployWithSig(
        ...
        _deploy(implementation, owner, owner, name, symbol);
    }
