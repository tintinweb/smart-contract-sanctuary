...
contract GodIsAWoman is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private _maxReserved = 5;
    uint256 private _reserved = 0;

    string public GIW_PROVENANCE = "";
    ...
    function mint(uint256 _tokensNum) external payable whenSaleStarted {
        ...
        require(_tokensNum <= 2, "You cannot mint more than 2 tokens at once!");
    ...
    function claimReserved(uint256 _number, address _receiver) external onlyOwner {
        require(_reserved + _number <= _maxReserved, "That would exceed the max reserved.");
