...
// File: contracts/CryptoChrist.sol
...
contract CryptoChrist is ERC721Enumerable, Ownable {
  ...
  uint256 private maxTokensPerMint = 10;

  string private tokenBaseURI = "ipfs://QmTSQFJmxX44xzdQ9V8k9YJTFMZ2Kh176MtfFDgxim4h75";

  uint256 private tokensToBuyAmount = 10000;

  uint256 private publicSaleStartTime = 1640390400; // Sat Dec 25 2021 00:00:00 GMT+0000

  constructor() ERC721("Crypto Christ NFT", "CC") {
  ...
  function setPublicSaleStartTime(uint256 val) external onlyOwner {
    publicSaleStartTime = val;
  }
  ...
  function mint(uint256 amount) external payable {
    require(hasPublicSaleStarted(), "Cannot mint tokens before the start of the public sale");
