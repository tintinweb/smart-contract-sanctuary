...
contract CD is ERC721, Ownable, ReentrancyGuard {
  using Counters for Counters.Counter;
  using SafeMath for uint256;
  Counters.Counter public _tokenIds;
  uint256 public _mintCost = 0.077 ether;
  uint256 public _maxSupply = 7000;
  bool public _isPublicMintEnabled = true;
  string public _baseTokenURI = " https://cryptohobos.io/tokens/";
