...
contract CryptoHearts is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CRYPTOHEARTS", "CRH") {
    setHiddenMetadataUri("ipfs://Qmbry8vbucx9MkF4SJHLX4WcsGXNXKnVkg9tJNQn3D239k/hidden.json");
  }
