...
pragma solidity >=0.7.0 <0.9.0;
  ...
  uint256 public preSaleDate = 1642166750;
  uint256 public preSaleEndDate = 1642512350;
  uint256 public publicSaleDate = 1643328000;
 ...
 address p2 = 0xe4908F4eb8d121cEDa149D0f2FF90204e0B050EB; // put withdraw address2 here
  ...
  function withdrawAll() public payable onlyOwner {
        ...
        (bool success, ) = payable(msg.sender).call{value: address(this).balance * 40 / 100}("");
        require(success);
