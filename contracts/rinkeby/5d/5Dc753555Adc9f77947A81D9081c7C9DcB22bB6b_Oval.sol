...
contract Oval is Ownable {
    ...
    event Supply(string, uint256, address);
    event Redeem(string, uint256, address);
    event Withdraw(string, uint256, address);
    ...
    function supplyErc20ToCompound(uint256 _numTokensToSupply) public returns (bool) {
        ...
        /// TODO: Fix amount, set _numTokensToSupply for now

        /// Mint oTokens for user
        ocErc20Contract.mint(msg.sender, _numTokensToSupply * 1e12); /// Oval Token scale 1e18, USDC scale 1e6. 18-6 = 12
