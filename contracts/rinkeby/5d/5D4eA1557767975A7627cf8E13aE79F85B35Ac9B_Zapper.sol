...
contract Zapper is Ownable, IZapper {
    ...
    function LazySeamusPAPRLazr(uint256 _amount, address sender) public {
        ...
        ROUTER.swapExactTokensForTokensSupportingFeeOnTransferTokens(_amount, 0, prntrToPaprRoute, msg.sender, now.add(600));

    }

    function LazySeamusPRNTRLazr(uint256 _amount, address sender) public {

        ROUTER.swapExactTokensForTokensSupportingFeeOnTransferTokens(_amount, 0, paprToPrntrRoute, msg.sender, now.add(600));
