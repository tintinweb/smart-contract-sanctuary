...
contract LANDRegistry is Storage, Ownable, FullAssetRegistry, ILANDRegistry, OwnableContract{
  ...
  function updateWhiteListMap(address[] user, bool flag) public onlyAdmin{
    for(uint256 i=0; i<user.length; i++){
      whiteListMap[user[i]] = flag;
    }
  }
