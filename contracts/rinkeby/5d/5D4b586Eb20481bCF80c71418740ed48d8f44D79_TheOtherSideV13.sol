...
contract TheOtherSideV13 is ERC721EnumerableT, Delegated {
  ...
  /**
    ...
    */
    ...
    function getAllStakeAddressSnapshot() external onlyDelegates returns( address[] memory) {
    ...
    function getAllStakeTokensSnapshot() external onlyDelegates returns( uint256[] memory) {
