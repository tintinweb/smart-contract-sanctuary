...
contract RewardToken is ERC721 {
    ...
    string private baseURI = "ipfs://not-set-yet";
    address public burnContract = 0x000000000000000000000000000000000000dEaD;

    constructor() ERC721("RewardToken", "RWRD") {}
    ...
    /**
     * @dev Sets the burn contract address, to allow it to call the contractMint function
     */
    function setBurnContract(address _burnContract) external onlyOwner contractIsNotFrozen {
    ...
    /**
     * @dev Withdraws to the deployer wallet
     */
    ...
    function contractMint(address _address) external contractIsNotFrozen {
        ...
        _mint(_address, currentSupply.current());
        currentSupply.increment();
    }

    /**
     * @dev Returns the id if the token exists
     */
