...
contract Vendor {
    ...
    function buyTokensForDAI(uint256 amountToBuy) public {
        ...
        amountOfDAITokensToPay = amountToBuy/uint256(getLatestPrice(aggregatorAddressFor_DAI_USD))/100000000;
        amountOfDAITokensToPay2 = amountToBuy/(uint256(getLatestPrice(aggregatorAddressFor_DAI_USD))/100000000);
