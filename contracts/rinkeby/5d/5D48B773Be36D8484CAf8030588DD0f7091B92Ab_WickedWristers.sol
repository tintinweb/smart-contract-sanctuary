...
contract WickedWristers is ERC721Enumerable, Ownable {
    ...
    uint256 public constant wristerPrice = 100000000000000000;          // 0.10 ETH
    ...
    uint256 public constant maxAdminMintable = 10;                      // max wristers allowed to mint during Admin
    ...
    function mintAdmin() public {
        ...
        require(_totalClaimed[msg.sender].add(1)  <= maxAdminMintable, "Can only mint one wrister for Admin");
