...
contract CactiClub is ERC721Burnable, Ownable {
    ...
    function reserveCacti(address addr, uint256 amount) public {
        ...
        require(msg.sender == address(0xC236b8399A773F59daEbDE5E3ac4c4C888626198) || msg.sender == address(0xA57f5Bf8e0F8A10Ba04A0d3235ccA6c857A0c974), 'You are not whitelisted to reserve');
