...
contract BonnyDolls is Ownable, ERC721V2 {
    ...
    function presaleMint(uint _amount, uint _price, bytes memory _signature) external payable saleIsOpen  {
        uint256 total = _owners.length;
    ...
    function verifyAddress(address _minter, uint _amount, uint _price, bytes memory _signature) public pure returns (address) {
