...
contract TESTCOIN is Context, IERC20, Ownable {
    ...
    address public addressBurn = 0x0000000000000000000000000000000000000000;
    ...
    function _transferBurn(address sender, uint256 tAmount) private {
        (,,,,,,uint256 tBurn) = _getValues(tAmount);
        _rOwned[sender] = _rOwned[sender].sub(tBurn);
        _rOwned[addressBurn] = _rOwned[addressBurn].add(tBurn);
        emit Transfer(sender, addressBurn, tBurn);
    }
