...
contract PoolPobladoNFT is Context, ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_SUPPLY = 133;
    uint256 public constant MAX_PRESALE_SUPPLY = 33;
    uint256 public constant MAX_MINT_PER_TX = 20;

    // The base link that leads to the image / video of the token
    string public baseTokenURI = "https://pool-nft-001.uc.r.appspot.com/";

    // List of addresses that have a number of reserved tokens for whitelist
    mapping(address => uint256) public whitelistReserved;

    constructor() ERC721("PoolPobladoNFT", "MINDPOBLADO") {
        price = initial_price;
    }
