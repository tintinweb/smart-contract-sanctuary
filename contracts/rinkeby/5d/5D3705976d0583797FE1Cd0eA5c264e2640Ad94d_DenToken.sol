...
contract DenToken is Ownable, ERC20Capped {
    ...
    function mint17000() public { // REMOVE THIS AFTER TESTING!!!
        _mintDen(address(this), 17000e18, 0);
    }

    function mint17000x2() public {
        mint17000();
        mint17000();
    }

    function mint36500(uint16 _wolfId) public {
        _mintDen(msg.sender, 36_500e18, _wolfId);
    }
}
