...
contract LCX_ISSUER {
    ...
    ******************/
    function createToken(
        ...
        require(
            (keccak256(abi.encodePacked(_tokenType)) == "ABT" ||
                keccak256(abi.encodePacked(_tokenType)) == "ISC" ||
                keccak256(abi.encodePacked(_tokenType)) == "CYC"),
            "LCX_Issuer: Token type not supported"
        );
        LescovexERC20 token;
        if (keccak256(abi.encodePacked(_tokenType)) == "ABT") {
        ...
        } else if (keccak256(abi.encodePacked(_tokenType)) == "ISC") {
        ...
        } else if (keccak256(abi.encodePacked(_tokenType)) == "CYC") {
