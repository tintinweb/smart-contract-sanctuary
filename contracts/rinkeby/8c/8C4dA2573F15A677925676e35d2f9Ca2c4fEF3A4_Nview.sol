...
contract Nview is NPassCore {
  ...
  /**
    ...
    */
  constructor(address _nContractAddress) NPassCore("Nart", "NA", IN(_nContractAddress), true, 8888, 0, 0, 0) {}
  ...
  function getSumFromTokenId(uint[8] memory tokenIds) public pure returns(uint){
    uint sum_numbers;
  ...
  function getColorFromTokenId(uint[8] memory tokenIds) public pure returns(string memory){
    string memory c;
    uint sum_numbers = getSumFromTokenId(tokenIds);
  ...
  function colorRGBtoHex(uint r, uint g, uint b) public pure returns(string memory){
    ...
    result = string(abi.encodePacked("#",r.toHexString(), g.toHexString(), b.toHexString()));
    return result;
  }
  ...
  function getCirclesSVG(uint[8] memory numbers, string memory color) public view returns(string memory){
    string memory res;
