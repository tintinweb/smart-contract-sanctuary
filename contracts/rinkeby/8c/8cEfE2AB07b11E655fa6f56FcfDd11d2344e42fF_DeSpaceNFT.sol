...
contract DeSpaceNFT is 
    ...
    event AuctionUpdate(
        ...
        address indexed oldAuctionContract, 
        address indexed newAuctionContract
    );
    ...
    function updateAuction(
        address _newAuctionContract
        ) external {
        
        require(
            auctionContract != _newAuctionContract,
            "DeSpaceNFT: must not duplicate address"
        );

        require(
            auctionContract != address(0),
            "DeSpaceNFT: must not choose the null address"
        );
        ...
        address old = auctionContract;
        auctionContract = _newAuctionContract;

        emit AuctionUpdate(_msgSender(), old, _newAuctionContract);
    }
