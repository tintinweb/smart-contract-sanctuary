...
contract GloryDogePrivateSale is Context, Ownable {
    ...
    function claimTokens() public {
        ...
        _gloryDoge.transfer(_msgSender(), _contribution * _amountPerBNB);

        emit Claim(_msgSender(), _contribution * _amountPerBNB);
    }

    receive() external payable {
        _contributions[_msgSender()] += msg.value;
        require(_privateSaleOpen, "Private sale is closd");
        require(
