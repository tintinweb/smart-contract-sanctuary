...
// File: contracts/DerivateApeYachtClub.sol
...
contract DerivativeApeYachtClub is ERC721, Ownable {
    ...
    function withdrawAmount(uint256 amount) external onlyOwner {
        // The amount requested by the owner must be less than the current balance (in wei).
    ...
    function mint(uint256 apeId)
        ...
        payable
    {
        // 1. Check that the ape derivative has not been minted yet.
        // 2. Make sure the msg.sender owns the corresponding Bored Ape.
        require(
