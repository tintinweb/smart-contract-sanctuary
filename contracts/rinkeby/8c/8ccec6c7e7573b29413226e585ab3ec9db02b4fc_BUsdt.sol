...
contract BUsdt is Context, IBEP20, Ownable { // contract name
    ...
    uint256 public _marketingBNBFee = 150; // marketing BNB fee
    ...
    uint256 public _minTokensSwapToAndTransferTo = 90000000 * 10**1 * 10**_decimals; // modifier to after each successfull swapandliquify disable the swapandliquify
