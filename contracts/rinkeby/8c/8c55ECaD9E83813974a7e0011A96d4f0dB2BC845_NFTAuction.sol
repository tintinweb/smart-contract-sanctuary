 ...
 //       isAuctionNotStartedByOwner( _tokenId)
    {
        ...
        if(nftContractAuctions[_nftContractAddress][_tokenId] != address(0)){
            nftContractAuctions[_nftContractAddress][_tokenId] = address(0);
    ...
    function resetAuction( string memory _tokenId)internal  {
  //      require(escrowOwner[msg.sender],"you cannot reset the Auction");
        nftContractAuctions[_nftContractAddress][_tokenId] = address(0);
    }
