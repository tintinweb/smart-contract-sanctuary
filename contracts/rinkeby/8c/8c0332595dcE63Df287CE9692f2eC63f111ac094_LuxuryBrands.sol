...
contract LuxuryBrands is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE7D5D08cBD87071831F45CE3d2EA99b0f4A6A976); // Marketing Address
    ...
    string private _name = "LuxuryBrands";
    string private _symbol = "LuxBrands";
