...
contract LeviathanTest is ERC20Mintable, OwnedUpgradeabilityStorage, Claimable {
    ...
    address payable[] private _registry;
    ...
    address payable[] private _projects;
    ...
    function _setVote(address payable voter, address choice) internal {
    ...
    function _countVotes() internal onlyMinter {
      ...
      for (uint256 i=0; i<_registry.length; i++) {
        ...
        _votedFor[_votes[_registry[i]]].push(_registry[i]);
      }
    ...
    function registerProject(address projectContractAddress, uint256 amountOffered, uint256 giveawayAmount, uint256 amountForSale) public payable {
      ...
      // need to not accept projects offering 0 tokens
      ...
      _projectsData[msg.sender] = ProjectInfo(msg.sender, projectContractAddress, IERC20(projectContractAddress), amountOffered, giveawayAmount, amountForSale, block.timestamp, _projectid);
    ...
    function _addToGiveawayAmount() public payable {
    ...
    function buyProjectToken() public payable {
