...
contract puluts{
    ...
    IERC20  plt = IERC20(address(0xc826f4a7620a3433838818e319B17924EFD3f82A));
    RTInterface rt = RTInterface(address(0x61895F2be8e72Ca668915595bb1c350bb3611210));
    ...
    function deposit(uint amount ,address recommender)public {
        ...
        if(recommender!= address(0x0) && rt.get_recommender(msg.sender) == address(0x0)){
