...
contract TestCatryoshkas is ERC721, ERC721Enumerable, Ownables {
    ...
    uint256 private constant _SPECIAL_CATS = 6;
    uint256[_SPECIAL_CATS] private _specialCats;
    ...
    function bindSpecialCats(uint256[] memory specials_) public onlyOwners {

        uint256 insertIndex = specials_.length == _SPECIAL_CATS ? 0 : _specialCats.length;
