...
contract aithereal is ERC721Enumerable, Ownable {
    ...
    uint256 public price = 100000000000000000; // 0.100000000000000000 ETH
    ...
    function setMaxTokens(uint256 tokens) public onlyOwner {
        maxTokens = tokens;
    }
    ...
    function reserve(address _to, uint256 _amount) public onlyOwner {
        require(
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(0x1Dac794d333ce41461540a0BCF8195029EFE6557).send((_balance * 25) / 100));
        require(payable(0xf6AbfbABF3Ec8f1635F32cDA0F5288351bb7e6A6).send((_balance * 3) / 100));
