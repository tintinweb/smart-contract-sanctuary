...
"July", "August", "September", "October", "November", "December"
    ...
    "Changing my pfp","Channeling my Pete Davidson energy",
    "Taking Doge on a walk", "Serenading the Queen of England",
    ...
    "Getting a colonoscopy", "Arm wrestling The Rock"
    ];
    
    string[] private outfits = [
        "My birthday suit", "A Spiderman costume", "J Lo's 2000 Grammy's dress",
        "Air Force 1s","Socks and sandals", "Crocs",
        "Harry Potter's invisibility cloak",
        "Steve Job's turtleneck", "A gray patagonia vest",
        "My Oculus headset","Hella sunscreen",
    ...
    string[] private locations = [
        ...
        "On the toilet", "At Olive Garden","At a diner with Elon Musk",
        ...
        "At the Grammys","At Crypto.com Arena","At Times Square",
        "In space with a billionaire","At a funeral home",
...
//// BYOT /////////////
  ...
  //////////////////////
    ...
    function getTimeOfDay(uint256 tokenId) public view returns(string memory) {
        ...
        if(hourIndex >= 5 && hourIndex < 11 && timeSuffix == 0){
            return "gm";
    ...
    function mint(uint256 _toMint) public nonReentrant payable {
        ...
        require(numPurchased + _toMint <= totalSupply - freeSupply, "Will exceed alloted supply");
    ...
    function freeMint(uint256 _toMint) public nonReentrant {
        require(_toMint <= 20, "Can only mint a max of 20");
        require(numFreeMinted + _toMint <= freeSupply, "Will exceed alloted free supply");
        for(uint256 i = 0; i < _toMint; i++){
