...
contract AuctionFactory is IAuctionFactory, IERC721Receiver {
    ...
    function getAuctionSlots(uint256 auctionId) external view override returns(Slot[] memory) {
        return auctions[auctionId].slots;
    }
...
interface IAuctionFactory {
    ...
    /// @notice Gets slots of an auction
    /// @param auctionId The auction id
    function getAuctionSlots(uint256 auctionId) external view returns(Slot[] memory);
}
