...
// File: contracts/ZeroClaiming.sol
...
contract ZeroClaiming is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public whitelistDeadline = 1 days;
    ...
    function adminSetRate(uint256 _newRate) external onlyOwner{
        rate = _newRate;
    }
    ...
    function purchase() public payable {
        ...
        if (block.timestamp < genesis + whitelistDeadline) {
            require(buyers_limits[msg.sender] >= msg.value, "Limit exceeded");
            buyers_limits[msg.sender] -= msg.value;
        }
