...
contract decoffer_V2{
    ...
    Credit_token CT = Credit_token(0xd7C2fD4410257Ed6127A6c3cC6bd463c5f84D477);
    ...
    function withdraw()public {
        ...
        if(coffer_info[msg.sender][3] >= coffer_info[msg.sender][5]){
            ...
            now_balance = now_balance.sub(coffer_info[msg.sender][1]).sub(profit).add(fine);
        }else{
            now_balance = now_balance.sub(coffer_info[msg.sender][1]).sub(profit);
        }
