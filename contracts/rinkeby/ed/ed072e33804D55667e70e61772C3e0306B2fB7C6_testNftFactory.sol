...
// File: contracts/metadata/SurvivorMetadata.sol
...
// File: contracts/metadata/SurvivorFactory.sol
...
// File: contracts/metadata/ZombieMetadata.sol
...
// File: contracts/metadata/MetadataFactory.sol
...
contract testNftFactory is Ownable, ERC721Enumerable{
    ...
    function buy (uint8 tokenType, bool stake, bool mintOnlyUsingSUP) external payable {
        ...
        //mint&stake
            ...
            SUP.transferFrom(_msgSender(), address(this), 60 ether);
            SUP.burn(60 ether);
