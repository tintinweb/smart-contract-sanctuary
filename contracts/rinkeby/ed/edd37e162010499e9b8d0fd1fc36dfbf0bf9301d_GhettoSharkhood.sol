...
contract GhettoSharkhood is ERC721, Ownable, MinterMintable, GhettoSharkhoodInterface {
    ...
    modifier onlySealed() {
        require(!_isRevealed_, "GhettoSharkhood: has been revealed");
        _;
    }
     ...
     */
    function mint(address owner) external override onlyMinter onlySealed enoughToMint(1) returns (uint256) {
