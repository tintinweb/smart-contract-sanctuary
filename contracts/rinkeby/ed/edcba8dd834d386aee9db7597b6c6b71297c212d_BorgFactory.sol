...
contract BorgFactory{
    ...
    function addBorgPeice(string memory borgPeice, string memory fragment, string memory delimiter) public{
        string[] storage image = _borgs[borgPeice];
    ...
    function getBorgPeice() public view returns(string memory borgPeice){
        string[] memory image = _borgs[borgPeice];
