...
contract ScriptStorageNFT1 is ERC721, Pausable, AccessControl, ERC721Burnable {
    ...
    constructor() ERC721("NFT Storage 3", "NF3") {
...
//    }
    ...
    function formatScript (uint256 tokenId) internal view returns (string memory){
        ...
        string memory hashyString = string(abi.encodePacked('let tokenData = {"hash":',tokenIdToHash[tokenId],"}"));
        string memory baseURL = "data:text/html;base64,";
        string memory uriScript = string(abi.encodePacked(baseURL,scriptHEAD,hashyString,storedScripts,scriptTAIL));
