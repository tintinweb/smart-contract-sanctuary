...
// @title: OnChain Monkeys
// @author: huuep

// The Onchain Monkey NFTs are completely on chain
// All metadata and all image data are on chain and created from this file
// 10,000 unique monkeys with 171 parts in 7 different categories
// The distribution, rarity, and colors are mapped from BAYC.
// (The monkeys with gold fur are the rarest ones.)
//
// getAttributes returns the attributes and this can be used for other apps
//   that may want to create unique items up to 10k
...
contract Monkey2 is ERC721Enumerable, ReentrancyGuard, Ownable {
	using Strings for uint256;

  uint256 public constant maxSupply = 10000;
  uint256 public numClaimed = 0;

  string[] private background = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  string[] private fur1 = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  string[] private fur2 = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  uint8[] private fur_w =[249, 246, 223, 141, 116, 114, 93, 90, 89, 86, 74, 72, 55, 48, 39, 32, 28, 14, 8];
  string[] private eyes = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  uint8[] private eyes_w = [245, 121, 107, 101, 79, 78, 70, 68, 62, 58, 56, 51, 50, 48, 44, 38, 35, 33, 31, 22, 15, 10, 7];
  string[] private mouth = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  uint8[] private mouth_w = [252, 172, 80, 79, 56, 49, 37, 33, 31, 30, 28, 27, 26, 23, 22, 18, 15, 14, 13, 12, 11, 10, 10, 10, 9, 8, 7, 7, 6, 5, 5, 4, 3];
  string[] private earring = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  ...
  string[] private clothes2 = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  ...
  string[] private hat1 = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  string[] private hat2 = ["f00","f00","222","f00","f00","f00","f00","f00","f00","00f","00f","00f","00f","00f","00f","00f","222","00f","f0f","222","f0f","f0f","f0f","f0f","f0f","f0f","f0f","f80","f80","f80","f80","f80","f00","f80","f80","f80","90f","90f","00f","90f","90f","90f","222"];
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" width="500" height="500" viewBox="0 0 500 500"><rect x="0" y="0" width="500" height="500" style="fill:#',
'"/><rect width="300" height="120" x="99" y="400" style="fill:#',
'"/><circle cx="190" cy="40" r="5" style="fill:#',
'"/><circle cx="310" cy="40" r="5" style="fill:#',
'"/><circle cx="100" cy="250" r="50" style="fill:#',
'"/><circle cx="100" cy="20" r="20" style="fill:#',
'"/><circle cx="400" cy="250" r="5" style="fill:#',
'"/><circle cx="400" cy="250" r="2" style="fill:#',
'"/><circle cx="250" cy="250" r="10" style="fill:#',
'"/><circle cx="25" cy="250" r="10" style="fill:#',
'"/><circle cx="200" cy="215" r="3" style="fill:#fff"/><circle cx="35" cy="2" r="1" style="fill:#fff"/><circle cx="200" cy="220" r="20" style="fill:#',
'"/><circle cx="300" cy="20" r="20" style="fill:#',
'"/><circle cx="20" cy="220" r="7" style="fill:#000"/><circle cx="300" cy="20" r="7" style="fill:#000"/>',
...
'</svg>'];
  ...
  string private cross='<rect x="95" y="275" width="10" height="4" style="fill:#872"/><rect x="85" y="285" width="30" height="10" style="fill:#872"/>';
  string private clo1='<rect width="300" height="120" x="99" y="40" style="fill:#';
  string private clo2='"/><rect width="50" height="55" x="20" y="430" style="fill:#';
  string private hh1='<rect width="200" height="99" x="150" y="40" style="fill:#';
  string private hh2='"/><rect width="200" height="33" x="150" y="16" style="fill:#';
  string private sl1='<rect x="150" y="190" width="20" height="30" style="fill:#';
  string private sl2='"/><rect x="160" y="170" width="10" height="50" style="fill:#';
  string private mou='<line x1="287" y1="331" x2="32" y2="366" style="stroke:#000;stroke-width:5"/>';

string private ey1='<rect x="160" y="190" width="75" height="15" style="fill:#';
string private ey2='"/><rect x="275" y="190" width="5" height="15" style="fill:#';
string private ey3='<rect x="160" y="235" width="18" height="50" style="fill:#';
string private zz='"/>';

string private ea1='<circle cx="100" cy="290" r="14" style="fill:#';
string private ea2='fe7';
string private ea3='999';
string private ea4='"/><circle cx="100" cy="29" r="4" style="fill:#000"/>';
...
string private ra2='h';
string private ra3='1';
string private ra4='i';
string private ra5='i';
string private ra6='3';

string private co1=', ';

string private rl1='{"name": "nkey #';
string private rl3='"}';
...
struct Ape {
  ...
  uint8 hat;
	...
	Ape memory ape = randomOne(tokenId);
        return string(abi.encodePacked(rl4,Base64.encode(bytes(string(abi.encodePacked(rl1,tokenId.toString(),'", "description": "Loot is ran", "image": "data:image/svg+xml;base64,',Base64.encode(bytes(genSVG(ape))),rl3))))));
    }
    ...
    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
        require(tokenId > 5 && tokenId < 10001, "invalid claim");
        _safeMint(owner(), tokenId);
    }
    
    constructor() ERC721("slfnkey", "DFONK") Ownable() {}
}
