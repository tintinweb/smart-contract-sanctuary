...
contract RiverSide is OwnableUpgradeable, IERC721ReceiverUpgradeable, PausableUpgradeable, VRFConsumerBaseUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function _claimGenXRewards(address account, uint16[] calldata tokenIds) internal whenNotPaused _updateEarnings nonReentrant() {
  ...
  function _claimGenXReward(address account, uint16 tokenID) internal whenNotPaused _updateEarnings nonReentrant() returns (uint256 owed) {
