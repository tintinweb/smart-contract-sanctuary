...
contract Punk is ERC721, Ownable {
    ...
    uint public constant maxFreeMint = 20;

    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        MAX_SUPPLY = maxNftSupply;
        mintPrice  = 20000000000000000; // 0.01
    }
    ...
    function mintPunk() public onlyOwner {        
    ...
    function mintPunk(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to purchase");
        ...
        if(numberOfTokens == 3 ){
            ...
            mintPrice = mintPrice.mul(numberOfTokens);
        }
        for(uint i = 0; i < numberOfTokens; i++) {

            uint mintIndex = totalSupply();
            
            if(mintIndex < maxFreeMint){
                mintPrice = 0;
            }
