...
contract WarpedApeYachtClub is ContextMixin, ERC1155Supply, NativeMetaTransaction, AuthorizedList {
    ...
    uint256 public maxApeHoldings = 15;

    mapping(address => uint256) public apeHoldings;
    mapping(uint256 => mapping(address => uint256)) public apeBalances;
    ...
    */
    ...
    unchecked {
        ...
        if(apeHoldings[to] > maxApeHoldings){
