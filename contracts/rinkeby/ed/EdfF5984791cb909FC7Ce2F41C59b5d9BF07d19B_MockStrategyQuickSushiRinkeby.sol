...
contract MockStrategyQuickSushiRinkeby is StrategyBase {

  string private constant _PLATFORM = "MOCK_STRATEGIES";
  address public constant SUSHI_MockSUSHI_MockQUICK = address(0x654b9378909013e7251AF8C0A2524126Fc9eDeFf);
  address public constant MockQUICK = address(0x8a6ff5BbD1FE5CAe737386781e7BCf6212eEF8bA);
  address public constant MockSUSHI = address(0x3B8AC0774B0AF054634602865fB849ef752CA474);
