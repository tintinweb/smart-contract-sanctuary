...
import {RideLibHoldingV2} from "../../libraries/core/RideLibHoldingV2.sol";
import {RideLibHolding} from "../../../libraries/core/RideLibHolding.sol";
import {RideLibTicket} from "../../../libraries/core/RideLibTicket.sol";

import {IRideHoldingV2} from "../../interfaces/core/IRideHoldingV2.sol";

contract RideHoldingV2 is IRideHoldingV2, ReentrancyGuard {
    /**
    ...
    function getHolding(address _user, bytes32 _key)
        ...
        returns (uint256)
    {
        return RideLibHoldingV2._getHolding(_user, _key);
    }
}
