...
contract FullTest6 is ERC721Enumerable, Ownable {
  ...
  function buildImage() public pure returns(string memory) {
   return Base64.encode(bytes(abi.encodePacked(
     ...
     '</circle>',
     '<image href="https://s3.ap-northeast-1.amazonaws.com/metadata.nft-studio.com/assets/tests/test.png" height="50" width="50"/>',
     '</svg>'
   )));
   }
