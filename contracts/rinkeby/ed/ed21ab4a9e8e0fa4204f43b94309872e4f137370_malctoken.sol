...
contract malctoken is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "malc token";
    string private constant _symbol = "malc";
    ...
    address payable private _marketingAddress = payable(0x29d2aCDD63A22A9FF349dD46957FF50495839213);
    address payable private _buybackAddress = payable(0x211403C2a8Ddf31e679B7203Bc3df59A68823f83);
