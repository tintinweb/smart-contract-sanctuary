...
contract DestinyWarCharacter is ERC721, ERC721Enumerable, Ownable {
    ...
    // for Normal NFT
    uint256 public amntNormal = 45000;
    uint256 public amntNormalImg = 50;
    string  public normalImgUri;
    // for Rare NFT
    uint256 public amntRare   = 5000;
    uint256 public amntRareImg = 50;
    string  public rareImgUri;
    ...
    constructor(string memory _notrevealURI, string memory _normalImgURI, string memory _rareImgURI) ERC721("DestinyWarCharacter", "DWC") { 
        notRevealedUri = _notrevealURI;
        normalImgUri = _normalImgURI;
        rareImgUri = _rareImgURI;
    }
    ...
    function setRareImgURI(string memory _uri) external onlyOwner {
        rareImgUri = _uri;
    }
    ...
    function setAmntRare(uint256 _amntRare) external onlyOwner{
        amntRare = _amntRare;
    }
    ...
    function setAmntRareImg(uint256 _amntRareImg) external onlyOwner{
        amntRareImg = _amntRareImg;
    }
    ...
    function internalMint(address to) internal {
        ...
        string memory currentBaseURI = _tokenIdCounter.current() > amntNormal ? normalImgUri : rareImgUri;
        uint256 imgId = _tokenIdCounter.current() > amntNormal ? random(amntNormalImg) : random(amntRareImg);
        string memory _image = string(abi.encodePacked(currentBaseURI, imgId.toString(), baseImgExtension));
