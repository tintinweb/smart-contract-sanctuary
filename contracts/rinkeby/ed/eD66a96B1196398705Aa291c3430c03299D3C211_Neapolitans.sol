...
// File: contracts/neapolitans.sol

pragma solidity 0.7.0;

/**
 * @title Neapolitans contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract Neapolitans is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public constant neapolitanPrice = 10000000000000000; // in Wei, 0.01
    uint256 public constant maxNeapolitanPurchase = 20;
    uint256 public constant MAX_NEAPOLITANS = 10000;
    uint256 public constant MAX_GIFT = 30;
    ...
    function withdraw() external onlyOwner {
        ...
        uint halfBalance = balance.mul(50).div(100);

        beneficiary1.transfer(halfBalance);
    ...
    function mint(uint numberOfTokens) external payable {
        ...
        require(neapolitanPrice.mul(numberOfTokens) <= msg.value, "Ether value sent is not correct");
