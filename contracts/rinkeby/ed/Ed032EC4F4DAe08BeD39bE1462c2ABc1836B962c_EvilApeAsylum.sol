...
contract EvilApeAsylum is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public constant originalCost = 0.01 ether; // Original Cost
  uint256 public cost = 0.01 ether; // Variable Cost
  uint256 public tier1Cost = 0.01 ether; // Whitelist Tier 1
  uint256 public tier2Cost = 0.02 ether; // Whitelist Tier 2
  uint256 public tier3Cost = 0.03 ether; // Whitelist Tier 3
  uint256 public maxSupply = 8000;
  uint256 public maxMintAmount = 8;
  bool public paused = false;
  bool public whitelistOnly = false;
  uint256 public walletLimit = 8000;
