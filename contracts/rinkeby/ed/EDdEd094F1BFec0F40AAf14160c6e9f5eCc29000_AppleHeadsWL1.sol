...
contract AppleHeadsWL1 is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    constructor(string memory baseURI, string memory _initNotRevealedURI) ERC721("AppleTest123", "AhT") {
        setBaseURI(baseURI);
