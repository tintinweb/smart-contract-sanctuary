...
import './lib/PostDeliveryCrowdsale.sol';
 ...
 */
contract EchoCrowdsale is Crowdsale, CappedCrowdsale, TimedCrowdsale, PostDeliveryCrowdsale {
    ...
    function _processPurchase(address _beneficiary, uint256 _tokenAmount) internal override(Crowdsale, PostDeliveryCrowdsale) {
...
contract Crowdsale is Ownable, ReentrancyGuard {
     ...
     */
    constructor (uint256 __rate, address payable __wallet, IERC20Upgradeable __token) {
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        ...
        // Send ETH directly to issuer after token purchase
        _forwardFunds();
    ...
    */
    ...
    /**
     * @dev Ends the sale and returns token balance to _wallet.
     */
    function endSale() onlyOwner public {
        // Require admin
        require(_msgSender() == _wallet, 'Not called from issuer');

        // // Forward the ETH balance of the contract to the issuer
        // require(_forwardFunds(), "Failure to transfer eth to issuer");

        // Transfer remaining tokens back to the issuer
        require(_token.transfer(_wallet, _token.balanceOf(address(this))), "Did not successfully transfer token balance back to issuer");
 ...
 * UNUSED - modification taken from https://github.com/Blockchain-development/syntera-contracts/blob/master/zeppelin-solidity/contracts/crowdsale/distribution/PostDeliveryCrowdsale.sol
 */
// solhint-disable-next-line contract-name-camelcase
contract __unstable__TokenVault {

    // function transfer(IERC20Upgradeable token, address to, uint256 amount) public {
