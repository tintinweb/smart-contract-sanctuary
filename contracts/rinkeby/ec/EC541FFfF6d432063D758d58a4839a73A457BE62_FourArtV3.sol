 ...
 */
contract FourArtV3 is Context, ERC1363, AccessControlEnumerable, ERC20Burnable, ERC20Pausable, ERC20Capped{
    ...
    constructor(string memory name, string memory symbol, uint256 _sellPrice,uint256 _buyPrice) ERC20(name, symbol) ERC20Capped(1000000000 * (10 ** uint256(decimals()))) {
   ...
   // @dev if owner wants to transfer contract ether balance to own account.
    ...
    function buy() payable public {
        ...
        uint256 amount = msg.value * (10 ** uint256(decimals())); //ether amount need to convert in wei.
    ...
    function sell(uint256 amount) public {
        ...
        uint256 requiredBalance = SafeMath.mul(amount / (10 ** uint256(decimals())),sellPrice); // calculates the amount.
