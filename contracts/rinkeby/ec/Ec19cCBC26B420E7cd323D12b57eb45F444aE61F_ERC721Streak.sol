...
contract ERC721Streak is ERC721PresetMinterPauserAutoId, ContextMixin, NativeMetaTransaction {
...
//        }
    ...
    function mintItem(address to, string memory _tokenUri) public virtual returns(uint256 tokenId) {
