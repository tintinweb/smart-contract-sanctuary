...
// Part: OpenZeppelin/openzeppelin-c[email protected]/Ownable
...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        return (usdEntryFee * 10**8) / uint256(answer);
    }
        ...
        override
    {
        ...
        uint256 playersIndex = randomness % players.length;
        recentWinner = players[playersIndex];
