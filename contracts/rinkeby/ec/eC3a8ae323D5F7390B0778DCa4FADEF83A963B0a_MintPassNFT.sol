...
contract MintPassNFT is ERC1155Pausable, Ownable {
    ...
    constructor(address _owner) public ERC1155("https://gateway.pinata.cloud/ipfs/") {
        ...
        lastID++;
        mint(_owner, lastID, 1, "QmSfc1FpqDQM1hsdCYfAAYyW62BPfehTsVRUuSXD6pUv8T");
    }
