...
// contracts/MyNFT.sol
// 
contract Adorabilities is ERC721, VRFConsumerBase {
    ...
    internal override {
        ...
        uint256 age = (randomNumber % 18);
        uint256 cuteness = ((randomNumber % 100) / 10);
        uint256 stamina = ((randomNumber % 1000) / 100);
