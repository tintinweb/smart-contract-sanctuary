  ...
  function _beforeTokenTransfer(
        ...
        , Allowlist
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x5F0A028d9577edaB4AaB7777ba1b6bC208b270fe);
            payableFees.push(uint256(65));
    
            payableAddresses.push(0x2a6704aBD642917Ef20Ec90B88A9493995B6b2C9);
            payableFees.push(uint256(30));
        ...
        function mintTo(address _to) public payable {
            ...
            require(msg.value == PRICE, "Value needs to be exactly 0.04 ETH!");
            uint256 newTokenId = _getNextTokenId();
            _mint(_to, newTokenId);
            _incrementTokenId();
        }
    ...
    // File: contracts/cryptoChumzContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CryptoChumzContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("CryptoChumz", "CHUMZ", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmZLWeSeeE75d2wnwLU1yQgS38WFMfWGSfrxYagJAURCDs/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/z2zet5UXyX32vrRbh9ip/contract-metadata";
        }
    }