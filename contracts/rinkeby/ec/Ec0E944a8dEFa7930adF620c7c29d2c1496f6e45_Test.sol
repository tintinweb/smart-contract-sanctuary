...
contract Test {
    ...
    Orbit2D orbit2d;
    Orbit3D orbit3d;
    mapping (bytes => Orbit3D) public Solar_System_Keplerian_Elements;
    ...
    function test_orbit_3d() public {
        string[9] memory planetList = ['Mercury', 'Venus', 'Earth', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto' ];
        for (uint8 i = 0; i < 9; i++) {
            Solar_System_Keplerian_Elements[bytes(planetList[i])]._update_Euler_angle_transformation_matrix();
        }
    ...
    function read_orbit3d_matrix(string memory planet) public view returns (int256[3][3] memory) {
