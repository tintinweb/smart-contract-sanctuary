...
contract DuckArt is ERC721, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    address[] private _team = [0x10cD8079755bC23b7E644F60627478e62E8817D5,
                                0xb79B40D3798A84509Cb802adDD24D2422C9B73C6];
    ...
    function isFirstWhitelisted(address _a) public view returns(bool) {
        return whitelist1Wallets[_a];
    }
    ...
    function isSecondWhitelisted(address _a) public view returns(bool) {
        return whitelist2Wallets[_a];
    }
    ...
    function getCurrentStatus() public returns(WorkflowStatus) {
        if (!saleActive) {
