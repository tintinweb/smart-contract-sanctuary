...
contract Market is Ownable{
    ...
    function buyToken(uint amountOutMin,  uint deadline)payable public {
    ...
    function saleToken(uint256 _value,uint amountOutMin,  uint deadline) public {
    ...
    function setPath(address _usdg,address _usdt, address _uniswap)onlyOwner public {
        _setPath(_usdg,_usdt,_uniswap);
    }
