...
contract Vlaunch is ERC20 {
    ...
    constructor(
        ...
        // start time moved to 25th december and we will update time as we get closer
        ...
        TokenVesting _advisors = new TokenVesting(owner, alocation.advisors, 1640383200, 365 days, 730 days, true);
        _mint(address(_advisors), 20_000_000e18);
...
//TODO we can use this version from openzepelin
