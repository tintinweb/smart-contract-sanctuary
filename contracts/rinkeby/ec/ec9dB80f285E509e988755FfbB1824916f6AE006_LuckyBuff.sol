...
contract LuckyBuff is ERC20, Ownable {
    ...
    function _transfer(
        ...
        uint penalty_fee = penalty_fee_for_holders.add(penalty_fee_for_liquidity);
        uint sell_fee = sellFee_for_holders.add(sellFee_for_liquidity);
        uint256 amountWithFee = amount.sub(penalty_fee).sub(sell_fee);
