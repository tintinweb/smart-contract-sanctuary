...
// END AMOS //
    ...
    function redeem(
       ...
       lastRedeemed[msg.sender] = block.number;
        ...
        mintersDetails[msg.sender].amount = mintersDetails[msg.sender].amount.sub(collateralNeededAfterFee.mul(10**_missingDeciamls));
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0x8e6E93d86d7Ae60c9F0A120AfC2fA74deeD6Dc43"
    }
  },
  "outputSelection": {
    "*": {
