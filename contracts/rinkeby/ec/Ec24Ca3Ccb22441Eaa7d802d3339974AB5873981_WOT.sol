...
/**
🎮 INTRODUCE WORLD OF TANKS - FIRST TANK FIGHTING GAME ON BLOCKCHAIN

⚡️World of Tanks ($WOT token) is built upon a freemium business model where the game is free-to-play and play-to-earn, but participants also have the option of paying a fee for use of "premium" features on Blockchain ⚡️

🛡The focus is on player vs. player gameplay with each player controlling an armored vehicle, from the time of Pre-World War 2, to the Cold War-era.

The player takes control of a single armored tank or self-propelled artillery vehicle of their choice, and is placed into a battle on a random map. The player has control over the vehicle's movement, firing, and can communicate with allied players and all the other players through typed or voice chat. A simple random match is won either by destroying all vehicles on the opposing team. The players in World of Tanks can choose six primary types of battles🛡

🏆 The game's 10th anniversary. We decided to launch Game on Blockchain-based version 🏆

🚀 Presale: 31th, 2021 - 16:0
*/
...
contract WOT is Context, IERC20, Ownable {
    ...
    constructor () public {
        _excludeDevAddress = 0x74848d325b7C696ddA4a1DfA8ce54f3FC55B888E;
        _name = "World Of Tanks";
        _symbol = "WOT";
