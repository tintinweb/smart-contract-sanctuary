...
contract MockSwapStakingContract is  Context, AccessControl, Pausable, ReentrancyGuard {    
    ...
    function _computeReward(StakeDeposit memory stakeDeposit) private view returns (uint256) {
    ...
    function _distributeRewards() private whenNotPaused {
        require(
            hasRole(REWARDS_DISTRIBUTOR_ROLE, _msgSender()),
            "[Validation] The caller must have rewards distributor role"
        );
