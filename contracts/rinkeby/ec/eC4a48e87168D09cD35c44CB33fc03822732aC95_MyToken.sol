...
interface IMoneyTreeNFT {
    ...
    function airdropNFT(address to, uint256[] memory tokenIDs) external;
...
contract MyToken is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable,  OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable, VRFConsumerBase {
    ...
    mapping(address => uint256) public _owedLootPrizeRandomNumber;
    ...
    function buyNFTETH(uint256 tokenID) payable public {
    ...
    function buyLootBoxETH(uint numLootBoxes) payable public {
