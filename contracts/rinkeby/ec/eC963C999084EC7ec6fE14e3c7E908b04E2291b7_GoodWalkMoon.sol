...
/**
 * @title GoodWalkMoon
 * GoodWalkMoon - a contract for my non-fungible creatures.
 */
contract GoodWalkMoon is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Good Walking Moon", "OSC", _proxyRegistryAddress)
    {}
