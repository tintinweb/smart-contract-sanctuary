...
contract Router is Ownable {
    ...
    address public immutable merge;  // The Merge contract

    address public immutable gToken;  // Governance token

    address public immutable manager;  // Wallet proxy manager
    ...
    uint256 public immutable WEIGHT_MULTIPLIER;  // a multiplier to mass
    ...
    function setContenderWallet(address contender_) external onlyOwner {
        specialWallets[contender] = false;
        contender = contender_;
    }
