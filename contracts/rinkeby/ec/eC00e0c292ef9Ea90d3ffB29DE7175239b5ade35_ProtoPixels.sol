...
contract ProtoPixels is ERC721Enumerable, Ownable {
    ...
    function mintPixel(uint256 num) public payable {
        uint256 supply = totalSupply();
        require( saleIsActive,                              "Sale is paused" );
        require( num < 21,                              "Only 20 at a time" );
        require( supply + num < 10000 - _reserved,      "Exceeds maximum supply" );
        require( msg.value >= _price * num,             "TX Value not correct" );
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Too many!" );
