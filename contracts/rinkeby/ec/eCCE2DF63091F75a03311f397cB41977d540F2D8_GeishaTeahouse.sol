...
contract GeishaTeahouse is ERC721Enumerable, ERC721Pausable, Ownable, ERC721Burnable {
    ...
    bool public vipPreSaleActive = false;
    ...
    function mint(uint256 _mintAmount) public payable whenNotPaused {
        ...
        require(vipPreSaleActive || preSaleActive || publicSaleActive, "Sale has not started yet");
    ...
    function getCurrentCost() public view returns (uint256) {
        if (preSaleActive || vipPreSaleActive) {
            return preSaleCost;
        } else {
            return cost;
        }
    ...
    function setSaleActive(bool _vipPresale, bool _presale, bool _publicSale) public onlyOwner {
        vipPreSaleActive = _vipPresale;
