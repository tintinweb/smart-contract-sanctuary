...
contract BlockchainBillboard is ERC721Full, Ownable {
    ...
    uint256 constant peakCapacity = 100;
    ...
    function mint(string memory tokenURI, uint256 tokenId) payable public returns (bool)  {
        ...
        if (tokenId == 22 || tokenId == 34 || tokenId == 42 || tokenId == 54 || tokenId == 62 || tokenId == 74 || tokenId == 82 || tokenId == 94) {         // INITIAL TOKEN OFFERING
