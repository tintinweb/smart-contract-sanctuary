...
contract APIConsumer is ChainlinkClient {
    ...
    constructor() public {
        setPublicChainlinkToken();
        // oracle = 0x1b666ad0d20bC4F35f218120d7ed1e2df60627cC; // kovan
        oracle = 0x7AFe1118Ea78C1eae84ca8feE5C65Bc76CcF879e;
        //jobId = "e7fbe2c2bde643788f4a76b7b09db8ff"; // kovan
    ...
    function requestWeather() public returns (bytes32 requestId) 
    {
        ...
        request.add("get",string(abi.encodePacked("api.openweathermap.org/data/2.5/weather?q=", city, "&appid=60c410e380bce538ecb359dd84ae70e7")));
