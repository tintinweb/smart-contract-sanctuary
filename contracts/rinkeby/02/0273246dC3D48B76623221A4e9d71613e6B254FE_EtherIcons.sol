...
contract EtherIcons is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    returns (string memory)
  {
    require(
      ...
      string(
        abi.encodePacked(
          "ERC721Metadata: _tokenURI of _tokenId: ",
          _tokenId,
          " cant be read because _tokenId doesnt exist."
        )
      )
    );
    ...
    require(
      ...
      string(
        abi.encodePacked(
          "ERC721Metadata: _tokenURI of _tokenId: ",
          tokenId,
          " cant be set because _tokenId doesnt exist."
        )
      )
    );
  ...
  function tokenNAME(uint256 _tokenId) public view returns (string memory) {
    require(
      ...
      string(
        abi.encodePacked(
          "ERC721Metadata: _tokenNAME with _tokenId: ",
          _tokenId,
          " doesnt exist."
        )
      )
  ...
  function _setTokenNAME(uint256 tokenId, string memory _tokenNAME) public {
    ...
    require(
      ...
      string(
        abi.encodePacked(
          "ERC721Metadata: _tokenNAME for _tokenId: ",
          tokenId,
          " already set."
        )
      )
