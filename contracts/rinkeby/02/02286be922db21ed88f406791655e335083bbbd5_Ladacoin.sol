...
contract UpgradedStandardToken is StandardToken {
    ...
    function safeTransfer(address to, uint value) public returns (bool);
    function safeTransferFrom(address from, address spender, uint value) public returns (bool);
...
contract Ladacoin is Pausable, StandardTokenWithFees, BlackList {
    ...
    function transfer(address _to, uint _value) public whenNotPaused returns (bool) {
        ...
        if (deprecated) {
            return UpgradedStandardToken(upgradedAddress).transfer(_to, _value);
        } else {
    ...
    function transferFrom(address _from, address _to, uint _value) public whenNotPaused returns (bool) {
        ...
        if (deprecated) {
            return UpgradedStandardToken(upgradedAddress).transferFrom(_from, _to, _value);
        } else {
    ...
    function approve(address _spender, uint _value) public whenNotPaused returns (bool) {
        if (deprecated) {
            return UpgradedStandardToken(upgradedAddress).approve(_spender, _value);
        } else {
    ...
    function increaseApproval(address _spender, uint _addedValue) public whenNotPaused returns (bool) {
        if (deprecated) {
            return UpgradedStandardToken(upgradedAddress).increaseApproval(_spender, _addedValue);
        } else {
    ...
    function decreaseApproval(address _spender, uint _subtractedValue) public whenNotPaused returns (bool) {
        if (deprecated) {
            return UpgradedStandardToken(upgradedAddress).decreaseApproval(_spender, _subtractedValue);
        } else {
    ...
    function deprecate(address _upgradedAddress) public onlyOwner {
        ...
        deprecated = true;
        if(_upgradedAddress == address(this)) deprecated = false;
