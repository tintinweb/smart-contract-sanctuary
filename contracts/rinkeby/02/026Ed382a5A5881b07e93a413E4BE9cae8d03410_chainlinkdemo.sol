...
contract chainlinkdemo is ChainlinkClient{
    ...
    uint256 public numberOfOracleSwaps;
    bytes32 public currentJobId;
    ...
    constructor() public {
        ...
        numberOfOracleSwaps = 0;
        currentOracleAddress = 0x807bf4842C40c130a10E388E4c410e837330a75A;
        currentJobId = "8c076f2dae734ce8be84718e9e8b9b7d";
        fee = 1*10**18;
    }

    function requestPrice() public returns (bytes32 requestId){
        Chainlink.Request memory request = buildChainlinkRequest(currentJobId, address(this), this.fulfill.selector);
        ...
        return sendChainlinkRequestTo(currentOracleAddress, request, fee);
    }

    function setNewJob(bytes32 jobId, address oracleAddress) public returns (bytes32) {
        //insert chainlink connecting to job functionality here
    ...
    function getCurrentJob() public view returns (bytes32){
        return currentJobId;
    }
