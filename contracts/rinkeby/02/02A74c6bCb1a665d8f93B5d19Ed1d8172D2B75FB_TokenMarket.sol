...
contract TokenMarket is TokenMarketBase {
    ...
    */
    ...
    function fullLoanPaybackEarly(uint256 _loanId) public {
     ...
     */
    function partialLoanPaybackEarly(uint256 _loanId, uint256 _paybackAmount) public {
        ...
        require(_paybackAmount < loanOffersToken[_loanId].loanAmountInBorrowed, "GLM: Invalid Loan Amount");
        ...
        {   
            uint256 remainingLoanAmount =  loanDetails.loanAmountInBorrowed - _paybackAmount;
