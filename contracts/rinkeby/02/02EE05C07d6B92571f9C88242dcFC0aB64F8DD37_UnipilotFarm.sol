...
contract UnipilotFarm is IUnipilotFarm, ReentrancyGuard, IERC721Receiver {
    ...
    // mapping farming status --> tokenId => bool
    mapping(uint256 => bool) public farmingActive;

    //mapping Exist in whitelist or not --> pool address => bool
    mapping(address => bool) public poolWhitelist;

    //mapping poolinfo address =>Poolinfo struct
    mapping(address => PoolInfo) public poolInfo;

    //mapping poolAltInfo address => PoolAltInfo struct
    ...
    address internal constant UNIPILOT = 0x6c3ee6937007b76d74A0837E579190666966cC1c;

    constructor(address _ulm, address _governance) {
