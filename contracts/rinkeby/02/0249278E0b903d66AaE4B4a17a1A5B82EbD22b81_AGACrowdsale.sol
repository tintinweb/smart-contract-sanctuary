...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.5.1/contracts/access/roles/CapperRole.sol
...
contract AGACrowdsale is PausableCrowdsale, CappedCrowdsale, AllowanceCrowdsale, CapperRole {
...
constructor (
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        super._preValidatePurchase(beneficiary, weiAmount);
        // solhint-disable-next-line max-line-length
        require(_contributions[beneficiary].add(weiAmount) >= getCap(beneficiary), "Agape Crowdsale: minimum investement is 0.1 eth");
    }
