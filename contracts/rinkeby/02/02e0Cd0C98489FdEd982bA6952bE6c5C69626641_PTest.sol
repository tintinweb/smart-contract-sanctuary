...
contract PTest is ERC721, Ownable {
    ...
    constructor() public ERC721("PTest", "PTEST") {}

    event TokenBought(uint256 mintedTokenID, string image, string metadata, string poemText);
    ...
    function mint(
        ...
        // save poem on chain
        poems[newItemId].image = _image;
        poems[newItemId].metadata = _metadata;
        ...
        emit TokenBought(newItemId,_image, _metadata, _poemText);
