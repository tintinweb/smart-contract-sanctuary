...
contract Metagenesis is ERC721, Ownable {
    ...
    uint private airdropItems = 24;
    uint public maxItems = 6666;
    uint public preMintCount = 0;
    uint private airdropMintCount = 0;
    uint public totalSupply = 0;
    uint public maxItemsPerPreMint = 3; 
    uint public maxItemsPerTx = 5; 
    uint public maxItemsPerAddress = 5; // airdrop count except
    string public _baseTokenURI = "https://a.com/test/";
    ...
    // record mint address->count
    mapping(address => uint) private mintAddress;

    event Mint(address indexed owner, uint indexed tokenId);

    constructor() ERC721("Meta Genesis", "MG") {}
    ...
    function publicMint() external payable {
        ...
        require(mintAddress[msg.sender] + amount <= maxItemsPerAddress, "Max 5 per address");
    ...
    function withdrawAll() external onlyOwner {
        ...
        sendEth(0x941b8B3791DDEE52801cab8295b785Fe61DbD0ab, amount);
    }
