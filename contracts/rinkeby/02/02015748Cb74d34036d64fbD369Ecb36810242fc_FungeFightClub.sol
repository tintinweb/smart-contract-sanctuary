...
contract FungeFightClub is ERC721, ERC721Enumerable, Ownable
{
    ...
    bool public ogSaleIsActive = true;
    ...
    address payable private devguy = payable(0xFCcdFA147B105d9b1E9dd495A135F972ccCa2733);

    constructor() ERC721("Funge Fight Club", "FFC") {}
    ...
    function withdraw() external
    {
        ...
        uint devPart = address(this).balance / 100 * 3;
