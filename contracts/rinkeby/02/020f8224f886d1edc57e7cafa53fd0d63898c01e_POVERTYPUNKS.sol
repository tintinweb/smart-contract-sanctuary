...
contract POVERTYPUNKS is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public PunksPrice = 50000000000000000; // 0.050 ETH
    ...
    uint256 public PunksReserve = 250; // Reserve 250 Punks for team & community (Used in giveaways, events etc...)

    event licenseisLocked(string _licenseText);

    constructor() ERC721("Poverty Punks", "POVERTY") {}
        ...
        onlyOwner
    {
        ...
        require(
            _reserveAmount > 0 && _reserveAmount <= PunksReserve,
            "Not enough reserve left for team"
        );
        for (uint256 i = 0; i < _reserveAmount; i++) {
            _safeMint(_to, supply + i);
        }
        PunksReserve = PunksReserve.sub(_reserveAmount);
    }
    ...
    function mintPunk(uint256 numberOfTokens) public payable {
        ...
        require(
            msg.value >= PunksPrice.mul(numberOfTokens),
