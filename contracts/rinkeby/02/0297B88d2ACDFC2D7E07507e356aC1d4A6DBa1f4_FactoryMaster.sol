    ...
    function createChild(Types types,string memory name,string memory symbol,uint256 _interestsRate) external payable {
        ...
        if (types == Types.erc20) {
           ...
           require(types != Types.none, "you must enter the word 1");
            require(keccak256(abi.encodePacked((name))) !=keccak256(abi.encodePacked((""))),"rERC20:equireed value");
            require(keccak256(abi.encodePacked((symbol))) !=keccak256(abi.encodePacked((""))),"ERC20:requireed value");
        ...
        if (types == Types.erc721) {
            ...
            require(types != Types.none, "you must enter the word 1");
            require(keccak256(abi.encodePacked((name))) !=keccak256(abi.encodePacked((""))),"ERC721:requireed value");
            require(keccak256(abi.encodePacked((symbol))) !=keccak256(abi.encodePacked((""))),"ERC721:requireed value");
        ...
        if (types == Types.erc2917) {
            ...
            require(types != Types.none, "you must enter the word 1");
            require(keccak256(abi.encodePacked((name))) !=keccak256(abi.encodePacked((""))),"ERC2917:requireed value");
            require(keccak256(abi.encodePacked((symbol))) !=keccak256(abi.encodePacked((""))),"ERC2917:phai nhap gia tri");
            require(_interestsRate >= 0, "value must be greater than 0");
            require(msg.value>=fee_erc2917,"ERC2917:value must be greater than 0.3");
