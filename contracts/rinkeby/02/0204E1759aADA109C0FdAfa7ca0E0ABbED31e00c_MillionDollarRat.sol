...
// TODO: Set actual provenance hash
contract MillionDollarRat is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant SALE_START_TIMESTAMP = 1618517008;

    // The sale lasts for 21 days
    uint256 public constant REVEAL_TIMESTAMP = 1618517018;

    // Sale price tiers
    uint256 private constant TIER_1_PRICE = 5000000000000000; // 0.005 ETH
    uint256 private constant TIER_2_SUPPLY_THRESHOLD = 51;
    uint256 private constant TIER_2_PRICE = 15000000000000000; // 0.015 ETH
    uint256 private constant TIER_3_SUPPLY_THRESHOLD = 251;
    uint256 private constant TIER_3_PRICE = 18000000000000000; // 0.018 ETH
    uint256 private constant TIER_4_SUPPLY_THRESHOLD = 1251;
    uint256 private constant TIER_4_PRICE = 20000000000000000; // 0.020 ETH
    uint256 private constant TIER_5_SUPPLY_THRESHOLD = 2051;
    uint256 private constant TIER_5_PRICE = 22000000000000000; // 0.22 ETH
    uint256 private constant TIER_6_SUPPLY_THRESHOLD = 2851;
    uint256 private constant TIER_6_PRICE = 40000000000000000; //  0.4 ETH
    uint256 private constant TIER_7_SUPPLY_THRESHOLD = 3251;
    uint256 private constant TIER_7_PRICE = 45000000000000000; // 0.45 ETH
    uint256 private constant TIER_8_SUPPLY_THRESHOLD = 3301;
    uint256 private constant TIER_8_PRICE = 50000000000000000; // 0.5 ETH

    // ETH-USD price at deployment: $2350
    uint256 private constant GOLDEN_RAT_PRIZE = 5 ether;
    uint256 private constant GOLDEN_RAT_THRESHOLD = GOLDEN_RAT_PRIZE + 1 ether;
     ...
     *  `startingIndex` for rats and calculates balance shares.
     */
