...
contract BnbPrediction is Ownable, Pausable {
    ...
    constructor(
        ...
        symbols.push('BNB');
        symbols.push('BTC');
        adminAddress = 0x9ba5271fB97aBbcdBd295470ab22Bb987A1876e9;
        operatorAddress = 0x9ba5271fB97aBbcdBd295470ab22Bb987A1876e9;
        //        intervalBlocks = _intervalBlocks;
        //        bufferBlocks = _bufferBlocks;
        minBetAmount = 100000000;
        oracleUpdateAllowance = 60;
        _setUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        teamAddress = 0x43eE4A2547fF50ab3139D3A5992BDC86A65D3fDc;
    ...
    function setRewardRate(uint256 _rewardRate) external onlyAdmin {
        ...
        emit RatesUpdated(currentEpochMap["BNB"], rewardRate, treasuryRate);
    }
    ...
    function _claimTreasury() internal {
        ...
        uint256 destroy = treasuryAmount.mul(destroyRate).div(TOTAL_FEE);
        uint256 team =  treasuryAmount.sub(destroy);
        address[] memory path;
        path[0] = uniswapV2Router.WETH();
        path[1] = uniswapV2Pair;
        //50%回购TP销毁
        uniswapV2Router.swapExactETHForTokens(destroy, path,blackHoleAddress,0);
        //50%
        treasuryAmount = 0;
    ...
    function pause(string memory _symbol) public onlyAdminOrOperator whenNotPaused {
        ...
        emit Pause(currentEpochMap[_symbol]);
    }
    ...
    function unpause(string memory _symbol) public onlyAdmin whenPaused {
        ...
        emit Unpause(currentEpochMap[_symbol]);
    }
