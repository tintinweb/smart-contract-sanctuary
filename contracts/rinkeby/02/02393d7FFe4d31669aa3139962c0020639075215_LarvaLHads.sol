...
//.____                               .____    .__                .___      
//|    |   _____ __________  _______  |    |   |  |__ _____     __| _/______
//|    |   \__  \\_  __ \  \/ /\__  \ |    |   |  |  \\__  \   / __ |/  ___/
//|    |___ / __ \|  | \/\   /  / __ \|    |___|   Y  \/ __ \_/ /_/ |\___ \ 
//|_______ (____  /__|    \_/  (____  /_______ \___|  (____  /\____ /____  >
//        \/    \/                  \/        \/    \/     \/      \/    \/ 


contract LarvaLHads is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getSVG(LarvaObject memory larvaLad) internal view returns (string memory) {
        ...
        parts[0] = '<svg id="x" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 30 30" ><g transform="translate(-1,1)"><path fill="#638596" d="M0 0h30v30H0z"/>';
        parts[1] = '<path fill="';
        ...
        parts[8] = '</g><style>#x{shape-rendering: crispedges;}</style></svg>';
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Larva Lad #', toString(tokenId), '", "description": "Larva Lhads are a play on the CryptoPunks and their creators, Larva Labs. The artwork and metadata are fully on-chain and were randomly generated at mint."', getTraits(larvaLad), '"image": "data:image/svg+xml;base64,', Base64.encode(bytes(getSVG(larvaLad))), '"}'))));
    ...
    constructor() ERC721("Larva Lhads", "LARVA") Ownable() {}
}
