...
contract AvaxLottery is Ownable {
    ...
    uint256 public avaxLotteryComissionAmount = 12;
    uint256 lotTokenComissionAmount = 0;
    //mapping (address => GuessedPerson[]) public persons;


    function changeAvaxComission(uint256 newComission) public onlyOwner returns (uint256 amount)  {
       avaxLotteryComissionAmount = newComission;
       return avaxLotteryComissionAmount;
    ...
    function profitPercantage(uint256 pricePool)internal  returns(uint256 multiplier){
        ...
        uint256 profitMultiplier = avaxpool*10000/netPool;
    ...
    function changeLotComission(uint256 newComission) public onlyOwner returns (uint256 amount)  {
       lotTokenComissionAmount = newComission;
       return lotTokenComissionAmount;
