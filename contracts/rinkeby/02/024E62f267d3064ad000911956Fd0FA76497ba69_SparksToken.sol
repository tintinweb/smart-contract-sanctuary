...
contract SparksToken is ILockerUser, Context, ERC20, Ownable {
    ...
    uint256 public constant INITIAL_SUPPLY = 325000000 * (10**uint256(DECIMALS));
    ...
    uint256 public constant SEED_INVESTMENT = 19500000 * (10**uint256(DECIMALS)); // 6% for Seed investment
    uint256 public constant STRATEGIC_ROUND = 32500000 * (10**uint256(DECIMALS)); // 10% for Strategic Round
    ...
    uint256 public constant TEAM_ALLOCATION = 25187500 * (10**uint256(DECIMALS)); // 7.75% for Team allocation
    uint256 public constant STAKING_REWARDS = 65000000 * (10**uint256(DECIMALS)); // 20% for Staking Revawards
    uint256 public constant COMMUNITY_DEVELOPMENT = 40625000 * (10**uint256(DECIMALS)); // 12.5% for Community development
    uint256 public constant MARKETING_DEVELOPMENT = 48750000 * (10**uint256(DECIMALS)); // 15% for Community development
