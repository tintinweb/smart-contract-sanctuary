...
contract OCETrickorTreat is ERC721Enumerable, Ownable {
  ...
  function mint(address _wallet, uint256 _mintAmount) public payable {
    ...
    if (mintPhase == 1) { // Whitelist can mint presaleMintAmount
        ...
        require(presaleMintAmount - _mintAmount - ownerMintedCount >= 0, "You've already minted the maximum presale amount");
  ...
  function claim(address _wallet, uint256 _mintAmount) public {
      ...
      uint256 totalCanMint = amountCanMint - addressMintedBalance[_wallet];

      require(totalCanMint < _mintAmount, "You can not claim more trick or treat NFTS then you have Ghost.");
  ...
  function withdraw() public payable onlyOwner {
    ...
    require(success, "OnChain: The transfer failed");
  }
}