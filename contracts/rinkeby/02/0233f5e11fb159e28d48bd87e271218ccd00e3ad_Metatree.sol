...
contract Metatree is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 8888;
    uint256 public reserved = 388;
    ...
    constructor(string memory _baseuri, string memory _NotRevealedUri) ERC721A("MyEngine", "MTE", 20) {
        setBaseURI(_baseuri);
