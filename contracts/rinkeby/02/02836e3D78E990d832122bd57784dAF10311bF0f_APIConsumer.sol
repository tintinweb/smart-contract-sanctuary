...
contract APIConsumer is ChainlinkClient {
    ...
    function fulfillPriceWithUintArray(bytes32 _requestId, uint256[] memory _valuation) public recordChainlinkFulfillment(_requestId) {
