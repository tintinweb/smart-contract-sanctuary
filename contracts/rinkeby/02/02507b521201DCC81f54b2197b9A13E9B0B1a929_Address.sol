...
contract DepressedDucks is ERC721, Ownable {
    ...
    uint256 public constant duckPrice = 20000000000000000; // 0.02 ETH
    ...
    // GET ALL DUCKS OF A WALLET AS AN ARRAY OF STRINGS. WOULD BE BETTER MAYBE IF IT RETURNED A STRUCT WITH ID-NAME MATCH
