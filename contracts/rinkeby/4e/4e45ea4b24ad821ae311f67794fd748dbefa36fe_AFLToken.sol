...
// File contracts/AFLToken.sol



contract AFLToken is ERC20PresetMinterPauser {
    ...
    function burn(uint256 amount) public virtual override {
        require(hasRole(MINTER_ROLE, _msgSender()), "must have role to burn");
        _burn(_multisig, amount);
    }
}