    ...
    ERC721PausableUpgradeable
{
	...
	uint256 constant public PRICE = 4 ether / 100;
    ...
    function reserveMeow() public onlyOwner {        
    ...
    function mintMeow(uint256 amount) public payable {
        require(amount <= 20, "Can only mint 20 tokens at a time");
		require(msg.value >= PRICE * amount, "Incorrect price");
		require(_tokenIdTracker.current() + amount < BUYABLE, "Exceed max supply");
