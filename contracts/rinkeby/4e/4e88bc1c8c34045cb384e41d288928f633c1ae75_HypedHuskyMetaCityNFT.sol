...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
    ...
    //0xdff5efd0ee4c90bc4a0f21927ed8d145f1c5b809|round earring|yellow|wagmi sweater|teal neon|red warm hat|single katana|simple smile|sea|
    //0x9213db07070c02c333ba2eb6e83c6d568071a88d9b354a2a814232c6da45e2f0792215e8f374e2db9b3d28239e5ef62b5dca35db81b10a882d8c7c861b19462d1b
    //103000000000000000 //test

    //address proxyRegistryAddress;
	  uint256 private totalTokenAssets = 10000;
    uint256 private totalReserve = 336;
    uint256 public _currentTokenID = 0;
    uint256 public _customizedTokenId = 9001;
    ...
    uint256 private preSalesMaxSupply1 = 888;
    uint256 private preSalesMaxSupply2 = 7776;
    ...
    */
    ...
    function presales(
        ...
        if(salesStage == 1){
            require(sold <= preSalesMaxSupply1, "Max Token reached for Sales Stage 1");
            require(_initialSupply * preSalesPrice1 == msg.value, "Invalid Fund");

        }else if(salesStage == 2){
            require(sold <= preSalesMaxSupply2, "Max Token reached for Sales Stage 2");
    ...
    function publicsales(
        ...
        require(sold <= preSalesMaxSupply3, "Max Token reached for Sales Stage 3");
