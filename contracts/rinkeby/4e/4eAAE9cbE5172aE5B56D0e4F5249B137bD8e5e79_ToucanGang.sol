...
contract ToucanGang is  ERC721Enumerable,  Ownable{
 ...
 using SafeMath for uint256;
  ...
  address constant creatorAddress = 0xa2D38Ba2A327Cc7ceDd9B5c62748a38885f83765; 
  address constant creator2Address = 0x1470da31E47D522e2e1236346E978ed03659f147;
  address constant creator3Address = 0xD446a21A8b1554a8d56afFA82d31a8957f1f3268;
  address constant creator4Address = 0xD446a21A8b1554a8d56afFA82d31a8957f1f3268;
  string public provenance;
  string public baseTokenURI;

  constructor( string memory _baseURI)  ERC721("ToucanGang", "TOUC") public{
   ...
   function _baseURI() internal view virtual override returns (string memory) {
    ...
    function withdrawAll() external onlyOwner {
        ...
        payable(creatorAddress).transfer(balance.mul(10).div(100));
        payable(creator2Address).transfer(balance.mul(30).div(100));
        payable(creator3Address).transfer(balance.mul(30).div(100));
        payable(creator4Address).transfer(balance.mul(30).div(100));
