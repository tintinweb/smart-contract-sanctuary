  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x2133BEBE01A2DaC6439a103E5462876357c636D4);
    ...
    // File: contracts/molepunksContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MolepunksContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Molepunks", "Punks", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/LKb7syNPEogN5tmDDtXJ/contract-metadata";
        }
    }