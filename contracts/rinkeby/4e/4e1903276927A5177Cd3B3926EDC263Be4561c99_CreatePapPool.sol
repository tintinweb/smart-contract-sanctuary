...
contract PAPpool {
    ...
    constructor(
        ...
        uint256 _tokenAmountT1,
        uint256 _tokenAmountT2,
        uint256 _tokenAmountT3
    ) {
...
contract CreatePapPool is Ownable {
    ...
    */
    function createPool(
        ...
        uint256 _tokenAmountT1 = (_Tier1.maxAllocation * _Tier1.swapPriceNumerator) /
            _Tier1.swapPriceDenominator;
