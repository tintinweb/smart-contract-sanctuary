...
contract SHIBABEAST is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  // ========== SB CONTRACT WITHDRAW ==========
  function WITHDRAW() public payable onlyOwner {
    uint256 _BALANCE = address(this).balance;
    uint256 _FOUNDER_BALANCE = _BALANCE * 14 / 100;
    uint256 _PARTNER_BALANCE = _BALANCE * 7 / 100;
    ...
    payable(0x2A935d4261f5bd0De6FFDA0ed6461153a7Ea1470).transfer(_CMUNITY_BALANCE); /* == SB|CMUNITY ===== */
  }
}