...
contract CatHand is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CatHand", "CH") {
    setHiddenMetadataUri("ipfs://QmVorpu39UQJFrEohiYbQw9ev4AzxyQakMkjMc5NSGAsna/hidden.json");
  }
