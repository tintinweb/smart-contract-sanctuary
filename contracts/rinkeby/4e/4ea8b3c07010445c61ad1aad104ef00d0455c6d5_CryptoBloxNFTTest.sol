...
contract CryptoBloxNFTTest  is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;
    Counters.Counter private _reserveId;

    uint256 public MAX_SUPPlY = 88;
    uint256 public PRESALE_SUPPLY = 10;
    uint256 public MAX_ALLOWED = 5;
    uint256 public MAX_PRESALE_ALLOWED = 2;
    //0.88,1.00,1.25,1.50,1.75,2.00,2.25,2.88
    uint256[] public priceScale = [88000000000000000,100000000000000000,125000000000000000,150000000000000000,
    175000000000000000,200000000000000000,225000000000000000,288000000000000000]; 
    ...
    constructor(string memory baseURI) ERC721("CryptoBloxNFTTest", "CBLOX") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFT(uint256 _count) public payable {
        ...
        price = priceScale[(totalSupply()-_reserveId.current()+1)/10];
