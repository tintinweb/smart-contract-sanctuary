...
contract Traitz is ERC721, ERC721Burnable, ERC721Enumerable, Ownable {
  ...
  string public PROVENANCE_HASH; // of rarity map
  string public PROVENANCE_ADDRESS; // of private seed
  ...
  constructor(
    ...
    string memory provenanceAddress
  )
  ...
  function trait(uint256 tokenId) public view returns (bytes32) {
    ...
    return keccak256(abi.encodePacked(publicSeed(tokenId), privateSeed()));
  }
