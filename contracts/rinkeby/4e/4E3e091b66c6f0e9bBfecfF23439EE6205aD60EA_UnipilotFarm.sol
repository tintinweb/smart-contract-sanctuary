...
contract UnipilotFarm is IUnipilotFarm, ReentrancyGuard, IERC721Receiver {
    ...
    address internal constant UNIPILOT = 0x4AC41d4f46C5d00F1Bc3deC8a59cc7Dc4da42b87;
    ...
    // function updateUserBooster(uint256 _tokenId, uint256 _booster) external onlyStake {
    //     toggleBooster(_tokenId);
    //     emit UserBooster(_tokenId, userInfo[_tokenId].booster = _booster);
    // }
    ...
    function getBoostMultiplier(
        ...
        return
            IUnipilotStake(stakeContract).getBoostMultiplier(
                userAddress,
                poolAddress,
                tokenId
            );
    ...
    function userMultipliers(address userAddress, address poolAddress)
        external
        view
        returns (uint256)
    {
        return IUnipilotStake(stakeContract).userMultipliers(userAddress, poolAddress);
    }
}
