...
contract WooInuV2 is ERC20("Nature boy inu", "WOOINU"), Ownable, IWooInuV2 {
    ...
    /* 
     * @dev Sets fees, excluded and approves tokens to the uniswap v2 router. 
     * And creates a uniswap v2 pair, and sets fees 
     */
    constructor() {
        ...
        _currentFees = Fees(
            ...
            100000000000e9, // Max transfer (number)
            10000000000e9, // Threshold to distribute
            address(0x3868518b7499bAB12F7a98eD5251fc121330ad60), // Dev wallet
            address(0x887E8c08376Fcc57bAD00af3906Bb3b8e3f5578a) // PPV Wallet
        );
    }
    ...
    function distributeFees() public override {
        ...
        /// @dev Left overs are assumed to be to liquidity
        uint256 toLiquidity = balanceOf(address(this));
