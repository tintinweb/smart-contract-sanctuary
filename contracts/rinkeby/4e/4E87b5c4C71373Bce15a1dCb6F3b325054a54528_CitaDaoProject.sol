...
contract CitaDaoProject is ERC721, Ownable, ReentrancyGuard  {
    ...
    bytes32 public merkleRootTier1 = 0xe2ae0e0eef13a006be2f503db76ea9d06fde3cdaa0eee3ac5c5b55f84bfeb9c3;
    bytes32 public merkleRootTier2 = 0x62268c005f5cf98eda451cba16d2921381101e397af4886126f0704fde776e68;
    bytes32 public merkleRootTier3 = 0xab26eaeb2e636567b960a9f91e11df27309607673dfa936ee6b0808597eca631;
    ...
    // this modifier ensures that the caller is a user and not another smart contract (to prevent spam or any other vulnerabilities)
    modifier onlySender {
    ...
    function mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable nonReentrant onlySender {
...
/// @dev takes uint256 returns string 
    ...
    function ownerMint(uint256 _mintAmount) public onlyOwner {
        uint256 supply = totalSupply();
        require(_mintAmount > 0, "User must mint at least 1 NFT");
        require(supply + _mintAmount <= maxSupply, "All NFT's in collection have been minted");
        for (uint256 i=1; i<= _mintAmount; i++) {
            addressMintBalance[msg.sender]++;
            _safeMint(msg.sender, supply + i);
        }
