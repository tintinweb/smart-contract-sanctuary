...
contract StakingPoolFactory is PoolCreator {
    ...
    function setSwapRouter(address _swapRouter) public onlyPoolCreator {
...
contract StakingPool is Context, Ownable, PriceConsumer, USDRetriever, BTCDistributor {
    ...
    )PriceConsumer(_oracleContract) BTCDistributor(_swapRouter, _usdToken, _btcToken){
        totemToken = _totemToken;
