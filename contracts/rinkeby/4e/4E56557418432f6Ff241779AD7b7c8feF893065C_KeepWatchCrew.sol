...
contract KeepWatchCrew is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public DISCOUNT_PRICE = 7 * (10**16);
    uint256 public maxVIPMint = 1;
    uint256 public maxWhitelistMint = 2;
    uint256 public maxPublicTransactionMint = 2;

    uint256 public publicSaleDate = 1638475200;
    ...
    function mint(uint256 _count) public payable {
        ...
        if (saleMode == SaleModes.PUBLIC_SALE) {
            if (sender != owner()) {
                require(_count <= maxPublicTransactionMint, "Number of mintable tokens limited per transaction");
    ...
    function updateMaxPublicTransactionAmount(uint256 _amount) public onlyOwner {
        maxPublicTransactionMint = _amount;
    }
