...
contract DegenDojoRouter is VRFConsumerBase {
    ...
    function getMinimumTradeSize() public view returns (uint256) {
        ...
        //offset used as 10**18 * 1% fee
        uint256 offset = 10**16;
    ...
    function getETHP() public view returns (uint256) {
        (, int256 ethPrice, , , ) = ethUsdPriceFeed.latestRoundData();
        return uint256(ethPrice);
    }

    function getLINKP() public view returns (uint256) {
        (, int256 linkPrice, , , ) = linkUsdPriceFeed.latestRoundData();
