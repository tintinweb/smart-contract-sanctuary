...
import "./Gaugecash.sol";
import "@openzeppelin/contracts-upgradeable/token/ERC20/ERC20Upgradeable.sol";


contract TokenSwap is  ERC20Upgradeable,
...
contract Gaugecash is
  Whitelist,
  ERC20Upgradeable,
  ERC20BurnableUpgradeable,
  ERC20PermitUpgradeable
{
  function __GAU_init(string memory name, string memory symbol)
    public
    initializer
  {
    __ERC20_init_unchained(name, symbol);
    __EIP712_init_unchained(name, "1");
    __GAU_init_unchained();
    __ERC20Burnable_init();
    __ERC20Permit_init(name);
   // _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
   // _setupRole(GAU_ROLE, msg.sender);
  }

  function __GAU_init_unchained() internal initializer {}
  ...
  // AggregatorV3Interface internal gauPriceFeed;
  // function returnGauPrice() internal  returns(uint256) {
  // gauPriceFeed = AggregatorV3Interface(
  //         0x8A753747A1Fa494EC906cE90E9f37563A8AF630e
  //     );
  //     console.log("gau price", gauPriceFeed);
  //     }
}
...
contract Whitelist is AccessControlUpgradeable {
    ...
    bytes32 public constant GAU_ROLE = keccak256("GAU_ROLE");
    ...
    modifier onlyWhitelisted() {
        require(isWhitelisted(msg.sender), "GAU::NOT_WHITELISTED");
        _;
    }

    function addToWhitelist(address _address) external {
        require(
            hasRole(GAU_ROLE, msg.sender),
            "GAU::CALLER_ISNT_GAU_ROLE"
        );
    ...
    function removeFromWhitelist(address _address) external {
        ...
        require(
            _address != address(0),
            "GAU::CANNOT_REMOVE_ZERO_ADDRESS_FROM_WHITELIST"
        );
