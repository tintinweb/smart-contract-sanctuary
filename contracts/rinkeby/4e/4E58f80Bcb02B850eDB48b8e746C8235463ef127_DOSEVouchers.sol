...
contract DOSEVouchers is ERC1155InventoryBurnable, IERC1155InventoryMintable, IERC1155InventoryCreator, BaseMetadataURI, MinterRole {
    ...
    string public constant name = "ToyDoseVouchers_1";
    // solhint-disable-next-line const-name-snakecase
    string public constant symbol = "ToyDoseVouchers_1";
...
import "@animoca/ethereum-contracts-core_library-5.0.0/contracts/utils/types/UInt256ToDecimalString.sol";
