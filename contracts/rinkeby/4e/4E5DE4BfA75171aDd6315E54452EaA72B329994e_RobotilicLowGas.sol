...
// File: contracts/RobotilicLowGas.sol
...
contract RobotilicLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Robotilic Ghost", "RG") {
    setHiddenMetadataUri("ipfs://QmdLke3vjDezJGBVNAxrVYTzcNwpcSneYwK6thkbqcRQfK/hidden.json");
  }
