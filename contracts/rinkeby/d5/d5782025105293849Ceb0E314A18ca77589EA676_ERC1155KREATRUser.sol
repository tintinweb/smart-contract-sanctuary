...
contract ERC1155BaseURI is ERC1155Upgradeable {
    ...
    */
    ...
    function _setTokenURI(uint256 tokenId, string memory _uri) internal virtual {
        ...
        emit URI(_getTokenURI(tokenId), tokenId);
    }
...
import "./ERC1155KREATRUser.sol";
import "../mint/ERC1155Lazy.sol";
...
contract ERC1155KREATRUser is OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI {

    event CreateERC1155KREATRUser(address owner, string name, string symbol);

    string public name;
    string public symbol;

    function __ERC1155KREATRUser_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators) external initializer {
        ...
        __ERC1155KREATRUser_init_unchained(_name, _symbol);
        _setBaseURI(baseURI);
        for(uint i = 0; i < operators.length; i++) {
            setApprovalForAll(operators[i], true);
        }
        emit CreateERC1155KREATRUser(_msgSender(), _name, _symbol);
    }

    function __ERC1155KREATRUser_init_unchained(string memory _name, string memory _symbol) internal initializer {
        name = _name;
        symbol = _symbol;
    }
...
import "../mint/LibERC1155LazyMint.sol";
...
import "../contracts/ERC1155Upgradeable.sol";
import "../royalties//RoyaltiesV2Impl.sol";
import "../royalties/RoyaltiesV2Upgradeable.sol";
import "./IERC1155LazyMint.sol";
import "../contracts/Mint1155Validator.sol";
import "../contracts/ERC1155BaseURI.sol";
...
import "../contracts/IERC1155Upgradeable.sol";
...
import "../contracts/ERC165StorageUpgradeable.sol";
