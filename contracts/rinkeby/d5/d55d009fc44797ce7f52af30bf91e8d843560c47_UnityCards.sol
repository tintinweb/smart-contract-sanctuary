...
contract UnityCards is ERC721Enumerable, Ownable, IUnityCards, IUnityCardsMetadata, ReentrancyGuard {
  ...
  */
  ...
  nonReentrant() {
    ...
    require(_verify(_leaf(index, account, numberOfTokens), proof), "Invalid merkle proof");
    require(numberOfTokens > _allowListClaimed[msg.sender], 'Purchase exceeds max allowed');
    ...
    emit Claimed(index, msg.sender, numberOfTokens);
