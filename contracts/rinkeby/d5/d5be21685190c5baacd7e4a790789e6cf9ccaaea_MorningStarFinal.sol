...
contract MorningStarFinal is ERC20Pausable, Ownable, ERC20Burnable, ERC20Capped {
    constructor (uint256 initialSupply, uint256 capAmount) ERC20("MorningStarFinal", "MSF") ERC20Capped(capAmount) {
