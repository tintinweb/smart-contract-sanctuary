...
contract KillyWilly is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Killy Willy";
    string private constant _symbol = unicode"Killy Willy";
