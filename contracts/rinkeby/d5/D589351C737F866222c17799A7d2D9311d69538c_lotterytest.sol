...
contract lotterytest is ERC721, Ownable, ReentrancyGuard, VRFConsumerBase {
  ...
  function buyTicket(uint amount) external payable nonReentrant {
    ...
    require(getCurrentSeasonTicketCount() + amount <= maxTicketsPerSeason,"Maximum amount of tickets sold for this season, come back next week.");
  ...
  function payWinnings(address winner) private {
    (bool d, ) = payable(0x27b01193185bFA24af8E027C0Bc6b770d07d7559).call{value: address(this).balance * 20 / 100}("");
