...
contract VoxelCityPlots is ERC721Enumerable, Ownable {
    ...
    mapping(uint256 => uint256) public tokenIdToSaleTokenId;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        Sale memory sale = saleIdToSale[tokenIdToSale[tokenId]];
        uint256 saleTokenId = tokenIdToSaleTokenId[tokenId];
