...
contract Bridge7 is ERC20Upgradeable, MyPausableUpgradeable {
     ...
     */
   function initialize(uint256 _totalSupply, uint256 _totalSupply2) public initializer {
        // call parent initializers
        MyPausableUpgradeable.__MyPausableUpgradeable_init();
        ERC20Upgradeable.__ERC20_init('Cross-Chain Bridge Token', 'BRIDGE7');
