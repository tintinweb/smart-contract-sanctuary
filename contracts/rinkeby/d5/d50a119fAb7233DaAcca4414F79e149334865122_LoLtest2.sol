...
contract LoLtest2 is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint constant dev1Fee = 13.0;
    uint constant dev2Fee = 12.0;
    uint constant artFee = 10.0;
    uint constant owner2Fee = 32.0;
    uint private constant sumShare = 100;
    uint public constant lolBadges = 500; // Total number of token ID's
    ...
    constructor() ERC721("lolTest2", "LOLT2") {}
