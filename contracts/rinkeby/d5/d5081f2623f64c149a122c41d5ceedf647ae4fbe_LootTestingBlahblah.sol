...
contract LootTestingBlahblah is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        // New parts here
        parts[16] = '</text><svg width="400" height="110"><rect width="300" height="100" style="fill:';
        
        parts[17] = getColor(tokenId);

        parts[18] = '" /></svg></svg><a>testhere</a>';
