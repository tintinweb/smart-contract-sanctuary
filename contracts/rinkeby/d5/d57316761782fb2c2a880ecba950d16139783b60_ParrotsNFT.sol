...
contract ParrotsNFT is Ownable, ERC721, PaymentSplitter {
    ...
    uint8 public maxMintAmountFreemint = 15;
    uint16 public maxMintAmountPresale = 500;
    uint16 public maxMintAmount = 5555;
    uint8 public nftPerAddressLimitFreemint = 1;
    uint8 public nftPerAddressLimitPresale = 1;
    ...
    uint256[] private _teamShares = [17, 36, 47];
    address[] private _team = [
        0x413a992170d4564877De196202F2e99e5fabfb4b,
        0x645eAf82481A2eE98A6dD1Eaf01a07D10E31f604,
        0xd88948b7a22E239492a56790F9c1c1418Ab56235
    ];

    constructor() ERC721("Parrots Fight Club", "PFC") PaymentSplitter(_team, _teamShares) {}
    ...
    function freemintValidations(uint256 _ownerMintedCount, uint256 _mintAmount) internal view {
        require(isFreemint(msg.sender), "user is not in freemint list");
        require(_ownerMintedCount + _mintAmount <= nftPerAddressLimitFreemint, "max NFT per address exceeded for free mint");
