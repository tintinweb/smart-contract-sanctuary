...
contract Topogen is NPassCore {
    ...
    constructor(address _nContractAddress, string memory baseURI_) NPassCore("Topogen", "TOPOGEN", IN(_nContractAddress), true, 8888, 8888, 15000000000000000, 15000000000000000) {
        baseURI = baseURI_;
    }
