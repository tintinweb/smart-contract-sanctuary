...
contract WavesOnChain is ERC721, Ownable {
    ...
    uint public constant DEVELOPER_FEE = 50;
    uint public constant ARTIST_FEE = 50;
   ...
   function mint(uint256 wavesNumber) public payable {
    ...
    function withdraw() public payable onlyOwner {
        ...
        uint toDeveloper = balance.mul(DEVELOPER_FEE).div(SHARE_SUM);
        uint toArtist = balance.mul(ARTIST_FEE).div(SHARE_SUM);
