...
contract FeatureRegistry is IFeatureRegistry, ReclaimTokens {
     ...
     * return bool
     */
    function getFeatureStatus(string calldata _nameKey) external view override returns(bool) {
     ...
     * @param _newStatus is the new feature status
     */
    function setFeatureStatus(string calldata _nameKey, bool _newStatus) external override onlyOwner {
        bytes32 key = keccak256(bytes(_nameKey));
