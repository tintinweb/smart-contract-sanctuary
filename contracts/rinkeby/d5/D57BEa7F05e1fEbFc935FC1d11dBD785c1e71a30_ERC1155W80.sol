...
import "../erc-721/LibW80.sol";

contract ERC1155W80 is ERC1155Base {
    mapping(uint256 => LibW80.RequestStatus) private requestStatus;

    function __ERC1155W80_init(
        string memory _name,
    ...
    function setRequestStatus(
        ...
        requestStatus[tokenId] = _requestStatus;
        emit SetRequestStatus(tokenId, _requestStatus);
    }
    ...
    function safeTransferFrom(
        ...
        require(
            requestStatus[id] == LibW80.RequestStatus.RECEIVED,
            "ERC1155W80: should be received first"
        );
...
library LibW80 {
    enum RequestStatus {CANCELED, ORDERED, PICKED, DELIVERED, RECEIVED}
    struct Token {
