...
//rinekby: IClearingHouseViewer : 0x2b53BA3d842F76e4D96FecEA77d345d237680E2e
//USDC:0xe0B887D54e71329318a036CF50f30Dbe4444563c
//lemmaPerpetual: 0xDAC3Ec496b434469f3e0eF201C5932905B4c11D1
...
interface IClearingHouseViewer {
    ...
    function getPersonalBalanceWithFundingPayment(
        address _quoteToken,
        address _trader
    ) external view returns (some memory margin);
}

interface ISetLemmaToken{
    function setLemmaToken(address _lemmaToken) external ;
}

interface ILemmaToken{
    function redeem(uint256 _amount) external;
    function deposit(uint256 _minUSDC) payable external;
}

// File: contracts/interfaces/AMB/IAMB.sol
...
// File: contracts/interfaces/AMB/IMultiTokenMediator.sol
...
// File: contracts/LemmaMainnet.sol
