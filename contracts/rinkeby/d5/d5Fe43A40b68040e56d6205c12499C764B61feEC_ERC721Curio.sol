...
contract ERC721Curio is ERC721Base {

    event CreateERC721Curio(address owner, string name, string symbol);

    function __ERC721Curio_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        _setBaseURI(baseURI);
        ...
        emit CreateERC721Curio(_msgSender(), _name, _symbol);
    }
    uint256[50] private __gap;
}
