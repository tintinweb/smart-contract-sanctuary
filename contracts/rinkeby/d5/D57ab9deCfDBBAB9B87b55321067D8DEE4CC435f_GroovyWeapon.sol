...
contract GroovyWeapon is ERC721Enumerable, Ownable {
  uint256 public maxSupply = 10000;
  uint256 public maxPreSaleMintTotal = 8000;
  ...
  function mint(
    ...
    if (publicSaleStatus == true) {
      require(
        ...
        "Maximum of 5 mints allowed per transaction"
      );
    } else {
      require(
      ...
      require(
        _number > 0 && _number <= 20,
        "Maximum of 20 mints allowed per wallet"
      );
      require(
      ...
      require(
        preSaleMints + _number <= maxPreSaleMintTotal,
