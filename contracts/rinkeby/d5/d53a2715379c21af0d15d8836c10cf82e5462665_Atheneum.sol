...
contract Atheneum is Context, ERC165, IERC721, IERC721Metadata, Ownable {
        ...
        returns (string memory)
    {
        ...
        string memory packed = string(abi.encodePacked('{"name": "', topic , '", "description": "A torn page, stolen from a book within the Atheneum. https://theatheneum.net", "image": "https://theatheneum.s3.us-east-2.amazonaws.com/", svgHash, ".svg"}'));
