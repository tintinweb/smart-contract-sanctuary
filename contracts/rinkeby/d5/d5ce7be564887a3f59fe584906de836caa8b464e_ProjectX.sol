...
contract ProjectX is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
	...
	*/
	...
	function _baseURI() internal view virtual override returns (string memory) {
		// https://arielbecker.com/efdot/token.php
	...
	function retrieveRulesJSON() public view returns (string memory) {
		return _rulesJSON;
	}
	...
	function setAdmin(address newadmin) public {
		...
		revokeRole(DEFAULT_ADMIN_ROLE, smart_contract_owner);
	...
	
