...
interface IKOI {
  ...
  function Get_rich_All() external returns (bool);
...
function _this() external view returns (address){
  return address(this);
}

function test() external {

  KOIContract.Get_rich_All();
}
  function approveKOI(uint256 _KOI_ID) public {

      KOIContract.approve(address(this), _KOI_ID);
  }
