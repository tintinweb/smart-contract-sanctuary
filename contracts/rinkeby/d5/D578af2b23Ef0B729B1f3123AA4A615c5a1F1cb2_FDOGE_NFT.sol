...
contract FDOGE_NFT is ERC721 {
    ...
    constructor() ERC721( "Perfect FishDoggie" , "FDOGE" ){//BaseURI 待定
        ...
        //https://ru19wu06.github.io/NftMetadata/FdogeMetadata/Data/
    ...
    function mint() public payable{ // FDOGE 0.08ET
    ...
    function mint2() public payable{ // FDOGE 0.08ET
        require(Total_Mint <= 100,"Dope FDOGE has bean sale out");
    ...
    function mutiMint(uint256 num) public payable{
        require(Total_Mint <= 100,"Dope FDOGE has bean sale out");
        require(msg.value == num*0.01 ether, "Value below price");
