...
contract MappingExample {
    ...
    function update(address emiter, bytes32 source_chain, address recipient, bytes32 destination_chain, uint256 amount, bytes32 source_transaction,  bytes32 destination_transaction) public {
        swap memory a = swap({
            emiter: emiter,
