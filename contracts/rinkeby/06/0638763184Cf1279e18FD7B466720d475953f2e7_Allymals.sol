...
contract Allymals is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    uint256 public _startTime = 1640390400; //Christmas
    ...
    constructor()
    ERC721("Allymals Collection", "ALML")
    ...
    function mint(uint256 _count) public payable {
        ...
        require( block.timestamp >= _startTime || _presale, "General sale has not started yet" );
