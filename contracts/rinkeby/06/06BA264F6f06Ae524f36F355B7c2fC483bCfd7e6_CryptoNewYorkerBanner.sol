...
contract CryptoNewYorkerBanner is ERC1155, Ownable, Pausable, ERC1155Burnable
{
    ...
    //Banner Season Amounts
    uint256 public amt_banner_spring;
    uint256 public amt_banner_summer;
    uint256 public amt_banner_fall;
    uint256 public amt_banner_winter;

    constructor() ERC1155("https://ipfs.io/ipfs/QmSrvmnQ2Wmrcz7Brx7NfV98EP1rVJs3AiYVeaRNpG3JSS/{id}.json") 
    {
        // __ERC1155_init("https://ipfs.io/ipfs/QmSrvmnQ2Wmrcz7Brx7NfV98EP1rVJs3AiYVeaRNpG3JSS/{id}.json");
        // __Ownable_init();
        // __Pausable_init();
        // __ERC1155Burnable_init();
        amt_banner_spring = 250;
        amt_banner_summer = 250;
        amt_banner_fall = 250;
        amt_banner_winter = 250;
    ...
    function uri(uint256 _tokenID) override public pure returns (string memory)
    {
        return string(
            abi.encodePacked(
                "https://ipfs.io/ipfs/QmSrvmnQ2Wmrcz7Brx7NfV98EP1rVJs3AiYVeaRNpG3JSS/",
    ...
    function setIPFSHash(string memory ipfshash) public onlyOwner { _ipfshash = ipfshash; }
