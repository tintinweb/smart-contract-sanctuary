...
interface IMosaicNFT {
    function getOriginalNftInfo() external view returns (address, uint256, string memory, string memory);
}
...
interface ISummonerConfig {
    ...
    function isMosaicNft(address _addr) external view returns(bool);
