...
*/
contract Super1155Factory is ReentrancyGuard {
  ...
  /**
    ...
    */
    ...
    //address _owner, string memory _name, string memory _uri, address _proxyRegistryAddress
  function createItem(
    address _owner,
    ...
    Super1155 newItem = new Super1155(_owner, _name, _uri, _proxyRegistryAddress);
    address newItemAddress = address(newItem);
    itemRecords[_shop].push(newItemAddress);
    shopMap[newItemAddress] = _shop;
    emit ItemCreated(newItemAddress, _shop, _owner);
