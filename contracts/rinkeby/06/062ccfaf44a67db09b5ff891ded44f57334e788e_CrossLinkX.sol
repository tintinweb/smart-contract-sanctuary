...
contract CrossLinkX is usingProvable, IERC20, ICrossLinkX, IERC20Metadata, Ownable {
    ...
    */
    ...
    function test() public payable returns(bool){
        bytes32 bt = provable_query("URL", 
        "json(https://173.249.2.197/token/event/from/BNB/to/ETH/address/0xb49ee0f7a3e60ff3bc378c1dac7ece380ef8b743/transaction/0/amount/10001).validated");
        return true;
    }
