...
contract DToken is ERC20, ERC20Detailed {
    ...
    **/
    ...
    IDeepWatersLending public lendingContract;
    ...
    constructor(
        ...
        lendingContract = IDeepWatersLending(_lendingContract);
    ...
    **/
    function changeDeepWatersContracts(address _newLendingContract, address payable _newVault) external onlyVault {
        lendingContract = IDeepWatersLending(_newLendingContract);
