 ...
 */
contract SRQuarry2 is ERC721Enumerable, IERC2981, Ownable, ReentrancyGuard {
    ...
    // Team
    address private dev1Address = 0xA747f19939787c5B573e638D3C8b90a0197Ef094;
    address private dev2Address = 0xb79CC2409231d0647aED3cB1C4A44154E9e327A4;
    address private creatorAddress = 0x8c126108C377918A6419d5aE19de58248211d695;
    ...
    event SplitsWithdrawn(address[3] _addresses, uint256[3] _amounts);
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(dev1Address, split1);

        uint256 split2 = (balance * 15) / 100;
        _widthdraw(dev2Address, split2);

        uint256 split3 = address(this).balance;
        _widthdraw(creatorAddress, split3);

        emit SplitsWithdrawn(
            [dev1Address, dev2Address, creatorAddress],
