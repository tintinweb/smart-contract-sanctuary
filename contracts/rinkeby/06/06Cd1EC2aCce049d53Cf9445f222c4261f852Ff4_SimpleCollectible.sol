...
contract SimpleCollectible is ERC721 {
    ...
    constructor () public ERC721 ("Sub Squares 1.001", "SUBSQ"){
        tokenCounter = 0;
    }
    ...
    function createCollectible(string memory tokenURI) public returns (uint256) {
        ...
        bytes32 hash = keccak256(abi.encodePacked(tokenCounter, block.number, msg.sender));
        tokenIdToHash[newItemId] = hash;
