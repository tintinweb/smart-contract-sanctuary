...
contract HippyGhostsERC721 is ERC721Enumerable, IERC2981, Ownable {
    ...
    /**
     * @dev total number of tokens available for minting
     */
    uint256 public maxSupply = 6666;

    /**
     * @dev maximum of tokenId available for minting
     */
    uint256 private _maxMintIndex;

    /**
     * @dev index for minting in sequence
     */
    ...
    /**
     * @dev for gasless listings on opensea
     */
    ...
    function releaseAllGhosts() external onlyOwner {
        _maxMintIndex = maxSupply;
    }

    function setMintIndex(uint256 mintIndex_) external onlyOwner {
        _mintIndex = mintIndex_;
    }
    ...
    function _safeMint(address to, uint256 tokenId) internal override {
        require(tokenId >= 1 && tokenId <= _maxMintIndex, "Incorrect tokenId to mint");
    ...
    function mintWithSignature(
        ...
        require(
            state == ContractState.PRIVATE || state == ContractState.PUBLIC,
            "Community sale is not open"
        );
    ...
    function mintMultipleTokensWithSignature(
        ...
        _claimedMintKeys[mintKey] = true;
        emit MintKeyClaimed(msg.sender, mintKey, 1);
