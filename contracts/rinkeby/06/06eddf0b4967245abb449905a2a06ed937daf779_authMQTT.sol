...
contract authMQTT {
  ...
  /**
   * @dev The authMQTT constructor sets the original `owner` of the contract to the sender
   * account.
   */
  constructor() public{
    owner = msg.sender;
...
contract Whitelist is authMQTT {
...
contract Authan is RoleBasedAcl,Whitelist {
