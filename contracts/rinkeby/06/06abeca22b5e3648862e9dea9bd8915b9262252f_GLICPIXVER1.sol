...
// File: GLICPIXVER1.sol

pragma solidity ^0.8.0;

contract GLICPIXVER1 is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("GL!C-P!X", "GLICPIX")  {
    ...
    function cancelOfferLocationSwap (uint8 yourGPX, uint8 theirGPX) public {
        ...
        require (offer.requester == msg.sender, "YOU ARE NOT THE ONE WHO MADE THE OFFER!");
    ...
    function acceptLocationSwap (uint8 yourGPX, uint8 theirGPX) public {
    	require (ownerOf(yourGPX) == msg.sender);
    ...
    function iOwnTwoGLICPIXYO (uint8 tokenA, uint8 tokenB) public {
    	require (tokenA > 0 && tokenA < 37 && tokenB > 0 && tokenB < 37, "THE TOKENS YOU ENTERED ARE NOT BETWEEN 1-36");    	
    	require (ownerOf(tokenA) == msg.sender && ownerOf(tokenB) == msg.sender, "YOU DON'T OWN THESE GLICPIX YO!");
    ...
    function rotateGLICPIXinCanvas (uint8 _id, Rotation _rotation) public {
     	require(ownerOf(_id) == msg.sender, "YOU ARE NOT THE OWNER OF THIS GLICPIX GODDAMNIT!");
    ...
    // testing
    function mint0(address _minter) public {
          _safeMint(_minter, 0);
    }
    function mint1(address _minter) public {
        for (uint i =1; i < 19; i++) {
            _safeMint(_minter, i);
        }
    }
     function mint2(address _minter) public {
        for (uint i=19; i < 37; i++) {
            _safeMint(_minter, i);
        }
    }
