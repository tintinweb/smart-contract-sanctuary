    ...
    Ownable
{
    ...
    uint256 public NFT_huge_price = 0.239 ether; 

    uint256 public startTime = 1637718239; // 26 Nov 22:00:01 UTC+7 - 1637938851
    string _name = "OniWorld";
    string _symbol = "ONINFT";
    
    bool public is_promotion = true;
    bool public is_surprise = false;
   ...
   function setSurpriseMint(bool result) external onlyOwner {
    ...
    //function hugeTeam() public payable {
        //require(msg.value == NFT_huge_price, "Sent Amount Not Enough");
        //_mintOni(6);
    //}
