...
contract BeOneDashboard {
    ...
    returns (Dashboard memory)
  {
    ...
    for (uint256 i = 0; i < beOneRegistry.getCTokensLength(); i++) {
      ...
      totalSupplyInUsd += cToken.totalSupply().mul(tokenPriceInUsd);
      totalBorrowedInUsd += cToken.totalBorrows();
      ...
      CTokensArray[i] = CToken({
        ...
        // TODO
        lendingApy: cToken.supplyRatePerBlock(),
        // TODO
        lendingApr: cToken.supplyRatePerBlock(),
        // TODO
        borrowingApy: cToken.borrowRatePerBlock(),
        // TODO
        borrowingApr: cToken.borrowRatePerBlock(),
        // TODO
        borrowedInToken: cToken.totalBorrows(),
        userBalanceInUnderlyingToken: underlying.balanceOf(userAddress),
        userBalanceInCToken: cToken.balanceOf(userAddress),
