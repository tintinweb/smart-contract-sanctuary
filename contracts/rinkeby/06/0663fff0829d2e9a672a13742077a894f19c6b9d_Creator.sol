...
// Root file: contracts/Creator/Creator.sol
...
contract Creator is ERC721, AccessControl {
    using SafeMath for uint256;
     ...
     * @dev Destroys `tokenId`.
     */
    function burn(uint256 tokenId) public onlyManager {
        _burn(tokenId);
    }
