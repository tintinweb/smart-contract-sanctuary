    ...
    ERC721
{
    ...
    address dev1 = 0x198e10b883B5A64F4ad46038B7Fb0691D20929eF;
    ...
    uint256 PRICE = 1 * 10**15; // 0.333 ETH
    uint256 ROYALTY_PRICE = 1 * 10**13; // 3% of PRICE
        ...
        payable
    {
        ...
        DRIBNET.send(ROYALTY_PRICE);
        multisig.send(multisigFee);
