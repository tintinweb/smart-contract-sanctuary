...
contract BABYCAKE is ERC20, Ownable {
    ...
    address public CAKE = address(0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984); //CAKE:0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "BABYCAKE: The dividend tracker already has that address"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "BABYCAKE: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BABYCAKE: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "BABYCAKE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "BABYCAKE: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "BABYCAKE: Cannot update gasForProcessing to same value"
        );
...
contract BABYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        public
        DividendPayingToken(
            "BABYCAKE_Dividen_Tracker",
            "BABYCAKE_Dividend_Tracker"
        )
    {
        claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        ...
        require(
            ...
            "BABYCAKE_Dividend_Tracker: Cannot update claimWait to same value"
        );
