...
contract PlushGetTree is Ownable {
    ...
    function addTreeName(string memory _name, uint256 _price, uint256 _count) external onlyOwner {
        require(!treeMap[_name].isValid, 'This type of tree already exists');

        trees.push(_name);
        treeMap[_name] = Tree(true, _name, _price, _count);
    }
