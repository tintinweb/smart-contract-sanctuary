...
// Using modified Openzeppelin contracts.
...
/**
 * Rigor v0.1.0 Rigor Contract
 *
 * Main on-chain client
 */
contract Rigor is IRigor, ERC721, Initializable {
    ...
    function setAddr(
        ...
        wrappedToken[etherCurrency] = _rETHAddress;
        wrappedToken[daiCurrency] = _rDaiAddress;
        wrappedToken[usdcCurrency] = _rUSDCAddress;
        addrSet = true;
    }
