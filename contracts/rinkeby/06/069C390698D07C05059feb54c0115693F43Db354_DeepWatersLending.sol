...
contract DeepWatersLending is ReentrancyGuard {
    ...
    **/
        ...
        nonReentrant
    {
        ...
        dToken.mint(msg.sender, interestOnDeposit);
    ...
    **/
        ...
        nonReentrant
    {
        ...
        if (isStableRateBorrow) {
            ...
            vault.updateAverageStableInterestRate(_asset, msg.sender, data.newAverageStableInterestRate);
        }
