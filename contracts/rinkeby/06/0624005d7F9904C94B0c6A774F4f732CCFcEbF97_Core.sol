...
contract Core is OwnableUpgradeable, ICore {
    ...
    function createCondition(
        ...
        require(timestamp < ILP(lpAddress).phase2end(), "DISTANT_FUTURE");
        require(timestamp > 0, "Core: timestamp can not be zero");
        require(
        ...
        )
    {
        ...
        require(odds >= minOdds, "Core: odds too small");
        require(amount > decimals, "Core: small bet");
        ...
        onlyOracle
    {
        ...
        require(
            block.timestamp >= condition.timestamp,
            "Azuro: condition cant be resolve before timelimit"
        );
        require(
