...
contract CryptoNewYorkerBanner is ERC1155, Ownable, Pausable, ERC1155Burnable
{
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/QmemPqij6JuXToFVXuzc4tBkJrNsttbmJVCWaYGrxD6ADX/{id}.json") 
    {
        name = "CryptoNewYorkerBanner";
        symbol = "CNB";
        setTokenURI(0, "https://gateway.pinata.cloud/ipfs/QmemPqij6JuXToFVXuzc4tBkJrNsttbmJVCWaYGrxD6ADX/0.json");
        setTokenURI(1, "https://gateway.pinata.cloud/ipfs/QmemPqij6JuXToFVXuzc4tBkJrNsttbmJVCWaYGrxD6ADX/1.json");
        setTokenURI(2, "https://gateway.pinata.cloud/ipfs/QmemPqij6JuXToFVXuzc4tBkJrNsttbmJVCWaYGrxD6ADX/2.json");
        setTokenURI(3, "https://gateway.pinata.cloud/ipfs/QmemPqij6JuXToFVXuzc4tBkJrNsttbmJVCWaYGrxD6ADX/3.json");
        setTokenURI(4, "https://gateway.pinata.cloud/ipfs/QmemPqij6JuXToFVXuzc4tBkJrNsttbmJVCWaYGrxD6ADX/4.json");
        _mint(msg.sender, 0, 50000, "");
        _mint(msg.sender, 1, 50000, "");
        _mint(msg.sender, 2, 50, "");
        _mint(msg.sender, 3, 50, "");
        _mint(msg.sender, 4, 50, "");
    }
