...
contract CappedCompositeCrowdsale is CompositeCrowdsale {
  using SafeMath for uint256;
    ...
    uint256 public constant cap = 500 ether;
...
contract EthicHubPresale is Ownable, Pausable, CappedCompositeCrowdsale, RefundableCompositeCrowdsale {
   ...
   */
  function EthicHubPresale(uint256 _startTime, uint256 _endTime, address _wallet, EthicHubTokenDistributionStrategy _tokenDistribution)
