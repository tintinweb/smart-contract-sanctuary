...
contract CertNFT is ERC721 {
    ...
    event requestedNFT(address indexed _from);

    constructor() public ERC721 ("certifiedTherapists", "GTCERT") {
        tokenCounter = 0;
    }


    function createCertNFT(string memory tokenURI) public returns (uint256)
    {
        uint256 newItemId = tokenCounter;
        //requestIdToSender[requestId] = msg.sender;
        //requestIdToTokenURI[requestId] = tokenURI;
        emit requestedNFT(msg.sender);
