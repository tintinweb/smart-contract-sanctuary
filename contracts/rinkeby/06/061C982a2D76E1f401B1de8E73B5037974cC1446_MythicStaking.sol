...
contract MythicStaking is Ownable {
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        if (depositEpoch[msg.sender].add(taxedPeriod) > epoch.number) { // take fees if the number of staked epochs is smaller than the minimum number of epochs required to avoid fees
    ...
    /**
     * @notice set taxed period in epoch's numbers
     * @param _taxedPeriod uint
     */
    ...
    /**
     * @notice set taxed period fees in base 10000
     * @param _fees uint
     */
