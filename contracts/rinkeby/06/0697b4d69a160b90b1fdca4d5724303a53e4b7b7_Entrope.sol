...
contract Entrope is ERC721Enumerable, Ownable {
    ...
    //constructor args 
    constructor(string memory baseURI_) ERC721("Entrope", "ENT") {
        baseURI = baseURI_;
    }
    ...
    // Need ERC721Enumerable to get tokenOfOWnerByIndex for staking
    ...
    function presaleMint(uint256 _times) public payable {
        ...
        require(_tokenSupply.current() + _times <= totalCount, "Max supply reached");
