...
contract SayBLOWE is ERC721, ChainlinkYoutube{
...
contract ChainlinkYoutube is ChainlinkClient, Ownable {
    ...
    function updateFollowerCount(uint256 _tokenId, string memory username, string memory id) public onlyOwner returns (bytes32 requestId1, bytes32 requestId2){
    ...
    function viewTokenId(bytes32 reqID) private onlyOwner returns(uint256){
