...
contract TestContract is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 32 32"><rect x="0" y="0" width="32" height="32" style="fill:#',
  ...
  mapping(uint => bool) tokenIdToUsed;
  ...
  function changeUsed(uint _tokenId) public onlyOwner() {
    tokenIdToUsed[_tokenId] = false;
  }
