...
contract SimpleCollectible is ERC721, Ownable {
    ...
    constructor () public ERC721 ("Skull", "SKULL"){
        tokenCounter = 0;
    }
    ...
    function suckamadick() public returns (uint256)
    {
      uint256 shamwow = 1;
      return shamwow;
    }
    ...
    {
      int amountTobuy = 100 * int(msg.value);

      while(amountTobuy > 0)
      {
        createCollectible("https://ipfs.io/ipfs/QmbZuhtgnF3h7QZTLTPA3aX4xcZwzRgq9YsSZ3L96GzLkD?filename=SKULLY_19.json");

        amountTobuy = amountTobuy - 5;
      }



      return uint256(amountTobuy);
    }
