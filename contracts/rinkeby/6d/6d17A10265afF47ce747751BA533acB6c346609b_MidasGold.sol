...
/* Midas Gold is the yeild token for the Midas Plantation
   midasreflect.com
   t.me/midasarbi
   */
...
pragma solidity ^0.6.12;
    ...
    contract MidasGold is Context, ERC20("MGLD", "Midas Gold"), Ownable {
        using SafeMath for uint256;
        ...
        string private constant _name = 'Midas Gold';
        string private constant _symbol = 'MGLD';
        ...
        address payable public _dappWalletAddress;
        ...
        uint256 private _maxTxAmount = 250000 * 10**18;
        ...
        constructor (address payable devWalletAddress, address payable marketingWalletAddress, address payable dappWalletAddress) public {
            _devWalletAddress = devWalletAddress;
            _marketingWalletAddress = marketingWalletAddress;
            _dappWalletAddress = dappWalletAddress;
        ...
        function sendETHToTeam(uint256 amount) private {
            _devWalletAddress.transfer(amount.div(2).mul(2));
            _marketingWalletAddress.transfer(amount.div(5));
            _dappWalletAddress.transfer(amount.div(5).mul(2));
        }
        ...
        function _setDappWallet(address payable dappWalletAddress) external onlyOwner() {
            _dappWalletAddress = dappWalletAddress;
        }
