...
contract DummyTheDudes is ERC721Enumerable {
  ...
  constructor () ERC721("the dummy dudes", "dummy dude") {}

  function setDNA(uint256 tokenId, string memory dna) public {
    dudes[tokenId] = dna;
  }
  
  function mint(uint256 _numDudes, address _to) public {
    ...
    uint256 beginIndex = totalSupply();
    for (uint256 i = 0; i < _numDudes; i++) {
      _safeMint(_to, beginIndex + i);
    }
  }
