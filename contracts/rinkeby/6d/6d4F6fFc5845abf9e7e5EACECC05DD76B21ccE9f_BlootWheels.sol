...
contract BlootWheels is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"> <style>.base { fill: #d4af37; font-family: serif; font-size:14px; -webkit-animation: glow 1.618s ease-in-out infinite alternate; -moz-animation: glow 1.618s ease-in-out infinite alternate; animation: glow 1.618s ease-in-out infinite alternate; } @-webkit-keyframes glow {from {text-shadow: 0 0 0.25px #9d8022, 0 0 0.5px #9d8022, 0 0 0.75px #9d8022, 0 0 1px #9d8022;} to { text-shadow: 0 0 0.5px #9d8022, 0 0 0.75px #9d8022, 0 0 1px #9d8022, 0 0 1.5px #9d8022, 0 0 2px #9d8022;}}</style> <rect width="100%" height="100%" fill="#003C5F" /><text x="10" y="20" class="base">';
