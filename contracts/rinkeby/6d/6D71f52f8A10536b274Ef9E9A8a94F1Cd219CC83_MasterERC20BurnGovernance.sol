...
import "../../token/ERC20/ERC20BurnGovernance.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20BurnGovernance is ContractOwnable, IMasterERC20 {
  ERC20BurnGovernance[] private childERC20BurnGovernance;
  ...
  function createERC20(
    ...
    ERC20BurnGovernance child = new ERC20BurnGovernance(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20BurnGovernance.push(child);
...
contract ERC20BurnGovernance is ERC20 {
  // @dev Governance
