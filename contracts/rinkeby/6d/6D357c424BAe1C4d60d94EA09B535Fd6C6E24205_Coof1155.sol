...
library NFTSVG {
  ...
  function _generateSVGDefs(SVGParams memory params) private pure returns (string memory svgDef) {
    svgDef = string(
      abi.encodePacked(
  ...
  function _generateSVGPaths(SVGParams memory params) private pure returns (string memory svgPaths) {
    svgPaths = string(
      abi.encodePacked(
        '<rect width="100%" height="100%" fill="black"/>',
        '<use xlink:href="#r1" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(30 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(60 160 160)"  filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(90 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(120 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(150 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(180 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(210 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(240 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(270 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(300 160 160)" filter="url(#f1)"/>',
        '<use xlink:href="#r1" transform="rotate(330 160 160)" filter="url(#f1)"/>'
      )
    );
    return svgPaths;
  }
