...
contract Puzzled is ERC721Tradable {
    ...
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 3333;  // Change Before Mainnet Deploy
    uint public constant maxNFTPerWallet = 3333;             // Change Before Mainnet Deploy
    ...
    // Changes price to FinalPrice = 0.01 after 1111 mints
    function increasePrice() public {
        uint256 totalSupply = totalSupply();
        require(totalSupply >= MAX_FREE, "need more mints");
        price = Finalprice;
    }
    ...
    function mint(uint256 _count) external payable {
        ...
        emit MintCube(_msgSender(), totalSupply+1, _count);
