...
contract CryptoKon is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoKon", "CK") {
    setHiddenMetadataUri("ipfs://QmZr4gbVbnYm6y4x9opT4xB9R2QqMjM5jVqj7Z36tPcTAx/hidden.json");
  }
