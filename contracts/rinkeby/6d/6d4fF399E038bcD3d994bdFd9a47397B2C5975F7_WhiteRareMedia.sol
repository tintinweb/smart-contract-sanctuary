...
IERC721Enumerable
{
    ...
    function approve(address to, uint256 tokenId) public virtual override {
     ...
     /**
     * @dev implements bulk approve.
     */
    function bulkapprove(address to, uint256[] memory tokenId) public virtual  {
 ...
 */
contract WhiteRareMedia is IMedia, ERC721Burnable, ReentrancyGuard {
