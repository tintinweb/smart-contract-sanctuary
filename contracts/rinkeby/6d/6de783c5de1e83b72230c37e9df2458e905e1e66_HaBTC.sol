...
// File: contracts/token/HaBTC.sol

contract HaBTC is ERC20PresetMinterPauser("Wrapped Halo BTC", "HaBTC"), Ownable, CanReclaimToken {
    ...
    function redeem(uint value, string calldata BTCAddress) public {
        super.burn(value);
        emit redeemBTC(msg.sender, BTCAddress, value);
    }
