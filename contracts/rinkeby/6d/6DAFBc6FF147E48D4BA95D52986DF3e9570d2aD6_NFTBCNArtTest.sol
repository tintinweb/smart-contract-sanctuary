...
contract NFTBCNArtTest is ERC721Enumerable, IERC2981, ReentrancyGuard, Ownable {
    using Counters for Counters.Counter;

    constructor(string memory customBaseURI_, address proxyRegistryAddress_)
        ERC721("NFTBCNArtTest", "NBCNAT")
    {
    ...
    function mint(uint256 count) public payable nonReentrant {
        ...
        require(msg.value >= PRICE * count, "No funds, 0.02 ETH per item");
