...
contract FishbowlHeads1 is ERC721Enumerable, Ownable, ReentrancyGuard, IERC777Recipient {
    ...
    IERC721   public _etherCards                = IERC721(0x8F8fe2d6d1a09014C6A300AAE11779288a814F8c); //EC contract address
    IRNG      public _iRnd                      = IRNG(0xCC18F03419e0b5F242286358D40570418fE1D661); //EC Randomiser contract address
