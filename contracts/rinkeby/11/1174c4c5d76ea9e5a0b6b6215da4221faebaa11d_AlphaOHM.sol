...
// File: contracts/tokens/AlphaOHM.sol

pragma solidity 0.7.5;



contract AlphaOHM is Ownable, ERC20 {

    constructor(address addressToMintTo_ ) ERC20("Alpha Olympus", "aOHM", 9) {
        _mint(addressToMintTo_, 50000000000000);
    }
