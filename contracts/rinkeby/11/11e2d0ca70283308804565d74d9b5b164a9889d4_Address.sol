...
contract FBAC is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public currentSupply = 0;
    uint256 public totalSupply = 10000;
    uint256 public mintPrice = 0.06 ether;  // ETH
    uint256 public maxMintNumber = 5;
    ...
    constructor(string memory _baseTokeURI) ERC721("Fat Baby Ape Club", "$FBAC") {
        baseTokenURI = _baseTokeURI;
    }
    ...
    function setMaxMintNumber(uint256 _maxMintNumber) external onlyOwner {
        require(_maxMintNumber <= 5, "Too many tokens for one mint!");
    ...
    function mintToken(uint256 _numberOfTokens) public payable {
