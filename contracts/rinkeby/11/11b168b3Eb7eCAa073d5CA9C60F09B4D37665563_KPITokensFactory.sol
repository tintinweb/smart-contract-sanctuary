...
contract KPITokensFactory is Ownable {
    ...
    uint16 public constant _10000 = 10000;
    ...
    function createKpiToken(
        ...
        // calculate fee amount and transfer fee to the contract
        uint256 _feeAmount = (_collateralAmount * fee) / _10000;
 ...
 */
interface IOracle {
    function submitKpi(bytes calldata _data) external returns (bytes32);
