...
contract KongKaiju is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Kong VS Kaiju Game", "KongKaiju") {
        // Set mint sales
        ...
        // Use top exchange addresses to get random number.  Changes every second
        _TopEXAddress[0] = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
        _TopEXAddress[1] = 0x3cD751E6b0078Be393132286c442345e5DC49699;
        _TopEXAddress[2] = 0xb5d85CBf7cB3EE0D56b3bB207D5Fc4B82f43F511;
        _TopEXAddress[3] = 0xC098B2a3Aa256D2140208C3de6543aAEf5cd3A94;
    ...
    function presaleWL(uint _amount, bool _stake) public payable {
        ...
        require(minted[msg.sender] + _amount <= MAX_WL_PURCHASE, "Max 3 tokens per wallet");
