...
contract Folk004 is ERC721Enumerable, ReentrancyGuard, Ownable {
...
//                output = string(abi.encodePacked('"', name[0], ' ', name[1], '" ', output, " +1"));
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[6] = '</text><text x="10" y="40" class="base">The ';
        ...
        parts[12] = '</text><text x="10" y="60" class="base">The ';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Folk004:', toString(tokenId), '", "description": "Folk generates random people you might meet on an adventure", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("Folk004", "FOLK004") Ownable() {}
}
