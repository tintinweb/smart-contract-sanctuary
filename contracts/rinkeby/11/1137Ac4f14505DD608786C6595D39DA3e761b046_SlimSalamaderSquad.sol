...
contract SlimSalamaderSquad is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    
    // Set variables
    
    uint256 public constant SSS_SUPPLY = 10000;
    uint256 public constant SSS_PRICE = 50000000000000000 wei;
    bool private _saleActive = false;
    string private _metaBaseUri = "";
    
    // Public Functions
    
    constructor() ERC721("Slim Salamader Squad", "SSS") {}
    
    function mint(uint16 numberOfTokens) public payable {
        require(isSaleActive(), "Slim Salamader Squad sale is not active");
        require(totalSupply().add(numberOfTokens) <= SSS_SUPPLY, "Insufficient supply");
