...
contract StringsToken is Context, Ownable, ERC165Storage, IERC721Enumerable, IERC721Metadata {
    ...
    // Events
    event MintedStrings(address minter, uint256 stringId, uint256 count, uint256 dustAmount);
    ...
    */
    function mintOneString(uint256 dustAmount) public {
        require(   (dustAmount == STRING_MINT_PRICE_S1) 
		|| (dustAmount == STRING_MINT_PRICE_S2)
		|| (dustAmount == STRING_MINT_PRICE_S3), "dustAmount not correct");
        require(_maxSupply >= mintedSupply().add(1), "Not enough Strings left");

	IDUST(_dustAddress).approve(address(this), dustAmount);
	...
	uint mintStart = mintedSupply();
        ...
        emit MintedStrings(msg.sender, mintStart, 1, dustAmount);
    }

    /**
    * @dev Buy a String with Dust
    */
    function mintOneStringPreApproved(uint256 dustAmount) public {
        require(   (dustAmount == STRING_MINT_PRICE_S1) 
		|| (dustAmount == STRING_MINT_PRICE_S2)
		|| (dustAmount == STRING_MINT_PRICE_S3), "dustAmount not correct");
        require(_maxSupply >= mintedSupply().add(1), "Not enough Strings left");
    ...
    */
    function mintStrings(uint256 count, uint256 dustAmount) public {
        require(   (dustAmount == STRING_MINT_PRICE_S1.mul(count)) 
		|| (dustAmount == STRING_MINT_PRICE_S2.mul(count))
		|| (dustAmount == STRING_MINT_PRICE_S3.mul(count)), "dustAmount not correct");
	...
	uint mintStart = mintedSupply();
        ...
        emit MintedStrings(msg.sender, mintStart, count, dustAmount.div(count));
    }

    /**
    * @dev Buy a String with Dust, preapproved
    */
    function mintStringsPreApproved(uint256 count, uint256 dustAmount) public {
        require(   (dustAmount == STRING_MINT_PRICE_S1.mul(count)) 
		|| (dustAmount == STRING_MINT_PRICE_S2.mul(count))
		|| (dustAmount == STRING_MINT_PRICE_S3.mul(count)), "dustAmount not correct");
        require(_maxSupply >= mintedSupply().add(count), "Not enough Strings left");
