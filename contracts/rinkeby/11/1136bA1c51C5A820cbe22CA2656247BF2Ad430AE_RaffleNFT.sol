...
contract RaffleNFT is Ownable, Pausable, Claimable, VRFConsumerBase {
	...
	//Event
	event RequesId(bytes32 indexed requestId, uint256 module);
	event RandomResult(bytes32 indexed requestId, uint256 randomResult, uint256 module, uint256 randomResultMod);
	...
	function getRequestRandomness(uint256 _module)
		...
		external returns (bytes32)
		{
			...
			emit RequesId(requestId, module);
			return requestId;
		}
	...
	function fulfillRandomness(bytes32 _requestId, uint256 _randomness)
    	internal override
		{
			...
			emit RandomResult(_requestId, _randomness, module, randomResult);
			randomResultMap[_requestId] = randomResult;
		}
