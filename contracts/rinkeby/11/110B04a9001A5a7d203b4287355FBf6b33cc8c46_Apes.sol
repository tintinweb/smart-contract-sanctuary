...
// File contracts/ApesPresale.sol
...
contract Apes is ERC721, Ownable, Pausable, ApesPresale, EIP712 {
    ...
    uint256 private OWNER_MAX_TOKEN_COUNT = 10;
    uint256 public PUBLIC_PRICE = 50000000000000000;
    bool private _isPresale = true;
    string private constant SIGNING_DOMAIN = "WarriorApesNFT";
    string private constant SIGNATURE_VERSION = "1";
    address private signer = 0x292Cd51c8E38B9d16a114EA1f088bd6078ACC5A4;
    ...
    */
        ...
        onlyPublicSale
    {
        ...
        require(
            totalSupply + tokenCount <= MAX_COUNT,
            "Minting would exceed max total supply"
        );
        require(
            balanceOf(msg.sender) + tokenCount <= OWNER_MAX_TOKEN_COUNT,
            "Minitng would exceed max count for owner"
        );
        require(msg.value >= PUBLIC_PRICE * tokenCount, "Insufifcient funds sent");
    ...
    function presaleMint(NFTVoucher calldata voucher, uint tokenCount) public payable onlyPresale whenNotPaused {
        ...
        require(
            ...
            "Minitng would exceed max presale count for owner"
        );
        require(
            balanceOf(msg.sender) + tokenCount <= OWNER_MAX_TOKEN_COUNT,
            "Minitng would exceed max count for owner"
