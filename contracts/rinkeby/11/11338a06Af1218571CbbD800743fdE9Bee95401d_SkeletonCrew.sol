...
contract pixiedust {
    ...
    string                   constant _name   = "GirlsRobotsDragons Presale";
    string                   constant _symbol = "GRDP";
    ...
    bool                     constant _timedPresale  = true;
    uint256                  constant _presaleStart = 1636102800;  // Fri, 05 Nov 2021 09:00
    uint256                  constant _presaleEnd = 1637398800;      // Sat, 20 Nov 2021 09:00

    bool                     constant _timedSale = true;
    uint256                  constant _saleStart = 1637398800;        // Sat, 20 Nov 2021 09:00
    uint256                  constant _saleEnd = 1638262800;            // Tue, 30 Nov 2021 09:00

    bool                     constant _dustMintAvailable = true;
    uint256                  constant _dustPrice = 560000000000000000000;

    // ETHER CARDS
    uint256                  constant _maxFreeEC = 1000;
    uint256                           _totalFreeEC;
    ...
    // per address limits
    uint256                  constant _freePerAddress = 5;
