    ...
    MythDivisionExclusiveAccess
{
    ...
    uint16 public MAX_SUPPLY = 5636;
    uint16 public MAX_PRESALE_COUNT = 1500;
    uint8 _maxPurchaseCount = 10;
    uint256 _reservedCount = 136;
    ...
    constructor(
        ...
        ERC721("Bored Ape Seeking Yacht Club Issue #0", "MD-APES0")
    ...
    function _randomVariantIndex(uint256 seed, uint256 tokenId)
        ...
        returns (uint256)
    {
        return uint256(keccak256(abi.encodePacked(seed, tokenId))) % 100;
    }
