...
//        usdEntryFee = 50 * (10**18);
    ...
    function enter() public payable{
        require(lottery_state == LOTTERY_STATE.OPEN, "lottery_state is not OPEN!");
        //50$ min.
    ...
    function getEntranceFee() public view returns(uint256){
        ...
        uint256 adjPrice = uint256(price) * 10**10; //18 decimals.. WTF? idk? https://docs.chain.link/docs/ethereum-addresses/
        //50$ fee
        // 4,696$/ETH
        // 50 * 100000 / 4696

//        uint256 costToEnter = (usdEntryFee * 10**18)/ adjPrice;
        return (usdEntryFee * 10**18)/ adjPrice;
    }
    ...
    function endLottery() public onlyOwner{
       // uint256(
        ...
        //Chainlink V.erifiably R.andom F.unction provides verifiable Randomness
