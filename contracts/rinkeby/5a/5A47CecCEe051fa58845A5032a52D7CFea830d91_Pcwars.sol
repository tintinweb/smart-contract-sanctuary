...
contract Pcwars is ERC721, Ownable {
    ...
    uint public totalSupply = 30; // 10k
    uint public maxPresaleTokens = 10; // 2.5k
    ...
    uint public teamTokens = 20;

    // Prices
    uint private price = 0.002 ether;
    uint private presalePrice = 0.0015 ether;
    ...
    function mintBear(uint256 _amount) public payable {
    ...
    function mintForTeam() public onlyOwner {
        require(totalSupply >= 25 + tokenIds.current(), "Not enough tokens left!");
