...
contract Traveler is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    // public minting
    function koalaMint(address _sender,uint256 _mintAmount) public payable nonReentrant {
        ...
        function koalaPresaleMint(address _sender,uint256 _mintAmount) public payable nonReentrant {
