...
contract CloneFactory is Ownable {
    ...
    event NewImplementationAdded(address implementation, string details, uint256 number);
    ...
    function addImplementation(address _implementation, string memory _details) public onlyOwner {
        ...
        emit NewImplementationAdded(_implementation, _details, implementations.length - 1);
    }
