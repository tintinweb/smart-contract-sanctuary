...
contract testson is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("sontest", "test") {
    setHiddenMetadataUri("ipfs://QmR1YJ8ziengZmMHQ1FSRomeMTwqLbckndKFvqxaSnwWfS/hidden.json");
  }
