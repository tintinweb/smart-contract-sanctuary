...
contract BridgeLeveragedPositionController is AbstractController, IERC1155Receiver {
    ...
    function canUnstake() public view override returns (bool) {
        //TODO check 'withdrawalsInfo'
        // WithdrawalStatus.READY
        return super.canUnstake();
    }

    function maxUnstake() public view override returns (uint256) {
        //TODO check withdrawalsInfo
        return PreciseUnitMath.MAX_UINT_256;
    }
    ...
    function unstake() external override onlyIndex returns (uint256) {
        ...
        setIdleState();
        return _amountStbl; //_baseAmount;
    }
    ...
    function netWorth() external view override returns (uint256 _worth) {
        ...
        if (staking()) {
            ...
            _worth = leveragedPortfolio.convertBMIXToSTBL(_bmiXStaked).add(_rewardsInBase);
        } else {
            //or unstaking
            (uint256 _unstakingBMIX, ) = unstakingInfo();
            _worth = leveragedPortfolio.convertBMIXToSTBL(_unstakingBMIX);
        }
    }
