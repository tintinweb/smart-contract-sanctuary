...
contract PixuCats is ERC721PresetMinterPauserAutoId {

    string private constant NAME = "PixuCats";
    string private constant SYMBOL = "pCats";
    uint256 private constant MAX_ITEMS = 26000;

    constructor(
        address platformSettings,
        string memory baseURI
    ) public ERC721PresetMinterPauserAutoId(platformSettings, NAME, SYMBOL, baseURI) {}
    ...
    function _beforeTokenTransfer(
        ...
        require(
            _getPlatformSettingsValue(_settingsConsts().PIXU_CATS_PAUSED()) == 0,
            "PIXU_CATS_TOKEN_PAUSED"
        );
    }
}
...
abstract contract ERC721PresetMinterPauserAutoId is Base, Context, ERC721Burnable, ERC721Pausable, IERC721Mintable {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(address platformSettings, string memory name, string memory symbol, string memory baseURI) public Base(platformSettings) ERC721(name, symbol) {
        _setBaseURI(baseURI);
    }
     ...
     */
    function mint(address to) public override onlyMinter(_msgSender()) {
