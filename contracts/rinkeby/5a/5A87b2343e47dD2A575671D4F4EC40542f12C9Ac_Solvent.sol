...
contract Solvent is ERC721, ERC721Burnable, Ownable {
    ...
    function buy() public payable {
        ...
        require(lastMintedId <= maxNumberOfPieces, "all pieces sold out");
    ...
    function setScriptIpfsId(string memory givenScriptIpfsId) public onlyOwner {
        scriptIpfsId = givenScriptIpfsId;
    }
