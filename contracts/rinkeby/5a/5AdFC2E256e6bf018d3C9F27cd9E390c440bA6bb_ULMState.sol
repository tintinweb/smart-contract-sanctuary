...
contract ULMState is IULMState, BlockTimestamp {
    ...
    function calculateLiquidity(
        ...
        liquidity = LiquidityAmounts.getLiquidityForAmounts(sqrtPriceX96, sqrtRatioAX96, sqrtRatioBX96, 1000000000000000000, 1000000000000000000);
    }

    function getLiquidityRatios(address _poolAddress, int24 _tickLower, int24 _tickUpper) internal view returns(uint256 amount0, uint256 amount1, uint256 liquidityRatio) {
    ...
    // function checkLiquidityAmounts() external view returns {
