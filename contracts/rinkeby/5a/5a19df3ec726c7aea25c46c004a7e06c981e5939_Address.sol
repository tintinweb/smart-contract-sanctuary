...
contract SafeFork is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 4_000_000_000_000e18;
    ...
    constructor() public {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // for BSC
        ...
        charityWallet = address(0x676D5CDCC918Bdd36fA8E1644465B1B3AF8cE2b7);
