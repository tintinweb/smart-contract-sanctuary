...
contract AdminUpgradeabilityProxy is UpgradeabilityProxy {
     ...
     * This is the keccak-256 hash of "speedProp03170001.proxy.admin", and is validated in the constructor.
     */
    bytes32 private constant ADMIN_SLOT = 0x55077b59f4354536f0195df080e53927712b8be17ef1581e0bb5ebf6866161fb;
    /**
    ...
    constructor(address _implementation) UpgradeabilityProxy(_implementation) public {
        assert(ADMIN_SLOT == keccak256("speedProp03170001.proxy.admin"));
...
**/
    function contProxyVersion20210317009() external view returns (string) {
        return "20210317009.proxy.0001" ;
    }
    
    function adminSlot() external view returns (bytes32) {
        return ADMIN_SLOT ;
    }
