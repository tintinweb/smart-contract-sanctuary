...
import "../token/ERC223/ERC223FixedSupply.sol";
import "../libraries/config-fee.sol";

contract MasterERC223FixedSupply {
  ERC223FixedSupply[] private childrenErc223FixedSupply;
  ...
  function createTokenERC223(
    ...
    ERC223FixedSupply child = new ERC223FixedSupply(
      name,
      symbol,
      decimal,
    ...
    childrenErc223FixedSupply.push(child);
  }
}
