...
contract BubblerClub is ERC721Tradable {
    constructor(address _proxyRegistryAddress) ERC721Tradable("BubblerClub", "BBRCL", _proxyRegistryAddress) {}
    ...
    function contractURI() public pure returns (string memory) {
        return "https://bubblerclub.web.app/metadata.json";
    }
}
