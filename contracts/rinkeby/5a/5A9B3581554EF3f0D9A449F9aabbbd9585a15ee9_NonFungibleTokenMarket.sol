...
// File contracts/IMarketMaker.sol
...
interface IMarketMaker {
    ...
    function setFeePercentage(uint8 feePercentage)
      external;

    function setFeeExemptCurrency(address currency)
      external;
    ...
    event MarketFeePercentageSet(address indexed marketContract, uint8 indexed feePercentage);
    event MarketFeeExemptCurrencySet(address indexed marketContract, address indexed currencyAddress);
}
...
// File contracts/TokenMarket.sol
...
abstract contract TokenMarket is IMarketMaker, ReentrancyGuard, Ownable {
    ...
    uint8 public ownerFeePercentage = 3;
    ...
    function setFeePercentage(uint8 feePercentage)
      ...
      emit MarketFeePercentageSet(address(this), ownerFeePercentage);
    }
    ...
    function setFeeExemptCurrency(address currency)
      ...
      emit MarketFeeExemptCurrencySet(address(this), feeExemptCurrencyAddress);
    }
...
// File contracts/NonFungibleTokenMarket.sol
