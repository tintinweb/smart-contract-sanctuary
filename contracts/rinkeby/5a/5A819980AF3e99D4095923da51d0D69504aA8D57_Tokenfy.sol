...
contract Tokenfy is ERC20, EIP712, Ownable {
    ...
    // initial max supply
    uint256 public constant INITIAL_MAX_SUPPLY = uint256(1e13 ether);

    // for staking
    uint256 public constant AMOUNT_STAKING = INITIAL_MAX_SUPPLY / 100 * 20;
    address public constant ADDR_STAKING = 0xE11F399Ee8C7788B5B1E25E3762cf073594663FE;

    // for DAO
    uint256 public constant AMOUNT_DAO = INITIAL_MAX_SUPPLY / 100 * 10;
    address public constant ADDR_DAO = 0x6c35BBAD5254765BbE7E3bce116531b3BDAC7927;

    // for team
    uint256 public constant AMOUNT_TEAM = INITIAL_MAX_SUPPLY / 100 * 10;
    address public constant ADDR_TEAM = 0x9c3154807Df6a66FEa8518580DF68d468ffc0155;

    // for LP
    uint256 public constant AMOUNT_LP = INITIAL_MAX_SUPPLY / 100 * 10;
    address public constant ADDR_LP = 0xFe41F9C3FbEdD9c91aA3a832Daa0523B4c0E9eB3;

    // for free claim
    uint256 public constant AMOUNT_AIRDROP = INITIAL_MAX_SUPPLY - (AMOUNT_STAKING + AMOUNT_DAO + AMOUNT_TEAM + AMOUNT_LP);
    ...
    */
    function claim(uint256 amountV, bytes32 r, bytes32 s) external {
        ...
        require(signerValid(v, r, s, msg.sender, amount), "Tokenfy: Invalid signer");
    ...
    */
    function signerValid(uint8 v, bytes32 r, bytes32 s, address sender, uint256 amount) private view returns (bool) {
