...
abstract contract NftBase is IERC721 {
    // Libraries 
    ...
    // -----------------------------------------------------------------------
    // UNINPLEMENTED STATE MODIFYING FUNCTIONS
    // -----------------------------------------------------------------------
    ...
    function approve(address to, uint256 tokenId) virtual external override {}
    function getApproved(uint256 tokenId) virtual external override view returns (address operator){}
    function isApprovedForAll(address owner, address operator) virtual external override view returns (bool){}
    ...
    function supportsInterface(bytes4 interfaceId) virtual external override view returns (bool){}
