...
contract SimpleCrowdsale {
  ...
  uint256 public rate = 325;

  // Amount of wei raised
  uint256 public weiRaised = 0;
  uint256 public target_wei = 10000000000000000000;
  ...
  address public owner_address;
    ...
    function set_target_wei(uint256 amount) public {
        require(msg.sender == owner_address,"Only owner");
        target_wei = amount;
    }
    function get_target_wei() public view returns (uint256){
        return target_wei;
    }
    ...
    function update_rate(uint256 _rate) public {
        require(msg.sender == owner_address,"Only owner");
        rate = _rate;
    }
