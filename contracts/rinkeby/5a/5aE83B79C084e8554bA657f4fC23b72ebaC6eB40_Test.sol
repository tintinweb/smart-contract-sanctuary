...
library Orbit2DFuns {
    ...
    function get_rv( Orbit2D storage self, int256 t ) internal view returns (int256, int256) {
        int256 M = self.n * t  + self.M;  // actual mean anomaly
...
contract Test {
    ...
    Orbit2D orbit =  Orbit2D({a:38709893, e:20563069, M: 305073760, T:760065407544000, n:0});
    Orbit3D orbit3d =  Orbit3D({a:38709893, e:20563069, M: 305073760, T:760065407544000, I:12225804, Omega:84354677, omega:50832330, Euler_angle_transformation_matrix: matrix, orbit2d:orbit });

    function test_get_rv() public view returns (int256, int256) {
        int256 t = 63374400;
        int256 res_x;
        int256 res_y;

        // Orbit2DFuns.Orbit2D storage orbit;

        (res_x, res_y) = orbit.get_rv(t);
        return (res_x, res_y);
    }

    function test_get_xy() public view returns (int256, int256) {
        int256 t = 63374400;
        int256 res_x;
        int256 res_y;
        ...
        (res_x, res_y) = orbit.get_xy(t);
        return (res_x, res_y);
    }

    function test_orbit_3d() public returns (int256[3][3] memory) {
