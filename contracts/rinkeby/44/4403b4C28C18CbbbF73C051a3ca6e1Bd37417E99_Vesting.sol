...
contract Vesting is TimelockController {
    ...
    function addInvestor(
        ...
        require(
            ...
            "addInvestor: investor already added"
        );
        ...
        investor.endTime = (_recurrence * periods[_vType]) + _cliffDays;
    ...
    function getInvestorEndTime(address investor)
        external
        view
        returns (uint256)
    {
