...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        unrevelead = true;
        unreveleadURI = "ipfs://QmZBHRtKHwVrH7KskYMfzFaJSaev7s3pU1LDhi22sceAYM/hidden.json";
    }
...
contract nft is ERC721, Ownable {
    ...
    address payable public projectAddress = payable(0xE62ff241c7f0d6037c844001221123928A4C7e21);
