...
*/
    ...
    // callable by owner only, after specified time, only for Tokens implementing ERC20
    function withdrawTokens(address wallet, address _tokenContract) public onlyOwner  {
        require(block.timestamp >= unlockDate);
   ...
   function getBalanceOf(address wallet, address _tokenContract) public view returns (uint256) {
        ERC20 token = ERC20(_tokenContract);
