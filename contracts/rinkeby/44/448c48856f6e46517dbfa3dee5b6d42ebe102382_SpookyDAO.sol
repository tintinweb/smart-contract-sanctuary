...
/// @title The Spooky DAO ERC-721 token
...
contract SpookyDAO is INounsToken, Ownable, ERC721Enumerable {
    using Strings for uint256;

    uint256 public price = 0; // .02 eth
    ...
    constructor() ERC721('SpookyDAO', 'SPOOKN') {
