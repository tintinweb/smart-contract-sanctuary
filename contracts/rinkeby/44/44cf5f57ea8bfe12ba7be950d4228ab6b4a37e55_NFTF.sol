...
contract NFTF is UUPSUpgradeable, OwnableUpgradeable, ERC1155Upgradeable {
    ...
    function mint(uint256 tokenId, uint256 amount, address recipient) external onlyOwner {
        _mint(recipient, tokenId, amount, "");
    }

    function mintBatch(uint256[] memory tokenIds, uint256[] memory amounts, address recipient)
        external
        onlyOwner
    {
