...
contract CNFTLNFT is ERC721, ERC721Enumerable, PaymentSplitter, Ownable, Pausable {
    ...
    // uint public salesStart = 1629550800; //mainnet
    uint public salesStart = 1630892711;
        ...
        ERC721("CryptoNftLegends.com", "CNFTL")
    {
        ...
        setItemPrice(2200000000); //mainnet
    }
    ...
    function getOneNFT() public payable {
        ...
        require(salesStart < block.timestamp, "Sales begin at 1629550800");
