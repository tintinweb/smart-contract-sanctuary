...
contract HelloWorld is ERC721, Ownable, ERC721Burnable {
    ...
    address public USDC;
    uint256 public mintFee;                 // USDC has 6 decimal, please careful, when setting the free
    uint256 public maxToken = 1000;
    uint256 mintedCount = 0;
    uint256[] mintedNumber;
    uint256 _randomNonce = 0;

    constructor(address _owner, uint256 _mintFee, string memory _tokenURIPrefix, address _beneficiary, address _usdc) ERC721("HelloWorld", "Hello")  {
