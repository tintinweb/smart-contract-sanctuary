...
contract dfhfgfghdfg    is dsefvs, saedfs, yuiyr, hgytuf, wqwreew {
    ...
    function d_FILL_Problem(uint Problem_ID) public payable {
        ...
        for (uint i=1; i<=s_TOTAL_Fillings; i++) {
            ...
            if (_linkage.Problem_ID_LinkedTo==problem.Problem_ID) {
...
contract ghhmbnhngf     is dsefvs, saedfs, yuiyr, hgytuf, wqwreew {
...
contract fyhfjgh        is dsefvs, saedfs, yuiyr, hgytuf, wqwreew {
...
contract Huintsphe      is tfgjyf, dfhfgfghdfg, ghhmbnhngf, fyhfjgh {
