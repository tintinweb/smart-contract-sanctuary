...
contract LFTest is ERC721Enum, Ownable, Pausable,  ReentrancyGuard {
	...
	constructor() ERC721S("LFTest", "LFtest"){
	    setBaseURI("");
	}
    ...
    */
	...
	function publicMint(address _to, uint256 _mintAmount) public payable nonReentrant{
    ...
    function mintWhitelist(bytes32[] calldata merkleProof, address _to, uint256 _mintAmount) public payable nonReentrant isValidMerkleProof(merkleProof, whitelistMerkleRoot){
		uint256 s = totalSupply();
