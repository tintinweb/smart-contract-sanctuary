...
contract Uniwine is ERC721, ERC721Enumerable, ERC721Burnable {
    ...
    function tokenURI(uint tokenId) public view virtual override returns (string memory) {
        // we only have 6 artworks - so we modulo the tokenId with 6, and append '.json'
    ...
    function claimFromFT(address to) public returns (uint) {
        ...
        fungibleContract.burnFrom(msg.sender, 10**18);
