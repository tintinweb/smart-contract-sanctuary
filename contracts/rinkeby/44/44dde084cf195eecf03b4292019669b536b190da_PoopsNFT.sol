...
contract PoopsNFT is Ownable, ERC721Enumerable  {
    using SafeMath for uint256;

    bool public saleIsActive = false;
    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmUvGabmpATiLz7WaqqiFH42k1pSc4mnkzwVKyqMzrG5x1/";
    uint public MAX_PURCHASE = 1;
    uint256 public CURRENT_PRICE = 0.00001 ether;
    uint256 public FIRST_BATCH = 3;
    uint256 public MAX_TOKENS = FIRST_BATCH;

    constructor() ERC721("Poops", "POOP") {
    ...
    function contractURI() public pure returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/Qmc15VcePpThGByiHHw9z5cirnq4EoMQRWwu8n5j4AVL6k";
    }
}