...
contract sMedieval is ERC20Permit, MedievalAccessControlled {
    ...
    constructor() ERC20("Staked Medieval Food", "sFOOD", 9) ERC20Permit() {
    ...
    function setIndex( uint _INDEX ) external onlyAdmin() returns ( bool ) {
        require( INDEX == 0 );
