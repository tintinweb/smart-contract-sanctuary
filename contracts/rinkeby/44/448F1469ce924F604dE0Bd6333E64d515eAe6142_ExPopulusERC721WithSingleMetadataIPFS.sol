...
contract ExPopulusERC721WithSingleMetadataIPFS is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    function mintToken(address owner) public payable returns (uint256) {
        ...
        setRoyalties(id, _raribleBeneficiary, _raribleRoyaltyPercentage);
    ...
    */
    ...
    function setContractURI(string memory contractURI_) public onlyOwner() {
        emit ContractURIChanged(_contractBaseURI, contractURI_);
        _contractBaseURI = contractURI_;
    }
    ...
    function contractURI() public view  onlyOwner() returns (string memory) {
        ...
        return string(abi.encodePacked(base, _contractBaseURI));
    }
    ...
    */
    ...
    /**
     * @dev function for getting the royalty data on rarible
