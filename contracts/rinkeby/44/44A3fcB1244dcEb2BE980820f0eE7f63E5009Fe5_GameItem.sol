...
contract GameItem is ERC721 {
	...
	function _random(uint256 _newItemId) internal pure returns (uint256) {
		return _newItemId % 3;
	}
	...
	function _awardItem(address player) internal returns (uint256) {
		...
		_setTokenURI(
			newItemId,
			string(
				abi.encodePacked('https://60700aa685c3f0001746f4ca.mockapi.io/api/v1/', uint2str(_random(newItemId)))
			)
		);
		return newItemId;
	}
