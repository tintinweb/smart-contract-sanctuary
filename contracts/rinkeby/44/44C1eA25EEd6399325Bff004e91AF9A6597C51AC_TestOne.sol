...
contract TestOne is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4eF9A651F8656DEf8454178406eEae16FB7Ca458;
    ...
    function setmarketingWallet(address newMarketing) external onlyOwner() {
