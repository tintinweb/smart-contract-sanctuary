...
// END AMOS //
    ...
    function redeem(
       ...
       lastRedeemed[msg.sender] = block.number;
        ...
        mintersDetails[_id].amount = mintersDetails[_id].amount.sub(collateralNeeded.mul(10**_missingDeciamls));
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0x5093ecEE4CF4718bfc466690b2622e73A290ca7e"
    }
  },
  "outputSelection": {
    "*": {
