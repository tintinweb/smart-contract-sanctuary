...
contract BlobAcademyTest is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateBlob(uint256 indexed id);
    constructor(string memory baseURI) ERC721("Blob Academy Test 4", "BA4") {
        setBaseURI(baseURI);
        pause(true);
    }
