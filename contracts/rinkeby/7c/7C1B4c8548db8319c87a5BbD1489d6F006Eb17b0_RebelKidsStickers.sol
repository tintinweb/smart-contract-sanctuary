...
contract RebelKidsStickers is ERC20, Ownable {
    ...
    uint public constant MAX_CAP = 10000_000;
    ...
    function hashTransaction(address minter, uint stickers, uint nonce) public pure returns (bytes32) {
    ...
    function claim(uint stickers, uint nonce, bytes memory signature) external {
        ...
        require(totalSupply() + stickers <= MAX_CAP, "You can't exceed total supply limit");
