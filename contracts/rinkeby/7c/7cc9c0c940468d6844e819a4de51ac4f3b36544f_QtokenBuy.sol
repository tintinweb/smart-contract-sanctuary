...
address  public PANCAKESWAP_ROUTER_ADDRESS ;
  ...
  constructor(address _pancakeswap_router_address)  {
  PANCAKESWAP_ROUTER_ADDRESS = _pancakeswap_router_address;
    manager = msg.sender;
}
...
modifier OnlyManager() {
  ...
  IPancakeRouter02  public uniRouter = IPancakeRouter02(PANCAKESWAP_ROUTER_ADDRESS);
