...
//  _                 _         _____
// | |               | |       / ____|
// | |     ___   ___ | | _____| (___   ___ ___  _ __ ___  ___
// | |    / _ \ / _ \| |/ / __|\___ \ / __/ _ \| '__/ _ \/ __|
// | |___| (_) | (_) |   <\__ \____) | (_| (_) | | |  __/\__ \
// |______\___/ \___/|_|\_\___/_____/ \___\___/|_|  \___||___/
...
contract LooksScores is ERC721, ReentrancyGuard, Ownable {
    ...
    function getChestCircumference(uint256 tokenId)
        ...
        returns (string memory)
    {
        return pluck(tokenId, "Chest Circumference", 50, 315, "cm");
    }
    ...
    function getWaistCircumference(uint256 tokenId)
        ...
        returns (string memory)
    {
        return pluck(tokenId, "Waist Circumference", 50, 300, "cm");
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Looks Sheet #',
                        toString(tokenId),
                        '", "description": "Looks Scores are randomized RPG style character physical appearance stats generated and stored on chain. Feel free to use Looks Scores in any way you want.", "image": "data:image/svg+xml;base64,',
    ...
    function claim() public nonReentrant {
        // public starts from 1 to 7777. increments after checking.
        require(_tokenIds.current() < 7777, "Sorry, we run out of LooksScores");
    ...
    function ownerClaim() public nonReentrant onlyOwner {
        // start owner on 7778. increments after checking.

        if (_tokenIdsOwner.current() < 7777) {
            _tokenIdsOwner._value = 7777;
        }
        require(_tokenIdsOwner.current() < 8000, "This is the end");
