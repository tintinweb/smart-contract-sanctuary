...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    //Update the wallet
    function updateWallet(address _wallet) public {
        wallet = _wallet;
    }
    ...
    function claim(bool payingCharges, uint256 _requestedTime) public nonReentrant updateReward(msg.sender) {
        if(_requestedTime == 0){
    ...
    function UpdateReward() public updateReward(msg.sender){
        return;
    }
