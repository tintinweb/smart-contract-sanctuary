...
contract TTNFT is ERC721, ERC721URIStorage, ERC721Enumerable, Governance {
    // for minters
    mapping(address => bool) public _minters;
    
    string private baseURI = "https://tt1.jar.today/nft/";
    
    constructor() ERC721("TT2 Network", "TT2-NFT") {
    }
...
library DegoUtil {
    function uintToString(uint v) internal pure returns (string memory _uintAsString) {
        uint maxlength = 100;
