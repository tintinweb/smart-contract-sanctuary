...
contract FarmProRata is Ownable {
    ...
    address public constant trustedDepositTokenAddress = 0xB63AC7ca1a3e62b5713d1a3D854a06590D6Fe03C;
    address public constant trustedRewardTokenAddress = 0x496FB52E0f23dAacEeC41e14A32e38d04ce14056; 
    
    // Make sure to double-check BURN_ADDRESS
    address public constant BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;
    
    // cliffTime - withdraw is not possible within cliffTime of deposit
    uint public constant cliffTime = 5 minutes;

    // Amount of tokens
    uint public constant disburseAmount = 216000e18;
    // To be disbursed continuously over this duration
    uint public constant disburseDuration = 36 hours;
    
    // If there are any undistributed or unclaimed tokens left in contract after this time
    // Admin can claim them
    uint public constant adminCanClaimAfter = 39 hours;
    
    // delays between attempted swaps
    uint public constant swapAttemptPeriod = 30 minutes;
    // delays between attempted burns or token disbursement
    uint public constant burnOrDisburseTokensPeriod = 90 minutes;
