...
// File: contracts/DmnsMinLowGas.sol
...
contract DmnsMinLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public privateMaxMintAmountPerTx = 3;
  ...
  constructor() ERC721(
    ...
    setHiddenMetadataUri("ipfs://QmP769AuVhHAMLQdyLetnGU56nYrCThPvZKFLbZjrSnGSR/");
  }
  ...
  function _mintLoop(address _receiver, uint256 _mintAmount, bool _incrementMintedBalance) internal {
    for (uint256 i = 0; i < _mintAmount; i++) {
      supply.increment();
      if(_incrementMintedBalance) {
