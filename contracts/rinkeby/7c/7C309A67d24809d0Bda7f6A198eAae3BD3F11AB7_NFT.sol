...
contract NFT is ERC721, VRFConsumerBase, Ownable {
	...
	function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
		...
		uint256 face = randomFace(randomNumber);
		uint256 hair = randomFace(randomNumber);
		uint256 beard = randomFace(randomNumber);
		uint256 ears = randomFace(randomNumber);
		uint256 eyes = randomFace(randomNumber);
		uint256 mouth = randomFace(randomNumber);
		uint256 nose = randomFace(randomNumber);
	...
	function randomFace(uint256 seed) public pure returns (uint256) {
