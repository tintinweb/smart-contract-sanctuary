...
contract PX is ERC721, ERC721Metadata {
    ...
    function updateOmnibus(address omnibus_) external onlyValidSender {

        if(_blacklistAddress[omnibus_]){
            _blacklistAddress[omnibus_] = false;
        }

        _whitelistAddress[_omnibus] = false; 
        _whitelistAddress[omnibus_] = true; 
