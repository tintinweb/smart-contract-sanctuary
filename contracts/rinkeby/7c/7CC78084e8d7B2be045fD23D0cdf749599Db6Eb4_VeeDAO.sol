...
contract VeeDAO is ERC721, Ownable {
    ...
    function TeamMint(address _to, uint256 _count) payable public onlyOwner {
		uint256 mintIndex = _tokenSupply.current();
	...
	function withdraw() public payable onlyOwner {
		...
		// 80% goes to the community wallet
        ...
        address  wallet_6 = 0x593773CB8c4ee924890c90Cf13adcdF2210E7Ed9;
    ...
    function changeTotalCount(uint256 _new) external onlyOwner {
