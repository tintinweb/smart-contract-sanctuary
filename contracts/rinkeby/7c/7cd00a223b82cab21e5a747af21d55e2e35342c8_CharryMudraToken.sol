...
contract CharryMudraToken {
    ...
    constructor (string memory name_, string memory symbol_, uint8 decimals_, uint256 cap_, uint256 initialTotalSupply_) public 
    {
        ...
        roles[MINTER_ROLE].members.add(msg.sender);
        roles[PAUSER_ROLE].members.add(msg.sender);
        roles[BURNER_ROLE].members.add(msg.sender);
    ...
    function mint(address account, uint256 amount) public {
        ...
        require(totalSupply+amount <= cap, "This exceeds the limit of charrymudra token production");
        totalSupply += amount;
