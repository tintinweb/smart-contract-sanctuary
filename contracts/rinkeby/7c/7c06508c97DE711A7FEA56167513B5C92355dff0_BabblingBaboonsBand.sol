...
contract BabblingBaboonsBand is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Babbling Baboons Band", "BBB") {
    setHiddenMetadataUri("ipfs://QmWPShP5iJ2FGLpzXhTMhUKtd3SZMYkyQvtPzkkLuhdFKs/1.json");
  }
