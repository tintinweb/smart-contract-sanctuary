...
contract PAPpool {
    ...
    function startPool(uint256 _TierNumber) public onlyOwner {
        ...
        uint256 _idoToDeposit = pool[_tier].tokensAmount * pool[_tier].tokenPrice;
    ...
    function participate(uint256 _amount) public {
        ...
        // (uint256 _amountStaked, , uint256 _tierNumber) = papStaking.UserInfo(msg.sender);
        ...
        require(
            _maxParticipationAmount >= _amount && _amount >= _minParticipationAmount,
    ...
    function declareWinner(uint256 _tierNumber) public onlyOwner {
        ...
        uint256 dai_return = lotteryToken.balanceOf(address(this)) -
            (amountOfDAIsToClaim * pool[_tier].tokenPrice);
...
contract CreatePapPool is Ownable {
    ...
    */
    function createPool(
        ...
        uint256 _tokenAmountT1 = _Tier1.maxAllocation * _Tier1.tokenPrice;
        uint256 _tokenAmountT2 = _Tier2.maxAllocation * _Tier2.tokenPrice;
        uint256 _tokenAmountT3 = _Tier3.maxAllocation * _Tier3.tokenPrice;
