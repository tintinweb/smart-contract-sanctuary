    ...
    PaymentSplitter
{
    ...
    uint256 public preSaleTime = 1633818654; 
    uint256 public saleTime = 1633820454; 
    uint256[] private _teamShares = [36, 50, 13, 1];


    // Rinkeby
    address[] private _team = [0xA44E579043e24Db3C23fd015C21c9591e6D7eAc1, 0x40cb92204724e1564153727aB603Fc5EE433c3C4, 0x58308c1109115CAF19B082218c95575382278783, 0xDD007c0B048Eaaff49c8A52c9f2b12BeA7d27F39];
    ...
    function mintPresale(uint256 _amountMinted) external payable nonReentrant {
        if (owner() != _msgSender()) {
            require(
                ...
                "ERC721:  Presale has not started."
            );
            require(
        ...
        require(preSaleTime < saleTime, "ERC721: Presale has ended.");
        require(totalSupply() < supplyCap, "ERC721: Sale is finished.");
        require(
            _amountMinted > 0 && _amountMinted <= perTxLimit,
            "ERC721: You may only mint up to 20 Empty Buns."
    ...
    function setpPreSaleTime(uint256 _preSaleTime) public onlyOwner {
