...
contract Token is Context, IERC20, Ownable {
  ...
  bool private swapAndSellEnabled;
  ...
  uint256 private numTokensSellToSendAsFee = 100 * 10**6 * 10**18;
  
  event SwapAndSell(uint256 contractTokenBalance, uint256 newBalance);
  ...
  function swapAndSell(uint256 contractTokenBalance) private lockTheSwap {
        ...
        emit SwapAndSell(contractTokenBalance, newBalance);
    }
