...
contract LiquidityMigrator is ILiquidityMigrator, IERC721Receiver, Context {
    ...
    function migrateV2Liquidity(MigrateV2Params calldata params) external {
        ...
        if (pair != address(0)) {
            ...
            (baseLiquidity, rangeLiquidity, ) = IUnipilot(params.unipilotAddress).deposit(
            ...
            (baseLiquidity, rangeLiquidity, ) = IUnipilot(params.unipilotAddress)
        ...
        uint256 amount0V3 = amount0Base + amount0Range;
        uint256 amount1V3 = amount1Base + amount1Range;
