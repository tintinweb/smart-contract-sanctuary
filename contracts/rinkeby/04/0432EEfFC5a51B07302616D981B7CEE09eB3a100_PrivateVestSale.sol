...
contract PrivateVestSale is Ownable {
    ...
    function ClaimEnable() onlyOwner public {
        claimableTime = now;
		claimableTime_1 = claimableTime + 2592000;
		claimableTime_2 = claimableTime_1 + 2592000; //add 30 days
    ...
    function Claim_40pct() claimable public {       
        withdrawal40(msg.sender);
    }

    function Claim_20pct_1() claimable1 public {
        //require(claimableTime_1 > now);
        withdrawal20_1(msg.sender);
    }

    function Claim_20pct_2() claimable2 public {
        //require(claimableTime_2 > now);
        withdrawal20_2(msg.sender);
    }
    ...
    function withdrawal20_1(address funder) internal {
        require(fundersProperty[funder].reservedToken > 0);
		require(fundersProperty[funder].claimState == 1);			

        tokenReward.transfer(funder, fundersProperty[funder].reservedToken*100/60*30/100);
        
        fundersProperty[funder].withdrawedToken = fundersProperty[funder].reservedToken*100/60*30/100;
        fundersProperty[funder].reservedToken = fundersProperty[funder].reservedToken - fundersProperty[funder].withdrawedToken;
    ...
    function withdrawal20_2(address funder) internal {
        require(fundersProperty[funder].reservedToken > 0);
		require(fundersProperty[funder].claimState == 2);			

        tokenReward.transfer(funder, fundersProperty[funder].reservedToken*100/30*30/100);
        
        fundersProperty[funder].withdrawedToken = fundersProperty[funder].reservedToken*100/30*30/100;
        fundersProperty[funder].reservedToken = fundersProperty[funder].reservedToken - fundersProperty[funder].withdrawedToken;        
