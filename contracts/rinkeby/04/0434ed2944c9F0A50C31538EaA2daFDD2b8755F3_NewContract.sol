...
contract NewContract is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("NewContract", "NMC") {}
    function reserveNFTs() private onlyOwner {
    ...
    function mintNFTs(uint _count) internal {
     uint totalMinted = _tokenIds.current();     require(
    ...
    function _mintSingleNFT() private onlyOwner {
