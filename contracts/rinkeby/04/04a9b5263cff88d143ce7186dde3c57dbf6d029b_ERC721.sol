...
contract SampleNFT is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    uint256 immutable public maxSupply = 20;
    uint256 public publicMintId = 14;
    ...
    modifier canMint(uint256 numberOfTokens) {
        require(
            publicMintId + numberOfTokens <= maxSupply,
            "Not enough tokens remaining to mint"
        );
        _;
    }

    modifier mintable(uint256 numberOfTokens){
        require(
            giftMintId + numberOfTokens <= maxGiftMintId,
