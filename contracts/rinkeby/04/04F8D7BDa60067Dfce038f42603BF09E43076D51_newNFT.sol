...
contract newNFT is NFTokenMetadata, Ownable {
  ...
  function mint(address _to, uint256 _tokenId, string calldata _uri) payable external onlyOwner {
    
    require(msg.value == 0.001 ether, "Minting fee of 0.01 ether");
