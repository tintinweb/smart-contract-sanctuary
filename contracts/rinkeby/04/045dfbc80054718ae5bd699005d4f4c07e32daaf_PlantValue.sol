...
contract PlantValue is ERC721Pausable, AccessControl, Ownable, IPlantValue {
    ...
    function mint(uint256 num, address from, address to, uint256 tokenId) external onlyOwner {
        uint256 supply = totalSupply();
        require(to != address(0));
        require(rangeOfId.length > 0, "INSUFFFICIENT PLANT ID");
        require( num > 0, "you can mint 0 plants");
        require( num <= 149, "You can mint maximum of 100 plants");
        require( supply + num < 149 - _reserved, "Exceeds maximum Plants spply");
