...
contract LarvaLHads is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getSVG(LarvaObject memory larvaLad) internal view returns (string memory) {
        ...
        parts[0] = '<svg id="x" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 30 30" ><g transform="scale(-1,1)"><path fill="#638596" d="M0 0h30v30H0z"/>';
        parts[1] = '<path fill="';
