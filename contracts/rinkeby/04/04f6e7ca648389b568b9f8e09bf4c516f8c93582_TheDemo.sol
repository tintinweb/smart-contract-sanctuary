...
contract TheDemo is Ownable, ERC721Enumerable {
    ...
    IERC721 private oldNFT;

    uint256 private oldLimit;



    constructor() ERC721("The Demo", "THEDEMO") {

        _setBaseURI("www/");

        oldLimit = 900;

        oldNFT = IERC721(address(0x87160F378F765080ad5172545305792e56aa5607));
    ...
    function buyExisting(uint256[] calldata oldIDs) external {
        ...
        require(saleStage == 0, "Existing buy not active");

        for(uint256 i = 0; i < oldIDs.length; i++) {

            require(oldIDs[i] <= oldLimit, "Invalid ID");
    ...
    function buyWithMintPass() external payable {
        ...
        require(saleStage == 1, "Mint pass sale not active");
    ...
    function buy(uint256 _count) external payable {
        ...
        require(saleStage == 2, "Public sale not active");
    ...
    function setSaleStage(uint256 _stage) external {
