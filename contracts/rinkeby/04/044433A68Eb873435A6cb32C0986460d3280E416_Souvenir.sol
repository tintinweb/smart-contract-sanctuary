...
contract Souvenir is Ownable, ERC721, IRaribleRoyaltiesV2 {
    ...
    modifier tokensAvailable(uint256 quantity) {
    ...
    // @author Ian Olson
    function mint(uint256 quantity) public payable onlyActive onlyNonPaused mintLimit(quantity) tokensAvailable(quantity) {
    ...
    // @dev Load up the Pre-Sale mappings with initial list and POAP sign ups.
    // @author Ian Olson
    function initialPresaleList() public onlyAdmin {
