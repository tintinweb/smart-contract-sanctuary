...
contract Shibuya is Ownable, ERC1155Holder, Pausable {
    ...
    */
    ...
    // Admin
    function setNumberOfEpisodes(uint256 numberOfEpisodes) external onlyOwner() {
    ...
    function removeLatestEpisode(uint256 microEpisodeId) external onlyOwner {
        ...
        // cant delete mappings in solidity so just setting to single option 0
        _microEpisodeOptions[microEpisodeId] = [0];
    }
    ...
    function stakeProducerPass(uint256 episodeId, uint256 voteOptionId, uint256 amount) public {
        ...
        _usersStakedEpisodeVotingOptionsCount[msg.sender][episodeId][voteOptionId] = _usersStakedEpisodeVotingOptionsCount[msg.sender][episodeId][voteOptionId] + amount;

        _microEpisodeVotesByOptionId[episodeId][voteOptionId] = _microEpisodeVotesByOptionId[episodeId][voteOptionId] + amount;
    ...
    // admin - voting
    function setVotingEnabled(bool enabled) public {
