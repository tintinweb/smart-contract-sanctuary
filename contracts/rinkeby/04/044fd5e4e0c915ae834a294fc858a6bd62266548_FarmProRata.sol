...
contract FarmProRata is Ownable {
    ...
    address public constant trustedDepositTokenAddress = 0x8B22F85d0c844Cf793690F6D9DFE9F11Ddb35449; // uniswap pair address
    
    // token used for rewards - this must be one of the tokens in uniswap pair.
    address public constant trustedRewardTokenAddress = 0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735; 

    address public constant trustedStakingContractAddress = 0xB5d36A3ec7ce914888ee37701301692021FBcef3;
    ...
    // Amount of tokens
    uint public constant disburseAmount = 216000000000e18;
    // To be disbursed continuously over this duration
    uint public constant disburseDuration = 3.6 hours;
    
    // If there are any undistributed or unclaimed tokens left in contract after this time
    // Admin can claim them
    uint public constant adminCanClaimAfter = 3.9 hours;
    
    // delays between attempted swaps
    uint public constant swapAttemptPeriod = 7 minutes;
    // delays between attempted burns or token disbursement
    uint public constant burnOrDisburseTokensPeriod = 10 minutes;
