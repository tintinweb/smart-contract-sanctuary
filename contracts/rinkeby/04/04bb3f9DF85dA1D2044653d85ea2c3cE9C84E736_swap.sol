    ...
    function dex(
        ...
        external payable{
            ...
            for(uint i=0; i<newDexRoute.length; i++){
                 uint[] memory Uni_amountIn = U_amountIn;
                if(newDexRoute[i]==0)
                {
            ...
            { 
                ...
                console.log("after Transfer & approve");
        ...
        eventEmit(amountIn_deadline[1], UserBalanceBeforeSwap, Tokens_In_Out1[0], Tokens_In_Out1[1], msg.sender);
    }
