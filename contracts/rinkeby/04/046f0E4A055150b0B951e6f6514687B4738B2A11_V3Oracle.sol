...
contract V3Oracle is IOracle {
    ...
    address public constant PILOT = 0x18F10404cC1414e6ACBfEA16CCC97D9ed303e98C;
    ...
    uint256 public constant LIQUIDITY_VALIDATION_AMOUNT = 100000e18;
    ...
    constructor(address _ulmState, address _governance) {
        governance = _governance;
        ulmState = _ulmState;
    }

    function setUlmState(address _ulmState) external onlyGovernance {
        require(_ulmState != address(0), "IA");
        emit ULMStateUpdated(ulmState, _ulmState);
        ulmState = _ulmState;
    }
