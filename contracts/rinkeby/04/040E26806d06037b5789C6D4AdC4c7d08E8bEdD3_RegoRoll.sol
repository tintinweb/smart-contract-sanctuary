...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'd9b28a8fe8a16a5acc4202dc659766b79054d2ec3544e1317a209d1b597211a7' // init code hash
            ))));
    }
...
// RegoRoll helps your migrate your existing Uniswap LP tokens to RegoSwap LP ones
contract RegoRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'RegoSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'RegoRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'RegoRoll: INSUFFICIENT_B_AMOUNT');
    }
    ...
    function pairForOldRouter(address tokenA, address tokenB) internal view returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                oldRouter.factory(),
                keccak256(abi.encodePacked(token0, token1)),
                hex'1ea27490be6eb46d0e3ddc98a004816abe3e2d9ccfd3fc07aa4a5ff15c6d1471' // init code hash
            ))));
    }
