...
contract Faucet is Ownable, ReentrancyGuard {
    ...
    constructor(IERC20 _token, uint256 _tokenPerBlock, uint256 _startBlock, uint256 _bonusEndBlock, Lock _lockAddress) public {
        token = _token;
    ...
    function distributeTokens(uint256 pending) private {
        ...
        uint256 amountToLock = pending.div(100).mul(20);
        ...
        // lock.bulkLock(lock.getLockToken(), amounts, durations, beneficiaries, amountThresholds, true);
    }
