...
contract MasterERC1155 is Initializable {
  ...
  function initialize(address configFee, address _cAddress)
    ...
    initializer
  {
    __MasterERC1155_init(configFee, _cAddress);
  }

  function __MasterERC1155_init(address configFee, address _cAddress)
    internal
    initializer
  {
    __MasterERC1155_init_unchained(configFee, _cAddress);
  }

  function __MasterERC1155_init_unchained(address configFee, address _cAddress)
    internal
    initializer
  {
