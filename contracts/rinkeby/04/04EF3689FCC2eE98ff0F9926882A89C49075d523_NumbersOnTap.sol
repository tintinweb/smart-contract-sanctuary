...
contract NumbersOnTap is ERC721 {
    ...
    constructor(uint maxPowerOfTen) ERC721("NumbersOnTap", "NumbersOnTap") {
    ...
    {
        string memory strId = NumberToString.numberToString(itemId);
        ...
        bytes memory json = abi.encodePacked(string(abi.encodePacked(
            '{"name": "Number ', strId, '","description": "Numbers","image": "', image, '","traits": [ ',
