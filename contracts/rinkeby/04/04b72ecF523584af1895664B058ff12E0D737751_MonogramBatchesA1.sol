...
contract MonogramBatchesA1 is ERC1155PresetMinterPauser {
    ...
    uint256 public constant BATCH3 = 3492;
     // Token name
    string private _contractName = 'Monogram Network, Inc.';
    // Is Token Paused Map
    mapping (uint256 => bool) public isPausedMap;
    ...
    function setIsTokenPaused(bool isPaused, uint256 id) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "Monogram: must have minter role to pause");
        isPausedMap[id] = isPaused;
    }
     ...
     * Requirements:
     *
     * - the specific token must not be paused
     */
        ...
        override
    {
        ...
        for (uint i = 0; i < ids.length; i++) {
          require(!isPausedMap[i], "One of these tokens is paused");
        }
