...
// Import hardhat, the ethereum development environment
import "hardhat/console.sol";

import { Base64 } from "./libraries/base64.sol";


contract JohnnyDappNFT is ERC721URIStorage{
    ...
    string[] firstWords = ["Pirate", "Cowboy", "Teacher", "President","Waiter", "Ninja", "Guru", "Demon"];
    string[] secondWords = ["Kakashu", "Hasirama", "Goku", "Kurama", "Mezuki", "Tsubasa", "Wakabayaschi"];
    string[] thirdWords = ["Flop", "Fart", "Head", "WAGMI", "Stupid", "Accident"];

    event NewJohnnyDappNFTMinted(address sender, uint256 tokenId);

    
    // We need to pass the name of our NFTs token and its symbol.
    constructor() ERC721 ("Johnny Dapp", "pirate") {
        totalSupply = 777;
        console.log("This is my NFT contract. BUHJA!");
    }
    ...
    // function that will allow Users to get their NFT
    function makeJohnnyDappNFT() public {
        ...
        //_setTokenURI(newItemId, "https://jsonkeeper.com/b/1BCU");
        ...
        // increment counter when NFT is minted
        _tokenIds.increment();
        console.log("An NFT w/ ID %s has been minted to %s", newItemId, msg.sender);
        emit NewJohnnyDappNFTMinted(msg.sender, newItemId);
