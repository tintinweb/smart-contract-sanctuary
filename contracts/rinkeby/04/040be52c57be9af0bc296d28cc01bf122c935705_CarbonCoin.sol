...
contract CarbonCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public rewardCycleBlock = 36 hours;
    ...
    function swapEthForRewardTokens(uint256 ethAmount) private {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: ethAmount.div(2)}(
            0, // accept any amount of usdt
            path1,
            address(this),
            block.timestamp
        );
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: ethAmount.sub(ethAmount.div(2))}(
            0, // accept any amount of usdt
            path2,
            address(this),
            block.timestamp
    ...
    function checkReward(address Claimer) public view returns (uint256,uint256) {
    ...
    function claimReward() isHuman nonReentrant public {
        ...
        (uint256 btcbR, uint256 usdtR) = checkReward(msg.sender);
