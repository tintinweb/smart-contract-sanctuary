...
contract CypherHumans is ERC721Enumerable, Ownable {
    ...
    string public contractURI = "ipfs://bafkreibikmrwcdaox6fhpqflnyadvkaqyvlxcfvv3kwvikybzemz2ic32a";

    string private constant _defaultURI = "ipfs://bafkreiar4y2gkkh3rulfvleokgktqo7oj2jmjybwhbhgnnadamwsqrnxci";
    ...
    constructor(
        ...
        RESERVED_TOKENS = 20;
        // RESERVED_TOKENS = _totalSupply / 10;
    ...
    function mint(uint256 amount) public payable onSaleOpen {
        ...
        require(currentTokenId + amount + RESERVED_TOKENS < TOTAL_SUPPLY, "Cannot mint more than TOTAL_SUPPLY!");
    ...
    function reserve(uint256[] memory tokenIds, address to) public onlyOwner {
        // require(tokenIds.length <= RESERVED_TOKENS, "Purchase would exceed remaining reserved tokens");
