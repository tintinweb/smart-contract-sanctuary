...
contract CouchMinter is ERC721Enumerable, PaymentSplitter, Ownable {
  ...
  function mint(uint256 amount) public payable {
    require(isMintingActive, "CouchMinter: sale is not active");
    ...
    require(amount <= 20, "CouchMinter: must mint fewer than 20");
    require(currentTokenId < MAX_SUPPLY, "CouchMinter: sale has ended");
    require(currentTokenId + amount <= MAX_SUPPLY, "CouchMinter: exceeds max supply");
