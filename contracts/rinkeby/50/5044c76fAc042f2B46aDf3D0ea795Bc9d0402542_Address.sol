...
contract DapperGang is ERC721, Ownable {
    ...
    uint256 public constant dapperPrice = 45000000000000000; // 0.025 ETH
    ...
    constructor() ERC721("Dapper Gang", "DG") { }
    ...
    function mintDapper(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxDapperPurchase, "Can only mint 20 tokens at a time");
