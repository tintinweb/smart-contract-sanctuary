...
contract AdvancedCollectible is ERC721, Ownable {
    using SafeMath for uint256;
    uint256 public constant MAX_TOKENS = 216;
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 20;
    uint256 private price = 1000000000000000000; // 0.0001 Ether
    bool public paused = false;

    constructor () public ERC721 ("Funky Frame 3", "FFR3"){
    }
    ...
    function salemint(uint256 _count) public payable {
        ...
        require(paused == false, "Sale is not yet active");
