...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmU73mRfCm4MLYJKy3jSKrg7v3129HCD8UUqesce8Ma8az/";
            ...
            returns (string memory)
        {
            return
                string(
                    abi.encodePacked(IPFSTokenURI, Strings.toString(_tokenId))
                );
        }
    ...
    // File: contracts/ramppWithPreRevealContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract RamppWithPreRevealContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("RamppWithPreReveal", "REVEAL", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "http://localhost:5001/nft-rampp/us-central1/app/RT2XS80jF3KTqBjiRQ4g/contract-metadata";
        }
    }