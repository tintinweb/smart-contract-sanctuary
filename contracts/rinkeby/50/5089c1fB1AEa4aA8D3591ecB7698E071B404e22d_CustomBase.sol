...
// File: CustomCollectible.sol

// @title CustomBase
// @dev ERC721 token.
//      mint, burn and transferFrom are supposed to be called 
//      from CustomBase contract only.
contract CustomBase is ERC721, ERC721URIStorage, Pausable, Ownable  {
    ...
    uint256 private constant nftsPublicNumber = 4900;
    ...
    constructor()
    public ERC721("CustomCrypto", "CCO") {
    ...
    function directMint(address to, uint256 tokenId) public onlyOwner {
        require(tokenId > nftsPublicNumber, "Tokens number to mint must not exceed number of public tokens");
        _safeMint(to, tokenId);
    }

    function buyCustomCoin(uint tokensNumber) whenNotPaused public payable {
