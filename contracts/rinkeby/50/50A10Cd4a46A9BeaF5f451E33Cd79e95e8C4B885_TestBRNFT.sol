...
// File: contracts/BassmentRats.sol
...
abstract contract WithLimitedSupply {
    ...
    function availableTokenCount() public view returns (uint256) {
        return totalSupply2() - tokenCount();
    }
...
abstract contract RandomlyAssigned is WithLimitedSupply {
    ...
    function nextToken() internal override ensureAvailability returns (uint256) {
        uint256 maxIndex = totalSupply2() - tokenCount();
...
// Calling mint mints a random  Bassment Rat until all 20 have been minted
// Mint costs 0.5 Ether
// 2 Kept for team 


contract TestBRNFT is ERC721Enumerable, Ownable, RandomlyAssigned {
  using Strings for uint256;
  ...
  constructor(
    ...
    address _payments
  ) RandomlyAssigned(20,1) // Max. 20 NFTs available; Start counting from 1 (instead of 0)
      ...
      payable
  {
      ...
      require( tokenCount() + 1 <= totalSupply2(), "YOU CAN'T MINT MORE THAN MAXIMUM SUPPLY");
      ...
      if (msg.sender != owner()) {
        ...
        require( balanceOf(_to) <= maxMintAmount);
      }
