...
* and defy the realm of the possible.  And build a community and have fun 
* in the process.
*/
    /// Motley Ds are here for the long run, and focused on utility, value is important to get all that is required to achieve mimetic desire.
    ...
    ///address private constant dFoundation;
    address private constant dGrants = 0xb5713725B6E5E8B719596a3Db218011B1286885c;
    address private constant dArt= 0x0E41e1d347CB78C90d593DA62f93e2C6Ddb9C6C2;
 ...
 /// The D Foundation is still on the fence, getting on dOps' case.

    function disburse()public onlyOwner{
        uint balance = address(this).balance;
        payable(msg.sender).transfer(balance/3000);
        payable(dGrants).transfer(balance/3000);
        payable(dArt).transfer(balance/2000);
        payable(dOps).transfer(balance/2000);
    }
...
/// The first Motley Happening is going to be sick!  A surrealist estate with amazing DJ's, more to be revealed soon!
...
/** 
* While meta-reality may seem unaccessible to all (it actually is), 
* the Motley D community is not.  We are gathering a crew of Motleys
* as the initial braintrust that will help us have strong footings
...
*/
    ...
    function distortReality(uint numberOfMotleys) public payable{
...
/// Yeah, only those with a Motley may enter.
...
/**
* Mimetic Desire as expressed by René Girard is the force that shapes our wants.
...
*/
    ...
    function contractURI()public pure returns(string memory){
      return "https://ipfs.io/ipfs/bafkreiefr4p2qusyu7q45t2pkijj56htngfirtjwjj4i3gor6rjp2nv2vy";
    }
}