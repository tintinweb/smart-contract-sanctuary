...
contract Fountain is ERC721, Ownable {
    ...
    constructor(uint256 _recordPrice, address payable _recordFund) ERC721("Fountain", "FNTN") {
    ...
    function record() public payable {
        require(recordPrice == msg.value, "Fountain: Wrong amount of ETH to make a record");
