...
contract QuantumOrbs is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    uint public MAX_TOKENS = 512;
    uint public MAX_TOKENS_PER_SALE = 10;
    ...
    function ownerMint(uint256 _amount) public onlyOwner {
            require(MAX_TOKENS > _amount + _tokenIdCounter.current() + 1, "Maximum number of tokens have been minted.");
            for(uint256 i = 0; i < _amount; i++){
                _safeMint(msg.sender, _tokenIdCounter.current());
                _tokenIdCounter.increment();
            }
