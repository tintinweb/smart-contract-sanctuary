...
contract Creature is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    address private _preMintReceiver;
    ...
    constructor(
        ...
        setBaseTokenURI("ipfs://QmbN6JzFVAkFb8QBaePWhYg66nAAsFvUtfyryZKqaca69X?");

        _preMintReceiver = msg.sender;
        mintAllNFT();
    ...
    function mintAllNFT() internal {
        ERC721._balances[_preMintReceiver] = MAX_NFT_SUPPLY;
        emit ConsecutiveTransfer(1, MAX_NFT_SUPPLY, address(0), _preMintReceiver);
