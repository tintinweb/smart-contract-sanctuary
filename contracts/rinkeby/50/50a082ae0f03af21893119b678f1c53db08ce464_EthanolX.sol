...
contract EthanolX is Ownable, IERC20Metadata {
    ...
    event ReferralReward(address indexed user, address indexed referrer, address uniswapV2Router, uint256 reward, uint256 timestamp);
    ...
    function _referralRewards(address _addr, uint256 _amount) internal returns(uint8) {
        ...
        */
        ...
        emit ReferralReward(_sender, _referrer, _addr, _amount, block.timestamp);
        return 1;
    }
