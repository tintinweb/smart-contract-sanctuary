...
contract Metafam721 is ERC721Enumerable, Ownable {
    ...
    string public baseURI =
        "https://us-central1-metafam-64f47.cloudfunctions.net/app/token/";
    string public notRevealedUri =
        "https://us-central1-metafam-64f47.cloudfunctions.net/app/notrevealed";
    ...
    uint256 public whiteListedCost = 0.06 ether;
    ...
    constructor() ERC721("METAFAM", "MFC") {}
    ...
    function manageWhiteList(
        ...
        for (uint256 i = 0; i < _whitelistAddresses.length; i++) {
            ...
            presaleWhitelist[addAddress] = _trueOrFalse;
        }
    }
