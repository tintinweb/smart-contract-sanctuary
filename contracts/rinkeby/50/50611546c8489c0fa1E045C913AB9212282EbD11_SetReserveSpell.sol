...
// hevm: flattened sources of src/governance/governance.sol
...
interface DripsHubLike {
    function setReserve(address reserve) external;
}
contract SetReserveSpell is Spell {
    address constant DRIPS_HUB =0xfbcD6918907902c106A99058146CBdBb76a812f6;
    address constant RESERVE=0xb06E42af04F2d07f3ce86Fa7267FB1b19F1573E7;

    function execute() override public {
        DripsHubLike(DRIPS_HUB).setReserve(RESERVE);
    }
}