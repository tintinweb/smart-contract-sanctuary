...
contract SharkFactory is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 private _maxMint = 7;
    uint256 private _price = 3 * 10**16; //0.03 ETH;
    bool public _paused = true;
    uint public constant MAX_ENTRIES = 1000;

    constructor(string memory baseURI) ERC721("Sharky", "SHKY")  {
        setBaseURI(baseURI);
    ...
    function mint(address _to, uint256 num) public payable {
        ...
        if(msg.sender != owner()) {
          ...
          require( num < (_maxMint+1),"You can mint maximum of _maxMint Sharks" );
