...
contract EthanolX is Ownable, IERC20Metadata {
    ...
    uint256 public etherPayouts;
    uint256 public stabilizingRewardsPool;
    uint8 private _activateRefund;
    ...
    event SwapAndAddLiquidity(uint256 tokensSwapped, uint256 ethReceived, uint256 tokensIntoLiqudity);
    ...
    constructor() {
        ...
        // BSC Testnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function _beforeTokenTransfer(address from, address to, uint256 _amount) internal virtual returns(uint256 _finalAmount, uint256 _tax) {
        // if(
        //     taxPercentage == 0 || 
        //     getPair() == address(0) ||
        //     // should not charge fees on newly minted tokens
        //     from == address(0) ||
        //     // should not charge fees for burning tokens
        //     to == address(0)
        // ) return(_amount, 0);
