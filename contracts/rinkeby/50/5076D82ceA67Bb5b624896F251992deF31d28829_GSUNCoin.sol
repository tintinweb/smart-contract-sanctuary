    ...
    ERC20Pausable
{
     ...
     */
    constructor() ERC20("GSUNCoin Token", "CARBON") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(
            ...
            "GSUNCoin: must have minter role to mint"
        );
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(
            ...
            "GSUNCoin: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "GSUNCoin: must have pauser role to unpause"
        );
        _unpause();
    }
