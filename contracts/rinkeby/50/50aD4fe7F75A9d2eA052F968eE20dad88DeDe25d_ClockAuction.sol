...
contract ClockAuction is ERC721Tradable{
    ...
    */
    ...
    function submitBid(uint256 _numTokens) payable public {
        ...
        userBid.totalBid += msg.value;
        require(minPrice <= (userBid.totalBid / _numTokens), "Below min. bid");
        require((userBid.totalBid / _numTokens) <= maxPrice, "Exceeds max bid");
     ...
     */
    function assignWinners(address[] calldata _winners) public onlyOwner {
    ...
    function claimTokens() public {
        ...
        for (uint256 i = 0; i < bids[msg.sender].numTokens; i++){
    ...
    function creatorMint(address _to, uint8 amount) public onlyOwner {
        uint256 ts = totalSupply();
        require((ts + amount) <= MAX_PREMINT, "No premints left");
     ...
     */
    function setReclaimLive(uint256 _reclaimEnds) public onlyOwner {
