...
contract Slavs is ERC721Enumerable, Ownable {
    ...
    uint256 public tokenPrice = 0.075 ether;
    ...
    function mintOne() external payable saleIsOpen {
        uint256 _nextTokenId = nextTokenId;

        require(treasury != address(0), "Slavs: no treasury yet");
        require(_nextTokenId + 1 <= maxSupply, "Slavs: max supply exceeded");
        require(
            tokenPrice * 1 == msg.value,
            "Slavs: no free stuff here, comrade"
        );
