...
contract Trade {
    ...
    function tradeAsset(address paymentAssetAddress, address assetOwner, address buyer, uint paymentAmt, BuyingAssetType buyingAssetType, address buyingAssetAddress, uint tokenId, uint8 buyingAssetQty,bytes calldata data) public returns(bool) {
        ...
        if(buyingAssetType == BuyingAssetType.ERC721)   {
            ...
            transferProxy.erc20safeTransferFrom(IERC20(paymentAssetAddress), buyer, assetOwner, paymentAmt);
        }
