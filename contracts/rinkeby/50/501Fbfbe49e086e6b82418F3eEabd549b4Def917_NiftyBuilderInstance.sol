...
contract NiftyBuilderInstance is ERC721, ERC721Burnable {
    ...
    constructor(
        ...
        address dateTimeContract_, 
        address niftyRegistryContract_) ERC721(defaultOwner_, niftyRegistryContract_) {
        _creator = "Six N. Five";
...
contract ERC721 is NiftyEntity, Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    constructor(address defaultOwner_, address niftyRegistryContract_) NiftyEntity(niftyRegistryContract_) {
        _id = 1;
        _typeCount = 1;
        _symbol = "SIXNFIVE";
        _name = "Eternal Wait";
