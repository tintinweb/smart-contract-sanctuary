...
contract TokenMarket is TokenMarketBase {
    ...
    */
    ...
    function fullLoanPaybackEarly(uint256 _loanId) internal {
        ...
        IERC20(loanOffersToken[_loanId].borrowStableCoin).transferFrom(loanOffersToken[_loanId].borrower, address(this), (loanOffersToken[_loanId].loanAmountInBorrowed.sub(loanOffersToken[_loanId].paybackAmount)));
