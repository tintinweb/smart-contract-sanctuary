...
//   - there are 6 traits with 171 values (including 3 traits of no scare, no Buttons, and no earring)
...
contract OnChainBots is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private fur1 = ["fd1","28F","324","3D4","ffc","81F","f89","F6F","049","901","fc5","creamishffe","cantuseheregreeish574","bcc","d04","q222","q889","ff0","qfd1"];
  string[] private fur2 = ["00f","000","000","000","000","000","000","000","000","000","060","000","96e","56e","799","d5d","d00","d9f","000"];
  ...
  string private tr4='"},{"trait_type": "Scare","value": "';
  ...
  constructor() ERC721("OnChainBots", "BOTS") Ownable() payable {
        _shareholders[0] = 0xAA821fC5CB1D3BB1c5B66e4823d9881FeD68f0cb; // Rob
        _shareholders[1] = 0xAA821fC5CB1D3BB1c5B66e4823d9881FeD68f0cb; // Treasure-Seeker
