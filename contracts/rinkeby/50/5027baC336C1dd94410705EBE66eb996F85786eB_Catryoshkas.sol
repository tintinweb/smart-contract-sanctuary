...
contract Catryoshkas is ERC721, ERC721Enumerable, Ownables {
    ...
    uint256 private _reserveSupply = 1;
    uint256 private _MAX_BIG_CATS = 100;
    uint256 private constant _MAX_RESERVE_SUPPLY = 250;
    uint256 private constant _MAX_MINT_SUPPLY = 8888;
    uint256 private constant _MINT_PRICE = 0.044 ether;
    uint256 private constant _SPECIAL_CATS = 600;
    ...
    function airdrop(uint256 startIndex_,  uint256 endIndex_, address to_) public onlyOwners {
    ...
    function breed(uint256 idCat1_ , uint256 idCat2_) public {
        ...
        _mintReserveTokens(_bigCats,_bigCats.add(1), _msgSender());
