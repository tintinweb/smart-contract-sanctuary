...
contract NiceToken1 is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "ipfs://";
	string private _contractURI = "contractURI";
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("Nice Token", "NICE") {
