...
contract Lottery is VRFConsumerBase, Ownable{
        ...
        VRFConsumerBase(_vrfCoordinator, _link)
    {
        ...
        lottery_state = LOTTERY_STATE.CLOSED; //Must be closed until an administrator opens it up
        fee = _fee;
        keyHash = _keyHash;
    }
    ...
    function endLottery() public onlyOwner {
        // //Below is a bad practice (insecure code) to generate pseudo random numbers
        // uint256(
        //     keccack256(
        //         abi.encodePacked(
