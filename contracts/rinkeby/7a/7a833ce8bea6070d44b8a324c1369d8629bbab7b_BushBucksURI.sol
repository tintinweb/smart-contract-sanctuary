...
interface IEcoz {/*ECOZ BUSH BUCK*/}
...
contract BushBucksURI is Ownable {
    ...
    function bushBuckTokenURI(uint256 buckID, uint256 buckWeight) external view virtual returns(string memory) {
        ...
        if (buckID <= 2250) {
            ...
            if (buckID == 1351) {
                thisTrait = Leg[0];
                metadataString = string(abi.encodePacked(metadataString,'{"trait_type":"','1/1','","value":"','Patronous''"},','{"trait_type":"','Generation','","value":"','Genesis''"},','{"trait_type":"','Thrive Production','","value":"','9''"}'));
                BGcolor = '4a5551';
            }

            else if (buckID == 1352) {
                thisTrait = Leg[1];
                metadataString = string(abi.encodePacked(metadataString,'{"trait_type":"','1/1','","value":"','Zombuck''"},','{"trait_type":"','Generation','","value":"','Genesis''"},','{"trait_type":"','Thrive Production','","value":"','9''"}'));
                BGcolor = '98e2bb';
            }

            else if (buckID == 1353) {
                thisTrait = Leg[2];
                metadataString = string(abi.encodePacked(metadataString,'{"trait_type":"','1/1','","value":"','Jimbo''"},','{"trait_type":"','Generation','","value":"','Genesis''"},','{"trait_type":"','Thrive Production','","value":"','9''"}'));
                BGcolor = '000000';
            }
            else {
