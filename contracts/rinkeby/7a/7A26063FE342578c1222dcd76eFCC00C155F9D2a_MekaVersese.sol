...
// File: contracts/MekaVersese.sol
...
contract MekaVersese is ERC721, Ownable {
    // public mint price
    ...
    // MekaVersese max items
    uint public maxItems = 8888;

    // MekaVersese max mint pass items
    uint public mintPassMaxItems = 500;

    // MekaVersese max mint pass items per anddress
    ...
    string public _baseTokenURI = "https://api.themekaverse.com/meka/";
    ...
    constructor() ERC721("MekaVersese", "MEKA") {}
