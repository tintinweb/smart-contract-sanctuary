...
contract OnChainMeta {
    ...
    function _buildName(uint256 _tokenId) internal view returns (string memory) {
      ...
      return string(abi.encodePacked("z", groupId.toString()));
    }
...
library NFTSVG {
  ...
  function _generateSVGDefs(SVGParams memory params) private pure returns (string memory svgDef) {
    svgDef = string(
      abi.encodePacked(
        '<svg version="1.1" width="1000" height="1000" viewBox="0 0 1000 1000"  stroke-linecap="round" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">',
        '<defs>',
        '<path id="r1" >',
