...
contract Omnid is ERC721, ChainlinkClient {
    ...
    function constructTokenURI(address _add, uint256 _tokenId) public view returns (string memory) {
        ...
        bytes memory image = abi.encodePacked(
            "<svg xmlns='http://www.w3.org/2000/svg' viewBox='8.2 4.24 69.87 106.69'>",
                "<circle cx='43' cy='40' r='35' fill='#d8d8d8'/>",
                "<text x='23.13' y='93.63' fill='#333' font-family='Arial,sans-serif' font-size='15'>",_add,"</text>",
                "<text x='23.55' y='107.7' fill='#333' font-family='Arial,sans-serif' font-size='15'>",score, " ",_tokenId,"</text>",
            "</svg>"
        );
    ...
    function createIdDev(address _for, uint256 score) external payable {

        uint256 newItemId = tokenCounter;
        addressToScore[_for] = score;
        _safeMint(_for, newItemId);
        tokenCounter += 1;

    }

    function createId(address _for) external payable {
