...
contract RealmTowerDefenseV1 {
  ...
  event UpgradeTower(
    ...
    uint256 levelAdded,
    uint256 totalTowersForKindRemoved,
    uint256 totalTowersForKindUpgraded,
  ...
  function getDefender(uint256 _realmId)
    external
    view
    returns (
      uint256,
    ...
    )
  {
    return (
      ...
      defenders[_realmId].buildableTowers,
      defenders[_realmId].totalTowers
    );
  }
  ...
  function buildTower(uint256 _realmId, uint256 _kind) external {
    ...
    require(defenders[_realmId].buildableTowers >= _cost, "You have no towers");
    ...
    defenders[_realmId].buildableTowers -= _cost;
    defenders[_realmId].totalTowers++;
  ...
  function startWave(uint256 _realmId, uint256 _useArmy) external {
    ...
    defenders[_realmId].army += (_level % 2);
    defenders[_realmId].buildableTowers += (_level % 2);
    defenders[_realmId].level++;
