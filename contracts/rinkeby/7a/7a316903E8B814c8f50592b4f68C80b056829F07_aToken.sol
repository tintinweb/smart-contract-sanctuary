...
contract aToken is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public mintFee;
    string public baseURI;

    constructor() ERC721("aToken", "ATO") {
        mintFee = 3000000000000000; // [wei] = 0.003 ether
        baseURI = "https://ato.ipfinder.de/";
        _mint(address(this), uint256(uint160(address(this))));
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes( _baseURI).length > 0 ? string(abi.encodePacked(_baseURI, tokenId.toHexString())) : "";
    }

    /**
     * @dev mint a token, everyone even a contract can mint his unique token
     * @dev tokenId is the senders address
     * @dev owner is the senders address
     *
     */
    ...
    function mint(address to) public payable {
        // this happens if address maybe becomes greater than 160bit in future
        require(msg.sender <= address(type(uint160).max), 'minters address greater than 160bit');
        require(msg.value >= mintFee, 'not enough ETH value');
    ...
    /**
     * @dev withdraw complete contract value to owner
     *
     */
    ...
    /**
     * @param amount [wei]  withdraw the given amount
     *
     */
    function withdraw(uint256 amount) public onlyOwner{
        (bool success, ) = payable(owner()).call{value: amount}("");
        require(success, "call value failed.");
    }
    ...
    /**
     * @param _mintFee the new mintFee [wei]
     */
    function setMintFee(uint256 _mintFee) public onlyOwner{
        mintFee = _mintFee;
    }

    function getCreatorsNick() public pure returns(string memory){
        return "homsch";
    }
}
