...
contract LazyMonster2 is Ownable, ERC721Enumerable, ERC721Pausable {
    using Strings for uint256;

    uint256 public constant TOTAL_MAX_QTY = 2000;
    uint256 public constant MAX_QTY_PER_TX = 10;
    uint256 public constant PRICE = 0.08 ether;

    string private _contractURI;
    string private _tokenBaseURI;

    constructor() ERC721("Lazy Monsters Space Club Season 2", "LAZY2") {
        _pause();
    }
    ...
    function mint(uint256 _mintQty) external payable {
        ...
        require(
            _mintQty <= MAX_QTY_PER_TX,
            "Exceed max quantity per transaction"
        );
