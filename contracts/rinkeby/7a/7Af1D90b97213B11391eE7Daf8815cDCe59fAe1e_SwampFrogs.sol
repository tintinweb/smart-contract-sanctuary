...
contract SwampFrogs is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  uint256 public constant PRESALE_ID = 10085;
  ...
  // Private mint
  function presaleMint(uint256 _tokenCount, uint256 _purchaseLimit, bytes memory _signature) external nonReentrant payable {
