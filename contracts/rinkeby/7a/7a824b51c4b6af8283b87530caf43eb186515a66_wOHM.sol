...
contract wOHM is ERC20 {
    ...
    function mint( address _address, uint _amount ) internal returns ( bool ) {
        _mint( _address, _amount );
        return true;
    }

    function burn( address _user, uint _amount) internal returns ( bool ) {
        _burn( _user, _amount );
        return true;
    }
    ...
    function unwrapToOHM( uint _amount ) external returns ( uint ) {
        ...
        IERC20( sOHM ).approve( staking, value );
