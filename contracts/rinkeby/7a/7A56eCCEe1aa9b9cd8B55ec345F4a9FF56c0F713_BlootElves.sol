...
contract BlootElves is ERC721, Ownable {
    ...
    function requestNewBloot(
        uint256 tokenId,
        bytes32 _tokenURI_part1,
        bytes32 _tokenURI_part2,
        bytes32 _tokenURI_part3
    ) public payable {
        ...
        string memory strTokenURI1 = bytes32ToStr(_tokenURI_part1);
        string memory strTokenURI2 = bytes32ToStr(_tokenURI_part2);
        string memory strTokenURI3 = bytes32ToStr(_tokenURI_part3);
        string memory strTokenURI = string(abi.encodePacked(strTokenURI1, strTokenURI2));
        strTokenURI = string(abi.encodePacked(strTokenURI, strTokenURI3));
        _setTokenURI(tokenId, strTokenURI);
    }
