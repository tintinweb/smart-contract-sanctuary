  ...
  function contractURI() public pure returns (string memory) {
    ...
    string memory contractmeta = base64(
      bytes(
        string(
          abi.encodePacked(
            '{"name": "Fortune Tigers 2022", "description": "A collection of 388 unique Fortune Tigers. Welcome the Year of the Tiger 2022 with your very own Fortune Tiger! Time to get Lucky with your very own fortune and lucky set of numbers!", "seller_fee_basis_points": 100, "fee_recipient": "0x0F0B154Aff44B2701874DEb88c48FD60DF49cf57"}'
          )
        )
      )
    );
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "Fortune Tiger #',
            tokenId.toString(),
            '", "description": "A collection of 388 unique Fortune Tigers. Welcome the Year of the Tiger 2022 with your very own Fortune Tiger! Time to get Lucky with your very own fortune and lucky set of numbers!", "image":"',
            output,
            '"}'
          )
        )
