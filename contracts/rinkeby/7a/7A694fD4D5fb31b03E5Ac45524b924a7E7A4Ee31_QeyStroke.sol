...
contract QeyStroke is ERC1155Burnable, Ownable, ReentrancyGuard, Pausable, PaymentSplitter {
    ...
    uint256[] private restParcel = [1,2,3,4];
    ...
    constructor(uint256 parcel1, uint256 parcel2, uint256 parcel3, uint256 parcel4, IRandom _rng) ERC1155(tokenURI) PaymentSplitter(_addresses, _shares) {
