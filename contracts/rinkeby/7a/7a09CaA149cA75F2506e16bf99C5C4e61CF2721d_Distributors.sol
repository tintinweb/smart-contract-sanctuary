    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint public _ownersCoverCount;
    
    bytes4 public constant IID_IERC165 = type(IDistributor).interfaceId;
    ...
    /// @notice Init the protocol with registry address
    ...
    function initialize(
        ...
        __ReentrancyGuard_init();
            registry = DistributorRegistry(_registry);
    }
    
    function getDistributorAddress(string memory _distributorName) public view returns(address){
        return registry.distributors(_distributorName);
    }
    
    /// @notice Gets the cover count owned by spec address
    ...
    function getCoversCount( string memory _distributorName, address _owner, bool _isActive) public view returns(uint256){
             IDistributor distributor = IDistributor(registry.distributors(_distributorName));
    ...
    /// @notice Gets all the covers for spec address
    ...
    /// @notice Gets single cover quote
    ...
    function getQuote(
        ...
        IDistributor.CoverQuote memory
         ...
         return distributor.getQuote( _interfaceCompliant1,
    ...
    function buyCover(
        ...
        IDistributor distributor = IDistributor(registry.distributors(_distributorName));
        distributor.buyCover(     _contractAddress,
                                  _coverAsset,
                                  _sumAssured,
                                  _coverPeriod,
                                  _coverType,
    ...
    /// @notice  Buy Insurace Covers in bulk
    /// @param  _distributorName string name of the protocol/distributor to buy from
...
contract DistributorRegistry is Initializable {
