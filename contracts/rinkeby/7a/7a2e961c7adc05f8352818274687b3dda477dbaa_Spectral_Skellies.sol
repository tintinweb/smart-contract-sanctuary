...
contract Spectral_Skellies is Ownable, ERC721 {
   ...
   function buy_presale() public payable{
        ...
        require(block.timestamp <=  presale_endtime,"Sale Ended.");
        require(pause_sale == false, "Sale is Paused.");
    ...
    function set_start_time(uint256 time) external onlyOwner{
     ...
     function set_presale_start_time(uint256 starttime, uint256 endtime) external onlyOwner{
        presale_starttime = starttime;
        presale_endtime = endtime;
    }
