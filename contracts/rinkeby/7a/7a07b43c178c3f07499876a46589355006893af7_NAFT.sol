...
contract ERC20Creator is ExchangeableToken, MintableToken {
...
contract BUSD is ExchangeableToken, MintableToken {
  constructor() ERC20Token("BUSD Token", "BUSD", 18, 1000000000000000) {}
}

contract LNCHX is ExchangeableToken, MintableToken {
  constructor() ERC20Token("LNCHX Token", "LNCHX", 18, 1000000000000000) {}
}

contract NAFT is ExchangeableToken, MintableToken {
  constructor() ERC20Token("NAFTER Token", "NAFT", 18, 1000000000000000) {}
}