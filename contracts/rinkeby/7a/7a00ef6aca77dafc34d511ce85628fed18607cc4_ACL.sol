...
contract MiniMeToken is Controlled {
    ...
    string public name = "AlexTRANS";                //The Token's name: e.g. DigixDAO Tokens
    uint8 public decimals = 0;             //Number of decimals of the smallest unit
    string public symbol = "RANS";              //An identifier: e.g. REP
    string public version = "RANS_0.1"; //An arbitrary versioning scheme
