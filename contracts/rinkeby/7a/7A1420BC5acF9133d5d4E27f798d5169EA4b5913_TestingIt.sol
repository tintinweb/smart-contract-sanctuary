...
contract TestingIt is 
    ...
    string uri;
    uint256 public testid=0; 
    
    constructor (string memory teststr,
    uint tid) ERC721 ("TestingIt", "TEST"){
        uri=teststr;
    ...
    function basesetup(string memory base) public onlyOwner {
        uri=base;
    }
