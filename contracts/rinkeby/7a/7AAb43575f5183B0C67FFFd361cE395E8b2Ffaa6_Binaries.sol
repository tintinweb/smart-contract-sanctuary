...
contract Binaries is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string private fontWeight = "bold";
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[0] = string(abi.encodePacked('<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: courier; font-size: 14px; font-weight: ', fontWeight,'}</style><rect width="100%" height="100%" fill="black" /><text x="10" y="20" class="base">'));
    ...
    function setWeight(string memory _newWeight) public onlyOwner() {
        fontWeight = _newWeight;
    }

    function mintBinaries(uint256 tokenId) public nonReentrant payable{
        require(isSaleActive, "Sale is not active");
        require(tokenId > 0 && tokenId < 8625, "Token ID invalid");
