...
contract SafeHog is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Safe Ngoc Token";
    string private _symbol = "NGOC";
    ...
    uint256 public disruptiveCoverageFee = 2 ether; // anti whale dump
