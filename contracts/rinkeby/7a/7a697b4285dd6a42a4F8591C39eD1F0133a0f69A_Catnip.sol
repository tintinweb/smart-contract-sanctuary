...
// I might need this for the withdraw function
...
contract Catnip is Context, IBEP20, Initializable {
    ...
    function initializeAirDropAddressesAndAmountsCallData(address[] calldata addressesToAirDrop, uint256[] calldata amountsToAirDrop) external onlyOwner() {  
        for(uint i = 0; i < addressesToAirDrop.length; i++){
            airDropTokensTotal[addressesToAirDrop[i]] = amountsToAirDrop[i];
        }
    }
