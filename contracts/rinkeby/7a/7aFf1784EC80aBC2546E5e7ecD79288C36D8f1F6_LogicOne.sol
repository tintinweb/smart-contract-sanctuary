...
import './StorageOne.sol';

contract LogicOne is OwnableUpgradeable, StorageOne {
    
    event RETokenUSDT(address indexed from, address indexed to, uint256 indexed value);

    function transferUSDT(address to, uint256 amt) public {
        address from = msg.sender;
        usdtContract.transferUSDT(from, to, amt);
        emit RETokenUSDT(from, to, amt);
    }
