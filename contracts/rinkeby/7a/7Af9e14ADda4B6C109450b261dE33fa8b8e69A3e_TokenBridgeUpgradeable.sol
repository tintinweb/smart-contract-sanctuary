...
import "./TokenFactory/ITokenFactoryERC721.sol";
import "./TokenFactory/ITokenFactoryERC1155.sol";
  ...
  ERC1155HolderUpgradeable
{
  ...
  function invalidateNonce(string memory nonce) public {
  ...
  function exportToken(bytes4 interfaceId, address tokenAddress, uint256 tokenId, uint256 amount, string memory nonce, uint256 expiration, bytes memory signature) public {
  ...
  function mintCollectibleToken(bytes4 interfaceId, address tokenAddress, uint256 tokenId, string memory nonce, uint256 expiration, bytes memory signature) public {
    uint256 amount = 1;
  ...
  function mintTokenFactory(bytes4 interfaceId, address tokenAddress, uint256 optionId, uint256 amount, string memory nonce, uint256 expiration, bytes memory signature) public {
  ...
  function verifySignature(bytes4 interfaceId, address tokenAddress, uint256 tokenId, uint256 amount, string memory nonce, uint256 expiration, string memory method, bytes memory signature) public returns (bool) {
  ...
  function hashToSign(bytes4 interfaceId, address tokenAddress, address to, uint256 tokenId, uint256 amount, string memory nonce, uint256 expiration, string memory method) public view returns (bytes32) {
  ...
  function ethSignedHash(bytes32 hash) public pure returns (bytes32) {
  ...
  function erc721TokenExists(address tokenAddress, uint256 tokenId) public view returns (bool) {
