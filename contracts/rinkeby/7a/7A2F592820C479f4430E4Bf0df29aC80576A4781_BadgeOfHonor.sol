...
//
// Project Website: https://walletbadge.io
//
...
contract BadgeOfHonor is ERC1155, Ownable {
    ...
    event AssholeAwarded(
        address indexed to,
        address indexed from,
        uint256 indexed qt
    );

    string private constant BADASS_URI =
        "https://arweave.net/tRe8Y2pTQzDis2Wp6Rmh0RUVQ0p5zhyJL3uocokFYRs";
    string private constant ASSHOLE_URI =
        "https://arweave.net/vLFz2LGEIIyNe-oWLawbvfhIE_EtDRSkDmrNM872I40";

    uint256 public fee;

    constructor(uint256 fee_) ERC1155("") {
        fee = fee_;
    }
