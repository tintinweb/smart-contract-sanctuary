...
contract Unc0vered is ERC721, Ownable {
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        wallet1 = 0x602211858d2Fa0110bC5841ECCA1E57567D9CC77;
        wallet2 = 0x1a7cB3c0b18d8F18A2f595f8475F2540F062c5a2;
        wallet3 = 0x0ded104A636CC6eE278bb06a5eb6Ba2B5bd8b391;
        wallet4 = 0xD5F7d2764c9B45F1F39c7B6C9a4eed76C03BE8B7;
    }
    ...
    function withdrawAll() external onlyOwner {
        ...
        uint256 balance1 = balance.mul(3).div(100);
        uint256 balance2 = balance.mul(15).div(1000);
        uint256 balance3 = balance.mul(2275).div(10000);
        uint256 balance4 = balance.mul(7275).div(10000);
