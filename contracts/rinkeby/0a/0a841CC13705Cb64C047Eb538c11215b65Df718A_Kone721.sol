...
contract Kone721 is ERC721, ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    uint256 public constant maxSupply = 10000;
    uint256 private _price = 20000000000000000; //0.02 eth
    uint256 private _promotionTokenNum = 5;
    
    bool private _saleStarted;
    bool private _promotion;
    string public baseURI;

    constructor() ERC721("Kone721", "Kone") {
        _saleStarted = false;
        _promotion = false;
    }
    ...
    function mint(uint256 _nbTokens) external payable whenSaleStarted {
        ...
        require((!_promotion && _nbTokens * _price <= msg.value) ||
            (_promotion && (_nbTokens - _nbTokens/_promotionTokenNum) * _price <= msg.value), 
    ...
    function setPromotion(bool _isActive) external onlyOwner{
        _promotion = _isActive;
    }
