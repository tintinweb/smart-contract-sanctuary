    ...
    ISipherNFT
{
    ...
    modifier onlyGenesisMinter() {
        require(
            ...
            "SipherERC721: caller is not genesis minter"
        );
        _;
    }
    ...
    modifier onlyForkMinter() {
        require(
            ...
            "SipherERC721: caller is not fork minter"
        );
        _;
    }
     ...
     */
    function mintGenesis(uint256 amount, address to)
        external
        override
        onlyGenesisMinter
    {
    ...
    function mintFork(uint256 tokenId) external override onlyForkMinter {
        ...
        require(
            ...
            "SipherERC721: not mint all genesis yet"
        );
