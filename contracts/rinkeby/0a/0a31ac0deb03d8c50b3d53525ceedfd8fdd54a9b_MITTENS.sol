...
contract MITTENS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MITTENS Token";
    ...
    constructor () {
        address payable FeeAddress=payable(address(0x79E551d8fF2eB3eC04e2d8B83c0714937cF00ECA));
        address payable marketingWalletAddress=payable(address(0x79E551d8fF2eB3eC04e2d8B83c0714937cF00ECA));
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(tradingOpen && maxBuy>0 && from != owner() && to != owner() && to!=uniswapV2Pair && to != address(uniswapV2Router))
