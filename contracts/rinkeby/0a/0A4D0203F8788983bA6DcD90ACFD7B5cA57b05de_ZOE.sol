...
contract ZOE is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable {
    function initialize(string memory name, string memory symbol,uint256 _supplyLibre,address _FoundersAddress,address _AirdropsAddress,address MainnetLoans,address Devteam,address listingfee) public virtual initializer {
