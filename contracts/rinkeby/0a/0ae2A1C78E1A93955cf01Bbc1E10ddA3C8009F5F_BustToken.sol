...
contract BustToken is ERC20, Ownable {
    ...
    function mint(address to, uint256 amount) public virtual returns (bool) {
        require((_msgSender() == _minter) || (_msgSender() == _extraMinter) || (_msgSender() == owner()), "ERROR: not minter");
        _mint(to, amount);
	    return true;
    }
}
...
contract ERC20 is Context, IERC20 {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        console.log("This is the amount %s",amount);
        
        uint256 currentAllowance = _allowances[sender][_msgSender()];
        console.log("This is the allowance %s",currentAllowance);
