...
contract BirdPass is ERC1155Burnable, ERC1155Supply, Ownable {
	...
	string public _contractURI = "https://to.wtf/contract_uri/bowerbird.json";
	...
	function whitelistBuy(bytes32[] memory _proof) external payable {
		...
		require(isPurchaseValid(msg.sender, 1, _proof), "invalid proof");
