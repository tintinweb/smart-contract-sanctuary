...
contract ExampleContract is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Example Token", "EXAMPLE", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure override returns (string memory) {
        return "https://example.com/app/token/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://example.com/app/contract-metadata";
    }
}