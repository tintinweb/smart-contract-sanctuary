...
contract SmartCat is ERC721, Ownable {

    uint public mintPrice = 0.0007 ether; // Mutable by owner
    uint public maxItems = 1000000;
    ...
    constructor() ERC721("SmartCat", "SCAT") {}
