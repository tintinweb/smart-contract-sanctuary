...
contract coolcowsrandomtest is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
      ...
      require( availableTokenCount() - _mintAmount >= 0, "YOU CAN'T MINT MORE THAN AVALABLE TOKEN COUNT"); 
    ...
    for (uint256 id = nextToken(); id <= _mintAmount; id++) {
      _safeMint(_to, currentSupply + id);
