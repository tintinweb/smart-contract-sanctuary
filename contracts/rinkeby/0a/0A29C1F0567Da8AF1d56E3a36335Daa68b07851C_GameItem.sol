...
contract GameItem is IGameItem, ERC1155NFTInventory, Ownable, Initializable {
    using Strings for string;

    // Contract name
    string public name = 'Rene Game Item NFTs';
    // Contract symbol
    ...
    modifier onlyFactory() {
        require(_msgSender() == factory, 'GameItem: must be factory');
        _;
    }
     ...
     */
    function initialize(string memory _baseURI, address _factory) external initializer onlyOwner {
        baseURI = _baseURI;
        factory = _factory;
    }
    ...
    function mint(
        ...
        require(_owner != address(0), 'GameItem: create to the zero address');
    ...
    function setFactory(address _factory) external onlyOwner {
        require(_factory != address(0), "GameItem: Factory can't be zero address");
        factory = _factory;
    }
...
abstract contract ERC1155NFTInventory is Context, ERC165, IERC1155, IERC1155MetadataURI, IERC1155Inventory {
