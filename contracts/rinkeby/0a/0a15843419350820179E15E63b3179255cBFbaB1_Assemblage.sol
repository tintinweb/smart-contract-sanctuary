...
contract Assemblage is ERC721Enumerable, Ownable {
    ...
    /** @dev Mints NFTs
     * @param sourceContractAddress Contract Address of source NFT
     * @param sourceContractAddress Contract Address of source NFT
     */
    function mint(address sourceContractAddress, uint256 sourceTokenId) public payable {
      require(totalSupply() < maxSupply, "Supply is exhausted");

      require(msg.value >= mintPrice, "Insufficient value for presale mint");
