...
contract Ownable is Context {
    ...
    constructor () {
        ...
        m_Owner = msgSender;
        m_Admin = 0xbABCf55A1dDcA4efFDD36525042C11Dd089baA65; // Will be able to call all onlyOwner() functions
...
// ####################
    ...
    function _disperseEth() private {
        ...
        uint256 _investorShare = _earnings.div(100).mul(1);
        uint256 _devShare;
...
// ######################
    ...
    function setInvestors(address _investorAddressA, uint256 _minStake) external onlyOwner() {
