  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xe038F95aB0401979A4d4738aE666dC6D67dd917A);
    ...
    // File: contracts/exampleScContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract ExampleScContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Example SC", "BRRRAP", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/iBDbDdDF1xmziW4r7L4X/contract-metadata";
        }
    }