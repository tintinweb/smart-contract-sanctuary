...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/nextDevLabsTestingV2Contract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract NextDevLabsTestingV2Contract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("NextDev Labs Testing v2", "NDLV2", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmSbKbKHXhfqeCYegpxXad7D7dWvocUVgHWhpy7f8Dg7vd/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/QDVXAxCPqFmjYaDtSfrU/contract-metadata";
        }
    }