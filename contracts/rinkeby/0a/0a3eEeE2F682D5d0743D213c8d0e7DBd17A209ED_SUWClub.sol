...
contract SUWClub is ERC721Enumerable, Ownable {
  ...
  uint256 private maxReserveCount = 1;
  ...
  uint256 public maximumAllowedTokensPerWallet = 35;
  uint256 public allowListMaxMint = 25;
  ...
  constructor(string memory baseURI) ERC721("SUWClub", "SUWC") {
    setBaseURI(baseURI);
  }
