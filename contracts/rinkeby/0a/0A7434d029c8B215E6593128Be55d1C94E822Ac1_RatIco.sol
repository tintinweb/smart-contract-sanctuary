...
contract Crowdsale is Context, Ownable, ReentrancyGuard, Listing {
    ...
    function setCurrentRate(uint256 value) public {
        _rate = value;
    }
    ...
    function buyTokens(address beneficiary)
        ...
        checkBlacklist(beneficiary) // This will check either investor is blacklisted or not (for bots)
        checkIcoTime
    {
