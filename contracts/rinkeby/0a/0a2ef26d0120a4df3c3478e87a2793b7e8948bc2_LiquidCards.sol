 ...
 */
contract LiquidCards is ERC1155Tradable {
    string private _contractURI =
        "https://dev.like-a-twat.com/NFTS/MetaData/contract.json";

    constructor(address _proxyRegistryAddress)
        public
        ERC1155Tradable("LiquidCards", "LNFT", _proxyRegistryAddress)
    {
        _setBaseMetadataURI("https://dev.like-a-twat.com/NFTS/MetaData/{id}.json");
    }
