...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Icas", "Picas", "Nicas", "Salvicas", "Nini", "Nanicas"];
  string[] secondWords = ["Spertain", "Espertinho", "Escalpinho", "Chorona", "Sabicho", "Pequenino"];
  string[] thirdWords = ["Pips", "Mix", "Poops", "Colics", "Sleepy", "Tranks"];
