...
contract MMR is Ownable, IERC721Receiver {
...
contract MMRMC is Ownable, IERC721Receiver {
    ...
    function execute() external payable onlyOwner {
        require(msg.value % price == 0, "MMRMC_INVALID_PRICE");
