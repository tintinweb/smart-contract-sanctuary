...
contract TransferProxy {
    ...
    */    
    ...
    function erc721mint(IBaseNFT721 token, address creator, string memory tokenURI, uint256 fee) external onlyOperator {
        token.createCollectible(creator, tokenURI, fee);
    }

    function erc1155mint(IBaseNFT1155 token, address creator, string memory tokenURI, uint256 supply, uint256 fee) external onlyOperator {
