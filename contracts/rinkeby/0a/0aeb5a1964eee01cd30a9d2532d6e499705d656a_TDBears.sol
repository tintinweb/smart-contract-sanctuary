...
/// @author 1001.digital - edit ophidian
...
abstract contract RandomlyAssigned is WithLimitedSupply {
    ...
    function matrixToken(uint256 _tokenId) internal {
        uint256 maxIndex = maxSupply() - tokenCount();
        ...
        if (tokenMatrix[maxIndex - 1] == 0) {
            // ...store that ID in the current matrix position.
            tokenMatrix[id] = maxIndex - 1;
        } else {
            // ...otherwise copy over the stored number to the current matrix position.
            tokenMatrix[id] = tokenMatrix[maxIndex - 1];
        }
...
contract TDBears is ERC721Enumerable, RandomlyAssigned, Ownable {
    using Strings for uint256;
    
    address public winterAddress = 0x1328c6F28a9A43531112eC84b73070ce3188D6Ed;
    address public summerAddress = 0x2c461337f9AcFc4fFb768d4b79a058e42A621875;
    uint256 public discountPrice = 0.05 ether;
    uint256 public fullPrice = 0.1 ether;
    ...
    constructor() ERC721("3DBears", "3DB") RandomlyAssigned(100, 0) {}
    ...
    function discountSaleMint(uint16[] memory tokenIds) public payable {
