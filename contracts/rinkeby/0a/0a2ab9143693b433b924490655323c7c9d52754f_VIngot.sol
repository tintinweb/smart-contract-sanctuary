...
contract VIngot is ERC20Permit, Ownable {
    ...
    constructor() ERC20("V-Ingot", "INGOT", 9) ERC20Permit() {
    ...
    /**
        @notice increases Vingot supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Vingot
