...
contract Cybernetics is ERC721, ERC721Enumerable, Verify, ReentrancyGuard{
    ...
    //address internal punkAddress = 0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB; //mainnet
    address internal punkAddress = 0x424f62Dd208074FbD4BfBE4B99844638F306bEA1;
    uint256 public punkMintsRemaining = 250;
    uint256 public giveawaysRemaining = 200;
    uint256 public mintAtOnceAmt = 20;
    uint256 randomMintMod = 5; // 1/5 chance
    ...
    function _mintCybernetic(address _to) internal {
        ...
        randomSeeds[totalSupply()] = uint(keccak256(abi.encodePacked(totalSupply(), block.number)));
