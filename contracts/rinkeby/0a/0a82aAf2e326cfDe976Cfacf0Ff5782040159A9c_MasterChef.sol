...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accRewardPerShare; // Accumulated rewardTokens per share, times 1e12. See below.
    }
    ...
    constructor(
        ...
        rewardReservoir = _rewardReservoir;  // Set token reservoir.
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.accRewardPerShare = pool.accRewardPerShare + (tokenReward * 1e12 / lpSupply);
        pool.lastRewardBlock = block.number;
    }
    ...
    function withdrawAlien(IERC20 _token, uint256 _amount) external onlyOwner {
