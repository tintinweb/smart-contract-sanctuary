...
Token: $BuzzLY
Website: https://buzzlightyear.link
...
contract BuzzLY is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "BuzzLightYear";
    string private _symbol = "BuzzLY";
    ...
    address payable public marketingWallet = payable(0x16390CeECDe55195b31d9a37874384Ed9cBAB1A0);
