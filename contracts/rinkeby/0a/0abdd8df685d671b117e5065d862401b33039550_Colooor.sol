...
contract Colooor is ERC721, ERC721Enumerable, Ownable {
  
  // Provenance
  string public COLOOOR_HASH = "";
  ...
  constructor(string memory baseURI) ERC721("Colooor", "COOL") {
    setBaseURI(baseURI);
  }
  ...
  function withdraw() public onlyOwner {
    ...
    require(payable(member2).send(address(this).balance /100*51));
