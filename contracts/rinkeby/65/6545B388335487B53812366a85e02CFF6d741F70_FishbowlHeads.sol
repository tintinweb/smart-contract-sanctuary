...
contract FishbowlHeads is ERC721Enumerable, Ownable {
    ...
    uint256   public _mintPrice                 = 0.0369 ether;           //42000000000000000 wei
    uint256   public _discMintPrice             = 0.03 ether;           //36900000000000000 wei
    ...
    IRNG      public _iRnd                      = IRNG(0xCC18F03419e0b5F242286358D40570418fE1D661);
    ...
    event ReturnState(bytes data, bool status);

    constructor(address signer, address multiSig) ERC721("Fishbowl Heads", "FBH") {
      _signer = signer;
      _multiSig = multiSig;
    }
