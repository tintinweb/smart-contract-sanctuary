    ...
    Ownable
{
    ...
    uint256 public NFT_price = 0.024 ether; 
    uint256 public NFT_price_for_3 = 0.055 ether; 
    ...
    function claimFree() external {
        require(balanceOf(_msgSender()) == 0, "You have already Claimed Your Free Darkseid.");
  ...
  function withdraw() external onlyOwner {
        ...
        returns (string memory)
    {
        ...
        if(block.timestamp < reveal_time){
            return "https://dontlooktooclose.com";
        }
        return
