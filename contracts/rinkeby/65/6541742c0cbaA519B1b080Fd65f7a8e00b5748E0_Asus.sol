...
contract Asus is ERC721, Ownable {
    ...
    string BASE_URI = "ipfs://QmWc8kbUAQ1itYZ5r6KM45vJ4VYH8TVuEUC9DLQjX6tZ7X/";
    
    bool public IS_PRESALE_ACTIVE = false;
    bool public IS_SALE_ACTIVE = false;
    
    uint constant TOTAL_SUPPLY = 200;
    ...
    address FOUNDER_1 = 0xe6B8312aC2731d1F606f4d6686aA60Fa0EAffEaf;
    
    bytes32 merkleroott = 0x5532501f7f99358bf4ae4df09971c0003b7ba7d5c80a7ab320478ab97320bcdd;
    address eproxyRegistryAddress = 0xf3ED573C2D326EFA84AB33f0c5b80A33a93d0f40;

    constructor() 
    ERC721("Asus", "ROG")
    {
        root = merkleroott;
        proxyRegistryAddress = eproxyRegistryAddress;
