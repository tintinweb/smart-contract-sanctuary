...
contract SuperCoof1155 is Super1155 {
  using SafeMath for uint256;
  using Address for address;

  constructor(address _owner, string memory _name, string memory _uri, address _proxyRegistryAddress) Super1155( _owner, _name, _uri, _proxyRegistryAddress ) {
