...
contract Monkey2 is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" width="350" height="350" viewBox="0 0 350 350"><rect x="0" y="0" width="500" height="500" style="fill:#',
...
string private svgimg='<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="black" /><text x="10" y="20" class="base">"Grim Shout" Grave Wand of Skill +1</text><text x="10" y="40" class="base">Hard Leather Armor</text><text x="10" y="60" class="base">Divine Hood</text><text x="10" y="80" class="base">Hard Leather Belt</text><text x="10" y="100" class="base">"Death Root" Ornate Greaves of Skill</text><text x="10" y="120" class="base">Studded Leather Gloves</text><text x="10" y="140" class="base">Necklace of Enlightenment</text><text x="10" y="160" class="base">Gold Ring</text></svg>';

//'<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" width="350" height="350" viewBox="0 0 350 350"><rect x="0" y="0" width="500" height="500" style="fill:#f00"/><rect width="300" height="120" x="99" y="400" style="fill:#f00"/><circle cx="190" cy="40" r="5" style="fill:#f00"/><circle cx="310" cy="40" r="5" style="fill:#f00"/><circle cx="100" cy="250" r="50" style="fill:#f00"/><circle cx="100" cy="20" r="20" style="fill:#f00"/><circle cx="400" cy="250" r="5" style="fill:#f00"/><circle cx="400" cy="250" r="2" style="fill:#f00"/><circle cx="250" cy="250" r="10" style="fill:#f00"/><circle cx="25" cy="250" r="10" style="fill:#f00"/><circle cx="200" cy="215" r="3" style="fill:#fff"/><circle cx="35" cy="2" r="1" style="fill:#fff"/><circle cx="200" cy="220" r="20" style="fill:#f0f"/><circle cx="300" cy="20" r="20" style="fill:#f0f"/><circle cx="20" cy="220" r="7" style="fill:#000"/><circle cx="300" cy="20" r="7" style="fill:#000"/><rect x="150" y="190" width="20" height="30" style="fill:#f00"/><rect x="160" y="170" width="10" height="50" style="fill:#f00"/><rect x="160" y="190" width="75" height="15" style="fill:#f00"/><rect x="275" y="190" width="5" height="15" style="fill:#f00"/><rect x="160" y="235" width="18" height="50" style="fill:#f00"/><ellipse cx="250" cy="315" rx="84" ry="34" style="fill:#f00"/><rect x="195" y="330" width="110" height="3" style="fill:#000"/><circle cx="268" cy="295" r="5" style="fill:#000"/><circle cx="232" cy="295" r="5" style="fill:#000"/><circle cx="100" cy="290" r="14" style="fill:#999"/><circle cx="100" cy="29" r="4" style="fill:#000"/><rect width="200" height="99" x="150" y="40" style="fill:#00f"/><rect width="200" height="33" x="150" y="16" style="fill:#00f"/><rect width="300" height="120" x="99" y="40" style="fill:#00f"/><rect width="50" height="55" x="20" y="430" style="fill:#00f"/></svg>';
