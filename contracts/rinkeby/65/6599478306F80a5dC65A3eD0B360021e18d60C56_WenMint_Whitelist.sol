...
/**
 * @title WenMint_Whitelist Token
 * WenMint_Whitelist - a contract for WenMint_Whitelist
 */

contract WenMint_Whitelist is Ownable, ChainlinkClient {
    ...
    constructor() {
      ...
      oracle = 0xb220D022EF8655Cb4AafA193db2BbEEf9064B1d0;
      jobId = "963aed2169e243ec9abcb1aea941a8b4";
      fee = 0.1 * 10 ** 18;
    }

    // only allow this to be called from approved collections

    function isAddressWhitelisted(uint256 _collection, address _address) public returns (bytes32 requestId) {

        Chainlink.Request memory request = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);
        request.add("get", string(abi.encodePacked("https://699f-47-186-100-248.ngrok.io//whitelisted?address=", _address, "&collection=", _collection)));
