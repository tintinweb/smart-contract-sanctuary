...
contract TRVBPToken is ERC1155Supply, Ownable {
  // constants
  address payable private ownerA = payable(0x9Ef48B9aCDC8644c2551c9a6964567737886e288);
  address payable private ownerB = payable(0x5F06CE9F9aB1be5FE3b5B84359FaC47ab75b43A3);
  address payable private ownerC = payable(0x5390484a263eC7b04B65B37d8e274c36a1E39a4f);
  address payable private ownerD = payable(0xb169C7e6D5D67384394348653a5fb5F36c56Ba4f);
  ...
  uint16 public constant MAX_SUPPLY_TEAM = 25;
  ...
  // variables
  string public baseURI = 'ipfs://QmT3fZWFnMUBHpuEFVTQQ6dtzc5ackknomM3peMahYNEzU';
  ...
  // verified
  function teamClaim() external onlyOwner { // should be run first (ex: after deploy or claim)
    require(!teamClaimed, "Team Claim: Already claimed.");

    _mint(msg.sender, TOKEN_ID, MAX_SUPPLY_TEAM, '');
    teamClaimed = true;
  }
  ...
  function withdraw() public onlyOwner {
    ...
    uint balanceA = (balance * 275) / 1000;
    uint balanceB = (balance * 175) / 1000;
    uint balanceC = (balance * 50) / 1000;
