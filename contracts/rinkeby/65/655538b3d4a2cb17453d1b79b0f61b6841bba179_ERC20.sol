...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    //make a function to change these 
    ...
    function battleFA(uint16 _fromId, uint16 _toId) external {
        ...
        {
            nftBattleEndTime[_fromId] = block.timestamp.add(86400);
        ...
        if (IFA(_nftAddress).battlePoints(_fromId) >= IFA(_nftAddress).battlePoints(_toId)) {
            ...
            totalTokensWon[_toId] = (totalTokensWon[_fromId].add(LOSE_REWARD));
        } else {
            ...
            totalTokensWon[_toId] = (totalTokensWon[_fromId].add(WIN_REWARD));
        }
    } 
