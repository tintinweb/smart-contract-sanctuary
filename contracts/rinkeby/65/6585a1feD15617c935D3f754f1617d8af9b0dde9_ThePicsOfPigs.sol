...
contract ThePicsOfPigs is ERC721A, Ownable {
    ...
    function mint(uint amount, bytes calldata signature) public payable {
    ...
    function withdraw(uint toOwner) external onlyOwner {
        ...
        payable(0x993F42634C113E478244452a453505a26fbB121b).transfer(balance * 7 / 100 + toOwner);
