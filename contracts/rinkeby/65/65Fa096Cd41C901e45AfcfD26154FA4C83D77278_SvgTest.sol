		...
		return
			string(
				abi.encodePacked(
					...
					'   <style>     rect {      fill: green;       animation: test 5s infinite;      }          @keyframes test {  to {    fill: red;  }}  </style>  <g>     <rect width="48" height="4" x="1" y="23" transform="rotate(90 25 24)"/>    <rect width="48" height="4" y="21" />  </g>',
					'</svg>'
				)
			);
	}
