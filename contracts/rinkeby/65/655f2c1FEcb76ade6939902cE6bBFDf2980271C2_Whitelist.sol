...
contract Whitelist is ERC721Enumerable, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/188/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/188/contract-uri";
	...
	uint256 public pricePerToken = 420000000000000000;

    // presale settings
    address private signerAddress;
	uint256 public presaleMaxSupply = 5;
	uint256 public presaleMaxPerMint = 2;
	uint256 public presalePricePerToken = 240000000000000000;
  uint256 public presaleEndDate = 1639498800000;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("Whitelist", "TST") {
    ...
    function presaleMint(bytes32 hash, bytes memory sig, uint256 qty) external payable {
