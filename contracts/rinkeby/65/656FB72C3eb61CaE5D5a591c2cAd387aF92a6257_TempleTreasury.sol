...
// File contracts/TempleERC20Token.sol
...
// File contracts/ITreasuryAllocation.sol
...
// File contracts/MintAllowance.sol
...
// File contracts/TempleTreasury.sol
...
contract TempleTreasury is Ownable {
  ...
  function harvest(uint256 distributionPercent) external onlyOwner {
    ...
    uint256 impliedSupplyAtCurrentIVTemple = (reserveStablec * intrinsicValueRatio.temple) /
      intrinsicValueRatio.stablec;
