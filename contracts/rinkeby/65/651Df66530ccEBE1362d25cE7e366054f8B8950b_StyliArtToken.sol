...
contract StyliArtToken is Context, IBEP20, Ownable {
    ...
    uint256 public maxSendAmount = _totalSupply.div(10000); // Amount of coins that can be sent per user before the unlockTime
    mapping(address => uint256) private transfers;
    ...
    constructor() {
        ...
        minter = msg.sender;
        unlockTime = block.timestamp + 15 days;
