...
contract SKYWALKERZ_NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxNumberPurchased = 2030;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        ...
        require(nftsBought + _mintAmount <= maxNumberPurchased, "max number of purchased NFTs exceeded");
        nftsBought = nftsBought + _mintAmount;
    }
  ...
  function setMaxNumberPurchasable(uint256 _newMaxNumberPurchasable) public onlyOwner() {
    maxNumberPurchased = _newMaxNumberPurchasable;
  }
