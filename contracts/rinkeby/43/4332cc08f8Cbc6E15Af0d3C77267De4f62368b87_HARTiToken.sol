...
contract HARTiToken is ERC721Mintable, ERC721Permit("HARTi:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("HARTi:Token", "HRT") {
        setDefaultURI("https://metadata.nft-harti/hrt/");
    }
