...
// File @openzeppelin/contracts/utils/introspection/E[email protected]
...
contract HungDaddies is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 private _maxMint = 10;
    uint256 private _price = 11 * 10**15; //0.011 ETH;
    bool public _paused = true;
    uint public constant MAX_ENTRIES = 420;

    constructor() ERC721("Hung Daddies", "HD")  {
    }
