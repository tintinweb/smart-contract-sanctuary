...
//     function pause() onlyOwner whenNotPaused public virtual{
//       paused = true;
//       emit Pause();
//     }
...
contract Crowdsale is Ownable { 
  ...
  uint256 public publicSaleTokensPerETH = 3200;
...
mapping (uint256 => tokenInfo) public tokenBook;
  ...
  address public delegateContract = address(0xd65C1EDAdD194bfDca9fC2bBfB85e3692007526d);
  ...
  bool public Paused;
    ...
    */
    ...
    delegate.transferFrom(owner(), tokenBook[i].beneficiary, tokenBook[i].tokens);
