...
contract BconContract {
    ...
    */
    ...
    event ContractInitialized(
        ...
        address defaultReportHandler,
        address defaultConfirmationHandler,
        address defaultPaymentHandler,
        address configurationHandler,
        SharedStates.BconContractState status
    );
    ...
    event RectificationWorkReported(
        string billingUnitItemId,
        string reportId, 
        address indexed sender,
        SharedStates.MessageType indexed reportType,
    ...
    event RectificationWorkRejected(
        string billingUnitItemId,
        string reportId, 
        address indexed sender,
        SharedStates.MessageType indexed reportType,
    ...
    event RectificationWorkConfirmed(
        string billingUnitItemId,
        string reportId, 
        address indexed sender,
        SharedStates.MessageType indexed reportType,
    ...
    */
    ...
    function initContract(
        ...
        billingUnits = BillingUnitFactory(billingUnitFactory)
            .createBillingUnitContract(_client, _contractor, address(this));

        reportConfig = IConfigurationHandler(configurationHandler)
    ...
    */
        ...
        external
    {
        ...
        console.log(
            ...
            address(this),
            billingUnits,
            reportConfig.confirmationHandler
        );
        console.logBytes(msg.data);
    ...
    */
    ...
    function throwBillingUnitItemCompleted(string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, uint256 completionQuantity, uint256 completionPrice, uint256 completionRate, string[] memory fileIds) public {
        ...
        emit BillingUnitItemCompletionClaimed(reportId, sender,reportType,timestamp,completionQuantity,completionPrice,completionRate,fileIds);
    }
    ...
    function throwBillingUnitItemConfirmed(
        ...
        require(
            msg.sender == defaultConfirmationHandler ||
                msg.sender == billingUnits,
            "sender must be confirmation Handler"
        );
        emit BillingUnitItemConfirmed(
            reportId,
            sender,
            reportType,
            timestamp,
    ...
    function throwBillingUnitItemConfirmedWithIssueReductionAmount(string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, uint256 issueReductionAmount, string[] memory fileIds) public {
        require(msg.sender == defaultConfirmationHandler || msg.sender == billingUnits,"sender must be confirmation Handler");
        emit BillingUnitItemConfirmedWithIssueReduction(reportId, sender,reportType,timestamp,issueReductionAmount,fileIds);
    }
    ...
    function throwBillingUnitItemPaymentTriggered(
        string memory reportId,
        string memory billingUnitItemId,
        address sender,
        SharedStates.MessageType reportType,
        uint256 timestamp,
        uint256 paymentTriggerTimestamp,
    ...
    function throwRectificationWorkReported(string memory billingUnitItemId,string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, string[] memory fileIds) public {
        require(msg.sender == defaultConfirmationHandler || msg.sender == billingUnits,"sender must be confirmation Handler");
        emit RectificationWorkReported(billingUnitItemId, reportId, sender,reportType,timestamp,fileIds);
    }
    function throwRectificationWorkRejected(string memory billingUnitItemId,string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, string[] memory fileIds) public {
        require(msg.sender == defaultConfirmationHandler || msg.sender == billingUnits,"sender must be confirmation Handler");
        emit RectificationWorkRejected(billingUnitItemId,reportId, sender,reportType,timestamp,fileIds);
    }
    function throwRectificationWorkConfirmed(string memory billingUnitItemId, string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, string[] memory fileIds) public {
        require(msg.sender == defaultConfirmationHandler || msg.sender == billingUnits,"sender must be confirmation Handler");
        emit RectificationWorkConfirmed(billingUnitItemId,reportId, sender,reportType,timestamp,fileIds);
    }
...
abstract contract IBconContract {
    ...
    function throwBillingUnitItemConfirmedWithIssueReductionAmount(string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, uint256 issueReductionAmount, string[] memory fileIds) virtual public;
    ...
    function throwRectificationWorkReported(string memory billingUnitItemId,string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, string[] memory fileIds) public virtual;
    function throwRectificationWorkRejected(string memory billingUnitItemId,string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, string[] memory fileIds) public virtual;
    function throwRectificationWorkConfirmed(string memory billingUnitItemId,string memory reportId, address sender, SharedStates.MessageType reportType, uint256 timestamp, string[] memory fileIds) public virtual;
}
