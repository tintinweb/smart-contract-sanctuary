...
contract tst197 is ERC721Enumerable, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/197/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/197/contract-uri";
	...
	uint256 public pricePerToken = 987000000000000000;

    // presale settings
    address private signerAddress;
	uint256 public presaleMaxSupply = 4;
	uint256 public presaleMaxPerMint = 4;
	uint256 public presalePricePerToken = 560000000000000000;
  uint256 public presaleEndDate = 1639742668;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("tst197", "TST") {
