...
contract Test is ERC721Enumerable, Ownable {
    // Make sure works on opensea, Etherscan, make sure minting works, WL for frens
        ...
        payable
    {
        ...
        require(_mintAmount > 0, "Cannot mint specified number of NFTs.");
    ...
    function setWhilelistClaimed(address _owner, bool _state) public onlyOwner {
        whitelistClaimed[_owner] = _state;
    }
