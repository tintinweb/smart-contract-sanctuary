...
contract PixlBrosFactory is FactoryERC721, Ownable {
    ...
    /*
     * Three different options for minting (basic, premium, and gold).
     */
    uint256 NUM_OPTIONS = 2;

    uint256 SINGLE_OPTION = 0;
    uint256 MULTIPLE_OPTION = 1;
    uint256 NUM_IN_MULTIPLE_OPTION = 10;
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        if (_optionId == SINGLE_OPTION) {
            ...
            for (uint256 i = 0; i < NUM_IN_MULTIPLE_OPTION; i++) {
                nft.mintTo(_toAddress);
            }
        }
    }
