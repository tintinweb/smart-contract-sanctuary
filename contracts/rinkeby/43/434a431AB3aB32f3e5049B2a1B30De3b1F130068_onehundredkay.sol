...
contract onehundredkay is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("100kTest", "100KT") {
  }
  ...
  function mintNTokens(address to, uint amount) external {
    require(_tokenIds.current() + amount <= MAX_NFT_SUPPLY , "Desired amount of Tokens exceeds the publicly available number of tokens.");
