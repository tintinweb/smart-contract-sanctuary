...
contract Minttester is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address[2] public fundRecipients = [
    0xAF531951987d274c08d5c38e70c2B0218b568C05,
    0x86957A33757c12525f56130Ad408cFdEFFC29e83
  ];
  uint256[] public receivePercentagePt = [5000, 5000];   //distribution in basis points
  ...
  function mint(address _to, uint _id) external onlyOwner {
    _mint(_to, _id);
  }
