...
contract PerilousPetz is ERC721Enumerable, Ownable {
  ...
  function withdraw() external onlyAuthorized {
    ...
    (bool hs, ) = payable(GSDAddress1).call{value: balance * 25 / 100}("");

    (bool hs2, ) = payable(GSDAddress2).call{value: balance * 25 / 100}("");

    (bool hs3, ) = payable(GSDAddress3).call{value: balance * 25 / 100}("");
