...
contract LAMO_Aftermath is ExPopulusERC721WithSingleMetadataIPFS {
  constructor()
    ExPopulusERC721WithSingleMetadataIPFS(
        "Aftermath",
        "LAMO",
        "ipfs://",
        "QmeSGTyKRXdvVBXpduqhp39fXVkxbvn5c2xqghYwCjHeyB",
        "https://ipfs.io/ipfs/",
        "QmcccparZ4LUqNw578BvvC8oLA2TMygYAHih6j33fK5hog",
        1111,
        50000000000000000,
        100,
...
contract ExPopulusERC721WithSingleMetadataIPFS is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    */
    ...
    function setRaribleBeneficiary(address payable newBeneficiary) public onlyOwner {
        ...
        address payable _oldRaribleBeneficiary = _beneficiary;
