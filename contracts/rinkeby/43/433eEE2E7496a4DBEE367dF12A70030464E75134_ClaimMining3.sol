...
contract ClaimMining3 is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(address _mining_token, uint256 _mining_start_block) public {
        ...
        phase1TokenPerBlock = 61 * 1e16; // 0.61 Claim per block
    }
    ...
    function getMultiplier(uint256 _from, uint256 _to) public view returns (uint256) {
        ...
        if (phase1StartBlockNumber < _from  &&  _from < phase1EndBlockNumber && phase1EndBlockNumber <  _to) {
