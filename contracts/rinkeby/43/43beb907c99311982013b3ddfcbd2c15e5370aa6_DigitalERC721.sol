...
contract DigitalERC721 is Ownable{
    ...
    constructor (string memory name_, string memory symbol_, address exc) public{
    ...
    function exchange() internal returns (address exc) {
        return _exc;
    }
    ...
    function _approve(address to, uint256 tokenId) public  {
        require(exchange() == msg.sender, "Your are Not Eligible to access");
...
contract NFTMint is DigitalERC721{
    ...
    constructor(
        ...
        address exc
    ) DigitalERC721(name, symbol, exc) public{
