...
contract Lottery is Ownable, VRFConsumerBase{
    ...
    function endLottery() public onlyOwner {
        //uint256(keccack256(abi.encodePacked(nonce,msg.sender,block.difficulty,block.timestamp))) % players.length; Pseudo random
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override{
        require (lottery_state == LOTTERY_STATE.CALCULATING_WINNER, "You arnn't there yet!");
