...
contract FundMe {
    ...
    // 'payable' keyword is used for pay with ETH/Ethereum
    ...
    function getConversionRate(uint256 ethAmount)
        ...
        returns (uint256)
    {
        uint256 getEth = getPrice();
        uint256 ethAmountInUSD = (getEth * ethAmount) / 1000000000000000000;
        return ethAmountInUSD;
    }

    // Modifier is used to change the behvior of a function in declarative way
    modifier onlyOwner {
