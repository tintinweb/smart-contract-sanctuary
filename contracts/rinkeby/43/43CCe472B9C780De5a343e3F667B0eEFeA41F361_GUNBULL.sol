    ...
    ERC721Burnable
{
    ...
    uint public LimitWhiteList; // 白名单已铸造的数量 不用管这是固定的99个
    uint public totalSell;

    uint private SoldAmount;
    uint public UnsoldAmount;
    ...
    constructor(
        ...
        StartTimestamp = block.timestamp + 3600 * 3;
        //StartTimestamp = 1638158400; // 2021-11-29 12:00:00
        EndTimestamp = StartTimestamp + 3600 * 4;// 4 days; // 2021-11-29 12:00:00
        Price = 8 * 1e16;
        LimitEarlyBird = 113;
        Admin = msg.sender;
    ...
    // WhiteList Mint
    function WhiteListMint() public payable LimitValue SoldStatus {
    ...
    // Private Mint
    function EarlyBirdMint() public SoldStatus {
        require(block.timestamp >= StartTimestamp, "NOT START");
    ...
    function mint() public payable SoldStatus LimitTotalAmount LimitValue {
        require(block.timestamp > EndTimestamp , "Waiting for the private placement to end");
...
contract GUNBULL is ERC721PresetMinterPauserAutoId {

    bool public UpgradeIPFS;

    constructor()
    ERC721PresetMinterPauserAutoId("GUNBULL", "GUNBULL", "https://gunbull.org/metadata/json/") 
    {}
