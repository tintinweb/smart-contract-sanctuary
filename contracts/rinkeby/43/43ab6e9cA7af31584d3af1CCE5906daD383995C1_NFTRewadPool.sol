...
contract NFTRewadPool is Context, Ownable {
    ...
    event Stake(address indexed userAddress, uint256 tokenId, uint256 time);
    event UnStake(address indexed userAddress, uint256 tokenId, uint256 time);
    event RewardClaim(address indexed userAddress, uint256 amount, uint256 time);
    event ReinvestReward(address indexed userAddress, uint256 amount, uint256 time);
    ...
    /**
    * @dev add recieve eth in balance variable
    */
    ...
    /**
    * @dev stake NFT to contract and give rewards
    *
    * Requirements:
    * 
    * caller must own the token and approve the contract to transfer token
    * `_tokenId` must exist
    * 
    */
    ...
    /**
    * @dev Claim Reward earn by staking NFT 
    * 
    * Requirements: 
    * 
    * caller must stake their NFT to the contract 
    * caller must take enough reward to claim
    */
    function claimReward() public {
        ...
        emit RewardClaim(_msgSender(), rewardAmount, block.timestamp);
    }
    
    /**
    * @dev to UnStake the NFT from contract and claim leftover reward 
    * 
    * Requirements: 
    * 
    * caller must stake their NFT to the contract
    */
    ...
    function unStake() public{
        require(isStaked[_msgSender()],"ERROR: you haven't stake");
         if(claimAmount[_msgSender()] > 0) claimReward();
        uint256 tokenId = stakedNft[_msgSender()];
        
        accessToken.transferFrom(address(this), _msgSender(), tokenId);
    ...
    /**
    * @dev to reinvest the claim Reward in GS50 token contract 
    * 
    * Requirements: 
    * 
    * caller must have enought reward to reinves GS50 contract
    */
    function reinvestInGs50() public {
        ...
        emit ReinvestReward(_msgSender(), rewardAmount, block.timestamp);
    }
    
    /**
    * @dev returns the ethereum in the contract
    */
    ...
    /**
    * @dev to calculate how much reward should be given to the user
    * 
    * Requirements:
    * 
    * caller must be the `owner` of the contract
    * contract must have receive at least 1 ETH from other contract
    * contract should have more than one 1 NFT staked in contract
    */
    ...
    /**
    * @dev to remove the array index and readjust the length of the array
    */
