...
contract NFT9021 is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  address coOwner1 = 0x6Ce7D6Ff15E46230F7a214D3D879BF295e8242E7;
  address coOwner2 = 0xD0491489DbAAF9Ab5C7B79d87250F27bF45FCCe3;
  ...
  function freeRollMint() public nonReentrant() {
    require(freeRoll9021s[msg.sender] > 0, "You don't have any free rolls!");
  ...
  function giveFreeRoll(address receiver, uint256 numRolls) public onlyOwner {
    ...
    require(freeRoll9021s[receiver] + numRolls < 21, "Cannot exceed 20 unused free rolls!");
  ...
  function setContractURI(string memory _contractURI) external onlyOwner {
    ...
    uint256 _coOwner1 = _balance / 100 * 6;
    uint256 _coOwner2 = _balance - _coOwner1;
    require(payable(coOwner1).send(_coOwner1));
    require(payable(coOwner2).send(_coOwner2));
  }


  function withdrawSplit(address otherAddy) public onlyOwner {
    uint256 _balance = address(this).balance;
  
    (bool sent1, ) = msg.sender.call{value: _balance / 2}("");
    require(sent1, "Failed to send Ether");

    (bool sent2, ) = otherAddy.call{value: _balance / 2}("");
