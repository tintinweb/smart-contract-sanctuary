...
contract PunkNFT is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    using SafeMath for uint256;

    string public IPUNK_PROVENANCE = "";
    ...
    uint256 constant public maxTokenPurchasePresale = 10;
    ...
    constructor() public ERC721("PunkNFT", "PUNKNFT") {
    }
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        IPUNK_PROVENANCE = provenanceHash;
    }
    ...
    */
    function mintToken(uint numberOfTokens) public payable {
        ...
        if(privateSaleIsActive) { // pre sale in whitelist
