...
contract Petz is ERC721, VRFConsumerBase {
    uint256 public tokenCounter;
    bytes32 public keyHash;
    uint256 public fee;
    uint256 public maxPetz;
    enum Breed {
        CAT_1,
        CAT_2,
        CAT_3,
    ...
    event requestedCollectible(bytes32 indexed requestId, address requester); // "indexed" is a keyword that makes it easier to search for this event
    ...
    // don't make tokenURI a parameter for createCollectible() since the URI won't be determined until the random number is returned and the breed is determined
    function createCollectible() public returns (bytes32) {
        require(
            tokenCounter < maxPetz,
            "The maximum number of Petz already exists"
        );
