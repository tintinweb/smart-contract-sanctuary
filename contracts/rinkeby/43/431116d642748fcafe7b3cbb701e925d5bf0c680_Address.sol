...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  uint256 public maxSupply = 238;
  uint256 public maxMintAmountPerTx = 238;
  ...
  constructor() ERC721("121_testz", "121test") {
    setHiddenMetadataUri("ipfs://QmPCpL8iWWRXFTgtPG6Kr6ARUzcXGjxiMcp7nuoZZ5Eb8J/hidden.json");
  }
