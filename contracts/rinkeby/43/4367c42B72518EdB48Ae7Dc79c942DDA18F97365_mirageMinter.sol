...
contract mirageMinter {
  ...
  constructor(address _mirageAddress) public {
  ...
  function artistToggleBonus(uint256 _projectId) public {
    require(msg.sender==mirageContract.projectIdToArtistAddress(_projectId), "can only be set by artist");
  ...
  function purchaseTo(address _to, uint256 _projectId) public payable returns(uint256 _tokenId){
    ...
    uint256 tokenId = mirageContract.mint(_to, _projectId, msg.sender);
  ...
  function _splitFundsETH(uint256 _projectId) internal {
    ...
    //   }
      ...
      uint256 creatorFunds = projectFunds;
      if (creatorFunds > 0) {
