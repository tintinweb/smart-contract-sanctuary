...
contract GreedIsRealGood {
    ...
    constructor() public {
        ...
        priceDai = AggregatorV3Interface(
    ...
    function buyTokens() public payable {
        ...
        uint256 tokenByEth = (msg.value * uint256(getEthPrice())) / 1;

        // uint256 dexBalance = token.balanceOf(address(this));
        try token.transfer(msg.sender, tokenByEth) {} catch Error(
    ...
    function buyTokenDai(uint256 _amount) public {
        // uint256 dexBalance = token.balanceOf(address(this));

        DAIToken.transferFrom(msg.sender, address(this), _amount);
        uint256 tokenByDai = ((_amount * uint256(getDaiPrice())) / 1) / (10**8);
