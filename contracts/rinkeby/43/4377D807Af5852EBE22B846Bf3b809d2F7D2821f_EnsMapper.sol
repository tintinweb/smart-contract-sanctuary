...
contract EnsMapper {
    ...
    mapping(uint256 => bytes32) public tokenId_used;
    IERC721 public nft;
    ...
    function setDomain(string memory label, address addy, uint256 token_id) public {
