...
contract womTrack is ERC721Tradable {
    ...
    address _proxyRegistryAddress; //opensea address
    ...
    */
    ...
    function initialize(address _twallet, address _dwallet, string memory _name_, string memory _symbol_, uint _reserve, uint256 _maxSupply, uint _maxPurchase, uint256 _price_, uint256 _pricePresale, address _proxyRegistryAddress_, uint256 _royaltyBps_) external {
