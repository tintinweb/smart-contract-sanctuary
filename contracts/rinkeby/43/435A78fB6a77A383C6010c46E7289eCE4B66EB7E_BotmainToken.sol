    ...
    AccessControlUpgradeable
{
    ...
    function initialize(address gnosisSafe) public initializer  {
        __ERC20_init_unchained('Botmain', 'TestBOT');
        ...
        // Mint 15% of supply to contract deployer for team distribution
        _mint(msg.sender, 1500000 * 10**decimals());

        // Mint 85% of supply to contract gnsosis safe for crowdsale
        _mint(gnosisSafe, 8500000 * 10**decimals());
