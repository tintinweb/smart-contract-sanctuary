...
contract DevChain is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Dev Chain", "DCH") {
    setHiddenMetadataUri("ipfs://Qmc4qWqfY3CgcqTEAJmjaM4BArKpEnmSnrhd7QPnkJFJPe/hidden.json");
  }
