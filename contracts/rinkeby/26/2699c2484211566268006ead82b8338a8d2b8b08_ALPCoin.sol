...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.0/contracts/presets/ERC20PresetFixedSupply.sol
...
// File: browser/ALP.sol

pragma solidity >=0.6.0 <0.8.0;


contract ALPCoin is ERC20PresetFixedSupply {
    uint256 total = 250000000 * 10**18;
    constructor() public ERC20PresetFixedSupply("ALP Coin", "ALP2", total, msg.sender) {
    }
}