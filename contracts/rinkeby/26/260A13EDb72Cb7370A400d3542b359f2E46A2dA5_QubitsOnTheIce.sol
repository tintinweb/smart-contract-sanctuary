...
contract QubitsOnTheIce is ERC721Enumerable, Ownable {
    ...
    uint256 public _qubinatorCount = 10000;
    ...
    function _qubinateProcess() private  {
        ...
        require( _qubinatorCount + 1 < 15000,      "Exceeds maximum Qubits that can be created" );
        require( msg.value >= _qubinatorPrice,             "Ether sent is not correct" );
        _safeMint( msg.sender, _qubinatorCount + 1 );
        _qubinatorCount = _qubinatorCount+1;
    }
