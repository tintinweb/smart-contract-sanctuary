...
contract PepeDoods is ERC721, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    function mint(uint amount) external payable whenNotPaused nonReentrant {
        ...
        for(uint i; i < amount; i++){
            _safeMint(msg.sender, totalSupply()); // +1 because metadata starts with 1
        }
    }
