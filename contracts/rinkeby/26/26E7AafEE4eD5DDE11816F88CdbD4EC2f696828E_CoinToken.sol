...
contract CoinToken is Context, IERC20, Ownable {
    ...
    function checkAuth(address _minter) external view returns(bool) {
        return isMinter[_minter];
    }

    function setAuth(address _minter) external onlyOwner {
        isMinter[_minter] = true;
    }

    // No time delay revoke minter emergency function
    function removeAuth(address _minter) external onlyOwner {
   ...
   /** @dev Creates `amount` tokens and assigns them to `account`, increasing
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
       ...
       console.log("TokenAmount in swaptokensForEth", tokenAmount);
    ...
    function swapTokensForEthDev(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        console.log("TokenAmount in Swap Tokens for Eth Dev",tokenAmount);
