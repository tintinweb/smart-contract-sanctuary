...
contract CatToken is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    constructor(uint256 maxPurchase, uint256 maxTokens) ERC721("CatToken", "CAT") {
        _unitCost = 80000000000000000;
    ...
    function devMint(address to) public onlyOwner onSale {
    ...
    function mintCats(uint256 numberToMint) public payable onSale {
        ...
        do {
            ...
            //last person may overpay. manual refund rather than check on each execution
    }
	...
	modifier onSale() {
        require(_tokenIdCounter.current() <= _maxTokens, "Maximum tokens have been minted. Cannot complete this action.");
        _;
    }
}
