...
// File: contracts/exchange/interfaces/IEasyBakeFactory.sol
...
// File: contracts/exchange/interfaces/IEasyBakeERC20.sol
...
// File: contracts/exchange/EasyBakeERC20.sol
...
// File: contracts/exchange/interfaces/IEasyBakeCallee.sol

pragma solidity >=0.5.0;

interface IEasyBakeCallee {
    function easybakeCall(
        address sender,
        uint amount0, 
        uint amount1, 
...
// File: contracts/exchange/interfaces/IEasyBakePair.sol
...
// File: easybake-swap-core/contracts/interfaces/IERC20.sol
...
// File: easybake-swap-core/contracts/libraries/UQ112x112.sol
...
// File: contracts/exchange/EasyBakePair.sol
...
contract EasyBakePair is IEasyBakePair, EasyBakeERC20 {
    ...
    function burn(address to) external lock returns (uint256 amount0, uint256 amount1) {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "EasyBake: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "EasyBake: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "EasyBake: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint256 balance1;
        {
            ...
            if (data.length > 0)
                IEasyBakeCallee(to).easybakeCall(
                    msg.sender,
                    amount0Out,
                    amount1Out,
                    data
        ...
        require(
            ...
            "EasyBake: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
...
// File: contracts/exchange/EasyBakeFactory.sol
