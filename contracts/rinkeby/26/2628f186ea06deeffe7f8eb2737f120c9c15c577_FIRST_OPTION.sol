...
contract FIRST_OPTION is ERC20, Ownable {
	...
	constructor () ERC20("TEST20211126", "TEST", 9, totalFund) Ownable(ownerWallet) {
	...
	function unlock() public onlyOwner {
		lockForAirdrop = false;
		emit Unlock();
	}

	function checkLockWallet(address sender) private view {
		if (lockForAirdrop) {
			require(sender == airdropWallet, "OPTN: locked tokens cannot be used");
		}
	}
