...
contract Monsternauts is ERC721Enumerable, Ownable
{
    ...
    uint256 public constant _initialReserve = 5;
    string private constant _initialBaseURI = "ipfs://QmRt6pNvmAvL6ph3JGu8bYvn8tUWwp8PNZjuDDmBUnHCdR/";
    ...
    ERC721("Monsternauts", "MNAUTS")
    {
        ...
        require((supply + _initialReserve) < _maxSupply, "Mint would exceed max supply of tokens.");
