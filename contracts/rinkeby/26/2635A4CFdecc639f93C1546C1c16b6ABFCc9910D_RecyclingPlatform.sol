...
contract RecyclingPlatform is Context, AccessControlEnumerable {
    ...
    constructor(IERC20 recyclingToken) {
        rcl = recyclingToken;
    ...
    function buyRCL() public payable {
        ...
        // TODO: счетчики выпилить, если гарантированно можно все отслеживать на Etherscan

    }

    function getETH(uint256 amount) public {
        require(hasRole(BACKEND_ROLE, _msgSender()), "RecyclingPlatform: must have backend role to withdraw Ether");
...
*/
    ...
    function exchangeRCL(address client, uint256 amountRCL) public payable {
        uint256 ethValue = amountRCL * 1000000000000000000 / ethRclPrice;
        require(msg.value == ethValue, 'RecyclingPlatform: get total price before call');
