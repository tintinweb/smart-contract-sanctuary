...
contract CrazySkullz is ERC721Enumerable, Ownable {
    ...
    // Maximum number of tokens that can be mintd in presale / address
    ...
    constructor() ERC721("CrazySkullz","SKLZ"){
