...
contract LonelyAlienNFT is ERC721, PaymentSplitter, Ownable, Pausable {
    ...
    function getOneNFT() public payable {
        ...
        require(_tokenIdCounter.current().add(2) <= MAXNFT, "Purchase would exceed max supply");
        master_mint();
    }
    ...
    function getMultipleNFT(uint256 _howMany) public payable {
        ...
        require(_tokenIdCounter.current().add(_howMany).add(1) <= MAXNFT, "Purchase would exceed max supply");
