...
contract loveletters_V2 is Ownable, ERC721Enumerable {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" width="256" height="239" fill="none" xmlns:v="https://vecta.io/nano"><defs><style>@font-face{font-family:"Damion";src:url(';
        ...
        parts[
            8
        ] = '</tspan></text><foreignObject class="d" x="18" y="68.9" width="220px" height="110px"><div xmlns="http://www.w3.org/1999/xhtml" style="text-overflow: ellipsis; display: -webkit-box; color: rgba(0,0,0,0.7); -webkit-line-clamp: 6; -webkit-box-orient: vertical">';
