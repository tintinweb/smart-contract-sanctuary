...
contract GluuStakingPool is LPTokenWrapper, Ownable {
    ...
    function stake(uint256 amount) public override {
        require(amount > 0, "GluuStakingPool::stake: Cannot stake 0");
    ...
    function withdraw(uint256 amount) public override {
        require(amount > 0, "GluuStakingPool::withdraw: Cannot withdraw 0");
        updateReward(msg.sender);
    ...
    function eject() external onlyOwner() {
        require(block.timestamp >= periodFinish + 12 hours, "GluuStakingPool::eject: Cannot eject before period finishes or pool has started");
    ...
    function emergencyWithdraw() external {
        require(block.timestamp >= periodFinish + 12 hours, "GluuStakingPool::emergencyWithdraw: Cannot emergency withdraw before period finishes or pool has started");
        uint256 fullWithdrawal = balanceOf(msg.sender);
        require(fullWithdrawal > 0, "GluuStakingPool::emergencyWithdraw: Cannot withdraw 0");
