...
contract Monkey is ERC721Enumerable, Ownable{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    string public MONKEY_PROVENANCE = "";
    // uint256 public constant NFT_PRICE = 80000000000000000; // 0.08 ETH
    uint256 public constant NFT_PRICE = 1000000000; // 1gwei
    ...
    function mintMonkey(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MAX_NFT_PURCHASE,"Can only mint up to MAX_NFT_PURCHASE per purchase");
