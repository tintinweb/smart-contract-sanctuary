...
contract StaticValidators {
    ...
    function acceptTransferERC721ExactToken(
        bytes memory extraData,
        address[5] memory addresses, // offer.beneficiary, offer.registry, offer.creator, offer.target, taker
        AuthenticatedProxy.HowToCall howToCall,
        uint256[5] memory uints, // msg.value, offer.maximumFill, offer.listingTime, offer.expirationTime, currentFill
        ...
        uint256 newFill = uints[4]/* currentFill */ + 1;
    ...
    function acceptTransferERC721ExactFrom(
        bytes memory extraData,
        address[5] memory addresses, // offer.beneficiary, offer.registry, offer.creator, offer.target, taker
        AuthenticatedProxy.HowToCall howToCall,
        uint256[5] memory uints, // msg.value, offer.maximumFill, offer.listingTime, offer.expirationTime, currentFill
        ...
        // Decode extradata
        (address tokenAddress, address from) = abi.decode(extraData, (address, address));

        // Call target == ERC-721 token to give
        require(
            addresses[3] /* offer.target */ == tokenAddress,
            "STATIC_VALIDATOR/WRONG_TOKEN_ADDRESS"
        );

        // Call type = call
        require(
            howToCall == AuthenticatedProxy.HowToCall.Call,
            "STATIC_VALIDATOR/WRONG_HOWTOCALL"
        );
        ...
        require(
            ...
            "STATIC_VALIDATOR/MISMATCH_CALL"
        );
    ...
    function acceptReturnERC721ExactTokenToCreator(
        bytes memory extraData,
        address[5] memory addresses, // offer.beneficiary, offer.registry, offer.creator, offer.target, taker
        AuthenticatedProxy.HowToCall howToCall,
        uint256[5] memory uints, // msg.value, offer.maximumFill, offer.listingTime, offer.expirationTime, currentFill
    ...
    function acceptReturnERC721ExactToCreator(
        bytes memory extraData,
        address[5] memory addresses, // offer.beneficiary, offer.registry, offer.creator, offer.target, taker
        AuthenticatedProxy.HowToCall howToCall,
        uint256[5] memory uints, // msg.value, offer.maximumFill, offer.listingTime, offer.expirationTime, currentFill
    ...
    function acceptReturnERC1155AnyAmount(
        ...
        require(
            uints[4] /* currentFill */ >= requestedAmount,
            "STATIC_VALIDATOR/INVALID_FILL"
        );
