...
contract Catbotica is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard, IERC2981 {
    ...
    uint16 public constant MAX_PRIVATE_SALE_SUPPLY = 30; // Cap for tokens to be sold in private sale is 2500 in addition to 500 for redmeption by RWA list
    uint16 public constant MAX_TOKENS = 60; // Max number of token sold in  sale
