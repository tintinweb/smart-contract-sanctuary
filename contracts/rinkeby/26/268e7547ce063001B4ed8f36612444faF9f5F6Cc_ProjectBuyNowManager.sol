    ...
    UUPSUpgradeable
{
    ...
    mapping(uint256 => mapping(uint64 => uint64)) randomMatrix;
    ...
    function buyNow(
        ...
        uint256 tokenId = buyNowInfo.project.managerMint(
            _msgSender(),
            string(abi.encodePacked(buyNowInfo.baseURI, uint256(randomPrintEdition).toString()))
        );
    ...
    UUPSUpgradeable
{
     ...
     * @dev See {IProjectCore-managerSetTokenURI}.
     */
    function managerSetTokenURI(uint256[] memory tokenIds, string[] calldata uris) external override managerRequired {
...
interface IProjectCoreUpgradeable is IERC165Upgradeable {
     ...
     */
    function managerSetTokenURI(uint256[] memory tokenId, string[] calldata uri) external;
