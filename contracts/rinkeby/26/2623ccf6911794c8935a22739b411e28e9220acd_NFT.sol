...
contract NFT is ERC721URIStorage {
    ...
    function mintFirstEdition(string memory _data) public onlyOwner returns (uint256) {
    ...
    function mintAfterTokenTransfer() public {
        require(_tokenIds.current() - 1 <= maxMintable);
        require(FrogInterface(frogToken).allowance(msg.sender, address(this)) >= cost);
