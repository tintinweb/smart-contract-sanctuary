...
import "Base64.sol";
// import "base64.sol";
// import "Base64.sol"; // this repo has no tags/releases
...
contract TFNFT is ERC721URIStorage {
    ...
    function create(string memory _svg) public {
        ...
        string memory strTokenURI = formatTokenURI(imageURI);
        _setTokenURI(tokenCounter, strTokenURI);
        tokenCounter++;
        emit TFTNFTCreated(tokenCounter, strTokenURI);
    }
    ...
    function svgToImageURI(string memory _svg) public pure returns (string memory) {
        ...
        string memory svgBase64Encoded = Base64.encode(string(abi.encodePacked(_svg)));
