...
contract SVGNFT is ERC721URIStorage {
  ...
  function _svgToImageURI(string memory _svg) internal pure returns (string memory imageURI) {
  ...
  function _formatTokenURI(string memory _imageURI) internal pure returns (string memory tokenURI) {
    ...
    string memory tokenURI = string(abi.encodePacked(baseURL, encodedJSON));
    return tokenURI;
  }
}
