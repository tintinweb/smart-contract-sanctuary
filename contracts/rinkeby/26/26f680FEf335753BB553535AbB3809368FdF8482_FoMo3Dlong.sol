...
contract FoMo3Dlong is modularLong {
    ...
    DiviesInterface constant private Divies = DiviesInterface(0xBDDCDB76f89105B24F88A49f3eba145d342410C7);
    JIincForwarderInterface constant private Jekyll_Island_Inc = JIincForwarderInterface(0x7dd7f12cfd3Cf16aF704545e7051cF82C57aec3A);
	PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0x19Ea528547CF3FC5754821Bfb7A844951D098256);
    F3DexternalSettingsInterface constant private extSettings = F3DexternalSettingsInterface(0x2dD453d0cdf31226728405C07245585c29a5F96A);
//==============================================================================
//     _ _  _  |`. _     _ _ |_ | _  _  .
