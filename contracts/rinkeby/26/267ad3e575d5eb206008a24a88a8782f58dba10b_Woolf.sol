...
contract Woolf is IWoolf, ERC721Enumerable, Ownable, Pausable {
	...
	constructor(
		...
		// ape
		// skin 9
		rarities[0] = [9, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[0] = [8, 8, 8, 8, 8, 8, 8, 8, 8];
		// eyes 19
		rarities[1] = [19, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[1] = [18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18];
		// mouth 22
		rarities[2] = [22, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		...
		// headwear 22
		rarities[4] = [22, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[4] = [21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21];
		...
		aliases[6] = [0];
		// eyes 10
		rarities[7] = [10, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[7] = [9, 9, 9, 9, 9, 9, 9, 9, 9, 9];
		// mouth 9
		rarities[8] = [9, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[8] = [8, 8, 8, 8, 8, 8, 8, 8, 8];
		// clothing 8
		rarities[9] = [8, 128, 128, 128, 128, 128, 128, 128];
		aliases[9] = [7, 7, 7, 7, 7, 7, 7, 7];

		// headwear 11
		rarities[10] = [11, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128];
		aliases[10] = [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10];
