...
contract Test is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Collezione", "C", _proxyRegistryAddress)
    {}
    ...
    function contractURI() public pure returns (string memory) {
        return "https://jennaro.netsons.org/contratto.txt";
    }
}
...
contract TestFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://creatures-api.opensea.io/api/creature/";

    uint256 MAX_SUPPLY = 3;
    uint256 NUM_OPTIONS = 1;
    uint256 SINGLE_OPTION = 0;
    uint256 MULTIPLE_OPTION = 1;
    uint256 MULTIPLE_OPTION_SUPPLY = 4;
