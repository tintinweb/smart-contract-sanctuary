...
contract UNITEST is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "UNITEST";
    string private _symbol = "UNITEST";
    ...
    //to receive ETH from Uniswap Router when swapping
    ...
    // Innovation for protocol by UNITEST Team
    ...
    uint256 public _liquidityFee = 6; // 3% will be added pool, 3% will be converted to ETH
    ...
    function claimETHReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own UNITEST to claim reward');
    ...
    function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 60 minutes;
        rewardCycleBlock = 20 minutes;
        easyRewardCycleBlock = 10 minutes;
