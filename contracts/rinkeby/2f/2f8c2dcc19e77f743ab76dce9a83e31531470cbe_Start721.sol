...
contract Start721 is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("StartCrypto", "SC", _proxyRegistryAddress)
    {}
    
    string public tokenIPFS ="QmWAMHgHbbx4ExC8EhvmGFfbJhWkkp13MwMCZLCXeRTvJ6/";
    string public contractIPFS ="Qmb5hHECQo7H3Mcs7Efu2L2RaNa86Xf6kWp37UxMj6wXry";
    string public domain = 'https://gateway.pinata.cloud/ipfs/';
    
    function setTokenIPFS(string memory _new) external onlyOwner {
        tokenIPFS = _new;
    }
    
    function setContractIPFS(string memory _new) external onlyOwner {
        contractIPFS = _new;
    }
    function setIPFSDomain(string memory _new) external onlyOwner {
        domain = _new;
    }

    function baseTokenURI() override view  public  returns (string memory) {
        return string(abi.encodePacked(domain,tokenIPFS)) ;
    }

    function contractURI() public view  returns (string memory) {
        return  string(abi.encodePacked(domain,contractIPFS)) ;
    }
}