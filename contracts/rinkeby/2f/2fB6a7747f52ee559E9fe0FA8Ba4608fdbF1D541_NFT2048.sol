...
contract NFT2048 is ERC721, Ownable {
    ...
    mapping(address => bool) private mintedFree4096Addresses;

    // mapping(address => bool) private mintedFreeBlueAddresses;

    constructor() ERC721("4096NFT", "4096") {
        _baseTokenURI = "https://4096nfts.io/api/token/";
    }
    ...
    function mint_free_4096() external {
        _canMint(1);
        require(canMintFree4096(msg.sender), "Already Minted Free 4096");
        _mint(msg.sender, 1);
        mintedFree4096Addresses[msg.sender] = true;
    }
    ...
    function canMintFree4096(address account) public view returns (bool) {
        return mintedFree4096Addresses[account] == false;
    }
