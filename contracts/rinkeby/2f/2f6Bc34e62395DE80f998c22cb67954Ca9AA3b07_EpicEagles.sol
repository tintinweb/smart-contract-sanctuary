...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    /**
     * @dev Edit for ownerOfBurnable token
     */
    function ownerOfBurnable(uint256 tokenId) public view returns (address) {
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        // Modifications for the _owner token
        _balances[to] += 1;
        _owners[tokenId] = to;
...
contract EpicEagles is ERC721, Ownable {
    ...
    uint private startSales = 1631131200; // 2021-09-08 à 22:00:00
