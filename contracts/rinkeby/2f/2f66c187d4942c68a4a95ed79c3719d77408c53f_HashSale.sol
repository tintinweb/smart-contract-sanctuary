...
contract HashSale is Ownable {
	...
	event NewSale(uint indexed saleId, address indexed customerAddress, string indexed referral, uint payAmount, uint tokenAmount, uint8 stage, uint stageSales, bool isSaleFinished);
