...
contract TimeForge is Ownable {
    ...
    constructor(IERC721 _dr_contract_address) {
        dr_contract_address = _dr_contract_address;
    }

    // Set Card Property
    function setRedeemable(uint256 _Id, bool _status) external onlyOwner{
        Claimed[_Id] = _status;
        emit setClaimStatus(_Id, _status);
    }
    ...
    function claimRedeemable(
        ...
        require(Claimed[_tokenId] == false, "Art claimed");
        require(_tokenId >= 5001 && _tokenId <= 7000, "Token not within Range");
        // Validate.
        ...
        emit setClaimStatus(_tokenId, false);
        claimCount++;
    }
