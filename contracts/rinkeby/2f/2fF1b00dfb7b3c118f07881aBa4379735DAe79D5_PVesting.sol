...
contract PVesting is Initializable {
    ...
    function initialize(address _stripToken, address _presaleContract, address payable _multiSigAdmin) public initializer {
        owner = msg.sender;
    ...
    function getVestingPlan(address _recipient) external view onlyOwner returns (uint256) {
