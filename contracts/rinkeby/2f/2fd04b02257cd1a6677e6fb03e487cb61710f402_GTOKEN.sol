...
contract GTOKEN is ERC20, AccessControl {
    ...
    address public marketingAddress = 0x0d9De3e879E23B9a16bc2248a95D6b54aFF7f184;
    ...
    constructor() ERC20("GameTime Token", "GTOKEN") {
        ...
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0x38eA51308c01AacB6cf88487f5F7b3C6a642e426);
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0x0d9De3e879E23B9a16bc2248a95D6b54aFF7f184);
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0xA85E8718810abf64D358F0E316d2c1C9F9967eFb);
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0x5804aa77e8d0f8952645A067a4DDED0f57739376);
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0x3A81ef17d207e86111cBFFD8368d5e9cc03b7C68);
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0x820D12fbF0f1599638a9457Af2571985C420525C);
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0x1Fa0A6156f1E2Ad1844670088B4f8bd8EB5e4BA9);
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0xB1a0b992341f0d1d8C93fa9Fe4279E7E2bD66467);
        _setupRole(EXCLUDED_FROM_FEE_ROLE, 0xf2F29E48892cbc5DB198E3dAFb64c3f909514b52);
        ...
        _setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0x38eA51308c01AacB6cf88487f5F7b3C6a642e426);
        _setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0x0d9De3e879E23B9a16bc2248a95D6b54aFF7f184);
        _setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0xA85E8718810abf64D358F0E316d2c1C9F9967eFb);
        _setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0x5804aa77e8d0f8952645A067a4DDED0f57739376);
        _setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0x3A81ef17d207e86111cBFFD8368d5e9cc03b7C68);
        _setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0x820D12fbF0f1599638a9457Af2571985C420525C);
        _setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0x1Fa0A6156f1E2Ad1844670088B4f8bd8EB5e4BA9);
        _setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0xB1a0b992341f0d1d8C93fa9Fe4279E7E2bD66467);
	_setupRole(EXCLUDED_FROM_ANTIWHALE_ROLE, 0xf2F29E48892cbc5DB198E3dAFb64c3f909514b52);
