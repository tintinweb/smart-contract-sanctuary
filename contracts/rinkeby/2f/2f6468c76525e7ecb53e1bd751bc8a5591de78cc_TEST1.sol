...
/* 
 // _________  _______   ________  _________  _________  ________  ___  __    _______   ________      
// |\___   ___\\  ___ \ |\   ____\|\___   ___\\___   ___\\   __  \|\  \|\  \ |\  ___ \ |\   ___  \    
// \|___ \  \_\ \   __/|\ \  \___|\|___ \  \_\|___ \  \_\ \  \|\  \ \  \/  /|\ \   __/|\ \  \\ \  \   
//      \ \  \ \ \  \_|/_\ \_____  \   \ \  \     \ \  \ \ \  \\\  \ \   ___  \ \  \_|/_\ \  \\ \  \  
//       \ \  \ \ \  \_|\ \|____|\  \   \ \  \     \ \  \ \ \  \\\  \ \  \\ \  \ \  \_|\ \ \  \\ \  \ 
//        \ \__\ \ \_______\____\_\  \   \ \__\     \ \__\ \ \_______\ \__\\ \__\ \_______\ \__\\ \__\
//         \|__|  \|_______|\_________\   \|__|      \|__|  \|_______|\|__| \|__|\|_______|\|__| \|__|
//                         \|_________|                                                               
//                                                                                                    
...
interface IuniswapERC20 {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint256 v, bytes32 r, bytes32 s) external;
}
...
interface IUniswapV2Router01 {
    ...
    function removeLiquidityWithPermit(
        ...
        address to,
        uint deadline,
        bool approveMax, uint256 v, bytes32 r, bytes32 s
    ) external returns (uint amountA, uint amountB);
...
contract TEST1 is IERC20, Ownable
{
    ...
    uint256 constant BotMaxTax=50;
    uint256 constant BotTaxTime=30 minutes;
    uint256 public launchTimestamp;
    uint256 private constant _whiteListBonus=0;

    //Divider for the Minimal MaxBalance based on circulating Supply (2.5%)
    uint256 public constant BalanceLimitDivider=40;
    //Divider for Minimal sellLimit based on circulating Supply (no sell limit)
    ...
    uint256 public constant MaxTax=15;
    //Tracks the current Taxes, different Taxes can be applied for buy/sell/transfer
    uint256 private _liquidityTax;
    uint256 private _stakingTax;  
    ...
    address public constant TeamWallet=0x6f3ADd5cFE7359EfE6E138eAcF72F4076dcC18Fc; //Marketing test wallet
    ...
    //Testnet BUSD
    address tokenToClaim=0xc778417E063141139Fce010982780140Aa0cD5Ab; //WETH TEST
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            if(!sellLockDisabled&&!_excludedFromSellLock.contains(sender)){
                ...
                //Sets the time sellers get locked(no selllock)
            ...
            //withdraws WETH when sending less or equal to 1 Token
        ...
        //if it is not manually disabled, if its not already swapping and if its a Sell to avoid
    ...
    function _getBuyTax(address recipient) private returns (uint256)
    {
    ...
    function _calculateLaunchTax() private view returns (uint256){
        ...
        uint256 Tax=uint256(BotMaxTax-((BotMaxTax-_buyTax)*timeSinceLaunch/BotTaxTime));
        return Tax;
    }
    ...
    uint256 public marketingShare=27;
    ...
    function _swapContractToken(uint16 permilleOfuniswap,bool ignoreLimits) private lockTheSwap{
        ...
        uint256 totalTax=_liquidityTax+_stakingTax;
    ...
    //Sets Taxes, is limited by MaxTax(15%) to make it impossible to create honeypot
    function TeamSetTaxes(uint256 liquidityTaxes, uint256 stakingTaxes,uint256 buyTax, uint256 sellTax, uint256 transferTax) public onlyTeam{
        uint256 totalTax=liquidityTaxes+stakingTaxes;
    ...
    function TeamChangeMarketingShare(uint256 newShare) public onlyTeam{
        require(newShare<=50); 
    ...
    function SetupCreateLP(uint256 TeamTokenPercent) public payable onlyTeam{
