...
contract UniswapLiquidityManager is PeripheryPayments, IUniswapLiquidityManager {
    ...
    function withdraw(bool pilotToken, bool wethToken, address sender, uint256 liquidity, bytes calldata data)
        external
        override
    {
        // only unipilot
        ...
        Position storage position = positions[tokenId];
        require(IUnipilot(address(unipilot)).isAuthorizedForToken(sender, tokenId) == true, "NO");
