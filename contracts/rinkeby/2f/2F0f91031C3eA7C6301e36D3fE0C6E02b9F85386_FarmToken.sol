...
contract FarmToken is ERC20, ChainlinkClient {
    address owner;
    ...
    uint256 public all_goods_length;
    ...
    mapping(address => uint256) public farmer_to_goods_length;

    constructor(uint256 initialSupply) ERC20("Farm Token", "FT") {
    ...
    function addGoods(
        ...
        farmer_to_goods[_farmer_address].push(new_good);
        all_goods.push(new_good);
        all_goods_length++;
        farmer_to_goods_length[_farmer_address]++;
    }
    ...
    function getGoodByFarmer(address _farmer_address) view public returns(Goods[] memory){
