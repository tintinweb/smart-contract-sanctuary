...
contract erc1155Test is ERC1155, Ownable, ERC1155Burnable, AccessControl {//ERC1155Pausable
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/QmWY9zTHDdDAJ6JQ47SW6GirVsbH6cRwA3DRGk48WYtAbK") {
    ...
    function getSTRUCT(address _address) external view returns(uint256){ 
        return users[_address].end_of_subscription;
    }
