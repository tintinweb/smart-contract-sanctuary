...
contract Tokenfy is ERC20, EIP712, Ownable {
    ...
    uint256 public constant DEV_AMOUNT = INITIAL_MAX_SUPPLY / 100 * 10;
    address public constant DEV_ADDRESS = 0xb8C94Ec82b5A2E004d34C7Cb7b2A657D8118E496;
    ...
    // for free claim
    uint256 public constant AIRDROP_AMOUNT = INITIAL_MAX_SUPPLY - (STAKING_AMOUNT + LP_AMOUNT + DEV_AMOUNT + TEAM_AMOUNT + ADVISORS_AMOUNT);
    ...
    */
    function transferToIncubationFund(address fund) external onlyOwner {
        ...
        uint256 remainingTokens = AIRDROP_AMOUNT - claimedAmount;
