...
contract KumaWorld is ERC721Enumerable, Ownable{
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    (bool mc, ) = payable(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2).call{value: address(this).balance * 25 / 100}("");
    require(mc);
    
    (bool zz, ) = payable(0xCA35b7d915458EF540aDe6068dFe2F44E8fa733c).call{value: address(this).balance * 25 / 100}("");
    require(zz);
    
    (bool jk, ) = payable(0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db).call{value: address(this).balance * 25 / 100}("");
    require(jk);
