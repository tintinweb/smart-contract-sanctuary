...
contract MyEpicNFT is ERC721URIStorage{
    ...
    string[] firstWords = ["Luffy", "Zoro", "Sanji", "Ichigo", "Naruto", "Baki"];
    string[] secondWords = ["Apples", "Bacon", "Pancakes", "Sausage", "Syrup", "Hamburgers"];
    string[] thirdWords = ["Elephant", "Tiger", "Leopard", "Squirrel", "Frog", "Lion"];

    event NewEpicNFTMinted(address sender, uint256 tokenId);

    constructor() ERC721 ("NFTSquare", "SQARE"){
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        combinedWord,
                        '", "description": "Collection of Squares.", "image": "data:image/svg+xml;base64,',
