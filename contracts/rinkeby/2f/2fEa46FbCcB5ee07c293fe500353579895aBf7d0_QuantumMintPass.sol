...
import "./AbstractQuantumMintPass.sol";
import "@openzeppelin/contracts/utils/cryptography/MerkleProof.sol";

contract QuantumMintPass is AbstractQuantumMintPass {
    ...
    constructor(string memory baseURI) public ERC1155(baseURI) {
        name_ = "Quantum MintPass";
        symbol_ = "QPASS";
    }

    function setURI(string calldata uri) onlyOwner public {
        _setURI(uri);
    }
...
abstract contract AbstractQuantumMintPass is IQuantumMintPass, ERC1155Supply, ERC1155Burnable, Ownable {
