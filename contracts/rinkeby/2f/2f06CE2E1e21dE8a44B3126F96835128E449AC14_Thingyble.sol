...
contract Thingyble is ERC721, Ownable {
    ...
    string public constant provenanceURI = "ipfs://abcd";
    ...
    /// Boom... Let's go!
    constructor(uint initialBatchCount) ERC721("Testing", "BJZF") {
    ...
    /**
     * @dev This can only be called once. It will lock any further changes to the metadata.
     */
    function lockMetadata() public onlyOwner {
        require(!metadataLocked, "Has already been locked");

        metadataLocked = true;
    }

    /**
     * @dev This will be called after all Thingyble have been released.
     */
    function setLinks(
        ...
        require(!metadataLocked, "Can no longer be set");
