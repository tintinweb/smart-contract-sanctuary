...
contract Squirrels is ERC721Enumerable, Ownable {
  ...
  (((@%(((((#######(##(((((((((((((((((((((####((((((((((((%#####(#(((((((@#@
    ...
    */
	...
	// Config Constans
	uint256 private constant price = 0.00001 ether; // price of 1 squirrel
	uint256 private constant maxCountForPublicTX = 10; // max mint count per transaction in public sale
	uint256 private constant maxCountForPresaleUser = 1000; // max one presale user can mint *total*
	...
	bool public mintingSupplyLocked = false; // is the minting supply allowed to be changed

	// Addresses
	address public constant signer = 0x6073674980474D3207584cd5B94D4CF00EbfC85A;
	...
	// function setMintingSupply(uint256 newSupply) public onlyOwner {
	// 	require(!mintingSupplyLocked, 'Minting supply is locked.');
	// 	require(newSupply <= maxSupply, 'That supply is over the maximum supply');
	// 	maxMintingSupply = newSupply;
	// }

	function bumpMintingSupply() public onlyOwner {
		require(maxMintingSupply < maxSupply, 'Minting supply already maxed');
		maxMintingSupply += 1000;
	}
