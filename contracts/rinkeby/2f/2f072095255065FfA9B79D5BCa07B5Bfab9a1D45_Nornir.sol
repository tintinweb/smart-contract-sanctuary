...
contract Nornir is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBase {
	...
	VikingConditions [] public vikingConditions;
	VikingApperance[] public vikingApperance;
	VikingStats[] public vikingStats;
	...
	function setVikingConditions(uint256 randomNumber) internal {
		vikingConditions.push(
			VikingConditions(
				// weapon_condition
	...
	function setVikingApperance(uint256 randomNumber) internal {
		vikingApperance.push(
			VikingApperance(
				randomNumber % 100,
				(randomNumber % 1000000) / 10000,
				(randomNumber % 10000000000) / 100000000,
				(randomNumber % 100000000000000) / 1000000000000,
				(randomNumber % 1000000000000000000) / 10000000000000000,
				(randomNumber % 1000000000000000000000000) / 10000000000000000000000,
				(randomNumber % 100000000000000000000000000) / 1000000000000000000000000,
				(randomNumber % 10000000000000000000000000000) / 100000000000000000000000000,
				(randomNumber % 1000000000000000000000000000000) / 10000000000000000000000000000
			)
		);
	}

	function setVikingStats(uint256 randomNumber) internal {
		vikingStats.push(
			VikingStats(
	...
	function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
		...
		uint256 newId = vikingStats.length;

		// Add the new viking to the vikings collction
		setVikingConditions(randomNumber);
		setVikingApperance(randomNumber);
