...
contract NFTP is ERC721, Ownable {
        ...
        payable 
    {
        ...
        require(_num < (maxMint+1),"You can mint a maximum of maxMint NFTPs");
        require(msg.value >= price * _num,"Ether amount sent is not correct");
        mint(_to, _num);
    }

    /**
     * @dev Private function for minting. Should not be called outside of buy() or the constructor
