...
contract SlyPantherClub is ERC721Enumerable, Ownable {
    ...
    function mintPantherToAddress(address to) public onlyOwner {
        ...
        require(currentSupply < MAX_SUPPLY, "SlyPantherClub: All Panthers have already been claimed");
        require((currentSupply + 1) <= MAX_SUPPLY, "Claim will exceed maximum available supply.");
    ...
    function mintPanthers(uint256 numOfTokens) public payable {
        ...
        require(currentSupply + numOfTokens <= MAX_SUPPLY, "Claim will exceed maximum available supply.");
