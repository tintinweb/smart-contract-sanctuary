...
contract TokenContract is ERC20, Ownable, Pausable {
    ...
    uint256 public _buyingFee = 2;
    uint256 public _sellingFee = 5;
    ...
    address public developmentWallet = 0x396B2C424494a14d4807F3dd5b7E0d94BDB7e1E1;
    ...
    //    uint private immutable _holdDaysThreshold = 86400 * 20; // just 20 days
    uint private immutable _holdDaysThreshold = 5 * 60; // just 5 minutes
    uint256 private _holdThreshold = 500 ether;                   // Initial threshold
    IterableMapping.Map private _holdTimestampMap;
    constructor () ERC20("TEST.finance", "TEST") {
    ...
    */
    ...
    function distributeEthereum(uint256 amount) public onlyOwner{
        ...
        require(_balance > amount, "You can't distribute more ehter than you have.");
        uint size = _holdTimestampMap.size();
        ...
        for (uint i = 0; i < rewardersCount; i++) {
            ...
            if(!blackList.contains(rewarders[i])){
                payable(rewarders[i]).send(rewardAmount);
            }
        }
    }
}