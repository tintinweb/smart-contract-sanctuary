...
contract animalMain is  ERC721,Ownable {
  ...
  function seeAnimalClass(uint256 _tokenId) public view returns (uint8 AnimalClass) {
    return animals[_tokenId].AnimalClass;
  }
  ...
  function createAnimal() public payable {
      ...
      uint id = animals.push(animal(dna, uint8(star), uint8(roletype), uint8(AnimalClass))) - 1;
