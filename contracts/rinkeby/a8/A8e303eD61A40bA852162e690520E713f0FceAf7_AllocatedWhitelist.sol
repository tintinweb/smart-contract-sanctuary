...
contract AllocatedWhitelist is Ownable {
    ...
    IERC20 public token = IERC20(0xe527Af9fbDa1D44e02C425455E33fc2A0C2f9B33);
    uint256 constant TIMELOCK = 600;
    struct UserInfoMap {
        uint256 amount;
    ...
    mapping(address => UserInfoMap) private userMapping;
    UserInfoArray[] private userArray;
    ...
    function release() external {
        ...
        require(amount > 0, "ALLOCATED_WHITELIST::INVALID_WEI_AMOUNT");
    ...
    function getAllocatedAddresses()
        external
        view
        returns (UserInfoArray[] memory)
    {
        return userArray;
    }

    function changeAllocationToken(IERC20 _contract) external onlyOwner {
        token = _contract;
