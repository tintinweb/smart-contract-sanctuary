...
contract CryptoBatz is Ownable, ERC721, ERC2981, SutterTreasury {
    ...
    {
        baseURI = "ipfs://QmNSQyYrZ86RCshmFgyJM5jvgfu5DhhVYbuHu1sLMRMFPW/";
    ...
    function buyPresale(
        ...
        //     "Whitelist signer has not been set"
        // );
        // require(
    ...
    function buyPublic(uint256 numberOfTokens) external payable {
        ...
        require(
            numberOfTokens <= _config.txLimit,
