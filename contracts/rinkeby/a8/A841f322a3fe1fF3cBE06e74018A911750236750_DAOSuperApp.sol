...
contract DAOSuperAppFactory {
    ...
    function createDAOSuperApp(string memory name, string calldata symbol, uint256 supply) external returns (address) {
        ...
        ISuperToken superDaoToken = _superTokenFactory.createERC20Wrapper(IERC20(address(daoToken)), uint8(18), ISuperTokenFactory.Upgradability.FULL_UPGRADABE, string("Test"), string("TSTx"));
        ...
        DAOSuperApp(superApp).initialize(address(daoToken), address(superDaoToken), msg.sender, address(this));
