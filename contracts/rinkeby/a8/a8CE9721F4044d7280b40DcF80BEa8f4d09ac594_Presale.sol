...
contract Presale {
    ...
    uint256 public constant MAX_ALLOC_FAST = 2e8 * 10e18; // 200,000,000 FAST is the max allocation for each presale buyer
    uint256 public constant MAX_ALLOC_WEI = 5e17; // 0.5 ETH is the max allocation for each presale buyer
    uint256 public constant RATE = MAX_ALLOC_WEI / MAX_ALLOC_FAST; // Fixed Rate
