...
modifier costs(uint price) {
    ...
    // public minting
    function mint(uint256 _mintAmount) public payable nonReentrant costs(_mintAmount*cost){
    ...
    function mintPresale(uint256 _mintAmount) public payable costs(cost) {
