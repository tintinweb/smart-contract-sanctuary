...
contract THERATNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;
	
	Counters.Counter private _tokenIdCounter;
    uint256 public MAX_RATS = 500;
    ...
    /**
     * @dev Used to set the max rat nft available.
     */
    function setMaxRats(uint256 newMaxRats) external  onlyOwner {
        MAX_RATS = newMaxRats;
    }
     ...
     */
    function getMaxRats() public view returns (uint256) {
        return MAX_RATS;
    }
}