...
interface iNP {
    ...
    enum MintCondition {IsAbleToMint, IsNotMintingOpen, NoNFTBalance, AlreadyMinted}
...
ReentrancyGuard
{
    ...
    {
        // TODO check address zero
        // TODO check base uri is not empty
    ...
    function buy(uint256 tokenId) external override payable nonReentrant {
        ...
        require(!mintedMap[tokenId], "Already minted");
