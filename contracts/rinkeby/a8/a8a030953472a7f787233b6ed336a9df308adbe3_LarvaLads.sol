...
contract LarvaLads is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[8] private baseColors = ['#AE8B61','#C2BD8B','#CE93BE','#C89CDD','#B1B7F2','#EAD9D9','#DB9781','#DBB181'];
    ...
    string[14] private fifthLayers = [
        ...
        '<path fill="#000" d="M13 3h9v1h1v5h1v1h1v1H10v-1h1V9h1V4h1V3z"/><path fill="#DC1D1D" d="M12 8h11v1H12z"/>',
        ''];
    ...
    function randomLarvaLad(uint256 tokenId) public pure returns (Larva memory) {
        Larva memory larvaLad;
    ...
    function getTraits(Larva memory larvaLad) internal view returns (string memory) {
        string[20] memory parts;
        
        parts[0] = ', "attributes": [{"trait_type": "Type","value": "';
        if (larvaLad.layerThree == 3) {
            parts[1] = 'Zombie';
            parts[2] = ', "attributes": [{"trait_type": "Mouth","value": "';
            parts[3] = 'Zombie';
        }
        if (larvaLad.layerThree == 4) {
            parts[4] = 'Alien';
            parts[5] = ', "attributes": [{"trait_type": "Mouth","value": "';
            parts[6] = 'Alien';
        }
        if (larvaLad.layerThree == 5) {
            parts[7] = 'Ape';
            parts[8] = ', "attributes": [{"trait_type": "Mouth","value": "';
            parts[9] = 'Ape';
        }
        if (larvaLad.layerThree < 3 || larvaLad.layerThree > 5) {
            parts[10] = 'Normal';
            parts[11] = ', "attributes": [{"trait_type": "Mouth","value": "';
            parts[12] = thirdNames[larvaLad.layerThree];
        }
        parts[13] = '"}, {"trait_type": "Eyewear","value": ';
        parts[14] = thirdNames[larvaLad.layerFour];
        parts[15] = '}, {"trait_type": "Headwear","value": ';
        parts[16] = thirdNames[larvaLad.layerFive];
        parts[17] = '"}, {"trait_type": "Accessory","value": "';
        parts[18] = thirdNames[larvaLad.layerSix];
        parts[19] = '"}], ';
    ...
    function getLayerFour(uint256 tokenId) internal pure returns (uint256) {
        ...
        uint256 rn4 = rand % 574;
        uint256 l4 = 0;

        if (rn4 >= 41 && rn4 < 62) { l4 = 1; }
        if (rn4 >= 62 && rn4 < 103) { l4 = 2; }
        if (rn4 >= 103 && rn4 < 144) { l4 = 3; }
        if (rn4 >= 144 && rn4 < 185) { l4 = 4; }
        if (rn4 >= 185 && rn4 < 266) { l4 = 5; }
        if (rn4 >= 266 && rn4 < 287) { l4 = 6; }
        if (rn4 >= 287) { l4 = 7; }
    ...
    function getSVG(Larva memory larvaLad) internal view returns (string memory) {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        Larva memory larvaLad = randomLarvaLad(tokenId);
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Larva Lad #', toString(tokenId), '", "description": "Larva Lads are fully on-chain and randomly generated at mint."', getTraits(larvaLad), '"image": "data:image/svg+xml;base64,', Base64.encode(bytes(getSVG(larvaLad))), '"}'))));
