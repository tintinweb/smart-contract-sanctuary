...
contract MyContract {
    ...
    // address[] whitlistedUser; // array of whitelisted address
    mapping(address=>bool) whitlistedUser;
    ...
    function whitelistUser( address userAddress ) public onlyAdmin returns (bool success){
        if(!isUserWhitelisted(userAddress)){
            whitlistedUser[userAddress] = true;
            return true;
        }else {
            return false;
        }
    ...
    function removeWhitelistedUser( address userAddress ) public onlyAdmin returns (bool success){
        whitlistedUser[userAddress] = false;
        return true;
    }

    // call mint function 
    // function mintNFT() public returns (bool success) {
    //     return true;
    // }
}