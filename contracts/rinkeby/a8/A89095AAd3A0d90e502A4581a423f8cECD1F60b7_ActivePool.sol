...
// File: contracts/Interface/IActivePool.sol
...
/*
 * The Active Pool holds the ETH collateral and MUSD debt (but not MUSD tokens) for all active troves.
 *
 * When a trove is liquidated, it's ETH and MUSD debt are transferred from the Active Pool, to either the
