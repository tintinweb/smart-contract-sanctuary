...
import "../contracts/rarible/erc-1155/ERC1155Rarible.sol";
pragma abicoder v2;

//TODO: Add FundingWallets
contract MockMinimalColors is ERC1155Rarible {
    function __ERC1155Rarible_init_unchained(
        ...
        super.__ERC1155Rarible_init_unchained(
            _name,
            _symbol,
            baseURI,
            contractURI,
...
abstract contract ERC1155Rarible is ERC1155Base {
    ...
    HasContractURI
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC1155Lazy, ERC165Upgradeable)
        returns (bool)
    {
    ...
    RoyaltiesV2Impl
{
    ...
    function mintAndTransfer(
        ...
        if (supply[data.tokenId] == 0) {
            // //TODO: do we need it? this should only be called by Rarible proxy
...
abstract contract Mint1155Validator is ERC1271Validator {
...
abstract contract ERC1155BaseURI is ERC1155Upgradeable {
        ...
        returns (string memory)
    {
        ...
        if (bytes(tokenURI_).length > 0) {
            return LibURI.checkPrefix(base, tokenURI_);
        }
        ...
        return
            string(
                abi.encodePacked(
                    base,
                    StringsUpgradeable.upper(tokenId.toHexString()),
                    ".json"
                )
            );
    }
