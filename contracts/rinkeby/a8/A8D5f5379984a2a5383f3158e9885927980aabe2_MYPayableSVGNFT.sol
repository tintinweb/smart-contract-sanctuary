...
contract MYPayableSVGNFT is ERC721URIStorage {
    ...
    constructor() ERC721 ("MY PAYABLE SVG NFT", "mypayablesvgnft") {
        Name = "My Payable SVG NFT";
    ...
    function create(string memory _svg) public payable {
        require(price <= msg.value, "Not enough ETH!");

        require(tokenCounter < MAX_SUPPLY);
    ...
    function formatTokenURI(string memory imageURI) public pure returns(string memory) {
        ...
        return string(abi.encodePacked(
            baseURL,
            Base64.encode(
                bytes(abi.encodePacked('{"name": "My Payable SVG NFT", ', 
