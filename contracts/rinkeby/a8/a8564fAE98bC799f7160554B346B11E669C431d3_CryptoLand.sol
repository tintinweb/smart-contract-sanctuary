 ...
 *      And the 61 to 21,000.00 (21k) represents the right to access the Vladimirs Club
 *
 */
...
contract CryptoLand is ERC721Enumerable, Ownable, ICryptoLand, ICryptoLandMetadata {
    ...
    uint256 public constant TOKEN_PURCHASE = 60;
    uint256 public constant TOKEN_PUBLIC = 20_940;
    uint256 public constant TOKEN_MAX = TOKEN_PURCHASE + TOKEN_PUBLIC;
    ...
    uint256 public totalPublicSupply = 60; // from 61 to 20_940
    uint256 public totalPurchaseSupply; // from 1 to 60;
