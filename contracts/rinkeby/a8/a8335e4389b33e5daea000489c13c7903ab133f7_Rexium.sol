...
contract Ownable is Context {
    ...
    constructor() internal {
        _owner =0xc15e242cf75E627e17081b142d3aB7b9Ef9c1Dca; // 0xc15e242cf75E627e17081b142d3aB7b9Ef9c1Dca;
...
contract Rexium is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Rexium";
    string private _symbol = "RXM";
    ...
    address marketingAddress=0x23872e3Ed07361bE065D678D06d05CccaD8B5454;
    ...
    uint256 public minBuybackTokensBeforeSell = 1000e9;
    uint256 public minBuybackTokensBeforeBurn = 100_000e9;
    uint256 public minTeamTokenBeforeSell = 10_000e9;
    
    uint256 public maxTxAmount = _tokenTotal; // no limit
    uint256 public minTokensBeforeSwap = 10e9;
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && sender != uniswapV2Pair) {
            uint256 teamBalance = balanceOf(marketingAddress);
            if(convertToEthEnabled && teamBalance >= minTeamTokenBeforeSell){
                _reflectionBalance[marketingAddress] = _reflectionBalance[marketingAddress].sub(teamBalance.mul(rate));
                _reflectionBalance[address(this)] = _reflectionBalance[address(this)].add(teamBalance.mul(rate));
                distributeMarketing(teamBalance);
            }
    ...
    function distributeMarketing(uint256 amount) private lockTheSwap {
    ...
    function setMarketingWallet(address marketAddress) external onlyOwner() {
