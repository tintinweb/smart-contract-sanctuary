...
/**
 * @title NameChangeToken
 * @dev A minimal NameChangeToken implementation (for test only!) where all tokens are pre-assigned to the creator.
 * The purpose of this contract is to very simply simulate real NCTs for testing purposes only.
 * The basic functions available in NameChangeToken are the same.
 *
 * Authors: s.imo
 * Created: 01.07.2021
 * Last revision: 26.07.2021: add the debugging-only increaseTotalSupply() function
 */
contract NameChangeToken is ERC20Burnable, Ownable {
