...
// Different EVM based blockchains will need different Dex Strategy
enum PriceStrategy {
    PANCAKE_SWAP,
    UNISWAP
}
contract LoanMarket {
    ...
    */
        ...
        returns(uint)
    {
        ...
        return((10**token1.decimals()*res0)/resToken1); // return amount of token0 needed to buy token1
    }
...
library LoanData {
	...
	struct LoanDetails{
		...
		uint256[] collateralErc20TokensStaked;
		...
		//current value in USD for staked collateral
		uint32 ltv;
