...
//https://etherscan.io/address/0x956c43998316b6a2F21f89a1539f73fB5B78c151#code
...
contract OlympusBondDepository is Ownable {
    ...
    enum PARAMETER { VESTING, PAYOUT, FEE, DEBT, controlVariable }
    /**
    ...
    function setBondTerms ( PARAMETER _parameter, uint _input ) external onlyPolicy() {
        ...
        } else if ( _parameter == PARAMETER.controlVariable ) { // 4
    ...
    function bondPrice() public view returns ( uint price_ ) {        
        price_ = terms.controlVariable.mul( debtRatio() ).div(100).add( 1000000000 ).div( 1e7 );
