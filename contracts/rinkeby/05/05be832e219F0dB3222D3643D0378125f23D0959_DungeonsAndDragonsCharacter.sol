...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase, Ownable {
        ...
        )
    {
        return (
            ...
            characters[tokenId].latitude + characters[tokenId].longitude + characters[tokenId].constitution + characters[tokenId].intelligence + characters[tokenId].wisdom + characters[tokenId].charisma,
            getLevel(tokenId),
