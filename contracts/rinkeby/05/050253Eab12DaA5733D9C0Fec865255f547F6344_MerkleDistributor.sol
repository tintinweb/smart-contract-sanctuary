...
/**
 * @dev A merkle distributor for ERC20 tokens.
 */
contract MerkleDistributor is Ownable {
    ...
    uint256 public immutable claimPeriodEnds; // Timestamp
     ...
     */
    constructor(address _token, bytes32 _merkleRoot, uint256 _claimPeriodEnds) {
        token = _token;
    ...
    function claim(uint256 amount, bytes32[] calldata merkleProof) external {
        ...
        require(valid, "MerkleDistributor: Valid proof required.");
        require(!isClaimed(index), "MerkleDistributor: Tokens already claimed.");
    ...
    function sweep(address dest) external onlyOwner {
        require(block.timestamp > claimPeriodEnds, "MerkleDistributor: Claim period not yet ended.");
