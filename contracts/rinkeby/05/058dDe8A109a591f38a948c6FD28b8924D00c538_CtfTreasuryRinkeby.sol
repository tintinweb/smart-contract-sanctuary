...
contract CtfTreasuryRinkeby is ERC165 {
    ...
    function approveERC20(IERC20 _token, address spender, uint256 amount) external  {
    ...
    function prepareCondition(address _oracle, bytes32 _questionId, uint _outcomeSlotCount) external  {
        conditionalTokens.prepareCondition(_oracle, _questionId, _outcomeSlotCount);
    }

    function splitPosition(IERC20 _collateralToken, bytes32 _parentCollectionId, bytes32 _conditionId, uint[] calldata _partition, uint _amount) external  {
        conditionalTokens.splitPosition(_collateralToken, _parentCollectionId, _conditionId, _partition, _amount);
    }

    function splitDeeperPosition(bytes32 layer1ParentCollectionId, bytes32 layer1conditionId, uint layer1indexSet, IERC20 _collateralToken, bytes32 _conditionId, uint[] calldata _partition, uint _amount) external  {
    ...
    function safeTransferFrom(bytes32 parentCollectionId, bytes32 conditionId, uint256 indexSet, IERC20 collateralToken, address from, address to, uint256 value, bytes calldata data) external  {
    ...
    function getCollectionAndPositionIds(bytes32 parentCollectionId, bytes32 conditionId, uint[] calldata indexSet, IERC20 collateralToken) external view {
    ...
    function getDeeperCollectionAndPositionIds(bytes32 layer1ParentCollectionId, bytes32 layer1conditionId, uint[] calldata layer1indexSet, bytes32 conditionId, uint[] calldata indexSet, IERC20 collateralToken) external view  {
    ...
    function getPositionId(IERC20 collateralToken, bytes32 collectionId) public view returns (uint) {
