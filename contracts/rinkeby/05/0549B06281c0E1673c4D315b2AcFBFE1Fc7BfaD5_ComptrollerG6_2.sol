 ...
 * @author Compound
 */
contract ComptrollerG6_2 is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getCompAddress() public view returns (address) {
        return 0x2D85ebc73eC5120622b4B0025BEE306479E24b88;
    }

    /**
      * @notice Remove the market from the markets mapping and set it as listed
      * @dev Admin function to delete market from the supported list
      * @param cToken The address of the market (token) to list
      * @return uint 0=success, otherwise a failure.
      */
...

{
  ...
  "remappings": [
    ":@openzeppelin=/home/dev/code/agilecode/compound-protocol/node_modules/@openzeppelin"
  ],
  "outputSelection": {
    "*": {
      "*": [
