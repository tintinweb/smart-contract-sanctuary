...
contract Dragaan is Ownable, EIP712, ERC721Enumerable {
    ...
    uint256 public constant TOTAL_MAX_QTY = 999;
    uint256 public constant GIFT_MAX_QTY = 20;
    uint256 public constant PRESALES_MAX_QTY = 333;
    uint256 public constant PRESALES_MAX_QTY_PER_MINTER = 5;
    uint256 public constant PUBLIC_SALE_MAX_QTY_PER_MINTER = 20;
    ...
    constructor() ERC721("Dragaan", "DRAGAAN") EIP712("Dragaan", "1") {}
    ...
    function publicSalesMint(uint256 _mintQty) external payable {
        ...
        require(
            publicSalesMinterToTokenQty[msg.sender] + _mintQty <=
                PUBLIC_SALE_MAX_QTY_PER_MINTER,
