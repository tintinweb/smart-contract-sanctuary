...
contract CatsLifecycle is ERC721Enumerable, Ownable {
    uint256 public startSale; //when the sale starts

    constructor() ERC721("CATSLifecycle", "CAT") {
        startSale = block.timestamp + 0; // 86400 * 7 //1 week from now
    }
...
// import "@openzeppelin/contracts/token/ERC721/ERC721.sol";
// import "@openzeppelin/contracts/token/extensions/ERC721Enumerable.sol";
// import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
// import "@openzeppelin/contracts/access/Ownable.sol";
// import "@openzeppelin/contracts/utils/Context.sol";
// import "@openzeppelin/contracts/utils/Counters.sol";

// contract CatsLifecycle is Context, AccessControlEnumerable,ERC721Enumerable, Ownable {
...
// 	uint256 public startingIndexBlock;
//   uint256 public startingIndex;
//   uint256 public constant catPrice = 70000000000000000; //0.07 ETH
// 	string public _baseTokenURI = "https://xxxx/j/";
// 	string public _contractURI =
// 		"https://raw.githubusercontent.com/xxxxx/master/contract_uri.json";
...
// // set some cats aside
//     function reserveCats() external onlyOwner {
//         uint supply = totalSupply();
//         uint i;
//         for (i = 0; i < 30; i++) {
//             _safeMint(msg.sender, supply + i);
