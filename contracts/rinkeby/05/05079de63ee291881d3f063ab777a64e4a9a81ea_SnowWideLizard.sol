...
contract SnowWideLizard is MintableToken {

  string public constant name = "Snow Wide Lizard"; // solium-disable-line uppercase
  string public constant symbol = "SWL"; // solium-disable-line uppercase
