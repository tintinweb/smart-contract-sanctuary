...
contract ReDistr is ERC20, Ownable {
    ...
    address[] tokens = [
        0x1F35452F794c18EAF1d51673505622F83615b825
    ];
    ...
    function handleFees(address sender, uint256 fees) private {
        ...
        if(sender != address(_UniswapV2Pair)) {
            uint256 maxAmount = feeTokens * 10**18 / (marketingTax + redistributeTax) * marketingTax / 10**18;
            ...
            (bool success,) = marketingWallet.call{value: ethGained}("");
            require(success, "LPAD6: Transfer failed");
            ...
            for(uint256 i; i < tokens.length; i++) {
                ...
                _approve(address(this), address(_UniswapV2Router02), redistributeTax);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override virtual {
        ...
        if(isExcludedFromTax[msg.sender]) {
            ...
            if(!isExcludedFromTax[sender] && !isExcludedFromTax[recipient] && (sender == address(_UniswapV2Pair) || recipient == address(_UniswapV2Pair))) {
                ...
                uint256 fees = amount / 100 * (tax + redistributeTax);
