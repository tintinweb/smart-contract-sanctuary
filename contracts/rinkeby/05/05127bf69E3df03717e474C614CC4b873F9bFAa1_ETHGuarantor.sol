...
abstract contract Guarantor is Pausable {
    ...
    function register(uint256 _collateralAmount, string calldata _name, string calldata _telegramId, string calldata _description) external whenNotPaused onlyNotRegistered {
    ...
    function deposit(uint256 _guarantorIndex, uint256 _amount) external whenNotPaused {
