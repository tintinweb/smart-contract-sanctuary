...
contract AokiForge is ERC721BurnRedeem {
    ...
    function forge(uint16 _checkToken, uint16 _burnToken) public {
        // Attempt Burn
        // Check that we can burn
        require(redeemable(creator, _burnToken), "BurnRedeem: Invalid NFT");
        require(canClaim[_checkToken] == true, "Claimed");
    ...
    IERC721BurnRedeem
{
    ...
    function onERC721Received(
        ...
        require(
            _redemptionRate == 1,
            "BurnRedeem: Can only allow direct receiving of redemptions of 1 NFT"
        );
