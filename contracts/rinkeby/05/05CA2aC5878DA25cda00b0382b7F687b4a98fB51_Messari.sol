...
contract Messari {
    ...
    string public constant name = "Messari";

    /// @notice EIP-20 token symbol for this token
    string public constant symbol = "INTEL";

    /// @notice EIP-20 token decimals for this token
    uint8 public constant decimals = 18;

    /// @notice Total number of tokens in circulation
    uint256 public totalSupply = 1_000_000_000e18; // 1 billion Intel
    ...
    function transfer(address dst, uint256 rawAmount) external returns (bool) {
        uint96 amount =
            safe96(rawAmount, "Uni::transfer: amount exceeds 96 bits");
    ...
    function transferFrom(
        ...
        uint96 amount =
            safe96(rawAmount, "Uni::approve: amount exceeds 96 bits");
    ...
    function delegateBySig(
        ...
        require(
            ...
            "Uni::delegateBySig: signature expired"
        );
