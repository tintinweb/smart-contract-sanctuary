...
contract Wrapper is ERC721Enumerable, Ownable {
    ...
    address payable public vault1 = payable(0x96F315d3808BF7ff197336f9418A4DD32f96f449);
    address payable public vault2 = payable(0x1cc1F6aC7d8549897321efeba4080e9356ebbD98);
    address payable public vault3 = payable(0x88B5fBcfd1f4D13E77A495bFb9f255b77DB3a4aa);
    address payable public vault4 = payable(0x345d01A0EeA919dF4304f746c971B5Eb9B6C5011);

    //list of frontend (ideally ipfs or other decentral storage) URIs
    string[] fe;
    Ethz public base;
    address public baseAddress = address(0xCa8B5FBFE831cd3d32227Fb78bcb9AB2aFdf4537);
    Cities public cities;
    address public citiesAddress = address(0xA5e42b0616ab38E47934714A17155a6875590607);
    //tokenIds on the map
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmQBXqhV8k2qxiLUCbibFk78z1QSQ2oTmk5FNSUyWevo6B/";
        //return "";
    }

    function contractURI() public pure returns (string memory) {
        //return "ipfs://QmU1B3Q1FpHfYanV9PHPfv6EqASz2XFCwy13wNctLU22E8";
        return "";
    }
