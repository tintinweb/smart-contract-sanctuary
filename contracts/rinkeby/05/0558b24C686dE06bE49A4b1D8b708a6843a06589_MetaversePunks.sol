    ...
    ReentrancyGuard
{
    ...
    uint256 public MAX_SUPPLY = 334;
    uint256 public mintableCount = 0;
    ...
    function mint() external payable nonReentrant {
        ...
        require(
            isOpen || _claims[msg.sender] != claimStatus.Claimed,
            "Already Claimed"
        );
        require(
            isOpen || _claims[msg.sender] == claimStatus.Unclaimed,
            "Not on the list"
        );
    ...
    function setMintableCount(uint256 count) external onlyOwner {
        mintableCount = count;
    }
