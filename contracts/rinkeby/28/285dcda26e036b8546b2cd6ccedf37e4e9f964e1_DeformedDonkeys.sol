...
contract DeformedDonkeys is ERC721, Ownable {
    ...
    function adoptDonkey(uint numberOfTokens, bytes memory eligibilityKey) public payable {
        ...
        address extraContractAddress = 0x886688aB3f2fFd73A073cc95f5ce5c25fc353D4c;
        DeformedDonkeysExtraContract deformedDonkeysExtra = DeformedDonkeysExtraContract(extraContractAddress);
