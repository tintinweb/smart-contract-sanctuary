...
contract testlol is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 25000000000000000000000;
    uint256 public launchedAt;

    string private _name = 'testlol';
    string private _symbol = 'lolz';
    ...
    uint256 public _maxTxAmount = 125000000000000000000;
    uint256 private _numOfTokensToExchangeForTeamDev = 50000000000000000000;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
      ...
      if(sender != owner() && recipient != owner()) {
        require(amount < _maxTxAmount, "Maximum TX limit exceeded");
      ...
      if (activeFee && feeException[_msgSender()] == false) {
        ...
        _balances[recipient] = _balances[recipient].add(amountLessFee);
