...
contract JStak is Whitelist, ERC20Pausable {
    ...
    function _beforeTokenTransfer(
        ...
        require(isWhitelisted(from), "JSTAK::SENDER_NOT_WHITELISTED");
        require(isWhitelisted(to), "JSTAK::RECEIVER_NOT_WHITELISTED");
...
contract Whitelist is AccessControl {
    ...
    bytes32 public constant JSTAK_ROLE = keccak256("POOL_ROLE");
    ...
    function addToWhitelist(address _address) external {
        require(hasRole(JSTAK_ROLE, msg.sender), "JSTAK::CALLER_ISN'T_ADMIN");
        require(_address != address(0), "JSTAK::INVALID_WALLET");
