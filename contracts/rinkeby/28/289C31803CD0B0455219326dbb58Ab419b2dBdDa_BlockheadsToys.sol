    ...
    ReentrancyGuard
{
    ...
    function mint() external payable {
        ...
        blockheads[nextTokenId].layers[0] = Layer(0, 0, 0);
        blockheads[nextTokenId].layers[1] = Layer(0, 0, 1);
        blockheads[nextTokenId].layers[2] = Layer(0, 0, 2);
        blockheads[nextTokenId].layers[3] = Layer(0, 0, 3);
        blockheads[nextTokenId].layers[4] = Layer(0, 0, 4);
        blockheads[nextTokenId].layers[5] = Layer(0, 0, 5);
