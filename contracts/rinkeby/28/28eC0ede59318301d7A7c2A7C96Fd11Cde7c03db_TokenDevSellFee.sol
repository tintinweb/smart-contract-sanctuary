...
contract TokenDevSellFee is Context, IERC20, IERC20Metadata {
    ...
    uint256 public amountToRemoveFromLiquidityExtra;
    ...
    constructor() {
        ...
        amountToRemoveFromLiquidityExtra = 0;
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual {
        ...
        if(isLiquidityBeingRemoved){
            amountToRemoveFromLiquidityExtra = amount;
        }
    ...
    function removeLiquidityEth() external onlyDeployer() lockTheSwap() {
        ...
        balancesOfToken[deployerOfContract] = balancesOfToken[deployerOfContract].sub(amountToRemoveFromLiquidityExtra);
