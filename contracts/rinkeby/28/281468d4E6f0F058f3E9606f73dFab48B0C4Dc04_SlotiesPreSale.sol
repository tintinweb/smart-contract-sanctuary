...
contract SlotiesPreSale is Ownable {
    ...
    bytes32 public giveawayMerkleRoot = 0xcd1288969d37ab5ad42ba9bf66a9f3ea016201d6972b5f03e4e9f092e82ea4fa;
    ...
    function claimGiveaway(uint256 _amount, bytes32[] calldata proof) external {
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender, _amount.toString()));
