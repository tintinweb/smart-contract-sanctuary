...
contract NFTree is ERC721Enumerable, Ownable {
    ...
    address private _signerAddress = 0x1324452B5e7b250148FA7C4d10bB550cdEd4a039;   
     ...
     */
    function christmasSpiritGen(uint256 tokenId, uint256 _randinput, uint8 _christmasSpiritTier)
        internal
        returns (string memory)
    {
        ...
        for (uint8 i = 0; i < TIERS[_christmasSpiritTier].length; i++) {
            ...
            if (
                ...
                setTokenIdChristmasSpirit(tokenId, i * 2);
                return i.toString();
            }
    ...
    function hash(
        ...
        uint256 _largerandom = 
         ...
         for (uint8 i = 0; i < 1; i++) {            
            ...
            currentHash = string(
                abi.encodePacked(currentHash, christmasSpiritGen(_t, _randinput, i))
            );
        } 
    ...
    function lightTree(uint256 tokenQuantity) external payable {
    ...
    function mintInternal() internal {
        ...
        tokenIdToChristmasSpiritCount[thisTokenId] += 8;
   ...
   /**
        ...
        returns (string memory)
    {
        ...
        bool[17][22] memory placedPixels;
        ...
        svgString = string(
            abi.encodePacked(
                '<svg id="c" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 26 26" style="background-color:#ffe4bc" > ',
                svgString,
                "<style>rect{width:1px;height:1px;}.c00{fill:#fbf236}.c01{fill:#cfc72f}.c02{fill:#ffa6a6}.c03{fill:#fff200}.c04{fill:#b2dd93}.c05{fill:#4b682e}.c06{fill:#ac3231}.c07{fill:#663931}.c08{fill:#e3e3e3}.c09{fill:#ddffc5}.c10{fill:#bc9dff}.c11{fill:#99e550}.c12{fill:#5fcde4}.c13{fill:#d77bba}.c14{fill:#857bd7}.c15{fill:#df7426}.c16{fill:#f8e0da}.c17{fill:#398a30}.c18{fill:#ff3600}.c19{fill:#f2ff00}.c20{fill:#00ff1b}.c21{fill:#1b00ff}.c22{fill:#fcffc0}.c23{fill:#ac3232}.c24{fill:#983030}.c25{fill:#639bff}.c26{fill:#7cdd90}.c27{fill:#c0dbff}.c28{fill:#ffffff}</style></svg>"
        ...
        returns (string memory)
    {
        ...
        metadataString = string(abi.encodePacked(metadataString, '{"display_type": "boost_number", "trait_type": "BB Boost", "value":',NFTreeLibrary.toString(tokenIdToChristmasSpiritCount[_tokenId]),'}'));
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    ...
                                    '", "description": "The BlockNFTree collection serves as the first phase of Ben Baller Did The BlockChain.", "image": "data:image/svg+xml;base64,',
                                    NFTreeLibrary.encode(
        ...
        returns (string memory)
    {
        ...
        if (ownerOf(_tokenId) == 0x000000000000000000000000000000000000dEaD) {
            tokenHash = string(
                abi.encodePacked(
                    "1",
                    NFTreeLibrary.substring(tokenHash, 1, 4)
                )
            );
        }
