...
contract TestWhitelistPass is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
	...
	uint256 public WHALE_PASS_LIMIT = 50;
	
	uint256 public RESERVED_MINTED;
	uint256 public PRESALE_MINTED;
	uint256 public SALE_MINTED;
	
	uint256 public PRESALE_PRICE = 300 * 10**14;
	uint256 public SALE_PRICE = 500 * 10**14;
    ...
    event CreateWhiteListPass(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Test WhitelistPass", "TWLP") {
		setBaseURI(baseURI);
        pause(true);
    }
