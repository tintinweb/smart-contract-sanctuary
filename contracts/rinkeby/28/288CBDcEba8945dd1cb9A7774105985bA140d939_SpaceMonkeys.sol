...
import "./Counters.sol";
import "./ERC721.sol";
import "./ISpaceMonkeysMintPass.sol";
import "./ISpaceMonkeysPreMintPass.sol";
...
contract SpaceMonkeys is ERC721 {
    ...
    ISpaceMonkeysMintPass SpaceMonkeysMintPassContract;
    ISpaceMonkeysPreMintPass SpaceMonkeysPreMintPassContract;
    ...
    function setMintPassContractAddress(address _contractAddress) public onlyOwner {
        SpaceMonkeysMintPassContract = ISpaceMonkeysMintPass(_contractAddress);
    }
    ...
    function setPreMintPassContractAddress(address _contractAddress) public onlyOwner {
        SpaceMonkeysPreMintPassContract = ISpaceMonkeysPreMintPass(_contractAddress);
    }
    ...
    function mintReserveSpaceMonkeys() public onlyOwner {
        require(!teamMintHappened, "Team Mint Has already happened");
        _mintToken();
        _mintToken();
        _mintToken();
        _mintToken();
    ...
    function preMintSpaceMonkeys() public payable {
        require(teamMintHappened, "Pre minting isn't yet avalible");
