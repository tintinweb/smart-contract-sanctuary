...
contract PunkAsses is ERC721,ERC721Enumerable, Ownable {
    ...
    function setPixels(address _pixels) external onlyOwner { 
         Pixels = InterfacePixels(_pixels); 
    }

    function PunkAsseMint(uint256 num) public payable {
