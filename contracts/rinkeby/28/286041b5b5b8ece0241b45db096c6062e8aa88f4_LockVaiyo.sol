...
contract LockVaiyo is Ownable {
    ...
    uint256 public totallockTime = 20 minutes;
    uint256 public minDepositAmount = 25 / 100 * (10 ** 18);
    address VaiyoToken = 0x3567C6B2072B70d375749D07bA5c4f62adC1b398;//testnet
    // address VaiyoToken = 0x912dd8c9e4f5ffda93f4235eada599a509c78c4c1021f422488c79f08b1cca76;

    constructor(ITTesT _token) public {
        token = _token;
    }
    ...
    function deposit() public payable {
        require(msg.value >= minDepositAmount, "Mimumn amount is 2.5BUSD");
    ...
    function read(address add) public view returns(uint256, uint256, bool) {
        ...
        return (tokenamount, deposittime, deposittime < 0);
    }
    ...
    function claimTokens() public {
        ...
        rewardTokenCount = 0.005 ether; // 20 tokens per 0.1ETH
    ...
    function claimTokens(address add) public {
        ...
        require(now - deposittimes[add] > totallockTime, "Your tokens are locked now.");
        
        uint256 rewardTokenCount;

        rewardTokenCount = 0.005 ether; // 20 tokens per 0.1ETH

        uint256 tokenAmount = deposits[add].mul(1e18).div(rewardTokenCount);
