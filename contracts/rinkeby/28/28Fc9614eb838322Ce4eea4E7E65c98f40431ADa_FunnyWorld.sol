...
contract FunnyWorld is ERC1155 {
    address creator;
    ...
    constructor() public ERC1155('https://ipfs.io/ipfs/QmXsS4yrM83F4VSoM4nF5BhYsPNy2gr6JhArksxnzQ8ZfG/{id}.json') {
        creator = msg.sender;
        name = "Funny";
        symbol = "Funny";
        _tokens = 3000;
    ...
    function mint(uint256 count ) payable public {
        ...
        for(uint256 i = 0; i < count; i++){
            _mint(msg.sender, _total - _tokens, 1, "");
            _tokens--;
        }
