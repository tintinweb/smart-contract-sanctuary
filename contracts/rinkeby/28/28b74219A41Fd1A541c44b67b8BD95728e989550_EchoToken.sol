...
contract EchoToken is Initializable, ERC20Upgradeable {
    ...
    function _calculateRedistributionAmount(uint256 amount) internal pure returns (uint256 remainder, uint256 distAmount) {
