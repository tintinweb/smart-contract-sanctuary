...
/// @dev Everything
contract NonFungibleTimeCollectionV2 is IERC2981, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function callMePlease() public pure returns (string memory) {
        return "I'm upgraded sir";
    }
