...
contract Puppy is ERC721, ERC721Enumerable, Verify, ReentrancyGuard{
    constructor(address _verificationAddress, string memory _base) ERC721("Puppy2", "PUP2") Verify(_verificationAddress){
        baseURI = _base;
    }
