...
contract RSToken is ERC20Interface, Owned {
    using SafeMath for uint256;

    string public symbol = "RRST";
    string public name = "RealRSFirstToken";
    ...
    function transferFrom(
        ...
        require(allowed[from][msg.sender] >= tokens, "exceed allowance amount");
