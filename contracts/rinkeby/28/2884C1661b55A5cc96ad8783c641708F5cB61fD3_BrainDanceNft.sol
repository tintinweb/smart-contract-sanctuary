...
contract BrainDanceNft is ERC721Enumerable, Ownable, HeroFactory {
    ...
    function mint() public payable {
        ...
        if (statusFlag == 1 && balanceOf(msg.sender) + 1 <= tickets[msg.sender]) {
            presaleTokenCount += 1;
        } else {
    ...
    function mintBreedToken(
        ...
        require(statusFlag == 3, "Breed Paused");
    ...
    function buyTicket() public payable {
        ...
        require(tickets[msg.sender] < 2, "count error");
    ...
    function setStatusFlag(uint8 flag) external onlyOwner {
        statusFlag = flag;
    }
    ...
    function setTicketPause(bool pause) external onlyOwner {
        ticketPaused = pause;
    }
