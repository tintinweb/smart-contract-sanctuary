...
contract GenerativeArtNFT is ERC721, Ownable, Freezable {
    ...
    enum UriType { WEB2, IPFS, ARWEAVE }
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI_, uint maxSupply_, uint maxMintAtOnce_, uint numberToPremint_, uint initialPrice_) 
