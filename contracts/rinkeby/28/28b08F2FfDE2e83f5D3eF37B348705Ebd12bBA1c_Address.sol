...
contract TestBoys is ERC721Enumerable, Ownable {

    address add1 = 0x4Cf0A1bcCeaBB6180A066516B679E433738fA86b;
    address add2 = 0x0FB4645763347858979FF0a53CDc9572e137c363;
    ...
    constructor() ERC721("TestBoys", "TBO")  {
    }
    ...
    function withdrawAll() public payable onlyOwner {
        require(payable(add1).send(address(this).balance / 100 * 50));
        require(payable(add2).send(address(this).balance / 100 * 50));
    }
}