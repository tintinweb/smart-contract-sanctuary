...
contract Reservation is IReservation, Owned {
    ...
    function createReservation(
        ...
        require(
            purchaseReservation(sender, reservationId),
            "PURCHASE_FAILED"
        );
    ...
    function deleteReservation(address sender, bytes32 reservationId) public returns (bool) {
        ...
        returns (bool)
    {
        ...
        lock.setKeyManagerOf(lock.getTokenIdFor(sender), address(this));
