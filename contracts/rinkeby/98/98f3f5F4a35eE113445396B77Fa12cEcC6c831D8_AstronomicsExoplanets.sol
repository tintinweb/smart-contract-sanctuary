...
contract AstronomicsExoplanets is ERC1155, Ownable {
    ...
    uint256 public planetPrice = 300000000000000; // 0.0003 ETH
    // uint256 public planetPrice = 400000000000000000; // 0.4 ETH
    ...
    // pass loadingURI into contructor, but not final URI
    ...
    // override for custom uris
    function uri(uint256 _tokenId) override public view returns (string memory) {
      if (baseTokenUriNotSet) {
        // pre-reveal metadata
        return "https://gateway.pinata.cloud/ipfs/QmaYC4w6MHuwdoJ9b3Wca9HJ1Ea8KwiE1CSEtj8Wk3JjQg";
      }
    ...
    */
    ...
    function reservePlanets(address _to, uint _reserveAmount) public onlyOwner {
        require(totalSupply() + _reserveAmount <= MAX_PLANETS, "Exceeds Max. Supply of 4000 Planets");
    ...
    function mintPlanets(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxPlanetPurchase, "Maximum of 5 Allowed");
        require(totalSupply() + numberOfTokens <= MAX_PLANETS, "Exceeds Max. Supply of 4000 Planets");
