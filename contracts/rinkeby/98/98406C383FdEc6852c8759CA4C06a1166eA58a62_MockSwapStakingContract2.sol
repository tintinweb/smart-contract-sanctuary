...
import "../SwapStakingContract.sol";
...
contract MockSwapStakingContract2 is  SwapStakingContract {    
    ...
    function executeWithdrawal() external override nonReentrant whenNotPaused {
        ...
        uint256 daysPassed = (block.timestamp - stakeDeposit.endDate);// for mock / 1 days;
    ...
    ReentrancyGuardUpgradeSafe
{
        ...
        returns (uint256, uint256) 
    {
        return(
            ...
            _withdrawStates[account].initiateDate + unstakingPeriod
        );
    }
