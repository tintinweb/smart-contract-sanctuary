...
contract TheSadCats is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  string public baseTokenURI; // = "https://thesadcats.sadgirlsbar.io/json/";
//  address public sgbAddress = 0x335eEEF8e93A7A757D9e7912044d9cd264e2b2D8; // PROD
  address public sgbAddress; // = 0x2d0cEb6F49084dCF0e17aA6D7e9a7a8cc1111c4D; // TEST
  uint256 public _maxBatchSize = 20;
//  uint public catPrice = 0.05 ether; // PROD
  uint public catPrice = 0.0001 ether; // TEST
