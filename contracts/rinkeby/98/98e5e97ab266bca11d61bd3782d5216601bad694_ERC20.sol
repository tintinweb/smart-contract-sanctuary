...
// File: contracts/token/ERC20/Moth.sol
...
/**
 * @title Moth
 * @dev Implementation of the Moth
 */
contract Moth is ERC20Burnable, ServicePayer {
    ...
    constructor (
        ...
        ERC20(name, symbol)
        ServicePayer(feeReceiver, "Moth")
        payable
    {
        require(initialBalance > 0, "Moth: supply cannot be zero");
