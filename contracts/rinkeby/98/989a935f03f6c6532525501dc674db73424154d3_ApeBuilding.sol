    ...
    UUPSUpgradeable
{
    ...
    function _beforeTokenTransfer(
        ...
        whenNotPaused
    {
        require(balancesbyTypeMap[to][typeOfBuildingByNFTId[tokenId]] > 0, "You don't have this token amount");
        balancesbyTypeMap[to][typeOfBuildingByNFTId[tokenId]] ++;
        balancesbyTypeMap[from][typeOfBuildingByNFTId[tokenId]] --;
