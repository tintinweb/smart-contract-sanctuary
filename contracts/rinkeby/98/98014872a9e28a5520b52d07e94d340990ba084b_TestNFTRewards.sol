...
contract TestNFTRewards is ERC721, Ownable {
    ...
    uint256 public RewardsUpgradPrice = 777000000000000000000;
    ...
    */
    ...
    function setRewardsUpgradPrice(uint256 _newPrice) external onlyOwner {
        RewardsUpgradPrice = _newPrice;
    }
    ...
    function getTotalRewardsBalance(address _address) public view returns (uint256) {
        ...
        require(nftIds.length > 0, "This address does not have a token");
    ...
    function setRewardDividend(uint _id, uint256 _amount) public  {
        ...
        uint256 tokenAmount = _amount.mul(RewardsUpgradPrice);
    ...
    function claimAllRewards(address _address) public returns (uint256) {
        ...
        require(tokenIds.length > 0, "You have no NFT");
        uint256 totalSpent = 0;
