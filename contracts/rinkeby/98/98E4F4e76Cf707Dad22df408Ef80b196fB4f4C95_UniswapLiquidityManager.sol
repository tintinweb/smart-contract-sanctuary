...
// import "../libraries/UniswapDetails.sol";
...
contract UniswapLiquidityManager is PeripheryPayments, IUniswapLiquidityManager {
    ...
    // uint256 private feesPercentageIndexFund;
        ...
        returns (uint256 fees0, uint256 fees1)
    {
        ...
        (uint256 tokensOwed0, uint256 tokensOwed1, , ) = UserPositions
            .getTokensOwedAmount(
                position.feeGrowth0,
                position.feeGrowth1,
                position.liquidity,
    ...
    function readjustLiquidity(
        ...
        if ((b.amount0 == 0 || b.amount1 == 0)) {
            ...
            b.exactSqrtPriceImpact =
                (b.sqrtPriceX96 *
                    (IUniStrategy(unipilotProtocolDetails.uniStrategy).pricethreshold() /
                        2)) /
                1e6;
            ...
            b.amountIn = FullMath.mulDiv(
                b.amountIn,
                IUniStrategy(unipilotProtocolDetails.uniStrategy).swapPercentage(),
                100
            );
        ...
        )
    {
        ...
        (
            ...
            a.feeGrowthGlobal0,
            a.feeGrowthGlobal1
        ) = UserPositions.getTokensOwedAmount(
