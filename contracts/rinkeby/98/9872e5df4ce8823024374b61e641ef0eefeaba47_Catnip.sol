...
// TODO - with the proxy get a base storage layout, that way we can control most variables maybe?
...
contract Catnip is Context, IBEP20, Initializable {
    ...
    function initialize() public {
        ...
        reflectTokensOwned[_msgSender()] = _rTotal;     // TODO - rename variables after understanding them
    ...
    function transferFromAirDrop(address sender, address recipient, uint256 amount) public returns (bool) {
    ...
    function deliverReflectTokens(uint256 tAmount) public {     // TODO - figure this out
    ...
    function tokenFromReflection(uint256 rAmount) public view returns (uint256){        // TODO - figure this out
    ...
    function getCurrentSupplyTotals() private view returns (uint256, uint256) { // TODO - figure out
    ...
    function transferInternal(address senderAddr, address receiverAddr, uint256 amount, bool isAirDropTransfer) private {   
    ...
    function airDropClaim() public {
        ...
        transferFromAirDrop(ownerOfToken, claimer, amountToGiveClaimer.mul(10**9));       // transfers the airdrop amount from the owner address to the claimer
    ...
    // TODO - Remove Function In Production
    function airDropClaimWeekSimulation(uint256 NumberOfWeeksToTest) public {
        ...
        // TODO - remove out of testing, this is only for adddition with testing
