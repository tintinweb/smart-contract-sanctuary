...
contract Chubbies is ERC721, Ownable {
    ...
    // event ChubbyAdopted(address indexed recipient, uint256 tokenId, uint256 pricePaid);
    ...
    function tokensOfOwner(address _owner) external view returns(uint256[] memory ) {
        ...
        if (tokenCount == 0) {
            console.log('tokensOfOwner: tokenCount == 0');
            // Return an empty array
            return new uint256[](0);
        } else {
            console.log('tokensOfOwner: compiling ur tokens...');
   ...
   function adoptChubby(uint256 numChubbies) public payable {
        console.log("hello from adoptChubby, msg.sender=>", msg.sender);
        ...
        for (uint i = 0; i < numChubbies; i++) {
            ...
            console.log("time to emit ChubbyAdopted, mintIndex =>", mintIndex);
            // emit ChubbyAdopted(msg.sender, mintIndex, msg.value);
