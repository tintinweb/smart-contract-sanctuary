...
import "../../token/ERC777/ERC777Mint.sol";
import "./interfaces/IMasterERC777.sol";
import "../../access/ContractOwner.sol";

contract MasterERC777Mint is ContractOwnable, IMasterERC777 {
  ERC777Mint[] private childERC777Mint;
  ...
  function createERC777(
    ...
    ERC777Mint child = new ERC777Mint(
      name,
      symbol,
      decimal,
    ...
    childERC777Mint.push(child);
    emit ChildCreatedERC777(address(child), name, symbol);
  }
}
