...
contract BASTARDOUSMEMES is ERC721, ERC2981PerTokenRoyalties, AccessControl {
    ...
    constructor()
        ERC721("BASTARDOUS MEMES", "BGANMEMES")
    {
    ...
    // LEAVING THIS FUNCTION ON IN CASE SOMETHING FUCKS UP
    ...
    function mintMeme(
        ...
        _setTokenRoyalty(tokenId, to, 1000); // %10 royalty for secondary sales if marketplace platforms adopt
