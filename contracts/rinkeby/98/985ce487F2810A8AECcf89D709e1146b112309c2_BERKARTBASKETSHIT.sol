...
artbasketshit
random stuff / audio / video / audiovisual / conceptual / glitch / databending / codebending / noise
...
@berkozdemir
        ...
        [email protected]               `.~1\ ^vhPYPPhnu3};;;}ooI*+*oOo*,___"-^:[email protected]@[email protected][email protected]_       
...
contract BERKARTBASKETSHIT is ERC721Enumerable, ERC2981ContractWideRoyalties, AccessControl {
    ...
    constructor()
        ERC721("berk aka princesscamel artbasketshit", "BERKAKAPRINCESSCAMELARTBASKETSHIT")
    {
