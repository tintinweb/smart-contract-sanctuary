...
contract TaxOfficeV2 is Operator {
    ...
    constructor (address _wftm, address _galaxy, address _uniRouter) {
        wftm = _wftm;
        galaxy = _galaxy;
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtGalaxy, resultAmtFtm, liquidity) = IUniswapV2Router(uniRouter).addLiquidityETH{value: msg.value}(
            galaxy,
            amtGalaxy,
            amtGalaxyMin,
            amtFtmMin,
        ...
        return (resultAmtGalaxy, resultAmtFtm, liquidity);
    }
