...
contract BonnyRoyals is ERC721, Ownable {
    ...
    constructor() ERC721("Bonny Royals", "BOR") {
        setNotRevealedURI('https://gateway.pinata.cloud/ipfs/QmXpUqkrBM2qXh6xX6AvyJUAjEDGeMUtJTMXZTg5izny5G/hidden.json');
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmbF8EbM6nqjerop5hNLthxK4EXL1T9aGuTxiEUgojahcQ/");
    }
