...
contract MiraNft is Ownable, ERC721URIStorage {
    ...
    // Token owner => token spender => token ID
    mapping(address => mapping(address => uint256)) internal ownerApprovals_;
    ...
    function approveTransfer(
        ...
        ownerApprovals_[_from][_to] = _tokenId;
        // TODO multiple approves [tokeId][to]
    }
