...
contract NFTest is ERC721Enumerable, Ownable{
    ...
    constructor(string memory _value) ERC721("NFTest", "NFTe") {
        setBaseURI(_value);
        mintGiveaway();
    }

    // Hash of images at original index: f51cbada3f2b27d48c92d520d1e301bf43e1340a7c9b9559c8fbbb3e8b68893d
    ...
    address public constant Address1 = 0x1f5EDc172dafAD979917749651Fd807955425dEC; // Artist
    address public constant Address2 = 0x5F553361C0DB8544B75ae3689F28C963A0d8E783; // Community lead
    address public constant Address3 = 0x596261D50EE888698AB61dE1b1513E667943ef08; // Dev
    address public constant Address4 = 0x4eCDd8564c42033A604e91CEEc77c69505982957; // Community wallet
    ...
    function mintToken(uint256 _amount) public payable{
        require( (_amount + totalSupply() ) <= MAX_MINTED, "Amount is beyond availiable tokens");
