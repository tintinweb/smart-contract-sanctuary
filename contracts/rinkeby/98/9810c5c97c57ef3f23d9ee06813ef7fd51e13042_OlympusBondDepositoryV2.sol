...
/* ======== CREATE ======== */
  ...
  function create(
    ...
    /*
     * the names array provides front end operators with a title for the market.
     * note that front end operators can also distinguish Uniswap V2 LP bonds, 
     * and their corresponding exchange, from the factory() view function
     * present on Uniswap V2 pair tokens.
     *
...
/* ======== EXTERNAL VIEW ======== */
  ...
  function payoutFor(uint256 _amount, uint256 _id) external view override returns (uint256) {
    ...
    return 
      _amount
      * 1e18 // = ohm decimals (9) + market price decimals (9)
      / marketPrice(_id)
