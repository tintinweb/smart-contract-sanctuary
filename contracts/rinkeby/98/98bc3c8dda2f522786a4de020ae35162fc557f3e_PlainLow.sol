...
contract PlainLow is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("PlainLow", "PLW") {
    setHiddenMetadataUri("ipfs://QmXKRRW3YQoJijGNJDq2ZBSwppUxwaT3ivFMpkaFN41mNL/hidden.json");
  }
