...
contract PolyPixos is ERC721, ERC721Enumerable, ERC721Burnable, ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    constructor() ERC721("PolyPixos", "POLYPIXOS")
    {
    }
    
    uint256 public constant MAX_SUPPLY = 1_000;

    uint256 public constant RESERVED_SUPPLY = 20; // Marketing/Team
    ...
    function mintPresale(uint256 numberOfNfts) external nonReentrant {
        require(saleIsActive, "Sale did not start");
