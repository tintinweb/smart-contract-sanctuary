...
contract Stake is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 erc20Reward = nrOfBlocks
            ...
            .mul(pool.allocPoint)
            .div(totalAllocPoint);
        console.log(erc20Reward);
        console.log("aaaaa");
        pool.accERC20PerShare = pool.accERC20PerShare.add(
            erc20Reward.mul(1e36).div(lpSupply)
        );
        console.log(pool.accERC20PerShare);
        ...
        )
    {
        ...
        userInfo[_pid][_user].amount > 0 ? totStaked : totStaked += _lpAmount;
    ...
    // function apr(uint256 _pid) public returns (uint256) {
    //     PoolInfo memory pool = poolInfo[_pid];
    //     uint256 totalERC20Amount = (totalStaked * pool.accERC20PerShare) / 1e18;
    //     uint256 rewardOneBlock = (rewardPerBlock * totalStaked) / 1e18;
    //     uint256 rewardOneDay = rewardOneBlock * 28653;
    //     // Binance average 1 year total block count (28653 * 365) = 10458345
    //     uint256 rewardOneYear = rewardOneBlock * (28653 * 365);
    //     return (rewardOneYear * 1e18) / totalERC20Amount;
    // }
}
