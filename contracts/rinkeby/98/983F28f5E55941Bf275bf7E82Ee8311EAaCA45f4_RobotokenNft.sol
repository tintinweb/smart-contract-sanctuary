...
contract RobotokenNft is RobotokenNftSale {
    ...
    function withdraw() external {
        uint256 amount = address(this).balance - refRewardsTotal;
    ...
    function withdrawErc20(address tokenAddress) external {
        ...
        (bool success, bytes memory data) = tokenAddress.call(
            abi.encodeWithSelector(
                0xa9059cbb,
                owner(),
                IERC20B(tokenAddress).balanceOf(address(this))
            )
        );
        require(
...
abstract contract RobotokenNftSale is ERC721, Ownable {
    // Airdrop
    uint256 public constant airdropStartTime = 1640331600; // TODO
    ...
    // Presale
    uint256 public constant presalePrice = 0.0001 ether; // TODO
    uint256 public constant presaleStartTime = 1640331900; // TODO
    mapping(address => bool) public presaleWhitelist;

    // Sale
    uint256 public constant salePrice = 0.00012 ether; // TODO
    uint256 public constant saleStartTime = 1640332200; // TODO
