...
contract XGLD is Context, Ownable, ERC20 {
    address public badgeContractAddress = 0xCf12F95CE89a88853DcCA23E460aaE38c834611B;
...
//        return badgeContract.getCostUserTotalSupply() >= 7999 - 999 - 200;
        return badgeContract.getCostUserTotalSupply() >= 7999 - 7997;
    }
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        require(checkFinish(),"MUST_BADGE_FINISH");
    ...
    onlyOwner
    {
        badgeContractAddress = lootContractAddress_;
        badgeContract = BadgeInterface(badgeContractAddress);
    }
