...
contract TST is ERC721Enumerable, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/13/metadata/";
	string private _contractURI = "https://tokenfy-staging.s3.us-east-2.amazonaws.com/13/contract-uri";
  ...
  uint256 public presaleEndDate = 0;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("TST", "TST") {
