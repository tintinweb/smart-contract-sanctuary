...
contract DingoDinos is ERC721Enumerable, Ownable {
    ...
    // Test addresses
    address a1 = 0x48bE675BaeaEbcC99055d20fcdCbdb29f7612c51;
    address a2 = 0x056aB1CD0f0D6DC88Ac7d55C11FB8b44990c3bf0;
    ...
    function preSaleMint(uint256 mintCount) public payable {
        ...
        require(supply < 700,                               "max_token_supply_exceeded");
        ...
        require(balanceOf(msg.sender) < 5,                  "presale_wallet_limit_met");
    ...
    function mint(uint256 mintCount) public payable {
        // todo - dynamically set the limit? https://www.youtube.com/watch?v=MLtUIpj0zJo @21:00
        uint256 supply = totalSupply();

        require(_saleIsActive,                      "sale_not_active");
        require(mintCount < 20,                     "max_mint_count_exceeded");
        require(supply + mintCount < 500,           "max_supply_exceeded");
