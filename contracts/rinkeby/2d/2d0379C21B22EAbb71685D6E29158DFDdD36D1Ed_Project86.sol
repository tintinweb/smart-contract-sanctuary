...
contract Project86 is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/86/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/86/contract-uri";
	...
	uint256 public pricePerToken = 123000000000000000;
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("Collection name of contract", "TID") {
