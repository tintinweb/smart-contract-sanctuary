...
contract FrostyMarketplace is Context, ReentrancyGuard {
    ...
    constructor(
        ...
        require(_monaErc20Token != address(0), "FrostyMarketplace: Invalid ERC20 Token");
    ...
    function buyOffer(uint256 _garmentCollectionId, bool _payWithFrst) external payable nonReentrant whenNotPaused {
        ...
        if(_payWithFrst) {
            require(!freezeFrstERC20Payment, "FrostyMarketplace.buyOffer: mona erc20 payments currently frozen");
            ...
            require(IERC20(monaErc20Token).allowance(msg.sender, address(this)) >= amountOfFrstToTransfer, "FrostyMarketplace.buyOffer: Failed to supply ERC20 Allowance");
            // Transfer ERC20 token from user to contract(this) escrow
            IERC20(monaErc20Token).transferFrom(msg.sender, garmentNft.garmentDesigners(garmentTokenId), amountOfFrstToTransferToDesigner);
            IERC20(monaErc20Token).transferFrom(msg.sender, platformFeeRecipient, amountOfFrstToTransferAsFees);
