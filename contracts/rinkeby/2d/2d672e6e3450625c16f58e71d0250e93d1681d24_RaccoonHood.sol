...
contract RaccoonHood is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public TOTAL_SUPPLY = 10000;

    uint256 public coonPrice = 20000000000000000;
    ...
    function reserveCoons() public onlyOwner {
    ...
    function mintCoons(address _to, uint numberOfTokens) public payable {
        ...
        require(_currentTokenId.add(numberOfTokens) <= TOTAL_SUPPLY, "Purchase would exceed max supply of Coons");
