...
contract WalletFactory is CloneFactory, IWalletFactory {
  ...
  constructor(address _implementationAddress,address _coldWalletAddress, address _owner1, address _owner2, address _owner3) {
    ...
    function showColdWalletAddress() public override view returns(address){
        return(coldWalletAddress);
    }
    function showDeployerAddress()public override view returns(address){
        return(deployer);
    }
    
    function isOwnerOrNot()public override view returns(address, address, address){
        return(ownerAddress['owner1'], ownerAddress['owner2'], ownerAddress['owner3']);
    }
    
    function allowTochangeColdWalletAddress()public override{
    ...
    function changeColdWalletAddress(address _coldWalletAddress)public override {
    ...
    function allowToChangeDeployer()public override{
        require(msg.sender == ownerAddress['owner1']
         || msg.sender == ownerAddress['owner2']
         || msg.sender == ownerAddress['owner3']);
    ...
    function changeDeployer(address _deployer)public override{
    ...
    function allowToChangeOwner(address _targetedAddress)public override{
         require(msg.sender == ownerAddress['owner1']
         || msg.sender == ownerAddress['owner2']
         || msg.sender == ownerAddress['owner3']  );
    ...
    function notAllowToChangeOwner()public override{
        require(msg.sender == ownerAddress['owner1']
         || msg.sender == ownerAddress['owner2']
         || msg.sender == ownerAddress['owner3']  );
    ...
    function createWallet(bytes32 salt) override
        external
    {
  ...
  function changeOwner(address _owner, address _changeOwnerTo)public override{
      require(msg.sender == ownerAddress['owner1']
         || msg.sender == ownerAddress['owner2']
         || msg.sender == ownerAddress['owner3']  );
