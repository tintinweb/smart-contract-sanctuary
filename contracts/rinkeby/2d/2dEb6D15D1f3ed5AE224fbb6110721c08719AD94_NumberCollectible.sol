...
// File: NumberCollectible.sol

contract NumberCollectible is ERC721, VRFConsumerBase {
    uint256 public tokenCounter;
    enum oddOrEven{EVEN, ODD}
    uint256 Value;
    // add other things
    mapping(bytes32 => address) public requestIdToSender;
    mapping(bytes32 => string) public requestIdToTokenURI;
    mapping(uint256 => oddOrEven) public tokenIdTooddOrEven;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        oddOrEven oddOrEven = oddOrEven(Value % 2); 
        tokenIdTooddOrEven[newItemId] = oddOrEven;
        tokenIdToValue[newItemId] = Value;
