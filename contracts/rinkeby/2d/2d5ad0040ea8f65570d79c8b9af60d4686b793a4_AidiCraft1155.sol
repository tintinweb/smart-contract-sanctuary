...
contract AidiCraft1155 is ERC1155, Ownable, ERC1155Burnable{
    ...
    IInterfaceAidiFee aidifeecon = IInterfaceAidiFee(0x937FB725A26955d2c2BE2F36F4c0Dc0337F9dB88);
    ...
    constructor(
        ...
        addTokenType("WETH",0x6Ad21c4C2e6704f3a3cd8E46E4A9Ce945057d0c6);//todo change to WETH mainnet
        addTokenType("VERSE",0xac6b61387277f3d150a4900bc320D2F793FB3B55);//todo change to Verse mainnet
    }
    ...
    function _saleToken(
        ...
        if(keccak256(abi.encodePacked((bidtoken))) == keccak256(abi.encodePacked(("ETH")))){   
         ...
         uint256 servfee =   aidifeecon.getServiceFee();
            ...
            (uint256 _adminfee, uint256 roy, uint256 netamount) = calc(amount, _royal[tokenId], servfee);
            ...
            from.transfer(netamount);
                     ...
                     uint256 dyntokfee=  aidifeecon.getTokenFee(bidtoken);
            ...
            require( approveValue >= _adminfee.add(roy.add(netamount)), "Approved value mismatch");
    ...
    function acceptBId(string memory bidtoken,address bidaddr, uint256 amount, uint256 tokenId, uint256 numOfToken) public{
        _acceptBId(bidtoken, bidaddr, amount, tokenId, owner());
        tokenTrans(tokenId, msg.sender, bidaddr, numOfToken);
    ...
    function _acceptBId(string memory tokenAss,address from, uint256 amount, uint256 tokenId, address admin) internal{
        ...
        require(_balances[tokenId][msg.sender] > 0, "You should be the token owner");
        (uint256 _adminfee, uint256 roy, uint256 netamount) = calc(amount, _royal[tokenId], dyntokfee);
    ...
    function burnToken(address from, uint256 tokenId, uint256 numOfToken ) public{
        ...
        require( _balances[tokenId][from] >= numOfToken, "You should be the token owner and must have sufficient balance!");
            ...
            if(_balances[tokenId][from] == numOfToken){
