...
contract RoninPunks is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable{
    ...
    uint256 public maxPunksTemp = 5800;
    ...
    function mintReservedPunks(uint256 quantity)public onlyOwner{
        require(_tokenIdTracker.current() <= 5800,"RoninPunks: Cannot mint reserved NFT!");
    ...
    function mint() public payable{
        ...
        require(totalSupply <= 5800, "RoninPunks: All public sale Punks are minted!");
