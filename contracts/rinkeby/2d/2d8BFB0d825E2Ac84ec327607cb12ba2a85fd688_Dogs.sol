...
contract Dogs is ERC721Enumerable, Ownable, ReentrancyGuard {
  using Strings for uint256;

  address constant founder = 0x05343aDE6Fc7d42d33Cf75fFd3fd9F671Ef012b0;
  address constant payout = 0x05343aDE6Fc7d42d33Cf75fFd3fd9F671Ef012b0;
  ...
  string constant provenance = "bb8f45cd466b49c2edc09060114521c802c4be2096958908ab9ffff5bbaf6992";
  ...
  constructor(string memory unrevealedURI) ERC721("Art Dogs Collective", "ADC") {
    ...
    // Owner gets Founder and Golden Dogs
    _safeMint(founder, 0);
    _safeMint(payout, 1);

    transferOwnership(payout);
  }
