...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string baseSvg = "<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 350 350'> <style>.base { fill: white; font-family: serif; font-size: 24px; }</style> <rect width='100%' height='100%' fill='black' /> <rect width='117' x='0' y='0' height='100%' fill='";
  string oneToTwo = "' /> <rect width='117' x='117' y='0' height='100%' fill='";
  string twoToThree = "' /> <rect width='117' x='234' y='0' height='100%' fill='";
  string endSvg = "' /> </svg>";
  ...
  string[] colors = ["#f72585ff",  
  "#b5179eff",
  "#7209b7ff", "#560badff", " #480ca8ff", "#3a0ca3ff", "#3f37c9ff", " #4361eeff", "#4895efff", "#4cc9f0ff"];

  event NewEpicNFTMinted(address sender, uint256 tokenId);


  // I create a function to randomly pick a word from each array.
  function pickRandomColor(uint256 tokenId, string memory seed) public view returns (string memory) {
  ...
  function makeAnEpicNFT() public {
    ...
    string memory c1 = pickRandomColor(newItemId, "first");
    string memory c2 = pickRandomColor(newItemId, "second");
    string memory c3 = pickRandomColor(newItemId, "third");

    string memory finalSvg = string(abi.encodePacked(baseSvg, c1, oneToTwo, c2, twoToThree, c3, endSvg));
