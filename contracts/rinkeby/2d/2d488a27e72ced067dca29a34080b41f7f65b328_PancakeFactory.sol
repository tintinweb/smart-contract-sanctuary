...
contract PancakeERC20 {
        ...
        string public constant name = 'NoaSwap LPs';
        string public constant symbol = 'NOA-LP';
...
contract PancakePair is PancakeERC20 {
        ...
        uint private reserve0_ = 1;
        uint private reserve1_ = 1;
        modifier lock() {
        ...
        function skim(address to) external lock {
                require(msg.sender == router); // gas savings
                address _token0 = token0; // gas savings
                address _token1 = token1; // gas savings
...
contract PancakeFactory is IPancakeFactory {
        ...
        constructor(address _feeToSetter, address _router) public {
        ...
        function createPair(address tokenA, address tokenB) external override returns (address pair) {
                ...
                PancakePair(pair).initialize(token0, token1, router);
