...
contract CL is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    //     require(statsMap[tokenId].ownedBy < 1, "OWNED");
    //     require(ownerOf(tokenId) == address(this));
    //     require(statsMap[battleId].mintBlock > 0, "Err1");
    //     require(((block.number - statsMap[tokenId].challengedBlock) < reset_timing), "Cool Down");
    //     require(tokenId != battleId, "Err");

    //     uint256 p1Luck = 50 + getWeaponLevel(tokenId) + reputation(tokenId);        
    //     uint256 p1Rand = random(string(abi.encodePacked(toString(block.number))));
    //     uint256 p1Draw = p1Rand % p1Luck;
    //     statsMap[tokenId].challengedBlock = block.number;
       
    //     uint256 p2Luck = 50 + getWeaponLevel(battleId) + reputation(battleId);
    //     uint256 p2Rand = random(string(abi.encodePacked(toString(block.number))));
    ...
    function getOwner(uint256 tokenId) public view returns (string memory) {
        if (statsMap[tokenId].ownedBy > 0) {
            return string(abi.encodePacked("Owned By: ", toString(tokenId)));
        }
        return "";
    }    
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = animFactory.draw();                
        parts[1] = headFactory.draw(1);
        ...
        parts[8] = string(abi.encodePacked("Reputation: ", toString(reputation(tokenId))));        
        parts[9] = '</text><text x="100" y="20" class="base owned">';        
        parts[10] = getHead(tokenId);        
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Biker #', toString(tokenId), '", "description": "Chain Bikerz is a NFT game stored on chain. Players may challenge to get into the lead. Bikers gain reputation every 6000 blocks", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    //     require(_count > 0.02, "Mint fee is 0.02 Eth");
...
library animFactory {
  ...
  function draw() public pure returns (string memory) {
    ...
    return string(abi.encodePacked(top, '<style> ',styles, ';</style><g transform="scale(2 2)  translate(42 20)">', anim1, '</g>'));
  }
  ...
  function _getCycle() internal pure returns (string memory) {
    string memory cycle =    
        ...
        unicode'<rect x="5" y="8" width="1" height="1" fill="#1533F6" />'
        ...
        unicode'<rect x="10" y="8" width="1" height="1" fill="#1533F6" />'
        ...
        unicode'<rect x="4" y="9" width="1" height="1" fill="#1533F6" />'
        unicode'<rect x="5" y="9" width="1" height="1" fill="#1533F6" />'
        ...
        unicode'<rect x="10" y="9" width="1" height="1" fill="#1533F6" />'
        unicode'<rect x="11" y="9" width="1" height="1" fill="#1533F6" />'
        ...
        unicode'<rect x="4" y="10" width="1" height="1" fill="#1533F6" />'
        unicode'<rect x="5" y="10" width="1" height="1" fill="#1533F6" />'
        ...
        unicode'<rect x="10" y="10" width="1" height="1" fill="#1533F6" />'
        unicode'<rect x="11" y="10" width="1" height="1" fill="#1533F6" />'
        ...
        unicode'<rect x="4" y="11" width="1" height="1" fill="#1533F6" />'
        unicode'<rect x="5" y="11" width="1" height="1" fill="#1533F6" />'
        ...
        unicode'<rect x="10" y="11" width="1" height="1" fill="#1533F6" />'
        unicode'<rect x="11" y="11" width="1" height="1" fill="#1533F6" />'
...
library headFactory {
  ...
  function _getHelmet(uint256 number) internal pure returns (string memory) {
    string memory helmet = 
      ...
      unicode'<rect x="7" y="4" width="1" height="1" fill="#555555" />'
      unicode'<rect x="8" y="4" width="1" height="1" fill="#555555" />'
      unicode'<rect x="9" y="4" width="1" height="1" fill="#30323F" />'
      unicode'<rect x="6" y="5" width="1" height="1" fill="#000000" />'
      unicode'<rect x="7" y="5" width="1" height="1" fill="#555555" />'
      unicode'<rect x="8" y="5" width="1" height="1" fill="#555555" />'
      ...
      string memory straight_long =
        unicode'<g transform="scale(2 2)  translate(42 13)">'
        unicode'<rect x="6" y="2" width="1" height="1" fill="#555555" />'
        unicode'<rect x="7" y="2" width="1" height="1" fill="#30323F" />'
        unicode'<rect x="8" y="2" width="1" height="1" fill="#555555" />'
        unicode'<rect x="9" y="2" width="1" height="1" fill="#555555" />'
        unicode'<rect x="6" y="3" width="1" height="1" fill="#000000" />'
        ...
        unicode'<rect x="8" y="6" width="1" height="1" fill="#EEC39A" />'
        unicode'</g>';
      string memory cowboy = unicode'<rect x="7" y="0" width="1" height="1" fill="#785B3F" />'
