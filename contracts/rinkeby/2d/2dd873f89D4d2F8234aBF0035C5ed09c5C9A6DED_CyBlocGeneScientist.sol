...
contract CyBlocGeneScientist {
    ...
    function generateGene(uint256 class, uint256[3] memory traits) public pure returns (uint256 genes, string memory genesString) {
        ...
        genesString = newGenesString;
        uint256 newGenes = toUint(newGenesString);
        genes = newGenes;
    }
    ...
    function toUint(string memory _string) public pure returns (uint256) {
