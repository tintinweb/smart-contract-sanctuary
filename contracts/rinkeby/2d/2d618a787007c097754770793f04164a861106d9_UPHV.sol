...
//                                                                                                                                          //
//                                                                                                                                          //
//            oyy      +yy`  /yyyyyyys+.   .yy/      yys   -yyyyyyyyyy/       yy/     oyy.      oyy` :yyyyyyyyyy/  :yyyyyyyyo-              //
//            hMM      yMM.  oMPhyyyymMMo  .MMs      NMm   :MUdyyyyyyy/      sMMM-    -MMy     :MMs  /MMhyyyyyyy:  +MMhyyyydMMs             //
//            hMM      yMM.  oMA:     dMM. .MMs      NMm   :MZ+             /MMdMm`    oMM:   `mMm   /MM:          +MM:     hMM.            //
//            hMM      yMM.  oMU:    .mMN` .MMy......NMm   :MAo......`     .NMs`mMh     dMm`  sMM-   /MM+......`   +MM+..../NMN`            //
//            hMM      yMM.  oMLNNNNNMMd-  .MMMMMMMMMMMm   :MMMMMMMMM/    `dMm  :MM+    -MMs -MMs    /MMMMMMMMM-   +MMMMMMMMNy.             //
//            hMM      yMM.  oMIs////:.    .MMy......NMm   :MMo......`    yMM+:::dMM-    oMM-dMm`    /MM+......    +MM+..yMMo               //
//            sMM/    .mMN   oMU:          .MMs      NMm   :MM+          /MMMMMMMMMMm`    mMNMM-     /MM:          +MM:   yMMs              //
//            `hMMmhhdMMm-   oMS:          .MMs      NMm   :MMmhhhhhhh+ .NMh      -MMh    -MMMs      /MMdhhhhhhh/  +MM:    sMMy             //
//              .+syyso:     :ss.          `ss/      oso   .ssssssssss/ +ss.       /ss.    /ss`      -ssssssssss:  :ss.     +ss/            //
//                                                                                                                                          //
//                                                                                                                                          //
//                                                                                                                                          //
//                                                                                                                                          //
...
contract UPHV is ERC1155Creator {
