...
contract METAMILLIONAIRE is ERC721, Ownable {
    ...
    uint256 public devAmount = 50 * 10**18;
    ...
    function withdrawAll() public onlyOwner {
        ...
        if (totalBalance < devAmount) {
            uint256 tempAmount = totalBalance.mul(30).div(100);
            uint256 clientAmount = totalBalance.sub(tempAmount);

            (bool withdrawDev, ) = devAddress.call{value: tempAmount}("");
            ...
            devAmount = devAmount.sub(tempAmount);
        } else {
