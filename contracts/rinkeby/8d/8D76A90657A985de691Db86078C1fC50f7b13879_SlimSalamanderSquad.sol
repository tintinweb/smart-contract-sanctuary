...
contract SlimSalamanderSquad is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    function PUBLICSALEMINT(uint16 numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= SSS_SUPPLY, "Sold Out");
        require(SSS_PRICE.mul(numberOfTokens) <= msg.value, "Ether amount sent is incorrect");
        require(numberOfTokens<=30, "Max 30 are allowed" );
    ...
    function shouldrequirewhitelist() external onlyOwner {
