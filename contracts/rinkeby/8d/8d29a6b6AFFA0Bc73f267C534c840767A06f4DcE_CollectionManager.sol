...
contract CollectionManager is ICollectionManager {
    ...
    function createCollection(
        ...
        Collection collection = new Collection(_uri, _name, _symbol, _startingAt, _payees, _shares);
...
contract Collection is ICollection, ERC1155, Ownable, PaymentSplitter {
    ...
    function create(string calldata _cid, uint256 _maxSupply) external override onlyOwner returns (uint256 _id) {
    ...
    function mint(address _account, uint256 _id) external payable onlyOwner {
...
interface ICollection {
    event Created(string, uint256, address);

    function create(string calldata _cid, uint256 _maxSupply) external returns (uint256 _id);

    function mint(address _account, uint256 _id) external payable;
}
