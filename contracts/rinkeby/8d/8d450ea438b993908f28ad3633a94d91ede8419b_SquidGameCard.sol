...
contract SquidGameCard is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint8 private constant _PICKSIZE = 5;
    uint16 private constant _MAX_CLAIMS = 30 * 5;
    uint16 private constant _MAX_OWNER_CLAIMS = 30;
    uint16 private constant _TIMELOCK_COUNT = 30;
    uint private constant _TIMELOCK_DURATION = 60 seconds;
    ...
    constructor() ERC721("Squid Game Card MINI", "SquidGameCard") Ownable() {
        mintPickSize();
