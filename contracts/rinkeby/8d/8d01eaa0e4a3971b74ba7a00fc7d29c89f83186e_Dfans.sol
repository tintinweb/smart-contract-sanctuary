...
contract Dfans is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
 ...
 constructor() ERC721("DissapointedFanss", "DFANSS") {
    setHiddenMetadataUri("ipfs://QmchfzQodn9h4PM4n4UrDGydhAzDxXkU8w7tJeLVyGKUmX/1.json");
  }
