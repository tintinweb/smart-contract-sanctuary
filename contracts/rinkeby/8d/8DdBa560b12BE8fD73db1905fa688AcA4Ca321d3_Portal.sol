...
import "../soldeps/openzeppelin/contracts/token/ERC20/extensions/draft-IERC20Permit.sol";
import "./IBridge.sol";
import "../soldeps/uniswap/contracts/libraries/TransferHelper.sol";
...
* @dev Internal function used in synthesize, synthesizeNative,
    ...
    function sendSynthesizeRequest(
        ...
        bytes memory out = abi.encodeWithSelector(
            bytes4(
                keccak256(
                    bytes(
                        "mintSyntheticToken(bytes32,address,uint256,uint256,address)"
                    )
                )
            ),
            txID,
...
pragma solidity ^0.8.0;
import "../../soldeps/openzeppelin/contracts/token/ERC20/IERC20.sol";
