...
contract brrsb is ERC721Enumerable, VRFConsumerBase, Ownable {
    ...
    */
    ...
    function getTokensReadyToBatch(uint256 batchType) internal view returns(uint256[] memory, bool hasBatch) {
    ...
    function returnReadyTokens(uint256 batchType) public view returns(uint256[] memory, bool hasBatch) {
    ...
    function batchFeed() public {
        (uint256[] memory batchArray, bool hasBatch) = returnReadyTokens(1);
        require(hasBatch, "nb");
    ...
    function batchPlay() public {
        (uint256[] memory batchArray, bool hasBatch) = returnReadyTokens(2);
        require(hasBatch, "nb");
        for (uint i = 0; i < batchArray.length; i++) {
            if (batchArray[i] != 0) {
                play(batchArray[i]);
    ...
    function batchPrestige() public {
        (uint256[] memory batchArray, bool hasBatch) = returnReadyTokens(3);
        require(hasBatch, "nb");
        for (uint i = 0; i < batchArray.length; i++) {
            if (batchArray[i] != 0) {
    ...
    function batchGetReward() public {
        (uint256[] memory batchArray, bool hasBatch) = returnReadyTokens(4);
        require(hasBatch, "nb");
        for (uint i = 0; i < batchArray.length; i++) {
            if (batchArray[i] != 0) {
