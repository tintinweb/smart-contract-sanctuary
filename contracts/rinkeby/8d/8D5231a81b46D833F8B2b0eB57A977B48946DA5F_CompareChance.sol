...
contract CompareChance is ERC721, ERC721Enumerable, Ownable {
    ...
    function shuffleAllBackpack(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllAllies(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllNemesis(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllDamageIntoxication(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllWeaponsCommunication(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllShieldsProtection(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllSurroundingSpaceBases(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllLandscapeBeingsCreatures(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllCurrenchAssets(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function shuffleAllTransportation(uint256 tokenId) internal view returns (string[75] memory) {
    ...
    function generateAllies(uint256 tokenId) private view returns (string[5] memory) {
        ...
        for (uint a = 0; a < 5; a++) {
            ...
            string[75] memory h = shuffleAllAllies(tokenId);
            uint256 x = q % l--;
            r[a] = h[x];
            l--;
    ...
    function generateNemesis(uint256 tokenId) private view returns (string[5] memory) {
        ...
        for (uint a = 0; a < 5; a++) {
            ...
            string[75] memory h = shuffleAllNemesis(tokenId);
            uint256 x = q % l--;
            r[a] = h[x];
            l--;
    ...
    function insertLine() private pure returns (string memory) {
        string memory line = "__________";
        return line;
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 2000 750"><style>.base { style="background-color:white" fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="black" /><text x="10" y="20" class="base">';
        ...
        parts[7] = generateAllies(tokenId)[0];

        parts[8] = '</text><text x="10" y="120" class="base">';

        parts[9] = generateAllies(tokenId)[1];

        parts[10] = '</text><text x="10" y="140" class="base">';

        parts[11] = generateAllies(tokenId)[2];

        parts[12] = '</text><text x="10" y="160" class="base">';

        parts[13] = generateAllies(tokenId)[3];

        parts[14] = '</text><text x="10" y="180" class="base">';

        parts[15] = generateAllies(tokenId)[4];

        parts[16] = '</text><text x="10" y="220" class="base">';

        parts[17] = generateNemesis(tokenId)[0];

        parts[18] = '</text><text x="10" y="240" class="base">';

        parts[19] = generateNemesis(tokenId)[1];

        parts[20] = '</text><text x="10" y="260" class="base">';

        parts[21] = generateNemesis(tokenId)[2];

        parts[22] = '</text><text x="10" y="280" class="base">';

        parts[23] = generateNemesis(tokenId)[3];

        parts[24] = '</text><text x="10" y="300" class="base">';

        parts[25] = generateNemesis(tokenId)[4];

        parts[26] = '</text><text x="10" y="340" class="base">';

        parts[27] = getBackpack();
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Generated #', toString(tokenId), '", "description": "Generated.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
