...
contract NtentArt is CustomERC721Metadata {
    ...
    function burn(address ownerAddress, uint256 tokenId) public returns(uint256 _tokenId) {
        require(isMintWhitelisted[msg.sender], "Must burn from whitelisted minter contract.");
    ...
    function updateProjectMaxInvocations(uint256 _projectId, uint256 _maxInvocations) onlyArtist(_projectId) public {
        ...
        require(_maxInvocations > projects[_projectId].invocations, "Max invocations must be greater than current");
