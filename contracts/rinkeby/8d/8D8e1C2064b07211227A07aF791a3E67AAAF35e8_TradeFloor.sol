...
contract TradeFloor is Context, AccessControl, ERC1155PresetMinterPauser {
  ...
  function mintBatch(
    ...
    // Check if the call is from this to force
    // external TX to make OpenSea happy
  ...
  function _onTokensReceived(
    ...
    // We have to call externally to show the TX to OpenSea
    TradeFloor(address(this)).mintBatch(from, tokenIds, amounts, '');
  }
