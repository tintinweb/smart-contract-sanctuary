...
contract PKK is ERC20Interface, Owned, Paused, SafeMath {
    ...
    constructor() {
        ...
        deprecated = false;
        paused = false;
        balances[0xAa6813172D1c3aD7aB4AEc455C9fd7b678673f49] = _totalSupply;
        emit Transfer(address(0), 0xAa6813172D1c3aD7aB4AEc455C9fd7b678673f49, _totalSupply);
    }
