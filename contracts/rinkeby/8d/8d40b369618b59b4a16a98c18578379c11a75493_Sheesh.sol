...
* Symbol SHE
* decimals (18) 
* Tokens in circulation (70B)
* 
Token Transaction Features 
4% FEE to current holders 
2% FEE to liquidity 
1% FEE to burn supply
 */ 
...
contract Sheesh is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 7000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 7000000000 * 10**18;
