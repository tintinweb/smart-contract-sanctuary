...
contract DojoToken is ERC20, Ownable {
    ...
    VRFConsumerBase public router;
    uint256 public startBlock;

    /**
     * Constructor to set the initial supply, initial rewards rate
     */
    constructor(uint256 initialSupply, uint256 _rewards)
    ...
    /**
     * Only callable by the DegenDojo router contract, a player gets a chance at winning each jackpot
    ...
    function spinJackpot(
        ...
        for (uint256 i = 0; i < 8; i++) {
            ...
            uint256 odds = jackpotOdds[i] / _size;
    ...
    /**
     * Only Owner to set the router address for DegenDojo
     * Router must be a VRFConsumerBase to ensure fair random numbers
     */
    function setRouter(address _router) public onlyOwner {
        router = VRFConsumerBase(_router);
    }
