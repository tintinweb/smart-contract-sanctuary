...
contract YamatoRepayerV2 is IYamatoRepayer, YamatoAction {
        ...
        onlyYamato
    {
        ...
        */
        ...
        require(_wantToRepayAmount > senderBalance, "You are trying to repay more than you have."); // V2 (Dec 7, 2021)
        require(_wantToRepayAmount < pledge.debt, "You are trying to repay more than your debt."); // V2 (Dec 7, 2021)

        /*
            2. Compose a pledge in memory
        */
        pledge.debt -= _wantToRepayAmount;
        ...
        */
        ...
        /*
            5. Commit totalDebt
        */
        IYamato(yamato()).setTotalDebt(totalDebt - _wantToRepayAmount);

        /*
            4-1. Charge Currency
            4-2. Return coll to the redeemer
        */
        ICurrencyOS(currencyOS()).burnCurrency(_sender, _wantToRepayAmount);
    }
}
