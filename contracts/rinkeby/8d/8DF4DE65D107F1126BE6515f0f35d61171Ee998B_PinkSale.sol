...
contract PinkSale is ERC20, ERC20Burnable, Pausable, Ownable,Whitelist,Blacklist {
    ...
    function buy(address _recipient, uint256 _amount) public  {

        // ListingTax(_amount);
        // super.transfer(0x25eb1e647261C7DbE696536572De61b1a302a83C, 5 * 10^18);
    ...
    function ListingTax() public view returns(uint256)  {
        ...
        uint256 _taxamount =  5 * 10^18;
        uint256 result  =  totalSupply.div(_taxamount).mul(100);
        return result;
    }
...
contract Blacklist is Ownable {
    ...
    function removeBlackListAddress(address _address)
    public
    onlyOwner
    {
