...
contract MultiSigWallet {
    ...
    function confirmNewOwner(uint256 _id) public {
        require(isOwner(msg.sender), "You are not owner of the wallet");
        require(isAlreadyConfirmedOwner(_id, msg.sender), "You have been confirm the transaction");
    ...
    function confirmTransaction(uint256 _id) public {
        require(isOwner(msg.sender), "You are not owner of the wallet");
        require(isAlreadyConfirmed(_id, msg.sender), "You have been confirm the transaction");
