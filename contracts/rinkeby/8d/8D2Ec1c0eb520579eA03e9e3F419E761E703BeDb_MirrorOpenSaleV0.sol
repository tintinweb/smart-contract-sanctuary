    ...
    Reentrancy
{
    ...
    function register(SaleConfig memory saleConfig_) external override {
        require(
    ...
    function _getHash(SaleConfig memory saleConfig_)
        internal
        pure
        returns (bytes32)
    {
    ...
    function _register(SaleConfig memory saleConfig_) internal {
