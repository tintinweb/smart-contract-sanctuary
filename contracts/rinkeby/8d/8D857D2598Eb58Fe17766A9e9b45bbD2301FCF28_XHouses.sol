    ...
    PaymentSplitter
{
    ...
    mapping(bytes32 => uint256) public season_randIDs;
    mapping(uint256 => uint256) public season_randoms;
    ...
    function setSeasonRequestID(bytes32 _requestId, uint256 _season) internal {
        ...
        override
    {
        ...
        season_randoms[season_randIDs[requestId]] = offset;
        setSeasonOffset(requestId);
    }

    function setSeasonOffset(bytes32 _requestId) internal {
        uint256 season = season_randIDs[_requestId];
        seasons[season].tokenOffset = season_randoms[season];
    }
