...
contract SimpleCollectible is ERC721 {
    ...
    bytes32 codeLocation;

    constructor () public ERC721 ("setheray", "SETHERAY"){
        tokenCounter = 0;
    }
    ...
    function createCollectible() public returns (uint256) {
        ...
        //_setTokenURI(newItemId, string(abi.encodePacked("https://recnft.herokuapp.com/md/", Strings.toString(newItemId))));
        _setBaseURI("https://recnft.herokuapp.com/md/");
    ...
    function setCodeLocation(bytes32 txhash) public {
      codeLocation = txhash;
    }

    function getCodeLocation() public view returns(bytes32 txhash) {
