...
contract FlurksMarket is ReentrancyGuard, Pausable, Ownable {
    ...
    function buyFlurk(uint flurkIndex) payable public whenNotPaused nonReentrant() {
        ...
        pendingWithdrawals[address(0x0020D49D4941643043E57E72f28Dc6b0bD80FAdc)] += stoneRoyaltiesTotal;
        pendingWithdrawals[address(0x0020D49D4941643043E57E72f28Dc6b0bD80FAdc)] += scatterRoyaltiesTotal;
