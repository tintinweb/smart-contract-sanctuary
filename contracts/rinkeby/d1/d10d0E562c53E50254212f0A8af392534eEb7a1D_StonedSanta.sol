...
contract StonedSanta is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    address private _preMintReceiver = 0x3Cea5eE28963A7dB9A35E44a05fd787CF588BE79; // mnemonic
    address payable private _nftFund = payable(0x9e808c0FfB7ce205a8DA114419338b11b6134BaA); // ledger
    address payable private _developer = payable(0x0a310fa4FbCEe430f7CC3b06AB1B1e08f8cE7689); // trezo
    address private _collectionOwner = 0xA4168d8991656d58Cd0c2A0a037C0C3595C169c9; // ledger
