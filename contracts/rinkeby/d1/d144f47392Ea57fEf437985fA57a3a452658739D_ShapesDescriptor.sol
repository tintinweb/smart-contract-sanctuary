...
/// @title The Shapes NFT descriptor
...
contract ShapesDescriptor is IShapesDescriptor, Ownable {
    ...
    // Whether or not new Shape parts can be added
    ...
    // Shape Color Palettes (Index => Hex Colors)
    mapping(uint8 => string[]) public override palettes;

    // Shape Backgrounds (Hex Colors)
    ...
    /**
     * @notice Get the number of available Shape `backgrounds`.
     */
    ...
    /**
     * @notice Batch add Shape backgrounds.
    ...
    /**
     * @notice Given a token ID and seed, construct a base64 encoded data URI for an official Shape.
     */
    function tokenURI(uint256 tokenId, IShapesSeeder.Seed memory seed) external view override returns (string memory) {
        string memory shapeId = tokenId.toString();
        string memory name = string(abi.encodePacked('Shape ', shapeId));
        string memory description = string(abi.encodePacked('Shape ', shapeId, ' is a cool NFT'));
    ...
    function genericDataURI(
        ...
        console.log('wow', name, description);
     ...
     */
    function generateSVGImage(IShapesSeeder.Seed memory seed) external view override returns (string memory) {
    ...
    /**
     * @notice Get all Shape parts for the passed `seed`.
     */
    function _getPartsForSeed(IShapesSeeder.Seed memory seed) internal view returns (bytes[] memory) {
