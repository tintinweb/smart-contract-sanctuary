...
contract BBUNNIES is ERC721, Ownable {
    using SafeMath for uint256;
    uint public constant MAX_BUNNIES = 11305;
    bool public hasSaleStarted = false;
    
    // THE IPFS HASH OF ALL TOKEN DATAS WILL BE ADDED HERE WHEN ALL BUNNIES ARE FINALIZED.
    string public METADATA_PROVENANCE_HASH = "";
    
    
    constructor() ERC721("BASTARD BUNNIES","BBUNNIES")  {
    ...
    function calculatePrice() public view returns (uint256) {
     ...
     function calculatePriceTest(uint _id) public view returns (uint256) {
        ...
        require(_id < MAX_BUNNIES, "Sale has already ended");
   ...
   function adoptBUNNY(uint256 numBunnies) public payable {
        ...
        require(msg.value >= calculatePrice().mul(numBunnies), "Ether value sent is below the price");
