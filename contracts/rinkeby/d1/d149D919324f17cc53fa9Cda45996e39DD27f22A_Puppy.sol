...
contract Puppy is ERC20, Ownable {
    ...
    uint public constant INITIAL_PRESALE_PRICE_WEI = 1000000000000000000000000;
    uint public constant PUPPY_WEI_PER_PUPPY = 1000000000000000000;
    uint public constant MAX_NUM_PURCHASE_PER_TX = 100000000000;
    ...
    function presalePurchase(uint num) public payable {
      ...
      require(num < MAX_NUM_PURCHASE_PER_TX, "Cannot purchase that many");
      require(msg.value >= num * presalePriceWei, "Insufficent amount sent");
      _mint(msg.sender, num * PUPPY_WEI_PER_PUPPY);
    }
