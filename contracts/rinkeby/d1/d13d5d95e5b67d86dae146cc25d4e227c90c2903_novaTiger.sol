...
contract novaTiger is ERC721Enumerable, PullPayment, Ownable {
    using Counters for Counters.Counter;

    // Constants
    uint256 public constant WL_PRICE = 25000000000000000; // 0.025 ETH
    uint256 public constant NFT_PRICE = 50000000000000000; // 0.05 ETH

    uint256 public MAX_SUPPLY = 4000; // total supply of tigers
    ...
    constructor() ERC721("novaTigerProject", "novaTiger") {
        baseTokenURI = "";
    }
    ...
    function reserveTokens(uint256 num) public onlyOwner {
        ...
        for (i = 0; i < num; i++) {
            ...
            purchaseHistory[msg.sender] = purchaseHistory[msg.sender] + 1;
        }
