...
contract Nft is Ownable, ERC721Enumerable, ToggleableSale, WhitelistVerifier {
...
contract WhitelistVerifier is Ownable {
  ...
  modifier whenCapIsSet() {
    require(!capEnabled || maxToClaim > 0, 'Whitelist cap is set incorrectly.');
    _;
  }
