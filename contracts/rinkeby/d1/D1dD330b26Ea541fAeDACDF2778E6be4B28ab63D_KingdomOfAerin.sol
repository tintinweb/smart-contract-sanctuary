...
contract KingdomOfAerin is ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_PER_TX_PRES = 8;
    uint256 public MAX_PER_TX_PS = 25;
    uint256 public RESERVES = 94;
    uint256 public priceInWei = 0.07 ether;
    uint256 public priceInErc20 = 2.5 ether;
    ...
    function setSaleParams(
        uint256 _maxSupply,
        uint256 _maxPerTxPreS,
        uint256 _maxPerTxPs,
        uint256 _priceInWei,
        uint256 _priceInErc20
    ) external onlyOwner {
        MAX_SUPPLY = _maxSupply;
        MAX_PER_TX_PRES = _maxPerTxPreS;
        MAX_PER_TX_PS = _maxPerTxPs;
