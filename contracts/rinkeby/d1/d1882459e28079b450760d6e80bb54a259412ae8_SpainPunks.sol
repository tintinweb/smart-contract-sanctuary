...
// File contracts/SpainPunksDNA.sol


pragma solidity ^0.8.0;

contract SpainPunksDNA {
    ...
    // Funci├│n PSEUDO-Aleatoria, usar oraculo (chainlink) para producci├│n
...
// File contracts/SpainPunks.sol


pragma solidity ^0.8.0;
// Importar interfaz ERC721 de NFTS
contract SpainPunks is ERC721, ERC721Enumerable, SpainPunksDNA{
    ...
    // Constructor recibe 2 parametros, nombre & ticker del NFT
    constructor(uint256 _maxSupply) ERC721('SpainPunks','SPPKS') {
    ...
    function mint() public{
        ...
        // Comprobar maxSupply antes de mintear
        require (current < maxSupply,'No SpainPunks left :(');
        ...
        returns (string memory)
        {
            ...
            string memory jsonURI = Base64.encode(
                abi.encodePacked(
                    ...
                    '"name":"SpainPunks #',
                    tokenId.toString(),
                    '","description":"SpainPunks are randomized avatars of your favorite spanish characters", "image":"',
                    image,
                    '"}'
                )
            );
    ...
    // Overrides necesarios para funcionalidades NFT
