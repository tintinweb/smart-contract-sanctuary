...
contract tokenB is token {
   ...
   function transfer(address _to, uint256 _amount) public override returns(bool) { //Transfer from one address to another
    ...
    function mint(address _to, uint256 _amount) public override onlyAdmin { //To mint TokenB
    ...
    function burn(address _to, uint256 _amount) public override onlyAdmin { //To burn TokenB
