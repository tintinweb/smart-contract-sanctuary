...
contract FangsToken is ERC20 {
     ...
     */
    function stakeLions(uint256[] memory tokenIds, uint256[] memory lockMods) external returns (bytes4) {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            tokenStakedInfo[tokenId] = StakedInfo(msg.sender, block.timestamp + (15 minutes * lockMod), DAY_15_RATE * lockMod);
        }
    }
