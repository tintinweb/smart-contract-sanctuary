...
contract BUNSLANDGenesis is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    function safeMint(address to, uint256 numBuns) public payable {
        ...
        require(publicAmountMinted + numBuns <= MAX_SALE, "EXCEED MAX_SALE.");
    ...
    function safePresaleMint(address to, uint256 numBuns) public payable {
         ...
         require(numBuns > 0 && numBuns <= 2, "You can mint 1 bun to 2 buns at a time.");
        require(msg.value >= bunsPrice * numBuns, "Not enough ETH sent; check price!");
        require(totalSupply() < MAX_PRESALE, "Presale has already ended.");
        require(whitelist[msg.sender], "NOT_QUALIFIED");
        require(privateAmountMinted + numBuns <= MAX_PRESALE, "EXCEED MAX_PRESALE.");
        require(presalerListPurchases[msg.sender] + numBuns <= 2, "EXCEED_ALLOC.");
