...
contract ApeBarracks is Initializable, ERC721Upgradeable,
    ...
    function setBuildingParams(uint256 typeID_, uint256 slots_, uint256 buildAtBlock)
        public
        onlyOwner
    {
        props = ApeBuilding({
