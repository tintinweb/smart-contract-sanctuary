...
contract ROID is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ROID.Finance";
    string private _symbol = "ROID";
    ...
    uint256 internal _tokenTotal = 80_000e9;
    ...
    uint256 public _rebalanceCallerFee = 1400;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(
            ...
            "ROID: Uniswap router cannot be excluded."
        );
        require(account != address(this), 'ROID: The contract it self cannot be excluded');
        require(!_isExcluded[account], "ROID: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "ROID: Account is already included");
    ...
    function _transfer(
        ...
        require(now > liquidityAddedAt + 5 minutes  || amount <= 600e9, "You cannot transfer more than 600 tokens.");
