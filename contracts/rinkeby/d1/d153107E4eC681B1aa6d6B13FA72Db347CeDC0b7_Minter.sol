// SPDX-License-Identifier: MIT
 ...
 contract Minter is ERC721, Ownable, ERC721Enumerable {
   ...
   event minterMinted(uint256 tokenId, address owner);
 
   constructor() ERC721("MinterNew", "EFS") {}
   ...
   function mintEmoji(uint256 numberOfTokens) external payable {
     ...
     for (uint256 i = 0; i < numberOfTokens; i++) {
       ...
       if (totalSupply() < MAX_TOKENS) {
         ...
         emit minterMinted(id, msg.sender);
       }
     }
   }
 
   function presaleMinter(uint256 numberOfTokens) external payable {
