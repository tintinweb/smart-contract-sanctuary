...
Decimals: 15
Supply: 27,320,000
5% total fee paid in COAST where 4% goes to our wallet and 1% is redistributed to token holders.
 */ 
contract CoastGives is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 27320000 * 10**15;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Coast Gives";
    string private _symbol = "COAST";
    ...
    uint256 public _maxTxAmount = 27320000 * 10**15;
    uint256 private numTokensSellToAddToLiquidity = 500* 10**15;
    ...
    constructor () {
     ...
     IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Etherscan 
     //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // BSC V2
