...
contract TRLabBuyNowV1 is IBuyNow, SignerRole, Ownable {
    ...
    function buyNow(
        ...
        bytes32 messageHash = keccak256(
            abi.encode(this, _msgSender(), _artworkId)
        );
        require(
            _verifySignedMessage(messageHash, v, r, s),
            "signer should sign buyer address and artwork id!"
        );
        ...
        require(
            alreadyBought < onSaleInfo.purchaseLimit,
            "you have reached purchase limit!"
        );
