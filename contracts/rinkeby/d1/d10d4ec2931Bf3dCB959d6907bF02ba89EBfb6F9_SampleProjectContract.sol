...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/sampleProjectContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract SampleProjectContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Sample Project", "SAMPLE", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/uloOKb0v5Z2UBpWLcj0k/contract-metadata";
        }
    }