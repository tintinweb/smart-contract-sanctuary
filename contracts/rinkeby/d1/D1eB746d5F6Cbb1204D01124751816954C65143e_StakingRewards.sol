...
// File contracts/MockRewardsToken.sol
...
contract MockRewardsToken is ERC20, ERC20Detailed {
    constructor(uint256 _initialSupply) ERC20Detailed("MRToken", "MRT", 18) public {
        _mint(msg.sender, _initialSupply);
    }
}


// File contracts/MockStakingToken.sol
...
contract MockStakingToken is ERC20, ERC20Detailed {
    constructor(uint256 _initialSupply) ERC20Detailed("MSToken", "MST", 18) public {
        _mint(msg.sender, _initialSupply);
    }
}
...
// https://dirt-slime-eb1.notion.site/An-overview-of-the-GET-Staking-contract-e3d9bc8a2e3e45238d7408354d889426
contract StakingRewards is ReentrancyGuard, Pausable {
    ...
    event PeriodFinishUpdated(uint256 newPeriodFinish);
}