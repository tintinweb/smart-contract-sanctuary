...
contract Strip is ERC20, Administration {
    ...
    constructor() ERC20("StripperVille Coin", "STRIP") {}
    
    function depositFromNFT() external {
    ...
    function initialMint() external onlyOwner {
        ...
        _mint(_msgSender(), _initialTokens);
    }
    ...
    function burnAssets(uint amount) external onlyOwner {
