...
contract EtheesNFT is Ownable, ERC721Enumerable  {
    using SafeMath for uint256;

    bool public saleIsActive = false;
    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmZ5PZ42aLymdZkB1bEntn3mKySVme8mPmnoFsTwMP66gx/";
    uint public MAX_PURCHASE = 1;
    uint256 public CURRENT_PRICE = 0.00001 ether;
    uint256 public FIRST_BATCH = 250;
    uint256 public MAX_TOKENS = FIRST_BATCH;

    constructor() ERC721("Ethees", "ETHEE") {
    ...
    function contractURI() public pure returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/Qmc5MpaYjS7qe3kabnr2xcLc8dHR4AZoToE5GFzpG2bivR";
    }
}