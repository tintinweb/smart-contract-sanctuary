...
// File: contracts/collections/NFTify1155Collection.sol
...
contract NFTify1155 is ERC1155Supply {
    address public owner;
    address public controller;
    string public name; 
    string public symbol;

    constructor(string memory _name, string memory _symbol, string memory _uri, address _controller) ERC1155(_uri) {
        owner = msg.sender;
        name = _name;
        symbol = _symbol; 
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data) public onlyControllers {
