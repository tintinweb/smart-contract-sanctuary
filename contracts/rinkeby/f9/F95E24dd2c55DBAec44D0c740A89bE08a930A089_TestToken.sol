...
contract TestToken is ERC721, Ownable {
    ...
    uint public pirateStolen = 0;
    uint public goldMinerStolen = 0;
    uint public pirateMinted = 0;
    ...
    mapping(uint => bool) private _isPirate;
    ...
    function add_AvailableTokens(uint _from, uint _to) public onlyOwner {
    ...
    function isPirate(uint id) public view returns (bool) {
        return _isPirate[id];
    }
