...
contract VanillaMightyHorse is MintableToken {

  string public constant name = "Vanilla Mighty Horse"; // solium-disable-line uppercase
  string public constant symbol = "VMH"; // solium-disable-line uppercase
