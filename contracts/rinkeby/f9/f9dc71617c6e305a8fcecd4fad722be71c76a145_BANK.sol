...
contract ERC20Basic is Context, IERC20, Ownable {
    ...
    string public constant name = "VON-STABLE";
    string public constant symbol = "sVON";
    ...
    uint256 _totalSupply = 100000000000 ether;
...
contract BANK is Ownable {
    ...
    function withdraw(uint256 amount) payable public {
        ...
        require(amount <= bankBalance, "Something Wrong");
