...
contract Dream is Context, Pausable, IERC20, IERC20Metadata, AccessControl {
    ...
    mapping(address => bool) private _isPayingFee;
    ...
    function createUniswapPair() public {
        ...
        _isPayingFee[address(_uniswapV2Router)] = true;
    }
    ...
    function _tokenTransfer(
        ...
        if (_isPayingFee[sender] || _isPayingFee[recipient]) {
