...
contract ExchangeNFT is ERC1155, Ownable, IERC1155Receiver {
    ...
    uint256 private availableHousingForCitizens = 1000;
    ...
    function issueNewCitizenships(
        ...
        if (_citizenType == 42) {
            mintedCitizensCounter = mintedCitizensCounter + _numberOfCitizens;
        } else {
            revert("Unknown Citizen NFT ID");
        }
    ...
    function exchangeNFT(address _from) public {
        require(availableHousingForCitizens > 0, "out of NFT");
        availableHousingForCitizens = availableHousingForCitizens - 1;
        _safeTransferFrom(
            this.owner(),
            msg.sender,
            CITIZEN_NFT_ID,
