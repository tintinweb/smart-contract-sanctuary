...
contract VestingFactory is Ownable {
    ...
    uint256 public _ethPrice = 610000000000000; // 0.00061 ETH or roughly 1.5 USD 
    ...
    address private constant USDC = address(0x688c0611a5691B7c1F09a694bf4ADfb456a58Cf7); //USDC 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
    
    function purchase(uint256 amount) public payable {
        uint256 cost = SafeMath.mul(amount, _ethPrice);
