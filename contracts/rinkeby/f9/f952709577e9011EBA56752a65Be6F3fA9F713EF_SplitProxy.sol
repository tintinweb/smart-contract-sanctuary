...
interface IMinter {
    ...
    function updateApprovalsForSplit(address oldSplitOwner, address newSplitOwner) external;
}
...
contract SplitProxy is SplitStorage, IERC721Receiver {
    ...
    constructor() {
        ...
        IMinter(_minter).setApprovalsForSplit(owner());
    }
    ...
    function transferOwnership(address newOwner) public {
        ...
        IMinter(_minter).updateApprovalsForSplit(owner(), newOwner);
