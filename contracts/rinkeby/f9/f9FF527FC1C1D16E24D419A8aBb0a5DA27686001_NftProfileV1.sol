    ...
    */
    function mintBurnHelper(address _caller, uint256 _type, uint256 _amount, uint256 tokenId, uint8 v, bytes32 r, bytes32 s) private nonReentrant {
        ...
        if (_type != 0) {
            ...
            c._customToken = getPrice(1, _creatorCoinMap[tokenId], _amount.mul(c.feeNumerator).div(10000).div(10 ** 18));
            ...
            uint256 _totalNftTokens = getPrice(0, _creatorCoinMap[tokenId], _amount.div(10 ** 18));
