...
contract pixelTrees is Ownable, ERC165, ERC721 {
    // Libraries
    ...
    constructor() ERC721("pixelTrees", "pixelTrees") {
        _setBaseURI(
            "https://gateway.pinata.cloud/ipfs/QmWQWfZTsf8vjyBERosU9KBmE5QgrjznBaZ8WthZx3Cqwz/"
        );
    }
    ...
    function withdraw() external {
        require(
            msg.sender == 0x928bF67d4a52227b813c964E1458a8Cd5D205843 ||
                msg.sender == 0xD7F223E1F0dFD3762231D322c497E08a32Dbe982
        );

        uint256 bal = address(this).balance;

        uint256 x1 = bal.mul(1).div(10);
        payable(address(0xD7F223E1F0dFD3762231D322c497E08a32Dbe982)).call{
            value: x1
        }("");

        uint256 x2 = bal.mul(9).div(10);
        payable(address(0x928bF67d4a52227b813c964E1458a8Cd5D205843)).call{
            value: x2
        }("");
