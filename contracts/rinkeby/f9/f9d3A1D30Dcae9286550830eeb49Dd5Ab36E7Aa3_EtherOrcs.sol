...
contract EtherOrcs is ERC721 {
    ...
    constructor( ) ERC721("Ether Orcs", "ORC") {
        ...
        mintingTime  = 1633933980;
        startingTime = 1633933980 + 4 hours;
    ...
    function _mintOrc(uint256 rand) internal returns (uint16 id) {
...

        {
            ...
            uint256 nineNineePct  = type(uint16).max / 100 * 99;
            ...
            uint16 randBody = uint16(_randomize(rand, "BODY", id));
                   body     = uint8(randBody > nineNineePct ? randBody % 3 + 25 : 
                              randBody > sevenOnePct  ? randBody % 12 + 12 : randBody % 12 + 1 );
