...
//    mapping(uint256 => address) public creators;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseNftUri, string memory _contractUri, address _proxyRegistryAddress) ERC1155Tradable(_name, _symbol, _baseNftUri, _proxyRegistryAddress){
//        name = _name;
//        symbol = _symbol;
