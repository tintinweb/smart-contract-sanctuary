...
contract RaccoonHood is ERC1155, Ownable {

	using SafeMath for uint256;
	using Strings for string;
	uint256 public mintedRaccoons;
    
	string public _baseURI = "https://elasticbeanstalk.s3.eu-west-2.amazonaws.com/j/";
	...
	function safeMint() public payable {
		...
		require(mintedRaccoons < totalSupplyCount, "All BadCoons has been minted!");
		mintedRaccoons = mintedRaccoons + 1;
		_mint(msg.sender, mintedRaccoons, 1, "0x0000");
	}

	function safeMintBatch(uint256 _count) public payable {
		require(sellStart == true, "Wait for sales to start!");
		require(itemPrice.mul(_count) >= msg.value, "insufficient ETH");
		require(_count <= maxMintPerBatch, "10 is a limit");
		require(mintedRaccoons + _count <= totalSupplyCount, "All Coons has been minted!");
	...
	function mint(address to) public onlyOwner {
		require(mintedRaccoons < totalSupplyCount, "All Coons has been minted!");
		mintedRaccoons = mintedRaccoons + 1;
		_mint(to, mintedRaccoons, 1, "0x0000");
	}
