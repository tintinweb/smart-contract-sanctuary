...
"#b71c1c"
 ...
 function withdraw() public payable onlyOwner {
    ...
    function generateSVG(uint256 _randomness) public view returns (string memory finalSvg) {
        ...
        finalSvg = string(abi.encodePacked("<svg xmlns='http://www.w3.org/2000/svg' height='", uint2str(height), "' width='", uint2str(width), "' fill='none' viewBox='500 100 1500 2000'><path d='M500 100h1500v2000H0z' fill= '#fafafa'/>"));
