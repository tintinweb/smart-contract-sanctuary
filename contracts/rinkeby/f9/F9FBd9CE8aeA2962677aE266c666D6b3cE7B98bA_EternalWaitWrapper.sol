...
contract EternalWaitWrapper {
	...
	constructor() {
        //address _eternalWaitContract = 0x1d57A4C1D91F617E42D1B103895a673A60631abF; //Mainnet
        address _eternalWaitContract = 0xA8641aFB0802708F7b0D3aFE15FE80B939ea3e00; //Rinkeby
    ...
    uint immutable internal topLevelMultiplier = 10000;
    uint immutable internal midLevelMultiplier = 100000000;
    ...
    function mintNifty(uint256 niftyType, uint256 count) public {
