...
contract DungeonsAndDragons is ERC721, VRFConsumerBase {
    ...
    function requestNewRandomCharacter(
        uint256 userProviedSeed, 
        string memory name
    ) public returns (bytes32) {
        bytes32 requestId = requestRandomness(keyHash, fee, userProviedSeed);
    ...
    internal override {
        // define teh creation of the NFT
        uint256 newId = characters.length;
        uint256 strength = (randomNumber % 100);
        uint256 speed = ((randomNumber % 10000) / 100);
        uint256 stamina = ((randomNumber % 1000000) / 100);
