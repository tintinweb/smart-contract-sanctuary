...
library LiquidityMathLibrary {
    ...
    function getLiquidityValue(
        ...
        (uint256 reservesA, uint256 reservesB) = IUniswapV2Factory(factory).getReserves(tokenA, tokenB);
        IUniswapV2Pair pair = IUniswapV2Pair(IUniswapV2Factory(factory).pairFor(tokenA, tokenB));
