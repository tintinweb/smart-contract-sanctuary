...
contract FrakToken is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x080917E141539D50B763ff92F5D54EbcAE8d0080] = 8550000000000000000000000000;
        ...
        /* add balance of total vesting to the deployer address */
        /* add rest of total supply to fraktal DAO */
        /*
        if we dont have the DAO address, then keep it all in deployer until that, then
        do the whole vesting ownership and tokens migration to it
         */
        /* add events for added account balances */
        ...
        emit Transfer(address(16), 0x080917E141539D50B763ff92F5D54EbcAE8d0080, 8550000000000000000000000000);
