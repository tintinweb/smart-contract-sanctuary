...
contract DisTest is Context, IERC20, Ownable {
    ...
    string private _name = "Discord Test";
    ...
    address payable public _marketingWalletAddress = 0x35B6eD4dBDC63C86299Ae576335372cb3e518121;
    address payable public _charityWalletAddress = 0xAe53301A417c64A7fbf74FAF21D13a5f0120965b;
    ...
    function _setMarketingWallet(address payable _markWallet) external onlyOwner() {
        _marketingWalletAddress = _markWallet;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // split the contract balance into 4 (2 for liquidity, 1 for charity and 1 for marketing)
        uint256 halfOfLiquify = contractTokenBalance.div(4); // 1/4
        uint256 otherHalfOfLiquify = contractTokenBalance.div(4); // 1/4
        uint256 portionForCharity = contractTokenBalance.div(4); // 1/4
        uint256 portionForMarketing = contractTokenBalance.div(4); // 1/4
