    ...
    ReentrancyGuard
{
    ...
    uint256 constant presaleCapped = 969;
    uint256 constant bottomPrice = 42000000000000000;
    ...
    uint256 public publicSalePrice = 69000000000000000; // 0.069
    uint256 public presalePrice = 42000000000000000; // 0.069
        ...
        if (getSaleMode() == 3) {
            if (discountStartBlock > 0 && block.number > discountStartBlock) {
                ...
                if (discountTimes >= 3) {
                    ...
                    return
                        publicSalePrice.sub(
                            discountTimes.mul(9000000000000000)
                        );
                }
            } else {
