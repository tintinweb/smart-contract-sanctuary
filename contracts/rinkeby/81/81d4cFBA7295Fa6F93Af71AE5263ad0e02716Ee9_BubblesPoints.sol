...
contract BubblesPoints is ERC20, Admin {
    constructor() Admin(msg.sender) ERC20("BUBBLES NFT POINT", "NFTpoint") {}
    /**
     *
     * Change decimals to ZERO
     *
     */  
    ...
    /**
     *
     * This contract not for transferring point, it's for showing NFT claiming balance of the creator and use it for claiming new nft
     *
     */
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        recipient;
        amount;
        require(false, "DOES NOT SUPPORT IN THIS CONTRACT");
        return false;
    }
    ...
    // DEPOSIT
    function deposit( address to, uint256 amount) public onlyMinter() returns (bool) {
        _mint(to, amount);
        return true;
    }

    // USE FOR CLAIMING
    function use( address from, uint256 amount) public onlyMinter() returns (bool) {
        _burn(from, amount);
        return true;
    }
