...
contract Common1155 is Token1155 {
  constructor(
    ...
    _setBaseMetadataURI("https://api.nftsky.io/api/v1/");
  }
...
contract Token1155 is ERC1155, ERC1155MintBurn, ERC1155Metadata, ContextMixin, NativeMetaTransaction, Ownable {
