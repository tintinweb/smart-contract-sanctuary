...
contract BMIStaking is IBMIStaking, OwnableUpgradeable, AbstractDependant {
    ...
    uint256 internal constant WITHDRAWING_LOCKUP_DURATION = 1 days;
    uint256 internal constant WITHDRAWING_COOLDOWN_DURATION = 600;
    uint256 internal constant WITHDRAWAL_PHASE_DURATION = 600;
