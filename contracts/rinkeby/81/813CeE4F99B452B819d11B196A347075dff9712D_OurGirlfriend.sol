...
contract OurGirlfriend is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        return string(abi.encodePacked('data:application/json;base64,', Base64.encode(bytes(string(abi.encodePacked('{"name": "Asami (v0.1) #', paddedTokenId, '", "description": "Asami is looking for her soulmate.", "attributes": [ { "trait_type": "Alignment", "value": "', tokenId % 2 == 0 ? 'Light' : 'Dark', '" }, { "trait_type": "Auspicious Number", "value": ', Strings.toString(tokenId % 7 + 1) , ' }, { "trait_type": "Zodiac", "value": "Scorpio" }, { "trait_type": "Favorite thing to do with you", "value": "', HOBBIES[rand % HOBBIES.length], '" } ], "image": "https://d3l938e4wlber9.cloudfront.net/ASAMI-', paddedTokenId, '-' , relationshipLevel(tokenId) , '.svg"}'))))));
    }

    function heartTokenUri() internal view returns (string memory) {
