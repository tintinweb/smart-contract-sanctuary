...
contract StakingRewards {
     ...
     */
    constructor(address _stakingToken, address _rewardToken, uint256 _stakingPool, uint256 _stakingPoolRewards, uint256 _stakingStartTime, uint256 _stakingDuration) {
    ...
    function stake(uint256 _noOfTokens) external {
        ...
        require(currentBlockTimestamp() > stakingStartTime, "Staking Not Started Yet");
    ...
    function calculateStakingReward(uint256 _noOfTokens) internal view returns (uint256) {
        uint256 userShareInPool = _noOfTokens.div(stakingPool).mul(100);
