...
contract Ornament is Ownable, ERC721Enumerable {
    ...
    uint256 public price = 0.01 ether; // TODO: Change. .01 eth
    ...
    constructor() ERC721('Ornament', unicode'▣') {
        baseUrl = "https://ornament.leegte.org/ornament.html?o=";
        ...
        returns (string memory)
    {
        ...
        string memory description = string(abi.encodePacked('Ornament is swapping the actors. The frame becoming the content.\nOrnament is an on-chain deterministically generated SVG.\n No. ', tokenId.toString(), ' / 256'));
