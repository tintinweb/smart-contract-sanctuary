...
contract animalMain is  ERC721,Ownable {
  ...
  function seeAnimalArrt(uint256 _tokenId) public view returns (uint8 Attributes) {
    return animals[_tokenId].Attributes;
  }
  ...
  function createAnimal() public payable {
      ...
      uint id = animals.push(animal(dna, uint8(star), uint8(roletype),uint8(Attributes))) - 1;
