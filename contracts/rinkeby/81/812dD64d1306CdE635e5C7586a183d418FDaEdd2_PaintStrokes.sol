...
contract PaintStrokes is ERC721Enumerable, Ownable {
    ...
    uint256 constant public PaintStrokes_PRICE = 0.05 ether;
    
    mapping(bytes32 => bool) public usedHashes;
    mapping(address => uint256) public walletMintNumber;

    string private _tokenBaseURI;
    address private _signatureVerifier = 0x805c057A31B31c84F7759698298aD4dC6F8fA622;
    
    constructor() ERC721("PaintStrokes", "PaintStrokes") {
    }
    ...
    function earlyMint(bytes memory signature, uint256 nonce) public payable {
        ...
        require(PaintStrokes_PRICE == msg.value, "Sent ether value is incorrect");
