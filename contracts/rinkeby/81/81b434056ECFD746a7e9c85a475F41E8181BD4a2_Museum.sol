...
contract Museum is ERC721Enumerable, PaymentSplitter, Ownable {
  ...
  string private _baseUri = "https://gateway.pinata.cloud/ipfs/QmWkjj1kTz2eMomdB9sLEoRBSfSC15km7WbJtDHHARsGxm/";
  ...
  uint256 public constant WHITELIST_A_START = 1633467600; // Oct 5 2021 4:00pm ET
  uint256 public constant WHITELIST_B_AND_C_START = 1633468200; // Oct 5 2021 4:10pm ET
  uint256 public constant SALE_START = 1633468800; // Oct 5 2021 4:20pm ET

  uint8 public constant _SALE = 3;
  uint8 public constant _BC = 2;
  uint8 public constant _A = 1;

  uint256 private _mintCount = 1; // start at one because we're reserving one
  uint256[MAX_SUPPLY - 1] private _indices; // minus one because we're reserving 5822 for ourselves
  ...
  constructor(address[] memory payees, uint256[] memory shares) ERC721("Museum", "MUSE") PaymentSplitter(payees, shares) { 
    ...
    _mint(address(0x3856d637898Ff0B77ceD57769F7E8Cb0f2C48783), 5822);
  }
