...
contract MerkleTest is ERC721Enumerable, Ownable, ReentrancyGuard {
    bytes32 merkleRoot;
    ...
    uint public constant RESERVE_SUPPLY = 5;
    uint public constant MAX_ALLOWLIST_MINT = 15;
    uint public constant MAX_PUBLIC_MINT = 15;
    uint public constant PRICE_PER_TOKEN = 0.05 ether;
