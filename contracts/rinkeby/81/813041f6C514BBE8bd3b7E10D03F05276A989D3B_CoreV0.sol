...
contract CoreV0 is ICoreV0 {
    ...
    */
        ...
        returns (bytes32 receiptId)
    {
        ...
        require(IERC20(erc20Addr).approve(AMM_ROUTEV2, _supply*10**18));//only uint256
    ...
    *
    ...
    onlyReceiptOwner(_receiptId) receiptExist(_receiptId) 
       external override  payable returns (uint tokenAmount, uint amountETH, uint liquidity){
        ...
        curveParameters[_erc20Token] = CurveRules(msg.value,_amountTokenDesired,msg.value,_rRatio,lastPrice,(IERC20(_erc20Token).totalSupply()),msg.value,_maxCap,_rRtype,0);
    ...
    function getRedeemingValues(address _erc20Token)  public view returns(uint ethValue,uint tokens,uint liquidity, bool xyFlag) {
        ...
        return(ethValue.mul(_xyValue.div(10**18)),tokens,_liquidity,xyFlag);
