...
contract UniswapV3PositionAdapter is IUniswapV3PositionAdapter {
        ...
        returns (PositionDetail[2] memory positionDetails)
    {
        ...
        // Save tokens and tokens owed from the position
        ...
        // Compute feeGrowths that are not in tokensOwed{0,1} yet
    ...
    /// @param feeGrowthInside Pool's fee growth for the position
    /// @param feeGrowthInsideLast Position's fee growth
    /// @param liquidity Position's liquidity
