...
contract SicaaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sicaa-Inu";
    string private constant _symbol = "SICAA";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x7366Be615336B80e274300fDF9c648E20020728c); // Marketing Address
        
        devAddress = payable(0x62724D6A27973D2be48e008FEcd76b8DD9C6aECD); // Dev Address
