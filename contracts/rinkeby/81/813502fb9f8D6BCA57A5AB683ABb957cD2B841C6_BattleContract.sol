...
contract BattleContract is Ownable {
    ...
    function testBalance(address _to) public view returns (uint256) {
        return gfx_.balanceOf(_to);
    }

    function testTotalSupply() public view returns (uint256) {
        return gfx_.totalSupply();
    }
