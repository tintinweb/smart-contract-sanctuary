...
contract Reward is Ownable {
    ...
    receive() external payable {
        //      tValue = (msg.value * _config.ratio) / _config.totalSupply_100;
        uint256 tValue = ((msg.value.mul(_config.ratio))).div(_config.totalSupply_100);
        //      oValue =  msg.value - (_config.totalSupply * tValue);
        uint256 oValue =  msg.value.sub((_config.totalSupply.mul(tValue)));
    ...
    function claimToken(uint256 tokenId) public returns (bool) {
        ...
        //      amount  = _tBalance  -  _tClaimed[tokenId];
    ...
    */
    function claimTokens(uint256[] calldata tokenIds) public returns (bool) {
        ...
        for (i = 0; i < tokenIds.length; i++) {
            //                        _tBalance  -  _tClaimed[tokenIds[i]];
    ...
    */
    function balanceOf(address wallet) public view returns (uint256) {
        ...
        for (uint256 i = 0; i < numTokens; i++) {
                        //totalAmount += ( _tBalance  -  _tClaimed[_nft.tokenOfOwnerByIndex(wallet, i)]  );
