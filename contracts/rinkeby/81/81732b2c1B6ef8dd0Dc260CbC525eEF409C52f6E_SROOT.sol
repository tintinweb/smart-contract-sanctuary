...
contract SROOT is ERC20Upgradeable, Delegatable  {
    ...
    uint256 public _tTotal = 1000000000 * 10**18; // 1 quadrillion
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;

    string private _name = "SROOT";
    string private _symbol = "SROOT";
    ...
    uint256 public _Staking_rewardsFee = 200;
    uint256 public _Bearworld_rewardsFee = 500;
    uint256 public _Daily_RewardsFee = 275;

    address private _Treasury_account = 0x7405e618aeD67359761c2dbbB7e541e64a03A40a;
    address private _Staking_rewards_account = 0xFcBB29c9aE1FAfC801AA138fbA58A8Bcf72918EA;
    address private _Bearworld_rewards_account = 0x5F1decc0a7Dd91AB45F7B3dc05C53696b2e002A6;
    address private _Daily_Rewards_account = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
    ...
    uint256 public _test1;
    uint256 public _test2;
    uint256 public _test3;
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**18; // 0.1%
    ...
    constructor () {
        ...
        // _uniswapV2Router.addLiquidity(address(this), _uniswapV2Router.WETH())
    ...
    function __isConstructor () public view returns(bool) {
        return _isConstructor();
    }

    function runFeeMethods() public onlyAdmin{
    ...
    function _transferSpecial(address sender, address recipient, uint256 tAmount) public {
