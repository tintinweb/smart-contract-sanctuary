...
contract Community is ICommunity {
        ...
        checkMember(_communityID, msgSender())
    {
        ...
        if (
            ...
            _currency.safeTransferFrom(msgSender(), _treasury, _investorFee);
            _currency.safeTransferFrom(msgSender(), _project, _amountInvested);
        }
        ...
        _wrappedToken.mint(msgSender(), _investment);
    ...
    function repayInvestor(
        ...
        if (
            ...
            _currency.safeTransferFrom(msgSender(), _investor, _repayAmount);
        }
