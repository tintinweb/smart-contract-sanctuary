   ...
   mapping(uint8 => mapping(uint8 => uint8)) private _currentLostGenesisMana;
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
      require(
        ...
        string memory name = string(abi.encodePacked('Genesis Mana #', toString(tokenId)));
        ...
        if (_bagRefs[tokenId].lootTokenId == 0) {
          ...
          parts[7] = string(abi.encodePacked('Loot Bag #',toString(_bagRefs[tokenId].lootTokenId)));
        }
