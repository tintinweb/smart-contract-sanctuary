...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Mando", "Jabba", "Solo", "Skywalker", "Yoda", "Vader"];
  string[] secondWords = ["Kimchi", "Gimbap", "Tteok", "Jeon", "Mul", "Samgyeopsal"];
  string[] thirdWords = ["Build", "Learning", "Getting", "Throw", "Chocked", "Teaching"];
  ...
  constructor() ERC721 ("SquareNFT", "SQUARE") {
    console.log("This is my Epic NFT contract. Woah!");
  }
