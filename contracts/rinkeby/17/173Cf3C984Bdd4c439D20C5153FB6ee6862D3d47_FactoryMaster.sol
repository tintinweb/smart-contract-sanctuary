...
contract FactoryMaster {
    ...
    uint constant fee_erc20 = 0.03 ether;
    uint constant fee_erc721 = 0.04 ether;
    uint constant fee_erc2917 = 0.05 ether;
    ...
    function createChild(Types types,ConfigFee.typeFee config, string memory name,string memory symbol,uint256 _interestsRate) external payable {

         require(config != ConfigFee.typeFee.NONE, "you must enter the number 1");
        require(types != Types.none, "you must enter the number 1");
        require(keccak256(abi.encodePacked((name))) !=keccak256(abi.encodePacked((""))),"required value");
        require(keccak256(abi.encodePacked((symbol))) !=keccak256(abi.encodePacked((""))),"required value");

        if (types == Types.erc20) {

            if(config ==ConfigFee.typeFee.DEMO1){

                require(msg.value>=fee_erc20+ConfigFee.TYPE_1,"ERC20:value must be greater than 0.05");
                
                ERC20 child = new ERC20(name, symbol);
                childrenErc20.push(child);
                emit ChildCreatedERC20(address(child), name, symbol);
            }
            if(config ==ConfigFee.typeFee.DEMO2){

                require(msg.value>=fee_erc20+ConfigFee.TYPE_2,"ERC20:value must be greater than 0.06");
                
                ERC20 child = new ERC20(name, symbol);
                childrenErc20.push(child);
                emit ChildCreatedERC20(address(child), name, symbol);
            }
            if(config ==ConfigFee.typeFee.DEMO3){

                require(msg.value>=fee_erc20+ConfigFee.TYPE_3,"ERC20:value must be greater than 0.07");
                
                ERC20 child = new ERC20(name, symbol);
                childrenErc20.push(child);
                emit ChildCreatedERC20(address(child), name, symbol);
            }
            if(config ==ConfigFee.typeFee.DEMO4){

                require(msg.value>=fee_erc20+ConfigFee.TYPE_4,"ERC20:value must be greater than 0.08");
        ...
        if (types == Types.erc721) {
            ...
            if(config ==ConfigFee.typeFee.DEMO1){
                require(msg.value>=fee_erc721+ConfigFee.TYPE_1,"ERC721:value must be greater than 0.06");
            ...
            if(config ==ConfigFee.typeFee.DEMO2){
                require(msg.value>=fee_erc721+ConfigFee.TYPE_2,"ERC721:value must be greater than 0.07");
            ...
            if(config ==ConfigFee.typeFee.DEMO3){
                require(msg.value>=fee_erc721+ConfigFee.TYPE_3,"ERC721:value must be greater than 0.08");
            ...
            if(config ==ConfigFee.typeFee.DEMO4){
                require(msg.value>=fee_erc721+ConfigFee.TYPE_4,"ERC721:value must be greater than 0.09");
        ...
        if (types == Types.erc2917) {
            ...
            if(config ==ConfigFee.typeFee.DEMO1){
                ...
                require(msg.value>=fee_erc2917+ConfigFee.TYPE_1,"ERC2917:value must be greater than 0.07");
            ...
            if(config ==ConfigFee.typeFee.DEMO2){
                require(_interestsRate >= 0, "value must be greater than 0");
                require(msg.value>=fee_erc2917+ConfigFee.TYPE_2,"ERC2917:value must be greater than 0.08");
            ...
            if(config ==ConfigFee.typeFee.DEMO3){
                require(_interestsRate >= 0, "value must be greater than 0");
                require(msg.value>=fee_erc2917+ConfigFee.TYPE_3,"ERC2917:value must be greater than 0.09");
            ...
            if(config ==ConfigFee.typeFee.DEMO4){
                require(_interestsRate >= 0, "value must be greater than 0");
                require(msg.value>=fee_erc2917+ConfigFee.TYPE_4,"ERC2917:value must be greater than 0.1");
...
library ConfigFee{
    ...
    uint constant TYPE_1=0.03 ether;
    uint constant TYPE_2=0.04 ether;
    uint constant TYPE_3=0.05 ether;
    uint constant TYPE_4=0.06 ether;

    enum typeFee { NONE ,DEMO1 , DEMO2 , DEMO3 , DEMO4 }
}
