...
contract ShapesArt is ERC721Enumerable, Ownable, ReentrancyGuard{
    ...
    constructor() ERC721("shapeart", "SHP_ART")  Ownable(){}
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory){
       ...
       (shape,svg) = ShapeArtGenerator.makeShapeFactory(tokenId);
        ...
        '"}], '));
       string memory output = Base64.encode(bytes(string(abi.encodePacked('{"name": "Shape Art #', ShapeArtGenerator.toString(tokenId),'", "Description": "Abstract art painting on-chain for you to decorate your wall in the metaverse universe.",',
        attributes,
