...
contract AuctionV3 is ManagerAuction {
	...
	function migrateAuction(address _oldContract, uint256 _id) public view onlyOwner returns (bool, bool) {
		// totalAuctions = IAuctionVersion(_oldContract).totalAuctions();
		{
			...
			) = IAuctionVersion(_oldContract).auctions(_id);
