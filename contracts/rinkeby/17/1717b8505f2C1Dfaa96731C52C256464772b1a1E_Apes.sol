...
contract Apes is ERC721, Ownable {
    ...
    uint256 public preMintMaxItems = 300;
    uint256 public maxItems = 3000;
    uint256 public giveawayCount = 0;
    uint256 public preMintCount = 0;
    uint256 public totalSupply = 0;
    uint256 public maxItemsPerPreMint = 5; // Mutable by owner
    ...
    function preMint() external payable {
        ...
        require(
            preMintCount + amount <= preMintMaxItems,
            "preMint: Surpasses cap"
        );
        require(
            amount <= preMints[msg.sender],
            "preMint: Amount greater than allocation"
        );
        preMintCount += amount;
    ...
    function setMaxItemsPerPreMint(uint256 _maxItemsPerPreMint)
        external
        onlyOwner
    {
    ...
    function withdrawAll() external onlyOwner {
        uint256 amount1 = (address(this).balance * 825) / 1000;
        uint256 amount2 = (address(this).balance * 175) / 1000;
