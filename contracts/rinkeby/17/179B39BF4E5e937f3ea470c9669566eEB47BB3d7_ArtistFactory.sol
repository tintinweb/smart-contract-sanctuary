...
contract ArtistFactory is OwnableUpgradeable {
    ...
    function createTokenContract(string memory name, string memory symbol, string memory uri) payable external returns (address) {
        ...
        NiftyArtist(clone).initialize(name, symbol, uri);
