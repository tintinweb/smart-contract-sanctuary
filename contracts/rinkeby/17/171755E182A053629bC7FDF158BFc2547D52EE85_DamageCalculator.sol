...
contract DamageCalculator is IDamageCalculator, Initializable {
    IHero private _hero;
    ...
    // Computes damage per block given elements of a party
    function getDamage(
        uint256 hero,
        ...
        m += ((hStats.enhancement * PRECISION * 10) / 5) / PRECISION;
