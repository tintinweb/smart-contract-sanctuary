...
//    Do not deploy to production with this
    ...
    constructor(bool isTestInstance) ERC721("MytoBytes", "MYTO") {
    ...
    function setCurrentTime(uint256 timeToSet) public {
    ...
    function claimNotOnWhitelist() public {
        require(getCurrentTime() >= openMintStartTime, "not open mint yet");
        claim();
    }

    function claimOnWhitelist(bytes32[] calldata merkleProof) public {
        require( getCurrentTime() >= mintStartTime, "claiming hasn't started" );
        require(
