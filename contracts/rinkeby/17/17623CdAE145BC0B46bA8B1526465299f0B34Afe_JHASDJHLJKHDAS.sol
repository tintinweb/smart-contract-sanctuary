...
contract JHASDJHLJKHDAS is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    */
    ...
    /**
    * @dev Update external teams address's if needed
    */
    ...
    */
    ...
    function purchase(uint256 numberOfTokens) public payable nonReentrant {
        ...
        require(
            totalSupply().add(numberOfTokens) <= MAX_ODDBALL,
            "Purchase would exceed max supply"
        );
        require(
            numberOfTokens > 0 && numberOfTokens <= PURCHASE_LIMIT,
    ...
    function reserve(address _to, uint256 _reserveAmount) public onlyOwner {
        require(
            _reserveAmount > 0 && _reserveAmount <= oddballReserve,
