...
contract VanityNameController {
    ...
    function withdrawFeeFrom(string memory vanityName) public payable {
        ...
        require(!_vanityNameInUse(vanityName), "VanityNameController: subscription period must expire in order to withdraw fee");
    ...
    function ownerOf(string memory vanityName) public view returns (address) {
        ...
        require(owner != address(0), "VanityNameController: owner query for nonexistent vanity name");
        require(_vanityNameInUse(vanityName), "VanityNameController: vanityName expired");
