...
contract ElderlyApeClub is ERC721, Ownable, IMintedBeforeReveal {

    // This is the provenance record of all ELDERLY APES in existence. The provenance will be updated once metadata is live at launch.
    ...
    // Time after which the Elderly Apes are randomized and revealed 7 days from instantly after initial launch).
