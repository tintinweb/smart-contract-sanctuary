...
contract MetaDodge is ERC20Detailed, Ownable {
    ...
    uint256 public developFee = 1;
    uint256 public buyBackFee = 2;
    uint256 public totalFee =
        burnFee.add(liquidityFee).add(marketingFee).add(buyBackFee).add(
            developFee
        );
    ...
    address public developFeeReceiver;
    ...
    constructor() ERC20Detailed("MetaDodge", "MTDG", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0x64c3efaa73a2049B79CC51F9140eb0Be0d872F2a;
        developFeeReceiver = 0x64c3efaa73a2049B79CC51F9140eb0Be0d872F2a;
        buyBackFeeReceiver = 0x64c3efaa73a2049B79CC51F9140eb0Be0d872F2a;
    ...
    function swapBack() internal swapping {
        uint256 LiquidityFee = liquidityFee;
        ...
        uint256 amountETHDevelop = amountETH.mul(developFee).div(totalETHFee);
        uint256 amountETHEco = amountETH.mul(burnFee).div(totalETHFee);
        ...
        (success, ) = payable(developFeeReceiver).call{
            value: amountETHDevelop,
            gas: 30000
        }("");
        (success, ) = payable(burnFeeReceiver).call{
            value: amountETHEco,
            gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _developFeeReceiver,
        address _burnFeeReceiver,
        address _marketingFeeReceiver,
        address _buyBackFeeReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        developFeeReceiver = _developFeeReceiver;
