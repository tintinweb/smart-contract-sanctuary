...
contract CompoundBooster is Ownable {
    ...
    function demoInit() public {
        init(
            0xFf4013AE40aC8F81f1C234f59cBb6754EC073130,
        ...
        returns (bool)
    {
        ...
        // );
        address interestRewardPool = ICompoundPoolFactory(compoundPoolFactory)
            .CreateCompoundInterestRewardPool(lendflareToken, address(this));
        // aToken
    ...
    function _repayBorrow(
        ...
        if (isErc20) {
            ...
            ICompoundProxyUserTemplate(lendingInfo.proxyUser).repayBorrow{
                value: _amount.sub(_interestValue)
