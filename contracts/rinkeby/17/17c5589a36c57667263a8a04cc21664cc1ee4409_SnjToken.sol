...
/**
 * SNJ Token, totalSupply 100000000000000000
 */
contract SnjToken is BurnableToken, CappedToken(100000000000000000) {
    string public name = "SNJ Token";
    string public symbol = "SNJ";
