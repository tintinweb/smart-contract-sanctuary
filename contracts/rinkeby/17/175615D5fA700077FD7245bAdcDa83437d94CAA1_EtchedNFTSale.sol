...
contract EtchedNFTSale is ISale, Ownable, ReentrancyGuard {
  ...
  function buy(
    ...
    if(currentSale.owner != artistAddress){
      ...
      emit BalanceUpdated(artistAddress, currency, royalties, true);
    } else {
    ...
    emit BalanceUpdated(currentSale.owner, currency, fee, true);
  ...
  function claimFunds(address tokenContract) external {
    ...
    emit BalanceUpdated(msg.sender, tokenContract, payout, false);
  }
