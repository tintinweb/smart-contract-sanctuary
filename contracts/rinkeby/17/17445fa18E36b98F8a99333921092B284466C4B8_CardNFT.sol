...
contract CardNFT is ERC721URIStorage {
  ...
  // The function to get total minted NFT's count
  function fetchTotalSupply() public view returns(uint256) {
  ...
  function withdraw() public {
    ...
    require(ownerContract == msg.sender, "The caller is not owner of this contract.");

    // send the money to owner of contract
    ownerContract.transfer(address(this).balance);
  }
}
