...
contract NiftyBuilderInstance is ERC721, ERC721Burnable {
    ...
    string[2] artifact_1 = ["Ax00000000000000000000000000000000000000000000", //State 1a
                            "Bx00000000000000000000000000000000000000000000"];//State 2a

    string[3] artifact_2 = ["Ax11111111111111111111111111111111111111111111", //State 1b
                            "Bx11111111111111111111111111111111111111111111", //State 2b
                            "Cx11111111111111111111111111111111111111111111"];//State 3b

    string artifact_3 = "Ax22222222222222222222222222222222222222222222";
    ...
    constructor(
        ...
        id = 1;
        countType = 3;
        creator = "Julian Gilliam";

        _setNiftyTypeName(1, "Breffis");
        _numNiftyPermitted[1] = 15;
        _setNiftyTypeName(2, "FreeDOOM Rocket");
        _numNiftyPermitted[2] = 15;
        _setNiftyTypeName(3, "Love for the Low");
    ...
    function tokenIPFSHash(uint256 tokenId) external view override returns (string memory) {
        ...
        uint index = day % artifact_2.length;
        return artifact_2[index];
    }
}