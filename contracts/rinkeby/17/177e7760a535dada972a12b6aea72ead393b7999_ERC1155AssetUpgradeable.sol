    ...
    ReentrancyGuardUpgradeable
{
    ...
    {
        if(_proxyRegistry(_owner,_operator)){
            return true;
        }
    ...
    function setOpenTime(uint256 _openTime) external onlyOwner {
        require(
            ...
            "ERC1155Asset#setOpenTime: require block.timestamp < openTime"
        );
        openTime = _openTime;
    }
    ...
    function _proxyRegistry(address _user, address _address) internal view returns (bool) {
