        ...
        returns (string memory)
    {
        string memory svg = string(
            abi.encodePacked(
                ...
                (pool.cycleSecs() *
                    pool.amtPerSecond(pool.nftID(address(this), tokenId))),
                " DAI</text>",
                "</svg>"
            )
        );
        ...
        returns (string memory)
    {
        string memory svg = string(
            abi.encodePacked(
                ...
                string(
                    abi.encodePacked(
                        '<text x="20" y="80" class="medium">Project Name:</text>  <text x="150" y="80" class="small">RX Project</text>'
                    )
                ),
                string(
                    abi.encodePacked(
                        '<text x="20" y="100" class="medium">NFT-IDx:</text><text x="150" y="100" class="small">',
                        uint2str(tokenId),
                        "</text>"
                    )
                ),
                string(
                    abi.encodePacked(
                        '<text x="20" y="120" class="medium">Support-Rate:</text><text x="150" y="120" class="small">20 DAI</text>'
                    )
                ),
