...
contract BuyNFT is Ownable {
    ...
    constructor() public {
        ...
        Games[address(0xAad76bea7CFEc82927239415BB18D2e93518ecBB)].Fee = 50;
        Games[address(0xAad76bea7CFEc82927239415BB18D2e93518ecBB)].limitFee = 1000000000;
        arrGames.push(address(0xAad76bea7CFEc82927239415BB18D2e93518ecBB));
    }

    function getTokenPrice(address _game, uint256 _tokenId) public
    returns (address _tokenOwner, uint256 _Price, uint256 _fee) {
    ...
    event Sell(address _game, uint256 _tokenId, uint256 _Price, uint8 _type);
    ...
    function sell(address _game, uint256 _tokenId, uint256 _Price) public payable isOwnerOf(_game, _tokenId) {
        ...
        emit Sell(_game, _tokenId, _Price, 1);
    }
