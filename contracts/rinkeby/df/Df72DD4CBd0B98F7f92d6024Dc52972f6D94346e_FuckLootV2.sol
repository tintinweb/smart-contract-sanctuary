...
contract FuckLootV2 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public initialReserve = 100;
    ...
    string baseURI_ = 'ipfs://QmcB4PFhDEcZNPFqTUF1KPQGrfvrqmgaSNBPYmSTD7biXs/';
    ...
    function mintReservedNFTs(address[] memory to, uint256 _reserve) public onlyOwner { //Check this to make sure its how we want to reserve some of the initial supply
        require(totalMinted + _reserve + burnCount <= totalCount, "Not enough inventory");
        require(nftsReserved + _reserve <= initialReserve, "Exceeds reserve supply");
        require(_reserve > 0);
        require(to.length == _reserve);
    ...
    function getFucked(uint256 _batchCount) payable public {
        ...
        require(totalMinted + _batchCount + burnCount <= totalCount - initialReserve, "Not enough inventory");
