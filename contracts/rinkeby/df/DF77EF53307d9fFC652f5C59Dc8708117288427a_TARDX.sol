...
contract TARDX is ERC721Enumerable, Ownable {
    ...
    constructor(uint _initialDropMaxSupply, uint _airdropSupply, uint _tardXPrice, string memory _defaultURI) ERC721("tardXtest65", "tardx55") { 
