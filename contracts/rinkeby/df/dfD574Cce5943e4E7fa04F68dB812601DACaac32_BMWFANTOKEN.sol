...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1Bd2ec343C48A97C1539c44A95D443ABa21615F2;
...
contract BMWFANTOKEN is Ownable, IERC20, IERC20Metadata {
    ...
    mapping (address => bool) public _isMaxWallet;
    ...
    uint256 burnFee=500; //burn fee 5%
    uint256 liquidityFee = 500; // means 5% add liquidity
    
    
    uint256 public maxTxAmount = _totalSupply; // no limit

    //max wallet holding 2%
    uint256 public _maxWallet = 20_000_000 *(10**decimals());
    ...
    constructor () {
        ...
        _isMaxWallet[owner()] = true;
        _isMaxWallet[address(0)] = true;
        _isMaxWallet[address(this)]=true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (!inSwapAndLiquify && overMinTokenBalance && sender != uniswapV2Pair && swapAndLiquifyEnabled) {
         ...
         if(sender == uniswapV2Pair){
            ...
            if(!_isMaxWallet[recipient] && recipient != address(this)  && recipient != address(0)){
    ...
    function setFee(uint256 _burnFee, uint256 _liquidityFee) external onlyOwner {
        burnFee = _burnFee;
