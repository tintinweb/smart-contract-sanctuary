...
contract BurnProxy is Operator, IBurnProxy {
    ...
    function burnFrom(address _account, uint256 _amount)
        ...
        onlyRedeemPool
    {
        IERC20(bond).safeTransferFrom(_account, address(this), _amount);
    }

    function burnTo(address _to) public onlyOperator {
        IERC20(bond).safeTransfer(_to, IERC20(bond).balanceOf(address(this)));
    }
}
