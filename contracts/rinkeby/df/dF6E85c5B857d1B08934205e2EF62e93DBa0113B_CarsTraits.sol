...
contract CarsTraits is Ownable, ICarsTraits {
  ...
  function drawTrait(Trait memory trait) internal pure returns (string memory) {
    return string(abi.encodePacked(
      '<image x="4" y="4" width="32" height="32" image-rendering="pixelated" preserveAspectRatio="xMidYMid" xlinkHref="data:image/png;base64,',
      trait.png,
      '"/>'
    ));
  }
  ...
  function drawSVG(uint256 tokenId) public view returns (string memory) {
    ...
    return string(abi.encodePacked(
      '<svg id="car" width="100%" height="100%" version="1.1" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" xmlnsLink="http://www.w3.org/1999/xlink">',
      svgString,
      "</svg>"
    ));
  }
