...
contract AdminManager is Ownable {
    ...
    function setBrokerAddress(address _broker) onlyOwner public {
        broker = IBrokerV2(_broker);
    }

    function getBrokerAddress() public view returns (address){
    ...
    function decreaseApproval(address _erc20, address _spender, uint256 _subtractedValue) public {
        IERC20 erc20 = IERC20(_erc20);
    ...
    function increaseApproval(address _erc20, address spender, uint256 addedValue) public {
        IERC20 erc20 = IERC20(_erc20);
    ...
    function transfer(address _erc20, address to, uint256 value) public {
        IERC20 erc20 = IERC20(_erc20);
    ...
    function transferFrom(address _erc20, 
        address from,
        address to,
        uint256 value
    ) public {
    ...
    function increaseAllowance(address _erc20, address spender, uint256 addedValue) public {
        IERC20 erc20 = IERC20(_erc20);
    ...
    function decreaseAllowance(address _erc20, address spender, uint256 subtractedValue) public {
        IERC20 erc20 = IERC20(_erc20);
