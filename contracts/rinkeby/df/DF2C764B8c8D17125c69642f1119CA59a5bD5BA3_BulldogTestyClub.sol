...
contract BulldogTestyClub is ERC721, Ownable {
     ...
     */
    function mint(bool isMember,uint8 _amount) public payable{  
        ...
        if(!isMember){
            require(payerCounter < 200,"payer counter more than 200");
            payerCounter++;
            require(msg.value >= price,"value not enough");
            balance += msg.value;
            uint mintIndex = totalSupply(); 
            _safeMint(msg.sender,mintIndex);
            emit GoldMint(msg.sender, msg.value, mintIndex);
        }else{
            ...
            for(uint i = 0; i < _amount; i++) {
                ...
                emit MemberMint(msg.sender,mintIndex);
            }
        }
