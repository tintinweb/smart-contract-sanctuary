...
contract TravelingMusician is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  uint256 public price = 5000000000000000; //0.5 ETH
        ...
        bytes(
          string(
            abi.encodePacked(
              ...
              toString(tokenId),
              '", "description": "Traveling Musician: The Songs of the Metaverse. Each traveling musician carries a theme song they can play on the journey ahead. You can find the song in the tokenURI. Compatible with Loot (for Adventurers)", "song": "',
              song,
