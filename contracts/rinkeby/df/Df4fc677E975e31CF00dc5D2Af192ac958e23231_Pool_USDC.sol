...
// End Set functions //
    ...
    function redeem(
       ...
       lastRedeemed[msg.sender] = block.number;
        ...
        mintersDetails[msg.sender].amount = mintersDetails[msg.sender].amount.sub(arthAmount.mul(10e11));
    ...
    function redeemNotMinter(uint256 _arthAmount, uint256 _collateralOutMin) public {
    
    //TO DO : add pcr to the controller
    uint256 pcr = 1000000;
    uint256 collateralNeeded = calcCr(_arthAmount, pcr);
    ...
    lastRedeemed[msg.sender] = block.number;
        ...
        IERC20Burnable(_arthContractAddress).burn(_arthAmount);
        emit usedredeemNotMinter(msg.sender, _arthAmount);
    }
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0x5799a8cEf4D19ddC8b28e5A8E0f3cA5bf2edBeF5"
    }
  },
  "outputSelection": {
    "*": {
