...
// File: OwnableCollectible.sol

contract OwnableCollectible is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Flex URI", "FURI") {}
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public onlyOwner {
        require(
            ...
            "ERC 721: caller is not owner nor approved"
        );
