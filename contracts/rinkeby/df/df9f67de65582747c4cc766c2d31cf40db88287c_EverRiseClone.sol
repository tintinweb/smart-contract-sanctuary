...
contract EverRiseClone is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0cD0a57607f39bAA35AF70DD5da8EC12cA54ac9E); // Marketing Address
    ...
    string private _name = "EverRiseClone";
    string private _symbol = "RISECLONE";
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // PCS V2 MAINET
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // UNISWAP V2 TESTNET
