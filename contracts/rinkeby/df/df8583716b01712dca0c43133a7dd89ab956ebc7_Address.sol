...
contract TestLFD is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("122 LFC", "122LF") {
    setHiddenMetadataUri("ipfs://QmeAjyG9E13YDAhaDqDKHVKsJxcz3EBGgsPR1kfCr8yu3F/hidden.json");
  }
