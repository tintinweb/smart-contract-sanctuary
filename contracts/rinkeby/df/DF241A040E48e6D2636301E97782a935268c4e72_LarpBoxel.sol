...
contract LarpBoxel is ERC721URIStorage, Ownable {
  ...
  function _baseURI() internal pure override returns (string memory) {
    return "https://gateway.pinata.cloud/ipfs/QmRGw44D56EqT9ot4omG2LzJGBotCqHnsyFPj8C9YfTtkD/";
  }

  function contractURI() public pure returns (string memory) {
    return "https://gateway.pinata.cloud/ipfs/QmRGw44D56EqT9ot4omG2LzJGBotCqHnsyFPj8C9YfTtkD/contract.json";
  }
  ...
  function randomUri() private returns (string memory) {
    nonce++;
    uint randomHash = uint(keccak256(abi.encodePacked(msg.sender, block.difficulty, block.timestamp, nonce)));
