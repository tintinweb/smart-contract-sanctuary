...
contract miniFluffy is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x68bC505ADace0f0e0bBbCe605629fefd2655C2e4);
        _feeAddrWallet2 = payable(0x68bC505ADace0f0e0bBbCe605629fefd2655C2e4);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x5d08F72B19efb244767fCd36375621934cC75f13), _msgSender(), _tTotal);
    }
