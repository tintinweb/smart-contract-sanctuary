...
contract CRYPTINIES is ERC721, Ownable {
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(DEVELOPER_ADDRESS).send(current_balance / 100 * DEVELOPER_FEE));
        require(payable(CHARITY_ADDRESS).send(current_balance / 100 * (CHARITY_FEE * DEVELOPER_FEE)));
        require(payable(msg.sender).send(current_balance));
    }
}