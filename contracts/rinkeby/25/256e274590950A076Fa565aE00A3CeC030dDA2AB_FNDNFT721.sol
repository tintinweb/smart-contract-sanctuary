  ...
  NFT721Mint
{
  ...
  function initialize(
    ...
    FoundationTreasuryNode._initializeFoundationTreasuryNode(f8n);
...
/**
 * Copied from the OpenZeppelin repository in order to make the following changes:
 *  - `internal` _name/_symbol/_tokenURIs
 */
