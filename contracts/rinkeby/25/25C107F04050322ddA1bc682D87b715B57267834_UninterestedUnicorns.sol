    ...
    Ownable
{
    ...
    uint256 public constant PRIVATE_SALE_OPEN = 1630843200 + 1 hours; // For testing only
    uint256 public constant BLESSED_SALE_OPEN = 1630843200 + 1 hours + 15 minutes; // For testing only
    uint256 public constant PUBLIC_SALE_OPEN = 1630843200 + 1 hours + 30 minutes; // For testing only
    ...
    function privateMint() public payable whenNotPaused {
        ...
        require(
            block.timestamp <= PRIVATE_SALE_OPEN.add(15 minutes),
    ...
    function blessedMint() public payable whenNotPaused {
        ...
        require(
            block.timestamp <= BLESSED_SALE_OPEN.add(15 minutes),
