...
contract DungeonsAndDragonsCharacter is ERC721, VRFConsumerBase, Ownable {
        ...
        override
    {
        ...
        uint256 latitude = ((randomNumber % 3568600) / 3568579);
        uint256 longitude = ((randomNumber % 13969220) / 13969200);
        uint256 attack = ((randomNumber % 1000000) / 10000 );
        uint256 defense = ((randomNumber % 100000000) / 1000000 );
        uint256 stamina = ((randomNumber % 10000000000) / 100000000 );
        ...
        )
    {
        return (
            ...
            characters[tokenId].latitude + characters[tokenId].longitude + characters[tokenId].attack + characters[tokenId].defense + characters[tokenId].stamina,
            getLevel(tokenId),
    ...
    {
        return (
            characters[tokenId].latitude,
            characters[tokenId].longitude,
