...
contract ItemToken is ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    // @constructor
    function init(string memory _name, string memory _symbol) public isNotPaused initializer {
    ...
    ) isNotPaused public returns (uint256) {
    ...
    function buy(uint256 _tokenId) isNotPaused public payable {
