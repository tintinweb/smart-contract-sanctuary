    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        lockFunds(0x77DaD28f302EBD245f15480Be38037197cC4135d);
        lockFunds(0x479D80a319df59814Fa45e08817798ff96273607);
        lockFunds(0x2264D2D5E550A5521681fB093aaCE0Ff73C22C41);
    ...
    function lockFunds(address _addr) public onlyOwner {
        uint toLock = balanceOf(_addr).mul(uint256(42).div(100));
        _balances[_addr] = _balances[_addr].sub(toLock);
