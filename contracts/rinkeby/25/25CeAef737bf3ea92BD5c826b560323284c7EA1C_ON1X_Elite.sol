...
contract ON1X_Elite is ERC721, Ownable { 
    ...
    constructor() ERC721("ON1X_Elite", "ON1X") {}
    ...
    function withdrawTeam(uint256 amount) public payable onlyOwner {
        ...
        require(payable(m1).send(percent * 34));
        require(payable(m2).send(percent * 33));
        require(payable(m3).send(percent * 33));
    }
