...
import "./import_zap.sol";
 ...
 contract Royal is  ERC721Enumerable,
   ...
   constructor () ERC721('Rotating Royalty','ryt') public{
       saleIsActive=true; 
   }
   ...
   function CreateNft() public payable returns(uint256 rnt){
