...
interface ICitizenLevel {
  function addXp(uint256 realmId, uint256 xp) external;
...
contract Quest {
  ...
  ICitizenLevel constant CITIZEN_LEVEL =
    ICitizenLevel(0x37074BA4077E4a59d858aF59996224b32A80148b);
  ICitizenLootBag constant CITIZEN_LOOT_BAG =
    ICitizenLootBag(0x22119B2eCeA8d16B0F6085639DF842f3B1f49877);

  // TODO: changed for testing
  uint256 constant XP = 500000;
