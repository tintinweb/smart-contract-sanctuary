...
contract zack is ERC721Enumerable, Ownable {
    // Set collection provenance
    string public PROVENANCE = "dd70929be5ec3a04112cc8179d2b915e07e97262c6bda7bca975934d112929bc";
    ...
    address a1 = 0xe7583e054019fba574932B70Da249fb29b295C6B;
    address a2 = 0xEB5ceF5483B93e9d3FC58BEe5901564Aa303EfAB;
    address a3 = 0x3031b32cF661A30b1a2f7b643bAaDe9Cd59D4fC3;

    constructor(string memory baseURI) ERC721("zack", "zk") {
        setBaseURI(baseURI);
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(a1).send(share * 40));
