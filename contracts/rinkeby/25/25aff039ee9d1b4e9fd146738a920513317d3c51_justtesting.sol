...
contract justtesting is Context, IERC20, Ownable {
    ...
    string private constant _name = "justtesting";
    string private constant _symbol = "justtesting";
    ...
    function sendETHToFee(uint256 amount) private {
        _devWallet.transfer(amount.mul(20).div(100));
        _teamWallet.transfer(amount.mul(40).div(100));
        _marketingWallet.transfer(amount.mul(40).div(100));
