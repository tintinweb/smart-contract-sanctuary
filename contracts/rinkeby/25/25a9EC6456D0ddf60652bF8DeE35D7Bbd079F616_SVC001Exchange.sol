...
contract SVC001Exchange is Ownable {
    ...
    function claim(uint256 claimAmount) external {
        ...
        uint256 ethTotalAmount = 1579;
        uint256 tokenTotalSupply = 208613;
        uint256 formattedClaimAmount = (claimAmount * (10**10));
        uint256 mult = (ethTotalAmount * formattedClaimAmount);
        uint256 ethAmount =  mult / tokenTotalSupply;
