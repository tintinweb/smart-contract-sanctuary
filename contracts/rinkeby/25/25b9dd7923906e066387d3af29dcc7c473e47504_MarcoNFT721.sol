...
contract MarcoNFT721 is ERC721 {
     ...
     * @param creator address of the token to be minted.
     * @param tokenURI string memory URI of the token to be minted.
     * @param fee uint256 royalty of the token to be minted.
     */

    function createCollectible(address creator, string memory tokenURI, uint256 fee) public payable returns (uint256) {
