...
interface OSP {
   ...
   function scaledReward(uint amount) external returns(bool);
...
//======================================EVENTS=========================================//
    ...
    event RewardDistributionEvent(address indexed from, address indexed to, uint amount);
...
//======================================ACTION CALLS=========================================// 
    ...
    function DistributeReward(uint _amount, address _address) public onlyCreator returns(bool){
        
        require(_address != address(0), "Insertion of address(0) is not supported");
        OSP(_address).scaledReward(_amount); 
        require(IERC20(Axiatoken).transfer(_address, _amount), "Transaction failed");
        emit RewardDistributionEvent(address(this), _address, _amount);
