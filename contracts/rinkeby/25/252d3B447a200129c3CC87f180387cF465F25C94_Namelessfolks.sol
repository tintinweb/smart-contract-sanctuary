...
contract Namelessfolks is ERC721Enumerable, Ownable {
  ...
  address a1 = 0xc279C8b5ce0128C99F9Fc4671356e70a63DEd798;
  address a2 = 0x1AB9B9c23863814574538dFb6bA3125E73e1be57;
  ...
  function adoptFolk(uint256 _tokenId) external payable {
      require(_isOnPublicSale, "TRANSACTION: Public sale is not active");
      require(msg.value >= FOLK_PRICE, "PAYMENT:  Insufficient ETH value");
