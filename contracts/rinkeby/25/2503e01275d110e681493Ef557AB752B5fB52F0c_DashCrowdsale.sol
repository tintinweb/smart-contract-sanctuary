...
contract Crowdsale is Context {
     ...
     * @param collateralAmount Amount of collateral tokens involved in the purchase
     */
    function _postValidatePurchase(address beneficiary, uint256 collateralAmount) internal view {
    ...
    function _getTokenAmount(uint256 collateralAmount) virtual internal view returns (uint256) {
        return collateralAmount.mul(_rate);
    }
...
import "./validation/OptionalWhitelistCrowdsale.sol";

contract DashCrowdsale is OptionalWhitelistCrowdsale {
  constructor(uint256 rate, address wallet, IERC20 token, IERC20 collateral)
...
/**
 * @title OptionalWhitelistCrowdsale
 * @dev Crowdsale in which only whitelisted users can contribute.
 */
abstract contract OptionalWhitelistCrowdsale is WhitelistedRole, Crowdsale {
     ...
     */
    function setWhitelistOptional(bool optional) external {
        _optional = optional;
     ...
     * @param _collateralAmount Amount of collateral tokens involved in the purchase
     */
    function _preValidatePurchase(address _beneficiary, uint256 _collateralAmount) override internal view {
        require(isWhitelistOptional() || isWhitelisted(_beneficiary), "WhitelistCrowdsale: beneficiary doesn't have the Whitelisted role");
        super._preValidatePurchase(_beneficiary, _collateralAmount);
    }
}
