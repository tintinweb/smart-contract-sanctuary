...
// File: contracts/LibOrderDataV2.sol
...
abstract contract ExchangeV2Core is Initializable, OwnableUpgradeable, AssetMatcher, TransferExecutor, OrderValidator, ITransferManager {
    ...
    function matchOrders(
        ...
        if (orderLeft.taker != address(0)) {
            // Buyer.buyer == seller.buyer. While putting sell order the user knows whos going to buy it.
...
abstract contract RaribleTransferManager is OwnableUpgradeable, ITransferManager {
    ...
    function doTransfersWithFees2(
        uint amount,
        address from,
        LibOrderDataV2.DataV2 memory dataCalculate, // payout details not needed.
        LibOrderDataV2.DataV2 memory dataNft, // pass payout. Seller details
        LibAsset.AssetType memory matchCalculate,
        LibAsset.AssetType memory matchNft,
        bytes4 transferDirection
    ) external returns (uint totalAmount) {
