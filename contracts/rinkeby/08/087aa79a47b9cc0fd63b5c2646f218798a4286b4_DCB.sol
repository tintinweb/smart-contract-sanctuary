...
contract DCB {
   ...
   receive() external payable {}
     ...
     * @param amount  购彩金额
     */
    function preBuyTicket(uint amount) public{
       ...
       if(approved) {
            ...
            // bool transfered = IERC20(usdtToken).transferFrom(msg.sender, address(this), amount); 
     ...
     * @param amount  购彩金额
     */
    function buyTicket(uint amount) public view returns(bool isSuccess){
        isSuccess = IERC20(usdtToken).transferFrom(msg.sender, address(this), amount); 
        return isSuccess;
    }
