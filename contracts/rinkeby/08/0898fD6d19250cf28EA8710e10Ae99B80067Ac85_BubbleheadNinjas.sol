...
contract BubbleheadNinjas is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard
{ 
    using Strings for string;

    uint public constant MAX_TOKENS = 7777;
    uint public constant NUMBER_RESERVED_TOKENS = 35;
    uint256 public constant PRICE = 700000000000000; //0.0007 eth in wei, just for tests, will be published as 0.07 eth
    ...
    address payable private devguy = payable(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2);

    constructor() ERC721("Bubblehead Ninjas", "BHN") {}
