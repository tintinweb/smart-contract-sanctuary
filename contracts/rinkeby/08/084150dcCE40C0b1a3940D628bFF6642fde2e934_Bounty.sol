    ...
    Ownable
{
    ...
    uint256 private _heroicItemRolls = 6;
    uint256 private _epicItemRolls = 12;
    uint256 private _legendaryItemRolls = 24;
    ...
    constructor(address lootContractAddress, address lootComponentAddress, address goldContractAddress, address gloryContractAddress, address mlootContractAddress)
    ...
    function completeBounty(uint256 tokenId) public {
        ...
        for (uint256 i = 1; i < numRecipients; i += 1) {
            ...
            if (lootTokenId <= 8000) {
                ...
                _gloryContract.mint(_mlootContract.ownerOf(lootTokensPledged[tokenId][i]), rewardPerRecipient);
            }
        }
        ...
        returns (string memory)
    {
        ...
        string memory questTypeAttribute = ['Heroic', 'Epic', 'Legendary'][getDifficulty(tokenId)];
        ...
        output = string(abi.encodePacked(output, unicode'<text x="10" y="330" class="base">A reward of ✨', reward, unicode' 𝔾𝕃𝕆ℝ𝕐✨ shall be split among the party.</text></svg>'));
