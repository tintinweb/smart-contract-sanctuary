    ...
    NFT721Mint
{
    ...
    function _beforeTokenTransfer(
        ...
        uint256 count = perkTransfer[tokenId];
        perkTransfer[tokenId] = count++;

        require(perkTransfer[tokenId] <= 2, "Not authorized to transfer");
    ...
    ERC721Upgradeable
{
     ...
     */
    mapping(string => bool) private creatorToTokenUriToMinted;
     ...
     */
    function getHasCreatorMintedTokenUri(string memory tokenUri)
        public
        view
        returns (bool)
    {
        return creatorToTokenUriToMinted[tokenUri];
    }
        ...
        internal
    {
        ...
        require(
            !creatorToTokenUriToMinted[tokenUri],
            "NFT721Metadata: NFT was already minted"
        );

        creatorToTokenUriToMinted[tokenUri] = true;
    ...
    function _burn(uint256 tokenId) internal virtual override {
        delete creatorToTokenUriToMinted[_tokenURIs[tokenId]];
    ...
    NFT721Metadata
{
     ...
     */
    function mintAndApproveMarketForAsset(string memory tokenPath)
        public
     ...
     * @notice Allows a creator to mint an NFT.
     */
    function mintAndApproveMarketForPerk(string memory tokenPath)
        public
        returns (uint256 tokenId)
    {
        tokenId = nextTokenId++;
