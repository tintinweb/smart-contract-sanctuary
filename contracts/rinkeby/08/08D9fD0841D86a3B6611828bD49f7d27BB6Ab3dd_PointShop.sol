...
contract PointShop is ERC1155Receiver, Ownable {
    ...
    function setConstraints(address _uToken, address _contract, uint256[] calldata _ids, bool _isAllowed, bool _anyAllowed) public {
    ...
    function deposit(address _uToken, uint256[] calldata tokenIDs, uint256[] calldata amounts, uint256[] calldata prices, address contractAddr) external {
        ...
        isShopAdmin[_uToken][msg.sender] || isPublic, "PointShop: Only shop admin can add to shop");
    ...
    function add(address _uToken, bool _withUpdate) public {
        require(Converter(_uToken).issuer() == msg.sender || 
        isShopAdmin[_uToken][msg.sender] || isPublic, "PointShop: Only shop admin can add shop to farm");
