...
library QuiltGenerator {
    ...
    struct RandValues {
        ...
        uint256 bg;
        uint256 sf;
        uint256 specialPatchPosX;
        uint256 specialPatchPosY;
        ...
        returns (QuiltStruct memory, string memory)
    {
        ...
        rand.includesSpecialPatch = random(seed, "ISP") % 4000 > 3996;
        rand.specialPatchPosX = random(seed, "SPX") % quilt.patchXCount;
        rand.specialPatchPosY = random(seed, "SPY") % quilt.patchYCount;
        ...
        for (uint256 col = 0; col < quilt.patchXCount; col++) {
            for (uint256 row = 0; row < quilt.patchYCount; row++) {
                ...
                if (rand.includesSpecialPatch) {
                    quilt.patches[rand.specialPatchPosX][
                        rand.specialPatchPosY
                    ] = 15;
                }
            }
        }
