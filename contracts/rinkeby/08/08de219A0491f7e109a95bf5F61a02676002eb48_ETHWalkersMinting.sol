...
contract ETHWalkersMinting is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address payable public payoutsAddress = payable(address(0x0554FCC6C6eEe2A1502C7FaACBcb450f98c55Af6)); // TODO: Update with address from ETHWalkersPayments.sol
    ...
    //address boredApesAddress = 0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D; // Live Address
    address boredApesAddress = 0x5283419AC661651beB0d162BB87F384A1433C4a4; // ToDo: TEST ADDRESS ONLY - remove 
    // address mutantApesAddress = 0x60E4d786628Fea6478F785A6d7e704777c86a7c6; // Live Address
    address mutantApesAddress = 0x88489b4D8842C938CCB4e30654dDA705dcEDd730; // ToDo: TEST ADDRESS ONLY - remove
    // address nerdyNuggetsAddress = 0xb45F2ba6b25b8f326f0562905338b3Aa00D07640; // Live Address
    address nerdyNuggetsAddress = 0x886334B629308dd0D2EAB95e956ddff714457BeB; // ToDo: TEST ADDRESS ONLY - remove before prod
    // address zenAcademyAddress = 0xf64e6fB725f04042b5197e2529b84be4a925902C; // Live Address
    address zenAcademyAddress = 0xF6090818DCc7955c0ec910a76a896B05F7B6C962; // ToDo: Test Address only
...
//        else if(block.timestamp >= presaleApeStart && boredApes.balanceOf(destination) > 0) {
//       		require(boredApes.balanceOf(destination) > 0, "Must own BAYC, MAYC, or ZA token to mint during Ape presale");
//       	} else if(block.timestamp >= presaleApeStart && mutantApes.balanceOf(destination)) {
//       		require(mutantApes.balanceOf(destination) > 0, "Must own BAYC, MAYC, or ZA token to mint during Ape presale");
//       	} else if(block.timestamp >= presaleApeStart && zenAcademyAddress.balanceOf(destination) > 0) {
//       		require(zenAcademyAddress.balanceOf(destination) > 0, "Must own BAYC, MAYC, or ZA token to mint during Ape presale");
//       	}
