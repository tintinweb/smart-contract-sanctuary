...
*   @notice ERC721 smart contract with access control
...
contract dontDieBook is ERC721, AccessControl {
    ...
    uint256 private _totalSupply = 892;
    ...
    */
    ...
    /**
    *   @notice function to set total supply
    *   @dev requires ADMIN access
    *   @param supply_ uint256 specifying supply
    */
    function setTotalSupply(uint256 supply_) public onlyRole(ADMIN) {
