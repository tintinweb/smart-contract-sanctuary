...
// Following the recent worldwide pandemic, emerging reports suggest that several duck species have begun exhibiting strange characteristics. Our research team located across the globe has commenced efforts to study and document these unusual phenomena.
...
// The fate of the world's ducks depends on it.

// from our website (https://lazyducks.co)

// DucksProject is a community-centered enterprise focussed on preserving our research about the emerging reports that several duck species have begun exhibiting strange characteristics following the recent worldwide pandemic. 
...
contract DucksProject is ERC721, Ownable {
    ...
    uint256 public constant duckPrice = 20000000000000000; // 0.020 ETH
    ...
    constructor() ERC721("Lazy Duck", "BDC") { }
