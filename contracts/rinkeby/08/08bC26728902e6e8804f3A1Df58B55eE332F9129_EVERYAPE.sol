...
3) 14% buyback and marketing tax is collected and 6% of it is sent for marketing fund and other 7% is used to buyback the tokens
   And 1% Animal House NFT Donation (animalhousenft.io).
...
contract EVERYAPE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xBFd4a78f174B262A5763C28Ab3aAc120dc9E4496); // Marketing Address
    address payable public ahouseAddress = payable(0x040C41Aee080e3BcD659bFc77Bbbb70F4AFB0aBa); // Animal House Address
    ...
    uint256 public ahouseDivisor = 1;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //Send to Ahouse address
        transferToAddressETH(ahouseAddress, transferredBalance.div(_liquidityFee).mul(ahouseDivisor));
