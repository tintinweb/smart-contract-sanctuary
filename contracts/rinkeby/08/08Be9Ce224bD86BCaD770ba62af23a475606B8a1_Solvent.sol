...
contract Solvent is ERC721, ERC721Burnable, Ownable {
    ...
    ) public ERC721("SOLVENCY", "SOLVENCY") {
        tokenUriBase = givenTokenUriBase;
    ...
    function setPricePerPiece(uint256 givenPricePerPiece) public onlyOwner {
        pricePerPiece = givenPricePerPiece;
    }
    ...
    function setTokenUriBase(string memory givenTokenUriBase) public onlyOwner {
        tokenUriBase = givenTokenUriBase;
    }
    ...
    {
        require(
            lastMintedId <= maxNumberOfPieces,
            "all pieces sold out -- cant change max number"
        );
        maxNumberOfPieces = givenMaxNumberOfPieces;
    }
