...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[xtkn140711][ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[xtkn140711][ownable] new owner is the zero address");
...
contract IXTKN140711Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN140711Project{
    function init() public{}
...
contract IXTKN140711StakingLocked{
    function init(uint256, uint256) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN140711PreSale{
    function init(uint256, address) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN140711Lottery{
...
*/
contract XTKN140711 is Context, IERC20, Ownable, RobinHood, Native, ReentrancyGuard{
    // public properties
        // lib
        ...
        // interfaces
            ...
            IXTKN140711Liquidity private _liquidity;
            IXTKN140711Project private _project;
            IXTKN140711Staking private _staking;
            IXTKN140711StakingLocked private _staking30D;
            IXTKN140711StakingLocked private _staking90D;
            IXTKN140711StakingLocked private _staking180D;
            IXTKN140711StakingLocked private _staking365D;
            IXTKN140711PreSale private _preSale;
            IXTKN140711Lottery private _lottery;
        ...
        // addresses
            ...
            address public ADDRESS_ERC20_USDC = 0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b; // address of the USDC coin on this blockchain
        ...
        // taxes
            ...
            uint16 public TAX_SELL_REDISTRIBUTE_ROBIN_HOOD = 110; // 11% of all tokens taken by robin hood will be added to the staking pool and lottery (2x11%)
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals
            string private _name = "XTKN140711"; // the name of our project
            string private _symbol = "XTKN140711";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN140711Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN140711Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(
        ...
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN140711Staking(ADDRESS_STAKING);
            _staking.init();
            
            _staking30D = IXTKN140711StakingLocked(ADDRESS_STAKING_DAYS30);
            _staking30D.init(1642141264, 30);

            _staking90D = IXTKN140711StakingLocked(ADDRESS_STAKING_DAYS90);
            _staking90D.init(1642141264, 90);

            _staking180D = IXTKN140711StakingLocked(ADDRESS_STAKING_DAYS180);
            _staking180D.init(1642141264, 180);

            _staking365D = IXTKN140711StakingLocked(ADDRESS_STAKING_DAYS365);
            _staking365D.init(1642141264, 365);
    ...
    function initPreSale(address contractAddress, address contractVault) public onlyOwner{
        if(!_contractPreSaleActive){
            ...
            // init contract
            _preSale = IXTKN140711PreSale(ADDRESS_PRESALE);
            _preSale.init(1642141264, ADDRESS_PRESALE_VAULT);
    ...
    function initLottery(address contractAddress) public onlyOwner{
        if(!_contractLotteryActive){
            ...
            // init contract
            _lottery = IXTKN140711Lottery(ADDRESS_LOTTERY);
            _lottery.init(1642141264);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[xtkn140711] approve from the zero address");
        require(spender != address(0), "[xtkn140711] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[xtkn140711] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[xtkn140711] transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function price() public view returns(uint256){
        require(_contractLiquidityActive, "[xtkn140711] no liquidity, no price!");
    ...
    function _transfer(address pFrom, address pTo, uint256 pAmount) private{
        ...
        if(pFrom == ADDRESS_PAIR){
            require(SWAPPING_ENABLED, "[xtkn140711] trading disabled during presale!");
