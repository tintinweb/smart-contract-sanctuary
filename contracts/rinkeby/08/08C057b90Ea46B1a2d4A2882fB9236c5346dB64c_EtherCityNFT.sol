...
contract EtherCityNFT is ERC721, Pausable, Ownable, RoyaltiesV2Impl {
    ...
    function mint() public payable whenNotPaused {
        ...
        if (msg.sender != owner()) {
            ...
            uint256 ticketID2 = inbox.depositEth{value: (msg.value / 4)}(10000000000000000000);

            IBridge bridge = inbox.bridge();
            bridge.executeCall(TEAM_WALLET, msg.value / 2, "");
    ...
    function anotherTest() public view returns (address) {
        return AddressAliasHelper.applyL1ToL2Alias(address(0x7B81F0eEF247F06E64fdF61F39Bd15ad71c01e7e));
    }
