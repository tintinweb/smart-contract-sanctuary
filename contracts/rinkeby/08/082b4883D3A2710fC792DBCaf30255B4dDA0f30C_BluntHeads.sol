...
contract BluntHeads is ERC1155, Ownable, Pausable, ERC1155Burnable, ReentrancyGuard
{
    /*--------------------
        * VARIABLES *
    ---------------------*/
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/Qmea7uYRwiDnefF93nVJWeEPZn8cGEstsunsE766vw9A4g/{id}.json") { }
    ...
    function BluntHeadsMint(uint256 numberOfTokens) public payable nonReentrant
    {
        ...
        {
            uint256 numFree = numberOfTokens.div(3);
    ...
    function __withdrawEther() public onlyOwner 
    { 
        require(address(this).balance > 0, "Zero Ether Balance");
        payable(_BHMultisig).transfer(address(this).balance); 
    }
