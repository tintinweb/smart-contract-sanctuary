...
contract StakingRewardsFactory is Ownable {
    ...
    function deploy(address stakingToken, 
                    ...
                    uint256 minimumLockDays) public onlyOwner {
        StakingRewardsInfo storage info = stakingRewardsInfoByStakingToken[stakingToken];
        require(info.stakingRewards == address(0), 'StakingRewardsFactory::deploy: already deployed');

        info.stakingRewards = address(new StakingRewards(/*_rewardsDistribution=*/ address(this), rewardsToken, stakingToken, nonWithdrawalBoost, nonWithdrawalBoostPeriod, minimumLockDays));
