...
contract testjpeg is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("testjpeg", "testjpeg") {
    setHiddenMetadataUri("ipfs://QmcbjKicQfGiq2hzUaKFi8ivicdBjBpgpPd3tXjkvW9VJC/hidden.json");
  }
