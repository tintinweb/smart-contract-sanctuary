...
contract ERC1155Tradable is ERC1155MintBurn, Ownable {
    ...
    /**
     * Override isApprovedForAll to whitelist user's NFTMarketplace proxy accounts to enable gas-free listings.
     */
    function isApprovedForAll(address _owner, address _operator)
        public
        view
    ...
    {
        // Whitelist NFTMarketplace proxy contracts for easy trading.
...
/**
 * @title AssetContract
 * AssetContract - A contract for easily creating non-fungible assets on NFTMarketplace.
 */
contract AssetContract is ERC1155Tradable {
    ...
    function NFTMarketplaceVersion() public pure returns (string memory) {
        return "2.0.3";
    }
    ...
    /**
     * Compat for factory interfaces on NFTMarketplace
 ...
 * NFTMarketplace shared asset contract - A contract for easily creating custom assets on NFTMarketplace
 */
