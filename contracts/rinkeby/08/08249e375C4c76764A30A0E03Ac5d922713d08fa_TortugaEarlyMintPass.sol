...
contract TortugaEarlyMintPass is ERC721, ReentrancyGuard, Ownable {
    ...
    constructor(string memory customBaseURI_) ERC721("TortugaEarlyMintPass", "TUGAPASS"){
    ...
    function mint() public payable nonReentrant {
        ...
        require(balanceOf(_msgSender()) == 0, "Address already owns mint pass");
