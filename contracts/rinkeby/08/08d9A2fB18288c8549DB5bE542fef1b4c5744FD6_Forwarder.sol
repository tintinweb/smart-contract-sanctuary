...
contract Forwarder is Initializable, AccessControlUpgradeable {
    ...
    function initialize(string memory name, string memory version) public initializer {
        ...
        setDomainSeparator(name, version);
    }

    function setDomainSeparator(string memory name, string memory version) public onlyAdmin {
    ...
    */
    ...
    function execute(ForwardRequest calldata req, bytes calldata signature) public payable onlyAdmin returns (bool, bytes memory) {
