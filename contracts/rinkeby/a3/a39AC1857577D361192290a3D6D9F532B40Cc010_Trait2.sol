...
contract Trait2 is TraitBase {
	constructor(address factory) TraitBase("Body Color", factory) {
		items.push(Item("body color 1", "#FDA78B"));
		items.push(Item("body color 2", "#F9BBDC"));
		items.push(Item("body color 3", "#A4A4F4"));
		items.push(Item("body color 4", "#69DCFF"));
		items.push(Item("body color 5", "#79E8B3"));
		items.push(Item("body color 6", "#F4DA5B"));
		items.push(Item("body color 7", "#4F4F4F"));
