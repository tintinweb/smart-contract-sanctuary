...
// Written by: afellanamedrob & thezman
...
contract RND is ERC721A, ReentrancyGuard, Ownable, EIP712Whitelisting {
    ...
    ) ERC721A("Research and Development", "RND", _maxBatchSize, _collectionSize) EIP712Whitelisting() {
    ...
    /** WHITELIST **/
    function checkWhitelist(bytes calldata signature) public view
    ...
    function setMultiMint(uint256 _maxMultiMint) external onlyOwner {
        maxMintCountPerTxn = _maxMultiMint;
    }
