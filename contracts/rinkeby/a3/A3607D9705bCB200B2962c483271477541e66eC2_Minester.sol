...
// File: contracts/Minester.sol


pragma solidity >=0.8.0 <0.9.0;


contract Minester is ERC721Tradable {
    constructor(
        address _proxyRegistryAddress
    ) ERC721Tradable('Minester', 'MINE', _proxyRegistryAddress) {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://ipfs.io/ipfs/QmRjxbZDrKdKkXA3YQmrZKSWuUY1VzvSSabMKcieyXbPcX/";
    }
}