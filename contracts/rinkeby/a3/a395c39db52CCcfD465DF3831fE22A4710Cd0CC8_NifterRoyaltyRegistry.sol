 ...
 * @title IERC1155 Non-Fungible Token Creator basic interface
 */
contract NifterRoyaltyRegistry is Ownable, IERC1155CreatorRoyalty {
    ...
    /////////////////////////////////////////////////////////////////////////
    // getPercentageForSetERC1155TokenRoyalty
    /////////////////////////////////////////////////////////////////////////
    /**
     ...
     * @return uint8 wei royalty fee.
     */
    function getPercentageForSetERC1155TokenRoyalty(
        uint256 _tokenId
    ) external view returns (uint8) {
        return tokenRoyaltyPercentage[_tokenId];
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    // setPercentageForSetERC1155TokenRoyalty
    /////////////////////////////////////////////////////////////////////////
    /**
     ...
     */
    function setPercentageForSetERC1155TokenRoyalty(
        uint256 _tokenId,
        uint8 _percentage
        ...
        require(
            ...
            iERC1155TokenCreator.tokenCreator(_tokenId) ||
            msg.sender == owner(),
            "setPercentageForSetERC1155TokenRoyalty::Must be contract owner or creator "
        );
        require(
            _percentage <= 100,
            "setPercentageForSetERC1155TokenRoyalty::_percentage must be <= 100"
        );
    ...
    function restore(address _oldAddress, address _oldNifterAddress, uint256 _startIndex, uint256 _endIndex) external onlyOwner {
        NifterRoyaltyRegistry oldContract = NifterRoyaltyRegistry(_oldAddress);
        ...
        for(uint i = _startIndex; i < _endIndex; i++){
            ...
            uint8 percentage = oldContract.getPercentageForSetERC1155TokenRoyalty(tokenId);
            if(percentage != 0){
    ...
    function calculateRoyaltyFee(
        ...
        _amount
        .mul(
            getERC1155TokenRoyaltyPercentage(_tokenId)
        )
        .div(100);
    }
