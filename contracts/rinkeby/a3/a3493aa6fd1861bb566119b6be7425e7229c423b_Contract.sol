...
contract Contract is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    function redeem(address player, uint _amount) public payable {
        _grantRole(PLAYER, player);
        uint r_amount = _amount * 1000000000000000000;
