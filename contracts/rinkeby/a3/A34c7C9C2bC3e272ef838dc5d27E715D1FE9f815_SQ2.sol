...
contract SQ2 is ERC721, ERC721Pausable, Ownable {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override(ERC721Pausable, ERC721) whenNotPaused {
