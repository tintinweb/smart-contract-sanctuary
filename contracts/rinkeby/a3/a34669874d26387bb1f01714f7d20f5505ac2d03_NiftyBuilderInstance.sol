...
contract NiftyEntity {
   ...
   function setMasterBuilderContract(address newMasterBuilderContract) onlyValidSender public {
       masterBuilderContract = newMasterBuilderContract;
   }

   function setNiftyRegistryContract(address newNiftyRegistryContract) onlyValidSender public {
       niftyRegistryContract = newNiftyRegistryContract;
   }
}
