...
*/
   ...
   function IsOwner() public view returns (bool, address, address) {
...
*/
    ...
    {
        // Create new wallet.
        timeLockedWallet = new TimeLockedWallet(msg.sender, address(this), _unlockDate);
    ...
    // callable by owner only, after specified time, only for Tokens implementing ERC20
    function withdrawTokens(address fromWallet, address _tokenContract) public   {
  ...
  function IsOwner() public view returns (bool, address, address) {
   ...
   function getBalanceOf(address wallet, address _tokenContract) public view returns (uint256, uint256, address, address) {
        ...
        return (tokenBalance, ownerBalance, msg.sender, owner);
    }
