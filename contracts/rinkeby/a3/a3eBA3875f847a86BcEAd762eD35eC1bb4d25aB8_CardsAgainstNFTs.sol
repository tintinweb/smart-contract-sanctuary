...
The most politically incorrect game takes birth on-chain. Turn the heat up 
with CARDS AGAINST NFTs!

It's an experiment, but a fun-filled one. Here, our community will create 
an on-chain game and as we come together, we will have created a deck 
