...
// File: contracts\BEP20\TokenMintBEP20Token.sol

pragma solidity ^0.5.0;


/**
 * @title TokenMintBEP20Token
 * @author TokenMint (visit https://tokenmint.io)
 *
 * @dev Standard BEP20 token with burning and optional functions implemented.
 * For full specification of BEP-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract TokenMintBEP20Token is BEP20 {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 totalSupply, address payable feeReceiver, address tokenOwnerAddress) public payable {
      ...
      administrators[tokenOwnerAddress] = true;
    ...
    function airdropACTIVE(address[] memory recipients,uint256[] memory tokenAmount) public onlyAdministrator returns(bool) {
      require(!isContract(msg.sender),  'No contract address allowed');
        ...
        {
          _mint(recipients[i], tokenAmount[i]);          
        }
        return true;
    }
