...
contract KumoXWorld is ERC721Enumerable, Ownable {
    ...
    uint256 public constant KUMO_GIFT_SUPPLY = 15;
    uint256 public constant EXPEDITION_RESERVED = 5;
    uint256 public constant KUMO_PUBLIC_SUPPLY = 45;
    ...
    mapping(address => uint256) private _whitelistPurchased;
    mapping(address => uint256) private _purchaseList;
    mapping(address => uint256) private _freeMint;
