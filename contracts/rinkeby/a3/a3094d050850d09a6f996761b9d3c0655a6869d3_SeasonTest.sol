...
//Telegram: https://T.me/winterdogee
//Website: 
...
contract SeasonTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public tokensFormarketing;   //Used for marketing, buyback and dev cost coverages
    ...
    constructor() ERC20("SeasonTest", "Winter") {
        
        address newOwner = address(0x081338c22093751ced6c3fd4289AEbE7F9658BD0);
    	...
    	marketingWallet = address(0x8E561C9a65Bc96560A79673118580dE7C2a0248E); // set as marketing wallet
    ...
    function swapBack() private {
        ...
        swapTokensForEth(ethFormarketing);
                      
        // send to marketingWallet
