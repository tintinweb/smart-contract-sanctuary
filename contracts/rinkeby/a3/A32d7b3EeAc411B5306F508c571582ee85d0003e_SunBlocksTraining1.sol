...
contract SunBlocksTraining1 is ERC721Enumerable, Ownable, RandomlyAssigned {
 ...
 // bool public publicPaused = true;
  ...
  function presaleMint(uint256 _mintAmount) external payable {
      ...
      require(_mintAmount > 0, "You can 1 or more tokens");
      require(_mintAmount <= maxPresaleMintAmount, "Exceeds max presale mint amount");
      require(totalSupply() + _mintAmount <= maxBlocksSupply, "Exceeds max block supply");
      require(publicSupplyMinted + _mintAmount <= publicMaxSupply, "Exceeds max supply");
      require(msg.value >= cost * _mintAmount, "Insufficien payment");
