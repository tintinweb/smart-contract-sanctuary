...
contract WeMintArt is ERC721URIStorage, ERC721Enumerable, AccessControlEnumerable, Ownable, IERC2981 {
    ...
    address public baseRoyaltiesReceiver;

    uint256 public baseRoyaltiesPercent;
    ...
    function setTokenRoyalty(
        ...
        require(value <= 10000, 'WeMintArt: royalty amount too high');
        perTokenRoyalty[id] = Royalty(recipient, value);
    }

    function setBaseRoyalty(address recipient, uint256 value) internal {
        require(value <= 10000, 'ERC2981Royalties: Too high');
        baseRoyaltiesReceiver = recipient;
        baseRoyaltiesPercent = value;
    }
    ...
    function royaltyInfo(
        ...
        if(perTokenRoyalty[_tokenId].percent != 0 && perTokenRoyalty[_tokenId].receiver != address(0)){
            Royalty memory royalty = perTokenRoyalty[_tokenId]; 
            return (royalty.receiver, (_salePrice * royalty.percent) / 1000);
        }
        return (baseRoyaltiesReceiver,  (_salePrice * baseRoyaltiesPercent) / 10000); 
    }
