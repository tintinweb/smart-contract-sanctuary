...
contract TheSadCats is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  string public baseTokenURI = "https://thesadcats.sadgirlsbar.io/testjson/";
  address public sgbAddress = 0x2d0cEb6F49084dCF0e17aA6D7e9a7a8cc1111c4D;
  uint256 public _maxBatchSize = 20;
  uint public catPrice = 0.0001 ether; // 0.05 ether;
   ...
   */
  constructor() ERC721("TheSadCats","The Sad Cats") public {}
  ...
  function setContractState(uint256 newContractState) public {
