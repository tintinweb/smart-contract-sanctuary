...
contract FUDFamiglia is ERC721, Ownable {
    ...
    function mintMafia(uint amount) public payable{
        ...
        require(msg.value >= _fudfPrice.mul(amount) , "Ether value sent is not enough");
        uint256 bonusAmount= amount/10;
        uint256 totalMint = amount+bonusAmount;
        mintMafia(totalMint);
    ...
    function withdrawBalance(address recipient, uint256 amt) external onlyOwner {
