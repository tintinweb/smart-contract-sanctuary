...
// File: contracts/PerlinWayPlayers.sol
...
contract PerlinWayPlayers_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Perlin Way Players", "PWP") {
    setHiddenMetadataUri("ipfs://QmfBLswNtkfzKZHCLchi4ndBTpJrBrCUMTnfykbycrqc6a/hidden.json");
  }
