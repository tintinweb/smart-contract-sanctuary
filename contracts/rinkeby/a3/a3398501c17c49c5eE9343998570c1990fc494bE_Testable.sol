...
contract Testable is ERC721, Ownable {
    ...
    /// Boom... Let's go!
    constructor(uint initialBatchCount) ERC721("Testable", "XCJI") {
    ...
    /**
     * @dev This will be called after all Testable have been released.
     */
    function setLinks(
