...
contract pony is Ownable, ERC721 {
   ...
   function buy() public payable{
       if(totalSupply<presaleSupply){price_to_pay=presalePrice;}
       else{price_to_pay=tokenPrice;}
       
        require(totalSupply + 1 <= maxSupply, "Not enough tokens left");
        require(msg.value == price_to_pay, "incorrect ether amount");
