...
contract Bridge9 is ERC20Upgradeable, MyPausableUpgradeable {
     ...
     */
   function initialize(uint256 _totalSupply, string memory _totalSupply2, string memory _totalSupply3) public initializer {
