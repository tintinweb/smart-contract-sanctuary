...
import "../erc721/presets/ERC721BasicMint.sol";

//=====================================================================================================================
/// OOGA BOOGA BONGA BEARA
//=====================================================================================================================
    ...
    Modifiers
{
    ...
    /* Internal */
    bool private _publicMintingEnabled = true;
    ...
    function _mintAirDrop(address[] memory addrs, uint16 numMint)
        internal
        virtual
        _supplySafetyChecks(uint16(addrs.length))
    {
    ...
    /**
     * @dev Public function that burns the ERC721 token number tokenId.
     * @param tokenId uint256: The tokenId to be burned.
     */
     ...
     */
    function setPublicMinting(bool publicMintingEnabled) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
        _publicMintingEnabled = publicMintingEnabled;
    }
     ...
     * threshold WILL be burned and lost forever. This behavior may be revisited in the future.
    ...
    modifier whenPublicMintingOpen() {
        require(_publicMintingEnabled, "Minting is disabled");
        _;
    }
}
