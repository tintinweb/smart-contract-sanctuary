...
contract MarketPlace is ReentrancyGuard, Ownable {
    ...
    enum Status {Cancelled, Open, Executed}
    ...
    *
    ...
    /**
    * @notice create new token for requesting user
     */
    function mintNFTToken() external {
...
contract CustomNFT is ERC721, AccessControl {
    ...
    * @param client address of the potentional owner of the new token
     */
    function mint(address client) public onlyRole(DEFAULT_ADMIN_ROLE) {
