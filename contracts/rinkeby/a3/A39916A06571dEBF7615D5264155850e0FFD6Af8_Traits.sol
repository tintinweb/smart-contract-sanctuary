   ...
   */
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory metadata = string(abi.encodePacked(
                ...
                s.isCat ? s.isCrazy ? 'Crazy Cat Lady #' : 'Cat #' : 'Mouse #',
                tokenId.toString(),
                '", "description": "Thousands of Cats and Mice compete in a tower in the metadata. A tempting prize of $CHEDDAR awaits, with deadly high stakes. All the metadata and images are generated and stored 100% on-chain. No IPFS. NO API. Just the Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
