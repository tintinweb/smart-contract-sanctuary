...
// File: contracts/MetheorsNFTFInalTest.sol
...
contract MetheorsNFTFinalTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor(address _payments) ERC721("MetheorsNFT", "MNFT") {
    setHiddenMetadataUri("ipfs://QmZWxHwumPFj6k25rFbW7GPPQ7coonEQK8ZztgUM97iU6M/hidden.json");
