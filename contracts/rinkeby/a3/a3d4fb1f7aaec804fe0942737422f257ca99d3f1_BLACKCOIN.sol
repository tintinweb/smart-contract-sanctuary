...
// Black Coin contract based on the full ERC 20 Token standard
// Symbol: BC
...
/**
 * BLACKCOIN Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract BCStandardToken is BLACKCOINToken, Ownable {
    
    using BCMaths for uint256;
...
contract BLACKCOIN is BCStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 5 * (10**7) * 10**8 ; // 50 million tokens, 8 decimal places
    string constant public name = "BLACK COIN"; //fancy name: eg Black Coin
    string constant public symbol = "BC"; //An identifier: eg BC
