...
contract TheBeeCollaborativeByJess is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;
  ...
  constructor(
    ...
    // How many I want to have in my own wallet
    mint(msg.sender, 8); // Must be lower than line 1231 | This is how many is minted FREE to owner upon deployment
  }
