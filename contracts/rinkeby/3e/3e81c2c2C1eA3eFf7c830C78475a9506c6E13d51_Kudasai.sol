...
contract Kudasai is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private constant maxWalletPerToken = 3;
    ...
    modifier onlyKudasaiList() {
        require(_publicEnable || _isKudasaiList[msg.sender], "You do not have execute permission");
        _;
    }
    ...
    function kudasai(uint256 tokensNumber) public onlyKudasaiList {
        require(maxWalletPerToken <= this.balanceOf(msg.sender), "You can\'t Kudasai any more");
