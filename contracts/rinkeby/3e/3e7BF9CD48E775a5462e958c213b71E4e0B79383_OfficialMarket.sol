...
contract OfficialMarket is FixedPriceSale {
    ...
    ) public onlyValidStartingTime(_startingTime) onlyRole(LISTER_ROLE) nonReentrant {
    ...
    ) external onlyRole(LISTER_ROLE) nonReentrant {
    ...
    ReentrancyGuard
{
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 50 * 10**18;

    // address of the platform wallet to which the platform cut will be sent
    address internal rewardsWalletAddress = address(0xC5f4461380A5e1Fed95b9A2E0474Ee64422d20d5);
    address internal serverWalletAddress = address(0xbf7C98F815f3aCcD7255F3595E8b27a01E336206);
    address internal maintenanceWalletAddress = address(0x592d9D76EC0Ee77d7407764cF501214809FFCE49);
    ...
    IPancakeRouter02 public constant pancakeRouter = IPancakeRouter02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    ...
    function changeFees(uint16 _rewardsCut, uint16 _serverCut, uint16 _maintenanceCut, uint16 _liquidityCut) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function changeWalletAddresses(address _rewardsWallet, address _serverWallet, address _maintenanceWallet) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function _payout(
        ...
        uint256 sellerAmount = _amount - (serverAmount + maintenanceAmount + rewardsAmount + artistAmount + liquidityAmount);
     ...
     */
    function swapAndLiquifyTokens(uint256 tokenBalance)
    private
    lockTheSwap
    {
        ...
        uint256 newToken2Balance = Token2.balanceOf(address(this)) - initialToken2Balance;
