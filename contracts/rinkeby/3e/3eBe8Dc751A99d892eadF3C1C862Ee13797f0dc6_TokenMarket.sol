...
contract TokenMarket is TokenMarketBase {
    ...
    */
    ...
    function fullLoanPaybackEarly(uint256 _loanId) internal {
        ...
        emit FullTokensLoanPaybacked(_loanId, msg.sender, activatedLoanOffersFull[_loanId].lender, loanOffersToken[_loanId].loanAmountInBorrowed.sub(loanOffersToken[_loanId].paybackAmount),   TokenLoanData.LoanStatus.CLOSED);
    }
    ...
    function payback(uint256 _loanId, uint256 _paybackAmount) public {
        ...
        {   
            ...
            emit PartialTokensLoanPaybacked(loanId,  msg.sender, activatedLoanOffersFull[_loanId].lender, _paybackAmount);
        }     
    }
