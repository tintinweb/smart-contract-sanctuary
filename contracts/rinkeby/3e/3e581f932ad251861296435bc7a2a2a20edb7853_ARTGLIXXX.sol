...
contract ARTGLIXXX is ERC721, Ownable {
    ...
    address private GLICPIXXXVER002_ADDRESS = 0xD356c91ABeF50a428dC54EA9494660c54448eFC2;
    address private GLIXTOKEN_ADDRESS = 0x25Ae3D3003ac04923038145f759f6FBb049BE409;
    ...
    constructor() ERC721("ARTGLIXXX VOLUME ONE","ARTGLIXXXVOL1")  {
        ...
        setBaseURI("https://artglixxx.herokuapp.com/api/project/0/token/");
        setGeneratorAddress("https://artglixxx.herokuapp.com/generate/project/0/token/");

        projectInfo = ProjectInfo(
            "ARTGLIXXX VOLUME ONE",
            "ARTGLIXXX is the first on-chain generated art that is powered by GLICPIXXXVER002 GRAND COLLECTION. ARTGLIXXX VOLUME ONE comes alongside with $GLIX token to utilize GLICPIXXX ecosystem.",
     ...
     */
    function generateARTGLIXXX(uint _glicpixxxId, address _to) public {
        ...
        emit Mint(_to, mintIndex, ARTGLIXXX_NEXT_GEN[_glicpixxxId]);
    ...
    function setProjectDescription(string memory _description) public onlyOwner {
        projectInfo.description = _description;
    }
    
    function setProjectArtistName(string memory _artist) public onlyOwner {
        projectInfo.artist = _artist;
    }

    function setProjectLicense(string memory _license) public onlyOwner {
        projectInfo.license = _license;
    }
    
    function setProjectRoyaltyReceiver(address _royaltyReceiver) public onlyOwner {
        projectInfo.royaltyReceiver = _royaltyReceiver;
    }

    function setProjectRoyaltyReceiver(uint _royaltyAmount) public onlyOwner {
