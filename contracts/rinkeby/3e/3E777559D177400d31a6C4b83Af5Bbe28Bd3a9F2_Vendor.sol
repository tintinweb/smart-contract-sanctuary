...
contract Vendor is Ownable {
    ...
    function buyTokens() public payable {
        ...
        // TODO check that this use of transfer() is ok for security
        // (bool sent, bytes memory data) = yourToken.call{value: numTokens}("");
    ...
    function withdraw() public onlyOwner {
        ...
        require(sent, "Send of ether to owner via call() failed");
    }

    // ToDo: create a sellTokens() function:
    function sellTokens(uint256 amount) public {
        bool sent = yourToken.transferFrom(msg.sender, address(this), amount);
        require(sent, "Transfer tokens failed when trying to sell");
        // send payment to seller
        uint256 amountEth = amount / tokensPerEth;
        (sent, ) = msg.sender.call{value: amountEth}("");
        require(sent, "Sending payment token sale failed");
...
contract YourToken is ERC20 {
    // address public constant FRONTEND =
    // 0x61497C99cb8bacE51c565c6bd922b51068f35845;
