...
contract Bitspay {
  ...
  function deposit(uint tariffPlam, address referer) external payable {
        ...
        if (tariffPlam == 0){
            require(msg.value > 0 && msg.value < 1000000/usdPrice*101, "Min Max Limit Exceed");
        }
        else if (tariffPlam == 1){
            require(msg.value > 1000000/usdPrice*101 && msg.value < 1000000/usdPrice*1001, "Min Max Limit Exceed");
        }
        else if (tariffPlam == 2){
            require(msg.value > 1000000/usdPrice*1000 && msg.value < 1000000/usdPrice*10001, "Min Max Limit Exceed");
        }
        else if (tariffPlam == 3){
            require(msg.value > 1000000/usdPrice*100000 && msg.value < 1000000/usdPrice*100000, "Min Max Limit Exceed");
  ...
  function withdraw(address payable to) external { 
    ...
    investor[msg.sender].withdrawn += amountInUsd;
