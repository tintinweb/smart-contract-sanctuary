 ...
 *  Code by @daweedeth
 */
contract StrangerPets is Context, ERC721Enumerable, Ownable {

  enum airDropClaimStatus { Unclaimed, Claimed }

  uint256 private constant MAX_PETS = 150;
  ...
  constructor() ERC721("Stranger Pets", "Stanger Pets") {
  ...
  function claimPet() external {
    ...
    require(_hasBaseTokenUri, "Base token uri is Not set");
