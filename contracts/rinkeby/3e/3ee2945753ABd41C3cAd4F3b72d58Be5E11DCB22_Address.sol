...
// File @openzeppelin/contracts/utils/[email protected].3.0
...
contract C01Project is ERC721("C01Test", "Testo"), ERC721Enumerable, Ownable {
    ...
    uint256 public NFTPrice = 50000000000000000;  // 0.25 ETH
    bool public reveal;
    ...
    */
        ...
        onlyOwner 
    {
        ...
        payable(address(0x380DDCA711c57a387e29B149Fd7fAEDf2E0141a4)).transfer(balance);
    }
