...
contract UCCToken is ERC20Interface, SafeMath {
    ...
    // Constructor for token (symbol, name, dec, supply, balance, transfer)
    constructor() {
        symbol = "UCC";
        name = "UCC Token";
        decimals = 18;
    ...
    // Transfer the balance owner --- receiver 
    // ensure owner has enough token balance
    //no transfers of 0 value
    ...
    // approve fucntion allows owner to approve another account to withdraw tokens from account and transfer them to others 
