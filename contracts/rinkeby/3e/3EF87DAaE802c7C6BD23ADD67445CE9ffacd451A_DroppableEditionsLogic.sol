    ...
    Reentrancy
{
    ...
    function purchaseWithProof(
        ...
        require(price * allocation <= msg.value, "insufficient funds sent");
        ...
        returns (address)
    {
        ...
        if (tokenId < allocation) {
            ...
            require(tokenId < claimedTokens, "ERC721: owner query for nonexistent token");

            // Check if this token was allocated but then burned.
            require(!burned[tokenId], "ERC721: owner query for nonexistent token");
