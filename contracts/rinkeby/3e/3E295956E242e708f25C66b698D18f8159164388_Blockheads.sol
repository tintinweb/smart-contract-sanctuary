...
interface ImageDataBlock {
    ...
    // How many images/names are in this block, aka how many slots
    function getNumValues() external pure returns (uint16);
...
contract Blockheads is ERC721Tradable, ERC2981ContractWideRoyalties {
    ...
    uint256 constant totalAvailable = 10000;
    uint256 mintCost = 0.05 ether;
    uint256 nextTokenId = 1; // 1, for friendship
    ...
    // mapping(uint256 => uint256) bgOverrides;
    // mapping(uint256 => bool) bgOverridden;
    // mapping(uint256 => uint256) bodyOverrides;
    // mapping(uint256 => bool) bodyOverridden;
    // mapping(uint256 => uint256) armsOverrides;
    // mapping(uint256 => bool) armsOverridden;
    // mapping(uint256 => uint256) headOverrides;
    // mapping(uint256 => bool) headOverridden;
    // mapping(uint256 => uint256) faceOverrides;
    // mapping(uint256 => bool) faceOverridden;
    // mapping(uint256 => uint256) headwearOverrides;
    // mapping(uint256 => bool) headwearOverridden;
    ...
    function totalAvailability() public pure returns (uint256) {
    ...
    function backgroundIndex(uint256 tokenId) public view returns (uint256) {
        ...
        ImageDataBlock backgroundData = ImageDataBlock(backgroundDataBlock);
        return initialValueFor(tokenId, backgroundData.getNumValues(), "bg");
    }
    ...
    function bodyIndex(uint256 tokenId) public view returns (uint256) {
        ...
        return initialValueFor(tokenId, bodyData.getNumValues(), "body");
    }
    ...
    function armsIndex(uint256 tokenId) public view returns (uint256) {
        ...
        return initialValueFor(tokenId, armsData.getNumValues(), "arms");
    }
    ...
    function headIndex(uint256 tokenId) public view returns (uint256) {
        ...
        return initialValueFor(tokenId, headData.getNumValues(), "head");
    }
    ...
    function faceIndex(uint256 tokenId) public view returns (uint256) {
        ...
        ImageDataBlock dataBlock = ImageDataBlock(faceDataBlock);
        return initialValueFor(tokenId, dataBlock.getNumValues(), "face");
    }
    ...
    function headwearIndex(uint256 tokenId) public view returns (uint256) {
        ...
        return initialValueFor(tokenId, dataBlock.getNumValues(), "headwear");
    }
    ...
    {
        bytes
            memory svg = "<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 512 512' width='512' height='512'>";
        svg = image(svg, getBgData(tokenId));
        svg = image(svg, getBodyData(tokenId));
        svg = image(svg, getArmsData(tokenId));
        svg = image(svg, getHeadData(tokenId));
        svg = image(svg, getFaceData(tokenId));
        svg = image(svg, getHeadwearData(tokenId));
