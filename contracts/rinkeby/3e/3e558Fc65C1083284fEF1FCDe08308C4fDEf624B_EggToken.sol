...
contract EggToken is ERC20("EGG", "EGG"), OwnableContract{
    ...
    event CheckRestrictions(uint256 maxEggAmount, uint256 userAddUpClaimEggCount, bool flag);
    ...
    function checkRestrictions(uint256 userAddUpCchickCount, uint256 userAddUpClaimEggCount) internal returns(bool){
        ...
        emit CheckRestrictions(maxEggAmount, userAddUpClaimEggCount, (maxEggAmount >=  userAddUpClaimEggCount));
