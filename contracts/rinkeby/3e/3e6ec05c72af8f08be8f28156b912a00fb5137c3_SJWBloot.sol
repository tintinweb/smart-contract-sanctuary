...
contract SJWBloot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private namePrefixes = [
        ...
        "Corruption", "Faithless", "Sturdy", "Painful", "Painted", "Gnarly", "Microdosing", "MUD", "Sad", "Angry", "Touchy", "Cold", "Robot", "Ghastly", 
    ...
    function svblootOwnerFreeClaim() public nonReentrant {
        require(svblootOwnersSupply < 2000, "No more svloot owner claims");
    ...
    function blootOwnerFreeClaim() public nonReentrant {
        require(blootOwnersSupply < 2000, "No more bloot owner claims");
        require(totalSupply() < maxSupply, "No more tokens to mint");
