...
contract CheekyCorgi is CheekyCorgiBase
{
    ...
    function initialize(
        ...
        ====================================================================================
        */
        PAYMENT_METHODS[0].token = 0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735; // USDT
        PAYMENT_METHODS[0].decimals = 18;
        PAYMENT_METHODS[0].publicPrice = 2 * (10**18);

        PAYMENT_METHODS[1].token = 0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b; // USDC
        PAYMENT_METHODS[1].decimals = 6;
        PAYMENT_METHODS[1].publicPrice = 1 * (10**6);

        PAYMENT_METHODS[2].token = 0x01BE23585060835E02B77ef475b0Cc51aA1e0709; // SHIBA INU
        PAYMENT_METHODS[2].decimals = 18;
        PAYMENT_METHODS[2].publicPrice = 3 * (10**18);
