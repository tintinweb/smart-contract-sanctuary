...
contract SpartacusBondDepository is Ownable {
    ...
    uint public basePrice = 1000000000;
    ...
    function setBasePrice( uint _basePrice ) external onlyPolicy() {
    ...
    function bondPrice() public view returns ( uint price_ ) {        
        price_ = terms.controlVariable.mul( debtRatio() ).add( basePrice ).div( 1e7 );
