...
contract SystemContext is AccessControl {
    ...
    constructor (CollectionRegistry collectionRegistry_) {
...
contract LayerZeroBridge is ILayerZeroReceiver, AccessControl {
    ...
    bytes32 public constant BRIDGE_CALLER_ADMIN_ROLE = keccak256("BRIDGE_CALLER_ADMIN_ROLE");
    ...
    constructor(ILayerZeroEndpoint endpoint_, SystemContext systemContext_) {
        ...
        _setupRole(BRIDGE_CALLER_ADMIN_ROLE, msg.sender);
        _setRoleAdmin(CALLER_ROLE, BRIDGE_CALLER_ADMIN_ROLE);
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
    }
