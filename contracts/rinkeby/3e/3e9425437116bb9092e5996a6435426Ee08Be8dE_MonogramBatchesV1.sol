...
contract MonogramBatchesV1 is ERC1155, Ownable {

    // uint256 public constant BATCH1 = 0;
    // uint256 public constant BATCH2 = 1;

     // Token name
    string private _contractName = "Monogram";

    // Token symbol
    string private _symbol = "MONO";

    // Base URI
    string private _baseURI = "https://https://monogramnetwork.com/api/items/";
    ...
    */
    ...
    function create(uint256 _initialSupply, address _to, string calldata _name) 
    external onlyOwner returns (uint256 _id) {

        _id = _create(_initialSupply, _to, ""); 
    ...
    function batchCreate(uint256[] calldata _ids, uint256[] calldata _initialSupplies, address _to, string calldata _name) external onlyOwner {
        
        // for (uint256 i = 0; i < _to.length; ++i) {
        //     _create(_initialSupplies[i], _to[i], _name); 
        // }
        _mintBatch(_to, _ids, _initialSupplies, "");
...
function update(string calldata _update, uint256 _id) external onlyOwner {
    ...
    constructor() public ERC1155("https://monogramnetwork.com/api/item/{id}.json") {
