...
contract FishBadge is ERC721, VRFConsumerBase {
    ...
    ERC721("FishBadge", "FHB") public {
        vrfCoordinator = _VRFCoordinator;
        keyHash = _keyhash;
        fee = 0.1 * 10**18;
    }

    function requestNewRandomBadge(uint256 userProvidedSeed,
    string memory name) public returns (bytes32) {
        bytes32 requestId = requestRandomness(keyHash, fee, userProvidedSeed);
        requestToBadgeName[requestId] = name;
        requestToSender[requestId] = 0xd5421C7dc9B3E1aB2C9a7551Af2f2c981c48f4AB;
        return requestId;
    }
