...
contract Factory is OwnableUpgradeable {
    ...
    function createNewCollection(string memory name, string memory symbol)
        public
        returns (address)
    {
        Erc721 nCollection = new Erc721();
       // Erc1967Proxy nCollection = new Erc1967Proxy(address() )




        //nCollection.initialize(name, symbol,_Owner);
        // nCollection.transferOwnership(_msgSender());
...
contract Erc721 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable {
