...
// SimpliToken with Governance.
contract SimpliToken is BEP20('SIMPLI Token', 'SIMP') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "SIMP::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "SIMP::delegateBySig: invalid nonce");
        require(now <= expiry, "SIMP::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "SIMP::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "SIMP::_writeCheckpoint: block number exceeds 32 bits");
