...
interface IERC165 {
    ...
    event rarityClaim( uint256 price, uint256 claimableAmount);
    ...
    function createIngredient( string memory ingredientTokenURI, uint256 price, address artist, uint256 ingType, uint256 totalCount) public {
    ...
    function checkMultipleIngredientPrice(uint256[] memory _ingredientIds) public view returns (uint256) {
