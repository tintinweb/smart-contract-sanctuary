...
/**
 * @title ArtxMarketPLace
 * MyCollectible - a contract for my semi-fungible tokens.
 */
contract ArtxMarketPlace is ERC1155Tradable {
  constructor(address _proxyRegistryAddress)
  ERC1155Tradable(
    "ArtxMarketPlace",
    "AMP",
    _proxyRegistryAddress,
    "http://softquake.in/demo/nft-dev-new/nft-dev-3/creations/metadata/"
  ){
    
  }
  function contractURI() public pure returns (string memory) {
    return "https://softquake.in/demo/nft-dev-new/nft-dev-3/contract/artx.json";
  }
