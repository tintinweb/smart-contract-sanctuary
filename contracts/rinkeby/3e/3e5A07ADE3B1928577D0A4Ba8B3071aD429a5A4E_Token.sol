...
contract Token is Ownable {
    ...
    function deposit(address _tokenAddress, uint256 _amount) external payable {
        require(supportTokens[_tokenAddress], "This token is not supported");
    ...
    function withdraw(address _tokenAddress, uint256 _amount) external payable {
        require(userTokenBalance[msg.sender][_tokenAddress] >= _amount, "Not enought balance");
