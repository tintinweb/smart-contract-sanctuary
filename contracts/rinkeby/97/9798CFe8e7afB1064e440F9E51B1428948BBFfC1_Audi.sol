...
contract Audi is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    string BASE_URI = "ipfs://QmaCKqUxbC9YAzmzZcbhNRvUewjeWgsnZwh4EnQY6FgB7N/";

    bool public IS_PRESALE_ACTIVE = false;
    bool public IS_SALE_ACTIVE = false;

    uint constant TOTAL_SUPPLY = 2;
    uint constant INCREASED_MAX_TOKEN_ID = TOTAL_SUPPLY + 2;
    uint constant MINT_PRICE = 0.020 ether; 
    ...
    address FOUNDER_1 = 0x3131bEC966034f9b3E8278477f9B05035dfF4bA2;

    constructor() ERC721("Audi", "AUD") {
    ...
    function withdrawAll() public onlyOwner {
        ...
        _withdraw(FOUNDER_1, (balance * 50) / 1000);
