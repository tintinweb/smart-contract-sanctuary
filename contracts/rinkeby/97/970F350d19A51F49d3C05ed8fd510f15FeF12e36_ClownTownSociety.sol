...
import "@openzeppelin/[email protected]v4.3/token/ERC721/extensions/ERC721Enumerable.sol";
...
//   ╚══╝╚══╝ ╚═╝  ╚═╝╚═╝   ╚═╝   ╚══════╝    ╚═╝      ╚═════╝ ╚═╝  ╚═══╝ ╚═════╝   ╚═╝   ╚═╝ ╚═════╝ ╚═╝  ╚═══╝╚══════╝
    ...
    function mintClowns(uint16 start, uint16 end) external payable {  // TODO remove
        for (uint16 i = start; i < end; ++i) {
            mintClownFromPunk(2 * i + 1);
        }
    }
