...
contract Test145 is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/145/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/145/contract-uri";
  ...
  // mint settings
	...
	uint256 public pricePerToken = 123000000000000000000;
  ...
  // activation flags
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("T", "TST") {
