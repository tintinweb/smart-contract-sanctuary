...
contract RocketGame is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Game0Rocket", "RKT") {
    ...
    function mintRocketParts(uint8 numRocketParts) public payable gameNotEnded {
        ...
        require(
            numRocketParts > 0 && numRocketParts <= 500,
    ...
    function claimAllColorsOfFuelWin(uint256 characterId, uint256 grayFuelId, uint256 blackFuelId, uint256 goldFuelId, uint256 trippyFuelId) public gameNotEnded {
        validateColorsAndBurn(characterId, Fuel, grayFuelId, blackFuelId, goldFuelId, trippyFuelId, 100);     
        hasGameEnded = true;        
    }
    ...
    function claimAllColorsOfRocketBodyWin(uint256 characterId, uint256 grayRocketBodyId, uint256 blackRocketBodyId, uint256 goldRocketBodyId, uint256 trippyRocketBodyId) public gameNotEnded {
        validateColorsAndBurn(characterId, RocketBody, grayRocketBodyId, blackRocketBodyId, goldRocketBodyId, trippyRocketBodyId, 25);
    }
    ...
    function claimAllColorsOfNoseConeWin(uint256 characterId, uint256 grayNoseConeId, uint256 blackNoseConeId, uint256 goldNoseConeId, uint256 trippyNoseConeId) public gameNotEnded {
        validateColorsAndBurn(characterId, NoseCone, grayNoseConeId, blackNoseConeId, goldNoseConeId, trippyNoseConeId, 5);
    }
    ...
    function claimAllColorsOfWingsWin(uint256 characterId, uint256 grayWingsId, uint256 blackWingsId, uint256 goldWingsId, uint256 trippyWingsId) public gameNotEnded {
        validateColorsAndBurn(characterId, Wings, grayWingsId, blackWingsId, goldWingsId, trippyWingsId, 10);
    }
    ...
    function claimAllColorsOfEngineWin(uint256 characterId, uint256 grayEngineId, uint256 blackEngineId, uint256 goldEngineId, uint256 trippyEngineId) public gameNotEnded {
        validateColorsAndBurn(characterId, Engine, grayEngineId, blackEngineId, goldEngineId, trippyEngineId, 15);
    }
