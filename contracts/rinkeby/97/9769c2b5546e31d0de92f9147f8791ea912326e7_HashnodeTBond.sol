...
contract HashnodeTBond is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTBond() {
        ...
        name = "Eth Bond";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DTB";                                             // Set the symbol for display purposes (CHANGE THIS)
