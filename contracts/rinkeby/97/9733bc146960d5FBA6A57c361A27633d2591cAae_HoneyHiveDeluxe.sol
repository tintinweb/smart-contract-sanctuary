...
contract HoneyHiveDeluxe is ERC721Enumerable, AccessControlEnumerable, Ownable {
    ...
    function mint(address _owner, uint16 _bearId) external {
     ...
     */
    function increaseUsageOfMintingBee(uint16 _hiveId) external {
     ...
     */
    function resetUsageOfMintingBee(uint16 _hiveId) external {
        require(hasRole(PROPERTIES_ROLE, _msgSender()), "Missing PROPERTIES_ROLE");
