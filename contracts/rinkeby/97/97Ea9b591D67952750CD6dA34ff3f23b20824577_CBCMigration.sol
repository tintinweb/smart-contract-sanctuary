...
import "./CBCNetwork.sol";
import "./CashBetCoin.sol";
import "./utils/ECDSAVerify.sol";

contract CBCMigration is Initializable, OwnableUpgradeable {
	CBCNetwork public newCBC;
	CashBetCoin public oldCBC;
	...
	function migrate(
		...
		require(verifyContract.isValidRewardData(amount, nonce, signature) == true, "Transaction is not verified");
