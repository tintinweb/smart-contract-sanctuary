...
contract Besties is ERC721Enumerable, Ownable {
    ...
    uint256 public constant bestiesSupply = 20;
    uint256 public bestiesPrice = 0.000004 ether;
    ...
    function claimBesties(uint numberOfTokens) public {
        uint256 supply = totalSupply();
        require(numberOfTokens <= 4, "Above max tx count");
        require(totalSupply() + numberOfTokens <= bestiesSupply, "Exceeds max supply");
