...
contract Worldstartest is ERC721, Ownable {
  ...
  address private t1 = 0x5D52F6632B1a9D743A5290dc26a3f831f09Db6A0;
  address private t2 = 0x5D52F6632B1a9D743A5290dc26a3f831f09Db6A0;

  uint public constant maxSupply = 10000;
  uint public constant maxPresaleSupply = 1000;
  ...
  string public hiddenTokenURI = "https://zenlabs.mypinata.cloud/ipfs/Qma9htfc4u7QzA4VMkVqEHANFCasMAhdZUaqdjMCXKWR6L";
  string public baseExtension = ".json";
  
  event MilestoneReachedStateChange(uint val, uint time);

  constructor() ERC721("Worldstartest", "WSt") {}
  ...
  function mintPresale(uint amount) external payable onlyEOA {
    ...
    require(totalSupply() + amount <= maxPresaleSupply - (reservedAmount - reservedMintedAlready), "max supply reached");
