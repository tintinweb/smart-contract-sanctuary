    ...
    
{
 ...
 function getServiceFee() public view returns(uint256){
    ...
    function investToken(
        ...
        user.penality = planInfo[plan].penality;

        user.investdatetime = block.timestamp;
    ...
    function stopInvest(uint256 invid) public{
        investInfo[msg.sender][invid].status = 'stop';
    }

    function renewInvest(uint256 invid) public{
        // need to check before investperiod : date
        investInfo[msg.sender][invid].status = 'renew';
        investInfo[msg.sender][invid].investperiod += 1;
    }
