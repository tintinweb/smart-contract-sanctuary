...
contract Wolvorine is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
   ...
   uint256 public maxbuy=10;
    constructor(address _owner) ERC721("Wolve", "wolve") Ownable(_owner) {
    ...
    function mint(address[] memory to,string memory _tokenURI)external onlyOwner payable {
