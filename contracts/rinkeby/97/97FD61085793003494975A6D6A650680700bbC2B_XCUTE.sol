 ...
 */
contract XCUTE is AccessControlEnumerable, ERC20Burnable {
    ...
    function permit(
        ...
        bytes32 _hash = ECDSA.toTypedDataHash(
            DOMAIN_SEPARATOR,
            keccak256(
                abi.encode(
                    PERMIT_TYPEHASH,
        ...
        if (_signer != _owner) revert SignerNotOwner();
