...
contract Beetest is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;
  ...
  constructor(
    ...
    mint(msg.sender, 2); // Must be lower than line 1231 | This is how many is minted FREE to owner upon deployment
  }
