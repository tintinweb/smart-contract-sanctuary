...
contract FarmToken is ERC20, ChainlinkClient {
    ...
    mapping(bytes32=>address) requestId_toSender;
    mapping(address=>uint256) address_to_ethgiven;
    ...
    function payUser (address _token, address _to_user) payable public {
    ...
    function requestVolumeData() public returns (bytes32 requestId) 
    {
        ...
        request.add("get", "https://min-api.cryptocompare.com/data/price?fsym=INR&tsyms=ETH");
    ...
    function fulfill(bytes32 _requestId, uint256 _volume) public recordChainlinkFulfillment(_requestId)
    {
        ...
        uint256 amount_in_eth = address_to_ethgiven[requestId_toSender[_requestId]];

        uint256 amount_of_tokens = (amount_in_eth / _volume) / 10;
