...
contract DigitalDudes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("DigitalDudesCon", "DD") {
    setHiddenMetadataUri("ipfs://QmSRaNw5s9zpzyTmgk2hWxPM5KjdMwQFghYTB5S6vcZiMn/hidden.json");
  }
