...
// File: contracts\TulipsAndOracles.sol
pragma solidity ^0.6.0;

/**
 * @title TulipsAndOracles
 */
contract TulipsAndOraclesNFT is ERC721Tradable {
    ...
    constructor()
        public
        ERC721Tradable("Tulips And Oracles", "DArtCo1", 0xF57B2c51dED3A29e6891aba85459d600256Cf317)
    {
        mintTo(_msgSender());
    }
