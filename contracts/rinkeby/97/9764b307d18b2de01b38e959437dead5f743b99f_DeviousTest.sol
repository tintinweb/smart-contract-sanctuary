...
// File: contracts/DeviousLicks_PreFlat.sol
...
contract DeviousTest is ERC721Enumerable, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    uint256 public constant DL_GIFT = 88;
    uint256 public constant DL_PRIVATE = 800;
    uint256 public constant DL_PUBLIC = 8000;
    uint256 public constant DL_MAX = DL_GIFT + DL_PRIVATE + DL_PUBLIC;
    uint256 public constant DL_PRICE = 0.08 ether;
    uint256 public constant DL_PER_MINT = 5;
    ...
    string private _tokenBaseURI = "https://deviouslicks.io/test/";
    address private _signerAddress = 0xeabf1e941768674D2aF1110c2f233003fc05cbb1;
    ...
    function buy(bytes32 hash, bytes memory signature, string memory nonce, uint256 tokenQuantity) external payable {
        ...
        require(totalSupply() < DL_MAX, "OUT_OF_STOCK");
        require(publicAmountMinted + tokenQuantity <= DL_PUBLIC, "EXCEED_PUBLIC");
