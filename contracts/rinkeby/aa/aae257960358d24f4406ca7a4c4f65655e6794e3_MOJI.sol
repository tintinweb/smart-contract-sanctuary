...
// GO TO LINE 1889 TO SEE WHERE THE MOJI CONTRACT STARTS
...
contract MOJI is ERC721, Ownable {
    ...
    function mintMOJI(uint numberOfTokens) public payable {
        ...
        require(currentTotalSupply.add(numberOfTokens) < 10001, "Purchase would exceed max supply of MOJIs"); // ref MAX_MOJI
