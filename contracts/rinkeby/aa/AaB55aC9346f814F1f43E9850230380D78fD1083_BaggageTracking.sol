...
contract BaggageTracking {
    ...
    */
    ...
    function confirmBaggage(string memory pnr, string memory tag) public isOwner {
        require(tagStage[tag] == CheckinStage.OutofAirport,"Bag not yet out of Airport..");
        require(tagStage[tag] != CheckinStage.UserConfirmed, "Bag already confirmed by user...");
        bool hasBag = false;
