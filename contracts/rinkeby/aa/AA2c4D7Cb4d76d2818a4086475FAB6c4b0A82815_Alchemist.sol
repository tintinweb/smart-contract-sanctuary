...
//Collateralized Debt Positions：债务抵押仓库
...
contract Alchemist is  ReentrancyGuard {
  ...
  //存款抵押进一个CDP
  ///
  /// This function reverts if an emergency exit is active. This is in place to prevent the potential loss of additional funds.
  ///
...
/// Collateralized Debt Positions：抵押债仓
library CDP {
  using CDP for Data;
  using FixedPointMath for FixedPointMath.FixedDecimal;
