...
contract Ethcrow {
	...
	function release(address _arbiter) public nonReentrant {
		require(outstanding[_arbiter].amount != 0, "No outstanding deposit");
        require(msg.sender == _arbiter || msg.sender == outstanding[_arbiter].governor, "You are not the arbiter or the governor");
    ...
    function cancel(address _arbiter) public nonReentrant {
        require(outstanding[_arbiter].amount != 0, "No outstanding deposit");
        require(outstanding[_arbiter].beneficiary == msg.sender || outstanding[_arbiter].governor == msg.sender, "You are not the beneficiary or governor");
