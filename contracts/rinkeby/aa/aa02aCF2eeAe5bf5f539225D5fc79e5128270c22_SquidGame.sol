...
contract SquidGame is Initializable {
    ...
    //mint batch
    function mint(uint times) public Reentrant {
        require(times > 0,"invalid times");
        uint amounts =  squidNftPrice * times;
    ...
    function getFee(uint amounts_) public Reentrant calFee returns (uint256 fee_) {
    ...
    function getFunds(uint amounts_) public Reentrant calFee returns (uint256 funds_) {
