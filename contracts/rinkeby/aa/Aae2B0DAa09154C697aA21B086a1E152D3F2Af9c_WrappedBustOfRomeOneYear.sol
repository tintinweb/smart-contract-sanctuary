...
contract WrappedBustOfRomeOneYear is ERC721, ERC721Holder, ERC721Enumerable, AccessControl, ReentrancyGuard {
	...
	function wrap(uint256 tokenId) public onlyRole(MINTER_ROLE) nonReentrant {
        ...
        emit TokenWrapped(msg.sender, tokenId);
	}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory imageURI = string(abi.encodePacked(_ipfsGatewayUri, _niftyBuilderInstance.tokenIPFSHash(tokenId)));
