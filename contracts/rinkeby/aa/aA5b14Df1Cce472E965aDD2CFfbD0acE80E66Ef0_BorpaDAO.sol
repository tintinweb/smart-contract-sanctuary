...
contract BorpaDAO is Ownable, ERC721A, ReentrancyGuard {
    ...
    function Mint(uint256 quantity) external payable callerIsUser {
        ...
        require(
            quantity > remainingFree() && msg.value != (quantity - remainingFree()) * priceAfterFree,
            "Your quantity exceeds the number of free remaining please correct your payableAmount"
        );
