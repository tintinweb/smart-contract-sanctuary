...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function deposit() external payable override {
        /*require (msg.sender == _treasury, "Only Treasury can deposit");
        require (amount <= msg.sender.balance, "Amount is bigger than Treasury ETH Balance"); */
...
contract CoinMerge is IBEP20, Auth {
    ...
    address payable public marketingWallet = payable(0x2b9d5c7f2EAD1A221d771Fb6bb5E35Df04D60AB0);
    address payable public treasury = payable(0x2b9d5c7f2EAD1A221d771Fb6bb5E35Df04D60AB0);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (block.number <= (launchedAt + 1)) { 
            ...
            _setIsDividendExempt(recipient, true);       
        }
