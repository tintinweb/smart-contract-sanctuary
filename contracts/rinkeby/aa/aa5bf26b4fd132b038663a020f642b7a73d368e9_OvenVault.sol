...
// File: contracts/bakery/libs/IMasterChef.sol
...
// File: contracts/bakery/OvenVault.sol

pragma solidity ^0.6.12;

contract OvenVault is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 ovenAtLastUserAction; // keeps track of oven deposited at the last user action
        uint256 lastUserActionTime; // keeps track of the last user action time
    }

    IERC20 public immutable token; // Oven token
    ...
    /**
     * @notice Constructor
     * @param _token: Oven token contract
    ...
    function deposit(uint256 _amount) external whenNotPaused notContract {
        ...
        user.ovenAtLastUserAction = user.shares.mul(balanceOf()).div(totalShares);
    ...
    /**
     * @notice Reinvests OVEN tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the Oven Vault
     */
     ...
     * @return Expected reward to collect in OVEN
     */
    function calculateHarvestOvenRewards() external view returns (uint256) {
    ...
    /**
     * @notice Withdraws from funds from the Oven Vault
