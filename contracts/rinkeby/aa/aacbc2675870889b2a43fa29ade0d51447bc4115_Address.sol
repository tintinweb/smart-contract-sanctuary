...
contract Sanora is ERC721Burnable, Ownable {
    ...
    uint256 constant public TOTAL_SUPPLY = 40;
    ...
    uint256 public MAX_TEAM_TOKENS = 40;
    ...
    address payable claimEthAddress = 0x708d9ae82Bf36fb18E92190239306986094A8C4A; // multisig

    bool public saleIsActive = false;
    bool public privateSaleIsActive = true;

    constructor(address[] memory addrs) public ERC721("Sanora", "Sanora") {
        whitelistAddr = addrs;
    ...
    function reserveSanora(address addr, uint256 amount) public {
        require(MAX_TEAM_TOKENS > 0, 'There is no team tokens left');
        require(msg.sender == address(0x708d9ae82Bf36fb18E92190239306986094A8C4A), 'You are not whitelisted to reserve');
    ...
    function mintSanora(uint numberOfTokens) public payable {
