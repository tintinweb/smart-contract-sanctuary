...
contract DioneToken is ERC20("DioneToken", "DIONE"), Ownable {
    ...
    */
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "DIONE::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "DIONE::_writeCheckpoint: block number exceeds 32 bits");
