...
contract RandomNumber is ERC721Enumerable, Ownable, VRFConsumerBase {
    ...
    constructor(string memory baseURI) ERC721("Random Number", "RandomNumber") VRFConsumerBase(
    ...
    function mint(address _to, uint256 num) public payable {
        ...
        for(uint256 i; i < num; i++){
            ...
            currentIndex++;
            require( currentIndex != start, "Exceeds maximum supply" );
        }
    }
