...
contract MintopolyCards is ERC1155, Ownable {
    ...
    constructor() ERC1155("https://mintopoly.io/cards_api/{id}.json") {
        ...
        // rinkeby address; 0xF57B2c51dED3A29e6891aba85459d600256Cf317
        // live address: 0xa5409ec958c83c3f309868babaca7c86dcb077c1
    }
    ...
    function mintCards(uint256[] memory _ids, uint256[] memory _amounts) public onlyOwner {
        ...
        for(uint i = 0; i < _amounts.length; i++) {
            ...
            if(_ids[i] == 1) { // ID 1 is the unique mintopolist card – supply of 50
        ...
        require(totalMintedBaseCards + totalNewBaseCards <= BASE_CARD_SUPPLY_CAP, "10,000 base cards have already been minted");
        require(totalMintedBonusCards + totalNewBonusCards <= BONUS_CARD_SUPPLY_CAP, "5,000 bonus cards have already been minted");
        require(highestBaseCardSupply <= MAX_SUPPLY_PER_BASE_ID, "max supply for base cards is 25");
