...
contract Mandelbrot is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress) ERC721Tradable("Mandelbrot Set", "MAN", _proxyRegistryAddress) {}

    bool    private _active;
    uint256 private _activeTime;
    uint256 private PRICE = 10000000000000000;     // 1 cent
    uint16  private PRESALE_TIME = 3600;          // 1 hour
    uint8   private MAX_QUANTITY = 5;            // Maximum allowed quantity to purchase
    address private VIP_PASS_ADDRESS;           // Vip Pass Address
    ...
    function premine(uint256 amount) external onlyOwner {
        require(!_active, "Already active");
        for (uint i = 0; i < amount; i++) {
            mintTo(msg.sender);
        }
    ...
    /////////////////////////////////////////////
    /// TEST ONLY
    function de_activate()  external onlyOwner { _activeTime = block.timestamp; _active = true; }    
    function stop_presale() external onlyOwner { PRESALE_TIME = 0; }  
    /////////////////////////////////////////////  
