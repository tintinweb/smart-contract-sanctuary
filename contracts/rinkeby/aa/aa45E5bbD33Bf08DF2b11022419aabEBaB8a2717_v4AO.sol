...
contract v4AO is ERC721Enumerable, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/186/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/186/contract-uri";
  ...
  uint256 public presaleEndDate = 0;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("v4AO", "v4AO") {
