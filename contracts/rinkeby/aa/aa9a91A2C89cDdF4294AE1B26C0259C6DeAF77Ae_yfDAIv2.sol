...
contract yfDAIv2 is ERC20, Ownable {
  /**
  ...
  // IYearn public earn = IYearn(0xC2cB1040220768554cf699b0d863A3cd4324ce32);
  // IYvault public vault = IYvault(0xACd43E627e64355f1861cEC6d3a6688B31a6F952);
  IERC20 public token = IERC20(0x5592EC0cfb4dbc12D3aB100b257153436a1f0FEa);
  IYearn public earn = IYearn(0x21857B392B7D0ca20C439bc39896f38ee74c6023);
  IYvault public vault = IYvault(0x193b83E8cC108c86362E47A4c2D3048837D4996E);
  ...
  constructor() ERC20("Yearn Farmer v2 DAI", "yfDAIv2") {
      _setupDecimals(6);
      _approvePooling();
  }
