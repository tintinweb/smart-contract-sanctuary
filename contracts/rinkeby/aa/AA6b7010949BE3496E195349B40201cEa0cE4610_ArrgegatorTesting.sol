...
contract  ArrgegatorTesting is IAggregator,Initializable {
    ...
    uint256 constant public MARKET_UNISWAP = 0;
    uint256 constant public MARKET_SUSHISWAP = 1;
    ...
    function _swapOnUniswap(
        ...
        uint256 returnAmount = exchange.getReturn(fromTokenReal, toTokenReal, amount);
