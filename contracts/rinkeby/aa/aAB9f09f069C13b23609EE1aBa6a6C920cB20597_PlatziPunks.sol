...
contract PlatziPunksDNA {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        // method encode from abi is used to save 140 gas and 
        // prevent hash collisions watch for info about
        // hash collisions https://www.youtube.com/watch?v=rxZR3ITZlzE
        bytes memory encodedParams = abi.encode(combinedParams);
