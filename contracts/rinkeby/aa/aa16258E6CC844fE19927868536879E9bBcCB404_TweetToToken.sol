...
contract TweetToToken is ERC721URIStorage, Ownable {
    ...
    // TODO: upgradeble contract
    // TODO: burn vs set tokenuri to null
    // TODO: what would be if I had a private mapping of the addresses?

    constructor() public ERC721("TweetToToken", "TTT") {
        baseURI = "test base uri "; // TODO:
        saleIsActive = false;
        tokenCounter = 0;
    }

    function createToken(uint256 tweetID) public returns (uint256) {
