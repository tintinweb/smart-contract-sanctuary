...
contract sLootFakeLife is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private assetTwo = [
    ...
    "Fake Drivers License +1",
    "Fake House +1",
    "Fake Television +2",
    "Fake Twitter Account +1",
    "Fake Crypto Punk +1",
    "Fake Garden"
    "Fake Pool",
    "Fake Vacation",
  ...
  string[] private assetEight = [
    ...
    function sLootClaim(uint256 tokenId) public nonReentrant {
