...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721[email protected]
...
contract sdfbsbrgrege is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    uint256 public constant MAX_ODDBALL = 10;
    ...
    */
    ...
    function sendTeamValue() internal {
        /**
        * @dev funds sent to external teams on mint
        *
        * Remaining funds send to owner wallet
        */
