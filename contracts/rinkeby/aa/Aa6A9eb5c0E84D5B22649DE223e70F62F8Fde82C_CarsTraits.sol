...
/// @title The CarsDAO traits contract
...
contract CarsTraits is Ownable, ICarsTraits {
  ...
  function drawSVG(uint256 tokenId) public view returns (string memory) {
    ...
    return string(abi.encodePacked(
      '<svg id="car" width="100%" height="100%" version="1.1" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">',
      svgString,
      "</svg>"
    ));
  }
...
interface ICarsToken is IERC721 {
  ...
  event CarBurned(uint256 carId);
  event CarMinted(uint256 carId);

  function mint() external payable returns (uint256);
  function burn(uint256 carId) external;
