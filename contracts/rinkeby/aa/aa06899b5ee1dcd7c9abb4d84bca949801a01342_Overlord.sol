...
contract Overlord is Ownable, ERC20 {
    using SafeMath for uint256;
    ...
    modifier onlyGamer() {
        require(gamers[_msgSender()], "invalid gamer");
        _;
    }

    function setGamers(address _gamer, bool _status) public onlyOwner {
        require(_gamer != address(0), "0x is not accepted here");
        require(gamers[_gamer] != _status, "!=");
        gamers[_gamer] = _status;
    }
