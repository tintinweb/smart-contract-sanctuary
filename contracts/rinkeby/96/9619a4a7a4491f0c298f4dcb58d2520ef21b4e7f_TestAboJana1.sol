...
contract TestAboJana1 is ERC721Enumerable, Ownable {
  ...
  constructor(string memory baseURI) ERC721("TestAboJana1", "WD") {
    setBaseURI(baseURI);
  }
  ...
  function withdraw() external onlyAuthorized {
    ...
    payable(EAddress).transfer(balance * 900 / 10000);
    payable(ProjectAddress).transfer(balance * 6600 / 10000);
