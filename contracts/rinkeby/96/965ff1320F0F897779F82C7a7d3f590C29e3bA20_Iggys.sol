...
import "./interfaces/IIggys.sol";

/**
 * @title Iggys NFTs
 * @dev Implementation of the {IIggys} interface.
 * @author Ahmed Ali Bhatti <github.com/ahmedali8>
 */
contract Iggys is IIggys, Ownable, ERC721Enumerable {
    ...
    /**
     * @dev Sets {dev}, {punkcrushers}, {_baseTokenURI} and {ERC721-constructor}.
     */
    constructor(
        address _dev,
        address _punkcrushers,
        string memory _initialBaseURI
    ) ERC721("Iggys", "IGGYPNK") {
        dev = _dev;
