...
contract NFTMarketAuction {
    ...
    address public withdrawAddress = 0x33C8AFDF13dD5F629C1684c8FD4c4FEa2eB1eb95;
    address public recipientAddr = 0x33C8AFDF13dD5F629C1684c8FD4c4FEa2eB1eb95;
	...
	emit AuctionStatusChange(_tokenId,"Create",msg.sender,_price,address(this));
    }
	...
	require(payable(msg.sender).balance >=msg.value, "insufficient balance");
	    ...
	    emit AuctionStatusChange(_tokenId,"Bid",address(this),msg.value,msg.sender);
        }
    }
    ...
    function finishAuction(uint256 _tokenId) public payable {
	    ...
	    emit AuctionStatusChange(_tokenId,"Finish",address(this),_bidAmount,_bider);
        }
    }
   ...
   function cancelAuction(uint256 _tokenId)
	...
	emit AuctionStatusChange(_tokenId,"Cancel",address(this),0, auction.seller);
    }
