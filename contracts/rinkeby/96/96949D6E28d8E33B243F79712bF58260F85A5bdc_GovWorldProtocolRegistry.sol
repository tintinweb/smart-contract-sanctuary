...
contract GovWorldProtocolRegistry is GovWorldProtocolBase {
    ...
    uint256 public lenderUnearndedAPYPercentage = 20;
    uint256 public govUnearndedAPYPercentage = 80;
    uint256 public govPlatformFee = 20;
...
contract GovWorldAdminRegistry is GovWorldAdminBase {
        ...
        onlyAddGovAdminRole(msg.sender)
    {
        ...
        require(!_addressExists(msg.sender, pendingAddedAdminKeys) || !_addressExists(msg.sender, pendingEditAdminKeys) || !_addressExists(msg.sender, pendingRemoveAdminKeys), "GAR: caller already in pending");
