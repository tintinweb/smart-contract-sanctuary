...
contract Diamond is ERC721, Ownable {
    using SafeMath for uint256;

    // Variables
    // ------------------------------------------------------------------------
    uint256 public MAX_Token = 1000;
    ...
    constructor() ERC721("Diamond", "DIAMOND") {
        setBaseURI("http://api.diamondServer/metadata/");
    }
    ...
    function giveawayMint(address _to, uint256 quantity) public onlyOwner {
        require(
            ...
            "You can mint minimum 1, maximum 50."
        );
    ...
    function setMAX_Token(uint256 _MAX_num) public onlyOwner {
        MAX_Token = _MAX_num;
    }
