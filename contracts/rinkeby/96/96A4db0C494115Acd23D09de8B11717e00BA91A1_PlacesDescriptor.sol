...
contract PlacesDescriptor is IPlacesDescriptor, Ownable {
        ...
        returns (string memory)
    {
        ...
        string memory json = Base64.encode(
            bytes(
                '{"name": "Places", "description": "Places is an experiment to establish geographic locations as non-fungible tokens on the Ethereum blockchain.", "external_link": "https://places.xyz"}'
            )
        );
