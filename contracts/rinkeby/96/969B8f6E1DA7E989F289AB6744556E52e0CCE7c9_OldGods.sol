...
contract OldGods is ERC721, Ownable,Pausable {
    ...
    uint256 private maxSupply = 7777;
     uint256 private currentPrice = 0.03 ether;
    uint256 private maxQuantity=10;
    ...
    constructor(string memory _baseURII) ERC721("The Old Gods", "GODS"){tokenBaseURI=_baseURII; Owner = payable(msg.sender);}
