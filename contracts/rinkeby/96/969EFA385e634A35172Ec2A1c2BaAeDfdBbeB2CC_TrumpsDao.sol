...
contract TrumpsDao is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmTbBiQ6i3HNsXmu7mEPZ15w18WXwuFpTGaMFeW9SCGiSy";
    ...
    constructor(
    ) ERC721A("TrumpsDao", "TRMP", 100, maxSupply) {
    }
