    ...
    PaymentSplitter
{
    ...
    uint128 public PUBLIC_SUPPLY = 9941; // Reserve 60
    ...
    // @dev: let the contsact control launch timing
    uint256 public presaleStartTime;
    uint256 public publicStartInterval = 86400;
    ...
    /*
     * @dev: Important! This tokenURI method is a basic stub that assumes a
     * centralized server is handling revealed/unrevealed state. update this
     * as needed if you are using onchain conditionals for revealed/unrevealed
     * URI's
     */
...
contract RewardToken is ERC20, ERC20Burnable, Ownable, Pausable {
    ...
    // TODO: calc the cap amount base on the 10 year supply
    constructor(address _coreContractAddress) ERC20("TBS", "TS") {
        // ERC20Capped(365336530)
        // @dev: Initialize the erc721 contract
        CoreToken = iCoreContract(_coreContractAddress);
        START = block.timestamp;
    }

    // @dev: called by the erc721 contracts on mint/transferFrom/safeTransferFrom
