...
contract Baphelions is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private _tokenIds;

    uint256 public constant MAX_SUPLLY = 2666;
    uint256 public constant MAX_PURCHASE_PER_TX = 20;
    uint256 public constant MAX_PURCHASE_PER_WALLET = 50;

    uint256 public mintPrice;
    bool public sale = false;
    string public baseURI = "";

    constructor() ERC721("Baphelions", "BH") {
        _tokenIds.increment();
    }
    ...
    function  mint(uint256 amount) public payable {
        ...
        require(totalSupply() + amount <= MAX_SUPLLY, "Sold Out");
        ...
        require(balanceOf(msg.sender) <= MAX_PURCHASE_PER_WALLET, "Each address can only own upto 50 Baphelions.");
