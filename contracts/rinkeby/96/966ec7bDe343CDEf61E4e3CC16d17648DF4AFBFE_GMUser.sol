...
/**
  ...
  */
contract GMUser is AccessControl {
    ...
    function grantTrader(address user) public {
        return grantRole(TRADER, user);
    }

    function grantCreator(address user) public {
        return grantRole(CREATOR, user);
    }

    function revokeTrader(address user) public {
        return revokeRole(TRADER, user);
    }

    function revokeCreator(address user) public {
