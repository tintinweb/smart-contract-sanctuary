...
contract Bulltangclan is ERC721Enumerable, Ownable {
    ...
    address public constant treasuryAddress = 0x1509eADe40F039f345bdb0D88747BD124Ab4785C;
    address public constant teamAddress = 0xc0a9A682DAEFdE5788d633129787423A2A7BcBeE;
    
    uint256 private pricePresale = PRICE_PRE_SALE;
    uint256 private priceWhitelistSale = PRICE_PUBLIC_SALE;
    ...
    function mintWhitelist(uint256 amountOfNfts) external payable whenWhitelistSaleStarted {
        ...
        require(totalSupply() < MAX_NFTS, "All NFTs have been minted");
        require(amountOfNfts <= MAX_MINT_PRESALE, "Purchase exceeds Whitelist limit");
        require(totalSupply() + amountOfNfts <= MAX_NFTS, "Mint exceeds max supply");
        require(_totalClaimed[msg.sender] + amountOfNfts <= MAX_MINT_PRESALE, "Purchase exceeds max allowed max allowed per wallet");
        require(amountOfNfts > 0, "Must mint at least one NFT");
