...
contract Vendor is Ownable, UUPSUpgradeable, Initializable {
  ...
  function initialize (address _tokenAddress, address _aggregator, address _students) public initializer {
