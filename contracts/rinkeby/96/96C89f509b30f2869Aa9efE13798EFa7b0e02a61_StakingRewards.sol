...
contract StakingRewards is IStakingRewards, ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public rewardRate = 367;
    uint256 public rewardsDuration = 4 weeks;
    uint256 public lastUpdateTime;
    uint256 public rewardPerTokenStored;
    address public stripMultiSig;
    ...
    constructor(
        ...
        address _stripMultiSig
    ) {
        rewardsToken = _rewardsToken;
        stakingToken = _stakingToken;
        stripMultiSig = _stripMultiSig;
        ...
        onlyOwner
    {
        ...
        IERC20(tokenAddress).safeTransfer(stripMultiSig, tokenAmount);
