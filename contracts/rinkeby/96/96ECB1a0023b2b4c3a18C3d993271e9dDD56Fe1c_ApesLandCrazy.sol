  ...
  UUPSUpgradeable
{
  ...
  */
  ...
  function stackBuilding(uint256 buildingNftID) public {
    ...
    uint256 genericType = typeOfBuildingStrToInt(apeBuilding.typeOfBuildingByNFTId(buildingNftID));
    // hasta aca va
  ...
  */
  ...
  function typeOfBuildingStrToInt(string memory typeOfBuildingStr) private returns(uint256) {
    uint256 typeId;
    if (compareStrings(typeOfBuildingStr, "ApeHouse")) {
      typeId = 1;
    } else if (compareStrings(typeOfBuildingStr, "ApeFarm")) {
      typeId = 2;
    } else if (compareStrings(typeOfBuildingStr, "ApeBarracks")) {
      typeId = 3;
    }
  }
