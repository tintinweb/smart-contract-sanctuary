    ...
    ERC721URIStorage
{
    ...
    mapping(bytes32 => string) requestToTokenURI;
    ...
    function requestNewRandom(address _sender, string memory _tokenURI)
        public
        returns (bytes32)
    {
        require(
        ...
        requestToTokenURI[requestId] = _tokenURI;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness)
        ...
        override
    {
        tokenPower[_tokenIdTracker.current()] = (randomness == 0 ||
            randomness % 5 == 0)
            ? 1
            : randomness % 5;
        _mint(requestToSender[requestId], _tokenIdTracker.current());
        _setTokenURI(_tokenIdTracker.current(), requestToTokenURI[requestId]);
        _updateTokenCreator(
            _tokenIdTracker.current(),
            payable(requestToSender[requestId])
        );
    ...
    function onTokenTransfer(
        ...
        requestNewRandom(_sender, string(_data));
    }
