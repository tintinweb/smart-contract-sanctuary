...
contract Learn is ERC721Enumerable, Ownable {
    ...
    uint256 public constant CURRENT_PRICE = 60000000000000000; // 0.06 ETH
    ...
    // check why alien has monkey doesnt
    ...
    function mintToken(uint256 numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MAX_PURCHASE, "Can only mint 50 at a time");
        require(
