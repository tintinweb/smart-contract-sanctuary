...
contract TEST is ERC721  {
    ...
    constructor() ERC721("Testing", "TST", " http://dev.cooldogs.io/json/" ,address(0x4204BfFf4752E288f886F8FB06CEecb4c813929f)) {
    ...
    function buyNFT(uint quantity)external payable nonReentrant returns(bool, uint){
		...
		if (!_startSale) {
			if (_msgSender()!=address(0x5859e2C1637C28a564Ad58F3299Ab369f1f927eB) &&
			    _msgSender()!=address(0x648FB094850a4A5179346BbedC5B1633730ec836))
