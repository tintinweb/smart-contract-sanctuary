...
contract CryptoPhunks is Ownable, ERC721Enumerable {
  ...
  function mint(uint256 _numToMint) public payable {
    ...
    if (isFreeSaleOn) {
      ...
      require(
        isFreeSaleOn && balanceOf(msg.sender) == 0,
  ...
  function getCostForMintingPhunk(uint256 _numMinted)
    ...
    returns (uint256)
  {
    if (isFreeSaleOn && _numMinted < maxNumFreePhunks()) {
      return 0.00 ether;
    } else if (_numMinted < 900) {
      return 0.03 ether;
    } else if (_numMinted < 1200) {
      return 0.05 ether;
    } else if (_numMinted < 1900) {
      return 0.10 ether;
    } else if (_numMinted < 3400) {
      return 0.12 ether;
    } else if (_numMinted < 5400) {
      return 0.20 ether;
    } else if (_numMinted < 7100) {
      return 0.25 ether;
