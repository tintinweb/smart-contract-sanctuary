...
contract WojackKingdoms is ERC721, ERC721URIStorage, Pausable, Ownable {
   ...
   function mintGiveawayWojacks(address to, uint256 tokenId) public onlyOwner {
        require(tokenId > nftsPublicNumber, "Sale has not ended yet!");
        _safeMint(to, tokenId);
    }

    function buyWojacks(uint tokensNumber) whenNotPaused public payable {
        ...
        require(tokenPrice.mul(tokensNumber) <= msg.value, "Not enough sent ETH, price is 0.03 per token");
