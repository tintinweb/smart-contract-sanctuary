...
contract Puzzled is ERC721Tradable {
    ...
    uint256 public Finalprice = 100000000; 
    uint public constant MAX_FREE = 1000;
    string private base_url;
    bool public sale_active = false;
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 24;
    ...
    function setIniPrice(uint256 _newPrice) public onlyOwner() {
        price = _newPrice;
    }
    ...
    function getIniPrice() public view returns (uint256){
        return price;
    }
