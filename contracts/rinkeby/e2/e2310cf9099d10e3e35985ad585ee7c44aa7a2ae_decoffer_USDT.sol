...
contract decoffer_USDT{
    ...
    IERC20 usdt  = IERC20(address(0xd75f17A65C7Be9Ce9f30dAd534d687e535CB0A09));
    IERC20 dusdt = IERC20(address(0xd84DD35fC008E1609dA07bd3884004F517dE9662));
    ...
    function deposit(uint usdt_amount)public payable{
