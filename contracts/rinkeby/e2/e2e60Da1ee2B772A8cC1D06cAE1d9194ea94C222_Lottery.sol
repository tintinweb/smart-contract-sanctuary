...
contract Lottery is VRFConsumerBase, Ownable
{
        ...
        VRFConsumerBase(_vrfCoordinator, _linkToken)
    {
        ...
        usdEntryFee = 50 * (10 ** ethUsdPriceFeed.decimals());
    ...
    function getEntranceFee() public view returns(uint256)
    {
        ...
        uint256 entranceFeeInWei = (usdEntryFee * (10 ** 18)) / uint256(price);
    ...
    {
        require(lottery_state == LOTTERY_STATE.CLOSE, "Can't start new lottery");
