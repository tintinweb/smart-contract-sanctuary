...
contract ninetyNFT is ERC721Enumerable, Ownable {
    ...
    mapping (uint256 => address) public targetNFTWhitelist;
    mapping (uint256 => address) public priorityNFTWhitelist;
    ...
    */
    ...
    function mintXXXsPreSale(uint256 numberOfXXXs) public payable returns (uint256[] memory){
        ...
        require(balanceOf(msg.sender) + numberOfXXXs <= XXX_PACK_LIMIT, "Buy limit exceeded");
    ...
    function mintXXXsPublic(uint256 numberOfXXXs) public payable returns (uint256[] memory){
        ...
        if(preSaleWhitelist[msg.sender]){
            ...
            require(XXX_PRICE * numberOfXXXs == msg.value, "Invalid ETH Amount");
        }
