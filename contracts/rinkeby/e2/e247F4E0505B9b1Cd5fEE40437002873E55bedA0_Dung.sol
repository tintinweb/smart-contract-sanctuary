...
contract Dung is ERC20, MinterRole {
    ...
    //address public trustedSpender; //Must be set at deploy with INventary Address

    constructor() 
    ERC20("Degen's Farm Dung", "DUNG")
    ...
    /**
     * @dev Overriding standart function for gas safe swap with Inventary
     * Requirements:
     *
     * - `sender` and `recipient` cannot be the zero address.
     * - `sender` must have a balance of at least `amount`.
