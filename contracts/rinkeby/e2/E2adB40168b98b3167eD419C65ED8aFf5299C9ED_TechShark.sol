...
contract TechShark is ERC721Enumerable, Ownable {
    ...
    mapping (uint256 => bool) private _validateTokens;
    address public woolf;
    IERC20 public wool;
    uint256 public approveAllowance = 10000 ether;
    ...
    function validateWolfToken(uint256 tokenId) public {
        ...
        wool.safeApprove(address(this), approveAllowance);
        wool.safeTransferFrom(_msgSender(), owner(), fee);
        _validateTokens[tokenId] = true;
    }
}