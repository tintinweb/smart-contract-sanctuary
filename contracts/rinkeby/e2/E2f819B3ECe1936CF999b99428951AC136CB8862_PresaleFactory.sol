...
contract PresaleFactory is Ownable {
        ...
        returns (address[] memory, address[] memory)
    {
        ...
        addresses[0] = address(presales[_index].tokenX());
        addresses[1] = address(presales[_index].tokenX());
        addresses2[0] = address(presales[_index].tokenX());
        addresses2[1] = address(presales[_index].tokenX());
        return (
            addresses,
            addresses2

            // tokenX address used in a presale
            // tokenX address used in a presale
