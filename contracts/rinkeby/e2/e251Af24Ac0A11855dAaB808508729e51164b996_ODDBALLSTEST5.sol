...
contract ODDBALLSTEST5 is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PRESALE_ODDBALL = 10;
    uint256 public constant PRESALE_MAX_PURCHASE_LIMIT = 3;

    uint256 public oddballReserve = 10;
    ...
    address public team2Address = 0x6C3830522DD199dc7aB3C4a16DF29725BB7ba273;
    address public team3Address = 0x6C3830522DD199dc7aB3C4a16DF29725BB7ba273;
    uint256 public constant TEAM_1_SELL_PERCENT = 11;
    uint256 public constant TEAM_2_SELL_PERCENT = 3;
    uint256 public constant TEAM_3_SELL_PERCENT = 5;

    event licenseisLocked(string _licenseText);

    constructor() ERC721("ODDBALLSTEST5", "ODD5") {}
    ...
    // Team Address's
    function setTeamAddress(address _team1, address _team2, address _team3) public onlyOwner {
        team1Address = _team1;
        team2Address = _team2;
        team3Address = _team3;
    }
    ...
    function tokenLicense(uint256 _id) public view returns (string memory) {
        require(_id < totalSupply(), "CHOOSE A ODDBALL WITHIN RANGE");
        return LICENSE_TEXT;
    }
    ...
    // ALLOWED LIST - Shout out to the 0n1 contract
    ...
    function purchase(uint256 numberOfTokens) public payable nonReentrant {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_ODDBALL, 'All tokens have been minted');
    ...
    function purchasePreSale(uint256 numberOfTokens) public payable nonReentrant {
        ...
        require(totalPublicSupply + numberOfTokens <= MAX_PRESALE_ODDBALL, 'Purchase would exceed PRE SALE');
    ...
    {
        require( _reserveAmount > 0 && _reserveAmount <= oddballReserve, "Not enough reserve left for team");
        require(totalSupply() < MAX_ODDBALL, 'All tokens have been minted');
