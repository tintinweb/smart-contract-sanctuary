...
contract FlashMintsPass is ERC1155, Ownable {
	...
	uint256 public itemPrice; //price to adopt one mint pass, configurable

	constructor() ERC1155(_baseURI) {
		itemPrice = 0.1 ether; // 0.07 ETH
	}
