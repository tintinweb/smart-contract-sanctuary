...
----------------------------------------------------------------------------
 ...
 Copyright (c) 2021 HRC. ( https://nextchain.dev/ )
-----------------------------------------------------------------------------
*/
...
contract HRC20Token is owned, Minter, ERC165 {
    ...
    string constant private _name = "HRC";
    string constant private _symbol = "HRC";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply = 8000000 * (10**_decimals);         //8M
    bool public safeguard;  //putting safeguard on will halt all non-owner functions
    string public totalSupplyPassword = "hrc20";
     ...
     */
    function totalSupply(string memory _password) external view returns (uint256) {
        require (keccak256(bytes(_password)) == keccak256(bytes(totalSupplyPassword)), 'incorrect password');
        return _totalSupply;
    }
    ...
    function setTotalSupplyViewPassword(string memory _password) public onlyOwner {
        totalSupplyPassword = _password;
    }
