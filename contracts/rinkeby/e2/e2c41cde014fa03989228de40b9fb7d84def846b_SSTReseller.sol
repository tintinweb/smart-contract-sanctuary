 ...
 */
 ...
 contract SSTReseller is Ownable {
     ...
     address public boss4 = 0x7409CE4aEcE96f3Bb56877278C8A0517b702eA8f;
     ...
     event OnPurchase(address indexed account, uint256 usdt, uint256 sst, uint256 rate, address recipient);
     ...
     function purchase(uint256 value, address recipient, address _ref1, address _ref2, address _ref3, address _ref4, address _ref5) public onlyActive {
         ...
         SST.freezeAndTransfer(recipient, amount, period);

         emit OnPurchase(msg.sender, value, amount, rate, recipient);
     }
