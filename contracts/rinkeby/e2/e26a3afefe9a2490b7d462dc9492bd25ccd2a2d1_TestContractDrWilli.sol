...
// File: contracts/TestContractDrWilli.sol

pragma solidity >=0.8.0 <0.9.0;

/**
 * @title TestContractDrWilli
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract TestContractDrWilli is ERC721Enumerable, Ownable {
    using Strings for uint256;
    using Address for address;
    ...
    /**
     * @notice Mint reserved TestContract.
    ...
    /**
     * @notice Bring new Items into the world.
    ...
    function mint(uint256 amount) public payable {
        ...
        require(
            conf.supply + amount < conf.maxItems,
        ...
        require(
            amount <= conf.perMint,
            "Amount exceeds current maximum Items per mint."
        );
        require(
    ...
    /**
     * @notice Returns max maxItems per mint.
     */
    ...
    /**
     * @notice Sets max Items per mint.
     */
