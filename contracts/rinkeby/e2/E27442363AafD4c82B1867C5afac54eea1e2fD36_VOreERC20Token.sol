...
contract VaultOwned is Ownable {
  ...
  mapping(address => bool) _vaultList;
  ...
  modifier onlyVault() {
    require( _vaultList[msg.sender], "VaultOwned: caller is not the Vault" );
    _;
  }

}

contract VOreERC20Token is ERC20Permit, VaultOwned {

    using LowGasSafeMath for uint256;

    constructor() ERC20("V-Ore", "ORE", 9) {
    }
