...
contract Benis is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><rect width="100%" height="100%" fill="black" /><text style="font-size:12px;" x="10" y="168" fill="';
        parts[1] = benis.color;
        parts[2] = '">';
        parts[3] = benis.name;
        parts[4] = "</text></svg>";
