...
contract PlasticCat is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0xF4aEeA36958Ec8f76E15Ec5C596cf4373EB78F29;
    ...
    constructor(string memory baseURI) ERC721("PlasticCat", "PLA")  {
        setBaseURI(baseURI);
    ...
    function adopt(uint256 num) public payable {
        ...
        require( num < 21,                              "You can only collect a maximum of 20 Yeti" );
        require( supply + num < 10000 - _reserved,      "Maximum Yeti supply exceeds" );
        require( msg.value >= _price * num,             "Ether amount sent incorrect" );
