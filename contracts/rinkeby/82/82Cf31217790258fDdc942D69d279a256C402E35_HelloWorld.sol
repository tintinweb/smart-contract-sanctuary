...
contract HelloWorld is Ownable, ERC721Full {
    ...
    uint256 payEther = 30000000000000000;

    uint256 platformEther = 10000000000000000;
    uint256 creatorsEther = 2000000000000000;
    uint256 holderEther = 8000000000000000;
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "', letter, '", "description": "',letter,'", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
