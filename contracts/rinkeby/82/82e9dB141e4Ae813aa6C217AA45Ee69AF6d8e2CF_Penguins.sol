...
contract Penguins is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 public immutable mintPrice = 0.00001 ether;
    ...
    constructor(uint256 _maxTotalSupply) ERC721("ERENFT", "ERNFT") {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        combined,
                        '", "description": "A simple collection of nfts.", "image": "data:image/svg+xml;base64,',
