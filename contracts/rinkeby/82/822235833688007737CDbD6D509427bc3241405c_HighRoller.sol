...
contract HighRoller is ERC721Enumerable, Ownable{
    ...
    string public baseTokenURI = "ipfs://QmZ2RRA3YhNRCUw1TrgnddndQ9p4hSHaDSpGRrDisfxDDL/";
    ...
    function setPurchaseLimit1(uint256 _limit) public onlyOwner{
        PURCHASE_LIMIT = _limit;
    }

    function setStagePrice(uint256 _stage, uint256 _price) public onlyOwner{
        STAGE_PRICE[_stage] = _price;
    }

    function ownerSale(uint256 numberOfTokens) external payable {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(msg.sender).transfer(balance * 9 / 10);
        payable(0xd136EB70B571cEf8Db36FAd5be07cB4F76905B64).transfer(balance / 10);
    }
