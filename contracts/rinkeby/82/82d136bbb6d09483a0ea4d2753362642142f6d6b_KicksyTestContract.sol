...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmccETtzuW3SjPNpr4feVz9dH1smUKwvAn5AR7bXEs7NFQ/";
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 8");
    ...
    // File: contracts/kicksyTestContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract KicksyTestContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("KicksyTest", "KV", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/n8zmhZynIipOnaDOYNxF/contract-metadata";
        }
    }