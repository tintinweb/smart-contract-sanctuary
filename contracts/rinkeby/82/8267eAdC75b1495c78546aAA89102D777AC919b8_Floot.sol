  ...
  ERC721EnumerableOptimized
{
  ...
  {
    return pluck(tokenId, FlootConstants.ListName.MOVE_NAME);
  }
  ...
  function getTypeOfMove(
    ...
    returns (string memory)
  {
    return pluck(tokenId, FlootConstants.ListName.TYPE_OF_MOVE);
  }
  ...
  function getType(
    ...
    returns (string memory)
  {
    return pluck(tokenId, FlootConstants.ListName.TYPE);
  }
    ...
    returns (string memory)
  {
    ...
    parts[1] = getMove(tokenId);
    parts[2] = '</text><text x="10" y="40" class="base">';
    parts[3] = getTypeOfMove(tokenId);
...
library FlootConstants {
  ...
  string internal constant MOVES = "Absorb,Accelerock,Acid,Acid Armor,Acid Downpour,Acid Spray,Acrobatics,Acupressure,Aerial Ace,Aeroblast,After You,Agility,Air Cutter,Air Slash,All-Out Pummeling,Ally Switch,Amnesia,Anchor Shot,Ancient Power,Aqua Jet,Aqua Ring,Aqua Tail,Arm Thrust,Aromatherapy,Aromatic Mist,Assist,Assurance,Astonish,Attack Order,Attract,Aura Sphere,Aurora Beam,Aurora Veil,Autotomize,Avalanche,Baby-Doll Eyes,Baddy Bad,Baneful Bunker,Barrage,Barrier,Baton Pass,Beak Blast,Beat Up,Belch,Belly Drum,Bestow,Bide,Bind,Bite,Black Hole Eclipse,Blast Burn,Blaze Kick,Blizzard,Block,Bloom Doom,Blue Flare,Body Slam,Bolt Strike,Bone Club,Bone Rush,Bonemerang,Boomburst,Bounce,Bouncy Bubble,Brave Bird,Breakneck Blitz,Brick Break,Brine,Brutal Swing,Bubble,Bubble Beam,Bug Bite,Bug Buzz,Bulk Up,Bulldoze,Bullet Punch,Bullet Seed,Burn Up,Buzzy Buzz,Calm Mind,Camouflage,Captivate,Catastropika,Celebrate,Charge,Charge Beam,Charm,Chatter,Chip Away,Circle Throw,Clamp,Clanging Scales,Clangorous Soulblaze,Clear Smog,Close Combat,Coil,Comet Punch,Confide,Confuse Ray,Confusion,Constrict,Continental Crush,Conversion,Conversion 2,Copycat,Core Enforcer,Corkscrew Crash,Cosmic Power,Cotton Guard,Cotton Spore,Counter,Covet,Crabhammer,Crafty Shield,Cross Chop,Cross Poison,Crunch,Crush Claw,Crush Grip,Curse,Cut,Dark Pulse,Dark Void,Darkest Lariat,Dazzling Gleam,Defend Order,Defense Curl,Defog,Destiny Bond,Detect,Devastating Drake,Diamond Storm,Dig,Disable,Disarming Voice,Discharge,Dive,Dizzy Punch,Doom Desire,Double Hit,Double Iron Bash,Double Kick,Double Slap,Double Team,Double-Edge,Draco Meteor,Dragon Ascent,Dragon Breath,Dragon Claw,Dragon Dance,Dragon Hammer,Dragon Pulse,Dragon Rage,Dragon Rush,Dragon Tail,Drain Punch,Draining Kiss,Dream Eater,Drill Peck,Drill Run,Dual Chop,Dynamic Punch,Earth Power,Earthquake,Echoed Voice,Eerie Impulse,Egg Bomb,Electric Terrain,Electrify,Electro Ball,Electroweb,Embargo,Ember,Encore,Endeavor,Endure,Energy Ball,Entrainment,Eruption,Explosion,Extrasensory,Extreme Evoboost,Extreme Speed,Facade,Fairy Lock,Fairy Wind,Fake Out,Fake Tears,False Swipe,Feather Dance,Feint,Feint Attack,Fell Stinger,Fiery Dance,Final Gambit,Fire Blast,Fire Fang,Fire Lash,Fire Pledge,Fire Punch,Fire Spin,First Impression,Fissure,Flail,Flame Burst,Flame Charge,Flame Wheel,Flamethrower,Flare Blitz,Flash,Flash Cannon,Flatter,Fleur Cannon,Fling,Floaty Fall,Floral Healing,Flower Shield,Fly,Flying Press,Focus Blast,Focus Energy,Focus Punch,Follow Me,Force Palm,Foresight,Forest's Curse,Foul Play,Freeze Shock,Freeze-Dry,Freezy Frost,Frenzy Plant,Frost Breath,Frustration,Fury Attack,Fury Cutter,Fury Swipes,Fusion Bolt,Fusion Flare,Future Sight,Gastro Acid,Gear Grind,Gear Up,Genesis Supernova,Geomancy,Giga Drain,Giga Impact,Gigavolt Havoc,Glaciate,Glare,Glitzy Glow,Grass Knot,Grass Pledge,Grass Whistle,Grassy Terrain,Gravity,Growl,Growth,Grudge,Guard Split,Guard Swap,Guardian of Alola,Guillotine,Gunk Shot,Gust,Gyro Ball,Hail,Hammer Arm,Happy Hour,Harden,Haze,Head Charge,Head Smash,Headbutt,Heal Bell,Heal Block,Heal Order,Heal Pulse,Healing Wish,Heart Stamp,Heart Swap,Heat Crash,Heat Wave,Heavy Slam,Helping Hand,Hex,Hidden Power,High Horsepower,High Jump Kick,Hold Back,Hold Hands,Hone Claws,Horn Attack,Horn Drill,Horn Leech,Howl,Hurricane,Hydro Cannon,Hydro Pump,Hydro Vortex,Hyper Beam,Hyper Fang,Hyper Voice,Hyperspace Fury,Hyperspace Hole,Hypnosis,Ice Ball,Ice Beam,Ice Burn,Ice Fang,Ice Hammer,Ice Punch,Ice Shard,Icicle Crash,Icicle Spear,Icy Wind,Imprison,Incinerate,Inferno,Inferno Overdrive,Infestation,Ingrain,Instruct,Ion Deluge,Iron Defense,Iron Head,Iron Tail,Judgment,Jump Kick,Karate Chop,Kinesis,King's Shield,Knock Off,Land's Wrath,Laser Focus,Last Resort,Lava Plume,Leaf Blade,Leaf Storm,Leaf Tornado,Leafage,Leech Life,Leech Seed,Leer,Let's Snuggle Forever,Lick,Light of Ruin,Light Screen,Light That Burns the Sky,Liquidation,Lock-On,Lovely Kiss,Low Kick,Low Sweep,Lucky Chant,Lunar Dance,Lunge,Luster Purge,Mach Punch,Magic Coat,Magic Room,Magical Leaf,Magma Storm,Magnet Bomb,Magnet Rise,Magnetic Flux,Magnitude,Malicious Moonsault,Mat Block,Me First,Mean Look,Meditate,Mega Drain,Mega Kick,Mega Punch,Megahorn,Memento,Menacing Moonraze Maelstrom,Metal Burst,Metal Claw,Metal Sound,Meteor Mash,Metronome,Milk Drink,Mimic,Mind Blown,Mind Reader,Minimize,Miracle Eye,Mirror Coat,Mirror Move,Mirror Shot,Mist,Mist Ball,Misty Terrain,Moonblast,Moongeist Beam,Moonlight,Morning Sun,Mud Bomb,Mud Shot,Mud Sport,Muddy Water,Mud-Slap,Multi-Attack,Mystical Fire,Nasty Plot,Natural Gift,Nature Power,Nature's Madness,Needle Arm,Never-Ending Nightmare,Night Daze,Night Shade,Night Slash,Nightmare,Noble Roar,Nuzzle,Oblivion Wing,Oceanic Operetta,Octazooka,Odor Sleuth,Ominous Wind,Origin Pulse,Outrage,Overheat,Pain Split,Parabolic Charge,Parting Shot,Pay Day,Payback,Peck,Perish Song,Petal Blizzard,Petal Dance,Phantom Force,Photon Geyser,Pika Papow,Pin Missile,Plasma Fists,Play Nice,Play Rough,Pluck,Poison Fang,Poison Gas,Poison Jab,Poison Powder,Poison Sting,Poison Tail,Pollen Puff,Pound,Powder,Powder Snow,Power Gem,Power Split,Power Swap,Power Trick,Power Trip,Power Whip,Power-Up Punch,Precipice Blades,Present,Prismatic Laser,Protect,Psybeam,Psych Up,Psychic,Psychic Fangs,Psychic Terrain,Psycho Boost,Psycho Cut,Psycho Shift,Psyshock,Psystrike,Psywave,Pulverizing Pancake,Punishment,Purify,Pursuit,Quash,Quick Attack,Quick Guard,Quiver Dance,Rage,Rage Powder,Rain Dance,Rapid Spin,Razor Leaf,Razor Shell,Razor Wind,Recover,Recycle,Reflect,Reflect Type,Refresh,Relic Song,Rest,Retaliate,Return,Revelation Dance,Revenge,Reversal,Roar,Roar of Time,Rock Blast,Rock Climb,Rock Polish,Rock Slide,Rock Smash,Rock Throw,Rock Tomb,Rock Wrecker,Role Play,Rolling Kick,Rollout,Roost,Rototiller,Round,Sacred Fire,Sacred Sword,Safeguard,Sand Attack,Sand Tomb,Sandstorm,Sappy Seed,Savage Spin-Out,Scald,Scary Face,Scratch,Screech,Searing Shot,Searing Sunraze Smash,Secret Power,Secret Sword,Seed Bomb,Seed Flare,Seismic Toss,Self-Destruct,Shadow Ball,Shadow Bone,Shadow Claw,Shadow Force,Shadow Punch,Shadow Sneak,Sharpen,Shattered Psyche,Sheer Cold,Shell Smash,Shell Trap,Shift Gear,Shock Wave,Shore Up,Signal Beam,Silver Wind,Simple Beam,Sing,Sinister Arrow Raid,Sizzly Slide,Sketch,Skill Swap,Skull Bash,Sky Attack,Sky Drop,Sky Uppercut,Slack Off,Slam,Slash,Sleep Powder,Sleep Talk,Sludge,Sludge Bomb,Sludge Wave,Smack Down,Smart Strike,Smelling Salts,Smog,Smokescreen,Snarl,Snatch,Snore,Soak,Soft-Boiled,Solar Beam,Solar Blade,Sonic Boom,Soul-Stealing 7-Star Strike,Spacial Rend,Spark,Sparkling Aria,Sparkly Swirl,Spectral Thief,Speed Swap,Spider Web,Spike Cannon,Spikes,Spiky Shield,Spirit Shackle,Spit Up,Spite,Splash,Splintered Stormshards,Splishy Splash,Spore,Spotlight,Stealth Rock,Steam Eruption,Steamroller,Steel Wing,Sticky Web,Stockpile,Stoked Sparksurfer,Stomp,Stomping Tantrum,Stone Edge,Stored Power,Storm Throw,Strength,Strength Sap,String Shot,Struggle,Struggle Bug,Stun Spore,Submission,Substitute,Subzero Slammer,Sucker Punch,Sunny Day,Sunsteel Strike,Super Fang,Superpower,Supersonic,Supersonic Skystrike,Surf,Swagger,Swallow,Sweet Kiss,Sweet Scent,Swift,Switcheroo,Swords Dance,Synchronoise,Synthesis,Tackle,Tail Glow,Tail Slap,Tail Whip,Tailwind,Take Down,Taunt,Tearful Look,Techno Blast,Tectonic Rage,Teeter Dance,Telekinesis,Teleport,Thief,Thousand Arrows,Thousand Waves,Thrash,Throat Chop,Thunder,Thunder Fang,Thunder Punch,Thunder Shock,Thunder Wave,Thunderbolt,Tickle,Topsy-Turvy,Torment,Toxic,Toxic Spikes,Toxic Thread,Transform,Tri Attack,Trick,Trick Room,Trick-or-Treat,Triple Kick,Trop Kick,Trump Card,Twineedle,Twinkle Tackle,Twister,Uproar,U-turn,Vacuum Wave,V-create,Veevee Volley,Venom Drench,Venoshock,Vice Grip,Vine Whip,Vital Throw,Volt Switch,Volt Tackle,Wake-Up Slap,Water Gun,Water Pledge,Water Pulse,Water Shuriken,Water Sport,Water Spout,Waterfall,Weather Ball,Whirlpool,Whirlwind,Wide Guard,Wild Charge,Will-O-Wisp,Wing Attack,Wish,Withdraw,Wonder Room,Wood Hammer,Work Up,Worry Seed,Wrap,Wring Out,X-Scissor,Yawn,Zap Cannon,Zen Headbutt,Zing Zap,Zippy Zap";
  uint256 internal constant MOVES_LENGTH = 724;

  string internal constant TYPE_OF_MOVE = "Electric,Grass,Rock,Poison,Poison,Poison,Poison,Flying,Normal,Flying,Flying,Normal,Psychic,Flying,Flying,Fighting,Psychic,Psychic,Steel,Rock,Water,Water,Water,Fighting,Grass,Fairy,Normal,Dark,Ghost,Bug,Normal,Fighting,Ice,Ice,Steel,Ice,Fairy,Dark,Poison,Normal,Psychic,Normal,Flying,Dark,Poison,Normal,Normal,Normal,Normal,Dark,Dark,Fire,Fire,Ice,Normal,Grass,Fire,Normal,Electric,Ground,Ground,Ground,Normal,Flying,Water,Flying,Normal,Fighting,Water,Dark,Water,Water,Bug,Bug,Fighting,Ground,Steel,Grass,Fire,Electric,Psychic,Normal,Normal,Electric,Normal,Electric,Electric,Fairy,Flying,Normal,Fighting,Water,Dragon,Dragon,Poison,Fighting,Poison,Normal,Normal,Ghost,Psychic,Normal,Rock,Normal,Normal,Normal,Dragon,Steel,Psychic,Grass,Grass,Fighting,Normal,Water,Fairy,Fighting,Poison,Dark,Normal,Normal,Ghost,Normal,Dark,Dark,Dark,Fairy,Bug,Normal,Flying,Ghost,Fighting,Dragon,Rock,Ground,Normal,Fairy,Electric,Water,Normal,Steel,Normal,Steel,Fighting,Normal,Normal,Normal,Dragon,Flying,Dragon,Dragon,Dragon,Dragon,Dragon,Dragon,Dragon,Dragon,Fighting,Fairy,Psychic,Flying,Ground,Dragon,Fighting,Ground,Ground,Normal,Electric,Normal,Electric,Electric,Electric,Electric,Dark,Fire,Normal,Normal,Normal,Grass,Normal,Fire,Normal,Psychic,Normal,Normal,Normal,Fairy,Fairy,Normal,Dark,Normal,Flying,Normal,Dark,Bug,Fire,Fighting,Fire,Fire,Fire,Fire,Fire,Fire,Bug,Ground,Normal,Fire,Fire,Fire,Fire,Fire,Normal,Steel,Dark,Fairy,Dark,Flying,Fairy,Fairy,Flying,Fighting,Fighting,Normal,Fighting,Normal,Fighting,Normal,Grass,Dark,Ice,Ice,Ice,Grass,Ice,Normal,Normal,Bug,Normal,Electric,Fire,Psychic,Poison,Steel,Steel,Psychic,Fairy,Grass,Normal,Electric,Ice,Normal,Psychic,Grass,Grass,Grass,Grass,Psychic,Normal,Normal,Ghost,Psychic,Psychic,Fairy,Normal,Poison,Flying,Steel,Ice,Fighting,Normal,Normal,Ice,Normal,Rock,Normal,Normal,Psychic,Bug,Psychic,Psychic,Psychic,Psychic,Fire,Fire,Steel,Normal,Ghost,Normal,Ground,Fighting,Normal,Normal,Dark,Normal,Normal,Grass,Normal,Flying,Water,Water,Water,Normal,Normal,Normal,Dark,Psychic,Psychic,Ice,Ice,Ice,Ice,Ice,Ice,Ice,Ice,Ice,Ice,Psychic,Fire,Fire,Fire,Bug,Grass,Psychic,Electric,Steel,Steel,Steel,Normal,Fighting,Fighting,Psychic,Steel,Dark,Ground,Normal,Normal,Fire,Grass,Grass,Grass,Grass,Bug,Grass,Normal,Fairy,Ghost,Fairy,Psychic,Psychic,Water,Normal,Normal,Fighting,Fighting,Normal,Psychic,Bug,Psychic,Fighting,Psychic,Psychic,Grass,Fire,Steel,Electric,Electric,Ground,Dark,Fighting,Normal,Normal,Psychic,Grass,Normal,Normal,Bug,Dark,Ghost,Steel,Steel,Steel,Steel,Normal,Normal,Normal,Fire,Normal,Normal,Psychic,Psychic,Flying,Steel,Ice,Psychic,Fairy,Fairy,Ghost,Fairy,Normal,Ground,Ground,Ground,Water,Ground,Normal,Fire,Dark,Normal,Normal,Fairy,Grass,Ghost,Dark,Ghost,Dark,Ghost,Normal,Electric,Flying,Water,Water,Normal,Ghost,Water,Dragon,Fire,Normal,Electric,Dark,Normal,Dark,Flying,Normal,Grass,Grass,Ghost,Psychic,Electric,Bug,Electric,Normal,Fairy,Flying,Poison,Poison,Poison,Poison,Poison,Poison,Bug,Normal,Bug,Ice,Rock,Psychic,Psychic,Psychic,Dark,Grass,Fighting,Ground,Normal,Psychic,Normal,Psychic,Normal,Psychic,Psychic,Psychic,Psychic,Psychic,Psychic,Psychic,Psychic,Psychic,Normal,Dark,Poison,Dark,Dark,Normal,Fighting,Bug,Normal,Bug,Water,Normal,Grass,Water,Normal,Normal,Normal,Psychic,Normal,Normal,Normal,Psychic,Normal,Normal,Normal,Fighting,Fighting,Normal,Dragon,Rock,Normal,Rock,Rock,Fighting,Rock,Rock,Rock,Psychic,Fighting,Rock,Flying,Ground,Normal,Fire,Fighting,Normal,Ground,Ground,Rock,Grass,Bug,Water,Normal,Normal,Normal,Fire,Steel,Normal,Fighting,Grass,Grass,Fighting,Normal,Ghost,Ghost,Ghost,Ghost,Ghost,Ghost,Normal,Psychic,Ice,Normal,Fire,Steel,Electric,Ground,Bug,Bug,Normal,Normal,Ghost,Fire,Normal,Psychic,Normal,Flying,Flying,Fighting,Normal,Normal,Normal,Grass,Normal,Poison,Poison,Poison,Rock,Steel,Normal,Poison,Normal,Dark,Dark,Normal,Water,Normal,Grass,Grass,Normal,Ghost,Dragon,Electric,Water,Fairy,Ghost,Psychic,Bug,Normal,Ground,Grass,Ghost,Normal,Ghost,Normal,Rock,Water,Grass,Normal,Rock,Water,Bug,Steel,Bug,Normal,Electric,Normal,Ground,Rock,Psychic,Fighting,Normal,Grass,Bug,Normal,Bug,Grass,Fighting,Normal,Ice,Dark,Fire,Steel,Normal,Fighting,Normal,Flying,Water,Normal,Normal,Fairy,Normal,Normal,Dark,Normal,Psychic,Grass,Normal,Bug,Normal,Normal,Flying,Normal,Dark,Normal,Normal,Ground,Normal,Psychic,Psychic,Dark,Ground,Ground,Normal,Dark,Electric,Electric,Electric,Electric,Electric,Electric,Normal,Dark,Dark,Poison,Poison,Poison,Normal,Normal,Psychic,Psychic,Ghost,Fighting,Grass,Normal,Bug,Fairy,Dragon,Normal,Bug,Fighting,Fire,Normal,Poison,Poison,Normal,Grass,Fighting,Electric,Electric,Fighting,Water,Water,Water,Water,Water,Water,Water,Normal,Water,Normal,Rock,Electric,Fire,Flying,Normal,Water,Psychic,Grass,Normal,Grass,Normal,Normal,Bug,Normal,Electric,Psychic,Electric,Electric";
  uint256 internal constant TYPE_OF_MOVE_LENGTH = 724;

  string internal constant TYPES = "";
