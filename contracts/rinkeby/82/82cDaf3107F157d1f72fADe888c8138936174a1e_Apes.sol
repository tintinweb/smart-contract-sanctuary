...
contract Apes is ERC721, Ownable {
    ...
    // Sale starts at 
    uint256 public constant SALE_START_TIMESTAMP = 1618900011;

    // Sale ends 14 days later
    ...
    function addClaimableContract(address contractAddress) public onlyOwner {
        _claimableContracts.add(contractAddress);
    }
