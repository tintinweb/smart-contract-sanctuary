...
contract PRNTR is ERC20Burnable, DoubleOperator {
    ...
    mapping(address => bool) blacklistUsers;
    ...
    constructor() public ERC20('PRNTR', 'PRNTR') {
     ...
     modifier whitelist() {
        require(blacklistUsers[msg.sender] == false, "You have been papr-ed, no printeri-no.");
        _;
    }
    ...
    function addBlacklist(address _blacklist) external onlyDoubleOperator {
        ...
        require(blacklistUsers[_blacklist] == false, "This user has been blacklisted");
    ...
    function transfer(address recipient, uint256 amount) public whitelist override returns (bool) {
