...
contract ZkSync is UpgradeableMaster, Storage, Config, Events, ReentrancyGuard {
    ...
    function requestFullExit(uint32 _accountId, address _token) public nonReentrant {
        ...
        require(_accountId != (2**32) - 2, "v"); // request full exit for nft storage account
...
contract KeysWithPlonkVerifier is VerifierWithDeserialize {
    ...
    uint256 constant VK_TREE_ROOT = 0x271574d0ac90be208249ab4aacd81379f889715a531ae67ee0a90c651b72d456;
...
contract KeysWithPlonkVerifierOld is VerifierWithDeserializeOld {
    ...
    function getVkExit() internal pure returns(VerificationKeyOld memory vk) {
        ...
        vk.selector_commitments[0] = PairingsBn254.new_g1(
            0x2e3b2c0c396044657d2ef54dbce1bed4623cadac1505de4a9e297ecf5b3f82bd,
            0x1d88caf1503d84f95d10c9f0fac9ef893389a3a6388ab96dd9c57cb4852041ee
        );
        vk.selector_commitments[1] = PairingsBn254.new_g1(
            0x1a3ac781331b12c6a446eecf1eff9e6366f1265e816fffdd770603f086d3d6b8,
            0x048fd54712aa674ea78112ed78ec9574933d53f6e3ef2130ecba94df8541e2cd
        );
        vk.selector_commitments[2] = PairingsBn254.new_g1(
            0x19062de0eb8807533116c240e1406c02afd66cffc42c84d9b86058fdf36a4a79,
            0x0898877b0083b1807a3a739efa5139b78b370c86ffd89b3dd4a308a1bc41907a
        );
        vk.selector_commitments[3] = PairingsBn254.new_g1(
            0x290a0b23761ffea4fe9fe33e682b9f1b16e6b27e72c9212382ee9ea911024de3,
            0x2f6b928badc05f0ed92981df971729153eada5ee38700e963c6bc55992fcd783
        );
        vk.selector_commitments[4] = PairingsBn254.new_g1(
            0x295793578a57a10f3797f271ba59693793579e16a424fd366567e548dd2b37aa,
            0x297aa75b26c4f57678e1d7cf51a11150f725d8bc87d36717bc9b30f5fb1c1eff
        );
        vk.selector_commitments[5] = PairingsBn254.new_g1(
            0x032b4502713935600cb45cfbe8218e55d88d90d3ba20b01e086865334dbb4bc8,
            0x0876ebe157a84de27c19266f27c9018323431a1c4e1a387237e0331cf72c6e52
        );
        ...
        vk.next_step_selector_commitments[0] = PairingsBn254.new_g1(
            0x021bae2d9c17df9ed61a9394cf669e3449b7413e4c1626d9d5ab93993bb17782,
            0x0a00a514ad36677e9fc9acb5d88fa6c6c543a099d3ac0ce193b6986a90399f15
        );

        vk.permutation_commitments[0] = PairingsBn254.new_g1(
            0x0e639435948b6a404c280bd12dd469fc24b1241028e0166c6a4aff24107cd8ac,
            0x0bdf1c65a1cc45292a5c504aa2bc25461b917788eb1e2b7449cc479d8e4621ee
        );
        vk.permutation_commitments[1] = PairingsBn254.new_g1(
            0x23bb5fccb50aa90dee47717f26cfb4527d038f1b9fe319daeeb0d1c3761196cb,
            0x2789c674e84c9be73d03331141edb3ad8f3f134583b8cfc0b503a91ae82cb840
        );
        vk.permutation_commitments[2] = PairingsBn254.new_g1(
            0x19f77f95c089a3e588dc099967a627de9c9f74f839a5ba05278fe649b7d6fb10,
            0x035c9e345aaf21c3eccbb25ff39bef0cbb1aac9991a6624eb17de0bbe782f690
        );
        vk.permutation_commitments[3] = PairingsBn254.new_g1(
            0x2033480cb7062832a3bab87ab0b3016fa5d5756e9902e9623414551c78cf3430,
            0x1d554a8086d6913107be01d0b21c42b5fd1d167f40a742d146023699a7faeff4
        );
