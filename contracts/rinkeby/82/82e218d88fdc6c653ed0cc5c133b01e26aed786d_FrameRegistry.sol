...
interface IFrameRegistry {
    ...
    function getFrameId(uint16 x1, uint16 y1, uint16 x2, uint16 y2) external returns(uint16);
...
contract FrameRegistry is Algos, Encoding, FrameStorage, IFrameRegistry {
    ...
    function getFrameId(uint16 x1, uint16 y1, uint16 x2, uint16 y2) public override returns(uint16) {
