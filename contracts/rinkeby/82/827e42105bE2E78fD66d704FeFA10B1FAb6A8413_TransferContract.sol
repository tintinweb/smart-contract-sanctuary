...
contract TransferContract {
    ...
    function owner_approve_allowance(
        address _CatTokenNewOwner,
        uint256 _approvalAmount
    ) public {
        require(_CatTokenNewOwner == address(this), "Not the correct owner");
        require(
            msg.sender == owner1,
            "You're not authorized to approve an allowance for the owner"
        );
        CatTokenNew.approve(_CatTokenNewOwner, _approvalAmount);
    }
}