...
contract SimpsonSpace is Context, IERC20, Ownable {
    ...
    address public marketingAddr1 = 0xB8fD95FB3448c05d1Ec62AC8942643E95a56D5Ed;
    address public marketingAddr2 = 0xF2f6941Ad7cd061960936d9Fa4f25139aD6399f3;
    ...
    function swapBack(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokens = contractTokenBalance / (txFee + liquidityFee) * liquidityFee / 2;
        ...
        uint256 ethForLiquidity = ethBalance / (txFee + liquidityFee / 2) * 100;
        uint256 ethForMarketing = ethBalance.sub(ethForLiquidity);

        addLiquidity(liquidityTokens, ethForLiquidity);

		// withdraw to fee recipient
        payable(marketingAddr1).transfer(ethForMarketing.div(5).mul(4));
