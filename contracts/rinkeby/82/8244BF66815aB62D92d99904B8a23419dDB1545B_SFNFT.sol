    ...
    ERC721Pausable
{
    ...
    function setBaseURI(string calldata baseTokenURI_) public onlyRole(MINTER_ROLE) {
    ...
    /**
     *  Explicit call to ERC721URIStorage._setTokenURI().
     */
    ...
    function mint(address to_, string calldata tokenURI_) external onlyRole(MINTER_ROLE) {
        _safeMint(to_, _tokenIdTracker.current());
        ERC721URIStorage._setTokenURI(_tokenIdTracker.current(), tokenURI_);
