...
/**
 * @title NftyStar
 * NftyStar - a contract for my non-fungible NftyStars.
 */
contract NftyStar is ERC721Tradable {
    using SafeMath for uint256;

    constructor(address _proxyRegistryAddress)
        ERC721Tradable("NftyStar", "OSC", _proxyRegistryAddress)
    {
        setBaseTokenURI("http://intermeco.de/nft/nfty-stars/api/star/");
        setContractURI("http://intermeco.de/nft/nfty-stars/contract");
    }
...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    /**
     * @dev Mints a number of tokens to the msg.sender.
