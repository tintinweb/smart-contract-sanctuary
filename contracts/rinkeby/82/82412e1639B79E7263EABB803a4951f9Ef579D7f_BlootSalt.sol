...
contract BlootSalt is ERC721Enumerable, ReentrancyGuard, Ownable {
    //Loot Contract
    address public lootAddress = 0xDA5beF32Ee6173a35Dcd1A08c6F43E9c9F2FD00c;
    address public doggAddress =
    0x291eEd8cc9fC64291Cd2a7563BCb7A2477481E13;
    ...
    bool private blootMintToggle = false;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[3] = toggle == true ? getBreed(tokenId) : getTag(tokenId);
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Salt #',
                        toString(tokenId),
                        '", "description": "Bloot Salt is one of the first free-mint NFTs that has immediate real-world utility. If you ever sees someone being salty on the internet, just pull out your Bloot Salt! Every Bloost Salt is randomly generated and stored on chain. Images and other functionality are intentionally omitted for others to interpret. Feel free to use Bloot Salt in any way you want.", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("Bloot Salt", "SALT") Ownable() {}
}
