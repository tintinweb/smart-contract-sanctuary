...
contract LFTNFT is ERC721, ERC721Enumerable, Ownable {

    uint256 internal _price; // = 0.05 ether;
    uint256 internal _reserved; // = 10;

    uint256 public MAX_SUPPLY; // = 2019;
    ...
    constructor() ERC721("LFT NFT", "LFT") {
        ...
        baseURI = "ipfs://QmTgWU2y81i3Y9ryPTcNvxjJwrnt1BDbedr8Fi3d5GFsgM/";
    }
    ...
    function mint(uint256 _nbTokens) external payable whenSaleStarted whenSaleAllowed(msg.sender) {
        ...
        require(_nbTokens * _price <= msg.value, "Not enough ETH sent!");
    ...
    // Helper to list all the LFTs of a wallet
