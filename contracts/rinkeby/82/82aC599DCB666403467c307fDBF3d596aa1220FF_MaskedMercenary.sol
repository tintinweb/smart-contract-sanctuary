...
contract MaskedMercenary is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Maske Mercenary", "MM") {
    setHiddenMetadataUri("ipfs://QmU1XdpMHkXU1nCbvmLeRenJzMGLvYPELXqwPAzG4cDWqJ/1.json");
  }
