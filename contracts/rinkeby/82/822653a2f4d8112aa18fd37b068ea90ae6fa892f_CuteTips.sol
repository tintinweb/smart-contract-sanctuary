...
contract CuteTips is ERC721, Ownable {
	...
	uint public amountAvailableFreeMint = 5;
    ...
    constructor(address payable shareholderAddress_) ERC721("Cute Tips", "TIPS") {
