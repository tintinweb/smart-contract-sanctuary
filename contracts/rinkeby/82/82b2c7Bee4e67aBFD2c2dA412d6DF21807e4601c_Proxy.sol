...
contract Proxy is OwnableUpgradeable, Storage {

    // admin to set USDT contract, REToken contract, Logic contract
    function setUSDTContract(address _c) public onlyOwner returns (bool success){
        usdt_contract = _c;
        usdtContract = USDT(usdt_contract);
        return true;
    }

    function setRETokenContract(address _c) public onlyOwner returns (bool success){
        retoken_contract = _c;
        return true;
    }
    ...
    fallback () external payable {
        ...
        assembly {
            ...
            // (4) forward returned data back to caller
            switch result
...
contract Storage {
    ...
    USDT usdtContract;
    address public retoken_contract;
