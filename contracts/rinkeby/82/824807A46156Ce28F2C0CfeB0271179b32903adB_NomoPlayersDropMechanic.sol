...
contract NomoPlayersDropMechanic is ReentrancyGuard {
    ...
    /**
     * @notice 
     * Distributes the requested quantity by the user and transfers the respective ETH value
     * to DAO wallet address and Strategy contract address.
     
     * @dev Buyer sends particular value in ETH and request quantity.
     ...
     * NomoPlayersDropMechanic transfers 20% of the funds to DAO wallet address and 80% to Strategy contract address.
     *
