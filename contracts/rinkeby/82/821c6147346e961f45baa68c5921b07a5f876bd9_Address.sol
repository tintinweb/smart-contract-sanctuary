...
contract WNGMI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000 * 10**1 * 10**6;
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**1 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 300000000 * 10**1 * 10**6;
