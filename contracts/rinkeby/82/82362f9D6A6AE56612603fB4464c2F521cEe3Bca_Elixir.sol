...
contract Elixir is ERC721, ERC721Burnable, AccessControl  {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory name = string(abi.encodePacked(certificateType, ' Elxir Certificate #',toString(certificates[tokenId].nr)));
        string memory description = "Elixir NFT Certificate";
    ...
    function generateImage(uint256 tokenId) public view returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                paletteSection,
                skyscraper,
                '<text x="215" y="80" class="small">ELIXIR</text>',
                '<text x="15" y="120" class="medium">CHYME:</text>',
                '<rect x="15" y="125" width="205" height="40" style="fill:white;opacity:0.5"/>',
                '<text x="15" y="190" class="small">POOL ID:</text>',
    ...
    function generatePaletteSection(uint256 tokenId, uint256 pIndex) internal view returns (string memory) {
        return string(abi.encodePacked(
                ...
                '<text x="15" y="25" class="medium">STEADY CERTIFICATE</text>',
