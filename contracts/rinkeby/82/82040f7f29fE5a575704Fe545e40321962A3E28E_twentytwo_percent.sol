...
contract twentytwo_percent is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAXHUMANS = 40;
    uint256 public reservedHumans = 15;
    uint256 public maxHumansPurchase = 10;
    ...
    constructor(string memory baseURI) ERC721("22PERCENT", "22PERCENT") {
        ...
        isSaleActive = false;
        tokenCounter = 0;
        // First 20 Humans for Giveaways saved in owner wallet 
