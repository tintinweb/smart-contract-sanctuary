...
contract CorruptionsBookOfElysium is ERC721, ERC721Metadata, ReentrancyGuard, Ownable {
    ...
    uint256 public constant _maxPrintsPerChapter = 64;
    ...
    // Stored renderers:
    // 0 is default and subject to change
    // 1+ is user selectable preset
    ...
    function escapeHatch() public payable onlyOwner {
        address multisig = 0x4fFFFF3eD1E82057dffEe66b4aa4057466E24a38;
        require(payable(multisig).send(address(this).balance - elysiumBalance));
    }
