...
contract WickedWristers is ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_WRISTERS_PRESALE = 210;                          // max wristers possible for presale
    ...
    uint256 public maxWristerMintable  = 2;                             // max wristers allowed to be mint per wallet

    uint256 public constant maxAdminMintable = 10;                      // max wristers allowed to mint during admin mint
    ...
    address t4 = 0xAd7E3bC36a5750B4bEe28022519F948399655846; // bdubs
    ...
    constructor() ERC721("wristers", "ww") {
    }
    ...
    function setmaxWristersMintable(uint256 newmaxWristerMintable) public onlyOwner{
        maxWristerMintable = newmaxWristerMintable;
    }
    ...
    function mintPresale(uint256 numberOfTokens) public payable {
        ...
        require(_totalClaimed[msg.sender].add(numberOfTokens) <= maxWristerMintable, "Purchase exceeds max allowed per wallet of 2");
    ...
    function mintAdmin(uint numberOfTokens) public {
        require(totalSupply() < MAX_WRISTERS_ADMIN, "All tokens have been minted for the Admin");
