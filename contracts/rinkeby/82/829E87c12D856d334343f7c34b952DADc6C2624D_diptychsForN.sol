...
contract diptychsForN is NPassCore {

    string public baseTokenURI;

    constructor(address _nContractAddress, string memory _newBaseURI)
    NPassCore(
        "diptychs for n",
        "DIPN",
    ...
    function setOnlyNHolders(bool _onlyNHolders) public onlyOwner {
        onlyNHolders = _onlyNHolders;
    }
