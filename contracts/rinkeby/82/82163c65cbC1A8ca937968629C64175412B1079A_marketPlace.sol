...
contract marketPlace {
    address private nftAddress = 0xcE016D273CFc1AD01F52adE439F6c73Fc8B4069d;
    ...
    function buyNFT(uint256 _tokenId) external {
        ...
        MyToken(erc20Address).transferFrom(msg.sender, MyNFT(nftAddress).ownerOf(_tokenId), sellPrice[_tokenId]);
        address NFTowner= MyNFT(nftAddress).ownerOf(_tokenId);
        MyNFT(nftAddress).transferFrom(NFTowner, msg.sender, _tokenId);
