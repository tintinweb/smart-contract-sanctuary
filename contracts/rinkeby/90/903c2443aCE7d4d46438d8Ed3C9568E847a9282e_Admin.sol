...
// File: contracts/destroyeNFTcontracrt3.sol
...
contract Admin is Ownable {
  ...
  function CreatNewNft(address user,  string memory _uri, string memory walletAddress, bool KYC_verified, string memory publicid ,string memory blockchain,address verifiedby ) public onlyOwner
    {
         NFT A = new NFT(owner(), user, _uri, walletAddress, KYC_verified, publicid,blockchain,verifiedby);
...
contract NFT is NFTokenMetadata {
    ...
    constructor (
        address _owner, address _user, string memory _uri, string memory _walletAddress, bool _KYC_verified, string memory _publicid,string memory _blockchain,address _verifiedby
        ) public {
         owner = _owner;
         nftName = "Simple NFT";
         nftSymbol = "NFT5";
