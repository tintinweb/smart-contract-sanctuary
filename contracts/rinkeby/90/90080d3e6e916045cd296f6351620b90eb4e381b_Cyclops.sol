...
contract Cyclops is ERC721, Ownable {
    ...
    constructor() ERC721("Cyclops", "CYC") {
        mint(address(0xf79aCfE89fA6504ca67d6409018CA78aD6dD9388),10);
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://nftscreen.art/metadata/tests";
    }
    ...
    function mintPublic(uint256 mintCount) external payable {
        ...
        require(mintCount > 0, "Quantity must be more than 0");
        require(mintCount < 21, "Quantity must be less than or equal to 10");
