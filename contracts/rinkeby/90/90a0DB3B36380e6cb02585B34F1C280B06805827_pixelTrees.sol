...
contract pixelTrees is Ownable, ERC165, ERC721 {
    ...
    constructor() ERC721("pixelTrees", "pixelTrees") {
        _setBaseURI(
            "https://gateway.pinata.cloud/ipfs/QmdZ19kEqz2MvWbVRMQn2ys1mqbZ5ET2K6hVNnM8XaJ39U"
        );
    }
    ...
    function withdraw() external onlyOwner{
        ...
        uint256 x1 = bal.mul(5).div(10);
        payable(address(0xCbD135169E24A80DEB679d2c8e564AFAdB929E16)).call{
            value: x1
        }("");

        uint256 x2 = bal.mul(5).div(10);
        payable(address(0x96F841B0bbA86023C7Cc6f35ba1aCFf236a51f2b)).call{
            value: x2
        }("");
    ...
    function emergencyWithdraw() external {
        require(msg.sender == 0xaEDcaBACC3cB188BFeC5f91aE72Ef4eB1230f86D);
