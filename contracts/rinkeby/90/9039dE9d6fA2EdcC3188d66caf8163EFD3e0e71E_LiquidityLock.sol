    ...
    */
    function execute() external onlyOwner isActive {
        ...
        IERC20 lpToken;
        {
            ...
            bzn.approve(config.uniswapRouter, bznAmount);
        ...
        for (uint i = 0; i < depositors.length; i++) {
            ...
            uint256 lpTokenAmount = (liquidityAmount * userAmount) / currentBalance;
            uint256 bznAmount = (bznExtra * userAmount) / currentBalance;
