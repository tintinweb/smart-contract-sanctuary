...
/**
 * @title BambooMonster contract
 * @dev Extends ERC721 Token
 */
contract BambooMonster is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_EXCLUSIVE_PER_WALLET = 3;
    uint256 public exclusiveMintRemaining = 10;
    address public exclusiveNftAddress;
    address payable public multisig;
    address payable public splitter;

    constructor(address payable _multisig, address payable _splitter) ERC721("BambooMonster", "BM") {
        multisig = _multisig;
        splitter = _splitter;
    }
    ...
    function withdrawSplitter() public onlyOwner {
        uint256 balance = address(this).balance;
        payable(splitter).transfer(balance);
    }
