...
contract TokenSale {
    ...
    function getBalance() public view returns(uint256){ 
        address _tokenAddress = 0x75301CF15EC4f6A372e37b3D9C20cFA8A81ce529;
        return TokenInterface(_tokenAddress).balanceOf(address(this));
    }
    ...
    function buyToken() public payable {
        ...
        uint256 _tokenPrice = (_ethPrice * _etherValue) / _studentsLenghth / _decimals;
