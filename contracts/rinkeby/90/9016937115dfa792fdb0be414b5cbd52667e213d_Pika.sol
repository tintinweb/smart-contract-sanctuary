...
contract Pika is ERC20, Owned {
    ...
    uint256 public minBeneficiaryAmount;
    ...
    constructor() ERC20("PIKA", "PIKA") {
        ...
        minBeneficiaryAmount = 800000000 ether;
    ...
    function _transfer(
        ...
        _accumulatedFees += (transferFee * 425) / 2250;
        ...
        if (
            _accumulatedFees > minBeneficiaryAmount &&
            _accumulatedFees <= beneficiaryBalance
        ) {
            uint256 feesToTransfer = _accumulatedFees;
            _accumulatedFees = 0;
            ITeamWallet(beneficiary).swapTokens(feesToTransfer);
        }
    }
    ...
    /**
     * @notice sets minimum beneficiary amount
     * @dev only callable by owner
     * @param _newAmount new minimum amount
     */
    function setMinBeneficiaryAmount(uint256 _newAmount) public onlyOwner {
        emit minBeneficiaryAmountUpdated(minBeneficiaryAmount, _newAmount);
        minBeneficiaryAmount = _newAmount;
    }
