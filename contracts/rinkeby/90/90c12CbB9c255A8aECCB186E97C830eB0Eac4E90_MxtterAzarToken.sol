...
contract MxtterAzarToken is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    function presaleMint(bytes32[] calldata proof) public payable {
        ...
        require(!presaleClaimed[msg.sender], "Already Claimed");
        require(
            MerkleProof.verify(
                proof,
                root,
    ...
    // @dev Returns if an address has minted in the presale
    // @param _address Address to check
    function hasMintedPresale(address _address) external view returns (bool) {
