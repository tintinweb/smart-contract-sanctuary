...
contract YourContractName is ERC721, Ownable {
    ...
    constructor() ERC721("NameOfProject", "SymbolOfProject") {
        //  Max amount of tokens
        maxAmntTokens = 5000;
    ...
    //  Base URI function, this won't be callable, you will use the above function instead
    ...
    function mintNFT(uint256 amountTokens) public payable {
        ...
        //  Requires that the amount of tokens already minted don't surpass the available tokens
