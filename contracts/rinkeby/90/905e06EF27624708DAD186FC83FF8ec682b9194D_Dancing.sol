...
contract Dancing is ERC721, Ownable {
    ...
    function setRegularSale() external onlyOwner {
    ...
    function whitelistBuy(uint256 _numberOfPasses) public payable {
        ...
        require(
            _tokenIdCounter.current().add(_numberOfPasses) <=
                whiteListMintMaxSupply,
            "ATTEMPTED TO MINT PAST WHITELIST MAX SUPPLY"
        );
        require(
    ...
    function reserve() public onlyOwner {
        require(reserveTokens == false, "tokens already reserved");
