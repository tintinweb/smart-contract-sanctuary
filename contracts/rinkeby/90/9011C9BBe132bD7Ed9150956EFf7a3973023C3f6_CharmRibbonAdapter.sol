...
// File: CharmRibbonAdapter.sol

contract CharmRibbonAdapter is Ownable {
    using Address for address;
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
     ...
     */
    function getMarket(address underlying, uint256 expiry, bool isPut) external returns (OptionMarket) {
    ...
    function getOption(OptionMarket market, uint256 strikePrice, bool isLong) external returns (OptionToken) {
