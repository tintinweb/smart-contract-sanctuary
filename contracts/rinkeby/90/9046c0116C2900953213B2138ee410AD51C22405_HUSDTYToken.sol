...
contract HUSDTYToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "HUSDTY";
    string  public constant symbol = "HUSDTY";
    ...
    uint256 public tokenExchangeRate = 625;             // 625 HUSDTY 兑换 1 ETH
