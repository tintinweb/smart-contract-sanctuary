...
contract Psyborg is ERC721Creator {
    constructor() ERC721Creator("Psyborg.gallery", "PSYGAL") {}
}
...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.4.0/contracts/token/ERC721/extensions/ERC721Burnable.sol";
...
contract ERC721Creator is ERC721, ERC721URIStorage, ERC721Burnable, Mintable {
    ...
    */
    ...
    function setRoyaltyBips(uint256 percentageRoyalty_) external onlyOwner {
        require(percentageRoyalty_ <= _percentageTotal, "ERC721Creator: Illegal argument more than 100%");
    ...
    */
     ...
     * Only allowed for adresses that have the minter role AND are the creator of the token.
     */
    function updateTokenURI(uint256 tokenID, string memory _tokenURI) external onlyMinter{
        require(bytes(_tokenURI).length != 0, "ERC721Creator: Missing tokenURI");
        require(exists(tokenID),"ERC721Creator: Token does not exists.");
        require(msg.sender==tokenCreator(tokenID) || msg.sender==owner(),"ERC721Creator: Not your Own Token");
