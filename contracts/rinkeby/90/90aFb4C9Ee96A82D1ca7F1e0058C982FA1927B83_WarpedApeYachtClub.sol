...
//    mapping(uint256 => uint256) public tokenSupply;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseNftUri, string memory _uri, address _proxyRegistryAddress) ERC1155(_uri){
        name = _name;
        symbol = _symbol;
...
contract AuthorizedList is Ownable
{
    ...
    function authorizeCaller(address authAddress, bool shouldAuthorize) external virtual onlyOwner {
