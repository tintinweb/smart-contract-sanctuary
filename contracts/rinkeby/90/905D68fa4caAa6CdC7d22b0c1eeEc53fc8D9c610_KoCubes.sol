...
contract KoCubes is iKoCubes, ERC721Burnable, Ownable {
    using Strings for uint256;

    bool private _isOnSale;
    string private baseURI;
    uint256 private constant _maxSupply = 5;
    ...
    constructor(string memory initialBaseURI) ERC721("KoCubes", "KoCubes") {
    ...
    function buy(uint256 amount) external payable override {
        ...
        require(nextTokenId + amount <= _maxSupply, "No remaining tokens");
