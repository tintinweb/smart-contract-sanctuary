...
contract AvarikSaga is EIP712, ERC721Enumerable, Ownable {
    ...
    function buy(uint256 tokenQuantity, uint256 maxCount, bytes memory signature) external payable {
        ...
        require(salerListPurchases[msg.sender] + tokenQuantity <= maxCount, "You can not mint exceeds maximum NFT");
