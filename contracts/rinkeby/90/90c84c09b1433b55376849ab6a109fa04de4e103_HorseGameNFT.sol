...
// File: HorseGameNFT.sol

pragma solidity ^0.8.0;

contract HorseGameNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public price = 57000000000000000; //0.057 Ether
    string baseTokenURI;
    ...
    constructor(string memory baseURI) ERC721("Temp Name Hrse", "TMPHRSE") {
        setBaseURI(baseURI);
    }
