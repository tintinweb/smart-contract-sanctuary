    ...
    BlockTimestamp
{
    ...
    address internal constant ULM_STATE = 0xd2052684C2eca004c6B501852CF85114262fc8C8;
    ...
    function withdraw(
        ...
        (uint256 amount0Removed, uint256 amount1Removed) = _removeLiquidityWithFees(
            false,
            position.pool,
            liquidity
        );
    ...
    function collect(
        ...
        (uint256 indexAmount0, uint256 indexAmount1) = _distributeFeesAndLiquidity(
            DistributeFeesParams({
                pilotToken: pilotToken,
                wethToken: wethToken,
                pool: position.pool,
    ...
    function _removeLiquidityWithFees(bool isRebase, address pool, uint256 liquidity)
        private
