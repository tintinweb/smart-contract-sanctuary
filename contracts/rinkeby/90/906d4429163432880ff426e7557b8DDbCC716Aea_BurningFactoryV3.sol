...
import "./BurningV3.sol";

/**
 * BurningFactoryV3 is the contract for management of ZUSD/GYEN.
 * Create Burning Contract with create2.
 */
contract BurningFactoryV3 {
    ...
    function burn(bytes32 _salt, bytes memory _bytecode) public onlyBurner {

        assembly {
            let codeSize := mload(_bytecode)
            let newAddr := create2(
                0,
                add(_bytecode, 32),
                codeSize,
    ...
    function predictBurningAddress(bytes32 _salt, bytes32 _bytecodeHash) public view returns(address){
...
import "./BurningFactoryV3.sol";
import "./Token_v2.sol";

/**
 * BurningV3 is the contract for management of ZUSD/GYEN.
 */
contract BurningV3 {

    constructor(address _tokenAddress, address _recipient, uint256 _amount) public {
