...
/**
 * @title ChubbyApe
 * ChubbyApe - a contract for non-fungible Chubby Ape.
 */
contract ChubbyApe is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Chubby Ape", "CAP", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "http://www.thesubpro.com/subproadmin/chubbyape/metadata";
    }
