...
contract CyBlocGeneScientist {
    ...
    function decode(uint256 _genes) public view returns(uint256 class, uint256 trait, uint8[] memory classs, uint8[] memory traits) {
        ...
        return (class, trait, classs, traits);
    }
