...
contract SassySucculent is ERC721, Ownable {

    string public SUCCULENT_PROVENANCE = "";

    uint256 public constant MAX_TOKENS = 6000;
    
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 20;

    uint256 public constant price = 25000000000000000; // 0.025 Ether

    bool public isSaleActive = false;

    uint public reserve = 125;
    
    mapping(uint => string) public succulentNames;
    


    constructor() ERC721("Sassy Succulents", "SCLNT") payable {}

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
       SUCCULENT_PROVENANCE = _provenanceHash;
    }
    ...
    function mintSucculent(uint256 _count) public payable {
        ...
        require(totalSupply + _count < MAX_TOKENS + 1, "Exceeds available succulents");
