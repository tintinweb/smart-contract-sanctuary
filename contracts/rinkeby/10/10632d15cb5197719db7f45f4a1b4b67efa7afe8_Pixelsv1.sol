...
import "@openzeppelin/[email protected].2/utils/math/SafeMath.sol";
...
contract Pixelsv1 is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function getBackgroundColor(uint256 tokenId) internal view returns (string memory) {
        return "CDD000";
    }

    // Get Your Color

    function getYourColor(uint256 tokenId) internal view returns (string memory) {
        return "FA0D5f";
    }

    function getMyColor(uint256 tokenId) internal view returns (string memory) {
        return "CA035f";
    }
    ...
    function makeAttributes(uint256 tokenId) public view returns (string memory) {
        ...
        traits[0] = string(abi.encodePacked('{"trait_type":"you: #","value":"', getYourColor(tokenId), '"}'));
        traits[1] = string(abi.encodePacked('{"trait_type":"me: #","value":"', getMyColor(tokenId), '"}'));
        traits[2] = string(abi.encodePacked('{"trait_type":"us #:","value":"', getBackgroundColor(tokenId), '"}'));
