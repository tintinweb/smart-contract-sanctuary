...
contract Abominations is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant LIMIT_PUBLIC = 15;
    uint256 public constant LIMIT_OWNER = 10;
    ...
    constructor() ERC721("Abominations Beta", "ABOMB") {}
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Abomination #',
                        tokenId.toString(),
                        '", "description": "On-chain, randomly generated abominations for whatever fiendish uses your mad mind can concoct.", "image": "data:image/svg+xml;base64,',
