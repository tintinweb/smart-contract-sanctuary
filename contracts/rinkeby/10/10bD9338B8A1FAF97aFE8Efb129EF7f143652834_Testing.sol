...
contract Testing is ERC721Enumerable, Ownable {
    ...
    address private wallet = 0xf2A9c0e9B455A5CE22A81B3a41461439096C6C87;
...
/*
    function freeMint(uint256 count) public {
        uint256 totalSupply = _owners.length;
        require(count < MAX_TX, "Exceeds max transaction.");
        require(totalSupply + count < free, "Exceeds free supply");
    ...
    function mint(uint256 count) public payable {
        uint256 totalSupply = _owners.length;
        require(totalSupply >= free, "Can not mint before free mint stage.");
