...
contract Borpi is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
  ...
  uint public raffleSaleIndex;
    ...
    uint256 private constant nftsNumber = 1725;
    uint256 private constant nftsPublicNumber = 1750;
  ...
  function borpacassoBalance(address owner) public view virtual returns(uint256) {
        Borpacasso sd = Borpacasso(0xd9145CCE52D386f254917e481eB44e9943F39138); 
...
function allotmentScaleOf(uint a) private pure returns(uint b){
  ...
  function buyWhitelistBorp(uint tokensNumber) public payable {
   ...
   require(claimed[msg.sender].add(tokensNumber) <= allotmentScaleOf(borpacassoBalance(msg.sender)), "You're not holding enough borpacassos to claim the rest of your allotment");
