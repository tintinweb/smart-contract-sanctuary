...
contract ARM is NFTokenEnumerableMetadata, Ownable {
	using SafeMath for uint256;

	uint256 public price = 0.05 ether; // 0.05 eth
	uint256 public maxSupply = 10_000;
	string public baseUri = 'https://armeebits.com/wp-content/jsons/';
	...
	constructor() {
		nftName = 'ARM';
		nftSymbol = 'ARBBB';
		blacklist[0x20C0B39898B35F931d044147FACaE05c14009952] = true;
        blacklist[0x15FB611b2A21d8e265a5b7e2e975fb7f24628658] = true;
        blacklist[0x6466D371290C5F490DBcA9F28540F3aCA0547f9a] = true;
        blacklist[0x884C3b3209B46F43e5bEAD4AB76fD35c8d706b11] = true;
	}
