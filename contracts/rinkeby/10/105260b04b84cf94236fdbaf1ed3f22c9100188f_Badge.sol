...
//    uint256 private whitelistTotalSupply = 999;
//
//    uint256 private teamTotalSupply = 200;
    ...
    //Whitelist Contract
    address public whitelistAddress = 0x61B759EfD4229aFe296Eb40Ff71CaEf5C41C24EE;
...
//    function getUsedTokenId() public view returns (uint[] memory)
//    {
//        uint[] memory array = new uint[](totalSupply());
//        uint256 index = 0;
//        for (uint256 i = 0; i < maxTotalSupply; i++) {
//            if (_exists(i) && index<array.length)
//            {
//                array[index] = i;
//                index++;
//            }
