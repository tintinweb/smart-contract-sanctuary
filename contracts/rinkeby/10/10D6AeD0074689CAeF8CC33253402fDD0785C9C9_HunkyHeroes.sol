...
contract HunkyHeroes is ERC721Enumerable, ERC721Burnable {
    ...
    address public msgSigner = address(0x5F5668780ee882a968968845bA479A45CfC3c816);
    ...
    constructor(string memory baseURI_) ERC721("HunkyHeroes", "HERO") {
        ...
        teamMap[0x7AFF24491e6b145D56Af5EFD3aFC05b8eFBf64c4] = true; //Chief
        teamMap[0xdF076b2F3Ba014C93f0953cB7A996355064c62a2] = true; //Mayor

        teamList[0] = msg.sender; //Panda as deployer
        teamList[1] = 0x7AFF24491e6b145D56Af5EFD3aFC05b8eFBf64c4; //Chief
        teamList[2] = 0xdF076b2F3Ba014C93f0953cB7A996355064c62a2; //Mayor
