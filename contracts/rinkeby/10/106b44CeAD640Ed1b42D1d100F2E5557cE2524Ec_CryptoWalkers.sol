  ...
  ReentrancyGuard
{
  ...
  uint256 public constant MAX_WALKERS = 10000;
  uint256 public constant MAX_MINT = 10;
  uint256 public constant RESERVED_WALKERS = 500;
  ...
  constructor() ERC721("CryptoWalkers", "Walkers") {
    ...
    _whitelistDetails[0].whitelistType = "Infected Walker & Metakey";
    _whitelistDetails[0].amountToMint = 1;
    _whitelistDetails[1].whitelistType = "Netvrk Land Owner";
    _whitelistDetails[1].amountToMint = 2;
    _whitelistDetails[2].whitelistType = "Whitewalker";
    _whitelistDetails[2].amountToMint = 3;
    _whitelistDetails[3].whitelistType = "Zombie";
    _whitelistDetails[3].amountToMint = 4;
    _whitelistDetails[4].whitelistType = "Mutant";
    _whitelistDetails[4].amountToMint = 5;
  }
  ...
  function mintReserve(address reserveAddress, uint256 amountToReserve) public onlyOwner {
    ...
    require(_amountReserved.add(amountToReserve) <= RESERVED_WALKERS, "Reserving too many walkers");
    if (totalSupply() == 0){
    ...
    if (_amountReserved == RESERVED_WALKERS) {
