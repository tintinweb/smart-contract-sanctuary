...
contract TestLoot is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public immutable pricePerNomad;
    uint256 public immutable maxPerTx;
    uint256 public immutable maxNomad;
    ...
    constructor() public ERC721("Modern Nomad", "NOMAD") {
        pricePerNomad = 0.09 * 10**18;
        maxPerTx = 20;
        maxNomad = 10000;
    }
    ...
    function reserveKILLAz(uint256 number) public onlyOwner {
    ...
    function mintNomad(uint256 numberOfTokens) public payable {
        ...
        require(
            totalSupply().add(numberOfTokens) <= maxNomad,
            "Purchase would exceed max supply of Nomads"
        );
        require(
            pricePerNomad.mul(numberOfTokens) == msg.value,
