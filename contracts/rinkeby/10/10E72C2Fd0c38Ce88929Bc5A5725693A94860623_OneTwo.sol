    ...
    Ownable
{
    ...
    string public baseTokenURI = "tryagain";
    ...
    function adoptFree() external {
        ...
        require(_currentTokenId < 666, "sorry all freebies have been claimed.");
    ...
    function adoptMultiples(uint amountToAdopt) external payable {
