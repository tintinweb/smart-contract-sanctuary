...
ThreeOh Token
$OOO
Decimals? Starting ppt: .0000005
2.1T
Distribution:
Total Supply: 2.1T (TBD w/dev) 2,100,000,000,000
25% Private Sale
10% Public Presale
5% Team
60% Community
...
*/
contract ThreeOhToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2100000000000 * 10**9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ThreeOh Token";
    string private _symbol = "OOO";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2; // distribution 
    ...
    address  public MarketingAddress = 0x097F4838635fe0f166f24E28D4eDdf446301F5Fe; 
    address  public BuybackAddress = 0xc66d393b3122aB411E83ad0cb53bcEdE28d8601C; 
    address  public AdvocacyAddress = 0x39Ab2FDb799Cba478C5a22f61333ba34f5676c85;
    ...
    uint256 private numTokensSellToAddToLiquidity = 2100000000 * 10**9;
 ...
 //   function withdrawLPToken(uint256 _sid, uint256 _rate, uint256 _desirePrice, uint256 _slippage) external  {
  ...
  //  }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to burn Marketing and Buyback wallets
        ...
        _transferStandard(sender, BuybackAddress, fundingPiece.mul(3));
        _transferStandard(sender, AdvocacyAddress, fundingPiece.mul(2));       
    ...
    function setAdvocacyAddress(address newWallet) external onlyOwner() {
        emit FeeEvent(newWallet); 
        AdvocacyAddress = newWallet;
    }
