...
// test RandomlyAssigned

contract GeomTest is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://storage.googleapis.com/geometricguy/";

  constructor() 
    ERC721("geometric guy", "GEO")
    RandomlyAssigned(50,1) 
    {
       for (uint256 a = 1; a <= 15; a++) {
            mint();
        }
    }
