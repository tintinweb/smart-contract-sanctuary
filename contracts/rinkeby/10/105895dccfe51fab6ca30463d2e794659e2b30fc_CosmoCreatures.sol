...
contract CosmoCreatures is ERC721, Ownable {
  ...
  // TODO: UPDATE
  address payable public immutable creatorAddress = payable(0x1E357417F2aE132D80BC528A8e14AEfEd6C9e467);
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require (presaleIsActive || saleIsActive, "All sales inactive");
    if (presaleIsActive) { 
      // VERIFY USER ON WHITELIST
  ...
  function withdraw() public onlyOwner {
        ...
        Address.sendValue(creatorAddress, balance.mul(95).div(10));
        Address.sendValue(devAddress, balance.mul(5).div(10));
    }
