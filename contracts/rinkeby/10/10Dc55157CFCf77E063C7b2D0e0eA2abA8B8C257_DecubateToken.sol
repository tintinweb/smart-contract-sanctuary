...
//** Decubate ERC20 Token */
//** Author Alex Hong : Decubate Crowfunding 2021.5 */

pragma solidity 0.6.6;

import "./interfaces/IDecubateERC20.sol";
import "./libraries/SafeMath.sol";

contract DecubateToken is IDecubateERC20 {
    using SafeMath for uint256;

    string public constant name = "Decubate Token";
