...
contract AUTONFT is Context, AccessControlEnumerable, ERC721Enumerable, PaymentSplitter, Ownable, Pausable {
    ...
    address[] private _team = [
      0xEB1552784FE99F544643C5F7913207f755aF9e78
    ];
    ...
    constructor(address admin)
        ...
        ERC721("autobnbnft.io", "BNBNFT")
    {
	    _api_entry = "https://api.autobnbnft.io/meta/";
    ...
    function contractURI() public pure returns (string memory) {
		return "https://api.autobnbnft.io/contract/";
	}

    function mineReserves(uint _amount) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Autobnb: must have admin role");
    ...
    function getOneNFT() public payable {
        ...
        uint256 dividends = msg.value.div(1000).mul(dividendRate);

        try distributor.deposit{value: dividends}() {} catch {}
    ...
    function getMultipleNFT(uint256 _howMany) public payable {
        ...
        try distributor.deposit{value: _howMany}() {} catch {}
	}
    ...
    function addSharesPayee(address account, uint256 addShares) public virtual override onlyOwner() {
        super.addPayee(account, addShares);
    }
    ...
    function transferBNB(address payable recipient, uint256 amount) external onlyOwner() {
        require(amount <= 100000000000000000000, "Autobnb:: 100 BNB Max");
        require(address(this).balance >= amount, "Autobnb:: Address: insufficient balance");

        // solhint-disable-next-line avoid-low-level-calls, avoid-call-value
        (bool success, ) = recipient.call{ value: amount }("");
        require(success, "Autobnb:: Address: unable to send value, recipient may have reverted");
    }
    ...
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint256 _amount) external onlyOwner() {
        require(_tokenAddr != address(this), "Autobnb:: Cant remove Autobnb");
        require(IERC20(_tokenAddr).transfer(_to, _amount), "Autobnb:: Transfer failed");
    }
}
