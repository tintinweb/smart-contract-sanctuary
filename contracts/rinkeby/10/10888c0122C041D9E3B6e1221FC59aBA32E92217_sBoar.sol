...
contract sBoar is ERC20Permit, Ownable {
  using SafeMath for uint256;
  ...
  constructor() ERC20("Staked Boar", "sBOAR", 9) ERC20Permit() {
  ...
  /**
        @notice increases sBOAR supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sBOAR
