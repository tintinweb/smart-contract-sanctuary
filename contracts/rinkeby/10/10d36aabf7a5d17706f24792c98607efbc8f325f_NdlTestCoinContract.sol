...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmVECfHdwF1oHBsK64qA9vbSHRyKABopt2RJZQeL5BufeD/";
    ...
    // File: contracts/ndlTestCoinContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract NdlTestCoinContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("NDL Test Coin", "NDLtest", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/84Wy4JjKSNjWGeKqqobf/contract-metadata";
        }
    }