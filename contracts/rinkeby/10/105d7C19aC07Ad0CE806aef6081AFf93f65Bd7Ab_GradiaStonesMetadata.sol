...
contract GradiaStonesMetadata is IGradiaStonesMetadata, Ownable {
    ...
    function setMainContract(address _address) public onlyOwner {
    ...
    function setSingleBatchURI(uint256 batchNumber, string memory uri) public onlyWhitelisted {
    ...
    function setAllBatchURI(string [] calldata batchBaseURI) public onlyWhitelisted {
    ...
    function createBatch(uint256 amount, string calldata batchBaseURI) external onlyWhitelisted {
        ...
        emit NewBatch(batches.length, batchBaseURI, lastId);
    }
}
