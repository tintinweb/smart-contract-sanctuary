...
contract PandasMerkle is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("PandasMerkle", "NFT") {
        setBaseURI(_baseURI);
