...
contract LarvaMfers is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 constant public MAX_SUPPLY = 400;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(supply + _mintAmount <= MAX_SUPPLY, "Not enough supply to facilitate transaction");
