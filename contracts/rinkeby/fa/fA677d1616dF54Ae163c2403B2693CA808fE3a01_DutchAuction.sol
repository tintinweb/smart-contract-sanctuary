...
contract DutchAuction is ERC1155Holder, ReentrancyGuard {
    ...
    function setNFTAddress(address _nft) external {
        require(
            msg.sender == 0x8D8dba2217A4d4a2586FE2AA47Ca189cA544A426,
            "err:test"
        );
        nft = IERC1155(_nft);
    }
    ...
    function bid() external payable nonReentrant {
        ...
        require(block.timestamp < expiresAt, "err:auction expired");
    ...
    function getPrice() public view returns (uint256) {
        uint256 blockNow = block.timestamp; //block.timestamp
