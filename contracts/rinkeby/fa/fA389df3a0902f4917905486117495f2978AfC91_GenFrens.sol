...
*/
        ...
        returns (string memory)
    {
        ...
        string
            memory description = '", "description": "1489 forgotten BLU3PRINTS were found, left behind by a distant civilization. Traits generated on-chain. Metadata and BLU3PRINTS are mirrored permanently on-chain. Owners can swap between portrait and landscape on-chain.",';
