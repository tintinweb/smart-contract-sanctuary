...
contract NFT is ERC721, EIP712Whitelist {
    ...
    function genesisPresale(bytes calldata signature)
        public
        payable
    ...
    function normalPresale(uint256 num, bytes calldata signature)
        public
        payable
        requiresWhitelist(signature)
        returns (uint256)
    {
        ...
        require( isPresaleActive, "Presale are not active");
        require( balanceOf(msg.sender) + num <= 2, "Only two mint allowed during presale");
