...
contract BenFTCollection is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    uint public presaleStart = 1636137132; // November 6th 9AM EST - CURRENT TIME FOR TESTING
    uint public presaleEnd = 1636138211;   // November 6th 12PM EST - CURRENT TIME FOR TESTING
    uint public publicSale = 1636138211;   // November 6th 12PM EST - CURRENT TIME FOR TESTING
        ...
        PaymentSplitter(team, team_shares)
    {
        ...
        // teamClaimNFTs
        accounts[admins[0]] = Account( 100, 0, 0, false, true); // 
        accounts[admins[1]] = Account( 25, 0, 0, false, false);
        accounts[admins[2]] = Account( 25, 0, 0, false, false);
        accounts[admins[3]] = Account( 13, 0, 0, false, false);
        accounts[admins[4]] = Account( 12, 0, 0, false, false);
        accounts[admins[4]] = Account( 0, 0, 0, false, true); // 
        accounts[admins[4]] = Account( 0, 0, 0, false, true); // 
