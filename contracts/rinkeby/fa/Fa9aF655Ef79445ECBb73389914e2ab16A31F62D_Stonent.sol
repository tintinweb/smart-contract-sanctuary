...
contract Stonent is ChainlinkClient, Ownable {
    ...
    constructor() public {
        ...
        // 2 links
        dev = msg.sender;
        paymentToken = 0x01BE23585060835E02B77ef475b0Cc51aA1e0709;  //todo set paymentToken to Oracle (not it is Rinkeby LINK)
    }

    /**
     * Initial request
     */
    function check(string memory _id, string memory _collection) public {
        ...
        req.add("contract_address", _collection);
        req.add("nft_id", _id);
        ...
        certificate.collection = _collection;
    ...
    function changeCollection(address _collection, bool _active) onlyOwner public {
        collections[_collection] = _active;
        if (_active) {
    ...
    // in normal states contract should not hold assets
