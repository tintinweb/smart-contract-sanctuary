...
contract Token {
    string public name = "Core Mining Network Token";
    string public symbol = "CMNT";
    uint256 public decimals = 18;
    uint256 public totalSupply = 1000000000000000000000000000;      // 1Billion tokens created
    
    mapping(address => uint256) public balanceOf;                   // track the address containing the tokens
