...
contract YokaiMasksEthereumBridgeTest4 is IERC721Receiver, Ownable, ReentrancyGuard {
    ...
    // Max supply of all masks
    uint256 public constant MAX_ETH_SUPPLY = 13;
    ...
    function mintEthMask(uint256 _numberOfMasks) public payable nonReentrant {
        ...
        for (uint256 i = 0; i < _numberOfMasks; i++) {
            ...
            IYokaiMasks(yokaiMasksContract).mintMaskFromBridge(msg.sender, mintIndex);
