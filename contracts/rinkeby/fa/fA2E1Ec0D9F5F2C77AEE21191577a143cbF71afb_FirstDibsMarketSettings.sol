...
contract FirstDibsMarketSettings is Ownable, IFirstDibsMarketSettings {
     ...
     */
    function setGlobalMarketCommission(uint32 _marketCommission) external onlyOwner {
     ...
     */
    function setGlobalCreatorRoyaltyRate(uint32 _royaltyRate) external onlyOwner {
