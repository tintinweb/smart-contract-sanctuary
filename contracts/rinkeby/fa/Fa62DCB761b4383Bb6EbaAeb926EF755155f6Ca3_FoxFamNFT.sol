...
contract FoxFamNFT is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x15543697E5e6463df385C08815F6F00E757dc22b;
    address t2 = 0xF672072A5470978476DC7eF25388caf06B9948Ef;
    address t3 = 0xAB04a2Ea9396A1B0Cdc71Bf64521E29E96edB936;
    ...
    function adopt(uint256 num) public payable {
        ...
        require( num < 21,                  "You can mint a maximum of 20 fantastic foxes" );
    ...
    function setPreSaleWhitelist(address[] memory _a, uint256[] memory _num) public onlyOwner {
        for(uint256 i; i < _a.length; i++){
            preSaleReserved[_a[i]] = _num[i];
        }
    }
    ...
    function withdrawBalance() public payable onlyOwner {
        ...
        uint256 _t1Amt = _onePerc.mul(41);
        uint256 _t2Amt = _onePerc.mul(50);
        uint256 _t3Amt = _onePerc.mul(9);
