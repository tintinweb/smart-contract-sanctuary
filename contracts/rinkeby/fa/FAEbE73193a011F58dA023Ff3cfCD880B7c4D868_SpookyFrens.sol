...
contract SpookyFrens is ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint256 public endClaim_timestamp = 1635739019; // Thu Sept 06 2021 20:00:00 UTC
    ...
    ERC721 public fastFoodFrens = ERC721(0x4721D66937B16274faC603509E9D61C5372Ff220);
    ...
    function setFastFoodFrens(address _fastFoodFrens) external onlyOwner {
        fastFoodFrens = ERC721(_fastFoodFrens);
    }
}
