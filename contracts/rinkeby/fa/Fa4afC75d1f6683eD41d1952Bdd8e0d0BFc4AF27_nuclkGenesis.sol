...
contract nuclkGenesis is ERC721Enumerable, Ownable {
    uint public MAX_CLK = 1;
    bool public PAUSED = false;
    uint256 private _price = 1 ether;

    constructor() ERC721(unicode"NüCLK Génesis", "NUCLK-0") {}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        bytes memory json = abi.encodePacked(
            ...
            Base64.encode(CLK()), '", "animation_url":"data:text/html;base64,', Base64.encode(CLK()), '"}');
