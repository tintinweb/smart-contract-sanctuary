...
contract DaoPunks is ERC721, Ownable {
    ...
    string public notrevealed_nft = "not_revealed.json";
    uint256 MAX_NFTS = 4444;
    uint256 minting_price = 0.001 ether;
        ...
        returns (string memory)
    {
        if(is_collection_revealed == true){
            ...
            if(_revealedNFTs[_tokenId] == true) {
                ...
                return string(abi.encodePacked(contract_base_uri, notrevealed_nft));
            }
        }
    }
    ...
    */
    function mintNFT() public payable {
        ...
        require(canMint, "DaoPunks: You can't mint because not whitelisted or don't have minimum $BANK");
        ...
        require(amount <= 10, 'DaoPunks: Amount must be less or equal to 10');
    ...
    */
    function revealNFT(uint256 _tokenId) public returns (bool) {
        require(ownerOf(_tokenId) == msg.sender, "DaoPunks: You must own the NFT");
