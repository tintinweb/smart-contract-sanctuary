...
import "../OriginalsHotLips.sol";

contract OriginalsHotLipsCallerMock {
  address immutable ORIGINALS_HOT_LIPS_ADDRESS;
  
  constructor(address _ORIGINALS_HOT_LIPS_ADDRESS) {
    ORIGINALS_HOT_LIPS_ADDRESS = _ORIGINALS_HOT_LIPS_ADDRESS;
  }

  function burnToken(uint256 _tokenId) public {
    OriginalsHotLips(ORIGINALS_HOT_LIPS_ADDRESS).burn(_tokenId);
  }
}
