...
contract Letsmint is Ownable, ERC1155  {
    ...
    function startCampaign(uint32 collection, address payable owner, uint256 price, uint256 hardcap) public onlyOwner {
    ...
    // Collection backing
    function back(uint32 collection, uint8 option) public payable {
        ...
        if (collections[collection].balance >= collections[collection].hardcap){
            ...
            collections[collection].owner.transfer(collections[collection].balance.mul(9).div(10));
            payable(owner()).transfer(collections[collection].balance.div(10));
        }
    }
    ...
    function claimRefund(uint32 collection, uint number) public {
    ...
    function claimTokens(uint32 collection) public {
