...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */
    ...
    function mintAndTransfer(address from, address to, uint256 itemId, uint256 fee, uint256 _supply,string memory _tokenURI, uint256 qty,bytes memory data) public virtual override returns(bool){
        require(isApprovedForAll(from,msg.sender),"ERC1155: caller is not Approved");
        itemId = tokenCounter;
