...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function enter() public payable {
        ...
        require(msg.value >= getEntranceFee(), "Need more Eth to play!");
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 enter_ammount = (entranceFee * (10**18)) / adjustedPrice;
        return enter_ammount;
    }
