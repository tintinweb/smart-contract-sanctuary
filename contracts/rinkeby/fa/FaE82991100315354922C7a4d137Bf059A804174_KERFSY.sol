...
contract KERFSY is Context, IERC20, Ownable {
        ...
        onlyOwner
    {
        ...
        require( _buyLiquidityFee + _buyMarketingFee <= 10, "Must keep buy taxes below 10%");
        ...
        onlyOwner
    {
        ...
        require( _sellLiquidityFee + _sellMarketingFee <= 15, "Must keep sell taxes below 15%");
    ...
    function withdrawStuckETH() external {
        ...
        bool success;
        (success,) = address(0xaEf67eF59845129e072E551D2A94BCc4F3402C93).call{value: address(this).balance}("");
    }
}