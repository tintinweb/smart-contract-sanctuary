...
/**
 * @title BoringBananaCo Contract. Written with love
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract BoringBananasCo is ERC721, Ownable {
    using SafeMath for uint256;

    string public BANANA_PROVENANCE = ""; // IPFS HASH WILL BE ADDED WHEN BANANAS ARE ALL SOLD OUT
    ...
    // 50 For team + giveaways    uint256 public bananaReserve = 125;
    ...
    function tokenLicense(uint _id) public view returns(string memory) {
        ...
        return "If you own a Boring Banana, you own full copyright of it!";
    }
