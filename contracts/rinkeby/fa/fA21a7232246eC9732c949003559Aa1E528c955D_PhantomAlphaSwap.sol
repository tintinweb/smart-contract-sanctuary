...
contract PhantomAlphaSwap is IPhantomAlphaSwap, PhantomStorageMixin {
     ...
     */
    function swap(address claimer, uint256 amount) external override onlyRegisteredContracts nonReentrant {
        require(amount > 0, "Amount to swap should be greater than 0");
