...
contract BlootElf is ERC721, Ownable {
    ...
    ERC721 bloot = ERC721(0xCAccb157236B0969fe21eb486f2Bc5dc0662a5c5);
    BlootElves oldElves = BlootElves(0xacAaBeeE78B61011b3dA63AD3eED99195624F396);
    ...
    function requestNewBloot(
        ...
        require(super.totalSupply() + oldElves.totalSupply() < MAX_SUPPLY, "Maximum supply reached.");
    ...
    function migrate(uint[] calldata _newIDs) external {
        ...
        for(uint i = 0; i < _newIDs.length; i++) {
            ...
            oldElves.setTokenURI(oldElves.tokenOfOwnerByIndex(msg.sender, 0), "new burned tokenURI");
