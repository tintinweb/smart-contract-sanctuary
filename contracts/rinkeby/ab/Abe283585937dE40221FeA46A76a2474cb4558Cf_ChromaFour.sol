...
abstract contract CollectCode is ERC721, Ownable
{
    ...
    function buildCode(uint256 tokenId) public returns (bool)
    {
        ...
        require(_colors[tokenId].length == 0, "CC: Token already built");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(
            ...
            "/metadata?version=1&=1pixels=", (_colors[tokenId].length > 0 ? Utils.convertToHexString(Utils.makePixels(config_.gridSize, _colors[tokenId])) : '') ));
    }
}
