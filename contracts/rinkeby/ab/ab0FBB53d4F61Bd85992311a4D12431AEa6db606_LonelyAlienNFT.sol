...
contract LonelyAlienNFT is ERC721, PaymentSplitter, Ownable, Pausable {
    ...
    uint256 public constant MAX_NFT = 10762;
    bool public saleIsActive = false;

    // 40 premines founders and 20 giveaways
    uint256 public constant MAXNFT = 100 + 40 + 20;
    ...
    address[] private _team = [
        ...
        */
        0x58f873264b7B951C0FB47991817c2b935e542E68, // r1 -30%
        0x7f6731a245Cda74172D65f19A27C721580cB765B, // r2 -30%
        0xaa5079d9BB462B0F2f36D401f4d97D9d3490De7e, // r3 -30%
        0xDBADF9e0b51FAb7c8769B332C7C667033BDD13A8  // r4 -10%
    ...
    constructor()
        ...
        ERC721("Loneley Aliens Space Club TEST TEST", "LASCTT")
    {
        _api_entry = "https://raw.githubusercontent.com/darkacorn/test/master/";
        ...
        for (uint256 i = 0; i < 30; i++) {
                _premine(address(0x93a3cf8aaF3f6E4C2239245c4FD60f2d1F4feCBc));
        }
    ...
    function getOneNFT() public payable {
        ...
        require(_tokenIdCounter.current().add(1) <= MAX_NFT, "Purchase would exceed max supply");
        master_mint();
    }
    ...
    function getMultipleNFT(uint256 _howMany) public payable {
        ...
        require(_tokenIdCounter.current().add(_howMany) <= MAX_NFT, "Purchase would exceed max supply");
    ...
    function _premine(address _to) private {
        if (_mintIsRandom) {
            for (uint256 i = 0; i < 9999; i++) {
                uint256 randID = random(
                    1,
