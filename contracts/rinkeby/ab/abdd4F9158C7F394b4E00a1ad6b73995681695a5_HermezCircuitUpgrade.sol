...
contract HermezCircuitUpgrade is InstantWithdrawManager {
    ...
    function addVerifier() external {
        require(address(withdrawVerifier) == address(0xCF9D902d0A189c091e5A2d5516Ee0f43382EaDff), "Only can be called once");
        rollupVerifiers[0] = VerifierRollup({
                verifierInterface: VerifierRollupInterface(
                    address(0x84cAeea34Af1D16Ec8C6Ac6b06D13AbBe5C429AD)
                ),
                maxTx: 344,
                nLevels: 32
             });
        ...
        rollupVerifiers[1] = VerifierRollup({
                verifierInterface: VerifierRollupInterface(
                    address(0x419b6570920ce1b0Fb8A138EA23f044B56A9d414)
                ),
                maxTx: 1912,
                nLevels: 32
             });
        ...
        withdrawVerifier = VerifierWithdrawInterface(0xCF9D902d0A189c091e5A2d5516Ee0f43382EaDff);
        emit hermezV2();
    }
