  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x7007187A82B21926cD600d9Bf86aa64F40e81756);
    ...
    // File: contracts/funkyShoesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract FunkyShoesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("FunkyShoes", "FS", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://ipfs://QmYq5vttHj9CnX1hH7hPqFYWnGM6bx45NDmx9gXZHS3YoL/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/iL4hiYblYN4YO679jmFh/contract-metadata";
        }
    }