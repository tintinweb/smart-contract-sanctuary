...
import "../../token/ERC20/ERC20PauseGovernance.sol";
import "./interfaces/IMasterERC20.sol";
import "../../access/ContractOwner.sol";

contract MasterERC20PauseGovernance is ContractOwnable, IMasterERC20 {
  ERC20PauseGovernance[] private childERC20PauseGovernance;
  ...
  function createERC20(
    ...
    ERC20PauseGovernance child = new ERC20PauseGovernance(
      tx.origin,
      name,
      symbol,
      decimal,
    ...
    childERC20PauseGovernance.push(child);
...
contract ERC20PauseGovernance is ERC20 {
  // @dev Governance
