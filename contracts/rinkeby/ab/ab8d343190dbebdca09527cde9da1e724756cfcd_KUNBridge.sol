...
contract KUNBridge is Owned, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function burn(
        ...
        require(toChainId != chainId && toChainId != 0 && chainIds[toChainId], "!toChainId");
    ...
    function mint(
        ...
        require(toChainId == chainId && toAddress != address(0), "!toChainId !toAddress");
