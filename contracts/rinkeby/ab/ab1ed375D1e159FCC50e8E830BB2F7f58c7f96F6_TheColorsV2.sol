 ...
 */
contract TheColorsV2 is ERC721Enumerable, Ownable {
    using Strings for uint256;
    using Strings for uint32;

    string public PROVENANCE_HASH = "";

    uint256 public constant colorPrice = 0.1 ether; //0.1 ETH
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            ...
                            // '",',
                            generateNameDescription(hexString),
    ...
    */
    ...
    function generateNameDescription(string memory hexString) internal pure returns (string memory) {
        return string(
            abi.encodePacked(
                '"external_url":"https://thecolors.art",',
                '"description":"The Colors are a set of 8,888 iconic shades generated and stored entirely on-chain, to be used as a primitive and for vibes.'
                '\\nHex: #',
                hexString,
                '",',
                '"name":"#',
