...
contract TestToroids is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    uint256 public constant MAX_TOKENS_PER_ADDRESS = 3;
    uint256 public constant PRICE = 0.01 ether;
    uint256 private constant mintLimit = 2;
    ...
    function addPresaleListFixedLimit(
        address[] calldata _addrs,
        uint256 _limit
    ) external onlyOwner {
        for (uint256 i = 0; i < _addrs.length; i++) {
    ...
    function presaleMint(uint256 amount) external payable {
        ...
        require(amount <= mintLimit, "More tokens at a time than allowed");
