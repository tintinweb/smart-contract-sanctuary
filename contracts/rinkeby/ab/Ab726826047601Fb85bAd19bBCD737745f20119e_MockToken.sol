...
contract MockToken is ERC721 {
    ...
    uint256 private _count2 = 1000000;
    ...
    function tokenURI(uint256 tokenId) public override pure returns(string memory) {
        if (tokenId < 1000000) return "https://api.niftygateway.com/rhymezlikedimezoe/12600020153";
        return "https://api.niftygateway.com/rhymezlikedimezoe/12600010260";
    }
