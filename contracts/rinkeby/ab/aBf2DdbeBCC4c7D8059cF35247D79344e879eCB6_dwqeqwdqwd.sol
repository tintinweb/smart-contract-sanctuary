...
contract dwqeqwdqwd is ERC721, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

    uint256 public totalSupply = 0;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/239/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/239/contract-uri";
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _signerAddress) ERC721("dqweqw", "WEEW") {
