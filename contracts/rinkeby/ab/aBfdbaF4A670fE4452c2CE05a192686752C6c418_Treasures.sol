...
contract Treasures is Context, ERC721Enumerable, ERC721Burnable {
    ...
    event Mint(uint256 tokenId, uint256 xbtcBalance);
    /**
    ...
    function mint() public virtual {
        ...
        //get the balance before the minter pays
        uint256 xbtcBalance = IERC20(Oxbtc).balanceOf(_msgSender());
        ...
        emit Mint(_tokenIdTracker.current(),xbtcBalance);
