...
contract DODA is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Death of Digital Art", "DODA") {
        traitTypes[0] = Trait('Color', 'Pure Black', '#000');
        traitTypes[1] = Trait('Color', 'Pure Yellow', '#FF0');
        traitTypes[2] = Trait('Color', 'Pure Magenta', '#F0F');
        traitTypes[3] = Trait('Color', 'Pure Cyan', '#0FF');
        traitTypes[4] = Trait('Color', 'Pure Blue', '#00F');
        traitTypes[5] = Trait('Color', 'Pure Green', '#0F0');
        traitTypes[6] = Trait('Color', 'Pure Red', '#F00');
    }
    ...
    function idToMetadata(uint256 _id) public view returns (string memory)
    {
        ...
        uint256 colorCount = _id.mod(7) + 1;
        ...
        for (uint8 i = 0; i < colorCount; i++) {
            metadataString = string(
                abi.encodePacked(
                    metadataString,
                    '{"trait_type":"',
                    traitTypes[i].traitName,
                    '","value":"',
                    traitTypes[i].traitValue,
                    '"}'
                )
            );
            if (i != colorCount-1)
