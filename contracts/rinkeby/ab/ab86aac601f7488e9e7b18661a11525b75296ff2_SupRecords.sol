...
contract SupRecords is ERC1155(""), ReentrancyGuard, Pausable, Ownable {
    ...
    function createNonUnique(uint256 tokenId, uint256 price, uint256 count, string memory ipfsHash) external nonReentrant minterOrOwner {
    ...
    function mintUnique(uint256 tokenId, string memory ipfsHash) external nonReentrant minterOrOwner {
