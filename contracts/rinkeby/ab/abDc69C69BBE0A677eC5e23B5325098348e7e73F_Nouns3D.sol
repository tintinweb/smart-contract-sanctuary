...
contract Nouns3D is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function mintTierA(uint256 numberOfTokens) public payable nonReentrant{
        ...
        for(uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() <= MintCycleTierA) {
                _safeMint(msg.sender, mintIndex);
                //update balance count if it is part of the genesis nouns
                if (mintIndex < 7400) {
                    balanceN3D[msg.sender] += 1;
                }
            }
    ...
    function mintTierB(uint256 numberOfTokens) public payable nonReentrant{
    ...
    function mintTierC(uint256 numberOfTokens) public payable nonReentrant{
