...
contract CRZGANG is Ownable, ReentrancyGuard, ERC721Enumerable {
    ...
    */   
    ...
    require(saleOpen, "Sale not active yet !");
    require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "no more nft available");
    require(numberOfTokens > 0 && numberOfTokens <= MAX_MINT_PER_TRANSACTION, "5 mint max per transaction");
