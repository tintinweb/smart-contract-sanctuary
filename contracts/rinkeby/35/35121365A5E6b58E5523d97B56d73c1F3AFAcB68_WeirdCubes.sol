...
contract WeirdCubes is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint public availableToken = 100;
    ...
    constructor(string memory theBaseURI, address theOwner1, address theOwner2, uint numToken, bool debug) ERC721("WeirdCube", "WEIRDCUBE")  {
    ...
    function mintHeads(uint _count) public payable saleIsOpen notPaused notRevealed {
        require(_count > 0, "You can't mint 0 WeirdCubes");
    ...
    function contractURI() public pure returns (string memory) {
        return "https://weirddonuts.vercel.app/contract-info.json";
    }
