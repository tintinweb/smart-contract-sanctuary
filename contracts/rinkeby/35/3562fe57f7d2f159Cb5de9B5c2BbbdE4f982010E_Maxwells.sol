...
contract Maxwells is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        preSaleAddresses[0xC3D2A46894CbAB35b8FC2c1613f91cC76fdD3419] = true;
        preSaleAddresses[0x1BCE689565DdB9e5f4193130f693D2B976A72096] = true;
    ...
    uint256 public price = 0.00018 ether;
    ...
    address public mAddress = 0xC3D2A46894CbAB35b8FC2c1613f91cC76fdD3419;
    address public fAddress = 0x1BCE689565DdB9e5f4193130f693D2B976A72096;

    uint256 public constant M_PERCENT_CUT = 9;
    uint256 public constant F_PERCENT_CUT = 91;
    uint256 public constant MAX_PER_WALLET = 500;
    ...
    /**
     * @notice Allow for bulk minting of NFTs with a max of 5 at once
     */
    function multiMint(uint256 numberOfMints) public payable virtual nonReentrant {
        require(isPublicSaleActive || (isPreSaleActive && preSaleAddresses[msg.sender]), "SALE_IS_NOT_ACTIVE");
