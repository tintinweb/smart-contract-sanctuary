 ...
 */
contract NeonCity is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant dawgPrice = 28000000000000000; //0.028    ETH
    ...
    */
    function mint(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_DAWG, "Purchase would exceed max supply of Apes");
