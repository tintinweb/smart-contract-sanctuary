...
contract NFT is ERC721 {
    ...
    function setExcluded(address excluded, bool statues) external {
        require(msg.sender == artist, 'Only artist');
        excludedList[excluded] = statues;
    }
    ...
    function _baseURI() internal view override returns (string memory) {
        return 'https://salty-bayou-32219.herokuapp.com/';
    }
