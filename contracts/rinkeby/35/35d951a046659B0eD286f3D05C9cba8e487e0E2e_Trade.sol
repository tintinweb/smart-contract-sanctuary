...
contract Trade is Ownable {
    ...
    constructor(address owne) public{
        owner = owne;
        coinAddress = 0x154A9F9cbd3449AD22FDaE23044319D6eF2a1Fab;
        nftAddress = 0x7E091b0a220356B157131c831258A9C98aC8031A;
        free = 20; //2%
        orderInfos.push(OrderInfo(0,uint256(-1),owne));
        emit Sell(owne,0,uint256(-1));
    }
