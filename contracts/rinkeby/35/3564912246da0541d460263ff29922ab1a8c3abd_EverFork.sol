...
contract EverFork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5F2384B31D9B3AF5e864356200EEC6B29A59245b); // Marketing Address
    ...
    string private _name = "EverFork";
    string private _symbol = "EFORK";
