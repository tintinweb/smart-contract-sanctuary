...
contract CryptoIlluminati777 is ERC721Enumerable, Ownable {
    ...
    uint256 public ILLUMINATI_MAX = 11111;
    uint256 public PRESALE_PRICE = 0.07 ether;
    uint256 public PUBLIC_PRICE = 0.17 ether;
    uint256 private REVEAL_DELAY = 0 hours;
    uint256 private PRESALE_HOURS = 24 hours;
    uint256 public PURCHASE_LIMIT = 10;
    uint256 public PRESALE_MINT_LIMIT = 10;
    uint256 public PUBLIC_MINT_LIMIT = ILLUMINATI_MAX;
    ...
    uint256 private _activeDateTime = 1644246427; //Mon Feb 07 2022 07:07:07 GMT
    uint256 private _revealDateTime;
    
    string private _tokenBaseURI = "";
    string private _revealURI = "";
    
    Counters.Counter private _publicILLUMINATI;

    constructor() ERC721("CryptoIlluminati 777", "&#10686;") {}
    ...
    function airdrop(address to, uint256 numberOfTokens) external onlyOwner {
        for (uint256 i = 0; i < numberOfTokens; i++) {
            uint256 tokenId = _publicILLUMINATI.current();

            if (_publicILLUMINATI.current() < ILLUMINATI_MAX) {
                _publicILLUMINATI.increment();
                _safeMint(to, tokenId);
    ...
    function purchase(uint256 numberOfTokens) external payable {
        ...
        require(_publicILLUMINATI.current() < ILLUMINATI_MAX,"Purchase would exceed ILLUMINATI_MAX");
