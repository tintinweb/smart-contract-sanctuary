...
contract Floot is ERC721Enumerable, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<svg width="350" height="350" viewBox="0 0 350 350" xmlns="http://www.w3.org/2000/svg"> <style> .small { font: 8px sans-serif; } .text { font: 14px sans-serif; } .textdesc { font: 13px sans-serif; } .heavy { font: bold 24px sans-serif; } .Rrrrr { font: italic 40px serif; fill: red; } </style> <rect width="350" height="350" fill="#FEF8ED"/> <text x="27" y="32" class="heavy">Floot</text><g xmlns="http://www.w3.org/2000/svg" opacity="0.8"><path d="M279.558 14.7723H292.223V17.8937H279.558V14.7723ZM280.488 21.6348H291.294V24.7562H280.488V21.6348ZM279.415 28.8785H292.366V32H279.415V28.8785Z" fill="black"/><path d="M298.085 29.0215H306.115L302.064 18.4775L298.085 29.0215ZM300.384 14.7723H303.947L310.654 32H293.677L300.384 14.7723Z" fill="black"/><path d="M313.671 17.8937H308.548V14.7723H322.5V17.8937H317.377V32H313.671V17.8937Z" fill="black"/></g><text x="272" y="32" text-anchor="end" class="heavy">';
