...
contract TxDAO is ERC20, Ownable{
    ...
    uint8 public promotePercent;
    address private cSigner;
    constructor(string memory _name, string memory _symbol, address _signer, uint8 _promotePercent) ERC20(_name, _symbol) {
        cSigner = _signer;
        promotePercent = _promotePercent;
    }
