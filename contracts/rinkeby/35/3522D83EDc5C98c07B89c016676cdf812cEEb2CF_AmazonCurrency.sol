...
contract AmazonCurrency {
    ...
    Product [4] private productAvailable;
    uint256 private numberOfProduct;
    ...
    constructor () public {
        ...
        numberOfProduct = 4;
        productAvailable[0] = Product("Product: iPhone 12 ", "Product ID: 0 ", "Price: 600 AMZNCRY \n");
        productAvailable[1] = Product("Product: Xiaomi Band 5 ", "Product ID: 1 ", "Price: 30 AMZNCRY \n");
        productAvailable[2] = Product("Product: iRobot Roomba i7+ ", "Product ID: 2 ", "Price: 1200 AMZNCRY \n");
        productAvailable[3] = Product("Product: Planetary mixer ", "Product ID: 3 ", "Price: 200 AMZNCRY \n");
    }
    
    function catalogue() public view returns (string memory) {
        string memory response = '';
        uint256 i=0;
        for (i=0; i<numberOfProduct; i+=1) {
           response = string(abi.encodePacked(response, productAvailable[i].name, productAvailable[i].id, productAvailable[i].price, "\n")); 
        }
        return response;
    }
