...
contract Governor2 is Governor, GovernorCountingSimple, GovernorVotes {
    constructor(ERC20Votes _token) Governor("Governor") GovernorVotes(_token) {}
...
abstract contract IGovernor is IERC165 {
     ...
     */
    // solhint-disable-next-line func-name-mixedcase
    function COUNTING_MODE() public virtual pure returns (string memory);
     ...
     */
    function quorum(uint256 blockNumber) public virtual view returns (uint256);
     ...
     */
    function getVotes(address account, uint256 blockNumber) public virtual view returns (uint256);

    /**
     * @notice module:voting
     * @dev Returns weither `account` has casted a vote on `proposalId`.
     */
    function hasVoted(uint256 proposalId, address account) public virtual view returns (bool);
    ...
    function execute(
        ...
        bytes[] memory calldatas,
        bytes32 descriptionHash
    ) public virtual payable returns (uint256 proposalId);
