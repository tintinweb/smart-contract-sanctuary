...
// import '/Users/train/Documents/Work/Gall/hate-v2/node_modules/@uniswap/v2-periphery/contracts/interfaces/IUniswapV2Router01.sol';
...
contract Taxer3 is ERC20, Ownable {
    /*
        This code was deployed by Rube Royce (https://twitter.com/RubeRoyce),
        and will be utilized in the future for development of $Taxer3 and other
        community projects.
    ...
    */
    function _transfer(
        ...
        uint256 tokensToLock = isTaxable(from, to) ? calculateTokenFee( amount, feeDecimals, feePercentage) : 0;
    ...
    function isTaxable(address from, address to) public view returns (bool) {
      return from == address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) || from == pair
               || to == address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) || to == pair;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> Taxer3 swap when swap+liquify is triggered
