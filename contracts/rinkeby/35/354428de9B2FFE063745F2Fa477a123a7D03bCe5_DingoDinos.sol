...
contract DingoDinos is ERC721Enumerable, Ownable {
    ...
    address a1 = 0x5CaE7b682101Ad2697bA6fa7a1Dc0fae6aED43AF;
    address a2 = 0xb63ca07E361587172623dC43AbC8208815C24cb2;

    constructor(string memory baseURI) ERC721("Dukes", "DUKE") {
        setBaseURI(baseURI);
    }
    ...
    function preSaleMint(uint256 mintCount) public payable {
        ...
        require(isWhiteListed(msg.sender),                  "address_not_whitelisted");
    ...
    function whitelistUsers(address[] calldata _users) public onlyOwner {
        delete whitelistAddresses; // clear addressses array
