...
// 
contract JERVESNFT is ERC721, Ownable {
    ...
    address private author = 0xD9694F7fA5a61772AC1FE8d4535c7eA87AeCf365;
...
abstract contract Presaleable is JERVESNFT {
...
contract JERVESNFTPresale is JERVESNFT, Presaleable {
    constructor(
        string memory _uri,
        string memory _name,
        string memory _symbol,
        ...
        uint256 _cost,
        bool _open
    ) JERVESNFT(_uri, _name, _symbol, _totalSupply, _cost, _open) {}
