...
abstract contract IDispute is BasicMetaTransaction, Initializable {
    ...
    modifier onlyHomeFi() {
        ...
        require(address(homeFi) == msgSender(), "Only HomeFi");
        _;
    }
    ...
    modifier onlyAdmin() {
        ...
        require(homeFi.admin() == msgSender(), "Only admin");
        _;
    }
     ...
     */
    function initialize(address _homeFi, address _eventsContract) external virtual;
