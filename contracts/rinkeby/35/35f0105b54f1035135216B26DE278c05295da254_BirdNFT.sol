...
contract BirdNFT is ERC721, VRFConsumerBase, Ownable {
    ...
    uint256 public constant BIRDS_COLLAB_SUPPLY          = 3500;
    uint256 public constant BIRDS_PRESALE_SUPPLY         = 10006;
    uint256 public constant BIRDS_TOTAL_SUPPLY           = 10006;
    uint256 public constant BIRDS_COLLAB_MINT_LIMIT      = 5;
    uint256 public constant BIRDS_PRESALE_MINT_LIMIT     = 5;
    uint256 public constant BIRDS_SALE_MINT_LIMIT        = 10;
    
    string public provinance;
    ...
    function collabBuy(uint256 tokenQuantity) external payable {
        ...
        require(collabAmountMinted + tokenQuantity <= BIRDS_COLLAB_SUPPLY, "EXCEED_COLLAB_SUPPLY");
    ...
    function presaleBuy(uint256 tokenQuantity) external payable {
        ...
        uint256 tokenCount = supply.current();
        require(tokenCount + tokenQuantity < BIRDS_TOTAL_SUPPLY, "OUT_OF_STOCK");
        require(presaleAmountMinted + tokenQuantity <= BIRDS_PRESALE_SUPPLY, "EXCEED_PRESALE_SUPPLY");
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        require(bytes(provinance).length == 0, "Provenance hash already set");
        require(bytes(provenanceHash).length == 64, "Invalid provenance hash");
        provinance = provenanceHash;
    }
}
