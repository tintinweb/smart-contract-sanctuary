...
import "../libraries/config-fee-erc20.sol";
...
contract FactoryMaster {
    ...
    function createChild(Types types,ConfigFeeErc20.ConfigFee config, string memory name,string memory symbol,uint256 _interestsRate) external payable {
        ...
        if (types == Types.erc20) {
            ...
            if(config ==ConfigFeeErc20.ConfigFee.DEMO1){

                require(msg.value>=fee_erc20+ConfigFeeErc20.DEMO1_ERC20,"ERC20:value must be greater than 0.2");
                
                ERC20 child = new ERC20(name, symbol);
                childrenErc20.push(child);
                emit ChildCreatedERC20(address(child), name, symbol);
            }
            if(config ==ConfigFeeErc20.ConfigFee.DEMO2){

                require(msg.value>=fee_erc20+ConfigFeeErc20.DEMO2_ERC20,"ERC20:value must be greater than 0.2");
                
                ERC20 child = new ERC20(name, symbol);
                childrenErc20.push(child);
                emit ChildCreatedERC20(address(child), name, symbol);
            }
            if(config ==ConfigFeeErc20.ConfigFee.DEMO3){

                require(msg.value>=fee_erc20+ConfigFeeErc20.DEMO3_ERC20,"ERC20:value must be greater than 0.2");
                
                ERC20 child = new ERC20(name, symbol);
                childrenErc20.push(child);
                emit ChildCreatedERC20(address(child), name, symbol);
            }
            if(config ==ConfigFeeErc20.ConfigFee.DEMO4){

                require(msg.value>=fee_erc20+ConfigFeeErc20.DEMO4_ERC20,"ERC20:value must be greater than 0.2");
...
library ConfigFeeErc20{

    uint constant DEMO1_ERC20=0.3 ether;
    uint constant DEMO2_ERC20=0.3 ether;
    uint constant DEMO3_ERC20=0.3 ether;
    uint constant DEMO4_ERC20=0.3 ether;

    enum ConfigFee { DEMO1 , DEMO2 , DEMO3 , DEMO4 }
}
