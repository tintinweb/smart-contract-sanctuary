...
contract ScarNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor (string memory customBaseURI_) ERC721("Scarpanion", "SCAR") {
    customBaseURI = customBaseURI_;
  }

  uint256 public constant MAX_SUPPLY = 1150;
  uint256 public constant SCAR_RESERVE = 150;
  uint256 public constant MAX_MULTIMINT = 5;
  uint256 public constant PRICE = 0.1 ether; //currently set for testing
  ...
  function reserve(uint256 count) public onlyOwner {
    require(isDevMintEnabled, "Minting not active");
