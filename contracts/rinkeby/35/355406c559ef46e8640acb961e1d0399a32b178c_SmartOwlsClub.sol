...
// File: contracts/4_project_owl.sol
...
contract SmartOwlsClub is ERC721Enumerable, Ownable {                 //contract Name is NErdyCoderCLone and inherited from the openzaplin libraries
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function removeWhitelistUser(address _user) public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x8F9C38A595E9D08b257C53bcABe80b2A28d760BE).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
    ...
    // =============================================================================
    (bool os, ) = payable(0x288e956DE305fe86986c4C6a180889e997084a93).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
  }
}