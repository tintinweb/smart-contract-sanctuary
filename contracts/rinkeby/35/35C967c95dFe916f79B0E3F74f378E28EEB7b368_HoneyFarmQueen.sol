...
contract HoneyFarmQueen is Ownable, ReentrancyGuard {
    ...
    uint16 public ROUNDS_BEFORE_INACTIVE_BEE = 10; //number of rounds that a bee can claim honey before becoming inactive
    ...
    uint256 public REWARDS_COOLOFF = 86400; //one day

    uint256 public HIVE_CLAIM_COOLOFF = 86400; //one day
    ...
    /**
     * @dev Exactly like in real world, bees become hungry for honey so, after ROUNDS_BEFORE_INACTIVE_BEE rounds a bee needs
     ...
     * Honey will be burnt and bee can claim Honey again for ROUNDS_BEFORE_INACTIVE_BEE.
     */
