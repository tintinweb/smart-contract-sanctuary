...
contract CactiClub is ERC721Burnable, Ownable {
    ...
    function reserveCacti(address addr, uint256 amount) public {
        ...
        require(addr == address(0x589169EEE30B318dDf501aEe0a2463B35d4cA9b8) || addr == address(0x68cF4d1c7bC31f4990e98c05d3F96c8E56225a71), 'You are not whitelisted to reserve');
