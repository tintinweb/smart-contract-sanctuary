...
/// @title  Sample
/// @author TBob
/// @notice ERC1155 NFT Sale Tokens

contract uglyGirl is ERC1155Supply, Ownable {
    /// ============ Immutable Storage ============
    address payable private ownerA =
        payable(0xe21DD2Ce444dbdD2e3DD8a9D41DD21031d0bc464);

    uint256 public constant TOKEN_ID = 1;
    string public constant name = "UglyGril";
    string public constant symbol = "UGLY";
    uint256 public constant BUY_PRICE = 0.08 ether;
    //uint16 public constant MAX_PRESALE_SUPPLY = 2000;
    //uint16 public constant MAX_PRESALE_PER_ACCOUNT = 2;
    uint16 public constant MAX_SUPPLY = 9900;
    uint16 public constant MAX_SUPPLY_TEAM = 100;
    uint16 public constant MAX_PER_ACCOUNT = 28;
    uint16 public constant MAX_PER_TXN = 14;
    address public constant TEAM_ADDRESS =
        0xe21DD2Ce444dbdD2e3DD8a9D41DD21031d0bc464;
    address public constant TREASURY_ADDRESS =
        0xe21DD2Ce444dbdD2e3DD8a9D41DD21031d0bc464;
    address public constant DONATION_ADDRESS =
        0xe21DD2Ce444dbdD2e3DD8a9D41DD21031d0bc464;
    uint256 public constant TREASURY_RATE = 10;
    uint256 public constant DONATION_RATE = 10;

    /// ============ Mutable Storage ============
    string public baseURI =
        "ipfs://QmbG7TZt8WKK7HDUsyhZzZgH42jLC2ETet8FiJRgxerR6v";
    ...
    /// @notice override for baseURI
    function claim(uint16 amount) external payable {
        require(salesActive, "Claim is not active.");
        require(
            tx.origin == msg.sender,
            "Claim cannot be made from a contract"
        );
        require(amount <= MAX_PER_TXN, "TXN Claim: Can not claim that many.");
        require(
            balanceOf(msg.sender, TOKEN_ID) + amount <= MAX_PER_ACCOUNT,
            "Claim: Can not claim that many."
        );
        require(
            claimed + amount <= MAX_SUPPLY,
            "Claim: Cannot exceed total supply."
        );
        require(
            msg.value >= (amount * BUY_PRICE),
