...
contract CryptoFoxesOrigins is ERC721, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdTracker;
    // https://testnets.opensea.io/assets/0x88b48f654c30e99bc2e4a1559b4dcf1ad93fa656/12343489811036852159607689441263403578697540433741525365825045004583681654785
    IERC1155 public constant OPENSEA_STORE = IERC1155(0x88B48F654c30e99bc2e4A1559b4Dcf1aD93FA656); // opensea wallet
    uint256 public constant MAX_ELEMENTS = 1001;
    uint256 public constant START_AT = 1;
    string public baseTokenURI;

    event EvolveFox(uint256 indexed id);
    ...
    function convert(uint256 _tokenId) public {
        ...
        //require(isValidFox(_tokenId), "Not valid Fox");
        uint256 id = returnCorrectId(_tokenId);
        _mintAnElement(_msgSender(), id);
    ...
    function isValidFox(uint256 _id) public pure returns (bool) {
        ...
        if (_id >> 96 != 0x0000000000000000000000001b4a2aeb47CbD6CF0868e6BF8Ed878C77Dba0149) return false; // adresse du owner de la collection opensea.
        ...
        // if (id > 1005 || id == 262 || id == 197 || id == 75 || id == 34 || id == 18 || id == 0) return false;
        return true;
    }
    function returnCorrectId(uint256 _id) internal pure returns (uint256) {
        ...
        if (_id > 262) return _id - 5;
        else if (_id > 197) return _id - 4;
        else if (_id > 75) return _id - 3;
        else if (_id > 34) return _id - 2;
        else if (_id > 18) return _id - 1;
        else return _id;
    }
    /*function onERC1155Received(address, address, uint256, uint256, bytes calldata) external view returns (bytes4) {
        require(msg.sender == address(OPENSEA_STORE), "WrappedKongz: not opensea asset");
        return CryptoFoxesOrigins.onERC1155Received.selector;
    }*/
}
