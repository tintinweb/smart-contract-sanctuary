...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable
{
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual
    {
        ...
        PEZ.disableNftStaking("DOOLNIES", tokenId);
    }
...
contract DLZToken     is  ERC721Enumerable
{
    ...
    //=============================================================================
    function    isWhiteListUserDuringWhitelistingPeriod(address userWallet) external view returns(bool)
    {
        bool        isOk = false;
        
        if (whitelistingUsers[userWallet]==1)
        {
            if (block.timestamp>=presalesTimestamp && block.timestamp<salesTimestamp)
            {
                isOk = true;        // oui c'est un user whitelisté qui appel durant la periode de whitelisting
            }
        }
    ...
    //=============================================================================
    function    setMintingMode(uint256 newMode)     external onlyOwner        // 1: Raffle   2: Presale(whitelist)   3: PublicSale   0: disabled 
    {
    ...
    function    reserve(uint256 quantity)           external onlyOwner
    {
        ...
        for (uint256 i=0; i<quantity; i++)
        {
            ...
            PEZ.nftStake("DOOLNIES", mintedTokenCount);
    ...
    //=============================================================================
    function    getMintingPrice(uint256 quantity, uint256 stakingMode) view external returns(uint256)
    {
        uint256     orderPrice;
