...
contract SOTTest1 is ERC721, ERC721Burnable, Ownable {
    ...
    string private baseURI = "ipfs://Qmek5YTipNcMeo6bj3mxyPDSo4WJV7VwWrPQHByEjzur6H/";
    string private blankTokenURI = "ipfs://QmT5cyQ7MsSMfSAE8RcDnG6sb5sSscys21FL4K3M8wZAMF/";
    bool private isRevealed = false;
    bool private isFrozen = false;
    address public signerAddress = 0xd8e73bDd9806bAF6a06224c5EAC2E8a009528326;

    mapping(address => bool) public didAddressMint;
    mapping(uint16 => uint16) private tokenMatrix;

    constructor() ERC721("SOTTest1", "SOTT1") {}
