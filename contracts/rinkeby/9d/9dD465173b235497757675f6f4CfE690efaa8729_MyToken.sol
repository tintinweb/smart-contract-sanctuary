...
contract MyToken is ERC721, Ownable {
    ...
    uint256 public constant GIFT_BUFFER = 100;
    ...
    constructor(
        ...
        string memory _URI) ERC721("MyToken", "MTK") {
        signer = _signer;
    ...
    function firstPresale(uint256 mintAmount, bytes memory _signature) public payable {
        ...
        require(mintAmount + _tokenIdCounter.current() <= MAX_SUPPLY - giftsRemaining(), "Minting more than max supply");
    ...
    function secondPresale(uint256 mintAmount, bytes memory _signature) public payable {
