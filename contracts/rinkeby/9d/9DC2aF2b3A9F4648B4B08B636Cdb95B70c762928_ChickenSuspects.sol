...
contract ChickenSuspects is  ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBase {
    ...
    function getWeeklySuspects() public onlyOwner returns (bytes32[] memory) {
        bytes32[] memory weeklySuspects = new bytes32[](5);
        for (uint256 i = 0; i < 5; i++) {
            weeklySuspects[i] = getRandomNumber();
        }
        return weeklySuspects;
    }
}
