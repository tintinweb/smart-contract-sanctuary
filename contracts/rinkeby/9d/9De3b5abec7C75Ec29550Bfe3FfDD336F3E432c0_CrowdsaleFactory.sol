...
contract Crowdsale is Ownable {
    ...
    function getData() external view returns(uint256,uint256,uint256,uint256,uint256,uint256){
        ...
        uint256 maxAlPerUser = pool.ticketValue / maxUserTicketAmount;

        return(swapRate, totalTicketAmount, maxUserTicketAmount, allocationPerTicket, personelMaxAl, pool.ticketValue);
