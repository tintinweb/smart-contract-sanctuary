...
contract BearsDeluxe is ERC721Enumerable, AccessControl {
    ...
    constructor() ERC721("BearsDeluxe", "BearsDeluxe") {
     ...
     * only emergency
     */
    function setTokenUri(uint16 _tokenId, string calldata _tokenURI) public onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function mint(address _owner, uint16 _tokenId) external onlyRole(GOVERNANCE_ROLE) {
