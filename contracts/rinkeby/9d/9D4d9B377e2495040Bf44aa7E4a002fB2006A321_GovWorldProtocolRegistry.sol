...
contract GovWorldProtocolRegistry is GovWorldProtocolBase {
    ...
    uint256 public lenderUnearndedAPYPercentage = 10;
    // platform fee is the 1% of the loan amount
    uint256 public govPlatformFee = 2;
    uint256 public govAutosellFee = 7;
    uint256 public govThresholdFee = 1;
    uint256 public govAdminWalletFee = 20;
    ...
    */
    ...
    function setUnearnedAPYPercentageForLender(uint _percentage) public onlyEditFeeRole(msg.sender) {
        require(_percentage <= 100 && _percentage > 0, "GPL: Gov Percentage Error");
