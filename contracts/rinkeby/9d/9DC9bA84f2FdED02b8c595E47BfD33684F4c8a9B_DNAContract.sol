...
contract DNAContract is ERC721Enumerable, Ownable {
    ...
    function EyeType(uint256 Idx) public view returns (string memory) {
        ...
        if (Idx == 0) {
            eyeString = string(abi.encodePacked(
                eyeString, 
                '<g id="Left_eye">',
                    '<ellipse cx="325" cy="400" rx="35" ry="50" class="corneaColor" />',
                    '<circle cx="325" cy="425" r="25"  class="pupilColor" />',
                ...
                '</g>',
                '<g id="Right_eye">',   
                    '<ellipse cx="475" cy="400" rx="35" ry="50" class="corneaColor" />',
                    '<circle cx="475" cy="425" r="25" class="pupilColor" />',
    ...
    /*
    function tokenURIRef(uint256 tokenId) public view returns (string memory) {
        uint256 supply = totalSupply();
        string memory output;
        ...
        if (supply < 0) {
            ...
            output = string(abi.encodePacked(
                ...
                '<svg preserveAspectRatio="xMinYMin meet" viewBox="0 0 800 800" ',  
                    'xmlns="http://www.w3.org/2000/svg" version="1.1">', 
                    '<g stroke="#',
                        DNAColors[neucleotideIdxArray[0]], 
                    ...
                    '</g>', 
                    '<g stroke="#',
                        DNAColors[neucleotideIdxArray[3]], 
    ...
    function tokenURIDNA(uint256 tokenId) public view returns (string memory) {
        ...
        if (supply < 0) {
                ...
                output, 
                    '<svg preserveAspectRatio="xMinYMin meet" viewBox="0 0 800 800" ',  
                        ...
                        '<style>',
                            ...
                            DNAColors[neucleotideIdxArray[1]],
                            ';stop-opacity:1}',
                            '.color_3{fill:none;stroke-width:25;stroke:#',
                            DNAColors[neucleotideIdxArray[1]], 
                            '}',
                            '.color_4{fill:none;stroke-width:18;stroke:#',
                            DNAColors[neucleotideIdxArray[2]],      
                            '}',                     
                        '</style>'
            ));
            ...
            output = string(abi.encodePacked(
                output, 
                        '<g id="ladder_1">',
                            '<path d="M400,100 l-125,0" class="color_3"/>',
                            '<path d="M400,100 l125,0" class="color_3" />',
                            '<path d="M400,180 l-100,0" class="color_3" />',
                            '<path d="M400,180 l100,0" class="color_3" />',
                        '</g>',
                        '<g id="ladder_2">',
                            '<path d="M400,360 l-100,0" class="color_3" />',
                            '<path d="M400,360 l100,0" class="color_3" />',
                            '<path d="M400,440 l-100,0" class="color_3" />',
                            '<path d="M400,440 l100,0" class="color_3" />',
                        '</g>',
                        '<g id="ladder_3">',
                            '<path d="M400,620 l-100,0" class="color_3" />',
                            '<path d="M400,620 l100,0" class="color_3" />',
                            '<path d="M400,700 l125,0" class="color_3" />',
                            '<path d="M400,700 l-125,0" class="color_3" />',
                        '</g>'
            ));
            output = string(abi.encodePacked(
                output,                     
            ...
            string memory eyeTypeString = EyeType(neucleotideIdxArray[7]%eyeTypeNum);
            output = string(abi.encodePacked(
                output, 
                eyeTypeString
            ));

            string memory mouthTypeString = MouthType(neucleotideIdxArray[7]%mouthTypeNum);
            output = string(abi.encodePacked(
                output, 
                mouthTypeString
            ));
            
            string memory eyebrowTypeString = EyebrowType(neucleotideIdxArray[7]%eyebrowTypeNum);
            output = string(abi.encodePacked(
                output, 
                eyebrowTypeString
            ));
            /*
            string memory noseTypeString = NoseType(neucleotideIdxArray[7]%noseTypeNum);
            output = string(abi.encodePacked(
                output, 
                noseTypeString
            ));*/
            ...
            output = string(abi.encodePacked(
                output, 
                        '<g id="Left_strand_shadow">',
                            '<path stroke-linecap="round" d="M262.5,80 q0,25 7.5,50" class="color_4" />',                            
                            '<path stroke-linecap="round" d="M278,160 q0,0 4,10" class="color_4" />',
                            '<path stroke-linecap="round" d="M262.5,720 q0,-25 7.5,-50" class="color_4" />',                                    
                            '<path stroke-linecap="round" d="M278,640 q0,0 4,-10" class="color_4" />',
                        '</g>'
            ));
            output = string(abi.encodePacked(
                output, 
                        '<g id="Right_strand_shadow">',
                            '<path stroke-linecap="round" d="M537.5,80 q0,25 -7.5,50" class="color_4" />',                            
                            '<path stroke-linecap="round" d="M522,160 q0,0 -4,10" class="color_4" />',
                            '<path stroke-linecap="round" d="M537.5,720 q0,-25 -7.5,-50" class="color_4" />',                                    
                            '<path stroke-linecap="round" d="M522,640 q0,0 -4,-10" class="color_4" />',
                        '</g>',
                    '</svg>'
            ));  
