...
contract PhoenixEffect is ERC721EnumerableLite, Ownable {
    ...
    constructor() ERC721B("Phoenix Effect - Typhoon Odette Relief", "PE") {
    ...
    function mintPhoenix() public payable {
        ...
        require(supply + 1 <= maxPhoenixes, "Purchase would exceed max supply");
    ...
    function mintNPhoenixes(uint total) public payable {
        ...
        uint256 supply = _owners.length;
        require(supply + total <= maxPhoenixes, "Purchase would exceed max supply");
