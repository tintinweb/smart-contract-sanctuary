...
contract SkillCert {
    ...
    function award(bytes32 name, address receiver) public {
        ...
        awarded_certificates[receiver].keys.push(name);
    }
     ...
     */
    function get_certificates_list() public view returns (bytes32[] memory){
        return awarded_certificates[msg.sender].keys;
    }
}