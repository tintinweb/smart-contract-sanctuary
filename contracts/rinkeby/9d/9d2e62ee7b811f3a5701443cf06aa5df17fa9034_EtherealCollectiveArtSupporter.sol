...
contract EtherealCollectiveArtSupporter is ERC721, Ownable {
    ...
    uint256 public collectiblePrice = 0.01 ether;
    uint256 public constant maxCollectiblePerPurchase = 10;
    uint256 public constant maxCollectibles = 10000;
    uint256 public presalePurchaseLimit = 2;
    uint256 public purchaseLimit = 20;
    uint256 public collectibleReserve = 0;
    ...
    function mint(uint256 numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint Demons");
        require(!presaleIsLive, "Only presale");
        require(numberOfTokens > 0 && numberOfTokens <= maxCollectiblePerPurchase, "Can only mint 10 tokens at a time.");
        require(totalSupply().add(numberOfTokens) <= maxCollectibles, "Purchase would exceed max supply of Demons");
    ...
    function presaleMint(uint256 numberOfTokens) external payable {
        ...
        require(totalSupply().add(numberOfTokens) <= maxCollectibles, "Purchase would exceed max supply of Shadows");
