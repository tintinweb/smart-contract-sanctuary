...
//This is the upgraded BoardroomV2 !!! How cool is that ;)
...
contract BoardroomV2 is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 10; // Lock for 6 epochs (36h) before release withdraw
        rewardLockupEpochs = 6; // Lock for 3 epochs (18h) before release claimReward
