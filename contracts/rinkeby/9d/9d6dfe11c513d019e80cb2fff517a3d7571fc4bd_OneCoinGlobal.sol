...
contract OneCoinGlobal is Ownable {
    ...
    */    
        ...
        private
    {
        ...
        /* community total invested amount */
        uint256 community_total_invested = nodes_total_invested - nodes_max_invested;
    ...
    */
    function contractInfo() 
        view 
        external 
        returns(uint256 _total_invested, uint256 _total_investors, uint256 _total_withdrawn, uint256 _total_referral_bonus, uint256 _total_platform_bonus, uint256 _total_crowded_num,uint256[] memory _invest_periods,uint256 _crowd_amount) 
    {
        return (total_invested, total_investors, total_withdrawn, total_referral_bonus, total_platform_bonus, total_crowded_num, invest_period_months, CROWD_LIMIT_AMOUNT);
    }
    ...
    */
    function userInfo(address _addr) 
        view 
        external 
        returns(address _referral, uint256 _referral_num, uint256 _is_crowd, uint256 _payout_token, uint256 _payout_eth, uint256 _referral_bonus, uint256 _match_bonus, uint256 _holder_single_bonus, uint256 _holder_full_bonus) 
    {
        Player storage player = players[_addr];
        uint256 payout = this.payoutOf(_addr);
        uint256 payout_eth = this.payoutEthOf(_addr);
    ...
    */
    function userInfoTotals(address _addr) 
        view 
        external 
        returns(uint256 _total_invested, uint256 _total_withdrawn, uint256 _total_redeem, uint256 _total_referral_bonus, uint256 _total_match_bonus, uint256 _total_holder_full_bonus, uint256 _total_holder_single_bonus, uint256 _total_math_invested,uint256 _total_eth_dividends) 
    {
        Player storage player = players[_addr];
        PlayerTotal storage playerTotal = playerTotals[_addr];
    ...
    */
    function getInvestList(address _addr) 
        view 
        external 
        returns(uint256[] memory ids,uint256[] memory times, uint256[] memory amounts, uint256[] memory totalWithdraws,uint256[] memory endTimes,uint256[] memory statuses) 
    {
        Player storage player = players[_addr];
