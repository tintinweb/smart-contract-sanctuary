    ...
    Initializable
{
    ...
    function finalizeInboundTransfer(
        ...
        {
            bytes memory _inboundCallData;
            (exitNum, _inboundCallData) = GatewayMessageHandler.parseToL1GatewayMsg(_data);

            globalAMPLSupply = abi.decode(_inboundCallData, (uint256));
        }
