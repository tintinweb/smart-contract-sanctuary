...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    constructor(
        ...
        // init VRFConsumerBase properties
        keyHash = _keyHash;
        fee = _fee;

        // init ERC721 properties
        tokenCounter = 0;
    }

    // going to return the requestId for VRF (request randomness)
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        _safeMint(owner, newTokenId); // cannot use msg.sender, because it is always the VRFCoordinator
