...
contract LetsgoNFTMarketFixed is ReentrancyGuard, Ownable {
        ...
        nonReentrant
    {
        ...
        uint256 platformFeeValue = (finalValue * _platformFee) / _mantissa;
        uint256 royaltyValue = (finalValue * royalty) / _mantissa;
        ...
        if (isLetsgoNftContract == true) {
            ...
            if (royaltyValue > 0) {
                nftCreator.transfer(royaltyValue);
            }
        }
