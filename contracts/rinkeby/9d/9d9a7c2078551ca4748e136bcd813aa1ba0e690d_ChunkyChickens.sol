...
// File: contracts/ChunkyChickens.sol
...
contract ChunkyChickens is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateChicken(uint256 indexed id);
    constructor(string memory baseURI) ERC721("ChunkyChickens", "CHKN") {
        setBaseURI(baseURI);
        pause(true);
    }
    ...
    function batchCreate(string[] memory hash_list, uint amount) public {
        require(amount < MAX_BY_MINT, 'amount is less than MAX_BY_MINT');
