...
//commonERC20 is burnable, mintable, and pausable
contract CommonERC20 is DetailedERC20, ReentrancyGuard {
    ...
    function mint(uint256 amount) public OnlyOwner {
        require(amount <= RemainingSupply, "Amount Exceeds Total Supply");
