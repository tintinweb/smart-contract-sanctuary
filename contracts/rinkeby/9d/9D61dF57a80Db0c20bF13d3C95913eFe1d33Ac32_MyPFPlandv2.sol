...
contract MyPFPlandv2 is ERC721Upgradeable {
    ...
    uint256 public transfertest;
    string baseURIForLand;
    uint256 landWidth;
    uint256 landHeight;
    ...
    function claimLand(uint256 x, uint256 y, uint256 collectionID) external payable {
        require(msg.value == 25000000000000000, "invalid amount"); //0.025 ETH
        ...
        _setTokenURI(landTokenBase + assetID, string(abi.encodePacked(baseURIForLand, uint2str(landTokenBase + assetID))));
    ...
    //     super.tokenOfOwnerByIndex(claimer, index);
    ...
    function setBaseURIForLand(string calldata _baseURI) external {
        baseURIForLand = _baseURI;
    }
    ...
    function updateLandRoyalMetaData(uint256 x, uint256 y, uint256 collectionIDOfRoyalMetadata, uint256 tokenID) external {
        ...
        require(super.ownerOf(assetID) == msg.sender, "You are not the owner of this land");
    ...
    function _decodeTokenId(uint256 value) public view returns (uint256 x, uint256 y) {
