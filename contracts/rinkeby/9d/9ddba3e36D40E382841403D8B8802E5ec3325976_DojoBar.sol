...
contract DojoBar is ERC20("DojoBar", "xDOJO") {
    ...
    // Define the Dojo token contract
    constructor(address _dojo) public {
        dojo = IERC20(_dojo);
    }
    ...
    function enter(uint256 _amount) public {
        ...
        // Calculate and mint the amount of xDojo the Dojo is worth. The ratio will change overtime, as xDojo is burned/minted and Dojo deposited + gained from fees / withdrawn.
            ...
            uint256 what = (_amount * totalShares) / totalDojo;
            _mint(msg.sender, what);
        }
        // Lock the Dojo in the contract
        dojo.transferFrom(msg.sender, address(this), _amount);
    }
    ...
    function leave(uint256 _share) public {
        ...
        uint256 what = (_share * (dojo.balanceOf(address(this)))) / totalShares;
