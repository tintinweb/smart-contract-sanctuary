...
contract MONEYINAUTHENTIC1 is ERC721Enumerable, Ownable {
    ...
    // MONEYINAUTHENTIC is a free mint to avoid eroding authenticity by monetizing it 
    ...
    constructor(string memory baseURI) ERC721("MONEY IN AUTHENTIC", "phunkE-MIA")  {
        ...
        // team gets the first 10 MIA NFTS
        // one NFT for each of the 10 background colors 
        _safeMint( t1, 0);
        _safeMint( t1, 14);
        _safeMint( t1, 33);
        _safeMint( t1, 42);
