...
//TODO joren: claim only 1
//TODO joren: don't be able to mint a giveaway pass
...
contract CritterPasses is ERC1155Burnable, Ownable  {
    ...
    struct Pass {
        ...
        bytes32 merkleRoot;
        mapping(address => uint256) addressClaimed;
    ...
    */
    function mint(uint256 passID, uint256 amount, address to) external onlyOwner {
        ...
        require(passes[passID].totalSupply + amount <= passes[passID].maxSupply, "Mint: Max supply reached");
    ...
    */
    function claim(
        ...
        passes[passId].addressClaimed[msg.sender]++;
