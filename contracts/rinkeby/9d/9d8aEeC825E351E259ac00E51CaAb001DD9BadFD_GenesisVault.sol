...
contract GenesisVault is TokenVault, ContractGuard {
    ...
    address private peg; //LFBTC
    address private share; //LIFT
    address private ideaFund; //Where the LP goes
    address private lfbtcliftLPPool; // where the stakers get LP staked
    ...
    function beginGenesis() onlyOperator onlyOnce public {
        ...
        address pairTo = IUniswapV2Factory(router.factory()).createPair(peg, share);
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        //SUSHI SWAP PAIR CODE HASH - e18a34eb0e04b04f7a0ac29a6e80748dca96319b42c54d679cb821dca90c6303
                        // UNI  SWAP PAIR CODE HASH - 96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f
                    )
                )
            )
        );
