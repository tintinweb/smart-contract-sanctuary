...
contract GrailzNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // Allow OpenSea to approve; remove gas fee for listers
    ...
    // # # # # # # # # # # #
    // # # # # # # # # # # #
    constructor(string memory name, address _proxyRegistryAddress, string memory baseURI) ERC721(name, name) {
        proxyRegistryAddress = _proxyRegistryAddress;
        setBaseURI(baseURI);
    }
