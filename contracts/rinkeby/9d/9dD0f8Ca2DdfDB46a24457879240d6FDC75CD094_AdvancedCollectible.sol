...
contract AdvancedCollectible is ERC721URIStorage, VRFConsumerBase {
    // set variables for random number calls
    bytes32 keyhash;
    uint256 fee;
    // set token counter
    ...
    mapping(uint256 => BREED) public tokenIdToBreedMap;
    mapping(bytes32 => address) public requestIdToSenderMap;
    mapping(bytes32 => uint256) public requestIdToTokenIdMap;
        ...
        override
    {
        ...
        tokenIdToBreedMap[newTokenId] = breed;
        emit breedAssigned(newTokenId, breed);
        address owner = requestIdToSenderMap[_requestId];
        requestIdToTokenIdMap[_requestId] = 4;
