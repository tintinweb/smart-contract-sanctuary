    ...
    ContextMixin
{
    ...
    constructor(
        ...
        _setupContractId("NetVRKRootLand");
        ...
        only(PREDICATE_ROLE)
    {
        ...
        _setTokenURI(
            tokenId,
            string(abi.encodePacked(baseUrl, _uint2str(tokenId)))
        );
    }
    ...
    /**
     * @dev Set baseUrl
     * @param baseUrl_ new baseUrl
     */
    function setBaseURI(string calldata baseUrl_)
        external
