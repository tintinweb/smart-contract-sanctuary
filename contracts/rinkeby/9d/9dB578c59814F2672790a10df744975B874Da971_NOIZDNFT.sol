...
contract NOIZDNFT is ERC721, ERC721URIStorage, Ownable
{
  ...
  */
  ...
  {
    string memory deployedAddress = addressToString(address(this));
    return string(abi.encodePacked("http://localhost:8888/api/v1/metadata/", deployedAddress, "/"));
  }
