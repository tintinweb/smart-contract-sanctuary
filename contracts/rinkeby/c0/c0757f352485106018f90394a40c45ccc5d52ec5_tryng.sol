...
contract tryng is ERC721, Ownable {
    ...
    uint256 public constant MAX_CUPCAT = 30;
    uint public cupcatReserve = 10;
    ...
    constructor() ERC721("TRYNG", "TRYNG") { }
    ...
    function reserveCupcat(address _to, uint256 _reserveAmount) public onlyOwner {        
        ...
        require(_reserveAmount > 0 && _reserveAmount <= cupcatReserve, "Not enough reserve left for team");
    ...
    function tokensOfOwner(address _owner) external view returns(uint256[] memory ) {
      ...
      function mintCupCat(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxCupCatPurchase, "Can only mint 9 tokens at a time");
