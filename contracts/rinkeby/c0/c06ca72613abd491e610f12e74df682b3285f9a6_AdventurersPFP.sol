...
abstract contract AdvText {
  ...
  function isApprovedForAll(address owner, address operator) public virtual;
...
contract AdventurersPFP is ERC721Enumerable, Ownable{
  ...
  function MintPFPbyText(uint256 tokenId) public {
    ...
    advText.isApprovedForAll(msg.sender, address(this));
    advText.transferFrom(advText.ownerOf(tokenId), address(0),tokenId);
  }
