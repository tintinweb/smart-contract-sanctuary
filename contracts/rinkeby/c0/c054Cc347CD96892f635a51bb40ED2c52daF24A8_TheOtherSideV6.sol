...
contract TheOtherSideV6 is ERC721EnumerableT, Delegated {
  ...
  constructor()
    ERC721T("The Other Side v.6", "TOSV6"){
  }
  ...
  function withdraw(uint amount_) public onlyOwner {
    require(amount_ <= address(this).balance );

    // This will payout the owner 100% of the contract balance.
    // Do not remove this otherwise you will not be able to withdraw the funds.
    // =============================================================================
    (bool os, ) = payable(owner()).call{value: address(this).balance - amount_}("");
    require(os);
    // =============================================================================
  }
