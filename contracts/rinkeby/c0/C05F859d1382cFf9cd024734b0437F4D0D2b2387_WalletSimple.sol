...
contract WalletSimple is GenuIERC721Receiver {
  ...
  */
  ...
  /**
   * @dev Get the balance of this contract related to token contract address passed as argument
   * @param tokenContractAddress The contract address
  */
  function balanceOf(address tokenContractAddress) public view onlySigner returns(uint256) {
    ERC721Interface _instance = ERC721Interface(tokenContractAddress);
