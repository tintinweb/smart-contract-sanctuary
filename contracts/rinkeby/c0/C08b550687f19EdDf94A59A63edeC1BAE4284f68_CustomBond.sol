...
// Forked from the original Olympus CustomBond // https://etherscan.io/address/0x4CBD58469c964F999A380fD8180e1C645De35801#code
// Changes:
// 1. Name changes
// 2. Fix potential overflow
// 3. Remove unused variables
// 4. Remove treasury fees
// 5. Remove vesting, and stake on bond
// 6. Remove subsidy
contract CustomBond is Policy {
    ...
    function debtRatio() public view returns ( uint debtRatio_ ) {
        debtRatio_ = FixedPoint.fraction(
            currentDebt().mul( (uint)(10) ** payoutToken.decimals() ),
            payoutToken.totalSupply()
        ).decode112with18().div( 1e18 );
    }

    /**
     *  @notice return total debt
     *  @return uint
     */
