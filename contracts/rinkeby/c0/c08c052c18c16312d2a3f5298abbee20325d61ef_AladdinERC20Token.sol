...
contract AladdinERC20Token is Divine {
  ...
  using SafeMath for uint256;
    ...
    uint public PresalePrice = 200; // 1 BNB = PresalePrice Aladdin;
    uint public _floorbuyprice = 10000000000000000; // 0.01 BNB
    uint public _upperbuyprice =  10000000000000000000; // 10 BNB
    ...
    function buy() payable public returns(uint) {
        ...
        uint _payAmount = msg.value.mul(PresalePrice).div(1e18).mul(1e9); // pay attention to decimals
        _mint(msg.sender, _payAmount);
        return _payAmount;
    }
