...
contract Attention2476 is AdminControl, ERC1155Receiver{
    ...
    */
    ...
    /**
     * Retrieve all project name by index.
     */
    function getProjectsByIndex(uint index) public view returns (string memory project){
...
contract Token2476 is ERC1155Supply, Ownable, ERC1155Pausable, ERC1155Burnable{
    ...
    */
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(WALLET2476).send(dev*49));
