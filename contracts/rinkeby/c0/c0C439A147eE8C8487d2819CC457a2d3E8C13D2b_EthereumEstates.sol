...
contract EthereumEstates is ERC721, Ownable, ReentrancyGuard {
  ...
  uint256 public constant Ethereum_Estates_PRICE = 0.05 ether;
  ...
  function presaleMint(uint256 _quantity) external payable nonReentrant {
    ...
    require(_quantity <= MAX_Ethereum_Estates_WHITELIST_CAP, "You can only mint a maximum of 2 for presale");
