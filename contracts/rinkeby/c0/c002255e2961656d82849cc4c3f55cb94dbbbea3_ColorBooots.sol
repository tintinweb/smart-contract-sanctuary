...
contract ColorBooots is ERC721, ERC721Enumerable, Ownable {
  
  // Provenance
  string public COLORBOTS_HASH = "";

  // Price & Supply
  uint256 public constant NFT_PRICE = 10000000000000000; //0.01 ETH
  uint256 public constant NFT_5PRICE = 1000000000000000; //0.001 ETH
  uint public constant MAX_SUPPLY = 1000;
  uint public CrowReserve = 3;
  ...
  constructor(string memory baseURI) ERC721("ColorBooots", "CRB") {
    setBaseURI(baseURI);
  }
