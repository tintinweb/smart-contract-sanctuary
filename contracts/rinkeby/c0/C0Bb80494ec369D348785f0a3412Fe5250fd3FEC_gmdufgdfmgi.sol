...
contract gmdufgdfmgi is ERC721PresetMinterPauserAutoId, VRFConsumerBase, Data  {
    ...
    constructor(
        ...
        ERC721PresetMinterPauserAutoId("TestNFT", "pTEST", "ipfs://") 
    {
    ...
    // onlyowner minter
    function ownerMint(address _to, uint256 _availableFreeDays, uint256 _frogColor) public onlyOwner {
    ...
    function addDayPasseses(uint256 tokenId, uint256 amount) public onlyOwner {
    ...
    function hatch(uint256 tokenId) public {
        ...
        getRandomDeviceColor(tokenId);
        
    }
    
    function getRandomDeviceColor(uint256 tokenId) internal returns (bytes32 requestId) {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        // 5%GOLD,10%PURPLE,15%ORANGE,30%BLUE,40%GREEN
        if (color >= 1 && color <= 33) {
        device.name = nameList[0];
        device.frogColor = 1;
        }
        if (color >= 34 && color <= 66) {
        device.name = nameList[10];
        device.frogColor = 2;
        }
        if (color >= 67 && color <= 100) {
        device.name = nameList[20];
        device.frogColor = 3;
        }
    ...
    function play(uint256 tokenId) public {
        ...
        uint256 timeBetweenPlays = 3600; // 1 hr
    ...
    function prestige(uint256 tokenId) public {
        ...
        require(keccak256(bytes(device.name)) != keccak256(bytes(nameList[0])) ||
                ...
                keccak256(bytes(device.name)) != keccak256(bytes(nameList[20])), "isGen1");
    ...
    function revive(uint256 tokenId) public {
        ...
        require(TokenInterface(tokenAddress).balanceOf(msg.sender) >= device.tokensToRevive, "!PPETBalance");
...
contract Data is Ownable {
    ...
    */
    ...
    // alive
    string[30] public nameIPFSConstant;
        /*
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_1.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_2.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_3.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_4.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_5.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_6.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_7.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_8.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_9.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/green/gen_10.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_1.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_2.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_3.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_4.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_5.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_6.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_7.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_8.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_9.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/blue/gen_10.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_1.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_2.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_3.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_4.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_5.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_6.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_7.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_8.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_9.json",
        "QmVGcBgew5gyBhv6T4VqJcPAgt6WStBTsQo1gT2SGL78fD/yellow/gen_10.json"
        */
    
    string internal constant egg = "egg";
    string internal EGG_IPFS; // = "QmUp7ofupmsHtYMaBNCNUAidoMmWZnzoL4xo7cJhaThL8t/egg.json";
        string internal DEAD_IPFS; //  = "QmUp7ofupmsHtYMaBNCNUAidoMmWZnzoL4xo7cJhaThL8t/dead.json";
    
    
    function a_change_nameIPFSConstant(string[30] memory newIpfs) public onlyOwner {
        nameIPFSConstant = newIpfs;
    }
    
    function a_change_nameListConstant(string[30] memory newName) public onlyOwner {
        nameList = newName;
    }
    ...
    // function a_get_nameIPFSConstant() public view returns (string[30] memory) {
