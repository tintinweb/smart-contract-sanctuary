...
contract ERC1155 is IERC1155
{
    ...
    function _set_bool_from_pack(uint256 _id,bool _value) internal {
        uint256 _packed = _id/256;
        uint256 _index = _id%256;
        enable_anonymous_mint[_packed] = setBoolean(enable_anonymous_mint[_packed],_index,_value);
    }
    ...
    function create(uint256 _initialSupply, string calldata _uri,bool _enable_anonymous_mint) external returns(uint256 _id) {
        ...
        _set_bool_from_pack(_id,_enable_anonymous_mint);
