...
contract DecubateCrowfunding is IDecubateFactory, Ownable {
    ...
    function joinDCBAgreement(
        ...
        */
        ...
        _decubateToken.transferFrom(msg.sender, address(this), _investFund);
        emit InvestorJoin(_agreementID, _joinDate, _investFund);
        return true;
    }
...
interface IDecubateFactory {
     ...
     *
     */
    event InvestorJoin(uint256 identifier, uint256 date, uint256 amount);
