...
contract DemonicryptoSkulls is ERC721URIStorage, Pausable, Ownable {
    ...
    event UpdatedTokenPrice(uint256 oldPrice, uint256 newPrice);

    event PermanentURI(string value, uint256 indexed id);

    constructor() ERC721("MyNFT", "MFT") {
        // tokenPrice = 0.066 ether;
    ...
    function mint() public payable {
        ...
        require(
            _tokenCounter.current() < MAX_TOKENS,
    ...
    function setTokenPrice(uint256 newTokenPrice) public onlyOwner {
        ...
        emit UpdatedTokenPrice(oldTokenPrice, newTokenPrice);
    }
