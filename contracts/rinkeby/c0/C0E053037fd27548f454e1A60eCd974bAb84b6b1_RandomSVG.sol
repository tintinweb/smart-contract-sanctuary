...
contract RandomSVG is ERC721URIStorage, VRFConsumerBase, Ownable {
        ...
        VRFConsumerBase(_vrfCoordinator, _linkToken)
    {
        ...
        price = 100000000000000000; // 0.1 * 10**18
    ...
    function create() public payable returns (bytes32 requestId) {
        ...
        // get a random number
        // use that random number to generate some random SVG
        // base64 encode the SVG code
        // get the tokenURI and mint the NFT

        // Contract must be funded with Link
        ...
        returns (string memory finalSvg)
    {
        ...
        for (uint256 i = 0; i < maxNumberOfPaths; i++) {
        ...
        returns (string memory pathSvg)
    {
        uint256 numberOfCommands = (_randomNumber % maxNumberOfPathCommands) +
            1;
        pathSvg = "<path d='";
        for (uint256 i = 0; i < maxNumberOfPathCommands; i++) {
        ...
        returns (string memory)
    {
        ...
        // Concatination of baseURL and svgBase64Encoded
