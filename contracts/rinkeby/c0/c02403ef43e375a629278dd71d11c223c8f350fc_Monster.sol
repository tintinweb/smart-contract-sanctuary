...
contract Monster is ERC721 {
    ...
    function mintMonster() private{
        ...
        set_points(_next_monster, divide_points, professions[rand % professions.length]);
    ...
    function set_points(uint _next_monster, uint8[] memory _divide_points, uint8 _suffix) private{
