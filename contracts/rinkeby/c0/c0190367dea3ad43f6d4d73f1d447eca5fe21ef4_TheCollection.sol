...
contract TheCollection is ERC1155, Ownable, Pausable {
    ...
    string public constant name = "Collection Name for OpenSea"; // gets overriden by contract metadata, but adding for redundancy
    string public constant symbol = "TOK";
    string private constant _tokenBaseURI = "ipfs://QmcnD1bWTGBgf971SYyAXWcTPL2NmiapLuLSynX2Qt5L35/";
    string private constant CONTRACT_URI = "https://raw.githubusercontent.com/jeffreyscholz/nft-metadata/main/metadata1155/contract_metadata.json"; // will change to IPFS in prod
