    ...
    OwnableUpgradeable
{
    ...
    modifier onlyOwnerOrSeason() {
        require(
            (owner() == _msgSender()) || (_msgSender() == seasonAddress),
            "Ownable: caller is not the owner or season"
        );
        _;
    }
    ...
    function setSeasonAddress(address addr) public {
        seasonAddress = addr;
    }
    ...
    function setRandomSeed(string memory seed) public onlyOwnerOrSeason {
        // require(seasonAddress != 0x0000000000000000000000000000000000000000, "Season address not set");
        seedSet = true;
        randomSeed = seed;
    }
