...
contract verserer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "verserer";
    string private constant _symbol = "vers";
    ...
    address payable public marketingWallet = payable(0xB763828C50823C090f00D22022e1430D1BD2056F);
    address payable public treasury = payable(0xB763828C50823C090f00D22022e1430D1BD2056F);
