...
contract OnChainMonkey is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 500 500"><rect x="0" y="0" width="500" height="500" style="fill:#',
    ...
    '"/><circle cx="135" cy="312" r="37.5" style="fill:#', '"/><circle cx="135" cy="312" r="15" style="fill:#', '"/><circle cx="365" cy="312" r="37.5" style="fill:#',
    '"/><circle cx="365" cy="312" r="15" style="fill:#', '"/><circle cx="250" cy="312" r="112.5" style="fill:#', '"/><circle cx="250" cy="312" r="90" style="fill:#',
    '"/><circle cx="210" cy="285" r="35" style="fill:#fff"/><circle cx="295" cy="292" r="31" style="fill:#fff"/><circle cx="210" cy="290" r="20" style="fill:#',
    '"/><circle cx="290" cy="290" r="20" style="fill:#', '"/><circle cx="210" cy="290" r="7" style="fill:#000"/><circle cx="290" cy="290" r="7" style="fill:#000"/>',
    ...
    '</svg>'];
  string private cross='<rect x="135" y="325" width="10" height="40" style="fill:#872"/><rect x="125" y="335" width="30" height="10" style="fill:#872"/>';
  string private clo1='<rect width="225" height="90" x="99" y="400" style="fill:#';
  string private clo2='"/><rect width="37.5" height="35" x="280" y="430" style="fill:#';
  string private hh1='<rect width="200" height="99" x="150" y="162" style="fill:#';
  string private hh2='"/><rect width="200" height="33" x="150" y="228" style="fill:#';
  string private sl1='<rect x="174" y="265" width="152" height="25" style="fill:#';
  string private sl2='"/><rect x="180" y="230" width="140" height="40" style="fill:#';
  string private mou='<line x1="267" y1="371" x2="300" y2="406" style="stroke:#000;stroke-width:4"/>';
  string private ey1='<rect x="178" y="268" width="65" height="12" style="fill:#';
  string private ey2='"/><rect x="265" y="268" width="60" height="12" style="fill:#';
  string private ey3='<rect x="170" y="302" width="160" height="25" style="fill:#';
  string private zz='"/>';
