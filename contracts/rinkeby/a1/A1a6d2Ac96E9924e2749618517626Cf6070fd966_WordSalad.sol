    ...
    ERC721Pausable
{
    ...
    mapping(bytes32 => uint256) private _phraseIdTokens;

    mapping(uint256 => bytes32) private _tokenPhraseIds;
    ...
    function tokenIdToPhraseId(uint256 tokenId) public view returns (bytes32) {
        ...
        return _tokenPhraseIds[tokenId];
    }
    ...
    function phraseIdToTokenId(bytes32 phraseId) public view returns (uint256) {
        uint256 tokenId = _phraseIdTokens[phraseId];
    ...
    function mint(string memory _word1, string memory _word2, string memory _word3) public payable {
        ...
        require(_phraseIdTokens[phraseId] == 0, "phrase already minted");
        uint256 tokenId = _tokenIdTracker.current();
        _phraseIdTokens[phraseId] = tokenId;
        _tokenPhraseIds[tokenId] = phraseId;
        _mint(receiver, tokenId);
        _tokenIdTracker.increment();
        emit Mint(_word1, _word2, _word3, phraseId, tokenId);
    }
