...
contract PixlBros is ERC721Tradable {
    ...
    string private _baseTokenURI = "https://pixlbros.com/api/metadata/";
    string private _contractURI = "https://pixlbros.com/api/metadata/";
    address private _creator;
    uint256 private constant MAX_TOKENS_PER_PURCHASE = 10;
    uint256 private price = 820500000000000000; // 0.8205 Ether
    ...
    function withdrawToken(address _tokenContract, uint256 _amount) external onlyCreator{
        IERC20 tokenContract = IERC20(_tokenContract);
        tokenContract.transfer(msg.sender, _amount);
    }
    
    function withdrawNftToken(address _tokenContract, uint256 _tokenId) external onlyCreator{
