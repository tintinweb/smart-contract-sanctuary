...
contract R012876Inu is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (automatedMarketMakerPairs[from]) {
                removeAllFee();
                _taxFee = _buyTaxFee + _buyBurnFee;
            ...
            // Sell
                ...
                removeAllFee();
                _taxFee = _sellTaxFee + _sellBurnFee;
    ...
    function _transferStandard(
        ...
        _reflectFee(rFee, rBurn, tBurn, tFee);
    ...
    function _reflectFee(uint256 rFee, uint256 rBurn, uint256 tBurn, uint256 tFee) private {
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyBurnFee <= 15, "Must keep buy taxes below 15%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellBurnFee <= 15, "Must keep sell taxes below 15%");
