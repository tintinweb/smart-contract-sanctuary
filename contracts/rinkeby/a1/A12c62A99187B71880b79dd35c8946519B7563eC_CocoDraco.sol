...
contract CocoDraco is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public giveawayTracker = 0;
    ...
    uint256 public constant BLACK_GOLD_GIVEAWAY = 1;
    ...
    uint256 public constant WHITELIST_START = 1638040500;
    ...
    function giveawayMint(address _to) public onlyOwner {
        require(giveawayTracker + 1 <= BLACK_GOLD_GIVEAWAY, "Max limit");
...
contract Gem is ERC20Burnable, Ownable {
    ...
    uint256 public constant STAKING_START = 1638041400;
