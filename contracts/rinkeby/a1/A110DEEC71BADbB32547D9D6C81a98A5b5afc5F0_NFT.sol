...
contract NFT is ERC721, ERC721Enumerable, Ownable {
    ...
    function mint() public payable {
        ...
        // TODO: use better check with build in functions instead of mintAmount
        require(mintAmount[msg.sender] < nftPerAddressLimit, "Max amount of tokens per address reached");
    ...
    /// Set a new max limit per address
    ...
    /// set enabling of only whitelisted users
    function setOnlyWhitelisted(bool _state) public onlyOwner {
        onlyWhitelisted = _state;
    }

    /// set whitelisted access to the contract
    ...
    // Overrides for combined ERC721 and ERC721Enumerable support
