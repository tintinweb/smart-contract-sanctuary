...
contract RandomCollectorSelector is Ownable, VRFConsumerBase
{
    ...
    string _ipfsGiveawayData = "https://gateway.pinata.cloud/ipfs/Qmb57tbacQMgFZbkw6uMmhM6wmGAxj19CBi5UjF2zPyxH8";
    ...
    function addGiveawayData(string memory ipfsString) external onlyOwner 
    { 
        ipfsGiveawayData.push(ipfsString); 
    }    
