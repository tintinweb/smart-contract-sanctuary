...
contract ONCHAINTIMEPIECES is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("ONCHAINTIMEPIECES", "OCTP") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://mainnet-test.s3.amazonaws.com/assets/";
    }
