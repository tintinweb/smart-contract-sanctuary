...
contract AdminUpgradeabilityProxy is UpgradeabilityProxy {
     ...
     * This is the keccak-256 hash of "speedProp03170002.proxy.admin", and is validated in the constructor.
     */
    bytes32 private constant ADMIN_SLOT = 0x10ad94dce539492cade9deb16949270b4bfb2283f1f4d9cb8e8065d044371e61;
    /**
    ...
    constructor(address _implementation) UpgradeabilityProxy(_implementation) public {
        assert(ADMIN_SLOT == keccak256("speedProp03170002.proxy.admin"));
...
**/
    function contProxyVersion20210317011() external view returns (string) {
        return "20210317011.proxy.0001" ;
    }
