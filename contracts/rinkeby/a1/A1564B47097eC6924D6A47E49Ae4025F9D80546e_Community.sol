...
contract Community is ICommunity {
        ...
        override
    {
        ...
        require(
            !communities[_communityID].isMember[_newMemberAddr],
        ...
        communities[_communityID].members[_communityCount] = _newMemberAddr;
        communities[_communityID].isMember[_newMemberAddr] = true;
    ...
    function publishProject(
        ...
        communities[_communityID]
            .projectDetails[_project]
            .repaymentEndDate = _projectDetails[1];
        communities[_communityID]
            .projectDetails[_project]
            .investmentNeeded = _projectDetails[2];
