...
contract Packs is IPacks, ERC721, ReentrancyGuard {
  ...
  function mint() public override payable nonReentrant {
    ...
    require((freeClaim && block.timestamp > ds.saleStartTime - 600) || (block.timestamp > ds.saleStartTime), "Sale has not yet started");
...

{
  ...
  "libraries": {
    "contracts/LibPackStorage.sol": {
      "LibPackStorage": "0x45702d2ed312df59dd9b5844bc9ba1f24d51c8bf"
    }
  }
}