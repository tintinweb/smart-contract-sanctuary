...
contract CyBlocGeneScientist {
    ...
    function parseGene(uint256 gene) public pure returns (uint256 class, uint256[3] memory traits) {
        ...
        uint256 trait0 = _sliceNumber(gene, (numOfDigist * 8), (numOfDigist * 2));
        uint256 trait1 = _sliceNumber(gene, (numOfDigist * 4), (numOfDigist * 6));
        uint256 trait2 = _sliceNumber(gene, 0, (numOfDigist * 10));

        return (class, [trait0, trait1, trait2]);
    }
