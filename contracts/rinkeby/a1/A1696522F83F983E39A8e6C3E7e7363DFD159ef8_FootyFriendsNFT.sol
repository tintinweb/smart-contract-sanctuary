...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    bool public useBaseExtension = false;
    ...
    function safeMintTo(address _to) internal returns (uint256) {
        uint256 newTokenId = _getNextTokenId();
    ...
    function setUseBaseExtension() public onlyOwner {
        useBaseExtension = !useBaseExtension;
    }

    function baseTokenURI() virtual public view returns (string memory);

    function notRevealedURI() virtual public view returns (string memory);
...
// File: contracts/FootyFriends.sol
 ...
 */
contract FootyFriendsNFT is ERC721Tradable {

    using SafeMath for uint256;
    bool public preSaleIsActive = true;
    bool public saleIsActive = false;
    address constant WALLET1 = 0x7BEEd3e73f97C1e2891e844b3134E86E111123d6;
    address constant WALLET2 = 0x833B0cBee7E6e63303C516574B37E498f873D2E6;
    ...
    function createWhitelistedAddresses(address[] calldata _users) public onlyOwner {
    ...
    function isWhitelisted(address _address)
        ...
        returns (bool)
    {
        if (preSaleIsActive && preSalePhase == 0) {
            (bool _isWhitelisted ) = isWhitelistedByAddress(_address);
    ...
    function notRevealedURI() override virtual public view returns (string memory) {
    ...
    function setPreSalePhase(uint8 _phase) public onlyOwner {
        // 0 = wl addresses, 1 = mintpasses, 2 = wl contracts
        require(_phase == 0 || _phase == 1 || _phase == 2, "Invalid presale phase.");
        preSalePhase = _phase;
    }
    ...
    function mint(uint _quantity) public payable {
        ...
        if(preSaleIsActive && !saleIsActive) {
            ...
            if (preSalePhase == 0) {
                require(isWhitelistedByAddress(msg.sender), "You are not whitelisted.");
                require(
                    minters[msg.sender].hasMintedByWhitelist.add(_quantity) <=
                        maxPerWallet,
...
//            mintTo(msg.sender);
            safeMintTo(msg.sender);
        }
    }

    function withdraw() external onlyOwner {
        uint256 balance = address(this).balance;
        uint256 wallet1Balance = balance.mul(30).div(100);
        uint256 wallet2Balance = balance.mul(20).div(100);
