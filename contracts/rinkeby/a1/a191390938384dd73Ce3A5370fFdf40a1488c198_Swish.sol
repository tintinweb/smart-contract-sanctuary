...
contract Swish is ERC721, ERC721Burnable, Ownable {
    ...
    // Settings
    string public baseUri = "https://api.swishdreamsnft.com";
    ...
    uint256 public maxAccesslist = 1000;
    ...
    */
    function mint(uint256 amount) public payable {
        ...
        if(accesslistSale) {
            require(Accesslist[msg.sender], "Only accesslist minters.");
        }
    ...
    function addToAccesslist(address[] memory accesslist, uint256 total) public onlyOwner {
    ...
    */
    function withdraw() public payable onlyOwner {
        ...
        uint256 taylorPay = (address(this).balance / 1000) * 415;
        uint256 gregPay = (address(this).balance / 1000) * 415;
        uint256 communityPay = (address(this).balance / 100) * 2;

        // Payouts
        require(payable(sara).send(saraPay));
        require(payable(taylor).send(taylorPay));
        require(payable(greg).send(gregPay));
