    ...
    OwnableUpgradeable
{
    ...
    /**
      ...
      @param _seriesSize Number of editions that can be minted in total. If 0, unlimited editions can be minted.
    ...
    // CompilerError: Stack too deep when compiling inline assembly: Variable length is 1 slot(s) too deep inside the stack.
    // /// @dev returns the publisher of nft
    // function getPublisher() public view returns (string memory) {
    //     return publisher;
    // }
    /**
        Simple eth-based sales function
        More complex sales functions can be implemented through IUpbondNFTMintable interface
     */
    ...
    function numberCanMint() public view override returns (uint256) {
        ...
        return seriesSize + 1 - atEditionId.current();
    }
        ...
        returns (uint256)
    {
        ...
        require(seriesSize == 0 || endAt <= seriesSize, "Sold out");
    ...
    */
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        return type(IERC165Upgradeable).interfaceId == interfaceId ||
...
contract UpbondNFTMintableCreator {
    ...
    /// @param _seriesSize Total size of the edition (number of possible editions)
    function createAsset(
        ...
        UpbondNFTMintable(newContract).initialize(
            msg.sender,
            _name,
            _symbol,
            _description,
        ...
        emit CreatedAsset(newId, msg.sender, _seriesSize, newContract);
