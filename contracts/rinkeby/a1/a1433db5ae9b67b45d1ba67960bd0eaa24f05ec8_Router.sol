...
contract Router {
    ...
    event ExactInput(address indexed sender, address indexed recipient, string indexed customId, uint256 amountIn, uint256 amountOut);
    event ExactOutput(address indexed sender, address indexed recipient, string indexed customId, uint256 amountIn, uint256 amountOut);
