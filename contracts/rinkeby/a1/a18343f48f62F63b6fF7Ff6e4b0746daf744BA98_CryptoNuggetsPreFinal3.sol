...
contract CryptoNuggetsPreFinal3 is ERC721, Ownable, IMintedBeforeReveal {
    ...
    function mint(uint256 numberOfMonstro) public payable {
        ...
        require(numberOfMonstro <= getMonstroMaxAmount(), "You are not allowed to buy this many items at once.");
