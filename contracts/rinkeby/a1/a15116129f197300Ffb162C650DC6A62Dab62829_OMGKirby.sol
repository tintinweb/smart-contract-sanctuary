...
contract OMGKirby is ERC721, Ownable {
  ...
  function presaleMint(uint256 _mintAmount, string memory _presaleCode) public payable {
    require(presaleActive, "Sale has not started yet.");
    require(_mintAmount > 0, "Quantity cannot be zero");
    require(_mintAmount <= maxMintAmount, "Exceeds the max quantity per wallet");
