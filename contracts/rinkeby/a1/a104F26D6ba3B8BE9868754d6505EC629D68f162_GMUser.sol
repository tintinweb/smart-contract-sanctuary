...
contract GMUser is IGMUser, AccessControl {
    ...
    function userPermissions(address user) external view override returns (bool isTrader, bool isCreator) {
        isTrader = hasRole(TRADER, user);
        isCreator = hasRole(CREATOR, user);
    }
