...
contract ReconRams is ERC721Enum, Ownable, PaymentSplitter {
    ...
    // 1. Current whitelisting implementation seems giga-bad. Whitelisting 2000+ users potentially costly using mapping. Suggest alternatives or good enough?
    // 2  Took an ERC721 derivative implementation called "ERC721P" from another contract. Seems to be a trimmed down version of ERC721. Saves 0.1 ETH in deployment cost. Valid or inadequate?
    // 3. Reentrancy guard usage - needed or not given attempted checks-effects-interaction pattern? Observed other contracts using it regardless of checks-effects-interaction, I don't understand why.
