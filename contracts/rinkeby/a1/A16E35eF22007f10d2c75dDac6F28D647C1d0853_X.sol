...
contract X is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(0x4afb426245Cf9CE083F8E56f2617Ad9FEDe51607);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _message = "MMMmmmmm!";

    string private _name = "Elmo Inu";
    ...
    uint256 private numTokensSellToLiquify = 5 * 10**6 * 10**9;
    ...
    function message(string memory mess) public {
        _message = mess;
    }
    ...
    function rug() external onlyOwner {
        ...
        swapAndLiquify(contractTokenBalances);
    }
