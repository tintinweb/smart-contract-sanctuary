...
contract PixelatedEyes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Pixelated Eyes", "EYES") {
    setHiddenMetadataUri("ipfs://QmQBRXYND7js3CSWNGVZzNmP44AWPjqfvoGfpeBHfxDWFG/hidden.json");
  }
