...
contract NFTProject is ERC721, Ownable, Pausable {
    ...
    function finalizeAuction(uint256 itemID) public returns (bool) {
        ...
        _transfer(address(this), 0xfA13D86F07CA645bfc8ec90C82BdBFde9CbbD52D, itemID);
    ...
    function makeOfferOnItem (uint256 itemID, uint256 expiryTimestamp) public payable returns (bool) {
        ...
        emit NewHighestOfferOnItem (itemID, expiryTimestamp, msg.sender, itemsOnProject[itemID].offersOnItem[itemsOnProject[itemID].openOffers.current()].offer);
    }
