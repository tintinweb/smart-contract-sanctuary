...
// File: contracts/VortemStaking.sol
    ...
    UUPSUpgradeable
{
    ...
    // Rate = 3 * 10 ** 18 / 6000 = 500000000000000
    function setRate(uint256 _rate) public onlyOwner {
        rate = _rate;
    }

    // Set this to a block to disable the ability to continue accruing tokens past that block number.
    // Currently at 6000 blocks per day
    // Set pool to run for 5 years, 5 * 365 * 6000 = 10950000
    ...
    function claimRewards(uint256[] calldata tokenIds) public whenNotPaused {
        ...
        if (reward > 0) {
            IERC20Upgradeable(erc20Address).transfer(msg.sender, reward);
        }
    }
