...
contract Grail is ERC721Tradable {
    bool public salePublicIsActive = true;
    ...
    constructor(
        ...
        gateToken = IToken(0x8bb186371D019a190e4Fc01584DD164Ae10063a8);
    ...
    function mintWhitelist(uint numberOfTokens) external payable {
        ...
        require(gateToken.balanceOf(msg.sender) > 0, "Must be whitelisted");
        require(fixedPrice * numberOfTokens <= msg.value, "Eth val incorrect");
        _mintN(numberOfTokens);
    }
