...
// File: contracts\JJCatNotice.sol
...
contract JJCatNotice is ERC721URIStorage, Pausable, Ownable {
    // JJCat Notice

    constructor() ERC721("JJCatNotice", "JJC") {}

    function mint(address player, uint256 tokenId)
    public onlyOwner
    returns (uint256)
