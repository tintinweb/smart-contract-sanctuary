...
contract HeritageModule is Module {
        ...
        onlyHeir
    {
        ...
        IERC20 toDepositToken = IERC20(ERC20DepositAddress);
        uint256 depositedAmount = toDepositToken.balanceOf(address(manager)) + ERC20AlreadyDepositedAmount;
        require(depositedAmount >= ERC20ToDepositAmount, "Deposit not completed");
        readyToInherit = 0;
