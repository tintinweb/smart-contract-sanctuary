...
contract TestArthPool is AccessControl, IARTHPool {
    ...
    address public fund = address(0x0cc7fB3626C55Ce4EfF79045E8E7CB52434431D4);
    ...
    function repay(uint256 amount) external override onlyAMOS {
        ...
        function calcOverCollateralizedMintAmounts() public view returns (uint256 ,uint256) {
    

    }

    function checkup(uint256 collateralAmount) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    //1000000-100000 ==> 900000
     ...
     (uint256 arthAmountD18, uint256 arthxAmountD18) =
            ArthPoolLibrary.calcOverCollateralizedMintAmounts(
                collateralRatio,
                algorithmicRatio,
                getCollateralPrice(), //500000
                _arthController.getARTHXPrice(), //9999 
                collateralAmountD18);

    return (collateralAmountAfterFees,collateralAmountD18,cr,algorithmicRatio,collateralRatio,arthAmountD18,arthxAmountD18);
    ...
    function mint(
        ...
        uint256 collateralAmountAfterFees = (collateralAmount.mul(uint256(1e6).sub(_arthController.getMintingFee()))).div(1e6);
        //999999.5 for 1000000 col amount
        uint256 collateralAmountD18 = collateralAmountAfterFees * (10**_missingDeciamls);
        //999999.5 * 1000000000000
        //999999500000000000
        uint256 cr = _arthController.getGlobalCollateralRatio();
        //1100000 
        ...
        //adds corresponding amount to the pool
        require(
            (_COLLATERAL.balanceOf(address(this)))
                .sub(unclaimedPoolCollateral) //remove unclaimed as they dont belong in total col
    ...
    function checkup2(uint256 arthAmount, uint256 arthxAmount) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
    uint256 cr = _arthController.getGlobalCollateralRatio();
    ...
    return (cr,arthAmountPrecision,algorithmicRatio,collateralRatio, collateralNeededBeforeFee, collateralNeeded,arthxInputNeededD18);
...
contract Test_Pool is TestArthPool {
    /**
     * State variable.
     */
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0x3D9C26915941502bc03C45d418bcD0AA27Ae9f8f"
    }
  },
  "outputSelection": {
    "*": {
