...
contract FaircastleRedeemer is Ownable, ReentrancyGuard {
    ...
    uint256 public mimRedeemAmount = 13;

    // FCS token address
    // address public FCS = 0xf754675Ca3d7D34290007065a4DE786FeA6bB9B5;
    address public FCS = 0x2dc3c430bE94aC4893f00e181c840Bc885D1aC16; // Rinkeby
    // MIM token address
    // address public MIM = 0xFEa7a6a0B346362BF88A9e4A88416B77a57D6c2A;
    address public MIM = 0x748d4D606bA309CF209B1c573E560AbF7afA5270; // Rinkeby DAI
