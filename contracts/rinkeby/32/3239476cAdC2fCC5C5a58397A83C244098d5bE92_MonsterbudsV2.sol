...
interface IMonsterBuds {
    ...
    */
    ...
    /**
     * @dev Emitted when token is listed for sell.
    */
...
contract MonsterbudsV2 is MonsterBudHolders, ERC721URIStorageUpgradeable, IMonsterBuds {
    ...
    */
    ...
    /**
     * @dev updates the token listing price. 
     *
     * @param tokenId token Id.
    ...
    */
    ...
    function sellList(uint256 tokenId, uint256 price) external returns (bool){
        ...
        emit sellListing(msg.sender, tokenId, price);
        return true;
    }    
    ...
    */
    ...
    function buyCollectiable(uint256 token_id) external override payable returns(bool){
        ...
        listPrices[token_id] = 0;  // set token price to zero
    ...
    */
    ...
    function hybreedCollectiable( uint256 req_token_id,uint256 accept_token_id, uint256 breed_req_id) external override payable returns (uint256) {
        ...
        listPrices[newItemId] = 0; // set initial token price to zero
        tokenCounter = tokenCounter + 1;
