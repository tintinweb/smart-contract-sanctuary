...
contract BasePolkaOffChain is EIP712MetaTransaction("BasePolkaMetaTransaction", "1"), Ownable {
...
contract P4LPolka is Ownable, ReentrancyGuard, BasePolkaOffChain {
        ...
        nonReentrant
    {
        ...
        uint256 _pid = buyProduct(uint128(_value), uint128(_durPlan), uint64(_purchMonth), _device, _brand, msgSender());
