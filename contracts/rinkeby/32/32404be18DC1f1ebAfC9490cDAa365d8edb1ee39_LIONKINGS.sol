...
pragma solidity ^0.8.0;
contract  LIONKINGS  is ERC721Enumerable, Ownable {
    ...
    uint public constant _TOTALSUPPLY   = 6;
    ...
    uint public publicSaleSupply        = 3;
    uint public publicSaleMaxQuantity   = 2;

    constructor(string memory baseURI) ERC721("Lion Kings", "LKings")  {
        setBaseURI(baseURI);
    }
