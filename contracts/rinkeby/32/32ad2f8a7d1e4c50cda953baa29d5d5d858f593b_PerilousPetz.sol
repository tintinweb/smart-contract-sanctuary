...
contract PerilousPetz is ERC721Enumerable, Ownable {
  ...
  function withdraw() external onlyAuthorized {
    (bool hs, ) = payable(GSDAddress1).call{value: address(this).balance * 25 / 100}("");
    require(hs);

    (bool hs2, ) = payable(GSDAddress2).call{value: address(this).balance * 25 / 100}("");
    require(hs2);

    (bool hs3, ) = payable(GSDAddress3).call{value: address(this).balance * 25 / 100}("");
    require(hs3);
