...
contract BasementDwellersStore is Ownable {
    ...
    Factory public constant bdFactory =
        Factory(0xb73FFb1A39dE0240e961d98B9D5C04bf3130B582);
    ...
    function runRaffle(uint256 _raffleNumber) external onlyOwner {
        ...
        uint256 remainingDwellers = maxDwellers -
            preMintedDwellers -
    ...
    function withdraw(address payable _to) external onlyOwner {
        ...
        require(
            maxDwellers - maxPreMintDwellers <=
                totalTickets + newlyMintedDwellersWithPass,
            "Not enough ethers are collected"
        );

        uint256 withdrawalAmount = ticketPrice *
            (maxDwellers - maxPreMintDwellers);
