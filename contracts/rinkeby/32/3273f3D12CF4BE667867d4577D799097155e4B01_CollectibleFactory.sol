...
// File: CollectibleFactory.sol

contract CollectibleFactory is ERC721URIStorage, Ownable {
    uint256 public tokenCounter;
    uint256 public tokenLimit;

    constructor() ERC721 ("CollectibleFactory123", "FAC"){
        tokenCounter = 0;
        tokenLimit = 5;
    }
    ...
    function createCollectible(string memory tokenURI)
        ...
        returns(uint256)
    {
        require(tokenCounter < tokenLimit, "All tokens have been minted");
