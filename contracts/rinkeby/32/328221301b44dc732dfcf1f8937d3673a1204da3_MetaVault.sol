...
contract MetaVault is IBEP20, Ownable
{
    ...
    uint16 public constant MaxBuyLockTime= 15;
    ...
    //DevWallets
    address public TeamWallet=payable(0xC21dBAd061f02D77691Ba32Ab3393bf4b8D4e3fB);
    address public PawnShop=payable(0x6b6d959d7b67C8E66B7d8b726DBD403a810595F5);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==TeamWallet||addr==PawnShop;
    }
    ...
    function TeamWithdrawALLMarketingETH() public onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer(amount*30/100);
        payable(PawnShop).transfer(amount*70/100);
    } 
    ...
    function TeamChangePawnShop(address newPawnShop) public onlyOwner{
      PawnShop=payable(newPawnShop);
    }
