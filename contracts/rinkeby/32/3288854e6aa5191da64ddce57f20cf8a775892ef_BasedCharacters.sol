...
contract BasedCharacters is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private nameSuffixes = [
        ...
        "of the Bogandoff",
        "of the Mooncats",
        "of the Guild of OG Punks",
        ", Heir of the Pamp",
        "of the Guild of Pengu",
        "of the Ponzi of Fame",
        "of the Ponzi of Gains",
        "of the Ponzi of Pain",
        ", follower of the Church of Alameda",
        ", follower of the Cult of Smol Ting",
        "of Cock Strength"
    ];
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Based Charater #',
                        toString(tokenId),
                        '", "description": "Based Characters are randomized generated and stored on chain. Images and other functionality are intentionally omitted for others to interpret. Feel free to use characters in any way you want. Inspired and compatible with Loot (for Adventurers)", "image": "data:image/svg+xml;base64,',
    ...
    function withdraw() public onlyOwner {
        payable(0xd57cd8f4eE0De8FDdd1be8C7dce84Dc82a0413c6).transfer(address(this).balance);
    }
    ...
    constructor() ERC721("Based Characters", "BCHAR") Ownable() {}
}
