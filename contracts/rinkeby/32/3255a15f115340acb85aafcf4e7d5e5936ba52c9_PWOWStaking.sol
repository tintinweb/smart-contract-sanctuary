...
contract PWOWStaking is Ownable, IERC721Receiver, ReentrancyGuard, Pausable {
...
/* STAKING MECHANICS */
    ...
    //deposit function. 
    function deposit(address account,uint256[] calldata tokenIds) external whenNotPaused {
