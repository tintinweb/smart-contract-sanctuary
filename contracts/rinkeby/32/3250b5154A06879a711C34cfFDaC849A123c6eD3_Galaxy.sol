...
contract Galaxy is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 500 ether;
    // Initial distribution for the day 2-5 GXY-WFTM LP -> GXY pool
    uint256 public constant INITIAL_GXY_POOL_DISTRIBUTION = 10000 ether;
    ...
    /**
     * @notice Constructs the GXY ERC-20 contract.
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) ERC20("Galaxy", "GXY") {
        // Mints 1 GXY to contract creator for initial pool setup
    ...
    function _getGalaxyPrice() internal view returns (uint256 _galaxyPrice) {
        try IOracle(galaxyOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("Galaxy: failed to fetch GXY price from Oracle");
        }
    }
    ...
    /**
     * @notice Operator mints GXY to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of GXY to mint to
    ...
    function distributeReward(
        ...
        _mint(_galaxyPool, INITIAL_GXY_POOL_DISTRIBUTION);
