...
contract Dominapes is ERC721 {
    ...
    uint256 private startMintDate = 1628401679;
     ...
     */
    function addAvailableSlices(uint16 from, uint16 to)
        external
        onlyOwner
    {
     ...
     */
    function ownerMintSlicesToAddress(address _address, uint256 amount)
        external
        onlyOwner
    {
