...
contract StandoffNFT_1 {
  ...
  function mint() external {
    require(canMint, "minting is locked");

    collection.safeTransferFrom(address(this), msg.sender, TOKEN_ID, 1, "");
  }

  function allowMinting() external {
    require(msg.sender == owner, "only owner can allow minting");

    canMint = true;
  }

  function addToWaitlist() external {
