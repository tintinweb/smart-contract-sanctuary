...
contract RaffleWrap is IDO, Random {
    ...
    mapping(address => bool) public isWonRaffle;
    ...
    function buyTickets(uint256 _noOfTickets) external raffleParticipationPeriod nonReentrant {
        require(!getRegistrationStatus(msg.sender) || (getRegistrationStatus(msg.sender) && getPoolNo(msg.sender) != RAFFLE_POOL), "Already Participated In IDO");
