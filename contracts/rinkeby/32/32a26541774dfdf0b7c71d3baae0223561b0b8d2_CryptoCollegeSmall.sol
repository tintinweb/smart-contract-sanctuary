...
// File contracts/CryptoCollegeSmall.sol


pragma solidity ^0.8.2;

contract CryptoCollegeSmall is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string private _baseTokenURI;
    address public vault;
    uint256 public constant MAX_SUPPLY = 20;
    uint256 private _reserveCount = 5;
    bool public paused = true;

    constructor(string memory _tokenUri, uint256 reserveCount) ERC721("Crypto College", "CC") {
    ...
    function calculatePrice() public view returns (uint256) {
        ...
        if (currentSupply >= 16) {
            return 150000000000000000; // 161-288 : 0.15 ETH
        } else if (currentSupply >= 14) {
            return 125000000000000000; // 130 - 160 : 0.125 ETH
        } else if (currentSupply >= 12) {
            return 90000000000000000; // 101 - 130 : 0.09 ETH
        } else if (currentSupply >= 10) {
            return 60000000000000000; // 51 - 100 : 0.06 ETH
        } else if (currentSupply >= 8) {
            return 30000000000000000; // 30-50 : 0.03 ETH
        } else {
            return 15000000000000000; // 1 - 29 : 0.015 ETH
        }
    }
