...
contract Nft is ERC721Enumerable, Ownable, Unlockable {
    ...
    function nftBuy() public payable {
    ...
    function nftSwap(uint256 _id) public payable {
        require(
            _swapMap.inserted[_id] == true,
            "NFT: NFT not available for swap"
        );
...
contract NftManager is Ownable {
    ...
    function swap(address _recipient, uint256 _tokenID) public {
        require(
            ...
            "NftManager: Run setApprovedContract for NFT Contract"
        );
...

{
  ...
  "libraries": {
    "/home/ubuntu/environment/contracts/contracts/Nft.sol": {
      "SwapMapping": "0x8847252d04E6401036B3c686e152Ad3317bd8507"
    }
  },
  "outputSelection": {
    "*": {
