...
contract MonsterBlocks is MonsterBlockCoreERC721, VRFConsumerBase {
  ...
  function ownerMintMonsterBlocks(uint256 _quantity, uint256 _deadline) external onlyOwner {
    ...
    mintMonsterBlock(_quantity, _deadline);
  }
  ...
  function mintMonsterBlock(uint256 _quantity, uint256 _deadline) internal {
