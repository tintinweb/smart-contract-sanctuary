...
contract staking {
    ...
    constructor(Token _tokenA , Token _tokenB) {
        ...
        function buyTokenA(uint256 amount) public payable {  //Users can buy tokenA
        require(msg.value>0,"Pay some ethers");
        require(amount>0,"Amount can't be zero"); 
        setPrice(); 
        noOfTokenA = msg.value.mul(10E18).div(priceOfDAI);
    ...
    function stake(uint256 _amount) public {  //Users can stake tokenA and get tokenB as receipt
    ...
    function getTokenABack() public { //Users can return tokenB and get tokenA back
