...
// File: contracts/ValuartMarket.sol
...
contract ValuartMarket is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    function initialize() initializer public {
        __Ownable_init();
    }
}

contract ValuartMarket_v2 is ValuartMarket {
    struct Auction {
    ...
    function createAuction(address tokenAddress, uint tokenId, uint minBid, uint time) external onlyOwner() {
        ...
        ERC721Upgradeable(tokenAddress).safeTransferFrom(msg.sender, address(this), tokenId);
    }
    ...
    function endAuction(address tokenAddress, uint tokenId) external onlyOwner() {
        ...
        ERC721Upgradeable(tokenAddress).safeTransferFrom(address(this), highestBidder, tokenId);
    }
    ...
    function declineSelling(address tokenAddress, uint tokenId) external onlyOwner() {
        ...
        ERC721Upgradeable(tokenAddress).safeTransferFrom(address(this), seller, tokenId);
    }
    ...
    function buy(address tokenAddress, uint tokenId) external payable {
        ...
        ERC721Upgradeable(tokenAddress).safeTransferFrom(address(this), msg.sender, tokenId);
    }
