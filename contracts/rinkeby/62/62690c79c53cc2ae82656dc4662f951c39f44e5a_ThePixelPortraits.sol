...
contract ThePixelPortraits {
    ...
    uint public topCommissionIndex;
    uint public bottomCommissionIndex;
    uint public newCommissionIndex;
    ...
    event NewFrontLineCommission(uint _commissionIndex, string _name, uint _bid, address _recipient);
    ...
    event CommissionProcessed(uint _commissionIndex, CommissionStatus);
}