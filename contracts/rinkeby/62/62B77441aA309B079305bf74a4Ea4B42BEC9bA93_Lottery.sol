...
contract Lottery is VRFConsumerBase {
    ...
    function enter() public payable {
      require(lottery_state == LOTTERY_STATE.OPEN, "Cannot enter, the lottery is not open yet.");
    ...
    function startLottery() public onlyOwner {
      require(lottery_state == LOTTERY_STATE.CLOSED, "There is another lottery already running.");
