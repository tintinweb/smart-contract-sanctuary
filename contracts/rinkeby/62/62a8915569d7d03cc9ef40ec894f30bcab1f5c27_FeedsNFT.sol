...
contract FeedsNFT is ERC721 {
    ...
    function addLowURI(string memory _svgLow) public {
        lowImageURI = _svgLow;
    }   

    function addHighURI(string memory _svgHigh) public {
        highImageURI = _svgHigh;
    }
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '", "description":" ", "attributes":"", "image":"',imageURI,'"}'
                            )
                        )
                    )
                )
