...
contract TimeLockMultiSigWallet {
    ...
    uint public MINIMUM_DELAY = 60;
    uint public MAXIMUM_DELAY = 14 days;
    ...
    function executeTransaction(uint transactionId)
        ...
        notExecuted(transactionId)
    {
        require(getBlockTimestamp() >= transactions[transactionId].submitTime + MINIMUM_DELAY, "The time is not up, the command cannot be executed temporarily!");
