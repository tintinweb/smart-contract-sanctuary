...
contract MetaSafeNFT is ERC1155, Ownable {
    string public constant name = "MetaSafeNFT";
    ...
    */
    ...
    /*
    * Function to get Base and Blind URI 
    */
    function getURIs() 
        external 
        onlyOwner
    ...
    */ 
        ...
        payable
    {
        ...
        require(_proof.verify(root, keccak256(abi.encodePacked(msg.sender))), "You are not in the whitelist");
