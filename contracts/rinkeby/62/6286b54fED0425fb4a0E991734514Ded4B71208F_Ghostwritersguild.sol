//
// The Ghostwritersguild
//
// Twitter: https://twitter.com/GhostwritersNFT
//
// Project by: @Ghostwritersguild
//
...
contract Ghostwritersguild is ERC721Burnable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    // Team
    address public constant PROJECT_OWNER = 0xf25ceeAaf6E26CcB9F5DEaa6ba9D4dbC667A296f;

    string public baseUri = "ipfs://QmYbhufA9zDTC9mVWFeF7URRzF5kUS4oW2cZauuE49N7Db";
    ...
    // Constructor
    constructor() ERC721("Ghostwritersguild", "GG") {
        for(uint256 i=0; i<30; i++) {
            _tokenIds.increment();
            _safeMint(PROJECT_OWNER, _tokenIds.current());
        }
    }
    ...
    */
    function mintGhostwritersguild() public payable {
    ...
    */
    ...
    function contractSettings(bool _saleStart, bool _whitelistSale, bool _openForWhitelist,  bool _enforceOnePerWallet) public onlyOwner {
    ...
    */
    function withdraw() public payable onlyOwner {
        ...
        require(payable(PROJECT_OWNER).send(_each));
    }
