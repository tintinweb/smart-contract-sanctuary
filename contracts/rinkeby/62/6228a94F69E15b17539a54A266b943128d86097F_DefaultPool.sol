...
// File: contracts/Interface/IDefaultPool.sol
...
// File: contracts/Interface/CheckContract.sol
...
// File: contracts/Interface/Console.sol
...
/*
 * The Default Pool holds the ETH and MUSD debt (but not MUSD tokens) from liquidations that have been redistributed
 * to active troves but not yet "applied", i.e. not yet recorded on a recipient active trove's struct.
 *
 * When a trove makes an operation that applies its pending ETH and MUSD debt, its pending ETH and MUSD debt is moved
