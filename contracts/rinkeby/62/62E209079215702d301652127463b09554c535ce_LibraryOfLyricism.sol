...
contract LibraryOfLyricism is ERC721, Ownable, ReentrancyGuard {
  ...
  address lyricist = 0xF4617b57ad853f4Bc2Ce3f06C0D74958c240633c;
  ...
  function mint(address _to, uint256 _mintAmount) public payable nonReentrant{
    ...
    require(totalSupply + _mintAmount <= maxLyrics, "Sorry" );
    if (msg.sender != owner()) {
