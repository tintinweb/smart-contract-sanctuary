    ...
    ReentrancyGuard
{
    ...
    function rebalanceTokens() internal {
        uint256 balance0 = getBalance0();
        uint256 balance1 = getBalance1();
        ...
        if (balance0 > 0 && balance1 > 0) {
            ...
            pool.swap(address(this), true, int256(balance1.div(2)), TickMath.MAX_SQRT_RATIO - 1, "");
        }
...
// File: GammaStrategy.sol

contract GammaStrategy {
    GammaVault public immutable vault;
    ...
    constructor(
        ...
        IUniswapV3Pool _pool = GammaVault(_vault).pool();
        int24 _tickSpacing = _pool.tickSpacing();

        vault = GammaVault(_vault);
        pool = _pool;
    ...
    function rebalance() external {
        require(msg.sender == keeper || msg.sender == vault.governance(), "keeper");
        ...
        int24 tick = getTick();
        int24 maxThreshold = _baseThreshold;
