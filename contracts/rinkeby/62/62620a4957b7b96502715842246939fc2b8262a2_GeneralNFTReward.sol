...
import "../interface/ITT1NFTFactory.sol";
import "../interface/ITT1NFT.sol";
...
contract GeneralNFTReward is IPool,Governance {
    ...
    ITT1NFTFactory public _gegoFactory = ITT1NFTFactory(address(0x0));
    ITT1NFT public _gegoToken = ITT1NFT(address(0x0));
    address public _playerBook = address(0x0);

    address public _teamWallet = 0xC92f9311aE4f02e382DEE2409827e42DBdC0A8F6;

    uint256 public constant DURATION = 2 days;
    uint256 public _startTime =  1632378600; 
    uint256 public _periodFinish = 0;
    uint256 public _rewardRate = 0;
    uint256 public _lastUpdateTime;
    uint256 public _rewardPerTokenStored;
    uint256 public _harvestInterval = 0 hours;
    ...
    uint256 public _maxStakedDego = 100000 * 1e18;
    ...
    constructor(address TT1NftToken, address gegoFactory, address rewardAddress, uint256 startTime) {
        _rewardERC20 = IERC20(rewardAddress);
        _gegoToken = ITT1NFT(TT1NftToken);
        _gegoFactory = ITT1NFTFactory(gegoFactory);
...
interface ITT1NFTFactory {
    ...
    function getGegoStruct(uint256 tokenId)
        external view
        returns (ITT1NFT.Gego memory gego);
