...
contract MultiChainCapital is Context, IERC20, Ownable {
  ...
  function _setSellTaxMultiplier(uint8 multiplier) external onlyOwner {
    require(multiplier <= 10, 'multiplier should be in 0 - 10');
    _sellTaxMultiplier = multiplier;
  }
