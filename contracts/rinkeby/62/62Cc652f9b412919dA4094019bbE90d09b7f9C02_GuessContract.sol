...
contract GuessContract is VRFConsumerBase {
    ...
    address public _externalAddress = 0x80864Bdad5790eDe144a3E0F07C65A0Dd2b2280B; // address where 50 tokens to be transfered
...
//////////////////////////////////////////////////////////////////////////////////////Staking Function//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    function chooseWinner() public onlyAdmin returns(address) {
        ...
        require(ERC20Interface(stochContractAddress).transfer(user, 950));
        require(ERC20Interface(stochContractAddress).transfer(_externalAddress, 50));
        randomNumber = 0;
        return user;
    }
