...
contract ArtBottest is ERC721, Ownable {
    ...
    function buyArt(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxTokensPerTransaction, "Exceeds max number of Raccoons in one transaction");
        require(totalSupply().add(numberOfTokens) <= nftsPublicNumber, "Purchase would exceed max supply of Raccoons");
