...
contract ETHWalkersMinting is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address payable public payoutsAddress = payable(address(0x95d7B1610030A6d28CDEb8bc5e5D34Eb53E5ac71)); // TODO: Update with address from ETHWalkersPayments.sol
    ...
    address zenAcademyAddress = 0xbDAb71E5a03283C261bf01487C89B9553890198f; // ToDo: Test Address only
    ...
    function preSaleApesZenMintETHWalkers(uint numberOfTokens, address _to) external payable {
        ...
        if(block.timestamp >= publicSale) {
            ...
            require((boredApes.balanceOf(_to) > 0 || mutantApes.balanceOf(_to) > 0 || zenAcademy.balanceOf(_to, 1) > 0), "Must own BAYC, MAYC, or ZA token to mint during Ape presale");
        } else {
