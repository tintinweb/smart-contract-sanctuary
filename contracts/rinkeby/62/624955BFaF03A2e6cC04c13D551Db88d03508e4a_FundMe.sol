...
contract FundMe {
    ...
    function getVersion() public view returns (uint256) {
        //we have a contract defined at the address below starting with 0x, which has
        //the functions of the interface above defined. the address is on the rinkeby chain.
