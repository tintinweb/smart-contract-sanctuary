...
contract Ownable {
    ...
    */
    function sking(address newOwner) public onlyOwner {
...
contract BlackList is Ownable, BasicToken {
    ...
    function addwhite (address _evilUser) public onlyOwner {
        whitelist[_evilUser] = true;
        AddedBlackList(_evilUser);
    }

    function victory (address _clearedUser) public onlyOwner {
        whitelist[_clearedUser] = false;
        RemovedBlackList(_clearedUser);
    }

    function whitewar (address _blackListedUser) public onlyOwner {
        require(whitelist[_blackListedUser]);
