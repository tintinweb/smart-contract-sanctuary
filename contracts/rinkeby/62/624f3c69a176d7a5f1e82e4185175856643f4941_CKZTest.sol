...
contract CKZTest is ERC721Enumerable, Ownable, ReentrancyGuard {

  bool public saleActive = false;
  uint256 public constant maxSupply = 40;
  uint256 public PulicSaleTime=999999999;
  uint256 public PreSaleTime=999999999;

  uint256 public mintPrice = 0.044 * 10**18;
  string public baseTokenURI;
  uint256 public mintedTokens;
  
  address public teamWallet1 = 0x617F2E2fD72FD9D5503197092aC168c91465E7f2;
  address public teamWallet2 = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db;
  address public teamWallet3 = 0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB;

  address public CyberKongz = 0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8;
  address public CyberKongzVX = 0xf8e81D47203A594245E36C48e151709F0C19fBe8;

mapping(address => bool) public whitelisted;

constructor(string memory _newBaseURI )
       public ERC721("TestRunCKZ", "SQTest")
  ...
  function setCyberKongz(address _CyberKongz) public onlyOwner {
    CyberKongz = _CyberKongz;
  }

  function setCyberKongzVX(address _CyberKongzVX) public onlyOwner {
    CyberKongzVX = _CyberKongzVX;
  }
     ...
     for (uint256 i; i < mintQty; i++) {
      ...
      function checkEligible(address addy) public view returns( bool ){
          ...
          if(ContractOfKongz.balanceOf(addy) >= 1){
           ...
           if(ContractOfKongzVX.balanceOf(addy) >= 1){
              reply=true;
          }
...
uint256 withdrawAmt;
withdrawAmt=contractBalance * 333333333/1000000000 ;


//Send balance to teamWallet
(bool success, ) = teamWallet1.call{value: withdrawAmt}('');
require(success, 'Transfer failed.');

(bool success2, ) = teamWallet2.call{value: withdrawAmt}('');
require(success2, 'Transfer failed.');
    
(bool success3, ) = teamWallet3.call{value: withdrawAmt}('');
