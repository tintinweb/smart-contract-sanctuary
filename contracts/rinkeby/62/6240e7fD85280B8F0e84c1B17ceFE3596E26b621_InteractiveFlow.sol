...
// File: InteractiveFlow.sol

/*
....................................................................................................................................
......BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE........
....BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BAS.....
...BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64...
...BASE64BAS............................................................................................................BASE64BAS...
...BASE64BAS............................................................................................................BASE64BAS...
...BASE64BAS......A.....................................................................................................BASE64BAS...
......BASE6.............................................................................................................BASE6.......
....................................................................................................................................
................BASE64BASE64BAS....BASE64BASE64BAS...BASE64BASE64BAS...BASE64BASE64BAS..BASE64BASE64......BASE......................
................BAS.........BASE..BAS..........BASE.BAS...............BAS..............BASE..............BASE.......................
................BASE64BASE64BAS...BAS..........BASE..BASE64BASE64BA...BASE64BASE64B....BASE64BASE64.....BAS...BAS...................
................BAS..........BAS..BASE64BASE64BASE6.............BASE..BBB..............BASE......BBB...BASE64BASE64B................
................BASE........BASE..BAS..........BASE.............BASE..BASE.............BASE......BASE.........BASE..................
................BASE64BASE64BAS...BAS..........BAS...BASE64BASE64BA.....BASE64BASE64BA...BASE64BASE...........BAS...................
....................................................................................................................................
...BASE64BAS............................................................................................................BASE64BAS...
...BASE64BAS.........................................................................................PRODUCTION.........BASE64BAS...
...BASE64BAS............................................................................................................BASE64BAS...
...BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64...
...BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64...
.....BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BASE64BAS....
...
contract InteractiveFlow is ERC721Enumerable, Ownable {
    ...
    uint256 constant public TOKEN_PRICE = 0.00005 ether;
    uint256 constant public MAX_TOKENS_PURCHASE = 3;
    uint256 constant public MAX_FREE_MINTS_PER_WALLET = 1;
    string constant public SLASH ="/";
    address constant DOTDOTDOT_CONTRACT = 0x8f80D3fC6b1C6f6a8Db5f189be8aC658C3a17A0e;
    address constant ZEROXCULTURE_CONTRACT = 0x0000000000000000000000000000000000000000;
    address constant DOJI_CONTRACT = 0x0000000000000000000000000000000000000000;
/*    address constant DOTDOTDOT_CONTRACT = 0xcE25E60A89F200B1fA40f6c313047FFe386992c3;
    address constant ZEROXCULTURE_CONTRACT = 0xc789858e3b777aa6b7B209921d9368C4E898167e;
    address constant DOJI_CONTRACT = 0x5e9dC633830Af18AA43dDB7B042646AADEDCCe81;*/
    string private _tokenBaseURI;
    IERC721 public dotdotdotContract;
    IERC721 public zeroXCultureContract;
    ...
    event indexURI(uint256 indexed mintIndex, string uri);    

    constructor() ERC721("SuperSecretShit", "SUPERSECRETSHIT") {
        dotdotdotContract = IERC721(DOTDOTDOT_CONTRACT);
        zeroXCultureContract = IERC721(ZEROXCULTURE_CONTRACT);
    ...
    function freeMint() public {
        ...
        require(dotdotdotContract.balanceOf(msg.sender) > 0 || zeroXCultureContract.balanceOf(msg.sender) > 0 || dojiContract.balanceOf(msg.sender) > 0, "Your wallet does not hold DotDotDots, 0xCulture Brushtrokes, or DojiCrew NFTs");
        uint256 mintIndex = totalSupply();
        setMintIndexToHash(totalSupply() + 1);
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        //require(bytes(base).length > 0 , "BASE URI not yet set");
        string memory base = _tokenBaseURI;

        // If there is no base URI, return the token URI.
        if (bytes(base).length == 0) {
            //return string(abi.encodePacked(uint2str(tokenId), SLASH, hash));
            return string(abi.encodePacked(uint2str(tokenId)));
        }

        return string(abi.encodePacked(base, SLASH, uint2str(tokenId)));
    }
