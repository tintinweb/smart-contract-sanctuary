...
contract CollateralAndMint is LandOracleProxy, Ownable {
    ...
    address public UNISWAP_ROUTER_ADR;
    address public PROTOCOL_TOKEN_ADR;
    address public WETH_ADR;
    ...
    constructor(
        ...
        UNISWAP_ROUTER_ADR = _uniswaprouteradr;
        PROTOCOL_TOKEN_ADR = _protocoltokenadr;
        WETH_ADR = _wrappedetheraddress;
    }
    ...
    function BuyBackAndBurn() public payable onlyOwner {
        ...
        IUniProxy(UNISWAP_ROUTER_ADR).swapExactETHForTokens{value: EthBalance}(
            1,
            path,
            address(this),
            block.timestamp
