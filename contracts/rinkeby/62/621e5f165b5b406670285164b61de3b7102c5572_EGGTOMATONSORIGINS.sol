...
contract EGGTOMATONSORIGINS is ERC721Enumerable, Ownable, Payment, Guard {
	...
	function checkE1minted(uint256 n) private view returns (bool) {
	...
	function checkE2minted(uint256 n) private view returns (bool) {
	...
	function checkE3minted(uint256 n) private view returns (bool) {
	...
	function checkE4minted(uint256 n) private view returns (bool) {
	...
	function checkE5minted(uint256 n) private view returns (bool) {
	...
	function checkE6minted(uint256 n) private view returns (bool) {
	...
	function checkE7minted(uint256 n) private view returns (bool) {
