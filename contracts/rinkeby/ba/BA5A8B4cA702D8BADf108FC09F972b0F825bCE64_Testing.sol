...
contract Testing is ERC721Enumerable, Ownable {
    ...
    address public  constant  wallet = 0xf2A9c0e9B455A5CE22A81B3a41461439096C6C87;
    address public  proxyRegistryAddress;
    uint256 public  MAX_SUPPLY = 10;
    uint256 public  MAX_TX = 2;
    uint256 public  reserved = 3;
    uint256 public  free = 6;
    uint256 public  price = 0.042 ether;

    bool public saleState = false;
    mapping(address => bool) public projectProxy;

    constructor(string memory _baseURI,address _proxyRegistryAddress) ERC721("Testing", "TESTING")
    {
        baseURI = _baseURI;
