...
import "../token/ERC20/ERC20Standards.sol";

contract MasterERC20Standards is Ownable {
  ERC20Standards[] private childrenERC20Standards;
  ...
  function createTokenERC20(
    ...
    uint256 _value = uint256(msg.value * 1000000000000000000);
    ...
    ERC20Standards child = new ERC20Standards(
      msg.sender,
      _keyTypes,
      name,
      symbol,
    ...
    childrenERC20Standards.push(child);
  }
...
contract Dictionary is IDictionary, Ownable {
    ...
    function setFee(string memory key, uint256 value ) override public onlyOwner {
        bytes32 encodedKey = keccak256(abi.encodePacked(key));
...
contract ERC20Standards is ERC20, AccessControl {
  ...
  function beforeTokenTransfer(
    ...
    address to,
    uint256 amount
  ) external virtual checkTypes("20pause") {
