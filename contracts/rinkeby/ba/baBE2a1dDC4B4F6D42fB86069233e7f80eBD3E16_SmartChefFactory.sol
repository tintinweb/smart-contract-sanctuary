...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
    ...
    /*
     * @notice harvest staked tokens and collect reward tokens (if any)
     */
     ...
     * @param _bonusEndBlock: the new end block
     */
    function bonusEndBlockIncrease(uint256 _bonusEndBlock) external onlyOwner {
        require(
            bonusEndBlock < _bonusEndBlock,
            "New _bonusEndBlock must be greater than new current bonusEndBlock"
        );
        bonusEndBlock = _bonusEndBlock;
    }
