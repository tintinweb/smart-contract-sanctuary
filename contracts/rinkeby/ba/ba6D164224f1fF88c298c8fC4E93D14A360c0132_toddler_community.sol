...
contract pixiedust {
    ...
    // jsons/toddlerpillars_t1.json

    string                   constant _name   = "Toddlerpillars";
    string                   constant _symbol = "TODLER";
    ...
    uint256                           _presaleStart = 1636707634;  // Fri, 12 Nov 2021 09:00
    uint256                           _presaleEnd = 1636794034;      // Sat, 13 Nov 2021 09:00

    bool                              _timedSale = true;
    uint256                           _saleStart = 1636794034;        // Sat, 13 Nov 2021 09:00
    uint256                           _saleEnd = 1636880434;            // Sun, 14 Nov 2021 09:00
    ...
    // DISCOUNTS
    uint256                  constant _maxDiscount = 6000;
    uint256                           _totalDiscount;
    ...
    string                   constant _tokenPreRevealURI = "testmeta.ether.cards/47";

    address                  constant public _signer = 0xA55c7770161b6325B64a622821e2db3551Df6C9e;

    // Private Minting

    address             constant _clientVault = 0xDb89C1C66191E6B3Af2A299fbfF2E22EB1Fe1AE0;
    uint256             _clientMintPointer = 1;
    uint256             _clientMintPosition = 0;
    uint256             constant _clientMintLimit = 550;

    address             constant _ecVault = 0x31EFd75bc0b5fbafc6015Bd50590f4fDab6a3F22;
