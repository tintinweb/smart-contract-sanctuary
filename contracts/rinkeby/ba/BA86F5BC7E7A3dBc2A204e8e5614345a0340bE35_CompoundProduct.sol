...
interface IProduct {
    ...
    ****/
    function getQuote(address _policyholder, uint256 _coverLimit, uint256 _blocks, address _positionContract) external view returns (uint256);
...
abstract contract BaseProduct is IProduct {
    ...
    ****/
    ...
    function getQuote(address _policyholder, uint256 _coverLimit, uint256 _blocks, address _positionContract) external view override returns (uint256){
