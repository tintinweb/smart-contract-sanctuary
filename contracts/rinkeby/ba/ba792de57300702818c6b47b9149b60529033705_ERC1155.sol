...
contract ERC1155 is IERC1155
{
    ...
    function getBoolean(uint256 _packed, uint256 _index) public pure returns(bool)
    {
        uint256 flag = (_packed >> _index) & uint256(1);
        return (flag == 1 ? true : false);
    }

    function setBoolean(uint256 _packed, uint256 _index, bool _value) public pure returns(uint256) {
        if (_value)
    ...
    function getEnableAnonymousMint(uint256 _id) external view creatorOnly(_id) {
