...
contract FirstDrop is Ownable {
    ...
    uint16 public sMintLimit = 200;
    uint16 public sMintedTokens = 0;

    uint8 public maxMintsPerUser = 255; // Change this
    uint16 public totalAvatars = 2100;
    uint256 public mintPrice = 0.01 ether; // Change this
    ...
    /**
     * @dev Sets how many mints can the mintToAddress do
     */
    ...
    /**
     * @dev Sets how many mints can a user have
     */
    function setMaxMintsPerUser(uint8 _maxMintsPerUser) external onlyOwner {
    ...
    function mint(
        ...
        bytes32 messageHash = generateMessageHash(msg.sender, _fromTimestamp, _toTimestamp);
        ...
        if (_quantity + mintsPerUser[msg.sender] > maxMintsPerUser) {
            _quantity = maxMintsPerUser - mintsPerUser[msg.sender];
        }
    ...
    function generateMessageHash(
        ...
        return keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n84", _address, _fromTimestamp, _toTimestamp));
    }
...
contract QueensAndKingsAvatars is ERC721, ProtectedMint {
    using Strings for uint256;
    ...
    function mintTraits(
        ...
        require(ownerOf(_tokenId) == msg.sender, "Caller is not the owner of the avatar");
        require(hasMintedTraits[_tokenId] == false, "Traits already minted");
