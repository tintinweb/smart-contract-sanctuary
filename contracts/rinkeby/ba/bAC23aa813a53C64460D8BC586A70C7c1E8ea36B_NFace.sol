...
contract NFace is NPassCore {
    ...
    constructor(address _nContractAddress)
        NPassCore("NFace", "NFace", IN(0x3d8692BC49452FB8E83A3CCf8d8959387FCba9c2), true, 8888, 0, 13370000000000000, 0)
    {}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        parts[
            16
        ] = ' 100,150 " /></defs><g transform="translate(175,75)"><use xlink:href="#l" /><use transform="translate(-100,0)" xlink:href="#r" /><use xlink:href="#n" /><use xlink:href="#m" /><use xlink:href="#c" /></g></svg>';
