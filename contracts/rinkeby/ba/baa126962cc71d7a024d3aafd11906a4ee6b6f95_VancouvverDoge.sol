...
contract VancouvverDoge is owned {
    ...
    uint public claimTokens=10000 * 10 ** 18;
    string public name = "B Doge";
    ...
    function mintToken() public 
    {
       ...
       if(tokensowned>0 && tokensownedcur==0)
       {
           if(currentSupply<=totalSupply)
           {
			   ...
			   require(balanceOf(owner) >= claimTokens, 'balance to low');
			   balances[msg.sender] += claimTokens;
			   balances[owner] -= claimTokens;
			   emit Transfer(owner,msg.sender, claimTokens);
