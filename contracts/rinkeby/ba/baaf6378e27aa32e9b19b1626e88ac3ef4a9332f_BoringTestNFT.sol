...
// GO TO LINE 1884 TO SEE WHERE THE NFT STARTS
...
contract BoringTestNFT is ERC721, Ownable {
    ...
    uint256 public constant nftPrice = 2500000000000000; //  ETH
    ...
    constructor() ERC721("Boring Test NFT", "NFT") { }
    ...
    function reserveNFTs(address _to, uint256 _reserveAmount) public onlyOwner {        
        ...
        require(_reserveAmount > 0 && _reserveAmount <= nftReserveAmount, "Not enough reserve left for team");
