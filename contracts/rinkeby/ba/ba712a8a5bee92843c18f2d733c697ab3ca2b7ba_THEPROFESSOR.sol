...
contract THEPROFESSOR is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;
	
	uint256 public MAX_NFT = 5050;
	...
	uint256 public PRESALE_PRICE = 18 * 10**16;
	uint256 public SALE_PRICE = 20 * 10**16;
    ...
    constructor(string memory baseURI) ERC721("The Professor", "THEPROFESSOR") {
		setBaseURI(baseURI);
        pause(true);
    }
