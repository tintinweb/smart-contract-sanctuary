...
contract CoriteNFT is ERC721Enumerable, Ownable {
    ...
    constructor (uint _nftPrice, uint _nftCap, uint _nftBatchCap, uint _nftPerAddress, address payable _receiveFunds) ERC721 ("Corite x Emmery Kelly - Emotions Collection", "EMOTIONS") Ownable(){
