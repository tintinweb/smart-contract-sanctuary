...
// Dependency file: contracts/interfaces/external/IWHT.sol
 ...
 * @author Cook Finance
 *
 * Interface for Wrapped HT. This interface allows for interaction for wrapped HT's deposit and withdrawal
 * functionality.
 */
...
// Root file: contracts/protocol/modules/SingleIndexModule.sol
...
// import { Invoke } from "contracts/protocol/lib/Invoke.sol";
// import { ICKToken } from "contracts/interfaces/ICKToken.sol";
// import { IWHT } from "contracts/interfaces/external/IWHT.sol";
...
contract SingleIndexModule is ModuleBase, ReentrancyGuard {
     ...
     * @param _component            Component to trade
     */
    function tradeRemainingWHT(address _component) external nonReentrant onlyAllowedTrader(msg.sender) onlyEOA() virtual {
