...
contract EternalWaitWrapper {
	...
	constructor(address eternalWaitContract_) {
        ...
        _eternalWaitContract = eternalWaitContract_;
    ...
    function mintNifty() public onlyValidSender {
        address omnibus = 0xBDbAEe6326cF7164EDaf107C525c1928B66d133f; // Rinkeby
        //address omnibus = 0xE052113bd7D7700d623414a0a4585BCaE754E9d5; // Mainnet
