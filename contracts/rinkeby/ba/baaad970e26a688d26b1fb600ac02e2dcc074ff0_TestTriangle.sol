...
contract TestTriangle is ERC721Enumerable, Ownable, Payment, Guard {
	...
	//phase 1 reserve
	function reservePhase1(address _address, address contractAddressHash) public {
	...
	//phase 1 reserve (punk)
	function reservePhase1punk(address _address, address contractAddressHash) public {
	...
	//phase 2 reserve (1155)
	function reservePhase2_1155(address _address, address contractAddressHash) public {
	...
	//phase 3 reserve
	function reservePhase3(address _address, address contractAddressHash) public {
	...
	//phase 3 reserve (1155)
	function reservePhase3_1155(address _address, address contractAddressHash) public {
	...
	//check reserve limit
	require(phase3ReserveCount <= maxPhase2, "Phase limit has been hit");
