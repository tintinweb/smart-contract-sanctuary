...
contract MetaMammoths is ERC721Enumerable, Ownable {
    ...
    // Max total tokens is 3900 + 100 = 4000
    uint256 public MAX_TOKENS = DEV_TOKENS + 3900;
    ...
    /**
     * Mint MetaMammoths NFTs
     */
    function mintMM(uint256 numberOfTokens) public payable {
        ...
        require(
            ...
            "Purchase would exceed max supply of MetaMammoths"
        );
        require(
