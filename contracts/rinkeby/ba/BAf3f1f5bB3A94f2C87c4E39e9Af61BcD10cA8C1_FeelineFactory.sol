...
contract FeelineFactory is Ownable {
    ...
    address public FEELINE_CLUB_CONTRACT_ADDRESS =
        0x569AdEbd0A67f0Fe5c1457C6729472abfb9D1ae4;
     ...
     */
    function mint(address _to, uint256 _count) public payable notStopped {
        require(
