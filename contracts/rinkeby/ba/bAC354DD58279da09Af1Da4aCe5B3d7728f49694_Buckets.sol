...
contract Buckets is KeyInterface, ReentrancyGuard {
    ...
    constructor(address _salmon) ERC1155("https://game.example/api/item/{id}.json") {
        salmon = ISalmon(_salmon);
        m_Name = 'OURSONG NFT 1155';
        m_Symbol = 'OURNFT1155';
        bucketCost[0] = 1000 ether;
        bucketCost[1] = 1000 ether;
        bucketCost[2] = 1000 ether;
