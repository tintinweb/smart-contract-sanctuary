...
library AddressArray {
   ...
   */
  function push(Addresses storage self, address payable element) internal {
...
contract BattleRoyale is Ownable {
  ...
  function addToBattleQueue(address payable _battle) external onlyOwner {
    battleQueue.push(_battle);
  }
