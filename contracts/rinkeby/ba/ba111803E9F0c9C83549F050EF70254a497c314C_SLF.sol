...
interface SLC_CONTRACT{
     function InitiateTransaction(address,uint256,string memory) external returns(bool);
...
contract SLF{
    ...
    function ListProperty_details(uint _origValue,
                                  ...
                                  address receiver) public onlyMinter returns(bool){
        
        bool SUCCESS = SLC_CONTRACT(SLC_DEPLOYED_ADDRESS).InitiateTransaction(receiver,_origValue,token_uri);
