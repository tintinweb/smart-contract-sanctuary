...
/// @title Uniswap V2, V3, Sushiswap, Visor, Lixir Liquidity Migrator
    ...
    BlockTimestamp
{
    ...
    constructor(address _unipilot, address _exchangeManager) {
        unipilot = _unipilot;
    ...
    function migrateV3Liquidity(MigrateV3Params calldata params) external {
        ...
        positionManager.burn(params.uniswapTokenId);
    ...
    function migrateLixirLiquidity(MigrateV2Params calldata params) external {
        ...
        (address pairV3, uint256 amount0V3, uint256 amount1V3, uint256 mintedTokenId) = _addLiquidityUnipilot(
            UnipilotParams({
                sender: _msgSender(),
                token0: alt,
                token1: weth,
                fee: params.fee,
                amount0ToMigrate: altAmountToMigrate, // start
        ...
        )
    {
        ...
        // (token0, token1, amount0, amount1) = tokenA < tokenB
...
abstract contract PeripheryPayments {
    address internal constant PILOT = 0x18F10404cC1414e6ACBfEA16CCC97D9ed303e98C;
