...
contract DocuPay {
  ...
  function purchaseDocument(uint256 docIndex, address payable uploaderAddress) public payable {
    ...
    // Pay the uploader
    (bool sent, bytes memory data) = uploaderAddress.call{value: msg.value}("");
