...
contract decoffer_V2{
    ...
    Credit_token CT = Credit_token(0x2D277e2555031e6eD79aaEd3379fC28C15AD303a);
    ...
    constructor()public payable{
        ...
        out_share = CT.totalSupply().sub(CT.balanceOf(owner));
    ...
    function Deposit()public payable{
        ...
        CT.transferFrom(owner,msg.sender,ct_amount);
    ...
    function CT_swap_ETH(uint _ct,uint _eth,address _user)public {
       ...
       CT.transferFrom(_user,owner,_ct);
       _user.transfer(_eth);
    ...
    function get_out_share()public view returns(uint){
        uint _out_share = CT.totalSupply().sub(CT.balanceOf(owner));
        return _out_share;
    } 
...
contract loan{
    ...
    Credit_token CT = Credit_token(0x2D277e2555031e6eD79aaEd3379fC28C15AD303a);
    decoffer_V2 DT = decoffer_V2(0x17f93904ac6670Cfc4d452d439c9ef884fCc4Aba);
    ...
    constructor()public {
        owner = msg.sender;
        fee_info[1][1] = 10; // borrow_discount
        fee_info[1][3] = 10; // price_discount
    } 
    ...
    function borrow(uint _CT)public {
        ...
        uint fee = eth_amount.mul(fee_info[1][1]).div(1000);
        eth_amount = eth_amount.sub(fee);
        
        DT.CT_swap_ETH(_CT,eth_amount,msg.sender);
        
        loan_info[msg.sender][1] = loan_info[msg.sender][1].add(eth_amount);
    ...
    function redemption()public payable{
        ...
        CT.transferFrom(owner,msg.sender,loan_info[msg.sender][2]);
