...
// File @openzeppelin/contracts/token/ERC721/IERC72[email protected]
...
contract NebulaNFT is ERC721Enumerable, Ownable {
    ...
    uint public constant MAX_NEB = 5000;
    ...
    function mint(uint _count) public payable saleIsOpen {
        ...
        require(totalSupply() < MAX_NEB, "Sale end");
        require(_count <= 5, "Max 5 per mint");
        require(NFT_PRICE.mul(_count) <= msg.value, "Sent ether value is incorrect");
