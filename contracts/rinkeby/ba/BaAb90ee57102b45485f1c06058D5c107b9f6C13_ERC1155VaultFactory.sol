...
contract ERC1155TokenVault is ERC20Upgradeable, ERC1155HolderUpgradeable {
    ...
    /// @notice kick off an auction. Must send reservePrice
    ...
    function bid(uint256 amount) external payable {
        ...
        if (withETH) {
            require(
                msg.value * 1000 >= livePrice * increase,
                "bid:too low bid"
            );
        } else {
    ...
    function end() external {
        ...
        IERC1155(token).safeTransferFrom(address(this), winning, id, 1, "");
    ...
    function cash() external {
        ...
        uint256 share = (bal * assetBalance) / totalSupply();
...
import "./Settings.sol";
import "./ERC1155TokenVault.sol";

contract ERC1155VaultFactory is Ownable, Pausable {
    ...
    constructor(address _settings) {
        settings = _settings;
        logic = address(new ERC1155TokenVault(_settings));
    }
    ...
    function mint(
        ...
        IERC1155(_token).safeTransferFrom(msg.sender, vault, _id, 1, "");
