...
// File: IdCardsCollectible.sol

contract IdCardsCollectible is ERC721, VRFConsumerBase {

    enum Breed{ King, Secretary, Whale, Geek, Civilian }

    //mapping(bytes32 => address) public DidToSender;
    mapping(bytes32 => address) public  requestIdToSender;
    mapping(bytes32 => string) public requestIdToTokenURI;
    mapping(bytes32 => uint256) public requestIdToTokenId;
    mapping(uint256 => Breed) public tokenIdToBreed;
    mapping(Breed => uint256) public cardsCounter;
    ...
    ERC721("Crypto Universe Cards", "CUC"){
        tokenCounter = 0;
        keyHash = _keyhash;
        fee = 0.1 * 10 ** 18;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
            ...
            cardsCounter[breed] = cardsCounter[breed] + 1;
