    ...
    ERC721PausableUpgradeable
{
    ...
    function initializeV2Only() public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ArtValueNumber: must have default_admin role to initialize V2");
        require(!v2Initialized, "ArtValueNumber: contract instance has already been initialized for V2");
