...
// File: contracts/library/LnftUtil.sol
...
// File: contracts/nft/NFTAssetContract.sol
...
contract NFTAssetContract is ERC721Full, Governance {
    // for minters
    mapping(address => bool) public _minters;



    constructor() public ERC721Full("LuisNFT", "LNFT") {
        _setBaseURI("https://imgur.com/t/nft/9H4qxXc");
    }
    ...
    function mint(address to, uint256 tokenId) external returns (bool) {
        ...
        _mint(to, tokenId);
        _setTokenURI(tokenId, LnftUtil.uintToString(tokenId));
        return true;
    }
