...
// File: contracts/merkleSpaceFly.sol
...
contract merkleSpaceFly is ERC721, Ownable {
  using Strings for uint256;
  ...
  bool public earlySaleActive = false;
...
// Early mint using allowlist powered by Merkle Tree
  function earlyMint(bytes32[] calldata _merkleProof, address _to, uint256 _mintAmount) public payable {
    require(earlySaleActive, "the early sale is paused");
  ...
  function toggleEarlySale() public onlyOwner {
    earlySaleActive = !earlySaleActive;
  }
