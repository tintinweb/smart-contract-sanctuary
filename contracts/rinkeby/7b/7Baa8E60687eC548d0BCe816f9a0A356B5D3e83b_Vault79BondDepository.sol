...
contract Vault79BondDepository is Ownable {
    ...
    IBEP20 public immutable principle; // token used to create bond
    ...
    function deposit( 
         ...
         */
        principle.transferFrom( msg.sender, address(this), _amount );
    ...
    function recoverLostToken( address _token ) external returns ( bool ) {
        ...
        require( IBEP20(_token) != principle, "NAP" );
