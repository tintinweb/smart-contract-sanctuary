...
//            newPlanet.positionX=int16(700-newPlanet.radius-newPlanet.rotationX*707/1000)-int16(uint16(randomNum((700-newPlanet.radius-newPlanet.rotationX*707/1000)*2, newPlanet.randomness, block.timestamp)));
//            newPlanet.positionY=int16(700-newPlanet.radius-2*newPlanet.rotationY*707/1000)-int16(uint16(randomNum((700-newPlanet.radius-newPlanet.rotationY*707/1000)*2, newPlanet.randomness, block.timestamp)));
