...
contract AntiRunners is ERC721, Ownable, ReentrancyGuard {
    ...
    function withdraw() public nonReentrant {
        ...
        uint256 amount;
        if (msg.sender == owner()) {
            amount = total * 3 / 4 - antiRunnersTeamWithdrawalAmount;
            antiRunnersTeamWithdrawalAmount += amount;

        } else {
            amount = total * 1 / 4 - chainRunnersTeamWithdrawalAmount;
    ...
    function allowedWithdrawalAmount() public view returns (uint256) {
        if (msg.sender != owner() && msg.sender != chainRunnersTeamAddress) {
            return 0;
        }
