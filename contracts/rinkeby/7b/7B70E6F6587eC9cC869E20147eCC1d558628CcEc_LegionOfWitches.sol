...
contract LegionOfWitches is EIP712, ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_PRE_SALE = 20;
    uint256 public MAX_PUBLIC_SALE = 20;
    uint256 public MAX_GIVEAWAY_RESERVERD = 200;
    ...
    modifier whenMintNotPaused() {
        require(!paused_mint, "Legion of Witches: mint is paused");
        _;
    }

    modifier whenPreSaleNotPaused() {
        require(!paused_pre_sale, "Legion of Witches: pre sale is paused");
        _;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(msg.sender).send(balance), "Legion of Witches: FAILED withdraw all call");
    }
