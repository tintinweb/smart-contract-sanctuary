...
contract AFCharacter is AFRoles, IAFCharacter {
    ...
    function takeRandomCharacter(uint256 randomNumber, uint256 totalRemaining) external onlyContract returns (uint256) {
        ...
        for (uint256 index = 0; index < arrayCount; index++) {
            ...
            if (shorterRandomNumber < allCharactersEver[currentCharacterID].scarcity) {
                characterID = currentCharacterID;
                break;
            } else {
                shorterRandomNumber -= allCharactersEver[currentCharacterID].scarcity;
            }
        }
