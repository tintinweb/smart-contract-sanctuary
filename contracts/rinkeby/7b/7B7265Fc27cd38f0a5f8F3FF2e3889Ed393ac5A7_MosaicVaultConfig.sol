...
contract MosaicVaultConfig is IMosaicVaultConfig, VaultConfigBase {
    uint256 internal constant TOKEN_RATIO = 1000;
    string internal constant ACTIVE_TOKEN_NAME = "IOU-";
    string internal constant PASSIVE_TOKEN_NAME = "R-";
    ...
    */
    ...
    function getAMMAddress(uint256 _ammID) external view override returns (address) {
...
interface IMosaicVaultConfig is IVaultConfigBase {
     ...
     */
    function getCurrentTokenLiquidity(address _token) external view returns (uint256);
