...
contract MyTestStuff2 is ERC721Tradable {
    ...
    constructor(
        address _proxyRegistryAddress
    ) ERC721Tradable('MyTestToken2', 'MTT2', _proxyRegistryAddress) {
        /**
         * Start counting tokens in reversed order
         */
    ...
    function setOriginalContractAddress(address contractAddress) public onlyOwner {
    ...
    function mintEvolutionForOwner() external {
        require(msg.sender == originalContractAddress, "Invalid Owner address");
        _mintGeneric(1, 1);
    }
