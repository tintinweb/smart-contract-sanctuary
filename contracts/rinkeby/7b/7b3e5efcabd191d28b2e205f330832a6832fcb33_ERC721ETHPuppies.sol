...
// Root file: src/contracts/TestERC721.sol

pragma solidity 0.7.6;

// import "@openzeppelin/contracts/token/ERC721/ERC721.sol";

contract ERC721ETHPuppies is ERC721,Ownable {
    
    constructor(string memory name_, string memory symbol_, address tokenOwner) ERC721(name_, symbol_) 
    {
         owner=tokenOwner;
		_setBaseURI("http://www.api.com/");
    }      


    function createPuppiesToken(address to, uint256 tokenId) internal onlyOwner
    {
     _safeMint(to, tokenId);
        	
    }
    	
    function setURI(string memory uri) internal onlyOwner
	{
        _setBaseURI(uri);	
    }  
