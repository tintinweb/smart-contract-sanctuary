...
contract BlootWheelsUp is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory shimmer = '<defs><linearGradient id="shimmer" x1="0%" y1="0%" x2="100%" y2="0%"><stop stop-color="gold"></stop><stop stop-color="yellow"><animate attributeName="offset" values=".05;.95" dur="4s" begin="0" repeatCount="indefinite"/></stop><stop stop-color="gold"><animate attributeName="offset" values="0;2" dur="4s" begin="0" repeatCount="indefinite"/></stop></linearGradient></defs>';
