...
contract MerkleProof {
    ...
    // mapping(address => bool) emptyClaimedAddresses;
...
function claim(bytes32 leaf,bytes32[] memory proof,address account, uint256 amount) public{
    require(!claimedAddresses[account], "MerkleDistributor: Drop already claimed.");
    if(verify(leaf,proof)){
        mnst.transferFrom(0x15412D1f9C63e9123Fa62a3E385a130f5C959De5,account,amount);  //transfer
