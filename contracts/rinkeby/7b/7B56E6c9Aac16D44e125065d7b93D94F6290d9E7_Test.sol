...
contract Test is ERC721, Ownable {
    ...
    uint constant public MAX_SUPPLY = 9000; // 9000 unique  will be in total.
    ...
    uint constant public PRESALE_PER_TX_LIMIT = 10; // Up to 5  per transaction during the presale.
    uint constant public PRESALE_PER_WALLET_LIMIT = 10; // Up to 5  per unique wallet during the presale.
