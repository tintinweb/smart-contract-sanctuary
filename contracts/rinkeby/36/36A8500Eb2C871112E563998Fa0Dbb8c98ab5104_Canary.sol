...
contract Canary is ERC721, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    uint256 public constant STEEP_CURVE_PERIOD = 60 * 60;
    uint256 public constant GENERAL_CURVE_PERIOD = 12 * 60 * 60 * 24;
    uint256 public constant NAME_CHANGE_PRICE = 100000 * (10 ** 18);
    uint16[18] public DEVMINT_METADATA_INDICES = 
        [5, 618, 814, 2291, 2342, 2410, 3140, 4035, 4372, 4499, 11, 111, 1274, 2331, 2885, 3369, 4268, 4589];
    ...
    */
    ...
    string public physicalSpecificationsIPFSURIPrefix = "ipfs://placeholder/";
