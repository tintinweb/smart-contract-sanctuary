...
contract KD777 is ERC777 {
  ...
  ) ERC777(mName, mSymbol, _defaultOperators) {}
    ...
    returns (bool)
  {
    return (_operator == _tokenHolder || // solium-disable-line operator-whitespace
      ...
      (mIsDefaultOperator[_operator] &&
        !mRevokedDefaultOperator[_operator][_tokenHolder]));
  }
  ...
  function burn(uint256 _amount, bytes calldata _data) public override {
  ...
  function callRecipient(
    ...
    address recipientImplementation = _erc1820.getInterfaceImplementer(
      _to,
      TOKENS_RECIPIENT_INTERFACE_HASH
    );
    // address recipientImplementation = interfaceAddr(
    //   _to,
  ...
  function callSender(
    ...
    address senderImplementation = _erc1820.getInterfaceImplementer(
      _from,
