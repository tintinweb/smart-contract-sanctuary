...
contract AtakTest is Ownable, ERC721 {
  ...
  constructor() ERC721("AtakTest", "AT") { 
    deployer = msg.sender;
  }
  ...
  function tokensOfWallet(address _wallet, uint startId, uint endId) external view returns(uint256[] memory ) {
