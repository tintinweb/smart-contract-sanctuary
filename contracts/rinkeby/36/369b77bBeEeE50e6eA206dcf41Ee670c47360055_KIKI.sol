...
contract KIKI is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 10_000 * 10**18;
    ...
    modifier onlyFeeManager() {
        require(_feemanager == _msgSender(), "Caller is not the fee manager");
        _;
    }
    ...
    function excludeFromReward(address account) public onlyFeeManager {
    ...
    function includeInReward(address account) external onlyFeeManager {
    ...
    function changeFeeManager(address newManagerAddress)
        external
        onlyFeeManager
    {
        _feemanager = newManagerAddress;
    }
}