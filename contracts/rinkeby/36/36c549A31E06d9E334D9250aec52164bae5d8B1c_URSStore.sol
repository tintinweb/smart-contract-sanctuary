...
contract URSStore is Ownable, VRFConsumerBase {
    Pass public pass;
    ...
    uint256 public constant operationSecondsForVIP =  60 * 15;//3600 * 9; // 9 hours
    uint256 public constant operationSeconds = 3600 * 48; // 24 hours

    /**
        Ticket
     */
    uint256 public constant ticketPrice = 0.00008 ether;
    ...
    // Do not update newlyMintedURS to prevent withdrawal  // what is this
