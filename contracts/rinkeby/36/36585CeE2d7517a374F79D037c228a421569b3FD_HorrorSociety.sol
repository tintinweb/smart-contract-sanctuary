...
contract HorrorSociety is ERC721, EIP712, AccessControl {
    ...
    CandyCard public candyCard = CandyCard(0x6a683978d927fD4d4C0b373CBc9dE1F18F625B18);
    ...
    function mint(uint256 quantity) public payable {
        require(msg.value >= price.mul(quantity) || hasRole(MINTER_ROLE, msg.sender), "ether value must be greater than price");
    ...
    function preSaleMint(uint quantity, uint maxMint, bytes calldata signature) external {
