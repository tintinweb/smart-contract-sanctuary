...
contract BilliardBalls is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Billiard Balls", "BB") {
    setHiddenMetadataUri("ipfs://QmVaRfU6ZTfwFEZ5A8a5Tss4hd7hihf916zK557gx46QsQ/hidden.json");
  }
