...
contract MyToken is ERC721, Pausable, Ownable {
    ...
    Counters.Counter public _giftsSent;
    ...
    constructor(address _signer, uint256 _max_presale_mint) ERC721("MyToken", "MTK") {
        signer = _signer;
    ...
    function getRecover(bytes memory signature) public view returns (address) {
    ...
    function presaleMint1(uint256 mintAmount, bytes memory _signature) public payable {
        ...
        require(mintAmount + _tokenIdCounter.current() <= MAX_SUPPLY - _giftsSent.current(), "Minting more than max supply");
