 ...
 * fallback(). Previously the fallback routed calls to the splitter with a DELEGATECALL.
 * Now the SplitProxy is Ownable. If the owner triggers fallback(), the call is now
 * routed here. Anyone but the owner - and it will behave the same as before.
 ...
 * Or whatever else you can think of, it just needs to be implemented below.
 *
