...
// required for passing structs in calldata (fairly secure at this point)
...
contract ANDAOFactory {
    ...
    function _createGovern() internal returns (Govern govern, GovernQueue queue) {
        ERC3000Data.Config memory conf = ERC3000Data.Config({
                executionDelay: 0,
    ...
    function deployANSubDAOs() external returns (Govern compGovern, GovernQueue compQueue) {
        (compGovern, compQueue) = _createGovern();
    }
}