...
contract NiftyStonks is ERC721, ERC721Enumerable, Ownable {
  ...
  function onAllowList(address addr) public view returns (bool) {
    return _allowList[addr];
  }

  function allowListClaimedBy(address addr) public view returns (uint256) {
    require(addr != address(0), "Empty address is not on allowlist");
