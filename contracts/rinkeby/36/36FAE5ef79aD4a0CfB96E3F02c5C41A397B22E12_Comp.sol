...
contract Comp is ERC721, Ownable{
    ...
    mapping (address => uint256) public addressNextMintData;
    mapping (address => uint256) public _addressNormalMintAmount;
...
//    address  public NMTERC20Contract= address(0xd742C20DDe8474f74026df193AA12f26f96e3e65);
    ...
    */
    function mint(string memory luckyData) public{
        ...
        if(addressNextMintData[msg.sender] >=  timestamp){
            if(airdropWhitelist[msg.sender]>0){
                airdrop=true;
            }else{
        ...
        addressNextMintData[msg.sender] = timestamp + _addressNormalMintAmount[msg.sender] * 4 * 3600 ;
    ...
    * - `whitelist`  whitelist
    */
    function addWhitelist(address[] memory whitelist,uint8 number) public{
