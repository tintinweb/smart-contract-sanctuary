...
contract AlphaWolves is ERC721Enumerable, Ownable {
    ...
    uint256 public maxWolfSupply = 10; // 10000
    uint256 public maxAlphaWolfSupply = 5; // Max Alpha Wolf Count aka 5000
    ...
    function clone() public onlyWolfOwner() { 
        ...
        ERC20Burnable(stakeAddress).burnFrom(msg.sender, clonePrice);
