 ...
 * @notice  Rebalancing strategy for Alpha Vault that maintains the
 *          following range order:
 *
 *          Base order is placed between X - B and X + B + TS.
 *
 *          where:
 *
 ...
 *              B = base threshold
 *
 *          Note that after this order, the vault should have deposited
