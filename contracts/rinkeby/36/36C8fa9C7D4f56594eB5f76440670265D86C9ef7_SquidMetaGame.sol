...
contract SquidMetaGame is Initializable {
    ...
    event LuckChange(address operator,address pre_,address cur_);
    ...
    function extract(uint256 time) public {
        ...
        LuckToken.transferFrom(msg.sender, _recipientAddress, amount_);
    ...
    function withdraw(
        ...
        require(
            LuckToken.balanceOf(address(this)) >= amount,
            "stake insufficient"
        );
    ...
    function setToken(address token_) public onlyOwner {
       ...
       emit LuckChange(msg.sender,address(LuckToken),token_);
       LuckToken = IERC20(token_);
    }
