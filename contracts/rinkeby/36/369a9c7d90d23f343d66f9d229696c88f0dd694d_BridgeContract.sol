...
contract BridgeContract {
    ...
    uint256 constant WITHDRAW_ID_PARAMS_INDEX = 0;
    uint256 constant TIMESTAMP_PARAMS_INDEX = 1;
    uint256 constant TOKEN_ID_PARAMS_INDEX = 2;
    ...
    function withdraw(
        ...
        checkSignature(timestamp, withdrawID, tokenID, _r, _s, _v);
        _withdrawFromHotwallet(msg.sender, withdrawID, tokenID);
    }
    ...
    function lazyWithdraw(
        ...
        require(!withdrawals[withdrawID], "such-withdraw-already-used");
        checkSignature(timestamp, withdrawID, 0, _r, _s, _v);
        _withdrawFromHotwallet(msg.sender, withdrawID, IERC721(contr).mint(hotwallet, tokenURI));
    }
}