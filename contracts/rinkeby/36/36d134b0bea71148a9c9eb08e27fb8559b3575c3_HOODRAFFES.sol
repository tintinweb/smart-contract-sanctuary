...
contract HOODRAFFES is ERC721Enumerable, Ownable
{
    ...
    constructor() ERC721("Hood Raffes", "HOODRAFFES")  {
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmYBmTxJH9e9FucSmSRBUNH82E31mt2LSmrVpFeW8rvS4T/");

        for(uint i = 1001 ; i < 1101 ; i++){
    ...
    function flipRevealStatus() public onlyOwner {
        revealed = !revealed;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory base = baseURI();
        return bytes(base).length > 0 && revealed ? string(abi.encodePacked(base, tokenId.toString(), ".json")) : "https://gateway.pinata.cloud/ipfs/QmZnSujmn8uWaJQ6tZSx5DaZGodBMEWCPm2kcfBA5Uqia9";
    }
}