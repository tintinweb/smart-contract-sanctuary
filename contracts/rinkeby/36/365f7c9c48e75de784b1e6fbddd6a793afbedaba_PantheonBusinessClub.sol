...
contract PantheonBusinessClub is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    uint256 public nftPrice = 35000000000000000; // 0.35 ETH
    ...
    address[] private _team = [
        ...
        0xCf9192559C45c7EBDD2C4e3369D8e5CDe0647d7B,
        0x0d9A8d33428bB813Ea81D32B57A632C532057Fd5,
        0x0EefcD4C37C78eD786971EC822a1DA6977B08EaC
    ];

    //     address[] private _team = [
    //     0x17482Fa6221f7A6c8453901711d6E2cb3C1355E7, // ALEX 14%
    //     0xa2D23B0C857E802B97c99bD006Bd707139bAef9A, // PJ 14%
    //     " ", // WISS 10.5%
    //     0x0d9A8d33428bB813Ea81D32B57A632C532057Fd5, //PBCvault (team) 31.5%
    //     0x0EefcD4C37C78eD786971EC822a1DA6977B08EaC // PBC trésorerie 30%
    // ];
    ...
    uint256 public stage2 = 2222;
    uint256 public stage3 = 3333;
    uint256 public stage4 = 4444;
    uint256 public stage5 = 5555;
    uint256 public stage6 = 6666;
    uint256 public stage7 = 7777;
    ...
    {
        setBaseURI('ipfs://QmWokQaSi5MAXn5WwKVjxfPtkNXviEceNWCGSpoAHGMmQe/');
    ...
    /**
     * retrait des eth stockés dans le smart contrat
    ...
    */
    ...
    function mintG(address[] memory addresses, uint256 nbCard) public onlyOwner {
        ...
        for (i = 0; i < addresses.length; i++) {
            uint256 j;
            for (j = 0; j < nbCard; j++) {
            _safeMint(addresses[i], supply + i + j);
            }
        }
    }
