...
contract OneMillionNumbers is ERC721, Ownable {
    ...
    constructor() ERC721("OneMillionNumbers", "OneMillionNumbers") {}
                ...
                "<svg viewBox='0 0 640 640' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' class='", classname, "'>",
                    "<style>",
                        ...
                        "text { ",
                            ...
                            "stroke-width: 0.2em;",
                            "stroke-linecap: butt;",
                            "stroke-linejoin: round;")),string(abi.encodePacked(
                            "stroke-opacity: 1;",
                        ...
                        ".d69 > text { letter-spacing: -0.1em; }")),string(abi.encodePacked(
        ...
        bytes memory json = abi.encodePacked(
            string(abi.encodePacked(
                '{',
                    ...
                    '"image": "', image, '",')),string(abi.encodePacked(
                    '"traits": [ ',
