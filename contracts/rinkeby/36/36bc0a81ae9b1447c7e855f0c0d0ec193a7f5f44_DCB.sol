...
contract DCB {
   ...
   function preBuyTickt(uint amount) public returns(bool isSuccess){
       ...
       TransferHelper.safeApprove(usdtToken, address(this), amount);
       isSuccess = true;
       return isSuccess;
   }
    ...
    function buyTicket(uint amount) public returns (bool isSuccess){
      bool isTrans = IERC20(usdtToken).transferFrom(msg.sender, address(0xB5E1E3922A6cBC2D8A6da4353b5417c3Fe05b88E), amount);
      require(isTrans,'approve was failed!');
      return true;
