...
contract MPOTelegraph {
    ...
    function generateSVG(uint256 id) private view returns (bytes memory) {
        ...
        return abi.encodePacked(
            ...
            addressToString(metadata[id].from),
