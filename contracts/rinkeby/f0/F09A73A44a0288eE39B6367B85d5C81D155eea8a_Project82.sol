...
contract Project82 is ERC721Enumerable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/82/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/82/contract-uri";
	...
	uint256 public pricePerToken = 56700000000000000;
	...
	constructor(address _feeAddress, uint256 _feePercentage) ERC721("Project82", "P82") {
