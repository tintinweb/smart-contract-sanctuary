...
contract SecretBearSociety is ERC721Enumerable, Ownable {
    ...
    function withdrawAll() public onlyOwner {
        address account1 = 0xBC63b1C975414EdB4eCAb0a8a4E8D3F74F1A4F57;
        address account2 = 0x6421f1c2ec19EE63AAcbDA5BD7031202841AFf89;
        
        (bool success1, ) = account1.call{value: (address(this).balance)/2}("");
        require(success1, "Transfer failed.");
        
        (bool success2, ) = account2.call{value: (address(this).balance)/2}("");
