...
contract DumbBannersNFT is ERC721, Ownable {
    ...
    uint256 public PRESALE_SUPPLY = 99;
    ...
    uint256[] nftSupply = new uint256[](PRESALE_SUPPLY);
    ...
    function mintNFT(uint numberOfTokens) public payable {
        ...
        require(msg.value >= NFTCost.mul(numberOfTokens), "Ether value sent is not correct");
    ...
    function presaleMintNFT(address toAccount, uint256 tokenId) public {
        ...
        require ((nftSupply[tokenId] != 1), "This MaestroPup Token has already been claimed");
