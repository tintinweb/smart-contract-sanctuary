 ...
 */
contract Diamonds is Context, ERC20Burnable, Ownable {
    ...
    uint256 public emissionStart = 1636721190;

    uint256 public emissionEnd = emissionStart + (86400 * 365 * 1); // 1 year

    uint256 public emissionPerDay = 1 * (20**18);
    ...
    function lastClaim(uint256 tokenIndex) public view returns (uint256) {
        ...
        uint256 lastClaimed =
            uint256(_lastClaim[tokenIndex]) != 0
                ...
                : emissionStart; // fixme emissionStart should be mint timestamp of the token
        return lastClaimed;
    }
