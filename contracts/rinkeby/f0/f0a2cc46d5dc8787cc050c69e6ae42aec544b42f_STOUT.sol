...
contract STOUT is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable{
    ...
    event CreateSTOUT(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Stout Santas", "STOUT") {
		setBaseURI(baseURI);
        pause(true);
    }
