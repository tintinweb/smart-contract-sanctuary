...
contract NftUnboxer is IERC721Metadata, ERC721Enumerable, ERC721Burnable, ERC721Pausable, Ownable, Security, ReentrancyGuard {
    ...
    string internal baseURIString = "https://www.sccnft.com/api/cat/metadata/";
    string internal contractURIString = "https://www.sccnft.com/api/contract/cats";
    ...
    constructor(address boxContractAddress, address adminAddress, address payable payeeAddress, string memory baseURI, string memory contractURI) ERC721("SCC Cat", "SCCC") {
        ...
        _nftBox = INftBoxBurner(boxContractAddress);
    ...
    function setTrustedConsumer(address trustedConsumer) public onlyAdmin {
    ...
    function unbox(uint256 nftBoxTokenId) external payable onlyAllowList nonReentrant {
        ...
        uint256 genesisLessThanTokenId = _nftBox.getGenesisTotal();
     ...
     * Requirements:
     * - `tokenId` must exist.
     * - assumes encodedURI is base64 formatted `data:application/json;base64,...` or decentralized URL.
     */
    function bakeTokenURI(uint256 tokenId, string memory encodedURI) external onlyRole(BAKER_ROLE) {
