...
contract Orange is ERC721EnumerableAlt, Ownable {
    ...
    constructor(PaymentStruct[] memory _payments) ERC721Alt("Orange Friends Rinkeby", "Orange Rinkeby") {
    ...
    */
    ...
    function revealTokens(string memory _uri, uint128 _tokenRange) external onlyOwner {

        RevealStruct[] memory RevealList = revealList;
    ...
    /**
    * @dev Withdraw funds from the contract, allocating set funds to addresses everyone has been payed out. Any excess can be withdrawn by 
    */
