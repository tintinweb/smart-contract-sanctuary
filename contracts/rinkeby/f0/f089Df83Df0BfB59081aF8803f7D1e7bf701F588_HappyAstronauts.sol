...
constructor(string memory _name,
    ...
    string memory _uri,
    address _proxyRegistryAddress) public ERC1155Astronauts(_name, _symbol, _uri, _proxyRegistryAddress){
...
contract ERC1155Astronauts is ContextMixin, ERC1155Burnable, ERC1155Pausable, Ownable {
    ...
    function mint(address _to, uint256 _id, uint256 _quantity, bytes memory _data) public {
        ...
        require(address(proxyRegistry.proxies(owner())) == _msgSender() || owner() == _msgSender() || isContractOperator(_msgSender()));
