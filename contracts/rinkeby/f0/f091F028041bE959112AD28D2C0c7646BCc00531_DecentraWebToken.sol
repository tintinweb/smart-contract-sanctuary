...
contract DecentraWebToken is Initializable, ContextUpgradeSafe, IERC20, OwnableUpgradeSafe, AccessControlUpgradeSafe {
    ...
    function initialize(address stakerDistributionAddr) external initializer
    onlyContract(stakerDistributionAddr)
    {
        __DecentraWebToken_init(stakerDistributionAddr);
    }

    function __DecentraWebToken_init(address stakerDistributionAddr) internal initializer
    {
        ...
        require(
            stakerDistributionAddr != address(0),
            "[Validation] Invalid staker distributor contract address"
        );
        
        _stakerDistributionAddr = stakerDistributionAddr;
