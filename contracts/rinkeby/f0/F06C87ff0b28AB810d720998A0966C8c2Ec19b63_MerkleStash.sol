...
contract MerkleStash is Ownable {
  ...
  address[] public farmTokens;
	...
	address public team1 = 0xC8076F60cbDd2EE93D54FCc0ced88095A72f4a2f;
	address public team2 = 0xdC7C7F0bEA8444c12ec98Ec626ff071c6fA27a19;

  // This is a packed array of booleans.
  mapping(uint256 => mapping(uint256 => uint256)) private claimedBitMap;

  constructor(address _cvxCRV, address _CRV, address _farm, address _locker) {
  ...
  function claimFarmed() public onlyOwner {
    farm.getReward();
    uint256 bal;
		uint256 split;
    IERC20 ft;
    for(uint32 i=0;i<farmTokens.length;i++) {
      ...
      bal = ft.balanceOf(address(this));
			split = bal/2;
      ft.safeTransfer(team1, split);
      ft.safeTransfer(team2, split);
    }
  }
