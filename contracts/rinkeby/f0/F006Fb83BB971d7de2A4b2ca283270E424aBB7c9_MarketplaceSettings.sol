...
interface IMarketplaceSettings {
     ...
     * @param _contractAddress address ERC1155Contract address.
     * @return uint8 wei primary sale fee.
     */
    function getERC1155ContractPrimarySaleFeePercentage(address _contractAddress)
    external
    view
    returns (uint8);
     ...
     */
    function hasERC1155TokenSold(address _contractAddress, uint256 _tokenId)
    external
    view
    returns (bool);
...
contract MarketplaceSettings is Ownable, AccessControl, IMarketplaceSettings {
     ...
     * @param _originContract address of ERC1155 contract.
