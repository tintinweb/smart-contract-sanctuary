...
contract CLIQStaking {
    ...
    mapping(address => uint256) public tokenStakingIdLength;
    ...
    mapping(address => uint256) public bnbStakingIdLength;
        ...
        returns (bool)
    {
        ...
        tokenStakingIdLength[msg.sender] += 1;
        ...
        returns (bool)
    {
        ...
        bnbStakingIdLength[msg.sender] += 1;
