...
contract SchnoodleV1 is ERC20PresetFixedSupplyUpgradeable, OwnableUpgradeable {
    ...
    function setEleemosynary(address account, uint256 percent) public onlyOwner {
        ...
        emit EleemosynarySet(account, percent);
    }
    ...
    event FeePercentSet(uint256 percent);

    event EleemosynarySet(address indexed account, uint256 percent);
}
