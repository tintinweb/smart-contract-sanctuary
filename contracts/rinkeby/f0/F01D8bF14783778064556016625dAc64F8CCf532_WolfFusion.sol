...
contract WolfFusion is AccessControl {
    ...
    WolfGang _wolfgang = WolfGang(0x627795219fdc67D78E6321D5ce95bb00ada79eca);
    ...
    function fuse(uint tokenA, uint tokenB, bytes memory traits, bool payWithEther) public payable {
        ...
        require(_wolfpawn.transferFrom(address(this), msg.sender, fusePawnCashback), "pawn cashback transfer exception");
