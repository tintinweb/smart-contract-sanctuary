...
//   ======================================
    ...
    function shareLongTermAssets (address _beneficiary, uint256 _amount) external  onlyRole(Contract_Manager) {
        require (!Wallet[_beneficiary].isInternal && !Wallet[_beneficiary].isLocked 
                 && Wallet[_beneficiary].balance == 0, "Doesn't fit the requisites");
...
//   ======================================
    ...
    function _transfer( address sender, address recipient, uint256 amount ) internal override whenNotPaused {
        require(!Wallet[sender].isLocked, "This address can't send");  
...
//   ======================================
    ...
    function transferOwnership(address newOwner) public virtual override onlyOwner {
        require(newOwner != address(0) && newOwner != deadAssetsHole, "Owner cannot be burn-address");
...
//   ======================================
    ...
    function investorBurn (uint256 burnAmount) external { 
        ...
        require(!Wallet[_msgSender()].isInternal, "Internal Address can't burn");
...
contract SymplexiaToken is  Taxable {
  ...
  //
    ...
    constructor ()  ERC20("BETA09", "BTG09") BaseToken ( 
