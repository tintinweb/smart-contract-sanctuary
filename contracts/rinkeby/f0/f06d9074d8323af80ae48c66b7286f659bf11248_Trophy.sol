...
contract Trophy is ERC1155Supply, Ownable, Pausable {
    ...
    uint256 public constant TOKEN_ID_PRIORTROPHY = 2;
    ...
    function setTrophySaleState(bool newState) public onlyOwner {
        require(saleIsActiveTrophy != newState, "NEW_STATE_IDENTICAL_TO_OLD_STATE");
        saleIsActiveTrophy = newState;
    }

    function setPriorTrophySaleState(bool newState) public onlyOwner {
        require(saleIsActivePriorTrophy != newState, "NEW_STATE_IDENTICAL_TO_OLD_STATE");
        saleIsActivePriorTrophy = newState;
    }
     ...
     */
    function lockTropy() public onlyOwner {
