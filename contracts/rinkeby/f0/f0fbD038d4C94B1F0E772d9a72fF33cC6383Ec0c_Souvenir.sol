...
contract Souvenir is Ownable, ERC721, IRaribleRoyaltiesV2 {
    ...
    constructor(address _royaltyContractAddress) ERC721("Brendan Fernandes Souvenir", "SOUVENIR") {
        ...
        // Defaults
        contractUri = 'https://gateway.pinata.cloud/ipfs/QmUeUrBj7ccHdzP6xmrjqit3qrFhLRjnvkE9N8wK1f3oi4'; // @TODO(iolson): Update for Production
        metadataBaseUri = 'https://gateway.pinata.cloud/ipfs/QmPaMqnNwUvCWu8SU3LqfU4wDTY4oiMPuLBk8x3jW4s7ge/'; // @TODO(iolson): Update Metadata Base URI
