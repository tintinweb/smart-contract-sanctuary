...
contract LootAvatars is VRFConsumerBase, ReentrancyGuard, ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    address public lootAddress = 0xBD0f898eE38F8124b339066b0bD67ff85F0edf5C;
    ...
    uint256 public constant MAX_ELEMENTS = 8;
    uint256 public constant LAST_WINNER_OF_TOKEN_NUM = 7;
    uint256 public constant ELEMENTS_PER_TIER = 1;
    uint256 public constant MAX_BY_MINT = 20;
    uint256 public constant START_PRICE = 0 ether;
    uint256 public constant PRICE_CHANGE_PER_TIER = 0.05 ether; // price not change
    uint256 public constant BLOCKS_PER_MONTH = 10; // assume each block is 13s, 1 month = 3600 * 24 * 30 / 13
