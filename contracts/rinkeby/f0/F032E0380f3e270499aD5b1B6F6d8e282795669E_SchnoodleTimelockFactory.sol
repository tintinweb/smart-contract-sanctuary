...
contract SchnoodleTimelockFactory {
    ...
    constructor() {
        tokenImplementation = address(new SchnoodleTimelock());
    }

    function createToken(IERC20Upgradeable token, address beneficiary, uint256 releaseTime) external returns (address) {
