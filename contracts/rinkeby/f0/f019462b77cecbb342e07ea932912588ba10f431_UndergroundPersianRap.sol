...
=== 'Underground Persian Rap' Token contract with following features ===
    => ERC20 Compliance
...
======================= Quick Stats ===================
    => Name        : Underground Persian Rap
    => Symbol      : UPR
    => Total supply: 11,000,000 (11 Million)
    => Decimals    : 8
...
-------------------------------------------------------------------
 ...
 Copyright (c) 2020 onwards Underground Persian Rap Team ( https://UPR.io )
...
contract UndergroundPersianRap is owned {
    ...
    string constant private _name = "Underground Persian Rap";
