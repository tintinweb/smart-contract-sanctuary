...
contract Monsters is ERC721PresetMinterPauserAutoId, Garage {
    ...
    using Counters for Counters.Counter;
    Counters.Counter private _purchaseIdTracker;
    ...
    function purchase() public payable override {
        ...
        uint256 purchaseId = _purchaseIdTracker.current();
        metaDataTracker[purchaseId] = uint2str(random() % 15);
