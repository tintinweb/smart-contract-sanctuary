...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    constructor() {
        _name = "Proof of Autism";
        _symbol = "AUTISM";
        _creator = "Based Autism Collective";

        _owner = msg.sender;
       
        _baseURI = "https://gist.githubusercontent.com/smatthewenglish/0c970cc3f3c1baa01054983fd7719ddb/raw/c66f891aecefe262134c603a108962c654388f54/gistfile1.txt";
        _typeCount = 1;
        _operand = 10000;

        _typeName[1] = "Proof of Autism";
        _typeIPFSHashes[1] = "QmWVoK9nnsw2gyrcKjjWN8Q1JFjNtYAJAyRsnqA5kMAB4f";
    }
