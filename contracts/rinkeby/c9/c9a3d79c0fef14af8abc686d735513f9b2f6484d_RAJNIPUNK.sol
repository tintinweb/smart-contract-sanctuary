...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable,VRFConsumerBase {
    event randomness_with_tokenID(uint256 _sample, uint256 _value);
  ...
  // mapping for token creator
    ...
    uint256 public linkfee;
     ...
     mapping(bytes32 => uint256) public req_token_ID_map;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) public override returns(uint256) {
        ...
        uint256 newItemId = req_token_ID_map[requestId];
        _setlinkURI(newItemId,randomResult);
        emit randomness_with_tokenID(newItemId,randomResult);
        return randomResult;
...
contract RAJNIPUNK is ERC721 {
    ...
    function createCollectible() public returns (uint256) {
        ...
        req_token_ID_map[reqID] = newItemId;
