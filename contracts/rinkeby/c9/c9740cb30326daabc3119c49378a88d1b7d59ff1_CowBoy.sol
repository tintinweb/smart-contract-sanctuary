...
contract CowBoy is ERC721Enumerable, Ownable {
    ...
    uint256 public limit = 5000;
    uint256 public maxPerTx = 15;

    address public fundWallet;
    
    constructor(string memory baseURI, address _fundWallet) ERC721("Official Cowboy", "CB")  {
    ...
    function mint(uint256 num) public payable {
        ...
        require( supply + num <= limit - _reserved,     "Exceeds maximum supply" );
    ...
    function withdrawAll() public payable onlyOwner {
        require(fundWallet != address(0), "Zero address error");
