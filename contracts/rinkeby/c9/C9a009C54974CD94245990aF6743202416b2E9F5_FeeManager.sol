...
contract FeeManager is Ownable{
    ...
    ObofinanceMoneyPot public moneyPot;
    IObofinanceRouter02 public router;
    OboToken public obo;
    ...
    constructor (OboToken _obo, address _teamAddr,
    ...
    function removeLiquidityToToken(address _token) external{
        IObofinancePair _pair = IObofinancePair(_token);
    ...
    function setupRouter(address _router) external onlyOwner{
        router = IObofinanceRouter02(_router);
    }
    ...
    function distributeFee() external {
        ...
        if (obo.balanceOf(address(this)) > 0){
            obo.transfer(address(0x000000000000000000000000000000000000dEaD), obo.balanceOf(address(this)));
        }
    }
