...
mapping (address => uint) public arr;
    ...
    uint256 mintprice= 60000000000000000 wei;

    address www= 0xA2059f12Fa52644925fc8132E23A6e171A4F6a23;
...
mapping (uint256 => bool) public dotokenexist;
    ...
    //this function gets a value from a specific address in the map
    //If a value was not set the function will return the default value of 0.
    function gettoken(uint idd3) internal view returns (bool) {
    ...
    //this function gets a value from a specific address in the map
    //If a value was not set the function will return the default value of 0.
    function gettokentime(uint idd6) internal view returns (uint) {
 ...
 function setRari(uint256[] memory rarity, uint256 start1, uint256 end) external {
        for (start1; start1 < end ; start1++){
            uint a= rarity[start1];
        tokenid[a]= start1;
    }}
...
// in dynamic array
    ...
    function SOTMTOKENBYINDEX(address _address) internal {
         ...
         if(a==true){
            ...
            uint totalreward= lasttime-start;
            totalreward= ceilDiv(totalreward, 60);
    ...
    function getrarirty(uint256 idtoken) internal view returns (uint256 rari){
    ...
    function claimrewardd(address _adddress) public payable  {
        ...
        require(msg.value<=(SOTMBALANCeE()*38));
        {
            bool a= get();
            ...
            if (a == true)
            {
              ...
              require (lasttime<= block.timestamp, "Already claimed");{
                  ...
                  require(rewardyoucanclaim>0, "You can't claim");{ 
                    _mint(_adddress, rewardyoucanclaim );
                    rewardyoucanclaim=0;}
