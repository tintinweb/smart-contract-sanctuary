...
abstract contract feeshContract {
...
contract feeshTank is ERC721Enumerable, IERC721Receiver {
  ...
  constructor(address _feesh) ERC721("Feesh Tank", "FSHTNK") {
    feesh = feeshContract(_feesh);
  }
  ...
  function returnAllFeesh(uint256 _id) external {
    require(msg.sender == ownerOf(_id), "only tank owner can return the feesh");
  ...
  function tokenURI(uint256 id) public view override returns (string memory) {
      ...
      string memory name = string(abi.encodePacked('Feesh Tank #',id.toString()));
      string memory description = string(abi.encodePacked('Feesh Tank'));
        ...
        Base64.encode(
            bytes(
                abi.encodePacked(
                    ...
                    '", "description":"',
                    description,
                    '", "external_url":"https://goodmorningnews.club/',
                    id.toString(),
                    '", "owner":"',
  ...
  function renderTokenById(uint256 id) public view returns (string memory) {
    string memory render = string(abi.encodePacked(
       '<rect x="0" y="0" width="270" height="270" stroke="black" fill="#338BFF" stroke-width="5"/>',
       // - (0.3, the scaling factor) * feesh (cx, cy).
  ...
  function renderFeesh(uint256 _id) internal view returns (string memory) {
    ...
    for (uint8 i = 0; i < feeshById[_id].length; i++) {
      ...
      feeshSVG = string(abi.encodePacked(
        ...
        feesh.renderTokenById(feeshById[_id][i]),
        '</g>'));
    }
