...
contract TronicRacer is ERC721, Ownable, WithIPFSMetaData, WithContractMetaData, WithWithdrawals {
    ...
    function mintWithMiniRacer(uint256 amount, uint256[] memory tokenIds) external payable {
        require(block.timestamp > miniRacerSaleStartTimestamp, "Mini Racer MOGO has not started");
    ...
    function mintFromWhitelist(uint256 amount, bytes32[] calldata proof) external payable {
        require(block.timestamp > whitelistSaleStartTimestamp, "Whitelist sale has not started");
