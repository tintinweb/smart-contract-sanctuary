...
contract CoolNouns is INounsToken, Ownable, ERC721Enumerable {
    ...
    uint256 public price = 30000000000000000; // .02 eth
    ...
    constructor() ERC721('CoolNouns', 'COOL') {
        // Populate `clothingList` with spooky hat
        ...
        proxyRegistry = IProxyRegistry(0xF57B2c51dED3A29e6891aba85459d600256Cf317);
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory name = string(abi.encodePacked('SpookyDAO ', NounID));
