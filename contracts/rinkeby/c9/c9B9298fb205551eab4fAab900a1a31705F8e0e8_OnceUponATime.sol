...
contract OnceUponATime is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private eventDescription = [
        ...
        " they discover a secret and mysterious door to a different dimension.",
        " our hero is mistaken for a spy.",
        " a conflict between the classes erupts.",
        " an old classmate shows up.",
        " a political scandal erupts.",
        " our hero is accidentally sent back in time.",
        " a full-scale gang war is set in motion."
    ];
    ...
    string[] private externalConsequence = [
        ...
        " a robot machine was plotting to kill them.",
        ...
        " everyone goes in a dangerous adventure.",
        " finds their family and friends slaughtered.",
        " many people were hurt along the way.",
        " a child is taken hostage.",
        " greed took over everyone.",
        " was treasoned by their best friend.",
    ...
    string[] private climax = [
        ...
        " is consumed in power and defeats",
    ...
    function getConsequence(uint256 tokenId)
        public
        view
    ...
    function getConsequence2(uint256 tokenId)
        public
        view
        returns (string memory)
    {
    ...
    function getConsequence3(uint256 tokenId)
        public
        view
        returns (string memory)
    {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.font { fill: black; font-family: sans-serif; font-size: 16px; line-height: 25px; } foreignObject { width: 94%; padding: 28px; height: 100%; }</style><foreignObject x="0" y="0" class="font">';
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        toString(tokenId),
                        '", "description": "Where will your adventure lead?", "image": "data:image/svg+xml;base64,',
    ...
    function publicClaim(uint256 tokenId) public nonReentrant {
    ...
    modifier onlyAdmin() {
        require(
            _msgSender() == 0x273Dc0347CB3AbA026F8A4704B1E1a81a3647Cf3 ||
                ...
                _msgSender() == 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266,
            "No access"
        );
        _;
    }
