...
contract FAMECollectible is ERC1155Tradable {
  ...
  function setConversion(uint256 sourceID, uint256 targetID, uint256 multiplier, uint256 divisor) public
  {
  ...
  function deactivateConversion(uint256 sourceID, uint256 targetID) public
  {
    require(_exists(sourceID),"INVALID_SOURCE");
    require(_exists(targetID),"INVALID_TARGET");
