...
contract loan{
    ...
    Credit_token CT = Credit_token(0x217A35e37d3e730550ce4C76B41ee974afCEd688);
    decoffer_V2 DT = decoffer_V2(0xC5Ab125254040d153ec597cBecf1B3BFd0B2f027);
    
    
    
    address public owner;
    address public debt_address;
    ...
    function pay_off()public {
        ...
        CT.transferFrom(address(DT),debt_address,loan_info[msg.sender][2]);
        reset();
    }
    ...
    function set_debt_address(address _manager)public onlyOwner{
        debt_address = _manager;
    }
