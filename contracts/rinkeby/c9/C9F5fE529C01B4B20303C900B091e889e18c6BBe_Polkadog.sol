...
contract Polkadog is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    function getTaxValues(address sender, address recipient, uint256 tAmount) public view returns(uint256, uint256,uint256,uint256,uint256,uint256,uint256,uint256){
        ...
        return (taxAmount.tTransferAmount, taxAmount.tFee, taxAmount.tLiquidity, taxAmount.tBurn, taxAmount.tMarketingFee, taxAmount.rAmount, taxAmount.rTransferAmount, taxAmount.rFee);
    }
