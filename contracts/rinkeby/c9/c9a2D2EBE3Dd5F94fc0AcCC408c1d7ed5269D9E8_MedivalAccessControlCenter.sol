...
contract MedivalAccessControlCenter is AccessControlEnumerable {    
    bytes32 public constant KEEPER_ROLE = keccak256("KEEPER_ROLE");


    bytes32 public constant TREASURY_ID = keccak256("TREASURY_ID");
    bytes32 public constant GOVERNANCE_ID = keccak256("GOVERNANCE_ID");
    ...
    constructor(
        ...
        _setAddress(GOVERNANCE_ID, _governance);
    }
    ...
    function governance() public view returns(address) {
        return addressBook[GOVERNANCE_ID];
    }
}