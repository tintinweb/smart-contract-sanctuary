...
contract Toadz is ERC721, Ownable {
    uint256 public constant maxTokens = 69;                     //  CHANGE TO 6969 FOR FINAL DEPLOYMENT
    ...
    uint256 public reservedTokens=50;   //tokens reserved for dev issuance
    uint256 public nextTokenId=reservedTokens+1;
    address payable [] public teamMembers = new address payable[](10);
    uint256 private multiSigPercent;
    address payable public toadzMultiSig;
    ...
    constructor()
        ...
        ERC721("Toadz", "TDZ")
    {
            ///                         TO UPDATE   - randomly genetated wallets for testing
    teamMembers[0] = msg.sender;
    teamMembers[1] = 0xCDAd690CF10889aaa9Bd61425D7D5fEb99D30e58;
    teamMembers[2] = 0x52d869DfBD4b867d512C6d281bD6A37613b27416;
    teamMembers[3] = 0xc67f215624547D75302cA0132877065e82789cD0;
    teamMembers[4] = 0x89C639061ab5d347fC38A546bb5C5277e235221a;
    teamMembers[5] = 0x5845D8c85A7950a00A9E63fDbF99115d9CfC1838;
    teamMembers[6] = 0x0992ba6b7Ea5cB973ED7822C263A94571cF258e5;
    teamMembers[7] = 0x108A60F15A49f8DC8386b481429AA4fD700d923e;
    teamMembers[8] = 0xF1EfA1abf71Af01faE25623Daa98C01010c02874;
    teamMembers[9] = 0xA8E004592A93E867a6DE8Fc1FB1f558A01750dC7;
    toadzMultiSig  = 0x36814A6E322903E50965F5baEc2f52eD0562578D;
    multiSigPercent = 4;
    }

                            /// To confirm whether json extension required on ipfs
    ...
    //Dev may bulk mint reserved tokens at any time in any order
    function devMint(address [] memory recipients, uint256 [] memory tokenIds) 
        external 
        onlyOwner 
    {        
        for (uint256 i = 0; i < recipients.length; i++) {
            require (tokenIds[i] !=0 && tokenIds[i]<=reservedTokens,
        ...
        onlyOwner
    {
        ...
        "Sale has already started"); //dev may not change the starting block once it has been passed
        startingBlock=_startingBlock;
    }


    //Withdraw eth from the contract and send to multi sig and team members
    function withdraw() 
        public  
    {
        uint256 multiSigProceeds=address(this).balance*multiSigPercent/100;
        payable(toadzMultiSig).send(multiSigProceeds);

        uint256 teamShare = address(this).balance/teamMembers.length;
        for (uint256 i=0;i<teamMembers.length;i++){
            payable(teamMembers[i]).send(teamShare); 
        }
    }
}
