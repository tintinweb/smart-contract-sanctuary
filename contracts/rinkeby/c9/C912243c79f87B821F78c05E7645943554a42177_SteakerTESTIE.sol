...
contract SteakerTESTIE is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public constant stakersReserve = 300;
    uint256 public constant stakersPublic = 9700;
    ...
    function buy(uint256 tokenQuantity) external payable {
        ...
        require(totalSupply() < stakersMax, "OUT_OF_STOCK");
        require(publicAmountMinted + tokenQuantity <= stakersPublic, "EXCEED_PUBLIC");
        require(tokenQuantity <= stakersPurchaseLimit, "EXCEED_SVS_PER_MINT");
        require(stakersPrice * tokenQuantity <= msg.value, "INSUFFICIENT_ETH");
    ...
    function presaleBuy(uint256 tokenQuantity) external payable {
        ...
        require(totalSupply() < stakersMax, "OUT_OF_STOCK");
        require(privateAmountMinted + tokenQuantity <= stakersReserve, "EXCEED_PRIVATE");
