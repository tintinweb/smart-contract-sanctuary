...
contract TheOne is ERC721Enumerable, Ownable {
    ...
    constructor() public ERC721("TheOne", "TheOne") {
    ...
    function random() private view returns (uint) {
        ...
        return uint(keccak256(abi.encodePacked(block.difficulty, block.timestamp, _maxSupply)));
    }

    function pickTheOne() private {
        theOne = random() % _maxSupply;
    }
