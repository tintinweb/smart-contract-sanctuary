...
contract ChainRunnersBaseRenderer is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function tokenSvg(Layer [NUM_LAYERS] memory tokenLayers, uint8 numTokenLayers) public view returns (bytes memory) {
        ...
        '<image image-rendering="pixelated" href="data:image/png;base64,', tokenLayers[0].base64Png, '" />',
        '<image image-rendering="pixelated" href="data:image/png;base64,', tokenLayers[1].base64Png, '" />',
        '<image image-rendering="pixelated" href="data:image/png;base64,', tokenLayers[2].base64Png, '" />',
        '<image image-rendering="pixelated" href="data:image/png;base64,', tokenLayers[3].base64Png, '" />',
        '</svg>'
        );
    }
