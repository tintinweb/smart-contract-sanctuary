...
contract Swap is OwnableUpgradeable {
    ...
    event Withdraw(address receiver, uint256 amount, address token);
        ...
        returns (uint256 receiveAmount, uint256 blockNumber)
    {
        ...
        emit SwapToken(msg.sender, _amount, receiveAmount, _token);
    }
    ...
    function withdraw(
        ...
        emit Withdraw(_receiver, receiveAmount, _token);
    }
