...
contract FuddersNFT is ERC721("Testing", "Test"), Ownable {
    ...
    uint256 public constant MAX_SUPPLY = 200; //NGMI
    uint256 public price = 3232000000000000; //PRICE DECREASE 10X FOR TESTING INCREASE BEFORE DEPLOYMENT
    uint256 public REMAINING_RESERVED = 130;
