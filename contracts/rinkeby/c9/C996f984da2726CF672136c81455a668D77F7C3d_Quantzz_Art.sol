...
contract Quantzz_Art is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Quantzz_Art", "Demo3") {
      fee = 20000000000000000 wei; //0.02 ETH
      baseUri = "ipfs://QmfDwrbNG1NxmuvbX4cAUmx3d8Wx2RrLmQV1YUFzCqrth9/";
    }
    ...
    */
    function mint(address player, uint numberOfMints)
        ...
        returns (uint256)
    {
        require(_tokenIds.current() + numberOfMints <= 40, "Maximum amount of tokens already minted.");
