    ...
    GovernanceAndOwner
{
    ...
    ///@param _symbol- Symbol to be used for ERC20 token.
    ...
    OwnableUpgradeable
{
    ...
    modifier onlyGovernanceOrOwner {
        require(
            whiteListAddresses[_msgSender()] == true || owner() == _msgSender(),
    ...
    function addAddressInWhiteList(address addr) public onlyGovernance {
    ...
    function removeAddressFromWhiteList(address addr) public onlyGovernance {
