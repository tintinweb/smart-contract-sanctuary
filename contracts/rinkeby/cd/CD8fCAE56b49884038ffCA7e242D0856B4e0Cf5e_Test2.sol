...
contract Test2 is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/2/metadata/";
	string private _contractURI = "https://tokenfy-staging.s3.us-east-2.amazonaws.com/2/contract-uri";
	...
	uint256 public pricePerToken = 12300000000000000;

    // presale settings
    address private signerAddress;
	uint256 public presaleMaxSupply = 3;
	uint256 public presaleMaxPerMint = 2;
	uint256 public presalePricePerToken = 500000000000000;
  uint256 public presaleEndDate = 1640355629;
	...
	constructor(address _feeAddress, uint256 _feePercentage, address _affiliateAddress, uint256 _affiliatePercentage, address _signerAddress) ERC721("Test2", "TST") {
