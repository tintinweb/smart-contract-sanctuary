...
contract TestBreezeTwo is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    constructor(uint256 maxPurchase, uint256 maxTokens) ERC721("TestBreezeTwo", "TBTMSB") {
    ...
    function whitelistedOrOpenSale(address user) public view returns (bool) {
        return _whitelist[user] || _preSaleComplete;
    }

    function mintTestBreeze(uint256 mintNumber) public payable {
        ...
        // require(whitelistedOrOpenSale(msg.sender), "Not whitelisted or open Sale has not started!");
