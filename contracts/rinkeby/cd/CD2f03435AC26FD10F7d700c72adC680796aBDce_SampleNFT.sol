...
contract SampleNFT is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    uint256 immutable public maxGiftMintId = 5;

    uint256 immutable public maxWhitelistId = 10;
    uint256 public constant WHITELIST_SALE_PRICE = 0.06 ether;

    uint256 immutable public maxPublicMint = 20;
    ...
    constructor() ERC721("Pillow Cats", "PC") {
    ...
    modifier canMint(uint256 numberOfTokens) {
            require(supply.current() + numberOfTokens <= maxSupply, "Max supply exceeded!");
     _;
    }
