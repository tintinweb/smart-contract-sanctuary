...
contract OlympusBondDepository is Ownable {
    ...
    uint public vestingTermForDAI; // Block length to vest for DAI
    uint public vestingTermForLP; // Block length to vest for LP
    ...
    /**
        ...
        @param vestingTermForDAI_ uint
        @param vestingTermForLP_ uint
    ...
    function setBondTerms( 
        ...
        uint vestingTermForDAI_, 
        uint vestingTermForLP_,
        uint minPrice_, 
        uint maxPayout_,
        uint DAOShare_
    ) external onlyOwner() returns ( bool ) {
        bondControlVariable = bondControlVariable_;
        vestingTermForDAI = vestingTermForDAI_;
        vestingTermForLP = vestingTermForLP_;
        minPrice = minPrice_;
