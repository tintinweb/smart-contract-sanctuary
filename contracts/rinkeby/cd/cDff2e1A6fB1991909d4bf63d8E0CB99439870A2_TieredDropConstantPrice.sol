...
contract TieredDropConstantPrice is ERC721, ERC721Enumerable, Ownable {
    string public PROVENANCE;
    bool public saleIsActive = false;
    string private _baseURIextended;
    uint MAX_SUPPLY = 3;
    uint MINT_PRICE = 0.01 ether;
    uint MAX_PURCHASE_PER_TX = 3;
    uint NUM_TIERS;
    ...
    function mintByTier(uint numberOfTokens, uint tierId) public payable {
        ...
        uint endIndex = tiers[tierId].index + numberOfTokens;
        require(endIndex <= tiers[tierId].maxIndexExclusive, "Max purchase supply reached by tier");
    ...
    // just for testing
    function inspect(uint tierId) external view returns (TierConfig memory) {
        return tiers[tierId];
    }
