...
contract DHold is ERC20, Ownable {
    ...
    uint256 internal _ethReflectionBasis; //at 13
    ...
    constructor(
        ...
        _taxExcluded[marketingWallet] = true;
        _taxExcluded[treasuryWallet] = true;
