...
contract ToadkingsERC721 is ERC721Enumerable, Ownable {
    ...
    function mintToadking(uint256 passId) public payable {
        ...
        LilyPass.approve(address(this), passId);
...
contract Toadkings is ToadkingsERC721 {
    ...
    constructor(string memory name, string memory symbol, uint256 supply) ToadkingsERC721(name, symbol, supply) {}
