...
contract MarsPunks is ERC721Enumerable, Ownable {
    ...
    address public wallet1 = 0x6aC646018d6c82c1e51836658F9ca95885443e1c;
    address public wallet2 = 0x6aC646018d6c82c1e51836658F9ca95885443e1c;
    address public wallet3 = 0x6aC646018d6c82c1e51836658F9ca95885443e1c;
    address public wallet4 = 0x6aC646018d6c82c1e51836658F9ca95885443e1c;
    address public wallet5 = 0x6aC646018d6c82c1e51836658F9ca95885443e1c;
    address public wallet6 = 0x6aC646018d6c82c1e51836658F9ca95885443e1c;

    function withdraw() public payable onlyOwner {
        uint256 _mars1 = (address(this).balance * 350) / 1000;  // 35%  
        uint256 _mars2 = (address(this).balance * 350) / 1000;  // 35%
        uint256 _mars3 = (address(this).balance * 200) / 1000;  // 20%
        uint256 _mars4 = (address(this).balance * 50 ) / 1000;  // 5%
        uint256 _mars5 = (address(this).balance * 30 ) / 1000;  // 3%
        uint256 _mars6 = (address(this).balance * 20 ) / 1000;  // 2%

        payable(wallet1).transfer(_mars1);
        payable(wallet2).transfer(_mars2);
        payable(wallet3).transfer(_mars3);
        payable(wallet4).transfer(_mars4);
        payable(wallet5).transfer(_mars5);
        payable(wallet6).transfer(_mars6);
    }
}