...
contract AdvancedCollectible is ERC721, VRFConsumerBase {
    ...
    // in simplecollectible we return uint256 but here we return bytes coz we got it from VRF
    function createCollectible() public returns (bytes32) {
        //requestRandomness() inherited form VRFConsumerBase
        ...
        override
    {
        ...
        //msg.sender is alway vrfCoordinator since they are only one call this function. we deed to get sendre address via mapping
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(
            //_isApprovedOrOwner() and _msgSender() inherited form ERC721
