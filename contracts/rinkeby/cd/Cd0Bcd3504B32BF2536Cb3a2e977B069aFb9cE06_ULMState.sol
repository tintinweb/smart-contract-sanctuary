...
contract ULMState is IULMState, BlockTimestamp {
    ...
    function getLiquidityRatios(address _poolAddress, int24 _tickLower, int24 _tickUpper) external view returns(uint256 amount0, uint256 amount1, uint256 liquidityRatio) {
