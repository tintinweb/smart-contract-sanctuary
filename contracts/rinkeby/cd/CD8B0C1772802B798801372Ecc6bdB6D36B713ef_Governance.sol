...
abstract contract Parameters {
    uint256 public warmUpDuration = 20 minutes;
    uint256 public activeDuration = 20 minutes;
    uint256 public queueDuration = 20 minutes;
    uint256 public gracePeriodDuration = 20 minutes;

    uint256 public acceptanceThreshold = 60;
    uint256 public minQuorum = 40;

    uint256 constant ACTIVATION_THRESHOLD = 400_000_000 * 10**18;
