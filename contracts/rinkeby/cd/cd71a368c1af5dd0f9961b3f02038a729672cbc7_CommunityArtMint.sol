...
/** @title NFT contract for Communtiy Art
    @author 0xsublime.eth
    @notice This contract is the persistent center of the Community Art project,
 ...
 */
contract CommunityArtNFT is ERC721Enumerable, Ownable {
    ...
    uint256 constant public NUM_EDITIONS = 1000;
    ...
    string public baseURI = "https://communityart.io/api/token/";
    ...
    constructor() ERC721("Community Art", "COMART") { }
...
// File: CommunityArtMint.sol

pragma solidity ^0.8.7;



/** @title Community Art Minter v1
    Controls the CommunityArtNFT contract and allows users to mint new art, and the
    owner to mint a major art, that is sent to the auction contract.
 */
contract CommunityArtMint is Ownable {

    CommunityArtNFT immutable public nftContract;
    ...
    constructor(address _nftContract) {
        nftContract = CommunityArtNFT(_nftContract);
    }
    ...
    function getNextMintNumber(uint256 edition) public view virtual returns (uint256) {
        return nextMinorId[edition];
    }
    // Only owner functions.
    ...
    function mintMajor(uint256 edition) external onlyOwner() {
        ...
        require(nextMinorId[edition] -1 == maxMinorId[edition], "Number of minors is to low, need 99");
