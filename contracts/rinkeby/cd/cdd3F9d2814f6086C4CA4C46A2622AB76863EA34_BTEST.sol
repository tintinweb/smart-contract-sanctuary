...
contract BTEST is ERC721Enumerable, RandomlyAssigned, Ownable {
    using Strings for uint256;

    uint256 public _mintPrice = 0.06 ether;
    uint256 public _maxToMint = 8;
    uint256 public constant MAX_BUTTS = 50;
    uint256 public _maxToMintPreSale = 4;
    ...
    address wallet1 = 0x5B7eea8c32c24f1Fd09D77C8b22cF58F4f8a0f74;
    address wallet2 = 0x78447E304353611dfa58D646ba080858492A18F8;

    uint256 internal nonce = 0;
    uint256[MAX_BUTTS] internal indices;
    ...
    constructor() ERC721("BTEST", "BT") RandomlyAssigned(50, 0) {}
