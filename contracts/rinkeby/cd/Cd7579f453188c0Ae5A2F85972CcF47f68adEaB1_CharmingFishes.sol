...
import "./interfaces/IFearlessShrimps.sol";

contract CharmingFishes is ERC721Enumerable, Ownable {
  ...
  uint256 public publicSaleStartTime = 1637946000; // (GMT): Friday, November 26, 2021 5:00:00 PM
  ...
  function areOwned(uint256[] memory tokenIds) public view returns (bool out) {
    ...
    for (uint256 i = 0; i < tokenIds.length; i++){
      if (FS.ownerOf(tokenIds[i]) != msg.sender){
        out = false;
      }
    }
  }
...
interface IFearlessShrimps is IERC721Enumerable{
