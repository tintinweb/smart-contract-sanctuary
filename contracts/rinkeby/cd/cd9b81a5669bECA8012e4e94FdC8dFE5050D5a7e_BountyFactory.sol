...
import {ERC20Bounty} from "./ERC20Bounty.sol";
import {ERC1155Bounty} from "./ERC1155Bounty.sol";
import {IERC20VaultFactory} from "./external/interfaces/IERC20VaultFactory.sol";
...
contract BountyFactory is ReentrancyGuard {
    ...
    constructor(
        ...
        IERC20VaultFactory _tokenVaultFactoryERC20,
        ...
        ERC20Bounty _erc20 = new ERC20Bounty(_gov, _tokenVaultFactoryERC20);
        _erc20.initialize(
            _logicNftContract,
            _logicTokenID,
            "BOUNTY",
    ...
    function startBounty(
        ...
        uint256 _duration,
        bool _isPrivate
    ) external nonReentrant returns (address _bountyAddress) {
        _bountyAddress = Clones.clone(erc20);
        ERC20Bounty(_bountyAddress).initialize(
            _nftContract,
            _nftTokenID,
            _name,
            _symbol,
...
contract ERC1155Bounty is AbstractBounty, ERC1155HolderUpgradeable {
    uint256 public constant FRACTION_BASIS = 1e15; // 0.001 – RIP finney
...
contract ERC20Bounty is AbstractBounty {
    ...
    constructor(address _gov, IERC20VaultFactory _tokenVaultFactory)
        AbstractBounty(_gov)
    {
        tokenVaultFactory = _tokenVaultFactory;
    }
    ...
    function _fractionalizeNFTIfNeeded() internal override {
        ...
        address _tokenVaultAddress = tokenVaultFactory.vaults(_vaultNumber);
        tokenVault = IERC20(_tokenVaultAddress);
        emit Fractionalized(_tokenVaultAddress);
    }
}
...
interface ITokenVault {
    ...
    function fractionsID() external returns (uint256);
