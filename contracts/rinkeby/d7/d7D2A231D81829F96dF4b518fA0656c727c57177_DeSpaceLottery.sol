...
contract DeSpaceLottery is 
    ...
    mapping(bytes32 => uint) private requestIdToDrop;
    ...
    constructor(
        ...
        nft = IDESNFT(nft_);
        platformWallet = payable(platformWallet_);
    ...
    function fulfillRandomness(
        ...
        uint dropId_ = requestIdToDrop[requestId];
        address user = requestIdToUser[requestId];

        Lottery storage lottery = lotteries[dropId_];
