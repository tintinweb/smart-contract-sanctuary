...
contract SurfDreamz is ERC721Enumerable, Ownable {
    ...
    uint256 public reserve = 400;
    uint256 public presale_reserve = 86;
    uint256 public price = 0.08 ether;
    uint256 public presale_price = 0.05 ether;
    uint256 public max_per_mint = 5;
    uint256 public constant presale_max_per_mint = 3;
    ...
    event tokensMinted(address _from, uint256[] _tokens);
    ...
    function claim(uint256 quantity) public payable {
        ...
        uint256 presaleQuantityAtCost = quantity - 1;
    ...
    function _mintNFT() private returns (uint256 id) {
    ...
    function freeMint()
        public
        isSurfSpotOwner(msg.sender)
        hasNotRedeemed(msg.sender)
    {
        uint256 newTokenID = _tokenIds.current();
    ...
    function addUser(address _addressToSurfSpotlist) public onlyOwner {
        surfSpotAddresses[_addressToSurfSpotlist] = true;
    }
    ...
    function hasToken() private view returns (uint256 balance) {
        balance = balanceOf(msg.sender);
    }

    function getTokens() public view returns (uint256[] memory) {
        uint256 balance = hasToken();
    ...
    function getPresalePrice(uint256 quantity)
        public
        view
        returns (uint256 totalPrice)
    {
    ...
    function setMaxLimit(uint256 _max_per_mint) public onlyOwner {
