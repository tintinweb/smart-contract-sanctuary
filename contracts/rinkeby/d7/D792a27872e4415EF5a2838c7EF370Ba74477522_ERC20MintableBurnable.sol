...
contract ERC20MintableBurnable is ERC20Token {
  ...
  ) ERC20Token(name, symbol, decimal, initialSupply) {
  ...
  function _mint(address account, uint256 amount) internal virtual override {
    require(ERC20Token.totalSupply() + amount <= cap(), "ERC20Capped: cap exceeded");
