...
contract RFOXAuction is Context, Ownable, IERC721Receiver {
  ...
  function bid(uint _auctionId, uint _price) external {
    ...
    require(IERC20(_rfox).transferFrom(msg.sender, address(this), _price), 'Auction: RFOX transfer failed');
    require(IERC20(_rfox).transfer(auction.bidder, auction.price), 'Auction: RFOX transfer failed');
  ...
  function withdraw(uint amount) external onlyOwner {
    require(IERC20(_rfox).transfer(msg.sender, amount), 'Auction: RFOX transfer failed');
  ...
  function endAuction(uint _auctionId) external {
    ...
    require(IERC20(_rfox).transfer(auction.seller, auction.price), 'Auction: RFOX transfer failed');    
