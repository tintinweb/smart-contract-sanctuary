...
import {StakeLogicV1, NFTStatus} from "./Stake.sol";
...
contract Redeem is Ownable {
    ...
    StakeLogicV1 public lockV1;
    StakeLogicV1 public lockV2;

    constructor(
        StakeLogicV1 lockV1_,
        StakeLogicV1 lockV2_,
        IERC20 feeCurrency_
    ) Ownable() {
        setLock(lockV1_, lockV2_);
    ...
    function setLock(StakeLogicV1 lockV1_, StakeLogicV1 lockV2_)
        public
        onlyOwner
    {
        lockV1 = lockV1_;
    ...
    function redeemNFTs(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            require(
                lockV1.nftStatus(nft, tokenId) != NFTStatus.Lockable ||
                    lockV2.nftStatus(nft, tokenId) != NFTStatus.Lockable,
                "NEVER_LOCKED"
            );
 ...
 * the owner.
 */
abstract contract OwnableInitializable is Context, Initializable {
