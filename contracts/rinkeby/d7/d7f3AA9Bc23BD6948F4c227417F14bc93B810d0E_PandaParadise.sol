...
// File: PandaParadise.sol

contract PandaParadise is ERC721Enumerable, Ownable {
    ...
    function mint(uint256 num) public payable {
        ...
        require( num < 18,                              "You can mint a maximum of 18 Paradise Pandas" );
        require( supply + num < 8888 - _reserved,       "Exceeds maximum Paradise Panda supply" );
    ...
    function privateMint(uint256 num) public payable {
        uint256 supply = totalSupply();
        require( !_pausedPrivate,                     "Private Sale paused" );
        require( num < 18,                          "You can mint a maximum of 18 Paradise Pandas" );
        require( supply + num < 8888 - _reserved,     "Exceeds maximum Paradise Panda supply" );
        require( msg.value >= _price * num,           "Ether sent is not correct" );
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Exceeds reserved Panda Paradise supply" );
