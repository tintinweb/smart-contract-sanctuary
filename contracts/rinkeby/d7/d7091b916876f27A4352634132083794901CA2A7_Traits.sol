...
contract Traits is Ownable, ITraits {
    ...
    */
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        IPeople.People memory p = constructPeopleFromTokenIdForTest(tokenId);
    ...
    function constructPeopleFromTokenIdForTest(uint256 tokenId) internal view returns (IPeople.People memory t) {
        t.cloth = uint8(tokenId % _attrNumber[8]); tokenId /= _attrNumber[8];
        t.hair = uint8(tokenId % _attrNumber[7]); tokenId /= _attrNumber[7];
        t.glasses = uint8(tokenId % _attrNumber[6]); tokenId /= _attrNumber[6];
        t.nose = uint8(tokenId % _attrNumber[5]); tokenId /= _attrNumber[5];
        t.mouth = uint8(tokenId % _attrNumber[4]); tokenId /= _attrNumber[4];
        t.ear = uint8(tokenId % _attrNumber[3]); tokenId /= _attrNumber[3];
        t.eyes = uint8(tokenId % _attrNumber[2]); tokenId /= _attrNumber[2];
        t.skin = uint8(tokenId % _attrNumber[1]); tokenId /= _attrNumber[1];
        t.job = uint8(tokenId % _attrNumber[0]);
    }
