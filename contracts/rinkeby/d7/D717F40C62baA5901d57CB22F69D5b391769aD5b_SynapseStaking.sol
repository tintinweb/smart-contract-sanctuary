 ...
 */
contract SynapseStaking is RewardsDistribution, ReentrancyGuard {
     ...
     * @param _liquidity address of LP token for SNP/X liquidity on Uniswap
    ...
    ****************************************/
    ...
    function unstakeWithFee() external nonReentrant hasStake cantUnstake {
        ...
        if (ls.isWithdrawing) {
            uint256 lpTokens = (ls.tokens * 9) / 10; //remaining tokens remain on the contract
