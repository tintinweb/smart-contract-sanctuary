...
contract Words {
    ...
    function getRandomWord(
        ...
        string[] memory sourceArray) internal pure returns (string memory) {
    ...
    function getFiveSyllableLine(uint256 tokenId, uint256 lineNum) external view returns (string memory, string memory, uint256, uint256) {
        ...
        return (line[0], line[1], wordSyllables[0], wordSyllables[1]);
    }
    ...
    function getPrepositionForSevenLine(uint256 tokenId, uint256 lineNum) private view returns (string memory, uint256) {
        ...
        return (preposition, numSyllables);
    }
    ...
    function getAdjectiveForSevenLine(uint256 tokenId, uint256 lineNum, uint256 numSyllablesLeft) private view returns (string memory, uint256) {
        ...
        return (adjective, numSyllables);
    }

    function getSevenSyllableLine(uint256 tokenId, uint256 lineNum) external view returns (string memory, string memory, string memory, string memory, uint256, uint256, uint256, uint256) {
        ...
        return (line[0], line[1], line[2], line[3], wordSyllables[0], wordSyllables[1], wordSyllables[2], wordSyllables[3]);
    }
