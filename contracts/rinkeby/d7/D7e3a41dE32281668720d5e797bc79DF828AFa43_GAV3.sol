...
contract GAV3 is ERC20, Ownable, Editor {
    ...
    constructor(address payable _vaultAddress, uint256 _vaultFee) ERC20("GAV3", "GAv3") {
	...
	function updateVaultFee(uint256 newFee) public OwnerOrEditor {
        require(newFee >= 0 && newFee <= 10000, "GAv3: vaultFee fee must be between 0 and 10000");
        vaultFee = newFee;
    }
