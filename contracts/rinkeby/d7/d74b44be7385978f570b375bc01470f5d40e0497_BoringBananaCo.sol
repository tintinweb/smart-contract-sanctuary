...
/**
 * @title BoringBananaCo Contract. This contract is forked/modified from BoredApeYachtClub and borrowed a function from BGANPUNKSV2.
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract BoringBananaCo is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant bananaPrice = 35000000000000000; //0.035 ETH
    ...
    constructor() ERC721("Boring Banana Co.", "BBC") { }
    
    function initiateSale() public onlyOwner {
        require(REVEAL_TIMESTAMP == 0, "Sale already started");
    ...
    // Reserve 150 Bananas for team - Giveaways/Prizes etc
    // 100 people responded to the Twitter Giveaway
    // 50 For team + giveaways
    ...
    function tokenLicense(uint _id) public view returns(string memory) {
        require(_id < MAX_BANANAS, "CHOOSE A BANANA WITHIN RANGE");
        return "If you own this token, you have full copyright of it!";
    }
