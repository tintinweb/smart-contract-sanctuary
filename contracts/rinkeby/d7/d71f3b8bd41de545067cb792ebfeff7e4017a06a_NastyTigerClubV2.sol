...
// File: contracts/NastyTigerClub.sol
    ...
    contract NastyTigerClubV2 is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 65000000000000000; // 0.065 ETH 
      uint256 public constant maxTokenPurchase = 4;
      uint256 public constant MAX_TOKENS = 6560;
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmYGAp3Gz1m5UmFhV4PVRRPYE3HL1AmCwEKFPxng498vfb/hidden.json"; //Set hidden image metadata
        }
