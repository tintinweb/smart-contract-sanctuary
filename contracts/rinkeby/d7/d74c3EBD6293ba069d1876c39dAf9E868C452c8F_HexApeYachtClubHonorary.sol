...
contract HexApeYachtClubHonorary is ERC721Enumerable, ReentrancyGuard, Ownable {
    constructor() ERC721("HexApeYachtClubHonTest", "HAYCHTEST") Ownable() {}
        ...
        returns (string memory)
    {
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "HAYC Honorary Test #',
                        Strings.toString(tokenId + 1),
                        '", "description": "HAYC Honorary Test Membership is given to those who brought awareness to HAYC.", "image": "',
                        output,
                        '"}'
                    )
                )
