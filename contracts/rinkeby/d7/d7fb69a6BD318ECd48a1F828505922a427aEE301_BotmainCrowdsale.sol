...
contract BotmainCrowdsale is Crowdsale, TimedCrowdsale, AllowanceCrowdsale, PostDeliveryCrowdsale, IncreasingPriceCrowdsale {
    constructor(
        uint256 openingTime,
        uint256 closingTime,
        uint256 initialRate,
    ...
    function _forwardFunds() internal {
        (bool success,) = wallet().call.value(msg.value).gas(29000000)('');
