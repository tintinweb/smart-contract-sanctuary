...
// File @openzeppelin/contracts/token/ERC721/[email protected]v4.3.1
...
contract DemoContract is ERC721Enumerable, Ownable, ReentrancyGuard {
  using Address for address;
  ...
  uint256 public nPrice = 0.015 ether;
  uint256 public publicPrice = 0.04 ether;

  string public baseTokenURI;

  constructor(string memory _newBaseURI) ERC721('DEMOTEXT', 'DEM') {
  ...
  function mintWithN(uint256 nTokenId) public payable nonReentrant {
    ...
    require(msg.value == nPrice, 'Incorrect ETH Value');
    require(nContract.ownerOf(nTokenId) == msg.sender, 'Not the owner of this N');
