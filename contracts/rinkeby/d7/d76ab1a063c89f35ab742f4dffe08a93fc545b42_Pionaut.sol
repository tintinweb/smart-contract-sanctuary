...
contract Pionaut is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {    
    ...
    uint public mintSplitFeePercent1 = 50;
    uint public mintSplitFeePercent2 = 50;
    uint public royaltyCustomFeePercent = 10;
    uint public royaltyMinterFeePercent = 10;   

    address public mintSplitFeeWallet1 = 0x0f22F0f1C70b0277dEE7F0FF1ac480CB594Ca450;
    address public mintSplitFeeWallet2 = 0x6a9307652d93CaB45634cAD19cf9E60b0D7504E7;
    address public royaltyCustomFeeWallet = 0x0f22F0f1C70b0277dEE7F0FF1ac480CB594Ca450;    
    ...
    uint256 public whitelistMintTotalLimit = 1000;
    uint256 public whitelistTotalMinted = 0;

    receive() external payable {}

    constructor() ERC721('Pionaut', 'PFP') {}
    ...
    function withdraw() public onlyOwner {
        ...
        payable(mintSplitFeeWallet1).transfer((balance * mintSplitFeePercent1) / totalFeeUnitPercent);
        payable(mintSplitFeeWallet2).transfer((balance * mintSplitFeePercent2) / totalFeeUnitPercent);
    }

    function setFee(uint256 _mintSplitFeePercent1, uint256 _mintSplitFeePercent2, uint256 _royaltyCustomFeePercent, uint256 _royaltyMinterFeePercent, uint256 _totalFeeUnitPercent) public onlyOwner{
        mintSplitFeePercent1 = _mintSplitFeePercent1;
        mintSplitFeePercent2 = _mintSplitFeePercent2;
        royaltyCustomFeePercent = _royaltyCustomFeePercent;
        royaltyMinterFeePercent = _royaltyMinterFeePercent;
        totalFeeUnitPercent = _totalFeeUnitPercent;
    }

    function setWallets(address _mintSplitFeeWallet1, address _mintSplitFeeWallet2, address _royaltyCustomFeeWallet) public onlyOwner{
        mintSplitFeeWallet1 = _mintSplitFeeWallet1;
        mintSplitFeeWallet2 = _mintSplitFeeWallet2;
        royaltyCustomFeeWallet = _royaltyCustomFeeWallet;
    }
