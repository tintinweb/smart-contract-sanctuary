...
/*
    TODO
    supply possible from token contract allowance / _walletSafe balance ?
*/
...
//    function decimals(address) external returns (uint256);
}
...
*/    
    ...
    */
    function buyAmountTokens() payable external{
        ...
        IcoBalance[address(this)] += totalNet;
...
//            garb = IToken(_tokenContract).balanceOf(address(this));
    ...
    */
    function endSale() public payable{
        ...
        IcoBalance[address(this)] = address(this).balance;                          // update balance ICO contract
    ...
    */
    fallback() external payable { 
        //require (msg.value >= multiply(msg.data, tokenPrice));
//        buyTokens(msg.value); 
    }
...
//        garb = msg.value*(10**18) /tokenPrice;
    }
