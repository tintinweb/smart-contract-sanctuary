...
// File: contracts/token/ERC1155/presets/ERC1155PresetMinterPauser.sol => NFT
 ...
 */
contract NFT is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    ...
    function setURI(string memory uri_) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "NFT: must have admin role to setURI");
