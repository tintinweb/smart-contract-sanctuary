...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
    ...
    uint256 private preSalesMaxSupply1 = 1225;
    uint256 private preSalesMaxSupply2 = 9000;
    ...
    */
    ...
    function presales(
        ...
        if(salesStage == 1){
            require(sold + _initialSupply <= preSalesMaxSupply1, "Max Token reached for Sales Stage 1");
            require(_initialSupply * preSalesPrice1 == msg.value, "Invalid Fund");

        }else if(salesStage == 2){
            require(sold + _initialSupply <= preSalesMaxSupply2, "Max Token reached for Sales Stage 2");
