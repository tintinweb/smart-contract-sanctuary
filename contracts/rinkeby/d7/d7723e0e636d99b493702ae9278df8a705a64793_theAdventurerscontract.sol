...
contract theAdventurerscontract is ERC721, Ownable {
   ...
   function composePFP(address owner, uint256 WeapontokenId, uint256 PFPtokenId, uint256 newPFPtokenId) public payable returns (bool) {
   ...
   function composeWizard(uint256 PFPtokenId) public payable  {
