...
// File: contracts/SpaceRocketFleet.sol

contract SpaceRocketFleet is ERC1155PresetMinterPauser {
    using Strings for uint256;

    constructor(string memory uri) ERC1155PresetMinterPauser(uri) {
        _mint(msg.sender, 1, 14, '');
        _mint(msg.sender, 2, 33, '');
        _mint(msg.sender, 3, 10, '');
        _mint(msg.sender, 4, 25, '');
        _mint(msg.sender, 5, 11, '');
        _mint(msg.sender, 6, 17, '');
        _mint(msg.sender, 7, 50, '');
        _mint(msg.sender, 8, 25, '');
        _mint(msg.sender, 9, 14, '');
        _mint(msg.sender, 10, 13, '');
        _mint(msg.sender, 11, 17, '');
