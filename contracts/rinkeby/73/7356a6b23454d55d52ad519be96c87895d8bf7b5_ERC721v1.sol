...
contract ERC721v1 is Initializable, ERC721PresetMinterPauserAutoIdUpgradeable, OwnableUpgradeable {
  uint256 public secretNumber;
  uint256 public secretNumberTwo;

  function initialize() public initializer {
    // with the modifier initializer to make it is only init once
    __ERC721PresetMinterPauserAutoId_init('DayOne Upgradable version 1', 'DAY', 'ipfs://QmcTqigsEsUKYQ9MbeZHJ1ML6WiBZCF3cFNoCDFX3KdCLG');
    __Ownable_init();
    secretNumber = 42;
    secretNumberTwo = 100;
  }
  ...
  function getContractOnlyOwner() external view onlyOwner returns (string memory) {
    return 'the secret lies here';
  }
  ...
  function getSecretNumberTwo() external view returns (uint256) {
    return secretNumberTwo;
  }

  function getSecretNumberThree() external pure returns (uint256) {
    return 100;
  }
}
