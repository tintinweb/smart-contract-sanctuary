...
contract Swap is OwnableUpgradeable {
    ...
    event SwapToken(address receiver, uint256 amount, uint256 receiveAmount);
        ...
        returns (uint256 receiveAmount, uint256 blockNumber)
    {
        ...
        emit SwapToken(msg.sender, _amount, receiveAmount);
    }
    ...
    function withdraw(
        ...
        emit Withdraw(_receiver, receiveAmount);
    }
