...
contract DinoVerse is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    function price() public view returns (uint256 _cost) {
        ...
        return needToUpdateCost(supply);
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    // This will pay Relaxeddevil 10% of the initial sale.

    // =============================================================================
    (bool hs, ) = payable(0x194C45261Bd16B7a5Ab364715FBB06E11cb075CE).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
