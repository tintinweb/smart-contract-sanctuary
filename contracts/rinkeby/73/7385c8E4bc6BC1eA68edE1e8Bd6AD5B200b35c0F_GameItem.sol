...
contract ERC721 is  Context, ERC165, AccessControl, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(_baseURI(), _tokenURIs[tokenId],".json"));
    }
    ...
    function devMint(uint count, address recipient) external {
        ...
        for (uint i = 0; i < count; i++) {
            ...
            string memory _tokenURI = _tokenId.toString();
...
contract GameItem is ERC721  {
    ...
    constructor() ERC721("Girls", "GRLS", "https://...") {
    ...
    function withdrawAll() public payable {
        require(hasRole(MINTER_ROLE, _msgSender()), "You must have minter role to funds withdraw");
        (bool success, ) = payable(msg.sender).call{value:address(this).balance}("Tt");
