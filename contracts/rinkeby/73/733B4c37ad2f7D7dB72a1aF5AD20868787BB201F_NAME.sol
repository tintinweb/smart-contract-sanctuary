...
contract NAME is Context, IERC20, CVOwnable {
    ...
    uint256 public _liquidityFee = 0; //liq + market + char
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _marketingDivisor =0;
    uint256 public _charityDivisor = 0;
    ...
    constructor (address payable charityWalletAddress, address payable marketingWallet) public {
    ...
    function setDivisors(uint256 marketDivisor, uint256 charityDivisor) external onlyOwner{
        _marketingDivisor = marketDivisor; _charityDivisor = charityDivisor;
    }
   ...
   function manualswap() external {
    ...
    function manualsend() external {
        ...
        sendBNBToFee(_marketingWallet, contractETHBalance.div(2));
        sendBNBToFee(_charityWalletAddress, contractETHBalance.div(2));
    }
    ...
    function sendBNBToFee(address payable recipient, uint256 amount) private { 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 marketPart = contractTokenBalance.div(_liquidityFee).mul(_marketingDivisor);
        uint256 charPart = contractTokenBalance.div(_liquidityFee).mul(_charityDivisor);
        uint256 liqPart = contractTokenBalance.sub(marketPart).sub(charPart);
        ...
        sendBNBToFee(_charityWalletAddress, charPart);
        sendBNBToFee(_marketingWallet, marketPart);
