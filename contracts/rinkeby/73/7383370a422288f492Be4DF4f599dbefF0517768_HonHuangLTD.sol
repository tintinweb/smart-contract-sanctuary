...
interface MarketPlace {
    ...
    function createSale(uint256 _tokenId, uint256 _amount, uint256 _startingPrice, uint256 _endingPrice, uint256 _duration, address _seller) external;
    function createAuction(uint256 _tokenId, uint256 _amount, uint256 _initialPrice, uint256 _duration, address _seller) external;
