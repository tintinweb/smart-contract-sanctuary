...
contract AuctionNFT is ERC721, Ownable {
    ...
    /***  for test ***/
    uint256 MINT_AVAILABLE_PERIOD = 1800;
    ...
    *******************************/
    ...
    uint256 _startingPrice = 200000000000000000; // 3 * (10 ^ 17) wei
    uint256 _endingPrice = 50000000000000000; // 8 * (10 ^ 16)wei
    ...
    function requestPublicToken() external payable{
        ...
        require(_countlist[msg.sender] < MAX_OWN_COUNT, "Overflow 10 tokens");
        uint256 limitValue = getCurrenctPrice().mul(10000 - SLIPPAGE_TOLERANCE).div(10000);
    ...
    function getCurrenctPrice() public view returns (uint256) {
