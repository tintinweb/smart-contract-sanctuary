...
contract NiftyTestTreasureTokens7 is ERC721Enum, Ownable, PaymentSplitter, ReentrancyGuard {
    ...
    function setPayout(address[] calldata _addressList, uint[] calldata _shareList) public onlyOwner {
        uint percentage = 100;
        uint totalShares = 0;
