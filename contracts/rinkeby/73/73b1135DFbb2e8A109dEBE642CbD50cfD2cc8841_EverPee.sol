...
contract EverPee is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > uint256(1 * 10**18)) {
              ...
              uint256 minTransferAmountToBuyBack =_getTokenSwapRate().mul(buyBackUpperLimit.div(100));

              if (balance > buyBackUpperLimit && amount >= minTransferAmountToBuyBack) {
    ...
    function _getTokenSwapRate() private view returns(uint256) {
      ...
      // decimals
      uint res0 = Res0.mul(10**18);
      return res0.div(Res1); // return amount of token0 needed to buy token1
    }
