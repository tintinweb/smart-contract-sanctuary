 ...
 */
 ...
 contract CRYPTOCHELLE1 is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("CRYPTOCHELLE1", "CRYPTOCHELLE1") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x26aEE5F888D2F2ee18738Ad6D7A4752b46E06E4A); 
          _setupRole(MINTER_ROLE, 0x26aEE5F888D2F2ee18738Ad6D7A4752b46E06E4A); 
          _setupRole(MINTER_ADMIN_ROLE, 0x26aEE5F888D2F2ee18738Ad6D7A4752b46E06E4A); 
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x26aEE5F888D2F2ee18738Ad6D7A4752b46E06E4A);  
     }
     ...
     function mint_by_id(address to, uint256 tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "CRYPTOCHELLE1/minter-role-required");
         _mint(to, tokenId);
     }      
     /**
