...
contract RedBerry is BEP20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (recipient == BURN_ADDRESS || transferTaxRate == 0 || isExcludedFromTransferRate(sender) || isExcludedFromTransferRate(recipient)) {
    ...
    */
    function isExcludedFromTransferRate(address _account) public view returns (bool) {
        return _excludedFromAntiWhale[_account];
    }
     ...
     * Can only be called by the current operator.
     */
    function setExcludedFromTransferRate(address _account, bool _excluded) public onlyOperator {
        _excludedFromAntiWhale[_account] = _excluded;
    }
