...
contract LuckyCatz     is  ERC721Enumerable
{
    ...
    uint256 private     salesPrice         = 0.005 ether;
...
address private ownerWallet;
    ...
    uint256 private maxReservableTokenCount = 377; //total reserved token for rewards and wages
    ...
    constructor() ERC721("LKZ018 Token", "LKZ18")       // temporary Symbol and title
    {
    ...
    {
        require(amount         <= 200,                      "Reserve is limited to 100 per call at max");
        require(leftTokenCount >= amount,            "Not enough tokens left to reserve anymore");
        require(totalReserved  <= maxReservableTokenCount,  "We have already reserved all possible tokens");
