...
contract JustFive is ERC721, Ownable {
    ...
    constructor() ERC721("JustFive", "CINCO") {
        _tokenIds.increment();
    ...
    function mint(uint _amount) public payable {
        ...
        require(_tokenIds.current() + _amount <= maxSupply, "Supply exceeded");
        require(msg.value >= 100000000000000000, "Value is too low");
