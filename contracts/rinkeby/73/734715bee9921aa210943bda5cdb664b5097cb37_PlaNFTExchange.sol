        ...
        if (sell.minter != address(0)) {
            ...
            if (sell.feeMethod == FeeMethod.SplitFee) {
                ...
                if (sell.makerRelayerFee > 0) {
                    ...
                    uint256 makerRelayerFeeToExchange = SafeMath.div(
                ...
                if (sell.makerProtocolFee > 0) {
                    ...
                    uint256 makerProtocolFeeToExchange = SafeMath.div(
                        SafeMath.mul(_exchangeFee, price),
                        INVERSE_BASIS_POINT
                    );
                    if (sell.paymentToken == address(0)) {
                        receiveAmount = SafeMath.sub(
                            SafeMath.sub(receiveAmount, makerProtocolFee),
                            makerProtocolFeeToExchange
                        );
