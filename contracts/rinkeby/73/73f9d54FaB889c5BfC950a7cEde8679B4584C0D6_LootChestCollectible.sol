...
contract LootChestCollectible is BDERC1155Tradable, ERC1155Holder {
    ...
    */
    ...
    /**
    *@notice A roll was made for random determination, this is provided for transparency
    *@param user The address that opened the chests
    *@param timeStamp the timestamp that the chests were opened
    *@param roll The value rolled
    */
    event Roll(address indexed user, uint32 indexed timeStamp, uint16 roll);
