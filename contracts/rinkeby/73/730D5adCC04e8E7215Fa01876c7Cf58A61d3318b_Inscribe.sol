...
contract Inscribe is InscribeInterface {
    ...
    //keccak256("AddInscription(address nftAddress, uint256 tokenId, uint256 chainId, bytes32 contentHash, string inscriptionURI, bytes32 inscriptionId)");
    bytes32 public constant ADD_INSCRIPTION_TYPEHASH = 0x343798114e855a5a5840c4dfa1def8d6ddc66f6c476d780d7cdc310b01b09bb9;
