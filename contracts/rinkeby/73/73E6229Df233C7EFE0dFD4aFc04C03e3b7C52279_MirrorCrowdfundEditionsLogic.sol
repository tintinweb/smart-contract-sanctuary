...
import {IMirrorCrowdfundEditionsLogic, IMirrorCrowdfundEditionsLogicEvents} from "./interface/IMirrorCrowdfundEditionsLogic.sol";
...
/**
 * @title MirrorCrowdfundEditionsLogic
 * @author MirrorXYZ
 */
contract MirrorCrowdfundEditionsLogic is
    Operatable,
    Reentrancy,
    ERC721,
    IMirrorCrowdfundEditionsLogic,
    IMirrorCrowdfundEditionsLogicEvents,
    IERC721Metadata,
    IERC2309
{
    // ============ Factory ============
        ...
        returns (uint256 tokenId)
    {
        ...
        // Announce the edition purchase event.
