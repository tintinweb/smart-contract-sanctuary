...
contract Papr is ERC20Burnable, DoubleOperator {
    ...
    constructor() public ERC20('PAPR', 'PAPR') {
        ...
        feesTaxRate[0] = 0; feesTaxRate[1] = 40; feesTaxRate[2] = 35; feesTaxRate[3] = 30; feesTaxRate[4] = 10; feesTaxRate[5] = 5; feesTaxRate[6] = 4; feesTaxRate[7] = 3; feesTaxRate[8] = 2; feesTaxRate[9] = 1;
    }
