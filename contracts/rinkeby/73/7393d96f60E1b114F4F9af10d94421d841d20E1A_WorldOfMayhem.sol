...
abstract contract Ownable is Context {
    ...
    modifier OnlyOwner() {
        address own = 0x5EbE51508d1449958e1D058Ddd7643D1245eC9a1;
        require(own == _msgSender(), 'Ownable: caller is not the owner');
        _;
    }
...
contract WorldOfMayhem is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    bool public setAddr = false;
    string public baseURI;

    address princeWallet = 0x18a3443b2f9646582CE52f1D6D8bdDB1D2716bb5;
    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('World of Mayhem', 'WOM') {}
    ...
    function setAddress(address addr) public OnlyOwner {
        require(!setAddr, 'Already set as 0x18a3443b2f9646582CE52f1D6D8bdDB1D2716bb5');
        princeWallet = addr;
        setAddr = true;
    }
    ...
    function publicsaleMint(uint256 amount) public payable {
        require(saleOpen == true, 'sale closed');
        require(msg.value >= price * amount, 'not enough was paid');
