...
contract BuilderShop {
   ...
   address niftyRegistryContract = 0x33F8cb717384A96C2a5de7964d0c7c1a10777660;
...
contract NiftyBuilderInstance is ERC721Full {
   ...
   address public niftyRegistryContract = 0x33F8cb717384A96C2a5de7964d0c7c1a10777660;
   ...
   function setNumNiftyPermitted(uint256 nifty_type, uint256 num_nifty_permitted) onlyValidSender public {
       if (_numNiftyPermitted[nifty_type] != 0) {
          revert("Permitted number already set for this NFT");
       }
