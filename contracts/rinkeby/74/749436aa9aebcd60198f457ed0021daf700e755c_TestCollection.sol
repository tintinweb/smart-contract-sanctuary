...
contract TestCollection is ERC721, Ownable {
    ...
    string metaurl = 'https://testmetadatapiksl.herokuapp.com/metadata/tokenid=';
    ...
    function mintPublicTokens(uint numberOfTokens) public payable {
        require(numberOfTokens <= MaxPurchase, "Can only mint 20 tokens at a time");
        require(totalSupply().add(numberOfTokens) <= MaxTokens, "Purchase would exceed max supply of public tokens");
