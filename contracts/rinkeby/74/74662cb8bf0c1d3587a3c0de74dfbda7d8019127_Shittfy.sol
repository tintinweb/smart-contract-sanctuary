...
contract TradeableERC721Token is ERC721Full, Ownable {
  ...
  constructor(string memory _name, string memory _symbol, uint256 _supply, address _proxyRegistryAddress, string memory _LP_POOL_BONUS, uint256 _XTM_LOCKED) ERC721Full(_name, _symbol, _supply) public {
...
contract Shittfy is TradeableERC721Token, ReentrancyGuard {
  ...
  constructor(
    ...
    uint256 _xtm_locked
  ) TradeableERC721Token(_name, _symbol, _supply, _proxyRegistryAddress, _lp_pool_bonus, _xtm_locked) public {
