...
contract FOFlasttest is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(address payable fundsTo_, uint256 maxSupply_, uint256 maxPerTx_, uint256 pricePer_) ERC721("FOFlastTestHATS", "FOFLAT") {
        fundsTo = fundsTo_;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/Qmd4bXHGThwNwvZXXf6Dtvwb9WGHnHsYYYwEXCveNVbJPx/";
    }
