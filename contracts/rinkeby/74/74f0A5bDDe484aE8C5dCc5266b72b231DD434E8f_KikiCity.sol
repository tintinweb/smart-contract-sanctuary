...
contract KikiCity is Ownable, ERC721Enumerable {
    ...
    string private _baseTokenURI ="ipfs://QmT6gXf4TWeyVDP6L8W1RKJiQca7vrAn1TQUzhKGrCXw3u/";
    ...
    constructor() ERC721("Kiki City", "KIKI") {
        MAX_TOKENS = 10000;
        mintPass = 0x24C360186Ad288683d92aB65a8b3B5007aE923f4;
        _safeMint( FRANK, 0);
    }
   ...
   */
    ...
    */
    function mintPreSaleTokens(uint numberOfTokens) external payable {
        ...
        require(IERC1155(mintPass).balanceOf(msg.sender,420)>0,"You MUST have a mintpass to use get tokens");
