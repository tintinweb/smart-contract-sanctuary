...
contract Roles is AccessControl {
    ...
    modifier onlyAdmin() {
        require(hasRole(ADMIN_ROLE, _msgSender()), "Roles: caller does not have the ADMIN role");
        _;
    }
...
/**
 * @title AntCaveCoin - ACC 
 * @author AntCaveClub (https://discord.gg/Cdzy8jVKwU)
 * @dev Implementation of the ACCToken
 */
contract ACCToken is ERC20Capped, ERC20Mintable, ERC20Burnable, TokenRecover, Roles {
