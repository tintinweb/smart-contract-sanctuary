...
contract Moonopoly is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable
{
    //Initialization
    ...
    //Card Amounts
    uint256 public cards_founder = 555;
    uint256 public cards_usa = 80;
    uint256 public cards_china = 180;
    uint256 public cards_india = 270;
    uint256 public cards_switzerland = 300;
    uint256 public cards_peru = 450;
    uint256 public cards_turkey = 750;
    uint256 public cards_philippines = 900;
    uint256 public cards_vietnam = 800;
    uint256 public cards_exchange = 800;
    uint256 public cards_utility = 1000;

    function initialize() public initializer {
        __ERC1155_init("https://ipfs.io/ipfs/QmUkgTFcK9czsPQUbfwPmrU8phUvS4yqF5DXteMoNgfJrV");
        __Ownable_init();
        __Pausable_init();
        __ERC1155Burnable_init();
        _mint(msg.sender, 0, 555, "");
    }
    ...
    function uri(uint256 _tokenID) override public pure returns (string memory)
    {
        return string(
            abi.encodePacked(
                "https://ipfs.io/ipfs/QmUkgTFcK9czsPQUbfwPmrU8phUvS4yqF5DXteMoNgfJrV?filename=",
