...
import "../NomoLeague.sol";

contract NomoLeagueMock is NomoLeague {
    constructor() {
        gameDuration = 10 minutes;
        stakingDuration = 8 minutes;
    }

    function setGameAndStakingDuration(uint256 _gameDuration, uint256 _stakingDuration) external {
        require(_gameDuration > _stakingDuration, "gameDuration must be more than stakingDuration");
