...
contract MarsMaiers is ERC721, AccessControl, ReentrancyGuard {
  ...
  // allows changing baseURI to IPFS, after project is concluded
  // passing `lock=true` will freeze baseURI value and block any future changes
  ...
  // chooses a winner, and moves funds via bidToken
  ...
  // allows cashing out, from winnings only
  ...
  // returns funds for a lost bid. requires a signed signature generated on marsmaiers.com
  ...
  // validate and process return a bid, using bidder and amount keyed to bidToken
