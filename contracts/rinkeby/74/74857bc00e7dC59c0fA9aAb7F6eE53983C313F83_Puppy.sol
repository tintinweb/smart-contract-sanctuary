...
contract Puppy is ERC721, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (offset == 0) {
            ...
            return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, puppyId.toString())) : "";
        }
    }
