...
contract NFT is ERC721, Ownable, ReentrancyGuard {
  ...
  */
  ...
  function _baseHeroURI() internal pure returns (string memory) {
    return "https://mw9spidhbc.execute-api.us-east-1.amazonaws.com/dev/token/check";
  }
