...
contract Arc1 is ERC721, AccessControl, Ownable {
    ...
    constructor(uint256 maxPublic, uint256 maxTemporaryPublic, uint256 maxReserved, uint256 startingReservedID, uint256 maxPerAddress, address[] memory whitelistAddresses) ERC721("Arc2", "ARC2") {
