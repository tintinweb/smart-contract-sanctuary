...
contract TestTestTest is ERC721Enumerable, Ownable {
    ...
    function speedUpParentRelease(
        ...
        uint256 newReleaseBlock = thisBreedingEvent.releaseBlock - (_cheethAmount / CHEETH_COST_PER_BLOCK);

        //Set the new release block
        _addressToBreedingEvents[msg.sender][_breedingEventIndex].releaseBlock = newReleaseBlock;
