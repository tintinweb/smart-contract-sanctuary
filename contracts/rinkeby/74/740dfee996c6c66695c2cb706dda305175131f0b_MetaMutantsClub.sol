...
contract MetaMutantsClub is ERC721Enumerable, AccessControl, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    using Counters for Counters.Counter;
    using Address for address payable;

    address private creatorAddr = 0xC496F35cDe7cb214bE5D02f737052951C73E5465;
    ...
    uint256 public whitelistSupply = 888;
    uint256 public publicSupply = 8888;
