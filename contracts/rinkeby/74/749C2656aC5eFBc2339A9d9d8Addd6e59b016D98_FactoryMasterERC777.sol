...
import "./ERC777FixedSupply.sol";
// import "./ERC777Burnable.sol";
// import "./ERC777Mintable.sol";
import "./master-erc777Mintable.sol";
import "./master-erc777Burnable.sol";

contract FactoryMasterERC777 is MasterErc777Mintable {
  ...
  uint256 constant fee_erc777 = 0 ether;
  ...
  // event ChildCreatedERC777Burnable(
  //   address childAddress,
  //   address owner,
  //   string name,
  //   string symbol,
  ...
  //  event ChildCreatedERC777Mintable(
  //   address childAddress,
  //   address owner,
  //   string name,
  //   string symbol,
 ...
 function getLatestChildrenErc777() external view returns (address) {
  ...
  // function getLatestChildrenErc777Burnable() external view returns (address) {
  //   if (childrenErc777Burnable.length > 0) {
  //     return address(childrenErc777Burnable[childrenErc777Burnable.length - 1]);
  //   }
  //   return address(childrenErc777Burnable[0]);
  // }
...
contract MasterErc777Burnable {
  ERC777Burnable[] private childrenErc777Burnable;
  

  function createERC777Burnable(
