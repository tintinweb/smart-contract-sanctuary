...
contract XRC is ERC721A, Ownable, ReentrancyGuard {
    ...
    ) ERC721A("Test", "TEST", _maxBatchSize, _collectionSize) {
        baseURI = initBaseURI;
        _signer = signer;
    ...
    function withdraw() external nonReentrant onlyOwner {
        ...
        // TODO update values
        uint256 v1 = 0.05 * 10**18;
        uint256 v2 = 0.03 * 10**18;
        uint256 v3 = balance - v1 - v2;

        balanceWithdrawn = true;

        // TODO update wallets
        (bool success1, ) = payable(0x859957c556434e8D89771A82e1A2836150A80fc3)
            .call{value: v1}("");
        (bool success2, ) = payable(0xde7bd280B1b7a87DdFD880A71250ED416c1B3112)
            .call{value: v2}("");
        (bool success3, ) = payable(0x2982F097a68AB6caf16508FC1E17B7470c5AB71E)
            .call{value: v3}("");
