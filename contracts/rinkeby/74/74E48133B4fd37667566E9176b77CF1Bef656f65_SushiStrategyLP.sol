...
contract SushiStrategyLP is BasePairLPStrategy {
  ...
  function addPool(
    ...
    require(_pool != address(0), "Cannot be nonzero pool");
    ...
    bool oneSushiToken = token0 == address(sushiToken) || token1 == address(sushiToken);
    require(
      (oneSushiToken && pathFromSushi.length == 0)
      || !oneSushiToken,
