...
contract Sharkeby is ERC721, VRFConsumerBase {
    ...
    function setTokenURI(uint256 tokenId,string memory _tokenURI) public {
        require(
            ...
            "ERC721:transfer caller is not an owner nor approved"
        );
