...
abstract contract ArtGrailTransferManager is OwnableUpgradeable, ITransferManager {
    ...
    function __ArtGrailTransferManager_init_unchained(uint newBuyerFee, uint newSellerFee, address newCommunityWallet) internal initializer {
...
import "./ArtGrailTransferManager.sol";

contract ExchangeV2 is ExchangeV2Core, ArtGrailTransferManager {
    function __ExchangeV2_init(
        ...
        __ArtGrailTransferManager_init_unchained(newBuyerFee, newSellerFee, newCommunityWallet);
