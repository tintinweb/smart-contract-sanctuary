 ...
 */
contract BaseUpgradeableMinterPauserERC20 is BaseUpgradeable, Initializable, ContextUpgradeable, ERC20BurnableUpgradeable {
    function initialize(address settingsAddress, string memory name, string memory symbol, uint8 decimals) public virtual initializer {
        __ERC20PresetMinterPauser_init(settingsAddress, name, symbol, decimals);
    }

    function __ERC20PresetMinterPauser_init(address settingsAddress, string memory name, string memory symbol, uint8 decimals) internal initializer {
