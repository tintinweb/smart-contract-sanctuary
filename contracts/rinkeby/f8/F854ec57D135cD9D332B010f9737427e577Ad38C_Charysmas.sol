 ...
 */
contract Charysmas is ERC721, Ownable {
    
    using Address for address;

    // Minting
    bool public saleActive = true;
    uint16 public maxMintPerTransaction = 10;
    uint256 public price = 0.05 ether;
    uint16 public constant MAX_SUPPLY = 4022;
    ...
    function setMaxMintPerTransaction(uint16 maxMint) external onlyOwner {
        maxMintPerTransaction = maxMint;
    }

    function mint(uint16 numberOfMints) public payable {
        ...
        require(totalSupply + 1 < MAX_SUPPLY, "All trees have already been minted!");
    ...
    function ownerMintToAddress(address recipient, uint16 numberOfMints) external onlyOwner {
        require(numberOfMints > 0, "The minimum number of mints is 1");
        require(totalSupply + 1 < MAX_SUPPLY, "All trees have already been minted!");
