...
contract ChubbyPops is ERC721Enumerable, AccessControl, Ownable {
    ...
    uint256 public maxSaleMintPerAccount = 20;   // maximum of tokens address can hold
    uint256 public maxPreSaleMintPerAccount = 10; // maximum of tokens available by presale

    // mint token price
    uint256 public tokenPrePrice;
    ...
    function mint(
        ...
        require(totalSupply() + amount <= _cap, "ERC721Collection: Total supply will exceed limit");
        uint256 currentPrice = saleActive ? tokenPrice : tokenPrePrice;
        require((amount * currentPrice) < msg.value, "ERC721Collection: Not enough Ether sent");
