...
contract NFT is ERC721, Ownable {
    ...
    bytes32 public root = 0x71eb2b2e3c82409bb024f8b681245d3eea25dcfd0dc7bbe701ee18cf1e8ecbb1; // todo
    bytes32 public presaleRoot = 0x71eb2b2e3c82409bb024f8b681245d3eea25dcfd0dc7bbe701ee18cf1e8ecbb1; // todo
    ...
    */
    ...
    function presaleMint(address to, uint numberOfTokens, bytes32[] memory proof) public payable {
        ...
        require(NFTPrice.mul(numberOfTokens) <= msg.value, "Ether value sent is not correct");
        require(listPurchases[operator] + numberOfTokens <= maxNFTPurchase, 'Error: Each person can mint only 2 tokens');
