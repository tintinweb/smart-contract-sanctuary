...
contract troli is Context, IERC20, Ownable {
    ...
    address private _owner = 0xA996FB19AFaCecae6132614bE30a114fEa7cFdeB; //owner
    ...
    uint256 private constant _tTotal = 10 * 1e11 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "troli";
    string private constant _symbol = "troli";
    ...
    uint256 public maxAmountCanBuy = 1e7;

    uint256 public _buyTaxFee = 2;
    uint256 public _buyLiquidityFee = 5;
    uint256 public _buyMarketingFee = 6; //5 marketing 1 team
    
    uint256 public _sellTaxFee = 2;
    uint256 public _sellLiquidityFee = 5;
    uint256 public _sellMarketingFee = 6; //5 marketing 1 team
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 3;
        _rOwned[address(this)] = _rTotal / 1000 * 997;
        
         
        maxTransactionAmount = _tTotal * 5 / 1000; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 10 / 1000; // 1.0% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x5e2C0592c93cA9B46C71179d3bD0bAda34cDd335); // Marketing Address
        
        devAddress = payable(0xD756310C29e6D716469352A1718Ada4f4587fBF2); // Dev Address
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 3 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 997 / 1000);
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing *  1 / 6; // 1/6 or 1% goes to Team
