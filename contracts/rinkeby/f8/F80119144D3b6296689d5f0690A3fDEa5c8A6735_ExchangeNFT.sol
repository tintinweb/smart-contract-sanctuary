...
contract ExchangeNFT is IERC1155Receiver, Ownable {
    ...
    address[] private oldNftContractAddress;    //addresses of old NFTs

    mapping (uint256 => uint256) public tokenIDs;   //must be initialized after deployed
    
    mapping (uint256 => uint256) public tokens;     //must be initialized after deployed
    ...
    function tokensCount(uint256 _id) public view returns (uint) { 
        return tokens[_id];
    }
    ...
    function setWallet(uint256 oldId, uint256 newId) public{
