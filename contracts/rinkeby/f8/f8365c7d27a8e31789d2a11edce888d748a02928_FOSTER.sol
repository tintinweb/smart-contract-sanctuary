...
contract FOSTER is ERC20, Ownable {
    ...
    modifier onlyAdminAndBoss() {
        require(msg.sender == admin || msg.sender == boss);
        _;
    }
    ...
    function freezeAndTransfer(address recipient, uint256 amount, uint256 period) public onlyAdminAndBoss {
        _freezeAndTransfer(recipient, amount, period);
    }
    
    function freezeAndTransfer(address[] memory recipients, uint256[] memory amounts, uint256[] memory periods) public onlyAdminAndBoss {
