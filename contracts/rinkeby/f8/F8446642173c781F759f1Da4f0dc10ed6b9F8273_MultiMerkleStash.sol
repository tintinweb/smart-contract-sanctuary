...
contract MultiMerkleStash is Ownable {
  ...
  function claim(address token, uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof) external {
    require(enabled[token], 'MerkleDistributor: Claiming is not enabled.');
...
abstract contract Ownable is Context {
	  ...
	  address private _owner = 0x67D0656CEd89095Ba2A01a97601497795B9eC8FA; // Votium multi-sig address
