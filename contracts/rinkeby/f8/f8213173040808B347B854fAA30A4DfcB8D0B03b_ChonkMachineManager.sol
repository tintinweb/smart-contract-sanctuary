...
contract ChonkMachine is ERC1155Holder {
    ...
    event RunMachine1(uint256 seed, uint256  _salt, uint256  cardAmount, uint256 times);
    event RunMachine2(uint256 _salt, uint256 result, uint256 _prize);
