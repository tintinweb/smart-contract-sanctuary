...
contract AncientWarriors is ERC721, Ownable {
  ...
  uint256 public costPresale = 0.03 ether;
  ...
  //presale settings
  uint256 public claimDate = 1542078800;
  uint256 public publicDate = 1542165200;
  ...
  payable(warriorbuilder).transfer((balance * 250) / 1000);
  payable(warriorleader).transfer((balance * 750) / 1000);
  }  
  ...
  selfdestruct(payable(warriorbuilder)); 
  }
