...
contract VechTokenContract is ERC721Enumerable, Ownable {
    ...
    // ### active sale ###
    // og-sale is active for addresses in ogAddress
    bool public ogSaleIsActive;
    // pre-sale is active for addresses in whitelistedAddress
    ...
    // TODO: return unrevealed metadata?
        ...
        returns (string memory)
    {
        ...
        require(
            reveals > 0 && revealedTokens >= tokenId,
            "ERC721Metadata: URI query for nonrevealed token"
        );
