...
contract NativePunks is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    event PunkTransfer(address indexed from, address indexed to, uint256 tokenId);
    ...
    constructor() ERC721("NativePunks", "NATIVE") {}
