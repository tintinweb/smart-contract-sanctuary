...
contract WordNFT is ERC721, ReentrancyGuard, Ownable
{
	...
	function buildSVGFromToken(Word memory word) internal pure returns(string memory)
	{
		...
		bytes memory filter = "";
		bytes6 text_colour = word.text_color;
		...
		string memory svg = string(abi.encodePacked(
			"<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 420 420'><style type='text/css'><![CDATA[ @font-face{font-family:'Spartan';font-style:normal;font-weight:700;font-display:swap;src:url(https://fonts.gstatic.com/s/spartan/v3/l7gfbjR61M69yt8Z2QKtlA.woff2) format('woff2');unicode-range:U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+2000-206F,U+2074,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD;} ]]></style><rect width='100%' height='100%' fill='#",
			word.bg_color,
			"'/>",
			glitch,
			"<g><text x='50%' y='50%' style='",
			filter,
			"font-size:35pt;font-family:Helvetica,sans-serif;letter-spacing:1.5pt;fill:#",
			text_colour,
