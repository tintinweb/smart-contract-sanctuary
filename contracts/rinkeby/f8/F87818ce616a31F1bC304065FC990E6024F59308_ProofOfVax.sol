...
contract ProofOfVax is ERC721, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked('data:application/json;utf8,{"name":"COVID Vaccination Card ', tokenId.toString(), '/', _tokenIdCounter.current().toString(), '", "description":"My COVID Vaccination Card",','"image":"ipfs://', _tokenURIs[tokenId], '"}'));
