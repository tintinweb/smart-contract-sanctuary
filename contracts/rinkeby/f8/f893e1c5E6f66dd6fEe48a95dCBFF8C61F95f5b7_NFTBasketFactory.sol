...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/contracts/utils/StringsUpgradeable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/contracts/utils/introspection/IERC165Upgradeable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/contracts/utils/introspection/ERC165Upgradeable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/contracts/token/ERC721/IERC721Upgradeable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/contracts/token/ERC721/extensions/IERC721MetadataUpgradeable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/contracts/token/ERC721/ERC721Upgradeable.sol
...
// File: FNFT/contracts/NFTBasket.sol
...
contract NFTBasket is ERC721Upgradeable, ERC721HolderUpgradeable {
    ...
    function setMetadataURI(string memory _metadataURI) public {
        require(_isApprovedOrOwner(msg.sender, 0));
        metadataURI = _metadataURI;
    }
...
// File: FNFT/contracts/NFTBasketFactory.sol
...
contract NFTBasketFactory {
    ...
    uint public currentBasketIndex = 1;
    mapping(uint => address) public indexToBasketAddress;
    mapping(address => uint) public basketAddressToIndex;
    ...
    function createBasket(string memory _name, string memory _symbol, string memory _metadataURI) public returns (uint) {
        ...
        indexToBasketAddress[currentBasketIndex] = basketAddress;
        basketAddressToIndex[basketAddress] = currentBasketIndex;
        emit CreateBasket(basketAddress, msg.sender);

        currentBasketIndex++;
        basketCount++;
        return currentBasketIndex - 1;
    }
}