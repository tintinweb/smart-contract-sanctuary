...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        //return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, "5")) : "";
...
// File: contracts/wlpt.sol

pragma solidity ^0.8.0;

contract WLPT is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    constructor(string memory baseURI) ERC721("WLPT", "WLPT") {
		setBaseURI(baseURI);
        pause(true);
    }
