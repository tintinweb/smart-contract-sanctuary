...
contract LonelyAlienNFT is ERC721, PaymentSplitter, Ownable, Pausable {
    ...
    uint256 public constant MAXNFT = 10000 + 80 + 20;
    ...
    address[] private _team = [
        ...
        //0x93a3cf8aaF3f6E4C2239245c4FD60f2d1F4feCBc, // r1 -30%
        //0xEc49F11c699FD1b5CBb687bf0b079EB45a2129b5 // r2 -30%
       // 0xaa5079d9BB462B0F2f36D401f4d97D9d3490De7e, // r3 -30%
       // 0xDBADF9e0b51FAb7c8769B332C7C667033BDD13A8  // r4 -10%
        
    ];

    uint256[] private _team_shares = [90, 4 ,4 ,2];

    constructor()
        PaymentSplitter(_team, _team_shares)
        ERC721("Loneley Aliens Space Club MASTER TEST", "LASCMT")
    {
    ...
    function getOneNFT() public payable {
        ...
        require(_tokenIdCounter.current().add(1) <= MAXNFT, "Purchase would exceed max supply");
        master_mint();
    }
