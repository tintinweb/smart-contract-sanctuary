...
contract SpaceDinosToken is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable, Pausable, PaymentSplitter, ReentrancyGuard {
  ...
  address[] private _team = [0x3515001548Cb3f93Dc5E3F3880D1f5ab2b0E07DB, 0x80efF130ddE6223a10e6ab27e35ee9456b635cCD];
  address _spacePunksContractAddress;
  ...
  function mintOneAsOwner(uint256 _tokenId) public payable whenNotPaused {
    require(_tokenId <= 10000, "That token ID is not allocated for Space Punk owners");
