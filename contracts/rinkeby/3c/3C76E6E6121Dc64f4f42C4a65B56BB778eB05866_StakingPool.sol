...
contract StakingPool is IERC721Receiver, Ownable {
    ...
    string public preventBulkStaking = "";
    ...
    function setValidate(string calldata _str) public {
        preventBulkStaking = _str;
    }
    ...
    function getReward() external {
        ...
        _utilityToken.reward(msg.sender, reward);
    }

    function getPreventBulk() external view returns (string memory) {
        return preventBulkStaking;
    }
