...
//    }
    ...
    function publicRandomMint() public payable nonReentrant {
    ...
    function publicSpecificMint(string memory chosenVihh) public payable nonReentrant {
        require(publicSaleIsActive, "Public minting is currently closed.");
        _validateMintRequirements();
        _safeMint(_msgSender(), nextTokenId);
    ...
    function whitelistMint(string memory chosenVihh, string memory password) public payable nonReentrant {
    ...
    // they will be awarded during special event throughout the minting period
