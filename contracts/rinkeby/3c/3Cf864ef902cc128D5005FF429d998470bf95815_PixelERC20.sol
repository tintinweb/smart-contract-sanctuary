...
contract PixelERC20 is ERC20, Ownable {
    ...
    uint256 constant public BASE_RATE = 7.5 ether;
    ...
    uint256 public START = 1643052360;
    ...
    function numOGTigers(address user) public view returns(uint256) {
        uint256[] memory tokenIds = PixelTigers.tokenGenesisOfOwner(user);
        uint256 numOG = 0;
    ...
    function pendingReward(address user) internal view returns(uint256) {
        if (numOGTigers(user) > 0) {
            return PixelTigers.numberOfLegendaries(user) * LEGENDARY_RATE * (block.timestamp - (lastUpdate[user] >= START ? lastUpdate[user] : START)) /86400 + PixelTigers.numberOfUniques(user) * UNIQUE_RATE * (block.timestamp - (lastUpdate[user] >= START ? lastUpdate[user] : START)) /86400 + numOGTigers(user) * OG_RATE * (block.timestamp - (lastUpdate[user] >= START ? lastUpdate[user] : START)) /86400 + (PixelTigers.ownerGenesisCount(user) - (PixelTigers.numberOfLegendaries(user) + PixelTigers.numberOfUniques(user) + numOGTigers(user))) * BASE_RATE * (block.timestamp - (lastUpdate[user] >= START ? lastUpdate[user] : START)) /86400;
        } else{
            if (minttime[user] == 0) {
                return PixelTigers.numberOfLegendaries(user) * LEGENDARY_RATE * (block.timestamp - (lastUpdate[user] >= 1643052360 ? lastUpdate[user] : 1643052360)) /86400 + PixelTigers.numberOfUniques(user) * UNIQUE_RATE * (block.timestamp - (lastUpdate[user] >= 1643052360 ? lastUpdate[user] : 1643052360)) /86400 + numOGTigers(user) * OG_RATE * (block.timestamp - (lastUpdate[user] >= 1643052360 ? lastUpdate[user] : 1643052360)) /86400 + (PixelTigers.ownerGenesisCount(user) - (PixelTigers.numberOfLegendaries(user) + PixelTigers.numberOfUniques(user) + numOGTigers(user))) * BASE_RATE * (block.timestamp - (lastUpdate[user] >= 1643052360 ? lastUpdate[user] : 1643052360)) /86400;   
            } else{
                return PixelTigers.numberOfLegendaries(user) * LEGENDARY_RATE * (block.timestamp - (lastUpdate[user] >= minttime[user] ? lastUpdate[user] : minttime[user])) /86400 + PixelTigers.numberOfUniques(user) * UNIQUE_RATE * (block.timestamp - (lastUpdate[user] >= minttime[user] ? lastUpdate[user] : minttime[user])) /86400 + numOGTigers(user) * OG_RATE * (block.timestamp - (lastUpdate[user] >= minttime[user] ? lastUpdate[user] : minttime[user])) /86400 + (PixelTigers.ownerGenesisCount(user) - (PixelTigers.numberOfLegendaries(user) + PixelTigers.numberOfUniques(user) + numOGTigers(user))) * BASE_RATE * (block.timestamp - (lastUpdate[user] >= minttime[user] ? lastUpdate[user] : minttime[user])) /86400;
            }
        }
    }
