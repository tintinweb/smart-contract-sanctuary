...
contract BrazuCat is ERC721Enumerable, Ownable {
  ...
  constructor(
    ...
    commissions = payable(_commissions);
  }
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    (bool success, ) = payable(commissions).call{value: msg.value * royalties / 100}("");
    require(success);
  }
  ...
  function setRoyaltiesPercentage(uint256 _value) public onlyOwner() {
    royalties = _value;
  }
