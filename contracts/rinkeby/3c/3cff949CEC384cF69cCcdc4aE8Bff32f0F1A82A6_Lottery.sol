...
contract Lottery is VRFConsumerBase, Ownable{
    ...
    event randomNum(uint256 rand);
    event playerLength(uint256 pl);
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        require(lottery_state == LOTTERY_STATE.CACULATING_WINNER, "You aren't there yet");
        require(_randomness > 0, "random-not-found");
        emit randomNum(_randomness);
        emit playerLength(players.length);
