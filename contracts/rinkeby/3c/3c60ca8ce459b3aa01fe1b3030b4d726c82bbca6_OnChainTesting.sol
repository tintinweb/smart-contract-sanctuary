...
// File: contracts/OnChainTesting.sol
...
contract OnChainTesting is ERC721Enumerable, ReentrancyGuard, Ownable {
            ...
            abi.encodePacked(
                ...
                Base64.encode(
                    abi.encodePacked(
                        '{"name": "OnChainTesting #',
                        tokenId.toString(),
                        '", "description": "OnChainTesting is building a Metaverse FULLY Onchain! All the metadata and images are generated and stored 100% on-chain. No IPFS, no API. Merely Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("OnChainTesting", "OCT") Ownable() {}
