...
/****** public *******/
  ...
  function bundleMint() public payable nonReentrant{
    ...
    if (msg.sender != owner()) {
        ...
        uint256 ownerMintedCount = addressMintedBalance[msg.sender]; 
        require(ownerMintedCount + numberOfSeries <= mintPerAddressLimit, "max NFT per address exceeded, consider minting single NFT"); // each address cannot mint more than 16 tokens
