...
contract ClockAuction is ERC721Tradable{
    ...
    */
     ...
     */
    function creatorMint(address _to, uint8 amount) external onlyOwner {
        uint256 ts = totalSupply();
     ...
     */
    function presaleMint(uint8 amount) payable external {
     ...
     */
    function yeeYeeMint(uint8 amount) payable external {
