...
contract Enigma is ERC721Enumerable, Ownable, ReentrancyGuard {
    struct Parents {
        uint256 parentA;
        uint256 parentB;
    }
    ...
    address public genesisContractAddress = 0x68c5554008B128cBdE0e4c9a6fd79E6118538ADe;
    address public renderingContractAddress = 0x626B8E14C097Ba3ef5Ccc0aB9689F01F288Fdd98;
    ...
    event HadAChild(uint256 indexed parentA, uint256 indexed parentB, uint256 dowry, uint256 child, uint256 dna);
    event DowryWasZeroed(uint256 indexed chainRunner);

    constructor() ERC721("Enigma", "RUN1") {}
    ...
    function mate(uint256 myChainRunnerId, uint256 myLoverId) external nonReentrant {
        ...
        require(lastBreeding[myChainRunnerId] + 3600 * 2 < block.timestamp, "You need rest"); // each runner needs a 2 day rest after breeding
        require(lastBreeding[myLoverId] + 3600 * 2 < block.timestamp, "Lover needs rest"); // each runner needs a 2 day rest after breeding
