...
contract smartMFGNFT721V2 is ERC721 {
    address private owner;
    ...
    function createCollectible(address creator, string memory tokenURI, uint256 fee) public returns (uint256) {
        require(msg.sender == transferProxy,"Operator: caller is not Operator");
