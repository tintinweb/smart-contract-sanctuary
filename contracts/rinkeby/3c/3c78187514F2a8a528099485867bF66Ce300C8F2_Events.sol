...
contract Events is IEvents {
    ...
    function contractorConfirmed(address _contractor) external override validProject {
        emit ContractorConfirmed(msg.sender, _contractor);
    }

    function phasesAdded(uint256[] calldata _phaseCost) external override validProject {
    ...
    function scInvited(uint256 _taskID, address _sc) external override validProject {
    ...
    function scConfirmed(uint256 _taskID, address _sc) external override validProject {
    ...
    function contractorFeeReleased(uint256 _phase) external override validProject {
    ...
    function changeOrderSC(uint256 _taskID, address _sc) external override validProject {
    ...
    function nftCreated(uint256 _id, address _owner) external override onlyHomeFi {
