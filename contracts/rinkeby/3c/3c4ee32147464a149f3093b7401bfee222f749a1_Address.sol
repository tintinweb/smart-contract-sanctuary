...
contract SHIBAS is ERC721, Ownable {
    ...
    uint public constant MAX_SHIBAS = 5000;
    bool public hasSaleStarted = false;
    
    // THE HASH OF ALL TOKEN DATAS WILL BE ADDED HERE.
    string public METADATA_PROVENANCE_HASH = "";
    
        
    constructor() ERC721("CRYPTO SHIBAS!","SHIBAS")  {
        setBaseURI("https://shibass-git.github.io/shibassapi/api");  //REPLACE!!!
        setContractURI("https://shibass-git.github.io/shibassapi/api2");
        
        // TO FOUNDER
        _safeMint(address(0x111B78E2A110DF52310B7851B2D6743d93c738dC), 0);
    ...
    function calculatePrice() public view returns (uint256) {
     ...
     function calculatePriceTest(uint _id) public view returns (uint256) {
        ...
        require(_id < MAX_SHIBAS, "Sale has already ended");
   ...
   function adoptSHIBAS(uint256 numSHIBAS) public payable {
        require(totalSupply() < MAX_SHIBAS, "Sale has already ended");
        require(numSHIBAS > 0 && numSHIBAS <= 20, "You can adopt minimum 1, maximum 20 SHIBAS");
        require(totalSupply().add(numSHIBAS) <= MAX_SHIBAS, "Exceeds MAX_SHIBAS");
        require(msg.value >= calculatePrice().mul(numSHIBAS), "Ether value sent is below the price");
