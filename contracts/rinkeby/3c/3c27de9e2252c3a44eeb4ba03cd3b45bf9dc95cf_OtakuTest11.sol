...
contract OtakuTest11 is ERC721Enumerable, ReentrancyGuard, Ownable {

    string[] private color1 = [
        "fff100","f9ec00","ece700"
    ];
    string[] private color2 = [
        "dfd000","d7cd00","cbc800"
    ];
    string[] private color3 = [
        "cbbd00","c3ba00","b9b600"
    ];
    string[] private color4 = [
        "a09600","9a9300","929000"
    ];
    string[] private color5 = [
        "8a8000","857e00","7d7c00"
    ];
    ...
    constructor() ERC721("OtakuTest11", "OtakuTest11") Ownable() {}
}
