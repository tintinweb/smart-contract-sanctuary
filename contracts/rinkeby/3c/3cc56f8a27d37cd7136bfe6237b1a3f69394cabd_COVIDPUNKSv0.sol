...
contract COVIDPUNKSv0 is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  constructor() ERC721("COVIDPUNKSv0", "COV-0") {}
...
// have replaced 10000 with 100 for testing. Change back later.
  uint256[100] private _availableTokens;
  uint256 private _numAvailableTokens = 100;
  uint256 private _numFreeRollsGiven = 0;

  mapping(address => uint256) public freeRollPhunks;

  uint256 private _lastTokenIdMintedInInitialSet = 100;
