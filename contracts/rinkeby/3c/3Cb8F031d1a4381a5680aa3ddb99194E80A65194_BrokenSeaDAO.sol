...
contract BrokenSeaDAO is ERC721Enumerable, PaymentSplitter, Ownable {
    using Strings for uint;

    uint private PRICE = 0.07 ether;
    uint private MAX_TOKENS_PER_TRANSACTION = 999;
    uint private MAX_SUPPLY = 9999;
    uint private freeLimit = 1000;
    bool public revealed = false;

    string private notRevealedUri = 'https://gateway.pinata.cloud/ipfs/QmVzTvmDGVip8tzYYt1z6scAn9NayeaUhSx3w38PZKy2zC/1.json';
    ...
    address dev = 0x4872502dbB1c7198daE7B9D5c4529701aa2A6563;
    address art = 0x5Ab0787A16E66A57dDa644201b253D214fA5193a;

    address[] addressList = [art, dev];
    uint[] shareList = [9500, 500];

    mapping(address => bool) private whitelist;

    constructor()
    ERC721("BrokenSeaDAO", "BRKN")
