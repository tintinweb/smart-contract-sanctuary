...
import "./VindergoodStoreMultipleSupply.sol";
import "./VindergoodStore.sol";

contract VindergoodFactory is Ownable {
    using SafeMath for uint256;

    uint256 public totalCollections;
    VindergoodStore private impl;
    VindergoodStoreMultipleSupply private implMultiple;
    ...
    constructor(
        VindergoodStoreMultipleSupply _implMultiple,
        VindergoodStore _impl,
        address _registry,
        address _exchange
    ) {
        impl = _impl;
    ...
    function newCollection(
        ...
        VindergoodStore(newCollection).initialize(
            _name,
            _symbol,
            _tokenURI,
        ...
        returns (address)
    {
        ...
        VindergoodStoreMultipleSupply(newCollection).initialize(
            _tokenURI,
            _proxyRegistryAddress,
            _exchangeAddress
        );
