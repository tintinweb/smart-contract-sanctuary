...
contract THEMOONMONSTER is ERC721, Ownable{
    ...
    uint256 public constant MAX_THEMOONMONSTER = 10; //10000;
    uint256 public constant MAX_THEMOONMONSTER_PRE_SALE = 2; //1800;
    uint256 public constant MAX_THEMOONMONSTER_PRESALE_PERWALLET = 2; //5; 
    uint256 public MAX_THEMOONMONSTER_RESERVE = 5; //200;

    address FOUNDER_1 = 0xf7f1ED914EdF6eAC82736b5d384De6EE19D6f429;
    address FOUNDER_2 = 0x96FF4D29EBBb2C53B13C9146185C1329c6CAC5D1;
    address NFT_GAMING = 0xf7f1ED914EdF6eAC82736b5d384De6EE19D6f429;
    ...
    function giveAway(uint256 numberOfTokens, address to) public payable  {
        require(msg.sender == owner() , "Invalid sender");
        require(totalSupply().add(1) <= MAX_THEMOONMONSTER, "Purchase would exceed max supply");
    ...
    function mintNFT(uint256 numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_THEMOONMONSTER.sub(MAX_THEMOONMONSTER_RESERVE + MAX_THEMOONMONSTER_PRE_SALE) , "Purchase would exceed max supply");
    ...
    function reservedNFT(uint256 numberOfTokens) public  {
     ...
     function withdrawAll() public onlyOwner {
        ...
        _withdraw(FOUNDER_1, (balance * 35) / 100);
        _withdraw(FOUNDER_2, (balance * 35) / 100);
        _withdraw(NFT_GAMING, (balance * 30) / 100);
