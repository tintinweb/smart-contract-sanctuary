...
contract Locker is Ownable, ReentrancyGuard {
    ...
    function createLock(address pair, address baseToken, uint amount, uint unlockTimestamp, address recipient) external noContractsAllowed nonReentrant payable {
        ...
        emit Locked(locksLength, pair, recipient, amount, unlockTimestamp, platformTokensLocked, lock.claimed);
    }
