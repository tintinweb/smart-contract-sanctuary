...
// File: contracts/interfaces/IAlmanackLottery.sol

pragma solidity ^0.8.4;

interface IAlmanackLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in ALMANACK per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in ALMANACK token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInAlmanack: price of a ticket in ALMANACK
    ...
    function startLottery(
        uint256 _endTime,
        uint256 _priceTicketInAlmanack,
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public almanackLottery;
     ...
     * @param _seed: seed provided by the Almanack lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == almanackLottery, "Only AlmanackLottery");
    ...
    /**
     * @notice Set the address for the AlmanackLottery
     * @param _almanackLottery: address of the Almanack lottery
     */
    function setLotteryAddress(address _almanackLottery) external onlyOwner {
        almanackLottery = _almanackLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IAlmanackLottery(almanackLottery).viewCurrentLotteryId();
    }
}