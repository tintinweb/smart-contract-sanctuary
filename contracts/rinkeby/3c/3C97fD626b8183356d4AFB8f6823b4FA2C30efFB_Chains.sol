...
contract Chains is ERC721Enumerable, Ownable {
    ...
    **/
    ...
    uint256 _combinedTotalSupply = 3406;
    ...
    function mintWithBallerBars(uint256 ballerBarsGeneration) public {
        require(saleLive==true,"NOT_LIVE");
    ...
    function burnGenOneForMint(uint256 _tokenId) public {
        ...
        require(chainsGenOne.ownerOf(_tokenId) == msg.sender,"NOT_TOKEN_OWNER");
    ...
    function migrateGenOne(uint256 _tokenId) public {
        require(saleLive==true,"NOT_LIVE");
        require(IChains(_genOneChainsAddress).ownerOf(_tokenId) == msg.sender,"NOT_TOKEN_OWNER");
        migrate(_tokenId);
    }
