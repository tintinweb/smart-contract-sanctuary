...
contract DateUnlockSchedule is BaseGovernanceWithUserUpgradable {
    ...
    function __DateUnlockSchedule_init(ILock _lock, bytes calldata _data) internal initializer {
        __DateUnlockSchedule_init_unchained(_lock, _data);
    }

    function __DateUnlockSchedule_init_unchained(ILock _lock, bytes calldata _data) internal initializer {
        (
