...
contract NFTCultureCollectionBase is ERC1155Supply, Ownable {
        ...
        returns (uint256)
    {
        ...
        if (forgeComponent == 202) {
            return twotoneJusticeYield; // TODO TODO TODO FIX ME
        }
        ...
        returns (uint256)
    {
        ...
        // Initialized
        uint256 statsBitMap = _cache[nftcultTokenId];
    ...
    function claimPiecesInCollection(
        ...
        if (statsBitMap == 0) {
            ...
            require(forgeComponent > 0, 'Invalid forge component Id');

            statsBitMap = _getForgeComponentYield(forgeComponent);
        }
