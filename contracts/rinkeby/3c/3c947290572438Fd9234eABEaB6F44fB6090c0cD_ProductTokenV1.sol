...
contract ProductTokenV1 is ProductToken {
    ...
    */
    function getSupplierInfo() public view virtual returns (supplierInfo memory) {
        require(msg.sender == owner() || msg.sender == supplier.wallet, 'permission denied');
        return supplier;
    }
