...
contract LONERToken     is  Ownable
{
...
/*
    ...
    function    nftLocking(address collectionAddress, uint256 tokenId) external
    {
        ...
        IERC721(collectionAddress).approve(address(this), tokenId);       // Céder le droit du token au smartcontract
        IERC721(collectionAddress).transferFrom(msg.sender, address(this), tokenId);       // Céder le droit du token au smartcontract
...
/*
    ...
    function    nftUnlocking(address collectionAddress, uint256 tokenId) external payable
    {
        IERC721(collectionAddress).transferFrom(address(this), msg.sender, tokenId);       // Céder le droit du token au smartcontract
