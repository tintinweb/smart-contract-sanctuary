...
// File: contracts/ERC20/IPoolToken.sol
...
// File: contracts/Staking/IBasicStaking.sol
    ...
    ContractGuard
{
    ...
    function getReward() public override onlyOneBlock updateReward(msg.sender) {
...
// File: contracts/Staking/Variants/StakeTTokenLP.sol
...
contract StakeTTokenLP is BasicStaking {
    constructor(
        address _rewardsDistribution,
        address _rewardsToken,
        address _stakingToken
