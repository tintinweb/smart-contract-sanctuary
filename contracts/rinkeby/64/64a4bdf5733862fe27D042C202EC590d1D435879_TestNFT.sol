...
contract TestNFT is ERC721Tradable{
    ...
    constructor() ERC721Tradable("TahirNFT", "MD",0x465cD41394Eb35931f39fdd8507A230FF362f986,"https://gateway.pinata.cloud/ipfs/QmUePVdKQRcmT2ZHHELVqUrVupWUnLpSAedDAHif8PWnM6/") {}
...
contract ERC721Tradable is ContextMixin, ERC721PresetMinterPauserAutoId, Ownable {
    ...
    function mintTo(address _to ) payable public virtual {
          ...
          payable(0x7b25C04A313CDFF4eB03334a3f7B8e08c756266b).transfer(msg.value);
         _tokenIdTracker.increment();
