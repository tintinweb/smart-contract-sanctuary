...
contract VariousBooks is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  uint256 public constant mintPrice = 1000000000000000;
  ...
  string[] private nouns = [ 
    ...
    "Adjikistan", "Redonda", "Adzharia", "Micronesia","Ente Escuro Arruntado","Rasova",
    "Decentralized Autonomous Regime", "New Arkadia", "Algemeira", "Senghor", "Maccistan",
    "Vallonia","Bandung City","Friedegg", "Caledonia","Aburidiland"
  ];
  ...
  string[] private adjectives = [
    ...
    "Central", "Free", "United", "Socialist", "Ancient", "Third", "Eastern", "Cyber", "Northern",
    "Southern", "Solar", "Islands", "Kingdom", "State", "Monarchy", "Federation", "Confederation", "Alliance", "Assembly", "Region",
    "Caliphate", "Republic", "Province", "Grand", "Duchy", "Capital Federation"
  ];
