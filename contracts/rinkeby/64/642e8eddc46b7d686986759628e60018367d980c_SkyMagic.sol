...
contract SkyMagic is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(address initialRoyaltiesReceiver, uint256 initialRoyaltiesPercentage, string memory initialBaseURI) ERC721("Sky Magic", "SKY") {
        _royaltiesReceiver = initialRoyaltiesReceiver;
        _royaltiesPercentage = initialRoyaltiesPercentage;
    ...
    function royaltiesPercentage() public view returns(uint256) {
