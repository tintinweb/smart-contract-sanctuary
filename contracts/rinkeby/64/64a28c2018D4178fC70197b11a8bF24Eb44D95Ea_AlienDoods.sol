...
contract AlienDoods is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("AlienDoods", "AD") {
    setHiddenMetadataUri("ipfs://QmaG9wp9Y7CLHMbzpudPCCpmoufsBE8RvUjDJrVuktBYFi/alienhidden.json");
  }
