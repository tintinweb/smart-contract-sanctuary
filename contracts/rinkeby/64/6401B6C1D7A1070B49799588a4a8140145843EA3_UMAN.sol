 ...
 */
contract UMAN is Context, ERC1363, AccessControlEnumerable, ERC20Burnable, ERC20Pausable, ERC20Capped{
    ...
    constructor(string memory name, string memory symbol, uint256 _sellPrice,uint256 _buyPrice) ERC20(name, symbol) ERC20Capped(SafeMath.mul(2000000000 , (10 ** uint256(decimals())))) {
