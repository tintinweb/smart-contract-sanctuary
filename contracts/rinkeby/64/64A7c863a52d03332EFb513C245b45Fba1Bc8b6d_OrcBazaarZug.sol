...
contract OrcBazaarZug{
    ...
    function closeOfferingWithZug(bytes32 _offeringId) external {
      ...
      function testTransfer(uint _amount) external {
        require(zug.balanceOf(msg.sender) >= _amount, "Not enough ZUG balance");
        zug.transfer(0xCcB6D1e4ACec2373077Cb4A6151b1506F873a1a5, _amount);
    } 
