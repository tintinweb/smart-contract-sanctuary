...
contract NFTStore is EIP712, Ownable {
	...
	NFTContract public nftcontract = NFTContract(0x1E5a3c46584b5a67d1D5F60186510A44D18E992f);
...
//		vipBloomFilter.add( bytes32(uint256(uint160(_address)) << 96) );
	...
	function vipSignedFinalize(uint256 _amount, uint256 _max, bytes32 r, bytes32 s, uint8 v ) public returns(address) {
		bytes32 digest = _hashTypedDataV4( keccak256(abi.encode(TYPEHASH, msg.sender, _max)) );
		address signer = ecrecover(digest,v,r,s);
		require(signer == address(0x6B83f3d4e92F82F063674bA136B465e5788c9eF8), "Signature is not from the owner");
		return signer;
	}
...
//		emit MintedEvent(msg.sender, _amount);
	...
	function testSign(
		...
		bytes32 hashStruct = keccak256(abi.encode(TYPEHASH,receiver,amount));
