...
contract CorruptionsMetadata is Ownable, ICorruptionsMetadata {
    ...
    constructor() Ownable() {
        description = "Unknown";
        dataMapper = ICorruptionsDataMapper(
    ...
    function draw(
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 820 1460"><style>@font-face { font-family: CorruptionsFont; src: url("';
        parts[1] = font.font();
        ...
        parts[
            4
        ] = '; font-family: CorruptionsFont; font-size: 10px; }</style><g transform="scale(4 4)"><rect width="205" height="365" fill="';
        parts[5] = amount >= 2
            ? randomStrings[
                17 +
    ...
    function tokenURI(uint256 tokenId, uint256 amount)
        ...
        returns (string memory)
    {
        // ICorruptions corruptions = ICorruptions(
        ...
        //     DeviationInfo memory info = ICorruptionsDeviationRegistry(
        //         0x40f7ad19c7F37AcD76958d61Cbc783c77411cd9b
        //     ).valueFor(dataMapper.valueFor(0, tokenId));
        //     json = Base64.encode(
        //         bytes(
        //             string(
        //                 abi.encodePacked(
        ...
        //                         tokenId,
        //                         amount,
        //                         ICorruptionsDeviationWriter(
        //                             info.contractAddress
        //                         ).drawCanvas(tokenId, amount)
        //                     ),
