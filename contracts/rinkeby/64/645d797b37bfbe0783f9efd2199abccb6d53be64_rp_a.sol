...
contract rp_a is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    string baseURI = "https://rp_a.io";
    
    uint256 public cost = 0.01 ether;
    uint256 public maxSupply = 5000; //this can not be changed by anyone
    ...
    function tokenURI(uint256 _tokenId) public view override(ERC721) returns (string memory) {
        ...
        return string(abi.encodePacked(_baseURI(), _tokenId, ".", baseExtension));
