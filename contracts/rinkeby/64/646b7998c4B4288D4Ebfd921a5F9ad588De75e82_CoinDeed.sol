...
contract CoinDeed is ICoinDeed, AccessControl, ReentrancyGuard {
    ...
    function buyInDifferentToken(address tokenAddress, uint256 amount) onlyInState(DeedState.READY) external nonReentrant override {
    ...
    function _convertTokens(address tokenA, uint256 tokenAAmount, address tokenB) internal returns (uint256 tokenBAmount){
        ...
        ILendingPool.PoolInfo memory tokenBPool = lendingPool.poolInfo(tokenB);
