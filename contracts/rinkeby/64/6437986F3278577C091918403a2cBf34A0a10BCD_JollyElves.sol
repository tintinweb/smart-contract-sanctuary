...
contract JollyElves is Ownable, ERC721A, JEVoucherSigner {  
    ...
    // Mint Price
    uint256 public price = 10000000000000000; // 0.06 ETH
    ...
    ERC721A ("Jolly Elves", "JE", maxBatchSize_, collectionSize_) JEVoucherSigner(voucherSigner) {
