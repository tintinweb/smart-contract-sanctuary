...
contract AGFIGovernor {
    ...
    function quorumVotes() public pure returns (uint) { return 400000000e9; } // 400,000 = 4% of AGFI
    ...
    function _addToWhitelist(address member) private {
    ...
    function cancel(uint proposalId) public {
        ...
        require(state != ProposalState.Executed, "AGFIGovernor::cancel: cannot cancel executed proposal");
    ...
    function _castVote(address voter, uint proposalId, bool support) internal {
        ...
        uint96 votes = agfi.getPriorVotes(voter, proposal.startBlock);
