...
contract CapitalPool is ICapitalPool, OwnableUpgradeable, AbstractDependant {
    ...
    function addPolicyHoldersHardSTBL(
        ...
        (
            ...
            PermiumFactors(
                _stblAmount,
                _epochsNumber.mul(7), // amount of days in epoch not not seconds in epoch
                _protocolFee,
                _lStblDeployedByLP,
                _vStblDeployedByRP,
                _vStblOfCP,
        ...
        )
    {
        ...
        if (factors.reinsurancePoolPermium > 0) {
            reinsurancePoolPermium = factors.reinsurancePoolPermium;
        }
        if (factors.userLeveragePoolPermium > 0) {
            userLeveragePoolPermium = factors.userLeveragePoolPermium;
        }
        if (factors.coveragePoolPermium > 0) {
            coveragePoolPermium = factors.coveragePoolPermium;
        }
    }
    ...
    function _setupPremiumCalculation(PermiumFactors memory factors)
        internal
        view
        returns (PermiumFactors memory)
    {
        ...
        factors.premiumPerDay = factors.premiumPerDay.div(
            factors.permiumDurationInDays.mul(PRECISION)
        );
        ...
        factors.reinsurancePoolPermium = _calcReinsurancePoolPermium(factors);
        factors.userLeveragePoolPermium = _calcUserLeveragePoolPermium(factors);
        factors.coveragePoolPermium = _calcCoveragePoolPermium(factors);

        return factors;
    }

    function _calcReinsurancePoolPermium(PermiumFactors memory factors)
        internal
        view
        returns (uint256)
    {
    ...
    function _calcUserLeveragePoolPermium(PermiumFactors memory factors)
        internal
        view
        returns (uint256)
    {
    ...
    function _calcCoveragePoolPermium(PermiumFactors memory factors)
        internal
        view
        returns (uint256)
    {
        return
            factors.premiumPerDeployment.mul(factors.vStblOfCP).mul(factors.permiumDurationInDays);
    }
}
