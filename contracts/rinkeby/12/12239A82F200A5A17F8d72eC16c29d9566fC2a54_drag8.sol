...
contract drag8 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxFreePurchase = 3; 
 ...
 function freemint(uint256 numberOfTokens)public  {
     ...
     require(drop_is_active, "Please wait until the drop is active to mint");
        ...
        require(addressesThatMintedFree[msg.sender] + numberOfTokens <= 3, "You have already minted 3 free");
