...
contract FakeLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Bag #', toString(tokenId), '", "description": "FakeLoot is randomized adventurer gear generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Loot in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
...
//        require(tokenId > 7777 && tokenId < 8001, "Token ID invalid");
    ...
    constructor() ERC721("FAKELoot", "FLOOT") Ownable() {}
}


contract FakeRarity is ERC721 {
    uint public next_summoner;
    uint constant xp_per_day = 250e18;
    uint constant DAY = 1 minutes;

    constructor() ERC721("Fake Rarity Manifested","FRM")  {}
    ...
    event summoned(address indexed owner, uint classdata, uint summoner);
