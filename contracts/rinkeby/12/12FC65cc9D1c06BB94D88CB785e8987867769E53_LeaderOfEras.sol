...
import "./libs/IERC20Upgradeable.sol";
import "./libs/OwnableUpgradeable.sol";
import "./libs/ERC20BurnableUpgradeable.sol";
// import "./versions/SMPStakingRewards.sol";
// import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import "./libs/SafeERC20Upgradeable.sol";
import "@openzeppelin/contracts-upgradeable/utils/math/SafeMathUpgradeable.sol";
import "./versions/StakingRewards.sol";

contract LeaderOfEras is IERC20Upgradeable, OwnableUpgradeable, ERC20BurnableUpgradeable, StakingRewards {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;

    bool private initialized;

    function initialize(string memory name, string memory symbol, uint256 initialSupply) public override initializer virtual {
...
import "./../libs/RewardsDistributionRecipient.sol";

abstract contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;
    ...
    function initialize(string memory name, string memory symbol, uint256 initialSupply) public initializer virtual {}
    // /* ========== VIEWS ========== */
...
abstract contract ReentrancyGuard {
    ...
    // uint256 private constant _NOT_ENTERED = 1; ~> moved to StakingRewards
    // uint256 private constant _ENTERED = 2; ~> moved to StakingRewards
