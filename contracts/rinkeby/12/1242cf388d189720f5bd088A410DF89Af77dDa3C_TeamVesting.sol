...
contract TeamVesting is Ownable {
    ...
    uint256[48] public cumulativeAmountsToVest;
    ...
    modifier whenNotLocked() {
        require(locked == false, 'Claim is locked');
        _;
    }
     ...
     */
    constructor(address _tokenAddress, uint256[48] memory _cumulativeAmountsToVest) public {
        ...
        onlyOwner
    {
        ...
        require(_recipients.length == _withdrawPercentages.length, 'The two arrays are with different length');
     ...
     */
    function claim() public whenNotLocked {
