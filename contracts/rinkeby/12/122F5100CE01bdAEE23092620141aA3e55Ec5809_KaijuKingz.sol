...
contract KaijuKingz is KaijuKingzERC721 {
    ...
    function changeName(uint256 kaijuId, string memory newName)
        external
        kaijuOwner(kaijuId)
    {
        ...
        require(
            sha256(n) != sha256(bytes(kaijuData[kaijuId].name)),
    ...
    function changeBio(uint256 kaijuId, string memory newBio)
        external
        kaijuOwner(kaijuId)
    {
