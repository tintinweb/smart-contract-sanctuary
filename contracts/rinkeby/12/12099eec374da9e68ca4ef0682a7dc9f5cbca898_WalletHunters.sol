...
// File: contracts/interfaces/IWalletHunters.sol
...
// File: contracts/utils/AccountingTokenUpgradeable.sol
...
// File: contracts/hunters/WalletHunters.sol
    ...
    AccessControlUpgradeable
{
    ...
    mapping(uint256 => WalletRequest) public override walletRequests;
    ...
    function walletApproved(uint256 requestId)
        external
        view
        override
        returns (bool)
    {
        ...
        return _walletApproved(requestId);
    }
