...
contract LockVaiyo is Ownable {
    ...
    uint256 public minDepositAmount = 25 / 10 * (10 ** 18); //busd
    address VaiyoTokenAddress = 0x3567C6B2072B70d375749D07bA5c4f62adC1b398;//testnet
    // address VaiyoToken = 0x3567C6B2072B70d375749D07bA5c4f62adC1b398;
    ...
    function getBUSDAmountForBNB() public {
    }
    ...
    function getUSDAmount(uint256 bnbAmount) public view returns(uint256){
        uint256 usdAmount = bnbAmount.mul(uint256(getBNBPrice()));
        return usdAmount;
    }
