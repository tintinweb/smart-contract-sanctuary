...
contract Succession is Context, Ownable, IERC20 {
    ...
    uint256 private numTokensSellToAddToLiquidity = 481500 * 10**6 * 10**9;
    uint256 private minHoldingThreshold = 2342000 * 10**6 * 10**9;
    ...
    function startRipeBananas() public onlyOwner returns (bool success) {
        ...
        emit StartRipeBananas(mediumPrizeTotal);
