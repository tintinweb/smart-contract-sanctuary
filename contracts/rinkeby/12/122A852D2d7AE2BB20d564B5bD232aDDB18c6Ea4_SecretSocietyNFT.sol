...
contract SecretSocietyNFT is ERC721, Ownable {
	...
	function setNewRound(uint _supply, uint cost, string memory name, uint maxMint, uint perAddressLimit, uint theTime) public onlyOwner {
