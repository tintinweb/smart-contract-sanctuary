...
contract nft2 is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(address payable fundsTo_, uint256 maxSupply_, uint256 maxPerTx_, uint256 pricePer_) ERC721("Test2", "TST2") {
        fundsTo = fundsTo_;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmVAsuqwb6ogND8JAUnWg8nzhKAfjzLwzRR2reox1Qbj1j/";
    }
