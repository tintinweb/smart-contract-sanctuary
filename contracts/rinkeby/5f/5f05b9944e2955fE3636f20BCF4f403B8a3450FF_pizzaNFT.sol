...
library Strings {
    ...
    _Sauce public _sauce;
    _Cheese public _cheese;
    _Meats public _meats;
    _Toppings public _toppings;
    struct pizzabuying {
        uint256 buyingID;
        address owner;
        _Sauce _buysauce;
    ...
    mapping(address => pizzabuying) public idToBuyingPizza;
    ...
    function buyingPizza(
        ...
        idToBuyingPizza[msg.sender] = newbuyingPizza;    // plese check token in replace of  address
        return bakedTokenID;
    }
        ...
        payable
    {
        require(msg.sender != address(0));
         ...
         pizzabuying memory _pizzaID = idToBuyingPizza[buyerAddress];
