...
contract doggos is ERC721Enumerable, Ownable {
    ...
    // Price
    uint256 public price = 300000000000000; // 0.0003 eth
    ...
    constructor() ERC721("doggos", "ttttsssstttt321") {
        //_owner = msg.sender;
        ...
        //TIERS[7] = [20, 70, 721, 1000, 1155, 1200, 1300, 1434, 1541, 1559];
                ...
                //Hat
        TIERS[0] = [1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000];
        //Whiskers
        TIERS[1] = [2000, 2000, 2000, 2000, 2000];
        //Neck
        TIERS[2] = [2000, 2000, 2000, 2000, 2000];
        //Earrings
        TIERS[3] = [2000, 2000, 2000, 2000, 2000];
        //Eyes
        TIERS[4] = [1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000];
        //Mouth
        TIERS[5] = [1428, 1428, 1428, 1429, 1429, 1429, 1429];
        //Nose
        TIERS[6] = [2000, 2000, 2000, 2000, 2000];
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    ...
                                    '", "description": "On-Chain d0gg0s is a collection of 4,000 unique doggos. All the metadata and images are stored 100% on the Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
                                    doggosLibrary.encode(
