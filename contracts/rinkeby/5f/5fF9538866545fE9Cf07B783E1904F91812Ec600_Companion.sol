...
contract Companion is ERC721Enumerable, Ownable {  
    ...
    constructor(address parentAddress) ERC721("Companion", "COMPANION") {
    ...
    function claim(uint256 startingIndex, uint256 numberOfTokens) public {
        ...
        require(balance >= startingIndex + numberOfTokens, "Insufficient parent tokens."); // TODO: check logic: minting backwards
