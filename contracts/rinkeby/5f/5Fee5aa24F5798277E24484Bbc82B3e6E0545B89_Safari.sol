...
contract Safari is Ownable, IERC721Receiver, Pausable {
  ...
  function rescue(uint256[] calldata tokenIds) external {
    ...
    function getAlphaStats() external view returns (uint256, uint256, uint256, uint256){
        return(stripesPerAlpha, stripesPerAlpha, lastClaimTimestamp, unaccountedRewards);
    }
