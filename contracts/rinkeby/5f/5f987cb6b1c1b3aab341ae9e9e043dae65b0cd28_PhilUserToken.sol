...
contract PhilToken is Ownable, SignerRole, ERC1155Base {
    string public name;
...
contract PhilUserToken is PhilToken {
    event CreateERC1155_v1(address indexed creator, string name, string symbol);

    constructor(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) PhilToken(name, symbol, signer, contractURI, tokenURIPrefix) public {
