...
contract TokenVendor is UUPSUpgradeable, OwnableUpgradeable, VRFConsumerBaseUpgradeable, ChainlinkClient {
    ...
    function completeOrder(OrderData memory orderData) internal {
        ...
        emit MessageLog("completeOrder payableAmount", orderData.payableAmount);
        emit MessageLog("orderData.price", orderData.price);
        emit MessageLog("orderData.multiplier", orderData.multiplier);
