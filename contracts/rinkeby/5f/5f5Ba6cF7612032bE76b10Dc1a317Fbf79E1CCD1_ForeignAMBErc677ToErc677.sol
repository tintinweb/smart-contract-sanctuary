...
contract ForeignAMBErc677ToErc677 is BasicAMBErc677ToErc677, MediatorBalanceStorage {
    ...
    */
    ...
    // Selector: 0x2046f307
    function initializeMediatorBalance() external {
        bytes32 initializeMediatorBalanceStorage = 0x9b0353914e13ffe3bdfe5f1aec43d55701a0dac397466665fbe7a936b6889739; // keccak256(abi.encodePacked("initializeMediatorBalance20210528"))
        require(!boolStorage[initializeMediatorBalanceStorage]);
        
        _setMediatorBalance(erc677token().balanceOf(address(this)));
        
        boolStorage[initializeMediatorBalanceStorage] = true;
    }
