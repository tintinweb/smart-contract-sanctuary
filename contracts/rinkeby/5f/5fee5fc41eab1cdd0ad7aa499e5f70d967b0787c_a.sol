...
contract a is Context, IERC20, Ownable {
    ...
    address public deployer = 0x000000000000000000000000000000000000dEaD;
    address payable private teamDevAddress = payable(0x2B7EA64FaFf9340b7d7e878883d77288751F7833);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        _gonBalances[recipient] = _gonBalances[recipient].add(transferAmount);
