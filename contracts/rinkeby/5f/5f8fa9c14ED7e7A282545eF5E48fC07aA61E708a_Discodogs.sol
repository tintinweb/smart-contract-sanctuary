...
contract Discodogs is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PURCHASE_LIMIT = 9;
    ...
    uint256 private _startTime = 1632927500;
    ...
    ******************/
    ...
    modifier isLive() {
        require(block.timestamp >= _startTime, "Sale hasn't started");
        _;
    }
        ...
        onlyWhitelistedUser
    {
        ...
        require(
            ...
            "Requested number of tokens can't be minted, Try less numbers"
        );
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            if (totalPublicSupply < NFT_MAX) {
                _tokenID = totalPublicSupply + 1;
    ...
    function setRevealedBaseURI(string calldata _revealedBaseURI)
        ...
        onlyOwner
    {
        require(bytes(_tokenRevealedBaseURI).length == 0,"URI already revealed");
