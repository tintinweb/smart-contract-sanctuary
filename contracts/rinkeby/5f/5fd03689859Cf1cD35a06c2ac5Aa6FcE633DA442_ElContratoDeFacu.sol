...
// File: ElContratoDeFacu.sol

contract ElContratoDeFacu is ERC721 {
    address public owner;
    uint256 public tokenCounter;

    constructor () public ERC721("Facundo", "FFERRIN") {
        // Al crear el contrato, seteo mi address como owner, para referenciarla más tarde
        owner = msg.sender;
        tokenCounter = 0;
    }

    // tokenURI viene de ERC721; URL que apunta a un JSON con "name", "description", "image" y "attributes"
