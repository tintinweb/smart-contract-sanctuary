...
contract SLNFT is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    constructor() ERC721("TEST NFT", "TSLNFT") {
    ...
    */
    ...
    function withdrawFunds(uint256 _amount) public onlyOwner {
        ...
        address _safe = 0x47E78d4A3140269b1E8060894D5B5261255B81D1; // PLS CHANGE
    ...
    */
    ...
    function _addWhiteList() internal {
        address[2] memory _wlm = [
            0x2B7D200D43A4B24941186e840F47608AE7ea2A6a,
            0x67415a74418e4Ef5ad96E04a770B04Ed63EF647D
        ];
