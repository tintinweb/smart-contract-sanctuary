...
contract Testbat is Ownable, ERC721A, ReentrancyGuard {

    // constants
    uint256 constant MAX_FREE_ELEMENT = 50;    // 250
    uint256 constant MAX_ELEMENT_PER_USER = 5;

    uint256 constant MAX_ELEMENTS = 100;     // 1250
    ...
    constructor(uint256 maxBatchSize_) ERC721A("Testbat", "TESTBAT", maxBatchSize_) {}
