...
contract SotaPilotNFT is ERC721Enumerable, Ownable, AccessControl, SotaInvestors, RoyaltiesV2Impl {
    ...
    bool public authorizationRequired = true;
    ...
    function generateStartingIndex() private {
        require(startingIndex == 0, "Starting index is already set");
        
        startingIndex = uint(keccak256(abi.encodePacked(block.difficulty, block.timestamp, msg.sender))) % MAX_SUPPLY;
