...
contract Elements is ERC721Enumerable, Ownable {
    ...
    bool public paused = false;
     ...
     enum Element{HYDROGEN, HELIUM, LITHIUM, BERYLLIUM, BORON, CARBON, NITROGEN, OXYGEN, FLUORINE, NEON, SODIUM, MAGNESIUM, ALUMINUM, SILICON, PHOSPHORUS, SULFUR, CHLORINE, ARGON, POTASSIUM, CALCIUM, 
    ...
    mapping(uint256 => Elements) public tokenIdToElement;
