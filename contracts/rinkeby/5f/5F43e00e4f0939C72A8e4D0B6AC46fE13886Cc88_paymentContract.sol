...
// 70000000000000000
  ...
  function last_seed_public() external view returns (uint256) {

    return seeds[seeds.length-1];

  }

  function get_seed_public(uint256 tokenId) external view returns (uint256) {
  ...
  function get_test_seed(uint256 tokenId) external view returns (uint256) {
