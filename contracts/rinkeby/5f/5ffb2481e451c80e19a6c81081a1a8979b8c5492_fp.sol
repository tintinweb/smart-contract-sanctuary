...
contract fp is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("fapp", "FAPPP")  {
        setBaseURI(baseURI);

        // Mint first punk to owner
        mint(msg.sender);
    }
    ...
    function mint(address _to) public payable {
        ...
        if(msg.sender != owner()) {
          ...
          require(balanceOf(msg.sender) == 0, "You have already minted a fap.");
