...
contract Pigselated is ERC721, ERC721Enumerable, Ownables {
    ...
    function totalMintedSupply() public view returns(uint256) {
        ...
        return totalSupply().sub(_giveaways);
    ...
    function isWhiteListed(address walletAddress_) public view returns(bool) {

        return _whiteListedAddresses[walletAddress_];

    }

    function getGiveawaysCount() public view returns(uint256) {
