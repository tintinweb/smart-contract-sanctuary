...
contract ZooGangStaking is Ownable, IERC721Receiver, ReentrancyGuard, Pausable {
    using EnumerableSet for EnumerableSet.UintSet; 
    
    address public stackable;
...
/* STAKING MECHANICS */
    ...
    function calculateRewards(address account) external view returns (uint256[] memory rewards) {
    ...
    function calculateReward(address account, uint256 tokenId) internal view returns (uint256) {
