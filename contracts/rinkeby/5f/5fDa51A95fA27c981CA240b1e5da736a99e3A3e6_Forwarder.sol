...
contract Forwarder is Ownable {
    ...
    */
    ...
    function execute(ForwardRequest calldata req, bytes calldata signature) public payable returns (bool, bytes memory) {
        ...
        address signerAddress = req.from;
        _setCurrentContextAddressIfRequired(signerAddress, signerAddress);

        // solhint-disable-next-line avoid-low-level-calls
        (bool success, bytes memory returndata) = address(this).delegatecall{gas: req.gas}(req.data);
    ...
    */
    ...
    /** 
     *  @dev The current function will be called in the context of this address (either meta-transaction signer or `msg.sender`).
     *  @return Signer of meta-transaction if entry point is `execute`.
