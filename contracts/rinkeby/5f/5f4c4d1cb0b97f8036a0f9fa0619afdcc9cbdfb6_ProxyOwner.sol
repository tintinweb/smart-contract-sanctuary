...
contract ReflectERC20Test {
    ...
    string public constant name = "ScriptTokenTest";
    string public constant symbol = "SCTT";
...
contract ProxyOwner {
    ReflectERC20Test immutable public token;
    address public owner;
    address public pendingOwner;
    ...
    constructor (address tokenAddress, address routerAddress, address pairAddress) {
        owner = msg.sender;
        token = ReflectERC20Test(tokenAddress);
