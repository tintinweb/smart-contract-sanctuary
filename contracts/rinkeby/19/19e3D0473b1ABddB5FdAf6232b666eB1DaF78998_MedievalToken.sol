...
contract MedievalToken is Initializable, ERC20Upgradeable, MedievalAccessControlled {
    ...
    // Match the convention used in OHM based protocol
    function decimals() public view virtual override returns (uint8) {
        return 9;
    }

    function mint(address account_, uint256 amount_) external onlyRole(VAULT_ROLE) {
    ...
    function _burnFrom(address account_, uint256 amount_) internal {
        uint256 _allowance = allowance(account_, msg.sender);
        require(_allowance > amount_, "ERC20: burn amount exceeds allowance");
        
        uint256 decreasedAllowance_ = _allowance - amount_;
