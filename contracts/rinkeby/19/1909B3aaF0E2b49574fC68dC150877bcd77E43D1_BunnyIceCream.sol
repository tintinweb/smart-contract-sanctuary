...
contract BunnyIceCream is Ownable, ERC721 {
    ...
    constructor(uint256 _initialPrice, string memory _initURIPrefix, address _charityWallet1, uint8 _charityPercentage1, address _charityWallet2, uint8 _charityPercentage2)
