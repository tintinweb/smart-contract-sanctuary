...
contract ERC721 {
   string constant private tokenName = "ZPNFT";
   string constant private tokenSymbol = "ZPNFT";
   uint256 constant private totalTokens = 100000000000;
   ...
   function transfer(address _to, uint256 _tokenId){
       ...
       removeFromTokenList(newOwner,_tokenId);
