...
contract TestArthPool is AccessControl, IARTHPool {
    ...
    struct CollateralInfo {
        IERC20 tokenAddress;           // Address of the collateral
    }
...
// Set functions //
    ...
    function addCollateral(IERC20 _tokenAddress) public onlyByOwnerOrGovernance {
        collateralInfo.push(CollateralInfo({
...

{
  ...
  "libraries": {
    "/var/www/html/boltfork/arthcoin-v2/contracts/Arth/Pools/ArthPoolLibrary.sol": {
      "ArthPoolLibrary": "0x9c14859bb71C9A82Aa09Cd24Ac71B9F41C4f383e"
    }
  },
  "outputSelection": {
    "*": {
