 ...
 *
 */
contract ERC20PresetFixedSupply is ERC20Burnable, Ownable {
    string private _name;
    string private _symbol;
    ...
    /**
     * @dev Allows owner to change name of the token
     */
    ...
    /**
     * @dev Allows owner to change symbol of the token
     */
    function changeSymbol(string memory symbol_) public onlyOwner {
        _symbol = symbol_;
        emit SymbolChanged(symbol_, msg.sender);
    }
