...
contract BinaryOptions is Ownable, Pausable, Oracle {
    ...
    //all events
    event eventBid(address biddingAddress, address msgSender, uint256 _amount);
    ...
    function bidLong(address _address, uint256 bids)
        public
        payable
        whenNotPaused
    {
        ...
        longMap[_address] = bids;
        longBid++;
        dvdBalance[_address] = msg.value;
        emit eventBid(_address, msg.sender, msg.value);
    }

    function bidShort(address _address, uint256 bids)
        public
        payable
        whenNotPaused
    {
