...
// function transferFrom(address sender, address recipient, uint256 amount) external returns (bool);
//}
contract OlyPrincipleDepository is IPrincipleDepository, VaultOwned {
  ...
  function addReserveToken( address newReserveToken_, bool isERC1612_ ) external override onlyVault() returns ( bool ) {
  ...
  function addPrincipleToken( address newPrincipleToken_, bool isERC1612_ ) external override onlyVault() returns ( bool ) {
  ...
  function removePrincipleToken( address oldPrincipleToken_ ) external override onlyVault() returns ( bool ) {
  ...
  function removeBondTerm( address reserveToken_, address bondPrincipleToRemove_) external override onlyVault() returns ( bool ) {
