...
contract PropositionToken is ERC721Enumerable, Ownable {
    ...
    function mint(string memory _proposition) public payable {
        ...
        require(checkPropositionLength(_proposition) <= 350, "Proposition exceeds max length of 350 chars");
        ...
        _mint(msg.sender, id);
        emit Mint(msg.sender, id, _proposition);
    }   
    ...
    */
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        jsonMeta = string(abi.encodePacked(jsonMeta, ' "attributes": [{ "trait_type": "Image DNA", "value": "',toString(imageCode),'" }, { "trait_type": "Sky", "value": "',skyColors[getIndexes(imageCode, 0)],'" }, { "trait_type": "Planet", "value": "',bodyColors[getIndexes(imageCode, 1)],'" }, { "trait_type": "Heavenly Body", "value": "',heavenlyBody,'" }, { "trait_type": "Heavenly Reflection", "value": "',heavenlyReflectionColors[getIndexes(imageCode, 3)],'" }]}'));
