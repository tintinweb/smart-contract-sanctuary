...
contract Fauceth {
    ...
    uint public pb = 10 ** 18;       // Price Feed Base
    ...
    function mint() public payable {
        ...
        uint wad = msg.value;
        uint fee = wad * fr / frb;
        uint val = (wad - fee) * prx / pb; delete prx; delete wad;

        (bool success, bytes memory data) = _chest.call{value: fee}(""); delete fee;
    ...
    function burn(uint val) public {
        ...
        uint wad = val * pb / prx; delete prx;
        uint fee = wad * fr / frb;
        ...
        (bool success, bytes memory data) = _to.call{value: (wad - fee)}(""); delete wad; delete fee;
