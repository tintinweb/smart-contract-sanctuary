...
contract DoodleMfers is ERC721Enum, Ownable, Pausable,  ReentrancyGuard {
	...
	constructor() ERC721S("Doodle Mfers", "DMFERS"){
	    setBaseURI("ipfs://QmbnBoPSXhbyi7ktVR6jQNcJcQxU5YZpPCftJQxVMY3vz3/");
	}
