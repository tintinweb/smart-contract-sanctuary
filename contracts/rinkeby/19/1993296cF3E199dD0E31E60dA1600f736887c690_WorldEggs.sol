...
contract WorldEggs is ERC721Enumerable, Ownable {
    ...
    string private _baseTokenURI = "https://gateway.pinata.cloud/ipfs/Qmb7HEaUmB6Nrw2fU4odq6H2JBhAkB2HRZU8eBefVudk6u/";
    bool private _ripCord = false;
    uint256 public PRICE = 5 * 10**16;
    uint256 public RARE_PRICE = 10**18;
    ...
    function setRareState(uint[] calldata _tokenIds, bool _state) public onlyOwner{
        for (uint i = 0; i < _tokenIds.length; i++) {
            isRare[_tokenIds[i]] = _state;
        }
    }
