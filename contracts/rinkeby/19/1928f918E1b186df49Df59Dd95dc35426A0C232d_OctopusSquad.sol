...
//    uint256 public _saleStartDate = 1640293200; // 24 Dec 2021 00:00 MSK or 23 Dec 2021 21:00 UTC
    uint256 public _saleStartDate = 1639663215; // 16 Dec 14:05 UTC

    address payable treasurer; // withdraw to
    uint256 public firstThousandPrice = 0.01 ether; // 20 Matic for first 1000 octopuses
    ...
    function mint(address to, uint256 amount) public payable {
        ...
        if (_tokenIds.current() < 50) {
            price = firstThousandPrice;
        }
