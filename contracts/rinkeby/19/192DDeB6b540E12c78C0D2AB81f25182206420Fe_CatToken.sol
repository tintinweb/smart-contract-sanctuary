...
contract CatToken is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    function setBaseURI(string memory folderPath) public onlyOwner {
    ...
    function mintCats(uint256 numberToMint) public payable {
        require(_tokenIdCounter.current() <= _maxTokens, "Maximum tokens have been minted");
	...
	function reclaimTokens(IERC20 token) public onlyOwner {
