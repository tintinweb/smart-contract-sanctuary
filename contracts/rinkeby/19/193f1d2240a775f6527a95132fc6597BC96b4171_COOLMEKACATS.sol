...
// File: contracts/COOLMEKACATS.sol
...
contract COOLMEKACATS is ERC721Burnable, ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("COOLMEKACATS", "CMC")  {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 qty) external payable {
        ...
        require( qty < (maxMint + 1),"You can only mint a maximum of 10 COOL MEKA CATS" );
