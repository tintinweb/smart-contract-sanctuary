...
contract Kudasai is ERC721, ERC721Enumerable, Ownable {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    colorCode,
                    ';fill-rule:nonzero;"/></g><g transform="matrix(0.278631,-1.03987,1.03987,0.278631,-0.147034,739.635)"><text x="185.551px" y="359.393px" style="font-family:\'Menlo-Regular\', \'Menlo\', monospace;font-size:72px;fill:white;">KUDASAI</text></g></g></g></svg>'
                )
            );
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        Util.toStr(tokenId),
                        '", "description": "Kudasai JP collectible","attributes":',
                        attributes,
    ...
    function kudasai(uint256 tokensNumber) public {
