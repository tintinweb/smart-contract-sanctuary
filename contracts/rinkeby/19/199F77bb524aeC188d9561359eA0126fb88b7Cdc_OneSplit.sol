...
contract OneSplitRoot is IOneSplitView {
    ...
    uint256 internal constant DEXES_COUNT = 13;
    ...
    IERC20 internal constant dai =
        IERC20(0x6158864304e969B6d4daACb8f2e3bC5B76c03959);
    IERC20 internal constant usdc =
        IERC20(0x8570c3592CCeb7ebCd51Dc13f3b95fE2f4f01C80);
    IERC20 internal constant usdt =
        IERC20(0xEA040dB91b2FB439857145D3e660ceE46f458F94);
    ...
    ISwapFactory internal constant tokenStand =
        ISwapFactory(0x960e4a1A606210c9F705AB65E44EfDb19C016026);
    ...
    function _cheapGetPrice(
        ...
        (returnAmount, , ) = this.getExpectedReturnWithGas(
            ...
            FLAG_DISABLE_SPLIT_RECALCULATION |
                ...
                FLAG_DISABLE_SUSHISWAP_ALL |
                FLAG_DISABLE_SUSHISWAP_ETH |
                FLAG_DISABLE_SUSHISWAP_DAI |
                FLAG_DISABLE_SUSHISWAP_USDC |
...
contract OneSplitView is IOneSplitView, OneSplitRoot {
        ...
        )
    {
        ...
        return [
            ...
            invert !=
                flags.check(
                    FLAG_DISABLE_UNISWAP_V2_ALL | FLAG_DISABLE_UNISWAP_V2_ETH
                )
                ? _calculateNoReturn
                : calculateUniswapV2ETH,
            invert !=
                flags.check(
                    FLAG_DISABLE_UNISWAP_V2_ALL | FLAG_DISABLE_UNISWAP_V2_DAI
                )
                ? _calculateNoReturn
                : calculateUniswapV2DAI,
            invert !=
                flags.check(
                    FLAG_DISABLE_UNISWAP_V2_ALL | FLAG_DISABLE_UNISWAP_V2_USDC
                )
                ? _calculateNoReturn
                : calculateUniswapV2USDC,
            invert !=
                flags.check(FLAG_DISABLE_SUSHISWAP_ALL | FLAG_DISABLE_SUSHISWAP)
                ? _calculateNoReturn
                : calculateSushiswap,
            invert !=
                flags.check(
                    FLAG_DISABLE_SUSHISWAP_ALL | FLAG_DISABLE_SUSHISWAP_ETH
                )
                ? _calculateNoReturn
                : calculateSushiswapETH,
            invert !=
                flags.check(
                    FLAG_DISABLE_SUSHISWAP_ALL | FLAG_DISABLE_SUSHISWAP_DAI
                )
                ? _calculateNoReturn
                : calculateSushiswapDAI,
            invert !=
                flags.check(
                    FLAG_DISABLE_SUSHISWAP_ALL | FLAG_DISABLE_SUSHISWAP_USDC
                )
                ? _calculateNoReturn
                : calculateSushiswapUSDC,
            invert !=
                flags.check(
    ...
    function calculateUniswapV2ETH(
        ...
        return
            _calculateUniswapV2OverMidToken(
                fromToken,
                weth,
                destToken,
                amount,
    ...
    function _calculateSushiswap(
        ...
        IERC20 fromTokenReal = fromToken.isETH() ? weth : fromToken;
        IERC20 destTokenReal = destToken.isETH() ? weth : destToken;
        IUniswapV2Exchange exchange = sushiswap.getPair(
            fromTokenReal,
            destTokenReal
        );
        if (exchange != IUniswapV2Exchange(0)) {
    ...
    function calculateSushiswapETH(
        IERC20 fromToken,
        IERC20 destToken,
        uint256 amount,
        uint256 parts,
        ...
        return
            _calculateSushiswapOverMidToken(
                fromToken,
                weth,
                destToken,
                amount,
    ...
    function calculateSushiswapDAI(
        IERC20 fromToken,
        IERC20 destToken,
        uint256 amount,
        uint256 parts,
    ...
    function calculateSushiswapUSDC(
        IERC20 fromToken,
        IERC20 destToken,
        uint256 amount,
        uint256 parts,
    ...
    function _calculateSushiswapOverMidToken(
        IERC20 fromToken,
        IERC20 midToken,
        IERC20 destToken,
        uint256 amount,
        ...
        uint256 gas1;
        uint256 gas2;
        (rets, gas1) = _calculateSushiswap(fromToken, midToken, rets, flags);
        (rets, gas2) = _calculateSushiswap(midToken, destToken, rets, flags);
        return (rets, gas1 + gas2);
    }
...
contract OneSplit is IOneSplit, OneSplitRoot {
    ...
    function _swapOnUniswapV2Internal(
        ...
        if (needSync) {
            ...
            exchange.skim(0x1BaB8030249382A887F967FcAa7FE0be7B390728);
        }
    ...
    function _swapOnUniswapV2OverMid(
        ...
        _swapOnUniswapV2Internal(
            midToken,
            destToken,
            _swapOnUniswapV2Internal(fromToken, midToken, amount, flags),
            flags
        );
    }
    ...
    function _swapOnUniswapV2ETH(
        ...
        _swapOnUniswapV2OverMid(fromToken, weth, destToken, amount, flags);
    }
    ...
    function _swapOnUniswapV2DAI(
        ...
        _swapOnUniswapV2OverMid(fromToken, dai, destToken, amount, flags);
    }
    ...
    function _swapOnUniswapV2USDC(
        ...
        _swapOnUniswapV2OverMid(fromToken, usdc, destToken, amount, flags);
    }
    ...
    function _swapOnSushiswapOverMid(
        IERC20 fromToken,
        IERC20 midToken,
        IERC20 destToken,
        uint256 amount,
        ...
        _swapOnSushiswapInternal(
            midToken,
            destToken,
            _swapOnSushiswapInternal(fromToken, midToken, amount, flags),
            flags
        );
    }
    ...
    function _swapOnSushiswap(
        ...
        _swapOnSushiswapInternal(fromToken, destToken, amount, flags);
    }

    function _swapOnSushiswapETH(
        IERC20 fromToken,
        IERC20 destToken,
        uint256 amount,
        uint256 flags
    ) internal {
        _swapOnSushiswapOverMid(fromToken, weth, destToken, amount, flags);
    }

    function _swapOnSushiswapDAI(
        IERC20 fromToken,
        IERC20 destToken,
        uint256 amount,
        uint256 flags
    ) internal {
        _swapOnSushiswapOverMid(fromToken, dai, destToken, amount, flags);
    }

    function _swapOnSushiswapUSDC(
        IERC20 fromToken,
        IERC20 destToken,
        uint256 amount,
        uint256 flags
    ) internal {
        _swapOnSushiswapOverMid(fromToken, usdc, destToken, amount, flags);
    }
...
contract IOneSplitConsts {
    ...
    uint256 internal constant FLAG_DISABLE_SUSHISWAP_ALL = 0x66688888;
    uint256 internal constant FLAG_DISABLE_SUSHISWAP_ETH = 0x66888888;
    uint256 internal constant FLAG_DISABLE_SUSHISWAP_DAI = 0x68888888;
    uint256 internal constant FLAG_DISABLE_SUSHISWAP_USDC = 0x88888888;
