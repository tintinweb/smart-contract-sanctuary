...
contract UtopianUnicornSociety is ERC721, Ownable {
    ...
    uint256 private _unicornPrice = 70000000000000000; // 0.025 ETH
    ...
    //WITHDRAW ADDRESS
    address _withdrawAddress = 0x91a84B9Ef73b0C6D5E204a1F321514cCF47944ab;

    event Mint(address to, uint supply);

    constructor() ERC721("Utopian Unicorn Society","UUS") {}

    //MINT x amount of skullies
    function mint(uint256 _num) public payable {
        uint supply = totalSupply();
        require(!_paused, "Minting is currently paused!");
        require(_num < 21, "You can only mint 20 Unicorns with each transaction!");
        require(supply + _num < 10000-_reserve, "Supply exceeded!");
        require(msg.value >= _unicornPrice * _num, "ETH sent not correct!");
