...
/**
 *Originl Arbitrum Mutant Ape Yacht Club
 * ArbMAYC
 * t.me/ArbMAYC
 * Will be randomized and revealed after mint ! That makes your ArbMAYC even more special !
*/
...
contract MutantApeYachtClub is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721('Mutant Ape Yacht Club', 'ArbMAYC') {}
    ...
    function mintArbiBAYC(uint numberOfTokens) public payable {
