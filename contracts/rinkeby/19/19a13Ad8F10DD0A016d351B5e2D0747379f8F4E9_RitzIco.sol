...
contract RitzIco is CappedCrowdsale , RefundableCrowdsale{
    ...
    uint256 public MinimumGoal = 0.3 ether;
    // ==============================

    // Token Distribution
    // =============================
    uint256 public maxTokens = 2000 ether; // There will be total 1000000000000 RITZ Tokens
    uint256 public tokensForEcosystem = 1000 ether; // 400000000000 RITZ will be reserved for ecosystem
    uint256 public totalTokensForSale = 1000 ether; // 400000000000 RITZ will be sold in Crowdsale
    uint256 public totalTokensForSaleDuringPreICO = 1000 ether; // 400000000000 RITZ will be reserved for PreICO Crowdsale
    // ==============================
