...
contract PlayerBook {
    ...
    JIincForwarderInterface constant private Jekyll_Island_Inc = JIincForwarderInterface(JIincForwarderAddress);
    TeamJustInterface constant private TeamJust = TeamJustInterface(TeamJustAddress);
