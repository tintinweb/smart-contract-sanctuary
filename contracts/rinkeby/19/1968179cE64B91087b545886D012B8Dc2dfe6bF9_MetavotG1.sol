...
contract MetavotG1 is ERC721Tradable, ReentrancyGuard {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "https://item.metavots.com/gen0/meta/", // test
                    Strings.toString(tokenId)
                )
            );
    }

    function ownerPremint(address to) public nonReentrant onlyOwner {
