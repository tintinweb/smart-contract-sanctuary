...
/** 
    ...
    */
    ...
    function setExtraParams(uint256 _baseCurrency, uint256[] memory allowedCurrecny, address _bankAddress, uint256 boxPrice, uint256 maxBoxes, uint256 perBoxNftMint) internal {
        baseCurrency[generativeSeriesId.current()] = _baseCurrency;
        _allowedCurrencies[generativeSeriesId.current()] = allowedCurrecny;
        bankAddress[generativeSeriesId.current()] = _bankAddress;
        nonGenSeries[generativeSeriesId.current()].price = boxPrice;
