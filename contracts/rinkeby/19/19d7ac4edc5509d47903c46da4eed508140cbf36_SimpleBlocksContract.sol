...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/simpleBlocksContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract SimpleBlocksContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Simple Blocks", "BBLOCK", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/vWwIQTVVBUEJzdLT8MRd/contract-metadata";
        }
    }