...
contract LRX is ERC1155 , owned {
    

  uint256 [] ids;

  constructor() public ERC1155("LRX") {
  }

 function createToken (uint256 [] memory listIds, uint256 [] memory amounts , bytes memory data) public onlyOwner{ 
        ids = listIds; 
