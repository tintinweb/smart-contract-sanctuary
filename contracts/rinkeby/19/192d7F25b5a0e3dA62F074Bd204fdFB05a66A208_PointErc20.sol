...
contract PointErc20 is ERC20Burnable, Ownable {
  ...
  function transfer(address recipient, uint256 amount) public override returns (bool) {
    require(whitelisted[recipient] || whitelisted[msg.sender], "Only allowed to be used in ecosystem");
    return super.transfer(recipient, amount);
  }

  function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
    require(whitelisted[recipient] || whitelisted[sender], "Only allowed to be used in ecosystem");
