...
contract Catnip is Context, IBEP20, Initializable {
    ...
    function initialize() public initializer {
        ...
        tokenSymbol = "NIP8";        //CHANGEIT - Change the Name to the PRoduction one NIP
        tokenName = "Catnip8";       //CHANGEIT - Change the Name to the PRoduction one Catnip
        MAXintNum = ~uint256(0);
    ...
    function withdrawBEP20SentToContractAddress(IBEP20 tokenToWithdraw) external  {
