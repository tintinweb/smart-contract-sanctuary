...
contract Contraband is AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage {
    ...
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Contraband: caller is not admin");
        _;
    }
    ...
    function mint() public payable {
        ...
        require(tokenIdTracker.current() <= max_supply, "Contraband: all tokens have been minted");
        require(msg.value == price, "Contraband: amount sent is incorrect");
    ...
    function mint_5() public payable {

        require(tokenIdTracker.current()+4 <= max_supply, "Contraband: all tokens have been minted");
        require(msg.value == price*5, "Contraband: amount sent is incorrect");
