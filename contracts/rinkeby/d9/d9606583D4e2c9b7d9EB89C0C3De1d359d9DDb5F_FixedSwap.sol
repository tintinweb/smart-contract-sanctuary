...
contract FixedSwap is Pausable, Whitelist {
    ...
    address payable public FEE_ADDRESS = 0x71d53E5175Da8A2f032F10b33700457488ee02f4; /* Default Address for Fee Percentage */
    ...
    */
    ...
    function swap(uint256 _amount) payable external whenNotPaused isFunded isSaleOpen onlyWhitelisted {
        ...
        if(isTokenSwapAtomic){
            /* Confirm transfer */
            require(erc20.transfer(msg.sender, _amount), "ERC20 transfer not work");
        }
