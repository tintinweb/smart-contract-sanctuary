    ...
    ReentrancyGuard
{
     ...
     *
     * Params:
     * _label: listing label
     * _nfts: nfts to list
     * _listingPayments: price accepted for accepted payment methods
     * _setRoyalty: if we set royalty (creator only)
     * _royalty: royalty amount to either set or confirm
     * _split: how to split revenue if any
     */
    function createListing(
        ...
        for (uint256 i = 0; i < _listingPayments.length; i++) {
            ...
            require(_listingPayments[i].price > 0, "invalid price");
    ...
    function buyTokens(
        ...
        uint256 price = salePaymentAmounts[_listingId][
