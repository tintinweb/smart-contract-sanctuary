...
contract BigFanMinter is ERC721URIStorage, AccessControl {
    ...
    function approveTokenURI(string memory tokenURI) public onlyRole(DEFAULT_ADMIN_ROLE)  returns(bool success) {
