...
// Built by INU lovers, for INU lovers. 
//
// Website: https://www.kishutoken.net
// Telegram: https://t.me/kishutoken
//
//
...
contract KISHU is ERC20, Ownable {
  constructor() public ERC20("ASGES", "ASGES") { 
    _mint(msg.sender, 69000000000000000000000000000000);
  }

  // Transfer Fee
  event TransferFeeChanged(uint256 newFee);
  event FeeRecipientChange(address account);
  event MarketingRecipientChange(address account);
  ...
  function setTransferMarketingRecipient(address account) public onlyOwner {
    marketingRecipient = account;
    emit MarketingRecipientChange(account);
  }
