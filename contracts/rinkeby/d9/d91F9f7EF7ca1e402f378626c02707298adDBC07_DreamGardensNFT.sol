...
contract DreamGardensNFT is ERC721Tradable {
  // JSONS
  string private _prerevealMetaURI = "https://gateway.pinata.cloud/ipfs/QmQnzmCN4bhu1EeeSmFDcmHrZgM5jUYwSVJ3tYTHk6dn2b/";
  string private _revealedMetaURI = "https://gateway.pinata.cloud/ipfs/QmRA71NveXF5EFUSds873WqxkVuT8HvvATgz65ev3ea9d5/";
  string private _nightmareMetaURI = "https://gateway.pinata.cloud/ipfs/QmbpWLqDtN3sdFtev4TkWca3tasGmAHgJkpXA21GBkLDke/DreamGarden_Prereveal.mp4";
  ...
  function setSaleState(bool newState) public onlyOwner {
   ...
   function setAllowList(address[] calldata addresses, bool allow) external onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
            _allowList[addresses[i]] = allow;
        }
    }
  ...
  function mintGardenAllowlist(uint numberOfTokens) public payable {
    uint256 ts = totalSupply();
