...
contract ETHBridge is Ownable {
    ...
    event Port(address indexed ercToken, address indexed to, uint256 indexed amount);
    ...
    function port(address _ercToken, uint256 _amount) external {
        require(_amount > 0, "amount must be greater than 0");
        TransferHelper.safeTransferFrom(_ercToken, msg.sender, address(this), _amount);
        emit Port(_ercToken, msg.sender, _amount);
    }
