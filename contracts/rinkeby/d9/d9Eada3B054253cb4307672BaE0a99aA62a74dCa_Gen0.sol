...
contract Gen0 is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NFT_MINT      = 50;
    ...
    uint256 public constant NFT_MINT_PRICE    = 0.05 ether;
     ...
     */
    constructor(address nctAddress) ERC721("Puppies", "P0") {
        startingIndex = 0;
    ...
    /**
    * @dev Assign 'numberOfNfts' new tokens to a given 'destination' address
    */
    function assignNFT(address destination, uint256 numberOfNfts) public onlyOwner() {
        require(totalSupply() <  MAX_NFT_SUPPLY, "Sale has already ended");
        require(numberOfNfts  >  0, "numberOfNfts cannot be 0");
        require(totalSupply().add(numberOfNfts)  <= MAX_NFT_SUPPLY, "Sale has already ended");
