...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ETH = IBEP20(0x952450E44d41E37aa7DeBBb3a5e752bb967691F4);
...
contract RiseETH is IBEP20, HADAAuth {
    using SafeMath for uint256;

    address ETH = 0x952450E44d41E37aa7DeBBb3a5e752bb967691F4;
    address WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "RiseETH";
    ...
    uint256 public swapThreshold = _totalSupply / 5000; // 0.02% 200 uni
    bool inSwap;
