...
contract TheORB is Context, IBEP20, Ownable {
    ...
    function endPresaleProvideLiquidity() external onlyOwner {
        ...
        pancakeswapRouter.addLiquidityETH{value: BNBinContract}(address(this),ORBinContract, ORBinContract, BNBinContract, address(this), block.timestamp);     // adds the liquidity
