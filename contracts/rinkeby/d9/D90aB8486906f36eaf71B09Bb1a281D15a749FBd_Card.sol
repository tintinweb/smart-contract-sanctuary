...
contract Card is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getCommonMonster(uint256 tokenId, string memory offset) public view returns (string memory) {
        return pluck(tokenId, string(abi.encodePacked("MONSTER", offset)), commonMonsters);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[5] = getCommonMonster(tokenId, "3");

        parts[6] = '</text><text x="10" y="40" class="base">';

        parts[7] = getCommonMonster(tokenId, "3");

        parts[8] = '</text><text x="10" y="40" class="base">';

        parts[9] = getCommonMonster(tokenId, "3");

        parts[10] = '</text><text x="10" y="40" class="base">';

        parts[11] = getCommonMonster(tokenId, "3");

        parts[12] = '</text><text x="10" y="40" class="base">';

        parts[13] = getCommonMonster(tokenId, "3");

        parts[14] = '</text><text x="10" y="40" class="base">';

        parts[15] = getCommonMonster(tokenId, "3");
