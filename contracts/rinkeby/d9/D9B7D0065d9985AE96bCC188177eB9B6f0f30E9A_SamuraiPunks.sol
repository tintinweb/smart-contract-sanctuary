...
contract SamuraiPunks is ERC721, Ownable {
	...
	uint public constant MAX_Giveaway = 500; 
	...
	constructor() ERC721("Samurai Punks Test V11", "SamuraiPunks") {
	...
	function giveawayMintSamurai(address _to, uint256 numPurchase) public onlyOwner{
		...
		require(numGiveaways.add(numPurchase) <= MAX_Giveaway, "Exceeds the MAX_Giveaway.");
