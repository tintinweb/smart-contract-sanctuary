...
contract Exchange is ExchangeCore, AccessControl {
    ...
    function cancelSale(
        ...
        cancelSale_(seller, collection, tokenId);
    }
...
contract ExchangeCore is ReentrancyGuarded, EIP712, Ownable {
    ...
    event CancelSale(address collection, uint256 tokenId, address seller);
    ...
    function cancelSale_(
        ...
        collection.lockUnlockNFT(tokenId, false);

        emit CancelSale(_collection, tokenId, seller);
    }
    ...
    function atomicMatch_(
        ...
        ICollection collection = ICollection(seller.target);
        ...
        if (sale == SaleInfo.FINISHED) {
            collection.lockUnlockNFT(seller.tokenId, false);
            ...
            collection.lockUnlockNFT(seller.tokenId, true);
...
interface ICollection {
    ...
    function lockOf(uint256 tokenId) external view returns (bool);
}
