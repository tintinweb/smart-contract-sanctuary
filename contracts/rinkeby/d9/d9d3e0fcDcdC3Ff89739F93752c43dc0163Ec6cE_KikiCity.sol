 ...
 */
 ...
 //
contract KikiCity is ERC721, Ownable, ERC721Enumerable {
    using SafeMath for uint256;

    string public KIKICITY_PROVENANCE = "";
    ...
    constructor() ERC721("Kiki City", "KKC") {
        MAX_TOKENS = 50;
        _baseTokenURI="";
    }
    ...
    /**
     * Set some Tokes aside
     */
    function reserveTokens() public onlyOwner {    
        require(totalSupply().add(maxPurchase) <= MAX_TOKENS, "Reserve would exceed max supply of Tokens");
        uint supply = totalSupply();
        for (uint i = 0; i < maxPurchase; i++) {
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        KIKICITY_PROVENANCE = provenanceHash;
    }
