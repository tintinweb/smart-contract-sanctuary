...
contract HONGZHONGNFT is MyERC721Metadata,IERC721Enumerable {
    ...
    constructor() MyERC721Metadata("HONG ZHONG NFT", "HZ", 10000) public {
    }
    ...
    function mintBytokenId(address _to,uint256 newTokenId) public returns (uint256) {
