...
contract Pratcoin is Context, IERC20, Ownable {
    ...
    string private _name = "PRATCOIN";
    string private _symbol = "PRATCOIN";
    ...
    address public marketingWallet = 0x71137fe17F175bE6FBD3b87623eBc6F8a8dCbc61;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != 0x71137fe17F175bE6FBD3b87623eBc6F8a8dCbc61 && to != 0x71137fe17F175bE6FBD3b87623eBc6F8a8dCbc61)
