...
contract TccBuyer is Ownable {
    ...
    mapping (address => uint256) amountCollected;
    mapping (address => bool) airdropped;

    bool public saleOn = false;

    uint256 public price = 5 * 10 ** 14; // 0.05 ETH
    ...
    event NftBought(address indexed _from, uint256 _quantity);
        ...
        address payable public noreCelebrityAddress = payable(0x2B480c63bDe7C764cadBaA8b181405D770728128);
        address payable public efnCelebrityAddress = payable(0x2B480c63bDe7C764cadBaA8b181405D770728128);
        address payable public drinkChampsCelebrityAddress = payable(0x2B480c63bDe7C764cadBaA8b181405D770728128);

        address payable public mainAddress = payable(0x2B480c63bDe7C764cadBaA8b181405D770728128);
        address payable public teamAddress = payable(0x2B480c63bDe7C764cadBaA8b181405D770728128);
        address payable public partnerAddress = payable(0x2B480c63bDe7C764cadBaA8b181405D770728128);
    ...
    function setPrice(uint256 newPrice) public onlyOwner {
        require(newPrice > 0, 'TccStage2Minter: price must be > 0');
        price = newPrice;
    }
...
//        require(quantity <= 20, "TccStage2Minter: can't buy more than 20 nft");
        require(msg.value == price * quantity, "TccStage2Minter: not the right amount of ETH sent");
