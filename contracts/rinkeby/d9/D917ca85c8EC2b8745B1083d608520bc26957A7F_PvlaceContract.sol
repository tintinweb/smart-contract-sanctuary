...
contract PvlaceContract is ERC721, Ownable {
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        //these are the wrong prices by 10x
        if (currentSupply >= 350) {
            return 1000000000000000000; // 350 10 ETH
        } else if (currentSupply >= 311) {
            return 200000000000000000; // 311 - 349 2 ETH
        } else if (currentSupply >= 246) {
            return 150000000000000000; // 246 - 310 1.5 ETH
        } else if (currentSupply >= 176) {
            return 100000000000000000; // 176 - 245 1 ETH
        } else if (currentSupply >= 111) {
            return 70000000000000000; // 111 - 175 0.7 ETH
        } else if (currentSupply >= 51) {
            return 20000000000000000; // 51 - 110 0.2 ETH
        } else {
            return 10000000000000000; // 1 - 50 0.1 ETH
        }
    }
