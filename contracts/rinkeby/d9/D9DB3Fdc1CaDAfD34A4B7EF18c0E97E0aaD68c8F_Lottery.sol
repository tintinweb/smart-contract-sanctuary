...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        // 18 decimals chainlink provided 8 decimals so 10 decimal is remaining total will be 18 decimals
    ...
    function enter() public payable {
        // $50 minimum
        require(lottery_state == LOTTER_STATE.OPEN, "Lotter is not open");
