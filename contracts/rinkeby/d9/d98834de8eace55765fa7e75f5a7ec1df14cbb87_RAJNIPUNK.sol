...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable,VRFConsumerBase {
    ...
    mapping(uint256 => uint256) public tokenIdToPunk;
  ...
  // mapping for token creator
    ...
    mapping(bytes32 => uint256) public requestIdToRandomindex;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) public override returns(uint256) {
        ...
        requestIdToRandomindex[requestId] = randomResult;
        uint256 newItemId = requestIdToRandomindex[requestId];
        tokenIdToPunk[newItemId] = randomResult;
        _setTokenURI(newItemId,randomResult.toString());
        return randomResult;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory _tokenURI = tokenIdToPunk[tokenId].toString();
...
contract RAJNIPUNK is ERC721 {
    ...
    function createCollectible() public returns (uint256) {
        ...
        requestIdToTokenId[reqID] = newItemId;
