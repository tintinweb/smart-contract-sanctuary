...
contract SealFifteen is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 public tokenPrice = 20000000000000000; ///.02 Eth
    ...
    ///string public constant provenanceURI = "";
    ...
    /// Boom... Let's go!
    constructor(uint initialBatchCount) ERC721("SEAL15", "SLOA15") {
        // Mint the initial batch
        mintTokens(initialBatchCount);
    }

    /**
     * @dev Gives the ability to mint between 1-20 tokens.
     */
    function mintTokens(uint256 numberOfTokens) public payable {
        uint256 supply = totalSupply();
        require(saleIsActive, "Sale must be active");
        require(numberOfTokens >= 1, "Need at least 1 token");
        require(numberOfTokens <= 20, "Max 50 at a time");
        require(supply + (numberOfTokens) <= maxSupply, "Not enough tokens left");
        require(supply * (numberOfTokens) == msg.value, "Ether amount not correct");
   ...
   //   _safeMint(msg.sender, supply + i);
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://sealofapproval.io/";
    }
    ...
    function updateTokenPrice(uint256 _tokenPrice) public onlyOwner {
        require(_tokenPrice >= 1, "Must be >= 1"); // This is in wei
