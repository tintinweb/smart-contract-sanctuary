...
contract SimpleCollectible is ERC721, Ownable {
    ...
    function batchMint(string memory my_sample_ipfs_metadata_uri) public onlyOwner payable {
        ...
        uint256 numberOfNfts = 70;

        for (uint i = 0; i < numberOfNfts; i++) {
            createCollectible(my_sample_ipfs_metadata_uri);
        }
