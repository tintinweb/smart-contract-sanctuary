...
contract DeadPorkyPigs {
    function ownerOf(uint256 tokenId) public view returns (address) {}
}

contract PorkyPigs is ERC721Enumerable, Ownable {
    uint256 public constant OWNER_SUPPLY = 3;
    uint256 public constant MAX_SUPPLY = 5003;

    uint256 private _launchTimeEpochSeconds = 1636241441;

    string private _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmNrMKfZztzxSeq4c4LJKHth2EetR6JzaZWsS7dpZwLBBs/";
    bool private _ripCord = false;

    DeadPorkyPigs private _previous;

    constructor(address _dead) ERC721("PorkyPigs", "PORKPIGS") {
        _previous = DeadPorkyPigs(_dead);
    }
