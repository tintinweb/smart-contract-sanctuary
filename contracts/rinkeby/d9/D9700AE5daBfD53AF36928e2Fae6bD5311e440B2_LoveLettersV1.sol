...
contract LoveLettersV1 is ERC721 {
    uint256 public tokenCounter;
    mapping(uint256 => string) public idToLetter;


    constructor () public ERC721 ("LoveLetters", "LETTER"){
        tokenCounter = 0;
    }

    function writeLetter(string memory letter, address recipient) public returns (uint256) {
        string memory tokenURI = "https://ipfs.io/ipfs/Qmdx5CpGCmaEYZLGXBKTEtqxB1oEctjJpkAYBFm2CwoCdG?filename=0-buterin_meta_test.json";
        uint256 newItemId = tokenCounter;
        idToLetter[newItemId] = letter;
    ...
    function readLetters(uint256 newItemId) public view returns (string memory) {
      string memory letter = idToLetter[newItemId];
      return letter;
    }
