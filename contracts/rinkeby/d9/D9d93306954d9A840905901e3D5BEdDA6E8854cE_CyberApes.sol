...
contract CyberApes is ERC721, Ownable {
    ...
    function reserveApes(uint256 _count) public OnlyTokenAdmin {        
    ...
    */
    ...
    function mintCyberApe(uint numberOfTokens) public payable {
        require(saleIsActive || (presaleIsActive && isWhiteListed(_msgSender())), "Sale must be active to mint ape");
    ...
    function preMintCyberApe(uint numberOfTokens) public payable {
        require(presaleIsActive, "Presale must be active to mint ape");
