...
contract MadCrocodileNFT is ERC721URIStorage, Ownable {
    ...
    // variables / contants
    uint256 private NFTPrice = 1000000000000000; // Test for 0.001 eth, 77700000000000000; //0.0777 eth in WEI
    uint256 private mintLimit = 15;
    uint256 public presaleMintLimit = 3;
    uint256 public constant tokenSupply = 10000;

    // booleans - initialize these to false
    ...
    // URI related strings
    string private baseURI; //was public, täytyykö voida queryy? Ehkä opensean täytyy?
    string private notRevealedUri;
    string private contractURI; //was public, pudotti 100k kaasuu deployssa laittaa nää kaks privateks
    string public baseExtension = ".json";

    // addresses - private or internal?
    address private community = 0xCA750a94538e42a558952496afe5dc6cfccBcB61;
    ...
    function presaleStateChange() external onlyOwner {
        presaleOpen = !presaleOpen;
    }

    function saleStateChange() external onlyOwner {
        saleOpen = !saleOpen;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(payable(community).send(_split));
        require(payable(dev).send(_balance.sub(_split)));
    }
}
