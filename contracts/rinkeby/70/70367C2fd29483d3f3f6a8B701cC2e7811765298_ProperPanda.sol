...
contract ProperPanda is ERC721, EIP712, Ownable{
    ...
    /*
      ...
      #  white-list things:
        - whiteListNFT
        - pay fee : minting price 0.05
        - account wallet address , how much nft ?
      #  public sale done:
        - 0.05 same as whitelist mint fee
    */
    ...
    function mint() external payable {
      require(publicSaleEnabled, "NFT: Not in public sale!");
      require(msg.value >= mintFee, "NFT: Not enough Minting Fee!");
      // require();
      _tokenIds.increment();
    ...
    function claimNFT(bytes calldata _signature, uint256 _nftIndex) external {
      require(!isClaimed(_nftIndex, false), "NFT: Token already claimed!");
      require(_verify(_hash(msg.sender, _nftIndex), _signature), "NFT: Invalid Claiming!");
    ...
    function claimWhitelistSale(bytes calldata _signature, uint256 _nftIndex) external payable{
      require(msg.value >= mintFee, "NFT: Not enough Mint Fee!");
      ...
      uint256 newTokenId = _tokenIds.current();
      _mint(msg.sender, newTokenId);
      emit WhiteListSale(newTokenId, msg.sender);
    }
