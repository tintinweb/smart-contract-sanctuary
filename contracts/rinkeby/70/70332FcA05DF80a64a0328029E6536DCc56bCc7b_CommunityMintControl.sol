...
// mint 
// ------ call 0x931204Fb8CEA7F7068995dcE924F0d76d571DF99 create function (maxsupply/initialsupply/uri/data --- used?)
...
contract CommunityMintControl is AccessControl, ERC1155Holder {
    ...
    bytes[] public WhitelistNFTArray;
    mapping (bytes => uint256) public bytesToIdx;
    ...
    function Identifier (address _address, uint256 _tokenID) pure public returns (bytes memory) {
    ...
    function decodePackedIdentifier(bytes memory packedIdentifier) public pure returns (address, uint256){
