...
contract Ishiii is ERC721, Ownable {
    
    using SafeMath for uint256;

    string public ISHIHARA_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN BANANAS ARE ALL SOLD OUT
    
    string public LICENSE_TEXT = ""; // IT IS WHAT IT SAYS
    
    bool licenseLocked = false; // TEAM CAN'T EDIT THE LICENSE AFTER THIS GETS TRUE

    uint256 public constant ishiharaPrice = 50000000000000000; // 0.05 ETH
    ...
    uint public ishiharaReserve = 30;
        
    event licenseisLocked(string _licenseText);

    constructor() ERC721("Ishiii", "Ishiii") { }
    ...
    function mintIshihara(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxIshiharaPurchase, "Can only mint 20 tokens at a time");
