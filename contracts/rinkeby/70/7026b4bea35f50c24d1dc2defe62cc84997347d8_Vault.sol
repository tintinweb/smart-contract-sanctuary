...
contract Vault is ITreasury, Ownable {
  ...
  function initialize( address newManagedToken_, address newReserveToken_, address newpOLYToken_, address newBondingCalculator_, address newPrincipleDepository_ ) external onlyOwner() notInitialized() returns ( bool ) {
