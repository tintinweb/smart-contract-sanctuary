...
contract DigitalERC1155 is Ownable{
    ...
    address private _exc;

     constructor(string memory _name, string memory _symbol, address exc) public{
        name = _name;
        symbol = _symbol;
        _exc = exc;
    ...
    function safeTransferFrom(address _from, address _to, uint256 _id,uint256  _value) public{
        require(_exc == msg.sender, "Your are Not Eligible to access");
...
contract NFTMultiMint is DigitalERC1155{
    ...
    constructor(string memory _name, string memory _symbol, address exc) DigitalERC1155(name, symbol, exc) public{
        name = _name;
        symbol = _symbol;
        //_registerInterface(bytes4(keccak256('MINT_WITH_ADDRESS')));
    }
