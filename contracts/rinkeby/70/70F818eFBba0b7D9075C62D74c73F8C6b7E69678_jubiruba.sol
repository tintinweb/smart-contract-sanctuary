...
contract jubiruba is ERC20, Ownable {
    ...
    constructor() ERC20("TKH", "THEKEN") {
       _mint(msg.sender, 6942069);
    }
    ...
    function getPayments(uint index) public view returns(funder memory ) {
        return payment[msg.sender][index];
