...
contract TestNFT is ERC721, Ownable {
    ...
    string baseURI_ = "https://punkbodiesv2.mypinata.cloud/ipfs/QmYRvrRuERve5x2xKm7N3Wj9YhDPHuunk1Qng99QMafunh/";

    constructor(address _proxyRegistryAddress)  ERC721("TestNFT", "TNFT") {
        proxyRegistryAddress = _proxyRegistryAddress;
        tokenCounter = 0;
    }

    function mint(address to) payable external {
        require(msg.value == getBasePrice(), "ETH amount incorrect");
        require(tokenCounter < 6, "No remaining NFTs");
