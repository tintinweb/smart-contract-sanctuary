...
// will be transferred to a governance smart contract once PolkaBridge is sufficiently
...
contract PolkaBridgeFarm is Ownable, ReentrancyGuard {
    ...
    // Block number when bonus PBR period ends.
    ...
    function pendingPolkaBridge(uint256 _pid, address _user)
        external
        view
        returns (uint256)
    {
    ...
    function updatePool(uint256 _pid) public {
        ...
        polkaBridge.mint(devaddr, polkaBridgeReward.div(10));
        polkaBridge.mint(address(this), polkaBridgeReward);
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (user.amount > 0) {
            ...
            safePolkaBridgeTransfer(msg.sender, pending);
        }
    ...
    function safePolkaBridgeTransfer(address _to, uint256 _amount) internal {
