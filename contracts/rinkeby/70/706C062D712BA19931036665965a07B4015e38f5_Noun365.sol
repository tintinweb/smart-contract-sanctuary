...
contract Noun365 is ERC721 {
    uint256 public tokenCounter;
    uint public constant NUMBER_NOUNS = 30;
...
// string memory baseURI
    ...
    function createCollectible(string memory tokenURI)
        public returns (uint256) {
            uint256 newCollectibleId = tokenCounter;
            _safeMint(msg.sender, newCollectibleId);
            setTokenURI(newCollectibleId, tokenURI);
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(
            ...
            "ERC721: transfer caller is not owner nor approved, get fucked twat"
        );
