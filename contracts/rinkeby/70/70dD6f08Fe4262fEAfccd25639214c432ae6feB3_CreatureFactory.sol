...
contract Creature is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Emoji", "JED", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://jam-city-public.s3.us-west-2.amazonaws.com/ostest/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://jam-city-public.s3.us-west-2.amazonaws.com/ostest/contract.json";
    }
}
...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://jam-city-public.s3.us-west-2.amazonaws.com/ostest/factory/";
