...
contract RINKEMetafesto is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("RINKE Metafesto", "RING") {
  ...
  {
    return (address(this), (salePrice * 8800) / 10000);
  }
