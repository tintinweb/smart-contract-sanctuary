...
contract MyNFT is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x4748E5B0A78204C34E0FCecfE6Fc974DD55C1F8A;
    address t2 = 0x635aADe5f5b338C8e87eAF20A8B177F173ca806F;
    ...
    function awardItem(uint256 num) public payable {
        ...
        require( num < 11,                              "You can mint a maximum of 10 NFTs" );
        require( supply + num < 200,                    "Exceeds maximum NFT supply" );
    ...
    function withdrawAll() public payable canWithdraw {
