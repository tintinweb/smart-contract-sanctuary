...
import "./GateLibrary.sol";
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
import "@uniswap/v2-periphery/contracts/interfaces/IUniswapV2Router02.sol";

contract Gate is ERC20, Ownable {
  using SafeMath for uint256;

  address payable internal taxAddress;
  Fees private fees;
  ...
  constructor(uint256 _supply, address payable _taxAddress)
    ERC20("Gate", "GATE")
  {
  ...
  function swapTokensForEth(uint256 tokenAmount) internal {
    GateLibrary.swapForETH(uniswapV2Router, tokenAmount, address(this));
