...
contract LiquidityRegistry is ILiquidityRegistry, AbstractDependant {
    ...
    function setUpdate() external {
        require(capitalPool == address(0), "only usable once");
        capitalPool = 0xBbc0d29B829AA416153C1Ab43dDe5C41A453fD14;
    }
    ...
    function findWithdrawlAfterTime(uint256 _time) external view override returns(uint _index) {
    ...
    function adjustWithdrawlListCounter(uint256 _index) external onlyCapitalPool override {
