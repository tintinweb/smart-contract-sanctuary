...
contract PerksForAdventurers is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    event CreatePerk(uint128 indexed id);
...
'Spoiled'
   ...
   function mint(uint128 tokenId) public payable nonReentrant {
    ...
    function mintOwner(uint128 tokenId) public nonReentrant onlyOwner {
