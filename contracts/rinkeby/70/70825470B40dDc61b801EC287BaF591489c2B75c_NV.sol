...
contract NV is iNV, ERC721, ReentrancyGuard, Ownable {
    ...
    function generateMetadataJson(uint256 tokenId) public view returns (string memory) {
        ...
        parts[2] = '", ';
        parts[3] = '"description": "This is a description';
        parts[4] = '\\n\\n';
        parts[5] = 'Cid: [[cid]](https://ipfs.io/ipfs/[cid]?seed=';
        parts[6] = tokenId.toString();
        parts[7] = '#';
        parts[8] = ')\\n\\n';
        parts[9] = 'License: [Attribution-NonCommercial-ShareAlike 3.0 Unported (CC BY-NC-SA 3.0)](https://creativecommons.org/licenses/by-nc-sa/3.0/)\\n\\n';
        parts[10] = 'Artist SNS: [Twitter](https://twitter.com/r21nomi)", ';
        parts[11] = '"image": "ipfs://[cid]/?seed=';
        parts[12] = tokenId.toString();
        parts[13] = '.png", ';
        parts[14] = '"animation_url": "ipfs://[cid]?seed=';
        parts[15] = tokenId.toString();
        parts[16] = '#", ';
        parts[17] = '"external_url": "https://ipfs.io/ipfs/[cid]?seed=';
        parts[18] = tokenId.toString();
        parts[19] = '#", ';
        parts[20] = '"origin_cid": "[cid]", ';
        parts[21] = '"attributes":[ { "trait_type":"Artist", "value":"hoge" }, { "trait_type":"License", "value":"Attribution-NonCommercial-ShareAlike 3.0 Unported (CC BY-NC-SA 3.0)" } ],';
        parts[22] = '"license_url": "https://creativecommons.org/licenses/by-nc-sa/3.0/"';
        parts[23] = '}';
    ...
    function buy(uint256 tokenId) external override nonReentrant payable {
        ...
        require(tokenId < _nextReservedTokenId, "Invalid id");
