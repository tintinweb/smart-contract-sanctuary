...
contract Puzzled is ERC721Tradable {
    ...
    uint public constant MAX_TOKENS = 101;
    uint256 public price = 0; 
    uint256 public Finalprice = 10000000000000000 ;           // Change Before Mainnet Deploy
    uint public MAX_FREE = 90;
    string private base_url;
    bool public sale_active = true;                         // Change Before Mainnet Deploy
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 300;  // Change Before Mainnet Deploy
    uint public constant maxNFTPerWallet = 101;             // Change Before Mainnet Deploy
    ...
    function mintCube(uint256 _count) external payable {
        ...
        require(msg.value >= Finalprice.mul(_count), "Ether value sent is not correct");
