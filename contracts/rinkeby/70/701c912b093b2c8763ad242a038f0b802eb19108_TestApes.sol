...
contract TestApes is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PURCHASE_LIMIT = 5;//10;
    uint256 public constant PRESALE_PURCHASE_LIMIT = 5;//10;
    uint256 public constant MAX_APES = 100;//10000;
    ...
    constructor(string memory _baseTokenURI) ERC721("TestyWesty10","TESTYYY10") {
    ...
    function preSaleMintApes(uint256 num) public payable{
        uint256 supply = totalSupply();
        //test to see what happens if address is not in whitelist
    ...
    //could change this just to use send or transfer, but not best practice?
    //would be worried about not having a precedent - see cool cats or foxfam
...
/*
["0xAaDE29f2374A138Bd539FC3D08B920a54afc92EB",
 "0x677B146E634f3D63937a588ca986d3E39c985A6d",
 "0x2846B8a62A0C99636354a022dB03629823F2c0ae"]
*/