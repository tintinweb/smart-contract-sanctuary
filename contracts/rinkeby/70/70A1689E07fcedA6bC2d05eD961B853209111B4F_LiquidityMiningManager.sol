...
contract LiquidityMiningManager is TokenSaver {
    ...
    modifier onlyGov {
        require(hasRole(GOV_ROLE, _msgSender()), "FLiquidityMiningManager.onlyGov: permission denied");
        _;
    }

    modifier onlyRewardDistributor {
        require(hasRole(REWARD_DISTRIBUTOR_ROLE, _msgSender()), "FLiquidityMiningManager.onlyRewardDistributor: permission denied");
        _;
    }
