...
contract PP35 is ERC721, Ownable {
    using SafeMath for uint256;

    string public Pirate_Provenance = ""; 
    string public LICENSE_TEXT = "";
    bool licenseLocked = false;
    uint256 public PiratePrice = 25000000000000000000; // 0.025 ETH
    uint256 public constant maxPiratePurchase = 10000;
    uint256 public constant MAX_PIRATES = 10000;
    bool public saleIsActive = false;
    uint256 public PirateReserve = 100; // Reserve 150 Pirates for team & community (Used in giveaways, events etc...) 
    event licenseisLocked(string _licenseText);


    constructor() ERC721("pp35", "PP35") {
