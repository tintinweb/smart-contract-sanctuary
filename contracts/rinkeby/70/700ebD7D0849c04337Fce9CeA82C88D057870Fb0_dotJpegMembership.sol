...
contract dotJpegMembership is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxRegularSupply = 109;
  uint256 public maxOGSupply = 16;
  ...
  bool public whitelistedMintSale = false;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        ...
        howManyMinted[msg.sender] = totalMinted + _mintAmount;
    }
