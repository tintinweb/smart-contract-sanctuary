...
contract OneEye6 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public presaleRemaining = 20;
    uint256 public reservedRemaining = 30;
    ...
    constructor() ERC721("OneEye6", "OE6") {}
    ...
    function mint(uint256 mintCount) public payable {
        ...
        require((totalSupply() + mintCount) < maxItems, "Purchase would exceed max supply of items");
