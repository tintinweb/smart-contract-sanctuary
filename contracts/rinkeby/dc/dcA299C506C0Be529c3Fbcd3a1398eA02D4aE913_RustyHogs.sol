...
contract RustyHogs is ERC721, MerkleWhitelist, Ownable, ERCWithdrawable {
    /*
        Features: 
    ...
    */
    ...
    // Constructor
    constructor() ERC721("RustyHogs", "RSH") {}
    ...
    // Namable
    mapping(uint256 => string) public rustyHogsName;
    mapping(uint256 => string) public rustyHogsBio;
    ...
    function publicMint(uint256 amount_) external payable onlySender publicSale {
        require(addressToPublicMinted[msg.sender]+amount_ < 6, "You have no public mints remaining!");
        require(msg.value == mintPrice*amount_, "Invalid value sent!");
