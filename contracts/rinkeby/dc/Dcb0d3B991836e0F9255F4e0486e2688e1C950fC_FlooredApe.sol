...
contract FlooredApe is ERC721, ERC721URIStorage, Pausable, AccessControl {
    ...
    string ogUri =
        "https://flooredape.mypinata.cloud/ipfs/QmX8264nb5ND6uAuhwpnCvPpoWdtKcXc1qkG8WzmVSahxp";
    string normalUri =
        "https://flooredape.mypinata.cloud/ipfs/QmZLqNNUBpEkSA7xYpPXy4dBfTVifmNtTSop4A3KCGFHGz";
    ...
    function batchFreeMint(address[] memory whiteList, uint256 amount)
        public
        payable
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        for (uint256 j = 0; j < whiteList.length; j++) {
            ...
            for (uint256 i = 0; i < amount; i++) {
                ...
                _setTokenURI(_tokenIdCounter.current(), normalUri);
