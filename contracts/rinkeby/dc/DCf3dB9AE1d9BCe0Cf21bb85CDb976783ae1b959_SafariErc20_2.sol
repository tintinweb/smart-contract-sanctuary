...
contract SafariErc20_2 is UUPSUpgradeable, ERC20Upgradeable, OwnableUpgradeable {
  ...
  function burnStripes(uint256 amount) external {
    ...
    stripes.transferFrom(_msgSender(), address(this), amount);
