...
contract Gum is ERC721URIStorage, VRFConsumerBase {
    uint256 constant MAX_MINT = 20000;
    uint256 constant PRICE = 200000000000000000; // 2 MATIC !!!! 0.2 for testing !!!!
        ...
        override
    {
        ...
        properties.wrapper = Wrapper(randomValues[0] % 5);
        properties.color = randomValues[1] % 2**24;
