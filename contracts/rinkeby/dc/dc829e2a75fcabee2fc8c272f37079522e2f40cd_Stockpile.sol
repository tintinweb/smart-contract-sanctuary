...
contract StockpileMetadata {
    ...
    function itemSVG(
        ...
        bytes[4] memory male = genderParts(man, tokenId, Gender_2.MALE, componentType);
        bytes[4] memory female = genderParts(female, tokenId, Gender_2.FEMALE, componentType);
...
contract Stockpile is ERC1155, StockpileMetadata, Ownable {
    ...
    function setRle(
        ...
        rles[id][Gender_2.MALE] = male;
        rles[id][Gender_2.FEMALE] = female;
    }
