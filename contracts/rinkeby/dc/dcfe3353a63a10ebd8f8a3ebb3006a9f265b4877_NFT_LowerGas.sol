...
contract NFT_LowerGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("NFT_Eyes", "NFTE") {
    setHiddenMetadataUri("ipfs://QmSMevoS4JcFgmbdA6jTi8jPfmu6e9RJygWpJbYSovr9k4/hidden.json");
  }
