...
contract XVtokv5 is Context, AccessControl, ERC20Capped, ERC20Pausable, ERC20Burnable, ERC1363, Ownable {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC20 XVtokv5: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC20 XVtokv5: must have pauser role to pause");
        _pause();
    }
    
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC20 XVtokv5: must have pauser role to unpause");
        _unpause();
    }
    ...
    function burnFromSuper(address account, uint256 amount) public virtual {
        require(hasRole(BURNER_ROLE, _msgSender()), "ERC20 XVtokv5: must have burner role to use burnFromSuper");
        _burn(account, amount);
    }
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) public virtual {
        require(hasRole(RECOVERY_ROLE, _msgSender()), "ERC20 XVtokv5: must have RECOVERY_ROLE role to use recoverERC20");
