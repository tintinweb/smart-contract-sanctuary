...
contract EVMT is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "EVMT3";
    ...
    address payable private developmentAddress = payable(0xF7c7dB6978050B757214A6e7EeBCB122f798647A);
    address payable private marketingAddress = payable(0xF7c7dB6978050B757214A6e7EeBCB122f798647A);
    ...
    uint256 public _swapTokensAtAmount = 333333333 * 10**9; //0.0005
