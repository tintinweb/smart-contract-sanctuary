...
contract Dinos is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAXDINOS = 15;
    uint256 public constant MAXDINOS_PRESALE = 10;
    uint256 public maxDinosPurchase = 5;
    ...
    constructor(address _proxyRegistryAddress, string memory baseURI) ERC721("DinoSquad Unleashed", "Dinos") {
        setBaseURI(baseURI);
        isSaleActive = false;
