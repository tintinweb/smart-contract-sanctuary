...
contract FeraToken is ERC20, Ownable {
    ...
    // Min amount to liquify. (default 500 FERAs)
    uint256 public minAmountToLiquify = 500 ether;
    // The swap router, modifiable. Will be changed to FeraSwap's router when our own AMM release
    ...
    /**
     * @notice Constructs the FeraToken contract.
     */
    ...
    /// @dev overrides transfer function to meet tokenomics of FERA
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        // generate the feraSwap pair path of token -> weth
    ...
    // To receive BNB from feraSwapRouter when swapping
