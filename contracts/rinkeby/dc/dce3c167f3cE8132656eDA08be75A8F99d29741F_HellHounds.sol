...
contract HellHounds is ERC721Enumerable, Ownable, HHVoucherSigner {  
    ...
    uint256 public constant PRESALE_SUPPLY = 1200;
    ...
    function mintPresale(uint256 _amount) public payable {
        ...
        require( reservedAmt > 0,                "0 Tokens Reserved For Your Address" );
        require( _amount <= reservedAmt,         "Reached Max Reserved Ammount" );
        require( supply + _amount <= MAX_SUPPLY, "Not Enough Supply" );
        require( msg.value == price * _amount,   "Incorrect Amount Of ETH Sent" );
    ...
    // Presale Minting V2
    function mintPresaleV2(uint256 _amount, HHVoucher.Voucher calldata v) public payable {
        uint256 supply = totalSupply();
        require(presaleActive, "Private sale not open");
        require(claimedVouchers[v.voucherId] == false, "Voucher already claimed");
    ...
    // Edit Presale Spots
    function editPresale(address[] memory _a, uint256[] memory _amount) public onlyOwner {
...
abstract contract HHVoucherSigner is Ownable {
