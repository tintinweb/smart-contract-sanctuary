...
contract fxnPart is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getCredits(uint256 tokenId) public view returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        return pluck(tokenId, "CREDITYIELD", creditYield);
    }
    ...
    function getIntelligence() public view returns (string memory) {
        return "1000";
    }
    
    function getAttractiveness() public view returns (string memory) {
        return "1000";
    }
    
    function getTechSkill() public view returns (string memory) {
        return "1000";
    }
    
    function getCool() public view returns (string memory) {
        return "1000";
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 12px; }</style><rect width="100%" height="100%" fill="#515152" /><text x="10" y="20" class="base">';
        ...
        parts[5] = getCredits(tokenId);

        parts[6] = '</text><text x="10" y="80" class="base">';

        parts[7] = getGender(tokenId);
        ...
        parts[11] = getAbility(tokenId);

        parts[12] = '</text><text x="10" y="140" class="base">';

        parts[13] = getStrength();

        parts[14] = '</text><text x="10" y="160" class="base">';

        parts[15] = getAttractiveness();
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Bag #', toString(tokenId), '", "description": "Nope not yet.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("fxnPart", "FXNP") Ownable() {
        saleActive = false;
