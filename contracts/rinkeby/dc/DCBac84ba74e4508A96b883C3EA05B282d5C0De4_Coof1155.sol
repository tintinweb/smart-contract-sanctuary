...
contract Coof1155 is PermitControl, ERC165, IERC1155, IERC1155MetadataURI {
  ...
  */
  ...
  /**
  */
  function _infect(uint256 _id) internal {
    uint256 mintCount = itemGroups[1].mintCount;
    uint256 newgroupIdPrep = uint(9) << 128;
    uint256 id = newgroupIdPrep.add(mintCount).add(1);
  

    this.mintBatch(msg.sender, _asSingletonArray(id), _asSingletonArray(uint256(1)), "");
  }
