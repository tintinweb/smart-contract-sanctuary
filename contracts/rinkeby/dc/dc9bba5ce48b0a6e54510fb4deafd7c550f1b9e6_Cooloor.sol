...
contract Cooloor is ERC721, ERC721Enumerable, Ownable {
  
  // Provenance
  string public COOLOOR_HASH = "";
  ...
  // Adress
  address member1 = 0x6E7FeC3A9049aF6bF97722EB0CbB49e009A78BAF;
  address member2 = 0xEeB78d358FE10722644C4A187f7d381A7F54ee3E;
  address member3 = 0x6D72f0ceb6Ec0559cE35a0Dbf4e3309A1A784DD1;
  ...
  constructor(string memory baseURI) ERC721("Cooloor", "CLRB") {
    setBaseURI(baseURI);
  }
  ...
  function withdraw() public onlyOwner {
        require(payable(msg.sender).send(address(this).balance /100*34 ));
		require(payable(member2).send(address(this).balance /100*34));
		require(payable(member3).send(address(this).balance /100*32));
