...
contract Staking is Ownable {
    ...
    constructor(address stakeToken_, address treasure_, uint zeroRewardTimePercent_) {
        require(
    ...
    function stake(uint tokenAmount, uint stakeTime) public returns (bool) {
        ...
        require(rewardPercent != 0, "Staking::stake:rewardPercent must be less than 0");
    ...
    function withdraw() external {
        ...
        if (feeAmount > 0) {
            ...
            if(currentTimestamp <= endZeroRewardPeriod) {
                ...
                amountOut = stakeAmount * timeReward[stakeTime] / 100e18;
            }
        }
