...
contract SliceOfPizza is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    string baseURI;
    string public SLICE_OF_PIZZA_PROVENANCE = "";
    ...
    uint256 private reservedAmount = 10;
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        SLICE_OF_PIZZA_PROVENANCE = provenanceHash;
    }

    function reserveTokens(address _to, uint256 _amount) public onlyOwner {
        require(_amount <= reservedAmount, "Maximum reserved reached!");
