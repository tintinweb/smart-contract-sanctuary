  ...
  UUPSUpgradeable
{
    ...
    returns (string memory)
  {
    ...
    string memory attributes = Base64.encode(
      bytes(
        string(
          abi.encodePacked(
            '{"trait_type": "Strength", "max_value": 100, "value": ',
            uint256(character.strength).toString(),
            '}, {"trait_type": "Dexterity", "max_value": 100, "value": ',
            uint256(character.dexterity).toString(),
            '}, {"trait_type": "Constitution", "max_value": 100, "value": ',
            uint256(character.constitution).toString(),
            '}, {"trait_type": "Intelligence", "max_value": 100, "value": ',
            uint256(character.intelligence).toString(),
            '}, {"trait_type": "Wisdom", "max_value": 100, "value": ',
            uint256(character.charisma).toString(),
            '}'
          )
        )
      )
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "Test ID#',
            tokenId.toString(),
            '", "description": "Alien and Robot NFT characters", "background_color": "427646", "image": "',
            imageUrl,
            '", "attributes" : [',
            attributes,
            ', {"trait_type": "Type", "value": "',
            character.race == Type.Alien ? 'Alien' : 'Robot',
