...
contract HTML is ERC721, Ownable {
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "html nft #',
            toString(tokenId),
            '", "description": "testing code.", "image": "data:image/svg+xml;base64,',
