...
contract HappyBearIsland is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "https://happybearisland.herokuapp.com/api/creature/";
    ...
    constructor(uint _bearPrice, address _proxyRegistryAddress) ERC721("Happy Bear Island TEST", "HBIT") { 
    ...
    function buyBears(uint _numberOfTokens) public payable {
        ...
        require(_numberOfTokens <= maxBearPurchase, "You cannot purchase these many tardXs at a time");
