...
contract TheCollectedOne is AdminControl, ICreatorExtensionTokenURI {
    ...
    function mint() public payable {
        ...
        require(mints + 1 <= 100, "No more mints left.");
        mints++;
    ...
    function tokenURI(address creator, uint256 tokenId) external view override returns (string memory) {
        ...
        '{"name":"The Collected One","created_by":"yung wknd","description":"What if the collector was the collected one?","animation":"',
    ...
    function withdraw(address _to) public {
        ...
        require(mints == 100, "Can only withdraw when sold out");
