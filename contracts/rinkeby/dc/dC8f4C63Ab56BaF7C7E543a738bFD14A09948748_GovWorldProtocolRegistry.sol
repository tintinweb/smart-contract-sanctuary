...
contract GovWorldProtocolRegistry is GovWorldProtocolBase {
    ...
    uint256 public lenderUnearndedAPYPercentage;
    ...
    uint256 public govThresholdFee; //0.05 %
    ...
    function initialize(address _govAdminRegistry) external initializer {
        ...
        lenderUnearndedAPYPercentage = 2000;
        // platform fee is the 1% of the loan amount
        //TODO percentages should be in basis point to handle decimals in all contracts
    ...
    */
    function addTokens(
        ...
        for (uint256 i = 0; i < _tokenAddress.length; i++) {
            ...
            //TODO uncomment require before mainnet deployment
            // require(
...
abstract contract GovWorldProtocolBase is
    OwnableUpgradeable,
    IGovWorldProtocolRegistry
{
