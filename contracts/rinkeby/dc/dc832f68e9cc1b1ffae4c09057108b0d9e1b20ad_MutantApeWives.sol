...
contract MutantApeWives is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "http://ipfs.io/ipfs/QmfEMwk13McUshuSqCKCLemZzbv22wsWZktSXeiGh3NXnL/";
    ...
    constructor() ERC721("MutantApeWives_test1", "MAW"){
        whitelist[0x9D096539D98B4bD35a5a3a5587edb2E8534170F7].exists = true;
    }
    ...
    function PresaleMint(uint256 numberOfTokens) public payable{
        ...
        require(numberOfTokens > 0 && tokensMinted + numberOfTokens <= maxApePurchase, "Purchase would exceed max supply of MAW's");
