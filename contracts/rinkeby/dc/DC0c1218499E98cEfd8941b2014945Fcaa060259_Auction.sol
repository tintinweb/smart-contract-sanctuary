...
contract Auction{
    ...
    function CheckBidderIdentity(string calldata auctionID,address Bidder_Address) external isAuctionEnded(auctionID) returns(bool){
        require(Auction_Success[auctionID],"Auction Failed");
        string memory property_id = auction[auctionID].property_id;
