...
@dev Extends ERC721 Non-Fungible Token Standard to alllow
     ...
     Tokens are only mintable by a signed EIP-718 transaction to ward off
     attacks of the contract via other contracts, and minting via Etherscan.
*/
...
contract RADIOACTIVEPUNKS is ERC721Burnable, ERC721Pausable, ERC721Enumerable, HasSecondarySaleFees, ERC2981, Ownable {
  ...
  /*
   * For dbl checking signature functionality on main without spending money
   */
  ...
  // /*
  //  * For testing rsv values from the front end to are in sync with the contract
  ...
  //   bytes32 sigR = 0x8168a7611e4b4cc7e0f830e2c45ddb8b5291077defd92bf859f4d0c2b11ac55e;
  //   bytes32 sigS = 0x46b482a800104410882697cf1ffa5c19fd6e172477ded3c331bc40d1b8fe43ef;
  //   uint8 sigV = 27;

  //   address signer = 0x9029d487B494438f20dd937cE8548DF682633dDE;

  //   return verify(signer, sigV, sigR, sigS);
  // }
}