...
contract CryptoDog is ERC721Enumerable, Ownable {
    ...
    function mint(uint256 _amount) public payable {
        ...
        require(_amount > 0, "Mint number is null");
        require(_amount <= maxMint, "You try to mint too much tokens");
        require(supply + _amount <= maxSupply, "There are not enough tokens available");
