...
/*
 *  ______   __         __  __     __  __        _____     ______     ______    
 * /\  ___\ /\ \       /\ \/\ \   /\_\_\_\      /\  __-.  /\  __ \   /\  __ \   
 * \ \  __\ \ \ \____  \ \ \_\ \  \/_/\_\/_     \ \ \/\ \ \ \  __ \  \ \ \/\ \  
 *  \ \_\    \ \_____\  \ \_____\   /\_\/\_\     \ \____-  \ \_\ \_\  \ \_____\ 
 *   \/_/     \/_____/   \/_____/   \/_/\/_/      \/____/   \/_/\/_/   \/_____/ 
 */
...
contract FluxGovernor is Governor, GovernorCompatibilityBravo, GovernorVotes, GovernorTimelockControl {
    ...
    constructor(
        ...
        uint256 _initVotingDelay,
        uint256 _initVotingPeriod,
        uint256 _initProposalThreshold
    )
        Governor("FluxGovernor")
        GovernorVotes(_token)
        GovernorTimelockControl(_timelock)
    {
        _votingDelay = _initVotingDelay;
        _votingPeriod = _initVotingPeriod;
        _proposalThreshold = _initProposalThreshold;
    }
    ...
    function _setProposalThreshold(uint256 newProposalThreshold) external {
        require(msg.sender == timelock(), "Timelock only");
        uint oldProposalThreshold = _proposalThreshold;
        _proposalThreshold = newProposalThreshold;

        emit ProposalThresholdSet(oldProposalThreshold,_proposalThreshold);
    }
