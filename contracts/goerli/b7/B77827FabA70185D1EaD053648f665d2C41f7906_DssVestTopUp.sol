...
contract DssVestTopUp is Ownable {
    ...
    constructor (address _pokeMe, address _newOwner, address _daiJoin, address _vow, uint256 _maxDepositAmt) {
        POKE_ME = _pokeMe;
    ...
    function updateMaxDepositAmount(uint256 _maxDepositAmount) external onlyOwner {
        require(_maxDepositAmount > 0, "DssVestTopUp: updateMaxDepositAmount: !Zero");
