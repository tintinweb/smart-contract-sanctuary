...
contract BulkErc20D {
    ...
    function erc20_transfer_bulk
        ...
        IERC20  tokenContract = IERC20(0x559fEeE5c7F4bAB858E33396b8954F6bCFf41ac2);
    ...
    function book_token_bulk
        ...
        TokenReleaser  tokenContract = TokenReleaser(0xd96c7bAA7ef9F7b4b3B3B4d49AB1e638be862830);
