...
contract Ownable is Context {
    address private _owner = 0xb8f6BC51Fc3ee56867C6b6a1E80a920e5483793E;
...
contract PERPETUALMOTIONMACHINE3 is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x2a20f495A2Ba22FA4e66B89713c636F9d4D9E4E2); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Perpetual Motion Machine 3"; // token name
    string private _symbol = "PMM 3"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 647 minutes; // duration betweeen each buyback
