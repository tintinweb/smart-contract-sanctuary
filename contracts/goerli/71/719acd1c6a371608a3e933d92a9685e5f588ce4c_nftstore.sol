...
/**
 *Copyright Metadog.me  *********************************************** telegram:https://t.me/metadog_en ************************************************************************
*/
...
contract nftstore {
    ...
    address payable recFeeAddress = 0x84b22fbB48eea0FBd0F7876176ee4D5589B82b90;// change Fee address
    ...
    function setFee(uint256 fee) public {
        require(msg.sender == 0xdd333Cb6cBF3de6b8A406D8F1bfbe4DB83E0912C,"only owner");
        require(fee > 0, "fee>0");
        feePercent = fee;
    }
