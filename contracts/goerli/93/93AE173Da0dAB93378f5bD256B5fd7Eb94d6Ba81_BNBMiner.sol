...
/*   BNBMiner - investment platform based on Binance Smart Chain blockchain smart-contract technology. Safe and legit!
 *   
 *   [USAGE INSTRUCTION]
 *
 ...
 *   - Total income: based on your tarrif plan (from 4% to 54% daily!!!) !!!
 *   - Earnings every moment, withdraw any time 
 *
 *   [AFFILIATE PROGRAM]
 *
 *   - 3-level referral commission: 5% - 2% - 2%
 *
 *   [FUNDS DISTRIBUTION]
 *
...
contract BNBMiner {
	...
	constructor(address payable fundAddr,address payable mktAddr,uint256 startDate){
      ...
      plans.push(Plan(100, 40));
      plans.push(Plan(12, 100));
      plans.push(Plan(13, 130));
      plans.push(Plan(7, 180));
      plans.push(Plan(3, 380));
      plans.push(Plan(2, 540));
	}
