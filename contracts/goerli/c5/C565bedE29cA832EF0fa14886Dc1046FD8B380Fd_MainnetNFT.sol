...
// Part: OpenZeppelin/openzeppelin-contr[email protected]/Strings
...
contract MainnetNFT is ERC721URIStorage {
  ...
  constructor(address _predicate, string memory baseURI_) ERC721("Ponch Award", "POAW") {
    owner = msg.sender;
