    ...
    function checkPerformance(uint256 _inputDeFi, uint256 _inputSNP, bool _polarityDeFi, bool _polaritySnp) public {
        ...
        if(!_polarityDeFi && !_polaritySnp){
            ...
            if(_inputDeFi > _inputSNP){
                winnerScale = _inputDeFi.div(_inputSNP);
                who = false;
                thorCheck = 1;

            } else
                winnerScale = _inputSNP.div(_inputDeFi);
                who = true;
                thorCheck = 2;
        ...
        // DeFi = Positive |=====| SNP = Negative
            ...
            winnerScale = _inputDeFi.add(_inputSNP).div(_inputDeFi);
            who = true;
             thorCheck = 3;
        ...
        // DeFi = Negative |=====| SNP = Positive 
            ...
            winnerScale = _inputDeFi.add(_inputSNP).div(_inputSNP);
            who = false;
