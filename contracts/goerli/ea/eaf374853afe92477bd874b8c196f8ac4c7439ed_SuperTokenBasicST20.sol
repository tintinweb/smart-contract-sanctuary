...
contract SuperTokenBasicST20 is ST20, ServicePayer {
    constructor (
        string memory name,
        ...
        ST20(name, symbol)
        ServicePayer(feeReceiver, "SuperTokenBasicST20")
        payable
    {
        require(initialBalance > 0, "SuperTokenBasicToken: supply cannot be zero");
