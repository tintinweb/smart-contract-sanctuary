...
contract Gryldcheez is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x388f63CC49BF5569a3245e84271984529DB84Fce); // Marketing Address

    address public buyBackAddress = payable(0xe269DE0B60262345AcCD9b33f98481C8F6F020e7);
    address public devAddress = payable(0x388f63CC49BF5569a3245e84271984529DB84Fce);
    ...
    uint256 public _liquidationThreshold = 1000000 * 10**18;
    uint256 private launchTime;

    uint256 public _maxTransaction = 1000 * 10**6 * 10**18;
    uint256 public _maxWallet = 10000 * 10**6 * 10**18;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()){
            require(amount <= _maxTransaction, "GRYLDCHEEZ: Transfer amount exceeds the max transaction amount allowed");
            require(balanceOf(to).add(amount) <= _maxWallet, "GRYLDCHEEZ: Transfer amount exceeds the max amount allowed per wallet");
        }
