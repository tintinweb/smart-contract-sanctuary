...
contract Eth_broker {
    ...
    event burnTokensForEth(
        ...
        uint256 minRewardEth        // The min amount of ETH to sell for
    );
    ...
    /**
      ...
      * @param  _tokenAmount The amount of BZZ tokens the user would like to
      *         sell.
      * @param  _minEthSellValue The min value of ETH the user
