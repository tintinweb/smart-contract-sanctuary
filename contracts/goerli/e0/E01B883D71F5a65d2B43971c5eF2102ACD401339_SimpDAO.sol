...
contract SimpDAO is ERC721A, Ownable {
    ...
    uint32 constant public freeMintMax = 5;
    uint256 public freeMintCount = 0;
    uint256 public saleStartTimestamp;

    constructor() ERC721A("SimpDAO", "Simp", 5, maxSupply) {
    }
