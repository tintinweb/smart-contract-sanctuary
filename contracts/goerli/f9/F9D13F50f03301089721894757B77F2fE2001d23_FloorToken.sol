...
contract FloorToken is IFloorToken, Ownable, ERC721Checkpointable {
    ...
    modifier onlyDepositor() {
        require(msg.sender == depositor, 'Sender is not the depositor');
        _;
    }
    ...
    function withdrawWithMetadata(uint256 tokenId) external {
        ...
        emit TransferWithMetadata(ownerOf(tokenId), address(0), tokenId, this.encodeTokenMetadata(sizes[tokenId]));
