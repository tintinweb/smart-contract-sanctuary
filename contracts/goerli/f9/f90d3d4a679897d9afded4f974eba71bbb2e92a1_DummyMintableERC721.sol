...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked("https://www.losernft.org/loserpunks/", Strings.toString(tokenId), ".json"));
    }
    ...
    ContextMixin
{
    ...
    string private name_ = "LOSERPUNKS";
    string private symbol_ = "失败朋克";
