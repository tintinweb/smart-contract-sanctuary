...
contract qSpaceNative is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x835179D706EDeDCF491DCbcA3b14D1986FC72c0D); // Marketing Address
    ...
    uint256 private _tTotal = 1530000* 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "qSpace Native";
    string private _symbol = "qSpace";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x835179D706EDeDCF491DCbcA3b14D1986FC72c0D);
    }
