...
contract ReconRams is ERC721Enum, Ownable, PaymentSplitter {
    ...
    uint256[] private _shareList = [17, 17, 17, 17, 16, 16];

    
    // string memory _initBaseURI,
    // string memory _initNotRevealedUri,
    // bytes32 _root
    constructor() ERC721P("ReconRams", "RR") PaymentSplitter(_splitterAddressList, _shareList) {
        setBaseURI("asdf");
        setNotRevealedURI("asdf");
        merkleRoot = 0xbf40b9f6f149c74e08c6562d3c0044ddbbb24bda2abe9f3bf7b8897fc588e57d;
    }
    ...
    function _verifyLeaf(bytes32 _leafNode, bytes32[] memory proof) internal view returns (bool) {
    ...
    function teamLegendariesMint() public onlyOwner {
