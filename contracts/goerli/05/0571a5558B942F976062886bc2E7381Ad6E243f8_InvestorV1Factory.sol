...
contract InvestorV1Pool is IInvestorV1Pool {
    ...
    address public constant HSF = 0x51cf528c7Ce9e3186c869dFaA313de47358A2c61;
    address public constant USDT = 0x10701139142CF9812DEb4792D2aE2733d47F5708;
    ...
    function getExtra() public override view returns (address, address, uint256, uint256, uint256, string memory, string memory) {
        return (operator, factory, oraclePrice, depositors(), restakers(), collateralDocument, collateralHash);
    }
...
interface IInvestorV1PoolState {
    ...
    function getExtra() external view returns (address, address, uint256, uint256, uint256, string memory, string memory);
}
