...
contract OKPCMetadata is IOKPCMetadata {
  ...
  function draw(
    ...
    bytes memory svg = abi.encodePacked(
      ...
      drawArt(art),
      drawWord(parts.word),
      '<g transform="translate(19, 28)"><path d="M0 0h1v1H0zm2 0h1v1H2zm2 0h1v1H4zm2 0h1v1H6zm2 0h1v1H8zm2 0h1v1h-1zM0 2h1v1H0zm2 0h1v1H2zm2 0h1v1H4zm2 0h1v1H6zm2 0h1v1H8zm2 0h1v1h-1z"/></g></svg>'
    );
  ...
  function drawArt(bytes memory artData) internal view returns (string memory) {
    ...
    rects.appendSafe(abi.encodePacked('</g>'));
