...
contract Staking is Ownable, FxBaseRootTunnel {
    ...
    function stake(uint256 _amount) external {
        ...
        if (!staked[msg.sender]) {
            ...
            stakedAmount[msg.sender] = SafeMath.add(stakedAmount[msg.sender], _amount);
        }
        stakedAmount[msg.sender] = SafeMath.add(stakedAmount[msg.sender], _amount);
        _sendMessageToChild(abi.encode(msg.sender, true, _amount));

        emit StakedTokens(msg.sender);
    }
