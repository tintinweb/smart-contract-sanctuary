...
contract SquidGame is Context, IERC20, Ownable {
    ...
    address payable private charityAddress = payable(0x000000000000000000000000000000000000dEaD);
    ...
    string private _name = "EvilSquidGame";
    string private _symbol = "EvilSquid";
    ...
    uint256 private _crctLiquidityFee = 3;
