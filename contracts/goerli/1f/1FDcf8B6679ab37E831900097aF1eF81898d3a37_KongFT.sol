...
// File contracts/KongFT.sol


pragma solidity 0.8.0;


contract KongFT is ERC721URIStorage, Ownable {
  ...
  Ownable() {
    // Goerli testnet MintableERC721PredicateProxy
    address mintableERC721PredicateProxy = 0x56E14C4C1748a818a5564D33cF774c59EB3eDF59;

    minterRole[mintableERC721PredicateProxy] = true;
  }

  function setMinterRole(address _address, bool _roleStatus)
  external
  onlyOwner {
    minterRole[_address] = _roleStatus;
  }

  function setTokenBaseURI(string calldata _newURI)
  external
  onlyOwner {
