...
contract ArtistCoinOne is Initializable, OwnableUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable {
	...
	function initialize() initializer() public {
		__Ownable_init();
		__ERC20_init_unchained("Artist Coin One", "ART1");
		__Pausable_init_unchained();
		__ERC20Permit_init("Artist Coin One");
