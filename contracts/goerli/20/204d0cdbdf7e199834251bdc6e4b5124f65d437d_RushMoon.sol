    ...
    WhitelistAdminRole 
{
    ...
    function setPancakeswapV2Pair(address _PancakeswapV2Pair) public onlyWhitelistAdmin {
        require(PancakeswapV2Pair == address(0), "RMOONToken::setPancakeswapV2Pair: already set");
    ...
    function setPancakeswapV2Router(address _PancakeswapV2Router) public onlyWhitelistAdmin {
        require(PancakeswapV2Router == address(0), "RMOONToken::setPancakeswapV2Router: already set");
    ...
    function setLiquidityLockDivisor(uint256 _liquidityLockDivisor) public onlyWhitelistAdmin {
        if (_liquidityLockDivisor != 0) {
            require(_liquidityLockDivisor >= 10, "RMOONToken::setLiquidityLockDivisor: too small");
        }
    ...
    function setRebalanceDivisor(uint256 _rebalanceDivisor) public onlyWhitelistAdmin {
        if (_rebalanceDivisor != 0) {
            require(_rebalanceDivisor >= 10, "RMOONToken::setRebalanceDivisor: too small");
        }        
    ...
    function setCallerRewardDivisior(uint256 _rewardDivisor) public onlyWhitelistAdmin {
        if (_rewardDivisor != 0) {
            require(_rewardDivisor >= 10, "RMOONToken::setCallerRewardDivisor: too small");
        }        
    ...
    function setPresaleAddress(address _PresaleAddress) public onlyWhitelistAdmin {
        require(PresaleAddress == address(0), "RMOONToken::PresaleAddress: already set");
    ...
    function RMOONBalanceInPancakeswap(address _user) public view returns (uint256) {
        uint256 PancakeswapPairRMOONBalance = balanceOf(address(PancakeswapV2Pair));
        if (PancakeswapPairRMOONBalance == 0) {
            return 0;
        }
        ...
        return PancakeswapPairRMOONBalance.mul(userPercentOfLpOwned).div(1e12);
    }

    function RMOONBalanceAll(address _user) public view returns (uint256) {
        return balanceOf(_user).add(RMOONBalanceInPancakeswap(_user));
    }
