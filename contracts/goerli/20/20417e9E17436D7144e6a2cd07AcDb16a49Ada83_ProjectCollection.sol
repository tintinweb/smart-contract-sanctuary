...
contract ProjectCollection is IProjectCollection, ERC721, Ownable {
    ...
    function mapStorageMethod(string[] memory methodology, string[] memory storageMethod) public onlyOwner {
        uint256 methodologyLen = methodology.length;
        uint256 storageMethodLen = storageMethod.length;
        require(methodologyLen==storageMethodLen, "Error: Length of arrays do not match");
