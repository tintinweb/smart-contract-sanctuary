...
interface IWithArchetypes {
    ...
    function registerArchetype(uint256 archetypeId, uint256 limit) external;
}
...
abstract contract WithArchetypes is WithRoles, IWithArchetypes {
     ...
     */
    function registerArchetype(uint256 id, uint256 limit) public override onlyMinter {
...
// File contracts/Interfaces/IQuartzRootTunnel.sol

// contracts/IQuartzRootTunnel.so

pragma solidity ^0.8.0;

interface IQuartzRootTunnel {
...
// contracts/Quartz.so
pragma solidity ^0.8.0;
contract Quartz is ERC1155, WithRoles, WithArchetypes {
    ...
    /**
     * @dev QuartzRootTunnem contract used for state-syncing archetypes
     */
    address private rootTunnel;
    ...
    constructor(address _minter, address _predicate) ERC1155("ipfs://ipfs/{id}") {
    ...
    */
    ...
    function _registerArchetype(uint256 id, uint256 limit) internal virtual override onlyMinter {
        ...
        if (rootTunnel != address(0)) {
            IQuartzRootTunnel _tunnel = IQuartzRootTunnel(rootTunnel);
            ...
            _tunnel.sendMessageToChild(message);
        }
    }
    ...
    */
    ...
    /**
    * @dev Updates the address of the root tunnel contract
    */
    function setRootTunnel(address tunnel) public onlyQuartzAdmin {
        require(rootTunnel == address(0x0), "Quartz: ROOT_TUNNEL_ALREADY_SET");
        rootTunnel = tunnel;
    }
