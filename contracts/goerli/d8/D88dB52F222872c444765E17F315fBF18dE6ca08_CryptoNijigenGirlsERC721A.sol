...
contract CryptoNijigenGirlsERC721A is ERC721A, Ownable {
    using Strings for *;

    uint256 _baseMintPrice = 0.001 ether;

    string private _uri;

    constructor() ERC721A("Crypto Nijigen Girls", "CNG", 50) {
    ...
    function safeMintCNG(uint256 number) external payable{
        require(msg.value >= _baseMintPrice * number, 'CNGE002');
