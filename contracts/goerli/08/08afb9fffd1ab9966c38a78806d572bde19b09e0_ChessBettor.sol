...
contract ChessBettor is Ownable {
    ...
    function createGame(uint256 _gameId, uint256 _amount) internal {
       ...
       newGame.voteList.push(Vote(2, 0, block.timestamp, true));
    ...
    function getPlayerStats(address _address) external view returns(UserData memory) {
        return allPlayerData[_address];
    }
