...
mstore(544, '8&#44<svg xmlns="http://www.w3.o') 
mstore8(544, add(x, 0x30))
mstore(576, 'rg/2000/svg" xmlns:xlink="http:/') 
mstore(608, '/www.w3.org/1999/xlink" version=') 
mstore(640, '"1.1" id="Layer_1" x="0px" y="0p') 
mstore(672, 'x" viewBox="0 0 100 100" enable-') 
mstore(704, 'background="new 0 0 100 100" xml') 
mstore(736, ':space="preserve" height="100px"') 
mstore(768, ' width="100px"><g> <path d="M28.') 
...
mstore(896, '3.7-18.6-31.3 c-4.9-0.2-9.9 0.3-') 
mstore(928, '14.8 1.4C47.8 17.9 36.2 25.6 28.') 
mstore(960, '1 36.6z"/> <path d="M70.3 9.8C57') 
mstore(992, '.5 3.4 42.8 3.6 30.5 9.5c-3 6-8.') 
mstore(1024, '4 19.6-5.3 24.9c8.6-11.7 20.9-19') 
mstore(1056, '.8 35.2-23.1C63.7 10.5 67 10 70.') 
mstore(1088, '3 9.8z"/> <path d="M16.5 51.3c0.') 
mstore(1120, '6-1.7 1.2-3.4 2-5.1c-3.8-3.4-7.5') 
