...
contract ExchangeNFT is ERC721Holder, Ownable, Pausable {
    ...
    mapping(uint256 => address) private _tokenSellingCurrency;
    ...
    function buyToken(uint256 _tokenId, uint256 _price, address _currency) public whenNotPaused {
        ...
        IERC20 quoteToken = IERC20(buyCurrency);
        quoteToken.safeTransferFrom(msg.sender, _tokenSellers[_tokenId], price);
