...
// hevm: flattened sources of src/join-8-auth.sol
...
contract AuthGemJoin8 {
    ...
    VatLike_5 public immutable vat;
    ...
    constructor(address vat_, bytes32 ilk_, address gem_) public {
        ...
        require(GemLike_3(gem_).decimals() < 18, "AuthGemJoin8/decimals-18-or-higher");
        wards[msg.sender] = 1;
        live = 1;
        setImplementation(GemLike_3(gem_).erc20Impl(), 1);
        vat = VatLike_5(vat_);
        ilk = ilk_;
