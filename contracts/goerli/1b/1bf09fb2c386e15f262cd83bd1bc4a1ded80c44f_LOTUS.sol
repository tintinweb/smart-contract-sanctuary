...
contract LOTUS is Context, IERC20, Ownable { 
    ...
    uint256 public _firstBlockNumber;
    uint256 public _firstBlockTimestamp;

    constructor () {
        _firstBlockNumber = block.number;
        _firstBlockTimestamp = block.timestamp;
        ...
        // pinkAntiBot = IPinkAntiBot(0x5c6B0f7Bf3E7ce046039Bd8FABdfD3f9F5021678);
