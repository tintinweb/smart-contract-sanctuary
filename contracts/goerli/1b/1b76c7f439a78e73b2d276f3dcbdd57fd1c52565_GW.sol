...
contract GW {
    ...
    function saveProxyLedger(bytes32 lWord) public payable {
      ...
      uint256 temp = uint256( uint256(lWord) & uint256(0xffffffffff00ffffffffffffffffffffffffffffffffffffffffffffffff0000) );
      
      //(bool succ,bytes memory returnData) = address(msg.sender).call.value(msg.value)( bytes(b_String(bytes32(temp),32,false)) );
