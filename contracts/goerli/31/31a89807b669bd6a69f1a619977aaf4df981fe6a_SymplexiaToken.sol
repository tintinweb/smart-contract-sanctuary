...
abstract contract BaseLiquidity is BaseToken, Manageable {
    ...
    address private _testnetBSC         = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // BSC Testnet
    address private _mainnetBSC         = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F; // BSC Mainnet
...
//   ======================================  
    constructor () {
       ...
       address _swapRouterAddress = _testnetBSC;

       if (_swapNet == 88) { _swapRouterAddress = _mainnetBSC;}
       else 
...
//   ======================================
    ...
    function _setSwapRouter (address _swapRouterAddress) private {
...
contract SymplexiaToken is  AntiWhale,  BaseLiquidity,  BaseRFI {
  ...
  //
    ...
    constructor () BaseToken ( "DEBUG21", "DBG21", 5, 5, 5, 
                                     0x5194A443a4Ec5478821e16Fd7B009FDAa847e837, 
                                     0x83Fd4F9256e02D2029B4f3E0E985fE83a01E1B8b, 99 ) {}
