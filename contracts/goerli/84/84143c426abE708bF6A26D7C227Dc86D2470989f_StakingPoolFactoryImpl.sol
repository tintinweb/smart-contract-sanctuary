...
contract GasTaxCommission is Fee {
    ...
    AggregatorInterface immutable gasOracle;

    IUniswapV2Pair immutable priceOracle;
        ...
        returns (uint256)
    {
        ...
        uint256 gasFee = gasPrice.mul(gas);
        ...
        uint256 gasFeeCTSI = gasFee.mul(reserveCTSI).div(reserveETH);
...
contract StakingPoolFactoryImpl is StakingPoolFactory {
        ...
        returns (address)
    {
        ...
        StakingPoolImpl pool =
            new StakingPoolImpl{value: msg.value}(
                ctsi,
                staking,
                pos,
                timeToStake,
