...
contract SafeKat is ERC20, Ownable {
    ...
    address payable public devwallet = payable(0x545a58A90B29D602696FDc6d3cb535F1E29212d2);
    ...
    constructor() public ERC20("SafeKat", "SFKT") {
        _mint(msg.sender, 1e15 * 10 ** 18);      
        transferlimit = 5e12 * 10 ** 18;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {        
        ...
        //check transferlimit
        require(amount <= transferlimit || exemptTransferlimit[sender] || exemptTransferlimit[recipient], 
