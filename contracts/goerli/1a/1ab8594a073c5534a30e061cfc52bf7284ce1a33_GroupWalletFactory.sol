...
contract GroupWalletFactory {
    ...
    function createProxyToken(bytes32 _domainHash, address masterCopy, bytes memory data) public payable validDomain(_domainHash) byInitiator(_domainHash) returns (ProxyToken proxy)
    {
