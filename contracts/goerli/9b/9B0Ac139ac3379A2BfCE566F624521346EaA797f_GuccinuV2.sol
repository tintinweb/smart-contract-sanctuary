...
Official Telegram:
https://t.me/Guccinuv2

Website: 
https://www.guccinu.com/
...
contract GuccinuV2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Guccinu V2";
    ...
    address payable private _developmentAddress = payable(0x03412Ceb9C3233962e272632Ab132bAAC22426a3);
    address payable private _marketingAddress = payable(0x66dc1d47ccE298509Aa6000903DEEE7C48109bc3);
    ...
    uint256 public _swapTokensAtAmount = 500000000 * 10**9; //0.1
