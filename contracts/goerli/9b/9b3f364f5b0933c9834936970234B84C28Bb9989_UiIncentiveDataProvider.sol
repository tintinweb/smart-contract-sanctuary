...
contract UiIncentiveDataProvider is IUiIncentiveDataProvider {
    ...
    returns (AggregatedReserveIncentiveData[] memory)
  {
    ...
    for (uint256 i = 0; i < reserves.length; i++) {
      ...
      try IStableDebtToken(baseData.aTokenAddress).getIncentivesController() returns (ISturdyIncentivesController aTokenIncentiveController) {
      ...
      try IStableDebtToken(baseData.stableDebtTokenAddress).getIncentivesController() returns (ISturdyIncentivesController sTokenIncentiveController) {
      ...
      try IStableDebtToken(baseData.variableDebtTokenAddress).getIncentivesController() returns (ISturdyIncentivesController vTokenIncentiveController) {
    ...
    returns (UserReserveIncentiveData[] memory)
  {
    ...
    for (uint256 i = 0; i < reserves.length; i++) {
      ...
      try IAToken(baseData.aTokenAddress).getIncentivesController() returns (ISturdyIncentivesController aTokenIncentiveController) {
        if (address(aTokenIncentiveController) != address(0)) {
          address aRewardToken = aTokenIncentiveController.REWARD_TOKEN();
      ...
      try IVariableDebtToken(baseData.variableDebtTokenAddress).getIncentivesController() returns(ISturdyIncentivesController vTokenIncentiveController) {
        if (address(vTokenIncentiveController) != address(0)) {
          address vRewardToken = vTokenIncentiveController.REWARD_TOKEN();
