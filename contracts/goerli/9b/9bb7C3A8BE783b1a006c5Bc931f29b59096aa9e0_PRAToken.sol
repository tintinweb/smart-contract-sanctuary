...
contract PRAToken  is ERC20 {
    ...
    constructor(
        ...
        require(game != address(0), "PRAToken: ZERO ADDRESS");
        require(stake != address(0), "PRAToken: ZERO ADDRESS");
        require(community != address(0), "PRAToken: ZERO ADDRESS");
        require(team != address(0), "PRAToken: ZERO ADDRESS");
        _owner = msg.sender;
    ...
    function addLocker(uint8 pool_index, address pool_address) external {
        ...
        require(pool_address != address(0), "PRAToken: ZERO ADDRESS");
...
// OWNER : 0xDf49B5a5b19074958Db4DCb578723Ba76C93B694 
// GAME : 0x441F295C9Bb08Fce3cFdc6eF8d27E96284388EA2
//STAKE :0x257Eb21cD56811aFfDA86fF1676a95749C7A9557
//community: 0x617083564F12Dc90dD834c5dE4275D79c421760A
// TEAM : 0x215C995bE5797F2F3066C4939bd97992F5C826f9


// depoyed vbit address : 0x0B7127c4Ad30F33830F9DcEB9F917e12f9a45AcE

//depoyed vbit address   1 nov : 0xD63E6F3FE2f74814cE2DE6aecbAe5d6Da3bBb0A2
