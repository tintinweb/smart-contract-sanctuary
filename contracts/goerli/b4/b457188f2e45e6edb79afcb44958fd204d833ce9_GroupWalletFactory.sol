...
contract GroupWalletFactory {
    ...
    */
    ...
    function invite(bytes memory _base32Hex,address[] memory _owners,bytes memory data128,bytes32 _domainHash) public payable byInitiator(_domainHash)
    {
    ...
    function install(address[] memory _owners, bytes32[] memory _labels, bytes32[] memory _domainLabels, bytes32 _domainHash) public payable byInitiatorOrMember(_domainHash)
    {
    ...
    function saveColors(bytes32 _domainHash,string memory data) public payable byInitiatorOrMember(_domainHash)
    {
    ...
    function saveScript(bytes32 _domainHash, string memory key, string memory data) public payable byInitiatorOrMember(_domainHash)
    {
    ...
    function storeMembers(address[] memory _owners,bytes32 _domainHash) public payable byInitiator(_domainHash)
    {
      require(_owners.length>=2, "Nb owners >= 2!");
      require(_domainHash != 0x0," - Domain hash missing!");
