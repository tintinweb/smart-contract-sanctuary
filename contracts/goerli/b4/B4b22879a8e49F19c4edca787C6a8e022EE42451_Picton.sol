 ...
 contract Picton is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable,
    IMintableERC721 {
     ...
     constructor() ERC721("Picton", "PCT") {
          ...
          _setupRole(PAUSER_ROLE, 0xAbA7784f71B609CB553cb3432D72965F354C116c);
          _setupRole(MINTER_ADMIN_ROLE, 0xAbA7784f71B609CB553cb3432D72965F354C116c);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _setupRole(PREDICATE_ROLE, 0x56E14C4C1748a818a5564D33cF774c59EB3eDF59);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xAbA7784f71B609CB553cb3432D72965F354C116c);
    ...
    function mint(address user, uint256 tokenId) external override {
        require(hasRole(PREDICATE_ROLE, _msgSender()));
        _mint(user, tokenId);
    }
