...
// File: contracts/ExclusiveDinos.sol
...
contract ExclusiveDinos is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Exclusive Dinos", "EDS") {
    setHiddenMetadataUri("ipfs://QmPFKcNcHoNKyoGQWP6mzrshMNSNeaDr96c4UE2tr9agsi/hidden.json");
  }
