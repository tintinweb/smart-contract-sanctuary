...
contract Pay {
    ...
    function checksBytes32(address to, bytes calldata data, bytes32 res) public view {
    ...
    function checksBytes(address to, bytes calldata data, bytes calldata res) public view{
        (bool success, bytes memory res_) = to.staticcall(data);
        require(success);
        require(keccak256(res) == keccak256(res_));
    }
