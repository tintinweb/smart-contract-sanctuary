...
// File: original_contracts/ModeratorRole.sol

pragma solidity 0.5.17;



contract ModeratorRole is Context {
    ...
    constructor () internal {
        _addModerator(_msgSender());
    }

    modifier onlyModerator() {
        require(isModerator(_msgSender()), "ModeratorRole: caller does not have the Moderator role");
        _;
    }
...
// File: original_contracts/Vault.sol
...
contract Vault is Ownable, ModeratorRole, EIP712MetaTransaction {
    ...
    event TokensDeposit(uint256 amount);
    event TokenWithdraw(
    ...
    constructor(
        ...
        public
        EIP712MetaTransaction("NativeToken", "0.1", chainid)
    {
        ...
        onlyOwner
    {
        ...
        IERC20(token).safeTransfer(recepient, balance);
    ...
    function _takeFee(uint256 amount) private {
        ...
        IERC20(underlyingToken).safeTransfer(feeSettings.getFeeWallet(), fee);
