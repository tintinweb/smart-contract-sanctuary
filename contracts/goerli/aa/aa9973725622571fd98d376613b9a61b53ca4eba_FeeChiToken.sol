...
// File: contracts/FeeChiToken.sol
...
contract FeeChiToken is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    address private feeAddress; //Make private on deploy, only public for testing reasons.
    uint8 private fee;
