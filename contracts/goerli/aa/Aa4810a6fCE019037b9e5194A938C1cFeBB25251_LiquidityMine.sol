...
contract LiquidityMine is Initializable, LiquidityMinePrivileged {
  ...
  function bond(uint256 amount) external checkStart {
    ...
    checkStart
  {
    ...
    require(accountTotalBondedValue >= realMaltValue, "Insufficient balance to unbond");
    ...
    _removeFromStakePadding(msg.sender, lessStakePadding, lessMaltStakePadding, "Insufficient stake padding");
    ...
    checkStart
  {
    ...
    require(rewardAmount <= rewardEarned, "Cannot withdraw more than earned");
    require(maltAmount <= maltEarned, "Cannot withdraw more malt than earned");
...
contract LiquidityMineSetters is LiquidityMineGetters {
  ...
  function _bond(address account, uint256 amount) internal notSameBlock {
...
contract LiquidityMineGetters is LiquidityMineState {
  ...
  function totalMaltRewarded() public view returns (uint256) {
    return _globals.declaredMaltBalance;
  }
...
contract LiquidityMineState is Permissions {
  ...
  function _checkStart() internal view {
    require(
  ...
  // Calling internal function reduces bytecode size
  modifier checkStart() {
    _checkStart();
    _;
  }
