...
contract PiggiePalzHalloween is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Piggie Palz Zombie Edition", "PIGZ") {
        setBaseURI(baseURI);
    }
    ...
    function mintMyZombiePig(uint256 pigId) public whenMintActive {
        ...
        require(piggieHolders[pigId] == msg.sender, "Not Piggie owner");
        minted[pigId] = 1;
        _safeMint(_msgSender(), pigId);
        emit PigId(pigId);
    }
    
    function whitelistAddress(address[] memory users, uint256[] memory pigIds) public onlyOwner {
    ...
    function transferPigToAddress(address user, uint256 pigId) public onlyOwner {
