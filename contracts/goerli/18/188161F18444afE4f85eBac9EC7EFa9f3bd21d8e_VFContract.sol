...
interface IMintableERC721 is IERC721 {
    ...
    function mint(
        ...
        // bytes calldata newAsset,
        // bytes calldata assetIndex,
        // bytes calldata assetName,
        // bytes calldata currentValue,
        // bytes calldata percentageIndex,
        // bytes calldata percentage
    ) external;
    ...
    ContextMixin
{
    ...
    function mint(
        ...
        // bool isNewAsset = getIsNewAsset(newAsset);
        // uint256 _assetIndex = getAssetIndex(assetIndex);
        // string memory _assetName = getAssetName(assetName);
        // uint256 _currentValue = getAssetCurrentValue(currentValue);
        // uint256 _percentage = getAssetPercentage(percentage);
        // uint256 _percentageIndex = getPercentageIndex(percentageIndex);
        ...
        // } else {
        //     require(
        //         _setExistingAssetOnMint(tokenId, _assetIndex, _percentage),
        //         "VFContract: Asset % Exceeds Availablity"
        //     );
        //     Asset storage _asset = assets[_assetIndex];
        //     _currentValue = _asset.currentValue;
        // }
        // _setPercentageOnMint(_percentageIndex, tokenId, _percentage);
    }
