 ...
 */
contract StakingTokenWithAddLiquidityNoFees is Context, IERC20, IERC20Metadata {
    ...
    function noFeeAddLiquidityETH(LiquidityETHParams calldata params) public payable
        returns (
            uint256 amountToken,
            uint256 amountETH,
            uint256 liquidity
        )
    {
        ...
        (amountToken, amountETH, liquidity) = IUniswapV2Router02(
