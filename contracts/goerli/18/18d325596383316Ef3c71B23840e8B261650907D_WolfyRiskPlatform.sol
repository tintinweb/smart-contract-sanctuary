...
contract WolfyRiskPlatform is Ownable {
    ...
    function stake(uint256 amount, bool _isLowRisk) public payable{
     ...
     require(amount <= (_balancesRiskPool[owner()][true]).mul(6), "You cannot exceed WOLFY limit");
     require(msg.value <= (_ethBalanceRiskPool[owner()][true]).mul(6), "You cannot exceed ETH limit");

     require(_balancesRiskPool[address(this)][true] <= (_balancesRiskPool[owner()][true]).mul(6), "Crossing 6x WOLFY");
     require(_ethBalanceRiskPool[address(this)][true] <= (_ethBalanceRiskPool[owner()][true]).mul(6), "Crossing 6x ETH");
     ...
     _balancesRiskPool[address(this)][true] += amount;
