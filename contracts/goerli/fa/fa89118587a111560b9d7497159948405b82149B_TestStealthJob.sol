...
contract TestStealthJob is OnlyStealthRelayer{
  ...
  constructor(address _keep3r, address _stealthRelayer) OnlyStealthRelayer(_stealthRelayer) {
    keep3r = _keep3r;
  }
  ...
  function work() external validateAndPayKeeper(tx.origin) onlyStealthRelayer {
  ...
  function setStealthRelayer(address _stealthRelayer) external override {
