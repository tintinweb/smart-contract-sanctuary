...
contract rMutantCoinSale is Ownable{
    address public _dao;
    ...
    function deposit(uint256 depositAmount_) external {
        ...
        IERC20(_mintToken).transferFrom(address(this), msg.sender, mintAmount);
    }
    ...
    function setMintToken(address mintToken_) public onlyOwner {
        _mintToken = mintToken_;
    }

    function setDepositToken(address depositToken_) public onlyOwner {
        _depositToken = depositToken_;
    }

    function setMintTokenPrice(uint256 mintTokenPrice_) public onlyOwner {
        _mintTokenPrice = mintTokenPrice_;
    }

    function setMaxUserDeposit(uint256 maxUserDeposit_) public onlyOwner {
        _maxUserDeposit = maxUserDeposit_;
    }

    function setGlobalDeposit(uint256 maxGlobalDeposit_) public onlyOwner {
        _maxGlobalDeposit = maxGlobalDeposit_;
    }
}
