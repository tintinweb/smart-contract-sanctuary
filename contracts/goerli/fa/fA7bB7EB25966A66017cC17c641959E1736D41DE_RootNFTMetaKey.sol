    ...
    IMintableERC1155
{
    ...
    */
    ...
    function restTotalSupply(uint256 _id, uint256 _amount) public view returns (uint256) {
      ...
      if (_id == uint(1)) {
        require(( subtotal <= uint256(500_000_000_000_000_000_000) ), "RootNFTMetaKey: EXCEED MAX_AMOUNT");
      } else if (_id == uint(2)) {
        require(( subtotal <= uint256(750_000_000_000_000_000_000) ), "RootNFTMetaKey: EXCEED MAX_AMOUNT");
      } else if (_id == uint(3)) {
        require(( subtotal <= uint256(1000_000_000_000_000_000_000) ), "RootNFTMetaKey: EXCEED MAX_AMOUNT");
      } else if (_id == uint(4)) {
        require(( subtotal <= uint256(7500_000_000_000_000_000_000) ), "RootNFTMetaKey: EXCEED MAX_AMOUNT");
      } else if (_id == uint(5)) {
        require(( subtotal <= uint256(255_000_000_000_000_000_000) ), "RootNFTMetaKey: EXCEED MAX_AMOUNT");
      }
