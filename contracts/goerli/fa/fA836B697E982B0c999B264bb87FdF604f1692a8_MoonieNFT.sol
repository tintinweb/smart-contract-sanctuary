...
// File contracts/common/matic-sync/RLPReader.sol
...
// File contracts/common/matic-sync/MerklePatriciaProof.sol
...
// File contracts/common/matic-sync/Merkle.sol
    ...
    FxBaseRootTunnel
{
    ...
    function transferToPolygon(uint256 tokenId) external {
        ...
        _sendMessageToChild(abi.encode(_msgSender(), tokenId, tokenURI(tokenId)));
        _burn(tokenId);
