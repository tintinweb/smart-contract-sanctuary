...
contract TastyToastys is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public allowlistMintStartBlock =
    0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
  uint64 publicPrice = 20000000000000000;
  uint64 whitelistPrice = 0;
  bytes32 public allowlistMerkleRoot;
  bytes32 public allowOGlistMerkleRoot;
  uint256 maxWhiteListMint = 2;
  uint256 maxOGWhiteListMint = 5;
  //0x87807670deb43cc85614d3e79ad6e356dc3177f830d4d64d6f8943112089992c
  ...
  function whitelistMint(bytes32 [] calldata _merkleProof, uint256 quantity) public {
    //Basic data validation to ensure the wallet hasn't already claimed
    require(allowlistMintStarted(), 'Whitelist not started');
    require(!whitelistClaimed[msg.sender], "Address has already claimed.");
    require(quantity <= maxWhiteListMint, "Cannot claim this many");
  ...
  function OGwhitelistMint(bytes32 [] calldata _merkleProof, uint256 quantity) public {
    //Basic data validation to ensure the wallet hasn't already claimed
    require(allowlistMintStarted(), 'Whitelist not started');
    require(!whitelistClaimed[msg.sender], "Address has already claimed.");
    require(quantity <= maxOGWhiteListMint, "Cannot claim this many");
  ...
  function setOGMerkleRoot(bytes32 newOGMerkleRoot) public onlyOwner {
  ...
  function setMaxWhiteListMint(uint256 _newMaxWhiteListMint)
    external
    onlyOwner
  {
  ...
  function setMaxOGWhiteListMint(uint256 _newMaxOGWhiteListMint)
    external
    onlyOwner
  {
    maxOGWhiteListMint = _newMaxOGWhiteListMint;
  }
