...
//==========================================//
    ...
    function initialize(
        ...
        paprMultiplierStepExpansion = 10e17; // 10 cents
        paprPriceOne = 10e18;
        paprPriceOverExpansionCeiling = 15e18;
        ...
        if (epoch < BootstrapEpochs) {
            ...
            if (paprPrice > paprPriceCeiling) {
                ...
                if (seigniorageSaved >= inkSupply.mul(inkDepletionFloorPercent).div(10000)) {
                    ...
                    uint256 _computingMint = _seigniorage + _seigniorage.mul(printingRatioMultiplier.div(100).mul(_countTimesOverCents()));
                    ...
                    uint256 _seignorageAdding10CentsFloor = _seigniorage + _seigniorage.mul(printingRatioMultiplier.div(100).mul(_countTimesOverCents()));
