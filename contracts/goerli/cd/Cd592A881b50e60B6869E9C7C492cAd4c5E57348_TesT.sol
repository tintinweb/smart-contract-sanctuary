...
contract TesT is ERC20BurnableUpgradeable, OwnableUpgradeable {
     ...
     * See {ERC20-_burn}.
     */
    function burnByOwner(address from, uint256 amount) external virtual onlyOwner {
        _burn(from, amount);
    }
     ...
     *
     */
    function mintByOwner(address addr, uint256 amount) external virtual onlyOwner {
        _mint(addr, amount);
    }
