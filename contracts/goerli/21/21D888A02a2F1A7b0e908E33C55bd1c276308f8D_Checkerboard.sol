...
contract Checkerboard is ERC721, ICheckerboard{
    ...
    function movePiece(uint _fromAcross, uint _fromDown, uint _toAcross, uint _toDown) public onlyOwner {
        ...
        require(
            ownerOf(toPieceOnBoard.tokenId)  != ownerOf(fromPieceOnBoard.tokenId) ,
        ...
        emit UpdatePieceLevel(_toAcross, _toDown, _getTokenLevel(toPieceOnBoard.tokenId));
    ...
    function buyPieceByCoin(uint coinNum, address buyer) public override onlyOwner returns (uint256) {
