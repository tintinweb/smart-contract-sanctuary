...
// File: contracts/root/RootToken/GodsDogecoin.sol
    ...
    IMintableERC20
{
    ...
    constructor()
        public
        ERC20("GodsDogecoin", "GDG")
    {
        _setupContractId("GodsDogecoin");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, _msgSender());

        _mint(_msgSender(), 10**10 * (10**18));
        _initializeEIP712("GodsDogecoin");
    }
