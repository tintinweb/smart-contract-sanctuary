...
// strg: 0x677c71e313cfd741f0b389296e1e7086a0bb9061
// eth: 0xa67750dd7b76fecc1825a77a88ff30850f08a55b
contract STRGSale {
    ...
    function deposite() public onlyEOA {
        ...
        IERC20(baseToken).transferFrom(msg.sender, address(this), PRICE *  10 ** (ERC20(baseToken).decimals() - 1));
