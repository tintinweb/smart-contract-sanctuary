...
contract SuperTokenStandardST20 is ST20, ServicePayer {
    constructor (
        string memory name,
        ...
        ST20(name, symbol)
        ServicePayer(feeReceiver, "SuperTokenStandardST20")
        payable
    {
        require(initialBalance > 0, "SuperTokenStandardToken: supply cannot be zero");
