...
contract Business{
    ...
    function upsale(uint256 _tokenId,uint256 _price,address _reciveToken) public  payable{
        ...
        address snftaddress = nameAddr("SNFT");
        snftaddress.call(abi.encodeWithSelector(0x23b872dd, msg.sender,address(this),_tokenId));
    ...
    function  downsale(uint256 _tokenId) public  payable{
        ...
        address snftaddress = nameAddr("SNFT");
        TransferHelper.safeTransferFrom(snftaddress,address(this),orderdata.saler,_tokenId);
