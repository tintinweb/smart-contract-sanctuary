...
contract CryptoNijigen is IChildToken, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("Crypto Nijigen");
        __UUPSUpgradeable_init();
        adminMap[address(0x37c3bfC05d5ebF9EBb3FF80ce0bd0133Bf221BC8)] = true; // polygon mumbai
    }
