 ...
 */
contract VolmexRewardToken is VestingToken, OwnableUpgradeable {
    ...
    function cloneTreasuryVesterContract(
        ...
        require(
            ...
            "VolmexRewardToken: length of arrays are not equal"
        );
        uint256 _indexCount = indexCount;
        address[] memory treasuryContracts;
        ...
        onlyOwner
    {
        require(
            ...
            "VolmexRewardToken: Cannot be 0 address"
        );
        require(
        ...
        transferFrom(newRecipient, address(this), balance);
        _approve(newRecipient, address(this), balance);
...
contract VestingToken is GovernanceERC20VestingToken {
    ...
    function burn(address account, uint256 amount) external {
        require(whiteList[msg.sender], "VestingToken: Not authorized");
