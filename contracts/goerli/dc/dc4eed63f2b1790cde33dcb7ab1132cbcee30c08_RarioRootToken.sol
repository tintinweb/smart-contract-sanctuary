...
import "./utils/RarioBaseToken.sol";

contract RarioRootToken is RarioBaseToken, IMintableERC721 {
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");


    function initialize(address trustedForwarder, address predicateProxy ) external initializer {
        __RarioBaseToken_init(trustedForwarder);
    ...
    NativeMetaTransaction
{
    ...
    function __RarioBaseToken_init(address trustedForwarder) internal {
