...
contract Keep3rV1ForTest is ReentrancyGuard {
  using SafeMath for uint256;
  ...
  /* TEST: changed days for minutes */
  /// @notice 1 day to bond to become a keeper
  uint256 public constant BOND = 1 minutes;
  /// @notice 14 days to unbond to remove funds from being a keeper
  uint256 public constant UNBOND = 14 minutes;
  /// @notice 3 days till liquidity can be bound
  uint256 public constant LIQUIDITYBOND = 3 minutes;
