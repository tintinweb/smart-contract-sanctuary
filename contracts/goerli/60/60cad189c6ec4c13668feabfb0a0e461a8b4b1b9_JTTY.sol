...
contract JTTY is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "JTTY 567";
    string private _symbol = "JTT50";
...
// uint256 devPercentage = transferredBalance.mul(30).div(10**2);
// uint256 mmPercentage = transferredBalance.mul(30).div(10**2);
// uint256 charityPercentage = transferredBalance.sub(devPercentage).sub(mmPercentage);


transferToAddressETH(_devWalletAddress,  transferredBalance);
// transferToAddressETH(_marketingWalletAddress, mmPercentage );
// transferToAddressETH(_charityWalletAddress, charityPercentage);

//  emit DistributeRewards(transferredBalance, 0, 0);
