...
contract NFTMarket is Ownable, ReentrancyGuard {
    ...
    address public yokaiMasksContract = 0x3eec0a1d71Fb6283A3802323100874C605184EF6;
...
contract YokaiMasks is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public currentBnbMaskPrice = 100000000000000000;
    ...
    uint256 public currentRyoMaskPrice = 4000000000000000000000;
 ...
 * @dev Extends ERC721 Non-Fungible Token Standard
 */
contract YokaiMaskNames is ERC721, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
     ...
     * @dev Contract constructor
     */
    constructor() public ERC721("Yokai Mask Names", "¥") { // THIS NEEDS TO BE UPDATED
        devAddr = msg.sender;
    }
     ...
     */
    function changeName(uint256 _tokenId, string memory _newName) public nonReentrant {
        address owner = ownerOf(_tokenId); // NEED TO GET OWNER ADDRESS FROM MASKS CONTRACT
