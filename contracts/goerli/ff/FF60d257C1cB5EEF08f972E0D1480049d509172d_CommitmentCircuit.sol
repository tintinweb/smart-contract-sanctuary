...
contract CommitmentCircuit is SchnorrSignature, Ownable {
	...
	function transferCommitment(address _newAddress) public onlyOwner() {
	...
	function deposit(
		...
		require(x == recipientCommitment.x && y == recipientCommitment.y, "this amount cannot be deposited");
