...
contract KaiInu is Context, IERC20, Ownable {
    ...
    string private _name = "CashDogTest2";
    string private _symbol = "CASHDOGT2";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 10; //(2% liquidityAddition + 2% rewardsDistribution + 5% devExpenses)
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 forLiquidity = contractTokenBalance.div(5);
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
         require(taxFee <= 100, "Maximum fee limit is 100 percent");
        _taxFee = taxFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee <= 100, "Maximum fee limit is 100 percent");
