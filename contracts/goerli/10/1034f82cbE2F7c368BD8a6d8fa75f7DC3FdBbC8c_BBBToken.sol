...
contract BBBToken is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    constructor() ERC20("BBBToken", "BBB") {
        ...
        _grantRole(MINTER, 0x37c3bfC05d5ebF9EBb3FF80ce0bd0133Bf221BC8);
    ...
    function mint(address _to, uint256 _amount) public onlyRole(MINTER) {
