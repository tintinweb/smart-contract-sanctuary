...
abstract contract StandardToken is Context, IERC20, IERC20Metadata {
    ...
    function transfer(address _to, uint _value) override public returns (bool) {
		...
		uint tokensToBurn = findOnePercent(_value);
        uint tokensToTransfer = _value.sub(tokensToBurn);
...
contract Configurable {
    uint public constant cap = 500000000*10**18;
    uint public constant basePrice = 4000000*10**18; // tokens per 1 ether
    uint public tokensSold = 0;
    
    uint public constant tokenReserve = 500000000*10**18;
 ...
 **/
contract LBTestToken is CrowdsaleToken {
    string override public constant name = "LB Test Token";
    string override public constant symbol = "LBT";
