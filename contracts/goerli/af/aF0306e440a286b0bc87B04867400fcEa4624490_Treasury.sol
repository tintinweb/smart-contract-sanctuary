...
/**
 * This contract is a fork of Basis Treasury contract, adapted to send a certain percentage
...
//==========================================//
    ...
    function initialize(
        ...
        //paprPriceOverExpansionCeiling = paprPriceOne.mul(115).div(100);
        paprPriceOne = 10**18;
        paprPriceCeiling = paprPriceOne.mul(101).div(100);

        maxSupplyExpansionPercent = 450;
        ...
        //To define the bootstrap epochs :
        BootstrapEpochs = 2;
        ...
        if (epoch < BootstrapEpochs) {
            ...
            if (paprPrice > paprPriceCeiling) {
                ...
                if (seigniorageSaved >= inkSupply.mul(inkDepletionFloorPercent).div(10000)) {
                    ...
                    _savedForBoardRoom = paprSupply.mul(_percentage).div(1e18);
