...
contract Presale is ERC1155, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply, RoyaltiesV2Impl, ERC2981Base {
    ...
    //Meta data url parts
    string private baseUri = "https://codadev.s3.us-east-2.amazonaws.com/surfdev/presale/";
    ...
    uint256 public supplyAmount = 3;
    uint256 public maxBuy = 3;
    ...
    */
    ...
    /// @param _amount the price for the nft, need to set thsi in wei
    ...
    function buyNft(uint _amount) public payable {
        require(_amount > 0 && _amount <= maxBuy);
        require(balanceOf(address(this), 0) > 0);
    ...
    function uri(uint256 _id) public view virtual override returns (string memory) {
        string memory _str = Strings.toString(_id);
