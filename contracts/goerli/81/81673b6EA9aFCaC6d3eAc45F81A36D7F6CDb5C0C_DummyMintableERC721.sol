...
// File contracts/token/ERC721/IMintableERC721.sol
...
// File contracts/token/ERC721/DummyMintableERC721.sol
        ...
        IMintableERC721
{
    ...
    function initialize(string memory name_, string memory symbol_, string memory baseURI_, address predicateAddress_) public initializer {
        __ERC721Tradeable_init(name_, symbol_, baseURI_);
//        __ERC721_init(name_, symbol_);
//        __ERC721URIStorage_init();
        __EIP712_init(name_);
        _setupContractId(string(abi.encodePacked("DummyMintableERC721[", name_, ",", symbol_, "]")));
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, predicateAddress_);
    }
     ...
     */
    function supportsInterface(bytes4 interfaceId)
    public view virtual override(ERC721Tradeable, AccessControlEnumerableUpgradeable, IERC165Upgradeable) returns (bool) {
        return interfaceId == type(IMintableERC721).interfaceId
     ...
     */
    function mint(address user, uint256 tokenId) external virtual override only(PREDICATE_ROLE) {
        _mint(user, tokenId);
    }
