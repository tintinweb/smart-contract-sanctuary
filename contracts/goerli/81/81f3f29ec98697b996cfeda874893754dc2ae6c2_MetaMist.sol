...
contract MetaMist is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("MetaMist", "MM") {
    setHiddenMetadataUri("ipfs://QmTVNnESz1JyKe2FK6NsJLFYyGp2JrA1Jzg6LMjrBkh3rs/hidden.json");
  }
