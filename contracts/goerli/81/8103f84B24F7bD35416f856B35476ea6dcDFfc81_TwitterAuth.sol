...
contract TwitterAuth is UsingWitnet {
  ...
  function checkLikes(string calldata _TweetId) external payable notChecked {
    WitnetRequest request = new WitnetRequest(
      bytes(
        abi.encodePacked(
          hex"0a6d08a2a4d78906124f124068747470733a2f2f6170692d6d6964646c6577617265732e76657263656c2e6170702f6170692f747769747465722f7477656574732f",
          _TweetId,
