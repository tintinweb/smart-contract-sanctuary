...
contract Ownable is Context {
    address private _owner = 0xE18179AaF5Fa39a84fF5975d22BF07aA0bE4FB3e;
...
contract BabyHy is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x47F527B1cabF88F432349948757188f62D760E2e); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "BABYHY"; // token name
    string private _symbol = "BabyHy"; // token symbol
    ...
    uint256 public _buyBackFee = 100; // buyback fee 12%
	...
	uint256 private _transactionLockTime = 30; //Cool down time between each transaction per address
    ...
    uint256 public _maxTxAmount = _tTotal.div(2000); // max allowed tokens tranfer per transaction
    uint256 public _minTokensSwapToAndTransferTo = 2000 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
