...
/**
 * SmartContract: goreli.org/G999992
 * Website : goreli.org/G999992
...
contract G999992 is ERC20Interface, Tokenlock, UserLock {
    ...
    constructor() public {
        ...
        name = "G999992.goerli.org ";

        decimals = 2;

        _totalSupply = 30 * 10**uint(decimals);
