...
contract StakingPoolFactoryImpl is StakingPoolFactory {
    ...
    address immutable poolImplementationReference;
    ...
    constructor(
        ...
        poolImplementationReference = address(
            new StakingPoolImpl(
                _ctsiAddress,
                _stakingAddress,
                _pos,
...
contract StakingPoolManagementImpl is StakingPoolManagement, Initializable {
    ...
    constructor(
        ...
        pos = IPoS(_pos);
        // make sure reference code is locked to everyone to manage or use
        stakingLocked = true;
