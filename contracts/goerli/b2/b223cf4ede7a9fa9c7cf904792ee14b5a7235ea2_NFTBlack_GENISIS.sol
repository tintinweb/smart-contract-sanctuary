...
contract TradeableERC721 is ERC721Full, Ownable {
  ...
  constructor(string memory _name, string memory _symbol, uint256 _supply, address _proxyRegistryAddress, string memory _version, uint256 _IXI_LOCKED, address _ERC20_, uint256 _Time) ERC721Full(_name, _symbol, _supply) public {
...
contract NFTBlack_GENISIS is TradeableERC721, ReentrancyGuard {
  ...
  ) TradeableERC721(_name, _symbol, _supply, _proxyRegistryAddress, _version, _ixi_locked, _ERC20, _timeLimit) public {
