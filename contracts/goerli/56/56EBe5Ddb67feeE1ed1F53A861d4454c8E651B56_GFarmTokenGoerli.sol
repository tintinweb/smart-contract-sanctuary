...
// File: contracts\GFarmTokenGoerli.sol
...
abstract contract AccessControlTimeLock is Context {
     ...
     *
     */
    function initiateGrantRequest(bytes32[] calldata roles, address account) external {
...
contract GFarmTokenGoerli is ERC20, AccessControlTimeLock {

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");

    constructor(address _GOV, address _farm, address _trading)
    ERC20("Gains V2", "GFARM2") public{
