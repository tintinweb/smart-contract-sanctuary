...
contract DishNFT is DishNFTVerifier, ERC721Pausable, AccessControl, Ownable {
    ...
    address[2] private supportCurrency = [0xA802cDAED5440b593F14F5F01a151b1EF4982850, 0xA802cDAED5440b593F14F5F01a151b1EF4982850];
    ...
    function buyNFTWithPermission(address _token, address _to, uint256 _tokenId, uint256 _payAmount, bytes memory _signature) public onlyOwner {
        require(_verifyAdminSignature(_tokenId, _payAmount, _signature), "This signature isn't signed by admin");
    ...
    function _verifyAdminSignature(uint256 _tokenId, uint256 _payAmount, bytes memory _signature) private view returns(bool) {
        return verify(signer, _tokenId, _payAmount, _signature);
    }
...
contract DishNFTVerifier {
    function getMessageHash(uint256 _tokenId, uint256 _payAmount) public pure returns(bytes32) {
      return keccak256(abi.encodePacked(_tokenId, _payAmount));
    }
    ...
    function verify(
        ...
        bytes32 messageHash = getMessageHash(_tokenId, _payAmount);
...
contract USDT is ERC20 {
    constructor() public ERC20("Tether", "USDT") {
        _mint(msg.sender, uint256(10000000000000000));
    }
}
