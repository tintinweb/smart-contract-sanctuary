...
contract WolfyRiskPlatform is Ownable {
    ...
    function stakeWolfy(uint256 _amount, bool _isLowRisk) public updateLimitVariables() {
    ...
    function stakeEth(bool _isLowRisk) public payable updateLimitVariables{
       ...
       if(_factor >= 150 && _champ == true){
        ...
        // factor < 5x | High Risk Losing
            ...
            _balancesRiskPool[owner()][false] += _balancesRiskPool[_highRiskWolfyUsers[i]][false].mul(350).div(1000);
             ...
             // Storing everytime staker is winning | Token | ETH
            _profitWOLFYStakers[_highRiskWolfyUsers[i]][false] -= _balancesRiskPool[_highRiskWolfyUsers[i]][false].mul(350).div(1000);
