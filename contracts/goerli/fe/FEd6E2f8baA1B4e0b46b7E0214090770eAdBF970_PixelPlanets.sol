...
contract PixelPlanets is ERC721Enumerable, Ownable{
    ...
    constructor() ERC721("PixelPlanets","PixelPlanets"){
    }
    ...
    function mint5() public payable {
        require(saleIsActive, "Sale is not active at the moment");
        require(totalSupply() + 5 <= MAX_SUPPLY, "Purchase would exceed max supply");
        require(NFT_PRICE * 5 == msg.value, "Must Send 0.1 ETH to Mint 5 NFTs");
