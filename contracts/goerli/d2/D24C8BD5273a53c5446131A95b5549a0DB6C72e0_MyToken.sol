...
contract MyToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable,AccessControlUpgradeable {
    ...
    function consensusMint(address to)public onlyRole(MINTER_ROLE){
        ...
        lastConsensusMintBlock= lastConsensusMintBlock+_consensusMintInterval;
    ...
    function batchTransfer(address from,Consensus[] memory cs) public onlyRole(MINTER_ROLE){
        for(uint i =0;i<cs.length;i++){
