...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    uint public constant MIN_PROPOSAL_THRESHOLD = 0; // 50,000 Comp
    ...
    uint public constant quorumVotes = 500; // 400,000 = 4% of Comp
    ...
    function castVoteInternal(address voter, uint proposalId, uint8 support) internal returns (uint256) {
       ...
       // uint96 votes = comp.getPriorVotes(voter, proposal.startBlock);
        uint256 votes = comp.balanceOf(voter);
...
//        }
    ...
    function _initiate() external {
     ...
     //   proposalCount = GovernorAlpha(governorAlpha).proposalCount();
        initialProposalId = 1;
        proposalCount = 1;
        // waarom werkt dit niet  function call to a non-contract account
