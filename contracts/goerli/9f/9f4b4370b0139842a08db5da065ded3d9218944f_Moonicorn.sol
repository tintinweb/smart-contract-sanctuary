...
contract Moonicorn is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 9_000_000_000_000_000e18;
    ...
    uint256 public _burnFee = 3; // means 3% it burns from each buy and sell
    ...
    uint256 public maxTxAmount = 90000000000000e18; // no limit
    ...
    address private owner1 = 0x48656596EF052DA66c93830E2eD5BB7785f3C752;
    ...
    constructor() public {
        ...
        _reflectionBalance[owner1] = _reflectionTotal;
        emit Transfer(address(0),owner1, _tokenTotal);
    }
    ...
    function _transfer(
        ...
        if(recipient == uniswapV2Pair){
            require(userLastBuy[sender] + sellDelay < now || userLastBuy[sender] == 0 ,"Too soon to sell!");
