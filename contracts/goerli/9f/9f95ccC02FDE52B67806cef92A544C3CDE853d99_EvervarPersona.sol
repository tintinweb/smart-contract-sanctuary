...
contract EvervarPersona is ERC721Enumerable, Ownable {
    ...
    uint public constant RESERVED_MINTS = 200;
    
    bool public SALE_IS_ACTIVE = false;
    bool public PRESALE_IS_ACTIVE = false;
    uint public LIMIT_PER_ACCOUNT = 10; // Per transaction
    ...
    function mintPersona(uint _count) external payable {
        ...
        require(_count <= LIMIT_PER_ACCOUNT, "You can't mint more than 10 personas at once");
    ...
    function reservePersona(address reserveAddress, uint256 _amount) external onlyOwner {
        require(reserveIdCounter.current() + _amount <= RESERVED_MINTS, "There isnt anymore reserved left to mint");
