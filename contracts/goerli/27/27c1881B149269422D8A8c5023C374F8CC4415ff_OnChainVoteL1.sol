...
contract OnChainVoteL1 is Initializable, Ownable, Pausable {
    ...
    function setDestinations(address _fxStateSender, address _destinationOnL2) external onlyOwner {
    ...
    function encodeAndSendData(bytes32 _eventSig, UserVotePayload memory userVotePayload) private onEventSend {
        ...
        bytes memory data = abi.encode(
            VoteEvent({
                eventSig: _eventSig,
                userVotePayload: userVotePayload
            })
        );
