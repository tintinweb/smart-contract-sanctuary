...
contract SubjectRoot is SubjectWithGeneChanger, ISubjectRoot {
    ...
    event WhitelistedSet(address[] _whitelisted);
    ...
    * @notice Sets presaleStartDate.
     ...
     */
    function setPresaleStartDate(uint256 _presaleStartDate) public onlyDAO {
        require(
     ...
     */
    function setPresaleDuration(uint256 _presaleDuration) public onlyDAO {
     ...
     */
    function setWhitelisted(address[] memory beneficiaries) public onlyDAO {
        require(
        ...
        emit WhitelistedSet(beneficiaries);
    }
