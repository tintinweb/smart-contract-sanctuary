...
//Assange is absolutely vital to the survival to this planet.
//We will never give up.
//Please sign the petition, We will use all the taxes and fees for free-campaign. 
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a FA shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract FreeAssange is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Dont extradite Assange";
    string private constant _symbol = "FreeAssange";
    ...
    address payable public marketingWallet = payable(0x35f430EBDaB088eb068b37eED606418F08d8DfD3);
    address payable public treasury = payable(0x38c3e69B9e1dB032098929052485B6b51f9e3B94);
    ...
    constructor (    ) Auth(0x4639499f9EB50F39138d973701c22Ef879b11E6F) {
        address _owner = 0x4639499f9EB50F39138d973701c22Ef879b11E6F;
