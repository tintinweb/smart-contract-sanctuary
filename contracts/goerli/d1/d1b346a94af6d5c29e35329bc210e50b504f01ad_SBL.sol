...
contract SBL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x9740067bf30daa1C8C86406822505C3905a9d71c); // Marketing Address
    address payable public featurePaymentAddress =
        payable(0x9740067bf30daa1C8C86406822505C3905a9d71c); // Address for paying for product features.
    address payable public constant airDropAddress =
        payable(0x9740067bf30daa1C8C86406822505C3905a9d71c); // AirDrop Address
    ...
    string private constant _name = "SHIBALOKI";
    string private constant _symbol = "SBL";
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**18; // 3,000,000,000 MM, aka ~30 BNB at start
