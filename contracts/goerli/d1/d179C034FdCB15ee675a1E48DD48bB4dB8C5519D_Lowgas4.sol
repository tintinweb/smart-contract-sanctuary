...
contract Lowgas4 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("LowGas4", "LG4") {
    setHiddenMetadataUri("ipfs://QmateqMkxr5kpoiMv4B4AWg6BTbaueV9yTtfdyoQoxiyen/LG4hidden.json");
  }
