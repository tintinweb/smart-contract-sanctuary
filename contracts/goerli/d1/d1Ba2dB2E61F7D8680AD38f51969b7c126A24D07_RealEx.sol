...
contract RealEx is ERC20Burnable, ERC20Snapshot, AccessControl {
    ...
    constructor(uint256 _maxSupply, address adminRole, address snapshotRole, address minterRole) ERC20("RealEx", "RX") {
