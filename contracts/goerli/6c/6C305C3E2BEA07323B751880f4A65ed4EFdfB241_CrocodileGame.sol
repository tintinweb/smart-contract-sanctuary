...
contract CrocodileGame is ICrocodileGame, OwnableUpgradeable, IERC721ReceiverUpgradeable,
  ...
  // Both earn 10000 $PIRANHA per day (if coop / coop)
  ...
  /**
   * Adds Crocodile to the Metaverse Prison Swamp.
  ...
  /**
   * realize $PIRANHA earnings for a single crocodile bird and optionally unstake it
   * if claim, pay a 50% tax to the prison (erc20 burned)
   * if unstaking, you earn different amounts of $PIRANHA depending on your and your friend's choice.
  ...
  /**
   * Tracks $PIRANHA earnings to ensure it stops once 0.9 billion is eclipsed
   */
  ...
  /**
   * Update the WARDER contract address.
   */
