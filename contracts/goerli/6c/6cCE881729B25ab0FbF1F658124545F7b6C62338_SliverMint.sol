...
contract SliverMint is ERC20Burnable {
...
*/
        ...
        // RAPID RELEASE TESTING VALUES
        creatorsReleaseInterval = 1 * DAYS;
        creatorsReleaseSegments = 24;

        playToEarnReleaseInterval = 3 * DAYS;
        playToEarnReleaseSegments = 4;

        mintingReleaseInterval = 1 * WEEKS;
        mintingReleaseSegments = 4;

        marketingReleaseInterval = 5 * DAYS;
        marketingReleaseSegments = 10;
        ...
        uint256 supply = 2000000000 * 10**18; //2,000,000,000 $SLVR
        totalCreatorsSupply = supply / 5;
        totalPlayToEarnSupply = supply / 2;
        totalMintingSupply = supply / 10;
