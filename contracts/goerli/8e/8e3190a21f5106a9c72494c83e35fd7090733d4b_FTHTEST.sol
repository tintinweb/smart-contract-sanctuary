...
contract Ownable is Context {
    ...
    constructor()  {
     //   address msgSender = _msgSender();
        _owner = 0x71c87346fd1C86BE81FB461443f102cF67b08bFC;//0xe307F969bE971EC2e94d8AfacD6f942F8f208c68;
...
contract FTHTEST is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "FTHTEST";
