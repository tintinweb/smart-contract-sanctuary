...
# Contract for the Arena ERC20 fungible token.
# 
# Based on https://github.com/vyperlang/vyper/blob/master/examples/tokens/ERC20.vy
...
##################################
@external
def __init__(_name: bytes32, _symbol: bytes32, _initialSupply: uint256, _decimals: int128):
    """
