...
contract FETH_R11 is Ownable, IERC20, Lockable {
    ...
    function lockShares(uint256 shares) external onlyGlobalPool {
    ...
    function unlockShares(uint256 shares) external onlyGlobalPool {
