...
contract RMOONPresale is Ownable , Whitelisted {
    ...
    RMOONToken public token;
    
    
    constructor(address payable _walletMajorOwner) 
    {
        token = RMOONToken(0x204D0CdBDF7e199834251BDc6E4b5124F65D437d); 
        startTime = 1619366035 ;   
    ...
    function buy(address beneficiary, address payable referral) public onlyWhitelisted payable
    {
        ...
        require(weiAmount <30000000000000000001 , 'MAX_BUY_LIMIT is 30 BNB'); 
