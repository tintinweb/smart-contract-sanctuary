...
// flattened :  Tuesday, 08-Jun-21 02:30:25 UTC
...
abstract contract AProxy is IProxy, ABase {
    ...
    function implementationAddress(
        ...
        return vLighthouse().getAddress(implementationAddressKey());
    }
...
contract VErc20Proxy is AProxy {
    ...
    ) AProxy(VERC20_ADDRESS, vLighthouseProxyAddress, userAddress, recoveryAddress) {
