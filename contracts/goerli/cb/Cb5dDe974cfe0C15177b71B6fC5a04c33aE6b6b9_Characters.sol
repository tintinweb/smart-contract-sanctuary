...
contract Characters is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    //Loot Contract
    address public lootAddress = 0x785f3B15B4da9906Eeff75c8ccDa7E888A514690;
    ...
    function mint(uint256 tokenId) public payable nonReentrant {
        require(tokenId > 8000 && tokenId < 15600, "Token ID invalid");
    ...
    function multiMint(uint256[] memory tokenIds) public payable nonReentrant {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            require(tokenIds[i] > 8000 && tokenIds[i] < 15600, "Token ID invalid");
    ...
    function ownerClaim(uint256[] memory tokenIds) public nonReentrant onlyOwner {
        for (uint256 i = 0; i < tokenIds.length; i++) {
            require(tokenIds[i] >= 15600 && tokenIds[i] <= 16000, "Token ID invalid");
