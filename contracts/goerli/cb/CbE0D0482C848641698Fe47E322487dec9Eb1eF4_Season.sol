...
abstract contract SeasonNFT is SeasonBase, ERC721Upgradeable {
    ...
    function _beforeTokenTransfer(
        ...
        // only allow holding one nft at an address, because we don't want
        //  scores of same seasons nfts to be doublt counted
        if (to != address(0)) {
        ...
        if (from == address(0)) {
            ...
            seasonFactory.handleSeasonNftTransfer(from, to, userNfts[tokenId].individualScore);
        }
    }
}
