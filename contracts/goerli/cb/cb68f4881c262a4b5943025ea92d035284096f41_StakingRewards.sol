...
// File contracts/lon_token/implements/RewardsDistributionRecipient.sol
...
// File contracts/lon_token/implements/LPStakingReward.sol
...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, IEmergency {
    ...
    function updateRewardDistribution(address newRewardDistribution) external {
        require(msg.sender == rewardsDistribution, "not owner or reward distribution");
        rewardsDistribution = newRewardDistribution;
    }
