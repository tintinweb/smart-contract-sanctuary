...
contract Kit is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    uint256 private constant TOTAL_SUPPLY = 1000000000000 * 10**9;
    string private m_Name = "Kit";
    string private m_Symbol = "KIT";
    ...
    constructor () {
        FTPAntiBot _antiBot = FTPAntiBot(0x29CB711c24ae2458A6B4fBcd530d9Fca6Ab6474D);           // AntiBot address for KOVAN TEST NET (its ok to leave this in mainnet push as long as you reassign it with external function)
        AntiBot = _antiBot;
