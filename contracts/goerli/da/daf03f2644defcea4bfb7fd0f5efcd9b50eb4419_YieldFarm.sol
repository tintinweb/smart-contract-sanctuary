...
contract YieldFarm {
    ...
    ERC20 constant seeds = ERC20(0xA414AA6A3E57266b5a8dD4a9Ff0A6bcE55F94b45);
    Potato constant potatoes = Potato(0xb1d95b798a77780F9f7614da371F48258241F240);
    ...
    function harvest() public {
        ...
        potatoes.mint(msg.sender, diff * rate * plantings[msg.sender].balance);
        plantings[msg.sender].timestamp = block.timestamp;
    }
