...
// File: contracts\MeliroaCore.sol
...
contract MeliroaCore is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
        ...
        returns (bool)
    {
     ...
     function marketplace(address _from,address _to,uint256 tokenId) public onlyRole(MARKETPLACE_ROLE) { 
        super._transfer(_from,_to,tokenId);
    }
