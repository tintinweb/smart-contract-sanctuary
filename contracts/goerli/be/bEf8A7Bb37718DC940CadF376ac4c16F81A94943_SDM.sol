    ...
    ContextMixin
{
     ...
     */
    function setTokenMetadata(uint256 tokenId, string memory tokenURI) internal virtual {
     ...
     */
    function mint(address user, string memory tokenURI) external override only(PREDICATE_ROLE) {
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        _mint(user, newItemId);
        setTokenMetadata(newItemId, tokenURI);
    }
...
interface IMintableERC721 is IERC721 {
     ...
     * @param user user address for whom token is being minted
     * @param tokenURI tokenURI beign saved
     *
     *
     * Note : If you're interested in taking token metadata from L2 to L1 during exit, you must
     * implement this method
     */
    function mint(address user, string memory tokenURI) external;
