...
//staking rewards factory for Uniswap 
//forked from https://github.com/Synthetixio/synthetix/tree/v2.27.2/
//modified by the penguin party @penguinparty.eth
...
contract StakingRewardsFactory is Ownable {
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~READ ME~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    //function deploy(address stakingToken, uint rewardAmount) public onlyOwner {ORIGINAL|<<<<<<<<<<<<<<<<<<<<<<<<<<<
    function deploy(address stakingToken, uint rewardAmount, uint256 rewardsDuration) public onlyOwner {//MODIFIED|<<
    //This parameter was added so that UNI governence would be able to change the reward duration for future deployments
        StakingRewardsInfo storage info = stakingRewardsInfoByStakingToken[stakingToken];
        require(info.stakingRewards == address(0), 'StakingRewardsFactory::deploy: already deployed');

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~READ ME~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        //info.stakingRewards = address(new StakingRewards(/*_rewardsDistribution=*/ address(this), rewardsToken, stakingToken));ORIGINAL|<<<
        info.stakingRewards = address(new StakingRewards(/*_rewardsDistribution=*/ address(this), rewardsToken, stakingToken, rewardsDuration));//MODIFIED|<<<
        //This parameter was added so that UNI governence would be able to change the reward duration for future deployments
