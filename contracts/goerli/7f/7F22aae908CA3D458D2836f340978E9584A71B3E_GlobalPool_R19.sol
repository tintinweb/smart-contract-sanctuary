...
contract GlobalPool_R19 is Lockable, Pausable {
        ...
        while (_amount < 32 ether) {
            ...
            if (_amount > 32 ether) {
                ...
                if (providerStake > 0) {
                    ...
                    _etherBalances[staker] = _etherBalances[staker].add(_pendingEtherBalances[staker].sub(newPendingEther));
            ...
            _etherBalances[staker] = _etherBalances[staker].add(_pendingEtherBalances[staker].mul(mintAmount).div(32 ether));
