...
// VIEW FUNCTIONS
    ...
    function getQuestion(uint _teamId, uint _round) public view returns (string memory) {
        return teams[_teamId].capchas[_round].question;
    }
...
// INTERFACE FUNCTIONS
    ...
    function coffeeBalanceByAddress(address account) public view returns (uint256){
        return coffeeERC20(coffeeCoinRegistery).balanceOf(account); 
    }

    function coffeeDecimals() public view returns (uint8){
