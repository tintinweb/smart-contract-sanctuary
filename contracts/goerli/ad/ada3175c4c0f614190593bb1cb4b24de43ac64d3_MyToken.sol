...
interface IERC1363 is IERC20, IERC165 {
     ...
     */
     function transferToContractAndCall(address recipient, uint256 amount) external returns (bool);
...
abstract contract ERC1363 is ERC20, IERC1363, ERC165 {
     ...
     */
    function transferToContractAndCall(address recipient, uint256 amount) public virtual override returns (bool) {
        transfer(recipient, amount);
        require(_checkAndCallTransfer(_msgSender(), recipient, amount, ""), "ERC1363: _checkAndCallTransfer reverts");
        return true;
    }
...
contract MyToken is ERC20Decimals, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover, Roles {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        if (Address.isContract(recipient)) {
            transferToContractAndCall(recipient, amount);
            return true;
        }
