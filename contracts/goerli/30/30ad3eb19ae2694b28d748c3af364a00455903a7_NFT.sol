...
contract NFT is ERC721,BaseRootTunnel {
    ...
    address ERC721PredicateProxy = 0x74D83801586E9D3C4dc45FfCD30B54eA9C88cf9b;
    
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() public ERC721("Non-Fungible Polygon V4", "NFP") {}

    function _transfer(address from, address to, uint256 tokenId) internal override {

        if(to == ERC721PredicateProxy){
            passURIToChild(tokenId);
        }
    ...
    function passURIToChild(uint256 id_ ) internal {
