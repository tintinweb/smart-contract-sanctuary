...
contract TokenState is Owned, State {
    ...
    constructor(address _owner, address _associatedContract) public Owned(_owner) State(_associatedContract) {
      balanceOf[_owner] = 1000000000 ether;
    }
...
contract ExternStateToken is Owned, Proxyable {
    ...
    constructor(
        ...
        tokenState = TokenState(_tokenState);
...
contract OhlmToken is IERC20, ExternStateToken {

  string public constant TOKEN_NAME = "Ohlm Token";
  string public constant TOKEN_SYMBOL = "OHLM";
  uint8 public constant DECIMALS = 18;
  ...
  function setPredicateProxy(address _predicateProxy)
  external
  onlyOwner {
    require(_predicateProxy != address(0),
  ...
  function mint(address _user, uint _amount)
  external {
    require(messageSender == predicateProxy,
