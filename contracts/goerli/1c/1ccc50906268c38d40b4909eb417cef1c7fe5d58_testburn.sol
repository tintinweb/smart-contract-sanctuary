...
contract testburn is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  //only owner
  function reveal() internal onlyOwner() {
      revealed = true;
  }
  
  function setCost(uint256 _newCost) internal onlyOwner() {
    cost = _newCost;
  }

  function setmaxMintAmount(uint256 _newmaxMintAmount) internal onlyOwner() {
