...
/**
 * @dev The Internet Camera Film Registry allows creators of Internet Camera Film to pre-pay for usage of the Internet Camera.
 */

contract InternetCameraFilmRegistry is FxBaseRootTunnel {
    address _treasuryAddress;
    AggregatorV3Interface internal _priceFeed;

    /**
     * @dev Initialize Film Registry.
     */
    constructor(
    ...
    /**
     * @dev Register a new Film.
     */
    function registerFilm(address filmAddress) public payable {
        (
            uint80 roundID,
            int256 price,
            uint256 startedAt,
        ...
        require(msg.value >= 5 / uint256(price));
        _sendMessageToChild(toBytes(filmAddress));
    }
