...
contract GoldenCake is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public minTokensBeforeSwap = 1_000e18;
    ...
    event ClaimCakeSuccessfully(address recipient, uint256 cakeReceived, uint256 nextAvailableClaimDate, uint256 timestamp);
