...
contract RRR is Context, IERC20, Ownable, Pausable {
    ...
    function calculateLiquidityFee(uint256 _amount)
        ...
        returns (uint256)
    {
        return _amount.mul(_liquidityFee).div(15000000000 * 10**1 * 10**9);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 charityPercentage = contractTokenBalance.div(50);
        uint256 devPercentage = contractTokenBalance.div(50);
        uint256 mmPercentage = contractTokenBalance.div(100);
