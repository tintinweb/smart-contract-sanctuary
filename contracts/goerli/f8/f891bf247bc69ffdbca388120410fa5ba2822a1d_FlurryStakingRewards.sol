...
contract FlurryStakingRewards is IFlurryStakingRewards, BaseRewards {
    ...
    function _withdrawUser(address user, uint256 amount) internal nonReentrant {
        // check and update
        require(userInfo[user].stake > 0, "No stakes to withdraw");
    ...
    function claimReward() external override claimerNotZeroAddr(_msgSender()) {
        claimRewardInternal(_msgSender());
    }

    function claimAllRewards() external override claimerNotZeroAddr(_msgSender()) {
