...
contract BuyTheFloorExchange is Owned, ECRecovery  {
  ...
  event BuyTheFloor(address indexed bidderAddress, address indexed sellerAddress, address nftContractAddress, uint256 tokenId, address currencyTokenAddress, uint currencyTokenAmount);
