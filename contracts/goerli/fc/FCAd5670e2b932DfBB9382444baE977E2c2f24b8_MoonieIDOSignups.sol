...
contract MoonieIDOSignups {
    ...
    // TODO delete before going prod
    function cancelParticipation(address participant) external {
        require(!isParticipating(participant), "MoonieIDOSignups: The address is not participating");
        _participating[participant] = false;
        _no.decrement();
    }
