...
contract voTest is ERC721, Ownable {
    ...
    constructor() ERC721("voTest", "VOVI") {
        _tokenIds.increment();
    }

    modifier isMintable() {
        require(mintable, "voTest: NFT cannot be minted yet.");
        _;
    }

    modifier isPreSaleMintable() {
        require(preSaleMintable, "voTest: NFT cannot be minted yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "voTest: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedAvailableSupply(uint256 amount) {
        require(
            ...
            "voTest: There are no more remaining NFT's to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficient(uint256 amount) {
        require(
            ...
            "voTest There was not enough/extra ETH transferred to mint an NFT."
        );
        _;
    }
    ...
    modifier isAllowList() {
        require(
            ...
            "voTest: You're not on the list for the presale."
        );
        _;
    }
