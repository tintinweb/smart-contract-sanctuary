...
contract Verifier is IVerifier {
    ...
    function verifyingKey() internal pure returns (VerifyingKey memory vk) {
        ...
        vk.IC[0] = Pairing.G1Point(
            uint256(3857659530219906943152785552899198663852979207590420620802743549295296919679),
            uint256(8367960888682158022427105742558475486088669782591421317171600999122506510796)
        );
        vk.IC[1] = Pairing.G1Point(
            uint256(8361626798107864008264733825256613042734968937398128936109720230259510075488),
            uint256(9271507670617320818166611831037484320104273577166835176215748372308714790630)
        );
        vk.IC[2] = Pairing.G1Point(
            uint256(21480786565845101634948265554385650370680540421570179632822539769216309491270),
            uint256(20517002848256449318692808547386513700186931404514317826671867969707721490772)
        );
