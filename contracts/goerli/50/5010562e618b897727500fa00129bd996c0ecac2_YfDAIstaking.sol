...
contract YfDAIstaking is Ownable {
    ...
    address public constant tokenAddress = 0x0e575098fDD852ed68eD7ed28C04f8324da186d8;
    
    // reward rate 72.00% per year
    uint public constant rewardRate = 7200;
    uint public constant rewardInterval = 365 minutes;
    ...
    uint public constant cliffTime = 72 minutes;
