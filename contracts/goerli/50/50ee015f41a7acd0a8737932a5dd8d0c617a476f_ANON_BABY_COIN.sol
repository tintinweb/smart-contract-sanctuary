...
contract ANON_BABY_COIN is Context, IERC20, Ownable {
    ...
    string private _name = "ANON BABY";
    string private _symbol = "ABBY";
    uint8 private _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000 * 10**(_decimals);  // 10 Trillion
    ...
    uint256 public numTokensSellToAddToLiquidity = 1000000 * 10**(_decimals); // 1 Million
...
//---------------------------------//
    ...
    function recoverLostCoins(address coinAddress, address receiveWallet, uint256 amount) external onlyOwner() {
        ...
        coin.transfer(receiveWallet, amount);
    }
}