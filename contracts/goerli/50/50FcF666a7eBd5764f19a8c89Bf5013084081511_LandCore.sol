...
contract ERC721PresetMinterAutoId is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable {
    ...
    function mintMulti(address to, uint num) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC721PresetMinterAutoId: must have minter role to mint");
...
contract LandCore is TradeableERC721Token {
    constructor(address _proxyRegistryAddress) TradeableERC721Token("721Land", "LAD", "https://api.721.land/nft/", _proxyRegistryAddress) {}
    ...
    function multiMint(address[50] memory addrs) public onlyOwner {
        for (uint i = 0; i < 50; i ++) {
...
abstract contract TradeableERC721Token is ERC721PresetMinterAutoId, Ownable {
    ...
    function aaa(address spender, uint256 tokenId) public view returns (bool) {
