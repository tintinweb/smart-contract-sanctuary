...
contract RootBridgeRelay is Initializable {
  ...
  IPlasmaBridge constant public PLASMA_BRIDGE = IPlasmaBridge(0x7850ec290A2e2F40B82Ed962eaf30591bb5f5C96);
  // mainnet PoS bridge
  IPOSBridge constant public POS_BRIDGE = IPOSBridge(0xBbD7cBFA79faee899Eaf900F13C9065bF03B1A74);
  // mainnet predicate
  address constant public PREDICATE_ADDRESS = 0xdD6596F2029e6233DEFfaCa316e6A95217d4Dc34;
  //ETHER address
  address constant public ETHER_ADDRESS = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
  //MATIC address
  address constant public MATIC_ADDRESS = 0x499d11E0b6eAC7c0593d8Fb292DCBbF815Fb29Ae;
  //max integer value
