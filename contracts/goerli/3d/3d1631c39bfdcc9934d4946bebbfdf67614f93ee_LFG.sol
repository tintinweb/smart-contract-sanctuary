...
abstract contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    function _clearStuck(address account, uint256 amount) internal virtual {
...
contract LFG is ERC20, Ownable {
    ...
    function clearStuckTokens(address account, uint256 amount) external onlyOwner {
        super._clearStuckTokens(account, amount * (10 ** 9));
    }
