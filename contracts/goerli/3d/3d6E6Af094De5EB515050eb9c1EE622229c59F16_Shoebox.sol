...
contract Shoebox is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_BOXES = 18;

    uint public boxReserve = 10;

    bool public saleIsActive = false;

    constructor() ERC721("Shoebox", "SHBX") {}
    ...
    function reserveBox(address _to) public onlyOwner {
        require(boxReserve > 0, "Out of reserves");

        _safeMint(_to, _tokensIds.current());
        _tokensIds.increment();

        boxReserve = boxReserve.sub(1);
    }
    ...
    function mintBox() public payable {
        ...
        require(totalSupply().add(1) <= MAX_BOXES, "All boxes have been minted");
        require(msg.value >= boxPrice.mul(1), "Must send at least unit price of box");
