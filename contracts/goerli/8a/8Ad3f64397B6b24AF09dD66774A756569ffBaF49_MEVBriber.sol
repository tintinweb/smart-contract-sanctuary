...
contract MEVBriber is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function bribe(address token, uint256 minOut) external payable nonReentrant {
        _onlyKeeper();
        ...
        require(amounts[1] >= minOut, "Output is too low");
        ...
        block.coinbase.call{value: msg.value.sub(amountIn)}(new bytes(0));
