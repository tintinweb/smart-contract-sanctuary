...
// File: contracts/modules/Staking.sol
...
// File: contracts/GHarvestToken.sol
...
{
	constructor ()
		ERC20("growth Root Token", "gROOT") public
	{
...
contract hrvgROOT is GHarvestToken
{
	...
	constructor (address _gROOT)
		GHarvestToken("harvest gROOT/BNB", "hrvgROOT", 18, _gROOT, WETH, WETH) public
	{
	}
}