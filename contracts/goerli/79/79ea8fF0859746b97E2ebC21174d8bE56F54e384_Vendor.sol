...
contract Vendor is Ownable {
    ...
    function buyTokens() public payable {
        tokensPurchased = msg.value * tokensPerEth;
    ...
    function sellTokens(uint256 amountToSell) public {
        ethSellAmount = amountToSell / tokensPerEth;
        yourToken.transferFrom(msg.sender, address(this), amountToSell);
        payable(msg.sender).transfer(ethSellAmount);

        emit SellTokens(msg.sender, amountToSell, ethSellAmount);
    }
}
