...
contract Faucet is Ownable {
    ...
    event FaucetTransfer(address to, uint256 value);
    ...
    function transferAll(address _to, uint256 _value) external onlyOwner {
        ...
        IERC20(infiTokenAddr).transfer(_to, (_value * 10**18));
        ERC20(usdtTokenAddr).safeTransfer(_to, (_value * 10**6));
        IERC20(usdcTokenAddr).transfer(_to, (_value * 10**6));
        IERC20(daiTokenAddr).transfer(_to, (_value * 10**18));

        emit FaucetTransfer(_to, _value);
    }
}
