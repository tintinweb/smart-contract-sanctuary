...
contract KILLAz is ERC721, Ownable {
    ...
    constructor(address _reserveAddress) public ERC721("KILLAz", "Kz") {
    ...
    function mintKILLAz(uint256 numberOfTokens) public payable {
        ...
        require(
            ...
            "No more than 20 tokens per transaction"
        );
        require(
            totalSupply().add(numberOfTokens) <= maxKILLAz,
            "Purchase would exceed max supply of KILLAz"
        );
        require(
            pricePerKILLA.mul(numberOfTokens) == msg.value,
