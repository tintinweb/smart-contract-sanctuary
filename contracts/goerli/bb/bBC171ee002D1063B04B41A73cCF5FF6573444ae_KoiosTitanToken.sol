// KoiosTitanToken for https://www.koios.world
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.9;
import '@openzeppelin/contracts/token/ERC20/presets/ERC20PresetMinterPauser.sol';

contract KoiosTitanToken is ERC20PresetMinterPauser { // this adds the mint function
    ...
    constructor () ERC20PresetMinterPauser("Titan", "Titan") { 
    ...
    function _beforeTokenTransfer(address from,address to,uint256 amount) internal override {
        super._beforeTokenTransfer(from,to,amount); // check paused
        if (transfersEnabled     ||
            from == address(0)   ||
