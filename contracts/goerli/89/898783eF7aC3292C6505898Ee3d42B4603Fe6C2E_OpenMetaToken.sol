 ...
 */
contract OpenMetaToken is ERC20, ERC20Permit, Ownable, AccessControl {
     ...
     */
    constructor(uint256 _claimPeriodEnds) ERC20("TestOMeta", "TOMeta") ERC20Permit("TestOMeta") {
     ...
     */
    function initialMint(uint256 freeSupply, uint256 airdropSupply) external onlyOwner {
     ...
     */
    function mint(address dest, uint256 amount) external onlyRole(PREDICATE_ROLE) {
