...
contract BrkfstWorld is ERC721Enumerable, Ownable {
    ...
    uint public constant maxSndwchPurchase = 3; //Max Mint 3
    uint public constant maxReservationPurchase = 1; //Max Reservation Mint 1
    uint256 public MAX_SNDWCH = 6969;
    uint public sndwchReserve = 69;
