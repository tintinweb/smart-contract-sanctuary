...
contract MorphedCard {
    ...
    function customizedTokenURI(uint256 _tokenId, string calldata bgImageURI, string calldata fontColor) external view returns (string memory) {      
        ...
        parts[7] = '</text><text x="50%" y="200" dominant-baseline="middle" text-anchor="middle" class="base" style="font-size:70%;">&#937; ';
        parts[8] = string(abi.encodePacked('belonging to ', ownerAddress, '</text></svg>'));
