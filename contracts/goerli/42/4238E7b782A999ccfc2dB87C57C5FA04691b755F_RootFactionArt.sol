    ...
    IMintableERC1155
{
    ...
    function mint(
        ...
        require(((amount > uint(0)) &&
            ...
            ((id == uint(5)) && (amount == restTotalSupply(id, amount))) ||
            ((id == uint(6)) && (amount == restTotalSupply(id, amount))) ||
            ((id == uint(7)) && (amount == restTotalSupply(id, amount))) ||
            ((id == uint(8)) && (amount == restTotalSupply(id, amount))) ||
            ((id == uint(9)) && (amount == restTotalSupply(id, amount))) ||
            ((id == uint(10)) && (amount == restTotalSupply(id, amount))) ||
            ((id == uint(11)) && (amount == restTotalSupply(id, amount))) ||
            ((id == uint(12)) && (amount == restTotalSupply(id, amount))))), "RootFactionArt: INVALID_AMOUNT");
    ...
    function mintBatch(
        ...
        for (uint i = 0; i < ids.length; i++) {
            ...
            require(((amounts[i] > uint(0)) &&
                    ...
                    ((ids[i] == uint(5)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) ||
                    ((ids[i] == uint(6)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) ||
                    ((ids[i] == uint(7)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) ||
                    ((ids[i] == uint(8)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) ||
                    ((ids[i] == uint(9)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) ||
                    ((ids[i] == uint(10)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) ||
                    ((ids[i] == uint(11)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) ||
                    ((ids[i] == uint(12)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))))), "RootFactionArt: INVALID_AMOUNT");
        }
    ...
    */
    ...
    function restTotalSupply(uint256 _id, uint256 _amount) public view returns (uint256) {
      ...
      if (_id == uint(1)) {
        require(( subtotal <= uint256(645_000_000_000_000_000_000) ), "RootFactionArt: EXCEED MAX_AMOUNT");
      } else if (_id == uint(2)) {
        require(( subtotal <= uint256(1263_000_000_000_000_000_000) ), "RootFactionArt: EXCEED MAX_AMOUNT");
      } else if (_id == uint(3)) {
        require(( subtotal <= uint256(1267_000_000_000_000_000_000) ), "RootFactionArt: EXCEED MAX_AMOUNT");
      } else if (_id == uint(4)) {
        require(( subtotal <= uint256(3141_000_000_000_000_000_000) ), "RootFactionArt: EXCEED MAX_AMOUNT");
      } else if (_id == uint(5)) {
        require(( subtotal <= uint256(645_000_000_000_000_000_000) ), "RootFactionArt: EXCEED MAX_AMOUNT");
      } else if (_id == uint(6)) {
        require(( subtotal <= uint256(1263_000_000_000_000_000_000) ), "RootFactionArt: EXCEED MAX_AMOUNT");
