 ...
 *   - Total income: based on your tarrif plan (from 12% to 16  % daily!!!) + Basic interest rate !!!
 *   - Earnings every moment, withdraw any time in plan type 2 there are certain conditions . 
 *
 *   [AFFILIATE PROGRAM]
 *
 ...
 *   [FUNDS DISTRIBUTION]
 *
 *   - 78.5% Platform main balance, participants payouts
 *   - 8% Refferal rewards
 *   - 11.5% Advertising and promotion expenses
...
contract BNBHarvest {
	...
	uint256[] public REFERRAL_PERCENTS = [50, 20, 1];
	uint256 constant public PROJECT_FEE = 135;
