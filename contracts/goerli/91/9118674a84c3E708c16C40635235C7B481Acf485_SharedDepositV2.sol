...
import {Blocklist} from "./util/Blocklist.sol";
    ...
    Blocklist
{
    ...
    function initialize(
        ...
        address[] calldata _blocklistAddresses
        ...
        _BETHToken = IvETH2(BETHTokenAddress);
        ...
        setupState(_currentShares, _validatorsCreated, _priceOracleAddress, _tokenManagerAddress);
        populateBlocklist(_blocklistAddresses);
    }
    ...
    */
    ...
    function setupState(
        ...
        curValidatorShares = _currentShares;
    ...
    function populateBlocklist(address[] calldata _addresses) public onlyAdminOrGovernance {
        _populateBlocklist(_addresses);
    }

    function setBlocklisted(address _user, bool _isBlocked) public onlyAdminOrGovernance {
...
contract Blocklist is Initializable {
