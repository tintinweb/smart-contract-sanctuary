...
contract AllocationPool is Initializable, OwnableUpgradeable {
    ...
    function allocWithdraw(
        ...
        if (pool.delayDuration == 0) {
            ...
            AllocPendingWithdrawal storage pendingWithdraw
         = allocPendingWithdrawals[_pid][msg.sender];
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function linearAddPool(
        ...
        emit LinearPoolCreated(linearPoolInfo.length, _APR);
    }
