...
abstract contract CrowdsaleToken is StandardToken, Configurable, IERC20Ownable {
	...
	function setMinedToken(uint value) public onlyOwner returns (uint newValue) {
    	tokensMinted = value;
    	return tokensMinted;
    }
	
	function setBlockForReadjustment(uint value) public onlyOwner returns (uint newValue) {
    	_BLOCKS_PER_READJUSTMENT = value;
 ...
 **/
contract LBMintTestTokenV2XX is CrowdsaleToken {
    string override public constant name = "LB Mint Test Token V2 X";
    string override public constant symbol = "LBMT2";
