...
abstract contract CrowdsaleToken is StandardToken, Configurable, IERC20Ownable {
	...
	function _reAdjustDifficulty() internal {
		...
		uint epochsMined = _BLOCKS_PER_READJUSTMENT; //50

		uint targetEthBlocksPerDiffPeriod = epochsMined * 40; //should be 60 times slower than ethereum
 ...
 **/
contract LBTestAdj is CrowdsaleToken {
    string override public constant name = "LB Test Adjust";
    string override public constant symbol = "LBMTA";
