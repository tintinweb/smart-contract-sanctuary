	...
	ContextMixin
{
	...
	function collectNFTs(address _token, uint256 _tokenId) external onlyOwner {
		uint256 amount = IERC1155Upgradeable(_token).balanceOf(address(this), _tokenId);
...
/** 
 * @title Extended ERC1155Upgradeable
 * @author Bondly Finance
 * @notice This is basic ERC1155Upgradeable writen by OpenZeppelin team, with extended functionality
 * @dev Changes to the contract: overriden function uri():
 *     return concatination of _uri and _id,
 *     for converting uint to string we are used library Strings from OpenZeppelin. 
 */
