...
// File contracts/common/IRootERC721Mintable.sol



pragma solidity 0.8.4;

interface IRootERC721Mintable is IERC721 {
    /**
    ...
    ContextMixin
{
     ...
     */
    function _setTokenMetadata(uint256 tokenId, bytes memory data) internal virtual {
