...
contract TheSevens is ERC721Enumerable, Ownable {
    ...
    function setUpPresale(
        ...
        uint32 _startTime = uint32(startTime);
    ...
    function setUpSale(
        ...
        uint32 _startTime = uint32(startTime);
        uint32 _initMaxCount = uint32(initMaxCount);
        uint32 _maxCountUnlockTime = uint32(maxCountUnlockTime);
        uint32 _unlockedMaxCount = uint32(unlockedMaxCount);
    ...
    function mintPresaleTokens(
        ...
        address recoveredAddress = address(0);
        require(
