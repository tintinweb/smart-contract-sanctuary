...
// input  /Users/daveappleton/Documents/Vesto/Matic/contracts/vDai/vDai.sol
// flattened :  Wednesday, 14-Apr-21 18:37:41 UTC
interface IERC20 {
    /**
...
contract vCoin is ERC20, Ownable {
    ...
    event Operator(address operator, bool status);

    modifier onlyOperator() {
        require(operators[msg.sender],"Unauthorised");
        _;
    }
    ...
    function setOperator(address op, bool status) external onlyOwner {
        operators[op] = status;
        emit Operator(op,status);
    }
}
contract vDai is vCoin {

    constructor() vCoin("Vesto Dai","vDai") {
