...
contract ContractRegistry is Ownable, IContractRegistry {
    ...
    function batchCollectionAddress() external view override returns (address) {
        require(
            _batchCollectionAddress != address(0),
            'Error: batchCollectionAddress has not been set'
        );
        return _batchCollectionAddress;
    }

    function projectCollectionAddress()
        external
        view
        override
        returns (address)
    {
        require(
            _projectCollectionAddress != address(0),
            'Error: projectCollectionAddress has not been set'
        );
        ...
        returns (address)
    {
        require(
            _ProjectERC20FactoryAddress != address(0),
            'Error: projectERC20FactoryAddress address has not been set'
        );
    ...
    {
        require(
            _RetirementBadgeCollectionAddress != address(0),
            'Error: retirementBadgeCollectionAddress address has not been set'
        );
