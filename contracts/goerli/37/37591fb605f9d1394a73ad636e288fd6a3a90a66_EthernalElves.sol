...
//STATE
    ...
    mapping(address => uint16)  public whitelist; //DELETE THIS
...
function whitelistMint(uint256 qty, address to, uint256 roleIndex, bytes memory signature) public payable  {
    ...
    isPlayer();
    require(_isSignedByValidator(encodeForSignature(to, roleIndex),signature), "invalid signature");  
