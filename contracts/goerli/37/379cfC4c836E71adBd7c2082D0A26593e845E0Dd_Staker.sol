...
/**
   * @dev Allows withdrawals if threshold not met and deadline has passed. 
   */
...
//=======FUNCTIONS=======//
/**
   * @dev Allows user to stake ETH before deadline has passed and updates user balance. 
   * Sends an event that can be used on the frontend.
   */
  function stake() public payable notCompleted {
    require(block.timestamp < deadline, "Staking time has passed. :(");
...
/**
  ...
  function execute() public notCompleted  {
    require(address(this).balance >= threshold && 
      block.timestamp >= deadline, 
      "Threshold and/or deadline not met"
    );
