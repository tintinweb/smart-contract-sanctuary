...
contract VirtualAnimals is ERC721, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 10000;
    uint public constant NUMBER_RESERVED_TOKENS = 100;
    uint256 public constant PRICE = 100000000000000; //0.0001 eth in wei FOR TEST PURPOSE
    ...
    constructor() ERC721("VirtualAnimals", "ANIMAL") {}
