...
contract FlashBotTest is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdTracker;

    uint256 public constant MAX_ELEMENTS = 30;
    ...
    event CreateCritter(uint256 indexed id);
    constructor(string memory baseURI) ERC721("FlashBotTest", "FBT") {
        setBaseURI(baseURI);
        // pause(true);
    }
...
// File contracts/Flatten-FlashBotTest.sol