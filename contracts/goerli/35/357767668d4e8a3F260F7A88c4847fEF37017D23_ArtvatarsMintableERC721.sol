...
ContextMixin
{
	...
	constructor(
		...
		address server // 0xFbf82c5e6fb0bA2314b1ca4BAC0D446DCd0Ac8aa
	) public ERC721(name_, symbol_) {
		WETHContract = WETHInterface(address(0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa));
	...
	function calcPrice(uint256 _totalSupply, uint8 _amount) public pure returns (uint256) {
		return ceil(_totalSupply.mul(10000).div(2000), 10000).div(10000).mul(250000000000000000).mul(_amount).div(10000);
		// TODO: remove .div(10000) at the end later
	}
	...
	function withdrawWETH() public only(DEFAULT_ADMIN_ROLE) {
		uint tokens = WETHContract.balanceOf(address(this));
		WETHContract.transfer(msgSender(), tokens);
	}
}

// Contract - MATIC MUMBAI:        0x51dFa35d65dee3680b032834ab53bD82D0a3479a