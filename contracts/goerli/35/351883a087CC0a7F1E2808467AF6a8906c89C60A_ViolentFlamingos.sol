...
// File: contracts/ViolentFlamingosLowGas.sol
...
contract ViolentFlamingos is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Violent Flamingos", "VF") {
    setHiddenMetadataUri("ipfs://QmbYgPBCJfUgio7K4MD4mVcpHzgyet42vwLTKgHFZ63VxV/Hidden.json");
  }
