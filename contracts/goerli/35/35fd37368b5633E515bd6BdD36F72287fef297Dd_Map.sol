                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '", "image":"',
                                image,
                                '", "description": "Maps are (pseudo) randomly generated names of waypoints along a journey complete with a journey map. All data is stored on chain. Use Maps however you want and pair with your favourite adventure Loot."'
                            )
                        )
                    )
                )
