...
contract SocialMonitor is UsingWitnet {
  ...
  function checkLikes(string calldata _id) external payable notEmpty(_id) {
    WitnetRequest request = new WitnetRequest(
      bytes(
        abi.encodePacked(
          hex"0a7a08d4d2c28906124c123c68747470733a2f2f6170692d6d6964646c6577617265732e76657263656c2e6170702f6170692f747769747465722f7477656574732f",
          _id,
          hex"1a0c821877821865656c696b65731a110a0d08051209fb3ff199999999999a100322110a0d08051209fb3ff199999999999a100310c0843d186420e80728333080c8afa025"
        )
      )
    );
  ...
  function getLikes(string calldata _id) public notEmpty(_id) notPending(_id) {
    //Extracting data
