...
// Part: OpenZeppelin/openzeppe[email protected]/ERC721
...
contract NFT is ERC721, Ownable {
    ...
    function whiteListedMint(
        ...
        _mintWhiteListLoop(msg.sender, _mintAmount);
    }
    ...
    function _mintWhiteListLoop(address _receiver, uint256 _mintAmount)
        internal
    {
        for (uint256 i = 0; i < _mintAmount; i++) {
            supply.increment();
