...
// SPDX-License-Identifier: MIT AND UNLICENSEDD
...
interface IRootERC721Mintable is IERC721 {
     ...
     * @param tokenURI URI of token being minted
     */
    ...
    ContextMixin
{
     ...
     */
    function mint(address user, uint256 tokenId, string memory tokenURI_) external override only(PREDICATE_ROLE) {
        _mint(user, tokenId);
