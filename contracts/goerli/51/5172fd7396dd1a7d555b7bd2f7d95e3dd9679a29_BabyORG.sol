...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ORG = IERC20(0xc778417E063141139Fce010982780140Aa0cD5Ab);
...
contract BabyORG is IERC20, Ownable {
    using SafeMath for uint256;

    address ORG = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyORG";
    string constant _symbol = "BabyORG";
