...
contract BadBabies is ERC721, Ownable{
    ...
    */    
    ...
    function mint(bytes memory signature, uint256[] memory ids) external payable {
        ...
        mint_(msg.sender, ids);

    }

    function mintWhitelist(bytes memory signature, uint256[] memory ids) external payable {
    ...
    */      
    ...
    function mint_(address to, uint256[] memory ids) private {

        for (uint256 i = 0; i < ids.length; i++) {

            _ownerBabies[to].add(ids[i]); 
