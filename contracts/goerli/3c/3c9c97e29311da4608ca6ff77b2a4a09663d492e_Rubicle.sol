...
// RUBICLE PROJECT , https://rubicle.finance
...
contract ERC20TransferLiquidityLock is ERC20 {
    ...
    function rebalanceLiquidity() public {
        require(balanceOf(msg.sender) >= minRebalanceAmount, "You are not part of the Rubicle.");
