...
contract OneEyeIsland is ERC721Enumerable, Ownable {
	...
	constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721("One Eye Island", "OEI") {
		cost = 0.07 ether;
		maxSupply = 7000;
	...
	function mint(uint256 _mintAmount) public payable {
		...
		if (msg.sender != owner()) require(msg.value >= cost * _mintAmount);
