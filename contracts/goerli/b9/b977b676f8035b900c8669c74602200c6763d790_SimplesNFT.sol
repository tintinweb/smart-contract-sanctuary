...
// File: contracts/SimplesNFT2.sol
...
contract SimplesNFT is ERC721, Ownable, RandomlyAssigned {
  ...
  uint256 public maxSupply            = 12; //5000
  uint256 public discountSupply       = 3;  //1250
  uint256 public costDiscount         = 0.02 ether;
  uint256 public costNormal           = 0.03 ether;
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    require( availableTokenCount() - _mintAmount >= 0, "You can't mint more than the available token count"); 
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if (msg.sender != owner()) {  
      ...
      require(!paused, "YOU CAN'T MINT AT THIS TIME");
        ...
        if(currentSupply < discountSupply){
          require(msg.value >= costDiscount * _mintAmount);
        }
        else{
          require(msg.value >= costNormal * _mintAmount);
        }
      }
