...
// Valencoin is a social token created by squirelo.eth
// This token is based on the C-POW™ technology which combines a quantic (nope) proof of chat presence and the revolutionary Coin-census approval system which means "je decide dans mon coin, tu vas faire quoi ? bah rien"
