...
import {ERC721, FloppyBase} from "./FloppyBase.sol";
import {ContextMixin} from "./ContextMixin.sol";
import {AccessControl} from "@openzeppelin/contracts/access/AccessControl.sol";

contract FloppyMainnet is FloppyBase, AccessControl, ContextMixin {
    ...
    function mint(
        ...
        require(
            hasRole(PREDICATE_ROLE, msgSender()),
    ...
    function setTokenMetadata(uint256 tokenId, bytes memory data) internal {
        genes[tokenId] = abi.decode(data, (bytes32));
    }
...
abstract contract ContextMixin {
    function msgSender() internal view returns (address payable sender) {
        if (msg.sender == address(this)) {
            ...
            sender = payable(address(msg.sender));
        }
        return sender;
    }
}
