...
/*
haillifeAddress: XHalfLife addr
lqtyAddress	LQTYToken addr
teamHalflifeAdminAddress ALL_ZEROS
receivers address[]	beneficiary_addresses
amounts	uint256[] beneficiary_amounts
enableDestroy bool[] [false, false, false, ..., false]
*/
...
contract LockInHalflife is Ownable {
    ...
    uint256 public constant halflifeK = 15000;  // 3 second per block
    uint256 public constant halflifeRatio = 1;
    // halflife = (15000 * 3) * (0.69 / (-ln(1-0.001))) = 31034472.41 seconds = 359.19 days
