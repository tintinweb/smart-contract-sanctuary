...
contract FLX is ERC20PresetMinterPauser {
    ...
    constructor(address _initialMinter) ERC20PresetMinterPauser("Flux Token", "FLX") {
       // Mint initial balance for Flux DAO
       _mint(_initialMinter, INITIAL_SUPPLY);
       
       // Grant Flux DAO minter rights
       grantRole(MINTER_ROLE, _initialMinter);
