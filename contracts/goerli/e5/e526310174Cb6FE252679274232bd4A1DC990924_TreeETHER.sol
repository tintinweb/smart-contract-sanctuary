...
contract TreeETHER is ERC721Upgradeable, IMintableERC721 {
    ...
    modifier onlyPredicate() {
        accessRestriction.ifPredicate(msg.sender);
        _;
    }
...
interface IAccessRestriction {
    ...
    function ifPredicate(address _address) external view;

    function ifDepositor(address _address) external view;
}
