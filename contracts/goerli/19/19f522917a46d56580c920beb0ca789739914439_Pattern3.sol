...
contract Pattern3  {
    ...
    /******币的合约******/
    // address constant private glodaddress = 0xA2475490B31C0133CF3850AA88896C5546d42A1C;
    address constant private glodaddress = 0x00;//币合约地址  上面注释的是正式的
    Glod private glod;
    /******别名合约******/
    // address constant private aliasaddress = 0x73600A5b2BA7257451d20013B407187241c21483;
    address constant private aliasaddress = 0x00;//别名合约地址  上面注释的是正式的
    ...
    /******块地址数量******/
    uint256 public blockAddressnumber = 256;
    /******块间隔******/
    ...
    function releaseWater(address _address,uint256 _amount) public returns(bool){
        ...
        distributed += _amount * (10**decimals);
    ...
    /******节点状态******/
    function nodeState(address _address) public view returns(bool,bool,address,address){
