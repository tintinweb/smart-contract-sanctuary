...
contract ZoneStakingUpgradeable is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event ChangeType(bool enable, uint16 lockDay, uint256 rewardRate);
    ...
    function getTypes() public view returns(bool[] memory enables, uint16[] memory lockDays, uint256[] memory rewardRates) {
    ...
    function changeType(
        ...
        emit ChangeType (_type.enabled, _type.lockDay, _type.rewardRate);
    }
