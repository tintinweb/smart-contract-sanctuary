...
contract Dogematic is Context, IERC20, Ownable {
    ...
    string private _name = "Dogematic";
    ...
    address public _communityAccount = 0x000000000000000000000000000000000000dEaD;
    ...
    function setCommunityAccount(address communityAccount) external onlyOwner() {
        _communityAccount = communityAccount;
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
		...
		uint cTransferAmount;
		
		cTransferAmount = calculateCommunityFee(rTransferAmount); 
		tTransferAmount = tTransferAmount - cTransferAmount; 
		
        emit Transfer(sender, _communityAccount, cTransferAmount);
        emit Transfer(sender, recipient, tTransferAmount);
    }
