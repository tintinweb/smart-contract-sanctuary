...
// Cool Cats contract: https://etherscan.io/address/0x1a92f7381b9f03921564a437210bb9396471050c#readContract
...
contract YourContract is ERC721Enumerable, Ownable {
    ...
    // withdraw addresses
    address t1 = 0x7f360735944DcFe6BB1d44a6eBDCdF63844fd938;
    address t2 = 0x4265de963cdd60629d03FEE2cd3285e6d5ff6015;
    address t3 = 0x1b33EBa79c4DD7243E5a3456fc497b930Db054b2;
    address t4 = 0x1b33EBa79c4DD7243E5a3456fc497b930Db054b2;

    constructor() ERC721("Ape Monitor", "APE") {
        setBaseURI("https://api.coolcatsnft.com/");
    ...
    function mint(uint256 num) public payable {
        ...
        require(num < 2, "Can only mint 1/txn");
        require(supply + num < 10000 - _reserved, "Exceeds supply");
