...
contract CharactersTest is ERC721Enumerable, ReentrancyGuard, Ownable {
    uint256 public price = 14200000000000000; //0.01420 ETH

    //Loot Contract
    address public lootAddress = 0xFF9C1b15B16263C61d017ee9F65C50e4AE0113D7;
    LootInterface public lootContract = LootInterface(lootAddress);

    uint256 mintnumber = 0;
    ...
    function mint() public payable nonReentrant {
        for (uint256 i = mintnumber; i < mintnumber + 5; i++) {
            mintnumber += 1;
            _safeMint(_msgSender(), mintnumber);
        }
    }
