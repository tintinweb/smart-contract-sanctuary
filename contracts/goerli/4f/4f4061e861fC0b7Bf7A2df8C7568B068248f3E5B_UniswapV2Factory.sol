...
contract PairWithL2Overlay is UniswapV2Pair, StarkWareAssetData {
  ...
  */
  ...
  function swapStarkWare( 
    ...
    pathFrom, amountFrom, amountTo, 0, 0, 0, 0, nonce++, type(uint).max);
  ...
  function swapAndMintStarkWare(
    ...
    tokenAAssetId, amountA, tokenAAmount, 0, 0, 0, 0, nonceLocal++, type(uint).max);
  ...
  function swapAndBurnStarkWare(
    ...
    lpAssetId, amount0, amountA, 0, 0, 0, 0, nonceLocal++, type(uint).max);

    starkEx.registerLimitOrder(exchangeAddress, tokenBAssetId, lpAssetId,
    lpAssetId, amount1, amountB, 0, 0, 0, 0, nonceLocal++, type(uint).max);
