...
contract ProjectThetaNFT is ERC721Enumerable, Pausable, Ownable {
    ...
    // Public Constants
    address public constant THE_OTHER = 0x0000000000000000000000000000000000000000;
    address public constant TREASURY = THE_OTHER;
    uint256 public constant MAX_SUPPLY = 8888;
    uint256 public constant TOTAL_OTHER_QUOTA = 200;
    ...
    function _isPublicMintActiveInternal(uint256 _totalSupply)
        ...
        returns (bool)
    {
        return _totalSupply >= TOTAL_OTHER_QUOTA || _isPublicMintActive;
    }
