...
contract PUMPSKIES is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PUMPSKIES" ;
    string private constant _symbol = unicode"PSK";
    ...
    function setFeeRate(uint256 rate) external {
        require(_msgSender() == _FeeAddress);
        require(rate < 21, "Rate can't exceed 20%");
        _feeRate = rate;
