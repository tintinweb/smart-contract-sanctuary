...
contract SampleToken is IERC20,EIP712MetaTransaction("WRAPPER ETHER","1") {
    ...
    constructor() public {
        ...
        balances[msgSender()] = totalSupply_;
    }
    ...
    function transfer(address receiver, uint256 numTokens) public override returns (bool) {
        require(numTokens <= balances[msgSender()]);
    ...
    function transferFrom(address owner, address buyer, uint256 numTokens) public override returns (bool) {
        ...
        require(numTokens <= allowed[owner][msgSender()]);

        balances[owner] = balances[owner].sub(numTokens);
        allowed[owner][msgSender()] = allowed[owner][msgSender()].sub(numTokens);
