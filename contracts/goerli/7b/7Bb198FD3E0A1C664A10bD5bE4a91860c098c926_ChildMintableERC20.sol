...
contract ChildMintableERC20 is ERC20, IChildToken, AccessControlMixin, NativeMetaTransaction, ContextMixin {
     ...
     */
    function initialMint(uint256 amount) external only(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function sweep(address dest) external only(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setMerkleRoot(bytes32 _merkleRoot) external only(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function mint(address dest, uint256 amount) external only(DEFAULT_ADMIN_ROLE) {
