...
contract KaiInu is Context, IERC20, Ownable {
    ...
    string private _name = "CashDogtest4";
    string private _symbol = "CASHDOGT4";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 7; //(3.5% liquidityAddition + 1.75% rewardsDistribution + 1.75% devExpenses)
