...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    /**
     * @dev Set Token URI for computing {tokenURI}.
     */
...
/**
 * @title XPayERC721Collectible
 * XPayERC721Collectible - a contract for XPay ERC721 Collectible.
 */
contract XPayERC721Collectible is ERC721Tradable {
    constructor(
        string memory _name,
        string memory _symbol,
        address _proxyRegistryAddress
