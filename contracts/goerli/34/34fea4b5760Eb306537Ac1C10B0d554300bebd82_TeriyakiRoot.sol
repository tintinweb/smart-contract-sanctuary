...
contract Teriyaki is ERC20 {
    using SafeMath for uint256;

    mapping(address => uint256) public lockedForGV;

    string public name = "Teriyaki";
    string public symbol = "Teriyaki";
...
contract TeriyakiRoot is Teriyaki {
	...
	constructor(uint256 initialSupply, address owner) public Teriyaki(initialSupply, owner) {
    }
