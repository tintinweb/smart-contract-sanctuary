 ...
 */
contract LoopyCups is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, ReentrancyGuard {
    ...
    @param _maxForChillSale - Maximum number of tokens to allow selling.
    ...
    */
    ...
    function lock() public onlyOwner notLocked {
        ...
        require(totalSupply() == MAX_TOKENS, "Not all Cups are minted yet!");
        locked = true;
    }
