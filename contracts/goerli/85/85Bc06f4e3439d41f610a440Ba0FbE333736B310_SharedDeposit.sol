...
contract SharedDeposit is VaultWithAdminFeeUpgradeable, DepositHelperUpgradeable {
    ...
    function __SharedDeposit_init_unchained(
        ...
        BETHToken = IERC20MintableBurnable(_BETHTokenAddress);
    }
    ...
    function setBethAddress(address _BETHTokenAddress) external onlyAdmin {
    ...
    function deductExitFee(uint256 amount) public view returns(uint256) {
        ...
        uint fee = getFeeGivenAmountAndAdminPrct(amount, pick);
        return fee;
    }
}
