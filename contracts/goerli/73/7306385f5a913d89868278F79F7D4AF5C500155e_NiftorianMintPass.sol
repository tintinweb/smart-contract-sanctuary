...
contract NiftorianMintPass is ERC721, Ownable, AccessControlEnumerable {
    ...
    uint256 constant private MAX_NOO_PASSES = 70;

    mapping(uint256 => uint256) private utilityState; 
    mapping(address => uint256) private whitelistPasses;

    uint256 private publicCurrentLimit = 350;
    uint256 private whitelistCurrentLimit = 350;
    ...
    function setCurrentLimit(uint256 limit, bool forwhitelist) external onlyOwner {
        if(forwhitelist){
