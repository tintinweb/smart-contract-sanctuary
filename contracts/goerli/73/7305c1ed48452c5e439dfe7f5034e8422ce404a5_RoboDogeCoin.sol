...
contract RoboDogeCoin is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 100 *10**20; //
    ...
    //var
    uint256 public _charityFeeTotal = 47620157075159170608631;
    uint256 public _burnFeeTotal = 95240314150318341218448;
    uint256 public _taxFeeTotal = 238100785375795853047871;
    uint256 public _liquidityFeeTotal = 285720942450955023657616;
    uint256 public _marketingFeeTotal = 142860471225477511828241;
    uint256 public _earlySellFeeTotal = 622222220723903746065290;

    //addresses
    address public charityAddress = 0xF610f22Acb94ABEe089E34EABbE24f9ad5612CdE; // Charity Address
    address public routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // PancakeSwapRouterV2
    address public marketingFeeAddress = 0x47F527B1cabF88F432349948757188f62D760E2e; // marketing wallet
    address public liquidityManager = 0xB61c85ae41E3c92B89378104f6297D17de03d8B5; // address which will manually add liquidity to pool
