...
// input  /Users/daveappleton/Documents/akombalabs/trait_allocator/sender721b/sender721B.sol
// flattened :  Wednesday, 28-Apr-21 13:36:23 UTC
interface IERC165 {
    /**
...
contract sender721B {
   ...
   function sendManyToOneFor(
    ...
    function permitAccess(address operator, bool permission) external onlyOwner {
        access[msg.sender][operator] = permission;
