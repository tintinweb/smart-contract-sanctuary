...
contract Test721 is ERC721, FxBaseRootTunnel {
    uint256 public totalSupply = 0;

    event TestMsgFromChild(bytes message);
    ...
    function _beforeTokenTransfer(
        ...
        _sendMessageToChild(abi.encodePacked(from, "123456"));
    }
