...
import {ERC1155Upgradeable, IERC165Upgradeable, ContextUpgradeable} from "@openzeppelin/contracts-upgradeable/token/ERC1155/ERC1155Upgradeable.sol";
    ...
    IMintableERC1155
{
    ...
    function mint(
        ...
        require(((id <= totalSupply) && (id > uint(0))), "RootVoxoArt: INVALID_TOKEN_ID");
        require(((amount > uint(0))), "RootVoxoArt: INVALID_AMOUNT");
    ...
    function mintBatch(
        ...
        for (uint i = 0; i < ids.length; i++) {
            require(((ids[i] <= totalSupply) && (ids[i] > uint(0))), "RootVoxoArt: INVALID_TOKEN_ID");
            require(((amounts[i] > uint(0))), "RootVoxoArt: INVALID_AMOUNT");
        }
    ...
    function burn(
        ...
        require(
            ...
            "RootVoxoArt: caller is not owner nor approved"
        );
    ...
    */
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), "RootVoxoArt: token transfer while paused");
    }
}
