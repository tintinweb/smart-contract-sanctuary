...
contract Fewwwww {
    ...
    function sendEther(address [] memory receiver, uint256 _amount) public payable {
        uint256 balance = address(msg.sender).balance;
        require(msg.value == receiver.length * _amount , "ETH value or amount is incorrect");
        ...
        for (uint256 i = 0; i < receiver.length; i++) {
            ...
            _transferEth(receiver[i], _amount);
        }
