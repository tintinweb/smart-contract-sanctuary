...
contract VBIT is Context, IERC20, Configurable, Ownable {
    ...
    */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        burnTokens  = findFivePercent(amount);                                                         
        
        _balances[recipient] += amount.sub(burnTokens);                    //___| burn 5% on each transfer |______     
        _totalSupply -= burnTokens;                                      //____| reduce 5% from total supply |______
