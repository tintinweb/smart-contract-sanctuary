...
/**
   #BURNSAFE - #LIQ+#RFI+#SAFETOKEN, combine together to #BURNSAFE 
   ...
   I make this #BURNSAFE to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/BURNSAFEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #BURNSAFE to the community, make sure it's 100% safe.

   I will add 0.1 BNB and all the left 49% total supply to the pool
   1% for the dev
   Can you make #BURNSAFE 10000X? 
   ...
   it's the best part of the #BURNSAFESAFE idea, increasing the liquidity pool automatically, 
...
contract BURNSAFE is Context, IERC20, Ownable {
    ...
    string private _name = "BURN SAFE";
    string private _symbol = "BURNSAFE";
