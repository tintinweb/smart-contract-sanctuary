...
abstract contract Vault is Ownable, ReentrancyGuard, Pausable, ERC20 {
    ...
    uint256 public buyBackRate = 4000; // 40% of whatever left of controllerFee
    uint256 public constant buyBackRateMax = 10000; // 100 = 1%
    uint256 public constant buyBackRateUL = 4000; // 40%

    uint256 public earnToBeliRate = 5000; // 50%
...
abstract contract TimelockedVault is Vault {
    ...
    uint256 public minTimeToWithdraw = 7776000; // 90 days
