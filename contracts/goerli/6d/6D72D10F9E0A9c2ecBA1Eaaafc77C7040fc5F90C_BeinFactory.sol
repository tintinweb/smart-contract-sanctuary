...
contract BeinFactory {
    ...
    function createNewNFT(
        ...
        BeinNFT nft = new BeinNFT(owner, baseURI, name, symbol);
...
import "./BeinRC721Enumerable.sol";
import "@openzeppelin/contracts/security/Pausable.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract BeinNFT is BeinRC721Enumerable, Pausable {
    ...
    ) BeinRC721(admin_, name_, symbol_) {
...
import "./BeinRC721.sol";

import "@openzeppelin/contracts/token/ERC721/extensions/IERC721Enumerable.sol";

abstract contract BeinRC721Enumerable is BeinRC721, IERC721Enumerable {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, BeinRC721) returns (bool) {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < BeinRC721.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < BeinRC721Enumerable.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = BeinRC721.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = BeinRC721.balanceOf(from) - 1;
 ...
 */
contract BeinRC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = BeinRC721.ownerOf(tokenId);
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(BeinRC721.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(BeinRC721.ownerOf(tokenId), to, tokenId);
    }
