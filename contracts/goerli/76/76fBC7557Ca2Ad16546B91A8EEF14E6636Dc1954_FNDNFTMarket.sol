  ...
  SendValueWithFallbackWithdraw
{
  ...
  {
    (f8nFee, creatorFee, ownerRev) = _getFees(nftContract, tokenId, seller, price);
  ...
  NFTMarketAuction
{
  ...
  /**
   * @dev Returns the seller that put a given NFT into escrow, or 0 if no auction is found
   */
 ...
 */
abstract contract NFT721Market is FoundationNode, HasSecondarySaleFees, NFT721Creator {
  using AddressUpgradeable for address;
 ...
 */
abstract contract NFT721Creator is ERC721Upgradeable {
