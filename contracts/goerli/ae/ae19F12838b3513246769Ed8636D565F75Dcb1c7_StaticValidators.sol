...
contract StaticValidators {
    ...
    function acceptContractAndSelectorAddUint256FillFromCallData(
        ...
        (address requiredTarget, bytes4 requiredSelector, uint32 amountOffset) = abi.decode(
            extraData,
    ...
    function acceptContractAndSelectorAddUint32FillFromExtraData(
        ...
        (address requiredTarget, bytes4 requiredSelector, uint32 offeredAmount) = abi.decode(
            extraData,
            (address, bytes4, uint32)
        );
    ...
    function acceptTransferERC721ExactToken(
        ...
        uint256 newFill = uints[4] + 1; /* currentFill */
    ...
    function acceptTransferERC721ExactFrom(
        ...
        // Call type = call
        require(howToCall == AuthenticatedProxy.HowToCall.Call, "STATIC_VALIDATOR/WRONG_HOWTOCALL");
    ...
    function acceptReturnERC721Bulk(
        ...
        uint256 newFill = uints[4] - tokenIds.length; /* currentFill */
    ...
    function acceptReturnERC1155AnyAmount(
        ...
        require(
            ...
            "STATIC_VALIDATOR/EXCEEDS_CURRENT_FILL"
        );
