...
contract CommunityNFTAirdrop is CommunityDropBase {
    ...
    function startAirdrop(
        ...
        for (uint256 i = 0; i < _roleIds.length; i++) {
            active[_platform][_roleIds[i]][roleToken] = true;
        ...
        emit DropOnServer(_dropUrl, _channelId);
    }
    ...
    function stopAirdrop(
        ...
        require(active[platform][_roleId][roleToken], "No active airdrop");
        ...
        active[platform][_roleId][roleToken] = false;
    ...
    function claim(
        ...
        require(
            active[_platform][_roleId][_tokenAddress] || approvals[msg.sender][_platform][_roleId][_tokenAddress],
            "No active airdrop"
        );
    ...
    function addRoleToDrop(
        ...
        active[platform][_roleId][roleToken] = true;
...
contract CommunityDropBase is CommunityTokenManager, Pausable {
    ...
    event DropOnServer(string dropUrl, string channelId);
