...
contract AMyToken is StandardToken {
    ...
    */
    constructor() {
        ...
        _teamAddress = 0xE18179AaF5Fa39a84fF5975d22BF07aA0bE4FB3e;
        ...
        balances[0x79f62B0EAD6ff751EbAf5C1715EbCB9704f49645] = 0*(10 ** uint256(decimals));
        emit Transfer(address(0x0), 0x79f62B0EAD6ff751EbAf5C1715EbCB9704f49645, 0*(10 ** uint256(decimals)));
        
        balances[_whiteAddress] = INITIAL_SUPPLY*0;
        emit Transfer(address(0x0), _whiteAddress, balances[_whiteAddress]);
        balances[_promoteMiningAddress] = INITIAL_SUPPLY*0;
