...
// File: Ko-blockchain/KoMintableERC721.sol
...
ContextMixin
{
    ...
    constructor() ERC721("Ko Digital Collectible", "KODC")
    {
        _setupContractId("test2ERC721");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, _msgSender());
        _initializeEIP712("Ko Digital Collectible");
    }
