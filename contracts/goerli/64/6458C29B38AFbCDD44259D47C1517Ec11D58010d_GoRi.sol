...
contract GoRi is Context, IERC20, Ownable {
    ...
    string private _name = "GoRi";      //CHANGE_REQUIRED: name of token
    string private _symbol = "GRI";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
    uint8 private _decimals = 9;                //CHANGE_OPTIONAL: number of decimals of your token. Recommended to keep unchanged 
    
    uint256 public _taxFee = 6;                 //CHANGE_OPTIONAL: transaction fee redistributed to all holders
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 10;           //CHANGE_OPTIONAL: transaction fee sent to Pancakeswap pool
