...
contract Memes is ERC1155, Ownable, Royalties {
    ...
    constructor() public ERC1155("https://game.example/api/item/{id}.json") Royalties(50,msg.sender){
        ownerAddress = msg.sender;
    }

    function mint(string memory _hash, string memory _uri,address payable creator, uint256 percentRoyalty) public {
    ...
    function updatePercentRoyalty(uint256 _id, address _creator , uint256 newPercentRoyalty)public {
    ...
    function sendRoyalty(address payable _buyer, uint256 totalAmount, uint256 id)
        public
        payable
        returns (bool approved)
    {
       ...
       (bool successTramsferToCreator, ) = _creator.call{value: royaltyCreator}("");
