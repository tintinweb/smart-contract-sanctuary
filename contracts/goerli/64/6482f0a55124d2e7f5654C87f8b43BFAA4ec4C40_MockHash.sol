...
contract MockHash {
    ...
    function calculateTaskHash (address to, uint256 value, string calldata proof) external pure returns ( bytes32 taskHash ) {
        taskHash = keccak256((abi.encodePacked(to, value, proof)));       
    }
}
