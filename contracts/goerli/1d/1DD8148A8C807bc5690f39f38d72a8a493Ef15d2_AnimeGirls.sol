...
contract AnimeGirls is ERC721URIStorage, Ownable {
    ...
    string public _baseTokenURI = "https://werewolf-resource.53site.com/NFT/api/item/AG{id}.json";
    ...
    function setBaseTokenURI(string memory _tokenURI)
    public onlyOwner
    {
    ...
    function safeMintCNG(uint256 _tokenId) external payable{
        ...
        _setTokenURI(_tokenId, string(abi.encodePacked(_baseTokenURI, _tokenId)));
        _tokenIdNum += 1;
