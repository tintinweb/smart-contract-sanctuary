...
contract Plonk4VerifierWithAccessToDNext {
    ...
    function reconstruct_d(
        ...
        uint256 power_for_z_omega_opening = 1 +
            1 +
            STATE_WIDTH +
            STATE_WIDTH -
            1;
        ...
        for (uint256 i = 0; i < STATE_WIDTH; i++) {
            tmp_g1 = vk.selector_commitments[i].point_mul(
        ...
        // d_next
        tmp_g1 = vk.next_step_selector_commitments[0].point_mul(
        ...
        PairingsBn254.Fr memory grand_product_part_at_z_omega = state.v.pow(
            power_for_z_omega_opening
        );
        ...
        tmp_g1.point_sub_assign(
            vk.permutation_commitments[STATE_WIDTH - 1].point_mul(
        ...
        res.point_add_assign(
            proof.grand_product_commitment.point_mul(
    ...
    function verify_commitments(
        ...
        commitment_aggregation.point_sub_assign(
            ...
            PairingsBn254.G1Point memory pair_with_generator
...
contract KeyedVerifier is IVerifier, Plonk4VerifierWithAccessToDNext {
        ...
        returns (VerificationKey memory vk)
    {
        ...
        vk.selector_commitments[0] = PairingsBn254.new_g1(
            0x0c0bc21c74f81a133478f7db95da52dc15cc3d24a8c5cb2c7235d2d6abad6bd9,
            0x300c4e5895dd1dd1f5aa6ff32c564d99aa953dffbbd48a327b10e8ba74ddc53f
        );
        vk.selector_commitments[1] = PairingsBn254.new_g1(
            0x24e5e0bac083b1028774c0dd4121a9cdd941d31bde4d03e39d3f3ed2cc760c21,
            0x1007889d99b54159478b33892638ff9db7d114dd476c7773ba522bbd41313b3b
        );
        vk.selector_commitments[2] = PairingsBn254.new_g1(
            0x08227cf51288e704161ce72fc3133c405676672c754d426668e96dd9054e4201,
            0x00e2119abed54f2ed72c9eb4654d561e2913d31216dd89f181b292ca5408cae5
        );
        vk.selector_commitments[3] = PairingsBn254.new_g1(
            0x19338307e38ac3c2f890c2ce633fb8abbd94cc3c9e85b6759156e01f5bd837d6,
            0x052980cdc78cf475d5b766f58b506775ee8ed407c5e27ece1512dff37d80edbf
        );
        vk.selector_commitments[4] = PairingsBn254.new_g1(
            0x00c67307b5d770ee8b147ee33d6648a8890536344da6315f38e566fe18d59aaf,
            0x23738a31092d42fc2007f27e55c9d0a1ff80e13375cde8cc02adc77f83238576
        );
        vk.selector_commitments[5] = PairingsBn254.new_g1(
            0x074307e90102a6fb157389ebe3b2c37cb154afbcd798bf86105d2bd6fbee877f,
            0x0f5d99158f92386664b283c2d6a0682f3cc55a5966c03198fc024fb50d12613a
        );
        ...
        vk.next_step_selector_commitments[0] = PairingsBn254.new_g1(
            0x2282deb23eaebd836649b077b6da9697a6e9c214c9e3cc1147e97b2fceb5478b,
            0x0be4162ae93919cd7388bef2f524a975eabee9d287982de3554e823a4fc186e0
        );

        vk.permutation_commitments[0] = PairingsBn254.new_g1(
            0x2b5ecfd8b35b408f167d674fc275e57e1e7e578e49162768f329ba904ec6d624,
            0x19c9c837799587d743101e21e356964b9847f94c8a1b4e6f4559fdf686f09f7e
        );
        vk.permutation_commitments[1] = PairingsBn254.new_g1(
            0x0ff731bca14253343b1b61208d4eef6316adff21931ba41b0f639563f5a6d1f9,
            0x1b366e05626bec9d33e147a26120071f65e5365d496b90bfc4115220e31802d4
        );
        vk.permutation_commitments[2] = PairingsBn254.new_g1(
            0x132e206fa1d59754768a1d1eb6c63075f124221309b72e0dcc8933337542e539,
            0x03eebdc3d6b21dc9fb8e40d46f41d872b0b44594a72e0a58c66e46202dd2063b
        );
        vk.permutation_commitments[3] = PairingsBn254.new_g1(
            0x1dfb0405c3aa0c1f643e4ff34f9ea7a3ad76963749de7702c97012d41ed608b1,
            0x2eeec6d045007a12a25af3925d7372b6e1771bd367d971a5ab2893f5b26d1ad9
        );
