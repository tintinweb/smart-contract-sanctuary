...
/** 
 *  SourceUnit: /Users/dan/Side-Projects/orca-sushi-swaps/contracts/SushiClient.sol
*/
...
contract SushiClient {
    ...
    function swap(address _from, address _to, uint256 _amount) external {
        ...
        uint amountOut = getAmountOut(path, _amount);
        sushiRouter.swapExactTokensForTokens(_amount, amountOut, path, msg.sender, block.timestamp); 
    }
    ...
    function getAmountOut(
        ...
        uint amountOut = UniswapV2Library.getAmountsOut(address(sushiFactory), amountIn, path)[0];
        uint256 amountOutLessSlippage = amountOut * (slippageDenominator - slippageNumerator) / slippageDenominator;
