...
contract RootPUSDT is ERC20, AccessControlMixin, NativeMetaTransaction, ContextMixin, IMintableERC20 {
    bytes32 public constant PREDICATE_ROLE = keccak256('PREDICATE_ROLE');

    constructor() public ERC20('RootPUSDT', 'pUSDT') {
        _setupContractId('RootPUSDT');
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, _msgSender());
        _initializeEIP712('RootPUSDT');
    }
