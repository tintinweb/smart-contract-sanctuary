...
contract ChatterEthNFT is ERC721, AccessControl {
  ...
  constructor(address _MintableERC721PredicateProxy) ERC721("CNFT", "CNFT") {
    _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    _setupRole(PREDICATE_ROLE, _MintableERC721PredicateProxy);
  }
