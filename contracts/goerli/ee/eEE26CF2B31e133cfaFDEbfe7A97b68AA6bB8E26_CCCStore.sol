...
contract CCCStore is Ownable, VRFConsumerBase {
    ...
    uint256 public constant operationSecondsForVIP =  691200;//3600 * 9; // 9 hours 
    ...
    function mintWithPass(
        ...
        //Claim the pass
        bool validPartner = pass.checkPass(msg.sender, _amount, vSig, rSig, sSig);

        require(validPartner);
        uint256 mintedCCC = mintedCCCOf[msg.sender];
        uint256 passAmount = pass.claimBalance(msg.sender);
        require(
