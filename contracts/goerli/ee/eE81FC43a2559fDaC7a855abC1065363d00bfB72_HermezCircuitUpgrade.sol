...
contract HermezCircuitUpgrade is InstantWithdrawManager {
    ...
    function addVerifier() external {
        require(address(withdrawVerifier) == 0x4AC7E1771f17a1ED7153591487Eefdf37266E10f, "Only can be called once");
        rollupVerifiers[0] = VerifierRollup({
                verifierInterface: VerifierRollupInterface(
                    address(0x3c58c648B4a5a609C4e37F476BEC86EaB7521764)
                ),
                maxTx: 344,
                nLevels: 32
             });
        ...
        rollupVerifiers[1] = VerifierRollup({
                verifierInterface: VerifierRollupInterface(
                    address(0x3D88C570726382D403Ca6c1993ED0A155e6436aF)
                ),
                maxTx: 1912,
                nLevels: 32
             });
        ...
        withdrawVerifier = VerifierWithdrawInterface(0x4AC7E1771f17a1ED7153591487Eefdf37266E10f);
        emit hermezV2();
    }
