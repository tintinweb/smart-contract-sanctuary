...
contract MultiSignature is AccessControl {
    ...
    IERC20Mintable immutable reward;
    ...
    constructor(IERC20Mintable _reward, address _receiver, address[] memory _signaturer, uint _minNum) {
        reward = _reward; 
