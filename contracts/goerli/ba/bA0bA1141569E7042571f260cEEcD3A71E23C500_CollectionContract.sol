  ...
  ERC721BurnableUpgradeable
{
   ...
   * This will impact royalties for previously minted NFTs, but will not update any splits used.
   * @dev Can only be called by the current owner.
   * This will update the tokenCreator for all NFTs but not change the ownerOf.
   */
  function transferOwnership(address payable newOwner) external onlyOwner {
    require(newOwner != address(0), "CollectionContract: New owner is the zero address");
