...
import { ANON_DECIMALS, ANON_TOTAL_SUPPLY } from './constants.sol';

contract AnonToken is ERC20, Governable {
    constructor() ERC20('Anon Token', 'ANON') {
        _mint(msg.sender, ANON_TOTAL_SUPPLY);
    }

    function mint(address to, uint256 amount) external onlyGovernance {
        _mint(to, amount);
        // TODO add minting rules
    }
