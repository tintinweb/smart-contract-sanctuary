...
// File: contracts\GFarmNftGoerli.sol
...
contract GFarmNftGoerli is ERC721{
	...
	constructor(GFarmInterface _farm) ERC721("GFarmNFT V2", "GFARM2NFT") public{
		farm = _farm;
	}
    ...
    // GOERLI TEST
    function getNft(uint8 _leverage) correctLeverage(_leverage) external{
    	uint nftID = totalSupply();
		_mint(msg.sender, nftID);
		idToLeverage[nftID] = _leverage;
		supply[leverageID(_leverage)] += 1;
