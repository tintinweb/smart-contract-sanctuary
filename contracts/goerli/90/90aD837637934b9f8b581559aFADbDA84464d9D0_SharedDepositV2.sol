    ...
    WithdrawQueueUpgradeable
{
    ...
    function initialize(
        ...
        // address _blocklistAddress,
        // address _tokenUtilityModuleAddress
        uint256[] calldata configurableUints,
        address[] calldata configurableAddresses
        ...
        // setAdminFee(_adminFee); // Admin and infra fees and 'costPerValidator' set
    ...
    */
        ...
        onlyAdminOrGovernance
    {
        ...
        // address _priceOracleAddress = configurableAddresses[1];
        // address _tokenManagerAddress = configurableAddresses[2];
        // address _blocklistAddress = configurableAddresses[3];
        // address _tokenUtilityModuleAddress = configurableAddresses[4];
        ...
        // require(_priceOracleAddress != address(0), "Price oracle undefined");
        // require(_tokenManagerAddress != address(0), "Tokenmgr undefined");
        // require(_blocklistAddress != address(0), "blocklist undefined");
        // require(_BETHTokenAddress != address(0), "veth2 undefined");
    ...
    function readState()
        external
        view
        returns (uint256[6] memory configurableUints, address[6] memory configurableAddresses)
    {
        ...
        return (
            [validatorsCreated, performanceFeePrct, epochLength, numValidators, adminFee, _depositsEnabled],
            [
