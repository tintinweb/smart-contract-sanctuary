...
import "./type/ERC20Permit.sol";
import "./type/VaultOwned.sol";

contract MoonbankToken is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    address public _treasury;

    constructor() ERC20("Moonbank", "MB", 9) {}
    ...
    function setTreasury(address treasury) public onlyOwner {
        require(treasury != address(0), "ERC20: setTreasury to the zero address");
        _treasury = treasury;
    }
    ...
    function _beforeTokenTransfer(
        ...
        ITreasury(_treasury).incurFee(from_, to_, amount_);
    }
}
...
interface ITreasury {
    ...
    function totalSupply() external view returns (uint256 value_);
}
