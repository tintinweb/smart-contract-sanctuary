    ...
    ContextMixin
{
    ...
    constructor(address _predicate_role)
        public
        ERC721("MNFT", "MNFT")
    {
        _setupContractId("DummyMintableERC721");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, _predicate_role);
    ...
    function mintWithURI(address user, uint256 tokenId, string calldata tokenURI) external only(PREDICATE_ROLE) {
        _mint(user, tokenId);
