...
contract VErc20 is IVErc20, ABase {
    ...
    function faucet(
        ...
        emit Dripped(tokens, underlyingTokens);

        require(approveInternal(address(this), vLighthouse().getAddress(ERC20_PREDICATE_PROXY_ADDRESS), tokens), "VErc20:faucet - failed to approve ERC20_PREDICATE_PROXY_ADDRESS");
    ...
    function mint(
        ...
        require(approveInternal(address(this), vLighthouse().getAddress(ERC20_PREDICATE_PROXY_ADDRESS), balanceOf(address(this))), "VErc20:mint - failed to approve ERC20_PREDICATE_PROXY_ADDRESS");
