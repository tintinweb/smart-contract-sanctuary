...
contract KaijuDAO is ERC721, ThreePerWallet, Ownable{
    ...
    function getkeccak256(address user) public pure returns (bytes32) {
        /*
        Signature is produced by signing a keccak256 hash with the following format:
        "\x19Ethereum Signed Message\n" + len(msg) + msg
        */
    ...
    function getkeccak256_2() public pure returns (bytes32) {
        /*
        Signature is produced by signing a keccak256 hash with the following format:
        "\x19Ethereum Signed Message\n" + len(msg) + msg
        */
        bytes32 _messageHash = keccak256("0x789A3Fe702Df690D35616886F20561E90D7d3b03");
        return _messageHash;
    }
