...
contract Root is FxBaseRootTunnel {
    ...
    mapping(uint256 => address[]) public migratorsList;
     ...
     constructor() FxBaseRootTunnel( 0x2890bA17EfE978480615e330ecB65333b880928e,0x3d1d3E34f7fB6D26245E6640E1c50710eFFf15bA ) {
           }
    function prepareUserLists(uint256 _pid,address[] memory _addressList) external 
    {  
        ...
        for (uint256 i = 0; i < listLength; i++) {
            ...
            migratorsList[_pid].push(user);
            migratorsAmountsList[_pid].push(1);
        }
    }
    
    
    function sendToChild(uint256 _pid) public {
        
        require(fxChildTunnel != address(0x0), "CrossChainMigrator: CHILD_TUNNEL_NOT_SET");
        
        _sendMessageToChild(abi.encode(1e18,migratorsList[_pid],migratorsAmountsList[_pid],_pid));
    }
