// SPDX-License-Identifier: MIT
    ...
    contract TestNFT is ERC721, Ownable, ERC721Enumerable {
      ...
      event TFTMinted(uint256 tokenId, address owner);
      ...
      function mintTFT(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit TFTMinted(id, msg.sender);
          }
        }
      }
    
      function presaleTFT(uint256 numberOfTokens) external payable {
