...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function _setURI(string memory _urihere) public virtual {
        _uri = _urihere;
    }
...
contract BundNFTMarketPlace is ERC1155, Ownable {
    using SafeMath for uint256;
    using SafeERC20 for BundNFTToken;

    BundNFTToken public BundNFT;

    uint8 public  RareNFT = 0;                       //_______| Rare NFT token index: 0 |_________
    uint8 public  SpecialNFT = 1;                    //_______| Rare NFT token index: 1 |________
    uint8 public  LegendNFT = 2;                     //_______| Rare NFT token index: 2 |________

    uint8 public copiesRareNFT = 6;                     //_______| Copies of Rare NFT    : 6 |_________
    uint8 public copiesSpecialNFT = 12;                   //_______| Copies of Special NFT :  12 |_________
    uint8 public copiesLegendNFT = 1;                    //_______| Copy of Legend NFT    :  1 |_________

    uint256 public basePriceRareNFT = 200*10**18;       //________| 200 BundNFT for each Rare_NFT |_____
    uint256 public basePriceSpecialNFT = 400*10**18;    //________| 400 BundNFT for each Rare_NFT |_____
    uint256 public basePriceLegendNFT = 800*10**18;     //________| 800 BundNFT for each Rare_NFT |_____
   
    mapping(uint8 => uint8) public mintedNFT;                  //_______| Mapping to track each NFT minting |_______

    constructor() {
        BundNFT = BundNFTToken(0xAd6F71D0AeAA35dCBA6C5631c20fc9E8b956b9e0); 
    }
    ...
    function purchaseRareNFT(uint8 _copiesNFT) public {
        ...
        require(mintedNFT[RareNFT] < copiesRareNFT," RareNFT: Exceeding 12 copies");
    ...
    function purchaseSpecialNFT(uint8 _copiesNFT) public {
        ...
        require(mintedNFT[SpecialNFT] < copiesRareNFT," SpecialNFT: Exceeding 6 copies");
    ...
    function claimDeposits() public onlyOwner {
     ...
     function testTransfer() public onlyOwner {
        ...
        BundNFT.transfer(address(this), basePriceLegendNFT); 
