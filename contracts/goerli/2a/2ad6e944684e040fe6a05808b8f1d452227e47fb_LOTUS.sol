...
contract LOTUS is Context, IERC20, Ownable { 
    ...
    address payable public _devWalletAddress = payable(0xb6da15a6D99fbbf159068303408DF9457f13E981);
    address payable public _marketingWalletAddress = payable(0xb6da15a6D99fbbf159068303408DF9457f13E981);
    address payable public _developmentWalletAddress = payable(0xb6da15a6D99fbbf159068303408DF9457f13E981);
    address constant public _burnAddress = 0x000000000000000000000000000000000000dEaD;
   
    uint256 public constant MAX = type(uint256).max;
    uint256 public _tTotal = 10000;
    ...
    uint256 private numTokensSellToAddToLiquidity = 6000;
 ...
 function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function calculateReflectionFee(uint256 _amount) public view returns (uint256) {
