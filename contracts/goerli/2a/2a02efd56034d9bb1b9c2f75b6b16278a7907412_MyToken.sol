...
contract MyToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable,AccessControlUpgradeable {
    ...
    //当前每天区块共识奖励
    uint public currConsensusMint=6400*360 ** decimals();
    //共识奖励缩减步长 6400*360
    uint constant _consensusMintStep=6400;
    // 共识mint时间间隔 6400
    ...
    function preMint(address to)  public onlyRole(MINTER_ROLE){
    ...
    /// consensus Mint,
    function consensusMint(address to)public onlyRole(MINTER_ROLE){
    ...
    function updateChildChainManager(address newChildChainManagerProxy) external onlyRole(DEFAULT_ADMIN_ROLE){
        ...
        _grantRole(DEPOSITOR_ROLE,newChildChainManagerProxy);
    }
    /**
