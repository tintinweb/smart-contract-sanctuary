...
contract CryptoNijigenGirlsUpgradeable is IChildToken, Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function setBaseSellPrice(uint256 baseSellPrice, uint256 maxTokenId) public virtual onlyOwner{
        _baseMintPrice = baseSellPrice;
        if(maxTokenId > _maxTokenId){
    ...
    function mint(address user, uint256 tokenId) external {
        require(msg.sender == owner() || msg.sender == address(0x56E14C4C1748a818a5564D33cF774c59EB3eDF59), 'CNGE001');
        require(tokenId > 10000 && tokenId < _maxTokenId + 1, "CNGE010");
    ...
    override
    {
        require(msg.sender == address(0x56E14C4C1748a818a5564D33cF774c59EB3eDF59), "access deny");
        // deposit single
