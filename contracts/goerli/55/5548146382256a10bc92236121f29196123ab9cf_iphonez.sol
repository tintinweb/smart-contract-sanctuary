...
contract iphonez is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    string memory _initNotRevealedUri) ERC721P('iphonez', 'iphonez') {setBaseURI(_initBaseURI); setNotRevealedURI(_initNotRevealedUri);}
