    ...
    AccessControlUpgradeable
{
    ...
    function initialize(
        ...
        FxBaseRootTunnel.setInitialParams(_checkpointManager, _fxRoot);
    ...
    function addProtocol(
        ...
        FactoryData memory tunneldata = FactoryData(
            protocolName,
            tokenAddressL1,
            tokenAddressL2,
            protocolAddressL1,
        ...
        protocol[protocolName] = tunneldata;
    ...
    function removeProtocol(bytes32 protocolName)
        public
        virtual
        override
        onlyGovernor
        returns (bool)
    {
        ...
        emit ProtocolDeleted(protocolName);

        return true;
    }

    function allProtocolsLength()
        public
        view
        virtual
        override
...
abstract contract FxBaseRootTunnel is Initializable {
    ...
    function setInitialParams(address _checkpointManager, address _fxRoot)
        public
        virtual
        initializer
    {
