...
contract Flipstest is Context, IERC20, Ownable {
    ...
    string private _name = "Flipstest";
    string private _symbol = "FTest1";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 2; //(2% liquidityAddition + 2% rewardsDistribution + 2% devExpenses)
