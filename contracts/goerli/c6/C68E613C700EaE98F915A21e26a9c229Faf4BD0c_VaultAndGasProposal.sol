...
contract VaultAndGasProposal is ImmutableGovernanceInformation {
  ...
  function executeProposal() external {
    ...
    */
    ...
    uint256 amountOfTornToAuctionOff = 3 ether;
    ...
    */
    auctionHandler.initializeAuction(block.timestamp + 5 days, uint96(amountOfTornToAuctionOff), 151e16, 0.01 ether, 1 ether);
  }
}
...
contract TornadoAuctionHandler is ImmutableGovernanceInformation {
  ...
  address public constant EasyAuctionAddress = 0x618Ad7805F2c6B9e62023439E003e613709e7396;
