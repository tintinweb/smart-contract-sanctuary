...
contract BadBabies is ERC721Enumerable, Ownable, Pausable {
  ...
  uint256 public _publicSaleDate; //Public sale starts, pre sale ends

  uint256 public _preSaleDate; //Pre sale starts, special ends

  uint256 public _specialSaleDate; //Special Starts
  ...
  constructor(
    ...
    uint256 specialSaleDate_,

    uint256 preSaleDate_,

    uint256 publicSaleDate_
