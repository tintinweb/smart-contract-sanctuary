...
contract Dandelion is ERC721Enumerable, Ownable{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    uint256 public constant NFT_PRICE = 1000000000000000; // 0.001 ETH
    ...
    constructor() ERC721("Dande NFTs", "DNFT"){
    }
    ...
    function mintDande(uint numberOfTokens) public payable {
