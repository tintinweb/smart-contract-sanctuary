...
/**
 * RBK farming LP Pool.  Deposit LP earn RBK.
 * Unlocked farming contract, remove your LP and RBK rewards at anytime.
*/
...
contract RBKPool is IRewardDistributionRecipient, ReentrancyGuard {
    ...
    function recoverLostTokensExceptOurTokens(IERC20 _token, uint256 amount) external onlyOwner {
        // Ensure requested tokens aren't users LP or RBK tokens
    ...
    function enterpool(uint256 amount) external updateReward(msg.sender) noContract(msg.sender) nonReentrant {
