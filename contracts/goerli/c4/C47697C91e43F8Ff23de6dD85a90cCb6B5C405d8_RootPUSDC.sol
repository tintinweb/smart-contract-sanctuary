...
contract RootPUSDC is ERC20, AccessControlMixin, NativeMetaTransaction, ContextMixin, IMintableERC20 {
    bytes32 public constant PREDICATE_ROLE = keccak256('PREDICATE_ROLE');

    constructor(address predicate) public ERC20('RootPUSDC', 'pUSDC') {
        _setupContractId('RootPUSDC');
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, predicate);
        _initializeEIP712('RootPUSDC');
    }
