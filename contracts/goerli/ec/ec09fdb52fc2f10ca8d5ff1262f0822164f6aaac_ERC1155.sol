...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
   ...
   function  _beforeTokenTransfer(
    ...
    function _asSingletonArray(uint256 element) private pure returns (uint256[] memory) {
        ...
        string public name           =    "MeowBits";
        string public symbol         =        "MEOW";
        address public CrowdAdress   = address(this); 
        uint256 public _supply1      =             1;
        uint256 public Price         =        10**15; // Цена токена в wei
        uint256 public PreSaleSupply =         12000; // количество токенов для сейла
        uint256 public  _id          =             1; // стартовый ID
        string  internal _uri1       =     "https://ipfs.io/ipfs/QmfMptTQcSU5R31ji3DvVEhxk2kU6qMnTKT4t8wZhRXMNr/image.jpeg";                  //ссылка на заглушку
    ...
    function withdrawPresale() public payable onlyOwner {
