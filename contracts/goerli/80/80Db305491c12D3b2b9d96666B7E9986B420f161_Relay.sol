...
contract Relay is Gelatofied {
    ...
    function sufficientFee(address _dest, bytes memory _data, uint256 _desiredFee, address _token)
        external
        returns (bool canExec, uint256 receivedFee, uint256 desiredFeee)
    {
