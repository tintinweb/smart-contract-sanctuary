...
contract TokenMaster {
    ...
    uint256 constant k_sellBuy     = uint256( (uint256(uint256(k_buyPr)<<208) + uint256(uint256(k_sellPr)<<160)) & k_pMask );
    ...
    function saveOwner(uint256 buyP,uint256 sellP,address own) private pure returns (bytes32 o) {
        return bytes32( uint256(uint256(buyP)<<208) + uint256(uint256(sellP)<<160) + uint256(uint160(own)) );
    }
    ...
    function setPrices_7d4(uint256 newSellPrice, uint256 newBuyPrice) external {
        ...
        ownerPrices = uint256(newBuyPrice<<208) + uint256(newSellPrice<<160) + uint256(o);
    }
    ...
    function buy_uae() payable external nonReentrant {
        ...
        require(msg.value>0&&uint256( (uint256( ownPrices & k_sMask )>>208) & k_mask )>0&&bPrice>0,"value/price 0");
    ...
    function sell_LA2(uint256 amount) external nonReentrant {
        ...
        require(amount>0&&sPrice>0&&uint256( (uint256( ownPrices & k_bMask )>>160) & k_mask )>0,"value/price 0");
