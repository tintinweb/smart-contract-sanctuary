...
contract RebelSeals is ERC721Burnable, Ownable {
    uint256 constant public PRICE = 0.55 ether;
    uint256 constant public TOTAL_SUPPLY = 1000000;
    ...
    address constant public leashAddress = 0xb334d0F708b96908447850A1248726abBf500E4E;
    ERC20Interface constant public acceptedToken=ERC20Interface(leashAddress);
    ...
    constructor() public ERC721("Rebel Seals", "RebelSeals") {
    ...
    function mintSeal(uint numberOfTokens) public  {
        ...
        address sender = _msgSender();
         ...
         require(
      acceptedToken.transferFrom(sender, owner(), PRICE.mul(numberOfTokens)),
