...
import "./interfaces/IUranium.sol";
...
contract PlutoniumV2 is BoringOwnable, BoringBatchable {
...
interface IUranium {
    ...
    function poolInfo(uint256 pid) external view returns (IUranium.PoolInfo memory);
