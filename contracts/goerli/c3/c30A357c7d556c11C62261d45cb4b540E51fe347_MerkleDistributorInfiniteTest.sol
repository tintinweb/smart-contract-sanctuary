...
contract MerkleDistributorInfiniteTest is IMerkleDistributor, Ownable {
    ...
    // Change the Merkle root to allow moar claims (only used in testing), reset the claim status
