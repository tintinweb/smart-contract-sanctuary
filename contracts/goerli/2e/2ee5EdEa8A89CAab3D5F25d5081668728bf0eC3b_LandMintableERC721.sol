...
contract LandMintableERC721 is
    ERC721,
    AccessControlMixin,
    ...
    ContextMixin
{
    ...
    constructor(
        ...
        address _predicateRole
    ) public ERC721(_name, _symbol) {
        _setupContractId("LandMintableERC721");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, _predicateRole);
        _initializeEIP712(_name);
        predicateRole = _predicateRole;
    }
