...
contract BatchDeposit is Pausable {
     ...
     *  @notice failsafe in case change is required
     *  @param _depositContract The deposit contract to be pointing to
     *  @dev Updates deposit contract address (only governance)
     **/
