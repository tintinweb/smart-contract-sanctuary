...
contract TribeCoin is ERC20, Pausable, Ownable {

    bool public mintFrozen = false;

    constructor () ERC20("TribeCoin", "TRIBE") {

    }

    function mintTribeCoin(address account, uint256 amount) public onlyOwner returns (bool) {
