...
// File: contracts/Silly Alien.sol
...
contract SillyAlien_flat is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SillyAlien", "SA") {
    setHiddenMetadataUri("ipfs://QmccWDM7rY7BZwjEsNUWUyngDurYY6tpHn1ycvVBZXnvdw/hidden.json");
  }
