...
contract yethi is ERC20, Ownable {
    constructor ()
    public
    ERC20 ("Yethiswap", "yethi", 18) {
 ...
 */
contract Pausable is Context,yethi{
    /**
...
contract yethitoken is Context,yethi {
     uint256 public constant MAX_CAP =  0 * (10**18);
