...
contract DelegateProxyForwarder {
    ...
    function isAContract(address _target) internal view returns (bool) {
...
contract UpgradableProxy is DelegateProxy {
    ...
    function updateImplementation(address _newProxyTo) public onlyProxyOwner {
        ...
        require(isAContract(_newProxyTo), "DESTINATION_ADDRESS_IS_NOT_A_CONTRACT");
    ...
    StakeManagerStorageExtension
{
    ...
    function initialize(
        ...
        require(isAContract(_extensionCode), "auction impl incorrect");
    ...
    function reinitialize(
        ...
        require(isAContract(_extensionCode));
 ...
 */
    ...
    function _increaseRewardAndAssertConsensus(
        ...
        require(signedStakePower >= currentTotalStake.div(2), "2/3+1 non-majority!");
