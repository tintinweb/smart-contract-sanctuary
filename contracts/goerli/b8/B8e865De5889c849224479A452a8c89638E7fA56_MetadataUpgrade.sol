...
// File: contracts/token/upgrade/tst/MetadataUpgrade.sol
...
contract MetadataUpgrade is SygnumToken {
    string public tokenURI;
    bool public initializedMetadataUpgrade;

    // changed back to public for tests
    function init(string memory _tokenURI) public {
        require(!initializedMetadataUpgrade, "MetadataUpgrade: already initialized");
        tokenURI = _tokenURI;
