...
contract SharedDeposit is Pausable, ReentrancyGuard {
    ...
    uint256 public withdrawalFeeTotal;
    ...
    constructor(uint256 _numValidators, uint256 _adminFee, address _BETHTokenAddress, uint256 _withdrawalFee) public {
    ...
    */
    ...
    function withdraw(uint256 amount) public nonReentrant whenNotPaused {
        //TODO: check if there's enough for admin fees before allowing withdrawal
        require(address(this).balance > adminFeeTotal, "Not enough ETH in contract for admin fees");
        ...
        //check if withdraw fee is > 0, if it is, deduct the amount from the amount to give back
        ...
        withdrawalFeeTotal = withdrawalFeeTotal + amount*(withdrawalFee/100);
