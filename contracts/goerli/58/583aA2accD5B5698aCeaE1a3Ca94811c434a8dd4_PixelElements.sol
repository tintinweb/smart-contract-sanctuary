...
contract PixelElements is ERC721Enumerable, Ownable {
    ...
    //code to reference Pixel Planets
    ERC721 planets = ERC721(0xB8040C0129DbDe65571F0de76BE93E7c319767e0);
    ...
    constructor(address planetAddress) 
        ERC721("PixelElements","PixelElements")
    {
        planets = ERC721(planetAddress);
    }
