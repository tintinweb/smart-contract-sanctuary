...
contract ANON_INU_COIN is Context, IERC20, Ownable {
    ...
    uint256 public startBurnAmount;
    ...
    constructor () {
        ...
        nextBurnDate = block.timestamp + 3 minutes;
