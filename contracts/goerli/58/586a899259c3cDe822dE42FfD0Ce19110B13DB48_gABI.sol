...
contract gABI is IgABI, ERC20 {
     ...
     * @param _sABI address
     */
    function initialize(address _staking, address _sABI) external override onlyApproved {
        ...
        approved = _staking;
        require(_sABI != address(0), "Zero address found");
        sABI = IsABI(_sABI);
    }
    ...
    /**
     * @notice pull index from sABI token
     */
    ...
    /**
        @notice converts gABI amount to ABI
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts ABI amount to gABI
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gABI::getPriorVotes: not yet determined");
