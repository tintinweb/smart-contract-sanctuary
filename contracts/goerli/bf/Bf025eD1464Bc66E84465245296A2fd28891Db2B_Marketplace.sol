...
// File: ../marketplace/MarketplaceStorage.sol
...
interface ERC721Verifiable is ERC721Interface {
  function verifyFingerprint(uint256, bytes calldata) external view returns (bool);
}
...
contract Marketplace is Ownable, Pausable, MarketplaceStorage, NativeMetaTransaction {
  ...
  {
    // EIP712 init
    _initializeEIP712('Decentraland Marketplace');
