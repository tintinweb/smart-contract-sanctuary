...
*/
    ...
    function mintAllowList(uint8 numberOfTokens) external payable {
        ...
        require(ts + numberOfTokens <= MAX_Token, "Purchase would exceed max tokens");
...
*/
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        TestContract_PROVENANCE = provenanceHash;
    }
...
*/
    ...
    function reserveTokens(address [] memory _to) public onlyOwner {        
        uint supply = totalSupply();
        require(_to.length > 0 && _to.length <= TokenReserve, "Not enough reserve left for team");
        for (uint i = 0; i < _to.length; i++) {
            _safeMint(_to[i], supply + i);
        }
        TokenReserve = TokenReserve.sub(_to.length);
    }
...
*/
    // withdraw addresses
    address t1 = 0xDb94Daa8bF1b6F45B122F442F922a2C4DD2F7aDe; //TEST
