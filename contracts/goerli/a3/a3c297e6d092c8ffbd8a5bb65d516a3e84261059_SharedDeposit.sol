...
contract SharedDeposit is Pausable, ReentrancyGuard {
    ...
    using SafeMath for uint256;
    /* ========== STATE VARIABLES ========== */
    address public constant mainnetDepositContractAddress =  0x8c5fecdC472E27Bc447696F431E425D02dd46a8c;
    ...
    */
    ...
    function deposit() public payable nonReentrant whenNotPaused {
        ...
        uint256 myAdminFee =
            adminFee.mul(value).div(32).div(1e18);
