...
contract SuPPhunks is ERC721, Ownable {
    ...
    uint256 public maxMintPlusOne = 13;
    ...
    // set before deploy
    // bytes public merkleRoot = 0xbb8d2b7385b70b65255cc48538ba18180d320ac6ee084d1ab54a993a234a9e27
    ...
    // for our supPhunks
    function mintOgSupp(uint256 _mintAmount)
        public
        payable
        mintRequirements(_mintAmount)
    {
    ...
    function withdrawBetter() public payable onlyOwner {
        // here we pay our team(8% per team member)
        // uint256 paycheck = (address(this).balance * 80) / 1000;
        // payable(matty).transfer(paycheck);
        // payable(dude).transfer(paycheck);
