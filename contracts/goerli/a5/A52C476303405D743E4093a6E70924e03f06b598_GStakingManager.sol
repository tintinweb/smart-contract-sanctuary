...
contract GStakingManager is AccessControl, ReentrancyGuard {
    ...
    function _updateUserReward(
        ...
        updatePool(pid, stakeType);
        console.log("======================== start");
        console.log(pool.accRewardPerShare[stakeType]);
        console.log((userAmountByType * pool.accRewardPerShare[stakeType]) / ACCUMULATED_MULTIPLIER);
        console.log(staker.nftInGpoolAmount);
        console.log(userAmountByType);
        console.log(amount);
        console.log(userAmountByType * pool.accRewardPerShare[stakeType] / ACCUMULATED_MULTIPLIER);
        console.log(user.rewardDebt[stakeType]);
        console.log("======================== end");
    ...
    function pendingReward(uint256 pid, address userAddress) public view validatePoolById(pid) returns (uint256) {
        ...
        console.log("pending rw");
        console.log("close time", pool.closeTime );
        console.log("endTime", endTime);
        console.log("block time", block.timestamp);
        console.log(pool.lastRewardSecond[StakeType.GPOOL]);
        console.log(pool.lastRewardSecond[StakeType.NFT]);
        console.log(user.rewardDebt[StakeType.GPOOL]);
        console.log(user.rewardDebt[StakeType.NFT]);
        console.log(pool.accRewardPerShare[StakeType.GPOOL]);
        console.log(pool.accRewardPerShare[StakeType.NFT]);
        console.log("end pending rw");
        // gpool
    ...
    function updatePool(uint256 pid, StakeType stakeType) public validatePoolById(pid) {
        ...
        uint256 endTime = pool.closeTime < block.timestamp ? pool.closeTime : block.timestamp;
        console.log(endTime);
        console.log(pool.lastRewardSecond[stakeType]);
