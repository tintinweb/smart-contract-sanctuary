...
contract DssSpellAction is DssAction {
    ...
    function actions() public override {
        ...
        DssVestLike_1(MCD_VEST_DAI).create(address(this), WAD     , block.timestamp - 1 days, 1 days, 0, address(0));
        DssVestLike_1(MCD_VEST_MKR).create(address(this), WAD / 10, block.timestamp - 1 days, 1 days, 0, address(0));
