...
contract ContractRegistry is Ownable, IContractRegistry {
    ...
    function setProjectCollectionAddress(address _address) external onlyOwner {
    ...
    function setProjectERC20FactoryAddress(address _address) external onlyOwner {
        require(_address!=address(0), "Error: zero address provided");
        _ProjectERC20FactoryAddress = _address;
    }

    function setRetirementBadgeCollectionAddress(address _address) external onlyOwner {
        require(_address!=address(0), "Error: zero address provided");
