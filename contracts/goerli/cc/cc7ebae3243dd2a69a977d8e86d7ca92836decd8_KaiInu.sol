...
contract KaiInu is Context, IERC20, Ownable {
    ...
    string private _name = "CashDogTest1";
    string private _symbol = "CASHDOGT1";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 10; //(2% liquidityAddition + 2% rewardsDistribution + 6% devExpenses)
