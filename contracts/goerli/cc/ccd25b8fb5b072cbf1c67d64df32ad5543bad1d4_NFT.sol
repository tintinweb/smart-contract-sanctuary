...
contract NFT is ERC721,BaseRootTunnel {

    address RootChainManager = 0x8829EC24A1BcaCdcF4a3CBDE3A4498172e9FCDcE;
    address RootChainManagerProxy = 0xBbD7cBFA79faee899Eaf900F13C9065bF03B1A74;
    
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() public ERC721("Non-Fungible Polygon V2", "NFP") {}
    ...
    modifier onlyRoot {
        require(
            msg.sender == RootChainManager || msg.sender == RootChainManagerProxy ,
            "Only RootChain can call this function."
        );
        _;
    }

    function passURIToChild(uint256 id_ ) public onlyRoot {

        _sendMessageToChild( abi.encode(id_, tokenURI(id_))  );
    }

    function _processMessageFromChild(bytes memory message) virtual internal override {
        // no-op, overriding function because parent contract has no implementation and must be implemented
    }
