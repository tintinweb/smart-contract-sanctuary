...
contract RootTunnel is FxBaseRootTunnel {
    ...
    event Withdraw(address indexed childToken, uint256 amount);
    ...
    function deposit(uint256 amount) external {
        ...
        bytes memory message = abi.encode(DEPOSIT, abi.encode(msg.sender, amount));
    ...
    function withdraw(uint256 _amount) external {
        bytes memory message = abi.encode(WITHDRAW, abi.encode(msg.sender, _amount));
