...
contract MyToad2 is ERC721Enumerable, Ownable {
    uint256 private _price = 22 * 10**15; //0.022 ETH;
    uint public constant MAX_ENTRIES = 10000;
    bool public _paused = false;
    uint256 private _maxMint = 40;
    string _baseTokenURI;

    constructor(string memory baseURI) ERC721("MyToad2", "MyToad2")
    { 
        setBaseURI(baseURI); 
    }
        ...
        public payable
    {
        ...
        if(msg.sender != owner()) {
            ...
            require( quantity < (_maxMint+1),"You can adopt a maximum of _maxMint Toads" );
