...
import { TokenAddress, VestingPoolsAddress, PrivacyStakingAddress, RootChainManagerAddress, RootChainManagerProxyAddress } from "./utils/Linking.sol";
...
contract RewardPool is OwnableUpgradeable, IRewardPool {
    ...
    // Percentage value for bridging in the vested amount
    uint8 public constant bridgePercent = 50;
    ...
    // @notice Returns address of RootChainManager smart contract address
    function rootChainManager() external view override returns (address) {
        return address(_getRootChainManager());
    }

    // @notice Returns address of RootChainManagerProxy smart contract address
    function rootChainManagerProxy() external pure override returns (address) {
        return address(RootChainManagerProxyAddress);
    }

    // @notice Returns address of Privacy Staking address
    function privacyStaking() external pure override returns (address) {
        return address(PrivacyStakingAddress);
    }
...
interface IRewardPool {
    ...
    /**
     * @notice Returns Privacy Staking address.
     */
    function privacyStaking() external view returns (address);
    ...
    /**
     * @notice Returns RootChainManagerProxy contract address.
     */
    function rootChainManagerProxy() external view returns (address);
