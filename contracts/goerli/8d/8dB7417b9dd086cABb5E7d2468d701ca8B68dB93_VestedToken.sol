...
library VestedTokenConstants {
    ...
    address private constant _tokenOwner = 0xF5E1cA50Da44bF3CD71856Eb861Bda320AfFd396;
...
contract VestedToken is Context, IERC20, Ownable {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "VTKN: transfer amount exceeds allowance"));
        return true;
    }
