...
contract GlobalChainFarming is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Global Chain Farming";
    string private constant _symbol = "GCF";
    ...
    address payable public marketingWallet = payable(0x0685B056096F637b68e1213cD9408CFa6B873b86);
    address payable public treasury = payable(0x2472B47a77E2656bd03b24863978e7829Bd739cC);
