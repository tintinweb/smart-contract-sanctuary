...
contract Business{
    ...
    function upsale(uint256 _tokenId,uint256 _price,address _reciveToken) public  payable{
        ...
        TransferHelper.safeTransferFrom(snftaddress, msg.sender,address(this),_tokenId);
    ...
    function  downsale(uint256 _tokenId) public  payable{
     ...
     function buyOne(uint256 _tokenId,uint256 _sid) public  payable  {
        ...
        address snftaddress = nameAddr("SNFT");
        TransferHelper.safeTransferFrom(snftaddress,address(this),msg.sender,_tokenId);
