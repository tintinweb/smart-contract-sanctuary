...
//
// Twitter: https://twitter.com/ghostwritersguild
//
// Project by:      @tushur
//
...
contract Ghostwritersguild is ERC721Burnable, Ownable {
    ...
    // Team
    address public constant tusuhua = 0xf25ceeAaf6E26CcB9F5DEaa6ba9D4dbC667A296f;

    // Glitches
    string public baseUri = 'https://api.ghostwritersguild.art/json/';
    ...
    constructor() ERC721("Ghostwritersguild", "GG") {
        ...
        //     _tokenIds.increment();
        //     _safeMint(tusuhua, _tokenIds.current());
        // }
    }
    ...
    */
    function minGhostwritersguild() public payable {
    ...
    */
    function withdraw() public payable onlyOwner {
        ...
        require(payable(tusuhua).send(_each));
    }
