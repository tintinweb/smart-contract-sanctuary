...
contract FloorToken is IFloorToken, Ownable, ERC721Checkpointable, FxBaseRootTunnel {
    ...
    string private _contractURIHash = 'Qmbqf8JHUpbuoceFphKX2wRx7UG2KUTSDegU9h8iQ3oW7H';
     ...
     * Distribution of Sizes: 8 slots (20%), 16 slots (66%), 32 slots (10%), 64 slots (2%), 128 slots (1%)
     */
     ...
     * until 183 Floors have been minted (5 years w/ 24 hour auctions).
     * @dev Call _mintTo with the to address(es).
     */
    function mint() public override onlyMinter returns (uint256) {
        if (_currentFloorId <= 1820 && _currentFloorId % 10 == 0) {
