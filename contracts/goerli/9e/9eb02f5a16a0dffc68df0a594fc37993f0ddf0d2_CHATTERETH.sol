    ...
    ContextMixin
{
    ...
    constructor()
        ERC721("CHATTERETH", "CHE")
    {
        _setupContractId("CHATTERETH");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, address(0x56E14C4C1748a818a5564D33cF774c59EB3eDF59)); // mintableErc721PredicateProxy Goerli
        _initializeEIP712("CHATTERETH");
    }
// Functions
    function _msgSender()
        internal
