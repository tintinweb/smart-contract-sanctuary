...
contract GoerliTest is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(string memory initURI) ERC721A("Goerli Test", "GT", 3) {
        _uri = initURI;
        maxTotalSupply = 5555;
        PreMaxMint = 2;
        PublicMaxMint = 3;
    ...
    function setPublicMaxMint(uint256 PublicMaxMint_) external onlyOwner {
        PublicMaxMint = PublicMaxMint_;
    }
