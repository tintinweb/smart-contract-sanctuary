            ...
            if (paprPrice > paprPriceCeiling) {
                ...
                if (seigniorageSaved >= inkSupply.mul(inkDepletionFloorPercent).div(10000)) {
                   ...
                   // _savedForBoardRoom = percentCombined;
                    ...
                    uint256 ratio2 = inksPrintingRatioMultiplier.mul(1e14);
                    uint256 ratio3 = ratio2.mul(_countTimesOverCents());
                    uint256 percentCombined2 = _percentage.add(ratio3);
                    uint256 _seigniorage = paprSupply.mul(percentCombined2).div(1e18);
