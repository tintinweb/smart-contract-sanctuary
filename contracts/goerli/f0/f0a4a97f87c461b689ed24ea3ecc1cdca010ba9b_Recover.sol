...
contract Recover is Initializable, NativeMetaTransaction, ChainConstants, ContextMixin, IArbitrable {
    ...
    function addItem(
        ...
        owners[_msgSender()].itemIDs.push(_itemID);
    ...
    function acceptClaim(uint _claimID) payable public {
        ...
        // NOTE: Native meta-transactions are not available for this method because of `msg.value`.
    ...
    /* Note: We don't use the native meta-transactions feature for this section */
