...
contract TokenLocker {
    ...
    */
    function createMultipleLocks(
      ...
      uint256[] memory _unlockTimes
        ...
        require(_amounts.length == _unlockTimes.length, "amounts and unlockTimes must be of same length");

        uint256 i;
        for(i = 0; i < _amounts.length; i++){
            require(_amounts[i] > 0, "lock amount must be greater than zero");
            require(_unlockTimes[i] > block.timestamp, "unlock time must be in the future");
    ...
    */
    function withdrawTokens(uint256 _id) public {
        ...
        require(!lockedToken[_id].withdrawn, "token is already withdrawn");
