...
contract okb is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "okb"; // token name
    string private _symbol = "okb"; // token symbol
    ...
    uint256 public _buyBackFee = 70; // buyback fee 12%
    ...
    uint256 public _maxTxAmount = _tTotal.div(4000); // max allowed tokens tranfer per transaction
    uint256 public _minTokensSwapToAndTransferTo = 4000 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
