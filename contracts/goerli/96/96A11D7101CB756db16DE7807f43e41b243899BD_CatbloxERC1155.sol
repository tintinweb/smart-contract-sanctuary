...
contract CatbloxERC1155 is AccessControl, ERC1155Supply {
     ...
     *  Events
     */
    event DailyLimitChange(uint256 indexed dailyLimit);
    ...
    function uri(
        ...
        return string(abi.encodePacked(baseURI, tokenCIDs[_id]));
    }
    ...
    */
    ...
    /**
        ...
        * @param _CID URI for this token type
    ...
    */
    function create(
        ...
        uint256 _id = currentTokenID.add(1);
        currentTokenID++;
    ...
    **/
    ...
    function isUnderLimit() internal returns (bool) {
