 ...
 */
contract VolmexToken is GovernancePowerDelegationERC20 {
  ...
  /// @dev the amount being distributed among power holders
  uint256 internal constant TOTAL_AMOUNT = 1000000000 ether;
...
/**
 * @title GovernancePowerDelegationERC20 contract
 * @notice implementation of the VOLX token contract
 * @author volmex.finance [[email protected]]
 */
