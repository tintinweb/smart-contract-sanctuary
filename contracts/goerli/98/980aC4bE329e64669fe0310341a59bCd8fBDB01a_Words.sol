...
library Base64 {
    ...
    function encode(bytes32 _bs) internal pure returns (string memory) {
...
contract Words is ERC721, Ownable, ERC721Enumerable {
    ...
    function mintWords(uint256 numberOfTokens, bytes32[10] memory newTokenURIs)
        public
        payable
    {
        require(
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            tokenURIs[tokenId] = newTokenURIs[i];
        }
    }
    ...
    function setTokenURI(uint256 tokenId, bytes32 newTokenUri)
        public
        onlyOwner
    {
