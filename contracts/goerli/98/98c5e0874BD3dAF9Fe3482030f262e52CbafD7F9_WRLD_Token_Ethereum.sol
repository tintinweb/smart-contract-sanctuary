...
contract WRLD_Token_Ethereum is
  ERC20, ERC20Capped, AccessControlMixin,
  NativeMetaTransaction, ContextMixin,
  IMintableERC20
{
  bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

  constructor(address predicateManager)
  ERC20("NFT Worlds", "WRLD")
  ERC20Capped(5000000000 ether) {
    _setupContractId("WRLD_Token_Ethereum");
    _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    _setupRole(PREDICATE_ROLE, predicateManager);
    _initializeEIP712("NFT Worlds");
  }
