...
contract rMutantCoin is ERC20Burnable, Ownable {
    ...
    uint256 public _demonBaseRate = 85 ether;
    uint256 public _mummyBaseRate = 34 ether;
    uint256 public _apeZombieBaseRate = 9 ether;
    uint256 public _otherBaseRate = 0.5 ether;
    //(((10000 - (9+24+88))*0.35) + (5*88) + (20*24) + (60*9)) * 365 * 3 = 5,007,051 total ~ 5% of total supply.
    //(((10000 - (9+24+88))*0.5) + (9*88) + (34*24) + (85*9)) * 365 * 3 = 8,007,187 total ~8% of total supply.
