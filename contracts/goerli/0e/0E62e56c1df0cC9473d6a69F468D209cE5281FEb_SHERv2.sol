...
contract SHERv2 is ERC20PresetMinterPauserUpgradeable {
  // function doesn't make any sense, just for proxy testing purposes
  function pause() public virtual override {
    _mint(msg.sender, 10**18);
    super._pause();
  }

  function meme() external view returns (uint256) {
    return 69;
  }

  function bigMeme() external view returns (uint256) {
    return 420;
  }
}
