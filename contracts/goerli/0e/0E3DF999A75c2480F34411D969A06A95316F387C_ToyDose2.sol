...
contract ToyDose2 is ERC20WithOperators {

    // solhint-disable-next-line const-name-snakecase
    string private constant local_name = "TOYDOSE_2";
    // solhint-disable-next-line const-name-snakecase
    string private constant local_symbol = "TOYDOSE_2";

    constructor(address[] memory holders, uint256[] memory amounts) ERC20WithOperators(local_name, local_symbol) {
        require(holders.length == amounts.length, "TOYDOSE_2: wrong arguments");
