...
contract MapV2 is ERC721Enumerable, ReentrancyGuard, Ownable {
    MapInterface immutable mapV1;

    constructor(MapInterface v1Address) ERC721("Maps", "MAP") {
        mapV1 = v1Address;
    }
    ...
    function claimMapV2(uint256[] memory tokenIds) public nonReentrant {
