...
contract Drops is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Drop #', toString(tokenId), '", "description": "Drops are randomized traits generated and stored on chain. Images are intentionally omitted for others to interpret. Feel free to use Drops in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    constructor() ERC721("Drops", "DROP") Ownable() {}
}