// File: witnet-ethereum-bridge/contracts/interfaces/IWitnetRequestBoardEvents.sol
...
// File: witnet-ethereum-bridge/contracts/interfaces/IWitnetRequestBoardReporter.sol
...
// File: witnet-ethereum-bridge/contracts/interfaces/IWitnetRequest.sol
...
// File: witnet-ethereum-bridge/contracts/libs/Witnet.sol
...
// File: witnet-ethereum-bridge/contracts/interfaces/IWitnetRequestBoardRequestor.sol
...
// File: witnet-ethereum-bridge/contracts/interfaces/IWitnetRequestBoardView.sol
...
// File: witnet-ethereum-bridge/contracts/interfaces/IWitnetRequestParser.sol
...
// File: witnet-ethereum-bridge/contracts/WitnetRequestBoard.sol
...
// File: witnet-ethereum-bridge/contracts/requests/WitnetRequestBase.sol

abstract contract WitnetRequestBase is IWitnetRequest {
...
// File: witnet-ethereum-bridge/contracts/requests/WitnetRequest.sol

contract WitnetRequest is WitnetRequestBase {
...
contract Monetizer is UsingWitnet {
  // prettier-ignore
  struct Video {
    bool            notEmpty;        // whetherthe agreement is empty or not
    string          id;              // ID of the YouTube video
    address         depositor;       // the depositor's adress
    address payable beneficiary;     // the beneficiary's address
  ...
  function deposit(
    ...
    videos[_id] = Video(
      ...
      msg.sender,
      _beneficiary,
      _lockTime + uint64(block.timestamp),
      _targetViewCount,
      msg.value,
      0
    );
