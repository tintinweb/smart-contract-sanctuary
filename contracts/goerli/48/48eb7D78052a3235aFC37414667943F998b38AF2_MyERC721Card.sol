...
contract MyERC721Card is ERC721{
    ...
    /* --- Array para guardar CARTAS unicas --- */ 
    ...
    /* --- Funcion para generar nuevas CARTAS para un nombre (name) y destinatario (account) determinados --- */ 
    function mintCard(string memory _name, address _account) public {
