...
contract fg is IBEP20, Auth {
    ...
    // Anti-Bot v2
    uint256 public maxRoomRent = 80000000000000000;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**22 * 10**_decimals;
    uint256 public swapThreshold = rSupply * 10 / 100000000000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf30A25185d58614DB81CB6e6A88e9A5fAf50960A;
        devFeeReceiver = 0xAbc88dC6c749c5Ab499ff69C113543D6C9Bc1D09;
