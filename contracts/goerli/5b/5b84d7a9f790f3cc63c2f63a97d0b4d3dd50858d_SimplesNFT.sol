...
uint256 amountFounder = address(this).balance * 37 / 100;
uint256 amountArtist = address(this).balance * 37 / 100;
uint256 amountCommunity = address(this).balance * 18 / 100;
    ...
    require(artist);
    (bool community, ) = payable(0x37cC41fF7f1569365216D9E01231dE1B656bBBFD).call{value: amountCommunity}("");
    require(community);
    // =============================================================================
