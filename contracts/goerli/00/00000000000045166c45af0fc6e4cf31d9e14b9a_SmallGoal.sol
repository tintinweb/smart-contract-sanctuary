...
/* "SmallGoal" is a crypto artwork created by Liu Jiaying (ZR) in June 2020. "SmallGoal" is a fable about "100 Million"

You can send at least 1ETH to get SG at exchange rate of 1ETH = 100M SG
*/
...
contract SmallGoal is Ownable,ERC20 {
    ...
    /// Send at least 1ETH to get small goal at exchange rate of 1ETH = 100,000,000 SG
    receive() external payable {
        require(msg.value>= 1 ether,"send at least 1ETH to get small goal");
