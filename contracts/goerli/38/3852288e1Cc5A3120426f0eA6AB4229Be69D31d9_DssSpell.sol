...
contract DssSpellAction is DssAction {
    ...
    function actions() public override {
        ...
        DssVestLike_1(MCD_VEST_DAI).restrict(
            DssVestLike_1(MCD_VEST_DAI).create(TOP_UP1, 10.00 * 10**18 * duration / 1 days, block.timestamp, duration, 0, address(0))
        );
        DssVestLike_1(MCD_VEST_DAI).restrict(
            DssVestLike_1(MCD_VEST_DAI).create(TOP_UP2, 10.00 * 10**18 * duration / 1 days, block.timestamp, duration, 0, address(0))
        );
    }
}
