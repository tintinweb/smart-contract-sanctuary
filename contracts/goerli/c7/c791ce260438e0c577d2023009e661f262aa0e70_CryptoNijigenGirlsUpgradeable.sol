...
contract CryptoNijigenGirlsUpgradeable is Initializable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        ...
        __Ownable_init();
        setURI("https://werewolf-resource.53site.com/NFT/api/item/CNG");
        _baseMintPrice = 0.05 ether;
        for(uint256 i = 10001; i<17778; i++){
            _tokenPrice[i]=_baseMintPrice;
        }
    }
    ...
    function setURI(string memory newuri) public virtual onlyOwner{
        ...
        for(uint256 i =0 ; i<_tokenIds.length ; i++){
            _setTokenURI(_tokenIds[i], uri(_tokenIds[i]));
        }
    }
