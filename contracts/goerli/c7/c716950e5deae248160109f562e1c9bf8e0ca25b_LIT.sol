...
contract LIT is ERC1155, ContextMixin, NativeMetaTransaction {
    ...
    // constructor() ERC1155("https://mintlit.com/metadata/kovan/{id}") {
    // constructor() ERC1155("https://mintlit.com/metadata/mumbai/{id}") {
    constructor() ERC1155("https://mintlit.com/metadata/goerli/{id}") {
        admin = msg.sender;
