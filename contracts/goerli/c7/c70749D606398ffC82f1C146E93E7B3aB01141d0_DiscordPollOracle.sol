...
contract DiscordPollOracle is UsingWitnet {
  ...
  function checkResult(string calldata _id) external payable ended(_id) {
    ...
    WitnetRequest request = new WitnetRequest(
      bytes(
        abi.encodePacked(
          hex"0a5e08d8aeeb8b061240122f68747470733a2f2f766f74696e672e6775696c642e78797a2f6170692f7265616374732f",
          _id,
          hex"1a0d82187782186766726573756c741a090a050808120180100222090a050808120180100210c0843d180a20e80728333080c8afa025"
        )
      )
    );
