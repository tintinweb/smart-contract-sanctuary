...
contract iphone is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    string memory _initNotRevealedUri) ERC721P('iphone', 'iphone') {setBaseURI(_initBaseURI); setNotRevealedURI(_initNotRevealedUri);}
