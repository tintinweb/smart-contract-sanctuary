...
contract Mining is Ownable {
    ...
    /**
     * @dev Stake all available tokens
     */
    ...
    /**
     * @dev Refund all staked tokens for `account`
     */
    function refundAll(address account) external onlyOwner {
        _unstake(account, _stakings[account]);
    }
