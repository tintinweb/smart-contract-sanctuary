...
// File contracts/common/IERC721Mintable.sol
...
interface IERC721Mintable is IERC721 {
    ...
    function mint(address user, uint256 tokenId, string memory tokenURI) external;
...
// File contracts/common/lib/RLPReader.sol
...
// File contracts/common/tunnel/FxBaseRootTunnel.sol
...
// File contracts/ethereum/MoonieNFT.sol
    ...
    FxBaseRootTunnel
{
    ...
    event Burned(uint256 indexed tokenId, string indexed tokenURI);
    ...
    function _burn(uint256 tokenId) internal virtual override(ERC721, ERC721URIStorage) {
        emit Burned(tokenId, tokenURI(tokenId));
        super._burn(tokenId);
    }
