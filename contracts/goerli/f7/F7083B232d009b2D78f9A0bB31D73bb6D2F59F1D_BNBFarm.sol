...
contract BNBFarm is Ownable {
    ...
    uint256 public constant LAUNCH_TIME = 1618136441;
    ...
    investmentPlans_.push(Objects.Plan(50, TIME_STEP.mul(75))); //20 days
    ...
    function withdraw() public payable {
        ...
        require (block.timestamp >= uid2Investor[uid].checkpoint.add(DAY.mul(3).div(3)), "Withdraw every 24 hours");
