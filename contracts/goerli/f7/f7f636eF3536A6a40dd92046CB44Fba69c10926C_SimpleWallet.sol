...
contract SimpleWallet is IWallet {
	...
	event CalledFromEntryPoint(address indexed caller);
	...
	function verifyUserOp(UserOperation calldata userOp, uint256 requiredPrefund) external override {
		_requireFromEntryPoint();
		emit CalledFromEntryPoint(msg.sender);
	...
	function _rsv(bytes calldata signature)
		internal
		pure
		returns (
			bytes32 r,
