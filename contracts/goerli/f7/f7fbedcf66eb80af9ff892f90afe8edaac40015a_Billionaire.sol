...
/**
    FairMoon, but fixed. See comment where numTokensSellToAddToLiquidity is declared.
    
    
    P.S.: This contract has NOT been audited by WoR which makes zero difference regarding safety.
 */
...
contract Billionaire is Context, IERC20, Ownable {
    ...
    string private _name = "Billionaire Coin";
