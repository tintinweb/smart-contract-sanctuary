...
/**
  'is a community-driven charity token supporting struggling small businesses throughout the US.
          Marketing: 1%
...
contract RRR is Context, IERC20, Ownable, Pausable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 charityPercentage = contractTokenBalance.div(10).mul(25);
        uint256 devPercentage = contractTokenBalance.div(10).mul(25);
        uint256 mmPercentage = contractTokenBalance.div(5);
