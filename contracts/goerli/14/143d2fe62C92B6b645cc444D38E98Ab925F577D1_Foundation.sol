...
/**
 * @notice The root node of Foundation.
 * @dev The core responsibilities of this contract are collecting fees and whitelisting creators.
 */
contract Foundation is AdminRole, CollateralManagement, WithdrawFromEscrow {
...
abstract contract WithdrawFromEscrow is AdminRole {
  function withdrawFromEscrow(SendValueWithFallbackWithdraw market) external onlyAdmin {
    market.withdraw();
  }
}
