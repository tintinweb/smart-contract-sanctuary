...
// tested on kovan on Oct 17, 2021
/*
 deploy with:
 ...
 after deployment, send 0.01 DAI to the smart contract
 Run flashSwap, borrow 1 DAI (1**18) with parameter:
 	_tokenBorrow: 0xC4375B7De8af5a38a93548eb8453a498222C4fF2
	_amount: 1000000000000000000
	_tokenPay: 0xC4375B7De8af5a38a93548eb8453a498222C4fF2
	repay amount of DAI: 1003009027081243732 (1.003 DAI)
...
interface IPancakePair {
    ...
    contract UniswapFlashSwapper {
        ...
        // CONSTANTS
        // UniswapV2Factory on kovan, Goerli:    0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f
        ...
        // why need WETH and DAI in construction?
        constructor(address _WETH,address _DAI) public {
            WETH = _WETH; // 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2  //main
            DAI = _DAI; // 0x6b175474e89094c44da98b954eedeac495271d0f    //main
    ...
    function uniswapV2Call(address _sender, uint _amount0, uint _amount1, bytes calldata _data) external {
        ...
        if (_swapType == SwapType.SimpleLoan) {
            ...
            triangularFlashSwapExecute(_tokenBorrow, _amount, _tokenPay, _triangleData, _userData);
        }
    ...
    function simpleFlashLoan(address _tokenBorrow, uint256 _amount, bool _isBorrowingEth, bool _isPayingEth, bytes memory _userData) private {
        ...
        //get LP token address of WETH/DAI
        ...
        //borrowed asset is at this contract
    ...
    function triangularFlashSwap(address _tokenBorrow, uint _amount, address _tokenPay, bytes memory _userData) private {
        ...
        triangularFlashSwapHelper(_tokenBorrow, _amount, _tokenPay, borrowPairAddress, payPairAddress, amountOfWeth, _userData);
    }
...
contract MyFlashLoanContract is UniswapFlashSwapper {
    ...
    // @param _amount The amount of _tokenBorrow you will borrow
    // @param _tokenPay The address of the token you want to use to payback the flash-borrow, use 0x0 for ETH
    // @param _userData Data that will be passed to the `execute` function for the user => removed, default as 'not empty'
    // @dev Depending on your use case, you may want to add access controls to this function
