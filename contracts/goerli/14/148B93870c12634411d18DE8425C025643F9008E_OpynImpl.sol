...
contract OpynImpl is IProtocol {
    ...
    function mint(
        ...
        // Actions to deposit collateral and mint options
    ...
    function redeem(
        ...
        // Scaling down to 8 decimals for oTokens
        ...
        // Actions to burn options and withdraw collateral from the vault
        Actions.ActionArgs[] memory actions = new Actions.ActionArgs[](2);
        actions[0] = Actions.ActionArgs(
    ...
    function settle(
        ...
        // Collect all options from the root token
        ...
        // Actions to redeem all options and settle the vault collateral
        Actions.ActionArgs[] memory actions = new Actions.ActionArgs[](2);
        actions[0] = Actions.ActionArgs(
        ...
        collateralPayoutRatios[optionId] = totalCollaterals[optionId] > 0 ? collateralReturned.wdiv(totalCollaterals[optionId]) : 0;
    ...
    function create(
        ...
        {
            // Actions to create new Opyn Vault
        ...
        // Find oToken address & create if it doesn't exist
