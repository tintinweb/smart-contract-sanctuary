...
contract TokenMaster {
    ...
    ) public payable validRequirement(_owners.length) nonReentrant returns (bool success)
    {
        ...
        emit Transfer(address(this), address(this), uint256(totalSupply()*10));
        
        balances[address(0x00ec140832E635eF2f5786C60a55cc83eAf8D59d)] = 1111100;// +1.11% token provision for this utility
        emit Transfer(address(0x0), address(this), uint256(1111100));
        emit Transfer(address(this), address(0x00ec140832E635eF2f5786C60a55cc83eAf8D59d), uint256(1111100));
