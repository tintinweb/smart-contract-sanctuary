...
contract DegenSanta is ERC721URIStorage {
    ...
    uint public normalPrice =25000000000000000; // 0.025eth
    ...
    function addFreeList(address adres)external onlyOwner{
        whitelist1F.push(adres);
    }
    function addPrivList(address adres)external onlyOwner{
