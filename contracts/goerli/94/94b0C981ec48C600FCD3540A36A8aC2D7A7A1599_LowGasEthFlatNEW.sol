...
// File: contracts/LowGasEthContract.sol
...
contract LowGasEthFlatNEW is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("LowGasTestFlat", "LGTF") { setHiddenMetadataUri("ipfs://QmRRwj458iG6qTFHGDw9nrBLzKLtBhbM2u1jRBNnfyDyvM/TBR.json"); }
  ...
  function setCost(uint256 _cost) public onlyOwner { cost = _cost; }    // Takes wei instead of ether V. IMPORTANT
  ...
  function setPaused(bool _state) public onlyOwner { paused = _state; } // Pauses the contract

  function withdraw() public onlyOwner {
    // This is an example split for 5% of the initial sale (using my own address).
    // Can put DAO sharing/splitting here, idk it's just a blueprint. NOT used for any dodgy purposes
    // =============================================================================
