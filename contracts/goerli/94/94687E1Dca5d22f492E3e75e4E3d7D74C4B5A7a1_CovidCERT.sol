...
contract CovidCERT is ERC721, AccessControl {

    event Mint(address indexed from, address indexed to, uint256 indexed tokenId, bytes32 tokenHash);
    ...
    function mint(address to, uint256 tokenId, bytes32 tokenHash) external {
        ...
        _safeMint(to, tokenId);
        emit Mint(_msgSender(), to, tokenId, tokenHash);
    }
