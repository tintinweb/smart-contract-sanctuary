...
contract Quiz {
  ...
  uint256 private questionsCount;

  mapping(uint => Question) private questions;
  mapping(address => uint256) private usersCorrectVoteCount;
  mapping(address => mapping(uint256 => bool)) private userAnsweredQuestions; // tracking answered questions for user
