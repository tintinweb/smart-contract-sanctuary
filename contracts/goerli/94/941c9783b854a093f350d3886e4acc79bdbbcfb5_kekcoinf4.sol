...
contract kekcoinf4 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address private _owner;
    string private _name = 'kekcoinf4';
    string private _symbol = 'kekf4';
// EXCHANGES
    ...
    constructor () {
        ...
        _initalSupply(_msgSender(), _totalSupply);
    }
