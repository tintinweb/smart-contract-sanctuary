    ...
    IMintableERC1155
{
    ...
    function mint(
        ...
        require((id <= maxTotalSupply) && (id > uint(0)), "RootFactionArt: INVALID_TOKEN_ID");
        require(((amount > uint(0))), "RootFactionArt: INVALID_AMOUNT");
    ...
    function mintBatch(
        ...
        for (uint i = 0; i < ids.length; i++) {
            require((ids[i] <= maxTotalSupply) && (ids[i] > uint(0)), "RootFactionArt: INVALID_TOKEN_ID");
            require(((amounts[i] > uint(0))), "RootFactionArt: INVALID_AMOUNT");
        }
