...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x0686a82d9A1a0565b03e82ef13eBa0Bd7d25680C;
...
contract ChameleonTest is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   cTESTDividendTracker public dividendTracker;
    ...
    address private _dividendToken = 0x0686a82d9A1a0565b03e82ef13eBa0Bd7d25680C;
    ...
    function activate() public onlyOwner {
        require(!tradingEnabled, "cTEST: Trading is already enabled");
        _swapEnabled = true;
        tradingEnabled = true;
    }
    ...
    constructor() ERC20("ChameleonTest", "cTest") {
    ...
    receive() external payable {
      ...
      function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "cTEST: The Uniswap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function excludeFromFees(address account) public onlyOwner {
        require(!_isExcludedFromFees[account], "cTEST: Account is already excluded from fees");
...
contract cTESTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("cTEST_Dividend_Tracker", "cTEST_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function excludeFromDividends(address account) external onlyOwner {
      ...
      function updateGasForTransfer(uint256 newGasForTransfer) external onlyOwner {
        require(newGasForTransfer != gasForTransfer, "cTEST_Dividend_Tracker: Cannot update gasForTransfer to same value");
        emit GasForTransferUpdated(newGasForTransfer, gasForTransfer);
        gasForTransfer = newGasForTransfer;
    }

    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "cTEST_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
