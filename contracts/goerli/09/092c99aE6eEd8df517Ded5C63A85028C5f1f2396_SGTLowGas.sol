...
// Low gas ERC20 based on Uniswaps UNI token
contract SGTLowGas {
    /// @notice EIP-20 token name for this token
    string public constant name = "Sharedstake.finance";
    ...
    uint256 public totalSupply = 10_000_000e18; // 10 million 
    ...
    function burn(uint256 rawAmount) external {
        ...
        require(amount <= totalSupply, "burn: exceededed total supply");

        totalSupply = safe96(totalSupply - amount, "burn: totalSupply exceeds 96 bits");

        // transfer the amount to the recipient
        balances[msg.sender] = sub96(balances[msg.sender], amount, "burn: transfer amount overflows");
