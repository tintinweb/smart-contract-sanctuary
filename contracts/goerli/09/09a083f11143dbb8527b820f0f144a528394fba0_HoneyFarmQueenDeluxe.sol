...
contract HoneyFarmQueenDeluxe is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint32 public constant MIN_BURN_AMOUNT_FOR_STAKING_BEE = 800; //this is 7

    uint32 public constant MIN_AMOUNT_FOR_ACTIVATE_BEE = 800; //this is 7
    ...
    uint256 public STARTING_POINT2;
     ...
     * @dev Get last time you claimed a bee
     */
    function getStartingPoint2() external view returns (uint256) {
    ...
    function setStartingPoint2(uint256 _epochLength) external onlyOwner {
        STARTING_POINT2 = _epochLength;
    }
