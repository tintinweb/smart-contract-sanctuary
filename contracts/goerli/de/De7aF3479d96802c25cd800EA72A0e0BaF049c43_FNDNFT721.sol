...
abstract contract NFT721Creator is Initializable, ERC721Upgradeable {
  ...
  /*
   * bytes4(keccak256('tokenCreatorPaymentAddress(uint256)')) == 0x044d658d
   */
  bytes4 private constant _INTERFACE_TOKEN_CREATOR_PAYMENT_ADDRESS = 0x044d658d;
...
abstract contract NFT721Mint is Initializable, ERC721Upgradeable, NFT721Creator, NFT721Market, NFT721Metadata {
  ...
  function mint(string memory tokenIPFSPath) public returns (uint256 tokenId) {
    tokenId = _mintToken(tokenIPFSPath, address(0));
  }
  ...
  function mintWithCreatorPaymentAddressAndApproveMarket(
    ...
    tokenId = _mintToken(tokenIPFSPath, tokenCreatorPaymentAddress);
    setApprovalForAll(getNFTMarket(), true);
  }
  ...
  function mintWithCreatorPaymentFactory(
    ...
    return mintWithCreatorPaymentAddress(tokenIPFSPath, tokenCreatorPaymentAddress);
  }

  function _mintToken(string memory tokenIPFSPath, address payable tokenCreatorPaymentAddress)
    private
    returns (uint256 tokenId)
  {
    tokenId = nextTokenId++;
