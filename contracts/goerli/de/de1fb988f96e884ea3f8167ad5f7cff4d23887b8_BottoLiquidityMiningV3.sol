...
contract BottoLiquidityMiningV3 is BottoLiquidityMiningV2 {
    ...
    function updateEndTimeTwo(uint256 _endTime)
        public
        virtual
        update
        onlyOwner
        nonReentrant
    {
        require(
            ...
            "LiquidityMining::updateEndTimeTwo: staking is over"
        );
        require(
            block.timestamp < _endTime,
            "LiquidityMining::updateEndTimeTwo: new end time must be in future"
        );
