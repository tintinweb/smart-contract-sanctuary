...
contract Cowboys is ERC721Enumerable, Ownable {
    ...
    address public constant developer = 0xb82b2967C465dcd0483229eA2bF293E2D6A5CD7E;
    ...
    constructor(string memory baseURI) ERC721("Cowboys", "COWBOYS"){
        setBaseURI(baseURI);
    }
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(developer, address(this).balance);
    }
