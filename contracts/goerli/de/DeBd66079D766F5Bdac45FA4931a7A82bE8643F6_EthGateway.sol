...
contract EthGateway is Ownable {
    ...
    event TransferredFromSmartChain(address to, uint256 amount);
    ...
    function transferFromSmartChain(address to, uint256 amount)
        external
        onlyOwner
    {
        trade.transfer(to, amount);
        emit TransferredFromSmartChain(to, amount);
    }
}
