...
interface ILPStakingRewards {
     ...
     * @param newStakingRate rewards tokens per block
     */
    function setStakingRate(uint256 newStakingRate) external;
     ...
     * @param lpToken Address of LP Token contract
     */
    function claimReward(address user, address lpToken) external;
