...
contract CzechosUATM is PausableToken {

    string public constant name = "UATM";
    string public constant symbol = "UATM";
    uint8 public constant decimals = 10;

    uint256 private constant TOKEN_INITIAL = 7000000000 * (10 ** uint256(decimals));
