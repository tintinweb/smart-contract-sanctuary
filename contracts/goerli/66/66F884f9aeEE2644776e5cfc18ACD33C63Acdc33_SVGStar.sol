...
contract SVGStar is ERC721URIStorage, Ownable {
  ...
  function tokenURI(uint256 tokenId) override public pure returns (string memory) {
    ...
    string memory svgStringData = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="green" /><text x="10" y="20" class="base">';
    
    string memory output = string(abi.encodePacked(svgStringData));
