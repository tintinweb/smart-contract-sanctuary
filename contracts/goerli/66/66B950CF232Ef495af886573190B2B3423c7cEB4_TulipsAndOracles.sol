...
contract TulipsAndOracles is ERC721Tradable {
    ...
    modifier onlyArtist() {
        require(_msgSender() == artist, "Only Artist can access this");
        _;
    }
    
    constructor(address _proxyRegistryAddress, address _artist)
        public
    ...
    function updateSunshineURI(string memory _URI) public onlyArtist() {
        SUNSHINE_URI = _URI;
    }
    
    function updateRainURI(string memory _URI) public onlyArtist() {
        RAINY_URI = _URI;
    }

    function setTokenURI(string memory _tokenURI) public onlyArtist() {
