...
contract RandomNumberConsumer is Ownable, VRFConsumerBase {
     ...
     */
        console.log("contract status as right now paused =± :", paused);
    ...
    function newPrediction(uint8 _bet_type) public payable {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        if ((bet.bet_type == 2 && randomness % 2 == 0) || (bet.bet_type == 1 && randomness % 2 != 0)) {  //is pair
