...
import "./GovernancePowerDelegationTokenERC20.sol";

/**
 * @notice implementation of the Volmex Vesting token contract
 * @author Volmex
 */
contract VolmexToken is GovernancePowerDelegationTokenERC20 {

    string internal constant NAME = "Volmex Token";
    string internal constant SYMBOL = "VOLX";
    uint8 internal constant DECIMALS = 18;

    uint256 public constant REVISION = 1;

    /// @dev the total supply of volmex token
    uint256 internal constant TOTAL_AMOUNT = 1000000000;
...
import "../interfaces/IGovernancePowerDelegationTokenERC20.sol";

/**
 * @notice implementation of the VOLMEX ERC20 token contract
 * @author Volmex
 */
abstract contract GovernancePowerDelegationTokenERC20 is
    ERC20Upgradeable,
    IGovernancePowerDelegationTokenERC20
{
...
interface IGovernancePowerDelegationTokenERC20 {
    enum DelegationType {
        VOTING_POWER,
        PROPOSITION_POWER
    }
