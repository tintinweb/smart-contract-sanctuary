...
// File: contracts\JJC.sol

// SPDX-License-Identifier: SimPL-2.0
pragma solidity ^0.8.0;


contract JJC is ERC721URIStorage {
    string private _baseTokenURI="http://www.jjc.com/token/";

    constructor() ERC721("JJC", "JJC") {}

    function award(address player, uint256 tokenId)
        public
        returns (uint256)
    {
