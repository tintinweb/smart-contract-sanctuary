...
contract Toothpaste is ERC721, Ownable {
    ...
    constructor() ERC721("Toothpaste", "TP99") {
        _tokenIds.increment();
    }

    modifier isMintable() {
        require(saleActive, "Toothpaste: NFT cannot be minted yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "Toothpaste: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedMaxMintPerWallet(uint256 amount) {
        require(
            ...
            "Toothpaste: Mint amount exceeds max limit per wallet."
        );
        _;
    }
    ...
    modifier isNotExceedAvailableSupply(uint256 amount) {
        require(
            ...
            "Toothpaste: There are no more remaining NFT's to mint."
        );
        _;
    }
    ...
    modifier isNotExceedReservedSupply(uint256 amount) {
        require(
            ...
            "Toothpaste: There are no more remaining reserved NFT's to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficient(uint256 amount) {
        require(
            ...
            "Toothpaste: There was not enough/extra ETH transferred to mint an NFT."
        );
        _;
    }
