...
/**
 * SmartContract: goerli.org/G1000000/
 * Website : goerli.org/G1000000/
...
contract G1000000 is ERC20Interface, Tokenlock, UserLock {
    ...
    constructor() public {
        ...
        name = " G1000000.goerli.org ";

        decimals = 2;

        _totalSupply = 12 * 10**uint(decimals);
