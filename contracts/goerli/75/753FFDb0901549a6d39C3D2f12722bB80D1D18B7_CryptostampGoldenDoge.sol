...
/*
 * Crypto stamp Golden Doge (Layer 2)
...
// File: contracts/CryptostampGoldenDoge.sol

/*
 * Implements ERC 721 NFT standard: https://github.com/ethereum/EIPs/issues/721.
 */

contract CryptostampGoldenDoge is ERC721EnumerableSimple, ERC721ExistsI, ERC721SignedTransferI {
    ...
    ERC721("Crypto stamp Golden Doge", "CSGD")
    {
    ...
    modifier onlyMinter()
    {
        // Both the actual create control key and the shipping control key that delivers the on-chain raffle can mint Golden Doges.
        require(msg.sender == bridgeData.getAddress("createControl") || msg.sender == bridgeData.getAddress("shippingControl"), "createControl or shippingControl key required for this function.");
        _;
    }
