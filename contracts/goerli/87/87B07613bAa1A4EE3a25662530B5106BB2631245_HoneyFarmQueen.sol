...
contract HoneyFarmQueen is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint32 public constant HONEY_UNSTAKED_BEE_REWARDS_PER_ROUND = 13; //this is 0.13

    uint32 public constant HONEY_STAKED_BEE_REWARDS_PER_ROUND = 9; //this is 0.09

    uint8 public constant MIN_USAGE_PER_HIVE = 3;

    uint32 public constant REWARD_FOR_BURNING_BEE = 1200; //this is 12

    uint16 public ROUNDS_BEFORE_INACTIVE_BEE; //number of rounds that a bee can claim honey before becoming inactive

    uint16 private lowestBeeId;

    uint32 public constant MIN_BURN_AMOUNT_FOR_STAKING_BEE = 700; //this is 7
    ...
    uint256 public constant MIN_BURN_AMOUNT_FOR_BEE = 2300; //this is 23

    uint256 public constant MIN_AMOUNT_FOR_ACTIVATE_HIVE = 6900; //this is 69
