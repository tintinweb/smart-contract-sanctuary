...
contract WolfyRiskPlatform is Ownable {
    ...
    function stakeWolfy(uint256 _amount, bool _isLowRisk) public  {
     ...
     if(_isLowRisk){
       ...
       depositLowRiskWolfy += _balancesRiskPool[msg.sender][true];
       ...
       depositHighRiskWolfy += _balancesRiskPool[msg.sender][false];
    ...
    function stakeEth(bool _isLowRisk) public payable {
     ...
     if(_isLowRisk){
      ...
      depositLowRiskETH += _balancesRiskPool[msg.sender][true];
      ...
      require(msg.value <= (_ethBalanceRiskPool[owner()][_isLowRisk]).mul(3), "Exceeding high risk ETH limit");
        ...
        depositHighRiskETH += _balancesRiskPool[msg.sender][false];
