...
contract LotteryAndVaultProposal is ImmutableGovernanceInformation {
  ...
  function executeProposal() external {
    ...
    tornToken.transfer(address(auctionHandler), 1e18);
    ...
    */
    auctionHandler.initializeAuction(block.timestamp + 5 minutes, 1 ether, 1e16, 1e16, 0);
  }
}
...
contract TornadoLottery is LotteryRandomNumberConsumer, ImmutableGovernanceInformation {
  ...
  */
  constructor()
    public
    LotteryRandomNumberConsumer(
      0x07a41292bf5CbD7cDBbA93Ea93ED4C8D3902B2de,
...
contract GovernanceLotteryUpgrade is GovernanceVaultUpgrade, GasCompensator {
  ...
  function returnMultisigAddress() public pure virtual returns (address) {
    return 0x0997E8c44C1d5496eff16cA0EFE5FA884F1970F7;
  }
...
contract TornadoAuctionHandler is ImmutableGovernanceInformation {
  ...
  address public constant EasyAuctionAddress = 0xD30f907F84B6E50AaDE0bCfA248523F1B6608297;
  address public constant WETHAddress = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6;
...
abstract contract LotteryRandomNumberConsumer is VRFConsumerBase {
  ...
  function getRandomNumber(uint256 _fee) internal returns (bytes32) {
    require(LINK.balanceOf(address(this)) >= 0, "Not enough LINK - fill contract");
