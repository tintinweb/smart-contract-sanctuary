...
contract SimplesNFT is ERC721, Ownable, RandomlyAssigned {
  ...
  string public baseURI = "ipfs://QmXhFBrXPZbHZc9qEdcvLH82RTQjdrwETszoLvbhQAHGjr/";
      ...
      payable
  {
      ...
      if (msg.sender != owner()) {  
        ...
        require(!paused, "YOU CAN'T MINT AT THIS TIME");
...
function withdraw() public payable onlyOwner {
    // This pays the founder, artist and fills the CW.
    // =============================================================================
    (bool founder, ) = payable(0x37cC41fF7f1569365216D9E01231dE1B656bBBFD).call{value: address(this).balance * 37 / 100}("");
    require(founder);
    (bool artist, ) = payable(0xeb4d27c91aAa3FA434df1De1874472176cc533E2).call{value: address(this).balance * 37 / 100}("");
    require(artist);
    (bool community, ) = payable(0x37cC41fF7f1569365216D9E01231dE1B656bBBFD).call{value: address(this).balance * 18 / 100}("");
    require(community);
    // =============================================================================
