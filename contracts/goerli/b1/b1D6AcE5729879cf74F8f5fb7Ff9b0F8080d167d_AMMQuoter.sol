        ...
        returns (uint256 makerAssetAmount)
    {
        ...
        if (vars.makerAddr == UNISWAP_V2_ROUTER_02_ADDRESS ||
            ...
            if (swapType == 1) {
                ...
                makerAssetAmount = quoter.quoteExactInputSingle(vars.takerAssetAddr, vars.makerAssetAddr, poolFee, vars.takerAssetAmount, 0);
            } else if (swapType == 2) {
                ...
                revert("AMMQuoter: unsupported UniswapV3 swap type");
            }
        } else {
