...
import { IMintableERC1155 } from "./ethereum/IMintableERC1155.sol";

contract RPTToken is ERC1155, IMintableERC1155, AccessControlMixin, NativeMetaTransaction, ContextMixin {
    // constants
    address public constant predicateManager = 0x72d6066F486bd0052eefB9114B66ae40e0A6031a;
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    constructor() ERC1155('') {
        _setupContractId('RPTToken');
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, predicateManager);
        _initializeEIP712('RPT');
    }
    ...
    function mint(address account, uint256 id, uint256 amount, bytes calldata data) external override only(PREDICATE_ROLE) {
        _mint(account, id, amount, data);
    }

    function mintBatch(address to, uint256[] calldata ids, uint256[] calldata amounts, bytes calldata data ) external override only(PREDICATE_ROLE) {
...
// childChainManager = 0x8f4f2da22e8ac8f11e15f9fc141cddbb5deea8800186560abb6e68c5496619a9
