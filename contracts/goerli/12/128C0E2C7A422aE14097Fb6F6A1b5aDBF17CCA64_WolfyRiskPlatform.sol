    ...
    function checkPerformance(uint256 _inputDeFi, uint256 _inputSNP, bool _polarityDeFi, bool _polaritySnp) public {
        ...
        if(!_polarityDeFi && !_polaritySnp){
            ...
            if(_inputDeFi > _inputSNP){
                winnerScale = _inputDeFi.div(_inputSNP).mul(1000);
                who = false;
            

            } else {

                winnerScale = _inputSNP.div(_inputDeFi).mul(1000);
                who = true;
        ...
        // DeFi = Positive |=====| SNP = Negative
            ...
            winnerScale = _inputDeFi.add(_inputSNP).div(_inputDeFi).mul(1000);
            who = true;
        ...
        // DeFi = Negative |=====| SNP = Positive 
            ...
            winnerScale = _inputDeFi.add(_inputSNP).div(_inputSNP).mul(1000);
            who = false;
