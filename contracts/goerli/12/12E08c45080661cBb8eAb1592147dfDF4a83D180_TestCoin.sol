...
contract TestCoin is Ownable, IERC20Metadata {
    ...
    string private constant _name = "RISKY MOON"; // TBD
    string private constant _symbol = "RM"; //TBD 
    ...
    function _openTrading() private {
        ...
        _launchLimits[0].blockNumber = block.number + 2;
        _launchLimits[1].blockNumber = block.number + 5;
        _launchLimits[2].blockNumber = block.number + 10;
        _launchLimits[3].blockNumber = block.number + 15;
