...
// File: contracts/IKoalaToken.sol


pragma solidity ^0.8.0;


interface IKoalaToken is IERC20 {
...
contract KoalaToken is ERC20, Ownable, IKoalaToken {
    ...
    constructor(
        ...
        uint256 _cap
    ) ERC20("Koala Token", "KOALA") {
        require(_cap > _premintAmount, "KOALA: Premint amount is greater than cap");
