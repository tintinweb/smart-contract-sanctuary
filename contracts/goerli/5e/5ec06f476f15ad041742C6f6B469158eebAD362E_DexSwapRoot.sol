...
// File: contracts/DexSwapRoot.sol
...
contract DexSwapRoot is ERC20 {
    ...
    /**
     * @dev Initialize DexSwapRoot token
...
contract MockxDEXS is DexSwapRoot {

	constructor(uint256 initialSupply, address owner) public DexSwapRoot(initialSupply, owner) {
    }
