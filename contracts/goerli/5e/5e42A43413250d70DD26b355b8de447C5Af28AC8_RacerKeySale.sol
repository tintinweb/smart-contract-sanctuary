...
contract RacerKeySale is IERC1155Receiver, AccessControlEnumerable {
    ...
    // Public Sale
    function puchaseKeys(uint256 quantity) public payable {
        ...
        uint256 sellableQuantity = quantity;
        uint256 refund = 0;

        if (storeBalance < quantity) {
            sellableQuantity = storeBalance;
            uint256 difference = quantity - storeBalance;
            refund = difference * salePrice;
        }
