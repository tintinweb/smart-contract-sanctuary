 ...
 * behavior.
 */
contract Crowdsale is Context, ReentrancyGuard, CapperRole {
    using SafeMath for uint256;
    ...
    // ** ADDED BY STAKECLAIM - start **
    function changeRate(uint256 newRate) external onlyCapper {
        _rate = newRate;
    }
    // ** ADDED BY STAKECLAIM - end **
...
contract StakeClaimCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale {
